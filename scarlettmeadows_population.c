...
void func_3() // Position - 0xCB8
{
	return;
}

void func_4() // Position - 0xCC0
{
	return;
}

int func_5() // Position - 0xCC8
{
	return Global_1572887.f_14;
}

BOOL func_6(BOOL bParam0, BOOL bParam1) // Position - 0xCD6
{
	int i;
...
void func_8(Volume volParam0) // Position - 0xDCA
{
...
void func_9(Volume volParam0) // Position - 0xE11
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xE52
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xEC5
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xF44
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_13(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xFBA
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_14(Volume volParam0) // Position - 0x1030
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_15(var uParam0, int iParam1) // Position - 0x1071
{
