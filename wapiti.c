...
void _DEBUG_PRINT(int iParam0) // Position - 0x823
{
	iParam0 = iParam0;
	return;
}
...
void func_16(int iParam0) // Position - 0x83C
{
	if (func_45() == -1)
		if (bLocal_41)
			func_21(iParam0, 16);
...
void _DEBUG_PRINT_0(int iParam0) // Position - 0x88F
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x89B
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x8B0
{
	return func_56(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x8C1
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x900
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x90C
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x914
{
	if (func_57(iParam0))
		return true;
...
void func_25() // Position - 0x9C4
{
	return;
}

void func_26() // Position - 0x9CC
{
	return;
}

void func_27() // Position - 0x9D4
{
	return;
}

void func_28() // Position - 0x9DC
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x9E4
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x9F0
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x9FC
{
	return;
}

void func_32() // Position - 0xA04
{
	return;
}

void func_33(int iParam0) // Position - 0xA0C
{
	func_61(0.775f, 0.2f, 0.025f, 0f);
	return;
}

void func_34() // Position - 0xA28
{
...
void func_35(var uParam0) // Position - 0xA59
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA9F
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xAB4
{
	if (!func_63(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xACD
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xADE
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xAF6
{
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xAFF
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xC3E
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xC4B
{
...
BOOL func_44(int iParam0) // Position - 0xC81
{
	if (iParam0 == 0)
	{
		func_77();
...
int func_45() // Position - 0xD95
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xDA3
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xDAF
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xE1C
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xEFC
{
	if (!func_63(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xF1A
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xF2D
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

void func_53(Volume volParam0, BOOL bParam1) // Position - 0xF4B
{
	int num;
...
void func_54(int iParam0, BOOL bParam1) // Position - 0xF6E
{
	if (Global_1572887.f_14 == -1)
	{
...
BOOL func_55() // Position - 0xFC1
{
	return false;
}

BOOL func_56(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xFCA
{
	int num;
	int num2;
	int num3;
...
BOOL func_57(int iParam0) // Position - 0x10C2
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_58(int iParam0) // Position - 0x10D3
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_59(int iParam0) // Position - 0x10E7
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_60(var uParam0, var uParam1) // Position - 0x10FB
{
	return uParam0;
}

void func_61(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1105
{
...
void func_62(var uParam0, Volume volParam1, int iParam2) // Position - 0x112D
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_63(int iParam0) // Position - 0x1186
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_64() // Position - 0x119C
{
	int i;
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x11C9
{
	return iParam0 && iParam1 != false;
}

BOOL func_66(var uParam0, int iParam1) // Position - 0x11D8
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_67() // Position - 0x11E9
{
	return func_65(Global_1940199, 8192);
}

BOOL func_68(var uParam0, int iParam1) // Position - 0x11FC
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_69(int iParam0) // Position - 0x120D
{
	if (!func_63(iParam0))
		return false;
...
BOOL func_70(int iParam0, int iParam1) // Position - 0x124D
{
...
int func_71() // Position - 0x127A
{
	return Global_1896646.f_41;
}

void func_72(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1288
{
	BOOL flag;
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_108(&unk, joaat("COLOR_PURE_WHITE")), str3, func_108(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_108(&unk, joaat("COLOR_PURE_WHITE")), func_108(&unk2, joaat("COLOR_PURE_WHITE")));
		}
...
void func_73(var uParam0, int iParam1) // Position - 0x14EC
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_74(int iParam0, BOOL bParam1) // Position - 0x14FF
{
...
void func_75(BOOL bParam0) // Position - 0x1B68
{
	if (bParam0)
...
BOOL func_76(int iParam0) // Position - 0x1B91
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_77() // Position - 0x1BD6
{
	return;
}

Hash func_78(int iParam0, BOOL bParam1) // Position - 0x1BDE
{
	switch (iParam0)
	{
		case 0:
...
void func_79(BOOL bParam0) // Position - 0x23A3
{
	if (bParam0)
...
void func_80(int iParam0) // Position - 0x23CC
{
	func_61(0.775f, 0.2f, 0.025f, 0f);
...
void func_81(int iParam0) // Position - 0x245B
{
	int i;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x24BF
{
	int num;
	int num2;
	int num3;
...
BOOL func_84(int iParam0) // Position - 0x2575
{
	int i;
...
BOOL func_85(int iParam0, BOOL bParam1) // Position - 0x25EF
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_86(int iParam0) // Position - 0x2620
{
	if (!func_63(iParam0))
		return false;
...
BOOL func_87(int iParam0) // Position - 0x2641
{
	if (!func_63(iParam0))
		return false;
...
BOOL func_88(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2694
{
	BOOL flag;
...
BOOL func_89(int iParam0) // Position - 0x2D54
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_90(int iParam0) // Position - 0x2D6B
{
	switch (iParam0)
	{
		case 64:
...
int func_91(int iParam0, BOOL bParam1) // Position - 0x2DAE
{
	if (!func_89(iParam0))
		return 0;
...
BOOL func_92(int iParam0) // Position - 0x2E99
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_93(int iParam0) // Position - 0x2EAF
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_94(int iParam0) // Position - 0x2EC5
{
...
const char* func_96(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x2F3D
{
	const char* StringToTest;
...
BOOL func_97(int iParam0) // Position - 0x399C
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_98(int iParam0) // Position - 0x39B1
{
	switch (iParam0)
	{
		case 0:
...
Hash func_99(int iParam0) // Position - 0x3A6C
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_100(int iParam0) // Position - 0x3ADA
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_101(int iParam0) // Position - 0x3C35
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_102(int iParam0, BOOL bParam1) // Position - 0x3C70
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_103(int iParam0, int iParam1) // Position - 0x3CB2
{
	if (!func_97(iParam0))
		return false;
...
BOOL func_104() // Position - 0x3CF7
{
	return Global_1902569;
}

int func_105(BOOL bParam0) // Position - 0x3D03
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 12) & 31;
}

int func_106(BOOL bParam0) // Position - 0x3D16
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 6) & 63;
}

float func_107(float fParam0) // Position - 0x3D28
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_108(var uParam0, int iParam1) // Position - 0x3D3E
{
...
int func_109(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3D74
{
	int duration;
	var data;
	int num;
...
BOOL func_110(int iParam0) // Position - 0x3DB7
{
	if (func_136(iParam0))
		if (!func_137(44))
			return false;
...
void func_111(int iParam0, int iParam1) // Position - 0x3DD7
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_112(int iParam0, int iParam1) // Position - 0x3DE8
{
	int num;
...
void func_113(var uParam0, var uParam1, int iParam2) // Position - 0x3DFE
{
...
void func_114(Volume volParam0, var uParam1) // Position - 0x3E1B
{
...
void func_115(Volume volParam0) // Position - 0x3E82
{
...
void func_116(BOOL bParam0) // Position - 0x3E99
{
	if (bParam0)
	{
...
void func_117(int iParam0) // Position - 0x3F3C
{
...
void func_118(int iParam0) // Position - 0x401E
{
	int i;
	int num;
...
BOOL func_119(int iParam0, BOOL bParam1) // Position - 0x41F6
{
	if (func_45() != -1)
		return false;
...
int func_120(int iParam0, BOOL bParam1) // Position - 0x4224
{
	if (!func_89(iParam0))
		return 0;
...
int func_121(int iParam0) // Position - 0x42A7
{
	switch (iParam0)
	{
		case 27:
...
int func_122(int iParam0) // Position - 0x42CE
{
	switch (iParam0)
	{
		case 33:
...
void func_125(int iParam0, BOOL bParam1) // Position - 0x4531
{
	BOOL flag;
...
Hash func_126(int iParam0) // Position - 0x48E0
{
	if (!func_89(iParam0))
		return 0;
...
void func_127(int iParam0, PersChar pchParam1) // Position - 0x48FE
{
	if (!func_89(iParam0))
		return;
...
PersChar func_128(int iParam0) // Position - 0x491F
{
	if (!func_89(iParam0))
		return 0;
...
void func_129(int iParam0, BOOL bParam1) // Position - 0x493F
{
	if (func_45() != -1)
		return;
...
BOOL func_130(int iParam0) // Position - 0x4978
{
	if (!func_89(iParam0))
		return false;
...
BOOL func_132(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4A06
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_133(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4B7C
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_134(var uParam0, var uParam1, var uParam2) // Position - 0x4B90
{
	int i;
...
const char* func_135(int iParam0) // Position - 0x4BBE
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_136(int iParam0) // Position - 0x4EA2
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_137(int iParam0) // Position - 0x4ECC
{
	if (!func_169(iParam0))
		return false;
...
struct<2> func_138(Player plParam0) // Position - 0x4EE8
{
	var gamerHandle;
...
const char* func_139(const char* sParam0, int iParam1) // Position - 0x4EFC
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_140(int iParam0, int iParam1) // Position - 0x4F16
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_141(int iParam0, BOOL bParam1) // Position - 0x4F2B
{
	char* StringToTest;
...
void func_142(int iParam0, BOOL bParam1) // Position - 0x4F5F
{
	switch (iParam0)
	{
		case 5:
...
void func_143(int iParam0, int iParam1) // Position - 0x4F94
{
	func_171(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_144(int iParam0) // Position - 0x4FAE
{
	if (!func_89(iParam0))
		return false;
...
void func_145(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4FD3
{
	PersChar persChar;
...
void func_146(int iParam0, BOOL bParam1) // Position - 0x50BF
{
	if (!func_174(iParam0))
		return;
...
void func_147(int iParam0, int iParam1) // Position - 0x5115
{
	if (!func_179(iParam0))
		return;
...
int func_148(int iParam0) // Position - 0x5188
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_149(Hash hParam0) // Position - 0x519E
{
...
void func_150(int iParam0) // Position - 0x51BE
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_151(int iParam0, BOOL bParam1) // Position - 0x51D4
{
	if (func_45() != -1)
		return;
...
void func_152(int iParam0) // Position - 0x5205
{
	Ped EntityIndex;
...
void func_153(int iParam0) // Position - 0x5249
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_154(int iParam0) // Position - 0x525E
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_155(int iParam0) // Position - 0x5273
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_156(int iParam0) // Position - 0x5288
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_157(int iParam0) // Position - 0x5307
{
...
BOOL func_158(int iParam0, BOOL bParam1) // Position - 0x5364
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL func_159(int iParam0, int iParam1) // Position - 0x537D
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_160(int iParam0, int iParam1) // Position - 0x5396
{
...
int func_161(int iParam0) // Position - 0x53D1
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_162(int iParam0) // Position - 0x53E5
{
	return;
}

BOOL func_163(int iParam0, int iParam1) // Position - 0x53ED
{
	if (iParam0 == -1)
		return false;
...
struct<2> func_165() // Position - 0x546C
{
	return Global_1051268;
}

BOOL func_166(var uParam0, var uParam1) // Position - 0x547A
{
	if (!func_184(uParam0))
		return false;
...
struct<2> func_167() // Position - 0x54AE
{
...
BOOL func_168(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x54F9
{
	var unk;
	float num;
	float num2;
...
BOOL func_169(int iParam0) // Position - 0x5529
{
	if (iParam0 == 0)
		return false;
...
BOOL func_170(int iParam0) // Position - 0x553C
{
	int num;
	int num2;
	int offset;
...
void func_171(BOOL bParam0, int iParam1) // Position - 0x5566
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_172(int iParam0) // Position - 0x557B
{
	if (!func_89(iParam0))
		return false;
...
BOOL func_173(Hash hParam0) // Position - 0x559F
{
	return hParam0 != 0;
}

BOOL func_174(int iParam0) // Position - 0x55AB
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_175(int iParam0, BOOL bParam1) // Position - 0x55C1
{
	if (!func_174(iParam0))
		return false;
...
void func_176(int iParam0, BOOL bParam1) // Position - 0x55E7
{
	if (!func_174(iParam0))
		return;
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x5615
{
	if (!func_174(iParam0))
		return;
...
void func_178(int iParam0) // Position - 0x564F
{
	func_189(func_188(iParam0));
	return;
}

BOOL func_179(int iParam0) // Position - 0x5661
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_180(Hash hParam0) // Position - 0x5677
{
	if (func_190(hParam0))
...
BOOL func_181() // Position - 0x5692
{
	return 1;
}

Ped func_182(int iParam0) // Position - 0x569B
{
	PersChar persChar;
...
BOOL func_183(BOOL bParam0, BOOL bParam1) // Position - 0x56C9
{
	return bParam0 && bParam1 != false;
}

BOOL func_184(int iParam0) // Position - 0x56D8
{
	switch (iParam0)
	{
		case 2:
...
int func_185(int iParam0) // Position - 0x5717
{
	switch (iParam0)
	{
		case 2:
...
void func_186(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x57AD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_187(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x624A
{
	float num;
	float num2;
	float num3;
...
int func_188(int iParam0) // Position - 0x62B0
{
...
void func_189(int iParam0) // Position - 0x67CD
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_190(Hash hParam0) // Position - 0x67DE
{
	return hParam0 != 0;
}
