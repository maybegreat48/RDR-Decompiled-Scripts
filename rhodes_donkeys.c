...
void func_9(int iParam0) // Position - 0x516
{
	iLocal_16 = iParam0;
	return;
}

void func_10() // Position - 0x522
{
...
BOOL func_15(int iParam0) // Position - 0x74D
{
	int num;
...
void func_21(Volume volParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0xC34
{
	int num;
...
void func_26() // Position - 0xDAD
{
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (func_47(iLocal_23[i], 0))
		{
			...
			TASK::TASK_PERFORM_SEQUENCE(iLocal_23[i], Sequence);
...
int func_28() // Position - 0xE85
{
	return Global_1572887.f_14;
}

int func_29() // Position - 0xE93
{
	return Global_1893611.f_2;
}

int func_30(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEA1
{
	var ReturnZ;
	int num;
	BOOL flag;
...
void func_31(var uParam0, BOOL bParam1) // Position - 0xFA5
{
	if (bParam1)
	{
		uParam0->f_2 = 0;
...
void func_32(var uParam0, BOOL bParam1) // Position - 0x1021
{
	if (bParam1)
...
void func_33(var uParam0, BOOL bParam1) // Position - 0x1047
{
	if (bParam1)
...
void func_34(var uParam0, BOOL bParam1) // Position - 0x1069
{
	if (bParam1)
...
void func_35(var uParam0, BOOL bParam1) // Position - 0x108B
{
	if (bParam1)
...
void func_36(var uParam0, BOOL bParam1) // Position - 0x10AD
{
	if (bParam1)
...
void func_37(var uParam0, BOOL bParam1) // Position - 0x10D1
{
	if (bParam1)
...
void func_38(var uParam0, BOOL bParam1) // Position - 0x10F3
{
	if (bParam1)
...
void func_39(var uParam0, BOOL bParam1) // Position - 0x1119
{
	if (bParam1)
		func_57(uParam0, 128);
	else
...
Ped func_40(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x1139
{
	Ped EntityIndex;
	...
	func_58(EntityIndex, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return EntityIndex;
}

void func_41(int iParam0) // Position - 0x1179
{
	int num;
...
int func_42() // Position - 0x1246
{
	return Global_1902569;
}

int func_43(int iParam0) // Position - 0x1252
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

BOOL func_44(int iParam0, int iParam1) // Position - 0x1265
{
	return iParam0 && iParam1 != false;
}

void func_45(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6) // Position - 0x1274
{
...
BOOL func_46(Ped pedParam0, Entity eParam1, var uParam2, var uParam3, int iParam4, int iParam5) // Position - 0x14EF
{
	int frameCount;
...
BOOL func_47(Ped pedParam0, int iParam1) // Position - 0x1ADB
{
	int num;
...
float func_48() // Position - 0x1BDA
{
	return func_96(150f, BUILTIN::TO_FLOAT(Global_1939596.f_302)) / BUILTIN::TO_FLOAT(300);
}

BOOL func_49(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1BFE
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

void func_50(var uParam0, BOOL bParam1) // Position - 0x1C27
{
	if (bParam1)
		func_57(uParam0, 4);
	else
...
void func_51(var uParam0, BOOL bParam1) // Position - 0x1C45
{
	if (bParam1)
		func_57(uParam0, 8);
	else
...
void func_52(var uParam0, BOOL bParam1) // Position - 0x1C65
{
	if (bParam1)
	{
		func_57(uParam0, 16);
...
void func_53(var uParam0, BOOL bParam1) // Position - 0x1C90
{
	if (bParam1)
		func_57(uParam0, 32);
	else
...
void func_54(var uParam0, BOOL bParam1) // Position - 0x1CB0
{
	if (bParam1)
		func_57(uParam0, 64);
	else
...
void func_55(var uParam0, BOOL bParam1) // Position - 0x1CD0
{
	if (bParam1)
...
void func_56(var uParam0, int iParam1) // Position - 0x1CF4
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_57(var uParam0, int iParam1) // Position - 0x1D09
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_58(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x1D1A
{
	BOOL flag;
...
BOOL func_59(var uParam0) // Position - 0x1DE4
{
	int i;
...
Ped func_61(Ped pedParam0) // Position - 0x1E64
{
	return pedParam0;
}

BOOL func_62(Ped pedParam0) // Position - 0x1E6E
{
	Hash entityModel;
...
BOOL func_63(Ped pedParam0) // Position - 0x1EA0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x1EE2
{
	return iParam0 && iParam1 != false;
}

void func_65(var uParam0, BOOL bParam1, int iParam2) // Position - 0x1EF1
{
	func_100(iParam2);
...
BOOL func_66(Ped pedParam0, var uParam1) // Position - 0x20C1
{
	Hash recentEvent;
...
void func_67(Ped pedParam0, var uParam1, int iParam2) // Position - 0x2198
{
	if (iParam2 != 16384)
...
BOOL func_68(Ped pedParam0, var uParam1) // Position - 0x21D5
{
	float num;
	float num2;
	int num3;
...
BOOL func_69(Ped pedParam0, Entity eParam1, var uParam2) // Position - 0x22BF
{
	float num;
	float num2;
...
BOOL func_70(Ped pedParam0, var uParam1) // Position - 0x2395
{
	Entity EntityIndex;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_105(pedParam0, uParam1, pedIndexFromEntityIndex))
	{
		...
		{
			fFocusDistance = func_112(uParam1);
...
BOOL func_71(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x249E
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_72(var uParam0, int iParam1) // Position - 0x25D3
{
	int num;
	int num2;
...
BOOL func_73(Ped pedParam0, Ped pedParam1, var uParam2) // Position - 0x260A
{
	float num;
...
BOOL func_74(Ped pedParam0, Ped pedParam1, var uParam2) // Position - 0x2711
{
...
BOOL func_75(Ped pedParam0, Ped pedParam1, var uParam2, BOOL bParam3) // Position - 0x277C
{
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, uParam2->f_24))
				{
					...
					if (func_121(pedParam1, entityCoords, positionOut))
					{
						func_109(uParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, uParam2->f_24))
				{
					...
					if (func_121(pedParam1, entityCoords, positionOut2))
					{
						func_109(uParam2, true);
						return true;
					}
...
BOOL func_76(Ped pedParam0, var uParam1) // Position - 0x28F5
{
	int i;
	float num;
	var unk;
...
BOOL func_77(var uParam0, var uParam1) // Position - 0x2AD1
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_78(var uParam0, int iParam1) // Position - 0x2B49
{
	int num;
	int num2;
...
int func_79(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2B78
{
	Ped DamagerIndex;
	...
	{
		if (func_127(DamagerIndex, &FirstEntityIndex))
	...
	if (func_128(DamagerIndex, pedParam0))
		return 1;
...
int func_80(var uParam0, Ped pedParam1) // Position - 0x2D0E
{
	int _int;
...
BOOL func_81(var uParam0, Ped pedParam1) // Position - 0x2D5E
{
	if (func_129(uParam0))
		return true;
...
BOOL func_82(Ped pedParam0, Ped pedParam1) // Position - 0x2E0B
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_83() // Position - 0x2E58
{
	return;
}

BOOL func_84(var uParam0, Ped pedParam1) // Position - 0x2E60
{
...
BOOL func_87(var uParam0, Ped pedParam1) // Position - 0x2F8C
{
	float num;
	int num2;
	int num3;
...
BOOL func_88(var uParam0, Ped pedParam1) // Position - 0x3040
{
	Ped EntityIndex;
	var entityCoords;
	var entityCoords2;
	...
	if (func_136(EntityIndex, pedParam1, 1060437492) != 0)
		return false;
...
BOOL func_89(Ped pedParam0, Entity eParam1, var uParam2) // Position - 0x30DE
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_90(Ped pedParam0, var uParam1) // Position - 0x3126
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_91(Ped pedParam0, var uParam1) // Position - 0x3481
{
	if (!func_143(0))
		return false;
...
BOOL func_92(var uParam0, int iParam1) // Position - 0x34BA
{
	int num;
	int num2;
...
BOOL func_93(var uParam0, var uParam1) // Position - 0x34E9
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_94(Ped pedParam0, var uParam1) // Position - 0x34FD
{
	if (!PED::IS_PED_HUMAN(pedParam0))
		return false;
...
BOOL func_95(var uParam0, Ped pedParam1) // Position - 0x354A
{
...
float func_96(float fParam0, float fParam1) // Position - 0x359D
{
	if (fParam0 > fParam1)
		return fParam0;
...
void func_97(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x35B4
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_98(Ped pedParam0, BOOL bParam1) // Position - 0x35F9
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_99(Ped pedParam0, int iParam1) // Position - 0x363E
{
	if (iParam1 == 1)
...
void func_100(int iParam0) // Position - 0x3665
{
	int num;
	BOOL flag;
...
Hash func_101(int iParam0) // Position - 0x37FD
{
	return Global_1102813.f_3695[iParam0 /*3*/];
}

BOOL func_102(BOOL bParam0, BOOL bParam1) // Position - 0x3810
{
	Ped EntityIndex;
	Ped EntityIndex2;

	if (func_148(bParam0, &EntityIndex, &EntityIndex2))
	{
		if (bParam1)
		{
...
BOOL func_103(var uParam0) // Position - 0x3863
{
	Ped EntityIndex;
...
void func_104(var uParam0) // Position - 0x38E5
{
...
BOOL func_105(Ped pedParam0, var uParam1, Ped pedParam2) // Position - 0x390C
{
	int num;
	int num2;
...
float func_106(Ped pedParam0, Ped pedParam1) // Position - 0x3A05
{
	return func_130(pedParam0, pedParam1, true, true);
}

float func_107(var uParam0) // Position - 0x3A17
{
	return uParam0->f_29;
}

BOOL func_108(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3A23
{
	switch (iParam0)
	{
		case 1:
...
void func_109(var uParam0, BOOL bParam1) // Position - 0x3A88
{
	if (bParam1)
...
BOOL func_111(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x3AC2
{
	Ped EntityIndex;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(EntityIndex, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_130(EntityIndex, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_151(EntityIndex, 0)))
...
float func_112(var uParam0) // Position - 0x3C32
{
	return uParam0->f_18;
}

BOOL func_113(var uParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x3C3E
{
...
int func_114(var uParam0) // Position - 0x3C9F
{
	return uParam0->f_19;
}

int func_115(var uParam0) // Position - 0x3CAB
{
	return uParam0->f_20;
}

BOOL func_116(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x3CB7
{
	Ped EntityIndex;
	Player playerIndex;
...
int func_117(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3D79
{
...
float func_118(var uParam0) // Position - 0x3E17
{
	return uParam0->f_25;
}

int func_119(var uParam0) // Position - 0x3E23
{
	return uParam0->f_23;
}

int func_120(var uParam0) // Position - 0x3E2F
{
	int num;
...
BOOL func_121(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x3F6C
{
...
BOOL func_122(Ped pedParam0) // Position - 0x3FAF
{
...
BOOL func_123(Ped pedParam0) // Position - 0x4015
{
	Hash entityModel;
...
BOOL func_124(var uParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4041
{
	float num;
...
BOOL func_125(var uParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4088
{
	float num;
...
BOOL func_126(var uParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x40D3
{
	float num;
...
BOOL func_127(Ped pedParam0, var uParam1) // Position - 0x414D
{
...
BOOL func_128(Ped pedParam0, Ped pedParam1) // Position - 0x419A
{
...
BOOL func_129(var uParam0) // Position - 0x4206
{
	return !(*uParam0 & 2 != 0);
}

float func_130(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4216
{
...
BOOL func_131(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x425E
{
	float num;
...
float func_132(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x428A
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_133(var uParam0) // Position - 0x42B2
{
	return uParam0->f_26;
}

int func_134(Ped pedParam0) // Position - 0x42BE
{
...
int func_135(Ped pedParam0) // Position - 0x4312
{
	if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(pedParam0, true))
		return -1;
...
int func_136(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x4366
{
	var entityCoords;
...
float func_137(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x4386
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_138(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x43A4
{
	BOOL flag;
	Entity FirstEntityIndex;
	float num;
	...
	if (!bParam5)
	{
		...
		if (bParam3)
			if (func_127(Global_33, &FirstEntityIndex))
				if (fParam4 < 4f)
...
BOOL func_139(Ped pedParam0, var uParam1, BOOL bParam2) // Position - 0x4514
{
	Ped EntityIndex;
	Ped EntityIndex2;

	func_148(true, &EntityIndex, &EntityIndex2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex))
		if (EntityIndex != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_33, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_33, 17))
					if (!bParam2 || !func_142(uParam1, EntityIndex))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex2))
		if (EntityIndex2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_33, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_33, 17))
				if (!bParam2 || !func_142(uParam1, EntityIndex2))
					if (func_132(EntityIndex2, Global_34, true) < 5f)
						return true;

	return false;
}

BOOL func_140(Ped pedParam0) // Position - 0x4602
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_141(var uParam0) // Position - 0x4628
{
	return func_44(*uParam0, 131072);
}

BOOL func_142(var uParam0, Ped pedParam1) // Position - 0x463B
{
...
BOOL func_143(int iParam0) // Position - 0x46B1
{
	return false;
}

int func_144(var uParam0) // Position - 0x46BA
{
	return uParam0->f_22;
}

BOOL func_145(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0x46C6
{
	if (!bParam2)
		if (uParam1->f_5 == 0)
			return 0;
...
void func_147(Any* panParam0, int iParam1) // Position - 0x4797
{
	int num;
	int i;
	Player player;
...
BOOL func_148(BOOL bParam0, var uParam1, var uParam2) // Position - 0x483F
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_149(var uParam0) // Position - 0x4906
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_150(var uParam0) // Position - 0x49BC
{
	int i;
...
Hash func_151(Ped pedParam0, int iParam1) // Position - 0x4A21
{
	Hash ReturnWeaponType;
...
BOOL func_152(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x4A38
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_153(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x4A66
{
	float fScreenPosX;
	float fScreenPosY;
...
BOOL func_154(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x4AB0
{
...
BOOL func_155(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4AF1
{
...
BOOL func_156(Ped pedParam0) // Position - 0x4B6A
{
...
float func_157(var uParam0) // Position - 0x4C60
{
	return uParam0->f_28;
}

Hash func_158(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x4C6C
{
	Hash ReturnWeaponType;
...
int func_159(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x4CAE
{
	var entityCoords;
	...
	n = func_161(entityForwardVector, unk5);
...
float func_161(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4D74
{
	float num;
...
BOOL func_162(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x4DDB
{
