...
void _DEBUG_PRINT(int iParam0) // Position - 0x8D9
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x8E5
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x8F2
{
	return;
}

BOOL func_17(int iParam0) // Position - 0x8FA
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x907
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x913
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x928
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x939
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x978
{
	iParam0 = iParam0;
	return;
}
...
BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x98C
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0xA3C
{
	return;
}

void func_26() // Position - 0xA44
{
	return;
}

void func_27() // Position - 0xA4C
{
	return;
}

void func_28() // Position - 0xA54
{
	return;
}

void func_29(int iParam0) // Position - 0xA5C
{
...
void func_30(int iParam0) // Position - 0xAB2
{
	return;
}

void func_31() // Position - 0xABA
{
	return;
}

void func_32() // Position - 0xAC2
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xACA
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xAD6
{
...
void func_35(var uParam0) // Position - 0xB07
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xB4D
{
	return;
}

void func_37(int iParam0) // Position - 0xB55
{
	if (!func_61(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xB6E
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xB7F
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xB97
{
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xBA0
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xCDF
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xCEC
{
...
BOOL func_44(int iParam0) // Position - 0xD22
{
	if (iParam0 == 0)
	{
		func_75();
...
int func_45() // Position - 0xE36
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xE44
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xE50
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xEBD
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xF9D
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xFBB
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xFCE
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xFEC
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x10E4
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x10F5
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x1109
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x111D
{
	return uParam0;
}

void func_58(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x1127
{
...
void func_59(int iParam0, int iParam1) // Position - 0x12D6
{
	func_101(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

void func_60(int iParam0, int iParam1) // Position - 0x12F0
{
	if (!func_102(iParam0))
		return;
...
BOOL func_61(int iParam0) // Position - 0x1318
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_62() // Position - 0x132E
{
	int i;
...
BOOL func_63(int iParam0, int iParam1) // Position - 0x135B
{
	return iParam0 && iParam1 != false;
}

BOOL func_64(var uParam0, int iParam1) // Position - 0x136A
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_65() // Position - 0x137B
{
	return func_63(Global_1940199, 8192);
}

BOOL func_66(var uParam0, int iParam1) // Position - 0x138E
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_67(int iParam0) // Position - 0x139F
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_68(int iParam0, int iParam1) // Position - 0x13DF
{
...
int func_69() // Position - 0x140C
{
	return Global_1896646.f_41;
}

void func_70(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x141A
{
	BOOL flag;
	...
	StringToTest = func_106(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_118(&unk, joaat("COLOR_PURE_WHITE")), str3, func_118(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_118(&unk, joaat("COLOR_PURE_WHITE")), func_118(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_119(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_71(var uParam0, int iParam1) // Position - 0x1680
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_72(int iParam0, BOOL bParam1) // Position - 0x1693
{
...
void func_73(BOOL bParam0) // Position - 0x1CFC
{
	if (bParam0)
...
BOOL func_74(int iParam0) // Position - 0x1D25
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_75() // Position - 0x1D6A
{
	return;
}

Hash func_76(int iParam0, BOOL bParam1) // Position - 0x1D72
{
	switch (iParam0)
	{
		case 0:
...
void func_77(int iParam0, BOOL bParam1) // Position - 0x2537
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_78(BOOL bParam0) // Position - 0x258A
{
	if (bParam0)
...
void func_79(int iParam0) // Position - 0x25B3
{
	AUDIO::SET_AMBIENT_ZONE_STATE("AZ_Naturalist_Camp", false, true);
	return;
}

void func_80(int iParam0) // Position - 0x25C4
{
	int i;
...
void func_81(int iParam0) // Position - 0x25F5
{
	int i;
...
BOOL func_82(int iParam0, BOOL bParam1) // Position - 0x2628
{
	int num;
	int num2;
	int num3;
...
BOOL func_83(int iParam0) // Position - 0x26DE
{
	int i;
...
BOOL func_84(int iParam0, BOOL bParam1) // Position - 0x2758
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_85(int iParam0) // Position - 0x2789
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_86(int iParam0) // Position - 0x27AA
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_87(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x27FD
{
	BOOL flag;
...
BOOL func_88(int iParam0) // Position - 0x2EBD
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_89(int iParam0) // Position - 0x2ED4
{
	switch (iParam0)
	{
		case 64:
...
int func_90(int iParam0, BOOL bParam1) // Position - 0x2F17
{
	if (!func_88(iParam0))
		return 0;
...
BOOL func_92() // Position - 0x3016
{
	return func_137(func_56(0));
}

BOOL func_93(int iParam0) // Position - 0x3027
{
	return !func_138(iParam0);
}

void func_94(BOOL bParam0, BOOL bParam1) // Position - 0x3036
{
	if (func_139(255) == 4)
		return;
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x3181
{
	BOOL flag;
...
int func_96(int iParam0, int iParam1) // Position - 0x3530
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_97(int iParam0) // Position - 0x3E96
{
	if (!func_158(iParam0))
		return 0;
...
int func_98(int iParam0) // Position - 0x3ED7
{
	switch (iParam0)
	{
		case 3:
...
void func_99(int iParam0, int iParam1) // Position - 0x3F74
{
...
void func_100(int iParam0) // Position - 0x3FA3
{
...
void func_101(int iParam0, int iParam1) // Position - 0x3FDC
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_102(int iParam0) // Position - 0x3FED
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_103(int iParam0) // Position - 0x4004
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_104(int iParam0) // Position - 0x401A
{
...
const char* func_106(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x4092
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_163(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_165(func_164(Global_34));
...
BOOL func_107(int iParam0) // Position - 0x4AF8
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_108(int iParam0) // Position - 0x4B0D
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0) // Position - 0x4BC8
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_110(int iParam0) // Position - 0x4C36
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_111(int iParam0) // Position - 0x4D91
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_112(int iParam0, BOOL bParam1) // Position - 0x4DCC
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_113(int iParam0, int iParam1) // Position - 0x4E0E
{
	if (!func_107(iParam0))
		return false;
...
int func_114() // Position - 0x4E53
{
	return Global_1902569;
}

int func_115(int iParam0) // Position - 0x4E5F
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_116(int iParam0) // Position - 0x4E72
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_117(float fParam0) // Position - 0x4E84
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_118(var uParam0, int iParam1) // Position - 0x4E9A
{
...
int func_119(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4ED0
{
	int duration;
	var data;
	int num;
...
BOOL func_120(int iParam0) // Position - 0x4F13
{
	if (func_166(iParam0))
		if (!func_167(44))
			return false;
...
void func_121(int iParam0, int iParam1) // Position - 0x4F33
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_122(int iParam0, int iParam1) // Position - 0x4F44
{
	int num;
...
void func_123(var uParam0, var uParam1, int iParam2) // Position - 0x4F5A
{
...
void func_124(int iParam0) // Position - 0x4F77
{
...
void func_125(int iParam0) // Position - 0x5057
{
	int i;
	int num;
...
BOOL func_126(int iParam0, BOOL bParam1) // Position - 0x522F
{
	if (func_45() != -1)
		return false;
...
int func_127(int iParam0, BOOL bParam1) // Position - 0x525D
{
	if (!func_88(iParam0))
		return 0;
...
int func_128(int iParam0) // Position - 0x52E0
{
	switch (iParam0)
	{
		case 27:
...
int func_129(int iParam0) // Position - 0x5307
{
	switch (iParam0)
	{
		case 33:
...
Hash func_132(int iParam0) // Position - 0x556A
{
	if (!func_88(iParam0))
		return 0;
...
void func_133(int iParam0, PersChar pchParam1) // Position - 0x5588
{
	if (!func_88(iParam0))
		return;
...
PersChar func_134(int iParam0) // Position - 0x55A9
{
	if (!func_88(iParam0))
		return 0;
...
void func_135(int iParam0, BOOL bParam1) // Position - 0x55C9
{
	if (func_45() != -1)
		return;
...
BOOL func_136(int iParam0) // Position - 0x5602
{
	if (!func_88(iParam0))
		return false;
...
BOOL func_137(var uParam0, var uParam1) // Position - 0x5628
{
	return func_183(uParam0, 5, 8);
}

BOOL func_138(int iParam0) // Position - 0x563B
{
	return func_184(1, iParam0);
}

int func_139(int iParam0) // Position - 0x564A
{
	if (iParam0 == 255)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x5695
{
...
int func_141(int iParam0) // Position - 0x56BF
{
...
void func_142(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x56DC
{
	func_186(iParam0);
...
int func_143(int iParam0) // Position - 0x573E
{
...
void func_144(var uParam0) // Position - 0x575B
{
	var unk;
...
void func_145(float* pfParam0) // Position - 0x576D
{
	var unk;
...
void func_147(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x57D5
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_148(int iParam0) // Position - 0x5802
{
...
BOOL func_149(int iParam0, int iParam1) // Position - 0x585F
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_150(int iParam0, int iParam1) // Position - 0x5878
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_151(int iParam0, int iParam1) // Position - 0x5891
{
	func_150(iParam0, iParam1);
...
int func_152(int iParam0) // Position - 0x58CC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_153(Hash hParam0) // Position - 0x58E0
{
...
void func_154(int iParam0) // Position - 0x5900
{
	return;
}

void func_155(int iParam0) // Position - 0x5908
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_156(int iParam0, int iParam1) // Position - 0x591D
{
	if (iParam0 == -1)
		return false;
...
void func_157(int iParam0) // Position - 0x5944
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_158(int iParam0) // Position - 0x59C3
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_159(int iParam0) // Position - 0x59D9
{
	var unk;
...
BOOL func_160() // Position - 0x5A0A
{
	return false;
}

BOOL func_161() // Position - 0x5A13
{
	var unk;
	var unk3;
...
BOOL func_162(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5A7B
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_163(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5BF1
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_164(var uParam0, var uParam1, var uParam2) // Position - 0x5C05
{
	int i;
...
const char* func_165(int iParam0) // Position - 0x5C33
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_166(int iParam0) // Position - 0x5F17
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_167(int iParam0) // Position - 0x5F41
{
	if (!func_203(iParam0))
		return false;
...
struct<2> func_168(Player plParam0) // Position - 0x5F5D
{
	var gamerHandle;
...
const char* func_169(const char* sParam0, int iParam1) // Position - 0x5F71
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_170(int iParam0, BOOL bParam1) // Position - 0x5F8B
{
	char* StringToTest;
...
void func_171(int iParam0, BOOL bParam1) // Position - 0x5FBF
{
	switch (iParam0)
	{
		case 5:
...
void func_172(int iParam0, int iParam1) // Position - 0x5FF4
{
	func_205(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_173(int iParam0) // Position - 0x600E
{
	if (!func_88(iParam0))
		return false;
...
void func_174(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6033
{
	PersChar persChar;
...
void func_175(int iParam0, BOOL bParam1) // Position - 0x611F
{
	if (!func_158(iParam0))
		return;
...
void func_176(int iParam0, int iParam1) // Position - 0x6175
{
	if (!func_102(iParam0))
		return;
...
int func_177(int iParam0) // Position - 0x61E8
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_178(int iParam0) // Position - 0x61FE
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_179(int iParam0, BOOL bParam1) // Position - 0x6214
{
	if (func_45() != -1)
		return;
...
void func_180(int iParam0) // Position - 0x6245
{
	Ped EntityIndex;
...
void func_181(int iParam0) // Position - 0x6289
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_182(int iParam0) // Position - 0x629E
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_183(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x62B3
{
	int num;
...
BOOL func_184(int iParam0, int iParam1) // Position - 0x62EE
{
	int num;
...
BOOL func_185(Any* panParam0, int iParam1, int iParam2) // Position - 0x6362
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_191(BOOL bParam0) // Position - 0x6431
{
	if (func_216(bParam0))
		return;
...
BOOL func_192(Any* panParam0, int iParam1, int iParam2) // Position - 0x6458
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_193(Hash hParam0) // Position - 0x648B
{
	if (func_217(hParam0))
...
BOOL func_194() // Position - 0x64A6
{
	return 1;
}

BOOL func_195(BOOL bParam0, BOOL bParam1) // Position - 0x64AF
{
	return bParam0 && bParam1 != false;
}

int func_196(int iParam0) // Position - 0x64BE
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_197(int iParam0, int iParam1, var uParam2) // Position - 0x6EA6
{
	var unk;
...
struct<2> func_199() // Position - 0x6F25
{
	return Global_1051268;
}

BOOL func_200(var uParam0, var uParam1) // Position - 0x6F33
{
	if (!func_220(uParam0))
		return false;
...
struct<2> func_201() // Position - 0x6F67
{
...
BOOL func_202(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x6FB2
{
	var unk;
	float num;
	float num2;
...
BOOL func_203(int iParam0) // Position - 0x6FE2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_204(int iParam0) // Position - 0x6FF5
{
	int num;
	int num2;
	int offset;
...
void func_205(var uParam0, int iParam1) // Position - 0x701F
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_206(int iParam0) // Position - 0x7034
{
	if (!func_88(iParam0))
		return false;
...
BOOL func_207(Hash hParam0) // Position - 0x7058
{
	return hParam0 != 0;
}

BOOL func_208(int iParam0, BOOL bParam1) // Position - 0x7064
{
	if (!func_158(iParam0))
		return false;
...
void func_209(int iParam0, BOOL bParam1) // Position - 0x708A
{
	if (!func_158(iParam0))
		return;
...
void func_210(int iParam0, BOOL bParam1) // Position - 0x70B8
{
	if (!func_158(iParam0))
		return;
...
void func_211(int iParam0) // Position - 0x70F2
{
	func_225(func_224(iParam0));
	return;
}

Ped func_212(int iParam0) // Position - 0x7104
{
	PersChar persChar;
...
int func_213(int iParam0, var uParam1) // Position - 0x7132
{
	if (iParam0 == 2)
...
BOOL func_214(Any* panParam0, int iParam1, int iParam2) // Position - 0x714C
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_215() // Position - 0x7183
{
	return Global_1102813.f_3672;
}

BOOL func_216(BOOL bParam0) // Position - 0x7192
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_217(Hash hParam0) // Position - 0x71A8
{
	return hParam0 != 0;
}

BOOL func_218(int iParam0, int iParam1, Any* panParam2) // Position - 0x71B4
{
...
void func_219(Any* panParam0, int iParam1, var uParam2) // Position - 0x71E8
{
	var unk;
...
BOOL func_220(int iParam0) // Position - 0x7262
{
	switch (iParam0)
	{
		case 2:
...
int func_221(int iParam0) // Position - 0x72A1
{
	switch (iParam0)
	{
		case 2:
...
void func_222(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7337
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_223(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x7DD4
{
	float num;
	float num2;
	float num3;
...
int func_224(int iParam0) // Position - 0x7E3A
{
...
void func_225(int iParam0) // Position - 0x8500
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_226(var uParam0, var uParam1) // Position - 0x8511
{
	var unk;
...
int func_227(int iParam0) // Position - 0x853D
{
	int num;
...
BOOL func_228(int iParam0, var uParam1, Any* panParam2) // Position - 0x86B2
{
	if (!func_200(iParam0))
		return false;
...
void func_229(Any* panParam0) // Position - 0x87BD
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
