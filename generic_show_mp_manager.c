...
BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0x53
{
	int i;
...
void func_3() // Position - 0x133
{
	func_9();
	return;
}

void func_4(int iParam0, int iParam1) // Position - 0x13F
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_9();
...
void func_8(BOOL bParam0) // Position - 0x38C
{
	int num;
	var unk;
	int num2;
...
int func_10() // Position - 0x461
{
	return Global_1572887.f_14;
}

BOOL func_11() // Position - 0x46F
{
	return Global_1051645.f_8;
}

int func_12(int iParam0, int iParam1, char* sParam2) // Position - 0x47D
{
	return 1;
}

BOOL func_13() // Position - 0x486
{
	return !Global_1572887.f_10;
}

int func_14() // Position - 0x495
{
	return Global_1102813.f_3672;
}

int func_15(int iParam0, int iParam1, char* sParam2) // Position - 0x4A4
{
	return 1;
}
