...
int func_4() // Position - 0x72D
{
	return Global_1572887.f_14;
}

void func_5() // Position - 0x73B
{
...
BOOL func_6(BOOL bParam0, BOOL bParam1) // Position - 0x757
{
	int i;
...
void func_8() // Position - 0x8C0
{
	FLOCK::_0xFB16F08F47B83B4C(joaat("SPECIES_BIRD_CROW"));
	return;
}

void func_9(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x8D1
{
...
void func_10(Volume volParam0) // Position - 0x950
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
BOOL func_11() // Position - 0x991
{
	return false;
}

void func_12(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x99A
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_13(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xA10
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_14(Hash hParam0, int iParam1) // Position - 0xA86
{
	func_19(hParam0, true, 0, false, false, 0, false, false);
	return;
}

BOOL func_15(int iParam0) // Position - 0xA9B
{
	int num;
	int num2;
	int offset;
...
void func_16(int iParam0) // Position - 0xB1A
{
	int num;
	int num2;
	int BitIndex;
...
void func_17(int iParam0) // Position - 0xB4D
{
	int num;
	int num2;
	int BitIndex;
...
void func_18(var uParam0, int iParam1) // Position - 0xB80
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_19(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0xB95
{
...
int func_20(int iParam0, int iParam1) // Position - 0xC20
{
	switch (iParam0)
	{
...
BOOL func_21(int iParam0) // Position - 0x24C5
{
	int num;
...
BOOL func_22(int iParam0) // Position - 0x24E2
{
...
Hash func_23(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x24F9
{
...
BOOL func_24(Hash hParam0) // Position - 0x259D
{
	if (func_31(hParam0))
...
void func_25(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x25B8
{
	if (func_24(hParam0))
	{
...
void func_26(Hash hParam0, BOOL bParam1) // Position - 0x25F0
{
	if (func_24(hParam0))
...
void func_27(Hash hParam0, BOOL bParam1) // Position - 0x261E
{
	if (func_24(hParam0))
...
void func_28(Hash hParam0, BOOL bParam1) // Position - 0x264C
{
	if (func_24(hParam0))
...
BOOL func_29() // Position - 0x267A
{
	return true;
}

int func_30(int iParam0) // Position - 0x2683
{
	return func_32(iParam0) + 30;
}

BOOL func_31(Hash hParam0) // Position - 0x2693
{
	return hParam0 != 0;
}

int func_32(int iParam0) // Position - 0x269F
{
	return iParam0 * 31;
}
