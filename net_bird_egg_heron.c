...
int func_1() // Position - 0xB6
{
	return Global_1572887.f_14;
}

struct<2> func_2(int iParam0) // Position - 0xC4
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_3(int iParam0, var uParam1) // Position - 0xD8
{
	return iParam0;
}

void func_4(var uParam0) // Position - 0xE2
{
	int num;
	int i;
...
void func_5(var uParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6) // Position - 0x18E
{
	*uParam0 = 5;
...
BOOL func_6(var uParam0) // Position - 0x1D5
{
...
BOOL func_7() // Position - 0x1EF
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x1F8
{
	switch (uParam0->f_4)
	{
		case 0:
...
int func_9(var uParam0) // Position - 0x229
{
	var unk;
...
void func_10(BOOL bParam0) // Position - 0x27A
{
	if (bParam0)
		func_21(0, 6);
	else
...
void func_11(var uParam0) // Position - 0x297
{
...
int func_12(var uParam0) // Position - 0x2B2
{
	int i;
...
int func_13(Object obParam0, Object obParam1, int iParam2) // Position - 0x358
{
	int i;
	var SourceStruct;
...
BOOL func_14(int iParam0, int iParam1) // Position - 0x402
{
	return iParam0 && iParam1 != false;
}

void func_15(int iParam0, int iParam1) // Position - 0x411
{
	func_23(iParam0, iParam1);
	return;
}

void func_16(var uParam0) // Position - 0x421
{
	func_24(uParam0);
...
void func_17(var uParam0) // Position - 0x438
{
	BOOL flag;
	int i;
...
void func_18(var uParam0) // Position - 0x8A2
{
	BOOL flag;
	int i;
...
BOOL func_19(var uParam0) // Position - 0xB75
{
	if (uParam0->f_4 == 0)
...
int func_20(int iParam0, Any anParam1) // Position - 0xBC4
{
	var unk;
...
void func_21(int iParam0, int iParam1) // Position - 0xBED
{
...
void func_22(int iParam0, int iParam1, BOOL bParam2) // Position - 0xC31
{
...
void func_23(int iParam0, int iParam1) // Position - 0xC98
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_24(var uParam0) // Position - 0xCAD
{
	if (uParam0->f_4 != -1)
	{
...
void func_25(int iParam0, int iParam1) // Position - 0xCE0
{
	if (func_58(iParam0))
...
int _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0xCF9
{
	return uParam0->f_1;
}

void func_27(var uParam0) // Position - 0xD05
{
	if (func_59(*uParam0))
	{
...
BOOL func_28(var uParam0) // Position - 0xD75
{
	var unk;
...
void func_29(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xDBB
{
	BOOL flag;
	BOOL flag2;
	float num;
...
BOOL func_30(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7) // Position - 0xFE4
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
int func_31(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x1039
{
	int num;
	var unk13;
	int num2;
...
float func_32(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1074
{
...
void func_33(var uParam0) // Position - 0x109C
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
void func_34(Object obParam0, BOOL bParam1) // Position - 0x10DF
{
	if (ENTITY::DOES_ENTITY_EXIST(obParam0))
		if (!bParam1)
...
void func_35(var uParam0, int iParam1) // Position - 0x1151
{
	uParam0->f_1 = iParam1;
	return;
}

void func_36(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x115F
{
	if (!func_58(iParam0))
	{
...
void func_37(var uParam0) // Position - 0x1193
{
...
BOOL func_38(var uParam0) // Position - 0x11A9
{
...
BOOL func_39(var uParam0) // Position - 0x11CA
{
	if (!ENTITY::DOES_ENTITY_EXIST(obLocal_38))
...
void func_40(var uParam0) // Position - 0x11FB
{
	int i;
...
int func_41(Object obParam0, Object obParam1, int iParam2) // Position - 0x12E6
{
	int i;
...
void func_43(var uParam0, var uParam1, Any anParam2) // Position - 0x13B3
{
	var unk;
	int num;
	int num2;
...
void func_44(var uParam0, var uParam1, Any anParam2) // Position - 0x1455
{
	var unk;
	int num;
	int num2;
...
void func_45(var uParam0) // Position - 0x14F7
{
	var entityCoords;
	var unk3;
...
int func_46(var uParam0, var uParam1) // Position - 0x160E
{
	int num;
	int i;
...
void func_47(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x164A
{
	if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_7))
	{
...
void func_48(var uParam0) // Position - 0x1681
{
	TASK::_REQUEST_HERB_COMPOSITE_ASSET(hLocal_40);
	return;
}

BOOL func_49(var uParam0) // Position - 0x1690
{
...
BOOL func_50(var uParam0) // Position - 0x16A6
{
	var unk;
...
int func_51(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6) // Position - 0x16E8
{
	Volume volume;
	int num;
...
int func_52(var uParam0) // Position - 0x1719
{
...
int func_53(var uParam0) // Position - 0x175C
{
	if (func_14(Global_1222327[*uParam0 /*251*/][uParam0->f_13], 2))
		return 1;
...
void func_54(var uParam0, int iParam1) // Position - 0x1780
{
	BOOL flag;
	int i;
...
int func_55(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x18AC
{
	var unk;
	int num;
...
BOOL func_59(Entity eParam0) // Position - 0x1965
{
	Hash entityModel;
...
void func_61(int iParam0, BOOL bParam1) // Position - 0x19FB
{
	int num;
	int num2;
...
struct<5> func_62(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1A28
{
	var unk;
	int num;
	var unk6;
...
BOOL func_63(Hash hParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x1D9C
{
	var unk;
	var unk5;
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1ED0
{
...
BOOL func_65(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1EFA
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_66() // Position - 0x1FF9
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_67(var uParam0, int iParam1) // Position - 0x200E
{
	*uParam0 = iParam1;
	return;
}

void func_68(int iParam0) // Position - 0x201B
{
	if (iParam0 <= 0)
		return;
...
void func_69(var uParam0) // Position - 0x2042
{
	func_110(uParam0, 0f);
	return;
}

float func_70(var uParam0) // Position - 0x2051
{
	if (!func_111(uParam0))
		return uParam0->f_1;
...
BOOL func_71(Entity eParam0) // Position - 0x2086
{
	int num;
	var InputString;
	Hash entityModel;
...
var func_72(BOOL bParam0, int iParam1) // Position - 0x2120
{
	return func_73(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), bParam0, iParam1);
}

var func_73(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x213E
{
	var value;
	Player bitIndex;
	int i;
...
void func_75(Any* panParam0, int* piParam1) // Position - 0x256B
{
...
BOOL func_76(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x259C
{
	var ReturnZ;
	int num;
	BOOL flag;
...
int func_77(var uParam0, var uParam1, Volume volParam2, int iParam3) // Position - 0x26A0
{
	ItemSet itemSet;
...
void func_78(Volume volParam0) // Position - 0x275B
{
...
void func_79(var uParam0, var uParam1, int iParam2) // Position - 0x2772
{
	var value;
	int num;
	int num2;
...
void func_80(var uParam0) // Position - 0x2837
{
...
void func_81(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x286F
{
	int i;
	var unk;
...
Hash func_82(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x2925
{
...
BOOL func_83(Hash hParam0) // Position - 0x2967
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

void func_84(int iParam0, var uParam1, var uParam2) // Position - 0x2975
{
	int num;
...
BOOL func_85(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x2991
{
...
void func_86(int iParam0, int iParam1) // Position - 0x2A33
{
	int Variable;
...
struct<4> func_87(BOOL bParam0) // Position - 0x2A57
{
	int num;
...
int func_88(Hash hParam0) // Position - 0x2AF7
{
	var unk;
...
struct<4> func_89(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x2B22
{
	var outGuid;
...
struct<4> func_90(BOOL bParam0) // Position - 0x2B53
{
	int num;
...
BOOL func_91(Hash hParam0, BOOL bParam1) // Position - 0x2BF4
{
...
BOOL func_92(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2C2B
{
	return func_105(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_93(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x2C46
{
	var unk;
...
struct<4> func_94(BOOL bParam0) // Position - 0x2C67
{
	int num;
...
int func_95(Hash hParam0) // Position - 0x2CD1
{
	var unk;
...
BOOL func_96(Hash hParam0, int iParam1) // Position - 0x2CFC
{
	Hash hash;
	int num;
	int i;
...
BOOL func_97(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x2D69
{
	return func_137(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_98(var uParam0) // Position - 0x2D7F
{
...
BOOL func_99(Hash hParam0, int iParam1) // Position - 0x2E09
{
	if (hParam0 == 0)
		return false;
...
Hash func_100(Hash hParam0) // Position - 0x2E23
{
	return hParam0;
}

BOOL func_101(Hash hParam0, int iParam1) // Position - 0x2E2D
{
	if (hParam0 == 0)
		return false;
...
int func_102(Hash hParam0, int iParam1) // Position - 0x2E47
{
	if (iParam1 == 0)
		return 0;
...
BOOL func_103(Hash hParam0) // Position - 0x2E73
{
	return func_88(hParam0) == joaat("WEAPON");
}

int func_104(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2E87
{
	if (!func_99(hParam0, 0))
	{
		if (func_101(func_100(hParam0), 2))
...
int func_105(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2EFB
{
...
int func_106(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2F7A
{
...
BOOL func_107(BOOL bParam0) // Position - 0x303C
{
	if (bParam0)
...
BOOL func_108() // Position - 0x306C
{
	return func_142() != -1;
}

BOOL func_109() // Position - 0x307A
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_110(var uParam0, float fParam1) // Position - 0x309F
{
...
BOOL func_111(var uParam0) // Position - 0x30C5
{
	return func_145(*uParam0, 1);
}

BOOL func_112(var uParam0) // Position - 0x30D5
{
	return func_145(*uParam0, 2);
}

float func_113() // Position - 0x30E5
{
...
int func_114() // Position - 0x3117
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

int func_115() // Position - 0x312C
{
	return Global_1051645.f_12;
}

char* func_116() // Position - 0x313A
{
	return "unnamed";
}

BOOL func_117(int iParam0) // Position - 0x3145
{
	int num;
...
BOOL func_118(int iParam0) // Position - 0x31D4
{
...
int func_119(int iParam0) // Position - 0x31F2
{
	if (iParam0 == 255)
...
BOOL func_120(Player plParam0) // Position - 0x323D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
int func_121(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x3282
{
	if (!func_149(uParam0))
		return 0;
...
BOOL func_122(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x32B2
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

var func_123(int iParam0) // Position - 0x32DB
{
	var memberHandles;
	var value;
	int gangMembers;
...
int func_124() // Position - 0x3334
{
	return Global_1953292.f_1;
}

BOOL func_125(Any anParam0) // Position - 0x3342
{
...
BOOL func_126(int iParam0, int iParam1) // Position - 0x3388
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_127(int iParam0) // Position - 0x33A0
{
...
BOOL func_128(int iParam0) // Position - 0x33B7
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_129(int iParam0, int iParam1) // Position - 0x3483
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_130(int iParam0) // Position - 0x349C
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_131() // Position - 0x34AF
{
	if (!func_150())
		return false;
...
int func_132(BOOL bParam0) // Position - 0x34CA
{
	if (func_1() == -1)
	{
...
struct<4> func_133() // Position - 0x350B
{
	var unk;
...
BOOL func_135(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x3534
{
	int inventoryId;
...
BOOL func_136(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x3579
{
...
BOOL func_137(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x35AC
{
...
BOOL func_138(Hash hParam0) // Position - 0x35E6
{
	return func_152(hParam0, 1279601681);
}

Hash func_139(Hash hParam0, int iParam1) // Position - 0x35F9
{
	int num;
	var unk;
	Hash hash;
...
int func_140(Hash hParam0, BOOL bParam1) // Position - 0x3673
{
	var unk;
	int num;
	int num2;
...
struct<4> func_141(Hash hParam0, BOOL bParam1) // Position - 0x36D2
{
	var unk;
...
int func_142() // Position - 0x36F7
{
	return Global_1149172.f_137;
}

void func_143(var uParam0, int iParam1) // Position - 0x3705
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_144(var uParam0, int iParam1) // Position - 0x3716
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_145(int iParam0, int iParam1) // Position - 0x372B
{
	return iParam0 && iParam1 != false;
}

BOOL func_146(int iParam0, int iParam1) // Position - 0x373A
{
	int num;
...
BOOL func_147(Player plParam0) // Position - 0x37AE
{
...
void func_148(Player plParam0) // Position - 0x37CB
{
	Player player;
...
BOOL func_149(var uParam0) // Position - 0x384E
{
	if (*uParam0 >= 40)
		return false;
...
int func_151(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3877
{
...
BOOL func_152(Hash hParam0, Hash hParam1) // Position - 0x38AA
{
	if (!func_99(hParam0, 0))
...
void func_153(Hash hParam0, var uParam1, var uParam2) // Position - 0x38EB
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_154(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3AF7
{
	Hash hash;
...
void func_155(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x3BD5
{
...
BOOL func_156(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x3BF0
{
...
int func_157(int iParam0) // Position - 0x3C15
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_158(Any* panParam0, int iParam1, int iParam2) // Position - 0x3C36
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_159() // Position - 0x3C6D
{
	return Global_1102813.f_3672;
}

void func_160(Player plParam0) // Position - 0x3C7C
{
	Player player;
...
void func_161(Player plParam0) // Position - 0x3CE8
{
...
BOOL func_162(Hash hParam0) // Position - 0x3D23
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_163(Hash hParam0, Hash hParam1) // Position - 0x3D31
{
