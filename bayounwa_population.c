...
void func_3() // Position - 0x830
{
	return;
}

int func_4() // Position - 0x838
{
	return Global_1572887.f_14;
}

BOOL func_5(BOOL bParam0, BOOL bParam1) // Position - 0x846
{
	int i;
...
void func_6() // Position - 0x926
{
	return;
}

void func_7(Volume volParam0) // Position - 0x92E
{
...
void func_8(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x96F
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_9(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x9EE
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xA61
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0) // Position - 0xAD7
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12(var uParam0, int iParam1) // Position - 0xB18
{
