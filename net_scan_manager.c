...
void func_4() // Position - 0x88
{
	func_15();
	return;
}

void func_5() // Position - 0x94
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_6(int iParam0, int iParam1) // Position - 0xA0
{
...
void func_10(BOOL bParam0) // Position - 0x22C
{
	int num;
	var unk;
	int num2;
...
BOOL func_11(BOOL bParam0, BOOL bParam1) // Position - 0x2F3
{
	int i;
...
int func_16() // Position - 0x4D5
{
	return Global_1572887.f_14;
}

BOOL func_17() // Position - 0x4E3
{
	return Global_1051645.f_8;
}

void func_18() // Position - 0x4F1
{
...
void func_20(int iParam0) // Position - 0x9BA
{
	var unk;
	var unk4;
	var unk5;
...
void func_21(int iParam0) // Position - 0xB61
{
	int num;
	BOOL flag;
	int num2;
		...
		case 0:
			if (!func_42(iParam0, 2, -1) && !func_42(iParam0, 4, -1))
			{
				...
				else
				{
					...
					if (!MISC::GET_GROUND_Z_FOR_3D_COORD(Global_1265286[iParam0 /*10*/].f_3, &ReturnZ, false))
					{
						func_44(iParam0, 2);
						return;
					}
					...
					Global_1265286[iParam0 /*10*/].f_3.f_2 = ReturnZ;
...
int func_23(int iParam0, int iParam1, char* sParam2) // Position - 0xED6
{
	return 1;
}

int func_24(int iParam0, int iParam1, char* sParam2) // Position - 0xEDF
{
	return 1;
}

void func_25(int iParam0) // Position - 0xEE8
{
...
int func_26(int iParam0) // Position - 0xF7A
{
	return Global_1264306[iParam0 /*29*/].f_1.f_2;
}

BOOL func_27(int iParam0, int iParam1, int iParam2) // Position - 0xF8E
{
	int i;
...
void func_28(int iParam0, int iParam1) // Position - 0xFDC
{
	func_51(&(Global_1264306[iParam0 /*29*/].f_27));
...
void func_29(int iParam0, int iParam1) // Position - 0x1001
{
...
BOOL func_30(int iParam0, int iParam1, int iParam2) // Position - 0x104C
{
	int i;
...
Vector3 func_31(int iParam0) // Position - 0x1098
{
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x10F8
{
...
void func_33(int iParam0, int iParam1) // Position - 0x1122
{
...
BOOL func_34(Vector3 vParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1141
{
	*uParam3 = 0;
...
Vector3 func_35(int iParam0) // Position - 0x117A
{
...
BOOL func_36(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x1328
{
	Vector3 vector;
	var ReturnZ;
	var unk3;
	...
	for (i = 1; i <= 5; i = i + 1)
	{
		...
		if (MISC::GET_GROUND_Z_FOR_3D_COORD(vector, &ReturnZ, false))
			if (MISC::ABSF(vector.f_2 - ReturnZ) > 30f)
				return true;
	}
...
Vector3 func_37(float fParam0, var uParam1, var uParam2) // Position - 0x13BD
{
	float num;
	float num2;
...
void func_38(int iParam0, int iParam1) // Position - 0x13FC
{
...
void func_39(int iParam0) // Position - 0x141F
{
	func_51(&(Global_1264306[iParam0 /*29*/].f_27));
	func_33(iParam0, 3);
	return;
...
int func_40(int iParam0, int iParam1) // Position - 0x143C
{
	if (iParam1 == -1)
...
void func_41(int iParam0) // Position - 0x145E
{
	var SourceStruct;
	...
	if (func_42(iParam0, 1, -1))
	{
		...
		MISC::COPY_SCRIPT_STRUCT(&Global_1265286[iParam0 /*10*/], &SourceStruct, 9);
		func_58(iParam0, 1);
	}
...
BOOL func_42(int iParam0, int iParam1, int iParam2) // Position - 0x1518
{
	if (iParam2 == -1)
...
BOOL func_43(var uParam0, var uParam1, var uParam2) // Position - 0x153E
{
	BOOL num;
	Any any;
...
void func_44(int iParam0, int iParam1) // Position - 0x1564
{
...
BOOL func_45(var uParam0, var uParam1, var uParam2, Any* panParam3, var uParam4, int iParam5, BOOL bParam6, Any anParam7, int iParam8, int iParam9, int iParam10, float fParam11) // Position - 0x158D
{
	int num;
...
BOOL func_46(int iParam0, int iParam1) // Position - 0x16B2
{
	return func_65(Global_1264306[iParam0 /*29*/].f_12.f_9, iParam1);
}

BOOL func_47() // Position - 0x16CC
{
	return Global_1265286.f_75.f_1 != -1;
}

BOOL func_48(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10) // Position - 0x16DE
{
	int i;
...
void func_49() // Position - 0x1710
{
	...
	SourceStruct.f_1 = -1;
	SourceStruct.f_2 = -1;
	MISC::COPY_SCRIPT_STRUCT(&(Global_1265286.f_75), &SourceStruct, 11);
	func_67(&(Global_1265286.f_86));
	return;
}

BOOL func_50(int iParam0) // Position - 0x1743
{
	return iParam0 != 0;
}

void func_51(int iParam0) // Position - 0x174F
{
	*iParam0 = Global_1295666.f_16;
	return;
}

int func_52(int iParam0) // Position - 0x1760
{
	return (Global_1295666.f_16 - iParam0) * 1000;
}

void func_53(int iParam0) // Position - 0x1774
{
	var SourceStruct;

	SourceStruct = -1;
	SourceStruct.f_1 = -1;
	SourceStruct.f_1.f_1 = -1;
	SourceStruct.f_1.f_2 = -1;
	SourceStruct.f_12 = -1;
	SourceStruct.f_22.f_3 = -1;
	MISC::COPY_SCRIPT_STRUCT(&Global_1264306[iParam0 /*29*/], &SourceStruct, 29);
	func_67(&(Global_1264306[iParam0 /*29*/].f_27));
	return;
}

void func_54(int iParam0, int iParam1) // Position - 0x17C7
{
...
void func_55(int iParam0) // Position - 0x17EA
{
...
BOOL func_56(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1875
{
	int i;
...
void func_57(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0x18AB
{
	panParam0->f_2 = 0;
...
void func_58(int iParam0, int iParam1) // Position - 0x18E6
{
	if (func_42(iParam0, iParam1, -1))
...
int func_59(int iParam0) // Position - 0x190E
{
	int num;
...
void func_60(int iParam0, int iParam1) // Position - 0x1928
{
...
BOOL func_61(int iParam0, int iParam1) // Position - 0x1957
{
	return iParam0 && iParam1 != false;
}

void func_62(int iParam0, int iParam1) // Position - 0x1966
{
	func_73(iParam0, iParam1);
	return;
}

void func_63(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, Any anParam6, int iParam7, int iParam8, int iParam9, float fParam10) // Position - 0x1976
{
	int num;
	int num2;
...
void func_64(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x2784
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_65(BOOL bParam0, BOOL bParam1) // Position - 0x2F44
{
	return bParam0 && bParam1 != false;
}

BOOL func_66(var uParam0, var uParam1) // Position - 0x2F53
{
...
void func_67(int iParam0) // Position - 0x2F8C
{
	*iParam0 = 0;
	return;
}

int func_68(int iParam0) // Position - 0x2F98
{
	return Global_1264306[iParam0 /*29*/].f_22.f_3;
}

void func_69(int iParam0, int iParam1) // Position - 0x2FAC
{
...
void func_70(int iParam0, int iParam1) // Position - 0x2FD3
{
...
void func_71(int iParam0) // Position - 0x2FF8
{
	var unk;
	var unk4;
	var unk7;
...
void func_72(int iParam0, int iParam1) // Position - 0x30F4
{
	func_84(iParam0, iParam1);
	return;
}

void func_73(int iParam0, int iParam1) // Position - 0x3104
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

float func_74(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x3115
{
	float num;
...
int func_75(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x313A
{
	int num;
...
int func_76(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3188
{
	return func_88(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

void func_77(BOOL bParam0, int iParam1) // Position - 0x319E
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_78(Vector3 vParam0, var uParam1, var uParam2, var uParam3) // Position - 0x31B3
{
	*uParam3 = 8;
...
Vector3 func_79(int iParam0) // Position - 0x31EE
{
	int randomIntInRange;
...
BOOL func_80(Vector3 vParam0, var uParam1, var uParam2, var uParam3) // Position - 0x32F2
{
	*uParam3 = 17;
...
Vector3 func_81(int iParam0) // Position - 0x332D
{
	int randomIntInRange;
...
BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x353D
{
	float num;
	float num2;
	float num3;
...
Vector3 func_83(int iParam0) // Position - 0x35B4
{
	switch (iParam0)
	{
		case 0:
...
void func_84(int iParam0, int iParam1) // Position - 0x36CB
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

int func_85() // Position - 0x36E0
{
	return Global_1893611.f_2;
}

BOOL func_86(int iParam0) // Position - 0x36EE
{
	return iParam0 >= 0 && iParam0 <= 150;
}

int func_87(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x3704
{
	int num;
	int num2;
	int num3;
...
int func_88(Hash hParam0) // Position - 0x37BB
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
int func_89(var uParam0, var uParam1, var uParam2) // Position - 0x3875
{
	int num;
...
int func_90(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x38B0
{
	if (fParam0 < fParam3)
