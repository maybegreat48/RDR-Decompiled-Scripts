...
void func_1(BOOL bParam0) // Position - 0x6F
{
	int i;
...
BOOL func_2(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x17B
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_4() // Position - 0x300
{
	return func_19(1, 255);
}

BOOL func_5() // Position - 0x30F
{
				...
				for (i = 0; i < iLocal_45; i = i + 1)
				{
					...
					if (func_7(iLocal_45[i], 0))
					{
						if (func_24(&uLocal_42) < fLocal_30 || flag)
						{
							...
							{
								vOffsetY = 25f;
								offsetFromCoordAndHeadingInWorldCoords = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Global_34, MISC::GET_RANDOM_FLOAT_IN_RANGE(-80f, 80f), 0f, vOffsetY, 0f) };
								vector = { func_35(offsetFromCoordAndHeadingInWorldCoords, vOffsetY - 10f, 10f) };
							}
							...
							TASK::TASK_PERFORM_SEQUENCE(iLocal_45[i], Sequence);
						}
...
BOOL func_7(Ped pedParam0, int iParam1) // Position - 0x779
{
	int num;
...
void func_8(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x878
{
...
float func_9(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8E6
{
...
void func_10(Ped* ppedParam0) // Position - 0x92E
{
	if (!ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		return;
...
BOOL func_11(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x98D
{
...
int func_12() // Position - 0xA2B
{
	return Global_1939102.f_4;
}

BOOL func_13(int iParam0, BOOL bParam1) // Position - 0xA39
{
	if (!func_39(iParam0))
		return false;
...
int func_14() // Position - 0xA75
{
	return Global_1896646.f_41;
}

BOOL func_15(int iParam0, BOOL bParam1) // Position - 0xA83
{
	if (!func_41(iParam0))
		return false;
...
BOOL func_19(int iParam0, int iParam1) // Position - 0xB64
{
	int num;
...
BOOL func_20(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0xBD8
{
...
void func_21(var uParam0) // Position - 0xC0E
{
	func_49(uParam0, 0f);
	return;
}

BOOL func_22(int iParam0) // Position - 0xC1D
{
	int num;
	int num2;
	int offset;
...
void func_23(int iParam0, BOOL bParam1) // Position - 0xC47
{
	int num;
	int num2;
...
float func_24(var uParam0) // Position - 0xC74
{
	if (!func_53(uParam0))
		return 0f;
...
BOOL func_26(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, float fParam7, int iParam8, float fParam9, float fParam10, int iParam11) // Position - 0xCC7
{
	int num;
...
BOOL func_27(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDEC
{
	var unk;
	var unk6;
...
BOOL func_28(Volume volParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xE39
{
...
int func_29(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xE59
{
	return func_59(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

void func_30(var uParam0, int iParam1, BOOL bParam2) // Position - 0xE6F
{
	uParam0->f_2 = 0;
...
void func_32(int iParam0) // Position - 0xEEB
{
	if (!CAM::IS_SPHERE_VISIBLE(uLocal_26, 5f))
	{
...
void func_33(int iParam0) // Position - 0xF38
{
...
int func_34(Ped pedParam0, Ped pedParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0xFC4
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return 0;
...
Vector3 func_35(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x1009
{
	var unk;
	float MaxFloat;
...
int func_36(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1051
{
	var ReturnZ;
	int num;
	BOOL flag;
...
void func_37(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1155
{
...
BOOL func_38(int iParam0, int iParam1) // Position - 0x11C0
{
	return iParam0 && iParam1 != false;
}

BOOL func_39(int iParam0) // Position - 0x11CF
{
	return iParam0 > -1 && iParam0 < 6;
}

BOOL func_40(int iParam0, int iParam1) // Position - 0x11E4
{
	if (!func_39(iParam0))
		return false;
...
BOOL func_41(int iParam0) // Position - 0x1229
{
	return iParam0 > -1 && iParam0 < 17;
}

BOOL func_42(int iParam0, BOOL bParam1) // Position - 0x123F
{
	if (!func_41(iParam0))
		return false;
...
BOOL func_43(int iParam0) // Position - 0x1281
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_44(int iParam0, BOOL bParam1) // Position - 0x1297
{
	if (Global_1572887.f_14 == -1)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x12C8
{
...
BOOL func_46(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x12F2
{
...
BOOL func_47(Any* panParam0, int iParam1, int iParam2) // Position - 0x134D
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_48() // Position - 0x1384
{
	return Global_1102813.f_3672;
}

void func_49(var uParam0, float fParam1) // Position - 0x1393
{
...
void func_50(int iParam0, var uParam1, var uParam2) // Position - 0x13B9
{
	int num;
...
BOOL func_51(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x13D5
{
	if (iParam1 < 0 || iParam1 > 32)
		return false;
...
void func_52(int iParam0, int iParam1) // Position - 0x1477
{
	int Variable;
...
BOOL func_53(var uParam0) // Position - 0x149B
{
	return func_72(*uParam0, 1);
}

BOOL func_54(var uParam0) // Position - 0x14AB
{
	return func_72(*uParam0, 2);
}

float func_55() // Position - 0x14BB
{
...
void func_56(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6, int iParam7, float fParam8, float fParam9, int iParam10) // Position - 0x14ED
{
	int num;
	int num2;
...
void func_57(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x22FB
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_58(float fParam0, var uParam1, var uParam2) // Position - 0x2ABB
{
	float num;
	float num2;
...
int func_59(Hash hParam0) // Position - 0x2AFA
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
Ped func_60(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x2BB4
{
	Ped EntityIndex;
	...
	func_75(EntityIndex, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return EntityIndex;
}

Vector3 func_61(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2BF4
{
	float num;
...
BOOL func_62(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x2C2B
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

float func_63(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x2C54
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_64(var uParam0, int iParam1) // Position - 0x2C72
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_65(var uParam0, int iParam1) // Position - 0x2C83
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_66(int iParam0, int iParam1) // Position - 0x2C98
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_67(int iParam0) // Position - 0x2CB0
{
...
BOOL func_68(int iParam0) // Position - 0x2CC7
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_69(int iParam0, int iParam1) // Position - 0x2D93
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_70(int iParam0) // Position - 0x2DAC
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_71() // Position - 0x2DBF
{
	if (!func_76())
		return false;
...
BOOL func_72(int iParam0, int iParam1) // Position - 0x2DDA
{
	return iParam0 && iParam1 != false;
}

float func_73(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x2DE9
{
	float num;
...
int func_74(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2E0E
{
	int num;
...
void func_75(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2E5C
{
	BOOL flag;
...
int func_77(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2F3A
{
	int num;
	int num2;
	int num3;
...
void func_78(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2FF1
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_79(Ped pedParam0, BOOL bParam1) // Position - 0x3036
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_80(Ped pedParam0, int iParam1) // Position - 0x307B
{
	if (iParam1 == 1)
...
int func_81(var uParam0, var uParam1, var uParam2) // Position - 0x30A2
{
	int num;
...
int func_82(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x30DD
{
	if (fParam0 < fParam3)
