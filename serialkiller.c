...
void func_22(int iParam0) // Position - 0x87C
{
	return;
}
...
Hash func_94(int iParam0) // Position - 0x388D
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
BOOL func_150(int iParam0, BOOL bParam1) // Position - 0x5058
{
...
void func_163(BOOL bParam0, int iParam1) // Position - 0x525A
{
