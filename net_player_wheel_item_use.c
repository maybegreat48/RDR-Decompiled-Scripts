...
BOOL func_1(var uParam0, var uParam1, var uParam2) // Position - 0x8F
{
...
BOOL func_2(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xB0
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_3(BOOL bParam0, BOOL bParam1) // Position - 0x115
{
	int i;
...
BOOL func_4(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1F5
{
...
BOOL func_5(var uParam0, var uParam1) // Position - 0x22B
{
	switch (*uParam0)
	{
		case 0:
...
int func_6(var uParam0, var uParam1) // Position - 0x24C
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_7(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x26D
{
	if (*uParam3)
	{
	}
...
BOOL func_8(var uParam0) // Position - 0x28A
{
...
int func_9(var uParam0) // Position - 0x2D2
{
	if (*uParam0)
	{
	}
...
void func_10(Hash hParam0, var uParam1, var uParam2) // Position - 0x2E4
{
	int playbackMode;
