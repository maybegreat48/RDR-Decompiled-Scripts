...
void func_1(var uParam0, var uParam1) // Position - 0x2BD
{
	if (func_11())
	{
	}
...
int func_3() // Position - 0x406
{
	return Global_1572887.f_14;
}

int func_4(Hash hParam0, int iParam1) // Position - 0x414
{
	var unk;
	int num;
	int i;
...
BOOL func_5(Hash hParam0, Hash hParam1) // Position - 0x45E
{
...
BOOL func_6(Hash hParam0) // Position - 0x49F
{
...
BOOL func_7(var uParam0, var uParam1) // Position - 0x4CC
{
...
int func_8(var uParam0, var uParam1) // Position - 0x528
{
	if (*uParam0 > 0)
...
int func_9(var uParam0, var uParam1) // Position - 0x725
{
	if (*uParam0 > 0)
		func_28(uParam0, uParam1);
...
int func_10(var uParam0, var uParam1) // Position - 0x91E
{
...
BOOL func_12() // Position - 0xA21
{
	return Global_1940252.f_2 || Global_1940252 == 1;
}

void func_13(var uParam0, var uParam1) // Position - 0xA3B
{
	return;
}

int func_14(int iParam0) // Position - 0xA43
{
	if (iParam0 < 0)
		return 0;
...
void func_15(var uParam0, var uParam1) // Position - 0xA64
{
	Hash hash;
...
void func_16(var uParam0) // Position - 0xAC0
{
...
void func_17(var uParam0) // Position - 0xAF3
{
	int i;
...
void func_18(var uParam0, var uParam1) // Position - 0xB87
{
	if (uParam1->[0 /*11*/] != 0)
	{
...
void func_19(int iParam0) // Position - 0xC05
{
...
void func_20(var uParam0) // Position - 0xC2C
{
...
void func_21(var uParam0, var uParam1) // Position - 0xCB9
{
	if (uParam0->f_115)
		func_13(uParam0, uParam1);
...
BOOL func_22(Hash hParam0, int iParam1) // Position - 0xD33
{
	if (hParam0 == 0)
		return false;
...
Hash func_23(Hash hParam0) // Position - 0xD4D
{
	return hParam0;
}

int func_24(Hash hParam0, Hash hParam1) // Position - 0xD57
{
...
BOOL func_25(BOOL bParam0, BOOL bParam1) // Position - 0xD8D
{
	int i;
...
BOOL func_26(var uParam0, var uParam1) // Position - 0xE6D
{
...
BOOL func_27(Hash hParam0) // Position - 0xED4
{
	switch (hParam0)
	{
		case -904734609:
...
void func_28(var uParam0, var uParam1) // Position - 0xF04
{
	if (!uParam0->f_122)
	{
		if (func_33(uParam1->[0 /*11*/], uParam0->f_104))
...
void func_29(var uParam0, var uParam1) // Position - 0xF33
{
	var unk;
...
void func_30(var uParam0, var uParam1) // Position - 0xF8C
{
	return;
}

void func_31(var uParam0, Hash hParam1) // Position - 0xF94
{
...
void func_32(var uParam0, int iParam1) // Position - 0x1021
{
	*uParam0 = iParam1;
	return;
}

BOOL func_33(Hash hParam0, int iParam1) // Position - 0x102E
{
...
void func_34(Hash hParam0) // Position - 0x123D
{
	func_71(hParam0);
...
int func_35(var uParam0, var uParam1, BOOL bParam2) // Position - 0x125E
{
...
void func_36(var uParam0, var uParam1) // Position - 0x13C8
{
	int i;
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x14C2
{
...
void func_38(var uParam0, var uParam1) // Position - 0x14F2
{
	return;
}

BOOL func_39(Hash hParam0, int iParam1) // Position - 0x14FA
{
	switch (func_4(hParam0, -949239683))
	{
		case -1565009253:
...
BOOL func_40(int iParam0, BOOL bParam1) // Position - 0x173F
{
	int num;
...
void func_41(var uParam0, Hash hParam1) // Position - 0x1772
{
...
BOOL func_42(Hash hParam0, int iParam1) // Position - 0x17E5
{
	int num;
...
int func_43(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, Hash hParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x1868
{
	int value;
	Hash TypeOfWeapon;
	Hash lootTableKey;
	...
	if (!flag)
	{
		if (func_5(hParam0, -1588156645))
		{
			bParam2 = true;
			flag2 = true;
			TypeOfWeapon = func_96(func_95(hParam0, true), false);
		
			if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
			{
				if (func_3() == -1)
					func_97(TypeOfWeapon);
			
				if (func_98(false) && func_99(TypeOfWeapon, 0, false, true, 0, false, hParam5, false))
				{
...
Hash func_44(var uParam0) // Position - 0x231C
{
	Hash _int;
...
void func_45(var uParam0, Any anParam1) // Position - 0x2371
{
	int i;
...
void func_46(var uParam0, var uParam1) // Position - 0x23DE
{
...
int func_47(var uParam0, int iParam1) // Position - 0x2446
{
	Hash txdHash;
...
BOOL func_48(var uParam0, var uParam1) // Position - 0x24E3
{
...
int func_49(var uParam0, var uParam1) // Position - 0x2507
{
	return 1;
}

BOOL func_50(int iParam0) // Position - 0x2510
{
	if (iParam0 < 0)
		return false;
...
BOOL func_51(int iParam0, BOOL bParam1) // Position - 0x254F
{
	int num;
	int gameTimer;
	float progress;
...
void func_52(BOOL bParam0, int iParam1) // Position - 0x2649
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
BOOL func_53(var uParam0) // Position - 0x266B
{
	BOOL num;
...
Hash func_54(Hash hParam0) // Position - 0x26D8
{
	switch (func_4(hParam0, -949239683))
	{
		case -1565009253:
...
BOOL func_56(int iParam0) // Position - 0x2805
{
	return iParam0 == -492264119 || iParam0 == 1397875340;
}

void func_57(Hash hParam0, Hash hParam1) // Position - 0x2823
{
	int num;
	var unk;
	var unk11;
...
void func_58(int iParam0) // Position - 0x2874
{
	switch (iParam0)
	{
		case -492264119:
...
int func_59(int iParam0) // Position - 0x28C8
{
	switch (iParam0)
	{
		case -31140163:
...
void func_60(var uParam0) // Position - 0x28E6
{
	uParam0->[0 /*11*/] = 0;
	uParam0->[0 /*11*/].f_1 = 0;
	uParam0->[0 /*11*/].f_3 = 0;
...
void func_61(var uParam0) // Position - 0x2940
{
...
void func_62(var uParam0) // Position - 0x29C8
{
...
void func_63(var uParam0) // Position - 0x2A50
{
	uParam0->[2 /*11*/] = 0;
	uParam0->[2 /*11*/].f_1 = 0;
	uParam0->[2 /*11*/].f_3 = 0;
...
int func_64(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3, float fParam4) // Position - 0x2AF0
{
...
BOOL func_65(Hash hParam0, int iParam1) // Position - 0x2E43
{
	if (hParam0 == 0)
		return false;
...
void func_70(var uParam0) // Position - 0x2ED1
{
	if (uParam0->f_105 > 0)
...
void func_71(Hash hParam0) // Position - 0x2EF0
{
...
void func_72(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x2F11
{
	int num;
	var unk;
...
void func_73(Hash hParam0) // Position - 0x2FFA
{
	int num;
	Vector3 vector;
	float radius;
...
void func_74(int iParam0, BOOL bParam1) // Position - 0x304C
{
	if (func_50(*iParam0))
...
BOOL func_75(var uParam0, var uParam1) // Position - 0x3069
{
	BOOL flag;
...
BOOL func_76(Hash hParam0, int iParam1) // Position - 0x30AC
{
	switch (func_4(hParam0, -949239683))
	{
		case -1565009253:
...
BOOL func_77(int iParam0, BOOL bParam1) // Position - 0x3208
{
	if (bParam1 && !func_50(iParam0))
		return false;
...
void func_78(int iParam0, BOOL bParam1) // Position - 0x322D
{
	if (func_50(*iParam0))
...
void func_79(var uParam0, var uParam1) // Position - 0x324A
{
	func_78(&Global_17402[3], func_75(uParam0, uParam1));
	return;
}

BOOL func_80(Hash hParam0, int iParam1) // Position - 0x3264
{
	switch (func_4(hParam0, -949239683))
	{
		case -1565009253:
...
void func_81(var uParam0) // Position - 0x33C0
{
	return;
}

int func_82(int iParam0) // Position - 0x33C8
{
	return iParam0;
}

void func_83(var uParam0, Hash hParam1) // Position - 0x33D2
{
	Hash entryId;
...
int func_84(Hash hParam0) // Position - 0x34C3
{
	var unk;
...
BOOL func_85(Hash hParam0, int iParam1) // Position - 0x34EE
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_86(Hash hParam0) // Position - 0x3596
{
	int num;
	int num2;
	int num3;
...
int func_87(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3652
{
...
BOOL func_88(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x3714
{
	if (func_3() == -1)
	{
...
BOOL func_89(Hash hParam0, var uParam1, int iParam2) // Position - 0x376B
{
	var unk;
	int num;
	int num2;
...
void func_90(Hash hParam0, BOOL bParam1) // Position - 0x3809
{
	if (bParam1)
		return;
...
BOOL func_91(Hash hParam0, int iParam1) // Position - 0x38BA
{
	if (!func_22(hParam0, 0))
		return false;
...
BOOL func_92(int iParam0) // Position - 0x38D9
{
	if (!func_186(iParam0))
		return false;
...
void func_93(int iParam0) // Position - 0x38F5
{
	if (!func_186(iParam0))
		return;
...
void func_94(Hash hParam0) // Position - 0x3916
{
...
Hash func_95(Hash hParam0, BOOL bParam1) // Position - 0x399B
{
	Hash hash;
...
Hash func_96(Hash hParam0, BOOL bParam1) // Position - 0x3B91
{
	if (!func_22(hParam0, 0))
		return 0;
...
void func_97(Hash hParam0) // Position - 0x3BBD
{
	Hash weaponUnlock;
...
BOOL func_98(BOOL bParam0) // Position - 0x3BF7
{
	if (func_3() == -1)
		return true;
...
BOOL func_99(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, Hash hParam6, BOOL bParam7) // Position - 0x3C15
{
	var unk;
	var unk6;
	var unk28;
...
BOOL func_100(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x3D45
{
	if (iParam1 < 1)
		return true;
...
BOOL func_101(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x3D80
{
	int num;
	var unk;
	var unk6;
...
BOOL func_102(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3DEF
{
	Hash TypeOfWeapon;
	var unk;
	int num;
	...
	TypeOfWeapon = func_96(hParam0, false);
	...
	if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
	{
		if (func_3() == -1)
		{
			...
			if (hParam1 == 1248274121)
				func_200(TypeOfWeapon);
		}
	
		if (!func_184(hParam0, &unk, 1, false, false, -1, false))
		{
			func_179(hParam0, 1, false, uParam2, hParam1);
			num = func_201(TypeOfWeapon);
		
			if (WEAPON::_IS_WEAPON_SNIPER(TypeOfWeapon))
			{
				func_99(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (TypeOfWeapon == joaat("weapon_fishingrod") || WEAPON::_IS_WEAPON_BINOCULARS(TypeOfWeapon))
			{
				func_99(TypeOfWeapon, 0, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::_IS_WEAPON_LASSO(TypeOfWeapon))
			{
				func_99(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::IS_WEAPON_MELEE_WEAPON(TypeOfWeapon))
			{
				if (TypeOfWeapon == joaat("weapon_melee_knife_john") && !func_202())
					return false;
			
				if (WEAPON::SHOULD_WEAPON_BE_DISCARDED_WHEN_SWAPPED(hParam0))
				{
				}
				else if (!func_203(TypeOfWeapon))
				{
					func_99(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
				}
				else
				{
					func_99(TypeOfWeapon, WEAPON::GET_WEAPON_CLIP_SIZE(TypeOfWeapon) * 4, bParam3, bParam4, 0, false, hParam1, false);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(TypeOfWeapon))
			{
				weaponHash = func_204(Global_33, 2, false, true);
			
				if (func_168(weaponHash) && !Global_26688 && weaponHash != TypeOfWeapon && !func_42(joaat("upgrade_offhand_holster"), 1) && bParam4)
					WEAPON::_SEND_WEAPON_TO_INVENTORY(Global_33, weaponHash);
			
				if (func_168(weaponHash) && func_42(joaat("upgrade_offhand_holster"), 1))
					if (!func_99(TypeOfWeapon, num, bParam3, bParam4, 3, true, hParam1, false))
						return false;
				else if (!func_99(TypeOfWeapon, num, bParam3, bParam4, 0, true, hParam1, false))
					return false;
			}
			else if (!func_99(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false))
			{
				return false;
			}
		}
...
BOOL func_103(Hash hParam0) // Position - 0x3FFD
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_104(Hash hParam0, var uParam1, Hash hParam2) // Position - 0x400E
{
	int num;
	int weaponClipSize;
	int ReturnMaxAmmo;
...
struct<2> func_105(int iParam0) // Position - 0x410C
{
	var unk;
...
void func_106(var uParam0, var uParam1, int iParam2) // Position - 0x411E
{
...
struct<2> func_107(int iParam0, int iParam1) // Position - 0x413B
{
	int num;
...
void func_108(int iParam0, BOOL bParam1) // Position - 0x4151
{
	int num;
	int num2;
...
BOOL func_109() // Position - 0x417E
{
	return false;
}

int func_110(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, int iParam5, BOOL bParam6, int iParam7) // Position - 0x4187
{
	int num;
...
void func_111(Hash hParam0) // Position - 0x41CE
{
	return;
}

void func_112(Hash hParam0) // Position - 0x41D6
{
	return;
}

void func_113(Hash hParam0) // Position - 0x41DE
{
	return;
}

void func_114(Hash hParam0) // Position - 0x41E6
{
	return;
}

void func_115() // Position - 0x41EE
{
...
void func_116(Hash hParam0, var uParam1) // Position - 0x4212
{
	var unk;
...
Hash func_117(Hash hParam0, BOOL bParam1) // Position - 0x4224
{
	Hash hash;
...
void func_118(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x4252
{
	int num;
	int num2;
...
void func_119(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x42B2
{
	int num;
	int num2;
...
void func_120(var uParam0) // Position - 0x432D
{
	switch (*uParam0)
	{
...
void func_121(Hash hParam0) // Position - 0x4371
{
	if (func_3() != -1)
		return;
...
int func_123(Hash hParam0, int iParam1) // Position - 0x43A0
{
	var unk;
	var unk5;
...
struct<2> func_124(Hash hParam0) // Position - 0x43D4
{
	var unk;
	var unk3;
...
void func_125(Hash hParam0) // Position - 0x4468
{
	switch (hParam0)
	{
...
void func_126(Hash hParam0, int iParam1) // Position - 0x4481
{
	char* str;
...
void func_127(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x44C2
{
	BOOL flag;
	int value;
	var unk;
	...
	else if (!func_223(hParam0, &InputString, num3, num2, 0, joaat("ui_itemviewer")))
	{
	...
	str3 = func_231(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash), value), num5);
	...
	if (num4 == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || num4 == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || num4 == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || num4 == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str3 = MISC::VAR_STRING(0, func_232(hParam0, -442898163));
	...
	if (num4 == -126813555 || num4 == 1946043663)
	{
		...
		if (func_233(hParam0, &unk7))
			str3 = func_235(func_234(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_219(str3, InputString.f_1, MISC::GET_HASH_KEY(InputString), num6, num5, str2, str, 0, true);
	return;
}

int func_128(var uParam0, var uParam1) // Position - 0x499C
{
	int i;
	int num;
	var unk;
...
BOOL func_129(var uParam0, var uParam1) // Position - 0x4A53
{
	var unk;
	int i;
	BOOL flag;
...
void func_130(int iParam0, Hash hParam1) // Position - 0x4B0D
{
...
BOOL func_131(var uParam0, var uParam1) // Position - 0x4B84
{
	var unk;
	int i;
	int num;
...
void func_132(var uParam0) // Position - 0x4C47
{
	int i;
...
void func_133(var uParam0) // Position - 0x4C79
{
	int i;
...
BOOL func_134(var uParam0) // Position - 0x4CB8
{
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_135(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x4CF8
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
BOOL func_136(var uParam0, var uParam1) // Position - 0x4DEE
{
	if (uParam1->f_3)
		return true;
...
int func_137(var uParam0, var uParam1) // Position - 0x4E5B
{
	return 0;
}

Hash func_138(Hash hParam0, BOOL bParam1) // Position - 0x4E64
{
	var unk;
...
BOOL func_139(Hash hParam0) // Position - 0x4EBC
{
	return hParam0 != 0;
}

BOOL func_140(int* piParam0, Hash hParam1, var uParam2, BOOL bParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x4EC8
{
...
int func_141(int iParam0, int iParam1) // Position - 0x4F71
{
	int num;
...
BOOL func_142(int iParam0) // Position - 0x4FD5
{
	return func_247(Global_1940085.f_38, iParam0);
}

int func_143(Hash hParam0, BOOL bParam1) // Position - 0x4FE9
{
	if (!func_6(hParam0))
		return 0;
...
char* func_144(int iParam0) // Position - 0x50A4
{
	switch (iParam0)
	{
		case 1:
...
int func_145(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x5105
{
	int num;
	var unk13;
	int num2;
...
void func_146(var uParam0) // Position - 0x5140
{
	switch (uParam0->f_10)
	{
		case -1820411463:
...
int func_147(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) // Position - 0x5220
{
	int i;
...
void func_148(int iParam0, int iParam1) // Position - 0x5250
{
	*iParam0 = iParam1;
	return;
}

struct<2> func_149(int iParam0) // Position - 0x525D
{
	int num;
...
void func_150(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14) // Position - 0x526D
{
	int i;
...
struct<10> func_151() // Position - 0x52C2
{
	return Global_1296539.f_34[func_252() /*10*/];
}

void func_152(Hash hParam0) // Position - 0x52D9
{
	var unk;
	var value;
...
int func_153(Hash hParam0) // Position - 0x52FE
{
	int i;
...
Vector3 func_154(int iParam0) // Position - 0x532A
{
	var unk;
	var unk4;
...
Vector3 func_155(int iParam0) // Position - 0x535D
{
	var unk;
	var unk4;
...
void func_156(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5390
{
	int num;
...
BOOL func_157(int iParam0, int iParam1) // Position - 0x53E4
{
	if (iParam0 < 0)
		return false;
...
void func_158(var uParam0, Hash hParam1) // Position - 0x5405
{
	int i;
	int j;
...
void func_159(var uParam0, Hash hParam1) // Position - 0x550F
{
	int i;
	int j;
	int num;
...
void func_160(var uParam0, Hash hParam1) // Position - 0x5622
{
	int i;
	int j;
	int num;
...
void func_161(var uParam0, Hash hParam1) // Position - 0x56BF
{
	int i;
	int j;
...
void func_162(var uParam0, Hash hParam1) // Position - 0x5787
{
	int i;
	int j;
	int num;
...
void func_163(var uParam0, Hash hParam1) // Position - 0x5840
{
	int i;
	int j;
...
void func_164(var uParam0, Hash hParam1) // Position - 0x5960
{
	int i;
	int j;
	var unk;
...
Hash func_165(Hash hParam0, int iParam1) // Position - 0x5A5A
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_166(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x5AD4
{
...
BOOL func_167(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5AFB
{
	if (iParam2 < 0)
		return false;
...
BOOL func_168(Hash hParam0) // Position - 0x5B36
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_169(Hash hParam0) // Position - 0x5B51
{
	var unk;
...
int func_170(Hash hParam0) // Position - 0x5B7C
{
	switch (hParam0)
	{
...
int func_171(var uParam0, int iParam1) // Position - 0x5C5F
{
	int i;
...
int func_172(Hash hParam0) // Position - 0x5C9C
{
	int num;
...
int func_173(Hash hParam0, BOOL bParam1) // Position - 0x5D09
{
	var unk;
	int num;
	int num2;
...
int func_174(Hash hParam0, int iParam1) // Position - 0x5D68
{
	if (iParam1 == 0)
		return 0;
...
int func_175(BOOL bParam0) // Position - 0x5D94
{
	if (func_3() == -1)
	{
...
struct<4> func_176(Hash hParam0, BOOL bParam1) // Position - 0x5DD5
{
	var unk;
...
BOOL func_177(Hash hParam0) // Position - 0x5DFA
{
	return func_84(hParam0) == joaat("WEAPON");
}

BOOL func_178(Hash hParam0) // Position - 0x5E0E
{
	var unk;
...
void func_179(Hash hParam0, int iParam1, BOOL bParam2, var uParam3, Hash hParam4) // Position - 0x5E53
{
	Hash TypeOfWeapon;
	...
	if (bParam2 || !func_192(TypeOfWeapon))
	{
		if (bParam2 || !WEAPON::HAS_PED_GOT_WEAPON(Global_33, TypeOfWeapon, 0, false) && func_87(hParam0, false, false, false) == 0)
		{
			if (func_3() == -1)
				func_97(TypeOfWeapon);
...
void func_180(Hash hParam0, var uParam1) // Position - 0x5EFD
{
...
struct<5> func_181(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5F22
{
	var unk;
	int num;
	var unk6;
...
int func_182(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6296
{
	if (!func_22(hParam0, 0))
	{
		if (func_65(func_23(hParam0), 2))
...
int func_183(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x630A
{
...
BOOL func_184(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x633D
{
	var unk;
	var unk5;
	int num;
...
BOOL func_186(int iParam0) // Position - 0x64D6
{
	if (iParam0 == 0)
		return false;
...
BOOL func_187(int iParam0) // Position - 0x64E9
{
	int num;
	int num2;
	int offset;
...
void func_188(int iParam0) // Position - 0x6513
{
	int num;
	int num2;
	int BitIndex;
...
void func_189(int iParam0) // Position - 0x654D
{
	switch (iParam0)
	{
		case 1:
...
int func_190(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x6AC9
{
	var unk;
	var unk13;
	var unk26;
...
BOOL func_191(Hash hParam0) // Position - 0x6AF9
{
	Hash weaponUnlock;
...
BOOL func_192(Hash hParam0) // Position - 0x6B21
{
	Hash weaponUnlock;
...
BOOL func_193(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6B49
{
	return func_275(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_194(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x6B64
{
	var unk;
...
struct<4> func_195(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x6B85
{
	var outGuid;
...
BOOL func_196(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x6BB6
{
	var unk;
	int num;
	var unk15;
...
void func_197(Hash hParam0, int iParam1) // Position - 0x6CD4
{
	...
	{
		AmmoInClip = func_292(WEAPON::GET_WEAPON_CLIP_SIZE(hParam0), iParam1);
...
int func_198(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x6D46
{
	int num;
	var guid2;
	var guid1;
...
int func_199(Hash hParam0, Any* panParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x6DC2
{
	if (!func_22(hParam0, 0))
		return 0;
...
void func_200(Hash hParam0) // Position - 0x6E2A
{
	char* decoratorName;
	char* decoratorName2;
	int value;
...
int func_201(Hash hParam0) // Position - 0x6EF9
{
	int num;
	int pedAmmoByType;
...
BOOL func_202() // Position - 0x6F75
{
	return false;
}

BOOL func_203(Hash hParam0) // Position - 0x6F7E
{
	return WEAPON::_IS_AMMO_VALID(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0));
}

Hash func_204(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6F90
{
...
int func_205(Hash hParam0) // Position - 0x6FB6
{
	Hash weaponTypeFromAmmoType;
...
void func_206(int iParam0, var uParam1, var uParam2) // Position - 0x7022
{
	int num;
...
BOOL func_207(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x703E
{
...
void func_208(int iParam0, int iParam1) // Position - 0x70E0
{
	int Variable;
...
int func_209(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x7104
{
	float num;
	int num2;
	int i;
...
void func_210(int iParam0, const char* sParam1, int iParam2, BOOL bParam3) // Position - 0x71D4
{
	if (iParam0 == 0)
		return;
...
void func_211(int iParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x7226
{
	int num;
	int value;
	int num2;
...
void func_212(Hash hParam0, var uParam1, var uParam2) // Position - 0x7301
{
	*uParam1 = 0;
	*uParam2 = 0;
...
Hash func_213(Hash hParam0, BOOL bParam1) // Position - 0x750D
{
	switch (hParam0)
	{
...
BOOL func_214(int iParam0, int iParam1) // Position - 0x75AF
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

void func_215(var uParam0, int iParam1) // Position - 0x75C8
{
	BOOL flag;
	int i;
...
int func_216(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x76F4
{
	var unk;
	int num;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x7763
{
	switch (iParam0)
	{
		case 0:
...
Hash func_218(Hash hParam0) // Position - 0x783A
{
	Hash num;
...
int func_219(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x7864
{
	int num;
	var unk13;
	int num2;
...
BOOL func_220() // Position - 0x78C7
{
	return !Global_1913444;
}

void func_221(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x78D4
{
	int i;
...
var func_222(BOOL bParam0, var uParam1, var uParam2) // Position - 0x79F7
{
	if (bParam0)
		return uParam1;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_223(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x7A0E
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_224(Hash hParam0) // Position - 0x7B01
{
...
BOOL func_225(Hash hParam0) // Position - 0x7BFC
{
...
BOOL func_226(int iParam0) // Position - 0x7C7B
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_227(Hash hParam0) // Position - 0x7CA2
{
	var unk;
	int i;
...
Hash func_228(Hash hParam0) // Position - 0x7D10
{
	int num;
	var unk;
	int collectionId;
...
int func_229(Hash hParam0, Hash hParam1) // Position - 0x7D95
{
	if (hParam0 == 0)
		return 0;
...
int func_230(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x7DC6
{
	var unk;
...
const char* func_231(const char* sParam0, int iParam1) // Position - 0x7E25
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_232(Hash hParam0, int iParam1) // Position - 0x7E3F
{
	 num;
...
BOOL func_233(Hash hParam0, char* sParam1) // Position - 0x7E5D
{
	...
	TEXT_LABEL_ASSIGN_STRING(&StringToTest, func_316(hParam0), 128);
...
const char* func_234(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x7EDA
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_235(const char* sParam0, int iParam1) // Position - 0x7EEE
{
...
BOOL func_236(var uParam0, int iParam1) // Position - 0x7F24
{
	int num;
...
BOOL func_237(Hash hParam0, Hash hParam1) // Position - 0x8014
{
...
void func_238(var uParam0) // Position - 0x80B6
{
	var unk;
...
int func_239(Hash hParam0, BOOL bParam1) // Position - 0x80E2
{
	int num;
...
BOOL func_240(int* piParam0, BOOL bParam1) // Position - 0x811B
{
	if (!bParam1)
...
Hash func_241(int iParam0, int iParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x81B7
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_242(int iParam0, Hash hParam1, int iParam2) // Position - 0x82BC
{
	if (iParam0 == 0)
		return false;
...
BOOL func_243(int* piParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, Hash hParam19, BOOL bParam20) // Position - 0x831C
{
...
BOOL func_247(int iParam0, int iParam1) // Position - 0x8454
{
	return iParam0 && iParam1 != false;
}

BOOL func_248(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8463
{
	if (Global_1572887.f_14 != -1)
	{
...
void func_250(var uParam0, int iParam1) // Position - 0x8625
{
	int num;
	var unk;
	int i;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x88E9
{
...
void func_253(Any* panParam0, var uParam1) // Position - 0x898F
{
...
BOOL func_254(int iParam0, Hash hParam1) // Position - 0x89CE
{
	int i;
...
BOOL func_255(Any* panParam0, int iParam1) // Position - 0x8A1A
{
...
BOOL func_256(Any* panParam0) // Position - 0x8A45
{
	panParam0->f_2 = 1037679264;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam0->f_1), panParam0);
}

int func_257(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, Vector3* pvParam6, BOOL bParam7) // Position - 0x8A60
{
	uParam0.f_2 = iParam5;
...
void func_258(int iParam0, int iParam1) // Position - 0x8A86
{
	if (iParam0 < 0)
		return;
...
void func_259(int iParam0, BOOL bParam1) // Position - 0x8AB9
{
...
void func_260(int iParam0, BOOL bParam1) // Position - 0x8B11
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_261(int iParam0, int iParam1) // Position - 0x8B3A
{
	if (iParam0 < 0)
		return;
...
void func_262(var uParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8B62
{
	var unk;
...
BOOL func_263(int iParam0) // Position - 0x8BFB
{
	if (iParam0 % 2 == 0)
		return true;
...
void func_264(Hash hParam0, var uParam1, var uParam2, Hash hParam3) // Position - 0x8C10
{
	if (*uParam2 < 7)
	{
...
struct<18> func_265(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8C6D
{
	Hash hash;
...
struct<4> func_266(BOOL bParam0) // Position - 0x8D4B
{
	int num;
...
void func_267(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x8DEC
{
...
BOOL func_268(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x8E07
{
...
struct<4> func_269(BOOL bParam0) // Position - 0x8E2C
{
	int num;
...
BOOL func_270(Hash hParam0, BOOL bParam1) // Position - 0x8ECC
{
...
struct<4> func_271(BOOL bParam0) // Position - 0x8F03
{
	int num;
...
BOOL func_272(Hash hParam0, int iParam1) // Position - 0x8F6D
{
	Hash hash;
	int num;
	int i;
...
BOOL func_273(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x8FDA
{
	return func_361(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_274(var uParam0) // Position - 0x8FF0
{
...
int func_275(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x907A
{
...
BOOL func_276(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x90F9
{
...
void func_277(BOOL bParam0) // Position - 0x9122
{
...
void func_278(int iParam0) // Position - 0x9160
{
...
void func_279(BOOL bParam0) // Position - 0x91CE
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_280(BOOL bParam0) // Position - 0x9208
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_281(BOOL bParam0) // Position - 0x9242
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_282(BOOL bParam0) // Position - 0x927C
{
	Hash hash;
...
void func_283(BOOL bParam0) // Position - 0x929F
{
	int promptType;
	Player player;
...
void func_284(BOOL bParam0) // Position - 0x92E1
{
	int promptType;
	Player player;
...
BOOL func_285() // Position - 0x9323
{
	return true;
}

int func_286(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x9342
{
	int num;
	int num2;
	int num3;
...
int func_287(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x93A8
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_288(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x9489
{
	int inventoryId;
...
BOOL func_289(Hash hParam0) // Position - 0x94CE
{
...
int func_290(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x94E4
{
	int num;
...
void func_291(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x954E
{
	int i;
...
int func_292(int iParam0, int iParam1) // Position - 0x95CC
{
	if (iParam0 > iParam1)
		return iParam1;
...
int func_293() // Position - 0x95E2
{
	return Global_1902569;
}

void func_294(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x95EE
{
	int num;
	int i;
	int num2;
...
BOOL func_295(Hash hParam0) // Position - 0x9776
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

BOOL func_296(int iParam0, int iParam1) // Position - 0x9784
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_297(int iParam0) // Position - 0x979C
{
...
BOOL func_298(int iParam0) // Position - 0x97B3
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_299(int iParam0) // Position - 0x987F
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_300() // Position - 0x9892
{
	if (!func_55())
		return false;
...
void func_301(int iParam0, int iParam1) // Position - 0x98AD
{
	if (iParam0 <= 0)
		return;
...
BOOL func_302() // Position - 0x98E9
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_303() // Position - 0x98FA
{
	return DLC::IS_DLC_PRESENT(joaat("dlc_ultimateedition"));
}

void func_304(var uParam0) // Position - 0x990B
{
...
void func_305(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x9943
{
	int i;
	var unk;
...
void func_306(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x99F9
{
...
BOOL func_307(Hash hParam0, Hash hParam1) // Position - 0x9A2A
{
	if (hParam1 == 0)
		return false;
...
int func_308(Hash hParam0) // Position - 0x9A51
{
	var unk;
	int num;
...
struct<10> func_309(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x9A8B
{
	int num;
...
BOOL func_310(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x9B5F
{
...
BOOL func_311(Hash hParam0) // Position - 0x9B80
{
	!func_22(hParam0, 0);
...
int func_312(int iParam0) // Position - 0x9BA6
{
	if (iParam0 < 0)
		return 0;
...
int func_313(Hash hParam0, int iParam1) // Position - 0x9BC7
{
	var unk;
	int num;
	int num2;
...
char* func_314(Hash hParam0) // Position - 0x9C15
{
	Hash labelHash;
...
BOOL func_315(Hash hParam0) // Position - 0x9C49
{
...
char* func_316(Hash hParam0) // Position - 0x9C77
{
	Hash labelHash;
...
BOOL func_317(int iParam0) // Position - 0x9CAA
{
	switch (iParam0)
	{
		case -1649851713:
...
BOOL func_318(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13) // Position - 0x9CF8
{
	var unk;
	int num;
...
BOOL func_319(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x9EAE
{
	BOOL flag;
...
BOOL func_320(Hash hParam0) // Position - 0xA237
{
	int i;
...
BOOL func_321(BOOL bParam0) // Position - 0xA3C8
{
	if (bParam0)
...
BOOL func_322() // Position - 0xA3F8
{
	return Global_1940252.f_10;
}

void func_323(var uParam0) // Position - 0xA406
{
	Global_1940252.f_11588 = uParam0;
	return;
}

void func_324(int iParam0) // Position - 0xA417
{
	Global_1940252.f_10 = iParam0;
	return;
}

BOOL func_325(int* piParam0) // Position - 0xA427
{
	int num;
...
BOOL func_326(Any anParam0) // Position - 0xA459
{
...
BOOL func_327(int iParam0) // Position - 0xA49F
{
	if (iParam0 == 0)
		return false;
...
BOOL func_328(int iParam0, int iParam1) // Position - 0xA4B7
{
	return iParam0 && iParam1 != false;
}

BOOL func_329(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0xA4C6
{
	if (!func_327(iParam0))
		return false;
...
BOOL func_330(int iParam0, var uParam1) // Position - 0xA4FE
{
	*uParam1 = func_389(iParam0, true);
	return *uParam1 != 0;
}

BOOL func_331(int iParam0, var uParam1) // Position - 0xA515
{
	*uParam1 = func_390(iParam0, true, false);
	return *uParam1 != 0;
}

BOOL func_332() // Position - 0xA52D
{
	return Global_1915656.f_22477;
}

BOOL func_333(int iParam0) // Position - 0xA53C
{
...
BOOL func_334(int iParam0, Hash hParam1) // Position - 0xA577
{
	var unk;
	int num;
	Hash unlockHash;
...
BOOL func_335(int iParam0, Hash hParam1) // Position - 0xA6C0
{
	int num;
	int num2;
	var unk;
...
BOOL func_336(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0xA77A
{
...
BOOL func_337(int* piParam0, Hash hParam1) // Position - 0xA793
{
	Hash action;
...
BOOL func_338(int iParam0, Hash hParam1, Any* panParam2) // Position - 0xA7F6
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

BOOL func_339(int* piParam0, BOOL bParam1) // Position - 0xA80D
{
...
void func_341(int iParam0) // Position - 0xA86D
{
...
void func_343(int iParam0) // Position - 0xA8D5
{
...
BOOL func_344() // Position - 0xA8FE
{
	...
	if (!func_346(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_345(int iParam0) // Position - 0xA956
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_346(var uParam0, var uParam1) // Position - 0xA96A
{
	if (!func_399(uParam0))
		return false;
...
int func_347(var uParam0, var uParam1) // Position - 0xA99E
{
	return uParam0;
}

void func_348(var uParam0, int iParam1, int iParam2) // Position - 0xA9A8
{
	Vector3 vector;
	float distanceBetweenCoords;
	var unk3;
...
Hash func_349(int iParam0, int iParam1) // Position - 0xABD8
{
	int num;
...
BOOL func_350(Hash hParam0) // Position - 0xAC1B
{
	int num;
...
int func_351(int iParam0, Hash hParam1, int iParam2) // Position - 0xAD1D
{
	int num;
...
Vector3 func_352(int iParam0, Hash hParam1) // Position - 0xB013
{
	var unk;
...
void func_353(var uParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xB109
{
	Vector3 vector;
	float distanceBetweenCoords;
	int i;
...
int func_354(int iParam0, int iParam1) // Position - 0xB215
{
	switch (iParam0)
	{
		case -2013016202:
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
int func_355(var uParam0, Hash hParam1) // Position - 0xB302
{
	if (func_5(hParam1, 781094263))
	{
	}
...
void func_356(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xB5D0
{
	return;
}

char* func_357(Hash hParam0, int iParam1) // Position - 0xB5D8
{
	switch (iParam1)
	{
		case 0:
...
struct<4> func_358() // Position - 0xB66B
{
	var unk;
...
BOOL func_360(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xB694
{
...
BOOL func_361(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xB6C7
{
...
BOOL func_362(Hash hParam0) // Position - 0xB701
{
	return func_5(hParam0, 1279601681);
}

void func_363(int iParam0, int iParam1) // Position - 0xB714
{
	if (iParam1 == 0)
		return;
...
void func_364(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0xB744
{
	int i;
	var unk;
...
BOOL func_365(Hash hParam0, Any* panParam1) // Position - 0xB7FF
{
	int num;
...
BOOL func_366(int iParam0, Hash hParam1, Any* panParam2) // Position - 0xB9D5
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_367(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0xB9EC
{
	if (bParam0)
	{
...
int func_368(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0xBA35
{
	if (bParam0)
	{
		func_417(iParam1, 1, 0, 0);
...
int func_369(int iParam0) // Position - 0xBA51
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_370(int iParam0) // Position - 0xBA76
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_371(int iParam0) // Position - 0xBA89
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_372(int iParam0) // Position - 0xBA9C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_373(int iParam0) // Position - 0xBAAF
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_374(int iParam0) // Position - 0xBAC1
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_375(int iParam0, int iParam1) // Position - 0xBAD3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_376(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xBB6D
{
...
BOOL func_377() // Position - 0xBBA5
{
	return Global_1913444.f_127 == 0;
}

int func_378() // Position - 0xBBB5
{
	return Global_1953292.f_1;
}

BOOL func_379(Hash hParam0) // Position - 0xBBC3
{
	int i;
...
BOOL func_380(Hash hParam0) // Position - 0xBBFE
{
	if (func_5(hParam0, -839724752))
...
BOOL func_381(Hash hParam0) // Position - 0xBC23
{
...
BOOL func_382(Hash hParam0, int iParam1) // Position - 0xBD4D
{
...
BOOL func_383(Hash hParam0, int iParam1) // Position - 0xBE59
{
	if (iParam1 == 119)
...
void func_384(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0xBE7C
{
	if (func_22(hParam1, 0))
		if (bParam2)
...
Hash func_385(Hash hParam0) // Position - 0xBEA7
{
	Hash award;
	Hash currency;
	int i;
...
BOOL func_386(Hash hParam0) // Position - 0xBF2B
{
...
BOOL func_387(Hash hParam0) // Position - 0xBF46
{
	Hash hash;
...
int func_388(int* piParam0) // Position - 0xC06F
{
	return func_429(piParam0->f_1);
}

Hash func_389(int iParam0, BOOL bParam1) // Position - 0xC07F
{
	int i;
	int num;
	var unk;
...
Hash func_390(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC112
{
	int i;
	int num;
	var unk;
...
int func_391(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC271
{
	var unk;
	int num;
	int i;
...
BOOL func_392(int iParam0) // Position - 0xC305
{
	if (iParam0 < 0)
		return false;
...
int func_393(int iParam0) // Position - 0xC328
{
	return iParam0 / 100;
}

void func_394(const char* sParam0) // Position - 0xC335
{
	Global_1915656.f_22470 = func_145(sParam0, 10000, 0, 0, 0, true);
	return;
}

BOOL func_395(int iParam0) // Position - 0xC351
{
	if (iParam0 < 0)
		return false;
...
BOOL func_396(int iParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0xC37E
{
	var unk;
	int num;
	int i;
...
BOOL func_397(int* piParam0, Hash hParam1) // Position - 0xC485
{
...
BOOL func_398(int* piParam0) // Position - 0xC4A3
{
	Hash action;
...
BOOL func_399(int iParam0) // Position - 0xC540
{
	switch (iParam0)
	{
		case 2:
...
int func_400(int iParam0) // Position - 0xC57F
{
	switch (iParam0)
	{
		case 2:
...
void func_401(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xC615
{
...
void func_402(var uParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0xC654
{
...
int func_403(int iParam0) // Position - 0xC672
{
	int num;
...
Vector3 func_404(int iParam0, Hash hParam1) // Position - 0xC6A9
{
	var unk;
...
Vector3 func_405(int iParam0, Hash hParam1) // Position - 0xCF69
{
	var unk;
...
Vector3 func_406(int iParam0, Hash hParam1) // Position - 0xD74E
{
	var unk;
...
Vector3 func_407(int iParam0, Hash hParam1) // Position - 0xE239
{
	var unk;
...
Vector3 func_408(int iParam0, Hash hParam1) // Position - 0xED24
{
	var unk;
...
Vector3 func_409(int iParam0, Hash hParam1) // Position - 0xF3B9
{
	var unk;
...
Vector3 func_410(int iParam0, Hash hParam1) // Position - 0x11C47
{
	var unk;
...
Vector3 func_411(int iParam0, Hash hParam1) // Position - 0x1388A
{
	var unk;
...
Vector3 func_412(int iParam0, Hash hParam1) // Position - 0x15CA8
{
	var unk;
...
BOOL func_413(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x16B30
{
	int num;
	int num2;
...
BOOL func_414(var uParam0, Hash hParam1) // Position - 0x16BB8
{
	int i;
...
BOOL func_415(var uParam0, int iParam1) // Position - 0x16BE7
{
	int num;
...
BOOL func_416(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x16C17
{
...
void func_417(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x16C2F
{
	int i;
...
var func_418(BOOL bParam0, var uParam1, var uParam2) // Position - 0x16CCD
{
	if (bParam0)
		return uParam1;
...
void func_419(var uParam0, int iParam1) // Position - 0x16CE4
{
	if (iParam1 < 0)
		return;
...
void func_420(var uParam0, int iParam1) // Position - 0x16D6A
{
...
void func_421(var uParam0, int iParam1) // Position - 0x16DA6
{
	int num;
	int num2;
...
void func_422(var uParam0, int iParam1) // Position - 0x16DF9
{
...
void func_423(var uParam0, int iParam1) // Position - 0x16E34
{
...
void func_424(var uParam0, int iParam1) // Position - 0x16E6D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_425(Hash hParam0, int iParam1) // Position - 0x16EA5
{
	return iParam1 == func_4(hParam0, 1224357681);
}

BOOL func_426(Hash hParam0, Hash hParam1) // Position - 0x16EBB
{
...
BOOL func_427(Hash hParam0) // Position - 0x16F37
{
	int i;
	int num;
...
BOOL func_428(Hash hParam0, int iParam1) // Position - 0x16F88
{
	var unk;
	int num;
	Hash hash;
...
int func_429(int iParam0) // Position - 0x17012
{
	int num;
	int status;
...
Hash func_430(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1709C
{
	int num;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_431(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x17138
{
	int i;
...
BOOL func_432(Hash hParam0) // Position - 0x171C7
{
	return func_169(hParam0) == 1946043663;
}

BOOL func_433(Hash hParam0) // Position - 0x171DB
{
	return func_169(hParam0) == -126813555;
}

BOOL func_434(int iParam0) // Position - 0x171EF
{
	if (iParam0 < 0)
		return false;
...
int func_436(int iParam0, Hash hParam1) // Position - 0x1722D
{
...
int func_437(Hash hParam0, int iParam1) // Position - 0x17252
{
	var unk;
	var guid;
	int inventoryItemCountWithGuid;
...
BOOL func_438(int iParam0) // Position - 0x172AD
{
...
int func_439(int iParam0) // Position - 0x172CC
{
	if (!func_438(iParam0))
		return 0;
...
int func_440(int iParam0, BOOL bParam1) // Position - 0x172ED
{
	Hash hash;
	int xp;
...
BOOL func_441(int iParam0) // Position - 0x173AC
{
	if (iParam0 > 2)
		return true;
...
void func_442(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x173C2
{
	int i;
...
int func_443(int iParam0) // Position - 0x1749E
{
...
BOOL func_444(int iParam0, var uParam1) // Position - 0x179BB
{
	if (!func_453(iParam0))
		return false;
...
int func_445(int iParam0) // Position - 0x179E8
{
	if (func_3() != -1)
...
int func_446(int iParam0) // Position - 0x17A15
{
	int i;
...
void func_447(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x17A61
{
	int i;
	int j;
	int k;
...
int func_448(int iParam0) // Position - 0x17C37
{
	switch (iParam0)
	{
		case 0:
...
Hash func_449(int iParam0) // Position - 0x17C68
{
	switch (iParam0)
	{
		case 0:
...
int func_450(int iParam0) // Position - 0x17E01
{
...
Hash func_451(int iParam0) // Position - 0x17E2D
{
	switch (iParam0)
	{
		case 0:
...
void func_452(int iParam0) // Position - 0x17FC6
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
BOOL func_453(int iParam0) // Position - 0x17FE9
{
	return iParam0 > -1 && iParam0 < 26;
}

int func_454(int iParam0) // Position - 0x17FFF
{
	switch (iParam0)
	{
		case 0:
...
void func_455(var uParam0) // Position - 0x18233
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
