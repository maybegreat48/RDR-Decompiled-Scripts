...
int func_3() // Position - 0x243
{
	return Global_1572887.f_14;
}

BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x251
{
	int i;
...
BOOL func_6() // Position - 0x345
{
	return func_14(func_13(0));
}

void func_7(Hash hParam0, BOOL bParam1, float fParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x356
{
...
void func_8() // Position - 0x3E1
{
	return;
}

void func_9(Volume volParam0) // Position - 0x3E9
{
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x430
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x4AF
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12(Volume volParam0) // Position - 0x522
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
struct<2> func_13(int iParam0) // Position - 0x563
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_14(var uParam0, var uParam1) // Position - 0x577
{
	return func_23(uParam0, 9, 12);
}

Hash func_15(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x58A
{
...
BOOL func_16(Hash hParam0) // Position - 0x62E
{
	if (func_24(hParam0))
...
void func_17(Hash hParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x649
{
	if (func_16(hParam0))
	{
...
void func_18(Hash hParam0, BOOL bParam1) // Position - 0x681
{
	if (func_16(hParam0))
...
void func_19(Hash hParam0, BOOL bParam1) // Position - 0x6AF
{
	if (func_16(hParam0))
...
void func_20(Hash hParam0, BOOL bParam1) // Position - 0x6DD
{
	if (func_16(hParam0))
...
BOOL func_21() // Position - 0x70B
{
	return true;
}

void func_22(var uParam0, int iParam1) // Position - 0x714
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_23(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x729
{
	int num;
...
BOOL func_24(Hash hParam0) // Position - 0x764
{
	return hParam0 != 0;
}

BOOL func_25(var uParam0, var uParam1) // Position - 0x770
{
	if (!func_27(uParam0))
		return false;
...
int func_26(int iParam0, var uParam1) // Position - 0x7A4
{
	if (iParam0 == 2)
...
BOOL func_27(int iParam0) // Position - 0x7BE
{
	switch (iParam0)
	{
		case 2:
...
int func_28(int iParam0) // Position - 0x7FD
{
	switch (iParam0)
	{
		case 2:
...
int func_29(var uParam0, var uParam1) // Position - 0x893
{
	var unk;
...
BOOL func_30(int iParam0, var uParam1, Any* panParam2) // Position - 0x8BF
{
	if (!func_25(iParam0))
		return false;
...
void func_31(Any* panParam0) // Position - 0x9CA
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
