...
BOOL func_2(int iParam0) // Position - 0x7C7
{
	switch (iParam0)
	{
		case 1:
...
void func_3(var uParam0) // Position - 0x834
{
...
struct<2> func_4(int iParam0) // Position - 0x896
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_5(int iParam0, var uParam1) // Position - 0x8AA
{
	return iParam0;
}

BOOL func_6(int iParam0) // Position - 0x8B4
{
	return func_50(&(Global_3145858.f_6), iParam0);
}

void func_7(var uParam0, int iParam1) // Position - 0x8C8
{
	if (!func_45(iParam1))
		return;
...
int func_8() // Position - 0x8F1
{
	return Global_1902569;
}

int func_9(int iParam0) // Position - 0x8FD
{
...
int func_11(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x93B
{
	float num;
	float num2;
	int num3;
...
int func_12(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x9B5
{
	int num;
...
BOOL func_13(var uParam0) // Position - 0xA06
{
	return uParam0->f_22 != 3;
}

void func_14(var uParam0) // Position - 0xA14
{
	var unk;
	var unk8;
...
void func_15(var uParam0) // Position - 0xACC
{
	var unk;
	var unk8;
	int randomIntInRange;
...
BOOL func_16(var uParam0) // Position - 0xB26
{
...
BOOL func_17(var uParam0) // Position - 0xB9A
{
...
void func_18(var uParam0) // Position - 0xBC9
{
	BOOL flag;
	int i;
...
void func_19(var uParam0) // Position - 0xCB4
{
...
int func_20(var uParam0) // Position - 0xD13
{
	return uParam0->f_13;
}

void func_21(var uParam0, int iParam1) // Position - 0xD1F
{
	uParam0->f_13 = iParam1;
	return;
}

BOOL func_22(int iParam0, var uParam1) // Position - 0xD2D
{
	int num;
...
void func_23(int iParam0, BOOL bParam1) // Position - 0xD80
{
	int i;
...
BOOL func_24(int iParam0, int iParam1, int iParam2) // Position - 0xDC2
{
	int i;
...
void func_25(var uParam0) // Position - 0xE3E
{
	TASK::_REQUEST_HERB_COMPOSITE_ASSET(uParam0->f_44);
	return;
}

BOOL func_26(var uParam0) // Position - 0xE4F
{
...
int func_27(var uParam0) // Position - 0xE68
{
	int i;
	int num;
	int value;
...
BOOL func_28(var uParam0) // Position - 0xF9B
{
	var unk;
	int groundSetting;
...
BOOL func_29(int iParam0) // Position - 0x1176
{
	switch (iParam0)
	{
		case 40:
...
void func_30(var uParam0) // Position - 0x11C4
{
	func_82(uParam0);
...
BOOL func_31(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x11DB
{
	int i;
	int num;
	int value;
...
void func_32(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x12FF
{
	BOOL flag;
	BOOL flag2;
	float num;
...
void func_33(int iParam0, BOOL bParam1) // Position - 0x1526
{
	int num;
	int num2;
...
BOOL func_34(int iParam0, int iParam1) // Position - 0x1553
{
	if (iParam0 == -1)
		return false;
...
void func_35(int iParam0, int iParam1) // Position - 0x1573
{
	if (iParam0 == -1)
		return;
...
void func_36(int iParam0) // Position - 0x15A3
{
...
BOOL func_37(int iParam0, int iParam1) // Position - 0x15CE
{
	if (iParam0 <= -1)
		return false;
...
void func_38(int iParam0, int iParam1) // Position - 0x15F3
{
	if (iParam0 <= -1)
		return;
...
BOOL func_42(var uParam0, var uParam1, BOOL bParam2, var uParam3) // Position - 0x17A0
{
...
void func_43(var uParam0) // Position - 0x18F9
{
	var unk;
	int i;
	int j;
...
int func_44(var uParam0) // Position - 0x19A5
{
	return uParam0->f_10;
}

BOOL func_45(int iParam0) // Position - 0x19B1
{
	return iParam0 != 5;
}

int func_46(var uParam0) // Position - 0x19BD
{
	return uParam0->f_9;
}

void func_47(var uParam0, int iParam1) // Position - 0x19C9
{
	if (!func_45(iParam1))
		return;
...
void func_48(var uParam0) // Position - 0x19F2
{
	BOOL flag;
	int i;
...
void func_49(var uParam0, int iParam1) // Position - 0x1AAB
{
	switch (uParam0->f_7)
	{
		case 0:
...
BOOL func_50(var uParam0, int iParam1) // Position - 0x1B5D
{
	int num;
	int offset;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1B81
{
...
BOOL func_52(int iParam0) // Position - 0x1BAB
{
	if (iParam0 == -1)
		return false;
...
int func_53(int iParam0) // Position - 0x1BC6
{
	if (iParam0 == -1)
		return 0;
...
Vector3 func_54(int iParam0) // Position - 0x1BDF
{
	if (iParam0 == -1)
		return -1f, -1f, -1f;
...
float func_55(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x1C00
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x1C1E
{
	var SourceStruct;
...
void func_57(int iParam0, var uParam1, var uParam2) // Position - 0x1C58
{
	int i;
	int randomIntInRange;
	var unk;
...
void func_58(int iParam0, int iParam1, int iParam2) // Position - 0x1D4D
{
	if (iParam0 > 500)
		return;
...
BOOL func_59(Ped pedParam0) // Position - 0x1D6F
{
...
BOOL func_60() // Position - 0x1D8C
{
	return Global_1893611 & true != 0 && func_111() != -1;
}

BOOL func_61(BOOL bParam0, BOOL bParam1) // Position - 0x1DA7
{
	int i;
...
BOOL func_62() // Position - 0x1E87
{
	return func_112(Global_1572887.f_8, 1);
}

BOOL func_63(Player plParam0, int iParam1, BOOL bParam2) // Position - 0x1E9A
{
	Player player;
	int i;
...
int func_64(int iParam0) // Position - 0x1F18
{
	return Global_1205938.f_1[iParam0 /*26*/].f_3;
}

BOOL func_65(int iParam0) // Position - 0x1F2C
{
	if (!func_114(iParam0))
		return false;
...
BOOL func_66(int iParam0) // Position - 0x1F4A
{
	return iParam0 != -1;
}

BOOL func_67(Volume volParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1F56
{
...
BOOL func_68(int iParam0) // Position - 0x1F76
{
	return Global_20537[iParam0 /*9*/].f_2 != -15;
}

BOOL func_69(int iParam0, var uParam1) // Position - 0x1F8B
{
	return false;
}

int func_70(int iParam0) // Position - 0x1F94
{
	return Global_20537[iParam0 /*9*/].f_2;
}

void func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x1FA5
{
	int num;
	int i;
	int num2;
...
BOOL func_72(int iParam0, BOOL bParam1) // Position - 0x212D
{
	return func_123(func_8(), iParam0, bParam1);
}

BOOL func_73(int iParam0, int iParam1) // Position - 0x2141
{
	if (iParam0 == -1)
		return false;
...
void func_74(int iParam0, int iParam1) // Position - 0x2168
{
	if (iParam0 <= -1)
		return;
...
void func_75(int iParam0, int iParam1) // Position - 0x21A5
{
	if (iParam0 == -1)
		return;
...
void func_76(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x21CB
{
	if (iParam0 <= -1)
		return;
...
Vector3 func_77(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x21EF
{
	float num;
	float num2;
	float num3;
...
float func_78(float fParam0) // Position - 0x2233
{
	return fParam0 * 0.017453292f;
}

BOOL func_79(int iParam0) // Position - 0x2243
{
	switch (iParam0)
	{
		case 4:
...
void func_80(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x2270
{
	int num;
...
void func_81(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x228B
{
	int i;
...
void func_82(var uParam0) // Position - 0x23B0
{
	if (uParam0->f_4 != -1)
	{
...
void func_83(int iParam0, int iParam1) // Position - 0x23E1
{
	if (func_106(iParam0))
...
BOOL func_84(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x23FA
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_85() // Position - 0x24F9
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_86(var uParam0, int iParam1) // Position - 0x250E
{
	*uParam0 = iParam1;
	return;
}

void func_87(int iParam0) // Position - 0x251B
{
	if (iParam0 <= 0)
		return;
...
void func_88(var uParam0) // Position - 0x2542
{
	func_130(uParam0, 0f);
	return;
}

float func_89(var uParam0) // Position - 0x2551
{
	if (!func_103(uParam0))
		return uParam0->f_1;
...
void func_90(int iParam0, var uParam1, var uParam2) // Position - 0x2586
{
	int num;
...
BOOL func_91(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x25A2
{
...
void func_92(int iParam0, int iParam1) // Position - 0x2644
{
	int Variable;
...
Hash func_93(int iParam0) // Position - 0x2668
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_94(int iParam0) // Position - 0x29FE
{
	if (!func_114(iParam0))
		return false;
...
void func_95(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2A1C
{
	if (!func_114(iParam0))
		return;
...
void func_96(int iParam0, int iParam1) // Position - 0x2A7E
{
	var statId;
...
void func_97(int iParam0, int iParam1) // Position - 0x2AB0
{
...
void func_98(int iParam0, BOOL bParam1, int iParam2) // Position - 0x2AF4
{
	Hash num;
	int num2;
...
Hash func_99(int iParam0) // Position - 0x2B6A
{
	switch (iParam0)
	{
		case 2:
...
void func_100(Hash hParam0) // Position - 0x2E25
{
	int num;
	var unk22;
	int i;
...
void func_101(Hash hParam0, int iParam1, BOOL bParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3169
{
	BOOL flag;
	int value;
	var unk;
...
void func_102(var uParam0, BOOL bParam1) // Position - 0x3638
{
...
BOOL func_103(var uParam0) // Position - 0x3658
{
	return func_182(*uParam0, 1);
}

void func_104(var uParam0, int iParam1) // Position - 0x3668
{
	*uParam0 = iParam1;
	return;
}

void func_105(var uParam0) // Position - 0x3675
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_106(int iParam0) // Position - 0x368B
{
	if (*iParam0 == 0)
		return false;
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x36A3
{
	return iParam0 && iParam1 != false;
}

void func_108(var uParam0, int iParam1) // Position - 0x36B2
{
	uParam0->f_7 = iParam1;
	return;
}

Vector3 func_109(int iParam0) // Position - 0x36C0
{
	float num;
	int value;
	int value2;
...
BOOL func_110(float fParam0, var uParam1, var uParam2) // Position - 0x371C
{
	BOOL flag;
...
int func_111() // Position - 0x3771
{
	return Global_1893611.f_2;
}

BOOL func_112(BOOL bParam0, BOOL bParam1) // Position - 0x377F
{
	return bParam0 && bParam1 != false;
}

BOOL func_113(int iParam0, int iParam1, Player plParam2) // Position - 0x378E
{
	return func_183(Global_1206166[plParam2 /*10*/][iParam0], iParam1);
}

BOOL func_114(int iParam0) // Position - 0x37A8
{
	return !(iParam0 <= 0);
}

BOOL func_115(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x37B5
{
	if (bParam2)
		if (!func_114(iParam0))
			return false;
...
int func_116(int iParam0) // Position - 0x37F8
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_117(int iParam0) // Position - 0x381D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_118(int iParam0) // Position - 0x3830
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_119(int iParam0) // Position - 0x3843
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_120(int iParam0) // Position - 0x3855
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_121(int iParam0, int iParam1) // Position - 0x3867
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_122(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3901
{
...
BOOL func_123(int iParam0, int iParam1, BOOL bParam2) // Position - 0x3939
{
	if (bParam2)
...
void func_124(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x3966
{
...
void func_125(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x39A8
{
	if (!func_106(uParam0))
	{
...
int func_126(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x39DC
{
...
BOOL func_127(BOOL bParam0) // Position - 0x3A9E
{
	if (bParam0)
...
BOOL func_128() // Position - 0x3ACE
{
	return func_197() != -1;
}

BOOL func_129() // Position - 0x3ADC
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_130(var uParam0, float fParam1) // Position - 0x3B01
{
...
BOOL func_131(var uParam0) // Position - 0x3B27
{
	return func_182(*uParam0, 2);
}

float func_132() // Position - 0x3B37
{
...
BOOL func_133(int iParam0, int iParam1) // Position - 0x3B69
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_134(int iParam0) // Position - 0x3B81
{
...
BOOL func_135(int iParam0) // Position - 0x3B98
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_136(int iParam0, int iParam1) // Position - 0x3C64
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_137(int iParam0) // Position - 0x3C7D
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_138() // Position - 0x3C90
{
	if (!func_200())
		return false;
...
void func_139(int iParam0) // Position - 0x3CAB
{
	switch (iParam0)
	{
		case 2:
...
void func_140(int iParam0, BOOL bParam1) // Position - 0x3EB1
{
	if (!func_114(iParam0))
		return;
...
void func_141(int iParam0, BOOL bParam1) // Position - 0x3ED7
{
	if (!func_114(iParam0))
		return;
...
BOOL func_142(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3F1A
{
	if (Global_1572887.f_14 != -1)
	{
...
void func_143(BOOL bParam0, int iParam1) // Position - 0x4092
{
...
struct<2> func_144(int iParam0, Hash hParam1) // Position - 0x40D8
{
	int num;
...
struct<2> func_145(int iParam0) // Position - 0x40EE
{
	var unk;
...
void func_146(var uParam0, var uParam1, int iParam2) // Position - 0x4100
{
...
BOOL func_147(int iParam0) // Position - 0x411D
{
	switch (iParam0)
	{
		case 4:
...
int func_148(int iParam0) // Position - 0x414D
{
	switch (iParam0)
	{
...
BOOL func_149(Hash hParam0, Hash hParam1) // Position - 0x4328
{
	if (!func_161(hParam0, 0))
...
int func_150(Hash hParam0) // Position - 0x4369
{
	var unk;
...
float func_151(int iParam0, int iParam1) // Position - 0x4394
{
	int num;
	float pedStamina;
	float pedMaxStamina;
...
void func_152(int iParam0) // Position - 0x4449
{
	Ped ped;
	int num;
...
void func_153(int iParam0, BOOL bParam1) // Position - 0x4486
{
	int num;
...
void func_154(int iParam0) // Position - 0x44BB
{
	Ped ped;
	int num;
...
float func_155(float fParam0, float fParam1) // Position - 0x44F8
{
	if (fParam1 != 0f)
...
void func_156(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4526
{
	if (fParam1 == 0f)
		return;
...
float func_157(float fParam0, int iParam1) // Position - 0x455F
{
	switch (iParam1)
	{
		case 0:
...
int func_158(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x45B1
{
...
void func_159(float fParam0, BOOL bParam1) // Position - 0x45D5
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
struct<2> func_160(int iParam0) // Position - 0x462D
{
	int num;
...
BOOL func_161(Hash hParam0, int iParam1) // Position - 0x463D
{
	if (hParam0 == 0)
		return false;
...
BOOL func_162() // Position - 0x4657
{
	return !Global_1913444;
}

void func_163(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x4664
{
	int i;
...
var func_164(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4787
{
	if (bParam0)
		return uParam1;
...
BOOL func_165(Hash hParam0, int iParam1) // Position - 0x479E
{
	if (!func_161(hParam0, 0))
		return false;
...
int func_166(Hash hParam0) // Position - 0x47BD
{
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_167(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x47E8
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_168(Hash hParam0) // Position - 0x48DB
{
...
BOOL func_169(Hash hParam0) // Position - 0x49D7
{
...
Hash func_170(Hash hParam0, BOOL bParam1) // Position - 0x4A56
{
	Hash hash;
...
BOOL func_171(int iParam0) // Position - 0x4A84
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_172(Hash hParam0) // Position - 0x4AAB
{
	var unk;
	int i;
...
Hash func_173(Hash hParam0) // Position - 0x4B19
{
	int num;
	var unk;
	int collectionId;
...
int func_174(Hash hParam0, Hash hParam1) // Position - 0x4B9E
{
	if (hParam0 == 0)
		return 0;
...
int func_175(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x4BCF
{
	var unk;
...
const char* func_176(const char* sParam0, int iParam1) // Position - 0x4C2E
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_177(Hash hParam0, int iParam1) // Position - 0x4C48
{
	 num;
...
BOOL func_178(Hash hParam0, char* sParam1) // Position - 0x4C66
{
...
const char* func_179(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x4CE3
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_180(const char* sParam0, int iParam1) // Position - 0x4CF7
{
...
int func_181(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x4D2D
{
	int num;
	var unk13;
	int num2;
...
BOOL func_182(int iParam0, int iParam1) // Position - 0x4D90
{
	return iParam0 && iParam1 != false;
}

BOOL func_183(int iParam0, int iParam1) // Position - 0x4D9F
{
	return iParam0 && iParam1 != false;
}

var func_184(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4DAE
{
	if (bParam0)
		return uParam1;
...
void func_185(var uParam0, int iParam1) // Position - 0x4DC5
{
	if (iParam1 < 0)
		return;
...
void func_186(var uParam0, int iParam1) // Position - 0x4E4B
{
...
void func_187(var uParam0, int iParam1) // Position - 0x4E87
{
	int num;
	int num2;
...
void func_188(var uParam0, int iParam1) // Position - 0x4EDA
{
...
void func_189(var uParam0, int iParam1) // Position - 0x4F15
{
...
void func_190(var uParam0, int iParam1) // Position - 0x4F4E
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_191(int iParam0) // Position - 0x4F86
{
	int num;
	int num2;
	int num3;
...
Hash func_192(Hash hParam0, int iParam1) // Position - 0x5062
{
	int num;
	var unk;
	Hash hash;
...
int func_193(Hash hParam0, BOOL bParam1) // Position - 0x50DC
{
	var unk;
	int num;
	int num2;
...
int func_194(Hash hParam0, int iParam1) // Position - 0x513B
{
	if (iParam1 == 0)
		return 0;
...
int func_195(BOOL bParam0) // Position - 0x5167
{
	if (func_207() == -1)
	{
...
struct<4> func_196(Hash hParam0, BOOL bParam1) // Position - 0x51A8
{
	var unk;
...
int func_197() // Position - 0x51CD
{
	return Global_1149172.f_137;
}

void func_198(var uParam0, int iParam1) // Position - 0x51DB
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_199(var uParam0, int iParam1) // Position - 0x51EC
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_200() // Position - 0x5201
{
...
BOOL func_201(int iParam0) // Position - 0x5215
{
	if (!func_114(iParam0))
		return false;
...
int func_202(BOOL bParam0, int iParam1) // Position - 0x5233
{
...
BOOL func_204(var uParam0, var uParam1) // Position - 0x52E1
{
	if (!func_244(uParam0))
		return false;
...
void func_205(int iParam0, int iParam1) // Position - 0x5315
{
	iParam0->f_2 = iParam0->f_2 || iParam1;
	return;
}

BOOL func_206() // Position - 0x5328
{
	return true;
}

int func_207() // Position - 0x5347
{
	return Global_1572887.f_14;
}

Hash func_208(Hash hParam0) // Position - 0x5355
{
	return hParam0;
}

BOOL func_209(Hash hParam0, Hash hParam1) // Position - 0x535F
{
...
int func_210(int iParam0) // Position - 0x5395
{
	if (iParam0 == 2)
		iParam0 = func_246(1);
...
void func_211(float fParam0, Ped pedParam1) // Position - 0x53D5
{
	if (fParam0 == 0f)
		return;
...
int func_212(int iParam0) // Position - 0x5419
{
	if (iParam0 == 2)
		iParam0 = func_246(1);
...
void func_213(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x545D
{
	Player player;
	Ped EntityIndex;
...
int func_214(int iParam0) // Position - 0x550E
{
	if (iParam0 == 2)
		iParam0 = func_246(1);
...
void func_215(float fParam0, Ped pedParam1) // Position - 0x5552
{
	if (fParam0 == 0f)
		return;
...
float func_216(int iParam0, float fParam1, BOOL bParam2) // Position - 0x5594
{
	int num;
	int num2;
...
float func_217(int iParam0, int iParam1) // Position - 0x55FD
{
	if (iParam1 == 2)
		iParam1 = func_246(2);
...
int func_218(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x5649
{
	Ped ped;
...
int func_219(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x56C7
{
	char* effectName;
	Ped ped;
...
void func_221(float fParam0, int iParam1) // Position - 0x58A6
{
	float num;
	int num2;
	int num3;
...
BOOL func_222(Hash hParam0, Hash hParam1) // Position - 0x5919
{
	if (hParam1 == 0)
		return false;
...
Hash func_223(Hash hParam0, BOOL bParam1) // Position - 0x5940
{
	switch (hParam0)
	{
...
int func_224(Hash hParam0) // Position - 0x59E2
{
	var unk;
	int num;
...
struct<10> func_225(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x5A1C
{
	int num;
...
BOOL func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x5AF0
{
...
BOOL func_227(Hash hParam0) // Position - 0x5B11
{
	!func_161(hParam0, 0);
...
int func_228(int iParam0) // Position - 0x5B37
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_229(Hash hParam0, int iParam1) // Position - 0x5B58
{
	if (hParam0 == 0)
		return false;
...
int func_230(Hash hParam0, int iParam1) // Position - 0x5B72
{
	var unk;
	int num;
	int num2;
...
char* func_231(Hash hParam0) // Position - 0x5BC0
{
	Hash labelHash;
...
BOOL func_232(Hash hParam0) // Position - 0x5BF6
{
...
char* func_233(Hash hParam0) // Position - 0x5C24
{
	Hash labelHash;
...
void func_234(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x5C59
{
...
void func_235(Hash hParam0, var uParam1, var uParam2) // Position - 0x5C8A
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_236(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5E96
{
	Hash hash;
...
struct<4> func_237(BOOL bParam0) // Position - 0x5F74
{
	int num;
...
void func_238(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x6015
{
...
BOOL func_239(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x6030
{
...
int func_240(int iParam0) // Position - 0x6055
{
	if (iParam0 < 0)
		return 0;
...
struct<5> func_241(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x6076
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_242(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x63EA
{
	var outGuid;
...
BOOL func_243() // Position - 0x641B
{
	return !Global_1572887.f_10;
}

BOOL func_244(int iParam0) // Position - 0x642A
{
	switch (iParam0)
	{
		case 2:
...
int func_245(int iParam0) // Position - 0x6469
{
	switch (iParam0)
	{
		case 2:
...
int func_246(int iParam0) // Position - 0x64FF
{
	return func_273(func_272(iParam0));
}

BOOL func_247(Player plParam0) // Position - 0x6511
{
	float num;
...
void func_248(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x652C
{
	int num;
	int i;
	int j;
...
int func_249(int iParam0, int iParam1) // Position - 0x669F
{
	if (iParam1 == 2)
		iParam1 = func_246(2);
...
int func_250(int iParam0, int iParam1) // Position - 0x66EF
{
	if (iParam1 == 2)
		iParam1 = func_246(2);
...
void func_251(int iParam0, int iParam1, int iParam2) // Position - 0x6741
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
void func_252(int iParam0, int iParam1, int iParam2) // Position - 0x6797
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
BOOL func_253(Ped pedParam0, int iParam1, float fParam2) // Position - 0x67ED
{
...
void func_254(int iParam0, int iParam1, int iParam2) // Position - 0x6842
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
void func_255(Ped pedParam0, int iParam1, float fParam2) // Position - 0x68A3
{
	char* StringToTest;
...
void func_256(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x68CF
{
	int num;
...
BOOL func_257(int iParam0) // Position - 0x6905
{
	switch (iParam0)
	{
		case 0:
...
char* func_258(int iParam0) // Position - 0x6934
{
	switch (iParam0)
	{
		case 0:
...
void func_259(int iParam0) // Position - 0x696F
{
	int num;
	int num2;
	int i;
...
void func_260(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6A3F
{
	func_218(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

float func_261(int iParam0, int iParam1) // Position - 0x6A59
{
	if (iParam1 == 2)
		iParam1 = func_246(1);
...
int func_262(float fParam0) // Position - 0x6AA5
{
	float num;
...
float func_263(float fParam0, float fParam1, float fParam2) // Position - 0x6AD0
{
	if (fParam0 > fParam2)
		return fParam2;
...
int func_264(int iParam0, float fParam1, int iParam2) // Position - 0x6AF7
{
	if (!func_282(iParam0))
		return 0;
...
struct<4> func_265(BOOL bParam0) // Position - 0x6B48
{
	int num;
...
int func_266(Hash hParam0, BOOL bParam1) // Position - 0x6BE8
{
...
BOOL func_267(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6C1F
{
	return func_286(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_268(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x6C3A
{
	var unk;
...
struct<4> func_269(BOOL bParam0) // Position - 0x6C5B
{
	int num;
...
BOOL func_270(Hash hParam0, int iParam1) // Position - 0x6CC5
{
	Hash hash;
	int num;
	int i;
...
BOOL func_271(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6D32
{
	return func_289(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_272(int iParam0) // Position - 0x6D48
{
	return func_290(&(Global_1956875.f_1565), iParam0, 1);
}

int func_273(BOOL bParam0) // Position - 0x6D5E
{
	if (bParam0)
		return 1;
...
float func_274(Player plParam0) // Position - 0x6D70
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_291(2);
}

int func_275(int iParam0) // Position - 0x6D86
{
	switch (iParam0)
	{
		case 0:
...
char* func_276(int iParam0) // Position - 0x6DB5
{
	switch (iParam0)
	{
		case 0:
...
char* func_277(int iParam0) // Position - 0x6DF0
{
	switch (iParam0)
	{
		case 0:
...
void func_278(int iParam0, float fParam1, int iParam2) // Position - 0x6E2B
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
void func_279(int iParam0, int iParam1, int iParam2) // Position - 0x6E7D
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
int func_280(int iParam0, int iParam1) // Position - 0x6ED3
{
	switch (iParam0)
	{
		case -2101912686:
...
// Unhandled jump detected. Output should be considered invalid
int func_281(int iParam0) // Position - 0x76D4
{
	int num;
	int num2;
	int num3;
...
BOOL func_282(int iParam0) // Position - 0x7964
{
	if (func_257(iParam0))
		return true;
...
void func_283(int iParam0, float fParam1, int iParam2) // Position - 0x798A
{
	if (fParam1 < 0f)
		return;
...
struct<4> func_284() // Position - 0x79E6
{
	var unk;
...
int func_286(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x7A0F
{
...
BOOL func_287(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x7A8E
{
	int inventoryId;
...
BOOL func_288(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x7AD3
{
...
BOOL func_289(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7B06
{
...
BOOL func_290(Any* panParam0, int iParam1, int iParam2) // Position - 0x7B40
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_291(int iParam0) // Position - 0x7B77
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_292(int iParam0) // Position - 0x7BB8
{
	int num;
...
BOOL func_293(int iParam0) // Position - 0x7BE0
{
	int num;
...
int func_294(int iParam0, int iParam1) // Position - 0x7C08
{
	switch (iParam0)
	{
...
int func_295(int iParam0, int iParam1) // Position - 0x82BF
{
	Player player;
	Player player2;
	int num;
...
int func_296(int iParam0, int iParam1, int iParam2) // Position - 0x8342
{
	int num;
	int num2;
...
void func_297(int iParam0) // Position - 0x843A
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_298(int iParam0, int iParam1) // Position - 0x8450
{
	switch (iParam0)
	{
...
BOOL func_302(int iParam0) // Position - 0x8D7A
{
	switch (iParam0)
	{
		case 12:
...
int func_303(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8D9F
{
...
Player func_304(int iParam0) // Position - 0x8DD2
{
	if (func_315(iParam0))
...
BOOL func_305(int iParam0) // Position - 0x8DF3
{
	int num;
...
int func_306(int iParam0, int iParam1, int iParam2) // Position - 0x8E1B
{
	int num;
	int num2;
	int num3;
...
BOOL func_307(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x900C
{
	return uParam0.f_4 != 0;
}

BOOL func_308(int iParam0, int iParam1) // Position - 0x901A
{
	int num;
...
Vector3 func_309(int iParam0) // Position - 0x905A
{
	int num;
	var unk;
...
BOOL func_310(int iParam0, var uParam1, var uParam2) // Position - 0x9096
{
	if (!func_305(iParam0))
		return false;
...
BOOL func_311(int iParam0, int iParam1, int iParam2) // Position - 0x90CD
{
	int num;
	int num2;
	int num3;
...
void func_312(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x92FB
{
	int num;
...
void func_313(int iParam0) // Position - 0x937A
{
	int num;
...
BOOL func_314(Hash hParam0) // Position - 0x93CF
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_315(int iParam0) // Position - 0x93DD
{
	int num;
...
int func_316(int iParam0) // Position - 0x9404
{
	int num;
...
int func_317(int iParam0, int iParam1) // Position - 0x949E
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_318(int iParam0) // Position - 0x98D7
{
	int num;
...
float func_319(int iParam0) // Position - 0x98FF
{
	float num;
...
void func_320(int iParam0) // Position - 0x992F
{
	int num;
	int num2;
	int i;
...
BOOL func_321(int iParam0) // Position - 0x9B0E
{
	int num;
...
int func_322(int iParam0, int iParam1) // Position - 0x9B36
{
	switch (iParam0)
	{
...
void func_323(int iParam0) // Position - 0x9E46
{
	Ped ped;
	Player player;
...
BOOL func_324(int iParam0) // Position - 0xA056
{
	int num;
...
int func_325(int iParam0, int iParam1) // Position - 0xA07D
{
	switch (iParam0)
	{
...
int func_326(int iParam0) // Position - 0xA0DA
{
	int num;
	var unk;
	var unk32;
...
BOOL func_327(int iParam0) // Position - 0xA21E
{
...
void func_328(int iParam0) // Position - 0xA23C
{
	int num;
	int num2;
	int i;
...
BOOL func_329(int iParam0) // Position - 0xA391
{
	BOOL flag;
...
void func_330(int iParam0) // Position - 0xA3BB
{
	Ped EntityIndex;
	Player player;
	int num;
...
void func_331(int iParam0) // Position - 0xA656
{
	char* StringToTest;
	char* StringToTest2;
...
BOOL func_332(int iParam0) // Position - 0xA6A0
{
	int num;
...
BOOL func_333(int iParam0) // Position - 0xA6C8
{
	int num;
...
BOOL func_334(int iParam0) // Position - 0xA6F0
{
	int num;
...
BOOL func_335(int iParam0) // Position - 0xA718
{
	int num;
...
BOOL func_336(int iParam0) // Position - 0xA740
{
	int num;
...
BOOL func_337(int iParam0) // Position - 0xA768
{
	int num;
...
float func_338(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0xA790
{
	var unk;
	float num;
...
BOOL func_339(int iParam0) // Position - 0xA7C6
{
...
BOOL func_340(int iParam0) // Position - 0xA835
{
	int num;
...
int func_341(int iParam0, int iParam1) // Position - 0xA85C
{
	switch (iParam0)
	{
...
char* func_344(int iParam0) // Position - 0xA94B
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_345(int iParam0) // Position - 0xA993
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_346(int iParam0) // Position - 0xA9CE
{
	int i;
...
int func_348(int iParam0) // Position - 0xAA2E
{
	int num;
...
BOOL func_349(int iParam0, int iParam1) // Position - 0xAA5D
{
	int num;
	Player player;
	int num2;
...
struct<31> func_350(int iParam0) // Position - 0xAD32
{
	int num;
...
BOOL func_351(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0xAD56
{
	var unk;
	BOOL flag;
...
char* func_352(int iParam0, int iParam1) // Position - 0xAD8C
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_353(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xADE5
{
	int i;
...
char* func_355(int iParam0) // Position - 0xAE8F
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_356(int iParam0) // Position - 0xAEB0
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_357(Hash hParam0, Hash hParam1, var uParam2) // Position - 0xAED1
{
	int num;
	int num2;
...
BOOL func_358() // Position - 0xB0F3
{
	return Global_1572887.f_7;
}

BOOL func_359() // Position - 0xB101
{
	if (!Global_1048577)
		return false;
...
BOOL func_360(Player plParam0) // Position - 0xB14C
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_361(int iParam0, Player plParam1) // Position - 0xB191
{
	if (plParam1 == 255)
...
int func_362(int iParam0) // Position - 0xB1BD
{
	int num;
...
void func_365(Player plParam0) // Position - 0xB258
{
	Player player;
...
void func_366(Player plParam0) // Position - 0xB2DB
{
	Player player;
...
void func_367(Player plParam0) // Position - 0xB347
{
