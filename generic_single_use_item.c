...
int func_1(Hash hParam0, int iParam1) // Position - 0x1D3
{
	var unk;
	int num;
	int i;
...
int func_2(var uParam0) // Position - 0x21D
{
...
BOOL func_3(Hash hParam0, int iParam1) // Position - 0x28C
{
	if (hParam0 == 0)
		return false;
...
void func_4(var uParam0) // Position - 0x2A6
{
	int i;
...
void func_5(int iParam0) // Position - 0x2E6
{
	switch (iParam0)
	{
		case -1706054699:
...
void func_6(var uParam0, int iParam1) // Position - 0x316
{
	*uParam0 = iParam1;
	return;
}

void func_7(var uParam0, BOOL bParam1) // Position - 0x323
{
	int i;
	float num;
	float num2;
...
void func_8(int iParam0, BOOL bParam1) // Position - 0x6CA
{
	var unk;
	var unk11;
...
void func_9(BOOL bParam0) // Position - 0x894
{
	int num;
	int num2;
...
void func_10(var uParam0, int iParam1, BOOL bParam2) // Position - 0x94A
{
...
void func_11(var uParam0) // Position - 0x9D8
{
	if (!uParam0->f_176)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_174))
...
void func_12(BOOL bParam0) // Position - 0xA02
{
...
BOOL func_13(Hash hParam0, Hash hParam1) // Position - 0xA22
{
	if (!func_3(hParam0, 0))
...
BOOL func_14(int iParam0) // Position - 0xA63
{
	switch (iParam0)
	{
...
float func_15(int iParam0, float fParam1) // Position - 0xADB
{
	float pedStamina;
	float pedMaxStamina;
	float num;
...
void func_16(float fParam0) // Position - 0xB6C
{
	Ped ped;
	int num;
...
void func_17(float fParam0, BOOL bParam1) // Position - 0xBAC
{
	int num;
...
void func_18(float fParam0) // Position - 0xBE4
{
	Ped ped;
	int num;
...
float func_19(float fParam0, float fParam1) // Position - 0xC24
{
	if (fParam1 != 0f)
...
void func_20(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xC52
{
	if (fParam1 == 0f)
		return;
...
void func_21(float fParam0, BOOL bParam1) // Position - 0xC8B
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
float func_22(float fParam0, int iParam1) // Position - 0xCE3
{
	switch (iParam1)
	{
		case 0:
...
int func_23(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xD35
{
...
void func_25(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0xDD9
{
...
int func_26(int iParam0) // Position - 0x1043
{
	var unk;
...
void func_27(int iParam0) // Position - 0x109B
{
	func_69(iParam0);
	func_70(true, true);
	return;
...
int func_28(int iParam0, int iParam1, int iParam2) // Position - 0x10AF
{
	int num;
...
struct<2> func_31(int iParam0, int iParam1) // Position - 0x117F
{
	int num;
...
void func_32(var uParam0, var uParam1, int iParam2) // Position - 0x1195
{
...
void func_33(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, int iParam16) // Position - 0x11B2
{
	int i;
...
void func_34(int iParam0) // Position - 0x124E
{
	int num;
	int num2;
	int i;
...
BOOL func_35() // Position - 0x131E
{
	return func_84(1);
}

void func_36() // Position - 0x132B
{
	func_34(joaat("STATUS_EFFECT__POISON"));
...
BOOL func_37() // Position - 0x1345
{
	return Global_1953292.f_1676.f_1[1 /*3*/].f_1 == joaat("pomade");
}

int func_38(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x1361
{
	var unk;
	var guid;
	var guid2;
...
void func_39(BOOL bParam0, BOOL bParam1) // Position - 0x1486
{
	int num;
	Hash hash;
	BOOL flag;
...
int func_40() // Position - 0x1593
{
	return Global_1902569;
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x159F
{
	int num;
	int i;
	int num2;
...
BOOL func_42(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1727
{
	if (bParam2)
...
void func_43(int iParam0, int iParam1, int iParam2, Ped pedParam3, BOOL bParam4) // Position - 0x1754
{
	int num;
...
Hash func_44() // Position - 0x1786
{
	return Global_1953292.f_1676.f_1[1 /*3*/];
}

int func_45(Hash hParam0, Ped pedParam1, Hash hParam2, BOOL bParam3) // Position - 0x179A
{
	int num;
...
Hash func_46(Hash hParam0) // Position - 0x180B
{
	return hParam0;
}

BOOL func_47(Hash hParam0, Hash hParam1) // Position - 0x1815
{
...
int func_48(int iParam0) // Position - 0x184B
{
	if (iParam0 == 2)
		iParam0 = func_121(1);
...
void func_49(float fParam0, Ped pedParam1) // Position - 0x188B
{
	if (fParam0 == 0f)
		return;
...
int func_50(int iParam0) // Position - 0x18CF
{
	if (iParam0 == 2)
		iParam0 = func_121(1);
...
void func_51(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1913
{
	Player player;
	Ped EntityIndex;
...
int func_52(int iParam0) // Position - 0x19C4
{
	if (iParam0 == 2)
		iParam0 = func_121(1);
...
void func_53(float fParam0, Ped pedParam1) // Position - 0x1A08
{
	if (fParam0 == 0f)
		return;
...
float func_54(int iParam0, float fParam1, BOOL bParam2) // Position - 0x1A4A
{
	int num;
	int num2;
...
float func_55(int iParam0, int iParam1) // Position - 0x1AB3
{
	if (iParam1 == 2)
		iParam1 = func_121(2);
...
int func_56(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x1AFF
{
	Ped ped;
...
void func_58(float fParam0, int iParam1) // Position - 0x1BA2
{
	float num;
	int num2;
	int num3;
...
void func_59(int iParam0, BOOL bParam1) // Position - 0x1C15
{
	int num;
	int num2;
...
int func_60(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1C42
{
	char* effectName;
	Ped ped;
...
struct<2> func_61(int iParam0) // Position - 0x1DF8
{
	int num;
...
int func_62(Hash hParam0) // Position - 0x1E08
{
	switch (hParam0)
	{
		case joaat("consumable_herb_common_bulrush"):
...
void func_63(int iParam0, int iParam1) // Position - 0x1FE3
{
	var statId;
...
int func_64() // Position - 0x2015
{
	return Global_1572887.f_14;
}

void func_65(Hash hParam0, int iParam1) // Position - 0x2023
{
	int num;
...
BOOL func_66(Any* panParam0) // Position - 0x21C4
{
	var SourceStruct;
...
BOOL func_67(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x21F3
{
	var unk;
...
int func_68(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x222C
{
	return func_149(&uParam0, 61, 1);
}

void func_69(int iParam0) // Position - 0x223D
{
	int num;
...
void func_70(BOOL bParam0, BOOL bParam1) // Position - 0x228C
{
	if (func_156(255) == 4)
		return;
...
BOOL func_71(int iParam0) // Position - 0x23D7
{
	int num;
...
BOOL func_72(int iParam0) // Position - 0x23FF
{
	int num;
...
BOOL func_73(int iParam0) // Position - 0x2427
{
	int num;
...
BOOL func_74(int iParam0) // Position - 0x244F
{
	int num;
...
BOOL func_75(int iParam0) // Position - 0x2477
{
	if (!func_74(iParam0))
		return false;
...
int func_76(int iParam0) // Position - 0x24A4
{
	int num;
	int num2;
	int num3;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_77(int iParam0, int iParam1) // Position - 0x2734
{
	int num;
	int num2;
	int num3;
...
int func_78(int iParam0) // Position - 0x28EC
{
	int num;
...
BOOL func_79() // Position - 0x2986
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

BOOL func_80(int iParam0, int iParam1) // Position - 0x29AB
{
	return iParam0 && iParam1 != false;
}

BOOL func_81(const char* sParam0) // Position - 0x29BA
{
	int i;
...
void func_82(int iParam0) // Position - 0x29F4
{
...
int func_83(int iParam0, int iParam1) // Position - 0x2A0B
{
	switch (iParam0)
	{
		case -2101912686:
...
BOOL func_84(int iParam0) // Position - 0x320C
{
	return func_182(iParam0);
}

struct<5> func_85(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x321A
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_86(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x358E
{
	var outGuid;
...
int func_87(BOOL bParam0) // Position - 0x35BF
{
	if (func_64() == -1)
	{
...
BOOL func_88(BOOL bParam0) // Position - 0x3600
{
	if (func_64() == -1)
		return true;
...
struct<17> func_89(var uParam0, BOOL bParam1) // Position - 0x361E
{
	var unk;
...
int func_90(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x369F
{
	int num;
...
void func_91() // Position - 0x3709
{
	Global_1953292.f_1046 = 0;
	return;
}

BOOL func_92(BOOL bParam0) // Position - 0x3719
{
	return Global_1953292 && bParam0 != false;
}

int func_93(int iParam0) // Position - 0x372A
{
	int i;
...
void func_94(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3762
{
	func_199(&(Global_1953292.f_2938), bParam0, bParam1, bParam2, bParam3, bParam4);
	return;
}

Hash func_95(int iParam0, Hash hParam1) // Position - 0x377F
{
	int i;
	Hash hash;
...
BOOL func_96(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x37E8
{
	switch (func_190(hParam1))
	{
		...
		case 81053684:
			if (func_13(hParam1, -1303648999) && func_13(hParam0->f_1[1 /*3*/], -93469181))
				func_203(hParam1, bParam2, bParam3, bParam4, bParam5);
			break;
	}
...
BOOL func_97(Hash hParam0) // Position - 0x3888
{
	return !func_13(hParam0->f_1[1 /*3*/], -93469181);
}

BOOL func_98(int iParam0) // Position - 0x38A1
{
	return func_205(func_204(iParam0));
}

void func_99(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x38B3
{
	int i;
	Hash item;
	int inventoryId;
...
void func_100(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x394B
{
	int i;
	Hash item;
	int inventoryId;
...
void func_101(Hash hParam0, int iParam1) // Position - 0x39FF
{
	int i;
	Hash hash;
...
void func_102(int iParam0) // Position - 0x3A4D
{
	int i;
	Hash hash;
	int num;
...
void func_103() // Position - 0x3AB9
{
	Global_1149432.f_4787.f_7 = Global_1953292.f_1676.f_1[1 /*3*/];
	return;
}

void func_104() // Position - 0x3AD6
{
	int num;
	int i;
...
void func_105(var uParam0, var uParam1, int iParam2) // Position - 0x3B09
{
	int i;
...
int func_106(int iParam0) // Position - 0x3EA7
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_107(int iParam0) // Position - 0x3ECC
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_108(int iParam0) // Position - 0x3EDF
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_109(int iParam0) // Position - 0x3EF2
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_110(int iParam0) // Position - 0x3F05
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_111(int iParam0) // Position - 0x3F17
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_112(int iParam0, int iParam1) // Position - 0x3F29
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_113(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3FC3
{
...
BOOL func_114(int iParam0) // Position - 0x3FFB
{
	int num;
	int num2;
	int num3;
...
void func_115(BOOL bParam0) // Position - 0x40DC
{
	Global_1953292 = Global_1953292 || bParam0;
	return;
}

void func_116(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x40EF
{
	int i;
	int num;
...
BOOL func_117(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x43EB
{
	var unk;
	int num;
	int i;
...
BOOL func_118(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x458A
{
	Hash hash;
	int num;
	BOOL flag;
...
void func_119(int iParam0) // Position - 0x46CF
{
	Global_1953292.f_1046 = iParam0;
	return;
}

BOOL func_120(Hash hParam0, int iParam1) // Position - 0x46E0
{
	if (hParam0 == 0)
		return false;
...
int func_121(int iParam0) // Position - 0x46FA
{
	return func_245(func_244(iParam0));
}

BOOL func_122(Player plParam0) // Position - 0x470C
{
	float num;
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4727
{
	int num;
	int i;
	int j;
...
int func_125(int iParam0, int iParam1) // Position - 0x48EA
{
	if (iParam1 == 2)
		iParam1 = func_121(2);
...
void func_126(int iParam0, int iParam1, int iParam2) // Position - 0x493C
{
	if (iParam2 == 2)
		iParam2 = func_121(2);
...
void func_127(int iParam0, int iParam1, int iParam2) // Position - 0x4992
{
	if (iParam2 == 2)
		iParam2 = func_121(2);
...
BOOL func_128(Ped pedParam0, int iParam1, float fParam2) // Position - 0x49E8
{
...
void func_129(int iParam0, int iParam1, int iParam2) // Position - 0x4A3D
{
	if (iParam2 == 2)
		iParam2 = func_121(2);
...
void func_130(Ped pedParam0, int iParam1, float fParam2) // Position - 0x4A9E
{
	char* StringToTest;

	StringToTest = func_248(iParam1);
...
void func_131(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x4ACA
{
	int num;
...
BOOL func_132(int iParam0, BOOL bParam1) // Position - 0x4B00
{
	return func_42(func_40(), iParam0, bParam1);
}

float func_133(int iParam0, int iParam1) // Position - 0x4B14
{
	if (iParam1 == 2)
		iParam1 = func_121(1);
...
int func_134(float fParam0) // Position - 0x4B60
{
	float num;
...
float func_135(float fParam0, float fParam1, float fParam2) // Position - 0x4B8B
{
	if (fParam0 > fParam2)
		return fParam2;
...
int func_136(int iParam0, float fParam1, int iParam2) // Position - 0x4BB2
{
	if (!func_252(iParam0))
		return 0;
...
void func_137(int iParam0, var uParam1, var uParam2) // Position - 0x4C03
{
	int num;
...
BOOL func_138(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4C1F
{
...
void func_139(int iParam0, int iParam1) // Position - 0x4CC1
{
	int Variable;
...
BOOL func_140(int iParam0) // Position - 0x4CE5
{
	switch (iParam0)
	{
		case 0:
...
char* func_141(int iParam0) // Position - 0x4D14
{
	switch (iParam0)
	{
		case 0:
...
void func_142(int iParam0) // Position - 0x4D4B
{
	Ped ped;
	int num;
...
void func_143(int iParam0) // Position - 0x4D88
{
	Ped ped;
	int num;
...
void func_144(int iParam0, BOOL bParam1) // Position - 0x4DC5
{
	int num;
...
void func_145(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4DFA
{
	func_56(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

int func_146(int iParam0) // Position - 0x4E14
{
	switch (iParam0)
	{
		case 1:
...
struct<2> func_147(int iParam0) // Position - 0x51AA
{
	var unk;
...
BOOL func_148(int iParam0) // Position - 0x51BC
{
...
var func_149(Any* panParam0, int iParam1, int iParam2) // Position - 0x51F7
{
	var unk;
...
void func_150(int iParam0) // Position - 0x5212
{
	Global_1953292.f_1 = iParam0;
	return;
}

void func_151() // Position - 0x5222
{
	func_260(128);
	return;
}

void func_152(BOOL bParam0) // Position - 0x5230
{
	Global_1953292 = Global_1953292 - Global_1953292 && bParam0;
	return;
}

BOOL func_153(int iParam0, var uParam1) // Position - 0x5248
{
	int num;
...
int func_154(int iParam0) // Position - 0x52A5
{
...
void func_155(int iParam0) // Position - 0x5337
{
	Global_1953292.f_3 = iParam0;
	return;
}

int func_156(int iParam0) // Position - 0x5347
{
	if (iParam0 == 255)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x5392
{
...
int func_158(int iParam0) // Position - 0x53BC
{
...
void func_159(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x53D9
{
	func_266(iParam0);
...
int func_160(int iParam0) // Position - 0x543B
{
...
void func_161(var uParam0) // Position - 0x5458
{
	var unk;
...
void func_162(float* pfParam0) // Position - 0x546A
{
	var unk;
...
void func_164(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x54D2
{
	switch (uParam0.f_5)
	{
		case 1:
...
int func_165(int iParam0, int iParam1) // Position - 0x54FF
{
	switch (iParam0)
	{
...
int func_166(int iParam0, int iParam1) // Position - 0x5BB6
{
	Player player;
	Player player2;
	int num;
...
int func_167(int iParam0, int iParam1, int iParam2) // Position - 0x5C39
{
	int num;
	int num2;
...
void func_168(int iParam0) // Position - 0x5D31
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_169(int iParam0, int iParam1) // Position - 0x5D47
{
	switch (iParam0)
	{
...
int func_173(int iParam0, int iParam1) // Position - 0x6671
{
	Player player;
	Player player2;
	int num;
...
int func_174(int iParam0, int iParam1, int iParam2) // Position - 0x66EC
{
	int num;
	BOOL flag;
	int num2;
...
BOOL func_175(int iParam0) // Position - 0x67C3
{
	int num;
...
BOOL func_176(int iParam0) // Position - 0x67EA
{
	int num;
...
BOOL func_177(int iParam0) // Position - 0x6812
{
	int num;
...
BOOL func_178(int iParam0) // Position - 0x683A
{
	int num;
...
BOOL func_179(int iParam0) // Position - 0x6862
{
	int num;
...
BOOL func_180(int iParam0) // Position - 0x688A
{
	int num;
...
void func_181(int iParam0) // Position - 0x68B2
{
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		if (iParam0 == 1)
...
BOOL func_182(int iParam0) // Position - 0x68F5
{
	return func_286(Global_1940085.f_38, iParam0);
}

struct<4> func_183(BOOL bParam0) // Position - 0x6909
{
	int num;
...
int func_184(Hash hParam0) // Position - 0x69A9
{
	var unk;
...
struct<4> func_185(BOOL bParam0) // Position - 0x69D4
{
	int num;
...
int func_186(Hash hParam0, BOOL bParam1) // Position - 0x6A75
{
...
BOOL func_187(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6AAC
{
	return func_288(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_188(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x6AC7
{
	var unk;
...
struct<4> func_189(BOOL bParam0) // Position - 0x6AE8
{
	int num;
...
int func_190(Hash hParam0) // Position - 0x6B52
{
	var unk;
...
BOOL func_191(Hash hParam0, int iParam1) // Position - 0x6B7D
{
	Hash hash;
	int num;
	int i;
...
BOOL func_192(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6BEA
{
	return func_291(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_193(Hash hParam0, int iParam1) // Position - 0x6C00
{
	if (iParam1 == 0)
		return 0;
...
struct<4> func_194() // Position - 0x6C2C
{
	var unk;
...
BOOL func_195(Hash hParam0, Any* panParam1) // Position - 0x6C38
{
	int num;
...
BOOL func_196(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x6E0E
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

int func_197(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x6E25
{
	if (bParam0)
	{
...
int func_198(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x6E6E
{
	if (bParam0)
	{
		func_293(iParam1, 1, 0, 0);
...
void func_199(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x6E8A
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_200(Hash hParam0) // Position - 0x6FC9
{
	!func_3(hParam0, 0);
...
int func_201(Hash hParam0) // Position - 0x6FEF
{
	int num;
...
BOOL func_202(BOOL bParam0, int iParam1) // Position - 0x700B
{
	if (iParam1 == -1)
...
void func_203(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x704E
{
	BOOL flag;
	var unk;
	var unk120;
...
int func_204(int iParam0) // Position - 0x71D4
{
	switch (iParam0)
	{
		case -2061583405:
...
BOOL func_205(int iParam0) // Position - 0x722F
{
	return Global_1953292.f_3352.f_33.f_6 && iParam0 != false;
}

int func_206(int iParam0, BOOL bParam1) // Position - 0x7247
{
	switch (iParam0)
	{
		case -2061583405:
...
void func_207(BOOL bParam0, int iParam1) // Position - 0x72EA
{
	char* StringToTest;
	char* str;
	char* str2;
	...
	if (!func_305(hash, &StringToTest, joaat("Inventory"), 0, 0, joaat("ui_itemviewer")))
	{
	...
	func_308(func_307(MISC::VAR_STRING(10, str, MISC::VAR_STRING(0, func_306(iParam1))), num), StringToTest.f_1, MISC::GET_HASH_KEY(StringToTest), 0, num, "Transaction_Feed_Sounds", str2, 0, true);
	return;
}

void func_208(int iParam0, int iParam1) // Position - 0x73AB
{
	Global_1953292.f_3352.f_33.f_6 = Global_1953292.f_3352.f_33.f_6 || iParam0;
	return;
}

void func_209(int iParam0, int iParam1) // Position - 0x73CC
{
	Global_1953292.f_3352.f_33.f_6 = Global_1953292.f_3352.f_33.f_6 - Global_1953292.f_3352.f_33.f_6 && iParam0;
	return;
}

Vector3 func_210(int iParam0, int iParam1) // Position - 0x73F9
{
	if (iParam1 == -1)
		iParam1 = Global_17418.f_55.f_664.f_1777;
...
void func_211(Hash hParam0, int iParam1, int iParam2) // Position - 0x742C
{
	Global_17418.f_55.f_664.f_33[iParam2 /*120*/].f_1.f_1[iParam1 /*3*/] = { *hParam0 };
	return;
}

int func_212(int iParam0) // Position - 0x7450
{
	var unk;
...
int func_213(int iParam0, int iParam1) // Position - 0x7473
{
	switch (iParam0)
	{
		case -1944638739:
...
var func_214(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7644
{
	if (bParam0)
		return uParam1;
...
void func_215(int iParam0, int iParam1) // Position - 0x765B
{
	if (iParam1 < 0)
		return;
...
void func_216(int iParam0, int iParam1) // Position - 0x76E1
{
...
void func_217(int iParam0, int iParam1) // Position - 0x771D
{
	int num;
	int num2;
...
void func_218(int iParam0, int iParam1) // Position - 0x7770
{
...
void func_219(int iParam0, int iParam1) // Position - 0x77AB
{
...
void func_220(int iParam0, int iParam1) // Position - 0x77E4
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_221(int iParam0) // Position - 0x781C
{
	return Global_1953292.f_595[iParam0] > 0;
}

void func_222(int iParam0) // Position - 0x7831
{
	Global_1953292.f_595[iParam0] = Global_1953292.f_595[iParam0] + 1;
	return;
}

void func_223() // Position - 0x7851
{
	int i;
...
int func_224(Hash hParam0) // Position - 0x7898
{
	int i;
...
void func_225(int iParam0) // Position - 0x78D3
{
	func_234(iParam0, 8, 6);
	return;
}

BOOL func_226(Hash hParam0, BOOL bParam1) // Position - 0x78E4
{
	!func_3(hParam0, 0);
...
void func_227(Hash hParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x792F
{
	int num;
	Hash hash;
	...
	if (bParam3)
	{
		if (*uParam1 == 832230214 || *uParam1 == 30652334 || *uParam1 == 750544038)
		{
			...
			if (func_190(hParam0->f_1[num /*3*/]) != 1882579758)
				return;
		
			hash = func_309(hParam0->f_1[num /*3*/]);
...
void func_228(int iParam0) // Position - 0x79DD
{
	func_311(&(Global_1953292.f_2938), iParam0);
	return;
}

void func_229(int iParam0, int iParam1) // Position - 0x79F2
{
	if (iParam1 & 8 != 0)
		return;
...
void func_230(Hash hParam0, int iParam1, int iParam2) // Position - 0x7A15
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

void func_231(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x7A28
{
	Hash hash;
	BOOL flag;
	...
	if (bParam3 && func_13(hParam0->f_1[iParam2 /*3*/], 343781202))
		func_313(hParam0, hParam0->f_1[iParam2 /*3*/]);

	switch (func_233(iParam2, 1))
	{
		case -1944638739:
			func_329(hParam0, flag, hash, iParam4);
			break;
	
		case -1197751823:
			func_322(hParam0, flag, hash, iParam4);
			break;
	
		case joaat("MP_COMPONENT_TYPE_HAIR"):
			func_314(hParam0, hash, iParam2, iParam4);
			break;
	
		case -893163968:
			func_320(hParam0, flag, hash, iParam4);
			break;
	
		case -450913544:
			func_321(hParam0, flag, hash, iParam2, iParam4);
			break;
	
		case -426430150:
			func_326(hParam0, flag, iParam4);
			break;
	
		case -338487716:
			func_316(hParam0, hash, flag, iParam4);
			break;
	
		case joaat("MP_COMPONENT_TYPE_LOADOUT_2"):
			func_325(hParam0, flag, hash, iParam4);
			break;
	
		case 304805134:
			func_323(hParam0, flag, hash, iParam4);
			break;
	
		case 788010710:
			func_327(hParam0, flag, hash, iParam4);
			break;
	
		case 1108822547:
			func_317(hParam0, flag, hash, iParam4);
			break;
	
		case 1145151482:
			func_324(hParam0, flag, hash, iParam4);
			break;
	
		case 1250092473:
			func_319(hParam0, flag, hash, iParam4);
			break;
	
		case joaat("MP_COMPONENT_TYPE_BEARD"):
			func_315(hParam0, hash, iParam2);
			break;
	
		case 1742327865:
			func_318(hParam0, flag, hash, iParam4);
			break;
	
		case 1958421083:
			func_328(hParam0, flag, hash, iParam4);
			break;
	}
...
Hash func_232(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x7BC1
{
	BOOL flag;
...
int func_233(int iParam0, int iParam1) // Position - 0x7C22
{
	switch (iParam0)
	{
		case 0:
...
void func_234(int iParam0, int iParam1, int iParam2) // Position - 0x7E71
{
...
BOOL func_235(var uParam0, int iParam1) // Position - 0x7EB0
{
	return uParam0->f_8 && iParam1 != false;
}

Hash func_236(Hash hParam0) // Position - 0x7EC1
{
...
int func_237(var uParam0, int iParam1) // Position - 0x7F36
{
	int i;
...
int func_238(Hash hParam0) // Position - 0x7F84
{
	switch (hParam0)
	{
...
int func_239(var uParam0, var uParam1, int iParam2) // Position - 0x806C
{
	int num;
...
void func_240(var uParam0, var uParam1, int iParam2) // Position - 0x80A2
{
	int i;
...
BOOL func_241(var uParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x80FC
{
	int num;
...
void func_242(var uParam0, var uParam1, var uParam2) // Position - 0x8154
{
	int num;
...
int func_243(var uParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8244
{
	var unk;
	int i;
	var unk19;
...
BOOL func_244(int iParam0) // Position - 0x8327
{
	return func_338(&(Global_1956875.f_1565), iParam0, 1);
}

int func_245(BOOL bParam0) // Position - 0x833D
{
	if (bParam0)
		return 1;
...
float func_246(Player plParam0) // Position - 0x834F
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_339(2);
}

int func_247(int iParam0) // Position - 0x8365
{
	switch (iParam0)
	{
		case 0:
...
char* func_248(int iParam0) // Position - 0x8394
{
	switch (iParam0)
	{
		case 0:
...
char* func_249(int iParam0) // Position - 0x83CE
{
	switch (iParam0)
	{
		case 0:
...
void func_250(int iParam0, float fParam1, int iParam2) // Position - 0x8408
{
	if (iParam2 == 2)
		iParam2 = func_121(2);
...
void func_251(int iParam0, int iParam1, int iParam2) // Position - 0x845A
{
	if (iParam2 == 2)
		iParam2 = func_121(2);
...
BOOL func_252(int iParam0) // Position - 0x84B0
{
	if (func_140(iParam0))
		return true;
...
void func_253(int iParam0, float fParam1, int iParam2) // Position - 0x84D6
{
	if (fParam1 < 0f)
		return;
...
BOOL func_254(int iParam0, int iParam1) // Position - 0x8532
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_255(int iParam0) // Position - 0x854A
{
...
BOOL func_256(int iParam0) // Position - 0x8561
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_257(int iParam0, int iParam1) // Position - 0x862D
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_258(int iParam0) // Position - 0x8646
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_259() // Position - 0x8659
{
	if (!func_341())
		return false;
...
void func_260(int iParam0) // Position - 0x8674
{
	func_342(&Global_1300385, iParam0);
	return;
}

int func_261(int iParam0, int iParam1) // Position - 0x8686
{
	int num;
...
int func_262(int iParam0) // Position - 0x86B3
{
	return Global_1300387.f_52[iParam0 /*3*/].f_1;
}

int func_263(Any anParam0, int iParam1) // Position - 0x86C7
{
	anParam0->f_2 = iParam1;
	return DATAFILE::_PARSEDDATA_RQ_GET_NUM_NODES(anParam0);
}

int func_264(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x86DB
{
	return func_149(&uParam0, 61, 0);
}

BOOL func_265(Any* panParam0, int iParam1, int iParam2) // Position - 0x86EC
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_271(BOOL bParam0) // Position - 0x87BB
{
	if (func_345(bParam0))
		return;
...
BOOL func_272(Any* panParam0, int iParam1, int iParam2) // Position - 0x87E2
{
	int num;
	int offset;
	BOOL isBitSet;
...
Player func_273(int iParam0) // Position - 0x8815
{
	if (func_175(iParam0))
...
BOOL func_274(int iParam0) // Position - 0x8836
{
	int num;
...
BOOL func_275(int iParam0, int iParam1, int iParam2) // Position - 0x885E
{
	int num;
	int num2;
	int num3;
...
BOOL func_276(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x8A4F
{
	return uParam0.f_4 != 0;
}

BOOL func_277(int iParam0, int iParam1) // Position - 0x8A5D
{
	int num;
...
Vector3 func_278(int iParam0) // Position - 0x8A9D
{
	int num;
	var unk;
...
BOOL func_279(int iParam0, var uParam1, var uParam2) // Position - 0x8AD9
{
	if (!func_274(iParam0))
		return false;
...
BOOL func_280(int iParam0, int iParam1, int iParam2) // Position - 0x8B10
{
	int num;
	int num2;
	int num3;
...
void func_281(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8D3E
{
	int num;
...
void func_282(int iParam0) // Position - 0x8DBD
{
	int num;
...
BOOL func_283(int iParam0) // Position - 0x8E12
{
...
BOOL func_284(int iParam0) // Position - 0x8E30
{
	int num;
...
Vector3 func_285(int iParam0) // Position - 0x8E5D
{
	var unk;
	int num;
...
BOOL func_286(int iParam0, int iParam1) // Position - 0x8E9E
{
	return iParam0 && iParam1 != false;
}

int func_287() // Position - 0x8EAD
{
...
int func_288(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x8ECA
{
...
BOOL func_289(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x8F49
{
	int inventoryId;
...
BOOL func_290(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x8F8E
{
...
BOOL func_291(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x8FC1
{
...
BOOL func_292(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x8FFB
{
...
void func_293(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9013
{
	int i;
...
BOOL func_294(int iParam0) // Position - 0x90B1
{
...
void func_295(int iParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x913F
{
	if (bParam1)
...
BOOL func_296(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x919B
{
	var unk;
	var unk6;
...
void func_297(int iParam0, BOOL bParam1, int iParam2) // Position - 0x91D0
{
...
void func_298(BOOL bParam0, BOOL bParam1) // Position - 0x91F8
{
	if (bParam1)
		func_91();
...
int func_299(Hash hParam0) // Position - 0x922A
{
	switch (hParam0)
	{
		case -2011879201:
...
BOOL func_300(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x92AC
{
	int i;
	BOOL flag;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_301(var uParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6, BOOL bParam7, BOOL bParam8, int iParam9) // Position - 0x938C
{
	int num;
	int num2;
	BOOL flag;
...
void func_302(BOOL bParam0, Hash hParam1) // Position - 0x95BB
{
	char* StringToTest;
	char* str;
	char* str2;
	...
	if (!func_305(hParam1, &StringToTest, joaat("Inventory"), 0, 0, joaat("ui_itemviewer")))
	{
		StringToTest = "_PLACEHOLDER";
		StringToTest.f_1 = "inventory_items";
	}
	...
	if (bParam0)
	{
		...
		else
		{
			...
			str = "ITEM_STORED";
			str3 = MISC::VAR_STRING(0, func_378(hParam1, false));
		}
	}
	else
	{
	...
	str4 = func_307(MISC::VAR_STRING(10, str, str3), num);
	func_308(str4, StringToTest.f_1, MISC::GET_HASH_KEY(StringToTest), 0, num, "Transaction_Feed_Sounds", str2, 0, true);
	return;
}

void func_303() // Position - 0x9719
{
	int i;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_305(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x9828
{
	int i;
	Hash hashKey;
	Hash hashKey2;
 ...
 func_306(int iParam0) // Position - 0x991B
{
	switch (iParam0)
	{
		case -2061583405:
...
const char* func_307(const char* sParam0, int iParam1) // Position - 0x9956
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

int func_308(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x9970
{
	int num;
	var unk13;
	int num2;
...
Hash func_309(Hash hParam0) // Position - 0x99D3
{
	int num;
	var unk;
...
BOOL func_310(Hash hParam0, int iParam1) // Position - 0x9A17
{
	int num;
...
void func_311(int iParam0, int iParam1) // Position - 0x9ABE
{
	int i;
	int num;
	var unk;
...
void func_312(int iParam0, int iParam1, int iParam2) // Position - 0x9BBB
{
	int i;
	int j;
...
void func_313(var uParam0, var uParam1) // Position - 0x9CA1
{
	int num;
	int num2;
	int num3;
...
void func_314(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x9D54
{
	int num;
	int num2;
...
void func_315(var uParam0, Hash hParam1, int iParam2) // Position - 0x9F29
{
...
void func_316(var uParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0x9F6E
{
	int num;
	Hash hash;
...
void func_317(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xA037
{
...
void func_318(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xA071
{
	int num;
...
void func_319(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xA1B1
{
	int num;
	int metapedType;
	Hash hash;
...
void func_320(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xA49A
{
	int num;
...
void func_321(var uParam0, BOOL bParam1, Hash hParam2, int iParam3, int iParam4) // Position - 0xA4F9
{
	switch (func_190(hParam2))
	{
		case 698653232:
...
void func_322(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xA537
{
	switch (func_190(hParam2))
	{
		case -1080198344:
...
void func_323(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xA57B
{
	int num;
...
void func_324(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xA617
{
	int num;
...
void func_325(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xA726
{
	int num;
...
void func_326(var uParam0, BOOL bParam1, int iParam2) // Position - 0xA7C5
{
	int num;
...
void func_327(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xA82A
{
	switch (func_190(hParam2))
	{
		case -1740828670:
...
void func_328(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xA8BA
{
	switch (func_190(hParam2))
	{
		case -923693316:
...
void func_329(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xA8F8
{
	int num;
	Hash hash;
...
int func_330() // Position - 0xAA27
{
	return Global_1953292.f_1;
}

int func_331(Hash hParam0, BOOL bParam1, Hash hParam2) // Position - 0xAA35
{
	int i;
...
BOOL func_332(Hash hParam0, int iParam1, var uParam2) // Position - 0xAA77
{
	*uParam2 = joaat("base");
	return 1;
}

BOOL func_333(Any* panParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0xAA88
{
	var unk;
	var unk2;
	var unk3;
...
void func_334(var uParam0, BOOL bParam1) // Position - 0xAC8E
{
	Hash hash;
	var unk;
	Hash hash2;
...
void func_335(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xAD26
{
	uParam0->f_2 = uParam1;
	uParam0->f_3 = uParam2;
	uParam0->f_4 = uParam3;
...
void func_336(var uParam0, var uParam1, int iParam2) // Position - 0xAD54
{
...
void func_337(var uParam0, var uParam1, BOOL bParam2) // Position - 0xAD92
{
	if (bParam2)
...
BOOL func_338(Any* panParam0, int iParam1, int iParam2) // Position - 0xAE39
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_339(int iParam0) // Position - 0xAE70
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_340(int iParam0) // Position - 0xAEB1
{
	switch (iParam0)
	{
		case 12:
...
void func_342(int iParam0, int iParam1) // Position - 0xAEEA
{
	func_414(iParam0, iParam1);
	return;
}

int func_343(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xAEFA
{
	int num;
...
int func_344(int iParam0, int iParam1) // Position - 0xAF66
{
	return Global_1300387.f_84[iParam0 /*21*/][iParam1 /*2*/].f_1;
}

BOOL func_345(BOOL bParam0) // Position - 0xAF7E
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

int func_346(int iParam0, int iParam1) // Position - 0xAF94
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_347(int iParam0) // Position - 0xB3CD
{
	int num;
...
float func_348(int iParam0) // Position - 0xB3F5
{
	float num;
...
void func_349(int iParam0) // Position - 0xB424
{
	int num;
	int num2;
	int i;
...
BOOL func_350(int iParam0) // Position - 0xB603
{
	int num;
...
int func_351(int iParam0, int iParam1) // Position - 0xB62B
{
	switch (iParam0)
	{
...
void func_352(int iParam0) // Position - 0xB93B
{
	Ped ped;
	Player player;
...
BOOL func_353(int iParam0) // Position - 0xBB4A
{
	int num;
...
int func_354(int iParam0, int iParam1) // Position - 0xBB71
{
	switch (iParam0)
	{
...
int func_355(int iParam0) // Position - 0xBBCE
{
	int num;
	var unk;
	var unk32;
...
void func_356(int iParam0) // Position - 0xBD12
{
	int num;
	int num2;
	int i;
...
BOOL func_357(int iParam0) // Position - 0xBE67
{
	BOOL flag;
...
void func_358(int iParam0) // Position - 0xBE90
{
	Ped EntityIndex;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_422(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_428(iParam0, 0));
			func_429(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_428(iParam0, 1));
			func_429(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_428(iParam0, 2));
			func_429(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_428(iParam0, 3));
			func_429(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_359(int iParam0) // Position - 0xC12F
{
	char* StringToTest;
	char* StringToTest2;
	...
	StringToTest = func_431(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	StringToTest2 = func_432(iParam0);
...
int func_360(int iParam0) // Position - 0xC179
{
	int num;
...
int func_361(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC1A8
{
...
void func_362(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC1DB
{
	int i;
...
BOOL func_363(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xC2B7
{
	var unk;
...
void func_364(Hash hParam0, int iParam1) // Position - 0xC32B
{
	int i;
	...
	for (i = 0; i < 39; i = i + 1)
	{
		func_211(&hParam0->f_1[i /*3*/], i, iParam1);
	}

	return;
}

void func_365(BOOL bParam0, int iParam1, int iParam2) // Position - 0xC37C
{
	if (iParam1 == -1)
		iParam1 = Global_17418.f_55.f_664.f_1777;
...
int func_366(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC3C7
{
	var unk;
	var guid;
...
int func_367(int iParam0) // Position - 0xC419
{
	if (iParam0 == 0)
		iParam0 = func_330();
...
int func_368(int iParam0) // Position - 0xC455
{
	switch (iParam0)
	{
		case -1932005642:
...
// Unhandled jump detected. Output should be considered invalid
void func_369(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xC5F6
{
	int i;
	Hash hash;
	Hash hash2;
...
void func_370(int iParam0, int iParam1, int iParam2) // Position - 0xC6CF
{
	Global_1953292.f_83[func_213(iParam0, 1) /*12*/].f_11 = Global_1953292.f_83[func_213(iParam0, 1) /*12*/].f_11 || iParam1;
	return;
}

BOOL func_371(int iParam0) // Position - 0xC6FC
{
	int num;
	var unk;
...
int func_372(Hash hParam0) // Position - 0xC755
{
	var unk;
	int num;
...
void func_373(var uParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0xC78F
{
	int i;
	BOOL flag;
...
Hash func_374(Hash hParam0, int iParam1) // Position - 0xC89B
{
	int num;
	int num2;
	int num3;
	...
	num3 = 0;
	unk = { func_441(0, -1591664384, hParam0, -1591664384, 0, 0, 0) };
...
struct<8> func_375(int iParam0) // Position - 0xC8E8
{
	var unk;
...
const char* func_376(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xC91D
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

Hash func_377(Hash hParam0) // Position - 0xC931
{
	int num;
	var unk;
	int collectionId;
...
Hash func_378(Hash hParam0, BOOL bParam1) // Position - 0xC9B6
{
	Hash hash;
...
Hash func_379() // Position - 0xC9E4
{
	return Global_1953292.f_1676;
}

void func_380(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0xC9F3
{
...
void func_381(Any* panParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5) // Position - 0xCA24
{
	*panParam0 = iParam1;
...
BOOL func_382(var uParam0, int iParam1) // Position - 0xCA53
{
	return uParam0->f_1 && iParam1 != false;
}

void func_383(var uParam0, int iParam1, int iParam2) // Position - 0xCA64
{
	uParam0->f_1 = uParam0->f_1 || iParam1;
	return;
}

BOOL func_384(int iParam0, int iParam1) // Position - 0xCA77
{
	return iParam0->f_1 && iParam1 != false;
}

void func_385(int iParam0, int iParam1) // Position - 0xCA88
{
	iParam0->f_1 = iParam0->f_1 || iParam1;
	return;
}

void func_386(var uParam0, BOOL bParam1, int iParam2) // Position - 0xCA9B
{
	int num;
	Hash hash;
...
void func_387(var uParam0, BOOL bParam1, int iParam2) // Position - 0xCAFE
{
	int num;
...
BOOL func_388(Hash hParam0) // Position - 0xCB63
{
	if (!func_3(hParam0, 0))
		return false;
...
void func_389(var uParam0, BOOL bParam1, int iParam2) // Position - 0xCB9F
{
	int num;
...
BOOL func_390(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xCBEC
{
	int num;
...
BOOL func_391(int iParam0) // Position - 0xCC39
{
	return Global_17418.f_55.f_664.f_1734 && iParam0 != false;
}

void func_392(var uParam0, int iParam1) // Position - 0xCC51
{
	int num;
	BOOL flag;
...
void func_393(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xCD17
{
	int num;
...
void func_394(var uParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xCE1F
{
	int num;
	Hash hash;
...
void func_395(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xCF01
{
	int num;
	Hash hash;
...
void func_396(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xD16E
{
	int num;
...
void func_399(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xD377
{
	int num;
	Hash hash;
	BOOL flag;
...
void func_400(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xD61F
{
	int num;
	Hash hash;
...
void func_401(var uParam0, BOOL bParam1, int iParam2) // Position - 0xD780
{
	int num;
	Hash hash;
...
void func_402(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xD935
{
	int num;
	Hash hash;
...
void func_403(var uParam0, BOOL bParam1, int iParam2) // Position - 0xDB70
{
	int num;
...
void func_404(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xDD68
{
	int num;
	Hash hash;
...
void func_405(var uParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xDE85
{
	int num;
...
void func_406(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xDEE4
{
	int num;
...
int func_407(int iParam0) // Position - 0xDFDB
{
	switch (iParam0)
	{
		case -897347426:
...
Hash func_408(int iParam0) // Position - 0xE00A
{
	switch (iParam0)
	{
		case -2118203104:
...
Hash func_409(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0xE117
{
	return func_453(&uParam0, hParam4, bParam5, iParam6);
}

struct<18> func_410(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xE12B
{
	var unk;
	var unk19;
...
float func_411(int iParam0) // Position - 0xE1A0
{
	return func_135(BUILTIN::TO_FLOAT(iParam0) / 10000f, 0.001f, 1f);
}

void func_412(var uParam0, var uParam1) // Position - 0xE1BE
{
	int i;
	int num;
	var unk;
...
void func_413(var uParam0, var uParam1) // Position - 0xE28A
{
...
void func_414(int iParam0, int iParam1) // Position - 0xE2BE
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

float func_415(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0xE2CF
{
	var unk;
	float num;
...
BOOL func_416(int iParam0) // Position - 0xE305
{
...
BOOL func_417(int iParam0) // Position - 0xE374
{
	int num;
...
int func_418(int iParam0, int iParam1) // Position - 0xE39B
{
	switch (iParam0)
	{
...
char* func_421(int iParam0) // Position - 0xE48A
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_422(int iParam0) // Position - 0xE4D1
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_423(int iParam0) // Position - 0xE50C
{
	int i;
...
BOOL func_425(int iParam0, int iParam1) // Position - 0xE56C
{
	int num;
	Player player;
	int num2;
...
struct<31> func_426(int iParam0) // Position - 0xE841
{
	int num;
...
BOOL func_427(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0xE865
{
	var unk;
	BOOL flag;
...
char* func_428(int iParam0, int iParam1) // Position - 0xE89B
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_429(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xE8F3
{
	int i;
...
char* func_431(int iParam0) // Position - 0xE99D
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_432(int iParam0) // Position - 0xE9BD
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_433(Hash hParam0) // Position - 0xE9DD
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

void func_434(int iParam0) // Position - 0xE9EB
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
int func_435(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xEA0E
{
	int num;
	var unk;
	int num2;
...
BOOL func_436(var uParam0, int iParam1) // Position - 0xEB51
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_437(int iParam0, int iParam1) // Position - 0xEB62
{
...
BOOL func_438(int iParam0, int iParam1) // Position - 0xEB91
{
	return Global_1953292.f_83[iParam0 /*12*/].f_11 && iParam1 != false;
}

void func_439(int iParam0, int iParam1, int iParam2) // Position - 0xEBAA
{
	Global_1953292.f_83[iParam0 /*12*/].f_11 = Global_1953292.f_83[iParam0 /*12*/].f_11 - Global_1953292.f_83[iParam0 /*12*/].f_11 && iParam1;
	return;
}

void func_440(int iParam0, int iParam1, int iParam2) // Position - 0xEBDA
{
	Global_1953292.f_83[iParam0 /*12*/].f_11 = Global_1953292.f_83[iParam0 /*12*/].f_11 || iParam1;
	return;
}

struct<18> func_441(int iParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xEBFD
{
	int num;
...
BOOL func_442(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0xECDB
{
...
int func_443(int iParam0, int iParam1, int iParam2) // Position - 0xED00
{
	int i;
	var unk;
	int num;
...
int func_444(int iParam0) // Position - 0xEDCD
{
	if (iParam0 < 0)
		return 0;
...
Hash func_445(int iParam0) // Position - 0xEDEE
{
	switch (iParam0)
	{
		case 1:
...
int func_446(Hash hParam0) // Position - 0xEE8B
{
	var unk;
	int num;
...
struct<10> func_447(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0xEEC5
{
	int num;
...
BOOL func_448(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0xEF99
{
...
BOOL func_449(Hash hParam0) // Position - 0xEFBA
{
	!func_3(hParam0, 0);
...
int func_450(int iParam0) // Position - 0xEFE0
{
	if (iParam0 < 0)
		return 0;
...
Hash func_451(Hash hParam0, BOOL bParam1) // Position - 0xF001
{
	switch (hParam0)
	{
...
void func_452(var uParam0, int iParam1, int iParam2) // Position - 0xF0A3
{
	int num;
...
int func_453(Any* panParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0xF137
{
	var unk;
...
BOOL func_454(Hash hParam0, Hash hParam1, var uParam2) // Position - 0xF165
{
	int num;
	int num2;
...
BOOL func_455() // Position - 0xF386
{
	return Global_1572887.f_7;
}

BOOL func_456() // Position - 0xF394
{
	if (!Global_1048577)
		return false;
...
BOOL func_457(Player plParam0) // Position - 0xF3DF
{
...
BOOL func_458(int iParam0, Player plParam1) // Position - 0xF424
{
	if (plParam1 == 255)
...
void func_459(var uParam0) // Position - 0xF450
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
struct<29> func_460(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xF4AB
{
	var unk;
	var unk30;
...
int func_461(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0xF546
{
	int num;
...
struct<26> func_462(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xF5B0
{
	var unk;
	var unk27;
...
int func_463(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0xF633
{
	int num;
...
int func_464(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0xF683
{
	int num;
...
BOOL func_465(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0xF6ED
{
	if (iParam2 < 0)
		return false;
...
BOOL func_468(int iParam0, int iParam1) // Position - 0xF7A3
{
	return iParam0 && iParam1 != false;
}

BOOL func_469(Any* panParam0, Hash hParam1, Any* panParam2, BOOL bParam3, int iParam4) // Position - 0xF7B2
{
	var outGuid;
...
int func_470(int iParam0) // Position - 0xF800
{
	int num;
...
struct<2> func_471(int iParam0) // Position - 0xF836
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_472(var uParam0, var uParam1) // Position - 0xF84A
{
	if (!func_479(uParam0))
		return false;
...
void func_475(Player plParam0) // Position - 0xF8E3
{
	Player player;
...
BOOL func_476(int iParam0, Hash hParam1, Any* panParam2) // Position - 0xF966
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 29, panParam2, 0);
}

BOOL func_477(int iParam0, Hash hParam1, Any* panParam2) // Position - 0xF97D
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 26, panParam2, 0);
}

BOOL func_478(int iParam0, Hash hParam1, Any* panParam2) // Position - 0xF994
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

BOOL func_479(int iParam0) // Position - 0xF9AB
{
	switch (iParam0)
	{
		case 2:
...
int func_480(int iParam0) // Position - 0xF9EA
{
	switch (iParam0)
	{
		case 2:
...
void func_481(Player plParam0) // Position - 0xFA80
{
	Player player;
...
void func_482(Player plParam0) // Position - 0xFAEC
{
