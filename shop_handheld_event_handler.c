...
void func_1(int iParam0) // Position - 0x137
{
	Global_1915656.f_22504.f_4 = iParam0;
	return;
}

BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0x14A
{
	int i;
...
BOOL func_3() // Position - 0x22A
{
	return Global_1102813.f_3664;
}

void func_4(int iParam0) // Position - 0x239
{
