...
BOOL func_2(int iParam0) // Position - 0x7E4
{
	switch (iParam0)
	{
		case 1:
...
void func_3(var uParam0) // Position - 0x851
{
...
struct<2> func_4(int iParam0) // Position - 0x8B3
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_5(int iParam0, var uParam1) // Position - 0x8C7
{
	return iParam0;
}

BOOL func_6(int iParam0) // Position - 0x8D1
{
	return func_50(&(Global_3145858.f_6), iParam0);
}

void func_7(var uParam0, int iParam1) // Position - 0x8E5
{
	if (!func_45(iParam1))
		return;
...
int func_8() // Position - 0x90E
{
	return Global_1902569;
}

int func_9(int iParam0) // Position - 0x91A
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

BOOL func_10(int iParam0) // Position - 0x92D
{
	switch (iParam0)
	{
		case 40:
...
int func_11(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x958
{
	float num;
	float num2;
	int num3;
...
int func_12(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x9D2
{
	int num;
...
BOOL func_13(var uParam0) // Position - 0xA23
{
	return uParam0->f_22 != 3;
}

void func_14(var uParam0) // Position - 0xA31
{
	var unk;
	var unk8;
...
void func_15(var uParam0) // Position - 0xAE9
{
	var unk;
	var unk8;
	int randomIntInRange;
...
BOOL func_16(var uParam0) // Position - 0xB43
{
...
BOOL func_17(var uParam0) // Position - 0xBB7
{
...
void func_18(var uParam0) // Position - 0xBE6
{
	BOOL flag;
	int i;
...
void func_19(var uParam0) // Position - 0xCD1
{
...
int func_20(var uParam0) // Position - 0xD30
{
	return uParam0->f_13;
}

void func_21(var uParam0, int iParam1) // Position - 0xD3C
{
	uParam0->f_13 = iParam1;
	return;
}

BOOL func_22(int iParam0, var uParam1) // Position - 0xD4A
{
	int num;
...
void func_23(int iParam0, BOOL bParam1) // Position - 0xD9D
{
	int i;
...
BOOL func_24(int iParam0, int iParam1, int iParam2) // Position - 0xDDF
{
	int i;
...
BOOL func_26(var uParam0) // Position - 0xE6C
{
...
int func_27(var uParam0) // Position - 0xE85
{
	int i;
	int num;
	int value;
...
BOOL func_28(var uParam0) // Position - 0xFB8
{
	var unk;
	int groundSetting;
...
BOOL func_29(int iParam0) // Position - 0x1193
{
	switch (iParam0)
	{
		case 40:
...
void func_30(var uParam0) // Position - 0x11E1
{
	func_82(uParam0);
...
BOOL func_31(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x11F8
{
	int i;
	int num;
	int value;
...
void func_32(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x131C
{
	BOOL flag;
	BOOL flag2;
	float num;
...
void func_33(int iParam0, BOOL bParam1) // Position - 0x1543
{
	int num;
	int num2;
...
BOOL func_34(int iParam0, int iParam1) // Position - 0x1570
{
	if (iParam0 == -1)
		return false;
...
void func_35(int iParam0, int iParam1) // Position - 0x1590
{
	if (iParam0 == -1)
		return;
...
void func_36(int iParam0) // Position - 0x15C0
{
...
BOOL func_37(int iParam0, int iParam1) // Position - 0x15EB
{
	if (iParam0 <= -1)
		return false;
...
void func_38(int iParam0, int iParam1) // Position - 0x1610
{
	if (iParam0 <= -1)
		return;
...
BOOL func_42(var uParam0, var uParam1, BOOL bParam2, var uParam3) // Position - 0x17BD
{
...
void func_43(var uParam0) // Position - 0x1916
{
	var unk;
	int i;
	int j;
...
int func_44(var uParam0) // Position - 0x19C2
{
	return uParam0->f_10;
}

BOOL func_45(int iParam0) // Position - 0x19CE
{
	return iParam0 != 5;
}

int func_46(var uParam0) // Position - 0x19DA
{
	return uParam0->f_9;
}

void func_47(var uParam0, int iParam1) // Position - 0x19E6
{
	if (!func_45(iParam1))
		return;
...
void func_48(var uParam0) // Position - 0x1A0F
{
	BOOL flag;
	int i;
...
void func_49(var uParam0, int iParam1) // Position - 0x1AC8
{
	switch (uParam0->f_7)
	{
		case 0:
...
BOOL func_50(var uParam0, int iParam1) // Position - 0x1B7A
{
	int num;
	int offset;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1B9E
{
...
BOOL func_52(int iParam0) // Position - 0x1BC8
{
	if (iParam0 == -1)
		return false;
...
int func_53(int iParam0) // Position - 0x1BE3
{
	if (iParam0 == -1)
		return 0;
...
Vector3 func_54(int iParam0) // Position - 0x1BFC
{
	if (iParam0 == -1)
		return -1f, -1f, -1f;
...
float func_55(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x1C1D
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x1C3B
{
	var SourceStruct;
...
void func_57(int iParam0, var uParam1, var uParam2) // Position - 0x1C75
{
	int i;
	int randomIntInRange;
	var unk;
...
void func_58(int iParam0, int iParam1, int iParam2) // Position - 0x1D6A
{
	if (iParam0 > 500)
		return;
...
BOOL func_59(Ped pedParam0) // Position - 0x1D8C
{
...
BOOL func_60() // Position - 0x1DA9
{
	return Global_1893611 & true != 0 && func_111() != -1;
}

BOOL func_61(BOOL bParam0, BOOL bParam1) // Position - 0x1DC4
{
	int i;
...
BOOL func_62() // Position - 0x1EA4
{
	return func_112(Global_1572887.f_8, 1);
}

BOOL func_63(Player plParam0, int iParam1, BOOL bParam2) // Position - 0x1EB7
{
	Player player;
	int i;
...
int func_64(int iParam0) // Position - 0x1F35
{
	return Global_1205938.f_1[iParam0 /*26*/].f_3;
}

BOOL func_65(int iParam0) // Position - 0x1F49
{
	if (!func_114(iParam0))
		return false;
...
BOOL func_66(int iParam0) // Position - 0x1F67
{
	return iParam0 != -1;
}

BOOL func_67(Volume volParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1F73
{
...
BOOL func_68(int iParam0) // Position - 0x1F93
{
	return Global_20537[iParam0 /*9*/].f_2 != -15;
}

BOOL func_69(int iParam0, var uParam1) // Position - 0x1FA8
{
	return false;
}

int func_70(int iParam0) // Position - 0x1FB1
{
	return Global_20537[iParam0 /*9*/].f_2;
}

void func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x1FC2
{
	int num;
	int i;
	int num2;
...
BOOL func_72(int iParam0, BOOL bParam1) // Position - 0x214A
{
	return func_123(func_8(), iParam0, bParam1);
}

BOOL func_73(int iParam0, int iParam1) // Position - 0x215E
{
	if (iParam0 == -1)
		return false;
...
void func_74(int iParam0, int iParam1) // Position - 0x2185
{
	if (iParam0 <= -1)
		return;
...
void func_75(int iParam0, int iParam1) // Position - 0x21C2
{
	if (iParam0 == -1)
		return;
...
void func_76(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x21E8
{
	if (iParam0 <= -1)
		return;
...
Vector3 func_77(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x220C
{
	float num;
	float num2;
	float num3;
...
float func_78(float fParam0) // Position - 0x2250
{
	return fParam0 * 0.017453292f;
}

BOOL func_79(int iParam0) // Position - 0x2260
{
	switch (iParam0)
	{
		case 4:
...
void func_80(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x228D
{
	int num;
...
void func_81(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x22A8
{
	int i;
...
void func_82(var uParam0) // Position - 0x23CD
{
	if (uParam0->f_4 != -1)
	{
...
void func_83(int iParam0, int iParam1) // Position - 0x23FE
{
	if (func_106(iParam0))
...
BOOL func_84(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2417
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_85() // Position - 0x2516
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_86(var uParam0, int iParam1) // Position - 0x252B
{
	*uParam0 = iParam1;
	return;
}

void func_87(int iParam0) // Position - 0x2538
{
	if (iParam0 <= 0)
		return;
...
void func_88(var uParam0) // Position - 0x255F
{
	func_130(uParam0, 0f);
	return;
}

float func_89(var uParam0) // Position - 0x256E
{
	if (!func_103(uParam0))
		return uParam0->f_1;
...
void func_90(int iParam0, var uParam1, var uParam2) // Position - 0x25A3
{
	int num;
...
BOOL func_91(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x25BF
{
...
void func_92(int iParam0, int iParam1) // Position - 0x2661
{
	int Variable;
...
Hash func_93(int iParam0) // Position - 0x2685
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_94(int iParam0) // Position - 0x2A1B
{
	if (!func_114(iParam0))
		return false;
...
void func_95(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2A39
{
	if (!func_114(iParam0))
		return;
...
void func_96(int iParam0, int iParam1) // Position - 0x2A9B
{
	var statId;
...
void func_97(int iParam0, int iParam1) // Position - 0x2ACD
{
...
void func_98(int iParam0, BOOL bParam1, int iParam2) // Position - 0x2B11
{
	Hash num;
	int num2;
...
Hash func_99(int iParam0) // Position - 0x2B87
{
	switch (iParam0)
	{
		case 2:
...
void func_100(Hash hParam0) // Position - 0x2E42
{
	int num;
	var unk22;
	int i;
...
void func_101(Hash hParam0, int iParam1, BOOL bParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3186
{
	BOOL flag;
	int value;
	var unk;
...
void func_102(var uParam0, BOOL bParam1) // Position - 0x3655
{
...
BOOL func_103(var uParam0) // Position - 0x3675
{
	return func_182(*uParam0, 1);
}

void func_104(var uParam0, int iParam1) // Position - 0x3685
{
	*uParam0 = iParam1;
	return;
}

void func_105(var uParam0) // Position - 0x3692
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_106(int iParam0) // Position - 0x36A8
{
	if (*iParam0 == 0)
		return false;
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x36C0
{
	return iParam0 && iParam1 != false;
}

void func_108(var uParam0, int iParam1) // Position - 0x36CF
{
	uParam0->f_7 = iParam1;
	return;
}

Vector3 func_109(int iParam0) // Position - 0x36DD
{
	float num;
	int value;
	int value2;
...
BOOL func_110(float fParam0, var uParam1, var uParam2) // Position - 0x3739
{
	BOOL flag;
...
int func_111() // Position - 0x378E
{
	return Global_1893611.f_2;
}

BOOL func_112(BOOL bParam0, BOOL bParam1) // Position - 0x379C
{
	return bParam0 && bParam1 != false;
}

BOOL func_113(int iParam0, int iParam1, Player plParam2) // Position - 0x37AB
{
	return func_183(Global_1206166[plParam2 /*10*/][iParam0], iParam1);
}

BOOL func_114(int iParam0) // Position - 0x37C5
{
	return !(iParam0 <= 0);
}

BOOL func_115(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x37D2
{
	if (bParam2)
		if (!func_114(iParam0))
			return false;
...
int func_116(int iParam0) // Position - 0x3815
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_117(int iParam0) // Position - 0x383A
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_118(int iParam0) // Position - 0x384D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_119(int iParam0) // Position - 0x3860
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_120(int iParam0) // Position - 0x3872
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_121(int iParam0, int iParam1) // Position - 0x3884
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_122(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x391E
{
...
BOOL func_123(int iParam0, int iParam1, BOOL bParam2) // Position - 0x3956
{
	if (bParam2)
...
void func_124(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x3983
{
...
void func_125(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x39C5
{
	if (!func_106(uParam0))
	{
...
int func_126(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x39F9
{
...
BOOL func_127(BOOL bParam0) // Position - 0x3ABB
{
	if (bParam0)
...
BOOL func_128() // Position - 0x3AEB
{
	return func_197() != -1;
}

BOOL func_129() // Position - 0x3AF9
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_130(var uParam0, float fParam1) // Position - 0x3B1E
{
...
BOOL func_131(var uParam0) // Position - 0x3B44
{
	return func_182(*uParam0, 2);
}

float func_132() // Position - 0x3B54
{
...
BOOL func_133(int iParam0, int iParam1) // Position - 0x3B86
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_134(int iParam0) // Position - 0x3B9E
{
...
BOOL func_135(int iParam0) // Position - 0x3BB5
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_136(int iParam0, int iParam1) // Position - 0x3C81
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_137(int iParam0) // Position - 0x3C9A
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_138() // Position - 0x3CAD
{
	if (!func_200())
		return false;
...
void func_139(int iParam0) // Position - 0x3CC8
{
	switch (iParam0)
	{
		case 2:
...
void func_140(int iParam0, BOOL bParam1) // Position - 0x3ECE
{
	if (!func_114(iParam0))
		return;
...
void func_141(int iParam0, BOOL bParam1) // Position - 0x3EF4
{
	if (!func_114(iParam0))
		return;
...
BOOL func_142(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3F37
{
	if (Global_1572887.f_14 != -1)
	{
...
void func_143(BOOL bParam0, int iParam1) // Position - 0x40AF
{
...
struct<2> func_144(int iParam0, Hash hParam1) // Position - 0x40F5
{
	int num;
...
struct<2> func_145(int iParam0) // Position - 0x410B
{
	var unk;
...
void func_146(var uParam0, var uParam1, int iParam2) // Position - 0x411D
{
...
BOOL func_147(int iParam0) // Position - 0x413A
{
	switch (iParam0)
	{
		case 4:
...
int func_148(int iParam0) // Position - 0x416A
{
	switch (iParam0)
	{
...
BOOL func_149(Hash hParam0, Hash hParam1) // Position - 0x4345
{
	if (!func_161(hParam0, 0))
...
int func_150(Hash hParam0) // Position - 0x4386
{
	var unk;
...
float func_151(int iParam0, int iParam1) // Position - 0x43B1
{
	int num;
	float pedStamina;
	float pedMaxStamina;
...
void func_152(int iParam0) // Position - 0x4466
{
	Ped ped;
	int num;
...
void func_153(int iParam0, BOOL bParam1) // Position - 0x44A3
{
	int num;
...
void func_154(int iParam0) // Position - 0x44D8
{
	Ped ped;
	int num;
...
float func_155(float fParam0, float fParam1) // Position - 0x4515
{
	if (fParam1 != 0f)
...
void func_156(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4543
{
	if (fParam1 == 0f)
		return;
...
float func_157(float fParam0, int iParam1) // Position - 0x457C
{
	switch (iParam1)
	{
		case 0:
...
int func_158(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x45CE
{
...
void func_159(float fParam0, BOOL bParam1) // Position - 0x45F2
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
struct<2> func_160(int iParam0) // Position - 0x464A
{
	int num;
...
BOOL func_161(Hash hParam0, int iParam1) // Position - 0x465A
{
	if (hParam0 == 0)
		return false;
...
BOOL func_162() // Position - 0x4674
{
	return !Global_1913444;
}

void func_163(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x4681
{
	int i;
...
var func_164(BOOL bParam0, var uParam1, var uParam2) // Position - 0x47A4
{
	if (bParam0)
		return uParam1;
...
BOOL func_165(Hash hParam0, int iParam1) // Position - 0x47BB
{
	if (!func_161(hParam0, 0))
		return false;
...
int func_166(Hash hParam0) // Position - 0x47DA
{
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_167(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x4805
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_168(Hash hParam0) // Position - 0x48F8
{
...
BOOL func_169(Hash hParam0) // Position - 0x49F4
{
...
Hash func_170(Hash hParam0, BOOL bParam1) // Position - 0x4A73
{
	Hash hash;
...
BOOL func_171(int iParam0) // Position - 0x4AA1
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_172(Hash hParam0) // Position - 0x4AC8
{
	var unk;
	int i;
...
Hash func_173(Hash hParam0) // Position - 0x4B36
{
	int num;
	var unk;
	int collectionId;
...
int func_174(Hash hParam0, Hash hParam1) // Position - 0x4BBB
{
	if (hParam0 == 0)
		return 0;
...
int func_175(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x4BEC
{
	var unk;
...
const char* func_176(const char* sParam0, int iParam1) // Position - 0x4C4B
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_177(Hash hParam0, int iParam1) // Position - 0x4C65
{
	 num;
...
BOOL func_178(Hash hParam0, char* sParam1) // Position - 0x4C83
{
...
const char* func_179(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x4D00
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_180(const char* sParam0, int iParam1) // Position - 0x4D14
{
...
int func_181(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x4D4A
{
	int num;
	var unk13;
	int num2;
...
BOOL func_182(int iParam0, int iParam1) // Position - 0x4DAD
{
	return iParam0 && iParam1 != false;
}

BOOL func_183(int iParam0, int iParam1) // Position - 0x4DBC
{
	return iParam0 && iParam1 != false;
}

var func_184(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4DCB
{
	if (bParam0)
		return uParam1;
...
void func_185(var uParam0, int iParam1) // Position - 0x4DE2
{
	if (iParam1 < 0)
		return;
...
void func_186(var uParam0, int iParam1) // Position - 0x4E68
{
...
void func_187(var uParam0, int iParam1) // Position - 0x4EA4
{
	int num;
	int num2;
...
void func_188(var uParam0, int iParam1) // Position - 0x4EF7
{
...
void func_189(var uParam0, int iParam1) // Position - 0x4F32
{
...
void func_190(var uParam0, int iParam1) // Position - 0x4F6B
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_191(int iParam0) // Position - 0x4FA3
{
	int num;
	int num2;
	int num3;
...
Hash func_192(Hash hParam0, int iParam1) // Position - 0x507F
{
	int num;
	var unk;
	Hash hash;
...
int func_193(Hash hParam0, BOOL bParam1) // Position - 0x50F9
{
	var unk;
	int num;
	int num2;
...
int func_194(Hash hParam0, int iParam1) // Position - 0x5158
{
	if (iParam1 == 0)
		return 0;
...
int func_195(BOOL bParam0) // Position - 0x5184
{
	if (func_207() == -1)
	{
...
struct<4> func_196(Hash hParam0, BOOL bParam1) // Position - 0x51C5
{
	var unk;
...
int func_197() // Position - 0x51EA
{
	return Global_1149172.f_137;
}

void func_198(var uParam0, int iParam1) // Position - 0x51F8
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_199(var uParam0, int iParam1) // Position - 0x5209
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_200() // Position - 0x521E
{
...
BOOL func_201(int iParam0) // Position - 0x5232
{
	if (!func_114(iParam0))
		return false;
...
int func_202(BOOL bParam0, int iParam1) // Position - 0x5250
{
...
BOOL func_204(var uParam0, var uParam1) // Position - 0x52FE
{
	if (!func_244(uParam0))
		return false;
...
void func_205(int iParam0, int iParam1) // Position - 0x5332
{
	iParam0->f_2 = iParam0->f_2 || iParam1;
	return;
}

BOOL func_206() // Position - 0x5345
{
	return true;
}

int func_207() // Position - 0x5364
{
	return Global_1572887.f_14;
}

Hash func_208(Hash hParam0) // Position - 0x5372
{
	return hParam0;
}

BOOL func_209(Hash hParam0, Hash hParam1) // Position - 0x537C
{
...
int func_210(int iParam0) // Position - 0x53B2
{
	if (iParam0 == 2)
		iParam0 = func_246(1);
...
void func_211(float fParam0, Ped pedParam1) // Position - 0x53F2
{
	if (fParam0 == 0f)
		return;
...
int func_212(int iParam0) // Position - 0x5436
{
	if (iParam0 == 2)
		iParam0 = func_246(1);
...
void func_213(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x547A
{
	Player player;
	Ped EntityIndex;
...
int func_214(int iParam0) // Position - 0x552B
{
	if (iParam0 == 2)
		iParam0 = func_246(1);
...
void func_215(float fParam0, Ped pedParam1) // Position - 0x556F
{
	if (fParam0 == 0f)
		return;
...
float func_216(int iParam0, float fParam1, BOOL bParam2) // Position - 0x55B1
{
	int num;
	int num2;
...
float func_217(int iParam0, int iParam1) // Position - 0x561A
{
	if (iParam1 == 2)
		iParam1 = func_246(2);
...
int func_218(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x5666
{
	Ped ped;
...
int func_219(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x56E4
{
	char* effectName;
	Ped ped;
...
void func_221(float fParam0, int iParam1) // Position - 0x58C3
{
	float num;
	int num2;
	int num3;
...
BOOL func_222(Hash hParam0, Hash hParam1) // Position - 0x5936
{
	if (hParam1 == 0)
		return false;
...
Hash func_223(Hash hParam0, BOOL bParam1) // Position - 0x595D
{
	switch (hParam0)
	{
...
int func_224(Hash hParam0) // Position - 0x59FF
{
	var unk;
	int num;
...
struct<10> func_225(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x5A39
{
	int num;
...
BOOL func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x5B0D
{
...
BOOL func_227(Hash hParam0) // Position - 0x5B2E
{
	!func_161(hParam0, 0);
...
int func_228(int iParam0) // Position - 0x5B54
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_229(Hash hParam0, int iParam1) // Position - 0x5B75
{
	if (hParam0 == 0)
		return false;
...
int func_230(Hash hParam0, int iParam1) // Position - 0x5B8F
{
	var unk;
	int num;
	int num2;
...
char* func_231(Hash hParam0) // Position - 0x5BDD
{
	Hash labelHash;
...
BOOL func_232(Hash hParam0) // Position - 0x5C13
{
...
char* func_233(Hash hParam0) // Position - 0x5C41
{
	Hash labelHash;
...
void func_234(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x5C76
{
...
void func_235(Hash hParam0, var uParam1, var uParam2) // Position - 0x5CA7
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_236(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5EB3
{
	Hash hash;
...
struct<4> func_237(BOOL bParam0) // Position - 0x5F91
{
	int num;
...
void func_238(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x6032
{
...
BOOL func_239(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x604D
{
...
int func_240(int iParam0) // Position - 0x6072
{
	if (iParam0 < 0)
		return 0;
...
struct<5> func_241(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x6093
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_242(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x6407
{
	var outGuid;
...
BOOL func_243() // Position - 0x6438
{
	return !Global_1572887.f_10;
}

BOOL func_244(int iParam0) // Position - 0x6447
{
	switch (iParam0)
	{
		case 2:
...
int func_245(int iParam0) // Position - 0x6486
{
	switch (iParam0)
	{
		case 2:
...
int func_246(int iParam0) // Position - 0x651C
{
	return func_273(func_272(iParam0));
}

BOOL func_247(Player plParam0) // Position - 0x652E
{
	float num;
...
void func_248(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x6549
{
	int num;
	int i;
	int j;
...
int func_249(int iParam0, int iParam1) // Position - 0x66BC
{
	if (iParam1 == 2)
		iParam1 = func_246(2);
...
int func_250(int iParam0, int iParam1) // Position - 0x670C
{
	if (iParam1 == 2)
		iParam1 = func_246(2);
...
void func_251(int iParam0, int iParam1, int iParam2) // Position - 0x675E
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
void func_252(int iParam0, int iParam1, int iParam2) // Position - 0x67B4
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
BOOL func_253(Ped pedParam0, int iParam1, float fParam2) // Position - 0x680A
{
...
void func_254(int iParam0, int iParam1, int iParam2) // Position - 0x685F
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
void func_255(Ped pedParam0, int iParam1, float fParam2) // Position - 0x68C0
{
	char* StringToTest;
...
void func_256(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x68EC
{
	int num;
...
BOOL func_257(int iParam0) // Position - 0x6922
{
	switch (iParam0)
	{
		case 0:
...
char* func_258(int iParam0) // Position - 0x6951
{
	switch (iParam0)
	{
		case 0:
...
void func_259(int iParam0) // Position - 0x698C
{
	int num;
	int num2;
	int i;
...
void func_260(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6A5C
{
	func_218(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

float func_261(int iParam0, int iParam1) // Position - 0x6A76
{
	if (iParam1 == 2)
		iParam1 = func_246(1);
...
int func_262(float fParam0) // Position - 0x6AC2
{
	float num;
...
float func_263(float fParam0, float fParam1, float fParam2) // Position - 0x6AED
{
	if (fParam0 > fParam2)
		return fParam2;
...
int func_264(int iParam0, float fParam1, int iParam2) // Position - 0x6B14
{
	if (!func_282(iParam0))
		return 0;
...
struct<4> func_265(BOOL bParam0) // Position - 0x6B65
{
	int num;
...
int func_266(Hash hParam0, BOOL bParam1) // Position - 0x6C05
{
...
BOOL func_267(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6C3C
{
	return func_286(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_268(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x6C57
{
	var unk;
...
struct<4> func_269(BOOL bParam0) // Position - 0x6C78
{
	int num;
...
BOOL func_270(Hash hParam0, int iParam1) // Position - 0x6CE2
{
	Hash hash;
	int num;
	int i;
...
BOOL func_271(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6D4F
{
	return func_289(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_272(int iParam0) // Position - 0x6D65
{
	return func_290(&(Global_1956875.f_1565), iParam0, 1);
}

int func_273(BOOL bParam0) // Position - 0x6D7B
{
	if (bParam0)
		return 1;
...
float func_274(Player plParam0) // Position - 0x6D8D
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_291(2);
}

int func_275(int iParam0) // Position - 0x6DA3
{
	switch (iParam0)
	{
		case 0:
...
char* func_276(int iParam0) // Position - 0x6DD2
{
	switch (iParam0)
	{
		case 0:
...
char* func_277(int iParam0) // Position - 0x6E0D
{
	switch (iParam0)
	{
		case 0:
...
void func_278(int iParam0, float fParam1, int iParam2) // Position - 0x6E48
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
void func_279(int iParam0, int iParam1, int iParam2) // Position - 0x6E9A
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
int func_280(int iParam0, int iParam1) // Position - 0x6EF0
{
	switch (iParam0)
	{
		case -2101912686:
...
// Unhandled jump detected. Output should be considered invalid
int func_281(int iParam0) // Position - 0x76F1
{
	int num;
	int num2;
	int num3;
...
BOOL func_282(int iParam0) // Position - 0x7981
{
	if (func_257(iParam0))
		return true;
...
void func_283(int iParam0, float fParam1, int iParam2) // Position - 0x79A7
{
	if (fParam1 < 0f)
		return;
...
struct<4> func_284() // Position - 0x7A03
{
	var unk;
...
int func_286(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x7A2C
{
...
BOOL func_287(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x7AAB
{
	int inventoryId;
...
BOOL func_288(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x7AF0
{
...
BOOL func_289(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7B23
{
...
BOOL func_290(Any* panParam0, int iParam1, int iParam2) // Position - 0x7B5D
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_291(int iParam0) // Position - 0x7B94
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_292(int iParam0) // Position - 0x7BD5
{
	int num;
...
BOOL func_293(int iParam0) // Position - 0x7BFD
{
	int num;
...
int func_294(int iParam0, int iParam1) // Position - 0x7C25
{
	switch (iParam0)
	{
...
int func_295(int iParam0, int iParam1) // Position - 0x82DD
{
	Player player;
	Player player2;
	int num;
...
int func_296(int iParam0, int iParam1, int iParam2) // Position - 0x8360
{
	int num;
	int num2;
...
void func_297(int iParam0) // Position - 0x8458
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_298(int iParam0, int iParam1) // Position - 0x846E
{
	switch (iParam0)
	{
...
BOOL func_302(int iParam0) // Position - 0x8D98
{
	switch (iParam0)
	{
		case 12:
...
int func_303(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8DBD
{
...
Player func_304(int iParam0) // Position - 0x8DF0
{
	if (func_315(iParam0))
...
BOOL func_305(int iParam0) // Position - 0x8E11
{
	int num;
...
int func_306(int iParam0, int iParam1, int iParam2) // Position - 0x8E39
{
	int num;
	int num2;
	int num3;
...
BOOL func_307(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x902A
{
	return uParam0.f_4 != 0;
}

BOOL func_308(int iParam0, int iParam1) // Position - 0x9038
{
	int num;
...
Vector3 func_309(int iParam0) // Position - 0x9078
{
	int num;
	var unk;
...
BOOL func_310(int iParam0, var uParam1, var uParam2) // Position - 0x90B4
{
	if (!func_305(iParam0))
		return false;
...
BOOL func_311(int iParam0, int iParam1, int iParam2) // Position - 0x90EB
{
	int num;
	int num2;
	int num3;
...
void func_312(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9319
{
	int num;
...
void func_313(int iParam0) // Position - 0x9398
{
	int num;
...
BOOL func_314(Hash hParam0) // Position - 0x93ED
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_315(int iParam0) // Position - 0x93FB
{
	int num;
...
int func_316(int iParam0) // Position - 0x9422
{
	int num;
...
int func_317(int iParam0, int iParam1) // Position - 0x94BC
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_318(int iParam0) // Position - 0x98F5
{
	int num;
...
float func_319(int iParam0) // Position - 0x991D
{
	float num;
...
void func_320(int iParam0) // Position - 0x994D
{
	int num;
	int num2;
	int i;
...
BOOL func_321(int iParam0) // Position - 0x9B2C
{
	int num;
...
int func_322(int iParam0, int iParam1) // Position - 0x9B54
{
	switch (iParam0)
	{
...
void func_323(int iParam0) // Position - 0x9E64
{
	Ped ped;
	Player player;
...
BOOL func_324(int iParam0) // Position - 0xA074
{
	int num;
...
int func_325(int iParam0, int iParam1) // Position - 0xA09B
{
	switch (iParam0)
	{
...
int func_326(int iParam0) // Position - 0xA0F8
{
	int num;
	var unk;
	var unk32;
...
BOOL func_327(int iParam0) // Position - 0xA23C
{
...
void func_328(int iParam0) // Position - 0xA25A
{
	int num;
	int num2;
	int i;
...
BOOL func_329(int iParam0) // Position - 0xA3AF
{
	BOOL flag;
...
void func_330(int iParam0) // Position - 0xA3D9
{
	Ped EntityIndex;
	Player player;
	int num;
...
void func_331(int iParam0) // Position - 0xA674
{
	char* StringToTest;
	char* StringToTest2;
...
BOOL func_332(int iParam0) // Position - 0xA6BE
{
	int num;
...
BOOL func_333(int iParam0) // Position - 0xA6E6
{
	int num;
...
BOOL func_334(int iParam0) // Position - 0xA70E
{
	int num;
...
BOOL func_335(int iParam0) // Position - 0xA736
{
	int num;
...
BOOL func_336(int iParam0) // Position - 0xA75E
{
	int num;
...
BOOL func_337(int iParam0) // Position - 0xA786
{
	int num;
...
float func_338(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0xA7AE
{
	var unk;
	float num;
...
BOOL func_339(int iParam0) // Position - 0xA7E4
{
...
BOOL func_340(int iParam0) // Position - 0xA853
{
	int num;
...
int func_341(int iParam0, int iParam1) // Position - 0xA87A
{
	switch (iParam0)
	{
...
char* func_344(int iParam0) // Position - 0xA969
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_345(int iParam0) // Position - 0xA9B1
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_346(int iParam0) // Position - 0xA9EC
{
	int i;
...
int func_348(int iParam0) // Position - 0xAA4C
{
	int num;
...
BOOL func_349(int iParam0, int iParam1) // Position - 0xAA7B
{
	int num;
	Player player;
	int num2;
...
struct<31> func_350(int iParam0) // Position - 0xAD50
{
	int num;
...
BOOL func_351(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0xAD74
{
	var unk;
	BOOL flag;
...
char* func_352(int iParam0, int iParam1) // Position - 0xADAA
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_353(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xAE03
{
	int i;
...
char* func_355(int iParam0) // Position - 0xAEAD
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_356(int iParam0) // Position - 0xAECE
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_357(Hash hParam0, Hash hParam1, var uParam2) // Position - 0xAEEF
{
	int num;
	int num2;
...
BOOL func_358() // Position - 0xB111
{
	return Global_1572887.f_7;
}

BOOL func_359() // Position - 0xB11F
{
	if (!Global_1048577)
		return false;
...
BOOL func_360(Player plParam0) // Position - 0xB16A
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_361(int iParam0, Player plParam1) // Position - 0xB1AF
{
	if (plParam1 == 255)
...
int func_362(int iParam0) // Position - 0xB1DB
{
	int num;
...
void func_365(Player plParam0) // Position - 0xB276
{
	Player player;
...
void func_366(Player plParam0) // Position - 0xB2F9
{
	Player player;
...
void func_367(Player plParam0) // Position - 0xB365
{
