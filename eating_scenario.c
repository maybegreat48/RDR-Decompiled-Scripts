...
void func_7() // Position - 0x1A2
{
	return;
}

void func_8() // Position - 0x1AA
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x1B6
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x1DE
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x206
{
	struct<2> data;
...
void func_12(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x22E
{
	if (fParam1 == 0f)
		return;
...
void func_13(float fParam0, BOOL bParam1) // Position - 0x267
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
void func_14(Hash hParam0) // Position - 0x2BF
{
	int num;
	var unk22;
	int i;
...
BOOL func_15(int iParam0) // Position - 0x603
{
	return iParam0 > -1 && iParam0 < 2;
}

void func_16(float fParam0, BOOL bParam1) // Position - 0x618
{
	func_37(Global_1940026.f_9 + fParam0, bParam1);
	return;
}

void func_17(var uParam0) // Position - 0x62F
{
	return;
}

void func_18(var uParam0) // Position - 0x637
{
	return;
}

void func_19(var uParam0) // Position - 0x63F
{
	return;
}

float func_20(int iParam0, float fParam1, BOOL bParam2) // Position - 0x647
{
	int num;
	int num2;
...
float func_21(int iParam0, int iParam1) // Position - 0x6B0
{
	if (iParam1 == 2)
		iParam1 = func_45(2);
...
int func_22(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x6FC
{
	Ped ped;
...
void func_24(float fParam0, int iParam1) // Position - 0x79E
{
	float num;
	int num2;
	int num3;
...
void func_25(int iParam0, BOOL bParam1) // Position - 0x811
{
	int num;
	int num2;
...
BOOL func_26(Hash hParam0, Hash hParam1) // Position - 0x83E
{
...
int func_27(Hash hParam0) // Position - 0x87F
{
	var unk;
...
float func_28(int iParam0, int iParam1) // Position - 0x8AA
{
	int num;
	float pedStamina;
	float pedMaxStamina;
...
void func_29(int iParam0) // Position - 0x95F
{
	Ped ped;
	int num;
...
void func_30(int iParam0, BOOL bParam1) // Position - 0x99C
{
	int num;
...
void func_31(int iParam0) // Position - 0x9D1
{
	Ped ped;
	int num;
...
float func_32(float fParam0, float fParam1) // Position - 0xA0E
{
	if (fParam1 != 0f)
...
float func_33(float fParam0, int iParam1) // Position - 0xA3C
{
	switch (iParam1)
	{
		case 0:
...
int func_34(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA8E
{
...
struct<2> func_35(int iParam0) // Position - 0xAB2
{
	int num;
...
void func_36(var uParam0, var uParam1, int iParam2) // Position - 0xAC2
{
...
void func_37(float fParam0, BOOL bParam1) // Position - 0xADF
{
...
int func_38() // Position - 0xB82
{
	return Global_1902569;
}

void func_39(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xB8E
{
	int num;
	int i;
	int j;
...
int func_40(int iParam0, int iParam1) // Position - 0xD01
{
	if (iParam1 == 2)
		iParam1 = func_45(2);
...
int func_41(int iParam0, int iParam1) // Position - 0xD51
{
	if (iParam1 == 2)
		iParam1 = func_45(2);
...
BOOL func_42(int iParam0, int iParam1, BOOL bParam2) // Position - 0xDA3
{
	if (bParam2)
...
void func_43(int iParam0, int iParam1, int iParam2) // Position - 0xDD0
{
	if (iParam2 == 2)
		iParam2 = func_45(2);
...
void func_44(int iParam0, int iParam1, int iParam2) // Position - 0xE26
{
	if (iParam2 == 2)
		iParam2 = func_45(2);
...
int func_45(int iParam0) // Position - 0xE7C
{
	return func_80(func_79(iParam0));
}

BOOL func_46(Ped pedParam0, int iParam1, float fParam2) // Position - 0xE8E
{
...
void func_47(int iParam0, int iParam1, int iParam2) // Position - 0xEE3
{
	if (iParam2 == 2)
		iParam2 = func_45(2);
...
void func_48(Ped pedParam0, int iParam1, float fParam2) // Position - 0xF44
{
	char* StringToTest;

	StringToTest = func_82(iParam1);
...
void func_49(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0xF70
{
	int num;
...
BOOL func_50(int iParam0, BOOL bParam1) // Position - 0xFA6
{
	return func_42(func_38(), iParam0, bParam1);
}

float func_51(int iParam0, int iParam1) // Position - 0xFBA
{
	if (iParam1 == 2)
		iParam1 = func_45(1);
...
int func_52(float fParam0) // Position - 0x1006
{
	float num;
...
float func_53(float fParam0, float fParam1, float fParam2) // Position - 0x1031
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_54(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x1058
{
	int num;
	int i;
	int num2;
...
int func_55(int iParam0, float fParam1, int iParam2) // Position - 0x11E0
{
	if (!func_86(iParam0))
		return 0;
...
void func_56(int iParam0, var uParam1, var uParam2) // Position - 0x1231
{
	int num;
...
BOOL func_57(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x124D
{
...
void func_58(int iParam0, int iParam1) // Position - 0x12EF
{
	int Variable;
...
BOOL func_59(Hash hParam0, int iParam1) // Position - 0x1313
{
	if (hParam0 == 0)
		return false;
...
Hash func_60(Hash hParam0) // Position - 0x132D
{
	return hParam0;
}

BOOL func_61(Hash hParam0, Hash hParam1) // Position - 0x1337
{
...
int func_62(int iParam0) // Position - 0x136D
{
	if (iParam0 == 2)
		iParam0 = func_45(1);
...
void func_63(float fParam0, Ped pedParam1) // Position - 0x13AD
{
	if (fParam0 == 0f)
		return;
...
int func_64(int iParam0) // Position - 0x13F1
{
	if (iParam0 == 2)
		iParam0 = func_45(1);
...
void func_65(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1435
{
	Player player;
	Ped EntityIndex;
...
int func_66(int iParam0) // Position - 0x14E6
{
	if (iParam0 == 2)
		iParam0 = func_45(1);
...
void func_67(float fParam0, Ped pedParam1) // Position - 0x152A
{
	if (fParam0 == 0f)
		return;
...
int func_68(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x156C
{
	char* effectName;
	Ped ped;
...
float func_69() // Position - 0x1722
{
	return 0.75f;
}

int func_70(int iParam0) // Position - 0x172F
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_71(int iParam0) // Position - 0x1754
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_72(int iParam0) // Position - 0x1767
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_73(int iParam0) // Position - 0x177A
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_74(int iParam0) // Position - 0x178D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_75(int iParam0) // Position - 0x179F
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_76(int iParam0, int iParam1) // Position - 0x17B1
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x184B
{
...
BOOL func_78(int iParam0) // Position - 0x1883
{
	int num;
	int num2;
	int num3;
...
BOOL func_79(int iParam0) // Position - 0x195F
{
	return func_107(&(Global_1956875.f_1565), iParam0, 1);
}

int func_80(BOOL bParam0) // Position - 0x1975
{
	if (bParam0)
		return 1;
...
int func_81(int iParam0) // Position - 0x1987
{
	switch (iParam0)
	{
		case 0:
...
char* func_82(int iParam0) // Position - 0x19B6
{
	switch (iParam0)
	{
		case 0:
...
char* func_83(int iParam0) // Position - 0x19ED
{
	switch (iParam0)
	{
		case 0:
...
void func_84(int iParam0, float fParam1, int iParam2) // Position - 0x1A24
{
	if (iParam2 == 2)
		iParam2 = func_45(2);
...
void func_85(int iParam0, int iParam1, int iParam2) // Position - 0x1A76
{
	if (iParam2 == 2)
		iParam2 = func_45(2);
...
BOOL func_86(int iParam0) // Position - 0x1ACC
{
	if (func_96(iParam0))
		return true;
...
void func_87(int iParam0, float fParam1, int iParam2) // Position - 0x1AF2
{
	if (fParam1 < 0f)
		return;
...
BOOL func_88(int iParam0, int iParam1) // Position - 0x1B4E
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_89(int iParam0) // Position - 0x1B66
{
...
BOOL func_90(int iParam0) // Position - 0x1B7D
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_91(int iParam0, int iParam1) // Position - 0x1C49
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_92(int iParam0) // Position - 0x1C62
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_93() // Position - 0x1C75
{
	if (!func_109())
		return false;
...
BOOL func_94(Hash hParam0, int iParam1) // Position - 0x1C90
{
	if (hParam0 == 0)
		return false;
...
BOOL func_95(Player plParam0) // Position - 0x1CAA
{
	float num;
...
BOOL func_96(int iParam0) // Position - 0x1CC5
{
	switch (iParam0)
	{
		case 0:
...
char* func_97(int iParam0) // Position - 0x1CF4
{
	switch (iParam0)
	{
		case 0:
...
void func_98(int iParam0) // Position - 0x1D2B
{
	int num;
	int num2;
	int i;
...
void func_99(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1DFB
{
	func_22(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

var func_100(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1E15
{
	if (bParam0)
		return uParam1;
...
void func_101(var uParam0, int iParam1) // Position - 0x1E2C
{
	if (iParam1 < 0)
		return;
...
void func_102(var uParam0, int iParam1) // Position - 0x1EB2
{
...
void func_103(var uParam0, int iParam1) // Position - 0x1EEE
{
	int num;
	int num2;
...
void func_104(var uParam0, int iParam1) // Position - 0x1F41
{
...
void func_105(var uParam0, int iParam1) // Position - 0x1F7C
{
...
void func_106(var uParam0, int iParam1) // Position - 0x1FB5
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_107(Any* panParam0, int iParam1, int iParam2) // Position - 0x1FED
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

BOOL func_108(int iParam0) // Position - 0x2024
{
	switch (iParam0)
	{
		case 12:
...
float func_110(Player plParam0) // Position - 0x205D
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_113(2);
}

int func_111(int iParam0, int iParam1) // Position - 0x2073
{
	switch (iParam0)
	{
		case -2101912686:
...
int func_112(int iParam0) // Position - 0x2874
{
	int num;
	int num2;
	int num3;
...
int func_113(int iParam0) // Position - 0x2B04
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_114(int iParam0) // Position - 0x2B45
{
	int num;
...
BOOL func_115(int iParam0) // Position - 0x2B6D
{
	int num;
...
int func_116(int iParam0, int iParam1) // Position - 0x2B95
{
	switch (iParam0)
	{
...
int func_117(int iParam0, int iParam1) // Position - 0x324C
{
	Player player;
	Player player2;
	int num;

	player = func_124(iParam0);
	player2 = Global_1295666;
	num = func_120(iParam1, 1);
...
int func_118(int iParam0, int iParam1, int iParam2) // Position - 0x32CF
{
	int num;
	int num2;
...
void func_119(int iParam0) // Position - 0x33C7
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_120(int iParam0, int iParam1) // Position - 0x33DD
{
	switch (iParam0)
	{
...
Player func_124(int iParam0) // Position - 0x3D07
{
	if (func_134(iParam0))
...
BOOL func_125(int iParam0) // Position - 0x3D28
{
	int num;
...
int func_126(int iParam0, int iParam1, int iParam2) // Position - 0x3D50
{
	int num;
	int num2;
	int num3;
...
BOOL func_127(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x3F41
{
	return uParam0.f_4 != 0;
}

BOOL func_128(int iParam0, int iParam1) // Position - 0x3F4F
{
	int num;
...
Vector3 func_129(int iParam0) // Position - 0x3F8F
{
	int num;
	var unk;
...
BOOL func_130(int iParam0, var uParam1, var uParam2) // Position - 0x3FCB
{
	if (!func_125(iParam0))
		return false;
...
BOOL func_131(int iParam0, int iParam1, int iParam2) // Position - 0x4003
{
	int num;
	int num2;
	int num3;
...
void func_132(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4231
{
	int num;
...
void func_133(int iParam0) // Position - 0x42B0
{
	int num;
...
BOOL func_134(int iParam0) // Position - 0x4305
{
	int num;
...
int func_135(int iParam0) // Position - 0x432C
{
	int num;
...
int func_136(int iParam0, int iParam1) // Position - 0x43C6
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_137(int iParam0) // Position - 0x47FF
{
	int num;
...
float func_138(int iParam0) // Position - 0x4827
{
	float num;
...
void func_139(int iParam0) // Position - 0x4856
{
	int num;
	int num2;
	int i;
...
BOOL func_140(int iParam0) // Position - 0x4A35
{
	int num;
...
int func_141(int iParam0, int iParam1) // Position - 0x4A5D
{
	switch (iParam0)
	{
...
void func_142(int iParam0) // Position - 0x4D6D
{
	Ped ped;
	Player player;
...
BOOL func_143(int iParam0) // Position - 0x4F7C
{
	int num;
...
int func_144(int iParam0, int iParam1) // Position - 0x4FA3
{
	switch (iParam0)
	{
...
int func_145(int iParam0) // Position - 0x5000
{
	int num;
	var unk;
	var unk32;
...
BOOL func_146(int iParam0) // Position - 0x5144
{
...
void func_147(int iParam0) // Position - 0x5162
{
	int num;
	int num2;
	int i;
...
BOOL func_148(int iParam0) // Position - 0x52B7
{
	BOOL flag;
...
void func_149(int iParam0) // Position - 0x52E0
{
	Ped EntityIndex;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_164(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_171(iParam0, 0));
			func_172(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_171(iParam0, 1));
			func_172(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_171(iParam0, 2));
			func_172(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_171(iParam0, 3));
			func_172(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_150(int iParam0) // Position - 0x557A
{
	char* StringToTest;
	char* StringToTest2;
	...
	StringToTest = func_174(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	StringToTest2 = func_175(iParam0);
...
BOOL func_151(int iParam0) // Position - 0x55C4
{
	int num;
...
BOOL func_152(int iParam0) // Position - 0x55EC
{
	int num;
...
BOOL func_153(int iParam0) // Position - 0x5614
{
	int num;
...
BOOL func_154(int iParam0) // Position - 0x563C
{
	int num;
...
BOOL func_155(int iParam0) // Position - 0x5664
{
	int num;
...
BOOL func_156(int iParam0) // Position - 0x568C
{
	int num;
...
float func_157(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x56B4
{
	var unk;
	float num;
...
BOOL func_158(int iParam0) // Position - 0x56EA
{
...
BOOL func_159(int iParam0) // Position - 0x5759
{
	int num;
...
int func_160(int iParam0, int iParam1) // Position - 0x5780
{
	switch (iParam0)
	{
...
char* func_163(int iParam0) // Position - 0x586F
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_164(int iParam0) // Position - 0x58B2
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_165(int iParam0) // Position - 0x58ED
{
	int i;
...
int func_167(int iParam0) // Position - 0x594D
{
	int num;
...
BOOL func_168(int iParam0, int iParam1) // Position - 0x597C
{
	int num;
	Player player;
	int num2;
	...
	{
		num3 = Global_1156111.f_35859.f_9286[func_144(num2, 1) /*3*/];
		unk = { func_169(num3) };
	...
	switch (Global_1156111.f_35859.f_3116[num /*31*/])
	{
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (player != Global_1295666 && !func_180(Global_1295666.f_149[player]))
				return false;
		
			if (!func_181(512, player))
				return false;
...
struct<31> func_169(int iParam0) // Position - 0x5C51
{
	int num;
...
BOOL func_170(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0x5C75
{
	var unk;
	BOOL flag;
...
char* func_171(int iParam0, int iParam1) // Position - 0x5CAB
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_172(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x5D02
{
	int i;
...
char* func_174(int iParam0) // Position - 0x5DAC
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_175(int iParam0) // Position - 0x5DCC
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_176(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x5DEC
{
	int num;
	int num2;
...
BOOL func_177(int iParam0, int iParam1) // Position - 0x600D
{
	return iParam0 && iParam1 != false;
}

BOOL func_178() // Position - 0x601C
{
	return Global_1572887.f_7;
}

BOOL func_179() // Position - 0x602A
{
	if (!Global_1048577)
		return false;
...
BOOL func_180(Player plParam0) // Position - 0x6075
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_181(int iParam0, Player plParam1) // Position - 0x60BA
{
	if (plParam1 == 255)
...
int func_182(int iParam0) // Position - 0x60E6
{
	int num;
...
struct<2> func_183(int iParam0) // Position - 0x611C
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_184(var uParam0, var uParam1) // Position - 0x6130
{
	if (!func_188(uParam0))
		return false;
...
void func_187(Player plParam0) // Position - 0x61C9
{
	Player player;
...
BOOL func_188(int iParam0) // Position - 0x624C
{
	switch (iParam0)
	{
		case 2:
...
int func_189(int iParam0) // Position - 0x628B
{
	switch (iParam0)
	{
		case 2:
...
void func_190(Player plParam0) // Position - 0x6321
{
	Player player;
...
void func_191(Player plParam0) // Position - 0x638D
{
