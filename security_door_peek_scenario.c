...
void func_6() // Position - 0x10C
{
	...
	switch (iLocal_19)
	{
		...
		case 2:
			...
			func_27(&uLocal_23, true, true, false, false, true);
...
void func_7() // Position - 0x256
{
	return;
}

void func_8() // Position - 0x25E
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x26A
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x292
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x2BA
{
	struct<2> data;
...
BOOL func_12(int iParam0) // Position - 0x2E2
{
	return bLocal_18 && iParam0 != false;
}

void func_13(int iParam0) // Position - 0x2F1
{
	if (!func_12(iParam0))
		return;
...
void func_15(int iParam0) // Position - 0x33E
{
	iLocal_19 = iParam0;
	return;
}

Vector3 func_16() // Position - 0x34A
{
	return 2710.57f, -1291.2f, 48.63f;
}

Vector3 func_17() // Position - 0x361
{
	return -290.86f, 813.36f, 118.42f;
}

Vector3 func_18() // Position - 0x378
{
	return -281.07f, 815.24f, 118.42f;
}

Vector3 func_19(Ped pedParam0, var uParam1, var uParam2) // Position - 0x38F
{
	int i;
	var unk;
	float num;
...
Hash func_20(int iParam0) // Position - 0x40B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_21(var uParam0) // Position - 0x446
{
	return func_34(*uParam0, 1);
}

void func_22(var uParam0, BOOL bParam1) // Position - 0x456
{
...
BOOL func_23(var uParam0, float fParam1) // Position - 0x476
{
	if (!func_21(uParam0))
		return false;
...
void func_24(var uParam0) // Position - 0x49D
{
	func_36(uParam0, 0f);
	return;
}

void func_25(BOOL bParam0) // Position - 0x4AC
{
	if (func_12(bParam0))
		return;
...
BOOL func_26() // Position - 0x4C7
{
	...
	EntityIndex = func_38(hLocal_72, 0, false);

	if (!ENTITY::DOES_ENTITY_EXIST(EntityIndex))
		return false;

	offsetFromEntityInWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(EntityIndex, func_39()) };
...
void func_27(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x593
{
	float num;
	float num2;
	float num3;
	...
	CAM::SET_CAM_PARAMS(*uParam0, uParam0->f_1, uParam0->f_4 + uParam0->f_19, uParam0->f_23, 0, 1, 1, 2, bParam5, false);
	return;
}

void func_28(var uParam0) // Position - 0x924
{
	return;
}

void func_29(var uParam0) // Position - 0x92C
{
	return;
}

void func_30(var uParam0) // Position - 0x934
{
	return;
}

void func_31(var uParam0) // Position - 0x93C
{
	if (CAM::DOES_CAM_EXIST(*uParam0))
	{
...
float func_32(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x9E2
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xA0A
{
...
BOOL func_34(int iParam0, int iParam1) // Position - 0xA34
{
	return iParam0 && iParam1 != false;
}

float func_35(var uParam0) // Position - 0xA43
{
	if (!func_21(uParam0))
		return uParam0->f_1;
...
void func_36(var uParam0, float fParam1) // Position - 0xA78
{
...
BOOL func_37(Hash hParam0) // Position - 0xA9E
{
	return hParam0 != 0;
}

Entity func_38(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xAAA
{
	Entity EntityIndex;

	EntityIndex = func_49(hParam0, iParam1);
...
Vector3 func_39() // Position - 0xAEF
{
	return 0.537029f, 0.426005f, 1.6552f;
}

Vector3 func_40() // Position - 0xB06
{
	return -7.766f, 0f, 175.2488f;
}

void func_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, float fParam14, BOOL bParam15, int iParam16, int iParam17) // Position - 0xB19
{
	uParam0->f_1 = { uParam1 };
	uParam0->f_4 = { uParam4 };
	uParam0->f_7 = fParam7;
	...
	*uParam0 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", false);
	...
	CAM::SET_CAM_PARAMS(*uParam0, uParam0->f_1, uParam0->f_4, uParam0->f_23, 0, 1, 1, 2, true, false);
...
BOOL func_42(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xC1A
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

Vector3 func_43(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0xC43
{
	return ({ 1f - fParam6, 1f - fParam6, 1f - fParam6 } * uParam0) + ({ fParam6, fParam6, fParam6 } * uParam3);
}

float func_44(float fParam0, float fParam1, float fParam2) // Position - 0xC5E
{
	if (fParam0 > fParam2)
		return fParam2;
...
BOOL func_45(var uParam0) // Position - 0xC85
{
	return func_34(*uParam0, 2);
}

float func_46() // Position - 0xC95
{
...
void func_47(var uParam0, int iParam1) // Position - 0xCC7
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_48(var uParam0, int iParam1) // Position - 0xCD8
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

Entity func_49(Hash hParam0, int iParam1) // Position - 0xCED
{
...
Hash func_50(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD23
{
...
BOOL func_51(Hash hParam0) // Position - 0xDC7
{
	if (func_37(hParam0))
