...
BOOL func_2(Hash hParam0, int iParam1) // Position - 0x296
{
	if (hParam0 == 0)
		return false;
...
BOOL func_3(Hash hParam0, Hash hParam1) // Position - 0x2B0
{
	if (!func_2(hParam0, 0))
...
void func_5(var uParam0) // Position - 0x348
{
	int i;
	int j;
	int num;
...
Hash func_6(Hash hParam0) // Position - 0x417
{
	return hParam0;
}

BOOL func_7(Hash hParam0, Hash hParam1) // Position - 0x421
{
...
BOOL func_8(BOOL bParam0, BOOL bParam1) // Position - 0x457
{
	int i;
...
BOOL func_9() // Position - 0x537
{
	return func_13(1);
}

void func_10(var uParam0) // Position - 0x544
{
	int i;
...
void func_11(var uParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5D8
{
	var unk;
...
BOOL func_12(Hash hParam0, int iParam1) // Position - 0x66B
{
	if (hParam0 == 0)
		return false;
...
BOOL func_13(int iParam0) // Position - 0x685
{
	return func_14(iParam0);
}

BOOL func_14(int iParam0) // Position - 0x693
{
	return func_15(Global_1940085.f_38, iParam0);
}

BOOL func_15(int iParam0, int iParam1) // Position - 0x6A7
{
