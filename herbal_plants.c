...
int func_1() // Position - 0xB7
{
	return Global_1572887.f_14;
}

struct<2> func_2(int iParam0) // Position - 0xC5
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_3(int iParam0, var uParam1) // Position - 0xD9
{
	return iParam0;
}

void func_4(var uParam0) // Position - 0xE3
{
...
BOOL func_5(var uParam0) // Position - 0x109
{
	int i;
...
BOOL func_8(var uParam0) // Position - 0x196
{
...
BOOL func_9(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x224
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
int func_10(var uParam0) // Position - 0x279
{
	return *uParam0;
}

int func_11() // Position - 0x284
{
	int i;
	int num;
...
void func_12(var uParam0, int iParam1) // Position - 0x2C1
{
	*uParam0 = iParam1;
	return;
}

BOOL func_13(var uParam0) // Position - 0x2CE
{
...
void func_14(var uParam0, var uParam1, var uParam2) // Position - 0x2FF
{
...
void func_15(var uParam0) // Position - 0x32E
{
	MAP::BLIP_ADD_MODIFIER(uParam0->f_5, 287065609);
	return;
}

Hash func_16(int iParam0) // Position - 0x344
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_17(Hash hParam0, int iParam1) // Position - 0x3EF
{
	int num;
...
int func_18(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x472
{
...
BOOL func_19(Hash hParam0, int iParam1) // Position - 0x534
{
	if (hParam0 == 0)
		return false;
...
int func_20(Hash hParam0) // Position - 0x54E
{
	var unk;
...
BOOL func_21(Hash hParam0, int iParam1) // Position - 0x579
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_22(Hash hParam0) // Position - 0x61F
{
	int num;
	int num2;
	int num3;
...
Hash func_23(Hash hParam0, int iParam1) // Position - 0x6DB
{
	int num;
	var unk;
	Hash hash;
...
int func_24(Hash hParam0, BOOL bParam1) // Position - 0x755
{
	var unk;
	int num;
	int num2;
...
int func_25(Hash hParam0, int iParam1) // Position - 0x7B4
{
	if (iParam1 == 0)
		return 0;
...
int func_26(BOOL bParam0) // Position - 0x7E0
{
	if (func_1() == -1)
	{
...
struct<4> func_27(Hash hParam0, BOOL bParam1) // Position - 0x821
{
	var unk;
...
BOOL func_28(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x846
{
...
BOOL func_29(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x86D
{
	if (iParam2 < 0)
		return false;
...
BOOL func_30(Hash hParam0) // Position - 0x8A8
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_31(int iParam0) // Position - 0x8C3
{
	if (iParam0 < 0)
		return 0;
...
int func_32(Hash hParam0) // Position - 0x8E4
{
	var unk;
...
int func_33(Hash hParam0) // Position - 0x90F
{
	switch (hParam0)
	{
...
int func_34(var uParam0, int iParam1) // Position - 0x9F2
{
	int i;
...
int func_35(Hash hParam0) // Position - 0xA2F
{
	int num;
...
BOOL func_36(Hash hParam0, Hash hParam1) // Position - 0xA9C
{
	if (!func_19(hParam0, 0))
...
void func_37(Hash hParam0, var uParam1, var uParam2) // Position - 0xADD
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_38(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xCE9
{
	Hash hash;
...
struct<4> func_39(BOOL bParam0) // Position - 0xDC7
{
	int num;
...
void func_40(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE68
{
...
BOOL func_41(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0xE83
{
...
Hash func_42(Hash hParam0) // Position - 0xEA8
{
	return hParam0;
}

BOOL func_43(Hash hParam0, int iParam1) // Position - 0xEB2
{
	if (hParam0 == 0)
		return false;
...
struct<5> func_44(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xECC
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_45(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x1240
{
	var outGuid;
...
BOOL func_46(Hash hParam0, Hash hParam1) // Position - 0x1271
{
...
struct<4> func_47(BOOL bParam0) // Position - 0x12A7
{
	int num;
...
int func_48(Hash hParam0, BOOL bParam1) // Position - 0x1347
{
...
BOOL func_49(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x137E
{
	return func_56(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_50(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x1399
{
	var unk;
...
struct<4> func_51(BOOL bParam0) // Position - 0x13BA
{
	int num;
...
BOOL func_52(Hash hParam0, int iParam1) // Position - 0x1424
{
	Hash hash;
	int num;
	int i;
...
BOOL func_53(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x1491
{
	return func_59(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

struct<4> func_54() // Position - 0x14A7
{
	var unk;
...
int func_56(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x14D0
{
...
BOOL func_57(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x154F
{
	int inventoryId;
...
BOOL func_58(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1594
{
...
BOOL func_59(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x15C7
{
...
int func_60(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1601
{
...
BOOL func_61(Hash hParam0) // Position - 0x1634
{
