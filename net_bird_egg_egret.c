...
int func_1() // Position - 0xB5
{
	return Global_1572887.f_14;
}

struct<2> func_2(int iParam0) // Position - 0xC3
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_3(int iParam0, var uParam1) // Position - 0xD7
{
	return iParam0;
}

void func_4(var uParam0) // Position - 0xE1
{
	int num;
	int i;
...
void func_5(var uParam0, int iParam1, int iParam2, Hash hParam3, Hash hParam4, int iParam5, int iParam6) // Position - 0x18D
{
	*uParam0 = 5;
...
BOOL func_6(var uParam0) // Position - 0x1D4
{
...
BOOL func_7() // Position - 0x1EE
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x1F7
{
	switch (uParam0->f_4)
	{
		case 0:
...
int func_9(var uParam0) // Position - 0x228
{
	var unk;
...
void func_10(BOOL bParam0) // Position - 0x279
{
	if (bParam0)
		func_21(0, 6);
	else
...
void func_11(var uParam0) // Position - 0x296
{
...
int func_12(var uParam0) // Position - 0x2B1
{
	int i;
...
int func_13(Object obParam0, Object obParam1, int iParam2) // Position - 0x357
{
	int i;
	var SourceStruct;
...
BOOL func_14(int iParam0, int iParam1) // Position - 0x401
{
	return iParam0 && iParam1 != false;
}

void func_15(int iParam0, int iParam1) // Position - 0x410
{
	func_23(iParam0, iParam1);
	return;
}

void func_16(var uParam0) // Position - 0x420
{
	func_24(uParam0);
...
void func_17(var uParam0) // Position - 0x437
{
	BOOL flag;
	int i;
...
void func_18(var uParam0) // Position - 0x8A1
{
	BOOL flag;
	int i;
...
BOOL func_19(var uParam0) // Position - 0xB74
{
	if (uParam0->f_4 == 0)
...
int func_20(int iParam0, Any anParam1) // Position - 0xBC3
{
	var unk;
...
void func_21(int iParam0, int iParam1) // Position - 0xBEC
{
...
void func_22(int iParam0, int iParam1, BOOL bParam2) // Position - 0xC30
{
...
void func_23(int iParam0, int iParam1) // Position - 0xC97
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_24(var uParam0) // Position - 0xCAC
{
	if (uParam0->f_4 != -1)
	{
...
void func_25(int iParam0, int iParam1) // Position - 0xCDF
{
	if (func_58(iParam0))
...
int _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0xCF8
{
	return uParam0->f_1;
}

void func_27(var uParam0) // Position - 0xD04
{
	if (func_59(*uParam0))
	{
...
BOOL func_28(var uParam0) // Position - 0xD74
{
	var unk;
...
void func_29(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xDBA
{
	BOOL flag;
	BOOL flag2;
	float num;
...
BOOL func_30(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6, BOOL bParam7) // Position - 0xFE3
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
int func_31(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x1038
{
	int num;
	var unk13;
	int num2;
...
float func_32(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1073
{
...
void func_33(var uParam0) // Position - 0x109B
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
void func_34(Object obParam0, BOOL bParam1) // Position - 0x10DE
{
	if (ENTITY::DOES_ENTITY_EXIST(obParam0))
		if (!bParam1)
...
void func_35(var uParam0, int iParam1) // Position - 0x1150
{
	uParam0->f_1 = iParam1;
	return;
}

void func_36(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x115E
{
	if (!func_58(iParam0))
	{
...
void func_37(var uParam0) // Position - 0x1192
{
...
BOOL func_38(var uParam0) // Position - 0x11A8
{
...
BOOL func_39(var uParam0) // Position - 0x11C9
{
	if (!ENTITY::DOES_ENTITY_EXIST(obLocal_38))
...
void func_40(var uParam0) // Position - 0x11FA
{
	int i;
...
int func_41(Object obParam0, Object obParam1, int iParam2) // Position - 0x12E5
{
	int i;
...
void func_43(var uParam0, var uParam1, Any anParam2) // Position - 0x13B2
{
	var unk;
	int num;
	int num2;
...
void func_44(var uParam0, var uParam1, Any anParam2) // Position - 0x1454
{
	var unk;
	int num;
	int num2;
...
void func_45(var uParam0) // Position - 0x14F6
{
	var entityCoords;
	var unk3;
...
int func_46(var uParam0, var uParam1) // Position - 0x160D
{
	int num;
	int i;
...
void func_47(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1649
{
	if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_7))
	{
...
void func_48(var uParam0) // Position - 0x1680
{
	TASK::_REQUEST_HERB_COMPOSITE_ASSET(hLocal_40);
	return;
}

BOOL func_49(var uParam0) // Position - 0x168F
{
...
BOOL func_50(var uParam0) // Position - 0x16A5
{
	var unk;
...
int func_51(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6) // Position - 0x16E7
{
	Volume volume;
	int num;
...
int func_52(var uParam0) // Position - 0x1718
{
...
int func_53(var uParam0) // Position - 0x175B
{
	if (func_14(Global_1222327[*uParam0 /*251*/][uParam0->f_13], 2))
		return 1;
...
void func_54(var uParam0, int iParam1) // Position - 0x177F
{
	BOOL flag;
	int i;
...
int func_55(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x18AB
{
	var unk;
	int num;
...
BOOL func_59(Entity eParam0) // Position - 0x1964
{
	Hash entityModel;
...
void func_61(int iParam0, BOOL bParam1) // Position - 0x19FA
{
	int num;
	int num2;
...
struct<5> func_62(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1A27
{
	var unk;
	int num;
	var unk6;
...
BOOL func_63(Hash hParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x1D9B
{
	var unk;
	var unk5;
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1ECF
{
...
BOOL func_65(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1EF9
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_66() // Position - 0x1FF8
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_67(var uParam0, int iParam1) // Position - 0x200D
{
	*uParam0 = iParam1;
	return;
}

void func_68(int iParam0) // Position - 0x201A
{
	if (iParam0 <= 0)
		return;
...
void func_69(var uParam0) // Position - 0x2041
{
	func_110(uParam0, 0f);
	return;
}

float func_70(var uParam0) // Position - 0x2050
{
	if (!func_111(uParam0))
		return uParam0->f_1;
...
BOOL func_71(Entity eParam0) // Position - 0x2085
{
	int num;
	var InputString;
	Hash entityModel;
...
var func_72(BOOL bParam0, int iParam1) // Position - 0x211F
{
	return func_73(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), bParam0, iParam1);
}

var func_73(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x213D
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_117(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
void func_75(Any* panParam0, int* piParam1) // Position - 0x256A
{
...
BOOL func_76(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x259B
{
	var ReturnZ;
	int num;
	BOOL flag;
...
int func_77(var uParam0, var uParam1, Volume volParam2, int iParam3) // Position - 0x269F
{
	ItemSet itemSet;
...
void func_78(Volume volParam0) // Position - 0x275A
{
...
void func_79(var uParam0, var uParam1, int iParam2) // Position - 0x2771
{
	var value;
	int num;
	int num2;
...
void func_80(var uParam0) // Position - 0x2836
{
...
void func_81(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x286E
{
	int i;
	var unk;
...
Hash func_82(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x2924
{
...
BOOL func_83(Hash hParam0) // Position - 0x2966
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

void func_84(int iParam0, var uParam1, var uParam2) // Position - 0x2974
{
	int num;
...
BOOL func_85(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x2990
{
...
void func_86(int iParam0, int iParam1) // Position - 0x2A32
{
	int Variable;
...
struct<4> func_87(BOOL bParam0) // Position - 0x2A56
{
	int num;
...
int func_88(Hash hParam0) // Position - 0x2AF6
{
	var unk;
...
struct<4> func_89(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x2B21
{
	var outGuid;
...
struct<4> func_90(BOOL bParam0) // Position - 0x2B52
{
	int num;
...
BOOL func_91(Hash hParam0, BOOL bParam1) // Position - 0x2BF3
{
...
BOOL func_92(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2C2A
{
	return func_105(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_93(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x2C45
{
	var unk;
...
struct<4> func_94(BOOL bParam0) // Position - 0x2C66
{
	int num;
...
int func_95(Hash hParam0) // Position - 0x2CD0
{
	var unk;
...
BOOL func_96(Hash hParam0, int iParam1) // Position - 0x2CFB
{
	Hash hash;
	int num;
	int i;
...
BOOL func_97(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x2D68
{
	return func_137(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_98(var uParam0) // Position - 0x2D7E
{
...
BOOL func_99(Hash hParam0, int iParam1) // Position - 0x2E08
{
	if (hParam0 == 0)
		return false;
...
Hash func_100(Hash hParam0) // Position - 0x2E22
{
	return hParam0;
}

BOOL func_101(Hash hParam0, int iParam1) // Position - 0x2E2C
{
	if (hParam0 == 0)
		return false;
...
int func_102(Hash hParam0, int iParam1) // Position - 0x2E46
{
	if (iParam1 == 0)
		return 0;
...
BOOL func_103(Hash hParam0) // Position - 0x2E72
{
	return func_88(hParam0) == joaat("WEAPON");
}

int func_104(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2E86
{
	if (!func_99(hParam0, 0))
	{
		if (func_101(func_100(hParam0), 2))
...
int func_105(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2EFA
{
...
int func_106(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2F79
{
...
BOOL func_107(BOOL bParam0) // Position - 0x303B
{
	if (bParam0)
...
BOOL func_108() // Position - 0x306B
{
	return func_142() != -1;
}

BOOL func_109() // Position - 0x3079
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_110(var uParam0, float fParam1) // Position - 0x309E
{
...
BOOL func_111(var uParam0) // Position - 0x30C4
{
	return func_145(*uParam0, 1);
}

BOOL func_112(var uParam0) // Position - 0x30D4
{
	return func_145(*uParam0, 2);
}

float func_113() // Position - 0x30E4
{
...
int func_114() // Position - 0x3116
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

int func_115() // Position - 0x312B
{
	return Global_1051645.f_12;
}

char* func_116() // Position - 0x3139
{
	return "unnamed";
}

BOOL func_117(int iParam0) // Position - 0x3144
{
	int num;
...
BOOL func_118(int iParam0) // Position - 0x31D3
{
...
int func_119(int iParam0) // Position - 0x31F1
{
	if (iParam0 == 255)
...
BOOL func_120(Player plParam0) // Position - 0x323C
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
int func_121(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x3281
{
	if (!func_149(uParam0))
		return 0;
...
BOOL func_122(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x32B1
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

var func_123(int iParam0) // Position - 0x32DA
{
	var memberHandles;
	var value;
	int gangMembers;
...
int func_124() // Position - 0x3333
{
	return Global_1953292.f_1;
}

BOOL func_125(Any anParam0) // Position - 0x3341
{
...
BOOL func_126(int iParam0, int iParam1) // Position - 0x3387
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_127(int iParam0) // Position - 0x339F
{
...
BOOL func_128(int iParam0) // Position - 0x33B6
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_129(int iParam0, int iParam1) // Position - 0x3482
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_130(int iParam0) // Position - 0x349B
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_131() // Position - 0x34AE
{
	if (!func_150())
		return false;
...
int func_132(BOOL bParam0) // Position - 0x34C9
{
	if (func_1() == -1)
	{
...
struct<4> func_133() // Position - 0x350A
{
	var unk;
...
BOOL func_135(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x3533
{
	int inventoryId;
...
BOOL func_136(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x3578
{
...
BOOL func_137(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x35AB
{
...
BOOL func_138(Hash hParam0) // Position - 0x35E5
{
	return func_152(hParam0, 1279601681);
}

Hash func_139(Hash hParam0, int iParam1) // Position - 0x35F8
{
	int num;
	var unk;
	Hash hash;
...
int func_140(Hash hParam0, BOOL bParam1) // Position - 0x3672
{
	var unk;
	int num;
	int num2;
...
struct<4> func_141(Hash hParam0, BOOL bParam1) // Position - 0x36D1
{
	var unk;
...
int func_142() // Position - 0x36F6
{
	return Global_1149172.f_137;
}

void func_143(var uParam0, int iParam1) // Position - 0x3704
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_144(var uParam0, int iParam1) // Position - 0x3715
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_145(int iParam0, int iParam1) // Position - 0x372A
{
	return iParam0 && iParam1 != false;
}

BOOL func_146(int iParam0, int iParam1) // Position - 0x3739
{
	int num;
...
BOOL func_147(Player plParam0) // Position - 0x37AD
{
...
void func_148(Player plParam0) // Position - 0x37CA
{
	Player player;
...
BOOL func_149(var uParam0) // Position - 0x384D
{
	if (*uParam0 >= 40)
		return false;
...
int func_151(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3876
{
...
BOOL func_152(Hash hParam0, Hash hParam1) // Position - 0x38A9
{
	if (!func_99(hParam0, 0))
...
void func_153(Hash hParam0, var uParam1, var uParam2) // Position - 0x38EA
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_154(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3AF6
{
	Hash hash;
...
void func_155(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x3BD4
{
...
BOOL func_156(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x3BEF
{
...
int func_157(int iParam0) // Position - 0x3C14
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_158(Any* panParam0, int iParam1, int iParam2) // Position - 0x3C35
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_159() // Position - 0x3C6C
{
	return Global_1102813.f_3672;
}

void func_160(Player plParam0) // Position - 0x3C7B
{
	Player player;
...
void func_161(Player plParam0) // Position - 0x3CE7
{
...
BOOL func_162(Hash hParam0) // Position - 0x3D22
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_163(Hash hParam0, Hash hParam1) // Position - 0x3D30
{
