...
BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0xBD
{
	int i;
...
void func_3(int* piParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x19D
{
	int i;
...
void func_4(var uParam0) // Position - 0x1E3
{
	func_14(uParam0);
	return;
}

void func_5() // Position - 0x1F1
{
	return;
}

void func_6() // Position - 0x1F9
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_7() // Position - 0x205
{
...
void func_8(int iParam0, int iParam1) // Position - 0x233
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_6();
...
int func_10(int iParam0, int iParam1, char* sParam2) // Position - 0x361
{
	return 1;
}

int func_11(int iParam0, int iParam1, char* sParam2) // Position - 0x36A
{
	return 1;
}

void func_12(BOOL bParam0) // Position - 0x373
{
	int num;
	var unk;
	int num2;
...
void func_13(int* piParam0, var uParam1, int* piParam2, int iParam3, BOOL bParam4) // Position - 0x43C
{
	struct<4> data;
...
void func_14(var uParam0) // Position - 0x474
{
	Player player;
...
int func_15() // Position - 0x555
{
	return Global_1572887.f_14;
}

BOOL func_16() // Position - 0x563
{
	return Global_1051645.f_8;
}

void func_17(int* piParam0, var uParam1, int* piParam2, int iParam3, BOOL bParam4) // Position - 0x571
{
	struct<9> data;
	int num;
	Ped playerPed;

	if (!SCRIPTS::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam3, &data, 9))
		return;
	...
	switch (data.f_4)
	{
		case 0:
			...
			if (func_28(piParam0, data.f_6))
			{
				piParam0->f_67[num /*3*/] = { data.f_6 };
				piParam0->f_164[num] = 1;
				func_26(1, data.f_5, data.f_6, false, false);
			}
			else
			{
				piParam0->f_67[num /*3*/] = { func_29() };
				piParam0->f_164[num] = 0;
				func_26(2, data.f_5, data.f_6, false, false);
			}
			break;
		...
		case 6:
			if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(data.f_1))
				return;
		
			playerPed = PLAYER::GET_PLAYER_PED(data.f_1);
...
BOOL func_18(int iParam0) // Position - 0x6A9
{
...
BOOL func_19(int iParam0, Player plParam1) // Position - 0x6CA
{
	Player player;
...
void func_20(var uParam0, BOOL bParam1) // Position - 0x6E5
{
	var unk;
...
void func_21(var uParam0) // Position - 0x750
{
	Player player;
	Player player2;
...
void func_22(var uParam0, BOOL bParam1) // Position - 0x786
{
	struct<8> args;
	Player player;
...
void func_23(var uParam0) // Position - 0x86E
{
	Player player;
	Player player2;
...
void func_25(var uParam0) // Position - 0x8D6
{
	Player player;
	Player player2;
	Player Plr;
	...
	Plr = PLAYER::INT_TO_PLAYERINDEX(uParam0->f_4);
...
void func_26(int iParam0, Player plParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6) // Position - 0x9BB
{
	int data;
	var playerBits;
	...
	SCRIPTS::TRIGGER_SCRIPT_EVENT(SCRIPT_EVENT_QUEUE_NETWORK, &data, 9, 28, &playerBits);
	return;
}

void func_27(int iParam0, Player plParam1) // Position - 0xA2D
{
	Player num;
...
BOOL func_28(int* piParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xA5B
{
	int i;
...
Vector3 func_29() // Position - 0xAB0
{
	return 0f, 0f, 0f;
}

void func_30(int iParam0, Player plParam1) // Position - 0xABB
{
	Player num;
...
int func_31(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xADE
{
	int num;
	var unk13;
	int num2;
...
void func_32(var uParam0) // Position - 0xB19
{
	*uParam0 = { func_29() };
	uParam0->f_3 = 0f;
	uParam0->f_5 = 0;
...
void func_33(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0xB38
{
	int num;
	int num2;
	int num3;
	...
	if (DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(num.f_1), &num))
	{
		...
		for (j = 0; j < num7; j = j + 1)
		{
			...
			if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr) || Plr == PLAYER::PLAYER_ID())
				num7[j /*3*/] = { func_29() };
			else
				num7[j /*3*/] = { func_48(Plr) };
		}
...
BOOL func_34(var uParam0) // Position - 0xE0C
{
...
void func_35(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE4F
{
	var args;
...
BOOL func_36(var uParam0) // Position - 0xE84
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(-741705372))
		return false;
...
void func_38(var uParam0) // Position - 0xF01
{
	func_51(uParam0, 0f);
	return;
}

char* func_39() // Position - 0xF10
{
	return "player_camp";
}

BOOL func_40(var uParam0, var uParam1) // Position - 0xF1B
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xFC7
{
...
float func_42(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xFF1
{
...
var func_43(Player plParam0) // Position - 0x1041
{
	var value;
...
var func_44(int iParam0, int iParam1) // Position - 0x1053
{
	return func_53(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

BOOL func_45(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x1071
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

int func_46() // Position - 0x109A
{
	return Global_1896646.f_41;
}

int func_47(int iParam0) // Position - 0x10A8
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_48(Player plParam0) // Position - 0x11AB
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

BOOL func_49(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0x11BF
{
	var unk;
	var unk6;
...
BOOL func_50(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x120C
{
	int i;
...
void func_51(var uParam0, float fParam1) // Position - 0x124C
{
...
float func_52(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x1272
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
var func_53(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x1290
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_61(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
BOOL func_54(int iParam0) // Position - 0x1623
{
...
Vector3 func_55(int iParam0) // Position - 0x1651
{
	return func_66(iParam0);
}

float func_56() // Position - 0x165F
{
...
void func_57(var uParam0, int iParam1) // Position - 0x1691
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_58(var uParam0, int iParam1) // Position - 0x16A2
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_59() // Position - 0x16B7
{
	return Global_1051645.f_12;
}

char* func_60() // Position - 0x16C5
{
	return "unnamed";
}

BOOL func_61(int iParam0) // Position - 0x16D0
{
	int num;
...
BOOL func_62(int iParam0) // Position - 0x175F
{
	if (Global_1572887.f_14 == -1)
		return false;
...
int func_63(int iParam0) // Position - 0x177D
{
	if (iParam0 == 255)
...
BOOL func_64(Player plParam0) // Position - 0x17C8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_65(var uParam0, var uParam1) // Position - 0x180D
{
	int num;
...
Vector3 func_66(int iParam0) // Position - 0x182D
{
	return Global_1835011[iParam0 /*72*/].f_19;
}

BOOL func_67(int iParam0, int iParam1) // Position - 0x1841
{
	int num;
...
BOOL func_68(Player plParam0) // Position - 0x18B5
{
...
void func_69(Player plParam0) // Position - 0x18D2
{
	Player player;
...
int func_70(var uParam0, var uParam1) // Position - 0x1955
{
	int num;
...
BOOL func_71(Any* panParam0, int iParam1, int iParam2) // Position - 0x1990
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_72() // Position - 0x19C7
{
	return Global_1102813.f_3672;
}

void func_73(Player plParam0) // Position - 0x19D6
{
	Player player;
...
void func_74(Player plParam0) // Position - 0x1A42
{
...
BOOL func_75(var uParam0, var uParam1) // Position - 0x1A7D
{
	if (!func_77(uParam0))
		return false;
...
int func_76(var uParam0, var uParam1) // Position - 0x1AB1
{
	var unk;
	var unk4;
	int num;
...
BOOL func_77(int iParam0) // Position - 0x1B58
{
	switch (iParam0)
	{
		case 2:
...
int func_78(int iParam0) // Position - 0x1B97
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_79(int iParam0, var uParam1, Any* panParam2) // Position - 0x1C2D
{
	if (!func_75(iParam0))
		return false;
...
void func_80(Any* panParam0) // Position - 0x1D38
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
