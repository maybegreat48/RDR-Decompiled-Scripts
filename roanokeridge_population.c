...
BOOL func_5(BOOL bParam0, BOOL bParam1) // Position - 0x2C5
{
	int i;
...
void func_8(Volume volParam0) // Position - 0x466
{
...
void func_9(Volume volParam0) // Position - 0x4A7
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x4EE
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
BOOL func_11(int iParam0) // Position - 0x56D
{
	int num;
	int num2;
	int offset;
...
void func_12(int iParam0) // Position - 0x5EC
{
	int num;
	int num2;
	int BitIndex;
...
void func_13(int iParam0) // Position - 0x61F
{
	int num;
	int num2;
	int BitIndex;
...
void func_15(var uParam0, int iParam1) // Position - 0x67E
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_16(int iParam0, int iParam1) // Position - 0x693
{
	switch (iParam0)
	{
...
BOOL func_17(int iParam0) // Position - 0x1F38
{
	int num;
...
BOOL func_18(int iParam0) // Position - 0x1F55
{
...
int func_19(int iParam0) // Position - 0x1F6C
{
	return func_20(iParam0) + 30;
}

int func_20(int iParam0) // Position - 0x1F7C
{
	return iParam0 * 31;
}
