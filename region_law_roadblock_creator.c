...
void func_1() // Position - 0xD2
{
	...
	for (i = 0; i < iLocal_39; i = i + 1)
	{
		if (func_9(iLocal_39[i], 0))
		{
			...
			TASK::TASK_PERFORM_SEQUENCE(iLocal_39[i], Sequence);
...
BOOL func_2(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1A9
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_4() // Position - 0x32E
{
	return func_20(1, 255);
}

BOOL func_5() // Position - 0x33D
{
	return Global_1893611 & 2 != 0;
}

void func_6() // Position - 0x34D
{
	int num;
	BOOL flag;
	int i;
	...
	switch (iLocal_16)
	{
		...
		case 4:
			...
			{
				func_28();
				func_29(fLocal_33, 10f, 0, 0, 5, true);
...
int func_7() // Position - 0x5D2
{
	return func_33(func_32(func_15()));
}

void func_8(int iParam0, int iParam1) // Position - 0x5E6
{
	if (func_34(iParam0))
...
BOOL func_9(Ped pedParam0, int iParam1) // Position - 0x5FF
{
	int num;
...
void func_10(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6FE
{
...
void func_11(Vector3 vParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0x76C
{
...
BOOL func_12(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7E5
{
...
int func_13() // Position - 0x883
{
	return Global_1939102.f_4;
}

BOOL func_14(int iParam0, BOOL bParam1) // Position - 0x891
{
	if (!func_38(iParam0))
		return false;
...
int func_15() // Position - 0x8CD
{
	return Global_1896646.f_41;
}

BOOL func_16(int iParam0, BOOL bParam1) // Position - 0x8DB
{
	if (!func_40(iParam0))
		return false;
...
int func_17() // Position - 0x917
{
	return Global_1893611.f_2;
}

BOOL func_18(int iParam0) // Position - 0x925
{
	if (!func_42(iParam0))
		return false;
...
BOOL func_20(int iParam0, int iParam1) // Position - 0x9BC
{
	int num;
...
float func_21(var uParam0) // Position - 0xA30
{
	if (!func_48(uParam0))
		return 0f;
...
void func_22(var uParam0) // Position - 0xA62
{
	func_51(uParam0, 0f);
	return;
}

void func_23() // Position - 0xA71
{
	int i;
...
BOOL func_24(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, float fParam7, float fParam8, float fParam9, float fParam10, int iParam11) // Position - 0xBC0
{
	int num;
...
void func_25(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0xCE5
{
	if (!func_34(iParam0))
	{
...
void func_26(var uParam0, int iParam1, BOOL bParam2) // Position - 0xD19
{
	uParam0->f_2 = 0;
...
void func_29(Vector3 vParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0xF65
{
	var offsetFromCoordAndHeadingInWorldCoords;
	var offsetFromCoordAndHeadingInWorldCoords2;
	Vector3 vector;
...
float func_31(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3) // Position - 0x101C
{
...
int func_32(int iParam0) // Position - 0x1064
{
	switch (iParam0)
	{
		case 0:
...
int func_33(int iParam0) // Position - 0x111F
{
	if (!func_38(iParam0))
		return 0;
...
BOOL func_34(int iParam0) // Position - 0x116B
{
	if (*iParam0 == 0)
		return false;
...
BOOL func_35(int iParam0, int iParam1) // Position - 0x1183
{
	return iParam0 && iParam1 != false;
}

Vector3 func_36(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6) // Position - 0x1192
{
	float num;
...
Vector3 func_37(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6) // Position - 0x1201
{
	float num;
...
BOOL func_38(int iParam0) // Position - 0x1270
{
	return iParam0 > -1 && iParam0 < 6;
}

BOOL func_39(int iParam0, int iParam1) // Position - 0x1285
{
	if (!func_38(iParam0))
		return false;
...
BOOL func_40(int iParam0) // Position - 0x12CA
{
	return iParam0 > -1 && iParam0 < 17;
}

BOOL func_41(int iParam0, BOOL bParam1) // Position - 0x12E0
{
	if (!func_40(iParam0))
		return false;
...
BOOL func_42(int iParam0) // Position - 0x1322
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_43(int iParam0, BOOL bParam1) // Position - 0x1338
{
	if (Global_1572887.f_14 == -1)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1369
{
...
BOOL func_45(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1393
{
...
BOOL func_46(Any* panParam0, int iParam1, int iParam2) // Position - 0x13EE
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_47() // Position - 0x1425
{
	return Global_1102813.f_3672;
}

BOOL func_48(var uParam0) // Position - 0x1434
{
	return func_64(*uParam0, 1);
}

BOOL func_49(var uParam0) // Position - 0x1444
{
	return func_64(*uParam0, 2);
}

float func_50() // Position - 0x1454
{
...
void func_51(var uParam0, float fParam1) // Position - 0x1486
{
...
void func_52(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6, float fParam7, float fParam8, float fParam9, int iParam10) // Position - 0x14AC
{
	int num;
	int num2;
...
void func_53(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x22BA
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_54(float fParam0, var uParam1, var uParam2) // Position - 0x2A7A
{
	float num;
	float num2;
...
int func_55(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2AB9
{
	var ReturnZ;
	int num;
	BOOL flag;
...
Ped func_56(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x2BBD
{
	Ped EntityIndex;
	...
	func_71(EntityIndex, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return EntityIndex;
}

void func_57(Entity eParam0, ItemSet isParam1) // Position - 0x2BFD
{
...
struct<4> func_58(var uParam0) // Position - 0x2C30
{
	var unk;
	int randomIntInRange;
	int i;
...
float func_59(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x2C8A
{
	return MISC::GET_HEADING_FROM_VECTOR_2D(fParam3 - uParam0, fParam3.f_1 - uParam0.f_1);
}

Vector3 func_60(float fParam0) // Position - 0x2CA4
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

int func_61(int iParam0) // Position - 0x2CBA
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_62(int iParam0) // Position - 0x2D28
{
	int i;
...
float func_63(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x2D53
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x2D71
{
	return iParam0 && iParam1 != false;
}

void func_65(var uParam0, int iParam1) // Position - 0x2D80
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_66(var uParam0, int iParam1) // Position - 0x2D91
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_67(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x2DA6
{
	float num;
...
int func_68(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2DCB
{
	int num;
...
int func_69(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x2E19
{
	return func_74(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

BOOL func_70(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x2E2F
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

void func_71(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2E58
{
	BOOL flag;
...
struct<2> func_72(Player plParam0) // Position - 0x2F22
{
	var gamerHandle;
...
int func_73(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2F36
{
	int num;
	int num2;
	int num3;
...
int func_74(Hash hParam0) // Position - 0x2FED
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
void func_75(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x30A7
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_76(Ped pedParam0, BOOL bParam1) // Position - 0x30EC
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_77(Ped pedParam0, int iParam1) // Position - 0x3131
{
	if (iParam1 == 1)
...
int func_78(var uParam0, var uParam1, var uParam2) // Position - 0x3158
{
	int num;
...
int func_79(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x3193
{
	if (fParam0 < fParam3)
