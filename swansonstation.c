...
void _DEBUG_PRINT(int iParam0) // Position - 0x802
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x80E
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x81B
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x827
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x834
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x840
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x855
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x866
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x8A5
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x8B1
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x8B9
{
	if (func_54(iParam0))
		return true;
...
void func_26() // Position - 0x984
{
	return;
}

void func_27() // Position - 0x98C
{
	return;
}

void func_28() // Position - 0x994
{
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x99C
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x9A8
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x9B4
{
	return;
}

void func_32() // Position - 0x9BC
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0_0(int iParam0) // Position - 0x9C4
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0x9D0
{
...
void func_35(var uParam0) // Position - 0xA01
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA47
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xA5C
{
	if (!func_60(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xA75
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xA86
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xA9E
{
	return true;
}

void func_41(var uParam0, int iParam1) // Position - 0xAA7
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xBE6
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xBF3
{
...
BOOL func_44(int iParam0) // Position - 0xC29
{
	if (iParam0 == 0)
	{
		func_74();
...
int func_45() // Position - 0xD3D
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xD4B
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xD57
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xDC4
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xEA4
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xEC2
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xED5
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xEF3
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0xFEB
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0xFFC
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x1010
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x1024
{
	return uParam0;
}

void func_58(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x102E
{
	!bParam2;
...
void func_59(var uParam0, Volume volParam1, int iParam2) // Position - 0x1B73
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_60(int iParam0) // Position - 0x1BCC
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_61() // Position - 0x1BE2
{
	int i;
...
BOOL func_62(int iParam0, int iParam1) // Position - 0x1C0F
{
	return iParam0 && iParam1 != false;
}

BOOL func_63(var uParam0, int iParam1) // Position - 0x1C1E
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_64() // Position - 0x1C2F
{
	return func_62(Global_1940199, 8192);
}

BOOL func_65(var uParam0, int iParam1) // Position - 0x1C42
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_66(int iParam0) // Position - 0x1C53
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_67(int iParam0, int iParam1) // Position - 0x1C93
{
...
int func_68() // Position - 0x1CC0
{
	return Global_1896646.f_41;
}

void func_69(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1CCE
{
	BOOL flag;
	...
	StringToTest = func_100(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_112(&unk, joaat("COLOR_PURE_WHITE")), str3, func_112(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_112(&unk, joaat("COLOR_PURE_WHITE")), func_112(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_113(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_70(var uParam0, int iParam1) // Position - 0x1F33
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_71(int iParam0, BOOL bParam1) // Position - 0x1F46
{
...
void func_72(BOOL bParam0) // Position - 0x25AF
{
	if (bParam0)
...
BOOL func_73(int iParam0) // Position - 0x25D8
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_74() // Position - 0x261D
{
	return;
}

Hash func_75(int iParam0, BOOL bParam1) // Position - 0x2625
{
	switch (iParam0)
	{
		case 0:
...
void func_76(int iParam0, BOOL bParam1) // Position - 0x2DEA
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_77(BOOL bParam0) // Position - 0x2E3D
{
	if (bParam0)
...
void func_78(int iParam0) // Position - 0x2E66
{
	return;
}

void func_79(int iParam0) // Position - 0x2E6E
{
	int i;
...
void func_80(int iParam0) // Position - 0x2E9F
{
	int i;
...
BOOL func_81(int iParam0, BOOL bParam1) // Position - 0x2ED2
{
	int num;
	int num2;
	int num3;
...
BOOL func_82(int iParam0) // Position - 0x2F88
{
	int i;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x3002
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_84(int iParam0) // Position - 0x3033
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_85(int iParam0) // Position - 0x3054
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_86(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x30A7
{
	BOOL flag;
...
BOOL func_87(int iParam0) // Position - 0x3767
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_88(int iParam0) // Position - 0x377E
{
	switch (iParam0)
	{
		case 64:
...
int func_89(int iParam0, BOOL bParam1) // Position - 0x37C1
{
	if (!func_87(iParam0))
		return 0;
...
void func_90(int iParam0) // Position - 0x38AC
{
	int num;
	int num2;
	int BitIndex;
...
void func_91(int iParam0) // Position - 0x38DF
{
	int num;
	int num2;
	int BitIndex;
...
BOOL func_94(int iParam0) // Position - 0x39BB
{
	int num;
	int num2;
	int offset;
...
void func_95(Hash hParam0) // Position - 0x3A3A
{
...
BOOL func_96(int iParam0) // Position - 0x3A5A
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_97(int iParam0) // Position - 0x3A70
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_98(int iParam0) // Position - 0x3A86
{
...
const char* func_100(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x3AFE
{
	const char* StringToTest;
...
BOOL func_101(int iParam0) // Position - 0x4562
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_102(int iParam0) // Position - 0x4577
{
	switch (iParam0)
	{
		case 0:
...
Hash func_103(int iParam0) // Position - 0x4632
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_104(int iParam0) // Position - 0x46A0
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_105(int iParam0) // Position - 0x47FB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_106(int iParam0, BOOL bParam1) // Position - 0x4836
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x4878
{
	if (!func_101(iParam0))
		return false;
...
int func_108() // Position - 0x48BD
{
	return Global_1902569;
}

int func_109(int iParam0) // Position - 0x48C9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_110(int iParam0) // Position - 0x48DC
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_111(float fParam0) // Position - 0x48EE
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_112(var uParam0, int iParam1) // Position - 0x4904
{
...
int func_113(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x493A
{
	int duration;
	var data;
	int num;
...
BOOL func_114(int iParam0) // Position - 0x497D
{
	if (func_143(iParam0))
		if (!func_144(44))
			return false;
...
void func_115(int iParam0, int iParam1) // Position - 0x499D
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_116(int iParam0, int iParam1) // Position - 0x49AE
{
	int num;
...
void func_117(var uParam0, var uParam1, int iParam2) // Position - 0x49C4
{
...
void func_118(int iParam0) // Position - 0x49E1
{
...
void func_119(int iParam0) // Position - 0x4AC1
{
	int i;
	int num;
...
BOOL func_120(int iParam0, BOOL bParam1) // Position - 0x4C99
{
	if (func_45() != -1)
		return false;
...
int func_121(int iParam0, BOOL bParam1) // Position - 0x4CC7
{
	if (!func_87(iParam0))
		return 0;
...
int func_122(int iParam0) // Position - 0x4D4A
{
	switch (iParam0)
	{
		case 27:
...
int func_123(int iParam0) // Position - 0x4D71
{
	switch (iParam0)
	{
		case 33:
...
void func_126(int iParam0, BOOL bParam1) // Position - 0x4FD4
{
	BOOL flag;
...
Hash func_127(int iParam0) // Position - 0x5383
{
	if (!func_87(iParam0))
		return 0;
...
void func_128(int iParam0, PersChar pchParam1) // Position - 0x53A1
{
	if (!func_87(iParam0))
		return;
...
PersChar func_129(int iParam0) // Position - 0x53C2
{
	if (!func_87(iParam0))
		return 0;
...
void func_130(int iParam0, BOOL bParam1) // Position - 0x53E2
{
	if (func_45() != -1)
		return;
...
BOOL func_131(int iParam0) // Position - 0x541B
{
	if (!func_87(iParam0))
		return false;
...
int func_132(int iParam0, int iParam1) // Position - 0x5441
{
	switch (iParam0)
	{
...
BOOL func_133(int iParam0) // Position - 0x6CE6
{
	int num;
...
BOOL func_134(int iParam0) // Position - 0x6D03
{
...
BOOL func_135(Hash hParam0) // Position - 0x6D1A
{
	if (func_170(hParam0))
...
BOOL func_136() // Position - 0x6D35
{
	return 1;
}

BOOL func_137() // Position - 0x6D3E
{
	return false;
}

BOOL func_138() // Position - 0x6D47
{
	var unk;
	var unk3;
...
BOOL func_139(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6DAF
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_140(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6F25
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_141(var uParam0, var uParam1, var uParam2) // Position - 0x6F39
{
	int i;
...
const char* func_142(int iParam0) // Position - 0x6F67
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_143(int iParam0) // Position - 0x724B
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_144(int iParam0) // Position - 0x7275
{
	if (!func_176(iParam0))
		return false;
...
struct<2> func_145(Player plParam0) // Position - 0x7291
{
	var gamerHandle;
...
const char* func_146(const char* sParam0, int iParam1) // Position - 0x72A5
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_147(int iParam0, BOOL bParam1) // Position - 0x72BF
{
	char* StringToTest;
...
void func_148(int iParam0, BOOL bParam1) // Position - 0x72F3
{
	switch (iParam0)
	{
		case 5:
...
void func_149(int iParam0, int iParam1) // Position - 0x7328
{
	func_178(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_150(int iParam0) // Position - 0x7342
{
	if (!func_87(iParam0))
		return false;
...
void func_151(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7367
{
	PersChar persChar;
...
void func_152(int iParam0, BOOL bParam1) // Position - 0x7453
{
	if (!func_181(iParam0))
		return;
...
void func_153(int iParam0, int iParam1) // Position - 0x74A9
{
	if (!func_186(iParam0))
		return;
...
int func_154(int iParam0) // Position - 0x751C
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_155(int iParam0) // Position - 0x7532
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_156(int iParam0, BOOL bParam1) // Position - 0x7548
{
	if (func_45() != -1)
		return;
...
void func_157(int iParam0) // Position - 0x7579
{
	Ped EntityIndex;
...
void func_158(int iParam0) // Position - 0x75BD
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_159(int iParam0) // Position - 0x75D2
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_160(int iParam0) // Position - 0x75E7
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_161(int iParam0) // Position - 0x75FC
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_162(int iParam0) // Position - 0x767B
{
...
BOOL func_163(int iParam0, BOOL bParam1) // Position - 0x76D8
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL func_164(int iParam0, int iParam1) // Position - 0x76F1
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_165(int iParam0, int iParam1) // Position - 0x770A
{
...
int func_166(int iParam0) // Position - 0x7745
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_167(int iParam0) // Position - 0x7759
{
	return;
}

BOOL func_168(int iParam0, int iParam1) // Position - 0x7761
{
	if (iParam0 == -1)
		return false;
...
int func_169(int iParam0) // Position - 0x7788
{
	return func_189(iParam0) + 30;
}

BOOL func_170(Hash hParam0) // Position - 0x7798
{
	return hParam0 != 0;
}

BOOL func_171() // Position - 0x77A4
{
	if (Global_1048576)
		return true;
...
struct<2> func_172() // Position - 0x77FC
{
	return Global_1051268;
}

BOOL func_173(var uParam0, var uParam1) // Position - 0x780A
{
	if (!func_190(uParam0))
		return false;
...
struct<2> func_174() // Position - 0x783E
{
...
BOOL func_175(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7889
{
	var unk;
	float num;
	float num2;
...
BOOL func_176(int iParam0) // Position - 0x78B9
{
	if (iParam0 == 0)
		return false;
...
BOOL func_177(int iParam0) // Position - 0x78CC
{
	int num;
	int num2;
	int offset;
...
void func_178(BOOL bParam0, int iParam1) // Position - 0x78F6
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_179(int iParam0) // Position - 0x790B
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_180(Hash hParam0) // Position - 0x792F
{
	return hParam0 != 0;
}

BOOL func_181(int iParam0) // Position - 0x793B
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_182(int iParam0, BOOL bParam1) // Position - 0x7951
{
	if (!func_181(iParam0))
		return false;
...
void func_183(int iParam0, BOOL bParam1) // Position - 0x7977
{
	if (!func_181(iParam0))
		return;
...
void func_184(int iParam0, BOOL bParam1) // Position - 0x79A5
{
	if (!func_181(iParam0))
		return;
...
void func_185(int iParam0) // Position - 0x79DF
{
	func_195(func_194(iParam0));
	return;
}

BOOL func_186(int iParam0) // Position - 0x79F1
{
	return iParam0 > -1 && iParam0 < 40;
}

Ped func_187(int iParam0) // Position - 0x7A07
{
	PersChar persChar;
...
BOOL func_188(BOOL bParam0, BOOL bParam1) // Position - 0x7A35
{
	return bParam0 && bParam1 != false;
}

int func_189(int iParam0) // Position - 0x7A44
{
	return iParam0 * 31;
}

BOOL func_190(int iParam0) // Position - 0x7A50
{
	switch (iParam0)
	{
		case 2:
...
int func_191(int iParam0) // Position - 0x7A8F
{
	switch (iParam0)
	{
		case 2:
...
void func_192(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7B25
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_193(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x85C7
{
	float num;
	float num2;
	float num3;
...
int func_194(int iParam0) // Position - 0x862D
{
...
void func_195(int iParam0) // Position - 0x8B4A
{
