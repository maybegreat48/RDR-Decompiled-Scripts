...
void func_4(int iParam0) // Position - 0x13C
{
	Global_1572864.f_3 = Global_1572864.f_3 || iParam0;
	return;
}

void func_5() // Position - 0x153
{
	int i;
...
void func_6(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x17E
{
...
void func_7(int iParam0) // Position - 0x20B
{
	if (iParam0 == 0)
		iParam0 = 1;
...
void func_8(int iParam0) // Position - 0x224
{
	func_11(&(Global_1572887.f_300.f_1), func_10(iParam0), 3);
	return;
}

void func_9() // Position - 0x241
{
	int i;
...
int func_10(int iParam0) // Position - 0x2D0
{
	int num;
...
BOOL func_11(Any* panParam0, int iParam1, int iParam2) // Position - 0x48A
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_12(int iParam0) // Position - 0x4BD
{
	return func_13(&(Global_1572887.f_300.f_1), iParam0, 3);
}

BOOL func_13(Any* panParam0, int iParam1, int iParam2) // Position - 0x4D5
{
