...
void func_1(BOOL bParam0) // Position - 0xCA
{
	Player player;
	BOOL flag;
	var unk;
...
void func_3(int iParam0, int iParam1) // Position - 0x190
{
	if (iParam0 != 0)
...
void func_4() // Position - 0x1B4
{
	Global_1572887.f_196.f_42 = MISC::GET_GAME_TIMER();
	return;
}

void func_5(int iParam0) // Position - 0x1C8
{
	Global_1572887.f_196.f_2 = iParam0;
	return;
}

void func_6(int iParam0) // Position - 0x1DA
{
	Global_1572887.f_196 = iParam0;
	return;
}

void func_7(int iParam0, int iParam1) // Position - 0x1EA
{
...
void func_8(int iParam0) // Position - 0x20F
{
	Global_1572864.f_3 = Global_1572864.f_3 || iParam0;
	return;
}

void func_9() // Position - 0x226
{
	int i;
...
void func_10(int iParam0) // Position - 0x251
{
	if (iParam0 == 0)
		iParam0 = 1;
