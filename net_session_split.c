...
BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0x47
{
	int i;
...
void func_3(var uParam0) // Position - 0x127
{
	int i;
...
void func_4() // Position - 0x265
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_5(int iParam0, var uParam1) // Position - 0x271
{
	*uParam1 = iParam0;
	return;
}
