...
void func_2(Any* panParam0) // Position - 0x99
{
	if (iLocal_13 == 6)
		return;
...
void func_6() // Position - 0x16F
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_7(int iParam0, int iParam1) // Position - 0x17B
{
...
void func_9() // Position - 0x2A9
{
	return;
}

int func_10(int iParam0, int iParam1, char* sParam2) // Position - 0x2B1
{
	return 1;
}

int func_11(int iParam0, int iParam1, char* sParam2) // Position - 0x2BA
{
	return 1;
}

void func_12(BOOL bParam0) // Position - 0x2C3
{
	int num;
	var unk;
	int num2;
...
void func_13(Any* panParam0) // Position - 0x38C
{
	Player player;
	BOOL flag;
	int num;
...
void func_14() // Position - 0x447
{
	func_35();
	return;
}

void func_15() // Position - 0x453
{
	return;
}

BOOL func_16(BOOL bParam0, BOOL bParam1) // Position - 0x45B
{
	int i;
...
BOOL func_17(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x53B
{
...
BOOL func_19(int iParam0) // Position - 0x678
{
	return iParam0 >= 0 && iParam0 < 71;
}

struct<2> func_20(int iParam0) // Position - 0x68E
{
	return Global_1219595.f_1[iParam0 /*10*/].f_4;
}

BOOL func_21(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6A4
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

void func_22() // Position - 0x6BF
{
	if (iLocal_13 <= 5)
		func_40();
...
void func_24() // Position - 0x79B
{
	return;
}

void func_25() // Position - 0x7A3
{
	if (func_56())
...
void func_26() // Position - 0x7CD
{
	func_58();
	return;
}

void func_27() // Position - 0x7D9
{
...
int func_28() // Position - 0x823
{
	return Global_1572887.f_14;
}

BOOL func_29() // Position - 0x831
{
	return Global_1051645.f_8;
}

int func_30(var uParam0, var uParam1, int iParam2) // Position - 0x83F
{
	var unk;
	int num;
	int num2;
...
void func_31(Any* panParam0, int iParam1, int iParam2, int iParam3, Player plParam4) // Position - 0x92E
{
	var SourceStruct;
	int i;
...
struct<2> func_32(var uParam0, int iParam1) // Position - 0xC54
{
	int num;
...
void func_33() // Position - 0xD7A
{
	return;
}

void func_34() // Position - 0xD82
{
...
BOOL func_36(int iParam0, var uParam1) // Position - 0xDE8
{
	if (!func_110(iParam0))
		return false;
...
BOOL func_37(int iParam0) // Position - 0xE1C
{
...
BOOL func_38(BOOL bParam0, int iParam1) // Position - 0xE3D
{
...
void func_40() // Position - 0xED1
{
	return;
}

void func_41() // Position - 0xED9
{
	Player player;
	var unk;
...
void func_49() // Position - 0x11D2
{
	func_139();
	return;
}

void func_50() // Position - 0x11DE
{
	if (iLocal_13 == 6)
	{
		func_140(6);
...
void func_59(int iParam0, int iParam1) // Position - 0x1432
{
	Player playerIndex;
...
BOOL func_61(int iParam0) // Position - 0x1531
{
	return func_169(uLocal_100.f_7, iParam0);
}

void func_62(int iParam0) // Position - 0x1543
{
	Player player;
...
void func_63() // Position - 0x1577
{
	...
	for (i = 0; i <= 2; i = i + 1)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_100.f_19.f_2[i /*4*/].f_1))
		{
			...
			{
				PedIndex = NETWORK::NET_TO_PED(iLocal_13.f_7.f_2[i]);
			
				if (func_172(PedIndex, 0, true, false) != joaat("WEAPON_UNARMED"))
				{
					WEAPON::SET_CURRENT_PED_WEAPON(PedIndex, joaat("WEAPON_UNARMED"), false, 0, false, false);
					TASK::TASK_SWAP_WEAPON(PedIndex, true, true, false, false);
				}
			
				if (PED::GET_PED_CROUCH_MOVEMENT(PedIndex))
					PED::_SET_PED_CROUCH_MOVEMENT(PedIndex, false, 0, false);
				else if (PED::GET_PED_STEALTH_MOVEMENT(PedIndex))
					PED::SET_PED_STEALTH_MOVEMENT(PedIndex, false, 0, 0);
			
				if (!PED::IS_PED_FLEEING(PedIndex) && !PED::IS_PED_IN_COMBAT(PedIndex, 0))
					TASK::TASK_WANDER_STANDARD(PedIndex, 1193033728, 1);
			
				PED::SET_PED_KEEP_TASK(PedIndex, true);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(PedIndex, false);
				PED::SET_PED_CONFIG_FLAG(PedIndex, 178, true);
			
				if (!func_173())
					PED::_SET_REMOVE_PED_NETWORKED(PedIndex, -1);
	...
	for (j = 0; j <= 0; j = j + 1)
	{
		...
		{
			ObjectIndex = NETWORK::NET_TO_OBJ(iLocal_13.f_7.f_9[j]);
...
void func_64(var uParam0, var uParam1) // Position - 0x170E
{
	uParam0->f_9 = 2;
...
int func_65(var uParam0) // Position - 0x1731
{
	int num;
	int i;
...
struct<15> func_66(int iParam0) // Position - 0x1792
{
	var unk;
...
void func_67(Any* panParam0, int iParam1) // Position - 0x17FC
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 4;
...
void func_68(Any* panParam0, int iParam1) // Position - 0x19AE
{
	panParam0->f_6 = 1;
	*panParam0 = 20;
	panParam0->f_1 = 2;
...
void func_69(Any* panParam0, int iParam1) // Position - 0x1D5B
{
	panParam0->f_6 = 1;
	*panParam0 = 21;
	panParam0->f_1 = 8;
...
void func_70(Any* panParam0, int iParam1) // Position - 0x2321
{
	panParam0->f_6 = 1;
	*panParam0 = 11;
	panParam0->f_1 = 1;
...
void func_71(Any* panParam0, int iParam1) // Position - 0x2546
{
	panParam0->f_6 = 1;
	*panParam0 = 15;
	panParam0->f_1 = 3;
...
void func_72(Any* panParam0, int iParam1) // Position - 0x2813
{
	panParam0->f_6 = 1;
	*panParam0 = 16;
	panParam0->f_1 = 2;
...
void func_73(Any* panParam0, int iParam1, int iParam2) // Position - 0x2B20
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 12;
...
void func_74(Any* panParam0, int iParam1) // Position - 0x2F25
{
	panParam0->f_6 = 1;
	*panParam0 = 21;
	panParam0->f_1 = 1;
...
void func_75(Any* panParam0, int iParam1) // Position - 0x3300
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 4;
...
void func_76(Any* panParam0, int iParam1, int iParam2) // Position - 0x34F3
{
	panParam0->f_6 = 1;
	*panParam0 = 12;
	panParam0->f_1 = 4;
...
void func_77(Any* panParam0, int iParam1) // Position - 0x374B
{
	panParam0->f_6 = 1;
	*panParam0 = 20;
	panParam0->f_1 = 1;
...
void func_78(Any* panParam0, int iParam1) // Position - 0x3AF9
{
	panParam0->f_6 = 1;
	*panParam0 = 9;
	panParam0->f_1 = 2;
...
void func_79(Any* panParam0, int iParam1, Player plParam2) // Position - 0x3CC1
{
	panParam0->f_6 = 1;
	*panParam0 = 1;
	panParam0->f_1 = 6;
...
void func_80(Any* panParam0, int iParam1, int iParam2) // Position - 0x3D30
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 5;
...
void func_81(Any* panParam0, int iParam1) // Position - 0x3F2A
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 1;
	*panParam0 = 12;
...
void func_82(Any* panParam0, int iParam1, int iParam2) // Position - 0x417A
{
	panParam0->f_6 = 1;
	*panParam0 = 15;
	panParam0->f_1 = 2;
...
void func_83(Any* panParam0, int iParam1) // Position - 0x43EF
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 15;
...
void func_84(Any* panParam0, int iParam1) // Position - 0x4718
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 13;
...
void func_85(Any* panParam0, int iParam1) // Position - 0x49DC
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_86(Any* panParam0, int iParam1) // Position - 0x4C5F
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_87(Any* panParam0, int iParam1) // Position - 0x4E93
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 11;
...
void func_88(Any* panParam0, int iParam1) // Position - 0x50F5
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 20;
...
void func_89(Any* panParam0, int iParam1) // Position - 0x562C
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 15;
...
void func_90(Any* panParam0, int iParam1) // Position - 0x5A2D
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_91(Any* panParam0, int iParam1) // Position - 0x5D04
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 20;
...
void func_92(Any* panParam0, int iParam1) // Position - 0x612A
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_93(Any* panParam0, int iParam1) // Position - 0x6395
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 25;
...
void func_94(Any* panParam0, int iParam1, int iParam2) // Position - 0x689A
{
	BOOL flag;
...
void func_95(Any* panParam0, int iParam1, int iParam2) // Position - 0x6A90
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 3;
...
void func_96(Any* panParam0, int iParam1) // Position - 0x6C9A
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 2;
...
void func_97(Any* panParam0, int iParam1) // Position - 0x6EDA
{
	panParam0->f_6 = 1;
	*panParam0 = 11;
	panParam0->f_1 = 1;
...
void func_98(Any* panParam0, int iParam1) // Position - 0x70F3
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 1;
...
void func_99(Any* panParam0, int iParam1) // Position - 0x72DF
{
	panParam0->f_6 = 1;
	*panParam0 = 7;
	panParam0->f_1 = 3;
...
void func_100(Any* panParam0, int iParam1) // Position - 0x745B
{
	panParam0->f_6 = 1;
	*panParam0 = 8;
	panParam0->f_1 = 2;
...
void func_101(Any* panParam0, int iParam1, int iParam2) // Position - 0x75F7
{
	int num;
...
int func_102(int iParam0) // Position - 0x77AA
{
	switch (iParam0)
	{
		case 2:
...
int func_103(var uParam0, Any* panParam1, int iParam2) // Position - 0x7840
{
	int num;
	int num2;
	int num3;
...
struct<2> func_104() // Position - 0x7895
{
	var unk;
...
void func_105(var uParam0) // Position - 0x78AE
{
...
void func_106(var uParam0, BOOL bParam1) // Position - 0x78E9
{
	if (bParam1)
	{
		func_212(uParam0, 16);
...
void func_107(var uParam0, BOOL bParam1) // Position - 0x7914
{
	if (bParam1)
...
BOOL func_110(int iParam0) // Position - 0x79AC
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_111(var uParam0, int iParam1) // Position - 0x79EB
{
	return func_217(uParam0->f_25, iParam1);
}

void func_112(int iParam0) // Position - 0x79FD
{
...
int func_113(Player plParam0) // Position - 0x7A10
{
	Player player;
...
void func_114(int iParam0) // Position - 0x7A40
{
	if (!func_122(iParam0))
...
BOOL func_115(int iParam0) // Position - 0x7A5C
{
	if (!func_170(iParam0))
		return false;
...
void func_116(int iParam0) // Position - 0x7A8B
{
...
BOOL func_118(int iParam0) // Position - 0x7B86
{
	return iParam0 != 0;
}

void func_119(int iParam0) // Position - 0x7B92
{
	*iParam0 = Global_1295666.f_16;
	return;
}

int func_120(var uParam0) // Position - 0x7BA3
{
	return (Global_1295666.f_16 - uParam0) * 1000;
}

BOOL func_121(int iParam0, int iParam1) // Position - 0x7BB7
{
	if (iParam1 == 255)
		if (!func_221(&iParam1))
			return false;
...
BOOL func_122(int iParam0) // Position - 0x7BE0
{
	return func_169(iLocal_13.f_1, iParam0);
}

BOOL func_123() // Position - 0x7BF2
{
	return true;
}

void func_124() // Position - 0x7BFB
{
	return;
}

BOOL func_125() // Position - 0x7C03
{
	BOOL num;
	BOOL flag;
	int i;
...
BOOL func_126() // Position - 0x7CB1
{
	return true;
}

void func_127() // Position - 0x7CBA
{
	iLocal_13.f_7.f_11 = func_216();
	return;
}

void func_128() // Position - 0x7CCC
{
...
void func_130() // Position - 0x7D90
{
	return;
}

BOOL func_131() // Position - 0x7D98
{
	if (func_229())
		return true;
...
void func_132() // Position - 0x7E15
{
	return;
}

BOOL func_133() // Position - 0x7E1D
{
	Ped EntityIndex;

	EntityIndex = func_238(0);

	if (!ENTITY::DOES_ENTITY_EXIST(EntityIndex) || ENTITY::IS_ENTITY_DEAD(EntityIndex) || func_239(EntityIndex, 518218985) || func_240(4, false))
		return true;

	return false;
}

void func_134(int iParam0) // Position - 0x7E64
{
	if (func_61(iParam0))
...
int func_135(int iParam0, int iParam1, BOOL bParam2) // Position - 0x7E7F
{
	int num;
	Player player;
...
void func_136(int iParam0) // Position - 0x7EF2
{
	if (!func_61(iParam0))
...
void func_137(int iParam0) // Position - 0x7F0E
{
...
void func_138(int iParam0) // Position - 0x7F35
{
...
void func_140(int iParam0) // Position - 0x7FC3
{
...
void func_143(var uParam0) // Position - 0x8128
{
	*uParam0 = 0;
	return;
}

void func_144() // Position - 0x8134
{
	return;
}

int func_145() // Position - 0x813C
{
	return 1;
}

int func_146() // Position - 0x8145
{
	return 1;
}

int func_147(int iParam0) // Position - 0x814E
{
	return (iParam0 - Global_1295666.f_16) * 1000;
}

void func_148() // Position - 0x8162
{
	if (!func_61(1))
	{
...
void func_149() // Position - 0x8182
{
	func_252();
	return;
}

void func_150() // Position - 0x818E
{
	int i;
	Ped entityIndex;
	int j;
			...
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(entityIndex))
			{
				switch (i)
				{
					case 0:
						...
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(entityIndex, uLocal_100.f_19.f_158);
						break;
				
					case 1:
						func_253(1);
						PED::SET_LOOTING_FLAG(entityIndex, 4, false);
						ENTITY::SCRIPT_OVERRIDE_ENTITY_LOOT_TABLE_PERMANENT(entityIndex, joaat("gunholder_rich"));
						func_254(entityIndex, true, true);
						break;
				
					case 2:
						func_253(2);
						func_255(entityIndex, joaat("group_revolver"), 1, false, false, false, false, 1056964608, 1065353216, -1, false, false, false, false);
						PED::_SET_PED_CROUCH_MOVEMENT(entityIndex, true, 0, false);
						PED::SET_PED_RELATIONSHIP_GROUP_DEFAULT_HASH(entityIndex, joaat("rel_player_enemy"));
						PED::SET_PED_CONFIG_FLAG(entityIndex, 467, true);
						func_257(&(uLocal_100.f_19.f_56), entityIndex, func_256(2), true);
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(entityIndex, uLocal_100.f_19.f_158);
						ENTITY::SCRIPT_OVERRIDE_ENTITY_LOOT_TABLE_PERMANENT(entityIndex, joaat("gunholder_rich"));
						break;
				}
	...
	for (j = 0; j <= 0; j = j + 1)
	{
		if (func_224(j, func_216()))
		{
			...
			entityIndex2 = NETWORK::NET_TO_ENT(iLocal_13.f_7.f_9[j]);
		
			switch (j)
			{
				case 0:
					if (func_175(entityIndex2))
						func_258(OBJECT::_0x250EBB11E81A10BE(entityIndex2));
				
					if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(entityIndex2))
					{
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(entityIndex2, true, false);
						ENTITY::SET_ENTITY_HEADING(entityIndex2, func_259(0));
					}
...
void func_151() // Position - 0x8375
{
	return;
}

void func_152() // Position - 0x837D
{
	return;
}

void func_153() // Position - 0x8385
{
	float num;
...
BOOL func_160() // Position - 0x85B6
{
	Ped EntityIndex;

	EntityIndex = func_238(0);

	if (func_282(EntityIndex, 518218985, true, false) && !func_240(4, false))
		TASK::TASK_FLEE_COORD(EntityIndex, ENTITY::GET_ENTITY_COORDS(EntityIndex, false, false), 3, 0, -1082130432, -1, 0);

	return true;
}

void func_161() // Position - 0x85F9
{
	return;
}
...
BOOL func_163(var uParam0) // Position - 0x862B
{
	if (*uParam0 == 0)
		return false;
...
BOOL func_164(int iParam0, Player plParam1, int iParam2) // Position - 0x8643
{
...
void func_165(var uParam0, var uParam1, int iParam2, int iParam3, Player plParam4, int iParam5) // Position - 0x866B
{
	int deedType;
	Hash deedHash;
	int data;
...
void func_166(int iParam0, var uParam1) // Position - 0x873A
{
	int num;
...
void func_167(int iParam0, int iParam1) // Position - 0x875B
{
...
void func_168(int iParam0) // Position - 0x87C8
{
	var statId;
	int value;
...
BOOL func_169(int iParam0, int iParam1) // Position - 0x8810
{
	return iParam0 && iParam1 != false;
}

BOOL func_170(int iParam0) // Position - 0x881F
{
...
void func_171(int iParam0) // Position - 0x883E
{
...
int func_172(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8869
{
...
BOOL func_173() // Position - 0x888F
{
	return func_122(32) || func_121(32, 255);
}

Entity func_174(int iParam0) // Position - 0x88AA
{
	return uLocal_100.f_19.f_15[iParam0 /*2*/].f_1;
}

BOOL func_175(Entity eParam0) // Position - 0x88BE
{
...
Vector3 func_176(int iParam0) // Position - 0x88DC
{
	int num;
...
BOOL func_177(var uParam0) // Position - 0x8C79
{
	if (func_36(*uParam0))
		return true;
...
int func_178(var uParam0, int iParam1) // Position - 0x8CBD
{
	int num;
	int num2;
	BOOL flag;
...
void func_179(Any* panParam0, int iParam1) // Position - 0x8E1C
{
	switch (iParam1)
	{
		case 0:
...
void func_180(Any* panParam0) // Position - 0x8ED1
{
	int i;
...
void func_181(Any* panParam0) // Position - 0x8EF8
{
	int i;
...
void func_182(Any* panParam0, int iParam1) // Position - 0x8F1F
{
	MISC::SET_BIT(&(panParam0->f_3), iParam1);
	return;
}

void func_183(Any* panParam0, int iParam1) // Position - 0x8F31
{
	switch (iParam1)
	{
		case 0:
...
void func_184(Any* panParam0, int iParam1) // Position - 0x8FC2
{
	switch (iParam1)
	{
		case 0:
...
void func_185(Any* panParam0, int iParam1) // Position - 0x9063
{
	func_242(&(panParam0->f_25), iParam1);
	return;
}

void func_186(Any* panParam0, int iParam1) // Position - 0x9075
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_187(int iParam0) // Position - 0x90D0
{
	if (!func_170(iParam0))
		return 0f, 0f, 0f;
...
void func_188(Any* panParam0, int iParam1) // Position - 0x90F4
{
	switch (iParam1)
	{
		case 0:
...
void func_189(Any* panParam0, int iParam1) // Position - 0x914C
{
	switch (iParam1)
	{
		case 0:
...
void func_190(Any* panParam0, int iParam1) // Position - 0x9199
{
	switch (iParam1)
	{
		case 0:
...
void func_191(Any* panParam0, int iParam1) // Position - 0x9231
{
	switch (iParam1)
	{
		case 0:
...
void func_192(Any* panParam0, int iParam1) // Position - 0x92BC
{
	switch (iParam1)
	{
		case 0:
...
void func_193(Any* panParam0, int iParam1) // Position - 0x9388
{
	switch (iParam1)
	{
		case 0:
...
void func_194(Any* panParam0, int iParam1) // Position - 0x9447
{
	switch (iParam1)
	{
		case 0:
...
void func_195(Any* panParam0, int iParam1) // Position - 0x9500
{
	switch (iParam1)
	{
		case 0:
...
void func_196(Any* panParam0, int iParam1, int iParam2) // Position - 0x95E8
{
	switch (iParam1)
	{
		case 0:
...
void func_197(Any* panParam0, int iParam1, int iParam2) // Position - 0x9675
{
	switch (iParam1)
	{
		case 0:
...
void func_198(Any* panParam0, int iParam1) // Position - 0x96FB
{
	switch (iParam1)
	{
		case 0:
...
int func_199(int iParam0) // Position - 0x972F
{
	return Global_1260806.f_3432[iParam0];
}

int func_200(int iParam0) // Position - 0x9742
{
	if (iParam0 == -1)
		return -1;
...
int func_201(int iParam0) // Position - 0x975E
{
	if (iParam0 == -1)
		return 0;
...
var func_202(int iParam0, int iParam1) // Position - 0x9778
{
	var unk;
	var unk2;
...
int func_203(int iParam0, int iParam1) // Position - 0x97AB
{
	int num;
	var unk;
...
Hash func_204(int iParam0, int iParam1) // Position - 0x97E1
{
	int num;
...
Vector3 func_205(int iParam0, int iParam1) // Position - 0x9808
{
	int num;
...
void func_206(var uParam0, BOOL bParam1) // Position - 0x9835
{
	if (bParam1)
...
void func_207(var uParam0, BOOL bParam1) // Position - 0x985B
{
	if (bParam1)
...
void func_208(var uParam0, BOOL bParam1) // Position - 0x9881
{
	if (bParam1)
...
void func_209(var uParam0, BOOL bParam1) // Position - 0x98A7
{
	if (bParam1)
...
void func_210(var uParam0, BOOL bParam1) // Position - 0x98CB
{
	if (bParam1)
...
void func_211(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x98ED
{
	if (!bParam1)
...
void func_212(var uParam0, int iParam1) // Position - 0x9952
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_213(var uParam0, int iParam1) // Position - 0x9963
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_214() // Position - 0x9978
{
	return uLocal_100.f_2;
}

void func_215(int iParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, int iParam6, int iParam7, int iParam8) // Position - 0x9984
{
...
int func_216() // Position - 0x99E0
{
	return uLocal_100.f_3;
}

BOOL func_217(int iParam0, int iParam1) // Position - 0x99EC
{
	return iParam0 && iParam1 != false;
}

BOOL func_218(int iParam0) // Position - 0x99FB
{
	int num;
...
void func_219(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31) // Position - 0x9A26
{
...
int func_220(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x9A51
{
	var args;
...
BOOL func_221(var uParam0) // Position - 0x9A6A
{
...
BOOL func_222(int iParam0, int iParam1) // Position - 0x9A8F
{
	int num;
...
int func_223(int iParam0, var uParam1) // Position - 0x9B13
{
	BOOL flag;
...
BOOL func_224(int iParam0, int iParam1) // Position - 0x9B65
{
	int num;
...
BOOL func_225(int iParam0, var uParam1) // Position - 0x9B95
{
...
void func_226() // Position - 0x9BEC
{
	func_116(2);
	return;
}

BOOL func_227(int iParam0) // Position - 0x9BF9
{
	return func_169(uLocal_100.f_5, iParam0);
}

BOOL func_228(int iParam0) // Position - 0x9C0B
{
	return func_169(uLocal_100.f_6, iParam0);
}

BOOL func_229() // Position - 0x9C1D
{
	Entity EntityIndex;
...
void func_235() // Position - 0x9D72
{
	Entity EntityIndex;
	Entity EntityIndex2;

	EntityIndex = func_238(0);
	EntityIndex2 = func_238(2);
...
Ped func_238(int iParam0) // Position - 0x9E58
{
	return uLocal_100.f_19.f_2[iParam0 /*4*/].f_1;
}

BOOL func_239(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x9E6C
{
...
BOOL func_240(int iParam0, BOOL bParam1) // Position - 0x9E95
{
...
int func_241(int iParam0) // Position - 0x9EC8
{
	if (!func_170(iParam0))
		return 0;
...
void func_242(var uParam0, int iParam1) // Position - 0x9EF8
{
	func_328(uParam0, iParam1);
	return;
}

void func_243(var uParam0, int iParam1) // Position - 0x9F08
{
	func_329(uParam0, iParam1);
	return;
}

void func_244(int iParam0) // Position - 0x9F18
{
	var unk;
	struct<4> data;
...
void func_245(int iParam0) // Position - 0x9F5A
{
	return;
}

void func_246(int iParam0) // Position - 0x9F62
{
	return;
}

ePedType func_247(int iParam0) // Position - 0x9F6A
{
	int randomIntInRange;
...
BOOL func_248(ePedType eptParam0) // Position - 0xA032
{
...
ePedType func_249(int iParam0) // Position - 0xA051
{
	switch (iParam0)
	{
		case 0:
...
char* func_250(int iParam0) // Position - 0xA070
{
	switch (iParam0)
	{
		case 0:
...
void func_251(var uParam0, var uParam1) // Position - 0xA09B
{
...
void func_253(int iParam0) // Position - 0xA1BC
{
	Hash hash;
	Ped ped;
...
void func_254(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA1E7
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
		if (bParam1)
...
Hash func_255(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12, BOOL bParam13) // Position - 0xA223
{
	Hash TypeOfWeapon;
			...
			if (WEAPON::IS_WEAPON_A_GUN(TypeOfWeapon) || WEAPON::IS_WEAPON_MELEE_WEAPON(TypeOfWeapon) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(pedParam0) == joaat("rel_gang_dutchs"))
			{
				...
				if (!flag)
				{
					...
					if (weapontypeGroup != 0 && defaultPedWeaponCollection != 0)
					{
						...
						if (!Global_26688)
							if (func_333(hash) && hash != TypeOfWeapon)
								TypeOfWeapon = hash;
						else
							hash == TypeOfWeapon;
					}
	...
	if (func_28() == -1 && !func_334(TypeOfWeapon))
	{
	...
	if (iParam9 < 0)
	{
		if (pedParam0 != Global_33 && func_333(TypeOfWeapon))
		{
	...
	{
		func_335(TypeOfWeapon, iParam9, bParam2, bParam5, bParam4, bParam11, 752097756, false);
	}
	else if (bParam13)
	{
	}
	else if (!bParam13)
	{
		...
		func_336(pedParam0, &TypeOfWeapon, &permanentDegradation);
...
char* func_256(int iParam0) // Position - 0xA5F3
{
	switch (iParam0)
	{
		case 2:
...
void func_257(var uParam0, Ped pedParam1, char* sParam2, BOOL bParam3) // Position - 0xA649
{
...
void func_258(Any anParam0) // Position - 0xA6A6
{
	func_339(OBJECT::_0x08C5825A2932EA7B(anParam0));
	return;
}

float func_259(int iParam0) // Position - 0xA6B8
{
	int num;
...
void func_260(ePedType eptParam0, var uParam1, var uParam2, var uParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, var uParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, int iParam15, int iParam16) // Position - 0xA9BD
{
...
BOOL func_261(int iParam0, int iParam1) // Position - 0xAA34
{
	var statId;
	int num;
...
void func_262() // Position - 0xAA82
{
	return;
}

void func_263() // Position - 0xAA8A
{
	return;
}

BOOL func_264() // Position - 0xAA92
{
	BOOL flag;
...
void func_266(var uParam0) // Position - 0xAB35
{
...
void func_268() // Position - 0xABB0
{
	...
	if (func_350(EntityIndex, PLAYER::PLAYER_PED_ID()))
	{
...
BOOL func_269(int iParam0, int iParam1) // Position - 0xABFB
{
...
Ped func_270(Ped pedParam0) // Position - 0xAC32
{
	Ped lootTarget;
...
Ped func_271(Ped pedParam0) // Position - 0xAC92
{
	return pedParam0;
}

void func_272(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAC9C
{
	var unk;
	var value;
	int i;
...
void func_273(int iParam0) // Position - 0xADDD
{
	int num;
...
void func_274() // Position - 0xAE00
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex))
	{
		if (BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(playerPed, false, false), ENTITY::GET_ENTITY_COORDS(EntityIndex, false, false)) < 55f && func_354(playerPed, EntityIndex, true, 1114636288, false))
			func_320();
	
		func_355(EntityIndex, playerPed, false);
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_238(1)) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(func_238(1)))
	{
		...
		{
			if (MISC::GET_GROUND_Z_FOR_3D_COORD(entityCoords, &ReturnZ, false) && entityCoords.f_2 != ReturnZ)
			{
	...
	if (ENTITY::DOES_ENTITY_EXIST(func_174(0)) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(func_174(0)))
	{
		...
		if (MISC::GET_GROUND_Z_FOR_3D_COORD(entityCoords2, &ReturnZ2, false) && entityCoords2.f_2 != ReturnZ2)
		{
...
void func_275() // Position - 0xAF8C
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex))
	{
		func_355(EntityIndex, playerPed, true);
	
		if (BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(playerPed, false, false), ENTITY::GET_ENTITY_COORDS(EntityIndex, false, false)) > 6f)
		{
...
void func_276() // Position - 0xB02D
{
	...
	playerPed = PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
	EntityIndex = func_238(0);
	EntityIndex2 = func_238(1);
	num3 = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(playerPed, false, false), ENTITY::GET_ENTITY_COORDS(EntityIndex, false, false));
	vector = { func_359(ENTITY::GET_ENTITY_COORDS(EntityIndex2, false, false), EntityIndex, 1.75f) };
	func_358(0, -89429847, 0);

	if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(EntityIndex))
		PED::SET_PED_MAX_MOVE_BLEND_RATIO(EntityIndex, func_360());

	switch (func_109())
	{
		case 0:
		case 1:
			num = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(EntityIndex, false, false), ENTITY::GET_ENTITY_COORDS(EntityIndex2, false, false));
			num2 = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(playerPed, false, false), ENTITY::GET_ENTITY_COORDS(EntityIndex2, false, false));
		
			if (num3 < 30f)
				if (!ENTITY::IS_ENTITY_AT_COORD(EntityIndex, vector, 0.5f, 0.5f, 2f, false, true, 0))
					if (func_282(EntityIndex, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD, true, false))
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(EntityIndex, vector, 3f, -1, 0.75f, 0, func_361(vector, ENTITY::GET_ENTITY_COORDS(EntityIndex2, true, false), 1));
			else if (num < num2)
				if (!func_269(64, 255))
					func_273(64);
		...
		case 2:
			num = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(EntityIndex, false, false), func_365());
			...
			if (num3 < 30f)
			{
				...
				{
					if (func_282(EntityIndex, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD, true, false))
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(EntityIndex, func_365(), 3f, -1, 1048576000, 0, func_361(vector, func_176(0), 1));
				}
				else if (func_366(EntityIndex, SCRIPT_TASK_PERFORM_SEQUENCE))
				{
				...
				{
					TASK::TASK_PERFORM_SEQUENCE(EntityIndex, uLocal_100.f_19.f_2[1 /*4*/].f_2);
					func_273(2097152);
				}
			}
			else if (num < num2)
			...
			if (BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(playerPed, false, false), func_365()) < 10f && BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(EntityIndex, false, false), func_365()) < 10f)
			{
				func_362(&(iLocal_13.f_7.f_6));
				func_364(func_363(joaat("WINS"), joaat("re_hobo_dog")), 1);
				func_321();
...
void func_277() // Position - 0xB32A
{
	...
	if (func_282(EntityIndex, -1162159953, true, false))
		if (BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(playerPed, false, false), ENTITY::GET_ENTITY_COORDS(EntityIndex, false, false)) < 6f)
			if (func_269(64, 255))
				func_368(64);
		else
			TASK::TASK_PLAY_UPPER_ANIM_FACING_ENTITY(EntityIndex, func_250(0), func_369(0), playerPed, func_370(func_250(0), func_369(0)), 8f, -8f, 0, 0, false, false, 90f, 0, 262144, -1082130432);

	return;
}

void func_278() // Position - 0xB3C7
{
	Ped EntityIndex;
	Ped ped;
	Ped playerPed;
	...
	if (func_356(&(iLocal_13.f_7.f_6)) < 300000 && ENTITY::DOES_ENTITY_EXIST(EntityIndex))
	{
		switch (func_109())
		{
			case 0:
			...
			case 1:
				if (BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(playerPed, false, false), func_365()) < 7.5f || func_374(1))
				{
					...
					{
						if (func_282(EntityIndex, -2117564886, true, false) && func_326(2048))
						{
							func_376(EntityIndex, 2);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(EntityIndex, true);
							PED::SET_PED_CONFIG_FLAG(EntityIndex, 467, true);
							LAW::_0xFFEBE5AA96BC2E4E(EntityIndex, joaat("crime_murder_animal"), true);
				...
				if (!func_240(4, false))
				{
					if (ENTITY::IS_ENTITY_DEAD(EntityIndex) && ENTITY::IS_ENTITY_DEAD(func_238(2)))
					{
			...
			case 2:
				if (!func_269(4, 255))
				{
					...
					else if (!func_269(4194304, 255))
					{
						...
						if (BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(EntityIndex, false, false), func_365()) > 1f)
				...
				if (func_318())
				{
					...
					{
						if (PED::GET_RELATIONSHIP_BETWEEN_GROUPS(PED::GET_PED_RELATIONSHIP_GROUP_HASH(EntityIndex), PED::GET_PED_RELATIONSHIP_GROUP_HASH(playerPed)) != 2)
						{
							PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, PED::GET_PED_RELATIONSHIP_GROUP_HASH(EntityIndex), PED::GET_PED_RELATIONSHIP_GROUP_HASH(playerPed));
							PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, PED::GET_PED_RELATIONSHIP_GROUP_HASH(playerPed), PED::GET_PED_RELATIONSHIP_GROUP_HASH(EntityIndex));
							func_379(EntityIndex, 1);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(EntityIndex, false);
						}
					
						if (func_282(EntityIndex, -391815063, true, false))
							TASK::TASK_WALK_AWAY(EntityIndex, func_174(0));
					}
				}
				break;
		}
...
void func_279() // Position - 0xB830
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex) && !ENTITY::IS_ENTITY_DEAD(EntityIndex))
		if (func_282(EntityIndex, 518218985, true, false))
			TASK::TASK_FLEE_COORD(EntityIndex, ENTITY::GET_ENTITY_COORDS(EntityIndex, false, false), 3, 0, -1082130432, -1, 0);

	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex) && BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(playerPed, false, false), ENTITY::GET_ENTITY_COORDS(EntityIndex, false, false)) > 200f)
		func_273(32);

	return;
}

void func_280() // Position - 0xB8B3
{
	func_60();
...
BOOL func_281(Hash hParam0, int iParam1) // Position - 0xB972
{
	return hParam0->f_2 && iParam1 != false;
}

BOOL func_282(Ped pedParam0, eScriptTaskHash esthParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB983
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
int func_283(Any anParam0, var uParam1) // Position - 0xB9E0
{
	return anParam0;
}

int func_284(int iParam0) // Position - 0xB9EA
{
	switch (iParam0)
	{
		case 2:
...
Hash func_285(var uParam0, var uParam1) // Position - 0xBA5D
{
	return func_381(uParam0);
}

char* func_286(var uParam0, var uParam1, var uParam2) // Position - 0xBA6D
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

void func_287(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0xBA81
{
	int num;
	int i;
	int num2;
...
int func_288(int iParam0, var uParam1) // Position - 0xBB93
{
	int num;
	var unk;
	int num2;
...
void func_289(int iParam0) // Position - 0xBBFD
{
	var unk;
...
int func_290(int iParam0) // Position - 0xBC16
{
	switch (iParam0)
	{
		case 2:
...
int func_291(int iParam0) // Position - 0xBC3F
{
	switch (iParam0)
	{
		case 2:
...
int func_292(int iParam0) // Position - 0xBC68
{
	switch (iParam0)
	{
		case 2:
...
struct<2> func_293(int iParam0) // Position - 0xBC91
{
	var unk;
...
int func_294(int iParam0) // Position - 0xBCF9
{
	switch (iParam0)
	{
		case 0:
...
int func_295(int iParam0) // Position - 0xBD34
{
	switch (iParam0)
	{
		case 0:
...
void func_296(Any* panParam0) // Position - 0xBDD0
{
	func_182(panParam0, 0);
	func_182(panParam0, 1);
	func_182(panParam0, 3);
...
void func_297(Any* panParam0) // Position - 0xBDF3
{
	func_181(panParam0);
...
void func_298(Any* panParam0, int iParam1) // Position - 0xBE09
{
	MISC::SET_BIT(&(panParam0->f_4), iParam1);
	return;
}

void func_299(Any* panParam0) // Position - 0xBE1B
{
	func_182(panParam0, 0);
	func_298(panParam0, 0);
	func_298(panParam0, 1);
...
void func_300(Any* panParam0) // Position - 0xBE46
{
	func_182(panParam0, 1);
	func_298(panParam0, 2);
	func_298(panParam0, 3);
...
void func_301(Any* panParam0) // Position - 0xBE78
{
	func_182(panParam0, 0);
	func_298(panParam0, 0);
	func_298(panParam0, 1);
...
void func_302(Any* panParam0) // Position - 0xBE9C
{
	func_182(panParam0, 1);
	func_180(panParam0);
	return;
...
void func_303(Any* panParam0) // Position - 0xBEB1
{
	func_182(panParam0, 2);
	func_298(panParam0, 3);
	return;
...
void func_304(Any* panParam0) // Position - 0xBEC7
{
	func_182(panParam0, 3);
	func_298(panParam0, 4);
	return;
...
void func_305(Any* panParam0) // Position - 0xBEDD
{
	func_298(panParam0, 0);
	func_298(panParam0, 1);
	return;
...
void func_306(Any* panParam0) // Position - 0xBEF3
{
	func_298(panParam0, 2);
	func_298(panParam0, 3);
	return;
...
void func_307(Any* panParam0) // Position - 0xBF09
{
	func_298(panParam0, 4);
	func_298(panParam0, 5);
	return;
...
BOOL func_308(Any* panParam0, int iParam1) // Position - 0xBF1F
{
...
BOOL func_309(Any* panParam0, int iParam1) // Position - 0xBF56
{
...
int func_310(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, var uParam6, BOOL bParam7) // Position - 0xBF77
{
	var unk;
...
int func_311(int iParam0, int iParam1) // Position - 0xBFA7
{
	if (iParam0 == -1)
		return -1;
...
int func_312(int iParam0) // Position - 0xBFC6
{
	if (!func_170(iParam0))
		return 0;
...
BOOL func_313(int iParam0, BOOL bParam1) // Position - 0xBFE8
{
...
Vector3 func_314(int iParam0) // Position - 0xC01B
{
	int num;
...
float func_315(int iParam0) // Position - 0xCCBE
{
	int num;
...
BOOL func_316(var uParam0, ePedType eptParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0xD5DB
{
	Ped pedID;
	...
	pedID = func_389(eptParam1, uParam2, fParam5, bParam8, true, bParam6, iParam7, bParam9);
...
BOOL func_317(var uParam0, ePedType eptParam1, Vector3 vParam2, var uParam3, var uParam4, BOOL bParam5, int iParam6) // Position - 0xD678
{
	if (NETWORK::NETWORK_AUTO_SESSION_IS_OBJECT_CREATION_PAUSED())
		return false;
...
BOOL func_319(ePedType eptParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, Hash hParam6, BOOL bParam7, Pickup pkParam8) // Position - 0xD6E5
{
	int num;
	int num2;
	...
	if (bParam7)
		if (OBJECT::DOES_PICKUP_OBJECT_EXIST(pkParam8))
			num2 = 0;
...
BOOL func_322(Ped pedParam0, Ped pedParam1) // Position - 0xD7F5
{
...
BOOL func_323() // Position - 0xD837
{
	return func_122(64) || func_121(64, 255);
}

void func_324(int iParam0) // Position - 0xD852
{
...
void func_325(var uParam0, BOOL bParam1) // Position - 0xD869
{
...
BOOL func_326(int iParam0) // Position - 0xD889
{
	return func_169(uLocal_100.f_19.f_53, iParam0);
}

Ped func_327(int iParam0, float fParam1) // Position - 0xD89D
{
	int i;
	float num;
	Player Plr;
...
void func_328(var uParam0, int iParam1) // Position - 0xD90B
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_329(var uParam0, int iParam1) // Position - 0xD91C
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_330(Any* panParam0, int iParam1) // Position - 0xD931
{
...
void func_331(var uParam0) // Position - 0xD98D
{
	int num;
...
Hash func_332(int iParam0) // Position - 0xD9B5
{
	int randomIntInRange;
...
BOOL func_333(Hash hParam0) // Position - 0xDB10
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

BOOL func_334(Hash hParam0) // Position - 0xDB2B
{
	Hash weaponUnlock;
...
int func_335(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, Hash hParam6, BOOL bParam7) // Position - 0xDB53
{
	var unk;
	var unk6;
	var unk28;
...
void func_336(Ped pedParam0, var uParam1, var uParam2) // Position - 0xDC83
{
	BOOL flag;
	Hash entityModel;
...
BOOL func_337(Hash hParam0) // Position - 0xDE1E
{
	return WEAPON::_IS_AMMO_VALID(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0));
}

BOOL func_338(var uParam0, Entity eParam1, char* sParam2) // Position - 0xDE30
{
	BOOL flag;
	int i;
...
void func_339(Entity eParam0) // Position - 0xDEAE
{
	if (ENTITY::DOES_ENTITY_EXIST(eParam0))
...
Object func_340(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, Hash hParam5) // Position - 0xDED5
{
...
void func_341(ScrHandle shParam0, float fParam1, var uParam2, var uParam3, float fParam4, var uParam5, var uParam6) // Position - 0xDF5F
{
	if (!DECORATOR::DECOR_EXIST_ON(shParam0, "loot_item_type1"))
	{
		DECORATOR::DECOR_SET_FLOAT(shParam0, "loot_item_offset1x", fParam1);
		DECORATOR::DECOR_SET_FLOAT(shParam0, "loot_item_offset1y", fParam1.f_1);
		DECORATOR::DECOR_SET_FLOAT(shParam0, "loot_item_offset1z", fParam1.f_2);
		DECORATOR::DECOR_SET_FLOAT(shParam0, "loot_item_orient1x", fParam4);
		DECORATOR::DECOR_SET_FLOAT(shParam0, "loot_item_orient1y", fParam4.f_1);
		DECORATOR::DECOR_SET_FLOAT(shParam0, "loot_item_orient1z", fParam4.f_2);
	}
	else if (!DECORATOR::DECOR_EXIST_ON(shParam0, "loot_item_type2"))
	{
		DECORATOR::DECOR_SET_FLOAT(shParam0, "loot_item_offset2x", fParam1);
		DECORATOR::DECOR_SET_FLOAT(shParam0, "loot_item_offset2y", fParam1.f_1);
		DECORATOR::DECOR_SET_FLOAT(shParam0, "loot_item_offset2z", fParam1.f_2);
		DECORATOR::DECOR_SET_FLOAT(shParam0, "loot_item_orient2x", fParam4);
		DECORATOR::DECOR_SET_FLOAT(shParam0, "loot_item_orient2y", fParam4.f_1);
		DECORATOR::DECOR_SET_FLOAT(shParam0, "loot_item_orient2z", fParam4.f_2);
	}

	return;
}

void func_342(var uParam0) // Position - 0xE032
{
	if (func_411())
...
void func_343(ScrHandle shParam0, int iParam1) // Position - 0xE04E
{
	if (!DECORATOR::DECOR_EXIST_ON(shParam0, "loot_item_type1"))
		if (iParam1 >= 0)
			DECORATOR::DECOR_SET_INT(shParam0, "loot_item_bone1", iParam1);
	else if (!DECORATOR::DECOR_EXIST_ON(shParam0, "loot_item_type2"))
		if (iParam1 >= 0)
			DECORATOR::DECOR_SET_INT(shParam0, "loot_item_bone2", iParam1);

	return;
}

void func_344(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0xE09B
{
	Hash hash;
...
struct<2> func_345(int iParam0, int iParam1) // Position - 0xE142
{
	var statId;
	var unk2;
	int num;
...
BOOL func_348(Ped pedParam0, Entity eParam1, var uParam2, var uParam3, int iParam4, int iParam5) // Position - 0xE1D3
{
	int frameCount;
...
void func_349(BOOL bParam0) // Position - 0xE7BF
{
	int num;
...
BOOL func_350(Ped pedParam0, Ped pedParam1) // Position - 0xE817
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
int func_352(int iParam0, int iParam1) // Position - 0xE8A6
{
	switch (iParam0)
	{
		case -2086327823:
...
void func_353(Any* panParam0, var uParam1) // Position - 0xED4D
{
...
BOOL func_354(Ped pedParam0, Ped pedParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0xED83
{
	if (bParam2)
...
void func_355(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0xEDE7
{
	float num;
...
int func_356(var uParam0) // Position - 0xEF48
{
	if (!func_400(uParam0))
		return 0;
...
void func_357(var uParam0) // Position - 0xEF79
{
	func_452(uParam0, 0f);
	return;
}

void func_358(int iParam0, Hash hParam1, Hash hParam2) // Position - 0xEF88
{
	char* pTextLabel;
	...
	if (!MAP::DOES_BLIP_EXIST(uLocal_100.f_19.f_2[iParam0 /*4*/]))
	{
		...
		{
			case 0:
				pTextLabel = "NB_HDOG_BLIP_NAME";
				break;
		
			case 1:
				pTextLabel = "NB_HDOG_TREASURE_BLIP";
				break;
		
			case 2:
				pTextLabel = "NB_HDOG_AMBUSHER_BLIP";
				break;
		}
	
		MAP::SET_BLIP_NAME_FROM_TEXT_FILE(uLocal_100.f_19.f_2[iParam0 /*4*/], pTextLabel);
	}
...
Vector3 func_359(var uParam0, var uParam1, var uParam2, Ped pedParam3, float fParam4) // Position - 0xF052
{
	var unk;
...
float func_360() // Position - 0xF073
{
	var entityCoords;
	float num;
	float num2;
...
float func_361(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0xF0BA
{
	float num;
	float Y;
	float X;
...
void func_362(var uParam0) // Position - 0xF11F
{
	func_458(uParam0, 0);
	return;
}

struct<2> func_363(int iParam0, int iParam1) // Position - 0xF12E
{
	int num;
...
void func_364(var uParam0, var uParam1, int iParam2) // Position - 0xF144
{
...
Vector3 func_365() // Position - 0xF161
{
	int num;
...
BOOL func_366(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xF2E5
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		if (!PED::IS_PED_INJURED(pedParam0))
...
BOOL func_367(int iParam0, int iParam1) // Position - 0xF33E
{
	if (func_269(iParam0, 255))
		func_368(iParam0);
...
void func_368(int iParam0) // Position - 0xF384
{
	int num;
...
char* func_369(int iParam0) // Position - 0xF3A7
{
	switch (iParam0)
	{
		case 0:
...
int func_370(char* sParam0, char* sParam1) // Position - 0xF3D4
{
...
void func_371(int iParam0) // Position - 0xF3EE
{
	...
	switch (uLocal_100.f_19.f_51)
	{
		case 1:
			...
			{
				func_460(entityIndex, 4);
				TASK::TASK_PERFORM_SEQUENCE(entityIndex, uLocal_100.f_19.f_2[0 /*4*/].f_2);
				func_273(128);
				func_273(-2147483648);
			}
			break;
		...
		case 2:
			...
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(entityIndex, "script_re@savage_aftermath@weeping_dog", "idle_dog", 1))
				{
					func_460(entityIndex, 4);
					TASK::TASK_PERFORM_SEQUENCE(entityIndex, uLocal_100.f_19.f_2[0 /*4*/].f_2);
					func_273(536870912);
...
void func_373(BOOL bParam0) // Position - 0xF95B
{
	if (!func_61(8))
		return;
...
BOOL func_374(int iParam0) // Position - 0xF996
{
	return MISC::IS_BIT_SET(uLocal_100.f_19.f_55, iParam0);
}

void func_375(BOOL bParam0) // Position - 0xF9AA
{
	Ped playerPed;
...
void func_376(Ped pedParam0, int iParam1) // Position - 0xFA9B
{
	int _int;
...
int func_377(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0xFAEF
{
...
void func_379(Ped pedParam0, int iParam1) // Position - 0xFB98
{
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		if (iParam1 == 1)
...
Ped func_380(var uParam0) // Position - 0xFBED
{
	return uParam0->f_11;
}

Hash func_381(var uParam0, var uParam1) // Position - 0xFBF9
{
	int num;
...
int func_382(var uParam0, var uParam1) // Position - 0xFC23
{
	var unk;
...
int func_383(int iParam0) // Position - 0xFC4F
{
	int num;
	int num2;
...
int func_384(int iParam0) // Position - 0xFC7A
{
	if (iParam0 == -1)
		return 0;
...
BOOL func_385(int iParam0, BOOL bParam1) // Position - 0xFC96
{
	switch (iParam0)
	{
...
void func_386(Any* panParam0) // Position - 0xFCFE
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
...
struct<2> func_387(int iParam0) // Position - 0xFD69
{
	var unk;
...
void func_388(Any* panParam0, int iParam1, int iParam2) // Position - 0xFD7B
{
	int i;
...
Ped func_389(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, int iParam8, BOOL bParam9) // Position - 0xFDB7
{
	Ped ped;
...
int func_390(var uParam0, BOOL bParam1) // Position - 0xFDE3
{
	int num;
	int num2;
	int num3;
...
void func_391(int iParam0, int iParam1) // Position - 0xFE39
{
	var unk;
	var statId;
	BOOL Variable;
	...
	if (!func_111(&unk, 4) && func_467(Variable) == unk.f_1)
		Variable = false;
...
void func_392(int iParam0) // Position - 0xFEDF
{
	func_468(iParam0);
	return;
}

void func_393(int iParam0) // Position - 0xFEED
{
	int num;
	int num2;
	var unk;
...
void func_394(int iParam0) // Position - 0xFFCC
{
	var unk;
...
void func_395(var uParam0, var uParam1) // Position - 0xFFE5
{
	Hash hash;
	var unk;
...
void func_396(int iParam0) // Position - 0x10091
{
	var statId;
...
void func_397(int iParam0, int iParam1, int iParam2) // Position - 0x100AF
{
	var unk;
	int num;
...
BOOL func_398(int iParam0) // Position - 0x1012C
{
	switch (iParam0)
	{
		case 9:
...
int func_399(BOOL bParam0, Hash hParam1) // Position - 0x10147
{
	if (!NETWORK::NETWORK_IS_IN_SESSION())
		return 0;
...
BOOL func_400(var uParam0) // Position - 0x1019D
{
	return func_473(*uParam0, 1);
}

void func_401(int iParam0, int iParam1) // Position - 0x101AD
{
...
BOOL func_402() // Position - 0x10246
{
	BOOL unk;
	var unk2;
...
struct<5> func_403(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x10258
{
	var unk;
	int num;
	var unk6;
...
BOOL func_404(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x105CC
{
	return func_487(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_405(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x105E7
{
	var unk;
...
struct<4> func_406(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x10608
{
	var outGuid;
...
BOOL func_407(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x10639
{
	var unk;
	int num;
	var unk15;
...
BOOL func_408(BOOL bParam0) // Position - 0x10757
{
	if (func_28() == -1)
		return true;
...
int func_409(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x10775
{
	if (iParam1 < 1)
		return 1;
...
void func_410(Hash hParam0, int iParam1) // Position - 0x107B0
{
	...
	{
		AmmoInClip = func_495(WEAPON::GET_WEAPON_CLIP_SIZE(hParam0), iParam1);
...
BOOL func_411() // Position - 0x10822
{
	return Global_3145858 != 371211549;
}

Hash func_412(Ped pedParam0) // Position - 0x10834
{
...
BOOL func_413(Ped pedParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x10880
{
	int argStruct;
	int num;
...
int func_414(int iParam0) // Position - 0x108C0
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_415(Player plParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x10AAC
{
	Player player;
...
void func_416(var uParam0, BOOL bParam1, int iParam2) // Position - 0x10AF8
{
	func_496(iParam2);
...
BOOL func_417(Ped pedParam0, var uParam1) // Position - 0x10CC8
{
	Hash recentEvent;
...
void func_418(Ped pedParam0, var uParam1, int iParam2) // Position - 0x10DA0
{
	if (iParam2 != 16384)
...
BOOL func_419(Ped pedParam0, var uParam1) // Position - 0x10DDD
{
	float num;
	float num2;
	int num3;
...
BOOL func_420(Ped pedParam0, Entity eParam1, var uParam2) // Position - 0x10EC7
{
	float num;
	float num2;
...
BOOL func_421(Ped pedParam0, var uParam1) // Position - 0x10F9D
{
	Entity EntityIndex;
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
	...
	if (func_501(pedParam0, uParam1, pedIndexFromEntityIndex))
	{
		...
		{
			fFocusDistance = func_508(uParam1);
...
BOOL func_422(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x110A6
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_423(var uParam0, int iParam1) // Position - 0x111DB
{
	int num;
	int num2;
...
BOOL func_424(Ped pedParam0, Ped pedParam1, var uParam2) // Position - 0x11212
{
	float num;
...
BOOL func_425(Ped pedParam0, Ped pedParam1, var uParam2) // Position - 0x11319
{
...
BOOL func_426(Ped pedParam0, Ped pedParam1, var uParam2, BOOL bParam3) // Position - 0x11384
{
	Vector3 entityCoords;
	int num;
	var positionOut;
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, uParam2->f_24))
				{
					...
					if (func_517(pedParam1, entityCoords, positionOut))
					{
						func_505(uParam2, true);
						return true;
					}
		...
		switch (num)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), entityCoords, uParam2->f_24))
				{
					...
					if (func_517(pedParam1, entityCoords, positionOut2))
					{
						func_505(uParam2, true);
						return true;
					}
...
BOOL func_427(Ped pedParam0, var uParam1) // Position - 0x114FD
{
	int i;
	float num;
	var unk;
...
BOOL func_428(var uParam0, var uParam1) // Position - 0x116DD
{
	Hash recentEvent;
	Entity sourceEntityFromEvent;
	Entity tar;
...
BOOL func_429(var uParam0, int iParam1) // Position - 0x11755
{
	int num;
	int num2;
...
int func_430(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x11784
{
	Ped DamagerIndex;
	...
	{
		if (func_523(DamagerIndex, &FirstEntityIndex))
	...
	if (func_524(DamagerIndex, pedParam0))
		return 1;
...
int func_431(var uParam0, Ped pedParam1) // Position - 0x1191A
{
	int _int;
...
BOOL func_432(var uParam0, Ped pedParam1) // Position - 0x1196A
{
	if (func_525(uParam0))
		return true;
...
BOOL func_433(Ped pedParam0, Ped pedParam1) // Position - 0x11A17
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedParam0, pedParam1, true, true))
...
void func_434() // Position - 0x11A64
{
	return;
}

BOOL func_435(var uParam0, Ped pedParam1) // Position - 0x11A6C
{
...
BOOL func_437() // Position - 0x11B4B
{
	if (Global_1940199.f_36 == 0)
		return false;
...
BOOL func_438(var uParam0, Ped pedParam1) // Position - 0x11B98
{
	float num;
	int num2;
	int num3;
...
BOOL func_439(var uParam0, Ped pedParam1) // Position - 0x11C4C
{
	Ped EntityIndex;
	var entityCoords;
	var entityCoords2;
	...
	if (func_530(EntityIndex, pedParam1, 1060437492) != 0)
		return false;
...
BOOL func_440(Ped pedParam0, Entity eParam1, var uParam2) // Position - 0x11CEA
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_441(Ped pedParam0, var uParam1) // Position - 0x11D32
{
	Ped jackTarget;
	Hash recentEvent;
	Entity sourceEntityFromEvent;
...
BOOL func_442(Ped pedParam0, var uParam1) // Position - 0x1208D
{
	if (!func_537(0))
		return false;
...
BOOL func_443(var uParam0, int iParam1) // Position - 0x120C6
{
	int num;
	int num2;
...
BOOL func_444(var uParam0, var uParam1) // Position - 0x120F5
{
	return PED::_GET_IS_PED_BEING_ROBBED(*uParam0, PLAYER::PLAYER_ID(), false);
}

BOOL func_445(Ped pedParam0, var uParam1) // Position - 0x12109
{
...
BOOL func_446(var uParam0, Ped pedParam1) // Position - 0x12156
{
...
void func_447(int iParam0, int iParam1) // Position - 0x121AA
{
	int num;
...
BOOL func_448(Ped pedParam0, Ped pedParam1, float fParam2) // Position - 0x121D1
{
	return func_543(pedParam0, ENTITY::GET_ENTITY_COORDS(pedParam1, false, false), fParam2);
}

BOOL func_449(Ped pedParam0, Ped pedParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x121E9
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_450(var uParam0) // Position - 0x1225C
{
	return func_473(*uParam0, 2);
}

int func_451(int iParam0) // Position - 0x1226C
{
	return NETWORK::GET_TIME_DIFFERENCE(iParam0, NETWORK::GET_NETWORK_TIME_ACCURATE());
}

void func_452(var uParam0, float fParam1) // Position - 0x1227E
{
...
BOOL func_453(int iParam0) // Position - 0x122A4
{
	return func_121(8, iParam0);
}

float func_454(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x122B4
{
...
Vector3 func_455(var uParam0, var uParam1, var uParam2, Ped pedParam3, float fParam4) // Position - 0x122FC
{
	return func_548(uParam0, ENTITY::GET_ENTITY_COORDS(pedParam3, true, false), fParam4);
}

float func_456(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x12316
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
float func_457(float fParam0, float fParam1, float fParam2) // Position - 0x1233E
{
	return ((1f - fParam2) * fParam0) + (fParam2 * fParam1);
}

void func_458(var uParam0, int iParam1) // Position - 0x12353
{
...
BOOL func_459(int iParam0, int iParam1) // Position - 0x1238F
{
	switch (iParam0)
	{
		case 0:
...
void func_460(Ped pedParam0, int iParam1) // Position - 0x12425
{
...
int func_461(var uParam0) // Position - 0x1254C
{
	if (!func_549(uParam0))
...
void func_462(Any anParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, var uParam9, var uParam10) // Position - 0x1259F
{
	float num;
	var unk;
	var unk2;
...
void func_463(int iParam0) // Position - 0x1262E
{
	var unk;
...
BOOL func_464(int iParam0, var uParam1, Any* panParam2) // Position - 0x12650
{
	if (!func_36(iParam0))
		return false;
...
void func_466(Any* panParam0, var uParam1) // Position - 0x12793
{
	return;
}

int func_467(BOOL bParam0) // Position - 0x1279B
{
	int i;
...
void func_468(int iParam0) // Position - 0x127C0
{
	int value;
	var statId;
...
int func_469(int iParam0, var uParam1, var uParam2) // Position - 0x127EC
{
	int num;
	int i;
	int num2;
...
BOOL func_470(int iParam0, var uParam1, var uParam2) // Position - 0x1287E
{
	var unk;
...
BOOL func_471() // Position - 0x128B2
{
	return !Global_1572887.f_10;
}

void func_472(Hash hParam0, int iParam1) // Position - 0x128C1
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_473(int iParam0, int iParam1) // Position - 0x128D4
{
	return iParam0 && iParam1 != false;
}

char* func_474(int iParam0) // Position - 0x128E3
{
	switch (iLocal_13.f_7.f_12)
	{
		case 0:
...
BOOL func_475(char* sParam0) // Position - 0x129D4
{
...
Vector3 func_476(char* sParam0) // Position - 0x129F5
{
	var unk;
...
BOOL func_477(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x12A07
{
	return func_562(uParam0, &Global_1051270, uParam1, bParam4, iParam5, bParam6, bParam7);
}

void func_478(var uParam0, var uParam1) // Position - 0x12A25
{
...
struct<4> func_479(BOOL bParam0) // Position - 0x12A68
{
	int num;
...
int func_480(Hash hParam0) // Position - 0x12B08
{
	var unk;
...
struct<4> func_481(BOOL bParam0) // Position - 0x12B33
{
	int num;
...
int func_482(Hash hParam0, BOOL bParam1) // Position - 0x12BD4
{
...
struct<4> func_483(BOOL bParam0) // Position - 0x12C0B
{
	int num;
...
int func_484(Hash hParam0) // Position - 0x12C75
{
	var unk;
...
BOOL func_485(Hash hParam0, int iParam1) // Position - 0x12CA0
{
	Hash hash;
	int num;
	int i;
...
BOOL func_486(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x12D0D
{
	return func_567(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_487(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x12D23
{
...
BOOL func_488(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x12DA2
{
	int inventoryId;
...
BOOL func_489(Hash hParam0, int iParam1) // Position - 0x12DE7
{
	if (hParam0 == 0)
		return false;
...
int func_490(BOOL bParam0) // Position - 0x12E01
{
	if (func_28() == -1)
	{
...
BOOL func_491(Hash hParam0) // Position - 0x12E42
{
...
int func_492(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x12E58
{
	int num;
...
void func_493(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x12EC2
{
	int i;
...
BOOL func_494(Hash hParam0) // Position - 0x12F40
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_495(int iParam0, int iParam1) // Position - 0x12F4E
{
	if (iParam0 > iParam1)
		return iParam1;
...
void func_496(int iParam0) // Position - 0x12F64
{
	int num;
	BOOL flag;
...
Hash func_497(int iParam0) // Position - 0x130FC
{
	return Global_1102813.f_3695[iParam0 /*3*/];
}

BOOL func_498(BOOL bParam0, BOOL bParam1) // Position - 0x1310F
{
	Ped EntityIndex;
	Ped EntityIndex2;

	if (func_575(bParam0, &EntityIndex, &EntityIndex2))
	{
		if (bParam1)
		{
...
BOOL func_499(var uParam0) // Position - 0x13162
{
	Ped EntityIndex;
...
void func_500(var uParam0) // Position - 0x131E4
{
...
BOOL func_501(Ped pedParam0, var uParam1, Ped pedParam2) // Position - 0x1320B
{
	int num;
	int num2;
...
float func_502(Ped pedParam0, Ped pedParam1) // Position - 0x13304
{
	return func_454(pedParam0, pedParam1, true, true);
}

float func_503(var uParam0) // Position - 0x13316
{
	return uParam0->f_29;
}

BOOL func_504(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x13322
{
	switch (iParam0)
	{
		case 1:
...
void func_505(var uParam0, BOOL bParam1) // Position - 0x13387
{
	if (bParam1)
...
void func_506() // Position - 0x133AD
{
...
BOOL func_507(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x133C1
{
	Ped EntityIndex;
	Player playerIndex;
	Entity outEntity;
	...
	if (bParam3)
		if (WEAPON::IS_PED_ARMED(EntityIndex, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(playerIndex, pedParam0, bParam5) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(playerIndex, pedParam0) && func_454(EntityIndex, pedParam0, true, true) <= 4f)
			return true;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(playerIndex))
		if (WEAPON::_IS_WEAPON_SNIPER(func_578(EntityIndex, 0)))
...
float func_508(var uParam0) // Position - 0x13531
{
	return uParam0->f_18;
}

BOOL func_509(var uParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x1353D
{
...
int func_510(var uParam0) // Position - 0x1359E
{
	return uParam0->f_19;
}

int func_511(var uParam0) // Position - 0x135AA
{
	return uParam0->f_20;
}

BOOL func_512(Entity eParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x135B6
{
	Ped EntityIndex;
	Player playerIndex;
...
int func_513(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x13678
{
...
float func_514(var uParam0) // Position - 0x13716
{
	return uParam0->f_25;
}

int func_515(var uParam0) // Position - 0x13722
{
	return uParam0->f_23;
}

int func_516(var uParam0) // Position - 0x1372E
{
	int num;
...
BOOL func_517(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6) // Position - 0x1386B
{
...
BOOL func_518(Ped pedParam0) // Position - 0x138AE
{
...
BOOL func_519(Ped pedParam0) // Position - 0x13914
{
	Hash entityModel;
...
BOOL func_520(var uParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x13940
{
	float num;
...
BOOL func_521(var uParam0, Ped pedParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0x13987
{
	float num;
...
BOOL func_522(var uParam0, Ped pedParam1, float fParam2, int iParam3) // Position - 0x139D2
{
	float num;
...
BOOL func_523(Ped pedParam0, var uParam1) // Position - 0x13A4C
{
...
BOOL func_524(Ped pedParam0, Ped pedParam1) // Position - 0x13A99
{
...
BOOL func_525(var uParam0) // Position - 0x13B05
{
	return !(*uParam0 & 2 != 0);
}

BOOL func_526(Vehicle veParam0, Ped pedParam1, var uParam2, var uParam3, var uParam4) // Position - 0x13B15
{
	float num;
...
float func_527(var uParam0) // Position - 0x13B41
{
	return uParam0->f_26;
}

int func_528(Ped pedParam0) // Position - 0x13B4D
{
...
int func_529(Ped pedParam0) // Position - 0x13BA5
{
	if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(pedParam0, true))
		return -1;
...
int func_530(Ped pedParam0, Ped pedParam1, int iParam2) // Position - 0x13BFD
{
	var entityCoords;
...
float func_531(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x13C1D
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_532(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3, float fParam4, BOOL bParam5) // Position - 0x13C3B
{
	BOOL flag;
	Entity FirstEntityIndex;
	float num;
	...
	if (!bParam5)
	{
		...
		if (bParam3)
			if (func_523(Global_33, &FirstEntityIndex))
				if (fParam4 < 4f)
...
BOOL func_533(Ped pedParam0, var uParam1, BOOL bParam2) // Position - 0x13DAB
{
	Ped EntityIndex;
	Ped EntityIndex2;

	func_575(true, &EntityIndex, &EntityIndex2);
	...
	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex))
		if (EntityIndex != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_33, -1082130432, -1082130432, -1082130432, -1082130432))
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_33, 17))
					if (!bParam2 || !func_536(uParam1, EntityIndex))
						return true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex2))
		if (EntityIndex2 != pedParam0)
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(pedParam0, Global_33, -1082130432, -1082130432, -1082130432, -1082130432) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(pedParam0, Global_33, 17))
				if (!bParam2 || !func_536(uParam1, EntityIndex2))
					if (func_456(EntityIndex2, Global_34, true) < 5f)
						return true;

	return false;
}

BOOL func_534(Ped pedParam0) // Position - 0x13E99
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_535(var uParam0) // Position - 0x13EBF
{
	return func_169(*uParam0, 131072);
}

BOOL func_536(var uParam0, Ped pedParam1) // Position - 0x13ED2
{
...
BOOL func_537(int iParam0) // Position - 0x13F48
{
	return false;
}

int func_538(var uParam0) // Position - 0x13F51
{
	return uParam0->f_22;
}

BOOL func_539(Ped pedParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0x13F5D
{
	if (!bParam2)
		if (uParam1->f_5 == 0)
			return 0;
...
BOOL func_540(int iParam0, int iParam1) // Position - 0x13FD8
{
...
int func_541(int iParam0) // Position - 0x13FFD
{
	return iParam0 + 8;
}

void func_542(int iParam0, int iParam1) // Position - 0x1400C
{
	var statId;
	int address;
...
BOOL func_543(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x14055
{
...
float func_544(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x14096
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_545() // Position - 0x140B4
{
	int networkTimeAccurate;
...
void func_546(var uParam0, int iParam1) // Position - 0x140E6
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_547(var uParam0, int iParam1) // Position - 0x140F7
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

Vector3 func_548(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0x1410C
{
	return func_587(uParam3 - uParam0) * { fParam6, fParam6, fParam6 };
}

BOOL func_549(var uParam0) // Position - 0x14125
{
	return func_473(*uParam0, 1);
}

BOOL func_550(var uParam0) // Position - 0x14135
{
	return func_473(*uParam0, 2);
}

float func_551(float fParam0, float fParam1, float fParam2) // Position - 0x14145
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_552(int iParam0, var uParam1, var uParam2, int iParam3, float fParam4) // Position - 0x1416C
{
	int num;
...
void func_553(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6) // Position - 0x14806
{
	float num;
	int num2;
...
void func_554(int iParam0, int iParam1, int iParam2) // Position - 0x14A5D
{
	switch (iParam2)
	{
		case joaat("pvp"):
...
void func_555(int iParam0, var uParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x14AB7
{
	BOOL flag;
...
void func_556(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x14B51
{
	int num;
	int num2;
	int num3;
...
int func_557(int iParam0, Any anParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6) // Position - 0x14DE8
{
	var unk;
...
struct<15> func_558(int iParam0) // Position - 0x14E0E
{
	int num;
...
void func_559(Any* panParam0) // Position - 0x14E4A
{
	func_598(panParam0, func_597(4, 117));
	return;
}

void func_560(Any* panParam0) // Position - 0x14E5F
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
BOOL func_561(int iParam0, var uParam1, var uParam2) // Position - 0x14E75
{
	var unk;
...
BOOL func_562(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, int iParam6, BOOL bParam7, BOOL bParam8) // Position - 0x14EAA
{
	BOOL flag;
...
BOOL func_563() // Position - 0x14F06
{
	Vector3 VecClosestFirePos;

	if (FIRE::GET_CLOSEST_FIRE_POS(&VecClosestFirePos, Global_34))
		if (BUILTIN::VDIST(VecClosestFirePos, Global_34) < 5f)
			return true;

	return false;
}

struct<4> func_564() // Position - 0x14F33
{
	var unk;
...
BOOL func_566(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x14F5C
{
...
BOOL func_567(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x14F8F
{
...
int func_568(Hash hParam0, int iParam1) // Position - 0x14FC9
{
	if (iParam1 == 0)
		return 0;
...
BOOL func_569(Hash hParam0, Any* panParam1) // Position - 0x14FF5
{
	int num;
...
BOOL func_570(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x151CB
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_571(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x151E2
{
	if (bParam0)
	{
...
int func_572(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x1522B
{
	if (bParam0)
	{
		func_607(iParam1, 1, 0, 0);
...
BOOL func_573() // Position - 0x15247
{
	if (func_608())
		return false;
...
void func_574(Any* panParam0, int iParam1) // Position - 0x1529D
{
	int num;
	int i;
	Player player;
...
BOOL func_575(BOOL bParam0, var uParam1, var uParam2) // Position - 0x15348
{
	BOOL num;
	Ped lassoTarget;
...
Ped func_576(var uParam0) // Position - 0x1540F
{
	Ped pedIndexFromEntityIndex;
	Entity outEntity;
...
void func_577(var uParam0) // Position - 0x154C5
{
	int i;
...
Hash func_578(Ped pedParam0, int iParam1) // Position - 0x1552A
{
	Hash ReturnWeaponType;
...
BOOL func_579(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x15541
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_580(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x1556F
{
	float fScreenPosX;
	float fScreenPosY;
...
BOOL func_581(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x155B9
{
...
BOOL func_582(Ped pedParam0) // Position - 0x15632
{
...
float func_583(var uParam0) // Position - 0x15728
{
	return uParam0->f_28;
}

Hash func_584(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x15734
{
	Hash ReturnWeaponType;
...
int func_585(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x15776
{
	var entityCoords;
	...
	n = func_609(entityForwardVector, unk5);
...
int func_586(int iParam0) // Position - 0x15805
{
	switch (iParam0)
	{
		case 4:
...
Vector3 func_587(float fParam0, var uParam1, var uParam2) // Position - 0x1582B
{
	float num;
	float num2;
...
int func_588(int iParam0, int iParam1, int iParam2) // Position - 0x1586A
{
	if (iParam0 > iParam2)
		return iParam2;
...
void func_589(int iParam0, int iParam1) // Position - 0x1588F
{
	if (iParam1 == 0)
		return;
...
int func_590(var uParam0, var uParam1) // Position - 0x158BF
{
	int i;
...
BOOL func_591(int iParam0) // Position - 0x15901
{
	if (iParam0 < 0)
		return false;
...
int func_592(int iParam0) // Position - 0x1591F
{
	return Global_1107816.f_33[iParam0 /*16*/].f_3;
}

BOOL func_593(int iParam0) // Position - 0x15933
{
	return iParam0 >= 0 && iParam0 < 36;
}

Hash func_594(int iParam0) // Position - 0x15949
{
	return Global_1119235[iParam0 /*35*/];
}

int func_595(Hash hParam0) // Position - 0x15959
{
	var unk;

	unk = { func_363(joaat("reward_streak"), func_612(hParam0)) };
	return func_613(unk, -1);
}

int func_596(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x1597D
{
	BOOL flag;
	int num;
	var unk;
...
var func_597(int iParam0, int iParam1) // Position - 0x15A5E
{
	return func_615(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

void func_598(Any* panParam0, var uParam1) // Position - 0x15A7C
{
	if (!SCRIPTS::_IS_ANY_PLAYER_BIT_SET(&uParam1))
		return;
...
BOOL func_599(int iParam0) // Position - 0x15A9E
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_600(int iParam0, var uParam1, Any* panParam2) // Position - 0x15ADD
{
...
void func_601(int iParam0, Any* panParam1, var uParam2) // Position - 0x15B11
{
	int num;
...
void func_602(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x15D6C
{
	int i;
	int j;
	Ped listeningToPed;
...
int func_603(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x15E47
{
...
Hash func_604(Hash hParam0) // Position - 0x15E7A
{
	return hParam0;
}

BOOL func_605(Hash hParam0, int iParam1) // Position - 0x15E84
{
	if (hParam0 == 0)
		return false;
...
BOOL func_606(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x15E9E
{
...
void func_607(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x15EB6
{
	int i;
...
BOOL func_608() // Position - 0x15F54
{
...
float func_609(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x15F8B
{
	float num;
...
BOOL func_610(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x15FF2
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

struct<2> func_611(int iParam0) // Position - 0x1601B
{
	if (!func_591(iParam0))
		return func_104();
...
int func_612(Hash hParam0) // Position - 0x16044
{
	switch (hParam0)
	{
...
int func_613(var uParam0, var uParam1, int iParam2) // Position - 0x1625E
{
	int num;
...
void func_614(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x16288
{
	int i;
	var unk;
...
var func_615(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x16343
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_627(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
int func_616(int iParam0) // Position - 0x166D6
{
	int num;
...
int func_617(int iParam0, var uParam1) // Position - 0x1684B
{
	var unk;
...
int func_618(int iParam0) // Position - 0x16868
{
	switch (iParam0)
	{
		case joaat("IWD_INF"):
...
int func_619(int iParam0) // Position - 0x169BE
{
	switch (iParam0)
	{
...
int func_620(int iParam0) // Position - 0x16A15
{
	switch (iParam0)
	{
...
int func_621(int iParam0) // Position - 0x16AEF
{
	switch (iParam0)
	{
		case -1641798436:
...
int func_622(int iParam0) // Position - 0x16B87
{
	switch (iParam0)
	{
		case -1968391995:
...
void func_623(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x16D31
{
	int i;
...
BOOL func_624(Any anParam0) // Position - 0x16E0D
{
...
int func_625() // Position - 0x16E53
{
	return Global_1051645.f_12;
}

char* func_626() // Position - 0x16E61
{
	return "unnamed";
}

BOOL func_627(int iParam0) // Position - 0x16E6D
{
	int num;
...
BOOL func_628(int iParam0) // Position - 0x16EFC
{
	if (Global_1572887.f_14 == -1)
		return false;
...
int func_629(int iParam0) // Position - 0x16F1A
{
	if (iParam0 == 255)
...
BOOL func_630(Player plParam0) // Position - 0x16F65
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_631(int iParam0, var uParam1, var uParam2) // Position - 0x16FAA
{
	var unk;
...
void func_632(int iParam0) // Position - 0x16FD1
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
BOOL func_633(int iParam0, int iParam1) // Position - 0x16FF4
{
	int num;
...
BOOL func_634(Player plParam0) // Position - 0x17068
{
...
void func_635(Player plParam0) // Position - 0x17085
{
	Player player;
...
BOOL func_636(int iParam0, var uParam1, Any* panParam2) // Position - 0x17108
{
	*panParam2 = Global_1149432.f_7;
...
void func_637(Any* panParam0, int iParam1, var uParam2) // Position - 0x1713C
{
	var unk;
...
void func_638(var uParam0) // Position - 0x171B6
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_639(Any* panParam0, int iParam1, int iParam2) // Position - 0x17211
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_640() // Position - 0x17248
{
	return Global_1102813.f_3672;
}

void func_641(Player plParam0) // Position - 0x17257
{
	Player player;
...
void func_642(Player plParam0) // Position - 0x172C3
{
