...
void _DEBUG_PRINT(int iParam0) // Position - 0x801
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x80D
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x81A
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x826
{
	iParam0 = iParam0;
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x83F
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x84B
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x860
{
	return func_56(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x871
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x8B0
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x8BC
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x8C4
{
	if (func_57(iParam0))
		return true;
...
void func_25() // Position - 0x974
{
	return;
}

void func_26() // Position - 0x97C
{
	return;
}

void func_27() // Position - 0x984
{
	return;
}

void func_28() // Position - 0x98C
{
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x994
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x9A0
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x9AC
{
	return;
}

void func_32() // Position - 0x9B4
{
	return;
}

void func_33(int iParam0) // Position - 0x9BC
{
	iParam0 = iParam0;
...
void func_35(var uParam0) // Position - 0xA09
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA4F
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xA7C
{
	if (!func_62(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xA95
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xAA6
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xABE
{
	return true;
}

void func_41(var uParam0, int iParam1) // Position - 0xAC7
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xC06
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xC13
{
...
BOOL func_44(int iParam0) // Position - 0xC49
{
	if (iParam0 == 0)
	{
		func_76();
...
int func_45() // Position - 0xD5D
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xD6B
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xD77
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xDE4
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xEC4
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xEE2
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xEF5
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

void func_53() // Position - 0xF13
{
	return;
}

BOOL func_54(int iParam0) // Position - 0xF1E
{
	int num;
	int num2;
	int offset;
...
BOOL func_56(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1004
{
	int num;
	int num2;
	int num3;
...
BOOL func_57(int iParam0) // Position - 0x10FC
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_58(int iParam0) // Position - 0x110D
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_59(int iParam0) // Position - 0x1121
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_60(var uParam0, var uParam1) // Position - 0x1135
{
	return uParam0;
}

void func_61(var uParam0, Volume volParam1, int iParam2) // Position - 0x113F
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_62(int iParam0) // Position - 0x1198
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_63() // Position - 0x11AE
{
	int i;
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x11DB
{
	return iParam0 && iParam1 != false;
}

BOOL func_65(var uParam0, int iParam1) // Position - 0x11EA
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_66() // Position - 0x11FB
{
	return func_64(Global_1940199, 8192);
}

BOOL func_67(var uParam0, int iParam1) // Position - 0x120E
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_68(int iParam0) // Position - 0x121F
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_69(int iParam0, int iParam1) // Position - 0x125F
{
...
int func_70() // Position - 0x128C
{
	return Global_1896646.f_41;
}

void func_71(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x129A
{
	BOOL flag;
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_113(&unk, joaat("COLOR_PURE_WHITE")), str3, func_113(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_113(&unk, joaat("COLOR_PURE_WHITE")), func_113(&unk2, joaat("COLOR_PURE_WHITE")));
		}
...
void func_72(var uParam0, int iParam1) // Position - 0x14FE
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_73(int iParam0, BOOL bParam1) // Position - 0x1511
{
...
void func_74(BOOL bParam0) // Position - 0x1B7A
{
	if (bParam0)
...
BOOL func_75(int iParam0) // Position - 0x1BA3
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_76() // Position - 0x1BE8
{
	return;
}

Hash func_77(int iParam0, BOOL bParam1) // Position - 0x1BF0
{
	switch (iParam0)
	{
		case 0:
...
void func_78(int iParam0, BOOL bParam1) // Position - 0x23B5
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_79(BOOL bParam0) // Position - 0x2408
{
	if (bParam0)
...
void func_80(int iParam0) // Position - 0x2431
{
	iParam0 = iParam0;
...
void func_82(int iParam0) // Position - 0x248A
{
	int i;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x24BD
{
	int num;
	int num2;
	int num3;
...
BOOL func_84(int iParam0) // Position - 0x2573
{
	int i;
...
BOOL func_85(int iParam0, BOOL bParam1) // Position - 0x25ED
{
	if (Global_1572887.f_14 == -1)
...
int func_86(int iParam0, int iParam1) // Position - 0x261E
{
	switch (iParam0)
	{
...
BOOL func_87(int iParam0) // Position - 0x3EC3
{
	int num;
...
BOOL func_88(int iParam0) // Position - 0x3EE0
{
...
char* func_89() // Position - 0x3EF7
{
	return "shb_int_MP";
}

Vector3 func_90() // Position - 0x3F02
{
	return -2370.0269f, 472.46246f, 131.24455f;
}

BOOL func_91(int iParam0) // Position - 0x3F19
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_92(int iParam0) // Position - 0x3F3A
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_93(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3F8D
{
	BOOL flag;
...
BOOL func_94(int iParam0) // Position - 0x46B1
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_95(int iParam0) // Position - 0x46C8
{
	switch (iParam0)
	{
		case 64:
...
int func_96(int iParam0, BOOL bParam1) // Position - 0x470B
{
	if (!func_94(iParam0))
		return 0;
...
BOOL func_97(int iParam0) // Position - 0x47F6
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_98(int iParam0) // Position - 0x480C
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_99(int iParam0) // Position - 0x4822
{
...
const char* func_101(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x489A
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_138(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_140(func_139(Global_34));
...
BOOL func_102(int iParam0) // Position - 0x52FA
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_103(int iParam0) // Position - 0x530F
{
	switch (iParam0)
	{
		case 0:
...
int func_104(int iParam0) // Position - 0x53CA
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_105(int iParam0) // Position - 0x5438
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_106(int iParam0) // Position - 0x5593
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_107(int iParam0, BOOL bParam1) // Position - 0x55CE
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_108(int iParam0, int iParam1) // Position - 0x5610
{
	if (!func_102(iParam0))
		return false;
...
int func_109() // Position - 0x5655
{
	return Global_1902569;
}

int func_110(int iParam0) // Position - 0x5661
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_111(int iParam0) // Position - 0x5674
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_112(float fParam0) // Position - 0x5686
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_113(var uParam0, int iParam1) // Position - 0x569C
{
...
int func_114(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x56D2
{
	int duration;
	var data;
	int num;
...
BOOL func_115(int iParam0) // Position - 0x5715
{
	if (func_141(iParam0))
		if (!func_142(44))
			return false;
...
void func_116(int iParam0, int iParam1) // Position - 0x5735
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_117(int iParam0, int iParam1) // Position - 0x5746
{
	int num;
...
void func_118(var uParam0, var uParam1, int iParam2) // Position - 0x575C
{
...
void func_120(int iParam0) // Position - 0x57CF
{
...
void func_121(int iParam0) // Position - 0x58AF
{
	int i;
	int num;
...
BOOL func_122(int iParam0, BOOL bParam1) // Position - 0x5A87
{
	if (func_45() != -1)
		return false;
...
int func_123(int iParam0, BOOL bParam1) // Position - 0x5AB5
{
	if (!func_94(iParam0))
		return 0;
...
int func_124(int iParam0) // Position - 0x5B38
{
	switch (iParam0)
	{
		case 27:
...
int func_125(int iParam0) // Position - 0x5B5F
{
	switch (iParam0)
	{
		case 33:
...
void func_128(int iParam0, BOOL bParam1) // Position - 0x5DC2
{
	BOOL flag;
...
int func_129(int iParam0) // Position - 0x6171
{
	return func_168(iParam0) + 30;
}

Hash func_130(int iParam0) // Position - 0x6181
{
	if (!func_94(iParam0))
		return 0;
...
void func_131(int iParam0, PersChar pchParam1) // Position - 0x619F
{
	if (!func_94(iParam0))
		return;
...
PersChar func_132(int iParam0) // Position - 0x61C0
{
	if (!func_94(iParam0))
		return 0;
...
void func_133(int iParam0, BOOL bParam1) // Position - 0x61E0
{
	if (func_45() != -1)
		return;
...
BOOL func_134(int iParam0) // Position - 0x6219
{
	if (!func_94(iParam0))
		return false;
...
BOOL func_135() // Position - 0x623F
{
	return false;
}

BOOL func_136() // Position - 0x6248
{
	var unk;
	var unk3;
...
BOOL func_137(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x62B0
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_138(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6426
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_139(var uParam0, var uParam1, var uParam2) // Position - 0x643A
{
	int i;
...
const char* func_140(int iParam0) // Position - 0x6468
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_141(int iParam0) // Position - 0x674C
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_142(int iParam0) // Position - 0x6776
{
	if (!func_174(iParam0))
		return false;
...
struct<2> func_143(Player plParam0) // Position - 0x6792
{
	var gamerHandle;
...
const char* func_144(const char* sParam0, int iParam1) // Position - 0x67A6
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_145(int iParam0, BOOL bParam1) // Position - 0x67C0
{
	char* StringToTest;
...
void func_146(int iParam0, BOOL bParam1) // Position - 0x67F4
{
	switch (iParam0)
	{
		case 5:
...
void func_147(int iParam0, int iParam1) // Position - 0x6829
{
	func_176(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_148(int iParam0) // Position - 0x6843
{
	if (!func_94(iParam0))
		return false;
...
void func_149(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6868
{
	PersChar persChar;
...
void func_150(int iParam0, BOOL bParam1) // Position - 0x6954
{
	if (!func_179(iParam0))
		return;
...
void func_151(int iParam0, int iParam1) // Position - 0x69AA
{
	if (!func_184(iParam0))
		return;
...
int func_152(int iParam0) // Position - 0x6A1D
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_153(Hash hParam0) // Position - 0x6A33
{
...
void func_154(int iParam0) // Position - 0x6A53
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_155(int iParam0, BOOL bParam1) // Position - 0x6A69
{
	if (func_45() != -1)
		return;
...
void func_156(int iParam0) // Position - 0x6A9A
{
	Ped EntityIndex;
...
void func_157(int iParam0) // Position - 0x6ADE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_158(int iParam0) // Position - 0x6AF3
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_159(int iParam0) // Position - 0x6B08
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_160(int iParam0) // Position - 0x6B1D
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_161(int iParam0) // Position - 0x6B9C
{
...
BOOL func_162(int iParam0, int iParam1) // Position - 0x6BF9
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_163(int iParam0, int iParam1) // Position - 0x6C12
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_164(int iParam0, int iParam1) // Position - 0x6C2B
{
...
int func_165(int iParam0) // Position - 0x6C66
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_166(int iParam0) // Position - 0x6C7A
{
	return;
}

BOOL func_167(int iParam0, int iParam1) // Position - 0x6C82
{
	if (iParam0 == -1)
		return false;
...
struct<2> func_170() // Position - 0x6D0D
{
	return Global_1051268;
}

BOOL func_171(var uParam0, var uParam1) // Position - 0x6D1B
{
	if (!func_189(uParam0))
		return false;
...
struct<2> func_172() // Position - 0x6D4F
{
...
BOOL func_173(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x6D9A
{
	var unk;
	float num;
	float num2;
...
BOOL func_174(int iParam0) // Position - 0x6DCA
{
	if (iParam0 == 0)
		return false;
...
BOOL func_175(int iParam0) // Position - 0x6DDD
{
	int num;
	int num2;
	int offset;
...
void func_176(BOOL bParam0, int iParam1) // Position - 0x6E07
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_177(int iParam0) // Position - 0x6E1C
{
	if (!func_94(iParam0))
		return false;
...
BOOL func_178(Hash hParam0) // Position - 0x6E40
{
	return hParam0 != 0;
}

BOOL func_179(int iParam0) // Position - 0x6E4C
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_180(int iParam0, BOOL bParam1) // Position - 0x6E62
{
	if (!func_179(iParam0))
		return false;
...
void func_181(int iParam0, BOOL bParam1) // Position - 0x6E88
{
	if (!func_179(iParam0))
		return;
...
void func_182(int iParam0, BOOL bParam1) // Position - 0x6EB6
{
	if (!func_179(iParam0))
		return;
...
void func_183(int iParam0) // Position - 0x6EF0
{
	func_194(func_193(iParam0));
	return;
}

BOOL func_184(int iParam0) // Position - 0x6F02
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_185(Hash hParam0) // Position - 0x6F18
{
	if (func_195(hParam0))
...
BOOL func_186() // Position - 0x6F33
{
	return 1;
}

Ped func_187(int iParam0) // Position - 0x6F3C
{
	PersChar persChar;
...
BOOL func_188(BOOL bParam0, BOOL bParam1) // Position - 0x6F6A
{
	return bParam0 && bParam1 != false;
}

BOOL func_189(int iParam0) // Position - 0x6F79
{
	switch (iParam0)
	{
		case 2:
...
int func_190(int iParam0) // Position - 0x6FB8
{
	switch (iParam0)
	{
		case 2:
...
void func_191(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x704E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_192(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x7AEB
{
	float num;
	float num2;
	float num3;
...
int func_193(int iParam0) // Position - 0x7B51
{
...
void func_194(int iParam0) // Position - 0x806E
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_195(Hash hParam0) // Position - 0x807F
{
	return hParam0 != 0;
}
