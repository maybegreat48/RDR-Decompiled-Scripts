...
void func_10(int iParam0) // Position - 0x523
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x54B
{
	struct<2> data;
...
BOOL func_12(Ped pedParam0, int iParam1) // Position - 0x573
{
	int num;
...
BOOL func_13(int iParam0) // Position - 0x672
{
	return func_34(iParam0, 1);
}

float func_14(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x681
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_17(BOOL bParam0) // Position - 0x745
{
	...
	if (bLocal_37 && PED::_IS_PED_DOING_SCENARIO_TRANSITION(pedLocal_30))
	{
		...
		PED::SET_PED_CAN_PLAY_GESTURE_ANIMS(pedLocal_30, false, 1);
	}
...
int func_19() // Position - 0xA00
{
	return Global_1893611.f_2;
}

int func_20(int iParam0, int iParam1) // Position - 0xA0E
{
	switch (iParam0)
	{
		case 5:
...
Vector3 func_21() // Position - 0xAF1
{
	return -0.235327f, 1.850775f, 0f;
}

int func_22(int iParam0) // Position - 0xB04
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_23(int iParam0) // Position - 0xB7A
{
	return iParam0 > -1 && iParam0 < 948;
}

Ped func_24(int iParam0) // Position - 0xB91
{
	if (!func_23(iParam0))
		return 0;
...
void func_25(var uParam0, BOOL bParam1) // Position - 0xBD7
{
...
void func_27(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC2F
{
...
void func_28() // Position - 0xF52
{
	return;
}

void func_29(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF5A
{
	BOOL isPedUsingThisScenario;
...
void func_30(var uParam0) // Position - 0x1130
{
	return;
}

void func_31(var uParam0) // Position - 0x1138
{
	return;
}

void func_32(var uParam0) // Position - 0x1140
{
	return;
}

BOOL func_33(int iParam0, int iParam1) // Position - 0x1148
{
	return iParam0 && iParam1 != false;
}

BOOL func_34(int iParam0, int iParam1) // Position - 0x1157
{
	if (func_51() != -1)
		return false;
...
PersChar func_35(int iParam0) // Position - 0x1185
{
	if (!func_23(iParam0))
		return 0;
...
Volume func_36(int iParam0) // Position - 0x11A5
{
	Volume aggregate;
...
BOOL func_37(Volume volParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x147F
{
...
Hash func_38(int iParam0) // Position - 0x149F
{
	if (!func_23(iParam0))
		return 0;
...
BOOL func_39(Hash hParam0) // Position - 0x14BD
{
	return hParam0 != 0;
}

Ped func_40(int iParam0) // Position - 0x14C9
{
	PersChar persChar;
...
Hash func_41(int iParam0) // Position - 0x14F7
{
	if (!func_23(iParam0))
		return 0;
...
BOOL func_42(var uParam0) // Position - 0x1519
{
	return func_52(*uParam0, 1);
}

void func_43(var uParam0) // Position - 0x1529
{
	func_53(uParam0, 0f);
	return;
}

BOOL func_44(int iParam0) // Position - 0x1538
{
	if (!func_23(iParam0))
		return false;
...
BOOL func_46(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x1596
{
...
void func_50(var uParam0) // Position - 0x1739
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
int func_51() // Position - 0x174F
{
	return Global_1572887.f_14;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x175D
{
	return iParam0 && iParam1 != false;
}

void func_53(var uParam0, float fParam1) // Position - 0x176C
{
...
int func_54(var uParam0) // Position - 0x1792
{
	if (!func_42(uParam0))
...
void func_56(var uParam0, int iParam1) // Position - 0x1817
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_57(var uParam0, int iParam1) // Position - 0x1828
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_58(var uParam0) // Position - 0x183D
{
	return func_52(*uParam0, 2);
}

int func_59() // Position - 0x184D
{
	int networkTimeAccurate;
