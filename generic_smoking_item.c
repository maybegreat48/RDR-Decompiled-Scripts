...
int func_1(Hash hParam0, int iParam1) // Position - 0x39D
{
	var unk;
	int num;
	int i;
...
void func_2(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, Vector3 vParam5, var uParam6, var uParam7) // Position - 0x3E7
{
...
int func_3(var uParam0) // Position - 0x41D
{
...
BOOL func_4(Hash hParam0, int iParam1) // Position - 0x48C
{
	if (hParam0 == 0)
		return false;
...
void func_5(var uParam0) // Position - 0x4A6
{
	int i;
...
void func_6(var uParam0, int iParam1) // Position - 0x4E6
{
	uParam0->f_1 = iParam1;
	return;
}

void func_7(var uParam0, BOOL bParam1) // Position - 0x4F4
{
	int i;
	float num;
	float num2;
...
int func_8() // Position - 0x89B
{
	return Global_1572887.f_14;
}

BOOL func_9(int iParam0) // Position - 0x8A9
{
	return false;
}

BOOL func_10(Ped pedParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x8B2
{
	char* str;
...
void func_11(var uParam0) // Position - 0x8F9
{
	if (!uParam0->f_176)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_174))
...
BOOL func_12(Hash hParam0, Hash hParam1) // Position - 0x923
{
	if (!func_4(hParam0, 0))
...
BOOL func_13(int iParam0) // Position - 0x964
{
	switch (iParam0)
	{
...
float func_14(int iParam0, float fParam1) // Position - 0x9DC
{
	float pedStamina;
	float pedMaxStamina;
	float num;
...
void func_15(float fParam0) // Position - 0xA6D
{
	Ped ped;
	int num;
...
void func_16(float fParam0, BOOL bParam1) // Position - 0xAAD
{
	int num;
...
void func_17(float fParam0) // Position - 0xAE5
{
	Ped ped;
	int num;
...
float func_18(float fParam0, float fParam1) // Position - 0xB25
{
	if (fParam1 != 0f)
...
void func_19(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB53
{
	if (fParam1 == 0f)
		return;
...
void func_20(float fParam0, BOOL bParam1) // Position - 0xB8C
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
float func_21(float fParam0, int iParam1) // Position - 0xBE4
{
	switch (iParam1)
	{
		case 0:
...
int func_22(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC36
{
...
void func_23(var uParam0) // Position - 0xC5A
{
	switch (*uParam0)
	{
		case -2109344034:
...
void func_24(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0xCDA
{
...
BOOL func_25(Ped pedParam0, Any* panParam1) // Position - 0xF44
{
	return AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, panParam1);
}

Hash func_26(Hash hParam0) // Position - 0xF54
{
	return hParam0;
}

BOOL func_27(Hash hParam0, Hash hParam1) // Position - 0xF5E
{
...
int func_28(int iParam0) // Position - 0xF94
{
	if (iParam0 == 2)
		iParam0 = func_49(1);
...
void func_29(float fParam0, Ped pedParam1) // Position - 0xFD4
{
	if (fParam0 == 0f)
		return;
...
int func_30(int iParam0) // Position - 0x1018
{
	if (iParam0 == 2)
		iParam0 = func_49(1);
...
void func_31(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x105C
{
	Player player;
	Ped EntityIndex;
...
int func_32(int iParam0) // Position - 0x110D
{
	if (iParam0 == 2)
		iParam0 = func_49(1);
...
void func_33(float fParam0, Ped pedParam1) // Position - 0x1151
{
	if (fParam0 == 0f)
		return;
...
float func_34(int iParam0, float fParam1, BOOL bParam2) // Position - 0x1193
{
	int num;
	int num2;
...
float func_35(int iParam0, int iParam1) // Position - 0x11FC
{
	if (iParam1 == 2)
		iParam1 = func_49(2);
...
int func_36(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x1248
{
	Ped ped;
...
void func_38(float fParam0, int iParam1) // Position - 0x12EB
{
	float num;
	int num2;
	int num3;
...
void func_39(int iParam0, BOOL bParam1) // Position - 0x135E
{
	int num;
	int num2;
...
int func_40(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x138B
{
	char* effectName;
	Ped ped;
...
int func_41(int iParam0, int iParam1, int iParam2) // Position - 0x1541
{
	int num;
...
struct<2> func_42(int iParam0) // Position - 0x15D5
{
	int num;
...
void func_43(var uParam0, var uParam1, int iParam2) // Position - 0x15E5
{
...
int func_44(Hash hParam0) // Position - 0x1602
{
	switch (hParam0)
	{
...
void func_45(int iParam0, int iParam1) // Position - 0x17DD
{
	var statId;
...
struct<2> func_46(int iParam0, int iParam1) // Position - 0x180F
{
	int num;
...
void func_47(Hash hParam0, int iParam1) // Position - 0x1825
{
	int num;
...
BOOL func_48(Hash hParam0, int iParam1) // Position - 0x19C6
{
	if (hParam0 == 0)
		return false;
...
int func_49(int iParam0) // Position - 0x19E0
{
	return func_89(func_88(iParam0));
}

BOOL func_50(Player plParam0) // Position - 0x19F2
{
	float num;
...
int func_51() // Position - 0x1A0D
{
	return Global_1902569;
}

void func_52(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1A19
{
	int num;
	int i;
	int j;
...
int func_53(int iParam0, int iParam1) // Position - 0x1B8C
{
	if (iParam1 == 2)
		iParam1 = func_49(2);
...
int func_54(int iParam0, int iParam1) // Position - 0x1BDC
{
	if (iParam1 == 2)
		iParam1 = func_49(2);
...
BOOL func_55(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1C2E
{
	if (bParam2)
...
void func_56(int iParam0, int iParam1, int iParam2) // Position - 0x1C5B
{
	if (iParam2 == 2)
		iParam2 = func_49(2);
...
void func_57(int iParam0, int iParam1, int iParam2) // Position - 0x1CB1
{
	if (iParam2 == 2)
		iParam2 = func_49(2);
...
BOOL func_58(Ped pedParam0, int iParam1, float fParam2) // Position - 0x1D07
{
...
void func_59(int iParam0, int iParam1, int iParam2) // Position - 0x1D5C
{
	if (iParam2 == 2)
		iParam2 = func_49(2);
...
void func_60(Ped pedParam0, int iParam1, float fParam2) // Position - 0x1DBD
{
	char* StringToTest;

	StringToTest = func_101(iParam1);
...
void func_61(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x1DE9
{
	int num;
...
BOOL func_62(int iParam0, BOOL bParam1) // Position - 0x1E1F
{
	return func_55(func_51(), iParam0, bParam1);
}

float func_63(int iParam0, int iParam1) // Position - 0x1E33
{
	if (iParam1 == 2)
		iParam1 = func_49(1);
...
int func_64(float fParam0) // Position - 0x1E7F
{
	float num;
...
float func_65(float fParam0, float fParam1, float fParam2) // Position - 0x1EAA
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_66(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x1ED1
{
	int num;
	int i;
	int num2;
...
int func_67(int iParam0, float fParam1, int iParam2) // Position - 0x2059
{
	if (!func_105(iParam0))
		return 0;
...
void func_68(int iParam0, var uParam1, var uParam2) // Position - 0x20AA
{
	int num;
...
BOOL func_69(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x20C6
{
...
void func_70(int iParam0, int iParam1) // Position - 0x2168
{
	int Variable;
...
BOOL func_71(int iParam0) // Position - 0x218C
{
	switch (iParam0)
	{
		case 0:
...
char* func_72(int iParam0) // Position - 0x21BB
{
	switch (iParam0)
	{
		case 0:
...
void func_73(int iParam0) // Position - 0x21F2
{
	Ped ped;
	int num;
...
void func_74(int iParam0) // Position - 0x222F
{
	int num;
	int num2;
	int i;
...
void func_75(int iParam0) // Position - 0x22FF
{
	Ped ped;
	int num;
...
void func_76(int iParam0, BOOL bParam1) // Position - 0x233C
{
	int num;
...
void func_77(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2371
{
	func_36(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

BOOL func_78(int iParam0) // Position - 0x238B
{
	int num;
...
BOOL func_79(int iParam0) // Position - 0x23B3
{
	int num;
...
BOOL func_80(int iParam0) // Position - 0x23DB
{
	int num;
...
BOOL func_81(int iParam0) // Position - 0x2403
{
	int num;
...
BOOL func_82(int iParam0) // Position - 0x242B
{
	if (!func_81(iParam0))
		return false;
...
int func_83(int iParam0) // Position - 0x2458
{
	int num;
	int num2;
	int num3;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_84(int iParam0, int iParam1) // Position - 0x26E8
{
	int num;
	int num2;
	int num3;
...
int func_85(int iParam0) // Position - 0x28A0
{
	int num;
...
struct<2> func_87(int iParam0) // Position - 0x2CD0
{
	var unk;
...
BOOL func_88(int iParam0) // Position - 0x2CE2
{
	return func_130(&(Global_1956875.f_1565), iParam0, 1);
}

int func_89(BOOL bParam0) // Position - 0x2CF8
{
	if (bParam0)
		return 1;
...
float func_90(Player plParam0) // Position - 0x2D0A
{
...
int func_92(int iParam0) // Position - 0x2D45
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_93(int iParam0) // Position - 0x2D58
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_94(int iParam0) // Position - 0x2D6B
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_95(int iParam0) // Position - 0x2D7E
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_96(int iParam0) // Position - 0x2D90
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_97(int iParam0, int iParam1) // Position - 0x2DA2
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_98(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2E3C
{
...
BOOL func_99(int iParam0) // Position - 0x2E74
{
	int num;
	int num2;
	int num3;
...
int func_100(int iParam0) // Position - 0x2F50
{
	switch (iParam0)
	{
		case 0:
...
char* func_101(int iParam0) // Position - 0x2F7F
{
	switch (iParam0)
	{
		case 0:
...
char* func_102(int iParam0) // Position - 0x2FB6
{
	switch (iParam0)
	{
		case 0:
...
void func_103(int iParam0, float fParam1, int iParam2) // Position - 0x2FED
{
	if (iParam2 == 2)
		iParam2 = func_49(2);
...
void func_104(int iParam0, int iParam1, int iParam2) // Position - 0x303F
{
	if (iParam2 == 2)
		iParam2 = func_49(2);
...
BOOL func_105(int iParam0) // Position - 0x3095
{
	if (func_71(iParam0))
		return true;
...
void func_106(int iParam0, float fParam1, int iParam2) // Position - 0x30BB
{
	if (fParam1 < 0f)
		return;
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x3117
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_108(int iParam0) // Position - 0x312F
{
...
BOOL func_109(int iParam0) // Position - 0x3146
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_110(int iParam0, int iParam1) // Position - 0x3212
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_111(int iParam0) // Position - 0x322B
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_112() // Position - 0x323E
{
	if (!func_140())
		return false;
...
int func_113(int iParam0, int iParam1) // Position - 0x3259
{
	switch (iParam0)
	{
		case -2101912686:
...
int func_114(int iParam0, int iParam1) // Position - 0x3A5A
{
	switch (iParam0)
	{
...
int func_115(int iParam0, int iParam1) // Position - 0x4112
{
	Player player;
	Player player2;
	int num;
...
int func_116(int iParam0, int iParam1, int iParam2) // Position - 0x4195
{
	int num;
	int num2;
...
void func_117(int iParam0) // Position - 0x428D
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_118(int iParam0, int iParam1) // Position - 0x42A3
{
	switch (iParam0)
	{
...
int func_122(int iParam0, int iParam1) // Position - 0x4BCD
{
	Player player;
	Player player2;
	int num;
...
int func_123(int iParam0, int iParam1, int iParam2) // Position - 0x4C48
{
	int num;
	BOOL flag;
	int num2;
...
BOOL func_125(int iParam0) // Position - 0x4D46
{
	int num;
...
BOOL func_126(int iParam0) // Position - 0x4D6E
{
	int num;
...
BOOL func_127(int iParam0) // Position - 0x4D96
{
	int num;
...
BOOL func_128(int iParam0) // Position - 0x4DBE
{
	int num;
...
BOOL func_129(int iParam0) // Position - 0x4DE6
{
	int num;
...
BOOL func_130(Any* panParam0, int iParam1, int iParam2) // Position - 0x4E0E
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_131(int iParam0) // Position - 0x4E45
{
	switch (iParam0)
	{
		case 0:
...
var func_132(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4E86
{
	if (bParam0)
		return uParam1;
...
void func_133(int iParam0, int iParam1) // Position - 0x4E9D
{
	if (iParam1 < 0)
		return;
...
void func_134(int iParam0, int iParam1) // Position - 0x4F23
{
...
void func_135(int iParam0, int iParam1) // Position - 0x4F5F
{
	int num;
	int num2;
...
void func_136(int iParam0, int iParam1) // Position - 0x4FB2
{
...
void func_137(int iParam0, int iParam1) // Position - 0x4FED
{
...
void func_138(int iParam0, int iParam1) // Position - 0x5026
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_139(int iParam0) // Position - 0x505E
{
	switch (iParam0)
	{
		case 12:
...
Player func_141(int iParam0) // Position - 0x5097
{
	if (func_124(iParam0))
...
BOOL func_142(int iParam0) // Position - 0x50B8
{
	int num;
...
BOOL func_143(int iParam0, int iParam1, int iParam2) // Position - 0x50E0
{
	int num;
	int num2;
	int num3;
...
BOOL func_144(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x52D1
{
	return uParam0.f_4 != 0;
}

BOOL func_145(int iParam0, int iParam1) // Position - 0x52DF
{
	int num;
...
Vector3 func_146(int iParam0) // Position - 0x531F
{
	int num;
	var unk;
...
BOOL func_147(int iParam0, var uParam1, var uParam2) // Position - 0x535B
{
	if (!func_142(iParam0))
		return false;
...
BOOL func_148(int iParam0, int iParam1, int iParam2) // Position - 0x5392
{
	int num;
	int num2;
	int num3;
...
void func_149(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x55C0
{
	int num;
...
BOOL func_151(int iParam0) // Position - 0x5694
{
...
BOOL func_152(int iParam0) // Position - 0x56B2
{
	int num;
...
Vector3 func_153(int iParam0) // Position - 0x56DF
{
	var unk;
	int num;
...
int func_154(int iParam0, int iParam1) // Position - 0x5720
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_155(int iParam0) // Position - 0x5B59
{
	int num;
...
float func_156(int iParam0) // Position - 0x5B81
{
	float num;
...
void func_157(int iParam0) // Position - 0x5BB0
{
	int num;
	int num2;
	int i;
...
BOOL func_158(int iParam0) // Position - 0x5D8F
{
	int num;
...
int func_159(int iParam0, int iParam1) // Position - 0x5DB7
{
	switch (iParam0)
	{
...
void func_160(int iParam0) // Position - 0x60C7
{
	Ped ped;
	Player player;
...
BOOL func_161(int iParam0) // Position - 0x62D6
{
	int num;
...
int func_162(int iParam0, int iParam1) // Position - 0x62FD
{
	switch (iParam0)
	{
...
int func_163(int iParam0) // Position - 0x635A
{
	int num;
	var unk;
	var unk32;
...
void func_164(int iParam0) // Position - 0x649E
{
	int num;
	int num2;
	int i;
...
BOOL func_165(int iParam0) // Position - 0x65F3
{
	BOOL flag;
...
void func_166(int iParam0) // Position - 0x661C
{
	Ped EntityIndex;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_176(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_182(iParam0, 0));
			func_183(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_182(iParam0, 1));
			func_183(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_182(iParam0, 2));
			func_183(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_182(iParam0, 3));
			func_183(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_167(int iParam0) // Position - 0x68B6
{
	char* StringToTest;
	char* StringToTest2;
	...
	StringToTest = func_185(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	StringToTest2 = func_186(iParam0);
...
int func_168(int iParam0) // Position - 0x6900
{
	int num;
...
float func_169(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x692F
{
	var unk;
	float num;
...
BOOL func_170(int iParam0) // Position - 0x6965
{
...
BOOL func_171(int iParam0) // Position - 0x69D4
{
	int num;
...
int func_172(int iParam0, int iParam1) // Position - 0x69FB
{
	switch (iParam0)
	{
...
char* func_175(int iParam0) // Position - 0x6AEA
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_176(int iParam0) // Position - 0x6B2E
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_177(int iParam0) // Position - 0x6B69
{
	int i;
...
BOOL func_179(int iParam0, int iParam1) // Position - 0x6BC9
{
	int num;
	Player player;
	int num2;
...
struct<31> func_180(int iParam0) // Position - 0x6E9E
{
	int num;
...
BOOL func_181(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0x6EC2
{
	var unk;
	BOOL flag;
...
char* func_182(int iParam0, int iParam1) // Position - 0x6EF8
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_183(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x6F50
{
	int i;
...
char* func_185(int iParam0) // Position - 0x6FFA
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_186(int iParam0) // Position - 0x701A
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_187(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x703A
{
	int num;
	int num2;
...
BOOL func_188(int iParam0, int iParam1) // Position - 0x725B
{
	return iParam0 && iParam1 != false;
}

BOOL func_189() // Position - 0x726A
{
	return Global_1572887.f_7;
}

BOOL func_190() // Position - 0x7278
{
	if (!Global_1048577)
		return false;
...
BOOL func_191(Player plParam0) // Position - 0x72C3
{
...
BOOL func_192(int iParam0, Player plParam1) // Position - 0x7308
{
	if (plParam1 == 255)
...
int func_193(int iParam0) // Position - 0x7334
{
	int num;
...
struct<2> func_194(int iParam0) // Position - 0x736A
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_195(var uParam0, var uParam1) // Position - 0x737E
{
	if (!func_199(uParam0))
		return false;
...
void func_198(Player plParam0) // Position - 0x7417
{
	Player player;
...
BOOL func_199(int iParam0) // Position - 0x749A
{
	switch (iParam0)
	{
		case 2:
...
int func_200(int iParam0) // Position - 0x74D9
{
	switch (iParam0)
	{
		case 2:
...
void func_201(Player plParam0) // Position - 0x756F
{
	Player player;
...
void func_202(Player plParam0) // Position - 0x75DB
{
