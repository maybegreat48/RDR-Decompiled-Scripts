...
int func_9(int iParam0) // Position - 0x5E2
{
	if (iParam0 < 0)
		return -1;
	else if (iParam0 <= 10)
...
BOOL func_10(int iParam0) // Position - 0x6DE
{
	return iParam0 > -1 && iParam0 < 17;
}

void func_11(int iParam0, BOOL bParam1) // Position - 0x6F4
{
	Global_1896646[iParam0 /*2*/] = Global_1896646[iParam0 /*2*/] || bParam1;
	return;
}

Hash func_12(int iParam0) // Position - 0x70F
{
	Hash num;
...
BOOL func_13() // Position - 0x7F7
{
	return true;
}

void _DEBUG_PRINT(int iParam0) // Position - 0x800
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x80C
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x819
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x825
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x832
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x83E
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x853
{
	return func_55(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x864
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x8A3
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x8AF
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x8B7
{
	if (func_56(iParam0))
		return true;
...
void func_25() // Position - 0x967
{
	return;
}

void func_26() // Position - 0x96F
{
	return;
}

void func_27() // Position - 0x977
{
	return;
}

void func_28() // Position - 0x97F
{
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x987
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x993
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x99F
{
	return;
}

void func_32() // Position - 0x9A7
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0_0(int iParam0) // Position - 0x9AF
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0x9BB
{
...
void func_35(var uParam0) // Position - 0x9EC
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA32
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xA46
{
	if (!func_60(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xA5F
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xA70
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xA88
{
	iParam0 = iParam0;
...
void func_41(var uParam0, int iParam1) // Position - 0xBB5
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xCF4
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xD01
{
...
BOOL func_44(int iParam0) // Position - 0xD37
{
	if (iParam0 == 0)
	{
		func_83();
...
int func_45() // Position - 0xE4B
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xE59
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xE65
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xED2
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xFB2
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xFD0
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xFE3
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

char* func_53() // Position - 0x1001
{
	return "script@beat@wilderness@discoverables@dead_settler@dead_settler";
}

char* func_54() // Position - 0x100B
{
	return "pl_dead_settler";
}

BOOL func_55(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1016
{
	int num;
	int num2;
	int num3;
...
BOOL func_56(int iParam0) // Position - 0x110E
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_57(int iParam0) // Position - 0x111F
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_58(int iParam0) // Position - 0x1133
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_59(var uParam0, var uParam1) // Position - 0x1147
{
	return uParam0;
}

BOOL func_60(int iParam0) // Position - 0x1151
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_61() // Position - 0x1167
{
	int i;
...
BOOL func_62() // Position - 0x1194
{
	return func_72(Global_1940199, 8192);
}

int func_63() // Position - 0x11A7
{
	var unk;
...
void func_68(int iParam0) // Position - 0x13CA
{
...
void func_69() // Position - 0x1414
{
	...
	for (i = 0; i < 6; i = i + 1)
	{
		...
		{
			StringToTest = func_108(i);
		
			if (!MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && ANIMSCENE::_DOES_ENTITY_WITH_ID_EXIST_IN_ANIM_SCENE(ansLocal_21, StringToTest))
				ANIMSCENE::SET_ANIM_SCENE_ENTITY(ansLocal_21, StringToTest, uLocal_14[i], 0);
		}
	}
...
BOOL func_72(int iParam0, int iParam1) // Position - 0x1517
{
	return iParam0 && iParam1 != false;
}

BOOL func_73(var uParam0, int iParam1) // Position - 0x1526
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_74(var uParam0, int iParam1) // Position - 0x1537
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_75(int iParam0) // Position - 0x1548
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_76(int iParam0, int iParam1) // Position - 0x1588
{
...
int func_77() // Position - 0x15B5
{
	return Global_1896646.f_41;
}

void func_78(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x15C3
{
	BOOL flag;
...
void func_79(var uParam0, int iParam1) // Position - 0x1828
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_80(int iParam0, BOOL bParam1) // Position - 0x183B
{
...
void func_81(BOOL bParam0) // Position - 0x1EA4
{
	if (bParam0)
...
BOOL func_82(int iParam0) // Position - 0x1ECD
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_83() // Position - 0x1F12
{
	return;
}

Hash func_84(int iParam0, BOOL bParam1) // Position - 0x1F1A
{
	switch (iParam0)
	{
		case 0:
...
void func_85(int iParam0, BOOL bParam1) // Position - 0x26DF
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_86(BOOL bParam0) // Position - 0x2732
{
	if (bParam0)
...
void func_87(int iParam0) // Position - 0x275B
{
	iParam0 = iParam0;
...
void func_88(int iParam0) // Position - 0x27B1
{
	int i;
...
void func_89(int iParam0) // Position - 0x27E2
{
	int i;
...
BOOL func_90(int iParam0, BOOL bParam1) // Position - 0x2815
{
	int num;
	int num2;
	int num3;
...
BOOL func_91(int iParam0) // Position - 0x28CB
{
	int i;
...
BOOL func_92(int iParam0, BOOL bParam1) // Position - 0x2945
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_93(int iParam0) // Position - 0x2976
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_94(int iParam0) // Position - 0x2997
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_95(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x29EA
{
	BOOL flag;
...
BOOL func_96(int iParam0) // Position - 0x30AA
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_97(int iParam0) // Position - 0x30C1
{
	switch (iParam0)
	{
		case 64:
...
int func_98(int iParam0, BOOL bParam1) // Position - 0x3104
{
	if (!func_96(iParam0))
		return 0;
...
BOOL func_99(int iParam0) // Position - 0x31EF
{
	return iParam0 > -1 && iParam0 < 16;
}

Vector3 func_100(int iParam0) // Position - 0x3205
{
	switch (iParam0)
	{
		case 0:
...
float func_101(int iParam0) // Position - 0x32BA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_102(var uParam0, ePedType eptParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0x3331
{
	if (*uParam2)
		return false;
...
BOOL func_103(var uParam0) // Position - 0x339C
{
...
void func_104(var uParam0) // Position - 0x33CA
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_105(Ped pedParam0, Hash hParam1) // Position - 0x3410
{
...
BOOL func_106(var uParam0) // Position - 0x34B9
{
...
void func_107(var uParam0, int iParam1) // Position - 0x34EA
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && !ENTITY::IS_ENTITY_DEAD(*uParam0))
...
char* func_108(int iParam0) // Position - 0x3513
{
	switch (iParam0)
	{
		case 0:
...
void func_109(var uParam0) // Position - 0x3587
{
	int flags;
...
BOOL func_110(int iParam0) // Position - 0x35B8
{
...
const char* func_112(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x3630
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_154(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_156(func_155(Global_34));
...
BOOL func_113(int iParam0) // Position - 0x4097
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_114(int iParam0) // Position - 0x40AC
{
	switch (iParam0)
	{
		case 0:
...
int func_115(int iParam0) // Position - 0x4167
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_116(int iParam0) // Position - 0x41D5
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_117(int iParam0) // Position - 0x4330
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_118(int iParam0, BOOL bParam1) // Position - 0x436B
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_119(int iParam0, int iParam1) // Position - 0x43AD
{
	if (!func_113(iParam0))
		return false;
...
int func_120() // Position - 0x43F2
{
	return Global_1902569;
}

int func_121(int iParam0) // Position - 0x43FE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_122(int iParam0) // Position - 0x4411
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_123(float fParam0) // Position - 0x4423
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_124(var uParam0, int iParam1) // Position - 0x4439
{
...
int func_125(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x446F
{
	int duration;
	var data;
	int num;
...
BOOL func_126(int iParam0) // Position - 0x44B2
{
	if (func_157(iParam0))
		if (!func_158(44))
			return false;
...
void func_127(int iParam0, int iParam1) // Position - 0x44D2
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_128(int iParam0, int iParam1) // Position - 0x44E3
{
	int num;
...
void func_129(var uParam0, var uParam1, int iParam2) // Position - 0x44F9
{
...
void func_130(int iParam0) // Position - 0x4516
{
...
void func_131(int iParam0) // Position - 0x45F6
{
	int i;
	int num;
...
BOOL func_132(int iParam0, BOOL bParam1) // Position - 0x47CE
{
	if (func_45() != -1)
		return false;
...
int func_133(int iParam0, BOOL bParam1) // Position - 0x47FC
{
	if (!func_96(iParam0))
		return 0;
...
int func_134(int iParam0) // Position - 0x487F
{
	switch (iParam0)
	{
		case 27:
...
int func_135(int iParam0) // Position - 0x48A6
{
	switch (iParam0)
	{
		case 33:
...
void func_138(int iParam0, BOOL bParam1) // Position - 0x4B09
{
	BOOL flag;
...
Hash func_139(int iParam0) // Position - 0x4EB8
{
	if (!func_96(iParam0))
		return 0;
...
void func_140(int iParam0, PersChar pchParam1) // Position - 0x4ED6
{
	if (!func_96(iParam0))
		return;
...
PersChar func_141(int iParam0) // Position - 0x4EF7
{
	if (!func_96(iParam0))
		return 0;
...
void func_142(int iParam0, BOOL bParam1) // Position - 0x4F17
{
	if (func_45() != -1)
		return;
...
BOOL func_143(int iParam0) // Position - 0x4F50
{
	if (!func_96(iParam0))
		return false;
...
Ped func_144(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x4F76
{
	Ped EntityIndex;
	...
	func_184(EntityIndex, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return EntityIndex;
}

void func_145(var uParam0, BOOL bParam1) // Position - 0x4FB6
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		ENTITY::IS_ENTITY_DEAD(*uParam0);
...
void func_146(var uParam0, BOOL bParam1) // Position - 0x4FFA
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		ENTITY::IS_ENTITY_DEAD(*uParam0);
...
BOOL func_147(Ped pedParam0, Hash hParam1) // Position - 0x504A
{
	BOOL flag;
...
BOOL func_148(Ped pedParam0, Hash hParam1) // Position - 0x5078
{
	Hash _int;
...
BOOL func_149(Ped pedParam0, Hash hParam1) // Position - 0x50C8
{
	Hash _int;
	int _int2;
...
void func_150(Ped pedParam0) // Position - 0x5138
{
...
BOOL func_151() // Position - 0x5155
{
	return false;
}

BOOL func_152() // Position - 0x515E
{
	var unk;
	var unk3;
...
BOOL func_153(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x51C6
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_154(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x533C
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_155(var uParam0, var uParam1, var uParam2) // Position - 0x5350
{
	int i;
...
const char* func_156(int iParam0) // Position - 0x537E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_157(int iParam0) // Position - 0x5662
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_158(int iParam0) // Position - 0x568C
{
	if (!func_190(iParam0))
		return false;
...
struct<2> func_159(Player plParam0) // Position - 0x56A8
{
	var gamerHandle;
...
const char* func_160(const char* sParam0, int iParam1) // Position - 0x56BC
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_161(int iParam0, BOOL bParam1) // Position - 0x56D6
{
	char* StringToTest;
...
void func_162(int iParam0, BOOL bParam1) // Position - 0x570A
{
	switch (iParam0)
	{
		case 5:
...
void func_163(int iParam0, int iParam1) // Position - 0x573F
{
	func_192(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_164(int iParam0) // Position - 0x5759
{
	if (!func_96(iParam0))
		return false;
...
void func_165(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x577E
{
	PersChar persChar;
...
void func_166(int iParam0, BOOL bParam1) // Position - 0x586A
{
	if (!func_195(iParam0))
		return;
...
void func_167(int iParam0, int iParam1) // Position - 0x58C0
{
	if (!func_200(iParam0))
		return;
...
int func_168(int iParam0) // Position - 0x5933
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_169(Hash hParam0) // Position - 0x5949
{
...
void func_170(int iParam0) // Position - 0x5969
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_171(int iParam0, BOOL bParam1) // Position - 0x597F
{
	if (func_45() != -1)
		return;
...
void func_172(int iParam0) // Position - 0x59B0
{
	Ped EntityIndex;
...
void func_173(int iParam0) // Position - 0x59F4
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_174(int iParam0) // Position - 0x5A09
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_175(int iParam0) // Position - 0x5A1E
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_176(int iParam0) // Position - 0x5A33
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_177(int iParam0) // Position - 0x5AB2
{
...
BOOL func_178(int iParam0, int iParam1) // Position - 0x5B0F
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_179(int iParam0, int iParam1) // Position - 0x5B28
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_180(int iParam0, int iParam1) // Position - 0x5B41
{
...
int func_181(int iParam0) // Position - 0x5B7C
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_182(int iParam0) // Position - 0x5B90
{
	return;
}

BOOL func_183(int iParam0, int iParam1) // Position - 0x5B98
{
	if (iParam0 == -1)
		return false;
...
void func_184(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x5BBF
{
	BOOL flag;
...
BOOL func_185() // Position - 0x5C89
{
	...
	if (!func_187(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_186() // Position - 0x5CE1
{
	return Global_1051268;
}

BOOL func_187(var uParam0, var uParam1) // Position - 0x5CEF
{
	if (!func_208(uParam0))
		return false;
...
struct<2> func_188() // Position - 0x5D23
{
...
BOOL func_189(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x5D6E
{
	var unk;
	float num;
	float num2;
...
BOOL func_190(int iParam0) // Position - 0x5D9E
{
	if (iParam0 == 0)
		return false;
...
BOOL func_191(int iParam0) // Position - 0x5DB1
{
	int num;
	int num2;
	int offset;
...
void func_192(var uParam0, int iParam1) // Position - 0x5DDB
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_193(int iParam0) // Position - 0x5DF0
{
	if (!func_96(iParam0))
		return false;
...
BOOL func_194(Hash hParam0) // Position - 0x5E14
{
	return hParam0 != 0;
}

BOOL func_195(int iParam0) // Position - 0x5E20
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_196(int iParam0, BOOL bParam1) // Position - 0x5E36
{
	if (!func_195(iParam0))
		return false;
...
void func_197(int iParam0, BOOL bParam1) // Position - 0x5E5C
{
	if (!func_195(iParam0))
		return;
...
void func_198(int iParam0, BOOL bParam1) // Position - 0x5E8A
{
	if (!func_195(iParam0))
		return;
...
void func_199(int iParam0) // Position - 0x5EC4
{
	func_213(func_212(iParam0));
	return;
}

BOOL func_200(int iParam0) // Position - 0x5ED6
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_201(Hash hParam0) // Position - 0x5EEC
{
	if (func_214(hParam0))
...
BOOL func_202() // Position - 0x5F07
{
	return 1;
}

Ped func_203(int iParam0) // Position - 0x5F10
{
	PersChar persChar;
...
BOOL func_204(BOOL bParam0, BOOL bParam1) // Position - 0x5F3E
{
	return bParam0 && bParam1 != false;
}

void func_205(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5F4D
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_206(Ped pedParam0, BOOL bParam1) // Position - 0x5F92
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_207(Ped pedParam0, int iParam1) // Position - 0x5FD7
{
	if (iParam1 == 1)
...
BOOL func_208(int iParam0) // Position - 0x5FFE
{
	switch (iParam0)
	{
		case 2:
...
int func_209(int iParam0) // Position - 0x603D
{
	switch (iParam0)
	{
		case 2:
...
void func_210(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x60D3
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_211(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x6B70
{
	float num;
	float num2;
	float num3;
...
int func_212(int iParam0) // Position - 0x6BD6
{
...
void func_213(int iParam0) // Position - 0x70F3
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_214(Hash hParam0) // Position - 0x7104
{
	return hParam0 != 0;
}
