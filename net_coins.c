...
struct<2> func_3(int iParam0) // Position - 0x13C
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_4(int iParam0, var uParam1) // Position - 0x150
{
	return iParam0;
}

void func_5(var uParam0) // Position - 0x15A
{
...
BOOL func_6(var uParam0) // Position - 0x1CB
{
...
BOOL func_7() // Position - 0x1E5
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x1EE
{
	Hash hash;
	BOOL flag;
	BOOL flag2;
...
int func_9(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x89B
{
	int num;
	int num2;
	int scenario;
...
int func_10(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xCE7
{
	int num;
	int scenario;
...
void func_11(var uParam0, int iParam1) // Position - 0xD1A
{
...
int func_12(var uParam0) // Position - 0xD3A
{
	int num;
...
int func_13(int iParam0) // Position - 0x1000
{
	switch (iParam0)
	{
...
void func_14(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x150B
{
...
void func_15(var uParam0, var uParam1) // Position - 0x1542
{
	Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_1 = uParam0;
	return;
}

void func_16() // Position - 0x1558
{
...
void func_17(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1587
{
	int num;
...
void func_18(var uParam0) // Position - 0x15DB
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_21))
...
void func_19(var uParam0, var uParam1, var uParam2) // Position - 0x15FC
{
...
void func_20(var uParam0, var uParam1, BOOL bParam2) // Position - 0x161E
{
	var value;
	int num;
	int num2;
...
void func_21(int iParam0, int iParam1, int iParam2) // Position - 0x16EE
{
	func_74(&Global_1222327[iParam0 /*251*/][iParam1], iParam2);
	return;
}

void func_22() // Position - 0x1708
{
...
void func_24(var uParam0) // Position - 0x1782
{
	func_75(uParam0);
...
void func_25(BOOL bParam0) // Position - 0x1799
{
	if (bParam0)
		func_77(0, 6);
	else
...
void func_26(var uParam0) // Position - 0x17B6
{
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_7))
...
BOOL func_27(var uParam0, int iParam1) // Position - 0x17D1
{
	return func_64(uParam0->f_16, iParam1);
}

BOOL func_28(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x17E3
{
...
BOOL func_29(var uParam0) // Position - 0x183E
{
	if (!func_27(uParam0, 32))
...
int func_30(var uParam0) // Position - 0x188E
{
	return uParam0->f_2;
}

BOOL func_31(int iParam0) // Position - 0x189A
{
	int i;
	Player Plr;
	float num;
	...
	if (num > 0f)
	{
		...
		{
			if (!func_64(Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 1))
				func_65(&Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 1);
		
			return true;
		}
	
		if (!func_64(Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 32))
			func_65(&Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 32);
	}

	return false;
}

void func_32(var uParam0, int iParam1) // Position - 0x1A0F
{
	uParam0->f_2 = iParam1;
	return;
}

BOOL func_33(int iParam0) // Position - 0x1A1D
{
	if (iParam0 < 0)
		return false;
...
BOOL func_34(int iParam0, BOOL bParam1) // Position - 0x1A5C
{
	int num;
...
BOOL func_35(BOOL bParam0) // Position - 0x1A8F
{
...
void func_36(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1AC2
{
	if (!func_41(vParam1))
	{
		func_19(vParam1);
...
void func_37(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x1B37
{
	BOOL flag;
	BOOL flag2;
	float num;
...
void func_38(int iParam0) // Position - 0x1D60
{
...
void func_39(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1E5E
{
...
void func_40(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x1EB6
{
	if (!func_92(iParam0))
	{
...
BOOL func_41(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1EEA
{
	return !PERSISTENCE::_PERSISTENCE_IS_SCENARIO_MARKED_AS_LOOTED_AT_COORDS(vParam0);
}

Vector3 func_42(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x1EFB
{
	var unk;
	float X;
	float num;
	...
	unk = { func_93(uParam0) };
	X = { func_95(func_95(unk, func_94(iParam3 - 90f)), unk) };
	num = MISC::ATAN2(X.f_1, X);
	num2 = -MISC::ATAN2(X.f_2, BUILTIN::SQRT((X * X) + (X.f_1 * X.f_1)));
	vector = { -X.f_1, X, 0f };
	vector2 = { func_95(vector, X) };
	num3 = MISC::ATAN2(func_96(vector, unk) / BUILTIN::VMAG(vector), func_96(vector2, unk) / BUILTIN::VMAG(vector2)) + 180f;
	return num3, num2, num;
}

int func_43(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x1FB1
{
	int i;
...
BOOL func_44(var uParam0, int iParam1) // Position - 0x2061
{
	if (func_80(joaat("kit_collector_spade"), 1))
	{
...
int func_45(char* sParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, Hash hParam15, int iParam16) // Position - 0x212F
{
	int i;
	int num;
	int num2;
...
void func_46(int iParam0, var uParam1) // Position - 0x220D
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
BOOL func_47(int iParam0, BOOL bParam1) // Position - 0x224E
{
	int num;
	int gameTimer;
	float progress;
...
BOOL func_48(int iParam0, int iParam1, int iParam2) // Position - 0x2348
{
	return func_64(Global_1222327[iParam0 /*251*/][iParam1], iParam2);
}

void func_49(Ped pedParam0) // Position - 0x2362
{
	Entity firstEntityPedIsCarrying;
...
float func_50(int iParam0, BOOL bParam1) // Position - 0x23A4
{
	int num;
...
float func_52(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x2425
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
void func_53(float fParam0) // Position - 0x244D
{
	if (!Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_4)
	{
...
int func_54(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2491
{
...
float func_55(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x24B7
{
	float num;
	float Y;
	float X;
...
BOOL func_57(var uParam0) // Position - 0x2540
{
	var unk;
	int i;
	int num;
...
void func_58(int iParam0) // Position - 0x25DA
{
...
void func_59(BOOL bParam0, BOOL bParam1) // Position - 0x25F4
{
	if (bParam1)
...
BOOL func_62(Hash hParam0, int iParam1) // Position - 0x2750
{
	if (hParam0 == 0)
		return false;
...
int func_63(int iParam0) // Position - 0x276A
{
	switch (iParam0)
	{
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x2D91
{
	return iParam0 && iParam1 != false;
}

void func_65(int iParam0, int iParam1) // Position - 0x2DA0
{
	func_105(iParam0, iParam1);
	return;
}

int func_66(int iParam0) // Position - 0x2DB0
{
	return iParam0;
}

void func_67(int iParam0) // Position - 0x2DBA
{
	if (!func_106(iParam0))
		return;
...
int func_68(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x2E6D
{
	int i;
	var SourceStruct;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x2F17
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

var func_70(int iParam0, int iParam1) // Position - 0x2F40
{
	return func_71(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

var func_71(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x2F5E
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_109(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
void func_73(Any* panParam0, int* piParam1) // Position - 0x338B
{
...
void func_74(int iParam0, int iParam1) // Position - 0x33BC
{
	func_114(iParam0, iParam1);
	return;
}

void func_75(var uParam0) // Position - 0x33CC
{
	if (uParam0->f_4 != -1)
	{
...
void func_76(int iParam0, int iParam1) // Position - 0x33FF
{
	if (func_92(iParam0))
...
void func_77(int iParam0, int iParam1) // Position - 0x3418
{
...
void func_78(int iParam0, int iParam1, BOOL bParam2) // Position - 0x345C
{
...
float func_79(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x34C3
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_80(Hash hParam0, int iParam1) // Position - 0x34E1
{
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x3564
{
...
BOOL func_82(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x358E
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_83() // Position - 0x368D
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_84(var uParam0, int iParam1) // Position - 0x36A2
{
	*uParam0 = iParam1;
	return;
}

void func_85(int iParam0) // Position - 0x36AF
{
	if (iParam0 <= 0)
		return;
...
void func_86(var uParam0) // Position - 0x36D6
{
	func_124(uParam0, 0f);
	return;
}

float func_87(var uParam0) // Position - 0x36E5
{
	if (!func_125(uParam0))
		return uParam0->f_1;
...
BOOL func_89(Ped pedParam0) // Position - 0x377F
{
...
BOOL func_90(int iParam0, BOOL bParam1) // Position - 0x37C9
{
	if (bParam1 && !func_33(iParam0))
		return false;
...
void func_91(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x37EE
{
	int num;
...
BOOL func_92(int iParam0) // Position - 0x3842
{
	if (*iParam0 == 0)
		return false;
...
Vector3 func_93(float fParam0, var uParam1, var uParam2) // Position - 0x385A
{
	float num;
	float num2;
...
Vector3 func_94(float fParam0) // Position - 0x3899
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Vector3 func_95(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x38AF
{
...
float func_96(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x38E8
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

BOOL func_97(Entity eParam0) // Position - 0x3909
{
	int num;
	var InputString;
	Hash entityModel;
...
BOOL func_98(int iParam0, int iParam1) // Position - 0x39A3
{
	if (iParam0 < 0)
		return false;
...
BOOL func_99(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x39C4
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_101(int iParam0, Any anParam1) // Position - 0x3D33
{
	var unk;
...
struct<2> func_102(int iParam0, int iParam1) // Position - 0x3D5C
{
	int num;
...
void func_103(var uParam0, var uParam1, int iParam2) // Position - 0x3D72
{
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x3D8F
{
	var unk;
	var unk13;
	var unk26;
...
void func_105(var uParam0, int iParam1) // Position - 0x3DBF
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_106(int iParam0) // Position - 0x3DD0
{
	return func_98(iParam0, 2);
}

int func_107() // Position - 0x3DDF
{
	return Global_1051645.f_12;
}

char* func_108() // Position - 0x3DED
{
	return "unnamed";
}

BOOL func_109(int iParam0) // Position - 0x3DF8
{
	int num;
...
BOOL func_110(int iParam0) // Position - 0x3E87
{
...
int func_111(int iParam0) // Position - 0x3EA5
{
	if (iParam0 == 255)
...
BOOL func_112(Player plParam0) // Position - 0x3EF0
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
int func_113(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x3F35
{
	if (!func_145(uParam0))
		return 0;
...
void func_114(int iParam0, int iParam1) // Position - 0x3F65
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_115(int iParam0, int iParam1) // Position - 0x3F7A
{
	return MISC::IS_BIT_SET(Global_1072759.f_22475.f_417[iParam0 /*12*/], iParam1);
}

void func_116() // Position - 0x3F96
{
	SCRIPTS::_SET_ALL_PLAYER_BITS(&(Global_1072759.f_21353.f_260));
	return;
}

int func_117(Hash hParam0) // Position - 0x3FAC
{
	var unk;
...
BOOL func_118(Hash hParam0, int iParam1) // Position - 0x3FD7
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_119(Hash hParam0) // Position - 0x407E
{
	int num;
	int num2;
	int num3;
...
int func_120(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x413A
{
...
BOOL func_121(BOOL bParam0) // Position - 0x41FC
{
	if (bParam0)
...
BOOL func_122() // Position - 0x422C
{
	return func_159() != -1;
}

BOOL func_123() // Position - 0x423A
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_124(var uParam0, float fParam1) // Position - 0x425F
{
...
BOOL func_125(var uParam0) // Position - 0x4285
{
	return func_162(*uParam0, 1);
}

BOOL func_126(var uParam0) // Position - 0x4295
{
	return func_162(*uParam0, 2);
}

float func_127() // Position - 0x42A5
{
...
BOOL func_128(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x42D7
{
...
BOOL func_129(Ped pedParam0) // Position - 0x4300
{
	return func_163(pedParam0, 0);
}

BOOL func_130(Ped pedParam0) // Position - 0x430F
{
	return func_163(pedParam0, 3);
}

BOOL func_131(Ped pedParam0) // Position - 0x431E
{
	return func_163(pedParam0, 4) || func_163(pedParam0, 5);
}

BOOL func_132(Ped pedParam0) // Position - 0x433A
{
	return func_163(pedParam0, 6);
}

BOOL func_133(Ped pedParam0) // Position - 0x4349
{
	return func_163(pedParam0, 7);
}

void func_134(int iParam0, int iParam1) // Position - 0x4358
{
	if (iParam0 < 0)
		return;
...
void func_135(int iParam0, BOOL bParam1) // Position - 0x438B
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_136(int iParam0, BOOL bParam1) // Position - 0x43E3
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_137(int iParam0, int iParam1) // Position - 0x440C
{
	if (iParam0 < 0)
		return;
...
int func_138() // Position - 0x4434
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

void func_139(var uParam0, int iParam1) // Position - 0x4449
{
	BOOL flag;
	int i;
...
BOOL func_140(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x4575
{
	var unk;
	int num;
...
int func_141(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x45E4
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_142(int iParam0, int iParam1) // Position - 0x46C5
{
	int num;
...
BOOL func_143(Player plParam0) // Position - 0x4739
{
...
void func_144(Player plParam0) // Position - 0x4756
{
	Player player;
...
BOOL func_145(var uParam0) // Position - 0x47D9
{
	if (*uParam0 >= 40)
		return false;
...
Hash func_146(Hash hParam0, int iParam1) // Position - 0x47EE
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_147(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x4868
{
...
BOOL func_148(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x488F
{
	if (iParam2 < 0)
		return false;
...
BOOL func_149(Hash hParam0) // Position - 0x48CA
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_150(int iParam0) // Position - 0x48E5
{
	if (iParam0 < 0)
		return 0;
...
int func_151(Hash hParam0) // Position - 0x4906
{
	var unk;
...
int func_152(Hash hParam0) // Position - 0x4931
{
	switch (hParam0)
	{
...
int func_153(var uParam0, int iParam1) // Position - 0x4A14
{
	int i;
...
int func_154(Hash hParam0) // Position - 0x4A51
{
	int num;
...
int func_155(Hash hParam0, BOOL bParam1) // Position - 0x4ABE
{
	var unk;
	int num;
	int num2;
...
int func_156(Hash hParam0, int iParam1) // Position - 0x4B1D
{
	if (iParam1 == 0)
		return 0;
...
int func_157(BOOL bParam0) // Position - 0x4B49
{
	if (func_2() == -1)
	{
...
struct<4> func_158(Hash hParam0, BOOL bParam1) // Position - 0x4B8A
{
	var unk;
...
int func_159() // Position - 0x4BAF
{
	return Global_1149172.f_137;
}

void func_160(var uParam0, int iParam1) // Position - 0x4BBD
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_161(var uParam0, int iParam1) // Position - 0x4BCE
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_162(int iParam0, int iParam1) // Position - 0x4BE3
{
	return iParam0 && iParam1 != false;
}

BOOL func_163(Ped pedParam0, int iParam1) // Position - 0x4BF2
{
	var unk;
	int num;
...
void func_164(var uParam0) // Position - 0x4C31
{
...
void func_165(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x4C69
{
	int i;
	var unk;
...
void func_166(int iParam0, int iParam1) // Position - 0x4D1F
{
	if (iParam1 == 0)
		return;
...
void func_167(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x4D4F
{
	int i;
	var unk;
...
BOOL func_168(Any* panParam0, int iParam1, int iParam2) // Position - 0x4E0A
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_169() // Position - 0x4E41
{
	return Global_1102813.f_3672;
}

void func_170(Player plParam0) // Position - 0x4E50
{
	Player player;
...
void func_171(Player plParam0) // Position - 0x4EBC
{
...
BOOL func_172(Hash hParam0, Hash hParam1) // Position - 0x4EF7
{
	if (!func_62(hParam0, 0))
...
void func_173(Hash hParam0, var uParam1, var uParam2) // Position - 0x4F38
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_174(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5144
{
	Hash hash;
...
struct<4> func_175(BOOL bParam0) // Position - 0x5222
{
	int num;
...
void func_176(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x52C3
{
...
BOOL func_177(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x52DE
{
...
Hash func_178(Hash hParam0) // Position - 0x5303
{
	return hParam0;
}

BOOL func_179(Hash hParam0, int iParam1) // Position - 0x530D
{
	if (hParam0 == 0)
		return false;
...
struct<5> func_180(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x5327
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_181(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x569B
{
	var outGuid;
...
int func_182() // Position - 0x56CC
{
	return Global_1953292.f_1;
}

BOOL func_183(Any anParam0) // Position - 0x56DA
{
...
BOOL func_184(Hash hParam0, Hash hParam1) // Position - 0x5720
{
...
struct<4> func_185(BOOL bParam0) // Position - 0x5756
{
	int num;
...
int func_186(Hash hParam0, BOOL bParam1) // Position - 0x57F6
{
...
BOOL func_187(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x582D
{
	return func_194(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_188(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x5848
{
	var unk;
...
struct<4> func_189(BOOL bParam0) // Position - 0x5869
{
	int num;
...
BOOL func_190(Hash hParam0, int iParam1) // Position - 0x58D3
{
	Hash hash;
	int num;
	int i;
...
BOOL func_191(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x5940
{
	return func_197(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

struct<4> func_192() // Position - 0x5956
{
	var unk;
...
int func_194(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x597F
{
...
BOOL func_195(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x59FE
{
	int inventoryId;
...
BOOL func_196(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x5A43
{
...
BOOL func_197(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x5A76
{
...
int func_198(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5AB0
{
...
BOOL func_199(Hash hParam0) // Position - 0x5AE3
{
