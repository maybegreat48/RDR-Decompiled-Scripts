...
void func_69(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1433
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_121(&unk, joaat("COLOR_PURE_WHITE")), str3, func_121(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_121(&unk, joaat("COLOR_PURE_WHITE")), func_121(&unk2, joaat("COLOR_PURE_WHITE")));
		}
...
BOOL func_100(int iParam0, BOOL bParam1) // Position - 0x3FF4
{
...
Hash func_112(int iParam0) // Position - 0x4CC6
{
	int i;
	var gamerHandle;
	Hash bountyData;
