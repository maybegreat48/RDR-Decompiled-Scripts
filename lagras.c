...
void _DEBUG_PRINT(int iParam0) // Position - 0x93C
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x948
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x955
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x961
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x96E
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x97A
{
...
void func_21(int iParam0, BOOL bParam1) // Position - 0x9A0
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x9DF
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x9EB
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x9F3
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0xAA3
{
	return;
}

void func_26() // Position - 0xAAB
{
	return;
}

void func_27() // Position - 0xAB3
{
	return;
}

void func_28() // Position - 0xABB
{
	return;
}

void func_29(int iParam0) // Position - 0xAC3
{
...
void func_30(int iParam0) // Position - 0xB37
{
	func_62(638, volLocal_20, true);
	return;
}

void func_31() // Position - 0xB4A
{
	return;
}

void func_32() // Position - 0xB52
{
	return;
}

void func_33(int iParam0) // Position - 0xB5A
{
	iParam0 = iParam0;
...
void func_35(var uParam0) // Position - 0xBA7
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xBED
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xC0B
{
	if (!func_65(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xC24
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xC35
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xC4D
{
	iParam0 = iParam0;
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xC5A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_44(int iParam0) // Position - 0xDDC
{
	if (iParam0 == 0)
	{
		func_79();
...
int func_45() // Position - 0xEF0
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xEFE
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xF0A
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xF77
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x1057
{
	if (!func_65(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x1075
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x1088
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x10A6
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x119E
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x11AF
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x11C3
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x11D7
{
	return uParam0;
}

void func_58(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x11E1
{
...
int func_59(int iParam0, BOOL bParam1) // Position - 0x1390
{
	int num;
	Hash hash;
	float num2;
...
void func_60(int iParam0, int iParam1) // Position - 0x14B7
{
	func_111(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

void func_61(int iParam0, int iParam1) // Position - 0x14D1
{
	if (!func_112(iParam0))
		return;
...
int func_62(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x14F9
{
	PersChar persChar;
...
void func_63(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1547
{
...
void func_64(var uParam0, Volume volParam1, int iParam2) // Position - 0x156F
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_65(int iParam0) // Position - 0x15C8
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_66() // Position - 0x15DE
{
	int i;
...
BOOL func_67(int iParam0, int iParam1) // Position - 0x160B
{
	return iParam0 && iParam1 != false;
}

BOOL func_68(var uParam0, int iParam1) // Position - 0x161A
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_69() // Position - 0x162B
{
	return func_67(Global_1940199, 8192);
}

BOOL func_70(var uParam0, int iParam1) // Position - 0x163E
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_71(int iParam0) // Position - 0x164F
{
	if (!func_65(iParam0))
		return false;
...
BOOL func_72(int iParam0, int iParam1) // Position - 0x168F
{
...
int func_73() // Position - 0x16BC
{
	return Global_1896646.f_41;
}

void func_74(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x16CA
{
	BOOL flag;
	...
	StringToTest = func_119(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_131(&unk, joaat("COLOR_PURE_WHITE")), str3, func_131(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_131(&unk, joaat("COLOR_PURE_WHITE")), func_131(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_132(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_75(var uParam0, int iParam1) // Position - 0x1936
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_76(int iParam0, BOOL bParam1) // Position - 0x1949
{
...
void func_77(BOOL bParam0) // Position - 0x1FB2
{
	if (bParam0)
...
BOOL func_78(int iParam0) // Position - 0x1FDB
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_79() // Position - 0x2020
{
	return;
}

Hash func_80(int iParam0, BOOL bParam1) // Position - 0x2028
{
	switch (iParam0)
	{
		case 0:
...
void func_81(int iParam0, BOOL bParam1) // Position - 0x27ED
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_82(BOOL bParam0) // Position - 0x2840
{
	if (bParam0)
...
void func_83(int iParam0) // Position - 0x2869
{
...
void func_84(int iParam0) // Position - 0x2892
{
	int i;
...
void func_85(int iParam0) // Position - 0x28C3
{
	int i;
...
BOOL func_86(int iParam0, BOOL bParam1) // Position - 0x28F6
{
	int num;
	int num2;
	int num3;
...
BOOL func_87(int iParam0) // Position - 0x29AC
{
	int i;
...
BOOL func_88(int iParam0, BOOL bParam1) // Position - 0x2A26
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_89(int iParam0) // Position - 0x2A57
{
	if (!func_65(iParam0))
		return false;
...
BOOL func_90(int iParam0) // Position - 0x2A78
{
	if (!func_65(iParam0))
		return false;
...
BOOL func_91(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2ACB
{
	BOOL flag;
...
BOOL func_92(int iParam0) // Position - 0x318B
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_93(int iParam0) // Position - 0x31A2
{
	switch (iParam0)
	{
		case 64:
...
int func_94(int iParam0, BOOL bParam1) // Position - 0x31E5
{
	if (!func_92(iParam0))
		return 0;
...
BOOL func_96() // Position - 0x32E4
{
	return func_149(func_56(0));
}

BOOL func_97(int iParam0) // Position - 0x32F5
{
	return !func_150(iParam0);
}

void func_98(BOOL bParam0, BOOL bParam1) // Position - 0x3304
{
	if (func_151(255) == 4)
		return;
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x344F
{
	BOOL flag;
...
int func_100(int iParam0, int iParam1) // Position - 0x37FE
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_101(int iParam0) // Position - 0x4164
{
	if (!func_168(iParam0))
		return 0;
...
int func_102(int iParam0) // Position - 0x41A5
{
	switch (iParam0)
	{
		case 3:
...
void func_103(int iParam0, int iParam1) // Position - 0x4242
{
...
void func_104(int iParam0) // Position - 0x4271
{
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x42AA
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x42C3
{
...
int func_107() // Position - 0x42ED
{
	return Global_1893611.f_2;
}

BOOL func_108(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x42FB
{
	return func_170(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_109(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x431B
{
	return func_170(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_110(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x433B
{
	if (bParam6)
...
void func_111(int iParam0, int iParam1) // Position - 0x43B7
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_112(int iParam0) // Position - 0x43C8
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_113(int iParam0, BOOL bParam1) // Position - 0x43DE
{
	if (func_45() != -1)
		return false;
...
PersChar func_114(int iParam0) // Position - 0x4436
{
	if (!func_92(iParam0))
		return 0;
...
BOOL func_115(int iParam0) // Position - 0x4456
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_116(int iParam0) // Position - 0x446C
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_117(int iParam0) // Position - 0x4482
{
...
const char* func_119(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x44FA
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_176(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_178(func_177(Global_34));
...
BOOL func_120(int iParam0) // Position - 0x4F60
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_121(int iParam0) // Position - 0x4F75
{
	switch (iParam0)
	{
		case 0:
...
int func_122(int iParam0) // Position - 0x5030
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_123(int iParam0) // Position - 0x509E
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_124(int iParam0) // Position - 0x51F9
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_125(int iParam0, BOOL bParam1) // Position - 0x5234
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_126(int iParam0, int iParam1) // Position - 0x5276
{
	if (!func_120(iParam0))
		return false;
...
int func_127() // Position - 0x52BB
{
	return Global_1902569;
}

int func_128(int iParam0) // Position - 0x52C7
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_129(int iParam0) // Position - 0x52DA
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_130(float fParam0) // Position - 0x52EC
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_131(var uParam0, int iParam1) // Position - 0x5302
{
...
int func_132(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x5338
{
	int duration;
	var data;
	int num;
...
BOOL func_133(int iParam0) // Position - 0x537B
{
	if (func_179(iParam0))
		if (!func_180(44))
			return false;
...
void func_134(int iParam0, int iParam1) // Position - 0x539B
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_135(int iParam0, int iParam1) // Position - 0x53AC
{
	int num;
...
void func_136(var uParam0, var uParam1, int iParam2) // Position - 0x53C2
{
...
void func_137(int iParam0) // Position - 0x53DF
{
...
void func_138(int iParam0) // Position - 0x54BF
{
	int i;
	int num;
...
BOOL func_139(int iParam0, BOOL bParam1) // Position - 0x5697
{
	if (func_45() != -1)
		return false;
...
int func_140(int iParam0, BOOL bParam1) // Position - 0x56C5
{
	if (!func_92(iParam0))
		return 0;
...
int func_141(int iParam0) // Position - 0x5748
{
	switch (iParam0)
	{
		case 27:
...
int func_142(int iParam0) // Position - 0x576F
{
	switch (iParam0)
	{
		case 33:
...
Hash func_145(int iParam0) // Position - 0x59D2
{
	if (!func_92(iParam0))
		return 0;
...
void func_146(int iParam0, PersChar pchParam1) // Position - 0x59F0
{
	if (!func_92(iParam0))
		return;
...
void func_147(int iParam0, BOOL bParam1) // Position - 0x5A11
{
	if (func_45() != -1)
		return;
...
BOOL func_148(int iParam0) // Position - 0x5A4A
{
	if (!func_92(iParam0))
		return false;
...
BOOL func_149(var uParam0, var uParam1) // Position - 0x5A70
{
	return func_196(uParam0, 5, 8);
}

BOOL func_150(int iParam0) // Position - 0x5A83
{
	return func_197(1, iParam0);
}

int func_151(int iParam0) // Position - 0x5A92
{
	if (iParam0 == 255)
...
int func_152(int iParam0) // Position - 0x5ADD
{
...
void func_153(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x5AFA
{
	func_199(iParam0);
...
int func_154(int iParam0) // Position - 0x5B5C
{
...
void func_155(var uParam0) // Position - 0x5B79
{
	var unk;
...
void func_156(float* pfParam0) // Position - 0x5B8B
{
	var unk;
...
void func_158(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x5BF3
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_159(int iParam0) // Position - 0x5C20
{
...
BOOL func_160(int iParam0, int iParam1) // Position - 0x5C7D
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_161(int iParam0, int iParam1) // Position - 0x5C96
{
	func_160(iParam0, iParam1);
...
int func_162(int iParam0) // Position - 0x5CD1
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_163(Hash hParam0) // Position - 0x5CE5
{
...
void func_164(int iParam0) // Position - 0x5D05
{
	return;
}

void func_165(int iParam0) // Position - 0x5D0D
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_166(int iParam0, int iParam1) // Position - 0x5D22
{
	if (iParam0 == -1)
		return false;
...
void func_167(int iParam0) // Position - 0x5D49
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_168(int iParam0) // Position - 0x5DC8
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_169(int iParam0) // Position - 0x5DDE
{
	var unk;
...
BOOL func_170(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x5E0F
{
	int num;
...
int func_171(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5E97
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

Ped func_172(int iParam0) // Position - 0x5EB1
{
	PersChar persChar;
...
BOOL func_173() // Position - 0x5EDF
{
	return false;
}

BOOL func_174() // Position - 0x5EE8
{
	var unk;
	var unk3;
...
BOOL func_175(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5F50
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_176(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x60C6
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_177(var uParam0, var uParam1, var uParam2) // Position - 0x60DA
{
	int i;
...
const char* func_178(int iParam0) // Position - 0x6108
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_179(int iParam0) // Position - 0x63EC
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_180(int iParam0) // Position - 0x6416
{
	if (!func_217(iParam0))
		return false;
...
struct<2> func_181(Player plParam0) // Position - 0x6432
{
	var gamerHandle;
...
const char* func_182(const char* sParam0, int iParam1) // Position - 0x6446
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_183(int iParam0, BOOL bParam1) // Position - 0x6460
{
	char* StringToTest;
...
void func_184(int iParam0, BOOL bParam1) // Position - 0x6494
{
	switch (iParam0)
	{
		case 5:
...
void func_185(int iParam0, int iParam1) // Position - 0x64C9
{
	func_219(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_186(int iParam0) // Position - 0x64E3
{
	if (!func_92(iParam0))
		return false;
...
void func_187(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6508
{
	PersChar persChar;
...
void func_188(int iParam0, BOOL bParam1) // Position - 0x65F4
{
	if (!func_168(iParam0))
		return;
...
void func_189(int iParam0, int iParam1) // Position - 0x664A
{
	if (!func_112(iParam0))
		return;
...
int func_190(int iParam0) // Position - 0x66BD
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_191(int iParam0) // Position - 0x66D3
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_192(int iParam0, BOOL bParam1) // Position - 0x66E9
{
	if (func_45() != -1)
		return;
...
void func_193(int iParam0) // Position - 0x671A
{
	Ped EntityIndex;
...
void func_194(int iParam0) // Position - 0x675E
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_195(int iParam0) // Position - 0x6773
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_196(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x6788
{
	int num;
...
BOOL func_197(int iParam0, int iParam1) // Position - 0x67C3
{
	int num;
...
BOOL func_198(Any* panParam0, int iParam1, int iParam2) // Position - 0x6837
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_204(BOOL bParam0) // Position - 0x6906
{
	if (func_229(bParam0))
		return;
...
BOOL func_205(Any* panParam0, int iParam1, int iParam2) // Position - 0x692D
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_206(Hash hParam0) // Position - 0x6960
{
	if (func_230(hParam0))
...
BOOL func_207() // Position - 0x697B
{
	return 1;
}

BOOL func_208(BOOL bParam0, BOOL bParam1) // Position - 0x6984
{
	return bParam0 && bParam1 != false;
}

int func_209(int iParam0) // Position - 0x6993
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_210(int iParam0, int iParam1, var uParam2) // Position - 0x737B
{
	var unk;
...
int func_211() // Position - 0x73A2
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_212() // Position - 0x73B7
{
	if (Global_1048576)
		return true;
	...
	if (!func_214(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_213() // Position - 0x740F
{
	return Global_1051268;
}

BOOL func_214(var uParam0, var uParam1) // Position - 0x741D
{
	if (!func_233(uParam0))
		return false;
...
struct<2> func_215() // Position - 0x7451
{
...
BOOL func_216(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x749C
{
	var unk;
	float num;
	float num2;
...
BOOL func_217(int iParam0) // Position - 0x74CC
{
	if (iParam0 == 0)
		return false;
...
BOOL func_218(int iParam0) // Position - 0x74DF
{
	int num;
	int num2;
	int offset;
...
void func_219(var uParam0, int iParam1) // Position - 0x7509
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_220(int iParam0) // Position - 0x751E
{
	if (!func_92(iParam0))
		return false;
...
BOOL func_221(Hash hParam0) // Position - 0x7542
{
	return hParam0 != 0;
}

BOOL func_222(int iParam0, BOOL bParam1) // Position - 0x754E
{
	if (!func_168(iParam0))
		return false;
...
void func_223(int iParam0, BOOL bParam1) // Position - 0x7574
{
	if (!func_168(iParam0))
		return;
...
void func_224(int iParam0, BOOL bParam1) // Position - 0x75A2
{
	if (!func_168(iParam0))
		return;
...
void func_225(int iParam0) // Position - 0x75DC
{
	func_238(func_237(iParam0));
	return;
}

int func_226(int iParam0, var uParam1) // Position - 0x75EE
{
	if (iParam0 == 2)
...
BOOL func_227(Any* panParam0, int iParam1, int iParam2) // Position - 0x7608
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_228() // Position - 0x763F
{
	return Global_1102813.f_3672;
}

BOOL func_229(BOOL bParam0) // Position - 0x764E
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_230(Hash hParam0) // Position - 0x7664
{
	return hParam0 != 0;
}

BOOL func_231(int iParam0, int iParam1, Any* panParam2) // Position - 0x7670
{
...
void func_232(Any* panParam0, int iParam1, var uParam2) // Position - 0x76A4
{
	var unk;
...
BOOL func_233(int iParam0) // Position - 0x771E
{
	switch (iParam0)
	{
		case 2:
...
int func_234(int iParam0) // Position - 0x775D
{
	switch (iParam0)
	{
		case 2:
...
void func_235(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x77F3
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_236(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x8291
{
	float num;
	float num2;
	float num3;
...
int func_237(int iParam0) // Position - 0x82F7
{
...
void func_238(int iParam0) // Position - 0x8814
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_239(var uParam0, var uParam1) // Position - 0x8825
{
	var unk;
...
int func_240(int iParam0) // Position - 0x8851
{
	int num;
...
BOOL func_241(int iParam0, var uParam1, Any* panParam2) // Position - 0x89C6
{
	if (!func_214(iParam0))
		return false;
...
void func_242(Any* panParam0) // Position - 0x8AD1
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
