...
void func_2(var uParam0) // Position - 0x1F0
{
	return;
}

BOOL func_3(var uParam0) // Position - 0x1F8
{
	if (func_6(true, true))
		return true;
...
BOOL func_4(var uParam0) // Position - 0x2AE
{
	func_20(uParam0);
...
void func_5(var uParam0) // Position - 0x414
{
	Any any;
	Any any2;
	int i;
...
BOOL func_6(BOOL bParam0, BOOL bParam1) // Position - 0x5D7
{
	int i;
...
struct<2> func_7() // Position - 0x6B7
{
	var unk;
...
BOOL func_8(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x6D0
{
...
void func_9(int iParam0, BOOL bParam1) // Position - 0x7F9
{
	int num;
	int num2;
...
BOOL func_10(var uParam0) // Position - 0x826
{
	return false;
}

struct<2> func_11() // Position - 0x82F
{
...
BOOL func_12(var uParam0, var uParam1) // Position - 0x87A
{
	if (!func_56(uParam0))
		return false;
...
BOOL func_14(var uParam0) // Position - 0x906
{
	switch (func_58())
	{
		case 1:
...
void func_15(int iParam0) // Position - 0x94D
{
	Global_1292128.f_11 = iParam0;
	return;
}

int func_16() // Position - 0x95D
{
	return Global_1572887.f_196;
}

int _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x96B
{
	return uParam0->f_1;
}

int func_18() // Position - 0x977
{
	return Global_1915656.f_20241;
}

struct<2> func_19(int iParam0) // Position - 0x986
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

void func_20(var uParam0) // Position - 0x99A
{
	if (uParam0->f_328 >= 3)
	{
		uParam0->f_328 = 0;
...
void func_21(var uParam0) // Position - 0x9C0
{
	func_59(uParam0);
	return;
}

BOOL func_22(var uParam0) // Position - 0x9CE
{
	return MISC::IS_BIT_SET(uParam0->f_4, *uParam0);
}

void func_23(var uParam0) // Position - 0x9E1
{
	func_60(&(uParam0->f_1));
...
void func_24(var uParam0) // Position - 0xA22
{
	if (*uParam0 == 5 || *uParam0 == 8)
		func_63(uParam0);
...
BOOL func_25(var uParam0) // Position - 0xA58
{
	return MISC::IS_BIT_SET(uParam0->f_5, *uParam0);
}

void func_26(var uParam0) // Position - 0xA6B
{
	func_66(&(uParam0->f_1));
	return;
}

void func_27(var uParam0) // Position - 0xA7B
{
	func_60(&(uParam0->f_1));
	return;
}

void func_28(var uParam0) // Position - 0xA8B
{
	func_67(uParam0);
	func_68(uParam0);
...
void func_29(var uParam0) // Position - 0xAF5
{
	func_66(&(uParam0->f_1));
	return;
}

void func_30(var uParam0) // Position - 0xB05
{
	Hash hash;
...
void func_31(var uParam0) // Position - 0xB47
{
...
void func_32(var uParam0) // Position - 0xC30
{
	var unk;
...
void func_33(var uParam0) // Position - 0xCDC
{
	func_60(&(uParam0->f_1));
	func_95(uParam0);
	return;
...
void func_34(var uParam0) // Position - 0xCF2
{
	func_87(false, false, true);
	func_96();
...
void func_35(var uParam0) // Position - 0xD18
{
	func_66(&(uParam0->f_1));
	func_98(uParam0);
...
void func_36(var uParam0) // Position - 0xD38
{
	func_60(&(uParam0->f_1));
	return;
}

void func_37(var uParam0) // Position - 0xD48
{
	var entityName;
	var unk3;
...
void func_38(var uParam0) // Position - 0xE24
{
	func_66(&(uParam0->f_1));
	return;
}

void func_39(var uParam0) // Position - 0xE34
{
	func_60(&(uParam0->f_1));
	func_62(*uParam0);
...
void func_40(var uParam0) // Position - 0xE89
{
	BOOL flag;
...
void func_41(var uParam0) // Position - 0xEF7
{
	func_66(&(uParam0->f_1));
	return;
}

BOOL func_42(var uParam0) // Position - 0xF07
{
	if (!func_107(uParam0))
		return false;
...
void func_43(var uParam0, BOOL bParam1) // Position - 0xF45
{
	if (bParam1)
	{
		func_111(1);
...
BOOL func_44(int iParam0, var uParam1) // Position - 0x10CA
{
	*uParam1 = 0;
...
BOOL func_45(int iParam0, var uParam1) // Position - 0x1139
{
	*uParam1 = 0;
...
Hash func_46(int iParam0) // Position - 0x1160
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_47(var uParam0) // Position - 0x11EF
{
	return uParam0->f_296 != 0;
}

void func_48(var uParam0) // Position - 0x11FE
{
	if (uParam0->f_296 == 0)
		return;
...
void func_49() // Position - 0x1221
{
	func_125(false);
	return;
}

BOOL func_50(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x122E
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

BOOL func_51(int iParam0) // Position - 0x1249
{
...
BOOL func_52(BOOL bParam0, int iParam1) // Position - 0x126A
{
...
void func_53(int iParam0, var uParam1, var uParam2) // Position - 0x12A6
{
	int num;
...
BOOL func_54(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x12C2
{
...
void func_55(int iParam0, int iParam1) // Position - 0x1364
{
	int Variable;
...
BOOL func_56(int iParam0) // Position - 0x1388
{
	switch (iParam0)
	{
		case 2:
...
int func_57(int iParam0) // Position - 0x13C7
{
	switch (iParam0)
	{
		case 2:
...
int func_58() // Position - 0x145D
{
	Player Plr;

	Plr = PLAYER::INT_TO_PLAYERINDEX(Global_1295666.f_11);
...
void func_59(var uParam0) // Position - 0x1491
{
	int num;
...
void func_60(var uParam0) // Position - 0x14FD
{
	MISC::SET_BIT(&(uParam0->f_4), *uParam0);
	return;
}

int func_61(var uParam0, int iParam1) // Position - 0x1510
{
	switch (iParam1)
	{
		case 1:
...
void func_62(int iParam0) // Position - 0x2256
{
	if (!func_136(iParam0))
		return;
...
int func_63(var uParam0) // Position - 0x229A
{
	var unk;
	var unk4;
	int i;
...
void func_64(var uParam0) // Position - 0x2347
{
	switch (*uParam0)
	{
		case 4:
...
BOOL func_65(var uParam0) // Position - 0x24B8
{
...
void func_66(var uParam0) // Position - 0x2544
{
	MISC::SET_BIT(&(uParam0->f_5), *uParam0);
	return;
}

void func_67(var uParam0) // Position - 0x2557
{
	BOOL flag;
	int i;
...
void func_68(var uParam0) // Position - 0x25EE
{
	var unk;
	char* str;
	char* str2;
...
BOOL func_69(var uParam0) // Position - 0x2727
{
	int num;
...
void func_70(BOOL bParam0) // Position - 0x284B
{
	if (func_164(bParam0))
...
BOOL func_71(var uParam0) // Position - 0x2865
{
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_72(var uParam0) // Position - 0x2935
{
	int i;
	int j;
	int k;
	...
	switch (func_169(uParam0))
	{
		...
		case 3:
			for (i = 0; i < 2; i = i + 1)
			{
				...
				{
					Plr = PLAYER::INT_TO_PLAYERINDEX(Global_1295666);
				
					if (SCRIPTS::_IS_PLAYER_BIT_SET_AT_INDEX(&uParam0->f_241[i /*27*/], j))
					{
						if (func_174(uParam0, Plr, i, 0))
						{
						...
						else
						{
							...
							else
							{
								...
								else
								{
									for (m = 0; m < 7; m = m + 1)
									{
										if (Global_1056554[Global_1295666.f_11 /*491*/].f_42.f_1[*uParam0 /*16*/].f_3[m] == Plr)
											num2 = m;
									}
								}
								...
								if (num2 != -1)
								{
									if (func_174(uParam0, Plr, i, num2))
									{
										SCRIPTS::_CLEAR_PLAYER_BIT_AT_INDEX(&uParam0->f_241[i /*27*/], j);
										break;
									}
...
BOOL func_73(var uParam0) // Position - 0x3038
{
	var unk;
...
void func_74(int iParam0) // Position - 0x30BB
{
	if (!func_136(iParam0))
		return;
...
void func_75(var uParam0, int iParam1) // Position - 0x3113
{
	return;
}

void func_76(var uParam0, Hash hParam1, int* piParam2) // Position - 0x311B
{
	Hash hash;
	int num;
	Hash hash2;
...
// Unhandled jump detected. Output should be considered invalid
void func_77(var uParam0) // Position - 0x3234
{
	int i;
	BOOL flag;
...
void func_78(var uParam0) // Position - 0x3302
{
	var unk;
...
void func_79(int iParam0) // Position - 0x333A
{
	func_196(true);
	return;
}

void func_80(var uParam0) // Position - 0x3347
{
	int i;
...
void func_81(var uParam0) // Position - 0x33D4
{
	int i;
...
void func_82(var uParam0, int* piParam1) // Position - 0x342D
{
	Any any;
	var unk;
	var unk5;
...
void func_83(var uParam0) // Position - 0x350E
{
	func_204(uParam0);
	func_205(uParam0);
	func_86(uParam0);
...
void func_84(var uParam0) // Position - 0x3533
{
	float ReturnStartPhase;
	var ReturnEndPhase;
	...
	switch (*uParam0)
	{
		case 9:
			...
			ENTITY::FIND_ANIM_EVENT_PHASE("cutscene", "LAW_INT", "WINDOW", &ReturnStartPhase, &ReturnEndPhase);
		
			if (ReturnStartPhase <= ANIMSCENE::GET_ANIM_SCENE_PHASE(uParam0->f_8[0 /*40*/]))
			{
...
void func_85(var uParam0) // Position - 0x35C7
{
...
void func_86(var uParam0) // Position - 0x35FF
{
	Entity EntityIndex;
...
void func_87(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3659
{
	Player Plr;
	Ped playerPed;
	int i;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_88(var uParam0) // Position - 0x372C
{
	int i;
...
BOOL func_89(var uParam0) // Position - 0x386B
{
	BOOL flag;
	int i;
	int num;
...
BOOL func_90(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3BAB
{
	var unk;
	int num;
	var unk4;
...
void func_91(var uParam0) // Position - 0x465D
{
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
	*uParam0 = 0;
...
BOOL func_92(int iParam0) // Position - 0x4673
{
	if (iParam0 < 0)
		return false;
...
void func_93(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x46B2
{
	int num;
...
void func_94(var uParam0, BOOL bParam1) // Position - 0x4706
{
	if (!bParam1)
...
void func_95(var uParam0) // Position - 0x4725
{
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_97(var uParam0) // Position - 0x475C
{
	Vector3 vector;
	int i;
	int num;
...
void func_98(var uParam0) // Position - 0x4B04
{
	uParam0->f_329 = -1;
	return;
}

Vector3 func_99(int iParam0, int iParam1, BOOL bParam2) // Position - 0x4B12
{
	var unk;
...
void func_100(BOOL bParam0) // Position - 0x4CC8
{
	if (bParam0)
...
BOOL func_101(int iParam0) // Position - 0x4CFD
{
	Hash unlockHash;
	int num;
	BOOL flag;
...
BOOL func_102(var uParam0) // Position - 0x4E0F
{
	int i;
	BOOL num;
	Interior interiorAtCoords;
...
void func_103(int iParam0, int iParam1) // Position - 0x4E9C
{
	if (!func_136(iParam0))
		return;
...
void func_104(int iParam0, int iParam1) // Position - 0x4ED9
{
	if (!func_136(iParam0))
		return;
...
void func_106(var uParam0) // Position - 0x4F47
{
	func_203(64);
...
BOOL func_107(var uParam0) // Position - 0x4FD9
{
	int i;
	int num;
...
BOOL func_108(var uParam0) // Position - 0x5020
{
	int i;
...
void func_109(var uParam0) // Position - 0x506C
{
	int i;
	int j;
...
void func_110(var uParam0) // Position - 0x50D7
{
	int i;
	...
	for (i = 0; i < 6; i = i + 1)
	{
		if (uParam0->f_150[i /*13*/].f_8)
		{
			...
			ENTITY::REMOVE_MODEL_HIDE(offsetFromCoordAndHeadingInWorldCoords, 1f, uParam0->f_150[i /*13*/].f_1, false);
		}
	}
...
void func_111(BOOL bParam0) // Position - 0x5163
{
	Global_1048585 = bParam0;
	return;
}

int func_112() // Position - 0x5171
{
...
BOOL func_113() // Position - 0x51A3
{
	return Global_1896762.f_352;
}

void func_114() // Position - 0x51B2
{
...
BOOL func_115() // Position - 0x51CC
{
	return func_244() || func_245();
}

void func_116(BOOL bParam0) // Position - 0x51E2
{
	if (bParam0)
...
void func_119(Ped pedParam0) // Position - 0x530C
{
	int i;
...
BOOL func_120(Ped pedParam0) // Position - 0x5342
{
...
Ped func_121(Ped pedParam0) // Position - 0x535D
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
void func_122(BOOL bParam0) // Position - 0x5379
{
	var unk;
...
void func_123(BOOL bParam0, int iParam1) // Position - 0x53AF
{
	int num;
	BOOL flag;
	BOOL flag2;
...
void func_125(BOOL bParam0) // Position - 0x543E
{
	if (bParam0)
...
BOOL func_126(int iParam0, int iParam1) // Position - 0x5475
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_127(int iParam0) // Position - 0x548D
{
...
BOOL func_128(int iParam0) // Position - 0x54A4
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_129(int iParam0, int iParam1) // Position - 0x5570
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_130(int iParam0) // Position - 0x5589
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_131() // Position - 0x559C
{
	if (!func_211())
		return false;
...
BOOL func_132(Player plParam0) // Position - 0x55B7
{
	int num;
...
Vector3 func_135(Player plParam0) // Position - 0x56A1
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

BOOL func_136(int iParam0) // Position - 0x56B5
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x56D4
{
...
BOOL func_138(int iParam0, var uParam1, var uParam2, int iParam3) // Position - 0x56FE
{
	float num;
...
BOOL func_139(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x590F
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

Vector3 func_140(Player plParam0) // Position - 0x5938
{
	if (plParam0 == 255)
...
int func_141(var uParam0) // Position - 0x5964
{
	return uParam0->f_1.f_2;
}

void func_142(var uParam0, int iParam1) // Position - 0x5972
{
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_143(var uParam0) // Position - 0x5982
{
	int i;
	BOOL flag;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_144(var uParam0) // Position - 0x5DA9
{
	int i;
	BOOL num;
	int num2;
...
void func_145(var uParam0) // Position - 0x6058
{
	int value;
	var name;
...
int func_146(var uParam0) // Position - 0x6081
{
	return uParam0->f_296.f_1;
}

int func_147(var uParam0) // Position - 0x6090
{
	return uParam0->f_296.f_2;
}

void func_148(var uParam0, int iParam1) // Position - 0x609F
{
...
void func_149(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, char* sParam20, char* sParam21) // Position - 0x60BC
{
	func_48(uParam0);
...
void func_151(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x6128
{
	if (bParam2)
	{
		func_266(72);
...
void func_152(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0x6158
{
	var entityCoords;
	float num;
...
int func_153(int iParam0) // Position - 0x61B3
{
	if (iParam0 == 255)
...
void func_154(var uParam0, int iParam1) // Position - 0x61FA
{
...
BOOL func_155(int iParam0) // Position - 0x6217
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_156(int iParam0) // Position - 0x6282
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_157(var uParam0) // Position - 0x62ED
{
	Vector3 vector;
	BOOL flag;
	float volumeScale;
...
BOOL func_159(int iParam0) // Position - 0x6422
{
	if (!func_136(iParam0))
		return false;
...
int func_160(int iParam0, Player plParam1) // Position - 0x6444
{
	if (iParam0 <= 0 || iParam0 >= 10)
		return -1;
...
BOOL func_161(int iParam0) // Position - 0x6481
{
	int num;
...
void func_162(var uParam0, int iParam1) // Position - 0x64FC
{
	if (func_153(255) == 1)
	{
...
BOOL func_164(BOOL bParam0) // Position - 0x6597
{
	if (bParam0)
...
void func_165(int iParam0, BOOL bParam1) // Position - 0x65C7
{
	if (!func_276(iParam0))
		return;
...
BOOL func_166() // Position - 0x6631
{
	return Global_1292128.f_13;
}

BOOL func_167(int iParam0) // Position - 0x663F
{
	if (iParam0 == 255)
...
BOOL func_168(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6677
{
	var data;
	int i;
	Hash crimeType;
...
int func_169(var uParam0) // Position - 0x67AC
{
	return uParam0->f_1.f_3;
}

// Unhandled jump detected. Output should be considered invalid
void func_170(var uParam0) // Position - 0x67BA
{
	var value;
	int i;
	int num;
...
void func_171(var uParam0, int iParam1) // Position - 0x69A1
{
	uParam0->f_1.f_3 = iParam1;
	return;
}

BOOL func_172(var uParam0, int iParam1) // Position - 0x69B1
{
...
var func_173(int iParam0, int iParam1) // Position - 0x69DD
{
	var unk;
...
BOOL func_174(var uParam0, Player plParam1, int iParam2, int iParam3) // Position - 0x6A78
{
	Ped playerPed;
	Ped EntityIndex;
	var unk;
	...
	EntityIndex = PED::CLONE_PED(playerPed, false, false, true);
	...
	ENTITY::SET_ENTITY_VISIBLE(EntityIndex, false);
	func_283(playerPed, EntityIndex);
	ENTITY::SET_ENTITY_COORDS(EntityIndex, uParam0->f_320, true, false, true, true);
	ENTITY::FREEZE_ENTITY_POSITION(EntityIndex, true);
	PED::_0x7E8F9949B7AABBF0(EntityIndex, 1, 1);
	WEAPON::_HIDE_PED_WEAPONS(EntityIndex, 2, true);
	AUDIO::DISABLE_PED_PAIN_AUDIO(EntityIndex, true);

	if (MISC::IS_BIT_SET(uParam0->f_327, 17))
	{
		WEAPON::_SET_PED_WEAPON_ATTACH_POINT_VISIBILITY(EntityIndex, 16, false);
		WEAPON::_SET_PED_WEAPON_ATTACH_POINT_VISIBILITY(EntityIndex, 9, false);
		WEAPON::_SET_PED_WEAPON_ATTACH_POINT_VISIBILITY(EntityIndex, 18, false);
		WEAPON::_SET_PED_WEAPON_ATTACH_POINT_VISIBILITY(EntityIndex, 10, false);
		WEAPON::_SET_PED_WEAPON_ATTACH_POINT_VISIBILITY(EntityIndex, 7, false);
	}

	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(EntityIndex, true);
	unk = { func_99(*uParam0, iParam3, PED::IS_PED_MALE(EntityIndex)) };
	uParam0->f_241[iParam2 /*27*/].f_1[iParam3 /*6*/] = EntityIndex;
	uParam0->f_241[iParam2 /*27*/].f_1[iParam3 /*6*/].f_2.f_1 = { unk };
	uParam0->f_241[iParam2 /*27*/].f_1[iParam3 /*6*/].f_2 = uParam0->f_8[iParam2 /*40*/];
	return true;
}

BOOL func_175(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x6BA6
{
	if (iParam1 >= 2 || iParam1 < 0)
		return false;
...
BOOL func_176(var uParam0, int iParam1, int iParam2) // Position - 0x6C22
{
	if (iParam1 >= 2 || iParam1 < 0)
		return false;
...
BOOL func_177(var uParam0, int iParam1) // Position - 0x6C66
{
	Vector3 offsetFromCoordAndHeadingInWorldCoords;
...
void func_178(var uParam0, int iParam1) // Position - 0x6D2C
{
	func_284(uParam0, iParam1);
	return;
}

BOOL func_179(Ped pedParam0, var uParam1, int iParam2, eSetPlayerControlFlags espcfParam3, int iParam4, float fParam5, int iParam6, int iParam7, int iParam8) // Position - 0x6D3C
{
	int Sequence;
	...
	else if (isPedInAnyVehicle)
	{
		if (!func_289(iParam2, 1))
		{
			...
			TASK::TASK_PERFORM_SEQUENCE(pedParam0, Sequence);
...
Hash func_180(Hash hParam0, Hash hParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x7311
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_181(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x744D
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_182(Hash hParam0) // Position - 0x755E
{
...
int func_183(Hash hParam0, BOOL bParam1) // Position - 0x7579
{
	var unk;
...
Hash func_184(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x75D1
{
	var unk;
	int num;
	int i;
...
Hash func_185(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x763C
{
	var unk;
	int num;
	int i;
...
int func_186(Hash hParam0) // Position - 0x76A6
{
	int num;
	var unk;
	var unk6;
...
BOOL func_187(int* piParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x7708
{
	var unk;
	var unk18;
	int num;
...
int func_188(Hash hParam0) // Position - 0x7803
{
	return func_328(hParam0);
}

void func_189(Hash hParam0) // Position - 0x7811
{
	UNLOCK::_UNLOCK_SET_NEW(func_329(hParam0), false);
	return;
}

void func_190(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x7824
{
	int i;
...
void func_191(var uParam0, int iParam1) // Position - 0x78A2
{
	int num;
	int num2;
...
Vector3 func_193(var uParam0) // Position - 0x796F
{
	int num;
...
BOOL func_194(var uParam0, var uParam1, var uParam2) // Position - 0x7991
{
	int i;
...
void func_195(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x79E8
{
	int i;
...
void func_196(BOOL bParam0) // Position - 0x7A57
{
	UIFEED::UI_FEED_CLEAR_CHANNEL(1, bParam0, false);
	return;
}

void func_197(var uParam0, int iParam1) // Position - 0x7A67
{
	float animSceneTime;
	Hash hash;
	Hash hash2;
...
void func_198(var uParam0, int iParam1) // Position - 0x7C8A
{
	Hash hash;
	Hash hash2;
	BOOL flag;
...
void func_199(var uParam0) // Position - 0x8134
{
...
int func_200(int* piParam0) // Position - 0x818F
{
	return func_352(piParam0->f_1);
}

BOOL func_201(Any* panParam0, Any* panParam1) // Position - 0x819F
{
...
int func_202(int iParam0, var uParam1) // Position - 0x81B7
{
	int i;
...
void func_203(int iParam0) // Position - 0x820A
{
	func_353(iParam0);
	return;
}

void func_204(var uParam0) // Position - 0x8218
{
	int i;
	int j;
...
int func_205(var uParam0) // Position - 0x8270
{
	int i;
	int num;
...
const char* func_206(var uParam0, var uParam1, var uParam2) // Position - 0x82B8
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

void func_207(var uParam0) // Position - 0x82CC
{
...
BOOL func_208(int iParam0, var uParam1) // Position - 0x8390
{
	if (!func_276(iParam0))
		return false;
...
void func_209(int iParam0, BOOL bParam1) // Position - 0x8434
{
	if (bParam1)
...
void func_210(float fParam0) // Position - 0x845A
{
	Ped EntityIndex;
...
void func_212(int iParam0) // Position - 0x84AD
{
	if (iParam0 <= 0)
		return;
...
BOOL func_213(var uParam0, int iParam1) // Position - 0x84D4
{
	if (6 == *uParam0)
...
void func_214(var uParam0) // Position - 0x84FC
{
	Entity EntityIndex;
...
BOOL func_215(var uParam0) // Position - 0x8557
{
	return func_357(*uParam0, 1);
}

void func_216(var uParam0, BOOL bParam1) // Position - 0x8567
{
...
int func_217(var uParam0) // Position - 0x8587
{
	if (!func_215(uParam0))
		return 0;
...
int func_218(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, int iParam10, Hash hParam11, int iParam12) // Position - 0x85B8
{
	int i;
	int num;
...
void func_219(int iParam0, int iParam1, BOOL bParam2) // Position - 0x863E
{
	int num;
...
void func_220(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8687
{
	int num;
...
void func_221(int iParam0, char* sParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x86D2
{
	int num;
...
void func_222(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8724
{
	int num;
...
BOOL func_223(int iParam0, BOOL bParam1) // Position - 0x8778
{
	int num;
	int gameTimer;
	float progress;
...
BOOL func_224(int iParam0, var uParam1) // Position - 0x8872
{
	int num;
	var unk5;
	float num2;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		unk5 = { func_257() };
		num2 = 0f;
		TEXT_LABEL_ASSIGN_STRING(&InputString, "vPlayerPos", 24);
		TEXT_LABEL_APPEND_INT(&InputString, i + 1, 24);
		num.f_2 = 491979052;
		num.f_3 = MISC::GET_HASH_KEY(&InputString);
		DATAFILE::_PARSEDDATA_RQ_FILLOUT_VECTOR(&unk5, &num);
		TEXT_LABEL_ASSIGN_STRING(&InputString, "fPlayerHead", 24);
		TEXT_LABEL_APPEND_INT(&InputString, i + 1, 24);
		num.f_2 = -1023214806;
		num.f_3 = MISC::GET_HASH_KEY(&InputString);
		...
		unk5 = { func_257() };
		num2 = 0f;
		TEXT_LABEL_ASSIGN_STRING(&InputString, "vHorsePos", 24);
		TEXT_LABEL_APPEND_INT(&InputString, i + 1, 24);
		num.f_2 = 491979052;
		num.f_3 = MISC::GET_HASH_KEY(&InputString);
		DATAFILE::_PARSEDDATA_RQ_FILLOUT_VECTOR(&unk5, &num);
		TEXT_LABEL_ASSIGN_STRING(&InputString, "fHorseHead", 24);
		TEXT_LABEL_APPEND_INT(&InputString, i + 1, 24);
		num.f_2 = -1023214806;
		num.f_3 = MISC::GET_HASH_KEY(&InputString);
		DATAFILE::_PARSEDDATA_RQ_FILLOUT_FLOAT(&num2, &num);
...
int func_225(int iParam0) // Position - 0x89B5
{
	return iParam0;
}

void func_226(int iParam0) // Position - 0x89BF
{
	if (!func_368(iParam0))
		return;
...
void func_227(BOOL bParam0, BOOL bParam1) // Position - 0x8A72
{
	if (bParam0)
	{
		func_266(66);
...
BOOL func_228(int iParam0) // Position - 0x8AAA
{
	int num;
	int i;
...
int func_229(int iParam0, int iParam1) // Position - 0x8B0D
{
	switch (iParam1)
	{
		case 1:
...
int func_230(int iParam0) // Position - 0x8DAF
{
	if (iParam0 <= 0 || iParam0 >= 10)
		return -1;
...
BOOL func_231(int iParam0) // Position - 0x8DD5
{
...
int func_232(int iParam0, BOOL bParam1) // Position - 0x8DF7
{
	int i;
...
int func_233(int iParam0, int iParam1) // Position - 0x8EB2
{
	int num;
...
void func_234(int iParam0, int iParam1) // Position - 0x8F16
{
	if (!func_136(iParam0))
		return;
...
void func_235(int iParam0) // Position - 0x8F35
{
...
void func_236() // Position - 0x9005
{
	Global_1960746 = false;
	return;
}

BOOL func_237(Hash hParam0) // Position - 0x9012
{
	if (hParam0 == 0)
		return false;
...
Blip func_238(int iParam0) // Position - 0x902F
{
	return Global_1110244.f_268.f_3380[iParam0];
}

int func_239(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x9045
{
	int num;
	var unk13;
	int num2;
...
void func_240(BOOL bParam0) // Position - 0x9080
{
...
int func_241(Player plParam0, BOOL bParam1) // Position - 0x90D3
{
	if (bParam1)
...
BOOL func_242(Hash hParam0, int iParam1) // Position - 0x90FA
{
	int num;
...
void func_243(Hash hParam0) // Position - 0x917D
{
...
BOOL func_244() // Position - 0x9195
{
	return Global_1940026 == 1;
}

BOOL func_245() // Position - 0x91A3
{
	return Global_1940026 == 2;
}

void func_246(float fParam0) // Position - 0x91B1
{
	return;
}

void func_247() // Position - 0x91B9
{
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_248(int iParam0) // Position - 0x91D0
{
	int num;
	int num2;
	int num3;
...
void func_249(int iParam0) // Position - 0x9460
{
	Player iPlayerIndex;
	Ped EntityIndex;
	BOOL flag;
...
void func_250(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x9512
{
	Player iPlayerIndex;
	Ped PedIndex;
...
int func_251(Player plParam0) // Position - 0x9634
{
	if (plParam0 == 255)
...
BOOL func_252(int iParam0, int iParam1) // Position - 0x966B
{
	return iParam0->f_3 && iParam1 != false;
}

int func_253(Player plParam0) // Position - 0x967C
{
	if (plParam0 < 0 || plParam0 >= 32)
		return 0;
...
int func_254(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x96A8
{
	switch (iParam2)
	{
		case -2146415538:
...
int func_255(int iParam0) // Position - 0x9F5E
{
	switch (iParam0)
	{
		case 113:
...
int func_256(int iParam0) // Position - 0xA0B1
{
	switch (iParam0)
	{
...
Vector3 func_257() // Position - 0xA13E
{
	return 0f, 0f, 0f;
}

int func_258(int iParam0, Vector3* pvParam1, var uParam2) // Position - 0xA149
{
	int num;
	float num2;
...
Object func_259(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4) // Position - 0xA1CB
{
	ItemSet itemSet;
...
int func_260() // Position - 0xA247
{
	return Global_1102813.f_3672;
}

void func_261(Entity eParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xA256
{
	Vector3 vector;
...
void func_262(var uParam0, int iParam1) // Position - 0xA29E
{
	var sName;
	int i;
	...
	TEXT_LABEL_ASSIGN_INT(&sName, uParam0->f_1, 64);

	if (!PED::ADD_RELATIONSHIP_GROUP(&sName, &(uParam0->f_10)))
		return;
...
BOOL func_264(int iParam0, var uParam1, var uParam2) // Position - 0xA37A
{
	switch (iParam0)
	{
		case 5:
...
int func_265(Any* panParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xA3F7
{
	int num;
	int num2;
...
int func_266(int iParam0) // Position - 0xA423
{
...
int func_267(int iParam0) // Position - 0xA440
{
...
BOOL func_268(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0xA45D
{
	Hash* p_hash;
	int MaxInt;
	int randomIntInRange;

	p_hash = Global_1072759.f_23824.f_383[func_396(uParam0) /*272*/];
	MaxInt = func_397(p_hash);
	...
	else
	{
		...
		if (func_398(p_hash, randomIntInRange, pvParam3, pfParam4))
			return true;
	}
...
void func_269(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13) // Position - 0xA4AE
{
	if (func_399(255) == 4)
		return;
...
BOOL func_270(var uParam0) // Position - 0xA683
{
	return uParam0->f_328 == 0;
}

Vector3 func_271(var uParam0) // Position - 0xA692
{
	switch (*uParam0)
	{
		case 3:
...
float func_272(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xA6E6
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_273(var uParam0) // Position - 0xA704
{
	switch (*uParam0)
	{
		case 3:
...
BOOL func_274(var uParam0) // Position - 0xA766
{
	Ped mount;
	Entity firstEntityPedIsCarrying;
...
void func_275(Player plParam0) // Position - 0xA7C5
{
	int data;
	var value;
	...
	SCRIPTS::TRIGGER_SCRIPT_EVENT(SCRIPT_EVENT_QUEUE_NETWORK, &data, 4, 16, &value);
	return;
}

BOOL func_276(int iParam0) // Position - 0xA7F6
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_277(int iParam0, int iParam1) // Position - 0xA80C
{
	if (!func_276(iParam0))
		return false;
...
void func_278(int iParam0, int iParam1) // Position - 0xA857
{
	if (!func_276(iParam0))
		return;
...
void func_279(int iParam0, int iParam1) // Position - 0xA8AF
{
	if (!func_276(iParam0))
		return;
...
BOOL func_280(int iParam0) // Position - 0xA922
{
	if (func_407())
...
BOOL func_281(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA942
{
...
float func_282(int iParam0, BOOL bParam1) // Position - 0xA9E0
{
	float num;
...
void func_283(Ped pedParam0, Ped pedParam1) // Position - 0xAA94
{
...
void func_284(var uParam0, int iParam1) // Position - 0xAAF7
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_285(int iParam0, int iParam1) // Position - 0xAB08
{
	return iParam0 && iParam1 != false;
}

BOOL func_286(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xAB17
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		if (!PED::IS_PED_INJURED(pedParam0))
...
BOOL func_287(Ped pedParam0) // Position - 0xAB70
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
BOOL func_288(Ped pedParam0, var uParam1, var uParam2, var uParam3) // Position - 0xAC1A
{
	var entityCoords;
	var unk3;
...
BOOL func_289(int iParam0, int iParam1) // Position - 0xAC4D
{
	return iParam0 && iParam1 != false;
}

BOOL func_290(Ped pedParam0, int iParam1) // Position - 0xAC5C
{
...
void func_291(var uParam0, int iParam1) // Position - 0xACDD
{
	func_410(uParam0, iParam1);
	return;
}

BOOL func_292(Hash hParam0, int iParam1) // Position - 0xACED
{
	if (hParam0 == 0)
		return false;
...
BOOL func_293(Hash hParam0, Hash hParam1) // Position - 0xAD07
{
	if (!func_292(hParam0, 0))
...
BOOL func_294(Hash hParam0) // Position - 0xAD48
{
...
Hash func_295(int iParam0, int iParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0xAD70
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_296(Hash hParam0, BOOL bParam1) // Position - 0xAE75
{
	return func_300(hParam0, 997808187) && !func_416(hParam0, 997808187, bParam1);
}

BOOL func_297(Hash hParam0) // Position - 0xAE9B
{
	int num;
...
BOOL func_298(Hash hParam0, var uParam1) // Position - 0xAED5
{
	*uParam1 = func_417(hParam0, true);
	return *uParam1 != 0;
}

BOOL func_299(Hash hParam0, var uParam1) // Position - 0xAEEC
{
	*uParam1 = func_418(hParam0, true, false);
	return *uParam1 != 0;
}

BOOL func_300(Hash hParam0, Hash hParam1) // Position - 0xAF04
{
	if (!func_292(hParam0, 0))
		return false;
...
BOOL func_301() // Position - 0xAF50
{
	return Global_1915656.f_22477;
}

BOOL func_302(int iParam0) // Position - 0xAF5F
{
...
BOOL func_303(Hash hParam0, BOOL bParam1) // Position - 0xAF9A
{
...
BOOL func_304(Hash hParam0, BOOL bParam1) // Position - 0xB013
{
	int num;
	var unk;
...
BOOL func_305(Hash hParam0, var uParam1) // Position - 0xB05D
{
	int num;
	var unk;
...
BOOL func_306(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0xB11A
{
	if (!func_413(iParam0))
		return false;
...
BOOL func_307(int iParam0, Hash hParam1) // Position - 0xB152
{
	var unk;
	int num;
	Hash unlockHash;
...
BOOL func_308(int iParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB29B
{
	var unk;
	int num;
	int i;
...
int func_309(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB3A2
{
	int num;
	BOOL flag;
	int num2;
...
BOOL func_310(int iParam0) // Position - 0xB608
{
	if (iParam0 < 0)
		return false;
...
BOOL func_311(int iParam0) // Position - 0xB62B
{
	if (iParam0 < 0)
		return false;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_312(Hash hParam0, int iParam1, Hash hParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xB658
{
	var unk;
	int num;
	int num2;
			...
			else
			{
				if (flag)
				{
					if (func_438(unk[i /*2*/]) || func_439(unk[i /*2*/]))
					{
						...
						if (bParam5)
							num6 = func_440(7, unk[i /*2*/], &EntityIndex);
...
Hash func_313(Hash hParam0) // Position - 0xB858
{
	return hParam0;
}

int func_314(Hash hParam0, BOOL bParam1) // Position - 0xB862
{
	int num;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_315(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xB89B
{
	int i;
...
BOOL func_316(Hash hParam0) // Position - 0xB92A
{
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_317(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xB958
{
	int i;
...
struct<5> func_318(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xB9E8
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_319(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xBD5C
{
	var outGuid;
...
BOOL func_320(Any* panParam0) // Position - 0xBD8D
{
...
BOOL func_321(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xBDC3
{
	if (!func_320(&uParam0))
		return false;
...
int func_322(var uParam0) // Position - 0xBDF2
{
...
BOOL func_323(int* piParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, int iParam5, Hash hParam6, int iParam7, BOOL bParam8) // Position - 0xBE7C
{
	var unk;
...
BOOL func_324(Hash hParam0) // Position - 0xBECF
{
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_325(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, Hash hParam8, int iParam9, BOOL bParam10) // Position - 0xBEE2
{
	BOOL flag;
	var unk;
	BOOL flag2;
...
BOOL func_326(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, int iParam7, var uParam8, BOOL bParam9, Hash hParam10, int iParam11, BOOL bParam12) // Position - 0xC2B2
{
	var unk;
	var unk18;
...
void func_327(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0xC391
{
	Hash item;
	Hash hash;
	Hash item2;
...
int func_328(Hash hParam0) // Position - 0xC418
{
	if (!func_316(hParam0))
		return 0;
...
Hash func_329(Hash hParam0) // Position - 0xC4AB
{
	return hParam0;
}

Hash func_330(int iParam0) // Position - 0xC4B5
{
	Hash hash;
...
void func_331(int iParam0, int iParam1) // Position - 0xC4EC
{
	int Variable;
...
void func_332(var uParam0, var uParam1) // Position - 0xC510
{
	int Variable;
...
void func_333(Hash hParam0) // Position - 0xC53B
{
	if (!STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		func_488(hParam0);
...
BOOL func_334() // Position - 0xC554
{
	return Global_1220720.f_26;
}

BOOL func_335(int iParam0, var uParam1, var uParam2) // Position - 0xC562
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_336(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xC5A1
{
	if (iParam0 != uParam3)
		return false;
...
BOOL func_337(var uParam0) // Position - 0xC5ED
{
	Hash hash;
...
int func_338(int iParam0, BOOL bParam1) // Position - 0xC617
{
	if (bParam1)
		func_489();
...
int func_339() // Position - 0xC653
{
	return Global_1940252.f_1556;
}

BOOL func_340(var uParam0) // Position - 0xC662
{
	switch (*uParam0)
	{
		case 239629152:
...
BOOL func_341(int iParam0, var uParam1, var uParam2) // Position - 0xC686
{
	switch (iParam0)
	{
		case 3:
...
// Unhandled jump detected. Output should be considered invalid
int func_342(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0xC6EF
{
	var unk;
	int num;
	int i;
...
int func_343(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0xC7DF
{
	var unk;
	int num;
	int i;
...
int func_344(int iParam0) // Position - 0xC87A
{
	return iParam0 / 100;
}

BOOL func_345(Hash hParam0) // Position - 0xC887
{
	return func_432(hParam0) || func_492(hParam0);
}

Hash func_346(Hash hParam0, BOOL bParam1) // Position - 0xC8A1
{
	Hash hash;
...
void func_347(int iParam0, char* sParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0xC8CF
{
	int num;
	const char* str;
...
void func_348(int iParam0, char* sParam1, Hash hParam2, Hash hParam3, var uParam4, BOOL bParam5) // Position - 0xC92B
{
	int num;
	const char* str;
	const char* str2;
...
void func_349(var uParam0) // Position - 0xC992
{
...
BOOL func_350(int* piParam0, int* piParam1, BOOL bParam2) // Position - 0xC9DF
{
	BOOL basketIsValid;
	BOOL basketIsValid2;
	BOOL flag;
...
BOOL func_351(int iParam0) // Position - 0xCBD3
{
	if (!func_136(iParam0))
		return false;
...
int func_352(int iParam0) // Position - 0xCBF5
{
	int num;
	int status;
...
void func_353(int iParam0) // Position - 0xCC7F
{
	Global_1110244.f_268.f_3384 = Global_1110244.f_268.f_3384 || iParam0;
	return;
}

int func_354() // Position - 0xCC9E
{
	return Global_1572887.f_14;
}

void func_355(int iParam0, BOOL bParam1) // Position - 0xCCAC
{
	if (!func_497(iParam0))
		return;
...
void func_356(int iParam0, BOOL bParam1) // Position - 0xCCDA
{
	if (!func_497(iParam0))
		return;
...
BOOL func_357(int iParam0, int iParam1) // Position - 0xCD14
{
	return iParam0 && iParam1 != false;
}

void func_358(var uParam0) // Position - 0xCD23
{
	func_498(uParam0, 0);
	return;
}

BOOL func_359(var uParam0) // Position - 0xCD32
{
	return func_357(*uParam0, 2);
}

int func_360(int iParam0) // Position - 0xCD42
{
	return NETWORK::GET_TIME_DIFFERENCE(iParam0, NETWORK::GET_NETWORK_TIME_ACCURATE());
}

BOOL func_361(int iParam0, int iParam1) // Position - 0xCD54
{
	if (iParam0 < 0)
		return false;
...
void func_363(int iParam0, int iParam1) // Position - 0xD08F
{
	if (iParam0 < 0)
		return;
...
void func_364(int iParam0, BOOL bParam1) // Position - 0xD0C2
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_365(int iParam0, BOOL bParam1) // Position - 0xD11A
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_366(int iParam0, int iParam1) // Position - 0xD143
{
	if (iParam0 < 0)
		return;
...
int func_367(int iParam0) // Position - 0xD16B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_368(int iParam0) // Position - 0xDB53
{
	return func_361(iParam0, 2);
}

int func_369(int iParam0, int iParam1) // Position - 0xDB62
{
	switch (iParam1)
	{
		case 0:
...
void func_370() // Position - 0xE1D2
{
	return;
}

int func_371() // Position - 0xE1DA
{
...
void func_373(int iParam0) // Position - 0xE2B6
{
	if (iParam0 != -1)
...
int func_374(BOOL bParam0, Hash hParam1) // Position - 0xE2CD
{
	if (!NETWORK::NETWORK_IS_IN_SESSION())
		return 0;
...
int func_375(Hash hParam0) // Position - 0xE323
{
	var unk;
...
BOOL func_376(Hash hParam0, int iParam1) // Position - 0xE34E
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_377(Hash hParam0) // Position - 0xE3F6
{
	int num;
	int num2;
	int num3;
...
int func_378(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE4B2
{
...
int func_379(Hash hParam0) // Position - 0xE574
{
	if (!STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		return 1;
...
BOOL func_380(int iParam0) // Position - 0xE59C
{
	int num;
...
int func_381(int iParam0, int iParam1) // Position - 0xE5C4
{
	switch (iParam0)
	{
		case -2101912686:
...
BOOL func_382(int iParam0) // Position - 0xEDC5
{
	int num;
...
int func_383(int iParam0, int iParam1) // Position - 0xEDED
{
	switch (iParam0)
	{
...
int func_384(int iParam0, int iParam1) // Position - 0xF4A4
{
	Player player;
	Player player2;
	int num;
...
int func_385(int iParam0, int iParam1, int iParam2) // Position - 0xF527
{
	int num;
	int num2;
...
void func_386(int iParam0) // Position - 0xF61F
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_387(int iParam0, int iParam1) // Position - 0xF635
{
	switch (iParam0)
	{
...
Hash func_392(int iParam0, Hash hParam1) // Position - 0xFF8E
{
	switch (iParam0)
	{
		case 0:
...
int func_393(int iParam0, Hash* phParam1) // Position - 0x104DA
{
	int num;
...
BOOL func_394(Any* panParam0, int iParam1, int iParam2) // Position - 0x10535
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_395(Any* panParam0, int iParam1, int iParam2) // Position - 0x10568
{
	int num;
	int offset;
	BOOL isBitSet;
...
int func_396(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1059A
{
	int i;
	int num;
	float num2;
...
int func_397(Hash* phParam0) // Position - 0x105F7
{
	Any any;
...
BOOL func_398(Hash* phParam0, int iParam1, Vector3* pvParam2, float* pfParam3) // Position - 0x10623
{
	Any any;
...
int func_399(int iParam0) // Position - 0x10685
{
	if (iParam0 == 255)
...
void func_400(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x106D0
{
	func_527(iParam0);
...
void func_401(var uParam0) // Position - 0x10732
{
	var unk;
...
void func_402(float* pfParam0) // Position - 0x10744
{
	var unk;
...
void func_403(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, int iParam30) // Position - 0x10756
{
	switch (uParam0.f_5)
	{
		case 1:
...
void func_404(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x107AC
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_405() // Position - 0x107D9
{
	int i;
...
BOOL func_406() // Position - 0x10801
{
	return Global_1295658.f_2.f_1 == 2 || Global_1295658.f_2.f_1 == 1;
}

BOOL func_407() // Position - 0x10823
{
	return Global_1915656.f_20637 || Global_1915656.f_22504.f_1;
}

void func_408(Ped pedParam0, Ped pedParam1) // Position - 0x10841
{
...
BOOL func_409(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0x10890
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

void func_410(var uParam0, int iParam1) // Position - 0x108B9
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_411(Hash hParam0, Hash hParam1) // Position - 0x108CE
{
	if (!func_444(hParam0, 2))
		return 0;
...
BOOL func_412() // Position - 0x10904
{
	return func_534(func_19(0));
}

BOOL func_413(int iParam0) // Position - 0x10915
{
	if (iParam0 == 0)
		return false;
...
BOOL func_414(int iParam0, var uParam1) // Position - 0x1092D
{
	*uParam1 = func_535(iParam0, true);
	return *uParam1 != 0;
}

BOOL func_415(int iParam0, var uParam1) // Position - 0x10944
{
	*uParam1 = func_536(iParam0, true, false);
	return *uParam1 != 0;
}

BOOL func_416(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x1095C
{
	var unk;
	int num;
	int i;
...
Hash func_417(Hash hParam0, BOOL bParam1) // Position - 0x10A21
{
	int i;
	int num;
	var unk;
...
Hash func_418(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x10AB4
{
	int i;
	int num;
	var unk;
...
int func_419(Hash hParam0, BOOL bParam1) // Position - 0x10C13
{
...
BOOL func_420(Hash hParam0) // Position - 0x10CCB
{
	BOOL flag;
	Hash weaponUnlock;
...
int func_421(int iParam0, Hash hParam1) // Position - 0x10D15
{
...
int func_422(Hash hParam0, int iParam1) // Position - 0x10D3A
{
	var unk;
	var guid;
...
int func_423(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10D95
{
	var unk;
	int num;
	int i;
...
BOOL func_424(Hash hParam0) // Position - 0x10E29
{
	return func_446(hParam0) == -999503751;
}

int func_425(Hash hParam0) // Position - 0x10E3D
{
	if (!func_424(hParam0))
		return 0;
...
BOOL func_426(Hash hParam0) // Position - 0x11DC7
{
	if (!func_292(hParam0, 0))
		return false;
...
int func_427(Hash hParam0) // Position - 0x11DEA
{
	if (!func_426(hParam0))
		return 0;
...
BOOL func_428(Hash hParam0) // Position - 0x127A6
{
	return func_543(hParam0) && func_293(hParam0, 1584357097);
}

int func_429(Hash hParam0) // Position - 0x127C4
{
	if (!func_428(hParam0))
		return 0;
...
BOOL func_430(Hash hParam0) // Position - 0x12C7A
{
	return func_446(hParam0) == 1882579758;
}

int func_431(Hash hParam0) // Position - 0x12C8E
{
	switch (hParam0)
	{
...
BOOL func_432(Hash hParam0) // Position - 0x12D2B
{
	switch (hParam0)
	{
		case -1843707398:
...
int func_433(int iParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x12D70
{
	var unk;
	int num;
	int i;
...
BOOL func_434(int iParam0) // Position - 0x12DDC
{
	if (iParam0 < 0)
		return false;
...
BOOL func_436(BOOL bParam0) // Position - 0x12E1A
{
	if (func_354() == -1)
		return true;
...
BOOL func_437() // Position - 0x12E38
{
...
BOOL func_438(Hash hParam0) // Position - 0x12E54
{
	if (!func_292(hParam0, 0))
		return false;
...
BOOL func_439(Hash hParam0) // Position - 0x12E83
{
	if (!func_292(hParam0, 0))
		return 0;
...
int func_440(int iParam0, Hash hParam1, var uParam2) // Position - 0x12EAD
{
	Ped EntityIndex;
	ItemSet itemSet;
	int itemsetSize;
...
int func_441(Hash hParam0, int iParam1) // Position - 0x12FDA
{
	int num;
	int num2;
	int num3;
...
int func_442(int iParam0, Hash hParam1) // Position - 0x130F7
{
	Ped EntityIndex;
	Hash hash;
	int num;
...
int func_443(Hash hParam0) // Position - 0x13195
{
	int num;
	Entity firstEntityPedIsCarrying;
...
BOOL func_444(Hash hParam0, int iParam1) // Position - 0x131E7
{
	if (hParam0 == 0)
		return false;
...
void func_445(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x13201
{
	int i;
	int j;
	int k;
...
int func_446(Hash hParam0) // Position - 0x133D7
{
	var unk;
...
void func_447(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x13402
{
	int i;
	int j;
	int k;
...
struct<4> func_448(BOOL bParam0) // Position - 0x135D8
{
	int num;
...
struct<4> func_449(BOOL bParam0) // Position - 0x13678
{
	int num;
...
int func_450(Hash hParam0, BOOL bParam1) // Position - 0x13719
{
...
BOOL func_451(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x13750
{
	return func_558(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_452(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x1376B
{
	var unk;
...
struct<4> func_453(BOOL bParam0) // Position - 0x1378C
{
	int num;
...
BOOL func_454(Hash hParam0, int iParam1) // Position - 0x137F6
{
	Hash hash;
	int num;
	int i;
...
BOOL func_455(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x13863
{
	return func_561(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_456(BOOL bParam0) // Position - 0x13879
{
	if (func_354() == -1)
	{
...
BOOL func_457(Any* panParam0) // Position - 0x138BA
{
...
int func_458(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x138D6
{
	if (!func_320(&uParam0))
		return 0;
...
BOOL func_459(int iParam0) // Position - 0x138F2
{
	if (iParam0 <= 0)
		return false;
...
BOOL func_460(Hash hParam0) // Position - 0x13910
{
	return func_293(hParam0, 1279601681);
}

BOOL func_461(int* piParam0, Hash hParam1, var uParam2, BOOL bParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x13923
{
	if (!func_463(piParam0, false))
		return false;
...
void func_462(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x139CC
{
	int num;
	Hash hash;
...
BOOL func_463(int* piParam0, BOOL bParam1) // Position - 0x13A11
{
	if (!bParam1)
...
void func_464(var uParam0, int iParam1) // Position - 0x13AAD
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_465(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, Hash hParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x13AC2
{
	Hash hash;
...
struct<17> func_466(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, int iParam6, BOOL bParam7) // Position - 0x13B5F
{
	var unk;
...
BOOL func_467(int* piParam0, Hash hParam1) // Position - 0x13BD9
{
...
BOOL func_468(Hash hParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, int iParam6) // Position - 0x13BF7
{
	int i;
	int num;
	Hash hash;
...
BOOL func_469(Hash hParam0) // Position - 0x13D77
{
	int num;
...
BOOL func_470(Hash hParam0) // Position - 0x13DA5
{
	return func_293(hParam0, 1282106666);
}

BOOL func_471(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, int iParam7, var uParam8, BOOL bParam9, Hash hParam10, int iParam11, BOOL bParam12) // Position - 0x13DB8
{
	var unk;
...
BOOL func_472(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, BOOL bParam7, var uParam8, BOOL bParam9, Hash hParam10, int iParam11, int iParam12, BOOL bParam13) // Position - 0x13E35
{
	var unk;
...
Hash func_473(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0x13F15
{
	return func_577(&uParam0, hParam4, bParam5, iParam6);
}

BOOL func_474(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x13F29
{
	var unk;
...
void func_475(int* piParam0) // Position - 0x13F9D
{
...
BOOL func_476(int* piParam0) // Position - 0x13FD1
{
	Hash action;
...
int func_477(Hash hParam0, int iParam1) // Position - 0x14071
{
	switch (hParam0)
	{
		case -2141145462:
...
struct<2> func_478(int iParam0, int iParam1) // Position - 0x145B2
{
	int num;
...
void func_479(var uParam0, var uParam1, int iParam2) // Position - 0x145C8
{
...
BOOL func_481(int* piParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, Hash hParam18, BOOL bParam19, int iParam20) // Position - 0x14655
{
...
void func_482(char* sParam0, char* sParam1, BOOL bParam2) // Position - 0x146DF
{
	int soundId;
...
Hash func_483(Hash hParam0, int iParam1) // Position - 0x1471E
{
	if (!func_292(hParam0, 0))
		return 0;
...
BOOL func_484(Hash hParam0) // Position - 0x1474D
{
	return func_446(hParam0) == -126813555;
}

BOOL func_485(int iParam0) // Position - 0x14761
{
...
Hash func_486(int iParam0) // Position - 0x14780
{
	if (!func_485(iParam0))
		return 0;
...
Hash func_487(int iParam0, BOOL bParam1) // Position - 0x147A1
{
	Hash hash;
	Hash xp;
...
int func_488(Hash hParam0) // Position - 0x14860
{
	if (STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		return 1;
...
void func_489() // Position - 0x14887
{
...
BOOL func_490(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1489E
{
	BOOL flag;
...
void func_491(int iParam0) // Position - 0x148C6
{
	Global_1896762.f_365 = iParam0;
	return;
}

BOOL func_492(Hash hParam0) // Position - 0x148D7
{
	switch (hParam0)
	{
		case -1551258934:
...
Hash func_493(Hash hParam0, BOOL bParam1) // Position - 0x14904
{
	switch (hParam0)
	{
...
void func_494(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x149A6
{
	int num;
...
void func_495(int iParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x149EF
{
	int i;
...
int func_496(int iParam0) // Position - 0x14A8D
{
	int i;
...
BOOL func_497(int iParam0) // Position - 0x14AD9
{
	return iParam0 > -1 && iParam0 < 180;
}

void func_498(var uParam0, int iParam1) // Position - 0x14AEF
{
...
void func_500(int iParam0) // Position - 0x14B6A
{
...
void func_502(int iParam0) // Position - 0x14BD2
{
	if (iParam0 >= 10 || iParam0 < 0)
		iParam0 = 0;
...
BOOL func_503() // Position - 0x14BFB
{
	return !Global_1572887.f_10;
}

void func_504(Hash hParam0, int iParam1) // Position - 0x14C0A
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

Hash func_505(Hash hParam0, int iParam1) // Position - 0x14C1D
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_506(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x14C97
{
...
BOOL func_507(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x14CBE
{
	if (iParam2 < 0)
		return false;
...
BOOL func_508(Hash hParam0) // Position - 0x14CF9
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_509(int iParam0) // Position - 0x14D14
{
	if (iParam0 < 0)
		return 0;
...
int func_510(Hash hParam0) // Position - 0x14D35
{
	switch (hParam0)
	{
...
int func_511(var uParam0, int iParam1) // Position - 0x14E18
{
	int i;
...
int func_512(Hash hParam0) // Position - 0x14E55
{
	int num;
...
int func_513(Hash hParam0, BOOL bParam1) // Position - 0x14EC2
{
	var unk;
	int num;
	int num2;
...
int func_514(Hash hParam0, int iParam1) // Position - 0x14F21
{
	if (iParam1 == 0)
		return 0;
...
struct<4> func_515(Hash hParam0, BOOL bParam1) // Position - 0x14F4D
{
	var unk;
...
BOOL func_516() // Position - 0x14F72
{
	return func_531() == 4;
}

Player func_517(int iParam0) // Position - 0x14F80
{
	if (func_596(iParam0))
...
BOOL func_518(int iParam0) // Position - 0x14FA1
{
	int num;
...
int func_519(int iParam0, int iParam1, int iParam2) // Position - 0x14FC9
{
	int num;
	int num2;
	int num3;
...
BOOL func_521(int iParam0, int iParam1) // Position - 0x151C8
{
	int num;
...
Vector3 func_522(int iParam0) // Position - 0x15208
{
	int num;
	var unk;
...
BOOL func_523(int iParam0, var uParam1, var uParam2) // Position - 0x15244
{
	if (!func_518(iParam0))
		return false;
...
BOOL func_524(int iParam0, int iParam1, int iParam2) // Position - 0x1527B
{
	int num;
	int num2;
	int num3;
...
void func_525(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x154A9
{
	int num;
...
void func_526(int iParam0) // Position - 0x15528
{
	int num;
...
void func_532(BOOL bParam0) // Position - 0x1561A
{
	if (func_613(bParam0))
		return;
...
BOOL func_533(int iParam0) // Position - 0x15641
{
	if (!func_614(iParam0))
		return false;
...
BOOL func_534(var uParam0, var uParam1) // Position - 0x15661
{
	return func_615(uParam0, 5, 8);
}

Hash func_535(int iParam0, BOOL bParam1) // Position - 0x15674
{
	int i;
	int num;
	var unk;
...
Hash func_536(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x15707
{
	int i;
	int num;
	var unk;
...
BOOL func_537(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x15866
{
	var unk;
	int num;
	int i;
...
BOOL func_538(Hash hParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0x158F4
{
	var unk;
	int i;
...
Hash func_539(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x15978
{
	int num;
...
BOOL func_540(Hash hParam0) // Position - 0x15A14
{
	return func_446(hParam0) == 1946043663;
}

BOOL func_541(Hash hParam0) // Position - 0x15A28
{
	return func_375(hParam0) == joaat("WEAPON");
}

int func_542(int iParam0) // Position - 0x15A3C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_543(Hash hParam0) // Position - 0x15A6D
{
	return func_446(hParam0) == 1868067663;
}

int func_544(int iParam0) // Position - 0x15A81
{
	if (iParam0 == 7)
...
BOOL func_545(int iParam0) // Position - 0x15A9A
{
	iParam0 = func_544(iParam0);
...
Ped func_546(int iParam0) // Position - 0x15AD2
{
	iParam0 = func_544(iParam0);
...
BOOL func_547(Entity eParam0) // Position - 0x15AFE
{
...
int func_548(Hash hParam0, int iParam1) // Position - 0x15B61
{
	var unk;
	int num;
	int i;
...
struct<10> func_549(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x15BAB
{
	int num;
...
BOOL func_550(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x15C7F
{
...
Hash func_551(int iParam0, int iParam1) // Position - 0x15CA0
{
	int num;
...
Hash func_552(Hash hParam0) // Position - 0x15CE3
{
	int num;
...
int func_553(Hash hParam0) // Position - 0x16055
{
...
int func_554(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1609A
{
	var unk;
	int num;
	int i;
...
int func_555(int iParam0) // Position - 0x160EE
{
	if (iParam0 < 0)
		return 0;
...
struct<4> func_556() // Position - 0x1610F
{
	var unk;
...
Hash func_558(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x16138
{
	int inventoryItemCountWithGuid;
	var guid;
...
BOOL func_559(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x161B7
{
	int inventoryId;
...
BOOL func_560(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x161FC
{
...
BOOL func_561(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1622F
{
...
BOOL func_563(int iParam0, Hash hParam1, int iParam2) // Position - 0x162AD
{
	if (iParam0 == 0)
		return false;
...
BOOL func_564(int* piParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, Hash hParam19, BOOL bParam20) // Position - 0x1630D
{
...
BOOL func_565(int* piParam0) // Position - 0x16361
{
	int num;
...
BOOL func_566(var uParam0) // Position - 0x16393
{
...
BOOL func_567(Hash hParam0) // Position - 0x163D9
{
	Hash hash;
...
BOOL func_568(int* piParam0, Hash hParam1, Hash hParam2, int iParam3, int iParam4) // Position - 0x163F8
{
	int num;
	var unk;
	var unk2;
...
BOOL func_569(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5) // Position - 0x164A3
{
	var unk;
...
BOOL func_570(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x164F4
{
	if (func_289(iParam2, 1))
		if (!func_420(hParam0))
			return false;
...
BOOL func_571(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, Hash hParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x1652F
{
	var unk;
	int num;
	int num2;
...
BOOL func_572(int* piParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x165E6
{
	int num;
	int num2;
	int num3;
...
int func_573(Hash hParam0) // Position - 0x1672E
{
	int num;
...
BOOL func_574(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, Any* panParam5, BOOL bParam6, int iParam7) // Position - 0x1675D
{
	return func_629(&uParam0, hParam4, panParam5, bParam6, iParam7);
}

BOOL func_575(int* piParam0, Any* panParam1, Hash hParam2, BOOL bParam3, int iParam4) // Position - 0x16773
{
	var unk;
	int num;
...
BOOL func_576(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, Hash hParam7, int iParam8) // Position - 0x1691B
{
...
int func_577(Any* panParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0x1695F
{
	var unk;
...
int func_578(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1698D
{
	int num;
	var unk;
	int num2;
...
BOOL func_579(Hash hParam0, Any* panParam1, int iParam2) // Position - 0x16AD0
{
	if (panParam1->f_9 < 1)
		return false;
...
BOOL func_580(int* piParam0, Hash hParam1) // Position - 0x16B50
{
	Hash action;
...
BOOL func_581(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x16BB3
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

BOOL func_582(int* piParam0, BOOL bParam1) // Position - 0x16BCA
{
...
BOOL func_583(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x16BEB
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

Hash func_584(int iParam0) // Position - 0x16C02
{
	switch (iParam0)
	{
		case 0:
...
Hash func_585(int iParam0) // Position - 0x16D9B
{
...
Hash func_586(int iParam0) // Position - 0x16DC7
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_587() // Position - 0x16F60
{
	return Global_1915656.f_20643;
}

BOOL func_588(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x16F6F
{
	Player PlayerIndex;
	Ped EntityIndex;
	BOOL isEntityDead;
...
void func_589(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x17195
{
	int i;
...
void func_590(var uParam0, int iParam1) // Position - 0x17271
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_591(var uParam0, int iParam1) // Position - 0x17282
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_592(Hash hParam0, var uParam1, var uParam2) // Position - 0x17297
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_593(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x174A3
{
	Hash hash;
...
void func_594(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x17581
{
	if (INVENTORY::_INVENTORY_IS_GUID_VALID(&uParam1))
		uParam0->f_9 = { uParam1 };
...
BOOL func_595(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x1759C
{
...
BOOL func_596(int iParam0) // Position - 0x175C1
{
	int num;
...
int func_597(int iParam0) // Position - 0x175E8
{
	int num;
...
int func_598(int iParam0, int iParam1) // Position - 0x17682
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_599(int iParam0) // Position - 0x17ABB
{
	int num;
...
float func_600(int iParam0) // Position - 0x17AE3
{
	float num;
...
void func_601(int iParam0) // Position - 0x17B12
{
	int num;
	int num2;
	int i;
...
BOOL func_602(int iParam0) // Position - 0x17CF1
{
	int num;
...
int func_603(int iParam0, int iParam1) // Position - 0x17D19
{
	switch (iParam0)
	{
...
void func_604(int iParam0) // Position - 0x1802B
{
	Ped ped;
	Player player;
...
BOOL func_605(int iParam0) // Position - 0x1823A
{
	int num;
...
int func_606(int iParam0, int iParam1) // Position - 0x18261
{
	switch (iParam0)
	{
...
int func_607(int iParam0) // Position - 0x182BE
{
	int num;
	var unk;
	var unk32;
...
BOOL func_608(int iParam0) // Position - 0x18402
{
...
void func_609(int iParam0) // Position - 0x18420
{
	int num;
	int num2;
	int i;
...
BOOL func_610(int iParam0) // Position - 0x18575
{
	BOOL flag;
...
void func_611(int iParam0) // Position - 0x1859E
{
	Ped EntityIndex;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_669(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_676(iParam0, 0));
			func_677(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_676(iParam0, 1));
			func_677(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_676(iParam0, 2));
			func_677(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_676(iParam0, 3));
			func_677(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_612(int iParam0) // Position - 0x18839
{
	char* StringToTest;
	char* StringToTest2;
	...
	StringToTest = func_679(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	StringToTest2 = func_680(iParam0);
...
BOOL func_613(BOOL bParam0) // Position - 0x18883
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_614(int iParam0) // Position - 0x18899
{
...
BOOL func_615(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x188B7
{
	int num;
...
BOOL func_616(Hash hParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0x188F2
{
	var unk;
	int i;
...
int func_617(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x18976
{
...
BOOL func_618(int iParam0, Hash hParam1) // Position - 0x189A9
{
	int num;
	int num2;
	var unk;
...
BOOL func_619(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x18A63
{
...
BOOL func_620(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x18A7C
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

int func_621(Hash hParam0, Any anParam1, var uParam2, var uParam3, var uParam4) // Position - 0x18A93
{
	Hash hash;
	Hash hash2;
	int i;
...
BOOL func_622(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x18B78
{
	var unk;
	var unk48;
...
int func_623(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x18C44
{
	if (!func_292(hParam0, 0))
	{
		if (func_444(func_313(hParam0), 2))
...
BOOL func_624(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3) // Position - 0x18CB8
{
	var unk;
...
int func_625(int* piParam0, Hash hParam1) // Position - 0x18D17
{
	int num;
	int i;
	int numOfItems;
...
void func_626(const char* sParam0) // Position - 0x18D81
{
	Global_1915656.f_22470 = func_239(sParam0, 10000, 0, 0, 0, true);
	return;
}

int func_627(int* piParam0, Hash hParam1) // Position - 0x18D9D
{
	int num;
	int i;
	int numOfItems;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_628(Hash hParam0, int iParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x18E16
{
	var unk;
	int num;
	int num2;
...
BOOL func_629(Any* panParam0, Hash hParam1, Any* panParam2, BOOL bParam3, int iParam4) // Position - 0x18EFC
{
	var outGuid;
...
BOOL func_630(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x18F4A
{
	var unk;
...
BOOL func_631(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x18F78
{
	int num;
...
BOOL func_632(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x18FAF
{
	int num;
...
BOOL func_633(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x18FEF
{
	int num;
...
BOOL func_634(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19038
{
	int num;
...
BOOL func_635(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x1908A
{
	int num;
...
BOOL func_636(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x190E5
{
	int num;
...
BOOL func_637(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19149
{
	int num;
...
BOOL func_638(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x191B7
{
	int num;
...
BOOL func_639(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x1922E
{
	int num;
...
BOOL func_640(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x192AE
{
	int num;
...
BOOL func_641(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19337
{
	int num;
...
BOOL func_642(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x193C9
{
	int num;
...
BOOL func_643(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19464
{
	int num;
...
BOOL func_644(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19508
{
	int num;
...
struct<29> func_645(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x195B5
{
	var unk;
	var unk30;
...
int func_646(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x19650
{
	int num;
...
struct<26> func_647(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x196BA
{
	var unk;
	var unk27;
...
int func_648(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x1973D
{
	int num;
...
struct<18> func_649(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1978D
{
	var unk;
	var unk19;
...
int func_650(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x19802
{
	int num;
...
struct<17> func_651(var uParam0, BOOL bParam1) // Position - 0x1986C
{
	var unk;
...
int func_652(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x198ED
{
	int num;
...
BOOL func_653(Hash hParam0, Any* panParam1) // Position - 0x19957
{
	int num;
...
BOOL func_656(int iParam0) // Position - 0x19B6C
{
	int num;
...
BOOL func_657(int iParam0) // Position - 0x19B94
{
	int num;
...
BOOL func_658(int iParam0) // Position - 0x19BBC
{
	int num;
...
BOOL func_659(int iParam0) // Position - 0x19BE4
{
	int num;
...
BOOL func_660(int iParam0) // Position - 0x19C0C
{
	int num;
...
BOOL func_661(int iParam0) // Position - 0x19C34
{
	int num;
...
float func_662(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x19C5C
{
	var unk;
	float num;
...
BOOL func_663(int iParam0) // Position - 0x19C92
{
...
BOOL func_664(int iParam0) // Position - 0x19D01
{
	int num;
...
int func_665(int iParam0, int iParam1) // Position - 0x19D28
{
	switch (iParam0)
	{
...
void func_666() // Position - 0x19D85
{
	BOOL bTrue;
	BOOL bTrue2;
...
void func_667() // Position - 0x19DE7
{
	BOOL bTrue;
...
char* func_668(int iParam0) // Position - 0x19E17
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_669(int iParam0) // Position - 0x19E5E
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_670(int iParam0) // Position - 0x19E99
{
	int i;
...
void func_671() // Position - 0x19ED9
{
...
int func_672(int iParam0) // Position - 0x19EF9
{
	int num;
...
BOOL func_673(int iParam0, int iParam1) // Position - 0x19F28
{
	int num;
	Player player;
	int num2;
...
struct<31> func_674(int iParam0) // Position - 0x1A1FD
{
	int num;
...
BOOL func_675(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0x1A221
{
	var unk;
	BOOL flag;
...
char* func_676(int iParam0, int iParam1) // Position - 0x1A257
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_677(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1A2AF
{
	int i;
...
void func_678() // Position - 0x1A334
{
...
char* func_679(int iParam0) // Position - 0x1A359
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_680(int iParam0) // Position - 0x1A379
{
	switch (iParam0)
	{
		case -1822335806:
...
int func_681(int iParam0, var uParam1) // Position - 0x1A399
{
	if (iParam0 == 2)
...
BOOL func_682(Hash hParam0, Hash hParam1, Any anParam2) // Position - 0x1A3B3
{
	int i;
	int num;
...
BOOL func_683(Hash hParam0) // Position - 0x1A3F3
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

// Unhandled jump detected. Output should be considered invalid
BOOL func_684(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1A401
{
	int i;
...
BOOL func_685(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, int iParam4, Any* panParam5, BOOL bParam6, int iParam7) // Position - 0x1A491
{
	int i;
...
BOOL func_686(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x1A50E
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 29, panParam2, 0);
}

int func_687(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x1A525
{
	if (bParam0)
	{
...
int func_688(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x1A56E
{
	if (bParam0)
	{
		func_495(iParam1, 1, 0, 0);
...
BOOL func_689(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x1A58A
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 26, panParam2, 0);
}

BOOL func_690(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x1A5A1
{
...
void func_691(var uParam0) // Position - 0x1A5B9
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_692(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x1A614
{
	int num;
	int num2;
...
BOOL func_693() // Position - 0x1A835
{
	return Global_1572887.f_7;
}

BOOL func_694() // Position - 0x1A843
{
	if (!Global_1048577)
		return false;
...
BOOL func_695(Player plParam0) // Position - 0x1A88E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_696(int iParam0, Player plParam1) // Position - 0x1A8D3
{
	if (plParam1 == 255)
...
int func_697(var uParam0, var uParam1) // Position - 0x1A8FF
{
	var unk;
...
void func_698(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x1A92B
{
	int i;
	int j;
	int k;
...
BOOL func_699(Hash hParam0, int iParam1, var uParam2) // Position - 0x1AB01
{
	var unk;
	int num;
	int num2;
...
BOOL func_700(int* piParam0, Any* panParam1, Any* panParam2, Hash hParam3, BOOL bParam4, int iParam5) // Position - 0x1AC23
{
...
int func_701(int iParam0) // Position - 0x1AC95
{
	int num;
...
void func_704(Player plParam0) // Position - 0x1AD30
{
	Player player;
...
BOOL func_705(int iParam0, var uParam1, Any* panParam2) // Position - 0x1ADB3
{
	if (!func_12(iParam0))
		return false;
...
BOOL func_706(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x1AEBE
{
	*uParam1 = 0;
...
BOOL func_707(int iParam0, Hash hParam1, Any* panParam2, Any* panParam3) // Position - 0x1AF2B
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam3, *panParam3);
}

void func_708(Player plParam0) // Position - 0x1AF44
{
	Player player;
...
void func_709(Player plParam0) // Position - 0x1AFB0
{
...
void func_710(Any* panParam0) // Position - 0x1AFEB
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_711(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x1B001
{
	int i;
