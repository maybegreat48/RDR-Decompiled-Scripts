...
void func_1(var uParam0) // Position - 0x111
{
	func_13(&(uParam0->f_4));
...
BOOL func_2(var uParam0) // Position - 0x142
{
	if (SCRIPTS::IS_THREAD_EXIT_REQUESTED())
		return true;
...
int func_3(var uParam0) // Position - 0x170
{
	return *uParam0;
}

BOOL func_4(var uParam0) // Position - 0x17B
{
...
void func_5(var uParam0, int iParam1) // Position - 0x1A3
{
	*uParam0 = iParam1;
	return;
}

int func_6(var uParam0) // Position - 0x1B0
{
...
BOOL func_7(var uParam0) // Position - 0x1E1
{
	return func_16(*uParam0, 1);
}

void func_8(var uParam0, BOOL bParam1) // Position - 0x1F1
{
...
float func_9(var uParam0) // Position - 0x211
{
	if (!func_7(uParam0))
		return 0f;
...
void func_10(var uParam0) // Position - 0x243
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_11(var uParam0) // Position - 0x259
{
	var unk;
	var unk2;
	int i;
...
BOOL func_12(var uParam0) // Position - 0x33E
{
	return true;
}

void func_13(var uParam0) // Position - 0x347
{
...
BOOL func_14(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x36F
{
	if (iParam1 == 0)
		return false;
...
int func_15(var uParam0) // Position - 0x3AC
{
	if (!*uParam0)
		return 2;
...
BOOL func_16(int iParam0, int iParam1) // Position - 0x3F0
{
	return iParam0 && iParam1 != false;
}

void func_17(var uParam0) // Position - 0x3FF
{
	func_28(uParam0, 0f);
	return;
}

BOOL func_18(var uParam0) // Position - 0x40E
{
	return func_16(*uParam0, 2);
}

float func_19() // Position - 0x41E
{
...
BOOL func_20(var uParam0) // Position - 0x450
{
...
void func_21(int iParam0, var uParam1, var uParam2) // Position - 0x485
{
	switch (iParam0)
	{
		case 0:
...
struct<16> func_22(int iParam0) // Position - 0x67D
{
	var unk;
...
const char* func_23(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x699
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

struct<16> func_24(int iParam0) // Position - 0x6AD
{
	var unk;
...
Hash func_25(var uParam0, int iParam1) // Position - 0x6C1
{
	switch (*uParam0)
	{
		case 0:
...
struct<16> func_26(int iParam0) // Position - 0x949
{
	var unk;
...
Hash func_27(var uParam0, int iParam1) // Position - 0x95D
{
	switch (*uParam0)
	{
		case 0:
...
void func_28(var uParam0, float fParam1) // Position - 0xB75
{
...
void func_29(var uParam0, int iParam1) // Position - 0xB9B
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_30(var uParam0, int iParam1) // Position - 0xBAC
{
