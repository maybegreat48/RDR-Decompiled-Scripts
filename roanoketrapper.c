...
void _DEBUG_PRINT(int iParam0) // Position - 0x862
{
	iParam0 = iParam0;
	return;
}
...
void func_16(int iParam0) // Position - 0x87B
{
	return;
}

BOOL func_17(int iParam0) // Position - 0x883
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x890
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x89C
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x8B1
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x8C2
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x901
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x90D
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x915
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0x9C5
{
	return;
}

void func_26() // Position - 0x9CD
{
	return;
}

void func_27() // Position - 0x9D5
{
	return;
}

void func_28() // Position - 0x9DD
{
	return;
}

void func_29(int iParam0) // Position - 0x9E5
{
...
void func_30(int iParam0) // Position - 0xA2F
{
	return;
}

void func_31() // Position - 0xA37
{
	return;
}

void func_32() // Position - 0xA3F
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xA47
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xA53
{
...
void func_35(var uParam0) // Position - 0xA84
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xACA
{
	return;
}

void func_37(int iParam0) // Position - 0xAD2
{
	if (!func_61(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xAEB
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xAFC
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xB14
{
	func_45() == -1;
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xB25
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xC64
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xC71
{
...
BOOL func_44(int iParam0) // Position - 0xCA7
{
	if (iParam0 == 0)
	{
		func_75();
...
int func_45() // Position - 0xDBB
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xDC9
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xDD5
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xE42
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xF22
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xF40
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xF53
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF71
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x1069
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x107A
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x108E
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x10A2
{
	return uParam0;
}

void func_58(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x10AC
{
...
void func_59(int iParam0, int iParam1) // Position - 0x125B
{
	func_101(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

int func_60(int iParam0, BOOL bParam1) // Position - 0x1275
{
	int num;
	Hash hash;
	float num2;
...
BOOL func_61(int iParam0) // Position - 0x139C
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_62() // Position - 0x13B2
{
	int i;
...
BOOL func_63(int iParam0, int iParam1) // Position - 0x13DF
{
	return iParam0 && iParam1 != false;
}

BOOL func_64(var uParam0, int iParam1) // Position - 0x13EE
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_65() // Position - 0x13FF
{
	return func_63(Global_1940199, 8192);
}

BOOL func_66(var uParam0, int iParam1) // Position - 0x1412
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_67(int iParam0) // Position - 0x1423
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_68(int iParam0, int iParam1) // Position - 0x1463
{
...
int func_69() // Position - 0x1490
{
	return Global_1896646.f_41;
}

void func_70(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x149E
{
	BOOL flag;
...
void func_71(var uParam0, int iParam1) // Position - 0x1705
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_72(int iParam0, BOOL bParam1) // Position - 0x1718
{
...
void func_73(BOOL bParam0) // Position - 0x1D81
{
	if (bParam0)
...
BOOL func_74(int iParam0) // Position - 0x1DAA
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_75() // Position - 0x1DEF
{
	return;
}

Hash func_76(int iParam0, BOOL bParam1) // Position - 0x1DF7
{
	switch (iParam0)
	{
		case 0:
...
void func_77(int iParam0, BOOL bParam1) // Position - 0x25BC
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_78(BOOL bParam0) // Position - 0x260F
{
	if (bParam0)
...
void func_79(int iParam0) // Position - 0x2638
{
	AUDIO::SET_AMBIENT_ZONE_STATE("AZ_Naturalist_Camp", false, true);
	return;
}

void func_80(int iParam0) // Position - 0x2649
{
	int i;
...
void func_81(int iParam0) // Position - 0x267A
{
	int i;
...
BOOL func_82(int iParam0, BOOL bParam1) // Position - 0x26AD
{
	int num;
	int num2;
	int num3;
...
BOOL func_83(int iParam0) // Position - 0x2763
{
	int i;
...
BOOL func_84(int iParam0, BOOL bParam1) // Position - 0x27DD
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_85(int iParam0) // Position - 0x280E
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_86(int iParam0) // Position - 0x282F
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_87(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2882
{
	BOOL flag;
...
BOOL func_88(int iParam0) // Position - 0x2F42
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_89(int iParam0) // Position - 0x2F59
{
	switch (iParam0)
	{
		case 64:
...
int func_90(int iParam0, BOOL bParam1) // Position - 0x2F9C
{
	if (!func_88(iParam0))
		return 0;
...
BOOL func_92() // Position - 0x309B
{
	return func_142(func_56(0));
}

BOOL func_93(int iParam0) // Position - 0x30AC
{
	return !func_143(iParam0);
}

void func_94(BOOL bParam0, BOOL bParam1) // Position - 0x30BB
{
	if (func_144(255) == 4)
		return;
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x3206
{
	BOOL flag;
...
int func_96(int iParam0, int iParam1) // Position - 0x35B5
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_97(int iParam0) // Position - 0x3F1B
{
	if (!func_161(iParam0))
		return 0;
...
int func_98(int iParam0) // Position - 0x3F5C
{
	switch (iParam0)
	{
		case 3:
...
void func_99(int iParam0, int iParam1) // Position - 0x3FF9
{
...
void func_100(int iParam0) // Position - 0x402A
{
...
void func_101(int iParam0, int iParam1) // Position - 0x4063
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_102(int iParam0, int iParam1) // Position - 0x4074
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x408D
{
...
int func_104() // Position - 0x40B7
{
	return Global_1893611.f_2;
}

BOOL func_105(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x40C5
{
	return func_163(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_106(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x40E5
{
	return func_163(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_107(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x4105
{
	if (bParam6)
...
BOOL func_108(int iParam0) // Position - 0x4181
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_109(int iParam0) // Position - 0x4197
{
...
const char* func_111(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x420F
{
	const char* StringToTest;
...
BOOL func_112(int iParam0) // Position - 0x4C75
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_113(int iParam0) // Position - 0x4C8A
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0) // Position - 0x4D45
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_115(int iParam0) // Position - 0x4DB3
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_116(int iParam0) // Position - 0x4F0E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_117(int iParam0, BOOL bParam1) // Position - 0x4F49
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_118(int iParam0, int iParam1) // Position - 0x4F8B
{
	if (!func_112(iParam0))
		return false;
...
int func_119() // Position - 0x4FD0
{
	return Global_1902569;
}

int func_120(int iParam0) // Position - 0x4FDC
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_121(int iParam0) // Position - 0x4FEF
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_122(float fParam0) // Position - 0x5001
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_123(var uParam0, int iParam1) // Position - 0x5017
{
...
int func_124(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x504D
{
	int duration;
	var data;
	int num;
...
BOOL func_125(int iParam0) // Position - 0x5090
{
	if (func_171(iParam0))
		if (!func_172(44))
			return false;
...
void func_126(int iParam0, int iParam1) // Position - 0x50B0
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_127(int iParam0, int iParam1) // Position - 0x50C1
{
	int num;
...
void func_128(var uParam0, var uParam1, int iParam2) // Position - 0x50D7
{
...
void func_129(int iParam0) // Position - 0x50F4
{
...
void func_130(int iParam0) // Position - 0x51D4
{
	int i;
	int num;
...
BOOL func_131(int iParam0, BOOL bParam1) // Position - 0x53AC
{
	if (func_45() != -1)
		return false;
...
int func_132(int iParam0, BOOL bParam1) // Position - 0x53DA
{
	if (!func_88(iParam0))
		return 0;
...
int func_133(int iParam0) // Position - 0x545D
{
	switch (iParam0)
	{
		case 27:
...
int func_134(int iParam0) // Position - 0x5484
{
	switch (iParam0)
	{
		case 33:
...
Hash func_137(int iParam0) // Position - 0x56E7
{
	if (!func_88(iParam0))
		return 0;
...
void func_138(int iParam0, PersChar pchParam1) // Position - 0x5705
{
	if (!func_88(iParam0))
		return;
...
PersChar func_139(int iParam0) // Position - 0x5726
{
	if (!func_88(iParam0))
		return 0;
...
void func_140(int iParam0, BOOL bParam1) // Position - 0x5746
{
	if (func_45() != -1)
		return;
...
BOOL func_141(int iParam0) // Position - 0x577F
{
	if (!func_88(iParam0))
		return false;
...
BOOL func_142(var uParam0, var uParam1) // Position - 0x57A5
{
	return func_188(uParam0, 5, 8);
}

BOOL func_143(int iParam0) // Position - 0x57B8
{
	return func_189(1, iParam0);
}

int func_144(int iParam0) // Position - 0x57C7
{
	if (iParam0 == 255)
...
void func_146(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x582F
{
	func_191(iParam0);
...
int func_147(int iParam0) // Position - 0x5891
{
...
void func_148(var uParam0) // Position - 0x58AE
{
	var unk;
...
void func_149(float* pfParam0) // Position - 0x58C0
{
	var unk;
...
void func_151(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x5928
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_152(int iParam0) // Position - 0x5955
{
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x59B2
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_154(int iParam0, int iParam1) // Position - 0x59CB
{
	func_153(iParam0, iParam1);
...
int func_155(int iParam0) // Position - 0x5A06
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_156(Hash hParam0) // Position - 0x5A1A
{
...
void func_157(int iParam0) // Position - 0x5A3A
{
	return;
}

void func_158(int iParam0) // Position - 0x5A42
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_159(int iParam0, int iParam1) // Position - 0x5A57
{
	if (iParam0 == -1)
		return false;
...
void func_160(int iParam0) // Position - 0x5A7E
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_161(int iParam0) // Position - 0x5AFD
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_162(int iParam0) // Position - 0x5B13
{
	var unk;
...
BOOL func_163(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x5B44
{
	int num;
...
int func_164(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5BCC
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

BOOL func_165() // Position - 0x5BE6
{
	return false;
}

BOOL func_166() // Position - 0x5BEF
{
	var unk;
	var unk3;
...
BOOL func_167(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5C57
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_168(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5DCD
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_169(var uParam0, var uParam1, var uParam2) // Position - 0x5DE1
{
	int i;
...
const char* func_170(int iParam0) // Position - 0x5E0F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_171(int iParam0) // Position - 0x60F3
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_172(int iParam0) // Position - 0x611D
{
	if (!func_209(iParam0))
		return false;
...
struct<2> func_173(Player plParam0) // Position - 0x6139
{
	var gamerHandle;
...
const char* func_174(const char* sParam0, int iParam1) // Position - 0x614D
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_175(int iParam0, BOOL bParam1) // Position - 0x6167
{
	char* StringToTest;
...
void func_176(int iParam0, BOOL bParam1) // Position - 0x619B
{
	switch (iParam0)
	{
		case 5:
...
void func_177(int iParam0, int iParam1) // Position - 0x61D0
{
	func_211(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_178(int iParam0) // Position - 0x61EA
{
	if (!func_88(iParam0))
		return false;
...
void func_179(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x620F
{
	PersChar persChar;
...
void func_180(int iParam0, BOOL bParam1) // Position - 0x62FB
{
	if (!func_161(iParam0))
		return;
...
void func_181(int iParam0, int iParam1) // Position - 0x6351
{
	if (!func_218(iParam0))
		return;
...
int func_182(int iParam0) // Position - 0x63C4
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_183(int iParam0) // Position - 0x63DA
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_184(int iParam0, BOOL bParam1) // Position - 0x63F0
{
	if (func_45() != -1)
		return;
...
void func_185(int iParam0) // Position - 0x6421
{
	Ped EntityIndex;
...
void func_186(int iParam0) // Position - 0x6465
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_187(int iParam0) // Position - 0x647A
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_188(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x648F
{
	int num;
...
BOOL func_189(int iParam0, int iParam1) // Position - 0x64CA
{
	int num;
...
BOOL func_190(Any* panParam0, int iParam1, int iParam2) // Position - 0x653E
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_196(BOOL bParam0) // Position - 0x660D
{
	if (func_223(bParam0))
		return;
...
BOOL func_197(Any* panParam0, int iParam1, int iParam2) // Position - 0x6634
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_198(Hash hParam0) // Position - 0x6667
{
	if (func_224(hParam0))
...
BOOL func_199() // Position - 0x6682
{
	return 1;
}

BOOL func_200(BOOL bParam0, BOOL bParam1) // Position - 0x668B
{
	return bParam0 && bParam1 != false;
}

int func_201(int iParam0) // Position - 0x669A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_202(int iParam0, int iParam1, var uParam2) // Position - 0x7082
{
	var unk;
...
int func_203() // Position - 0x70A9
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_204() // Position - 0x70BE
{
	if (Global_1048576)
		return true;
...
struct<2> func_205() // Position - 0x7116
{
	return Global_1051268;
}

BOOL func_206(var uParam0, var uParam1) // Position - 0x7124
{
	if (!func_227(uParam0))
		return false;
...
struct<2> func_207() // Position - 0x7158
{
...
BOOL func_208(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x71A3
{
	var unk;
	float num;
	float num2;
...
BOOL func_209(int iParam0) // Position - 0x71D3
{
	if (iParam0 == 0)
		return false;
...
BOOL func_210(int iParam0) // Position - 0x71E6
{
	int num;
	int num2;
	int offset;
...
void func_211(BOOL bParam0, int iParam1) // Position - 0x7210
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_212(int iParam0) // Position - 0x7225
{
	if (!func_88(iParam0))
		return false;
...
BOOL func_213(Hash hParam0) // Position - 0x7249
{
	return hParam0 != 0;
}

BOOL func_214(int iParam0, BOOL bParam1) // Position - 0x7255
{
	if (!func_161(iParam0))
		return false;
...
void func_215(int iParam0, BOOL bParam1) // Position - 0x727B
{
	if (!func_161(iParam0))
		return;
...
void func_216(int iParam0, BOOL bParam1) // Position - 0x72A9
{
	if (!func_161(iParam0))
		return;
...
void func_217(int iParam0) // Position - 0x72E3
{
	func_232(func_231(iParam0));
	return;
}

BOOL func_218(int iParam0) // Position - 0x72F5
{
	return iParam0 > -1 && iParam0 < 40;
}

Ped func_219(int iParam0) // Position - 0x730B
{
	PersChar persChar;
...
int func_220(int iParam0, var uParam1) // Position - 0x7339
{
	if (iParam0 == 2)
...
BOOL func_221(Any* panParam0, int iParam1, int iParam2) // Position - 0x7353
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_222() // Position - 0x738A
{
	return Global_1102813.f_3672;
}

BOOL func_223(BOOL bParam0) // Position - 0x7399
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_224(Hash hParam0) // Position - 0x73AF
{
	return hParam0 != 0;
}

BOOL func_225(int iParam0, int iParam1, Any* panParam2) // Position - 0x73BB
{
...
void func_226(Any* panParam0, int iParam1, var uParam2) // Position - 0x73EF
{
	var unk;
...
BOOL func_227(int iParam0) // Position - 0x7469
{
	switch (iParam0)
	{
		case 2:
...
int func_228(int iParam0) // Position - 0x74A8
{
	switch (iParam0)
	{
		case 2:
...
void func_229(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x753E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_230(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x7FDB
{
	float num;
	float num2;
	float num3;
...
int func_231(int iParam0) // Position - 0x8045
{
...
void func_232(int iParam0) // Position - 0x8562
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_233(var uParam0, var uParam1) // Position - 0x8573
{
	var unk;
...
int func_234(int iParam0) // Position - 0x859F
{
	int num;
...
BOOL func_235(int iParam0, var uParam1, Any* panParam2) // Position - 0x8714
{
	if (!func_206(iParam0))
		return false;
...
void func_236(Any* panParam0) // Position - 0x881F
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
