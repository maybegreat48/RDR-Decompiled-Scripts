...
BOOL func_188(var uParam0, int iParam1, int iParam2) // Position - 0x64BF
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_195(var uParam0, int iParam1, int iParam2) // Position - 0x65B5
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_219(var uParam0, int iParam1, int iParam2) // Position - 0x72D4
{
