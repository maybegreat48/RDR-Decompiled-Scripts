...
void _DEBUG_PRINT(int iParam0) // Position - 0x8CE
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x8DA
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x8E7
{
	return;
}

BOOL func_17(int iParam0) // Position - 0x8EF
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x8FC
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x908
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x91D
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x92E
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x96D
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x979
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x981
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0xA31
{
	return;
}

void func_26() // Position - 0xA39
{
	return;
}

void func_27() // Position - 0xA41
{
	return;
}

void func_28() // Position - 0xA49
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xA51
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0xA5D
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0xA69
{
	return;
}

void func_32() // Position - 0xA71
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0xA79
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xA85
{
...
void func_35(var uParam0) // Position - 0xAB6
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xAFC
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xB11
{
	if (!func_59(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xB2A
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xB3B
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xB53
{
	BOOL flag;
	BOOL flag2;
...
void func_41(var uParam0, int iParam1) // Position - 0xBD8
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xD17
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xD24
{
...
BOOL func_44(int iParam0) // Position - 0xD5A
{
	if (iParam0 == 0)
	{
		func_80();
...
int func_45() // Position - 0xE6E
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xE7C
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xE88
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xEF5
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xFD5
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xFF3
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x1006
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1024
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x111C
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x112D
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x1141
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x1155
{
	return uParam0;
}

void func_58(var uParam0, Volume volParam1, int iParam2) // Position - 0x115F
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_59(int iParam0) // Position - 0x11B8
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_60() // Position - 0x11CE
{
	int i;
...
BOOL func_62() // Position - 0x120F
{
	return func_98(Global_1572887.f_8, true);
}

BOOL func_63() // Position - 0x1222
{
	return Global_1048577;
}

BOOL func_64(int iParam0) // Position - 0x122E
{
	return func_99(&(Global_3145858.f_6), iParam0);
}

BOOL func_65(int iParam0) // Position - 0x1242
{
	return !func_100(iParam0);
}

void func_66(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1251
{
	Ped ped;
...
void func_67(int iParam0, BOOL bParam1) // Position - 0x12EF
{
	var unk;
	float num;
...
BOOL func_68(int iParam0, int iParam1) // Position - 0x1384
{
	return iParam0 && iParam1 != false;
}

BOOL func_69(var uParam0, int iParam1) // Position - 0x1393
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_70() // Position - 0x13A4
{
	return func_68(Global_1940199, 8192);
}

BOOL func_71(var uParam0, int iParam1) // Position - 0x13B7
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_72(int iParam0) // Position - 0x13C8
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_73(int iParam0, int iParam1) // Position - 0x1408
{
...
int func_74() // Position - 0x1435
{
	return Global_1896646.f_41;
}

void func_75(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1443
{
	BOOL flag;
	...
	StringToTest = func_110(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_122(&unk, joaat("COLOR_PURE_WHITE")), str3, func_122(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_122(&unk, joaat("COLOR_PURE_WHITE")), func_122(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_123(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_76(var uParam0, int iParam1) // Position - 0x16A8
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_77(int iParam0, BOOL bParam1) // Position - 0x16BB
{
...
void func_78(BOOL bParam0) // Position - 0x1D24
{
	if (bParam0)
...
BOOL func_79(int iParam0) // Position - 0x1D4D
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_80() // Position - 0x1D92
{
	return;
}

Hash func_81(int iParam0, BOOL bParam1) // Position - 0x1D9A
{
	switch (iParam0)
	{
		case 0:
...
void func_82(int iParam0, BOOL bParam1) // Position - 0x255F
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_83(BOOL bParam0) // Position - 0x25B2
{
	if (bParam0)
...
void _DEBUG_PRINT_0_0_0_0_0_0(int iParam0) // Position - 0x25DB
{
	iParam0 = iParam0;
	return;
}

void func_85(int iParam0) // Position - 0x25E7
{
	int i;
...
void func_86(int iParam0) // Position - 0x2618
{
	int i;
...
BOOL func_87(int iParam0, BOOL bParam1) // Position - 0x264B
{
	int num;
	int num2;
	int num3;
...
BOOL func_88(int iParam0) // Position - 0x2701
{
	int i;
...
BOOL func_89(int iParam0, BOOL bParam1) // Position - 0x277B
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_90(int iParam0) // Position - 0x27AC
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_91(int iParam0) // Position - 0x27CD
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_92(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2820
{
	BOOL flag;
...
BOOL func_93(int iParam0) // Position - 0x2EE0
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_94(int iParam0) // Position - 0x2EF7
{
	switch (iParam0)
	{
		case 64:
...
int func_95(int iParam0, BOOL bParam1) // Position - 0x2F3A
{
	if (!func_93(iParam0))
		return 0;
...
BOOL func_96(int iParam0) // Position - 0x3025
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_97(int iParam0) // Position - 0x303B
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_98(BOOL bParam0, BOOL bParam1) // Position - 0x3051
{
	return bParam0 && bParam1 != false;
}

BOOL func_99(var uParam0, int iParam1) // Position - 0x3060
{
	int num;
	int offset;
...
BOOL func_100(int iParam0) // Position - 0x3084
{
	return func_142(1, iParam0);
}

void func_101(var uParam0, var uParam1) // Position - 0x3093
{
...
BOOL func_102(Vector3* pvParam0, float* pfParam1) // Position - 0x30B3
{
	Hash* p_hash;
	int MaxInt;
	...
	else
	{
		...
		if (func_146(p_hash, randomIntInRange, pvParam0, pfParam1))
			return true;
	}
...
int func_103(int iParam0) // Position - 0x3103
{
...
BOOL func_104(int iParam0, var uParam1) // Position - 0x3120
{
	var ReturnZ;
	float volumeScale;
	float num;
...
void func_105(var uParam0, var uParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x3225
{
	if (func_148(255) == 4)
		return;
...
int func_106(int iParam0) // Position - 0x335D
{
...
void func_107(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0x337A
{
	var entityCoords;
	float num;
...
BOOL func_108(int iParam0) // Position - 0x33D5
{
...
const char* func_110(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x344D
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_160(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_162(func_161(Global_34));
...
BOOL func_111(int iParam0) // Position - 0x3EB1
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_112(int iParam0) // Position - 0x3EC6
{
	switch (iParam0)
	{
		case 0:
...
Hash func_113(int iParam0) // Position - 0x3F81
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_114(int iParam0) // Position - 0x3FEF
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_115(int iParam0) // Position - 0x4154
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_116(int iParam0, BOOL bParam1) // Position - 0x418F
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_117(int iParam0, int iParam1) // Position - 0x41D1
{
	if (!func_111(iParam0))
		return false;
...
int func_118() // Position - 0x4216
{
	return Global_1902569;
}

int func_119(int iParam0) // Position - 0x4222
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_120(int iParam0) // Position - 0x4235
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_121(float fParam0) // Position - 0x4247
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_122(var uParam0, int iParam1) // Position - 0x425D
{
...
int func_123(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4293
{
	int duration;
	var data;
	int num;
...
BOOL func_124(int iParam0) // Position - 0x42D6
{
	if (func_163(iParam0))
		if (!func_164(44))
			return false;
...
void func_125(int iParam0, int iParam1) // Position - 0x42F6
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_126(int iParam0, int iParam1) // Position - 0x4307
{
	int num;
...
void func_127(var uParam0, var uParam1, int iParam2) // Position - 0x431D
{
...
void func_128(int iParam0) // Position - 0x433A
{
...
void func_129(int iParam0) // Position - 0x441A
{
	int i;
	int num;
...
BOOL func_130(int iParam0, BOOL bParam1) // Position - 0x45F2
{
	if (func_45() != -1)
		return false;
...
int func_131(int iParam0, BOOL bParam1) // Position - 0x4620
{
	if (!func_93(iParam0))
		return 0;
...
int func_132(int iParam0) // Position - 0x46A3
{
	switch (iParam0)
	{
		case 27:
...
int func_133(int iParam0) // Position - 0x46CA
{
	switch (iParam0)
	{
		case 33:
...
void func_136(int iParam0, BOOL bParam1) // Position - 0x492D
{
	BOOL flag;
...
Hash func_137(int iParam0) // Position - 0x4CDC
{
	if (!func_93(iParam0))
		return 0;
...
void func_138(int iParam0, PersChar pchParam1) // Position - 0x4CFA
{
	if (!func_93(iParam0))
		return;
...
PersChar func_139(int iParam0) // Position - 0x4D1B
{
	if (!func_93(iParam0))
		return 0;
...
void func_140(int iParam0, BOOL bParam1) // Position - 0x4D3B
{
	if (func_45() != -1)
		return;
...
BOOL func_141(int iParam0) // Position - 0x4D74
{
	if (!func_93(iParam0))
		return false;
...
BOOL func_142(int iParam0, int iParam1) // Position - 0x4D9A
{
	int num;
...
BOOL func_143(var uParam0, var uParam1) // Position - 0x4E0E
{
	BOOL flag;
...
int func_144(var uParam0) // Position - 0x4F13
{
	int num;
...
int func_145(Hash* phParam0) // Position - 0x5060
{
	Any any;
...
BOOL func_146(Hash* phParam0, int iParam1, Vector3* pvParam2, float* pfParam3) // Position - 0x508C
{
	Any any;
...
BOOL func_147(int* piParam0, int iParam1, int iParam2) // Position - 0x50EE
{
	int num;
	int offset;
	BOOL isBitSet;
...
int func_148(int iParam0) // Position - 0x5121
{
	if (iParam0 == 255)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x516C
{
...
void func_150(var uParam0) // Position - 0x5196
{
	var unk;
...
void func_151(float* pfParam0) // Position - 0x51A8
{
	var unk;
...
void func_153(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x5210
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_154(int* piParam0, int iParam1, int iParam2) // Position - 0x523D
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_155(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0x526F
{
	Hash* p_hash;
	int MaxInt;
	int randomIntInRange;

	p_hash = Global_1072759.f_23824.f_383[func_199(uParam0) /*272*/];
	MaxInt = func_145(p_hash);
	...
	else
	{
		...
		if (func_146(p_hash, randomIntInRange, pvParam3, pfParam4))
			return true;
	}
...
void func_156(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13) // Position - 0x52C0
{
	if (func_148(255) == 4)
		return;
...
BOOL func_157() // Position - 0x5495
{
	return false;
}

BOOL func_158() // Position - 0x549E
{
	var unk;
	var unk3;
...
BOOL func_159(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5506
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_160(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x567C
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_161(var uParam0, var uParam1, var uParam2) // Position - 0x5690
{
	int i;
...
const char* func_162(int iParam0) // Position - 0x56BE
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_163(int iParam0) // Position - 0x59A2
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_164(int iParam0) // Position - 0x59CC
{
	if (!func_206(iParam0))
		return false;
...
struct<2> func_165(Player plParam0) // Position - 0x59E8
{
	var gamerHandle;
...
const char* func_166(const char* sParam0, int iParam1) // Position - 0x59FC
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_167(int iParam0, BOOL bParam1) // Position - 0x5A16
{
	char* StringToTest;
...
void func_168(int iParam0, BOOL bParam1) // Position - 0x5A4A
{
	switch (iParam0)
	{
		case 5:
...
void func_169(int iParam0, int iParam1) // Position - 0x5A7F
{
	func_208(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_170(int iParam0) // Position - 0x5A99
{
	if (!func_93(iParam0))
		return false;
...
void func_171(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5ABE
{
	PersChar persChar;
...
void func_172(int iParam0, BOOL bParam1) // Position - 0x5BAA
{
	if (!func_211(iParam0))
		return;
...
void func_173(int iParam0, int iParam1) // Position - 0x5C00
{
	if (!func_216(iParam0))
		return;
...
int func_174(int iParam0) // Position - 0x5C73
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_175(Hash hParam0) // Position - 0x5C89
{
...
void func_176(int iParam0) // Position - 0x5CA9
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_177(int iParam0, BOOL bParam1) // Position - 0x5CBF
{
	if (func_45() != -1)
		return;
...
void func_178(int iParam0) // Position - 0x5CF0
{
	Ped EntityIndex;
...
void func_179(int iParam0) // Position - 0x5D34
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_180(int iParam0) // Position - 0x5D49
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_181(int iParam0) // Position - 0x5D5E
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_182(int iParam0) // Position - 0x5D73
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_183(int iParam0) // Position - 0x5DF2
{
...
BOOL func_184(int iParam0, BOOL bParam1) // Position - 0x5E4F
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL func_185(int iParam0, int iParam1) // Position - 0x5E68
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_186(int iParam0, int iParam1) // Position - 0x5E81
{
...
int func_187(int iParam0) // Position - 0x5EBC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_188(int iParam0) // Position - 0x5ED0
{
	return;
}

BOOL func_189(int iParam0, int iParam1) // Position - 0x5ED8
{
	if (iParam0 == -1)
		return false;
...
BOOL func_190(int* piParam0, int iParam1, int iParam2) // Position - 0x5EFF
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_191() // Position - 0x5F36
{
	return Global_1102813.f_3672;
}

void func_192(var uParam0) // Position - 0x5F45
{
	var unk;
...
int func_193(var uParam0) // Position - 0x5F84
{
	*uParam0 = 1;
...
BOOL func_194(Ped pedParam0, var uParam1) // Position - 0x5FC9
{
...
BOOL func_195(var uParam0, var uParam1) // Position - 0x6189
{
	switch (*uParam0)
	{
		case 3:
...
int func_196(var uParam0) // Position - 0x61CB
{
	BOOL flag;
	int num;
	int num2;
...
int func_197(var uParam0) // Position - 0x63A7
{
	BOOL flag;
...
int func_198(var uParam0) // Position - 0x681F
{
	BOOL flag;
	BOOL flag2;
	int relationshipBetweenGroups;
...
int func_199(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x6C47
{
	int i;
	int num;
	float num2;
...
void func_200(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x6CA4
{
	func_222(iParam0);
...
struct<2> func_202() // Position - 0x6D5E
{
	return Global_1051268;
}

BOOL func_203(var uParam0, var uParam1) // Position - 0x6D6C
{
	if (!func_228(uParam0))
		return false;
...
struct<2> func_204() // Position - 0x6DA0
{
...
BOOL func_205(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x6DEB
{
	var unk;
	float num;
	float num2;
...
BOOL func_206(int iParam0) // Position - 0x6E1B
{
	if (iParam0 == 0)
		return false;
...
BOOL func_207(int iParam0) // Position - 0x6E2E
{
	int num;
	int num2;
	int offset;
...
void func_208(BOOL bParam0, int iParam1) // Position - 0x6E58
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_209(int iParam0) // Position - 0x6E6D
{
	if (!func_93(iParam0))
		return false;
...
BOOL func_210(Hash hParam0) // Position - 0x6E91
{
	return hParam0 != 0;
}

BOOL func_211(int iParam0) // Position - 0x6E9D
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_212(int iParam0, BOOL bParam1) // Position - 0x6EB3
{
	if (!func_211(iParam0))
		return false;
...
void func_213(int iParam0, BOOL bParam1) // Position - 0x6ED9
{
	if (!func_211(iParam0))
		return;
...
void func_214(int iParam0, BOOL bParam1) // Position - 0x6F07
{
	if (!func_211(iParam0))
		return;
...
void func_215(int iParam0) // Position - 0x6F41
{
	func_233(func_232(iParam0));
	return;
}

BOOL func_216(int iParam0) // Position - 0x6F53
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_217(Hash hParam0) // Position - 0x6F69
{
	if (func_234(hParam0))
...
BOOL func_218() // Position - 0x6F84
{
	return 1;
}

Ped func_219(int iParam0) // Position - 0x6F8D
{
	PersChar persChar;
...
void func_220(var uParam0) // Position - 0x6FBB
{
	var unk;
...
var func_221(var uParam0) // Position - 0x6FE5
{
	return uParam0;
}

void func_222(int iParam0) // Position - 0x6FEF
{
	Global_1102813.f_26.f_12 = iParam0;
	return;
}

BOOL func_223(int iParam0) // Position - 0x7001
{
	return Global_1102813.f_26.f_7 && iParam0 != false;
}

BOOL func_224(BOOL bParam0) // Position - 0x7016
{
	return Global_1102813.f_26.f_9 && bParam0 != false;
}

BOOL func_225(int iParam0) // Position - 0x702B
{
	return Global_1102813.f_4[Global_1106895[iParam0 /*2*/]] && Global_1106895[iParam0 /*2*/].f_1 == Global_1106895[iParam0 /*2*/].f_1;
}

int func_226() // Position - 0x7059
{
	if (Global_1102813 <= 5)
...
void func_227(BOOL bParam0) // Position - 0x708C
{
	if (func_235(bParam0))
		return;
...
BOOL func_228(int iParam0) // Position - 0x70B3
{
	switch (iParam0)
	{
		case 2:
...
int func_229(int iParam0) // Position - 0x70F2
{
	switch (iParam0)
	{
		case 2:
...
void func_230(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7188
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_231(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x7C25
{
	float num;
	float num2;
	float num3;
...
int func_232(int iParam0) // Position - 0x7C8B
{
...
void func_233(int iParam0) // Position - 0x8500
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_234(Hash hParam0) // Position - 0x8511
{
	return hParam0 != 0;
}

BOOL func_235(BOOL bParam0) // Position - 0x851D
{
