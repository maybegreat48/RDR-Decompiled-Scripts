...
int func_1(var uParam0) // Position - 0x47F
{
	if (func_37() == -1)
		func_38();
...
void func_3(var uParam0) // Position - 0x557
{
	ATTRIBUTE::STOP_ITEM_PREVIEW();
	Global_1940252.f_7 = 0;
...
void func_4(BOOL bParam0) // Position - 0x5C6
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
void func_7(int iParam0) // Position - 0xB93
{
	Global_1940252.f_11561 = Global_1940252.f_11561 || iParam0;
	return;
}

BOOL func_8(int iParam0) // Position - 0xBAC
{
	return func_89(Global_1940085.f_7, iParam0);
}

void func_9(BOOL bParam0, int iParam1) // Position - 0xBC0
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
int func_10(Hash hParam0, int iParam1) // Position - 0xBE2
{
	var unk;
	int num;
	int i;
...
void func_11(Hash hParam0) // Position - 0xC2C
{
	int num;
...
BOOL func_12(Ped pedParam0) // Position - 0xC7F
{
	var lootTarget;
...
void func_15(int iParam0) // Position - 0xDC5
{
	func_99(0);
...
BOOL func_16() // Position - 0xDDB
{
	return Global_1940252.f_41.f_203 <= 0;
}

BOOL func_17(Hash hParam0, int iParam1) // Position - 0xDED
{
	if (hParam0 == 0)
		return false;
...
void func_18(int iParam0, var uParam1, int iParam2) // Position - 0xE07
{
	Hash hash;
...
BOOL func_19(Hash hParam0, Hash hParam1) // Position - 0xEB4
{
...
void func_20(int iParam0, var uParam1) // Position - 0xEF5
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
BOOL func_22(var uParam0) // Position - 0x14AB
{
	Hash hash;
	Any dataContainerFromChildIndex;
	Hash hash2;
...
BOOL func_23(Hash hParam0) // Position - 0x155D
{
	return hParam0 != 0;
}

void func_24(int iParam0) // Position - 0x1569
{
	Global_1940252.f_11 = iParam0;
	return;
}

void func_25(int iParam0, var uParam1) // Position - 0x1579
{
...
void func_27(int iParam0) // Position - 0x161A
{
...
BOOL func_31(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1689
{
	int num;
	var unk10;
...
BOOL func_33(BOOL bParam0) // Position - 0x203F
{
	if (bParam0)
...
void func_34(var uParam0) // Position - 0x206F
{
	Hash hash;
	Hash hash2;
	BOOL flag;
...
void func_35(Hash hParam0, int iParam1) // Position - 0x22F5
{
	if (!func_17(hParam0, 0))
		return;
...
void func_36(Hash hParam0) // Position - 0x23B8
{
	func_35(hParam0, func_185(func_174(0), hParam0, false, true, true));
	return;
}

int func_37() // Position - 0x23D4
{
	return Global_1572887.f_14;
}

void func_38() // Position - 0x23E2
{
...
int func_39(var uParam0) // Position - 0x2405
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
Hash func_40(int iParam0) // Position - 0x2863
{
	switch (iParam0)
	{
		case -2074770370:
...
Hash func_41(int iParam0) // Position - 0x29A5
{
	switch (iParam0)
	{
		case -2074770370:
...
BOOL func_44(int iParam0) // Position - 0x2B19
{
	if (func_195())
...
int func_45(int iParam0) // Position - 0x2B39
{
	switch (iParam0)
	{
		case -2074770370:
...
void func_46(int iParam0) // Position - 0x2BB2
{
	Global_1940252.f_40 = iParam0;
	return;
}

void func_47(int iParam0) // Position - 0x2BC2
{
	Global_1940252.f_39 = iParam0;
	return;
}

void func_48(int iParam0) // Position - 0x2BD2
{
	Global_1940252.f_12 = iParam0;
	return;
}

void func_49(var uParam0) // Position - 0x2BE2
{
	int num;
...
void func_50(int iParam0) // Position - 0x2C46
{
...
void func_53() // Position - 0x2CB4
{
	...
	EntityIndex = HUD::_0x0501D52D24EA8934(1);

	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex))
	{
		if (func_217(EntityIndex))
		{
			switch (ENTITY::GET_ENTITY_MODEL(EntityIndex))
			{
		...
		if (PED::_IS_META_PED_USING_COMPONENT(EntityIndex, 149557334))
			Global_1940085.f_7 = Global_1940085.f_7 - Global_1940085.f_7 & 8388608;
	
		if (!PED::IS_PED_RAGDOLL(EntityIndex) && PED::IS_PED_ON_VEHICLE(EntityIndex, false))
			Global_1940085.f_7 = Global_1940085.f_7 - Global_1940085.f_7 & 8388608;
	}
	else
	{
...
BOOL func_54(int iParam0) // Position - 0x3654
{
	return func_112(iParam0);
}

int func_55() // Position - 0x3662
{
	return 1039655040;
}

BOOL func_56(int iParam0, function funcParam1) // Position - 0x366F
{
	if (func_63(iParam0))
	{
		func_61(iParam0);
...
int func_57() // Position - 0x36B0
{
	return 1039645911;
}

int func_58() // Position - 0x36BD
{
	return 1031256086;
}

int func_59() // Position - 0x36CA
{
	return 1011329046;
}

BOOL func_60() // Position - 0x36D7
{
	return func_223();
}

void func_61(int iParam0) // Position - 0x36E3
{
	func_224(&(Global_1940085.f_38), iParam0);
	return;
}

BOOL func_62(int iParam0) // Position - 0x36F7
{
	return func_226(func_225(iParam0));
}

BOOL func_63(int iParam0) // Position - 0x3709
{
	return Global_1940085.f_39 && iParam0 != false;
}

int func_64() // Position - 0x371C
{
	return func_227();
}

BOOL func_65(BOOL bParam0, int iParam1) // Position - 0x3728
{
	Ped mount;
...
void func_66(int iParam0) // Position - 0x3B64
{
	func_236(&(Global_1940085.f_38), iParam0);
	return;
}

int func_67() // Position - 0x3B78
{
	return 1039392896;
}

int func_68() // Position - 0x3B85
{
	return 1037746167;
}

int func_69() // Position - 0x3B92
{
	return 1037647863;
}

int func_70() // Position - 0x3B9F
{
	return 225949718;
}

int func_71() // Position - 0x3BAC
{
	return 1037713383;
}

BOOL func_72() // Position - 0x3BB9
{
	return Global_1940085.f_10;
}

BOOL func_73() // Position - 0x3BC7
{
	return Global_1940085.f_11;
}

BOOL func_74() // Position - 0x3BD5
{
	return Global_1940085.f_12;
}

BOOL func_75() // Position - 0x3BE3
{
	return Global_1940085.f_13;
}

BOOL func_76() // Position - 0x3BF1
{
	return Global_1940252.f_2 || Global_1940252 == 1;
}

int func_77() // Position - 0x3C0B
{
	return 1039902720;
}

int func_78() // Position - 0x3C18
{
	return 1039907016;
}

int func_79() // Position - 0x3C25
{
	return 1039902864;
}

int func_80() // Position - 0x3C32
{
	return 1022861303;
}

int func_81() // Position - 0x3C3F
{
	return 955497620;
}

int func_82() // Position - 0x3C4C
{
	return 1038298244;
}

int func_83() // Position - 0x3C59
{
	return 1039902864;
}

int func_84() // Position - 0x3C66
{
	return 905165831;
}

int func_85() // Position - 0x3C73
{
	return 1039657088;
}

void func_86() // Position - 0x3C80
{
	Global_1940085.f_39 = 0;
	return;
}

BOOL func_87() // Position - 0x3C8F
{
	int num;
...
void func_88(BOOL bParam0, BOOL bParam1, int iParam2) // Position - 0x3CCB
{
...
BOOL func_89(int iParam0, int iParam1) // Position - 0x3D05
{
	return iParam0 && iParam1 != false;
}

int func_90(int iParam0) // Position - 0x3D14
{
	switch (iParam0)
	{
		case -889932290:
...
void func_91(int* piParam0, int iParam1) // Position - 0x3D39
{
	var unk;
	int i;
...
void func_92(int iParam0) // Position - 0x3DF2
{
...
Ped func_94(int iParam0) // Position - 0x3F6E
{
...
BOOL func_95(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x3F9A
{
...
int func_96(int iParam0) // Position - 0x4004
{
	Ped EntityIndex;
...
int func_97(int iParam0) // Position - 0x4058
{
	Ped EntityIndex;
	var entityCoords;
	var entityCoords2;
...
BOOL func_98(int iParam0, Hash hParam1) // Position - 0x40F2
{
...
void func_99(int iParam0) // Position - 0x4136
{
	Global_1940252.f_11645 = iParam0;
	return;
}

void func_100(int iParam0) // Position - 0x4147
{
	if (!func_17(Global_1940252.f_11588, 0))
...
Hash func_101(var uParam0) // Position - 0x41CC
{
	Hash hash;
	Hash hash2;
...
Hash func_102(Any anParam0) // Position - 0x4249
{
	Any any;
...
void func_103(Hash hParam0, var uParam1) // Position - 0x425D
{
	BOOL flag;
	int num;
	int num2;
...
void func_104(int iParam0, Hash hParam1) // Position - 0x4C8B
{
...
Hash func_105(Hash hParam0) // Position - 0x4D02
{
	return hParam0;
}

BOOL func_106(Hash hParam0, Hash hParam1) // Position - 0x4D0C
{
...
void func_107(Hash hParam0, var uParam1) // Position - 0x4D42
{
...
int func_109(Hash hParam0, Hash hParam1) // Position - 0x4FDC
{
...
BOOL func_111(Hash hParam0, Any anParam1) // Position - 0x515B
{
	return ITEMDATABASE::_0xF8D09EF8CE61D7BF(hParam0, anParam1);
}

BOOL func_112(int iParam0) // Position - 0x516B
{
	return func_89(Global_1940085.f_38, iParam0);
}

int func_113() // Position - 0x517F
{
	var unk;
	Hash hash;
	int num;
...
BOOL func_114() // Position - 0x52AE
{
	return Global_1940252.f_10;
}

void func_115(Hash hParam0) // Position - 0x52BC
{
	Global_1940252.f_11588 = hParam0;
	return;
}

void func_116(int iParam0, var uParam1, Any* panParam2, int iParam3) // Position - 0x52CD
{
	int i;
	int num;
...
BOOL func_121(int iParam0, var uParam1, Any* panParam2, int iParam3) // Position - 0x5866
{
	int i;
	int num;
...
void func_125(int iParam0, var uParam1) // Position - 0x5A04
{
...
void func_126(int iParam0) // Position - 0x5A4E
{
	int num;
	Any dataContainerFromChildIndex;
...
BOOL func_127(Ped pedParam0, int iParam1) // Position - 0x5B4F
{
	int num;
...
BOOL func_128(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5C4E
{
	int num;
	var unk;
	var unk6;
...
BOOL func_129(Hash hParam0, BOOL bParam1) // Position - 0x5CC6
{
	BOOL flag;
	int num;
...
BOOL func_130(Hash hParam0) // Position - 0x5D98
{
	if (func_140(hParam0))
		return false;
...
BOOL func_131(Hash hParam0) // Position - 0x5E17
{
	var unk;
...
void func_134(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x5E59
{
	return;
}

BOOL func_135(Hash hParam0) // Position - 0x5E61
{
...
BOOL func_136(Hash hParam0) // Position - 0x5E9A
{
...
BOOL func_137(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5EC9
{
...
void func_138(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, int iParam16) // Position - 0x62E6
{
	int i;
...
BOOL func_139() // Position - 0x6382
{
	return Global_1893611 & 2 != 0;
}

BOOL func_140(Hash hParam0) // Position - 0x6392
{
	if (!func_17(hParam0, 0))
		return false;
...
int func_141(int iParam0) // Position - 0x63BC
{
	return func_348(iParam0);
}

int func_142(Hash hParam0) // Position - 0x63CA
{
	var unk;
...
BOOL func_143(Hash hParam0) // Position - 0x63F5
{
	if (hParam0 == 0)
		return false;
...
int func_144(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x6424
{
	int num;
	var unk13;
	int num2;
...
int func_145(Hash hParam0) // Position - 0x645F
{
	var unk;
...
BOOL func_147(Player plParam0) // Position - 0x653D
{
	Ped playerPed;
	Ped mountOwnedByPlayer;
...
void func_148(int iParam0, Hash hParam1, int iParam2, Ped pedParam3, BOOL bParam4) // Position - 0x656F
{
	int num;
...
int func_149(Hash hParam0, BOOL bParam1) // Position - 0x65A1
{
	int num;
...
void func_150(Hash hParam0) // Position - 0x6618
{
	int num;
	Hash hash;
...
int func_151(Ped pedParam0, Hash hParam1, Hash hParam2, Hash hParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0x676E
{
	var unk;
	int num;
...
void func_152(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x68C7
{
	var unk;
	var guid;
...
Hash func_153(int iParam0, BOOL bParam1) // Position - 0x6917
{
	int i;
	Hash hash;
	Hash hash2;
...
BOOL func_154(int iParam0, Hash hParam1) // Position - 0x69D2
{
	Ped EntityIndex;
...
BOOL func_155(int iParam0) // Position - 0x6A79
{
	Ped EntityIndex;
...
BOOL func_157(int iParam0, int iParam1) // Position - 0x6BC9
{
	Any gangId;
...
int func_158(int iParam0, BOOL bParam1) // Position - 0x6C89
{
	if (bParam1)
		func_386();
...
BOOL func_159(int iParam0) // Position - 0x6CC5
{
	return func_89(Global_1147183.f_8, iParam0);
}

BOOL func_160() // Position - 0x6CD9
{
	int num;
...
void func_162(Any anParam0) // Position - 0x6DAB
{
	var unk;
...
Hash func_163(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x6DF0
{
...
void func_164(int iParam0, BOOL bParam1) // Position - 0x6E32
{
	int num;
	int num2;
...
void func_165(BOOL bParam0) // Position - 0x6E5F
{
...
struct<5> func_167(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x6EAE
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_168(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x7222
{
	var outGuid;
...
BOOL func_169(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x7253
{
	var unk;
...
BOOL func_170(BOOL bParam0) // Position - 0x72C7
{
	if (func_37() == -1)
		return true;
...
int func_172(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x7330
{
	int num;
	int num2;
	Hash hash;
...
BOOL func_173(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x740C
{
...
Ped func_174(int iParam0) // Position - 0x7482
{
	return PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::GET_PLAYER_INDEX());
}

Ped func_175(Ped pedParam0) // Position - 0x7492
{
	return pedParam0;
}

int func_176(Hash hParam0, Ped pedParam1) // Position - 0x749C
{
	if (func_37() == -1)
	{
...
BOOL func_177(Hash hParam0) // Position - 0x74DB
{
...
BOOL func_178() // Position - 0x7508
{
	return Global_17418.f_2992.f_21;
}

BOOL func_179(Hash hParam0) // Position - 0x7518
{
...
void func_180() // Position - 0x7532
{
	func_421(&(Global_17418.f_2992), 3);
	return;
}

BOOL func_181(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x7545
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_182() // Position - 0x76F7
{
	return Global_1940252.f_11587;
}

BOOL func_183(Hash hParam0, int iParam1, Ped pedParam2, BOOL bParam3, Hash hParam4) // Position - 0x7706
{
...
BOOL func_184(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, Hash hParam4) // Position - 0x7739
{
	if (hParam0 == 0)
		return false;
...
int func_185(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7780
{
	int num;
...
int func_186(Hash hParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5) // Position - 0x77B5
{
	int num;
	BOOL flag;
...
void func_189(Hash hParam0) // Position - 0x7904
{
...
BOOL func_190(Hash hParam0) // Position - 0x7AD8
{
	var unk;
...
int func_191(Hash hParam0, char* sParam1, Hash hParam2, char* sParam3, Hash hParam4) // Position - 0x7AE8
{
	int num;
	Hash hash;
...
void func_192(int iParam0) // Position - 0x7B61
{
	Hash hash;
...
void func_193(int iParam0, var uParam1, BOOL bParam2) // Position - 0x7BC9
{
	func_192(iParam0);
...
BOOL func_195() // Position - 0x7C76
{
	return Global_1915656.f_20637 || Global_1915656.f_22504.f_1;
}

void func_196() // Position - 0x7C94
{
	if (Global_1572887.f_14 == -1)
		return;
...
void func_197(var uParam0) // Position - 0x7CB0
{
...
BOOL func_198(BOOL bParam0, BOOL bParam1) // Position - 0x7CF4
{
	int i;
...
int func_199(BOOL bParam0) // Position - 0x7DD4
{
	if (func_37() == -1)
	{
...
BOOL func_200(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7E15
{
	int num;
	int size;
	int i;
...
void func_201(int iParam0) // Position - 0x800B
{
...
BOOL func_202(Ped pedParam0) // Position - 0x80F8
{
	return func_451(pedParam0, 4) || func_451(pedParam0, 5);
}

BOOL func_203(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x8114
{
...
BOOL func_204(Ped pedParam0) // Position - 0x813D
{
...
BOOL func_205(BOOL bParam0) // Position - 0x8233
{
	Player player;
	Player player2;
...
BOOL func_206(int iParam0, int iParam1) // Position - 0x84CA
{
	return DATABINDING::_DATABINDING_READ_DATA_BOOL(Global_1940252.f_1556.f_44.f_87);
}

BOOL func_207(BOOL bParam0) // Position - 0x84E1
{
...
BOOL func_208(BOOL bParam0) // Position - 0x85C0
{
...
BOOL func_209(BOOL bParam0) // Position - 0x8727
{
...
BOOL func_211() // Position - 0x87AB
{
	return Global_1235687.f_9478 != -1;
}

BOOL func_212(int iParam0, int iParam1) // Position - 0x87BC
{
...
BOOL func_213() // Position - 0x8807
{
	return PED::_GET_PLAYER_PED_WATER_DEPTH(Global_33) >= 1f;
}

BOOL func_214(BOOL bParam0) // Position - 0x8818
{
	Player EntityIndex;

	EntityIndex = _INVALID_PLAYER_INDEX();

	if (TASK::_0x756C7B4C43DF0422(1))
		EntityIndex = TASK::_0x351F74ED6177EBE7();
	else
		EntityIndex = HUD::_0x0501D52D24EA8934(1);
	...
	if (!ENTITY::IS_ENTITY_DEAD(EntityIndex) && !TASK::IS_PED_IN_WRITHE(EntityIndex))
	{
		if (bParam0)
			func_144("ITEM_UNUSABLE_NOT_DYING_HORSE", 10000, 0, 0, 0, true);
...
BOOL func_215(BOOL bParam0) // Position - 0x88DA
{
	Player outEntity;
	Player PedIndex;
	...
	PedIndex = HUD::_0x0501D52D24EA8934(1);

	if (!func_217(PedIndex))
	{
		if (bParam0)
			func_144("ITEM_UNUSABLE_NOT_A_HORSE", 10000, 0, 0, 0, true);
	...
	if (TASK::IS_PED_IN_WRITHE(PedIndex))
	{
		if (bParam0)
			func_144("ITEM_UNUSABLE_DYING_HORSE", 10000, 0, 0, 0, true);
	...
	if (ENTITY::DOES_ENTITY_EXIST(PED::_GET_VEHICLE_DRAFT_HORSE_IS_ATTACHED_TO(PedIndex)))
	{
		if (bParam0)
			func_144("ITEM_UNUSABLE_NOT_ILO_HORSE", 10000, 0, 0, 0, true);
	...
	if (!PED::IS_ANIMAL_INTERACTION_POSSIBLE(Global_33, PedIndex))
	{
		if (bParam0)
			func_144("ITEM_UNUSABLE_NOT_NEAR_HORSE", 10000, 0, 0, 0, true);
...
BOOL func_216(Ped pedParam0) // Position - 0x8A62
{
	return func_451(pedParam0, 7);
}

BOOL func_217(Player plParam0) // Position - 0x8A71
{
	Hash entityModel;
...
BOOL func_220(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8B15
{
	if (Global_1572887.f_14 != -1)
	{
...
BOOL func_221() // Position - 0x8C8B
{
	return Global_1913634.f_1578;
}

BOOL func_222() // Position - 0x8C9A
{
...
BOOL func_223() // Position - 0x8D04
{
	return Global_1953292.f_3502;
}

void func_224(int iParam0, int iParam1) // Position - 0x8D13
{
	func_462(iParam0, iParam1);
	return;
}

int func_225(int iParam0) // Position - 0x8D23
{
	switch (iParam0)
	{
		case -2061583405:
...
BOOL func_226(int iParam0) // Position - 0x8D7E
{
	return Global_1953292.f_3352.f_33.f_6 && iParam0 != false;
}

int func_227() // Position - 0x8D96
{
	return 1039645941;
}

BOOL func_228(int iParam0, int iParam1) // Position - 0x8DA3
{
	return iParam0 && iParam1 != false;
}

BOOL func_229(BOOL bParam0) // Position - 0x8DB2
{
	Entity entity;
...
BOOL func_230(BOOL bParam0, BOOL bParam1) // Position - 0x8E45
{
	var unk;
...
BOOL func_231(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x8E95
{
...
BOOL func_232(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x8F82
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		if (!PED::IS_PED_INJURED(pedParam0))
...
BOOL func_233(Ped pedParam0) // Position - 0x8FDB
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
BOOL func_234(Ped pedParam0, BOOL bParam1) // Position - 0x8FF8
{
	float entitySpeed;
	float num;
...
BOOL func_235(BOOL bParam0) // Position - 0x904E
{
	return Global_1958675 && bParam0 != false;
}

void func_236(int iParam0, int iParam1) // Position - 0x905F
{
	func_464(iParam0, iParam1);
	return;
}

BOOL func_237() // Position - 0x906F
{
...
void func_238(int iParam0) // Position - 0x90CE
{
	Global_1940252.f_10 = iParam0;
	return;
}

BOOL func_239(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x90DE
{
	if (iParam2 < 0)
		return false;
...
BOOL func_240(int iParam0) // Position - 0x9119
{
	switch (iParam0)
	{
		case -1649851713:
...
BOOL func_241(Hash hParam0, int iParam1) // Position - 0x9167
{
	return iParam1 == func_10(hParam0, 1224357681);
}

BOOL func_242(Hash hParam0) // Position - 0x917D
{
	int i;
...
void func_243(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13) // Position - 0x930E
{
	Hash hash;
	Hash dataContainerFromChildIndex;
	Hash hash2;
...
BOOL func_244(int iParam0) // Position - 0x943E
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_245(int iParam0, Ped pedParam1) // Position - 0x9454
{
	int num;
	var unk;
	float num2;
...
BOOL func_246(Ped pedParam0) // Position - 0x9504
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
BOOL func_247(int iParam0) // Position - 0x951F
{
...
float func_248(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9537
{
...
int func_249(int iParam0) // Position - 0x9560
{
	if (iParam0 == 7)
...
BOOL func_250(int iParam0) // Position - 0x9579
{
	iParam0 = func_249(iParam0);
...
float func_251(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x95B1
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_252(int iParam0) // Position - 0x95CF
{
	Ped modelHash;
	int num;
	...
	num5 = BUILTIN::TO_FLOAT(func_481(modelHash, num));
	num6 = BUILTIN::TO_FLOAT(func_481(modelHash, num3));
	num7 = num4 - num5;
	num8 = num6 - num5;
	num9 = num7 / num8;
...
BOOL func_253(int iParam0) // Position - 0x9687
{
	if (iParam0 < 0)
		return false;
...
BOOL func_254(char* sParam0, int iParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x96A8
{
...
Hash func_256(Hash hParam0) // Position - 0x9707
{
	int num;
...
int func_257(Hash hParam0) // Position - 0x9756
{
	switch (hParam0)
	{
...
BOOL func_258(int iParam0) // Position - 0x9931
{
	if (!func_485(iParam0))
		return false;
...
void func_259(Hash hParam0, var uParam1) // Position - 0x994F
{
	if (func_43())
	{
		func_487(true);
...
BOOL func_260(Hash hParam0) // Position - 0x99EB
{
	if (func_261())
		return 0;
...
BOOL func_261() // Position - 0x9A7A
{
	return Global_1940252.f_12;
}

int func_262(Hash hParam0, BOOL bParam1) // Position - 0x9A88
{
	if (!func_177(hParam0))
		return 0;
...
int func_263(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9B43
{
...
int func_264(Ped pedParam0, Hash hParam1) // Position - 0x9C05
{
	int num;
	int i;
...
int func_265(Hash hParam0, BOOL bParam1) // Position - 0x9C63
{
	if (!bParam1 || func_311())
...
int func_266(Hash hParam0, BOOL bParam1) // Position - 0x9C92
{
	var unk;
...
Hash func_267(Hash hParam0, BOOL bParam1) // Position - 0x9CB1
{
	Hash hash;
...
int func_268(Hash hParam0) // Position - 0x9CDF
{
	int num;
	Hash award;
	float num2;
...
Hash func_269(Hash hParam0) // Position - 0x9E3E
{
	switch (hParam0)
	{
...
int func_270(Hash hParam0, Hash hParam1) // Position - 0xB8B9
{
	int i;
	Hash currency;
	int awardItemCount;
...
BOOL func_271() // Position - 0xB919
{
	return Global_1156111.f_21645[64 /*209*/].f_208;
}

const char* func_272(const char* sParam0, int iParam1) // Position - 0xB92E
{
...
BOOL func_273(Hash hParam0, int iParam1) // Position - 0xB964
{
	if (iParam1 == 119)
...
int func_274() // Position - 0xB987
{
	return Global_1915656.f_20241;
}

BOOL func_275(Hash hParam0) // Position - 0xB996
{
	var unk;
	Hash hash;
	var unk2;
...
char* func_276(int iParam0) // Position - 0xBA80
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_278(int iParam0) // Position - 0xBB1E
{
	return iParam0 > -1 && iParam0 < 40;
}

int func_279(Hash hParam0) // Position - 0xBB34
{
	return func_270(hParam0, joaat("currency_cash"));
}

int func_280(Hash hParam0) // Position - 0xBB47
{
	var unk;
	int num;
	int i;
...
BOOL func_281(Hash hParam0, int iParam1) // Position - 0xBBD6
{
	if (hParam0 == 0)
		return false;
...
Hash func_282(Hash hParam0) // Position - 0xBBF0
{
	int num;
	Hash num2;
...
void func_283(var uParam0) // Position - 0xBC2A
{
	func_487(false);
...
BOOL func_284() // Position - 0xBC57
{
	return func_515(true);
}

struct<10> func_285(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0xBC64
{
	int num;
...
BOOL func_286(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0xBD38
{
...
Hash func_287(int iParam0, int iParam1) // Position - 0xBD59
{
	int num;
...
BOOL func_288(Hash hParam0) // Position - 0xBD9C
{
	Hash award;
...
Hash func_289(Hash hParam0) // Position - 0xBDD4
{
	if (!func_17(hParam0, 0))
		return 0;
...
int func_290(Hash hParam0) // Position - 0xBDF1
{
	int i;
...
BOOL func_291(int iParam0, int iParam1) // Position - 0xBE27
{
	return MISC::IS_BIT_SET(iParam0, iParam1);
}

void func_292(Hash hParam0) // Position - 0xBE37
{
	 Var0;
	var StringToTest;
	...
	if (!func_297(hParam0, &Var0, &StringToTest))
		return;
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&StringToTest))
		DATABINDING::_DATABINDING_WRITE_DATA_SCRIPT_VARIABLES(32768, num, 0, 1, 0, num2, num3, hParam0, &StringToTest);
	else
...
int func_293(int iParam0) // Position - 0xBEBB
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_294(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xBEDC
{
	int i;
...
BOOL func_295(Hash hParam0, int iParam1) // Position - 0xBF6B
{
	int num;
...
BOOL func_296(Hash hParam0) // Position - 0xBFEE
{
	return NETWORK::NETWORK_AWARD_HAS_REACHED_MAXCLAIM(func_499(hParam0, false));
}

BOOL func_297(Hash hParam0, var uParam1, var uParam2) // Position - 0xC003
{
	int i;
...
const char* func_298(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xC068
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

BOOL func_299(Any* panParam0, int iParam1) // Position - 0xC07C
{
	int num;
...
void func_300(Hash hParam0) // Position - 0xC169
{
	int num;
	BOOL flag;
	int i;
...
Hash func_302(Entity eParam0) // Position - 0xC252
{
	Hash hash;
...
int func_303(int iParam0, BOOL bParam1) // Position - 0xC2A5
{
	Ped mountOwnedByPlayer;
	int num;
...
int func_304(BOOL bParam0, BOOL bParam1) // Position - 0xC2E7
{
	int num;
	Ped ped;
	Ped ped2;
...
int func_305(BOOL bParam0) // Position - 0xC31A
{
	Vehicle vehicleOwnedByPlayer;
	int num;
	int num2;
...
BOOL func_306(int iParam0) // Position - 0xC3F6
{
	int i;
	Hash hash;
	int num;
...
void func_307(Hash hParam0) // Position - 0xC44F
{
	var unk;
	Hash hash;
	var unk15;
...
BOOL func_308(Hash hParam0) // Position - 0xC4DC
{
	Hash categoryItemSetBuyAward;
	var unk;
...
void func_309(Any* panParam0, int iParam1) // Position - 0xC524
{
	var unk;
	int i;
	int size;
...
void func_310(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, BOOL bParam14) // Position - 0xC5DD
{
	BOOL flag;
	Hash hash;
	BOOL flag2;
...
BOOL func_312(Vehicle veParam0) // Position - 0xC756
{
...
BOOL func_313(int iParam0, Vehicle veParam1) // Position - 0xC799
{
	int num;
	var unk;
	float num2;
...
void func_316(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC94F
{
	var unk;
...
int func_317(Hash hParam0, int iParam1) // Position - 0xC98C
{
	if (iParam1 == 0)
		return 0;
...
BOOL func_318(Hash hParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0xC9B8
{
	int num;
	var unk;
	int num2;
...
BOOL func_319(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6) // Position - 0xCAD0
{
	var unk;
	int num;
	var unk15;
...
int func_320(Hash hParam0) // Position - 0xCBEE
{
...
int func_321() // Position - 0xCDB5
{
	return Global_1915656.f_22504.f_5;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xCDC6
{
	var unk;
	int num;
...
void func_323(int iParam0) // Position - 0xD05F
{
	Global_1915656.f_22504.f_5 = iParam0;
	return;
}

int func_324(Hash hParam0) // Position - 0xD072
{
	int i;
...
int func_325(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD09E
{
	if (!func_555(iParam0))
		return 1;
...
void func_326(int iParam0) // Position - 0xD120
{
	Global_1940252.f_11599 = iParam0;
	return;
}

void func_327(Hash hParam0) // Position - 0xD131
{
	Global_1940252.f_11605 = hParam0;
	return;
}

BOOL func_328(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3, int iParam4) // Position - 0xD142
{
...
BOOL func_329() // Position - 0xD495
{
	return Global_1953292.f_1676.f_1[1 /*3*/].f_1 == joaat("pomade");
}

BOOL func_330(Ped pedParam0) // Position - 0xD4B1
{
	if (!ENTITY::DOES_ENTITY_EXIST(*pedParam0) || ENTITY::IS_ENTITY_DEAD(*pedParam0))
		return false;
...
void func_331(Hash hParam0) // Position - 0xD4EA
{
	Hash hash;
...
void func_332(Hash hParam0) // Position - 0xD584
{
	Hash hash;
...
void func_333(Hash hParam0, BOOL bParam1) // Position - 0xD604
{
	Hash hash;
...
void func_334(Hash hParam0, BOOL bParam1) // Position - 0xD6B1
{
	Hash hash;
...
void func_335(Hash hParam0) // Position - 0xD75E
{
	Hash hash;
...
void func_336(Hash hParam0) // Position - 0xD7DE
{
	Hash hash;
...
void func_337(Hash hParam0) // Position - 0xD85E
{
	Hash hash;
...
void func_338(Hash hParam0) // Position - 0xD8DE
{
	Hash hash;
...
void func_339(Hash hParam0) // Position - 0xD95E
{
	Hash hash;
...
void func_340(Hash hParam0) // Position - 0xD9DE
{
	Hash hash;
...
void func_341(Hash hParam0) // Position - 0xDA5E
{
	Hash hash;
...
void func_342(Hash hParam0) // Position - 0xDADE
{
	Hash hash;
...
void func_343(Hash hParam0, BOOL bParam1) // Position - 0xDB5E
{
	Hash hash;
...
void func_344(Hash hParam0, BOOL bParam1) // Position - 0xDBFC
{
	Hash hash;
...
BOOL func_345(int iParam0, int iParam1) // Position - 0xDC9B
{
	return iParam0 && iParam1 != false;
}

BOOL func_346(const char* sParam0) // Position - 0xDCAA
{
	int i;
...
void func_347(int iParam0) // Position - 0xDCE4
{
...
int func_348(int iParam0) // Position - 0xDCFB
{
	switch (iParam0)
	{
		case 0:
...
void func_349(BOOL bParam0) // Position - 0xDD38
{
	Global_1953292 = Global_1953292 || bParam0;
	return;
}

void func_350(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xDD4B
{
	int i;
	int num;
...
BOOL func_351(Hash hParam0) // Position - 0xE047
{
	if (func_567())
		return false;
...
BOOL func_352(Hash hParam0) // Position - 0xE07D
{
	return func_568(hParam0);
}

int func_353(Hash hParam0, int iParam1) // Position - 0xE08B
{
	Hash interactionAnimHash;
	BOOL flag;
	Hash hash;
...
BOOL func_354(BOOL bParam0) // Position - 0xE172
{
	return Global_1953292 && bParam0 != false;
}

void func_355() // Position - 0xE183
{
...
BOOL func_356(int iParam0, BOOL bParam1) // Position - 0xE23A
{
	return func_578(iParam0, false) < func_579(iParam0, bParam1);
}

void func_357(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0xE252
{
	int num;
	BOOL flag;
...
Hash func_358(int iParam0) // Position - 0xE3FE
{
	if (iParam0 == 0)
		iParam0 = func_584();
...
void func_359(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE429
{
...
Hash func_360(Hash hParam0) // Position - 0xE44E
{
	int i;
...
int func_361(Hash hParam0, int iParam1) // Position - 0xE489
{
	switch (hParam0)
	{
		case -1944638739:
...
BOOL func_362(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xE65A
{
	var unk;
	int num;
	int i;
...
void func_363(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE7F9
{
	func_596(&(Global_1953292.f_2938), bParam0, bParam1, bParam2, bParam3, bParam4);
	return;
}

BOOL func_364(Hash hParam0, BOOL bParam1) // Position - 0xE816
{
	!func_17(hParam0, 0);
...
BOOL func_365(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE861
{
	var unk;
	var unk5;
	Hash hash;
...
int func_366(Hash hParam0) // Position - 0xE8EA
{
	int num;
	int num2;
...
void func_367(var uParam0, int iParam1) // Position - 0xE94E
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

int func_368(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xE95F
{
...
struct<4> func_369(BOOL bParam0) // Position - 0xE9DE
{
	int num;
...
BOOL func_370(int iParam0) // Position - 0xEA7E
{
	Ped EntityIndex;
	...
	if (func_598(EntityIndex))
		return true;

	return false;
}

int func_371() // Position - 0xEADF
{
	return Global_38.f_289.f_3222;
}

BOOL func_372() // Position - 0xEAF0
{
	return Global_1915656.f_22504.f_1;
}

BOOL func_373(int iParam0) // Position - 0xEB01
{
	return Global_1051832.f_3648 && iParam0 != false;
}

void func_374(int iParam0) // Position - 0xEB15
{
	Global_1051832.f_3648 = Global_1051832.f_3648 - Global_1051832.f_3648 && iParam0;
	return;
}

void func_375(int iParam0) // Position - 0xEB36
{
	Global_1051832.f_3649 = iParam0;
	return;
}

BOOL func_376() // Position - 0xEB47
{
	return Global_1915656.f_22504;
}

void func_377() // Position - 0xEB56
{
	PAD::_SET_CONTROL_CONTEXT(4, joaat("HandheldCatalogue"));
	return;
}

BOOL func_378() // Position - 0xEB68
{
	return func_373(4);
}

int func_379(BOOL bParam0) // Position - 0xEB75
{
	Player playerIndex;
	Vehicle vehiclePedIsUsing;
	Hash entityModel;
...
void func_380(int iParam0) // Position - 0xEDD4
{
	int num;
...
BOOL func_384() // Position - 0xEE5C
{
	return !func_382(2);
}

BOOL func_385(BOOL bParam0) // Position - 0xEE6A
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_387(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEEA2
{
	BOOL flag;
...
void func_388(int iParam0) // Position - 0xEECA
{
	Global_1896762.f_365 = iParam0;
	return;
}

int func_389(Player plParam0) // Position - 0xEEDB
{
	Player player;
...
struct<2> func_390(int iParam0) // Position - 0xEF0B
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_391(var uParam0, var uParam1) // Position - 0xEF1F
{
	if (!func_607(uParam0))
		return false;
...
int func_392(Player plParam0, BOOL bParam1) // Position - 0xEF53
{
	Player player;
	int i;
...
int func_393(int iParam0) // Position - 0xEFDD
{
	if (iParam0 == -1)
		return 0;
...
var func_394(int iParam0, int iParam1) // Position - 0xEFF9
{
...
void func_396(int iParam0, var uParam1, var uParam2) // Position - 0xF0B1
{
	int num;
...
BOOL func_397(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF0CD
{
...
void func_398(int iParam0, int iParam1) // Position - 0xF16F
{
	int Variable;
...
void func_400(int iParam0, Player plParam1) // Position - 0xF1AE
{
	Player player;
...
struct<4> func_401(BOOL bParam0) // Position - 0xF1D1
{
	int num;
...
BOOL func_402(Hash hParam0, BOOL bParam1) // Position - 0xF272
{
...
BOOL func_403(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF2A9
{
	return func_368(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_404(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0xF2C4
{
	var unk;
...
struct<4> func_405(BOOL bParam0) // Position - 0xF2E5
{
	int num;
...
BOOL func_406(Hash hParam0, int iParam1) // Position - 0xF34F
{
	Hash hash;
	int num;
	int i;
...
BOOL func_407(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0xF3BC
{
	return func_621(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_408(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xF3D2
{
	int num;
	var unk;
	int num2;
...
BOOL func_409(Hash hParam0) // Position - 0xF515
{
	return func_142(hParam0) == joaat("WEAPON");
}

struct<4> func_410() // Position - 0xF529
{
	var unk;
...
void func_411(int iParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF535
{
	Hash item;
...
int func_412(Hash hParam0) // Position - 0xF5CE
{
...
Hash func_413(Hash hParam0) // Position - 0xF613
{
	int num;
...
struct<2> func_415(int iParam0, int iParam1) // Position - 0xF9A1
{
	int num;
...
void func_416(var uParam0, var uParam1, int iParam2) // Position - 0xF9B7
{
...
int func_417(Hash hParam0, int iParam1, Hash hParam2, int iParam3) // Position - 0xF9D4
{
	Hash hash;
	var unk;
	var unk13;
...
int func_418(Hash hParam0, Any* panParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5) // Position - 0xFAD2
{
	var unk;
	var unk15;
	int num;
...
void func_419(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0xFB9B
{
	int i;
...
BOOL func_420(Hash hParam0, Ped pedParam1) // Position - 0xFC19
{
...
void func_421(int iParam0, int iParam1) // Position - 0xFCDE
{
	*iParam0 = iParam1;
	return;
}

BOOL func_422(Hash hParam0) // Position - 0xFCEB
{
	return func_142(hParam0) == joaat("consumable");
}

Hash func_423(Hash hParam0, int iParam1) // Position - 0xFCFF
{
	int num;
	var unk;
	Hash hash;
...
void func_424(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xFD79
{
	BOOL flag;
	int value;
	var unk;
	...
	else if (!func_644(hParam0, &InputString, num3, num2, 0, joaat("ui_itemviewer")))
	{
	...
	str3 = func_505(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash), value), num5);
	...
	if (num4 == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || num4 == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || num4 == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || num4 == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str3 = MISC::VAR_STRING(0, func_650(hParam0, -442898163));
	...
	if (num4 == -126813555 || num4 == 1946043663)
	{
		...
		if (func_651(hParam0, &unk7))
			str3 = func_272(func_652(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_653(str3, InputString.f_1, MISC::GET_HASH_KEY(InputString), num6, num5, str2, str, 0, true);
	return;
}

struct<2> func_425(Hash hParam0) // Position - 0x10254
{
	var unk;
	var unk3;
...
BOOL func_426(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x102E8
{
	var unk;
	int num;
	int num2;
...
int func_427(Hash hParam0, int iParam1, Ped pedParam2, BOOL bParam3, BOOL bParam4, Hash hParam5, int iParam6, int iParam7) // Position - 0x103B4
{
	int num;
...
BOOL func_428(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1041E
{
	int num;
	int num2;
	int num3;
...
BOOL func_429(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x104AD
{
	var unk;
	var unk6;
...
void func_430() // Position - 0x10507
{
	int i;
	int num;
...
void func_431() // Position - 0x10553
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_432(int iParam0, Any anParam1) // Position - 0x1055F
{
	if (!func_662(iParam0))
		return false;
...
void func_433() // Position - 0x1058C
{
	int num;
...
void func_434(Hash hParam0, int iParam1, char* sParam2, int iParam3) // Position - 0x105DE
{
	int dataContainerFromChildIndex;
	BOOL flag;
	int num;
...
void func_435(Hash hParam0) // Position - 0x1065C
{
	if (func_93())
...
void func_436(Hash hParam0) // Position - 0x10682
{
	if (func_122())
...
void func_437(Hash hParam0) // Position - 0x106A8
{
	if (func_33(false))
		if (func_274() == 2)
...
BOOL func_438(Hash hParam0, var uParam1) // Position - 0x10709
{
	*uParam1 = 0;
	*uParam1 = 0;
...
void func_439(BOOL bParam0) // Position - 0x10749
{
	if (bParam0)
	{
...
BOOL func_440(Ped pedParam0) // Position - 0x1076D
{
	Entity EntityIndex;
	ItemSet itemSet;
	BOOL flag;
...
BOOL func_441(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13) // Position - 0x107F6
{
	var unk;
	int num;
...
void func_442(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x109AC
{
	if (func_17(hParam1, 0))
		if (bParam2)
...
BOOL func_443(Hash hParam0) // Position - 0x109D7
{
	return func_665(func_145(hParam0), hParam0);
}

struct<18> func_444(Hash hParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x109EB
{
	Hash hash;
...
BOOL func_445(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x10AC9
{
...
void func_446(int iParam0, BOOL bParam1) // Position - 0x10AEE
{
	var unk;
...
void func_447(int iParam0, BOOL bParam1) // Position - 0x10B62
{
	var unk;
...
void func_448(int iParam0, BOOL bParam1) // Position - 0x10BD6
{
	var unk;
...
void func_449(int iParam0, BOOL bParam1) // Position - 0x10C53
{
	var unk;
...
BOOL func_451(Ped pedParam0, int iParam1) // Position - 0x10D3B
{
	var unk;
	int num;
...
BOOL func_452(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10D7A
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_453(Hash hParam0) // Position - 0x10EAF
{
	int i;
...
BOOL func_454(int iParam0) // Position - 0x10EE9
{
	return Global_1915633.f_22 && iParam0 != false;
}

BOOL func_455() // Position - 0x10EFC
{
...
BOOL func_456() // Position - 0x10F27
{
	return Global_1893611 & true != 0 && func_668() != -1;
}

Player _INVALID_PLAYER_INDEX() // Position - 0x10F42
{
	return -1;
}

int func_458(var uParam0, var uParam1) // Position - 0x10F4B
{
	return uParam0;
}

BOOL func_459() // Position - 0x10F55
{
	return func_391(Global_1051268);
}

BOOL func_460() // Position - 0x10F67
{
	return func_669(func_390(0));
}

BOOL func_461(int iParam0) // Position - 0x10F78
{
	return iParam0 == -1759663922 || iParam0 == -318976023 || iParam0 == 772881414 || iParam0 == 31269700 || iParam0 == -133550749;
}

void func_462(int iParam0, int iParam1) // Position - 0x10FC0
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

Entity func_463(Ped pedParam0) // Position - 0x10FD5
{
	int lootTarget;
...
void func_464(int iParam0, int iParam1) // Position - 0x11035
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

Hash func_465(Hash hParam0) // Position - 0x11046
{
	Hash award;
	Hash currency;
	int i;
...
BOOL func_466(Hash hParam0) // Position - 0x110CA
{
...
BOOL func_467(Hash hParam0) // Position - 0x110E5
{
	Hash hash;
...
Hash func_468(Hash hParam0) // Position - 0x1120A
{
	var unk;
	int i;
...
BOOL func_469(Hash hParam0) // Position - 0x11278
{
	Ped mount;
...
BOOL func_470(Hash hParam0) // Position - 0x114ED
{
	if (!func_17(hParam0, 0))
		return false;
...
BOOL func_471(Hash hParam0) // Position - 0x11510
{
...
int func_472(int iParam0) // Position - 0x1158F
{
...
Vector3 func_473(Player plParam0) // Position - 0x11AAC
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x11AC0
{
...
float func_475(int iParam0) // Position - 0x11AEA
{
	int num;
...
float func_476(Vehicle veParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x11B54
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return 0f;
...
float func_477(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x11B7C
{
...
Ped func_478(int iParam0) // Position - 0x11BC4
{
	iParam0 = func_249(iParam0);
...
int func_479(int iParam0) // Position - 0x11BF7
{
	iParam0 = func_249(iParam0);
...
float func_480(int iParam0) // Position - 0x11C2B
{
	iParam0 = func_249(iParam0);
...
int func_481(Ped pedParam0, int iParam1) // Position - 0x11C61
{
...
float func_482(float fParam0, Any anParam1, float fParam2) // Position - 0x11C87
{
	return ((1f - fParam2) * fParam0) + (fParam2 * anParam1);
}

BOOL func_483(int iParam0) // Position - 0x11C9C
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_484(int iParam0) // Position - 0x11D09
{
	switch (iParam0)
	{
		case 40:
...
BOOL func_485(int iParam0) // Position - 0x11D57
{
	return !(iParam0 <= 0);
}

BOOL func_486(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x11D64
{
	if (bParam2)
		if (!func_485(iParam0))
			return false;
...
void func_487(BOOL bParam0) // Position - 0x11DA7
{
...
void func_489(Hash hParam0) // Position - 0x11E0F
{
...
Hash func_490(Hash hParam0) // Position - 0x1200D
{
	if (DATABINDING::_DATABINDING_READ_DATA_BOOL(Global_1940252.f_11634))
	{
		if (func_19(hParam0, 316290104))
...
void func_491(Hash hParam0, var uParam1) // Position - 0x1213A
{
	BOOL flag;
	var unk;
	var unk15;
...
BOOL func_492() // Position - 0x122C7
{
...
int func_493(Hash hParam0, BOOL bParam1) // Position - 0x12313
{
	var unk;
	int num;
	int num2;
...
struct<4> func_494(Hash hParam0, BOOL bParam1) // Position - 0x12372
{
	var unk;
...
BOOL func_495(Hash hParam0) // Position - 0x12397
{
...
int func_496(int iParam0, Hash hParam1) // Position - 0x123C2
{
	var guid;
	int inventoryItemCountWithGuid;
...
int func_497(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x12400
{
	if (!func_17(hParam0, 0))
	{
		if (func_281(func_105(hParam0), 2))
...
Hash func_498(Hash hParam0, BOOL bParam1) // Position - 0x12474
{
	switch (hParam0)
	{
...
Hash func_499(Hash hParam0, BOOL bParam1) // Position - 0x12516
{
	var unk;
...
Hash func_500(Hash hParam0) // Position - 0x1256E
{
	switch (hParam0)
	{
		case joaat("PROVISION_ANIMAL_CARCASS_CHICKEN_PERFECT"):
...
Hash func_501(Hash hParam0) // Position - 0x13A7E
{
	switch (hParam0)
	{
		case -2092697195:
...
int func_502(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x15717
{
	var unk;
	int num;
	int i;
...
float func_503(int iParam0, Hash hParam1) // Position - 0x15786
{
	float num;
...
float func_504(var uParam0, Hash hParam1) // Position - 0x157B1
{
	int i;
	float num;
	BOOL flag;
...
const char* func_505(const char* sParam0, int iParam1) // Position - 0x158A3
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

BOOL func_506(Hash hParam0) // Position - 0x158BD
{
	int i;
	int num;
...
BOOL func_507(Hash hParam0, int iParam1) // Position - 0x1590E
{
	var unk;
	int num;
	Hash hash;
...
BOOL func_508(Hash hParam0, var uParam1) // Position - 0x15998
{
	*uParam1 = func_680(hParam0);
	return *uParam1 != 0;
}

BOOL func_509(Hash hParam0) // Position - 0x159AE
{
	!func_17(hParam0, 0);
...
int func_510(Ped pedParam0, var uParam1, int iParam2) // Position - 0x159D4
{
	ItemSet itemSet;
	Entity entityFromItem;
	int i;
...
Hash func_511(Entity eParam0) // Position - 0x15A50
{
	Hash hash;
...
Hash func_512(var uParam0) // Position - 0x15AA3
{
	Ped pedIndexFromEntityIndex;
...
BOOL func_513(Player plParam0, BOOL bParam1) // Position - 0x15AC9
{
	int i;
	Any gangId;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_515(BOOL bParam0) // Position - 0x15B94
{
	var unk;
	int num;
	int num2;
...
BOOL func_516(Hash hParam0) // Position - 0x15C5D
{
	if (hParam0 == 0)
		return false;
...
void func_517(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x15C75
{
	int i;
	int j;
	int k;
...
BOOL func_518(Hash hParam0, int iParam1) // Position - 0x15E4B
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_519(Hash hParam0) // Position - 0x15EF3
{
	int num;
	int num2;
	int num3;
...
BOOL func_520(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x15FAF
{
	BOOL flag;
...
int func_521(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x16338
{
...
BOOL func_522(int iParam0) // Position - 0x1636B
{
	return iParam0 != 0;
}

void func_523(int iParam0, BOOL bParam1) // Position - 0x16377
{
	if (bParam1)
...
void func_524(int iParam0, BOOL bParam1) // Position - 0x16394
{
	int num;
...
Hash func_525(Entity eParam0) // Position - 0x163D6
{
...
void func_526(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x16434
{
	int address;
	BOOL flag;
	var unk;
...
int func_527(Hash hParam0) // Position - 0x165FB
{
	int num;
	int num2;
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
int func_528(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x1667A
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
void func_529(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6, Hash hParam7) // Position - 0x16770
{
	int dataContainerFromChildIndex;
	int num;
...
BOOL func_530(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x167D0
{
	var unk;
	int num;
	int i;
...
BOOL func_531(var uParam0, var uParam1, int iParam2) // Position - 0x168D7
{
	int i;
...
void func_532(var uParam0) // Position - 0x16902
{
	return;
}

void func_533(var uParam0) // Position - 0x1690A
{
	int i;
...
BOOL func_534() // Position - 0x16943
{
	if (func_195())
		if (Global_1915656.f_20241 == 29)
			return true;
...
Vector3 func_535(Any anParam0) // Position - 0x16963
{
	int num;
...
int func_536(Hash hParam0) // Position - 0x16997
{
...
void func_537(var uParam0) // Position - 0x169E0
{
...
BOOL func_538(Vehicle veParam0) // Position - 0x16A24
{
...
void func_539() // Position - 0x16A43
{
	var unk;
...
BOOL func_540() // Position - 0x16ABB
{
	return Global_1572887.f_7;
}

void func_541( Param0) // Position - 0x16AC9
{
	 Var0;
	int num;
	int num2;
...
BOOL func_542(Hash hParam0) // Position - 0x16B61
{
...
BOOL func_543(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x16B77
{
	*uParam1 = 0;
...
struct<17> func_544(Hash hParam0, var uParam1) // Position - 0x16BE4
{
	var unk;
...
int func_545(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x16C37
{
	int num;
...
int func_546(Hash hParam0) // Position - 0x16CA1
{
	if (func_17(hParam0, 0))
	{
		if (func_19(hParam0, -1242251796))
...
BOOL func_547(Hash hParam0) // Position - 0x16D43
{
	return hParam0 == 1401465909 || hParam0 == joaat("kit_collectors_bag");
}

BOOL func_548(Hash hParam0) // Position - 0x16D61
{
...
int func_549() // Position - 0x16E23
{
	return 972554239;
}

int func_550(var uParam0, int iParam1) // Position - 0x16E30
{
	int num;
	int num2;
	int num3;
...
BOOL func_551(int iParam0, int iParam1, BOOL bParam2) // Position - 0x16EB3
{
	return !MISC::IS_STRING_NULL_OR_EMPTY_OR_SPACES(func_553(func_721(iParam0, iParam1, bParam2)));
}

struct<8> func_552(int iParam0, int iParam1) // Position - 0x16ECE
{
	return func_721(iParam0, iParam1, true);
}

char* func_553(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x16EDF
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

BOOL func_554(int iParam0, Hash hParam1) // Position - 0x16EF3
{
	int i;
...
BOOL func_555(int iParam0) // Position - 0x16F3F
{
	return iParam0 >= 0 && iParam0 < 50;
}

BOOL func_556(int iParam0) // Position - 0x16F55
{
	float num;
	int i;
	int j;
...
BOOL func_557(int iParam0) // Position - 0x17066
{
	int i;
...
BOOL func_558(int iParam0) // Position - 0x170B4
{
	int i;
...
BOOL func_559(Ped pedParam0, Hash hParam1, BOOL bParam2) // Position - 0x17101
{
	if (!bParam2)
		if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
			return false;
...
int func_560() // Position - 0x17125
{
	...
	if (ReturnWeaponType2 == joaat("WEAPON_UNARMED"))
		if (ReturnWeaponType == joaat("WEAPON_UNARMED"))
			return 1;
		else if (WEAPON::IS_WEAPON_VALID(ReturnWeaponType) && WEAPON::_IS_WEAPON_TWO_HANDED(ReturnWeaponType) && !func_727(ReturnWeaponType) && !PED::IS_PED_FULLY_ON_MOUNT(Global_33, true) && !(PED::IS_PED_IN_ANY_VEHICLE(Global_33, false) && !CAM::IS_FIRST_PERSON_CAMERA_ACTIVE(1, 0, 0)))
			return 3;
		else if (WEAPON::_IS_WEAPON_BINOCULARS(ReturnWeaponType))
			return 1;
		else if (WEAPON::IS_WEAPON_VALID(ReturnWeaponType) && func_727(ReturnWeaponType) || WEAPON::_IS_WEAPON_LASSO(ReturnWeaponType))
			return 1;
		else
			return 0;
...
void func_561(int iParam0, BOOL bParam1, int iParam2) // Position - 0x17218
{
	Hash hash;
	int num;
...
BOOL func_562(Ped pedParam0, Hash hParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x1728E
{
...
void func_563(Hash hParam0) // Position - 0x172C7
{
	int num;
	var unk22;
	int i;
...
void func_564(int iParam0) // Position - 0x1760B
{
...
BOOL func_565(int iParam0) // Position - 0x17651
{
	return Global_1953292.f_595[iParam0] > 0;
}

void func_566(int iParam0) // Position - 0x17666
{
	Global_1953292.f_595[iParam0] = Global_1953292.f_595[iParam0] + 1;
	return;
}

BOOL func_567() // Position - 0x17686
{
...
BOOL func_568(Hash hParam0) // Position - 0x176D0
{
	int num;
...
BOOL func_569(Hash hParam0) // Position - 0x17720
{
	Hash hash;
...
BOOL func_570(var uParam0) // Position - 0x1774A
{
...
Hash func_571() // Position - 0x177A7
{
	int num;
...
Hash func_572() // Position - 0x177FE
{
	int num;
...
Hash func_573() // Position - 0x17855
{
	int num;
...
Hash func_574() // Position - 0x178AC
{
	int num;
...
BOOL func_575(var uParam0) // Position - 0x17903
{
...
void func_576(BOOL bParam0) // Position - 0x17930
{
	Global_1953292 = Global_1953292 - Global_1953292 && bParam0;
	return;
}

void func_577(int iParam0, int iParam1, int iParam2) // Position - 0x17948
{
...
int func_578(int iParam0, BOOL bParam1) // Position - 0x17987
{
	switch (iParam0)
	{
		case -2061583405:
...
int func_579(int iParam0, BOOL bParam1) // Position - 0x17A2A
{
	int num;
...
BOOL func_580(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x17AD9
{
	var unk;
	Hash hash;
...
void func_581() // Position - 0x17B6A
{
	int i;
...
void func_582(BOOL bParam0, Hash hParam1) // Position - 0x17C28
{
	char* StringToTest;
	char* str;
	char* str2;
	...
	if (!func_644(hParam1, &StringToTest, joaat("Inventory"), 0, 0, joaat("ui_itemviewer")))
	{
	...
	if (bParam0)
	{
		...
		else
		{
			...
			str = "ITEM_STORED";
			str3 = MISC::VAR_STRING(0, func_267(hParam1, false));
		}
	}
	else
	{
	...
	str4 = func_505(MISC::VAR_STRING(10, str, str3), num);
	func_653(str4, StringToTest.f_1, MISC::GET_HASH_KEY(StringToTest), 0, num, "Transaction_Feed_Sounds", str2, 0, true);
	return;
}

void func_583(BOOL bParam0, BOOL bParam1) // Position - 0x17D8B
{
	if (bParam1)
		func_753();
...
int func_584() // Position - 0x17DBD
{
	return Global_1953292.f_1;
}

BOOL func_585(Hash hParam0, Hash hParam1) // Position - 0x17DCB
{
	int num;
	int num2;
...
void func_586(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x17E07
{
...
int func_587(int iParam0, int iParam1) // Position - 0x17E2A
{
	switch (iParam0)
	{
		case 0:
...
void func_588() // Position - 0x1807A
{
	int i;
...
void func_589(int iParam0) // Position - 0x180C1
{
	func_577(iParam0, 8, 6);
	return;
}

void func_590(Hash hParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x180D2
{
	int num;
	Hash hash;
...
void func_591(int iParam0) // Position - 0x18180
{
	func_758(&(Global_1953292.f_2938), iParam0);
	return;
}

void func_592(int iParam0, int iParam1) // Position - 0x18195
{
	if (iParam1 & 8 != 0)
		return;
...
void func_593(Hash hParam0, int iParam1, int iParam2) // Position - 0x181B8
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

void func_594(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x181CB
{
	Hash hash;
	BOOL flag;
...
Hash func_595(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x18364
{
	BOOL flag;
...
void func_596(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x183C5
{
	int i;
	int num;
	BOOL flag;
...
Hash func_597(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0x18504
{
	return func_784(&uParam0, hParam4, bParam5, iParam6);
}

BOOL func_598(Ped pedParam0) // Position - 0x18518
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
BOOL func_599() // Position - 0x18550
{
	int num;
	int num2;
	int num3;
...
BOOL func_600(Player plParam0) // Position - 0x18684
{
	if (plParam0 == 255)
...
BOOL func_601(int iParam0) // Position - 0x186A9
{
...
void func_604(BOOL bParam0) // Position - 0x18710
{
...
BOOL func_605() // Position - 0x18750
{
	return Global_1915656.f_20643;
}

BOOL func_606(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x1875F
{
	Player PlayerIndex;
	Ped EntityIndex;
	BOOL isEntityDead;
...
BOOL func_607(int iParam0) // Position - 0x18985
{
	switch (iParam0)
	{
		case 2:
...
int func_608(int iParam0) // Position - 0x189C4
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_609(int iParam0, int iParam1, Player plParam2) // Position - 0x18A5A
{
	return func_89(Global_1206166[plParam2 /*10*/][iParam0], iParam1);
}

var func_610(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x18A74
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_792(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
int func_611(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x18E07
{
	if (!func_796(uParam0))
		return 0;
...
BOOL func_612(int iParam0, int iParam1) // Position - 0x18E37
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_613(int iParam0) // Position - 0x18E4F
{
...
BOOL func_614(int iParam0) // Position - 0x18E66
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_615(int iParam0, int iParam1) // Position - 0x18F32
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_616(int iParam0) // Position - 0x18F4B
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_617() // Position - 0x18F5E
{
	if (!func_383())
		return false;
...
BOOL func_619(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x18F96
{
	int inventoryId;
...
BOOL func_620(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x18FDB
{
...
BOOL func_621(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1900E
{
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(panParam0))
		return 0;
...
struct<29> func_622(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x19048
{
	var unk;
	var unk30;
...
int func_623(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x190E3
{
	int num;
...
struct<26> func_624(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1914D
{
	var unk;
	var unk27;
...
int func_625(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x191D0
{
	int num;
...
struct<18> func_626(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x19220
{
	var unk;
	var unk19;
...
int func_627(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x19295
{
	int num;
...
struct<17> func_628(var uParam0, BOOL bParam1) // Position - 0x192FF
{
	var unk;
...
int func_629(Hash hParam0) // Position - 0x19380
{
	if (func_19(hParam0, 1064293907))
		return 2;
	else if (func_19(hParam0, -1218707194))
...
struct<12> func_630(int iParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x193C5
{
	int num;
...
BOOL func_631(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x19526
{
	var unk;
...
int func_632(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, Hash hParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x19546
{
	int value;
	Hash TypeOfWeapon;
	Hash lootTableKey;
	...
	if (!flag)
	{
		if (func_19(hParam0, -1588156645))
		{
			bParam2 = true;
			flag2 = true;
			TypeOfWeapon = func_809(func_808(hParam0, true), false);
		
			if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
			{
				if (func_37() == -1)
					func_810(TypeOfWeapon);
			
				if (func_170(false) && func_811(TypeOfWeapon, 0, false, true, 0, false, hParam5, false))
				{
...
BOOL func_633(Hash hParam0) // Position - 0x19FFA
{
	switch (hParam0)
	{
...
BOOL func_634(Ped pedParam0, Hash hParam1) // Position - 0x1A01E
{
	ATTRIBUTE::STOP_ITEM_PREVIEW();
...
int func_635() // Position - 0x1A09D
{
	return Global_1904379;
}

void func_636(Ped pedParam0) // Position - 0x1A0A9
{
	Global_1904379.f_2 = pedParam0;
	return;
}

void func_637(Hash hParam0) // Position - 0x1A0B9
{
	Global_1904379.f_1 = hParam0;
	return;
}

void func_638(int iParam0) // Position - 0x1A0C9
{
	Global_1904379.f_5 = iParam0;
	return;
}

void func_639(Hash hParam0, var uParam1, var uParam2) // Position - 0x1A0D9
{
	*uParam1 = 0;
	*uParam2 = 0;
...
BOOL func_640() // Position - 0x1A2E5
{
	return !Global_1913444;
}

void func_641(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x1A2F2
{
	int i;
...
var func_642(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1A415
{
	if (bParam0)
		return uParam1;
...
BOOL func_643(Hash hParam0, int iParam1) // Position - 0x1A42C
{
	if (!func_17(hParam0, 0))
		return false;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_644(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x1A44B
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_645(Hash hParam0) // Position - 0x1A53E
{
...
BOOL func_646(int iParam0) // Position - 0x1A639
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_647(Hash hParam0) // Position - 0x1A660
{
	int num;
	var unk;
	int collectionId;
...
BOOL func_648(Hash hParam0, Hash hParam1) // Position - 0x1A6E5
{
	if (hParam0 == 0)
		return false;
...
int func_649(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x1A716
{
	var unk;
 ...
 func_650(Hash hParam0, int iParam1) // Position - 0x1A775
{
	 num;
...
BOOL func_651(Hash hParam0, char* sParam1) // Position - 0x1A793
{
	...
	TEXT_LABEL_ASSIGN_STRING(&StringToTest, func_837(hParam0), 128);
...
const char* func_652(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x1A810
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_653(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x1A824
{
	int num;
	var unk13;
	int num2;
...
struct<2> func_654(int iParam0) // Position - 0x1A887
{
	int num;
...
void func_655(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1A897
{
...
int func_656(Ped pedParam0, Hash hParam1) // Position - 0x1A8B2
{
	int i;
	int num;
...
int func_657(var uParam0, Hash hParam1, var uParam2, BOOL bParam3, Hash hParam4, int iParam5) // Position - 0x1A928
{
	var statId;
	int num;
...
int func_658(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x1A9FC
{
	Hash hash;
	ItemSet itemSet;
	Ped entityFromItem;
...
void func_659(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x1ABAE
{
	int i;
	int slot;
...
BOOL func_660(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1AC3A
{
	var statId;
...
int func_661(int iParam0, BOOL bParam1) // Position - 0x1AC71
{
	int num;
	int num2;
	int num3;
...
BOOL func_662(int iParam0) // Position - 0x1ACC7
{
	return iParam0 > -1 && iParam0 < 26;
}

int func_663() // Position - 0x1ACDD
{
	return Global_1940252.f_40;
}

Entity func_664() // Position - 0x1ACEB
{
	return Global_1902887.f_379;
}

BOOL func_665(int iParam0, Hash hParam1) // Position - 0x1ACFA
{
...
void func_666(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, BOOL bParam19, BOOL bParam20) // Position - 0x1AEB2
{
	int num;
	int num2;
	int i;
...
BOOL func_667(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1AF2B
{
...
int func_668() // Position - 0x1AFC9
{
	return Global_1893611.f_2;
}

BOOL func_669(var uParam0, var uParam1) // Position - 0x1AFD7
{
	return func_854(uParam0, 1, 4);
}

int func_670(Hash hParam0) // Position - 0x1AFE9
{
...
BOOL func_671(Hash hParam0, Hash hParam1) // Position - 0x1B000
{
	if (hParam1 == 0)
		return false;
...
BOOL func_672(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, Any* panParam5, BOOL bParam6, int iParam7) // Position - 0x1B027
{
	return func_855(&uParam0, hParam4, panParam5, bParam6, iParam7);
}

BOOL func_673(Hash hParam0, int iParam1) // Position - 0x1B03D
{
	int num;
...
struct<4> func_674(int iParam0, Hash hParam1) // Position - 0x1B05C
{
	var unk;
...
int func_675(Hash hParam0, BOOL bParam1) // Position - 0x1B07E
{
	int num;
...
BOOL func_676(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1B0B7
{
	var unk;
	int i;
...
BOOL func_677(int iParam0, Hash hParam1, float* pfParam2) // Position - 0x1B149
{
	var unk;
	var unk6;
	int num;
...
// Unhandled jump detected. Output should be considered invalid
int func_678(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x1B1CE
{
	var unk;
	int num;
	int i;
...
int func_679(int iParam0) // Position - 0x1B2BE
{
	if (func_37() != -1)
...
int func_680(Hash hParam0) // Position - 0x1B2EB
{
	switch (hParam0)
	{
...
Hash func_681(Ped pedParam0) // Position - 0x1BD27
{
	Ped EntityIndex;
...
int func_682(Any anParam0) // Position - 0x1BDFA
{
...
BOOL func_683(int iParam0) // Position - 0x1BE32
{
...
BOOL func_684(Hash hParam0) // Position - 0x1BE51
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_685(Hash hParam0) // Position - 0x1BE6C
{
	switch (hParam0)
	{
...
int func_686(var uParam0, int iParam1) // Position - 0x1BF4F
{
	int i;
...
int func_687(Hash hParam0) // Position - 0x1BF8C
{
	int num;
...
BOOL func_688(Hash hParam0) // Position - 0x1BFF9
{
	int i;
...
BOOL func_689(Hash hParam0) // Position - 0x1C035
{
	if (func_19(hParam0, -839724752))
...
BOOL func_690(Hash hParam0) // Position - 0x1C05A
{
...
BOOL func_691(Hash hParam0, int iParam1) // Position - 0x1C184
{
...
BOOL func_692(Hash hParam0) // Position - 0x1C290
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

void func_693(int iParam0, int iParam1) // Position - 0x1C29E
{
	Global_1940252.f_41.f_2[iParam0 /*2*/] = iParam1;
	return;
}

BOOL func_694(int iParam0) // Position - 0x1C2B4
{
	return Global_1940252.f_41.f_2[iParam0 /*2*/].f_1;
}

void func_695(int iParam0) // Position - 0x1C2CA
{
...
BOOL func_696(int iParam0, Any* panParam1, var uParam2, int* piParam3) // Position - 0x1C2EE
{
...
BOOL func_697(int iParam0) // Position - 0x1C30F
{
	if (iParam0 < 0)
		return false;
...
BOOL func_698(int iParam0) // Position - 0x1C33C
{
	if (iParam0 < 0)
		return false;
...
int func_699(int iParam0, Hash hParam1) // Position - 0x1C35F
{
...
int func_700(Hash hParam0, int iParam1) // Position - 0x1C384
{
	var unk;
	var guid;
	int inventoryItemCountWithGuid;
...
void func_701(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1C3DF
{
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_702(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x1C41D
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
void func_703(Any* panParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1C513
{
	int num;
	int num2;
	int i;
...
int func_704(int iParam0) // Position - 0x1C58F
{
	int num;
	int num2;
...
int func_705(int iParam0) // Position - 0x1C5C9
{
	int num;
	int num2;
...
Hash func_706(int iParam0) // Position - 0x1C603
{
	int num;
	var InputString;
	...
	num.f_2 = 4;
	num.f_3 = iParam0;
	DATAFILE::_PARSEDDATA_RQ_FILLOUT_STRING_63(&InputString, &num);
	return MISC::GET_HASH_KEY(&InputString);
}

Hash func_707(int iParam0) // Position - 0x1C641
{
	int num;
	var InputString;
...
BOOL func_708( Param0) // Position - 0x1C67F
{
	if (func_873(Param0))
		return func_54(16);
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_709(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x1C6D9
{
	int i;
...
BOOL func_710(Hash hParam0, Any* panParam1) // Position - 0x1C7F0
{
	int num;
...
BOOL func_711(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x1C9C6
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_712(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x1C9DD
{
	if (bParam0)
	{
...
int func_713(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x1CA26
{
	if (bParam0)
	{
		func_879(iParam1, 1, 0, 0);
...
int func_714() // Position - 0x1CA42
{
	return 1035451607;
}

int func_715(var uParam0, var uParam1) // Position - 0x1CA4F
{
	var unk;
...
int func_716(int iParam0) // Position - 0x1CA7B
{
	int num;
	int num2;
...
int func_717(int iParam0) // Position - 0x1CAA6
{
	if (iParam0 == -1)
		return -1;
...
int func_718(int iParam0) // Position - 0x1CAC2
{
	switch (iParam0)
	{
		case 0:
...
int func_719(int iParam0) // Position - 0x1CC77
{
	int num;
...
int func_720(int iParam0) // Position - 0x1CC9E
{
	return Global_1110244.f_3667[iParam0 /*7*/];
}

struct<8> func_721(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1CCB1
{
	var unk;
	var unk6;
...
BOOL func_722(int iParam0) // Position - 0x1CD64
{
	return func_89(Global_1220826.f_1196, iParam0);
}

BOOL func_723() // Position - 0x1CD79
{
	return Global_263042[Global_1295666 /*65*/] > 2;
}

BOOL func_724(BOOL bParam0, int iParam1) // Position - 0x1CD8D
{
...
struct<2> func_725() // Position - 0x1CDC9
{
...
BOOL func_726(Hash hParam0) // Position - 0x1CE14
{
...
BOOL func_727(Hash hParam0) // Position - 0x1CE2B
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

Hash func_728(int iParam0) // Position - 0x1CE39
{
	switch (iParam0)
	{
		case 2:
...
void func_729(int iParam0, BOOL bParam1) // Position - 0x1D0F4
{
	if (!func_485(iParam0))
		return;
...
void func_730(int iParam0, BOOL bParam1) // Position - 0x1D11A
{
	if (!func_485(iParam0))
		return;
...
BOOL func_731(int iParam0) // Position - 0x1D15D
{
	if (!func_485(iParam0))
		return false;
...
void func_732(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1D17B
{
	if (!func_485(iParam0))
		return;
...
void func_733(BOOL bParam0, int iParam1) // Position - 0x1D1DD
{
...
float func_734(int iParam0, int iParam1) // Position - 0x1D223
{
	int num;
	float pedStamina;
	float pedMaxStamina;
...
void func_735(int iParam0) // Position - 0x1D2D8
{
	Ped ped;
	int num;
...
void func_736(int iParam0, BOOL bParam1) // Position - 0x1D315
{
	int num;
...
void func_737(int iParam0) // Position - 0x1D34A
{
	Ped ped;
	int num;
...
float func_738(float fParam0, float fParam1) // Position - 0x1D387
{
	if (fParam1 != 0f)
...
void func_739(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1D3B5
{
	if (fParam1 == 0f)
		return;
...
float func_740(float fParam0, int iParam1) // Position - 0x1D3EE
{
	switch (iParam1)
	{
		case 0:
...
int func_741(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1D440
{
	if (!ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		return 0;
...
void func_742(float fParam0, BOOL bParam1) // Position - 0x1D464
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
BOOL func_743() // Position - 0x1D4BC
{
	int num;
...
int func_744(int iParam0) // Position - 0x1D552
{
	int num;
...
BOOL func_745(int iParam0, var uParam1) // Position - 0x1D581
{
	Hash hash;
	int num;
...
Hash func_746(Hash hParam0) // Position - 0x1D617
{
	return Global_1953292.f_1676.f_1[func_361(hParam0, 1) /*3*/];
}

int func_747() // Position - 0x1D631
{
	int i;
	Hash hash;
	int num;
...
BOOL func_748(Hash hParam0, int iParam1) // Position - 0x1D682
{
	if (iParam1 == 0)
...
BOOL func_749(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1D6EB
{
	var unk;
	var guid;
...
int func_750(Hash hParam0) // Position - 0x1D73D
{
	switch (hParam0)
	{
		case -2011879201:
...
BOOL func_751(BOOL bParam0, int iParam1) // Position - 0x1D7BF
{
	if (iParam1 == -1)
...
struct<8> func_752(int iParam0) // Position - 0x1D802
{
	var unk;
...
void func_753() // Position - 0x1D837
{
	Global_1953292.f_1046 = 0;
	return;
}

BOOL func_754(Hash hParam0) // Position - 0x1D847
{
	if (!func_17(hParam0, 0))
		return false;
...
void func_755(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1D883
{
	BOOL flag;
	var unk;
	var unk120;
...
Hash func_756(Hash hParam0) // Position - 0x1DA09
{
	int num;
	var unk;
...
BOOL func_757(Hash hParam0, int iParam1) // Position - 0x1DA4D
{
	int num;
...
void func_758(int iParam0, int iParam1) // Position - 0x1DAF4
{
	int i;
	int num;
	var unk;
...
void func_759(int iParam0, int iParam1, int iParam2) // Position - 0x1DBF1
{
	int i;
	int j;
...
void func_760(Hash hParam0, var uParam1) // Position - 0x1DCD7
{
	int num;
	int num2;
	int num3;
...
void func_761(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x1DD8A
{
	int num;
	int num2;
...
void func_762(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x1DF5F
{
...
void func_763(Hash hParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0x1DFA4
{
	int num;
	Hash hash;
...
void func_764(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1E06D
{
...
void func_765(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1E0A7
{
	int num;
...
void func_766(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1E1E7
{
	int num;
	int metapedType;
	Hash hash;
...
void func_767(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1E4D0
{
	int num;
...
void func_768(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3, int iParam4) // Position - 0x1E52F
{
	switch (func_145(hParam2))
	{
		case 698653232:
...
void func_769(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1E56D
{
	switch (func_145(hParam2))
	{
		case -1080198344:
...
void func_770(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1E5B1
{
	int num;
...
void func_771(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1E64D
{
	int num;
...
void func_772(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1E75C
{
	int num;
...
void func_773(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x1E7FB
{
	int num;
...
void func_774(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1E860
{
	switch (func_145(hParam2))
	{
		case -1740828670:
...
void func_775(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1E8F0
{
	switch (func_145(hParam2))
	{
		case -923693316:
...
void func_776(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1E92E
{
	int num;
	Hash hash;
...
int func_777(Hash hParam0, BOOL bParam1, Hash hParam2) // Position - 0x1EA5D
{
	int i;
...
BOOL func_778(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x1EA9F
{
	*uParam2 = joaat("base");
	return true;
}

int func_779(Hash hParam0) // Position - 0x1EAB0
{
	int num;
...
BOOL func_780(int iParam0) // Position - 0x1EACC
{
...
void func_781(int iParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x1EB5A
{
	if (bParam1)
...
BOOL func_782(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x1EBB6
{
	var unk;
	var unk6;
...
void func_783(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1EBEB
{
...
int func_784(Any* panParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0x1EC13
{
	var unk;
...
int func_785(int iParam0) // Position - 0x1EC41
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_786(int iParam0, Player plParam1) // Position - 0x1ED16
{
	if (plParam1 == 255)
...
BOOL func_787() // Position - 0x1ED42
{
	int frameCount;
...
void func_788(int iParam0) // Position - 0x1ED6C
{
	Global_1051832.f_3648 = Global_1051832.f_3648 || iParam0;
	return;
}

BOOL func_789() // Position - 0x1ED85
{
	return ANIMSCENE::DOES_ANIM_SCENE_EXIST(Global_26573) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(Global_26573, false);
}

int func_790() // Position - 0x1EDA1
{
	return Global_1051645.f_12;
}

char* func_791() // Position - 0x1EDAF
{
	return "unnamed";
}

BOOL func_792(int iParam0) // Position - 0x1EDBB
{
	int num;
...
BOOL func_793(int iParam0) // Position - 0x1EE4A
{
	if (Global_1572887.f_14 == -1)
		return false;
...
int func_794(int iParam0) // Position - 0x1EE68
{
	if (iParam0 == 255)
...
BOOL func_795(Player plParam0) // Position - 0x1EEB3
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_796(var uParam0) // Position - 0x1EEF8
{
	if (*uParam0 >= 40)
		return false;
...
BOOL func_797(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x1EF0D
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 29, panParam2, 0);
}

BOOL func_798(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x1EF24
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 26, panParam2, 0);
}

BOOL func_799(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x1EF3B
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

void func_800(var uParam0, int iParam1) // Position - 0x1EF52
{
	BOOL flag;
	int i;
...
BOOL func_801(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x1F07E
{
	var unk;
	int num;
...
BOOL func_802(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1F0ED
{
	if (func_37() == -1)
	{
...
BOOL func_803(Hash hParam0, var uParam1, int iParam2) // Position - 0x1F144
{
	var unk;
	int num;
	int num2;
...
void func_804(Hash hParam0, BOOL bParam1) // Position - 0x1F1E2
{
	if (bParam1)
		return;
...
BOOL func_805(int iParam0) // Position - 0x1F293
{
	if (!func_954(iParam0))
		return false;
...
void func_806(int iParam0) // Position - 0x1F2AF
{
	if (!func_954(iParam0))
		return;
...
void func_807(Hash hParam0) // Position - 0x1F2D0
{
...
Hash func_808(Hash hParam0, BOOL bParam1) // Position - 0x1F355
{
	Hash hash;
...
Hash func_809(Hash hParam0, BOOL bParam1) // Position - 0x1F54B
{
	if (!func_17(hParam0, 0))
		return 0;
...
void func_810(Hash hParam0) // Position - 0x1F577
{
	Hash weaponUnlock;
...
BOOL func_811(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, Hash hParam6, BOOL bParam7) // Position - 0x1F5B1
{
	var unk;
	var unk6;
	var unk28;
...
BOOL func_812(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1F6E1
{
	if (iParam1 < 1)
		return true;
...
BOOL func_813(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1F71C
{
	int num;
	var unk;
	var unk6;
...
BOOL func_814(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1F78B
{
	Hash TypeOfWeapon;
	var unk;
	int num;
	...
	TypeOfWeapon = func_809(hParam0, false);
	...
	if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
	{
		if (func_37() == -1)
		{
			...
			if (hParam1 == 1248274121)
				func_964(TypeOfWeapon);
		}
	
		if (!func_952(hParam0, &unk, 1, false, false, -1, false))
		{
			func_950(hParam0, 1, false, uParam2, hParam1);
			num = func_965(TypeOfWeapon);
		
			if (WEAPON::_IS_WEAPON_SNIPER(TypeOfWeapon))
			{
				func_811(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (TypeOfWeapon == joaat("weapon_fishingrod") || WEAPON::_IS_WEAPON_BINOCULARS(TypeOfWeapon))
			{
				func_811(TypeOfWeapon, 0, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::_IS_WEAPON_LASSO(TypeOfWeapon))
			{
				func_811(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::IS_WEAPON_MELEE_WEAPON(TypeOfWeapon))
			{
				if (TypeOfWeapon == joaat("weapon_melee_knife_john") && !func_966())
					return false;
			
				if (WEAPON::SHOULD_WEAPON_BE_DISCARDED_WHEN_SWAPPED(hParam0))
				{
				}
				else if (!func_967(TypeOfWeapon))
				{
					func_811(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
				}
				else
				{
					func_811(TypeOfWeapon, WEAPON::GET_WEAPON_CLIP_SIZE(TypeOfWeapon) * 4, bParam3, bParam4, 0, false, hParam1, false);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(TypeOfWeapon))
			{
				weaponHash = func_968(Global_33, 2, false, true);
			
				if (func_684(weaponHash) && !Global_26688 && weaponHash != TypeOfWeapon && !func_295(joaat("upgrade_offhand_holster"), 1) && bParam4)
					WEAPON::_SEND_WEAPON_TO_INVENTORY(Global_33, weaponHash);
			
				if (func_684(weaponHash) && func_295(joaat("upgrade_offhand_holster"), 1))
					if (!func_811(TypeOfWeapon, num, bParam3, bParam4, 3, true, hParam1, false))
						return false;
				else if (!func_811(TypeOfWeapon, num, bParam3, bParam4, 0, true, hParam1, false))
					return false;
			}
			else if (!func_811(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false))
			{
				return false;
			}
		}
...
BOOL func_815(Hash hParam0, var uParam1, Hash hParam2) // Position - 0x1F999
{
	int num;
	int weaponClipSize;
	int ReturnMaxAmmo;
...
struct<2> func_816(int iParam0) // Position - 0x1FA97
{
	var unk;
...
BOOL func_817() // Position - 0x1FAA9
{
	return false;
}

int func_818(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, int iParam5, BOOL bParam6, int iParam7) // Position - 0x1FAB2
{
	int num;
...
void func_819(Hash hParam0) // Position - 0x1FAF9
{
	return;
}

void func_820(Hash hParam0) // Position - 0x1FB01
{
	return;
}

void func_821(Hash hParam0) // Position - 0x1FB09
{
	return;
}

void func_822(Hash hParam0) // Position - 0x1FB11
{
	return;
}

void func_823() // Position - 0x1FB19
{
...
void func_824(Hash hParam0, var uParam1) // Position - 0x1FB3D
{
	var unk;
...
void func_825(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x1FB4F
{
	int num;
	int num2;
...
void func_826(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1FBAF
{
	int num;
	int num2;
...
void func_827(var uParam0) // Position - 0x1FC2A
{
	switch (*uParam0)
	{
...
void func_828(Hash hParam0) // Position - 0x1FC6E
{
	if (func_37() != -1)
		return;
...
BOOL func_829(Hash hParam0, int iParam1) // Position - 0x1FC81
{
	var unk;
	var unk5;
...
void func_830(Hash hParam0) // Position - 0x1FCB5
{
	switch (hParam0)
	{
		case joaat("provision_bird_feather_flight"):
...
void func_831(Hash hParam0, int iParam1) // Position - 0x1FCCE
{
	char* str;
...
int func_832(Hash hParam0) // Position - 0x1FD0F
{
	var unk;
	int num;
...
BOOL func_833(Hash hParam0) // Position - 0x1FD49
{
	!func_17(hParam0, 0);
...
int func_834(Hash hParam0, int iParam1) // Position - 0x1FD6F
{
	var unk;
	int num;
	int num2;
...
char* func_835(Hash hParam0) // Position - 0x1FDBD
{
	Hash labelHash;
...
BOOL func_836(Hash hParam0) // Position - 0x1FDF1
{
...
char* func_837(Hash hParam0) // Position - 0x1FE1F
{
	Hash labelHash;
...
void func_838(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x1FE52
{
...
BOOL func_839(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4) // Position - 0x1FE83
{
	return func_975(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(pedParam0), hParam1, iParam2, bParam3, hParam4);
}

BOOL func_840(Hash hParam0) // Position - 0x1FE9D
{
	int i;
	int num;
	Hash hash;
...
BOOL func_841(int iParam0, Hash hParam1, int iParam2) // Position - 0x1FEDF
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_842(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1FF77
{
	Player player;
...
int func_843(Ped pedParam0, Hash hParam1, int iParam2) // Position - 0x1FFB8
{
	int i;
	Hash peltFromHorse;
...
int func_844(Ped pedParam0, Hash hParam1) // Position - 0x2006C
{
	int num;
	ItemSet itemSet;
	int itemsetSize;
...
void func_845(Any* panParam0, Hash hParam1) // Position - 0x2010A
{
	MISC::COPY_SCRIPT_STRUCT(hParam1, panParam0, 96);
	return;
}

int func_846(Hash hParam0) // Position - 0x2011C
{
	int num;
	Hash hash;
...
int func_847(Hash hParam0) // Position - 0x20175
{
	switch (hParam0)
	{
		case joaat("PROVISION_ANIMAL_CARCASS_CHICKEN_PERFECT"):
...
void func_848(Hash hParam0, int iParam1) // Position - 0x20C86
{
	Ped mountOwnedByPlayer;
...
BOOL func_849(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x20CB5
{
	var unk;
	var unk6;
...
int func_850(int iParam0) // Position - 0x20D0C
{
	int num;
...
BOOL func_851(var uParam0) // Position - 0x210AF
{
	if (!func_988())
		return false;
...
BOOL func_852(Hash hParam0, var uParam1, BOOL bParam2) // Position - 0x210E0
{
	*uParam1 = 0;
...
BOOL func_853(Hash hParam0) // Position - 0x2112A
{
	if (func_17(hParam0, 0))
	{
...
BOOL func_854(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x21233
{
	int num;
...
BOOL func_855(Any* panParam0, Hash hParam1, Any* panParam2, BOOL bParam3, int iParam4) // Position - 0x2126E
{
	var outGuid;
...
int func_856(Hash hParam0) // Position - 0x212BC
{
	int num;
...
struct<5> func_857(int iParam0) // Position - 0x212D6
{
	var unk;
...
struct<4> func_858(int iParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6) // Position - 0x21303
{
	var outGuid;
...
void func_859(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x21330
{
	int i;
	int j;
	int k;
...
int func_860(int iParam0) // Position - 0x21499
{
	return func_991(func_990(iParam0));
}

void func_861(int iParam0, var uParam1) // Position - 0x214AB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_862(Hash hParam0, Hash hParam1) // Position - 0x215A8
{
	if (!func_17(hParam0, 0))
		return false;
...
int func_863(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x215F4
{
	var unk;
	int num;
	int i;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_864(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x21688
{
	int i;
...
int func_865(int iParam0) // Position - 0x21718
{
	switch (iParam0)
	{
		case 0:
...
int func_866(Ped pedParam0) // Position - 0x2194B
{
	int num;
	int pedQuality;
...
int func_867(int iParam0) // Position - 0x219A1
{
	switch (iParam0)
	{
		case joaat("PROVISION_ANIMAL_CARCASS_CHICKEN_PERFECT"):
...
int func_868(Player plParam0) // Position - 0x223DE
{
	int i;
...
BOOL func_869(Hash hParam0, Hash hParam1) // Position - 0x22441
{
	Hash categoryItemSetBuyAward;
	int num;
	int i;
...
BOOL func_870(int iParam0) // Position - 0x224BD
{
	if (iParam0 < 0)
		return false;
...
int func_872(int iParam0) // Position - 0x224FB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_873(int iParam0) // Position - 0x2252C
{
	switch (iParam0)
	{
...
BOOL func_874(int iParam0) // Position - 0x225B1
{
	switch (iParam0)
	{
...
BOOL func_875() // Position - 0x225CF
{
	return func_54(1);
}

BOOL func_876(int iParam0) // Position - 0x225DC
{
	switch (iParam0)
	{
...
BOOL func_877(Any* panParam0) // Position - 0x2264E
{
...
BOOL func_878(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x2266A
{
...
void func_879(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x22682
{
	int i;
...
BOOL func_880(int iParam0, var uParam1, Any* panParam2) // Position - 0x22720
{
	if (!func_391(iParam0))
		return false;
...
BOOL func_881(Any* panParam0, int iParam1) // Position - 0x2282B
{
...
int func_883() // Position - 0x2289A
{
	return Global_1110244.f_3667.f_938;
}

int func_884(int iParam0, int iParam1, var uParam2) // Position - 0x228AC
{
	int num;
...
int func_885(int iParam0) // Position - 0x22916
{
	return Global_1110244.f_3667.f_729[iParam0 /*2*/].f_1;
}

BOOL func_886(int iParam0) // Position - 0x2292E
{
	return iParam0 > -1 && iParam0 < 83;
}

BOOL func_887(Any* panParam0) // Position - 0x22944
{
	int fileHandle;
	var SourceStruct;
...
BOOL func_888(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int* piParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x2297D
{
	uParam0.f_2 = iParam6;
	uParam0.f_3 = iParam7;
	uParam0.f_4 = iParam8;
...
struct<8> func_889(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x229A8
{
	return func_999(uParam0, 52, 1);
}

int func_890(Hash hParam0) // Position - 0x229BB
{
	switch (hParam0)
	{
...
BOOL func_891(int iParam0) // Position - 0x22A54
{
	if (!func_485(iParam0))
		return false;
...
int func_892(BOOL bParam0, Hash hParam1) // Position - 0x22A72
{
	if (!NETWORK::NETWORK_IS_IN_SESSION())
		return 0;
...
void func_893(int iParam0) // Position - 0x22AC8
{
	switch (iParam0)
	{
		case 2:
...
void func_894(Hash hParam0, int iParam1) // Position - 0x22CCE
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_895() // Position - 0x22CE1
{
	return true;
}

int func_896(int iParam0) // Position - 0x22D00
{
	if (iParam0 == 2)
		iParam0 = func_1001(1);
...
void func_897(float fParam0, Ped pedParam1) // Position - 0x22D40
{
	if (fParam0 == 0f)
		return;
...
int func_898(int iParam0) // Position - 0x22D84
{
	if (iParam0 == 2)
		iParam0 = func_1001(1);
...
void func_899(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x22DC8
{
	Player player;
	Ped EntityIndex;
...
int func_900(int iParam0) // Position - 0x22E79
{
	if (iParam0 == 2)
		iParam0 = func_1001(1);
...
void func_901(float fParam0, Ped pedParam1) // Position - 0x22EBD
{
	if (fParam0 == 0f)
		return;
...
float func_902(int iParam0, float fParam1, BOOL bParam2) // Position - 0x22EFF
{
	int num;
	int num2;
...
float func_903(int iParam0, int iParam1) // Position - 0x22F68
{
	if (iParam1 == 2)
		iParam1 = func_1001(2);
...
int func_904(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x22FB4
{
	Ped ped;
...
int func_905(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x23032
{
	char* effectName;
	Ped ped;
...
BOOL func_906() // Position - 0x231E8
{
...
void func_907(float fParam0, int iParam1) // Position - 0x23211
{
	float num;
	int num2;
	int num3;
...
Hash func_908(int iParam0) // Position - 0x23284
{
	Hash hash;
...
Hash func_909() // Position - 0x232A7
{
	return Global_1953292.f_1676;
}

int func_910(BOOL bParam0) // Position - 0x232B6
{
	var unk;
	int num;
	var unk15;
...
Hash func_911(int iParam0) // Position - 0x233C3
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_912(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x23460
{
	int i;
	BOOL flag;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_913(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6, BOOL bParam7, BOOL bParam8, int iParam9) // Position - 0x23540
{
	Hash hash;
	int num;
	BOOL flag;
...
void func_914(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4, Hash hParam5) // Position - 0x2376F
{
	*panParam0 = iParam1;
...
BOOL func_915(var uParam0, int iParam1) // Position - 0x2379E
{
	return uParam0->f_1 && iParam1 != false;
}

void func_916(var uParam0, int iParam1, int iParam2) // Position - 0x237AF
{
	uParam0->f_1 = uParam0->f_1 || iParam1;
	return;
}

BOOL func_917(int iParam0, int iParam1) // Position - 0x237C2
{
	return iParam0->f_1 && iParam1 != false;
}

void func_918(int iParam0, int iParam1) // Position - 0x237D3
{
	iParam0->f_1 = iParam0->f_1 || iParam1;
	return;
}

int func_919(int iParam0) // Position - 0x237E6
{
	if (iParam0 == 0)
		iParam0 = func_584();
...
void func_920(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x23822
{
	int num;
	Hash hash;
...
void func_921(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x23885
{
	int num;
...
void func_922(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x238EA
{
	int num;
...
BOOL func_923(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x23937
{
	int num;
...
BOOL func_924(int iParam0) // Position - 0x23984
{
	return Global_17418.f_55.f_664.f_1734 && iParam0 != false;
}

Hash func_925(Hash hParam0, int iParam1) // Position - 0x2399C
{
	int num;
	int num2;
	int num3;
...
void func_926(Hash hParam0, int iParam1) // Position - 0x239E9
{
	int num;
	BOOL flag;
...
void func_927(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x23AAF
{
	int num;
...
void func_928(Hash hParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x23BB7
{
	int num;
	Hash hash;
...
void func_929(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x23C99
{
	int num;
	Hash hash;
...
void func_930(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x23F06
{
	int num;
...
BOOL func_931(int iParam0) // Position - 0x2401C
{
	return Global_1953292.f_1676.f_1[func_361(iParam0, 1) /*3*/] != Global_1953292.f_83[func_361(iParam0, 1) /*12*/];
}

void func_932(Hash hParam0, int iParam1) // Position - 0x24046
{
	int num;
...
void func_933(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x24111
{
	int num;
	Hash hash;
	BOOL flag;
...
void func_934(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x243B9
{
	int num;
	Hash hash;
...
void func_935(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x2451A
{
	int num;
	Hash hash;
...
void func_936(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x246CF
{
	int num;
	Hash hash;
...
void func_937(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x2490A
{
	int num;
...
void func_938(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x24B02
{
	int num;
	Hash hash;
...
void func_939(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x24C1F
{
	int num;
...
void func_940(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x24C7E
{
	int num;
...
void func_941(Hash hParam0, int iParam1, int iParam2) // Position - 0x24D75
{
	Global_17418.f_55.f_664.f_33[iParam2 /*120*/].f_1.f_1[iParam1 /*3*/] = { *hParam0 };
	return;
}

void func_942(Hash hParam0, int iParam1) // Position - 0x24D99
{
	int i;
...
void func_943(BOOL bParam0, int iParam1, int iParam2) // Position - 0x24DEA
{
	if (iParam1 == -1)
		iParam1 = Global_17418.f_55.f_664.f_1777;
...
BOOL func_944(int iParam0, int iParam1) // Position - 0x24E35
{
	int num;
...
BOOL func_945(Player plParam0) // Position - 0x24EA9
{
...
void func_946(Player plParam0) // Position - 0x24EC6
{
	Player player;
...
void func_947(var uParam0) // Position - 0x24F49
{
...
void func_948(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x24F81
{
	int i;
	var unk;
...
BOOL func_949(Hash hParam0) // Position - 0x25037
{
	var unk;
...
void func_950(Hash hParam0, int iParam1, BOOL bParam2, var uParam3, Hash hParam4) // Position - 0x2507C
{
	Hash TypeOfWeapon;
	...
	if (bParam2 || !func_960(TypeOfWeapon))
	{
		if (bParam2 || !WEAPON::HAS_PED_GOT_WEAPON(Global_33, TypeOfWeapon, 0, false) && func_263(hParam0, false, false, false) == 0)
		{
			if (func_37() == -1)
				func_810(TypeOfWeapon);
...
void func_951(Hash hParam0, var uParam1) // Position - 0x25126
{
...
BOOL func_952(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x2514B
{
	var unk;
	var unk5;
	int num;
...
BOOL func_953() // Position - 0x2527F
{
...
BOOL func_954(int iParam0) // Position - 0x252E4
{
	if (iParam0 == 0)
		return false;
...
BOOL func_955(int iParam0) // Position - 0x252F7
{
	int num;
	int num2;
	int offset;
...
void func_956(int iParam0) // Position - 0x25321
{
	int num;
	int num2;
	int BitIndex;
...
void func_957(int iParam0) // Position - 0x2535B
{
	switch (iParam0)
	{
		case 1:
...
int func_958(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x258D7
{
	var unk;
	var unk13;
	var unk26;
...
BOOL func_959(Hash hParam0) // Position - 0x25907
{
	Hash weaponUnlock;
...
BOOL func_960(Hash hParam0) // Position - 0x2592F
{
	Hash weaponUnlock;
...
void func_961(Hash hParam0, int iParam1) // Position - 0x25957
{
	...
	{
		AmmoInClip = func_1048(WEAPON::GET_WEAPON_CLIP_SIZE(hParam0), iParam1);
...
int func_962(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x259C9
{
	int num;
	var guid2;
	var guid1;
...
int func_963(Hash hParam0, Any* panParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x25A45
{
	if (!func_17(hParam0, 0))
		return 0;
...
void func_964(Hash hParam0) // Position - 0x25AAD
{
	char* decoratorName;
	char* decoratorName2;
	int value;
...
int func_965(Hash hParam0) // Position - 0x25B7C
{
	int num;
	int pedAmmoByType;
...
BOOL func_966() // Position - 0x25BF8
{
	return false;
}

BOOL func_967(Hash hParam0) // Position - 0x25C01
{
	return WEAPON::_IS_AMMO_VALID(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0));
}

Hash func_968(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x25C13
{
...
int func_969(Hash hParam0) // Position - 0x25C39
{
	Hash weaponTypeFromAmmoType;
...
int func_970(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x25CA5
{
	float num;
	int num2;
	int i;
...
void func_971(int iParam0, const char* sParam1, int iParam2, BOOL bParam3) // Position - 0x25D75
{
	if (iParam0 == 0)
		return;
...
void func_972(int iParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x25DC7
{
	int num;
	int value;
	int num2;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x25EA2
{
	switch (iParam0)
	{
		case 0:
...
Hash func_974(Hash hParam0) // Position - 0x25F79
{
	Hash num;
...
BOOL func_975(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4) // Position - 0x25FA3
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_976(Hash hParam0) // Position - 0x2607D
{
	if (!func_17(hParam0, 0))
		return false;
...
int func_977(int iParam0, int iParam1) // Position - 0x260AB
{
	switch (iParam0)
	{
		case 0:
...
Hash func_978(Hash hParam0) // Position - 0x264FC
{
	if (!func_840(hParam0))
		return 0;
...
int func_979(Hash hParam0, int iParam1) // Position - 0x26514
{
	switch (hParam0)
	{
		case joaat("provision_beaver_fur"):
...
BOOL func_980(int iParam0, BOOL bParam1) // Position - 0x2687C
{
	Player player;
	Player player2;
	int num;
...
int func_981(Player plParam0, BOOL bParam1) // Position - 0x26975
{
	return bParam1 ? Global_1289643[plParam0 /*19*/].f_1 : Global_1289643[plParam0 /*19*/];
}

int func_982(BOOL bParam0) // Position - 0x26995
{
	return bParam0 ? Global_1901671.f_701.f_30 : Global_1901671.f_701.f_29;
}

void func_983() // Position - 0x269B5
{
	var SourceStruct;

	SourceStruct = 7;
	SourceStruct.f_8 = -1;
	MISC::COPY_SCRIPT_STRUCT(&uLocal_0, &SourceStruct, 13);
	return;
}

void func_984(var uParam0) // Position - 0x269D4
{
	int i;
...
int func_985(var uParam0) // Position - 0x269F7
{
	switch (uParam0->f_9)
	{
		case 0:
...
BOOL func_986(var uParam0, int iParam1) // Position - 0x26A2F
{
...
int func_987(var uParam0) // Position - 0x26A64
{
	int num;
...
BOOL func_988() // Position - 0x26AB3
{
...
int func_989(int iParam0, var uParam1) // Position - 0x26AEE
{
	if (iParam0 == 2)
...
int func_990(int iParam0) // Position - 0x26B08
{
	if (!func_244(iParam0))
		return -1;
...
int func_991(int iParam0) // Position - 0x27030
{
	if (iParam0 < 0)
		return -1;
	else if (iParam0 <= 10)
...
BOOL func_992(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x2712C
{
	if (!func_516(hParam0))
		return false;
...
void func_993(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x27164
{
	int i;
	int j;
	int k;
...
BOOL func_994(int iParam0) // Position - 0x2733A
{
	switch (iParam0)
	{
...
BOOL func_995(Any* panParam0) // Position - 0x2739A
{
...
void func_996(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x273D0
{
	int i;
...
void func_997(Any* panParam0) // Position - 0x274AC
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
int func_998() // Position - 0x274C2
{
	return Global_1072759.f_28418[32 /*4*/].f_3;
}

struct<8> func_999(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6) // Position - 0x274D7
{
	var unk;
...
BOOL func_1000() // Position - 0x274F5
{
	return !Global_1572887.f_10;
}

int func_1001(int iParam0) // Position - 0x27504
{
	return func_1060(func_1059(iParam0));
}

BOOL func_1002(Player plParam0) // Position - 0x27516
{
	float num;
...
int func_1003() // Position - 0x27531
{
	return Global_1902569;
}

void func_1004(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2753D
{
	int num;
	int i;
	int j;
...
int func_1005(int iParam0, int iParam1) // Position - 0x276B0
{
	if (iParam1 == 2)
		iParam1 = func_1001(2);
...
int func_1006(int iParam0, int iParam1) // Position - 0x27700
{
	if (iParam1 == 2)
		iParam1 = func_1001(2);
...
BOOL func_1007(int iParam0, int iParam1, BOOL bParam2) // Position - 0x27752
{
	if (bParam2)
...
void func_1008(int iParam0, int iParam1, int iParam2) // Position - 0x2777F
{
	if (iParam2 == 2)
		iParam2 = func_1001(2);
...
void func_1009(int iParam0, int iParam1, int iParam2) // Position - 0x277D5
{
	if (iParam2 == 2)
		iParam2 = func_1001(2);
...
BOOL func_1010(Ped pedParam0, int iParam1, float fParam2) // Position - 0x2782B
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
void func_1011(int iParam0, int iParam1, int iParam2) // Position - 0x27880
{
	if (iParam2 == 2)
		iParam2 = func_1001(2);
...
void func_1012(Ped pedParam0, int iParam1, float fParam2) // Position - 0x278E1
{
	char* StringToTest;

	StringToTest = func_1072(iParam1);
...
void func_1013(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x2790D
{
	int num;
...
BOOL func_1014(int iParam0) // Position - 0x27943
{
	switch (iParam0)
	{
		case 0:
...
char* func_1015(int iParam0) // Position - 0x27972
{
	switch (iParam0)
	{
		case 0:
...
void func_1016(int iParam0) // Position - 0x279AC
{
	int num;
	int num2;
	int i;
...
void func_1017(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x27A7C
{
	func_904(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

BOOL func_1018(int iParam0, BOOL bParam1) // Position - 0x27A96
{
	return func_1007(func_1003(), iParam0, bParam1);
}

float func_1019(int iParam0, int iParam1) // Position - 0x27AAA
{
	if (iParam1 == 2)
		iParam1 = func_1001(1);
...
int func_1020(float fParam0) // Position - 0x27AF6
{
	float num;
...
float func_1021(float fParam0, float fParam1, float fParam2) // Position - 0x27B21
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_1022(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x27B48
{
	int num;
	int i;
	int num2;
...
int func_1023(int iParam0, float fParam1, int iParam2) // Position - 0x27CD0
{
...
int func_1024(int iParam0) // Position - 0x27D21
{
	switch (iParam0)
	{
		case -1932005642:
...
// Unhandled jump detected. Output should be considered invalid
void func_1025(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x27EC2
{
	int i;
	Hash hash;
	Hash hash2;
...
void func_1026(Hash hParam0, int iParam1, int iParam2) // Position - 0x27F9B
{
	Global_1953292.f_83[func_361(hParam0, 1) /*12*/].f_11 = Global_1953292.f_83[func_361(hParam0, 1) /*12*/].f_11 || iParam1;
	return;
}

BOOL func_1027(Hash hParam0) // Position - 0x27FC8
{
	int num;
	var unk;
...
int func_1028(Hash hParam0) // Position - 0x28022
{
	var unk;
	int num;
...
void func_1029(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x2805C
{
	int i;
	BOOL flag;
...
int func_1030(int iParam0, int iParam1, int iParam2) // Position - 0x28168
{
	int i;
	var unk;
	int num;
...
void func_1031(Hash hParam0, int iParam1, int iParam2) // Position - 0x28235
{
	int num;
...
BOOL func_1032(int* piParam0, int iParam1, int iParam2) // Position - 0x282C9
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_1033() // Position - 0x28300
{
	return Global_1102813.f_3672;
}

void func_1034(Player plParam0) // Position - 0x2830F
{
	Player player;
...
void func_1035(Player plParam0) // Position - 0x2837B
{
...
BOOL func_1036(Any anParam0) // Position - 0x283B6
{
...
int func_1037(var uParam0) // Position - 0x283FC
{
...
void func_1038(BOOL bParam0) // Position - 0x28486
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_1039(int iParam0) // Position - 0x284C4
{
...
void func_1040(BOOL bParam0) // Position - 0x28532
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_1041(BOOL bParam0) // Position - 0x2856C
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_1042(BOOL bParam0) // Position - 0x285A6
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_1043(BOOL bParam0) // Position - 0x285E0
{
	Hash hash;
...
void func_1044(BOOL bParam0) // Position - 0x28603
{
	int promptType;
	Player player;
...
void func_1045(BOOL bParam0) // Position - 0x28645
{
	int promptType;
	Player player;
...
int func_1046(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x28687
{
	int num;
	int num2;
	int num3;
...
int func_1047(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x286ED
{
	BOOL flag;
	int num;
	var unk;
...
int func_1048(int iParam0, int iParam1) // Position - 0x287CE
{
	if (iParam0 > iParam1)
		return iParam1;
...
void func_1049(int iParam0, int iParam1) // Position - 0x287E4
{
	if (iParam0 <= 0)
		return;
...
BOOL func_1050() // Position - 0x28820
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_1051() // Position - 0x28831
{
	return DLC::IS_DLC_PRESENT(joaat("dlc_ultimateedition"));
}

BOOL func_1052(int iParam0, Hash hParam1, int iParam2) // Position - 0x28842
{
	if (!func_17(hParam1, 0))
		return false;
...
BOOL func_1053(int iParam0, Hash hParam1, int iParam2, Hash hParam3, BOOL bParam4) // Position - 0x28864
{
	var unk;
	var unk6;
...
var func_1054(BOOL bParam0, var uParam1, var uParam2) // Position - 0x288B3
{
	if (bParam0)
		return uParam1;
...
BOOL func_1055(var uParam0) // Position - 0x288CA
{
...
BOOL func_1056(var uParam0) // Position - 0x288EC
{
	switch (uParam0->f_9)
	{
		case 0:
...
BOOL func_1057(Hash hParam0, Hash hParam1) // Position - 0x28935
{
	var unk;
	int num;
	Hash unlockHash;
...
void func_1058(int iParam0) // Position - 0x28A7E
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
BOOL func_1059(int iParam0) // Position - 0x28AA1
{
	return func_1032(&(Global_1956875.f_1565), iParam0, 1);
}

int func_1060(BOOL bParam0) // Position - 0x28AB7
{
	if (bParam0)
		return 1;
...
float func_1061(Player plParam0) // Position - 0x28AC9
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_1095(2);
}

int func_1062(int iParam0) // Position - 0x28ADF
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_1063(int iParam0) // Position - 0x28B04
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_1064(int iParam0) // Position - 0x28B17
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_1065(int iParam0) // Position - 0x28B2A
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_1066(int iParam0) // Position - 0x28B3D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_1067(int iParam0) // Position - 0x28B4F
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_1068(int iParam0, int iParam1) // Position - 0x28B61
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_1069(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x28BFB
{
...
BOOL func_1070(int iParam0) // Position - 0x28C33
{
	int num;
	int num2;
	int num3;
...
int func_1071(int iParam0) // Position - 0x28D0F
{
	switch (iParam0)
	{
		case 0:
...
char* func_1072(int iParam0) // Position - 0x28D3E
{
	switch (iParam0)
	{
		case 0:
...
char* func_1073(int iParam0) // Position - 0x28D78
{
	switch (iParam0)
	{
		case 0:
...
void func_1074(int iParam0, float fParam1, int iParam2) // Position - 0x28DB2
{
	if (iParam2 == 2)
		iParam2 = func_1001(2);
...
void func_1075(int iParam0, int iParam1, int iParam2) // Position - 0x28E04
{
	if (iParam2 == 2)
		iParam2 = func_1001(2);
...
int func_1076(int iParam0, int iParam1) // Position - 0x28E5A
{
	switch (iParam0)
	{
		case -2101912686:
...
// Unhandled jump detected. Output should be considered invalid
int func_1077(int iParam0) // Position - 0x2965B
{
	int num;
	int num2;
	int num3;
...
BOOL func_1078(int iParam0) // Position - 0x298EB
{
	if (func_1014(iParam0))
		return true;
...
void func_1079(int iParam0, float fParam1, int iParam2) // Position - 0x29911
{
	if (fParam1 < 0f)
		return;
...
BOOL func_1080(var uParam0, int iParam1) // Position - 0x2996D
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_1081(int iParam0, int iParam1) // Position - 0x2997E
{
...
Vector3 func_1082(int iParam0, int iParam1) // Position - 0x299AD
{
	if (iParam1 == -1)
		iParam1 = Global_17418.f_55.f_664.f_1777;
...
BOOL func_1088(int iParam0, int iParam1) // Position - 0x29AC7
{
	return iParam0 && iParam1 != false;
}

BOOL func_1089(Hash hParam0) // Position - 0x29AD6
{
	return func_19(hParam0, 1279601681);
}

void func_1090(int iParam0, int iParam1) // Position - 0x29AE9
{
	if (iParam1 == 0)
		return;
...
void func_1091(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x29B19
{
	int i;
	var unk;
...
BOOL func_1092() // Position - 0x29BD4
{
	return Global_1913444.f_127 == 0;
}

BOOL func_1093(int iParam0, Hash hParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x29BE4
{
	var unk;
...
void func_1094(var uParam0) // Position - 0x29C5C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_1095(int iParam0) // Position - 0x29CB7
{
	switch (iParam0)
	{
		case 0:
...
void func_1096(var uParam0, int iParam1) // Position - 0x29CF8
{
	if (iParam1 < 0)
		return;
...
void func_1097(var uParam0, int iParam1) // Position - 0x29D7E
{
...
void func_1098(var uParam0, int iParam1) // Position - 0x29DBA
{
	int num;
	int num2;
...
void func_1099(var uParam0, int iParam1) // Position - 0x29E0D
{
...
void func_1100(var uParam0, int iParam1) // Position - 0x29E48
{
...
void func_1101(var uParam0, int iParam1) // Position - 0x29E81
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_1102(int iParam0) // Position - 0x29EB9
{
	int num;
...
BOOL func_1103(int iParam0) // Position - 0x29EE1
{
	int num;
...
int func_1104(int iParam0, int iParam1) // Position - 0x29F09
{
	switch (iParam0)
	{
...
int func_1105(int iParam0, int iParam1) // Position - 0x2A5C0
{
	Player player;
	Player player2;
	int num;
...
int func_1106(int iParam0, int iParam1, int iParam2) // Position - 0x2A643
{
	int num;
	int num2;
...
void func_1107(int iParam0) // Position - 0x2A73B
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_1108(int iParam0, int iParam1) // Position - 0x2A751
{
	switch (iParam0)
	{
...
void func_1109(int iParam0, int iParam1) // Position - 0x2B002
{
	Global_1156111.f_35859.f_3116[iParam0 /*31*/].f_29 = Global_1156111.f_35859.f_3116[iParam0 /*31*/].f_29 + iParam1;
	return;
}

void func_1110(int iParam0, int iParam1) // Position - 0x2B031
{
	Global_1156111.f_35859.f_3116[iParam0 /*31*/].f_29 = iParam1;
	return;
}

void func_1111(int iParam0) // Position - 0x2B04D
{
	int i;
...
BOOL func_1112(int iParam0) // Position - 0x2B07B
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_1113(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, Any* panParam5, BOOL bParam6) // Position - 0x2B0A0
{
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&uParam1))
		return false;
...
Player func_1114(int iParam0) // Position - 0x2B0CC
{
...
BOOL func_1115(int iParam0) // Position - 0x2B0ED
{
	int num;
...
int func_1116(int iParam0, int iParam1, int iParam2) // Position - 0x2B115
{
	int num;
	int num2;
	int num3;
...
BOOL func_1117(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x2B306
{
	return uParam0.f_4 != 0;
}

BOOL func_1118(int iParam0, int iParam1) // Position - 0x2B314
{
	int num;
...
Vector3 func_1119(int iParam0) // Position - 0x2B354
{
	int num;
	var unk;
...
BOOL func_1120(int iParam0, var uParam1, var uParam2) // Position - 0x2B390
{
	if (!func_1115(iParam0))
		return false;
...
BOOL func_1121(int iParam0, int iParam1, int iParam2) // Position - 0x2B3C7
{
	int num;
	int num2;
	int num3;
...
void func_1122(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2B5F5
{
	int num;
...
void func_1123(int iParam0) // Position - 0x2B674
{
	int num;
...
BOOL func_1124(int iParam0) // Position - 0x2B6C9
{
	int num;
...
int func_1125(int iParam0) // Position - 0x2B6F0
{
	int num;
...
int func_1126(int iParam0, int iParam1) // Position - 0x2B78A
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_1127(int iParam0) // Position - 0x2BBC3
{
	int num;
...
float func_1128(int iParam0) // Position - 0x2BBEB
{
	float num;
...
void func_1129(int iParam0) // Position - 0x2BC1A
{
	int num;
	int num2;
	int i;
...
BOOL func_1130(int iParam0) // Position - 0x2BDF9
{
	int num;
...
int func_1131(int iParam0, int iParam1) // Position - 0x2BE21
{
	switch (iParam0)
	{
...
void func_1132(int iParam0) // Position - 0x2C133
{
	Ped ped;
	Player player;
...
BOOL func_1133(int iParam0) // Position - 0x2C342
{
	int num;
...
int func_1134(int iParam0, int iParam1) // Position - 0x2C369
{
	switch (iParam0)
	{
...
int func_1135(int iParam0) // Position - 0x2C3C6
{
	int num;
	var unk;
	var unk32;
...
BOOL func_1136(int iParam0) // Position - 0x2C50A
{
...
void func_1137(int iParam0) // Position - 0x2C528
{
	int num;
	int num2;
	int i;
...
BOOL func_1138(int iParam0) // Position - 0x2C67D
{
	BOOL flag;
...
void func_1139(int iParam0) // Position - 0x2C6A6
{
	Ped EntityIndex;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_1154(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_1161(iParam0, 0));
			func_1162(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_1161(iParam0, 1));
			func_1162(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_1161(iParam0, 2));
			func_1162(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_1161(iParam0, 3));
			func_1162(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_1140(int iParam0) // Position - 0x2C941
{
	char* StringToTest;
	char* StringToTest2;
	...
	StringToTest = func_1164(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	StringToTest2 = func_1165(iParam0);
...
BOOL func_1141(int iParam0) // Position - 0x2C98B
{
	int num;
...
BOOL func_1142(int iParam0) // Position - 0x2C9B3
{
	int num;
...
BOOL func_1143(int iParam0) // Position - 0x2C9DB
{
	int num;
...
BOOL func_1144(int iParam0) // Position - 0x2CA03
{
	int num;
...
BOOL func_1145(int iParam0) // Position - 0x2CA2B
{
	int num;
...
BOOL func_1146(int iParam0) // Position - 0x2CA53
{
	int num;
...
float func_1147(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x2CA7B
{
	var unk;
	float num;
...
BOOL func_1148(int iParam0) // Position - 0x2CAB1
{
...
BOOL func_1149(int iParam0) // Position - 0x2CB20
{
	int num;
...
int func_1150(int iParam0, int iParam1) // Position - 0x2CB47
{
	switch (iParam0)
	{
...
void func_1151() // Position - 0x2CBA4
{
	BOOL bTrue;
	BOOL bTrue2;
...
void func_1152() // Position - 0x2CC06
{
	BOOL bTrue;
...
char* func_1153(int iParam0) // Position - 0x2CC36
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_1154(int iParam0) // Position - 0x2CC7D
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_1155(int iParam0) // Position - 0x2CCB8
{
	int i;
...
void func_1156() // Position - 0x2CCF8
{
...
int func_1157(int iParam0) // Position - 0x2CD18
{
	int num;
...
BOOL func_1158(int iParam0, int iParam1) // Position - 0x2CD47
{
	int num;
	Player player;
	int num2;
...
struct<31> func_1159(int iParam0) // Position - 0x2D01C
{
	int num;
...
BOOL func_1160(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0x2D040
{
	var unk;
	BOOL flag;
...
char* func_1161(int iParam0, int iParam1) // Position - 0x2D076
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_1162(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2D0CE
{
	int i;
...
void func_1163() // Position - 0x2D153
{
...
char* func_1164(int iParam0) // Position - 0x2D178
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_1165(int iParam0) // Position - 0x2D198
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_1166(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x2D1B8
{
	int num;
	int num2;
...
BOOL func_1167() // Position - 0x2D3D9
{
	if (!Global_1048577)
		return false;
...
int func_1168(int iParam0) // Position - 0x2D424
{
	int num;
