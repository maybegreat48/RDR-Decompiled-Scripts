...
void func_4(BOOL bParam0, int iParam1) // Position - 0x156
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

void func_5(int iParam0) // Position - 0x16B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
...
int func_6() // Position - 0x18F
{
	return Global_1220316.f_211;
}

void func_7(int iParam0) // Position - 0x19D
{
	Global_1220316.f_211 = iParam0;
	return;
}

int func_8() // Position - 0x1AD
{
...
void func_10(int iParam0, int iParam1) // Position - 0x1CB
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_13();
...
void func_13() // Position - 0x327
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_14() // Position - 0x333
{
...
void func_15(BOOL bParam0) // Position - 0x35F
{
	int num;
	var unk;
	int num2;
...
void func_16(BOOL bParam0, int iParam1) // Position - 0x428
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

BOOL func_17(BOOL bParam0, BOOL bParam1) // Position - 0x439
{
	int i;
...
int func_20() // Position - 0x579
{
	return Global_1220529;
}

void func_21() // Position - 0x585
{
	return;
}

void func_22() // Position - 0x58D
{
	if (func_30(Global_1220316, true))
		func_5(1);

	return;
}

void func_23() // Position - 0x5A6
{
	int i;
	int num;
...
void func_25() // Position - 0x724
{
	Global_1220316 = false;
	func_34();
	func_27(&Global_1220529);
	func_5(0);
	return;
...
BOOL func_26() // Position - 0x742
{
	return Global_1051645.f_8;
}

void func_27(int* piParam0) // Position - 0x750
{
	var unk;
	int i;
...
int func_28(int iParam0, int iParam1, char* sParam2) // Position - 0x79D
{
	return 1;
}

void func_29(int iParam0) // Position - 0x7A6
{
	struct<12> data;
	Player hostOfThread;
	int i;
	...
	switch (data.f_4)
	{
		...
		case 3:
			...
			for (i = 0; i < 16; i = i + 1)
			{
				if (Global_1220529.f_5[i /*5*/] != data.f_5)
				{
				}
				else
				{
		...
		case 5:
			...
			if (GANG::NETWORK_IS_GANG_ID_VALID(data.f_10))
				if (data.f_5 != -1)
					func_35(data.f_5, data.f_10);
			break;
		...
		case 8:
			if (data.f_5 == Global_1220316.f_206)
			{
				unk36 = -1;
...
BOOL func_30(BOOL bParam0, BOOL bParam1) // Position - 0xB1F
{
	return bParam0 && bParam1 != false;
}

BOOL func_31(int iParam0) // Position - 0xB2E
{
	var unk;
	int num;
	int num2;
...
void func_35(int iParam0, var uParam1) // Position - 0x133B
{
	Global_1207480.f_231[iParam0 /*15*/].f_5.f_2 = uParam1;
	return;
}

BOOL func_36(int iParam0) // Position - 0x1353
{
	var unk;
	int num;
	int num2;
...
var func_37(int iParam0, int iParam1) // Position - 0x144A
{
	return func_54(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

void func_38(Any* panParam0, var uParam1) // Position - 0x1468
{
...
void func_39(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x149F
{
	var unk;
	int i;
	BOOL flag;
...
void func_40(int iParam0) // Position - 0x15D5
{
	if (!NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		return;
...
void func_41(int iParam0) // Position - 0x1617
{
	if (!NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		return;
...
void func_42(int iParam0, BOOL bParam1) // Position - 0x1664
{
	if (iParam0 <= -1 || iParam0 >= 16)
		return;
...
void func_43(int iParam0) // Position - 0x16A5
{
	if (iParam0 <= -1 || iParam0 >= 16)
		return;
...
struct<40> func_44(var uParam0, int iParam1) // Position - 0x16E4
{
	var unk;
...
void func_45(var uParam0) // Position - 0x17E5
{
	var unk;
...
BOOL func_46(int* piParam0, var uParam1, BOOL bParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x18B6
{
	int num;
	int num2;
...
int func_47(int* piParam0, var uParam1) // Position - 0x19A7
{
	int i;
	int num;
...
struct<40> func_48(int* piParam0, int iParam1) // Position - 0x19E8
{
	var unk;
...
int func_49(var uParam0) // Position - 0x1A0A
{
	int num;
	int i;
...
BOOL func_50(int iParam0) // Position - 0x1A6B
{
	return iParam0 >= 0 && iParam0 < 71;
}

struct<15> func_51(int iParam0) // Position - 0x1A81
{
	var unk;
...
BOOL func_53(int iParam0) // Position - 0x1B94
{
	if (iParam0 < 3)
		return false;
...
var func_54(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x1BF2
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_70(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
var func_55(int iParam0) // Position - 0x1F85
{
	var value;
...
void func_56(Any* panParam0, var uParam1) // Position - 0x1F97
{
	if (!SCRIPTS::_IS_ANY_PLAYER_BIT_SET(&uParam1))
		return;
...
BOOL func_57(int* piParam0) // Position - 0x1FC5
{
	return *piParam0 == piParam0->f_2;
}

BOOL func_58(var uParam0) // Position - 0x1FD5
{
	if (uParam0->f_1 == -1)
		return false;
...
BOOL func_59(var uParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1FFA
{
	var unk;
	var unk34;
	BOOL flag;
...
void func_60(var uParam0, int iParam1) // Position - 0x2253
{
	*uParam0 = iParam1;
	return;
}

BOOL func_61(var uParam0, var uParam1) // Position - 0x2260
{
	if (uParam1->f_2 == -1)
		return false;
...
struct<40> func_62(int* piParam0, int iParam1) // Position - 0x2323
{
	var unk;
	var unk41;
...
void func_63(int* piParam0, int iParam1) // Position - 0x240B
{
	int num;
	int i;
	int num2;
...
BOOL func_64(var uParam0) // Position - 0x252D
{
	if (func_74(*uParam0))
		return true;
...
int func_65(var uParam0, int iParam1) // Position - 0x2571
{
	int num;
	int num2;
	BOOL flag;
...
BOOL func_66(int iParam0) // Position - 0x26D0
{
	if (iParam0 <= -1 || iParam0 >= 16)
		return false;
...
void func_67(var uParam0, int iParam1) // Position - 0x26FA
{
	uParam0->f_1 = iParam1;
	return;
}

int func_68() // Position - 0x2708
{
	return Global_1051645.f_12;
}

char* func_69() // Position - 0x2716
{
	return "unnamed";
}

BOOL func_70(int iParam0) // Position - 0x2721
{
	int num;
...
BOOL func_71(int iParam0) // Position - 0x27B0
{
...
int func_72(int iParam0) // Position - 0x27CE
{
	if (iParam0 == 255)
...
BOOL func_73(Player plParam0) // Position - 0x2819
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_74(var uParam0, var uParam1) // Position - 0x285E
{
	if (!func_85(uParam0))
		return false;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2892
{
...
int func_76(var uParam0, var uParam1) // Position - 0x28BC
{
	int num;
...
BOOL func_77(int iParam0, var uParam1) // Position - 0x28E6
{
	int num;
...
BOOL func_78(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2914
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

BOOL func_79(int* piParam0, int iParam1) // Position - 0x292F
{
	return iParam1 >= 0 && iParam1 < piParam0->f_2;
}

int func_80(int iParam0) // Position - 0x2947
{
	switch (iParam0)
	{
		case 0:
...
int func_81(int iParam0) // Position - 0x2982
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_82(int iParam0, int iParam1) // Position - 0x2A1E
{
	int num;
...
BOOL func_83(Player plParam0) // Position - 0x2A92
{
...
void func_84(Player plParam0) // Position - 0x2AAF
{
	Player player;
...
BOOL func_85(int iParam0) // Position - 0x2B32
{
	switch (iParam0)
	{
		case 2:
...
int func_86(int iParam0) // Position - 0x2B71
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_87(int iParam0, var uParam1, Any* panParam2) // Position - 0x2C07
{
	if (!func_74(iParam0))
		return false;
...
struct<2> func_88(int iParam0) // Position - 0x2D12
{
	var unk;
...
int func_89(int iParam0, int iParam1, var uParam2) // Position - 0x2DE2
{
	var unk;
...
BOOL func_90(Any* panParam0, int iParam1, int iParam2) // Position - 0x2E17
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_91() // Position - 0x2E4E
{
	return Global_1102813.f_3672;
}

void func_92(Player plParam0) // Position - 0x2E5D
{
	Player player;
...
void func_93(Player plParam0) // Position - 0x2EC9
{
...
void func_94(Any* panParam0) // Position - 0x2F04
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
struct<2> func_95(int iParam0, int iParam1) // Position - 0x2F1A
{
	int num;
...
struct<2> func_96() // Position - 0x3040
{
	var unk;
...
BOOL func_97(int iParam0) // Position - 0x3059
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_98(int iParam0, int iParam1, Any* panParam2) // Position - 0x3098
{
...
void func_99(int iParam0, Any* panParam1, var uParam2) // Position - 0x30CC
{
	int num;
...
int func_100(int iParam0, Any* panParam1, int iParam2) // Position - 0x3327
{
	int num;
	int num2;
	int num3;
...
int func_101(int iParam0) // Position - 0x337C
{
	int num;
...
int func_102(int iParam0, var uParam1) // Position - 0x34F1
{
	var unk;
...
int func_103(int iParam0) // Position - 0x350E
{
	switch (iParam0)
	{
		case joaat("IWD_INF"):
...
int func_104(int iParam0) // Position - 0x3664
{
	switch (iParam0)
	{
...
int func_105(int iParam0) // Position - 0x36BB
{
	switch (iParam0)
	{
...
int func_106(int iParam0) // Position - 0x3795
{
	switch (iParam0)
	{
		case -1641798436:
...
int func_107(int iParam0) // Position - 0x382D
{
	switch (iParam0)
	{
		case -1968391995:
...
BOOL func_108(int iParam0, var uParam1, var uParam2) // Position - 0x39D7
{
	var unk;
...
BOOL func_109(int iParam0, var uParam1, Any* panParam2) // Position - 0x39FE
{
	*panParam2 = Global_1149432.f_7;
...
void func_110(Any* panParam0, int iParam1, var uParam2) // Position - 0x3A32
{
	var unk;
