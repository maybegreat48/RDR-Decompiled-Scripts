...
void func_1() // Position - 0x3A0
{
	Global_1913338 = 0;
	return;
}

BOOL func_2(int iParam0) // Position - 0x3AD
{
	int currentMessage;
...
void func_3(int iParam0) // Position - 0x3D5
{
	if (!func_2(iParam0))
		return;
...
void func_4(Object* pobParam0) // Position - 0x3EF
{
	if (func_2(509))
		func_3(509);
...
BOOL func_5(Object* pobParam0) // Position - 0x49A
{
	if (ENTITY::IS_ENTITY_DEAD(Global_33))
		return false;
...
int func_6() // Position - 0x53D
{
	return Global_1913339;
}

void func_7(Object* pobParam0) // Position - 0x549
{
	if (func_35(1))
	{
...
Hash func_8(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x653
{
...
void func_9(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x695
{
...
void func_10(var uParam0) // Position - 0x6F9
{
	func_40(uParam0, 0f);
	return;
}

void func_11(Object* pobParam0, int iParam1) // Position - 0x708
{
...
BOOL func_12(int iParam0) // Position - 0x71C
{
	if (iParam0 < 0)
		return false;
...
BOOL func_13(int iParam0, BOOL bParam1) // Position - 0x75B
{
	int num;
...
void func_14(var uParam0) // Position - 0x78E
{
	if (!WEAPON::_IS_WEAPON_BINOCULARS(func_8(Global_33, true, 0, true)))
	{
...
BOOL func_15(var uParam0) // Position - 0x82E
{
	return uParam0->f_10;
}

void func_16(var uParam0) // Position - 0x83A
{
	uParam0->f_10 = 0;
	return;
}

void func_17(BOOL bParam0) // Position - 0x847
{
	UIFEED::UI_FEED_CLEAR_CHANNEL(1, bParam0, false);
	return;
}

void func_18(int iParam0, BOOL bParam1) // Position - 0x857
{
	int num;
	int num2;
...
void func_19(Object* pobParam0) // Position - 0x884
{
	int i;
...
int func_20(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, Hash hParam10, int iParam11) // Position - 0x8BE
{
	int i;
	int num;
...
void func_22(char* sParam0, char* sParam1, BOOL bParam2) // Position - 0x97A
{
	int soundId;
...
void func_23(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9B9
{
	int num;
...
int func_24(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, int iParam10, Hash hParam11, BOOL bParam12) // Position - 0xA0D
{
	int i;
	int num;
...
void func_25(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA93
{
	int num;
...
void func_26(int iParam0, Hash hParam1) // Position - 0xADE
{
	int num;
...
Hash func_28(Ped pedParam0, int iParam1) // Position - 0xB42
{
	Hash ReturnWeaponType;
...
BOOL func_29(Object* pobParam0, int iParam1) // Position - 0xB59
{
	return pobParam0->f_12 && iParam1 != false;
}

BOOL func_30() // Position - 0xB6A
{
	int i;
...
void func_31(Object* pobParam0, int iParam1) // Position - 0xBC0
{
	pobParam0->f_12 = pobParam0->f_12 || iParam1;
	return;
}

BOOL func_32(Hash hParam0, int iParam1) // Position - 0xBD3
{
	int num;
...
BOOL func_33() // Position - 0xC56
{
	return Global_1940252.f_2;
}

BOOL func_34(Player plParam0) // Position - 0xC64
{
	if (plParam0 == 255)
...
BOOL func_35(int iParam0) // Position - 0xCB3
{
	return Global_1913338 && iParam0 != false;
}

void func_36(int iParam0) // Position - 0xCC4
{
	Global_1913338 = Global_1913338 - Global_1913338 && iParam0;
	return;
}

void func_37(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xCDC
{
	int num;
...
BOOL func_38(int iParam0, BOOL bParam1) // Position - 0xD30
{
	if (bParam1 && !func_12(iParam0))
		return true;
...
void func_39(Object* pobParam0, int iParam1) // Position - 0xD54
{
	pobParam0->f_12 = pobParam0->f_12 - pobParam0->f_12 && iParam1;
	return;
}

void func_40(var uParam0, float fParam1) // Position - 0xD6C
{
...
void func_41(Object* pobParam0) // Position - 0xD92
{
	pobParam0->f_10 = 1;
	return;
}

int func_42(int iParam0) // Position - 0xD9F
{
	return iParam0;
}

void func_43(int iParam0, var uParam1, var uParam2) // Position - 0xDA9
{
	int num;
...
BOOL func_44(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xDC5
{
...
void func_45(int iParam0, int iParam1) // Position - 0xE67
{
	int Variable;
...
BOOL func_46(int iParam0, int iParam1) // Position - 0xE8B
{
	if (iParam0 < 0)
		return false;
...
void func_48(int iParam0) // Position - 0x11C6
{
	if (!func_68(iParam0))
		return;
...
BOOL func_49(int iParam0) // Position - 0x1279
{
	struct<9> data;
	...
	SCRIPTS::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_AI, iParam0, &data, 9);
	...
	if (ENTITY::IS_ENTITY_A_PED(data))
	{
		...
		weapontypeGroup = WEAPON::GET_WEAPONTYPE_GROUP(data.f_2);
...
BOOL func_50(Hash hParam0, int iParam1) // Position - 0x1332
{
	if (hParam0 == 0)
		return false;
...
int func_51(Hash hParam0) // Position - 0x134C
{
	var unk;
...
BOOL func_52(Hash hParam0, int iParam1) // Position - 0x1377
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_53(Hash hParam0) // Position - 0x141E
{
	int num;
	int num2;
	int num3;
...
int func_54(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x14DA
{
...
void func_55(int iParam0, int iParam1) // Position - 0x159C
{
	if (iParam0 < 0)
		return;
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x15CF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_57(int iParam0, BOOL bParam1) // Position - 0x1627
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_58(int iParam0, int iParam1) // Position - 0x1650
{
	if (iParam0 < 0)
		return;
...
void func_60(var uParam0, int iParam1) // Position - 0x16AA
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_61(var uParam0, int iParam1) // Position - 0x16BB
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_62(int iParam0, int iParam1) // Position - 0x16D0
{
...
BOOL func_64(int iParam0) // Position - 0x16FF
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x17CB
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_66(int iParam0) // Position - 0x17E4
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_67() // Position - 0x17F7
{
	if (!func_82())
		return false;
...
BOOL func_68(int iParam0) // Position - 0x1812
{
	return func_46(iParam0, 2);
}

Hash func_69(Hash hParam0, int iParam1) // Position - 0x1821
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_70(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x189B
{
...
BOOL func_71(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x18C2
{
	if (iParam2 < 0)
		return false;
...
BOOL func_72(Hash hParam0) // Position - 0x18FD
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_73(int iParam0) // Position - 0x1918
{
	if (iParam0 < 0)
		return 0;
...
int func_74(Hash hParam0) // Position - 0x1939
{
	var unk;
...
int func_75(Hash hParam0) // Position - 0x1964
{
	switch (hParam0)
	{
...
int func_76(var uParam0, int iParam1) // Position - 0x1A47
{
	int i;
...
int func_77(Hash hParam0) // Position - 0x1A84
{
	int num;
...
int func_78(Hash hParam0, BOOL bParam1) // Position - 0x1AF1
{
	var unk;
	int num;
	int num2;
...
int func_79(Hash hParam0, int iParam1) // Position - 0x1B50
{
	if (iParam1 == 0)
		return 0;
...
int func_80(BOOL bParam0) // Position - 0x1B7C
{
	if (func_91() == -1)
	{
...
struct<4> func_81(Hash hParam0, BOOL bParam1) // Position - 0x1BBD
{
	var unk;
...
BOOL func_83(Hash hParam0, Hash hParam1) // Position - 0x1BF6
{
	if (!func_50(hParam0, 0))
...
void func_84(Hash hParam0, var uParam1, var uParam2) // Position - 0x1C37
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_85(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1E43
{
	Hash hash;
...
struct<4> func_86(BOOL bParam0) // Position - 0x1F21
{
	int num;
...
void func_87(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1FC2
{
...
BOOL func_88(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x1FDD
{
...
Hash func_89(Hash hParam0) // Position - 0x2002
{
	return hParam0;
}

BOOL func_90(Hash hParam0, int iParam1) // Position - 0x200C
{
	if (hParam0 == 0)
		return false;
...
int func_91() // Position - 0x2026
{
	return Global_1572887.f_14;
}

struct<5> func_92(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x2034
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_93(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x23A8
{
	var outGuid;
...
BOOL func_94(Hash hParam0, Hash hParam1) // Position - 0x23D9
{
...
struct<4> func_95(BOOL bParam0) // Position - 0x240F
{
	int num;
...
int func_96(Hash hParam0, BOOL bParam1) // Position - 0x24AF
{
...
BOOL func_97(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x24E6
{
	return func_104(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_98(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x2501
{
	var unk;
...
struct<4> func_99(BOOL bParam0) // Position - 0x2522
{
	int num;
...
BOOL func_100(Hash hParam0, int iParam1) // Position - 0x258C
{
	Hash hash;
	int num;
	int i;
...
BOOL func_101(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x25F9
{
	return func_107(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

struct<4> func_102() // Position - 0x260F
{
	var unk;
...
int func_104(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2638
{
...
BOOL func_105(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x26B7
{
	int inventoryId;
...
BOOL func_106(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x26FC
{
...
BOOL func_107(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x272F
{
...
int func_108(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2769
{
...
BOOL func_109(Hash hParam0) // Position - 0x279C
{
