...
void func_1(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x8E
{
...
int func_2() // Position - 0x2D8
{
	return Global_1572887.f_14;
}

struct<2> func_3(int iParam0) // Position - 0x2E6
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_4(int iParam0, var uParam1) // Position - 0x2FA
{
	return iParam0;
}
...
BOOL func_6(var uParam0) // Position - 0x349
{
...
BOOL func_7() // Position - 0x363
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x36C
{
	BOOL flag;
...
int func_9(var uParam0, var uParam1, var uParam2) // Position - 0x505
{
	int num;
	int scenario;
...
int func_10(var uParam0, var uParam1, var uParam2) // Position - 0x696
{
	int num;
	int scenario;
...
char* func_11(var uParam0, var uParam1, var uParam2) // Position - 0x880
{
	int num;
	int scenario;
...
int func_12(var uParam0) // Position - 0xA44
{
	int num;
...
void func_13(var uParam0) // Position - 0xBFA
{
	func_23(uParam0);
...
int func_14(Entity eParam0, Entity eParam1, int iParam2) // Position - 0xC11
{
	int i;
	var SourceStruct;
...
int func_15(var uParam0) // Position - 0xCBB
{
	return uParam0->f_3;
}

void func_16(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xCC7
{
	BOOL flag;
	BOOL flag2;
	float num;
...
float func_17(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xEF3
{
...
void func_18(var uParam0) // Position - 0xF1B
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
void func_19(var uParam0, int iParam1) // Position - 0xF61
{
	uParam0->f_3 = iParam1;
	return;
}

BOOL func_20(var uParam0) // Position - 0xF6F
{
...
Entity func_21(var uParam0) // Position - 0xF94
{
	int i;
	Entity unk;
...
int func_22(Entity eParam0, Entity eParam1, int iParam2) // Position - 0xFD7
{
	int i;
...
void func_23(var uParam0) // Position - 0x1087
{
	if (uParam0->f_4 != -1)
	{
...
void func_24(int iParam0, int iParam1) // Position - 0x10BD
{
	if (func_34(iParam0))
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x10D6
{
...
BOOL func_26(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1100
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_27() // Position - 0x11FF
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_28(var uParam0, int iParam1) // Position - 0x1214
{
	*uParam0 = iParam1;
	return;
}

void func_29(int iParam0) // Position - 0x1221
{
	if (iParam0 <= 0)
		return;
...
void func_30(var uParam0) // Position - 0x1248
{
	func_39(uParam0, 0f);
	return;
}

float func_31(var uParam0) // Position - 0x1257
{
	if (!func_40(uParam0))
		return uParam0->f_1;
...
int func_32(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6) // Position - 0x128C
{
	Volume volume;
	int num;
...
BOOL func_33(Entity eParam0) // Position - 0x12BD
{
	int num;
	var InputString;
	Hash entityModel;
...
BOOL func_34(int iParam0) // Position - 0x1357
{
	if (*iParam0 == 0)
		return false;
...
int func_35(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x136F
{
...
BOOL func_36(BOOL bParam0) // Position - 0x1431
{
	if (bParam0)
...
BOOL func_37() // Position - 0x1461
{
	return func_53() != -1;
}

BOOL func_38() // Position - 0x146F
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_39(var uParam0, float fParam1) // Position - 0x1494
{
...
BOOL func_40(var uParam0) // Position - 0x14BA
{
	return func_56(*uParam0, 1);
}

BOOL func_41(var uParam0) // Position - 0x14CA
{
	return func_56(*uParam0, 2);
}

float func_42() // Position - 0x14DA
{
...
int func_43(var uParam0, var uParam1, Volume volParam2, int iParam3) // Position - 0x150C
{
	ItemSet itemSet;
...
void func_44(Volume volParam0) // Position - 0x15C7
{
...
int func_45() // Position - 0x15DE
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

BOOL func_46(Hash hParam0, int iParam1) // Position - 0x15F3
{
	if (hParam0 == 0)
		return false;
...
int func_47(Hash hParam0) // Position - 0x160D
{
	var unk;
...
Hash func_48(Hash hParam0, int iParam1) // Position - 0x1638
{
	int num;
	var unk;
	Hash hash;
...
int func_49(Hash hParam0, BOOL bParam1) // Position - 0x16B2
{
	var unk;
	int num;
	int num2;
...
int func_50(Hash hParam0, int iParam1) // Position - 0x1711
{
	if (iParam1 == 0)
		return 0;
...
int func_51(BOOL bParam0) // Position - 0x173D
{
	if (func_2() == -1)
	{
...
struct<4> func_52(Hash hParam0, BOOL bParam1) // Position - 0x177E
{
	var unk;
...
int func_53() // Position - 0x17A3
{
	return Global_1149172.f_137;
}

void func_54(var uParam0, int iParam1) // Position - 0x17B1
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_55(var uParam0, int iParam1) // Position - 0x17C2
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_56(int iParam0, int iParam1) // Position - 0x17D7
{
	return iParam0 && iParam1 != false;
}

BOOL func_57(Hash hParam0, Hash hParam1) // Position - 0x17E6
{
	if (!func_46(hParam0, 0))
...
void func_58(Hash hParam0, var uParam1, var uParam2) // Position - 0x1827
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_59(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1A33
{
	Hash hash;
...
struct<4> func_60(BOOL bParam0) // Position - 0x1B11
{
	int num;
...
void func_61(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1BB2
{
...
BOOL func_62(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x1BCD
{
...
int func_63(int iParam0) // Position - 0x1BF2
{
	if (iParam0 < 0)
		return 0;
...
Hash func_64(Hash hParam0) // Position - 0x1C13
{
	return hParam0;
}

BOOL func_65(Hash hParam0, int iParam1) // Position - 0x1C1D
{
	if (hParam0 == 0)
		return false;
...
struct<5> func_66(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x1C37
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_67(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x1FAB
{
	var outGuid;
...
BOOL func_68(Hash hParam0, Hash hParam1) // Position - 0x1FDC
{
...
struct<4> func_69(BOOL bParam0) // Position - 0x2012
{
	int num;
...
int func_70(Hash hParam0, BOOL bParam1) // Position - 0x20B2
{
...
BOOL func_71(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x20E9
{
	return func_79(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_72(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x2104
{
	var unk;
...
struct<4> func_73(BOOL bParam0) // Position - 0x2125
{
	int num;
...
int func_74(Hash hParam0) // Position - 0x218F
{
	var unk;
...
BOOL func_75(Hash hParam0, int iParam1) // Position - 0x21BA
{
	Hash hash;
	int num;
	int i;
...
BOOL func_76(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x2227
{
	return func_82(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

struct<4> func_77() // Position - 0x223D
{
	var unk;
...
int func_79(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x2266
{
...
BOOL func_80(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x22E5
{
	int inventoryId;
...
BOOL func_81(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x232A
{
...
BOOL func_82(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x235D
{
...
int func_83(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2397
{
...
BOOL func_84(Hash hParam0) // Position - 0x23CA
{
