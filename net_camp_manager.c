...
BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0x7F
{
	int i;
...
void func_6() // Position - 0x24A
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_7(int iParam0, int iParam1) // Position - 0x256
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_6();
...
void func_11(BOOL bParam0) // Position - 0x41C
{
	int num;
	var unk;
	int num2;
...
void func_15(BOOL bParam0) // Position - 0x5A0
{
...
Blip func_16(Hash hParam0) // Position - 0x5E3
{
...
void func_17(Hash hParam0, BOOL bParam1) // Position - 0x608
{
	if (*hParam0 != -1)
	{
		func_38(*hParam0, -1);
...
int func_19() // Position - 0x6D5
{
	return Global_1572887.f_14;
}

BOOL func_20() // Position - 0x6E3
{
	return Global_1051645.f_8;
}

void func_21(int* piParam0) // Position - 0x6F1
{
	var unk;
	int i;
	var unk28;
...
int func_22(int iParam0, int iParam1, char* sParam2) // Position - 0x798
{
	return 1;
}

void func_23(Any* panParam0) // Position - 0x7A1
{
	int i;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		func_41(&panParam0->[i /*83*/]);
	}

	return;
}

int func_24(int iParam0, int iParam1, char* sParam2) // Position - 0x7C9
{
	return 1;
}

void func_25(int iParam0) // Position - 0x7D2
{
	var unk;
	int i;
	var unk2;
	...
	*iParam0 = unk;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		iParam0->f_1[i /*63*/] = { unk2 };
	}

	iParam0->f_2018 = unk65;
	unk66.f_4 = -15;
	iParam0->f_2027 = { unk66 };
	iParam0->f_2019 = 0;
	iParam0->f_2054 = -428030045;
...
void func_26(int* piParam0) // Position - 0x892
{
	return;
}

BOOL func_27() // Position - 0x89A
{
	return Global_263042[Global_1295666 /*65*/] > 2;
}

void func_28(int iParam0) // Position - 0x8AE
{
	if (func_42(iParam0))
...
BOOL func_29() // Position - 0x8D1
{
	...
	if (!func_44(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

BOOL func_30(int iParam0) // Position - 0x929
{
...
void func_31(int iParam0) // Position - 0x94A
{
	if (!func_42(iParam0))
...
void func_32() // Position - 0x96E
{
	func_46(1);
	return;
}

void func_33() // Position - 0x97B
{
	if (func_42(1))
		func_46(2);
...
void func_37(BOOL bParam0) // Position - 0xA48
{
	int num;
...
void func_38(Hash hParam0, int iParam1) // Position - 0xAD4
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_39(Hash hParam0, int iParam1) // Position - 0xB01
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_40(Hash hParam0, BOOL bParam1) // Position - 0xB32
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_41(var uParam0) // Position - 0xB63
{
	var unk;
...
BOOL func_42(int iParam0) // Position - 0xBCA
{
	return func_65(Global_1144526[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*83*/].f_73, iParam0);
}

void func_43(int iParam0, int iParam1) // Position - 0xBE4
{
	func_66(iParam0, iParam1);
	return;
}

BOOL func_44(var uParam0, var uParam1) // Position - 0xBF4
{
	if (!func_67(uParam0))
		return false;
...
void func_45(int iParam0, int iParam1) // Position - 0xC28
{
	func_69(iParam0, iParam1);
	return;
}

void func_46(int iParam0) // Position - 0xC38
{
...
void func_47(int iParam0, var uParam1) // Position - 0xC55
{
	Player Plr;
	...
	uniqueIntForPlayer = NETWORK::GET_UNIQUE_INT_FOR_PLAYER(Plr);
	...
	switch (Global_1141332.f_865[uniqueIntForPlayer /*7*/])
	{
		case 0:
			...
			if (unk4.f_2 == 0)
			{
				...
				if (SCRIPTS::_IS_PLAYER_BIT_SET_AT_INDEX(&(Global_1141332.f_1091), Plr))
					SCRIPTS::_CLEAR_PLAYER_BIT_AT_INDEX(&(Global_1141332.f_1091), Plr);
		...
		case 3:
			...
			for (i = 0; i < 32; i = i + 1)
			{
				if (Global_1141332[i /*27*/].f_9 == Plr)
				{
...
void func_48(int iParam0) // Position - 0x10FB
{
	func_82(iParam0);
...
void func_51(int iParam0) // Position - 0x11AD
{
...
int func_54() // Position - 0x12DE
{
	return Global_1142424.f_2018;
}

void func_55(int iParam0) // Position - 0x12ED
{
...
void func_57(int iParam0) // Position - 0x131E
{
	BOOL flag;
	BOOL flag2;
	int num;
...
void func_63(int iParam0) // Position - 0x24DC
{
	Global_1142424.f_2019 = iParam0;
	return;
}

void func_64(var uParam0) // Position - 0x24ED
{
	var unk;
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x252F
{
	return iParam0 && iParam1 != false;
}

void func_66(int iParam0, int iParam1) // Position - 0x253E
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_67(int iParam0) // Position - 0x2553
{
	switch (iParam0)
	{
		case 2:
...
int func_68(int iParam0) // Position - 0x2592
{
	switch (iParam0)
	{
		case 2:
...
void func_69(int iParam0, int iParam1) // Position - 0x2628
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_70(int iParam0, int iParam1) // Position - 0x2639
{
...
void func_71(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2662
{
	Global_1141332.f_865[iParam0 /*7*/].f_1 = { uParam1 };
	return;
}

void func_72(int iParam0, int iParam1) // Position - 0x267D
{
...
int func_73(Player plParam0) // Position - 0x26A2
{
	int i;
...
BOOL func_74(int iParam0) // Position - 0x2703
{
	if (iParam0 < 0 || iParam0 >= 32)
		return false;
...
void func_75(int iParam0, int iParam1) // Position - 0x2722
{
	if (!func_74(iParam0))
		return;
...
BOOL func_76(Player plParam0) // Position - 0x274E
{
	Player player;
	int i;
...
BOOL func_77(var uParam0, var uParam1, var uParam2, Vector3* pvParam3) // Position - 0x27B3
{
	var unk;
...
BOOL func_78(var uParam0, var uParam1, var uParam2, Player plParam3, Vector3 vParam4, var uParam5, var uParam6, int iParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x2807
{
	Hash unlockHash;
...
int func_79(var uParam0) // Position - 0x28E6
{
	int i;
...
void func_80(int iParam0, int iParam1) // Position - 0x2968
{
	if (!func_74(iParam0))
		return;
...
BOOL func_81(Any anParam0, var uParam1, BOOL bParam2, var uParam3, int iParam4) // Position - 0x2999
{
	var unk;
...
void func_82(int iParam0) // Position - 0x29D8
{
	Player Plr;
...
void func_83(int iParam0) // Position - 0x2A3E
{
	int networkTime;
	int uniqueIntForPlayer;
	Any gangId;
...
void func_84(int iParam0) // Position - 0x2BF5
{
	Any gangId;
	var memberHandles;
	int gangMembers;
...
void func_85(int iParam0) // Position - 0x2D5E
{
	BOOL flag;
	int num;
	int i;
...
void func_86(int iParam0) // Position - 0x2E2C
{
...
void func_87(int iParam0) // Position - 0x2E5B
{
...
void func_88(int iParam0) // Position - 0x2E7A
{
...
struct<4> func_91(BOOL bParam0) // Position - 0x2F0D
{
	int num;
...
struct<4> func_92(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x2FAD
{
	var outGuid;
...
void func_93(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2FDE
{
	Hash hash;
	int num;
...
Hash func_95(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0x3244
{
	return func_205(&uParam0, hParam4, bParam5, iParam6);
}

void func_96(int iParam0, int iParam1) // Position - 0x3258
{
...
void func_97(int iParam0, int iParam1) // Position - 0x3298
{
	if (iParam1 < 0 || iParam1 >= 32)
		return;
...
void func_98(int iParam0, int iParam1) // Position - 0x32D8
{
	if (iParam1 < 0 || iParam1 >= 32)
		return;
...
void func_99(int iParam0, int iParam1) // Position - 0x3328
{
	if (iParam1 < 0 || iParam1 >= 32)
		return;
...
void func_100(int iParam0, int iParam1) // Position - 0x3378
{
	if (iParam1 < 0 || iParam1 >= 32)
		return;
...
BOOL func_101(int iParam0) // Position - 0x33C8
{
	if (!func_74(iParam0))
		return false;
...
void func_102(int iParam0, Player plParam1) // Position - 0x33F7
{
	var unk;
	Any gangId;
...
void func_103(int iParam0, int iParam1) // Position - 0x3458
{
	if (!func_74(iParam0))
		return;
...
void func_104(int iParam0, var uParam1, var uParam2, var uParam3, Player plParam4) // Position - 0x348C
{
	Any gangId;
...
BOOL func_105(Hash hParam0) // Position - 0x350E
{
	if (hParam0 >= 0 && hParam0 < Global_17088)
...
void func_106(var uParam0) // Position - 0x3537
{
	var unk;
...
void func_107(int iParam0, BOOL bParam1) // Position - 0x3564
{
	int num;
	int num2;
	BOOL flag;
...
void func_108(int iParam0, BOOL bParam1) // Position - 0x39E8
{
	int num;
...
void func_109(int iParam0) // Position - 0x3B48
{
	int num;
	int num2;
	BOOL flag;
...
void func_110(int iParam0) // Position - 0x3DB5
{
	if (!func_12())
		return;
...
void func_111(int iParam0) // Position - 0x3EBF
{
...
void func_112(int iParam0) // Position - 0x3F2A
{
...
BOOL func_113(int iParam0, int iParam1) // Position - 0x3F8C
{
	if (!func_74(iParam0))
		return false;
...
void func_114(Player plParam0) // Position - 0x3FB6
{
	Any gangId;
	Player gangLeader;
	int num;
...
Vector3 func_115() // Position - 0x3FF6
{
	var unk;
	var unk4;
...
void func_116(var uParam0, var uParam1, var uParam2) // Position - 0x4070
{
...
BOOL func_117() // Position - 0x4092
{
	return Global_1142424.f_2027.f_7 == 3;
}

void func_118(int iParam0) // Position - 0x40A5
{
	Global_1142424.f_2027.f_7 = iParam0;
	return;
}

void func_119() // Position - 0x40B8
{
	Player player;
...
BOOL func_122(int iParam0) // Position - 0x414D
{
	return func_65(Global_1147183.f_8, iParam0);
}

BOOL func_123() // Position - 0x4161
{
	int currentMessage;
...
BOOL func_124(int iParam0) // Position - 0x4181
{
	return func_241(1, iParam0);
}

void func_125(int iParam0) // Position - 0x4190
{
	func_43(&(Global_1147183.f_8), iParam0);
	return;
}

BOOL func_126(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x41A4
{
	BOOL num;
	var unk;
...
void func_128(int iParam0) // Position - 0x4290
{
	Global_1142424.f_2027.f_5 = iParam0;
	return;
}

BOOL func_129() // Position - 0x42A3
{
	return Global_1142424.f_2046 < 10;
}

void func_130(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x42B5
{
	var args;
...
void func_131(int iParam0) // Position - 0x42FC
{
...
void func_132(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x432B
{
	var args;
...
void func_133(int iParam0) // Position - 0x4374
{
...
void func_134(int iParam0) // Position - 0x439F
{
	func_45(&(Global_1144526[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*83*/].f_33.f_4), iParam0);
	return;
}

BOOL func_135(var uParam0) // Position - 0x43BB
{
	Player player;
	int uniqueIntForPlayer;
	int num;
...
int func_137(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x4595
{
	int num;
	var unk13;
	int num2;
...
BOOL func_138(var uParam0, var uParam1, var uParam2) // Position - 0x45D0
{
	Hash unlockHash;
...
void func_139(int iParam0) // Position - 0x460B
{
...
BOOL func_140(int iParam0) // Position - 0x4692
{
	var unk;
...
struct<2> func_142() // Position - 0x487D
{
...
int func_147(Player plParam0) // Position - 0x4DD3
{
	int num;
	Player player;
...
void func_148(BOOL bParam0) // Position - 0x4DFD
{
	if (bParam0)
	{
...
void func_149(int iParam0) // Position - 0x4E2D
{
...
BOOL func_151(Player plParam0) // Position - 0x5039
{
	return NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && func_155(plParam0, 1);
}

BOOL func_152() // Position - 0x5053
{
	Hash hash;
...
void func_153(var uParam0, BOOL bParam1) // Position - 0x5080
{
...
BOOL func_155(Player plParam0, int iParam1) // Position - 0x51AF
{
	if (plParam0 < 0 || plParam0 >= 32)
		return false;
...
int func_156(Player plParam0) // Position - 0x51DD
{
	Player player;
...
void func_157(char* sParam0, int iParam1) // Position - 0x5203
{
	int num;
...
void func_158(int iParam0) // Position - 0x52AE
{
...
BOOL func_159(var uParam0) // Position - 0x52F0
{
	return func_289(*uParam0, 1);
}

int func_160(var uParam0) // Position - 0x5300
{
	if (!func_159(uParam0))
		return 0;
...
int func_162(int* piParam0) // Position - 0x5381
{
	return func_292(piParam0->f_1);
}

BOOL func_163(int* piParam0) // Position - 0x5391
{
	int num;
...
Hash func_164(Hash hParam0, Hash hParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x53C3
{
	Hash hash;
	BOOL flag;
	BOOL flag2;
...
BOOL func_165(int* piParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x54FF
{
	var unk;
	var unk18;
	int num;
...
int func_166(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x55FA
{
	var unk;
	int num;
	int i;
...
int func_167(Hash hParam0) // Position - 0x5664
{
	int num;
	var unk;
	var unk6;
...
void func_168(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x56C6
{
	int i;
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x5744
{
	int num;
	int num2;
...
Hash func_170(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x5771
{
...
void func_171(Hash hParam0) // Position - 0x57F0
{
...
void func_172(int iParam0) // Position - 0x581B
{
	if (func_65(Global_1144526[Global_1295666 /*83*/].f_74, iParam0))
	{
...
BOOL func_173(int iParam0, Any* panParam1) // Position - 0x585C
{
...
int func_174(int iParam0, var uParam1) // Position - 0x5874
{
	int i;
...
int func_175(Hash hParam0) // Position - 0x58C7
{
	return func_318(hParam0);
}

int func_176(int iParam0) // Position - 0x58D5
{
	switch (iParam0)
	{
		case 0:
...
void func_177(var uParam0) // Position - 0x62BD
{
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
	*uParam0 = 0;
...
Hash func_178(int iParam0, Hash hParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x62D3
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_179(int* piParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, int iParam5, Hash hParam6, int iParam7, BOOL bParam8) // Position - 0x63D8
{
	var unk;
...
int func_180(Hash hParam0, Hash hParam1) // Position - 0x642B
{
	int i;
	Hash currency;
	int awardItemCount;
...
Hash func_181(Player plParam0) // Position - 0x648B
{
	if (plParam0 < 0 || plParam0 >= 32)
		return 0;
...
Hash func_182(Player plParam0) // Position - 0x64B5
{
	if (plParam0 < 0 || plParam0 >= 32)
		return 0;
...
BOOL func_183(int iParam0, int iParam1) // Position - 0x64E1
{
	return iParam0 && iParam1 != false;
}

void func_184(int iParam0, int iParam1) // Position - 0x64F0
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_185() // Position - 0x6505
{
	int num;
	int num2;
	var unk;
...
BOOL func_186(Any* panParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6607
{
	int fileHandle;
...
BOOL func_187(int iParam0) // Position - 0x6661
{
	int i;
...
Hash func_188(var uParam0, var uParam1, var uParam2) // Position - 0x6690
{
	var unk;
	int num;
...
BOOL func_189(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x66DC
{
	int num;
...
int func_190() // Position - 0x66F1
{
	return -1635525483;
}

BOOL func_191(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x66FE
{
	int i;
	Player Plr;
	Ped playerPed;
...
BOOL func_192(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0x675F
{
	int i;
	float num;
	Vector3 vector;
...
BOOL func_193(int iParam0, int iParam1) // Position - 0x6893
{
	if (!func_74(iParam0))
		return false;
...
BOOL func_194(var uParam0, Any anParam1, BOOL bParam2, var uParam3, int iParam4) // Position - 0x68B9
{
	int numGangMembers;
	var unk;
...
Player func_195(int iParam0, int iParam1) // Position - 0x696F
{
	if (!func_74(iParam0))
	{
		iParam1 == 0;
...
BOOL func_196(var uParam0, var uParam1) // Position - 0x6996
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0);
}

char* func_197() // Position - 0x69A4
{
	return "net_camp";
}

char* func_198() // Position - 0x69B0
{
	return "gfh_campworks";
}

void func_199(int iParam0) // Position - 0x69BC
{
	var unk;
...
void func_200(int iParam0) // Position - 0x6A78
{
	var unk;
...
int func_201(BOOL bParam0) // Position - 0x6ACF
{
	if (func_19() == -1)
	{
...
struct<4> func_202() // Position - 0x6B10
{
	var unk;
...
BOOL func_203(Hash hParam0, int iParam1) // Position - 0x6B1C
{
	if (hParam0 == 0)
		return false;
...
BOOL func_204(Hash hParam0, int iParam1) // Position - 0x6B36
{
	int num;
...
int func_205(Any* panParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0x6BB9
{
	var unk;
...
Vector3 func_206(int iParam0) // Position - 0x6BE7
{
	if (!func_74(iParam0))
		return 0f, 0f, 0f;
...
BOOL func_207(int iParam0) // Position - 0x6C0B
{
	return !func_113(iParam0, 8);
}

int func_208(int iParam0, BOOL bParam1) // Position - 0x6C1C
{
	if (!func_74(iParam0))
	{
		!bParam1;
...
BOOL func_209(int iParam0) // Position - 0x6C62
{
	return func_65(Global_1142424.f_2040, iParam0);
}

void func_210(int iParam0) // Position - 0x6C77
{
	Global_1142424.f_2045 = iParam0;
	return;
}

int func_211(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x6C88
{
	int num;
...
int func_212(BOOL bParam0) // Position - 0x6CD6
{
	if (bParam0)
		return 98;
...
Hash func_213(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x6CED
{
	Hash i;
	Hash hash;
	BOOL flag;
...
Hash func_214(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6DC8
{
	switch (iParam0)
	{
...
BOOL func_215(int iParam0) // Position - 0x6FE1
{
	return func_193(iParam0, 16) && !func_193(iParam0, 32);
}

int func_216(Player plParam0) // Position - 0x6FFF
{
	Player player;
...
struct<2> func_217(int iParam0) // Position - 0x702F
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

void func_218(int iParam0, int iParam1) // Position - 0x7043
{
	if (!func_74(iParam0))
		return;
...
void func_219(int iParam0, int iParam1) // Position - 0x7078
{
	if (!func_74(iParam0))
		return;
...
void func_220(int iParam0) // Position - 0x70AC
{
	if (!func_74(iParam0))
		return;
...
void func_221(int iParam0) // Position - 0x70C8
{
	if (!func_74(iParam0))
		return;
...
void func_222(int iParam0) // Position - 0x70E4
{
	var unk;
...
void func_223(int iParam0) // Position - 0x710E
{
	func_45(&(Global_1147183.f_8), iParam0);
	return;
}

BOOL func_224(int iParam0, int iParam1) // Position - 0x7122
{
	if (!func_74(iParam0))
		return false;
...
void func_225(int iParam0) // Position - 0x714A
{
	var unk;
...
void func_226(int iParam0) // Position - 0x71BF
{
	var unk;
	int i;
...
void func_227(int iParam0) // Position - 0x722C
{
	var unk;
...
void func_228(int iParam0) // Position - 0x727D
{
	var unk;
...
void func_229(int iParam0) // Position - 0x72CE
{
	var unk;
...
void func_230(int iParam0) // Position - 0x731F
{
	var unk;
...
void func_231(int iParam0, int iParam1) // Position - 0x7370
{
	if (!func_74(iParam0))
		return;
...
void func_232(int iParam0, int iParam1) // Position - 0x73AD
{
	if (func_74(iParam0))
...
BOOL func_233(int iParam0) // Position - 0x73CC
{
	struct<4> args;
...
BOOL func_234(int iParam0) // Position - 0x7469
{
	struct<4> args;
...
void func_235(int iParam0) // Position - 0x7506
{
	var unk;
...
int func_236(Player plParam0) // Position - 0x7513
{
	int i;
...
void func_237(int iParam0) // Position - 0x7576
{
	Player player;
...
struct<20> func_238(BOOL bParam0) // Position - 0x7592
{
	var unk;
	var guid;
	var unk24;
...
int func_239() // Position - 0x762E
{
	return Global_1102813.f_3672;
}

void func_240(var uParam0, var uParam1, var uParam2) // Position - 0x763D
{
	int i;
	Hash hash;
...
BOOL func_241(int iParam0, Player plParam1) // Position - 0x76D4
{
	int num;
...
BOOL func_242(int iParam0, int iParam1) // Position - 0x7748
{
	Any gangId;
...
BOOL func_243() // Position - 0x7808
{
	return func_65(Global_1147183.f_8, 2);
}

BOOL func_244(int iParam0, var uParam1, var uParam2, int iParam3) // Position - 0x781B
{
	if (iParam0 < 4)
		iParam0 = 4;
...
BOOL func_245(int iParam0) // Position - 0x78E8
{
	Player gangLeader;
	int num;
	var unk;
...
BOOL func_246(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7974
{
	if (func_366())
		return false;
...
void func_247() // Position - 0x79D4
{
	Global_1144526[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*83*/].f_33.f_4 = 0;
	return;
}

void func_248(int iParam0, var uParam1, var uParam2) // Position - 0x79EB
{
	int num;
...
int func_249() // Position - 0x7A75
{
	return -1727708451;
}

void func_250(var uParam0, var uParam1, var uParam2) // Position - 0x7A82
{
	Global_1144526[func_239() /*83*/].f_38.f_4 = { uParam0 };
	return;
}

void func_251(int iParam0) // Position - 0x7A9E
{
	Global_1144526[func_239() /*83*/].f_38.f_11 = iParam0;
	return;
}

BOOL func_252(int iParam0) // Position - 0x7AB6
{
	if (iParam0 < 0 || iParam0 >= 32)
		return false;
...
void func_253(int iParam0, int iParam1) // Position - 0x7AE2
{
	if (iParam1 > 7)
		return;
...
int func_254() // Position - 0x7B2F
{
	return Global_1902569;
}

void func_255() // Position - 0x7B3B
{
	Player player;
	int num;
	int i;
...
void func_256(int iParam0) // Position - 0x7C28
{
	int num;
	Hash hash;
...
void func_257(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x7D36
{
	Hash hash;
	int num;
...
void func_258(int iParam0) // Position - 0x7EE6
{
	int num;
	var outTime;
	Player Plr;
	...
	if (MISC::GET_FRAME_COUNT() % 60 == 0)
	{
		...
		if (Plr != 255)
			if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr) || GANG::NETWORK_GET_GANG_ID(Plr) != GANG::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()) || num2 != -1 && MISC::GET_GAME_TIMER() - num2 > 5000)
	...
	if (func_388(unk13, &num3, &MaxInt, 0))
	{
		...
		{
			randomIntInRange = func_390(0, MaxInt, randomIntInRange);
			num4 = func_389(randomIntInRange, num3);
		}
...
void func_259(int iParam0) // Position - 0x8057
{
	int num;
	var outTime;
...
BOOL func_260() // Position - 0x8106
{
	return Global_1896762.f_352;
}

char* func_261(Player plParam0) // Position - 0x8115
{
	Player player;
...
const char* func_262(char* sParam0, int iParam1) // Position - 0x815F
{
...
BOOL func_263() // Position - 0x819D
{
	return func_204(joaat("upgrade_camp_butcher_table"), 1);
}

void func_264(int iParam0) // Position - 0x81AF
{
	if (iParam0 < 0)
		iParam0 = 0;
...
void func_265(int iParam0) // Position - 0x81FC
{
	if (iParam0 < 0)
		iParam0 = 0;
...
void func_267(int iParam0) // Position - 0x82D9
{
...
Hash func_268(Player plParam0) // Position - 0x8320
{
	Player player;
...
Hash func_269(Player plParam0) // Position - 0x8346
{
	Player player;
...
Hash func_270(Hash hParam0) // Position - 0x836C
{
	switch (hParam0)
	{
...
BOOL func_271(Hash hParam0) // Position - 0x9DE7
{
	return hParam0 != 0;
}

BOOL func_272(Hash hParam0, Hash hParam1) // Position - 0x9DF3
{
	if (!func_203(hParam0, 0))
...
BOOL func_273() // Position - 0x9E34
{
	return Global_1156111.f_21645[64 /*209*/].f_208;
}

BOOL func_274(int iParam0) // Position - 0x9E49
{
	if (func_397())
...
Hash func_275(Player plParam0) // Position - 0x9E69
{
	int num;
...
int func_276(Player plParam0) // Position - 0x9E8D
{
	Player player;
...
Hash func_277(Player plParam0) // Position - 0x9EC1
{
...
Hash func_278(Player plParam0) // Position - 0x9EE0
{
	int num;
...
Hash func_279(Player plParam0) // Position - 0x9F02
{
	Player player;
...
BOOL func_281(BOOL bParam0) // Position - 0x9FA9
{
	if (bParam0)
...
BOOL func_282(Any anParam0, Hash hParam1, int iParam2, BOOL bParam3) // Position - 0xA021
{
	Hash hash;
	char* InputString;
	var unk3;
	...
	if (!func_405(hParam1, &InputString, joaat("Inventory"), 0, 0, joaat("ui_itemviewer")))
	{
		InputString = "TRANSACTION_CAMP_GANG";
		InputString.f_1 = "ITEMTYPE_TEXTURES";
	}

	func_406(MISC::VAR_STRING(2, "TRANSACTION_DONATED"), InputString.f_1, MISC::GET_HASH_KEY(InputString), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, true);
	unk3.f_1 = 11;
...
void func_283(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0xA2AB
{
...
void func_284(var uParam0) // Position - 0xA2F3
{
	func_409(uParam0, 0);
	return;
}

BOOL func_285(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0xA302
{
	var unk;
...
int func_288(var uParam0) // Position - 0xA3A8
{
...
BOOL func_289(int iParam0, int iParam1) // Position - 0xA68A
{
	return iParam0 && iParam1 != false;
}

BOOL func_290(var uParam0) // Position - 0xA699
{
	return func_289(*uParam0, 2);
}

int func_291(int iParam0) // Position - 0xA6A9
{
	return NETWORK::GET_TIME_DIFFERENCE(iParam0, NETWORK::GET_NETWORK_TIME_ACCURATE());
}

int func_292(int iParam0) // Position - 0xA6BB
{
	int num;
	int status;
...
BOOL func_293(Hash hParam0) // Position - 0xA745
{
...
int func_294(Hash hParam0, BOOL bParam1) // Position - 0xA760
{
	var unk;
...
BOOL func_295(Hash hParam0) // Position - 0xA7B8
{
	if (!func_56() && func_423())
		return true;
...
BOOL func_296(Hash hParam0, BOOL bParam1) // Position - 0xA7E0
{
	return func_300(hParam0, 997808187) && !func_424(hParam0, 997808187, bParam1);
}

BOOL func_297(Hash hParam0) // Position - 0xA806
{
	int num;
...
BOOL func_298(Hash hParam0, var uParam1) // Position - 0xA840
{
	*uParam1 = func_425(hParam0, true);
	return *uParam1 != 0;
}

BOOL func_299(Hash hParam0, var uParam1) // Position - 0xA857
{
	*uParam1 = func_426(hParam0, true, false);
	return *uParam1 != 0;
}

BOOL func_300(Hash hParam0, Hash hParam1) // Position - 0xA86F
{
	if (!func_203(hParam0, 0))
		return false;
...
BOOL func_301() // Position - 0xA8BB
{
	return Global_1915656.f_22477;
}

BOOL func_302(int iParam0) // Position - 0xA8CA
{
...
int func_303(var uParam0) // Position - 0xA905
{
...
struct<5> func_304(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xA98F
{
	var unk;
	int num;
	var unk6;
...
BOOL func_305(Hash hParam0, var uParam1) // Position - 0xAD03
{
	int num;
	var unk;
...
BOOL func_306(Hash hParam0) // Position - 0xADC0
{
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_307(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, Hash hParam8, int iParam9, BOOL bParam10) // Position - 0xADD3
{
	BOOL flag;
	var unk;
	BOOL flag2;
...
BOOL func_308(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, int iParam7, var uParam8, BOOL bParam9, Hash hParam10, int iParam11, BOOL bParam12) // Position - 0xB1A0
{
	var unk;
	var unk18;
...
void func_309(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0xB27F
{
	Hash item;
	Hash hash;
	Hash item2;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_310(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xB306
{
	int i;
...
BOOL func_311(Hash hParam0) // Position - 0xB396
{
...
BOOL func_312(Any* panParam0) // Position - 0xB3C4
{
...
BOOL func_313(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xB3FA
{
	if (!func_312(&uParam0))
		return false;
...
void func_314(int iParam0, var uParam1, var uParam2) // Position - 0xB429
{
	int num;
...
BOOL func_315(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xB445
{
	if (iParam1 < 0 || iParam1 > 32)
		return false;
...
void func_316(int iParam0, int iParam1) // Position - 0xB4E7
{
	int Variable;
...
int func_317(Hash hParam0, int iParam1) // Position - 0xB50B
{
	if (iParam1 == 0)
		return 0;
...
int func_318(Hash hParam0) // Position - 0xB537
{
	if (!func_311(hParam0))
		return 0;
...
BOOL func_319(int iParam0) // Position - 0xB5CA
{
	if (iParam0 == 0)
		return false;
...
BOOL func_320(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0xB5E2
{
	if (!func_319(iParam0))
		return false;
...
BOOL func_321(int iParam0, var uParam1) // Position - 0xB61A
{
	*uParam1 = func_471(iParam0, true);
	return *uParam1 != 0;
}

BOOL func_322(int iParam0, var uParam1) // Position - 0xB631
{
	*uParam1 = func_472(iParam0, true, false);
	return *uParam1 != 0;
}

BOOL func_323(int* piParam0, Hash hParam1, var uParam2, BOOL bParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0xB649
{
	if (!func_438(piParam0, false))
		return false;
...
void func_324(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0xB6F2
{
	int num;
	Hash hash;
...
int func_325(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB737
{
...
int func_326(int iParam0) // Position - 0xB7F9
{
	int num;
	int num2;
...
int func_327(Player plParam0) // Position - 0xB870
{
	if (plParam0 >= 0)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xB88B
{
...
// Unhandled jump detected. Output should be considered invalid
void func_329(Any anParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xB8B5
{
	var unk;
	int num;
	int num2;
...
int func_330(Any* panParam0) // Position - 0xBA39
{
	int num;
	int i;
	int MaxInt;
	...
	if (MaxInt > 0)
		i = MISC::GET_RANDOM_INT_IN_RANGE(0, MaxInt);
	else
		i = 0;
...
int func_331(int iParam0, int iParam1) // Position - 0xBAB6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_332(var uParam0, var uParam1, var uParam2, Player plParam3, int iParam4, BOOL bParam5) // Position - 0xBB8B
{
	var unk;
...
int func_333(Hash hParam0) // Position - 0xBBCD
{
	var unk;
...
BOOL func_334(Hash hParam0, int iParam1) // Position - 0xBBF8
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_335(Hash hParam0) // Position - 0xBCA0
{
	int num;
	int num2;
	int num3;
...
BOOL func_336(Any* panParam0, Hash hParam1, Any* panParam2, BOOL bParam3, int iParam4) // Position - 0xBD5C
{
	var outGuid;
...
int func_337() // Position - 0xBDAA
{
	return Global_1893611.f_2;
}

BOOL func_338(int iParam0) // Position - 0xBDB8
{
	return iParam0 >= 0 && iParam0 <= 150;
}

int func_339(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xBDCE
{
	int num;
	int num2;
	int num3;
...
BOOL func_340(float fParam0, var uParam1, var uParam2) // Position - 0xBE85
{
	BOOL flag;
...
int func_341(Hash hParam0) // Position - 0xBEDA
{
	if (Global_1572887.f_14 == -1)
...
int func_342(Hash hParam0) // Position - 0xBF04
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_343(Hash hParam0) // Position - 0xBF2A
{
	if (Global_1572887.f_14 == -1)
...
void func_344(Hash hParam0, int iParam1) // Position - 0xBF54
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_345(Hash hParam0) // Position - 0xBF85
{
	Vector3 vector;
...
Hash func_346(int iParam0, BOOL bParam1) // Position - 0xBFDD
{
	switch (iParam0)
	{
		case 0:
...
void func_347(int iParam0, BOOL bParam1) // Position - 0xC7BE
{
	var unk;
	int num;
...
var func_348(int iParam0, int iParam1) // Position - 0xC7EC
{
	return func_494(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

BOOL func_349(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0xC80A
{
	var unk;
	var unk6;
...
BOOL func_350(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0xC880
{
	var unk;
	var unk6;
	...
	if (DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(unk.f_1), &unk))
	{
		...
		for (i = 0; i <= 50; i = i + 1)
		{
			if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(*pvParam3, i, &VecReturnNearestNodeCoors, 17, 1077936128, 0))
			{
				*pfParam4 = func_495(*pvParam3, VecReturnNearestNodeCoors, 1);
				return true;
			}
		}
...
BOOL func_351(var uParam0, var uParam1, var uParam2, int iParam3, Vector3* pvParam4, float* pfParam5) // Position - 0xC937
{
	var unk;
	var unk6;
...
BOOL func_352(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0xC9AE
{
	var unk;
	var unk6;
...
BOOL func_353(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0xCA24
{
	var unk;
	var unk6;
...
BOOL func_354(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0xCA9A
{
	var unk;
	var unk6;
...
BOOL func_355(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0xCB10
{
	var unk;
	var unk6;
...
Vector3 func_356(int iParam0) // Position - 0xCB86
{
	var unk;
...
struct<17> func_357(var uParam0, BOOL bParam1) // Position - 0xCBAB
{
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
char* func_358(int iParam0, BOOL bParam1) // Position - 0xCC2C
{
	if (bParam1)
	{
		switch (iParam0)
...
int func_359(var uParam0) // Position - 0xCDA2
{
	Hash hash;
	int num;
...
BOOL func_360(Any* panParam0, int iParam1, int iParam2) // Position - 0xCDD1
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

BOOL func_361() // Position - 0xCE08
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_362() // Position - 0xCE24
{
	return !func_42(2);
}

BOOL func_363() // Position - 0xCE32
{
	int num;
...
void func_364(int iParam0) // Position - 0xCE74
{
	func_43(&(Global_1144526[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*83*/].f_33.f_4), iParam0);
	return;
}

struct<2> func_365(Player plParam0) // Position - 0xCE90
{
	var gamerHandle;
...
BOOL func_367(var uParam0, var uParam1) // Position - 0xCF06
{
	Any gangId;
	var unk;
...
Hash func_368(int iParam0) // Position - 0xCF37
{
	switch (iParam0)
	{
		case 4:
...
BOOL func_369(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xCF64
{
	int num;
	BOOL flag;
...
int func_370(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xCF93
{
	int num;
	var unk;
...
void func_371(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xCFD5
{
	Player player;
...
BOOL func_372(int iParam0) // Position - 0xD003
{
	int num;
...
int func_373(Hash hParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, Hash hParam5) // Position - 0xD029
{
	int cashBalance;
	int goldBarBalance;
	var unk;
...
void func_374(int iParam0) // Position - 0xD219
{
	var unk;
...
int func_375(int iParam0) // Position - 0xD264
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_376(int iParam0) // Position - 0xD277
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

Hash func_377(int iParam0) // Position - 0xD28A
{
	switch (iParam0)
	{
		case 4:
...
int func_378(int iParam0) // Position - 0xD2B7
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_379(int iParam0) // Position - 0xD2C9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_380(int iParam0) // Position - 0xD2DB
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_381(int iParam0) // Position - 0xD2EE
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

void func_382(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD313
{
...
Player func_383() // Position - 0xD34B
{
	Player gangLeader;
...
void func_385(Player plParam0, BOOL bParam1) // Position - 0xD3AE
{
	Player gangLeader;
...
BOOL func_386(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13) // Position - 0xD421
{
	if (uParam0 > uParam7)
		return true;
...
struct<10> func_387(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0xD509
{
	int num;
...
BOOL func_388(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0xD5DD
{
...
Hash func_389(int iParam0, int iParam1) // Position - 0xD5FE
{
	int num;
...
int func_390(int iParam0, int iParam1, int iParam2) // Position - 0xD641
{
	int randomIntInRange;
...
void func_391(int iParam0, int iParam1) // Position - 0xD6E7
{
	if (iParam0 < 0 || iParam0 >= 32)
		return;
...
int func_392(int iParam0) // Position - 0xD71B
{
	if (iParam0 < 0)
		return 0;
...
char* func_393(Player plParam0) // Position - 0xD73C
{
	const char* str;
...
const char* func_394(const char* sParam0, int iParam1) // Position - 0xD811
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

Hash func_395(Hash hParam0) // Position - 0xD82B
{
	return hParam0;
}

BOOL func_396(Hash hParam0, Hash hParam1) // Position - 0xD835
{
...
BOOL func_397() // Position - 0xD86B
{
	return Global_1915656.f_20637 || Global_1915656.f_22504.f_1;
}

int func_398(Hash hParam0) // Position - 0xD889
{
	if (!func_203(hParam0, 0))
		return 2;
...
BOOL func_399(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4) // Position - 0xD8F0
{
	if (!func_74(iParam1))
		return false;
...
float func_400(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xDA76
{
	Vector3 entityCoords;
...
int func_404(Hash hParam0, int iParam1) // Position - 0xDC3D
{
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_405(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0xDC93
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
int func_406(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0xDD86
{
	int num;
	var unk13;
	int num2;
...
void func_407(int iParam0, int iParam1) // Position - 0xDDE9
{
	if (iParam1 == 0)
		return;
...
BOOL func_408(Hash hParam0, Any anParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6) // Position - 0xDE19
{
	var unk;
...
void func_409(var uParam0, int iParam1) // Position - 0xDE3F
{
...
BOOL func_410(int iParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0xDE7B
{
	var unk;
	int num;
	int i;
...
const char* func_412(var uParam0, int iParam1) // Position - 0xDFD2
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
...
int func_413(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12, BOOL bParam13, BOOL bParam14, var uParam15, var uParam16) // Position - 0xE008
{
	var unk;
	var unk14;
	int num;
...
int func_414(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, int iParam15, int iParam16, int iParam17, var uParam18, var uParam19) // Position - 0xE095
{
	var unk;
	var unk14;
	int num;
...
int func_415(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, BOOL bParam12, BOOL bParam13) // Position - 0xE134
{
	var unk;
	var unk14;
	int num;
...
int func_416(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14, int iParam15, int iParam16) // Position - 0xE1B0
{
	var unk;
	var unk14;
	int num;
...
int func_417(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12, BOOL bParam13, BOOL bParam14) // Position - 0xE23E
{
	var unk;
	var unk14;
	int num;
...
int func_418(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12, int iParam13, int iParam14) // Position - 0xE2C0
{
	var unk;
	var unk14;
	int num;
...
int func_419(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0xE33D
{
	var unk;
	var unk14;
	int num;
...
int func_420(int iParam0) // Position - 0xE3A3
{
	int i;
...
void func_421(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xE3EF
{
	int i;
...
int func_422(Hash hParam0, BOOL bParam1) // Position - 0xE48D
{
	int num;
...
BOOL func_423() // Position - 0xE4C6
{
	return func_526(func_217(0));
}

BOOL func_424(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0xE4D7
{
	var unk;
	int num;
	int i;
...
Hash func_425(Hash hParam0, BOOL bParam1) // Position - 0xE59C
{
	int i;
	int num;
	var unk;
...
Hash func_426(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE62F
{
	int i;
	int num;
	var unk;
...
BOOL func_427(BOOL bParam0) // Position - 0xE78E
{
	if (bParam0)
...
BOOL func_428(Hash hParam0) // Position - 0xE7BE
{
	return func_272(hParam0, 1279601681);
}

struct<4> func_429(BOOL bParam0) // Position - 0xE7D1
{
	int num;
...
int func_430(Hash hParam0, BOOL bParam1) // Position - 0xE872
{
...
BOOL func_431(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE8A9
{
	return func_170(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_432(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0xE8C4
{
	var unk;
...
struct<4> func_433(BOOL bParam0) // Position - 0xE8E5
{
	int num;
...
int func_434(Hash hParam0) // Position - 0xE94F
{
	var unk;
...
BOOL func_435(Hash hParam0, int iParam1) // Position - 0xE97A
{
	Hash hash;
	int num;
	int i;
...
BOOL func_436(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0xE9E7
{
	return func_489(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_437(Hash hParam0) // Position - 0xE9FD
{
	BOOL flag;
	Hash weaponUnlock;
...
BOOL func_438(int* piParam0, BOOL bParam1) // Position - 0xEA47
{
	if (!bParam1)
...
BOOL func_439(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, Hash hParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xEAE3
{
	Hash hash;
...
struct<17> func_440(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, int iParam6, BOOL bParam7) // Position - 0xEB80
{
	var unk;
...
BOOL func_441(int* piParam0, Hash hParam1) // Position - 0xEBFA
{
...
BOOL func_442(Hash hParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, int iParam6) // Position - 0xEC18
{
	int i;
	int num;
	Hash hash;
...
BOOL func_443(Hash hParam0) // Position - 0xED98
{
	int num;
...
BOOL func_444(Hash hParam0) // Position - 0xEDC6
{
	return func_272(hParam0, 1282106666);
}

BOOL func_445(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, int iParam7, var uParam8, BOOL bParam9, Hash hParam10, int iParam11, BOOL bParam12) // Position - 0xEDD9
{
	var unk;
...
BOOL func_446(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, BOOL bParam7, var uParam8, BOOL bParam9, Hash hParam10, int iParam11, int iParam12, BOOL bParam13) // Position - 0xEE56
{
	var unk;
...
BOOL func_447(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xEF36
{
	var unk;
...
void func_448(int* piParam0) // Position - 0xEFAA
{
...
BOOL func_449(int* piParam0) // Position - 0xEFDE
{
	Hash action;
...
int func_450(Hash hParam0, int iParam1) // Position - 0xF07B
{
	switch (hParam0)
	{
		case -2141145462:
...
struct<2> func_451(int iParam0, int iParam1) // Position - 0xF5BC
{
	int num;
...
void func_452(var uParam0, var uParam1, int iParam2) // Position - 0xF5D2
{
...
BOOL func_454(int* piParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, Hash hParam18, BOOL bParam19, int iParam20) // Position - 0xF65F
{
...
int func_455(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF6E9
{
	var unk;
	int num;
	int i;
...
void func_456(char* sParam0, char* sParam1, BOOL bParam2) // Position - 0xF784
{
	int soundId;
...
Hash func_457(Hash hParam0, int iParam1) // Position - 0xF7C3
{
	if (!func_203(hParam0, 0))
		return 0;
...
void func_458(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0xF7F2
{
	int i;
	int j;
	int k;
...
BOOL func_459(Any* panParam0) // Position - 0xF9C8
{
...
int func_460(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xF9E4
{
	if (!func_312(&uParam0))
		return 0;
...
BOOL func_461(int iParam0) // Position - 0xFA00
{
	if (iParam0 <= 0)
		return false;
...
BOOL func_462(int iParam0, int iParam1) // Position - 0xFA1E
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_463(int iParam0) // Position - 0xFA36
{
...
BOOL func_464(int iParam0) // Position - 0xFA4D
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_465(int iParam0, int iParam1) // Position - 0xFB19
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_466(int iParam0) // Position - 0xFB32
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_467() // Position - 0xFB45
{
	if (!func_56())
		return false;
...
BOOL func_468(Hash hParam0, int iParam1) // Position - 0xFB60
{
	if (hParam0 == 0)
		return false;
...
BOOL func_469(Hash hParam0) // Position - 0xFB7A
{
	return func_434(hParam0) == -126813555;
}

BOOL func_470(int iParam0, Hash hParam1) // Position - 0xFB8E
{
	var unk;
	int num;
	Hash unlockHash;
...
Hash func_471(int iParam0, BOOL bParam1) // Position - 0xFCD7
{
	int i;
	int num;
	var unk;
...
Hash func_472(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xFD6A
{
	int i;
	int num;
	var unk;
...
BOOL func_473(int iParam0, Hash hParam1, int iParam2) // Position - 0xFEC9
{
	if (iParam0 == 0)
		return false;
...
BOOL func_474(int* piParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, Hash hParam19, BOOL bParam20) // Position - 0xFF29
{
...
int func_475(int iParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFF7D
{
	var unk;
	int num;
	int i;
...
Hash func_476(Hash hParam0, int iParam1) // Position - 0xFFE9
{
	int num;
	var unk;
	Hash hash;
...
int func_477(Hash hParam0, BOOL bParam1) // Position - 0x10064
{
	var unk;
	int num;
	int num2;
...
struct<4> func_478(Hash hParam0, BOOL bParam1) // Position - 0x100C3
{
	var unk;
...
int func_479(int iParam0, int iParam1) // Position - 0x100E8
{
	switch (iParam0)
	{
		case joaat("hennigans_stead_camp"):
...
int func_480(var uParam0, var uParam1, var uParam2) // Position - 0x10190
{
	var unk;
	int numNodes;
...
int func_481(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x101C2
{
	int num;
	int num2;
	var unk;
...
BOOL func_482(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x1021B
{
...
BOOL func_483(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x10242
{
	if (iParam2 < 0)
		return false;
...
BOOL func_484(Hash hParam0) // Position - 0x1027D
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_485(int iParam0) // Position - 0x10298
{
	if (iParam0 < 0)
		return 0;
...
int func_486(Hash hParam0) // Position - 0x102B9
{
	switch (hParam0)
	{
...
int func_487(var uParam0, int iParam1) // Position - 0x1039C
{
	int i;
...
int func_488(Hash hParam0) // Position - 0x103D9
{
	int num;
...
BOOL func_489(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x10446
{
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(panParam0))
		return 0;
...
int func_490(var uParam0, var uParam1, var uParam2) // Position - 0x10480
{
	int num;
...
Vector3 func_491(BOOL bParam0) // Position - 0x104BB
{
	float num;
	int value;
	int value2;
...
Hash func_492(int iParam0) // Position - 0x10517
{
	switch (iParam0)
	{
		case 1:
...
eBlipSprite func_493(int iParam0) // Position - 0x1074F
{
	switch (iParam0)
	{
		case 1:
...
var func_494(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x10C3C
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_563(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
float func_495(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x10FCF
{
	float num;
	float Y;
	float X;
...
int func_496(Hash hParam0, BOOL bParam1, Hash hParam2) // Position - 0x11034
{
	if (!func_203(hParam0, 0))
		return 0;
...
int func_497(Any anParam0) // Position - 0x11058
{
	if (!GANG::NETWORK_IS_GANG_ID_VALID(anParam0))
		return -1;
...
BOOL func_498(int iParam0) // Position - 0x11090
{
	if (iParam0 < 0)
		return false;
...
int func_499(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x110BD
{
	int num;
...
BOOL func_500() // Position - 0x1111B
{
...
// Unhandled jump detected. Output should be considered invalid
int func_501(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x11137
{
	var unk;
	int num;
	int i;
...
BOOL func_502(BOOL bParam0) // Position - 0x11227
{
	if (func_19() == -1)
		return true;
...
BOOL func_503(Hash hParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x11245
{
	int num;
	var unk;
	var unk6;
...
BOOL func_504(Hash hParam0) // Position - 0x112BD
{
	switch (hParam0)
	{
		case -1551258934:
...
int func_505(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x112EA
{
	int num;
...
var func_506(Any anParam0) // Position - 0x11354
{
	var memberHandles;
	var value;
	int gangMembers;
...
var func_507(BOOL bParam0, var uParam1, var uParam2) // Position - 0x113AD
{
	if (bParam0)
		return uParam1;
...
void func_508(int iParam0, int iParam1) // Position - 0x113C4
{
	if (iParam1 < 0)
		return;
...
void func_509(int iParam0, int iParam1) // Position - 0x1144A
{
...
void func_510(int iParam0, int iParam1) // Position - 0x11486
{
	int num;
	int num2;
...
void func_511(int iParam0, int iParam1) // Position - 0x114D9
{
...
void func_512(int iParam0, int iParam1) // Position - 0x11514
{
...
void func_513(int iParam0, int iParam1) // Position - 0x1154D
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_514() // Position - 0x11585
{
...
float func_515(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x115A6
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_516(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x115C4
{
	var unk;
	var unk5;
...
void func_517(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x115EA
{
...
BOOL func_518(Hash hParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x1161B
{
	BOOL flag;
	int num;
	var unk;
...
void func_519(var uParam0, int iParam1) // Position - 0x116FC
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_520(var uParam0, int iParam1) // Position - 0x1170D
{
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_521(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x11722
{
	int i;
...
BOOL func_522(int iParam0) // Position - 0x117B1
{
	if (iParam0 < 0)
		return false;
...
int func_523(int iParam0, Hash hParam1) // Position - 0x117D4
{
...
int func_524(Hash hParam0, int iParam1) // Position - 0x117F9
{
	var unk;
	var guid;
...
void func_525(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x11854
{
	int i;
...
BOOL func_526(var uParam0, var uParam1) // Position - 0x11930
{
	return func_581(uParam0, 5, 8);
}

BOOL func_527(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x11943
{
	var unk;
	int num;
	int i;
...
BOOL func_528(Hash hParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0x119D1
{
	var unk;
	int i;
...
Hash func_529(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x11A55
{
	int num;
...
BOOL func_530(Hash hParam0) // Position - 0x11AF1
{
	return func_434(hParam0) == 1946043663;
}

int func_531() // Position - 0x11B05
{
...
BOOL func_532(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x11B22
{
	int inventoryId;
...
BOOL func_533(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x11B67
{
...
BOOL func_534(Hash hParam0) // Position - 0x11B9A
{
	return func_333(hParam0) == joaat("WEAPON");
}

BOOL func_535(Any anParam0) // Position - 0x11BAE
{
...
BOOL func_536(Hash hParam0) // Position - 0x11BF4
{
	Hash hash;
...
BOOL func_537(int* piParam0, Hash hParam1, Hash hParam2, int iParam3, int iParam4) // Position - 0x11C13
{
	int num;
	var unk;
	var unk2;
...
BOOL func_538(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5) // Position - 0x11CBE
{
	var unk;
...
BOOL func_539(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x11D0F
{
...
BOOL func_540(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, Hash hParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x11D4A
{
	var unk;
	Hash hash;
	int num;
...
BOOL func_541(int* piParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x11E01
{
	int num;
	int num2;
	int num3;
...
int func_542(Hash hParam0) // Position - 0x11F49
{
	int num;
...
BOOL func_543(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, Any* panParam5, BOOL bParam6, int iParam7) // Position - 0x11F78
{
	return func_336(&uParam0, hParam4, panParam5, bParam6, iParam7);
}

BOOL func_544(int* piParam0, Any* panParam1, Hash hParam2, BOOL bParam3, int iParam4) // Position - 0x11F8E
{
	var unk;
	int num;
...
BOOL func_545(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, Hash hParam7, int iParam8) // Position - 0x12136
{
...
int func_546(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1217A
{
	int num;
	var unk;
	int num2;
...
BOOL func_547(Hash hParam0, Any* panParam1, int iParam2) // Position - 0x122BD
{
	if (panParam1->f_9 < 1)
		return false;
...
BOOL func_548(int* piParam0, Hash hParam1) // Position - 0x1233D
{
	Hash action;
...
BOOL func_549(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x123A0
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

BOOL func_550(int* piParam0, BOOL bParam1) // Position - 0x123B7
{
...
BOOL func_551(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x123D8
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_552() // Position - 0x123EF
{
	int value;
...
BOOL func_553(int iParam0, Hash hParam1) // Position - 0x12433
{
	int num;
	int num2;
	var unk;
...
BOOL func_554(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x124ED
{
...
BOOL func_555(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x12506
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

void func_556(Hash hParam0, var uParam1, var uParam2) // Position - 0x1251D
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_557(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x12729
{
	Hash hash;
...
void func_558(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x12807
{
	if (INVENTORY::_INVENTORY_IS_GUID_VALID(&uParam1))
		uParam0->f_9 = { uParam1 };
...
BOOL func_559(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x12822
{
...
int func_560(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x12847
{
	if (fParam0 < fParam3)
...
int func_561() // Position - 0x1288F
{
	return Global_1051645.f_12;
}

char* func_562() // Position - 0x1289D
{
	return "unnamed";
}

BOOL func_563(int iParam0) // Position - 0x128A9
{
	int num;
...
BOOL func_564(int iParam0) // Position - 0x12938
{
	if (Global_1572887.f_14 == -1)
		return false;
...
int func_565(int iParam0) // Position - 0x12956
{
	if (iParam0 == 255)
...
BOOL func_566(Player plParam0) // Position - 0x129A1
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_567(int iParam0) // Position - 0x129E6
{
	if (iParam0 < 0)
		return false;
...
BOOL func_569(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x12A24
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 20, panParam2, 0);
}

int func_570(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x12A3B
{
	if (bParam0)
	{
...
int func_571(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x12A84
{
	if (bParam0)
	{
		func_421(iParam1, 1, 0, 0);
...
int func_572(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x12AA0
{
	var unk;
	int num;
	int i;
...
BOOL func_573(Hash hParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x12B34
{
	int num;
	var unk;
	int num2;
...
BOOL func_574(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x12C4C
{
	var unk;
	int num;
	var unk15;
...
BOOL func_575(Hash hParam0, Any* panParam1) // Position - 0x12D6A
{
	int num;
...
int func_576(int iParam0, int iParam1) // Position - 0x12F40
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_577(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x12FDA
{
	int i;
	var unk;
...
void func_578(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x13095
{
	int i;
	int j;
	int k;
...
int func_579(int iParam0) // Position - 0x1326B
{
	switch (iParam0)
	{
		case 0:
...
void func_580(int iParam0) // Position - 0x1329C
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
BOOL func_581(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x132BF
{
	int num;
...
BOOL func_582(Hash hParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0x132FA
{
	var unk;
	int i;
...
int func_583(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1337E
{
...
int func_584(Hash hParam0, Any anParam1, var uParam2, var uParam3, var uParam4) // Position - 0x133B1
{
	Hash hash;
	Hash hash2;
	int i;
...
BOOL func_585(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x13496
{
	var unk;
	var unk48;
...
int func_586(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x13562
{
	if (!func_203(hParam0, 0))
	{
		if (func_468(func_395(hParam0), 2))
...
BOOL func_587(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3) // Position - 0x135D6
{
	var unk;
...
int func_588(int* piParam0, Hash hParam1) // Position - 0x13635
{
	int num;
	int i;
	int numOfItems;
...
BOOL func_589(Hash hParam0, BOOL bParam1) // Position - 0x1369F
{
...
BOOL func_590(Hash hParam0, BOOL bParam1) // Position - 0x13718
{
	int num;
	var unk;
...
void func_591(const char* sParam0) // Position - 0x13762
{
	Global_1915656.f_22470 = func_137(sParam0, 10000, 0, 0, 0, true);
	return;
}

int func_592(int* piParam0, Hash hParam1) // Position - 0x1377E
{
	int num;
	int i;
	int numOfItems;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_593(Hash hParam0, int iParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x137F7
{
	var unk;
	int num;
	int num2;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_594(Hash hParam0, int iParam1, Hash hParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x138DD
{
	var unk;
	int num;
	int num2;
			...
			else
			{
				if (flag)
				{
					if (func_629(unk[i /*2*/]) || func_630(unk[i /*2*/]))
					{
						...
						if (bParam5)
							num6 = func_631(7, unk[i /*2*/], &EntityIndex);
...
BOOL func_595(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13ADD
{
	var unk;
...
BOOL func_596(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13B0B
{
	int num;
...
BOOL func_597(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13B42
{
	int num;
...
BOOL func_598(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13B82
{
	int num;
...
BOOL func_599(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13BCB
{
	int num;
...
BOOL func_600(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13C1D
{
	int num;
...
BOOL func_601(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13C78
{
	int num;
...
BOOL func_602(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13CDC
{
	int num;
...
BOOL func_603(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13D4A
{
	int num;
...
BOOL func_604(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13DC1
{
	int num;
...
BOOL func_605(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13E41
{
	int num;
...
BOOL func_606(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13ECA
{
	int num;
...
BOOL func_607(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13F5C
{
	int num;
...
BOOL func_608(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13FF7
{
	int num;
...
BOOL func_609(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x1409D
{
	int num;
...
struct<29> func_610(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1414A
{
	var unk;
	var unk30;
...
int func_611(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x141E5
{
	int num;
...
struct<26> func_612(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1424F
{
	var unk;
	var unk27;
...
int func_613(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x142D2
{
	int num;
...
struct<18> func_614(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x14322
{
	var unk;
	var unk19;
...
int func_615(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x14397
{
	int num;
...
int func_616(int iParam0) // Position - 0x14401
{
	return iParam0 / 100;
}

BOOL func_617(Player plParam0) // Position - 0x1440E
{
...
void func_618(Player plParam0) // Position - 0x1442B
{
	Player player;
...
BOOL func_619(Hash hParam0) // Position - 0x144AE
{
...
BOOL func_620(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x144C4
{
	*uParam1 = 0;
...
struct<17> func_621(Hash hParam0, var uParam1) // Position - 0x14531
{
	var unk;
...
BOOL func_622(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x14584
{
...
void func_623(var uParam0) // Position - 0x1459C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_624(int iParam0, var uParam1) // Position - 0x145F7
{
	if (iParam0 == 2)
...
BOOL func_625(Hash hParam0, Hash hParam1, Any anParam2) // Position - 0x14611
{
	int i;
	int num;
...
BOOL func_626(Hash hParam0) // Position - 0x14651
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_627(Hash hParam0, BOOL bParam1) // Position - 0x1465F
{
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_628(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x14717
{
	int i;
...
BOOL func_629(Hash hParam0) // Position - 0x147A7
{
	if (!func_203(hParam0, 0))
		return false;
...
BOOL func_630(Hash hParam0) // Position - 0x147D6
{
	if (!func_203(hParam0, 0))
		return 0;
...
int func_631(int iParam0, Hash hParam1, var uParam2) // Position - 0x14800
{
	Ped EntityIndex;
	ItemSet itemSet;
	int itemsetSize;
...
int func_632(Hash hParam0, int iParam1) // Position - 0x1492D
{
	int num;
	int num2;
	int num3;
...
int func_633(int iParam0, Hash hParam1) // Position - 0x14A4A
{
	Ped EntityIndex;
	Hash hash;
	int num;
...
int func_634(Hash hParam0) // Position - 0x14AE8
{
	int num;
...
BOOL func_635(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, int iParam4, Any* panParam5, BOOL bParam6, int iParam7) // Position - 0x14B3A
{
	int i;
...
BOOL func_636(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x14BB7
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 29, panParam2, 0);
}

BOOL func_637(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x14BCE
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 26, panParam2, 0);
}

void func_638(Player plParam0) // Position - 0x14BE5
{
	Player player;
...
void func_639(Player plParam0) // Position - 0x14C51
{
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_640(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x14C8C
{
	int i;
...
int func_641(var uParam0, var uParam1) // Position - 0x14DA3
{
	var unk;
...
void func_642(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x14DCF
{
	int i;
	int j;
	int k;
...
int func_643(int iParam0) // Position - 0x14FA5
{
	if (iParam0 == 7)
...
BOOL func_644(int iParam0) // Position - 0x14FBE
{
	iParam0 = func_643(iParam0);
...
Ped func_645(int iParam0) // Position - 0x14FF6
{
	iParam0 = func_643(iParam0);
...
BOOL func_646(Entity eParam0) // Position - 0x15022
{
...
int func_647(Hash hParam0, int iParam1) // Position - 0x15085
{
	var unk;
	int num;
	int i;
...
Hash func_648(Hash hParam0) // Position - 0x150CF
{
	int num;
...
int func_649(Hash hParam0) // Position - 0x15441
{
...
int func_650(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x15486
{
	var unk;
	int num;
	int i;
...
BOOL func_651(Hash hParam0, int iParam1, var uParam2) // Position - 0x154DA
{
	var unk;
	int num;
	int num2;
...
BOOL func_652(int* piParam0, Any* panParam1, Any* panParam2, Hash hParam3, BOOL bParam4, int iParam5) // Position - 0x155FC
{
...
BOOL func_653(int iParam0, var uParam1, Any* panParam2) // Position - 0x1566E
{
	if (!func_44(iParam0))
		return false;
...
int func_654() // Position - 0x15779
{
	return Global_1915656.f_20241;
}

BOOL func_655(int iParam0, Hash hParam1, Any* panParam2, Any* panParam3) // Position - 0x15788
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam3, *panParam3);
}

void func_656(Any* panParam0) // Position - 0x157A1
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
