...
void func_7() // Position - 0x253
{
	return;
}

void func_8() // Position - 0x25B
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x267
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x28F
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x2B7
{
	struct<2> data;
...
BOOL func_12(int iParam0) // Position - 0x2DF
{
	return bLocal_18 && iParam0 != false;
}

void func_13(int iParam0) // Position - 0x2EE
{
	if (!func_12(iParam0))
		return;
...
void func_15(var uParam0) // Position - 0x33B
{
	uLocal_19 = uParam0;
	return;
}

Vector3 func_16() // Position - 0x347
{
	return 2710.57f, -1291.2f, 48.63f;
}

Vector3 func_17() // Position - 0x35E
{
	return -290.86f, 813.36f, 118.42f;
}

Vector3 func_18() // Position - 0x375
{
	return -281.07f, 815.24f, 118.42f;
}

Vector3 func_19(Entity eParam0, var uParam1, var uParam2) // Position - 0x38C
{
	int i;
	var unk;
	float num;
...
int func_20(int iParam0) // Position - 0x408
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_21(var uParam0) // Position - 0x443
{
	return func_34(*uParam0, 1);
}

void func_22(var uParam0, BOOL bParam1) // Position - 0x453
{
...
int func_23(var uParam0, float fParam1) // Position - 0x473
{
	if (!func_21(uParam0))
		return 0;
...
void func_24(var uParam0) // Position - 0x49A
{
	func_36(uParam0, 0f);
	return;
}

void func_25(BOOL bParam0) // Position - 0x4A9
{
	if (func_12(bParam0))
		return;
...
void func_27(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x590
{
	float num;
	float num2;
	float num3;
...
void func_28(var uParam0) // Position - 0x921
{
	return;
}

void func_29(var uParam0) // Position - 0x929
{
	return;
}

void func_30(var uParam0) // Position - 0x931
{
	return;
}

void func_31(var uParam0) // Position - 0x939
{
	if (CAM::DOES_CAM_EXIST(*uParam0))
	{
...
float func_32(Entity eParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x9DF
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xA07
{
...
BOOL func_34(int iParam0, int iParam1) // Position - 0xA31
{
	return iParam0 && iParam1 != false;
}

float func_35(var uParam0) // Position - 0xA40
{
	if (!func_21(uParam0))
		return uParam0->f_1;
...
void func_36(var uParam0, float fParam1) // Position - 0xA75
{
...
BOOL func_37(Hash hParam0) // Position - 0xA9B
{
	return hParam0 != 0;
}

Entity func_38(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xAA7
{
	Entity EntityIndex;
...
Vector3 func_39() // Position - 0xAEC
{
	return 0.585564f, 0.325876f, 1.6871f;
}

Vector3 func_40() // Position - 0xB03
{
	return -7.766f, 0f, 175.2488f;
}

void func_41(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, float fParam14, BOOL bParam15, int iParam16, int iParam17) // Position - 0xB16
{
	uParam0->f_1 = { uParam1 };
	uParam0->f_4 = { uParam4 };
	uParam0->f_7 = fParam7;
...
BOOL func_42(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xC17
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

Vector3 func_43(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0xC40
{
	return ({ 1f - fParam6, 1f - fParam6, 1f - fParam6 } * uParam0) + ({ fParam6, fParam6, fParam6 } * uParam3);
}

float func_44(float fParam0, float fParam1, float fParam2) // Position - 0xC5B
{
	if (fParam0 > fParam2)
		return fParam2;
...
BOOL func_45(var uParam0) // Position - 0xC82
{
	return func_34(*uParam0, 2);
}

float func_46() // Position - 0xC92
{
...
void func_47(var uParam0, int iParam1) // Position - 0xCC4
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_48(var uParam0, int iParam1) // Position - 0xCD5
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

Entity func_49(Hash hParam0, int iParam1) // Position - 0xCEA
{
...
Hash func_50(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD20
{
...
BOOL func_51(Hash hParam0) // Position - 0xDC4
{
	if (func_37(hParam0))
