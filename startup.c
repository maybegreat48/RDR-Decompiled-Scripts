...
struct<4> func_1() // Position - 0x273
{
	var unk;
...
void func_3() // Position - 0x29A
{
	return;
}

void func_4() // Position - 0x2A2
{
...
void func_6(BOOL bParam0) // Position - 0x306
{
...
int func_8(Any anParam0) // Position - 0x355
{
	return anParam0->f_76;
}

void func_9() // Position - 0x361
{
...
void func_10(int iParam0) // Position - 0x389
{
	iLocal_32 = iParam0;
...
int func_11() // Position - 0x39D
{
	return Global_1572887.f_14;
}

BOOL func_12() // Position - 0x3AB
{
...
BOOL func_13() // Position - 0x3BF
{
	return Global_1048577;
}

int func_14() // Position - 0x3CB
{
	return iLocal_32;
}

void func_15(int iParam0) // Position - 0x3D5
{
	if (iParam0 < 6)
	{
		Global_1902570 = 8;
...
void func_16(int iParam0) // Position - 0x40F
{
	BOOL flag;
	int clockYear;
...
void func_17(var uParam0) // Position - 0x4B9
{
	BOOL flag;
...
void func_18(BOOL bParam0) // Position - 0x52A
{
	int i;
...
void func_19(int iParam0) // Position - 0x571
{
	switch (*iParam0)
	{
		case 0:
...
BOOL func_20(int iParam0) // Position - 0x603
{
	return Global_1572864.f_3 && iParam0 != false;
}

void func_21(int iParam0) // Position - 0x616
{
	Global_1572864.f_3 = Global_1572864.f_3 - Global_1572864.f_3 && iParam0;
	return;
}

void func_22() // Position - 0x634
{
	func_67(4);
	func_68();
	func_24(2);
...
void func_24(int iParam0) // Position - 0x66A
{
	if (iParam0 == 0)
		iParam0 = 1;
...
int func_25() // Position - 0x683
{
	return Global_1572864.f_1;
}

void func_26() // Position - 0x691
{
	var unk;
...
BOOL func_29(int iParam0) // Position - 0x903
{
	char* InputString;
	...
	switch (iParam0)
	{
		...
		case 2:
			InputString = func_86(2);
			stackSize = 1024;
			break;
	
		case 3:
			InputString = func_86(3);
			stackSize = 25500;
			break;
	
		case 4:
			InputString = func_86(4);
			stackSize = 25500;
			break;
	
		case 5:
			InputString = func_86(5);
			stackSize = 1024;
			break;
	}

	if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(InputString)) > 0)
	{
		func_87(iParam0);
		return true;
	}

	if (func_88(InputString, stackSize))
	{
		func_87(iParam0);
		func_89(iParam0);
		func_36();
...
void func_30() // Position - 0x9B6
{
	return;
}

void func_31() // Position - 0x9BE
{
	return;
}

void func_32() // Position - 0x9C6
{
	return;
}

BOOL func_33() // Position - 0x9CE
{
	if (func_39() != func_25())
		return true;
...
void func_37() // Position - 0xB27
{
	return;
}

void func_38() // Position - 0xB2F
{
...
int func_39() // Position - 0xB4B
{
	return Global_1572864;
}

const char* func_40() // Position - 0xB57
{
	var unk;
	var unk9;
	var unk90;
...
BOOL func_44(int iParam0) // Position - 0x104D
{
...
BOOL func_45(int iParam0, var uParam1) // Position - 0x106A
{
	switch (*uParam1)
	{
		case 0:
...
void func_46() // Position - 0x1140
{
	...
	TEXT_LABEL_COPY(&decoratorName, { func_121() }, 4);
	DECORATOR::DECOR_REGISTER(&decoratorName, INT);
...
void func_48() // Position - 0x1A9C
{
	STREAMING::_0xDEEE1F265B7ECEF5();
	return;
}

int func_49(Any anParam0) // Position - 0x1AA8
{
...
BOOL func_50(var uParam0) // Position - 0x1B9A
{
	return uParam0->f_80;
}

void func_51(Any anParam0) // Position - 0x1BA6
{
...
int func_52(char* sParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x1BF6
{
	int num;
	var unk13;
	int num2;
...
void func_53(var uParam0) // Position - 0x1C31
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_55(var uParam0) // Position - 0x1C68
{
	Hash Variable;
	BOOL flag;
	...
	if (flag)
		MISC::SET_BIT(&Variable, 6);

	if (CAM::IS_GAMEPLAY_CAM_RENDERING() || CAM::IS_CINEMATIC_CAM_RENDERING())
	{
		MISC::SET_BIT(&Variable, 2);
		MISC::SET_BIT(&Variable, 5);
		MISC::SET_BIT(&Variable, 4);
	
		if (LAW::GET_WANTED_SCORE(PLAYER::PLAYER_ID()) > 0)
			MISC::SET_BIT(&Variable, 3);
	}
...
void func_60(const char* sParam0) // Position - 0x1F63
{
	BOOL flag;
	char* StringToTest;
	BOOL flag2;
	...
	if (!flag)
	{
		StringToTest = func_190(sParam0, sParam0->f_58);
	...
	{
		if (sParam0->f_58 > 0)
			func_191(sParam0, StringToTest, flag);
		else
			func_192(sParam0, StringToTest, flag);
	...
	{
		SourceStruct.f_12.f_3 = -1;
		SourceStruct.f_12.f_3.f_1 = -1;
		SourceStruct.f_12.f_11.f_12 = -1;
		SourceStruct.f_12.f_11.f_12.f_1 = -1;
		SourceStruct.f_12.f_11.f_14 = 255;
		SourceStruct.f_12.f_11.f_15 = 255;
		SourceStruct.f_52 = -1;
		SourceStruct.f_52.f_1 = -1;
		SourceStruct.f_54 = -1;
		MISC::COPY_SCRIPT_STRUCT(sParam0, &SourceStruct, 59);
	}

	return;
}

void func_61(int iParam0) // Position - 0x2081
{
	Global_1901571 = iParam0;
	return;
}

BOOL func_62() // Position - 0x208F
{
	BOOL num;
	int i;
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x20CA
{
	uParam0->f_1 = 0;
	return;
}

BOOL func_64(var uParam0, int iParam1, BOOL bParam2) // Position - 0x20D7
{
	if (iParam1 == -1)
		return true;
...
void func_67(int iParam0) // Position - 0x2222
{
	Global_1572864.f_3 = Global_1572864.f_3 || iParam0;
	return;
}

void func_68() // Position - 0x2239
{
	int i;
...
void func_69(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x2264
{
...
int func_71() // Position - 0x2326
{
	return iLocal_29;
}

void func_72(BOOL bParam0) // Position - 0x2330
{
	NETWORK::_0x704F92B3AF20D857(bParam0);
	return;
}

void func_73(BOOL bParam0) // Position - 0x233E
{
	Player player;
	BOOL flag;
	var unk;
...
void func_75(int iParam0) // Position - 0x2404
{
	Global_1572887.f_196.f_47 = iParam0;
	return;
}

void func_76() // Position - 0x2416
{
	var data;
...
void func_77(int iParam0) // Position - 0x2427
{
	Global_1572887.f_14 = iParam0;
	return;
}

void func_78(int iParam0) // Position - 0x2437
{
	iLocal_29 = iParam0;
...
BOOL func_80() // Position - 0x2561
{
	return func_206() > 120000;
}

BOOL func_81() // Position - 0x2572
{
	...
	{
		TEXT_LABEL_ASSIGN_STRING(&StringToConvert, NETWORK::GET_LAUNCH_PARAM_VALUE(func_207(156317380)), 64);
	
		if (MISC::STRING_TO_INT(&StringToConvert, &(Global_1572887.f_300.f_15)))
		{
		}
	}
...
int func_83() // Position - 0x293D
{
	return Global_1572887.f_300;
}

void func_84(int iParam0) // Position - 0x294C
{
	Global_1572887.f_17 = iParam0;
	return;
}

BOOL func_85(int iParam0) // Position - 0x295C
{
	return func_91(func_215(iParam0));
}

char* func_86(int iParam0) // Position - 0x296E
{
	switch (iParam0)
	{
		case 2:
...
void func_87(int iParam0) // Position - 0x29C2
{
	Global_1572864 = iParam0;
	return;
}

BOOL func_88(char* sParam0, eStackSize essParam1) // Position - 0x29D0
{
...
void func_89(int iParam0) // Position - 0x2A18
{
	switch (iParam0)
	{
		case 2:
...
char* func_90(int iParam0) // Position - 0x2A78
{
	char* str;
...
BOOL func_91(int iParam0) // Position - 0x2B04
{
	return func_216(&(Global_1572887.f_300.f_1), iParam0, 3);
}

int func_92(int iParam0) // Position - 0x2B1C
{
	int num;
...
char* func_93(int iParam0) // Position - 0x2D3D
{
	char* str;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x2F40
{
	switch (iParam0)
	{
		case 0:
...
Hash func_95(Hash hParam0) // Position - 0x3056
{
	Hash i;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(Hash hParam0) // Position - 0x30AD
{
	switch (hParam0)
	{
		case -1:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0(int iParam0) // Position - 0x37F4
{
	switch (iParam0)
	{
		case 0:
...
char* func_98(int iParam0) // Position - 0x38E3
{
	switch (iParam0)
	{
		case 0:
...
void func_99() // Position - 0x3943
{
	BRAIN::DISABLE_SCRIPT_BRAIN_SET(1);
	return;
}

void func_100() // Position - 0x3950
{
	BRAIN::DISABLE_SCRIPT_BRAIN_SET(4);
	return;
}

void func_101() // Position - 0x395D
{
	BRAIN::DISABLE_SCRIPT_BRAIN_SET(2);
	return;
}

void func_102(Any anParam0, char* sParam1, int iParam2) // Position - 0x396A
{
	int i;
	var unk;
	var unk9;
...
void func_103(int iParam0, char* sParam1) // Position - 0x39C9
{
...
void func_104(Any anParam0, char* sParam1, BOOL bParam2) // Position - 0x3A36
{
	int i;
	var unk;
	var variableName;
...
void func_105(Any anParam0, char* sParam1) // Position - 0x3A90
{
	int i;
	var unk;
	var variableName;
...
void func_106(float fParam0, char* sParam1) // Position - 0x3ADE
{
...
void func_107(Any anParam0, char* sParam1) // Position - 0x3B17
{
...
void func_108(Any anParam0, char* sParam1) // Position - 0x3B38
{
	int i;
	var variableName;
...
void func_109(Any anParam0, char* sParam1) // Position - 0x3BC3
{
	var unk;
	var unk9;
	var variableName;
...
void func_110(Any anParam0, char* sParam1) // Position - 0x3CFD
{
	int i;
	var unk;
	var variableName;
...
void func_111(Any anParam0, char* sParam1) // Position - 0x3D4B
{
	int i;
	var unk;
...
void func_112(int iParam0, char* sParam1) // Position - 0x3DC5
{
	int i;
	var variableName;
...
void func_113(Any anParam0, char* sParam1) // Position - 0x3EEC
{
	int i;
	var unk;
	var unk9;
...
void func_114(BOOL bParam0, char* sParam1) // Position - 0x4013
{
	var variableName;
...
void func_115(Any anParam0) // Position - 0x4056
{
...
void func_116(Any anParam0, char* sParam1) // Position - 0x40E4
{
	var variableName;
	int i;
...
BOOL func_118(int iParam0, BOOL bParam1) // Position - 0x4174
{
	BOOL flag;
...
void func_120(var uParam0, int iParam1, int iParam2) // Position - 0x42AB
{
	*uParam0 = iParam1;
	return;
}

Vector3 func_121() // Position - 0x42B8
{
	var unk;
...
char* func_122() // Position - 0x42CC
{
	return "brain_id";
}

char* func_123() // Position - 0x42D8
{
	return "brain_player";
}

char* func_124() // Position - 0x42E4
{
	return "brain_type";
}

char* func_125() // Position - 0x42F0
{
	return "brain_isHidden";
}

char* func_126() // Position - 0x42FC
{
	return "brain_isDisabled";
}

char* func_127() // Position - 0x4308
{
	return "brain_timeStamp";
}

char* func_128() // Position - 0x4314
{
	return "brain_value";
}

char* func_129() // Position - 0x4320
{
	return "bHasScriptBrain";
}

char* func_130() // Position - 0x432C
{
	return "MP_HUD_Local_Status_Icon";
}

char* func_131() // Position - 0x4338
{
	return "MP_HUD_Local_Secondary_Icon";
}

char* func_132() // Position - 0x4344
{
	return "MP_HUD_Local_Blip_Sprite";
}

char* func_133() // Position - 0x4350
{
	return "MP_HUD_Hide_My_Blip_FOR_TEAMS";
}

char* func_134() // Position - 0x435C
{
	return "MP_HUD_Force_My_Blip_Persistent_For_Teams";
}

char* func_135() // Position - 0x4368
{
	return "MP_HUD_Force_Can_Hear_Teams";
}

char* func_136() // Position - 0x4374
{
	return "fetch_entity_bitfield";
}

char* func_137() // Position - 0x4380
{
	return "fetch_combat_config";
}

char* func_138() // Position - 0x438C
{
	return "fetch_lockon_end_time";
}

char* func_139() // Position - 0x4398
{
	return "chu_vip_ped";
}

char* func_140() // Position - 0x43A4
{
	return "NetStableMount";
}

char* func_141() // Position - 0x43B0
{
	return "NetStableGUID1";
}

char* func_142() // Position - 0x43BC
{
	return "NetStableGUID2";
}

char* func_143() // Position - 0x43C8
{
	return "NetStableGUID3";
}

char* func_144() // Position - 0x43D4
{
	return "NetStableGUID4";
}

char* func_145() // Position - 0x43E0
{
	return "NSS_PLAYER_FLAG";
}

char* func_146() // Position - 0x43EC
{
	return "NSS_PLAYER_BOUNTY_CUSTODIAN";
}

void func_147() // Position - 0x43F8
{
	return;
}

void func_148() // Position - 0x4400
{
	return;
}

void func_149() // Position - 0x4408
{
	BRAIN::REGISTER_OBJECT_SCRIPT_BRAIN("net_fast_travel_barker", joaat("s_fasttravelmarker01x"), 100, 20f, -1, 4);
	return;
}

BOOL func_150(Any anParam0) // Position - 0x4426
{
	BOOL flag;
	var InputString;
	BOOL flag2;
	...
	TEXT_LABEL_ASSIGN_STRING(&InputString, "loading_tips", 24);
	flag = DATAFILE::PARSEDDATA_IS_FILE_VALID(*anParam0);

	if (!flag)
		*anParam0 = DATAFILE::_PARSEDDATA_LOAD_FILE_HASH(MISC::GET_HASH_KEY(&InputString));
	...
	for (i = 0; i <= anParam0->f_79 - 1; i = i + 1)
	{
		...
		unk119 = unk18[i];
		unk18[i] = unk18[randomIntInRange];
		unk18[randomIntInRange] = unk119;
	}
	...
	{
		anParam0->f_1 = unk10;
		anParam0->f_3 = unk18[num];
	
		if (func_227(anParam0, 0))
		{
			if (func_228(anParam0, 2, &StringToTest))
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&StringToTest))
				{
					TEXT_LABEL_COPY(&unk120, { StringToTest }, 4);
					...
					func_231(anParam0, 3, &(unk120.f_5));
				
					if (func_228(anParam0, 6, &StringToTest2))
						if (!MISC::IS_STRING_NULL_OR_EMPTY(&StringToTest2))
							unk120.f_6 = MISC::GET_HASH_KEY(&StringToTest2);
				}
			}
		
			if (unk120.f_6 == 0 || MISSIONDATA::MISSIONDATA_GET_RATING(unk120.f_6) >= 2)
			{
				anParam0->f_5[num /*7*/] = { unk120 };
				num = num + 1;
			}
		}
	}
...
void func_151(Any anParam0, int iParam1) // Position - 0x45C5
{
	anParam0->f_80 = iParam1;
	return;
}

void func_152(Any anParam0, int iParam1) // Position - 0x45D3
{
	anParam0->f_76 = iParam1;
	return;
}

int func_153() // Position - 0x45E1
{
...
void func_155(var uParam0, BOOL bParam1) // Position - 0x4825
{
...
BOOL func_156(var uParam0) // Position - 0x4845
{
	return func_241(*uParam0, 1);
}

float func_157(var uParam0) // Position - 0x4855
{
	if (!func_156(uParam0))
		return uParam0->f_1;
...
void func_158(Hash hParam0) // Position - 0x488A
{
...
void func_159(eEventType eetParam0, int iParam1) // Position - 0x48B0
{
	switch (eetParam0)
	{
		case -2095977185:
...
void func_164(int iParam0) // Position - 0x4F7E
{
...
void func_165() // Position - 0x4F90
{
	...
	gamerHandles = 2;
	gamerHandles[0 /*2*/] = { Global_1572887.f_196.f_7 };
	gamerHandles[1 /*2*/] = { Global_1572887.f_196.f_7.f_2 };
	Global_1572887.f_196.f_53 = NETWORK::NETWORK_DISPLAYNAMES_FROM_HANDLES_START(&gamerHandles, 2);
	return;
}

int func_166() // Position - 0x4FD0
{
	var displayNames;
	...
	if (MISC::IS_PC_VERSION() || MISC::IS_STADIA_VERSION())
	{
		...
		if (!NETWORK::_NETWORK_GET_DISPLAY_NAME_FROM_HANDLE(&(Global_1572887.f_196.f_7), &displayNames[0 /*8*/]))
			displaynamesFromHandles = -1;
		else if (!NETWORK::_NETWORK_GET_DISPLAY_NAME_FROM_HANDLE(&(Global_1572887.f_196.f_7.f_2), &displayNames[1 /*8*/]))
			displaynamesFromHandles = -1;
	}
	else
	{
		displaynamesFromHandles = NETWORK::NETWORK_GET_DISPLAYNAMES_FROM_HANDLES(Global_1572887.f_196.f_53, &displayNames, 2);
	}
	...
	str = func_266(&displayNames[0 /*8*/], joaat("COLOR_PURE_WHITE"));
	str2 = func_266(&displayNames[1 /*8*/], joaat("COLOR_PURE_WHITE"));
	str3 = str2;
	str4 = "";
...
int func_189(var uParam0) // Position - 0x608F
{
	if (!func_353(uParam0))
		return 0;
...
char* func_190(const char* sParam0, int iParam1) // Position - 0x60C0
{
	var unk;
	var gamerHandle;
	int num;
	...
	switch (iParam1)
	{
		case 1:
			...
			StringToTest = NETWORK::_REQUEST_PEDSHOT_TEXTURE_MULTIPLAYER_DOWNLOAD(&gamerHandle, 0);
...
void func_191(const char* sParam0, char* sParam1, BOOL bParam2) // Position - 0x61B9
{
	var unk;
...
void func_192(const char* sParam0, char* sParam1, BOOL bParam2) // Position - 0x6366
{
	return;
}

void _STOPWATCH_INITIALIZE(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x636E
{
	if (pStopwatch->f_1 == 0)
	{
...
BOOL func_194(int iParam0) // Position - 0x63B3
{
...
void func_195(int iParam0) // Position - 0x63DB
{
	int i;
...
void func_198(Hash hParam0) // Position - 0x6581
{
	func_372(&(Global_1572887.f_300.f_1), func_215(hParam0), 3);
	return;
}

void func_199() // Position - 0x659E
{
	int i;
...
void func_200() // Position - 0x662D
{
	Global_1572887.f_196.f_42 = MISC::GET_GAME_TIMER();
	return;
}

void func_201(int iParam0) // Position - 0x6641
{
	Global_1572887.f_196.f_2 = iParam0;
	return;
}

void func_202(int iParam0) // Position - 0x6653
{
	Global_1572887.f_196 = iParam0;
	return;
}

BOOL func_203() // Position - 0x6663
{
	return Global_1572887.f_196.f_61 != -1;
}

void func_204(Hash hParam0) // Position - 0x6675
{
	Global_1572887.f_300 = hParam0;
	return;
}

void func_205() // Position - 0x6686
{
	const char* launchParamValue;
	Hash hashKey;
...
int func_206() // Position - 0x66B9
{
	return MISC::GET_GAME_TIMER() - iLocal_29.f_1;
}

char* func_207(int iParam0) // Position - 0x66CA
{
	char* str;
...
void func_208(int iParam0) // Position - 0x680C
{
	int i;
...
int func_209(Hash hParam0) // Position - 0x6866
{
	switch (hParam0)
	{
...
int func_210(Hash hParam0) // Position - 0x6E7D
{
	switch (hParam0)
	{
...
int func_211(Hash hParam0) // Position - 0x6F41
{
	switch (hParam0)
	{
...
int func_212(Hash hParam0) // Position - 0x6F8E
{
	switch (hParam0)
	{
...
void func_213(int iParam0, int iParam1) // Position - 0x707E
{
	if (iParam0 != 0)
...
void func_214(int iParam0) // Position - 0x70A2
{
	char* paramName;
	const char* launchParamValue;
	Hash hashKey;
...
int func_215(int iParam0) // Position - 0x70E1
{
	int num;
...
BOOL func_216(int* piParam0, int iParam1, int iParam2) // Position - 0x729B
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

void func_217(Any* panParam0, char* sParam1) // Position - 0x72D2
{
	var variableName;
...
void func_218(Any anParam0) // Position - 0x7320
{
...
void func_219(Any anParam0) // Position - 0x73DA
{
	int i;
	var unk;
	var unk9;
...
void func_220(Any anParam0) // Position - 0x75B1
{
	int i;
	var unk;
...
void func_221(Any anParam0) // Position - 0x761F
{
	int i;
	var variableName;
	var unk8;
...
void func_222(Any anParam0) // Position - 0x779A
{
	int num;
	var unk;
	var unk9;
...
void func_223(Any anParam0) // Position - 0x77E2
{
	int i;
	int j;
	var variableName;
...
void func_224(Any anParam0) // Position - 0x79CA
{
	var unk;
	var unk9;
	int i;
...
void func_225(Any anParam0) // Position - 0x7A39
{
	int i;
...
Any func_226(Any anParam0, int iParam1) // Position - 0x7A63
{
	Any numNodes;
...
BOOL func_227(Any anParam0, int iParam1) // Position - 0x7A7B
{
	BOOL flag;
...
BOOL func_228(Any anParam0, int iParam1, char* sParam2) // Position - 0x7AA2
{
	BOOL flag;
...
BOOL func_229(Any anParam0, int iParam1, BOOL* pbParam2) // Position - 0x7AC7
{
	BOOL flag;
...
void func_230(var uParam0, int iParam1) // Position - 0x7AEC
{
	uParam0->f_4 = uParam0->f_4 || iParam1;
	return;
}

int func_231(Any anParam0, int iParam1, int* piParam2) // Position - 0x7AFF
{
	BOOL flag;
...
BOOL func_232(int iParam0) // Position - 0x7B24
{
	if (iParam0 == 255)
...
BOOL func_233(BOOL bParam0) // Position - 0x7B49
{
	if (bParam0)
...
BOOL func_234(int iParam0) // Position - 0x7B79
{
	return func_345(1, iParam0);
}

BOOL func_235(int iParam0, int iParam1) // Position - 0x7B88
{
	return iParam0 && iParam1 != false;
}

BOOL func_236() // Position - 0x7B97
{
	return func_385() != -1;
}

int func_237(Player plParam0) // Position - 0x7BA5
{
	if (plParam0 == 255)
...
BOOL func_238(Player plParam0, int iParam1) // Position - 0x7BC4
{
	return Global_263042[plParam0 /*65*/].f_63 && iParam1 != false;
}

BOOL func_239(BOOL bParam0) // Position - 0x7BDB
{
	return Global_262151 && bParam0 != false;
}

void func_240(var uParam0) // Position - 0x7BEC
{
	func_386(uParam0, 0f);
	return;
}

BOOL func_241(int iParam0, int iParam1) // Position - 0x7BFB
{
	return iParam0 && iParam1 != false;
}

BOOL func_242(var uParam0) // Position - 0x7C0A
{
	return func_241(*uParam0, 2);
}

float func_243() // Position - 0x7C1A
{
...
void func_244(int iParam0) // Position - 0x7C4C
{
	struct<17> data;
	int num;
	var gamerHandle1;
	...
	if (!SCRIPTS::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam0, &data, 17))
		return;
	...
	num = NETWORK::_0x27B1AE4D8C652F08(data.f_10);
	...
	if (func_387())
	{
		...
		if (NETWORK::NETWORK_ARE_HANDLES_THE_SAME(&gamerHandle1, &data))
			return;
	}

	if (func_268(data, 131072))
	{
		func_388(data.f_10);
		func_201(0);
		func_255(8);
	...
	if (func_268(data, 2048) && func_268(data, 32) || func_390(255))
		if (func_391())
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(&(data.f_12)))
	{
		num2.f_1 = -1;
		num2.f_2 = -1;
		num2.f_3 = -1;
		...
		{
			unk33.f_17 = MISC::VAR_STRING(42, "NT_INV_BODY_INFO", func_266(&(data.f_2), joaat("COLOR_PURE_WHITE")), "LANDING_FREEROAM_TITLE");
	...
	{
		hash = func_95(MISC::GET_HASH_KEY(&(data.f_12)));
	...
	{
		unk33.f_17 = MISC::VAR_STRING(42, "NT_INV_BODY_INFO", func_266(&(data.f_2), joaat("COLOR_PURE_WHITE")), "PRES_SET_MODE_MP");
...
void func_245(int iParam0) // Position - 0x8014
{
	struct<6> data;
	...
	if (Global_1572887.f_196.f_1 == -1)
		Global_1572887.f_196.f_1 = data.f_4;
...
void func_246(int iParam0) // Position - 0x80E1
{
	struct<2> data;
...
void func_247(int iParam0) // Position - 0x8107
{
	struct<4> data;
	...
	if (NETWORK::NETWORK_IS_GAMER_IN_MY_SESSION(&data))
	{
		NETWORK::NETWORK_CLEAR_PLATFORM_INVITE();
		func_271(128);
		return;
	...
	Global_1572887.f_196.f_1 = data.f_2;
	func_403(&data);
	func_404(&data);
...
void func_248(int iParam0) // Position - 0x81F0
{
	struct<7> data;
	var gamerHandle2;

	if (!SCRIPTS::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam0, &data, 7))
		return;

	if (Global_1572887.f_196.f_1 != -1 && Global_1572887.f_196.f_1 != data.f_4)
		return;

	gamerHandle2 = { func_371(PLAYER::PLAYER_ID()) };

	if (func_254(data.f_5, 2) || func_254(data.f_5, true))
		if (NETWORK::NETWORK_ARE_HANDLES_THE_SAME(&data, &gamerHandle2) && !func_387())
			return;
	else if (NETWORK::NETWORK_ARE_HANDLES_THE_SAME(&(data.f_2), &gamerHandle2) && !func_387())
		return;

	if (NETWORK::NETWORK_ARE_HANDLES_THE_SAME(&data, &gamerHandle2) && data.f_6 == 4)
		return;

	if (Global_1572887.f_196.f_1 != -1 && Global_1572887.f_196.f_1 != data.f_4)
		return;

	if (func_254(data.f_6, 4194304))
	{
	...
	Global_1572887.f_196.f_58 = data.f_6;
	Global_1572887.f_196.f_48 = { data };
	Global_1572887.f_196.f_50 = { data.f_2 };
	Global_1572887.f_196.f_59 = data.f_5;
	return;
}

void func_249() // Position - 0x8331
{
	if (MISC::IS_ORBIS_VERSION())
...
void func_250(int iParam0) // Position - 0x834C
{
	struct<6> data;
...
void func_251(int iParam0) // Position - 0x8394
{
	struct<7> data;
	var gamerHandle2;
	BOOL flag;
	...
	gamerHandle2 = { func_371(PLAYER::PLAYER_ID()) };
	flag = NETWORK::NETWORK_ARE_HANDLES_THE_SAME(&data, &gamerHandle2);

	if (func_254(data.f_6, 8) && flag)
		return;

	func_407(&data);
	Global_1572887.f_196.f_56 = data.f_5;
	Global_1572887.f_196.f_57 = Global_1572887.f_196.f_56;
	Global_1572887.f_196.f_48 = { data };
	Global_1572887.f_196.f_50 = { data.f_2 };
	Global_1572887.f_196.f_60 = data.f_6;
...
void func_253(int iParam0) // Position - 0x89E0
{
	Global_1572887.f_196.f_54 = iParam0;
	return;
}

BOOL func_254(BOOL bParam0, BOOL bParam1) // Position - 0x89F2
{
	return bParam0 && bParam1 != false;
}

void func_255(int iParam0) // Position - 0x8A01
{
	func_408(&(Global_1572887.f_196.f_43), iParam0);
	return;
}

void func_256() // Position - 0x8A17
{
...
BOOL func_257(BOOL bParam0) // Position - 0x8A2F
{
	return func_254(Global_1572887.f_196.f_44, bParam0);
}

void func_258(var uParam0) // Position - 0x8A45
{
	return;
}

char* func_259() // Position - 0x8A4D
{
	var gamerHandle;
	BOOL flag;
	BOOL flag2;
...
var func_261(BOOL bParam0, var uParam1, var uParam2) // Position - 0x9358
{
	if (bParam0)
		return uParam1;
...
void func_262(BOOL bParam0) // Position - 0x936F
{
...
int func_263() // Position - 0x93B1
{
	return Global_1051645.f_12;
}

void func_264(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x93BF
{
	if (bParam0)
	{
		func_341(1);
...
BOOL func_265(Player plParam0) // Position - 0x944D
{
	if (plParam0 == 255)
		return func_410();
...
const char* func_266(const char* sParam0, int iParam1) // Position - 0x946B
{
...
int func_267(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x94A9
{
	var unk;
	var unk14;
	int num;
...
BOOL func_268(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, BOOL bParam17) // Position - 0x950F
{
	return func_254(uParam0.f_11, bParam17);
}

BOOL func_269(int iParam0) // Position - 0x9521
{
	return func_254(Global_1572887.f_196.f_43, iParam0);
}

BOOL func_270() // Position - 0x9537
{
	return Global_1295658.f_2.f_1 == 2 || Global_1295658.f_2.f_1 == 1;
}

void func_271(int iParam0) // Position - 0x9559
{
	func_408(&(Global_1572887.f_196.f_44), iParam0);
	return;
}

BOOL func_272() // Position - 0x956F
{
	return Global_1900460.f_67;
}

BOOL func_273() // Position - 0x957D
{
	return Global_263042[Global_1295666 /*65*/] > 2;
}

int func_274() // Position - 0x9591
{
	return Global_1572887.f_196.f_2;
}

BOOL func_275(BOOL bParam0) // Position - 0x95A1
{
	var unk;
	int num;
	Player Plr;
	...
	if (bParam0)
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr))
		{
			...
			num = func_338(player);
			num.f_1 = func_416(player);
			num.f_2 = func_417(player);
			num.f_3 = { func_418(player) };
		}
	}
	else
	{
...
BOOL func_276(BOOL bParam0) // Position - 0x9742
{
	int num;
...
void func_278(BOOL bParam0) // Position - 0x979F
{
	int num;
	Any gangId;
...
void func_279() // Position - 0x9873
{
	Global_1572887.f_196.f_62 = 0;
	return;
}

void func_280() // Position - 0x9884
{
	Global_1072759.f_28644.f_109 = MISC::GET_GAME_TIMER();
	return;
}

void func_281() // Position - 0x9899
{
...
BOOL func_282() // Position - 0x98C8
{
	return Global_1072759.f_28644.f_66.f_42 != 0;
}

BOOL func_283() // Position - 0x98DD
{
...
void func_284(int iParam0) // Position - 0x9901
{
	func_415(&(Global_1572887.f_196.f_43), iParam0);
	return;
}

void func_285(BOOL bParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8) // Position - 0x9917
{
	if (bParam0)
	{
...
void func_286(BOOL bParam0, int iParam1) // Position - 0x99D6
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
BOOL func_287() // Position - 0x99F8
{
	return func_345(1, 255);
}

int func_288(int iParam0) // Position - 0x9A07
{
...
void func_289(int iParam0, int iParam1) // Position - 0x9A24
{
...
void func_292(BOOL bParam0) // Position - 0x9AB3
{
	if (func_426())
		Global_1958683 = true;
...
int func_293() // Position - 0x9B16
{
	return Global_1915656.f_20241;
}

void func_294(int iParam0, BOOL bParam1) // Position - 0x9B25
{
	if (!func_428(iParam0))
		return;
...
struct<17> func_296() // Position - 0x9BC5
{
	return Global_1572887.f_196.f_13;
}

void func_297(var uParam0) // Position - 0x9BD8
{
	Global_1572887.f_196.f_30 = { *uParam0 };
	return;
}

void func_298() // Position - 0x9BF0
{
	int i;
...
BOOL func_299() // Position - 0x9C50
{
	return func_432() != 0 || func_433(1);
}

int func_300(int iParam0) // Position - 0x9C69
{
	if (func_434())
		return 0;
...
BOOL func_301() // Position - 0x9CA3
{
	...
	if (!NETWORK::NETWORK_CAN_ACCESS_MULTIPLAYER(&nAccessCode))
		return false;

	return true;
}

void func_302() // Position - 0x9CD2
{
	func_67(64);
	func_68();
...
void func_306(int iParam0) // Position - 0x9DD3
{
	if (func_340(iParam0))
...
void func_307(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x9DF5
{
	func_441(iParam0);
...
BOOL func_308(int iParam0) // Position - 0x9E57
{
	return !func_234(iParam0);
}

void func_309(BOOL bParam0) // Position - 0x9E66
{
	if (!bParam0)
		func_348(18);
	else
...
BOOL func_310(int iParam0) // Position - 0x9E85
{
	if (func_447())
...
void func_311(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x9EA5
{
	BOOL flag;
...
BOOL func_312(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x9F65
{
...
BOOL func_314() // Position - 0x9FF1
{
	return Global_1072759.f_28756 >= 3;
}

void func_315() // Position - 0xA002
{
...
int func_316(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA04E
{
	Hash hash;
...
struct<4> func_320() // Position - 0xA1C0
{
	return Global_1572887.f_196.f_3;
}

struct<6> func_321() // Position - 0xA1D2
{
	return Global_1572887.f_196.f_7;
}

void func_322() // Position - 0xA1E4
{
	if (!func_334())
...
void func_323(Player plParam0) // Position - 0xA200
{
	Global_1572887.f_196.f_41 = plParam0;
	return;
}

BOOL func_324() // Position - 0xA212
{
	if (Global_1572887.f_14 == -1)
		return false;
...
int func_326() // Position - 0xA24A
{
	return Global_262155;
}

BOOL func_327() // Position - 0xA256
{
	return Global_1072759.f_28644.f_23.f_3 != 0;
}

void func_328(BOOL bParam0) // Position - 0xA26B
{
	if (!bParam0)
		func_348(19);
	else
...
int func_329() // Position - 0xA28A
{
	return Global_1572887.f_196.f_47;
}

BOOL func_330() // Position - 0xA29A
{
	return func_467(1024);
}

int func_331() // Position - 0xA2A9
{
	int num;
	BOOL flag;
	Player Plr;
	...
	{
		player = Plr;
		num.f_10 = func_468(player);
		num = func_338(player);
		num.f_1 = func_416(player);
		num.f_2 = func_417(player);
		num.f_3 = { func_418(player) };
		num.f_8 = func_469(player);
		num.f_9 = func_470(player);
	}
...
void func_332() // Position - 0xA457
{
	Global_1572887.f_196.f_62 = 1;
	return;
}

void func_333(int iParam0) // Position - 0xA468
{
	func_408(&(Global_1572887.f_72.f_15), iParam0);
	return;
}

BOOL func_334() // Position - 0xA47E
{
	int randomIntInRange;
	int num;
	Hash hash;
...
void func_335(BOOL bParam0) // Position - 0xA4CB
{
	if (!bParam0)
		func_348(25);
	else
...
void func_336(BOOL bParam0) // Position - 0xA4EA
{
	if (!bParam0)
		func_348(20);
	else
...
void func_337(Player plParam0, BOOL bParam1) // Position - 0xA509
{
	BOOL flag;
...
int func_338(Player plParam0) // Position - 0xA54C
{
	return Global_1056554[plParam0 /*491*/].f_204;
}

BOOL func_339() // Position - 0xA55F
{
	Ped playerPed;
	float entityCoords;
	Vector3 vector;
...
BOOL func_340(int iParam0) // Position - 0xA63C
{
	return func_484(Global_1072759.f_28644.f_23.f_1, iParam0);
}

void func_341(int iParam0) // Position - 0xA655
{
	func_485(&(Global_1072759.f_28644.f_23.f_1), iParam0);
	return;
}

BOOL func_342() // Position - 0xA66E
{
	if (func_329() != 2)
		return false;
...
int func_343(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA6F9
{
...
void func_344(BOOL bParam0, BOOL bParam1) // Position - 0xA788
{
	if (func_346(255) == 4)
		return;
...
BOOL func_345(int iParam0, Player plParam1) // Position - 0xA8D3
{
	int num;
...
int func_346(int iParam0) // Position - 0xA947
{
	if (iParam0 == 255)
...
void func_347(BOOL bParam0) // Position - 0xA992
{
	if (!bParam0)
		func_348(23);
	else
...
int func_348(int iParam0) // Position - 0xA9B1
{
...
void func_349(int iParam0, int iParam1, BOOL bParam2) // Position - 0xA9CE
{
...
void func_350(BOOL bParam0) // Position - 0xAA35
{
	var unk;
...
void func_352() // Position - 0xAAF9
{
	func_497(false);
	return;
}

BOOL func_353(var uParam0) // Position - 0xAB06
{
	return func_241(*uParam0, 1);
}

BOOL func_354(var uParam0) // Position - 0xAB16
{
	return func_241(*uParam0, 2);
}

int func_355(int iParam0) // Position - 0xAB26
{
	return NETWORK::GET_TIME_DIFFERENCE(iParam0, NETWORK::GET_NETWORK_TIME_ACCURATE());
}

int func_356(char* sParam0, int iParam1, int iParam2) // Position - 0xAB38
{
	Player Plr;
	...
	Plr = PLAYER::INT_TO_PLAYERINDEX(iParam1);
		...
		case 2:
			switch (num)
			{
				...
				case 2:
					...
					textureDownloadHandle = NETWORK::_LOCAL_PLAYER_PEDSHOT_TEXTURE_DOWNLOAD_REQUEST(iParam1, personaPhotoLocalCacheType);
					...
					func_501(iParam1, iParam2, textureDownloadHandle);
					break;
			
				case 3:
					textureDownloadHandle = func_502(iParam1, iParam2);
...
int func_357() // Position - 0xAD26
{
	return Global_1149432.f_5087.f_325;
}

void func_358(int iParam0) // Position - 0xAD38
{
	int num;
...
void func_359(var uParam0, BOOL bParam1) // Position - 0xAD5D
{
...
char* func_360(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0xAD7D
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

BOOL func_361(var uParam0, var uParam1) // Position - 0xAD91
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0);
}

void func_362(const char* sParam0, var uParam1, int iParam2, char* sParam3, BOOL bParam4) // Position - 0xAD9F
{
	char* str;
	BOOL flag;
	Hash hashKey;
...
void func_363(const char* sParam0, var uParam1, char* sParam2, BOOL bParam3) // Position - 0xB310
{
	int num;
	const char* str;
	Hash hashKey;
...
Hash func_364(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54) // Position - 0xB576
{
	int num;
	int cloudTimeAsInt;
	Hash hash;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0(int iParam0) // Position - 0xB8ED
{
	switch (iParam0)
	{
		case 0:
...
void func_366(const char* sParam0, Hash hParam1) // Position - 0xBDFB
{
	switch (sParam0->f_58)
	{
		case 8:
...
BOOL func_367(var uParam0) // Position - 0xBE43
{
	if (!*uParam0)
		return false;
...
void func_368(var uParam0, int iParam1) // Position - 0xBE73
{
	if (iParam1 < 0)
		return;
...
BOOL func_369(var uParam0) // Position - 0xBEA2
{
	if (!*uParam0)
		return false;
...
BOOL func_370(int iParam0) // Position - 0xBEDE
{
...
struct<2> func_371(Player plParam0) // Position - 0xBF4F
{
	var gamerHandle;
...
BOOL func_372(int* piParam0, int iParam1, int iParam2) // Position - 0xBF63
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_373(int iParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xBF96
{
...
void func_374(int iParam0, int iParam1) // Position - 0xBFE1
{
	int num;
	int num2;
	int num3;
...
void func_375(int iParam0, int iParam1) // Position - 0xC08B
{
...
void func_376(Any anParam0) // Position - 0xC0B0
{
	int i;
	var variableName;
...
void func_377(Any anParam0, Any anParam1) // Position - 0xC1F9
{
	int i;
	var variableName;
...
void func_378(Any anParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0xC53E
{
	int i;
	var variableName;
	var variableName2;
...
void func_379(Any anParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0xC659
{
	var variableName;
	var unk8;
...
void func_380(Any anParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0xC6C0
{
	int i;
	var variableName;
	var variableName2;
...
void func_381(Any anParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0xCA24
{
	var variableName;
	var unk8;
...
void func_382(Any anParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0xCA79
{
	var variableName;
	int i;
...
char* func_383(int iParam0) // Position - 0xCB1D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_384(int iParam0, Player plParam1) // Position - 0xCB9F
{
	if (plParam1 == 255)
...
int func_385() // Position - 0xCBCB
{
	return Global_1149172.f_137;
}

void func_386(var uParam0, float fParam1) // Position - 0xCBD9
{
...
BOOL func_387() // Position - 0xCBFF
{
	return Global_1572887.f_196 > 0;
}

void func_388(int iParam0) // Position - 0xCC0F
{
	int num;
	var gamerHandle;
...
void func_389(BOOL bParam0) // Position - 0xCC56
{
	if (bParam0)
		func_255(128);
...
BOOL func_390(int iParam0) // Position - 0xCC7B
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_391() // Position - 0xCC99
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

BOOL func_392(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, int iParam17) // Position - 0xCCAA
{
	int num;
...
int func_393(var uParam0, var uParam1) // Position - 0xCD39
{
...
int func_394(int iParam0) // Position - 0xCD59
{
	switch (iParam0)
	{
		case 0:
...
char* func_395(int iParam0) // Position - 0xCD8C
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0(Hash hParam0) // Position - 0xCE10
{
	switch (hParam0)
	{
		case -1759663922:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0(Hash hParam0) // Position - 0xCF0E
{
	switch (hParam0)
	{
		case -1918441640:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0(Hash hParam0) // Position - 0xD00C
{
	switch (hParam0)
	{
		case -1957416901:
...
void func_399(var uParam0) // Position - 0xD0AF
{
	func_532(uParam0);
...
void func_400(var uParam0) // Position - 0xD0C5
{
	Global_1572887.f_196.f_7 = { *uParam0 };
	return;
}

void func_401(int iParam0, int iParam1) // Position - 0xD0DB
{
	int i;
	int num;
	Hash hash;
...
void func_402(var uParam0) // Position - 0xD13C
{
	return;
}

void func_403(var uParam0) // Position - 0xD144
{
	func_532(uParam0);
	return;
}

void func_404(var uParam0) // Position - 0xD152
{
	Global_1572887.f_196.f_3 = { *uParam0 };
	return;
}

BOOL func_405(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD168
{
	return func_254(uParam0.f_3, bParam4);
}

int func_406() // Position - 0xD17A
{
	return Global_1572887.f_196;
}

void func_407(var uParam0) // Position - 0xD188
{
	return;
}

void func_408(BOOL bParam0, int iParam1) // Position - 0xD190
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

var func_409(BOOL bParam0, var uParam1, var uParam2) // Position - 0xD1A1
{
	if (bParam0)
		return uParam1;
...
char* func_411(const char* sParam0, int iParam1) // Position - 0xD222
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

struct<11> func_412() // Position - 0xD23C
{
	return Global_1572887.f_196.f_30;
}

Player func_413() // Position - 0xD24F
{
	return Global_1572887.f_196.f_41;
}

BOOL func_414(Player plParam0) // Position - 0xD25F
{
	return func_254(Global_1056554[plParam0 /*491*/].f_204.f_10, 4);
}

void func_415(BOOL bParam0, int iParam1) // Position - 0xD279
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

var func_416(Player plParam0) // Position - 0xD28E
{
	return Global_1056554[plParam0 /*491*/].f_204.f_1;
}

var func_417(Player plParam0) // Position - 0xD2A3
{
	return Global_1056554[plParam0 /*491*/].f_204.f_2;
}

struct<2> func_418(Player plParam0) // Position - 0xD2B8
{
	return Global_1056554[plParam0 /*491*/].f_204.f_3;
}

int func_419(int iParam0) // Position - 0xD2CF
{
	var unk;
	int num;
...
BOOL func_420(var uParam0) // Position - 0xD3FE
{
...
void func_421(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, Hash hParam6) // Position - 0xD458
{
...
int func_422() // Position - 0xD4B2
{
	return Global_1149172.f_143;
}

Vector3 func_423(int iParam0) // Position - 0xD4C0
{
	var unk;
...
BOOL func_427(Hash hParam0) // Position - 0xD549
{
	int i;
...
BOOL func_428(int iParam0) // Position - 0xD589
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_429(int iParam0, int iParam1) // Position - 0xD59F
{
	if (!func_428(iParam0))
		return false;
...
void func_430(int iParam0, int iParam1) // Position - 0xD5EA
{
	if (!func_428(iParam0))
		return;
...
void func_431(int iParam0, int iParam1) // Position - 0xD642
{
	if (!func_428(iParam0))
		return;
...
int func_432() // Position - 0xD6B5
{
	return Global_1300387.f_150;
}

BOOL func_433(int iParam0) // Position - 0xD6C3
{
	return Global_1300387.f_288.f_2 && iParam0 != false;
}

BOOL func_434() // Position - 0xD6D9
{
	return func_546() != 0;
}

BOOL func_435() // Position - 0xD6E7
{
	int threadId;
...
void func_436(int iParam0) // Position - 0xD70A
{
	Global_1300387.f_288 = iParam0;
	return;
}

void func_437(int iParam0) // Position - 0xD71B
{
	Global_1300387.f_288.f_1 = iParam0;
	return;
}

void func_438(int iParam0) // Position - 0xD72E
{
	int idOfThisThread;
...
void func_446(BOOL bParam0) // Position - 0xD889
{
	if (func_549(bParam0))
		return;
...
BOOL func_447() // Position - 0xD8B0
{
	return Global_1915656.f_20637 || Global_1915656.f_22504.f_1;
}

BOOL func_448(int iParam0) // Position - 0xD8CE
{
	return func_345(27, iParam0);
}

BOOL func_449(Hash hParam0) // Position - 0xD8DE
{
	return hParam0 >= 0 && hParam0 <= 150;
}

BOOL func_450(Hash hParam0) // Position - 0xD8F4
{
	if (!func_449(hParam0))
		return false;
...
void func_451(Hash hParam0, int iParam1) // Position - 0xD912
{
	if (!func_449(hParam0))
		return;
...
void func_452(BOOL bParam0) // Position - 0xD933
{
	Global_1893611 = Global_1893611 || bParam0;
	return;
}

BOOL func_453(Hash hParam0, BOOL bParam1) // Position - 0xD946
{
	if (Global_1572887.f_14 == -1)
...
void func_454(BOOL bParam0) // Position - 0xD977
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_455(BOOL bParam0) // Position - 0xD98F
{
	BOOL flag;
	Hash i;
...
BOOL func_456(int iParam0) // Position - 0xDAB4
{
	return Global_265213.f_122484.f_139 && iParam0 != false;
}

BOOL func_457() // Position - 0xDACC
{
	return func_551() > 11;
}

void func_458() // Position - 0xDADB
{
...
BOOL func_459(int iParam0, BOOL bParam1) // Position - 0xDB05
{
	BOOL flag;
...
void func_461(int iParam0) // Position - 0xDBE6
{
	Global_1572887.f_72.f_40 = iParam0;
	return;
}

int func_462(Hash hParam0) // Position - 0xDBF8
{
	int i;
	int j;
...
Hash func_463(int iParam0) // Position - 0xDC91
{
	switch (iParam0)
	{
		case 0:
...
void func_466(var uParam0, var uParam1, var uParam2) // Position - 0xDF47
{
	Hash hash;
	Volume volume;
	var volumeCoords;
...
BOOL func_467(BOOL bParam0) // Position - 0xE013
{
	return func_254(Global_1203952.f_3, bParam0);
}

BOOL func_468(Player plParam0) // Position - 0xE027
{
	return Global_1056554[plParam0 /*491*/].f_204.f_10;
}

var func_469(Player plParam0) // Position - 0xE03C
{
	return Global_1056554[plParam0 /*491*/].f_204.f_8;
}

BOOL func_470(Player plParam0) // Position - 0xE051
{
	return Global_1056554[plParam0 /*491*/].f_204.f_9;
}

BOOL func_471(var uParam0, var uParam1) // Position - 0xE066
{
	if (!func_555(uParam0))
		return false;
...
BOOL func_473(var uParam0, var uParam1) // Position - 0xE0AF
{
	int num;
	var unk;
	var unk2;
...
void func_474(int iParam0) // Position - 0xE10F
{
	Global_1572887.f_72.f_14 = iParam0;
	return;
}

int func_475(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0xE121
{
	Hash hash;
...
int func_476(int iParam0) // Position - 0xE1E9
{
	int randomIntInRange;
	int num;
...
Hash func_477(int iParam0) // Position - 0xE321
{
	int randomIntInRange;
	int num;
...
void func_478(Hash hParam0, BOOL bParam1) // Position - 0xE4C6
{
	var unk;
	float num;
...
BOOL func_479(Any anParam0) // Position - 0xE55B
{
	Player gangLeader;
	int num;
	var unk;
...
BOOL func_480(Player plParam0) // Position - 0xE5E7
{
	var unk;
	int num;
	int i;
...
BOOL func_482(Vector3* pvParam0, float* pfParam1) // Position - 0xE715
{
	Hash* p_hash;
	int MaxInt;
	int randomIntInRange;
	...
	else
	{
		...
		if (func_579(p_hash, randomIntInRange, pvParam0, pfParam1))
			return true;
	}
...
void func_483(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13) // Position - 0xE765
{
	if (func_346(255) == 4)
		return;
...
BOOL func_484(BOOL bParam0, BOOL bParam1) // Position - 0xE93A
{
	return bParam0 && bParam1 != false;
}

void func_485(BOOL bParam0, BOOL bParam1) // Position - 0xE949
{
	func_580(bParam0, bParam1);
	return;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xE959
{
...
void func_487(var uParam0) // Position - 0xE983
{
	var unk;
...
void func_488(float* pfParam0) // Position - 0xE995
{
	var unk;
...
void func_490(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0xE9FD
{
	switch (uParam0.f_5)
	{
		case 1:
...
int func_491() // Position - 0xEA2A
{
	return Global_1102813.f_3672;
}

BOOL func_492(int* piParam0, int iParam1, int iParam2) // Position - 0xEA39
{
	int num;
	int offset;
	BOOL isBitSet;
...
int func_493(int iParam0, BOOL bParam1) // Position - 0xEA6B
{
	BOOL flag;
	BOOL flag2;
	var gamerHandle2;
...
void func_494(int iParam0) // Position - 0xEB37
{
	func_415(&(Global_1203952.f_3), iParam0);
	return;
}

int func_495(Any* panParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xEB4B
{
	int num;
	int num2;
...
void func_496(Hash hParam0) // Position - 0xEB77
{
...
void func_497(BOOL bParam0) // Position - 0xEBB5
{
	if (bParam0)
...
int func_498(int iParam0, int iParam1) // Position - 0xEBEC
{
	if (iParam0 < 0 || iParam0 >= 32)
		return -1;
...
int func_499(int iParam0) // Position - 0xEC25
{
	switch (iParam0)
	{
		case 1:
...
void func_500(int iParam0, int iParam1, int iParam2) // Position - 0xEC4A
{
	Player Plr;
...
void func_501(int iParam0, int iParam1, int iParam2) // Position - 0xECA1
{
	Player Plr;
...
int func_502(int iParam0, int iParam1) // Position - 0xECED
{
	Player Plr;
...
void func_503(var uParam0) // Position - 0xED3A
{
	int num;
	int i;
	BOOL flag;
...
void func_504(var uParam0) // Position - 0xEF0D
{
	func_587(uParam0, 0);
	return;
}

char* func_505(Any anParam0, BOOL bParam1, int iParam2) // Position - 0xEF1C
{
	char* str;
	Player gangLeader;
	Player player;
...
char* func_506(int iParam0, var uParam1) // Position - 0xF0D6
{
	char* str;
...
char* func_507(Player plParam0) // Position - 0xF12C
{
	Player player;
...
char* func_508(const char* sParam0, int iParam1) // Position - 0xF173
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
...
struct<8> func_509(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29) // Position - 0xF1A9
{
	var unk;
	Hash hash;
...
const char* func_510(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xF26D
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_511() // Position - 0xF281
{
	int i;
	BOOL flag;
	Hash hash;
...
void func_513(int iParam0) // Position - 0xF3B7
{
...
BOOL func_514(var uParam0) // Position - 0xF3E8
{
	return true;
}

Hash func_515(var uParam0) // Position - 0xF3F1
{
...
int func_516() // Position - 0xF6D3
{
	return Global_1940252.f_245.f_1305;
}

void func_517() // Position - 0xF6E4
{
	var unk;
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0xF71A
{
	return uParam0->f_1;
}

int func_519(int iParam0) // Position - 0xF726
{
	return 60000;
}

BOOL func_520(int iParam0) // Position - 0xF732
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(func_463(iParam0));
}

int func_521(int iParam0) // Position - 0xF744
{
	int num;
	Hash hash;
	var unk;
...
Hash func_522(int iParam0) // Position - 0xF8F8
{
	int i;
...
struct<2> func_523() // Position - 0xF97B
{
	var unk;
...
int func_524(int iParam0, int iParam1, int iParam2, Hash hParam3, var uParam4, var uParam5, int iParam6, int iParam7, BOOL bParam8, int iParam9, int iParam10) // Position - 0xF994
{
	int num;
	var unk22;
	var unk30;
...
void func_525(Any anParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0xFC17
{
	int i;
	var variableName;
	var variableName2;
...
void func_526(var uParam0, int iParam1) // Position - 0xFD0B
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_527(var uParam0, int iParam1) // Position - 0xFD1C
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_528(var uParam0) // Position - 0xFD31
{
	Global_1572887.f_196.f_13 = { *uParam0 };
	return;
}

int func_529() // Position - 0xFD49
{
	int i;
	var unk;
...
int func_530(int iParam0, var uParam1) // Position - 0xFE1E
{
	return iParam0;
}

int func_531(var uParam0, var uParam1) // Position - 0xFE28
{
	var unk;
...
void func_532(var uParam0) // Position - 0xFE54
{
	return;
}

BOOL func_533() // Position - 0xFE5C
{
	return Global_1149172 == 3;
}

BOOL func_534(int iParam0) // Position - 0xFE6A
{
	return Global_1149172.f_1[iParam0 /*27*/].f_14 == 2;
}

struct<2> func_535() // Position - 0xFE80
{
...
BOOL func_536(int iParam0) // Position - 0xFECB
{
...
BOOL func_537(int iParam0) // Position - 0xFEEB
{
	if (!func_623(iParam0))
		return false;
...
BOOL func_538(int iParam0, int iParam1) // Position - 0xFF0F
{
	var unk;
...
BOOL func_539(int iParam0) // Position - 0xFF21
{
	return false;
}

BOOL func_540(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFF2A
{
	var data;
	int i;
	Hash crimeType;
...
int func_541(int iParam0, int iParam1) // Position - 0x10060
{
	int num;
...
BOOL func_542(int iParam0) // Position - 0x1007E
{
	if (iParam0 < 0)
		return false;
...
int func_543(int iParam0) // Position - 0x100AB
{
	switch (iParam0)
	{
		case 2:
...
struct<10> func_544(int iParam0) // Position - 0x100C6
{
	var unk;
...
void func_545(int iParam0) // Position - 0x100F3
{
	var unk;
...
int func_546() // Position - 0x10153
{
	return Global_1300387.f_288;
}

int func_547() // Position - 0x10162
{
	return Global_1300387.f_150.f_4;
}

void func_548(BOOL bParam0, int iParam1) // Position - 0x10172
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_549(BOOL bParam0) // Position - 0x10187
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

void func_550(Hash hParam0, BOOL bParam1) // Position - 0x1019D
{
	if (Global_1572887.f_14 == -1)
	{
...
int func_551() // Position - 0x101F0
{
	return Global_1572887.f_72.f_40;
}

BOOL func_552(BOOL bParam0) // Position - 0x10200
{
	return Global_1572887.f_72.f_15 && bParam0 != false;
}

Hash func_553(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x10215
{
	Hash hash;
	float num;
	Hash hash2;
...
void func_554(BOOL bParam0) // Position - 0x10290
{
	if (!bParam0)
		func_348(15);
	else
...
BOOL func_555(int iParam0) // Position - 0x102AF
{
	switch (iParam0)
	{
		case 2:
...
int func_556(int iParam0) // Position - 0x102EE
{
	switch (iParam0)
	{
		case 2:
...
Vector3 func_557(int iParam0, var uParam1) // Position - 0x10384
{
	switch (iParam0)
	{
		case 0:
...
void func_558(BOOL bParam0) // Position - 0x1043A
{
...
void func_559(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1045E
{
...
BOOL func_560(int iParam0, Hash hParam1) // Position - 0x1047A
{
	if (iParam0 == 0 || iParam0 == 3)
		return hParam1 != -1;
...
void func_561() // Position - 0x1049E
{
	if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(PLAYER::PLAYER_ID()))
...
void func_562(int iParam0, Hash hParam1, int iParam2, BOOL bParam3) // Position - 0x104F1
{
...
void func_563(var uParam0, var uParam1, BOOL bParam2) // Position - 0x1051E
{
...
void func_564(int iParam0) // Position - 0x1053D
{
	Global_1572887.f_72.f_13 = iParam0;
	return;
}

void func_565(int iParam0, BOOL bParam1) // Position - 0x1054F
{
...
void func_566() // Position - 0x1056A
{
...
void func_567() // Position - 0x10590
{
	Hash hash;
	int num;
	Hash hash2;
...
int func_568(var uParam0, var uParam1) // Position - 0x10663
{
	int num;
...
int func_569(var uParam0, var uParam1) // Position - 0x1068D
{
	if (func_638())
		return 0;
...
BOOL func_570(Hash hParam0, var uParam1) // Position - 0x106BB
{
	var ReturnZ;
	float volumeScale;
	float num;
...
void func_571(var uParam0, var uParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x107C0
{
	if (func_346(255) == 4)
		return;
...
void func_572(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0x108F8
{
	var entityCoords;
	float num;
...
BOOL func_573(int iParam0) // Position - 0x10953
{
	int i;
...
void func_574(int iParam0) // Position - 0x10987
{
...
int func_575(int iParam0, int iParam1) // Position - 0x109A6
{
...
void func_576(int iParam0) // Position - 0x10AB8
{
	Global_1203952.f_1 = iParam0;
	return;
}

void func_577(int iParam0) // Position - 0x10AC8
{
	func_408(&(Global_1203952.f_3), iParam0);
	return;
}

int func_578(Hash* phParam0) // Position - 0x10ADC
{
	Any any;
...
BOOL func_579(Hash* phParam0, int iParam1, Vector3* pvParam2, float* pfParam3) // Position - 0x10B08
{
	Any any;
...
void func_580(BOOL bParam0, int iParam1) // Position - 0x10B6A
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

struct<2> func_581() // Position - 0x10B7B
{
	var gamerHandle;
...
void func_582(BOOL bParam0, BOOL bParam1) // Position - 0x10B8D
{
	var unk;
...
void func_583() // Position - 0x10C08
{
	var unk;
	int num;
...
void func_584(Hash hParam0) // Position - 0x10C65
{
	int feedMessage;
...
void func_585(int iParam0, var uParam1, var uParam2) // Position - 0x10C8E
{
...
void func_586(Any* panParam0, var uParam1) // Position - 0x10CFC
{
...
void func_587(var uParam0, int iParam1) // Position - 0x10D33
{
...
char* func_588(Any anParam0, BOOL bParam1, int iParam2) // Position - 0x10D6F
{
	const char* str;
...
const char* func_589(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x10E32
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

BOOL func_590(const char* sParam0) // Position - 0x10E46
{
	return NETWORK::_0xD4022C7286B0DFA2(sParam0, 100, 22);
}

BOOL func_591(Player plParam0, char* sParam1) // Position - 0x10E57
{
...
char* func_592(Player plParam0) // Position - 0x10E83
{
	const char* str;
...
struct<8> func_593(int iParam0) // Position - 0x10F56
{
	var unk;
...
struct<8> func_594(Player plParam0) // Position - 0x10F85
{
	if (plParam0 == 255)
		plParam0 = Global_1295666.f_5;
...
int func_598(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12, BOOL bParam13, BOOL bParam14, var uParam15, var uParam16) // Position - 0x1120E
{
	var unk;
	var unk14;
	int num;
...
int func_599(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, int iParam15, int iParam16, int iParam17, var uParam18, var uParam19) // Position - 0x1129B
{
	var unk;
	var unk14;
	int num;
...
int func_600(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, BOOL bParam12, BOOL bParam13) // Position - 0x1133A
{
	var unk;
	var unk14;
	int num;
...
int func_601(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14, int iParam15, int iParam16) // Position - 0x113B6
{
	var unk;
	var unk14;
	int num;
...
int func_602(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12, BOOL bParam13, BOOL bParam14) // Position - 0x11444
{
	var unk;
	var unk14;
	int num;
...
int func_603(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12, int iParam13, int iParam14) // Position - 0x114C6
{
	var unk;
	var unk14;
	int num;
...
int func_604() // Position - 0x11543
{
	return Global_1072759.f_23.f_2;
}

int func_605() // Position - 0x11553
{
	return Global_1102813.f_3673;
}

Hash func_606(int iParam0) // Position - 0x11562
{
	int i;
...
BOOL func_607() // Position - 0x115DF
{
	return Global_1572887.f_72.f_40 != 1;
}

BOOL func_608(Player plParam0) // Position - 0x115F1
{
	Any gangId;
...
void func_609(Any* panParam0) // Position - 0x1161B
{
	MISC::COPY_SCRIPT_STRUCT(&(Global_1572887.f_72.f_17), panParam0, 22);
	return;
}

void func_610(int iParam0) // Position - 0x11633
{
	Global_1572887.f_72.f_15 = iParam0;
	return;
}

void func_611() // Position - 0x11645
{
	Ped PedIndex;
	var entityCoords;
...
BOOL func_612() // Position - 0x11679
{
	if (func_618() != 0)
		return false;
...
void func_613() // Position - 0x116AF
{
	Global_1056554[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*491*/].f_15.f_12 = 0;
	return;
}

void func_614(var uParam0, var uParam1) // Position - 0x116C7
{
	int num;
	int num2;
	int num3;
...
int func_615(int iParam0, BOOL bParam1) // Position - 0x1176F
{
	if (bParam1)
		func_655();
...
int func_616(var uParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x117AB
{
	Hash hash;
	int num;
	int num2;
...
char* func_617(Hash hParam0) // Position - 0x11A71
{
	Hash hash;
...
int func_618() // Position - 0x11BC7
{
	return Global_1572887.f_72;
}

char* func_619(int iParam0, Hash hParam1) // Position - 0x11BD5
{
	switch (iParam0)
	{
		case 0:
...
int func_620(char* sParam0) // Position - 0x11CB0
{
	const char* str;
	int num;
...
BOOL func_621(int iParam0, var uParam1, Any* panParam2) // Position - 0x11CD2
{
	if (!func_471(iParam0))
		return false;
...
struct<2> func_622(int iParam0) // Position - 0x11DDD
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_623(int iParam0) // Position - 0x11DF1
{
	return Global_1149172.f_1[iParam0 /*27*/].f_1 == 2;
}

BOOL func_624(int iParam0, int iParam1, Any anParam2) // Position - 0x11E07
{
	int i;
	int num;
...
BOOL func_625(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x11E7F
{
...
int* func_626(int iParam0, int iParam1) // Position - 0x11F1D
{
	return Global_1149172.f_1[iParam0 /*27*/].f_15[iParam1 /*3*/].f_1;
}

BOOL func_627(int iParam0) // Position - 0x11F37
{
	if (iParam0 < 0)
		return false;
...
int func_629(int iParam0) // Position - 0x11F75
{
	switch (iParam0)
	{
		case 0:
...
int func_630(int iParam0, var uParam1) // Position - 0x11FBD
{
	*uParam1 = iParam0;
...
Vector3 func_631(int iParam0) // Position - 0x123C5
{
	return Global_1149172.f_1[iParam0 /*27*/].f_7;
}

BOOL func_632(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x123DB
{
	if (_IS_NULL_VECTOR(uParam0))
		return false;
...
void func_633() // Position - 0x12462
{
	int num;
...
void func_636() // Position - 0x124ED
{
	Player player;
...
void func_637(Hash hParam0) // Position - 0x12505
{
	Global_1940252.f_11605 = hParam0;
	return;
}

BOOL func_638() // Position - 0x12516
{
	return func_471(Global_1051268);
}

BOOL func_639(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0x12528
{
	Hash* p_hash;
	int MaxInt;
	int randomIntInRange;

	p_hash = Global_1072759.f_23824.f_383[func_684(uParam0) /*272*/];
	MaxInt = func_578(p_hash);
	...
	else
	{
		...
		if (func_579(p_hash, randomIntInRange, pvParam3, pfParam4))
			return true;
	}
...
BOOL func_640(int iParam0, BOOL bParam1) // Position - 0x12579
{
	return func_254(Global_1203952.f_5[iParam0], bParam1);
}

void func_641(int iParam0) // Position - 0x12591
{
	Global_1203952.f_5[iParam0] = false;
	return;
}

void func_642(int iParam0, int iParam1) // Position - 0x125A4
{
	func_408(&Global_1203952.f_5[iParam0], iParam1);
	return;
}

void func_643(int iParam0) // Position - 0x125BC
{
	Global_17418.f_55.f_14.f_4 = iParam0;
	return;
}

void func_644(Any* panParam0) // Position - 0x125CF
{
	var playerBits;
...
void func_645(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x12602
{
	if (func_686(true))
		return;
...
Vector3 func_646(int iParam0) // Position - 0x12637
{
	if (iParam0 == 255)
...
int func_647(Player plParam0) // Position - 0x12663
{
	Player player;
...
BOOL func_648(var uParam0) // Position - 0x12693
{
...
int func_649(var uParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x126C1
{
	int num;
...
BOOL func_650(int iParam0) // Position - 0x12726
{
	return iParam0 != 0;
}

int func_651(var uParam0, var uParam1) // Position - 0x12732
{
	int i;
...
int func_652(int iParam0) // Position - 0x1276B
{
	return Global_1206497.f_78[iParam0 /*20*/].f_3;
}

int func_653(int iParam0) // Position - 0x1277F
{
	return Global_1205938.f_1[iParam0 /*26*/].f_3;
}

struct<8> func_654(int iParam0, int iParam1) // Position - 0x12793
{
	var unk;
	var unk9;
...
void func_655() // Position - 0x127DF
{
...
BOOL func_656(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x127F6
{
	BOOL flag;
...
void func_657(int iParam0) // Position - 0x1281E
{
	Global_1896762.f_365 = iParam0;
	return;
}

void func_658(var uParam0, int iParam1) // Position - 0x1282F
{
	uParam0->f_15 = uParam0->f_15 || iParam1;
	return;
}

void func_659(char* sParam0) // Position - 0x12842
{
	TEXT_LABEL_ASSIGN_STRING(&(Global_1572887.f_72.f_60.f_6), sParam0, 32);
	return;
}

BOOL func_660(int iParam0) // Position - 0x12858
{
...
BOOL func_661(int iParam0) // Position - 0x12870
{
...
int func_662(Hash hParam0) // Position - 0x12888
{
	int i;
...
Vector3 func_663(int iParam0) // Position - 0x128C1
{
	int num;
	int num2;
	int i;
...
struct<2> func_664(int iParam0) // Position - 0x129A6
{
	if (iParam0 < 0 || iParam0 >= 100)
		return func_523();
...
BOOL func_665(int iParam0) // Position - 0x129D3
{
	if (iParam0 == 0)
		return false;
...
int func_666(int iParam0) // Position - 0x129ED
{
	int i;
	int num;
...
struct<2> func_667(int iParam0) // Position - 0x12A1F
{
	return func_710(iParam0);
}

struct<2> func_668(var uParam0) // Position - 0x12A2D
{
	var unk;
	var unk6;
...
struct<2> func_669(int iParam0) // Position - 0x12AC7
{
	var unk;
...
struct<2> func_670(int iParam0) // Position - 0x12B97
{
	var unk;
	var unk6;
...
int func_671(int iParam0) // Position - 0x12BE9
{
	switch (iParam0)
	{
		case -933924539:
...
void func_672(var uParam0) // Position - 0x12C24
{
	uParam0->f_15 = 0;
	return;
}

Hash func_673(Hash hParam0) // Position - 0x12C31
{
	int i;
...
int func_674(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x12C75
{
	int num;
	var unk13;
	int num2;
...
void func_675(Any* panParam0) // Position - 0x12CB0
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
BOOL func_676(int iParam0, int iParam1) // Position - 0x12CC6
{
	switch (iParam1)
	{
		case 0:
...
void func_677(var uParam0) // Position - 0x12D15
{
	var unk;
...
void func_678(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x12D27
{
	switch (uParam0.f_5)
	{
		case 1:
...
int func_680(int iParam0, int iParam1, int iParam2) // Position - 0x12D78
{
	return func_715(iParam0, iParam1, iParam2);
}

int func_681() // Position - 0x12D8A
{
	int cashBalance;
...
int func_682(int iParam0, char* sParam1, int iParam2, BOOL bParam3) // Position - 0x12DB8
{
	int num;
	var unk;
	var unk6;
...
void func_683() // Position - 0x12E31
{
	int i;
...
int func_684(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x12E64
{
	int i;
	int num;
	float num2;
...
int func_690(int iParam0) // Position - 0x12F50
{
	switch (iParam0)
	{
...
BOOL func_691(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x12F75
{
	if (func_724())
		return false;
...
void func_692(int iParam0) // Position - 0x12FD5
{
	Global_1142424.f_2027.f_5 = iParam0;
	return;
}

BOOL func_693(int iParam0, var uParam1, var uParam2, int iParam3) // Position - 0x12FE8
{
	if (iParam0 < 4)
		iParam0 = 4;
...
void func_694(int iParam0) // Position - 0x130B5
{
	int num;
...
BOOL func_695(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x131B5
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

BOOL func_696(Any* panParam0, int iParam1) // Position - 0x131D0
{
...
BOOL func_697(Any* panParam0) // Position - 0x13212
{
	panParam0->f_2 = -310067910;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam0->f_1), panParam0);
}

BOOL func_698(Any* panParam0, int iParam1) // Position - 0x1322D
{
...
BOOL func_699(Any* panParam0) // Position - 0x1324E
{
	panParam0->f_2 = 1701407264;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam0->f_1), panParam0);
}

int func_700(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, char* sParam6, BOOL bParam7) // Position - 0x13269
{
	uParam0.f_2 = iParam5;
...
BOOL func_701() // Position - 0x1328F
{
	return Global_1915656.f_20643;
}

BOOL func_702(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x1329E
{
	Player PlayerIndex;
	Ped EntityIndex;
	BOOL isEntityDead;
...
int func_703(int iParam0, int iParam1) // Position - 0x134C4
{
	switch (iParam0)
	{
		case -1957416901:
...
int func_704(int iParam0, int iParam1) // Position - 0x13556
{
	switch (iParam0)
	{
		case -1918441640:
...
Hash func_705(int iParam0) // Position - 0x13640
{
	if (!func_741(iParam0))
		return 0;
...
BOOL func_706(Any* panParam0) // Position - 0x1366C
{
	int fileHandle;
	var SourceStruct;
...
BOOL func_707(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x136AE
{
	var unk;
...
int func_708(Any anParam0, int iParam1) // Position - 0x136E7
{
	anParam0->f_2 = iParam1;
	return DATAFILE::_PARSEDDATA_RQ_GET_NUM_NODES(anParam0);
}

int func_709(int iParam0) // Position - 0x136FB
{
	return Global_1295849[iParam0 /*37*/].f_9;
}

struct<2> func_710(int iParam0) // Position - 0x1370D
{
	var DestStruct;
...
var func_711(Any* panParam0) // Position - 0x13737
{
	return func_742(panParam0, 67, 1);
}

struct<2> func_712(var uParam0, int iParam1) // Position - 0x13748
{
	int num;
...
BOOL func_713(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1386E
{
...
void func_714(int iParam0, Any* panParam1, var uParam2) // Position - 0x1389F
{
	int num;
...
int func_715(int iParam0, int iParam1, int iParam2) // Position - 0x13AFA
{
	int num;
	int i;
	int num2;
...
int func_716(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x13BD2
{
	var unk;
	int num;
	int i;
...
struct<5> func_717(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x13CC2
{
	var unk;
	int num;
	var unk6;
...
struct<17> func_718(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, int iParam6, BOOL bParam7) // Position - 0x14037
{
	var unk;
...
int func_719(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x140B1
{
	int num;
...
void func_720(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x1411B
{
	int i;
...
BOOL func_721(int iParam0) // Position - 0x14199
{
	return iParam0 > -1 && iParam0 < 6;
}

void func_722(int iParam0) // Position - 0x141AE
{
	Hash i;
	int j;
...
var func_723(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x14240
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_782(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
BOOL func_724() // Position - 0x145D3
{
	BOOL flag;
...
BOOL func_725(var uParam0, var uParam1) // Position - 0x14635
{
	Any gangId;
	var unk;
...
BOOL func_726(int iParam0, int iParam1) // Position - 0x14666
{
	Any gangId;
...
BOOL func_727() // Position - 0x14726
{
	return Global_1142424.f_2027.f_7 == 3;
}

Hash func_728(int iParam0) // Position - 0x14739
{
	switch (iParam0)
	{
		case 4:
...
BOOL func_729(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x14766
{
	int num;
	BOOL flag;
...
void func_734() // Position - 0x14849
{
	Player player;
	var unk;
...
BOOL func_735(BOOL bParam0) // Position - 0x148BF
{
	return func_484(Global_1147183.f_8, bParam0);
}

void func_736(int iParam0) // Position - 0x148D3
{
	Global_1142424.f_2019 = iParam0;
	return;
}

struct<2> func_737(int iParam0, int iParam1) // Position - 0x148E4
{
	int num;
...
void func_738(var uParam0, var uParam1, int iParam2) // Position - 0x148FA
{
...
int func_739(int iParam0) // Position - 0x14917
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_740() // Position - 0x14A32
{
	return ANIMSCENE::DOES_ANIM_SCENE_EXIST(Global_26573) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(Global_26573, false);
}

BOOL func_741(int iParam0) // Position - 0x14A4E
{
	return iParam0 > -1 && iParam0 <= 80;
}

var func_742(Any* panParam0, int iParam1, int iParam2) // Position - 0x14A64
{
	var unk;
...
int func_743(var uParam0, Any* panParam1, int iParam2) // Position - 0x14A7F
{
	int num;
	int num2;
	int num3;
...
int func_744(int iParam0) // Position - 0x14AD4
{
	int num;
...
int func_745(int iParam0, var uParam1) // Position - 0x14C49
{
	var unk;
...
int func_746(int iParam0) // Position - 0x14C66
{
	switch (iParam0)
	{
		case joaat("IWD_INF"):
...
int func_747(int iParam0) // Position - 0x14DBC
{
	switch (iParam0)
	{
...
int func_748(int iParam0) // Position - 0x14E13
{
	switch (iParam0)
	{
...
int func_749(int iParam0) // Position - 0x14EED
{
	switch (iParam0)
	{
		case -1641798436:
...
int func_750(int iParam0) // Position - 0x14F85
{
	switch (iParam0)
	{
		case -1968391995:
...
BOOL func_751(Hash hParam0, Hash hParam1) // Position - 0x1512F
{
...
BOOL func_752(Hash hParam0) // Position - 0x1517B
{
...
BOOL func_753(Hash hParam0, Hash hParam1) // Position - 0x15196
{
	if (!func_791(hParam0, 0))
...
int func_754(Hash hParam0, BOOL bParam1) // Position - 0x151D7
{
	var unk;
...
int func_755(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1522F
{
	var unk;
	int num;
	int i;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_756(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x152C3
{
	int i;
...
struct<4> func_757(BOOL bParam0) // Position - 0x15353
{
	int num;
...
int func_758(Hash hParam0) // Position - 0x153F3
{
	var unk;
...
struct<4> func_759(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x1541E
{
	var outGuid;
...
struct<4> func_760(BOOL bParam0) // Position - 0x1544F
{
	int num;
...
int func_761(Hash hParam0, BOOL bParam1) // Position - 0x154F0
{
...
BOOL func_762(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x15527
{
	return func_800(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_763(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x15542
{
	var unk;
...
struct<4> func_764(BOOL bParam0) // Position - 0x15563
{
	int num;
...
int func_765(Hash hParam0) // Position - 0x155CD
{
	var unk;
...
BOOL func_766(Hash hParam0, int iParam1) // Position - 0x155F8
{
	Hash hash;
	int num;
	int i;
...
BOOL func_767(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x15665
{
	return func_803(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_768(Hash hParam0, int iParam1) // Position - 0x1567B
{
	if (iParam1 == 0)
		return 0;
...
BOOL func_769(Hash hParam0, Any* panParam1) // Position - 0x156A7
{
	BOOL flag;
...
BOOL func_770(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x1587D
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_771(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x15894
{
	if (bParam0)
	{
...
int func_772(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x158DD
{
	if (bParam0)
	{
		func_806(iParam1, 1, 0, 0);
...
void func_773(int iParam0, BOOL bParam1) // Position - 0x158F9
{
	int i;
...
int func_774(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x15966
{
	int num;
...
int func_775(int iParam0) // Position - 0x15C33
{
	switch (iParam0)
	{
...
void func_776(Hash hParam0, BOOL bParam1) // Position - 0x15D95
{
	BOOL flag;
...
void func_777(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x15DF9
{
	Volume volume;
	BOOL flag;
	int num;
...
BOOL func_778(int iParam0) // Position - 0x15EE3
{
	return iParam0 > -1 && iParam0 < 17;
}

int func_779(int iParam0) // Position - 0x15EF9
{
	switch (iParam0)
	{
		case 0:
...
void func_780(int iParam0, BOOL bParam1) // Position - 0x15FB4
{
	if (!func_778(iParam0))
		return;
...
char* func_781() // Position - 0x15FF3
{
	return "unnamed";
}

BOOL func_782(int iParam0) // Position - 0x15FFF
{
	int num;
...
BOOL func_783(Player plParam0) // Position - 0x1608E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
int func_784(Any anParam0) // Position - 0x160D3
{
	if (!GANG::NETWORK_IS_GANG_ID_VALID(anParam0))
		return -1;
...
Vector3 func_785(int iParam0) // Position - 0x1610B
{
	var unk;
...
BOOL func_786() // Position - 0x16130
{
	return !func_688(2);
}

BOOL func_787(BOOL bParam0) // Position - 0x1613E
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_788() // Position - 0x1615F
{
	int num;
...
int func_789(Hash hParam0, BOOL bParam1, Hash hParam2) // Position - 0x161A1
{
	if (!func_791(hParam0, 0))
		return 0;
...
BOOL func_790(int iParam0, var uParam1, var uParam2) // Position - 0x161C5
{
	var unk;
...
BOOL func_791(Hash hParam0, int iParam1) // Position - 0x161EC
{
	if (hParam0 == 0)
		return false;
...
BOOL func_792(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x16206
{
	if (!func_836(iParam0))
		return false;
...
Hash func_793(Hash hParam0) // Position - 0x1623E
{
	return hParam0;
}

BOOL func_794(Hash hParam0, Hash hParam1) // Position - 0x16248
{
...
int func_795(Hash hParam0, BOOL bParam1) // Position - 0x1627E
{
	int num;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_796(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x162B7
{
	int i;
...
void func_797(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x16346
{
	int i;
	int j;
	int k;
...
int func_798(BOOL bParam0) // Position - 0x1651C
{
	if (func_11() == -1)
	{
...
int func_800(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x1657A
{
...
BOOL func_801(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x165F9
{
	int inventoryId;
...
BOOL func_802(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1663E
{
...
BOOL func_803(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x16671
{
...
BOOL func_804(Hash hParam0, int iParam1) // Position - 0x166AB
{
	if (hParam0 == 0)
		return false;
...
BOOL func_805(var uParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x166C5
{
...
void func_806(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x166DD
{
	int i;
...
BOOL func_807(int iParam0, int iParam1) // Position - 0x1677B
{
	if (!func_721(iParam0))
		return false;
...
void func_808(int iParam0, int iParam1) // Position - 0x167C0
{
	if (!func_721(iParam0))
		return;
...
void func_809(int iParam0, int iParam1) // Position - 0x16824
{
	if (!func_721(iParam0))
		return;
...
void func_810(int iParam0, BOOL bParam1) // Position - 0x16896
{
	if (!func_721(iParam0))
		return;
...
BOOL func_811(Hash hParam0) // Position - 0x168C7
{
	if (!func_449(hParam0))
		return false;
...
Hash func_812() // Position - 0x168E8
{
	return Global_1939102.f_26;
}

BOOL func_813(int iParam0) // Position - 0x168F6
{
	if (!func_844(iParam0))
		return false;
...
int func_814(Hash hParam0) // Position - 0x16912
{
	if (hParam0 < 0)
		return -1;
	else if (hParam0 <= 10)
...
int func_815(int iParam0, BOOL bParam1) // Position - 0x16A0E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_816() // Position - 0x16B88
{
	return Global_1902569;
}

void func_817(Hash hParam0, BOOL bParam1) // Position - 0x16B94
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_818(Hash hParam0, BOOL bParam1) // Position - 0x16BC3
{
	if (Global_1572887.f_14 == -1)
...
void func_819(Hash hParam0) // Position - 0x16C02
{
	if (!func_449(hParam0))
		return;
...
BOOL func_820(Hash hParam0) // Position - 0x16C2F
{
	if (!func_449(hParam0))
		return false;
...
Volume func_821(Hash hParam0) // Position - 0x16C50
{
	if (!func_449(hParam0))
		return 0;
...
int func_822(Hash hParam0) // Position - 0x16C70
{
	int num;
	int num2;
	int num3;
...
void func_823(Hash hParam0, BOOL bParam1) // Position - 0x16CB6
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_824(Hash hParam0, int iParam1) // Position - 0x16CE5
{
	if (!func_449(hParam0))
		return;
...
void func_825(Hash hParam0) // Position - 0x16D0E
{
	if (!func_449(hParam0))
		return;
...
void func_826(int iParam0, BOOL bParam1) // Position - 0x16D50
{
	if (!func_778(iParam0))
		return;
...
BOOL func_827(int iParam0) // Position - 0x16DAE
{
	if (!func_778(iParam0))
		return false;
...
void func_828(int iParam0, BOOL bParam1) // Position - 0x16DCB
{
	if (!func_778(iParam0))
		return;
...
void func_829(int iParam0, BOOL bParam1) // Position - 0x16E34
{
	Hash hash;
...
BOOL func_830(Player plParam0) // Position - 0x16E6F
{
...
void func_831(Player plParam0) // Position - 0x16E8C
{
	Player player;
...
int func_832(Player plParam0) // Position - 0x16F0F
{
	int i;
...
BOOL func_833(int iParam0) // Position - 0x16F72
{
	if (iParam0 < 0 || iParam0 >= 32)
		return false;
...
BOOL func_834(int iParam0, var uParam1, Any* panParam2) // Position - 0x16F91
{
...
void func_835(Any* panParam0, int iParam1, var uParam2) // Position - 0x16FC5
{
	var unk;
...
BOOL func_836(int iParam0) // Position - 0x1703F
{
	if (iParam0 == 0)
		return false;
...
BOOL func_837(int iParam0, Hash hParam1) // Position - 0x17057
{
	var unk;
	int num;
	Hash unlockHash;
...
void func_838(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x171A0
{
	int i;
	int j;
	int k;
...
int func_839(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x17376
{
...
void func_840(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x173A9
{
	int i;
...
Hash func_841(int iParam0) // Position - 0x17485
{
	switch (iParam0)
	{
		case 0:
...
void func_842(Hash hParam0) // Position - 0x174EA
{
	Hash styleHash;
...
void func_843(Hash hParam0) // Position - 0x175A8
{
	if (func_209(hParam0) == 62)
	{
...
BOOL func_844(int iParam0) // Position - 0x175FE
{
	if (iParam0 == 0)
		return false;
...
BOOL func_845(int iParam0) // Position - 0x17611
{
	int num;
	int num2;
	int offset;
...
BOOL func_846(Hash hParam0) // Position - 0x1763B
{
	if (!func_449(hParam0))
		return false;
...
void func_847(Hash hParam0) // Position - 0x1765C
{
	var unk;
	...
	InputString = func_510(unk);
	MAP::_MAP_ENABLE_REGION_BLIP(MISC::GET_HASH_KEY(InputString), -1482012664);
	return;
}

void func_848(Hash hParam0) // Position - 0x17690
{
	var unk;
	const char* InputString;
	Hash hashKey;
...
int func_849(Hash hParam0) // Position - 0x176E2
{
	if (!func_449(hParam0))
		return 0;
...
BOOL func_850(Hash hParam0) // Position - 0x17711
{
	if (!func_449(hParam0))
		return -15;
...
int func_851(BOOL bParam0) // Position - 0x1774C
{
	int value;
	int value2;
	int value3;
...
BOOL func_852(Hash hParam0) // Position - 0x177E5
{
	if (!func_449(hParam0))
		return 0;
...
Hash func_853(Hash hParam0, BOOL bParam1) // Position - 0x17853
{
	switch (hParam0)
	{
		case 0:
...
BOOL func_854(int iParam0, BOOL bParam1) // Position - 0x18019
{
	if (!func_778(iParam0))
		return false;
...
Hash func_855(int iParam0) // Position - 0x1805B
{
	switch (iParam0)
	{
		case 0:
...
void func_856(Player plParam0) // Position - 0x1815E
{
	Player player;
...
void func_857(Player plParam0) // Position - 0x181CA
{
...
BOOL func_858(Hash hParam0) // Position - 0x18205
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

void func_859(int iParam0) // Position - 0x18213
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
BOOL func_860(BOOL bParam0) // Position - 0x18236
{
	int num;
	int num2;
	int num3;
...
void func_861(BOOL bParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x18312
{
	func_870(func_816(), bParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_862(var uParam0) // Position - 0x18330
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_863(BOOL bParam0) // Position - 0x1838A
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 0) & 63;
}

int func_864(BOOL bParam0) // Position - 0x1839C
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 6) & 63;
}

int func_865(BOOL bParam0) // Position - 0x183AE
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 12) & 31;
}

int func_866(BOOL bParam0) // Position - 0x183C1
{
	return (BUILTIN::SHIFT_RIGHT(bParam0, 26) & 31 * MISC::IS_BIT_SET(bParam0, 31) ? -1 : 1) + 1898;
}

int func_867(BOOL bParam0) // Position - 0x183E6
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 22) & 15;
}

int func_868(BOOL bParam0) // Position - 0x183F9
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 17) & 31;
}

int func_869(int iParam0, int iParam1) // Position - 0x1840C
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_870(BOOL bParam0, BOOL bParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x184A6
{
	int num;
	int num2;
	int num3;
...
BOOL func_871(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x186A8
{
	if (bParam2)
...
float func_872(float fParam0, float fParam1, float fParam2) // Position - 0x186D5
{
	float num;
