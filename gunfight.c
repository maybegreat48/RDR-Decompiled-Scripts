...
BOOL func_17(int iParam0) // Position - 0x806
{
	if (bLocal_15)
		return true;
...
void _DEBUG_PRINT_0(int iParam0) // Position - 0x828
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x834
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x849
{
	return func_54(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x85A
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x899
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x8A5
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x8AD
{
	if (func_55(iParam0))
		return true;
...
void func_25() // Position - 0x95D
{
	return;
}

void func_26() // Position - 0x965
{
	return;
}

void func_27() // Position - 0x96D
{
	return;
}

void func_28() // Position - 0x975
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x97D
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x989
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x995
{
	return;
}

void func_32() // Position - 0x99D
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x9A5
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0x9B1
{
...
void func_35(var uParam0) // Position - 0x9E2
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA28
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xA3C
{
	if (!func_59(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xA55
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xA66
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xA7E
{
	iParam0 = iParam0;
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xA8B
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xBCA
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xBD7
{
...
BOOL func_44(int iParam0) // Position - 0xC0D
{
	if (iParam0 == 0)
	{
		func_73();
...
int func_45() // Position - 0xD21
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xD2F
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xD3B
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xDA8
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xE88
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xEA6
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xEB9
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(BOOL bParam0) // Position - 0xED7
{
	int num;
	var unk;
	var unk6;
...
BOOL func_54(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF91
{
	int num;
	int num2;
	int num3;
...
BOOL func_55(int iParam0) // Position - 0x1089
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_56(int iParam0) // Position - 0x109A
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_57(int iParam0) // Position - 0x10AE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_58(var uParam0, var uParam1) // Position - 0x10C2
{
	return uParam0;
}

BOOL func_59(int iParam0) // Position - 0x10CC
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_60() // Position - 0x10E2
{
	int i;
...
BOOL func_61(int iParam0, int iParam1) // Position - 0x110F
{
	return iParam0 && iParam1 != false;
}

BOOL func_62(var uParam0, int iParam1) // Position - 0x111E
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_63() // Position - 0x112F
{
	return func_61(Global_1940199, 8192);
}

BOOL func_64(var uParam0, int iParam1) // Position - 0x1142
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_65(int iParam0) // Position - 0x1153
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_66(int iParam0, int iParam1) // Position - 0x1193
{
...
int func_67() // Position - 0x11C0
{
	return Global_1896646.f_41;
}

void func_68(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x11CE
{
	BOOL flag;
	...
	StringToTest = func_93(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_105(&unk, joaat("COLOR_PURE_WHITE")), str3, func_105(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_105(&unk, joaat("COLOR_PURE_WHITE")), func_105(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_106(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_69(var uParam0, int iParam1) // Position - 0x1432
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_70(int iParam0, BOOL bParam1) // Position - 0x1445
{
...
void func_71(BOOL bParam0) // Position - 0x1AAE
{
	if (bParam0)
...
BOOL func_72(int iParam0) // Position - 0x1AD7
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_73() // Position - 0x1B1C
{
	return;
}

Hash func_74(int iParam0, BOOL bParam1) // Position - 0x1B24
{
	switch (iParam0)
	{
		case 0:
...
void func_75(int iParam0, BOOL bParam1) // Position - 0x22E9
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_76(BOOL bParam0) // Position - 0x233C
{
	if (bParam0)
...
void _DEBUG_PRINT_0_0_0_0_0_0(int iParam0) // Position - 0x2365
{
	iParam0 = iParam0;
	return;
}

void func_78(int iParam0) // Position - 0x2371
{
	int i;
...
void func_79(int iParam0) // Position - 0x23A2
{
	int i;
...
BOOL func_80(int iParam0, BOOL bParam1) // Position - 0x23D5
{
	int num;
	int num2;
	int num3;
...
BOOL func_81(int iParam0) // Position - 0x248B
{
	int i;
...
BOOL func_82(int iParam0, BOOL bParam1) // Position - 0x2505
{
	if (Global_1572887.f_14 == -1)
...
int func_83(var uParam0, var uParam1, int iParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x2536
{
	Volume volume;
	int num;
...
BOOL func_84(int iParam0) // Position - 0x2567
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_85(int iParam0) // Position - 0x2588
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_86(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x25DB
{
	BOOL flag;
...
BOOL func_87(int iParam0) // Position - 0x2C9B
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_88(int iParam0) // Position - 0x2CB2
{
	switch (iParam0)
	{
		case 64:
...
int func_89(int iParam0, BOOL bParam1) // Position - 0x2CF5
{
	if (!func_87(iParam0))
		return 0;
...
BOOL func_90(int iParam0) // Position - 0x2DE0
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_91(int iParam0) // Position - 0x2DF6
{
...
const char* func_93(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x2E6E
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_130(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_132(func_131(Global_34));
...
BOOL func_94(int iParam0) // Position - 0x38CD
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_95(int iParam0) // Position - 0x38E2
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0) // Position - 0x399D
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_97(int iParam0) // Position - 0x3A0B
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_98(int iParam0) // Position - 0x3B66
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_99(int iParam0, BOOL bParam1) // Position - 0x3BA1
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_100(int iParam0, int iParam1) // Position - 0x3BE3
{
	if (!func_94(iParam0))
		return false;
...
int func_101() // Position - 0x3C28
{
	return Global_1902569;
}

int func_102(int iParam0) // Position - 0x3C34
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_103(int iParam0) // Position - 0x3C47
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_104(float fParam0) // Position - 0x3C59
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_105(var uParam0, int iParam1) // Position - 0x3C6F
{
...
int func_106(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3CA5
{
	int duration;
	var data;
	int num;
...
BOOL func_107(int iParam0) // Position - 0x3CE8
{
	if (func_133(iParam0))
		if (!func_134(44))
			return false;
...
void func_108(int iParam0, int iParam1) // Position - 0x3D08
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_109(int iParam0, int iParam1) // Position - 0x3D19
{
	int num;
...
void func_110(var uParam0, var uParam1, int iParam2) // Position - 0x3D2F
{
...
void func_111(int iParam0) // Position - 0x3D4C
{
...
void func_112(int iParam0) // Position - 0x3E2C
{
	int i;
	int num;
...
BOOL func_113(int iParam0, BOOL bParam1) // Position - 0x4005
{
	if (func_45() != -1)
		return false;
...
int func_114(int iParam0, BOOL bParam1) // Position - 0x4033
{
	if (!func_87(iParam0))
		return 0;
...
int func_115(int iParam0) // Position - 0x40B6
{
	switch (iParam0)
	{
		case 27:
...
int func_116(int iParam0) // Position - 0x40DD
{
	switch (iParam0)
	{
		case 33:
...
void func_119(int iParam0, BOOL bParam1) // Position - 0x4340
{
	BOOL flag;
...
int func_120(var uParam0, var uParam1, Volume volParam2, int iParam3) // Position - 0x46EF
{
	ItemSet itemSet;
...
void func_121(Volume volParam0) // Position - 0x47AA
{
...
Hash func_122(int iParam0) // Position - 0x47C1
{
	if (!func_87(iParam0))
		return 0;
...
void func_123(int iParam0, PersChar pchParam1) // Position - 0x47DF
{
	if (!func_87(iParam0))
		return;
...
PersChar func_124(int iParam0) // Position - 0x4800
{
	if (!func_87(iParam0))
		return 0;
...
void func_125(int iParam0, BOOL bParam1) // Position - 0x4820
{
	if (func_45() != -1)
		return;
...
BOOL func_126(int iParam0) // Position - 0x4859
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_127() // Position - 0x487F
{
	return false;
}

BOOL func_128() // Position - 0x4888
{
	var unk;
	var unk3;
...
BOOL func_129(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x48F0
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_130(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4A66
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_131(var uParam0, var uParam1, var uParam2) // Position - 0x4A7A
{
	int i;
...
const char* func_132(int iParam0) // Position - 0x4AA8
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_133(int iParam0) // Position - 0x4D8C
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_134(int iParam0) // Position - 0x4DB6
{
	if (!func_165(iParam0))
		return false;
...
struct<2> func_135(Player plParam0) // Position - 0x4DD2
{
	var gamerHandle;
...
const char* func_136(const char* sParam0, int iParam1) // Position - 0x4DE6
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_137(int iParam0, BOOL bParam1) // Position - 0x4E00
{
	char* StringToTest;
...
void func_138(int iParam0, BOOL bParam1) // Position - 0x4E34
{
	switch (iParam0)
	{
		case 5:
...
void func_139(int iParam0, int iParam1) // Position - 0x4E69
{
	func_167(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_140(int iParam0) // Position - 0x4E83
{
	if (!func_87(iParam0))
		return false;
...
void func_141(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4EA8
{
	PersChar persChar;
...
void func_142(int iParam0, BOOL bParam1) // Position - 0x4F94
{
	if (!func_170(iParam0))
		return;
...
void func_143(int iParam0, int iParam1) // Position - 0x4FEA
{
	if (!func_175(iParam0))
		return;
...
int func_144(int iParam0) // Position - 0x505D
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_145(Hash hParam0) // Position - 0x5073
{
...
void func_146(int iParam0) // Position - 0x5093
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_147(int iParam0, BOOL bParam1) // Position - 0x50A9
{
	if (func_45() != -1)
		return;
...
void func_148(int iParam0) // Position - 0x50DA
{
	Ped EntityIndex;
...
void func_149(int iParam0) // Position - 0x511E
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_150(int iParam0) // Position - 0x5133
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_151(int iParam0) // Position - 0x5148
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_152(int iParam0) // Position - 0x515D
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_153(int iParam0) // Position - 0x51DC
{
...
BOOL func_154(int iParam0, int iParam1) // Position - 0x5239
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_155(int iParam0, int iParam1) // Position - 0x5252
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_156(int iParam0, int iParam1) // Position - 0x526B
{
...
int func_157(int iParam0) // Position - 0x52A6
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_158(int iParam0) // Position - 0x52BA
{
	return;
}

BOOL func_159(int iParam0, int iParam1) // Position - 0x52C2
{
	if (iParam0 == -1)
		return false;
...
BOOL func_160() // Position - 0x52E9
{
	...
	if (!func_162(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_161() // Position - 0x5341
{
	return Global_1051268;
}

BOOL func_162(var uParam0, var uParam1) // Position - 0x534F
{
	if (!func_180(uParam0))
		return false;
...
struct<2> func_163() // Position - 0x5383
{
...
BOOL func_164(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x53CE
{
	var unk;
	float num;
	float num2;
...
BOOL func_165(int iParam0) // Position - 0x53FE
{
	if (iParam0 == 0)
		return false;
...
BOOL func_166(int iParam0) // Position - 0x5411
{
	int num;
	int num2;
	int offset;
...
void func_167(var uParam0, int iParam1) // Position - 0x543B
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_168(int iParam0) // Position - 0x5450
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_169(Hash hParam0) // Position - 0x5474
{
	return hParam0 != 0;
}

BOOL func_170(int iParam0) // Position - 0x5480
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_171(int iParam0, BOOL bParam1) // Position - 0x5496
{
	if (!func_170(iParam0))
		return false;
...
void func_172(int iParam0, BOOL bParam1) // Position - 0x54BC
{
	if (!func_170(iParam0))
		return;
...
void func_173(int iParam0, BOOL bParam1) // Position - 0x54EA
{
	if (!func_170(iParam0))
		return;
...
void func_174(int iParam0) // Position - 0x5524
{
	func_185(func_184(iParam0));
	return;
}

BOOL func_175(int iParam0) // Position - 0x5536
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_176(Hash hParam0) // Position - 0x554C
{
	if (func_186(hParam0))
...
BOOL func_177() // Position - 0x5567
{
	return 1;
}

Ped func_178(int iParam0) // Position - 0x5570
{
	PersChar persChar;
...
BOOL func_179(BOOL bParam0, BOOL bParam1) // Position - 0x559E
{
	return bParam0 && bParam1 != false;
}

BOOL func_180(int iParam0) // Position - 0x55AD
{
	switch (iParam0)
	{
		case 2:
...
int func_181(int iParam0) // Position - 0x55EC
{
	switch (iParam0)
	{
		case 2:
...
void func_182(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5682
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_183(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x611F
{
	float num;
	float num2;
	float num3;
...
int func_184(int iParam0) // Position - 0x6185
{
...
void func_185(int iParam0) // Position - 0x66A2
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_186(Hash hParam0) // Position - 0x66B3
{
	return hParam0 != 0;
}
