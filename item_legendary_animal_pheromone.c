...
BOOL func_5(var uParam0) // Position - 0x43E
{
	BOOL flag;
...
int func_6(var uParam0) // Position - 0x4D5
{
	return *uParam0;
}

BOOL func_7(var uParam0) // Position - 0x4E0
{
	return uParam0->f_8;
}

void func_8(var uParam0) // Position - 0x4EC
{
	uParam0->f_8 = 0;
	return;
}

var func_9(Ped pedParam0, int iParam1) // Position - 0x4F9
{
...
int func_10(Hash hParam0) // Position - 0x510
{
...
void func_11(var uParam0) // Position - 0x58E
{
...
BOOL func_12(var uParam0) // Position - 0x5EC
{
	if (func_30(uParam0->f_16))
...
void func_13(BOOL bParam0) // Position - 0x676
{
	if (!bParam0)
		func_33(false, 0);
...
void func_14(var uParam0) // Position - 0x692
{
...
void func_15(var uParam0) // Position - 0x705
{
	var entityName;
...
void func_16(var uParam0) // Position - 0x795
{
	if (uParam0->f_14)
	{
		if (uParam0->f_15 != 0)
...
int func_17(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x875
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
void func_18(var uParam0) // Position - 0xA27
{
	if (!func_31(uParam0->f_17))
		return;
...
BOOL func_19(var uParam0) // Position - 0xA79
{
	int num;
	int boneTag;
...
void func_20(Hash hParam0) // Position - 0xCB5
{
	int num;
	var unk22;
	int i;
...
void func_21(var uParam0) // Position - 0xFF9
{
...
void func_22(Hash hParam0, int iParam1) // Position - 0x100C
{
	int num;
...
BOOL func_23(var uParam0) // Position - 0x11AD
{
	if (uParam0->f_6)
	{
		if (uParam0->f_40 < 1)
...
void func_24(var uParam0) // Position - 0x120A
{
	uParam0->f_8 = 1;
	return;
}

BOOL func_25(Hash hParam0, int iParam1) // Position - 0x1217
{
	if (hParam0 == 0)
		return false;
...
int func_26(Hash hParam0) // Position - 0x1231
{
	var unk;
...
BOOL func_27(Hash hParam0, int iParam1) // Position - 0x125C
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_28(Hash hParam0) // Position - 0x1303
{
	int num;
	int num2;
	int num3;
...
int func_29(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x13BF
{
...
BOOL func_30(int iParam0) // Position - 0x1481
{
	return iParam0 != 0;
}

BOOL func_31(const char* sParam0) // Position - 0x148D
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
}

BOOL func_32(const char* sParam0) // Position - 0x149C
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
}

void func_33(BOOL bParam0, int iParam1) // Position - 0x14AB
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
BOOL func_34(const char* sParam0) // Position - 0x14CD
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
}

BOOL func_35(Hash hParam0) // Position - 0x14DC
{
	return func_26(hParam0) == joaat("consumable");
}

Hash func_36(Hash hParam0, int iParam1) // Position - 0x14F0
{
	int num;
	var unk;
	Hash hash;
...
void func_37(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x156A
{
	BOOL flag;
	int value;
	var unk;
	...
	else if (!func_81(hParam0, &InputString, num3, num2, 0, joaat("ui_itemviewer")))
	{
	...
	str3 = func_90(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash), value), num5);
	...
	if (num4 == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || num4 == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || num4 == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || num4 == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str3 = MISC::VAR_STRING(0, func_91(hParam0, -442898163));
	...
	if (num4 == -126813555 || num4 == 1946043663)
	{
		...
		if (func_92(hParam0, &unk7))
			str3 = func_94(func_93(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_95(str3, InputString.f_1, MISC::GET_HASH_KEY(InputString), num6, num5, str2, str, 0, true);
	return;
}

struct<2> func_38(Hash hParam0) // Position - 0x1A39
{
	var unk;
	var unk3;
...
BOOL func_39(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1ACD
{
	var unk;
	int num;
	int num2;
...
BOOL func_40(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1B99
{
	int num;
	var unk;
	var unk6;
...
struct<5> func_41(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x1C11
{
	var unk;
	int num;
	var unk6;
...
void func_43(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1FA3
{
...
BOOL func_44(var uParam0) // Position - 0x1FDD
{
	if (!uParam0->f_13)
		return false;
...
BOOL func_45(Ped pedParam0, const char* sParam1, const char* sParam2, int iParam3, int iParam4) // Position - 0x202A
{
...
int func_46(Ped pedParam0, AnimScene ansParam1) // Position - 0x2085
{
	var entityId;
...
void func_47(var uParam0) // Position - 0x213C
{
	BOOL flag;
...
BOOL func_48(Hash hParam0, Hash hParam1) // Position - 0x21C5
{
	if (!func_25(hParam0, 0))
...
float func_49(int iParam0, int iParam1) // Position - 0x2206
{
	int num;
	float pedStamina;
	float pedMaxStamina;
...
void func_50(int iParam0) // Position - 0x22BB
{
	Ped ped;
	int num;
...
void func_51(int iParam0, BOOL bParam1) // Position - 0x22F8
{
	int num;
...
void func_52(int iParam0) // Position - 0x232D
{
	Ped ped;
	int num;
...
float func_53(float fParam0, float fParam1) // Position - 0x236A
{
	if (fParam1 != 0f)
...
void func_54(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2398
{
	if (fParam1 == 0f)
		return;
...
float func_55(float fParam0, int iParam1) // Position - 0x23D1
{
	switch (iParam1)
	{
		case 0:
...
int func_56(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2423
{
...
void func_57(float fParam0, BOOL bParam1) // Position - 0x2447
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
struct<2> func_58(int iParam0) // Position - 0x249F
{
	int num;
...
void func_59(var uParam0, var uParam1, int iParam2) // Position - 0x24AF
{
...
void func_60(int iParam0, Ped pedParam1) // Position - 0x24CC
{
	int data;
	var playerBits;
	...
	SCRIPTS::TRIGGER_SCRIPT_EVENT(SCRIPT_EVENT_QUEUE_NETWORK, &data, 6, 5, &playerBits);
	return;
}

int func_61() // Position - 0x2563
{
	return Global_1572887.f_14;
}

int func_62(Hash hParam0, int iParam1) // Position - 0x2571
{
	var unk;
	int num;
	int i;
...
void func_63(int iParam0, BOOL bParam1) // Position - 0x25BB
{
	int num;
	int num2;
...
BOOL func_64(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x25E8
{
...
BOOL func_65(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x260F
{
	if (iParam2 < 0)
		return false;
...
BOOL func_66(Hash hParam0) // Position - 0x264A
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_67(int iParam0) // Position - 0x2665
{
	if (iParam0 < 0)
		return 0;
...
int func_68(Hash hParam0) // Position - 0x2686
{
	var unk;
...
int func_69(Hash hParam0) // Position - 0x26B1
{
	switch (hParam0)
	{
...
int func_70(var uParam0, int iParam1) // Position - 0x2794
{
	int i;
...
int func_71(Hash hParam0) // Position - 0x27D1
{
	int num;
...
int func_72(Hash hParam0, BOOL bParam1) // Position - 0x283E
{
	var unk;
	int num;
	int num2;
...
int func_73(Hash hParam0, int iParam1) // Position - 0x289D
{
	if (iParam1 == 0)
		return 0;
...
int func_74(BOOL bParam0) // Position - 0x28C9
{
	if (func_61() == -1)
	{
...
struct<4> func_75(Hash hParam0, BOOL bParam1) // Position - 0x290A
{
	var unk;
...
void func_76(Hash hParam0, var uParam1, var uParam2) // Position - 0x292F
{
	*uParam1 = 0;
	*uParam2 = 0;
...
BOOL func_77() // Position - 0x2B3B
{
	return !Global_1913444;
}

void func_78(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x2B48
{
	int i;
...
var func_79(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2C6B
{
	if (bParam0)
		return uParam1;
...
BOOL func_80(Hash hParam0, int iParam1) // Position - 0x2C82
{
	if (!func_25(hParam0, 0))
		return false;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_81(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x2CA1
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_82(Hash hParam0) // Position - 0x2D94
{
...
BOOL func_83(Hash hParam0) // Position - 0x2E90
{
...
Hash func_84(Hash hParam0, BOOL bParam1) // Position - 0x2F0F
{
	Hash hash;
...
BOOL func_85(int iParam0) // Position - 0x2F3D
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_86(Hash hParam0) // Position - 0x2F64
{
	var unk;
	int i;
...
Hash func_87(Hash hParam0) // Position - 0x2FD2
{
	int num;
	var unk;
	int collectionId;
...
BOOL func_88(Hash hParam0, Hash hParam1) // Position - 0x3057
{
	if (hParam0 == 0)
		return false;
...
int func_89(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x3088
{
	var unk;
...
const char* func_90(const char* sParam0, int iParam1) // Position - 0x30E7
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_91(Hash hParam0, int iParam1) // Position - 0x3101
{
	 num;
...
BOOL func_92(Hash hParam0, char* sParam1) // Position - 0x311F
{
	...
	TEXT_LABEL_ASSIGN_STRING(&StringToTest, func_143(hParam0), 128);
...
const char* func_93(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x319C
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_94(const char* sParam0, int iParam1) // Position - 0x31B0
{
...
int func_95(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x31E6
{
	int num;
	var unk13;
	int num2;
...
struct<18> func_96(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3249
{
	Hash hash;
...
struct<4> func_97(BOOL bParam0) // Position - 0x3327
{
	int num;
...
void func_98(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x33C8
{
...
BOOL func_99(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x33E3
{
...
BOOL func_100(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3408
{
	var unk;
	int num;
	var unk15;
...
BOOL func_101(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3526
{
	int num;
	var unk;
	int num2;
...
struct<4> func_102(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x363E
{
	var outGuid;
...
struct<4> func_103(BOOL bParam0) // Position - 0x366F
{
	int num;
...
int func_104(Hash hParam0, BOOL bParam1) // Position - 0x370F
{
...
BOOL func_105(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3746
{
	return func_152(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_106(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x3761
{
	var unk;
...
struct<4> func_107(BOOL bParam0) // Position - 0x3782
{
	int num;
...
BOOL func_108(Hash hParam0, int iParam1) // Position - 0x37EC
{
	Hash hash;
	int num;
	int i;
...
BOOL func_109(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x3859
{
	return func_155(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_110() // Position - 0x386F
{
...
void func_111(int iParam0) // Position - 0x38CE
{
	Global_1940252.f_11 = iParam0;
	return;
}

void func_112(int iParam0) // Position - 0x38DE
{
	Global_1940252.f_10 = iParam0;
	return;
}

BOOL func_113(AnimScene ansParam0) // Position - 0x38EE
{
...
Hash func_114(Hash hParam0) // Position - 0x390A
{
	return hParam0;
}

BOOL func_115(Hash hParam0, Hash hParam1) // Position - 0x3914
{
...
int func_116(int iParam0) // Position - 0x394A
{
	if (iParam0 == 2)
		iParam0 = func_159(1);
...
void func_117(float fParam0, Ped pedParam1) // Position - 0x398A
{
	if (fParam0 == 0f)
		return;
...
int func_118(int iParam0) // Position - 0x39CE
{
	if (iParam0 == 2)
		iParam0 = func_159(1);
...
void func_119(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3A12
{
	Player player;
	Ped EntityIndex;
...
int func_120(int iParam0) // Position - 0x3AC3
{
	if (iParam0 == 2)
		iParam0 = func_159(1);
...
void func_121(float fParam0, Ped pedParam1) // Position - 0x3B07
{
	if (fParam0 == 0f)
		return;
...
float func_122(int iParam0, float fParam1, BOOL bParam2) // Position - 0x3B49
{
	int num;
	int num2;
...
float func_123(int iParam0, int iParam1) // Position - 0x3BB2
{
	if (iParam1 == 2)
		iParam1 = func_159(2);
...
int func_124(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x3BFE
{
	Ped ped;
...
int func_125(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3C7C
{
	char* effectName;
	Ped ped;
...
void func_127(float fParam0, int iParam1) // Position - 0x3E5B
{
	float num;
	int num2;
	int num3;
...
var func_128(int iParam0, int iParam1) // Position - 0x3ECE
{
	return func_182(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

void func_129(int iParam0, var uParam1, var uParam2) // Position - 0x3EEC
{
	int num;
...
BOOL func_130(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3F08
{
...
void func_131(int iParam0, int iParam1) // Position - 0x3FAA
{
	int Variable;
...
BOOL func_132(Hash hParam0, int iParam1) // Position - 0x3FCE
{
	if (hParam0 == 0)
		return false;
...
BOOL func_133(Hash hParam0, Hash hParam1) // Position - 0x3FE8
{
	if (hParam1 == 0)
		return false;
...
Hash func_134(Hash hParam0, BOOL bParam1) // Position - 0x4014
{
	switch (hParam0)
	{
...
int func_135(Hash hParam0) // Position - 0x40B6
{
	var unk;
	int num;
...
struct<10> func_136(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x40F0
{
	int num;
...
BOOL func_137(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x41C4
{
...
BOOL func_138(Hash hParam0) // Position - 0x41E5
{
	!func_25(hParam0, 0);
...
int func_139(int iParam0) // Position - 0x420B
{
	if (iParam0 < 0)
		return 0;
...
int func_140(Hash hParam0, int iParam1) // Position - 0x422C
{
	var unk;
	int num;
	int num2;
...
char* func_141(Hash hParam0) // Position - 0x427A
{
	Hash labelHash;
...
BOOL func_142(Hash hParam0) // Position - 0x42B0
{
...
char* func_143(Hash hParam0) // Position - 0x42DE
{
	Hash labelHash;
...
void func_144(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x4313
{
...
BOOL func_145(Hash hParam0) // Position - 0x4344
{
...
int func_146(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x435A
{
	int num;
...
void func_147(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x43C4
{
	int i;
...
BOOL func_148(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x4442
{
	*uParam1 = 0;
...
struct<17> func_149(Hash hParam0, var uParam1) // Position - 0x44AF
{
	var unk;
...
struct<4> func_150() // Position - 0x4502
{
	var unk;
...
int func_152(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x452B
{
...
BOOL func_153(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x45AA
{
	int inventoryId;
...
BOOL func_154(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x45EF
{
...
BOOL func_155(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x4622
{
...
Ped func_156(int iParam0) // Position - 0x465C
{
	return PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::GET_PLAYER_INDEX());
}

int func_157(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x466C
{
	int num;
...
void func_158(int iParam0) // Position - 0x46A1
{
...
int func_159(int iParam0) // Position - 0x4726
{
	return func_198(func_197(iParam0));
}

BOOL func_160(Player plParam0) // Position - 0x4738
{
	float num;
...
int func_161() // Position - 0x4753
{
	return Global_1902569;
}

void func_162(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x475F
{
	int num;
	int i;
	int j;
...
int func_163(int iParam0, int iParam1) // Position - 0x48D2
{
	if (iParam1 == 2)
		iParam1 = func_159(2);
...
int func_164(int iParam0, int iParam1) // Position - 0x4922
{
	if (iParam1 == 2)
		iParam1 = func_159(2);
...
BOOL func_165(int iParam0, int iParam1, BOOL bParam2) // Position - 0x4974
{
	if (bParam2)
...
void func_166(int iParam0, int iParam1, int iParam2) // Position - 0x49A1
{
	if (iParam2 == 2)
		iParam2 = func_159(2);
...
void func_167(int iParam0, int iParam1, int iParam2) // Position - 0x49F7
{
	if (iParam2 == 2)
		iParam2 = func_159(2);
...
BOOL func_168(Ped pedParam0, int iParam1, float fParam2) // Position - 0x4A4D
{
...
void func_169(int iParam0, int iParam1, int iParam2) // Position - 0x4AA2
{
	if (iParam2 == 2)
		iParam2 = func_159(2);
...
void func_170(Ped pedParam0, int iParam1, float fParam2) // Position - 0x4B03
{
	char* StringToTest;

	StringToTest = func_210(iParam1);
...
void func_171(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x4B2F
{
	int num;
...
BOOL func_172(int iParam0) // Position - 0x4B65
{
	switch (iParam0)
	{
		case 0:
...
char* func_173(int iParam0) // Position - 0x4B94
{
	switch (iParam0)
	{
		case 0:
...
void func_174(int iParam0) // Position - 0x4BCF
{
	int num;
	int num2;
	int i;
...
void func_175(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4C9F
{
	func_124(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

BOOL func_176(int iParam0, BOOL bParam1) // Position - 0x4CB9
{
	return func_165(func_161(), iParam0, bParam1);
}

float func_177(int iParam0, int iParam1) // Position - 0x4CCD
{
	if (iParam1 == 2)
		iParam1 = func_159(1);
...
int func_178(float fParam0) // Position - 0x4D19
{
	float num;
...
float func_179(float fParam0, float fParam1, float fParam2) // Position - 0x4D44
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_180(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x4D6B
{
	int num;
	int i;
	int num2;
...
int func_181(int iParam0, float fParam1, int iParam2) // Position - 0x4EF3
{
	if (!func_216(iParam0))
		return 0;
...
var func_182(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x4F44
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_220(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
BOOL func_183(int iParam0, int iParam1) // Position - 0x52D7
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_184(int iParam0) // Position - 0x52EF
{
...
BOOL func_185(int iParam0) // Position - 0x5306
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_186(int iParam0, int iParam1) // Position - 0x53D2
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_187(int iParam0) // Position - 0x53EB
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_188() // Position - 0x53FE
{
	if (!func_224())
		return false;
...
BOOL func_189(Hash hParam0, Any* panParam1) // Position - 0x5419
{
	int num;
...
BOOL func_190(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x55EF
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_191(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x5606
{
	if (bParam0)
	{
...
int func_192(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x564F
{
	if (bParam0)
	{
		func_226(iParam1, 1, 0, 0);
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_193(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x566B
{
	int i;
...
int func_194(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5782
{
...
int func_195(Ped pedParam0, Hash hParam1) // Position - 0x57B5
{
	int num;
	int i;
...
int func_196(Hash hParam0, BOOL bParam1) // Position - 0x5813
{
	if (!bParam1 || func_231())
...
BOOL func_197(int iParam0) // Position - 0x5842
{
	return func_232(&(Global_1956875.f_1565), iParam0, 1);
}

int func_198(BOOL bParam0) // Position - 0x5858
{
	if (bParam0)
		return 1;
...
float func_199(Player plParam0) // Position - 0x586A
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_233(2);
}

int func_200(int iParam0) // Position - 0x5880
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_201(int iParam0) // Position - 0x58A5
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_202(int iParam0) // Position - 0x58B8
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_203(int iParam0) // Position - 0x58CB
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_204(int iParam0) // Position - 0x58DE
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_205(int iParam0) // Position - 0x58F0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_206(int iParam0, int iParam1) // Position - 0x5902
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_207(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x599C
{
...
BOOL func_208(int iParam0) // Position - 0x59D4
{
	int num;
	int num2;
	int num3;
...
int func_209(int iParam0) // Position - 0x5AB0
{
	switch (iParam0)
	{
		case 0:
...
char* func_210(int iParam0) // Position - 0x5ADF
{
	switch (iParam0)
	{
		case 0:
...
char* func_211(int iParam0) // Position - 0x5B1A
{
	switch (iParam0)
	{
		case 0:
...
void func_212(int iParam0, float fParam1, int iParam2) // Position - 0x5B55
{
	if (iParam2 == 2)
		iParam2 = func_159(2);
...
void func_213(int iParam0, int iParam1, int iParam2) // Position - 0x5BA7
{
	if (iParam2 == 2)
		iParam2 = func_159(2);
...
int func_214(int iParam0, int iParam1) // Position - 0x5BFD
{
	switch (iParam0)
	{
		case -2101912686:
...
// Unhandled jump detected. Output should be considered invalid
int func_215(int iParam0) // Position - 0x63FE
{
	int num;
	int num2;
	int num3;
...
BOOL func_216(int iParam0) // Position - 0x668E
{
	if (func_172(iParam0))
		return true;
...
void func_217(int iParam0, float fParam1, int iParam2) // Position - 0x66B4
{
	if (fParam1 < 0f)
		return;
...
int func_218() // Position - 0x6710
{
	return Global_1051645.f_12;
}

char* func_219() // Position - 0x671E
{
	return "unnamed";
}

BOOL func_220(int iParam0) // Position - 0x672A
{
	int num;
...
BOOL func_221(int iParam0) // Position - 0x67B9
{
...
int func_222(int iParam0) // Position - 0x67D7
{
	if (iParam0 == 255)
...
BOOL func_223(Player plParam0) // Position - 0x6822
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_225(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x687B
{
...
void func_226(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6893
{
	int i;
...
BOOL func_227(Any* panParam0) // Position - 0x6931
{
...
BOOL func_228(Hash hParam0) // Position - 0x694D
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_229(Hash hParam0) // Position - 0x695B
{
...
int func_230(int iParam0, Hash hParam1) // Position - 0x6986
{
	var guid;
	int inventoryItemCountWithGuid;
...
BOOL func_232(Any* panParam0, int iParam1, int iParam2) // Position - 0x6A13
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_233(int iParam0) // Position - 0x6A4A
{
	switch (iParam0)
	{
		case 0:
...
var func_234(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6A8B
{
	if (bParam0)
		return uParam1;
...
void func_235(var uParam0, int iParam1) // Position - 0x6AA2
{
	if (iParam1 < 0)
		return;
...
void func_236(var uParam0, int iParam1) // Position - 0x6B28
{
...
void func_237(var uParam0, int iParam1) // Position - 0x6B64
{
	int num;
	int num2;
...
void func_238(var uParam0, int iParam1) // Position - 0x6BB7
{
...
void func_239(var uParam0, int iParam1) // Position - 0x6BF2
{
...
void func_240(var uParam0, int iParam1) // Position - 0x6C2B
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_241(int iParam0) // Position - 0x6C63
{
	int num;
...
BOOL func_242(int iParam0) // Position - 0x6C8B
{
	int num;
...
int func_243(int iParam0, int iParam1) // Position - 0x6CB3
{
	switch (iParam0)
	{
...
int func_244(int iParam0, int iParam1) // Position - 0x736A
{
	Player player;
	Player player2;
	int num;
...
int func_245(int iParam0, int iParam1, int iParam2) // Position - 0x73ED
{
	int num;
	int num2;
...
void func_246(int iParam0) // Position - 0x74E5
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_247(int iParam0, int iParam1) // Position - 0x74FB
{
	switch (iParam0)
	{
...
BOOL func_251(int iParam0) // Position - 0x7E25
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_252(int iParam0, int iParam1) // Position - 0x7E4A
{
	int num;
...
BOOL func_253(Player plParam0) // Position - 0x7EBE
{
...
void func_254(Player plParam0) // Position - 0x7EDB
{
	Player player;
...
BOOL func_255(int iParam0, int iParam1) // Position - 0x7F5E
{
	return iParam0 && iParam1 != false;
}

void func_256(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7F6D
{
	int i;
...
BOOL func_257(Any* panParam0) // Position - 0x804B
{
...
BOOL func_258(Hash hParam0, int iParam1) // Position - 0x8081
{
	int num;
...
struct<4> func_259(int iParam0, Hash hParam1) // Position - 0x80A0
{
	var unk;
...
BOOL func_260(Vehicle veParam0) // Position - 0x80C2
{
...
Player func_261(int iParam0) // Position - 0x80E1
{
	if (func_278(iParam0))
...
BOOL func_262(int iParam0) // Position - 0x8102
{
	int num;
...
int func_263(int iParam0, int iParam1, int iParam2) // Position - 0x812A
{
	int num;
	int num2;
	int num3;
...
BOOL func_264(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x831B
{
	return uParam0.f_4 != 0;
}

BOOL func_265(int iParam0, int iParam1) // Position - 0x8329
{
	int num;
...
Vector3 func_266(int iParam0) // Position - 0x8369
{
	int num;
	var unk;
...
BOOL func_267(int iParam0, var uParam1, var uParam2) // Position - 0x83A5
{
	if (!func_262(iParam0))
		return false;
...
BOOL func_268(int iParam0, int iParam1, int iParam2) // Position - 0x83DC
{
	int num;
	int num2;
	int num3;
...
void func_269(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x860A
{
	int num;
...
void func_270(int iParam0) // Position - 0x8689
{
	int num;
...
int func_271() // Position - 0x86DE
{
	return Global_1102813.f_3672;
}

void func_272(Player plParam0) // Position - 0x86ED
{
	Player player;
...
void func_273(Player plParam0) // Position - 0x8759
{
...
void func_274(int iParam0) // Position - 0x8794
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
int func_275(Hash hParam0) // Position - 0x87B7
{
	int num;
...
struct<5> func_276(int iParam0) // Position - 0x87D1
{
	var unk;
...
struct<4> func_277(int iParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6) // Position - 0x87FE
{
	var outGuid;
...
BOOL func_278(int iParam0) // Position - 0x882B
{
	int num;
...
int func_279(int iParam0) // Position - 0x8852
{
	int num;
...
int func_280(int iParam0, int iParam1) // Position - 0x88EC
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_281(int iParam0) // Position - 0x8D25
{
	int num;
...
float func_282(int iParam0) // Position - 0x8D4D
{
	float num;
...
void func_283(int iParam0) // Position - 0x8D7D
{
	int num;
	int num2;
	int i;
...
BOOL func_284(int iParam0) // Position - 0x8F5C
{
	int num;
...
int func_285(int iParam0, int iParam1) // Position - 0x8F84
{
	switch (iParam0)
	{
...
void func_286(int iParam0) // Position - 0x9294
{
	Ped ped;
	Player player;
...
BOOL func_287(int iParam0) // Position - 0x94A4
{
	int num;
...
int func_288(int iParam0, int iParam1) // Position - 0x94CB
{
	switch (iParam0)
	{
...
int func_289(int iParam0) // Position - 0x9528
{
	int num;
	var unk;
	var unk32;
...
BOOL func_290(int iParam0) // Position - 0x966C
{
...
void func_291(int iParam0) // Position - 0x968A
{
	int num;
	int num2;
	int i;
...
BOOL func_292(int iParam0) // Position - 0x97DF
{
	BOOL flag;
...
void func_293(int iParam0) // Position - 0x9809
{
	Ped EntityIndex;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_309(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_316(iParam0, 0));
			func_317(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_316(iParam0, 1));
			func_317(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_316(iParam0, 2));
			func_317(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_316(iParam0, 3));
			func_317(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_294(int iParam0) // Position - 0x9AA4
{
	char* StringToTest;
	char* StringToTest2;
	...
	StringToTest = func_319(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	StringToTest2 = func_320(iParam0);
...
void func_295(var uParam0) // Position - 0x9AEE
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_296(int iParam0) // Position - 0x9B4A
{
	int num;
...
BOOL func_297(int iParam0) // Position - 0x9B72
{
	int num;
...
BOOL func_298(int iParam0) // Position - 0x9B9A
{
	int num;
...
BOOL func_299(int iParam0) // Position - 0x9BC2
{
	int num;
...
BOOL func_300(int iParam0) // Position - 0x9BEA
{
	int num;
...
BOOL func_301(int iParam0) // Position - 0x9C12
{
	int num;
...
float func_302(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x9C3A
{
	var unk;
	float num;
...
BOOL func_303(int iParam0) // Position - 0x9C70
{
...
BOOL func_304(int iParam0) // Position - 0x9CDF
{
	int num;
...
int func_305(int iParam0, int iParam1) // Position - 0x9D06
{
	switch (iParam0)
	{
...
char* func_308(int iParam0) // Position - 0x9DF5
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_309(int iParam0) // Position - 0x9E3D
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_310(int iParam0) // Position - 0x9E78
{
	int i;
...
int func_312(int iParam0) // Position - 0x9ED8
{
	int num;
...
BOOL func_313(int iParam0, int iParam1) // Position - 0x9F07
{
	int num;
	Player player;
	int num2;
...
struct<31> func_314(int iParam0) // Position - 0xA1DC
{
	int num;
...
BOOL func_315(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0xA200
{
	var unk;
	BOOL flag;
...
char* func_316(int iParam0, int iParam1) // Position - 0xA236
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_317(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xA28F
{
	int i;
...
char* func_319(int iParam0) // Position - 0xA339
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_320(int iParam0) // Position - 0xA35A
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_321(Hash hParam0, Hash hParam1, var uParam2) // Position - 0xA37B
{
	int num;
	int num2;
...
BOOL func_322() // Position - 0xA59D
{
	return Global_1572887.f_7;
}

BOOL func_323() // Position - 0xA5AB
{
	if (!Global_1048577)
		return false;
...
BOOL func_324(int iParam0, Player plParam1) // Position - 0xA5F6
{
	if (plParam1 == 255)
...
int func_325(int iParam0) // Position - 0xA622
{
	int num;
...
struct<2> func_326(int iParam0) // Position - 0xA658
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_327(var uParam0, var uParam1) // Position - 0xA66C
{
	if (!func_329(uParam0))
		return false;
...
int func_330(int iParam0) // Position - 0xA727
{
	switch (iParam0)
	{
		case 2:
