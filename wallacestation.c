...
void _DEBUG_PRINT(int iParam0) // Position - 0x96A
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x976
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x983
{
	return;
}
...
void _DEBUG_PRINT_0(int iParam0) // Position - 0x994
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x9A0
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x9B5
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x9C6
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0xA05
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0xA11
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0xA19
{
	if (func_54(iParam0))
		return true;
...
void func_26() // Position - 0xAD1
{
	return;
}

void func_27() // Position - 0xAD9
{
	return;
}

void func_28() // Position - 0xAE1
{
	return;
}

void func_29(int iParam0) // Position - 0xAE9
{
...
void func_31() // Position - 0xB87
{
	return;
}

void func_32() // Position - 0xB8F
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xB97
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xBA3
{
...
void func_35(var uParam0) // Position - 0xBD4
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xC1A
{
...
void func_37(int iParam0) // Position - 0xC35
{
	if (!func_64(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xC4E
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xC5F
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xC77
{
	func_66(100, volLocal_19, &uLocal_24);
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xC8A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xDC9
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xDD6
{
...
BOOL func_44(int iParam0) // Position - 0xE0C
{
	if (iParam0 == 0)
	{
		func_79();
...
int func_45() // Position - 0xF20
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xF2E
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xF3A
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xFA7
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x1087
{
	if (!func_64(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x10A5
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x10B8
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x10D6
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x11CE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x11DF
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x11F3
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x1207
{
	return uParam0;
}

void func_58(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x1211
{
...
void func_59(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x13C0
{
	int num;
...
void func_60(int iParam0, int iParam1) // Position - 0x1464
{
	func_110(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

int func_61(int iParam0, BOOL bParam1) // Position - 0x147E
{
	int num;
	Hash hash;
	float num2;
...
int func_62(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x15A5
{
	PersChar persChar;
...
void func_63(var uParam0, Volume volParam1, int iParam2) // Position - 0x15F3
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_64(int iParam0) // Position - 0x164C
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_65() // Position - 0x1662
{
	int i;
...
void func_66(int iParam0, Volume volParam1, var uParam2) // Position - 0x168F
{
	if (!*uParam2)
	{
...
BOOL func_67(int iParam0, int iParam1) // Position - 0x16D1
{
	return iParam0 && iParam1 != false;
}

BOOL func_68(var uParam0, int iParam1) // Position - 0x16E0
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_69() // Position - 0x16F1
{
	return func_67(Global_1940199, 8192);
}

BOOL func_70(var uParam0, int iParam1) // Position - 0x1704
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_71(int iParam0) // Position - 0x1715
{
	if (!func_64(iParam0))
		return false;
...
BOOL func_72(int iParam0, int iParam1) // Position - 0x1755
{
...
int func_73() // Position - 0x1782
{
	return Global_1896646.f_41;
}

void func_74(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1790
{
	BOOL flag;
	...
	StringToTest = func_126(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_138(&unk, joaat("COLOR_PURE_WHITE")), str3, func_138(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_138(&unk, joaat("COLOR_PURE_WHITE")), func_138(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_139(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_75(var uParam0, int iParam1) // Position - 0x19F8
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_76(int iParam0, BOOL bParam1) // Position - 0x1A0B
{
...
void func_77(BOOL bParam0) // Position - 0x2074
{
	if (bParam0)
...
BOOL func_78(int iParam0) // Position - 0x209D
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_79() // Position - 0x20E2
{
	return;
}

Hash func_80(int iParam0, BOOL bParam1) // Position - 0x20EA
{
	switch (iParam0)
	{
		case 0:
...
void func_81(int iParam0, BOOL bParam1) // Position - 0x28AF
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_82(BOOL bParam0) // Position - 0x2902
{
	if (bParam0)
...
void func_83(int iParam0) // Position - 0x292B
{
	return;
}

void func_84(int iParam0) // Position - 0x2933
{
	int i;
...
void func_85(int iParam0) // Position - 0x2964
{
	int i;
...
BOOL func_86(int iParam0, BOOL bParam1) // Position - 0x2997
{
	int num;
	int num2;
	int num3;
...
BOOL func_87(int iParam0) // Position - 0x2A4D
{
	int i;
...
BOOL func_88(int iParam0, BOOL bParam1) // Position - 0x2AC7
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_89(int iParam0) // Position - 0x2AF8
{
	if (!func_64(iParam0))
		return false;
...
BOOL func_90(int iParam0) // Position - 0x2B19
{
	if (!func_64(iParam0))
		return false;
...
BOOL func_91(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2B6C
{
	BOOL flag;
...
BOOL func_92(int iParam0) // Position - 0x322C
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_93(int iParam0) // Position - 0x3243
{
	switch (iParam0)
	{
		case 64:
...
int func_94(int iParam0, BOOL bParam1) // Position - 0x3286
{
	if (!func_92(iParam0))
		return 0;
...
BOOL func_96() // Position - 0x3385
{
	return func_155(func_56(0));
}

BOOL func_97(int iParam0) // Position - 0x3396
{
	return !func_156(iParam0);
}

void func_98(BOOL bParam0, BOOL bParam1) // Position - 0x33A5
{
	if (func_157(255) == 4)
		return;
...
void func_99(int iParam0, BOOL bParam1) // Position - 0x34F0
{
	BOOL flag;
...
int func_100(Hash hParam0, int iParam1) // Position - 0x389F
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_101(int iParam0) // Position - 0x420A
{
	if (!func_173(iParam0))
		return 0;
...
int func_102(int iParam0) // Position - 0x424B
{
	switch (iParam0)
	{
		case 3:
...
void func_103(int iParam0, int iParam1) // Position - 0x42E8
{
...
void func_104(int iParam0) // Position - 0x4317
{
...
int func_105(int iParam0) // Position - 0x4350
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

Hash func_106(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4364
{
...
BOOL func_107(Hash hParam0) // Position - 0x4408
{
	if (func_175(hParam0))
...
BOOL func_108(Hash hParam0) // Position - 0x4423
{
...
void func_109(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x444C
{
	func_106(hParam0, false, false);
...
void func_110(BOOL bParam0, int iParam1) // Position - 0x44D7
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

BOOL func_111(int iParam0, BOOL bParam1) // Position - 0x44E8
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4501
{
...
Hash func_113() // Position - 0x452B
{
	return Global_1893611.f_2;
}

BOOL func_114(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4539
{
	return func_181(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_115(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4559
{
	return func_181(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_116(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x4579
{
	if (bParam6)
...
BOOL func_117(int iParam0, BOOL bParam1) // Position - 0x45F5
{
	if (func_45() != -1)
		return false;
...
PersChar func_118(int iParam0) // Position - 0x464D
{
	if (!func_92(iParam0))
		return 0;
...
BOOL func_119(int iParam0) // Position - 0x466D
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_120(int iParam0) // Position - 0x4683
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_121(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x4699
{
...
struct<2> func_122(int iParam0) // Position - 0x46CF
{
	int num;
...
void func_123(var uParam0, var uParam1, int iParam2) // Position - 0x46EA
{
...
BOOL func_124(int iParam0) // Position - 0x4707
{
...
const char* func_126(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x477F
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_188(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_190(func_189(Global_34));
...
BOOL func_127(int iParam0) // Position - 0x51E5
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_128(int iParam0) // Position - 0x51FA
{
	switch (iParam0)
	{
		case 0:
...
Hash func_129(int iParam0) // Position - 0x52B5
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_130(int iParam0) // Position - 0x5323
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_131(int iParam0) // Position - 0x547E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_132(int iParam0, BOOL bParam1) // Position - 0x54B9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_133(int iParam0, int iParam1) // Position - 0x54FB
{
	if (!func_127(iParam0))
		return false;
...
BOOL func_134() // Position - 0x5540
{
	return Global_1902569;
}

int func_135(BOOL bParam0) // Position - 0x554C
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 12) & 31;
}

int func_136(BOOL bParam0) // Position - 0x555F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 6) & 63;
}

float func_137(float fParam0) // Position - 0x5571
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_138(var uParam0, int iParam1) // Position - 0x5587
{
...
int func_139(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x55BD
{
	int duration;
	var data;
	int num;
...
BOOL func_140(int iParam0) // Position - 0x5600
{
	if (func_191(iParam0))
		if (!func_192(44))
			return false;
...
void func_141(int iParam0, int iParam1) // Position - 0x5620
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_142(int iParam0, int iParam1) // Position - 0x5631
{
	int num;
...
void func_143(int iParam0) // Position - 0x5647
{
...
void func_144(int iParam0) // Position - 0x5727
{
	int i;
	int num;
...
BOOL func_145(int iParam0, BOOL bParam1) // Position - 0x58FF
{
	if (func_45() != -1)
		return false;
...
int func_146(int iParam0, BOOL bParam1) // Position - 0x592D
{
	if (!func_92(iParam0))
		return 0;
...
int func_147(int iParam0) // Position - 0x59B0
{
	switch (iParam0)
	{
		case 27:
...
int func_148(int iParam0) // Position - 0x59D7
{
	switch (iParam0)
	{
		case 33:
...
Hash func_151(int iParam0) // Position - 0x5C3A
{
	if (!func_92(iParam0))
		return 0;
...
void func_152(int iParam0, PersChar pchParam1) // Position - 0x5C58
{
	if (!func_92(iParam0))
		return;
...
void func_153(int iParam0, BOOL bParam1) // Position - 0x5C79
{
	if (func_45() != -1)
		return;
...
BOOL func_154(int iParam0) // Position - 0x5CB2
{
	if (!func_92(iParam0))
		return false;
...
BOOL func_155(var uParam0, var uParam1) // Position - 0x5CD8
{
	return func_208(uParam0, 5, 8);
}

BOOL func_156(int iParam0) // Position - 0x5CEB
{
	return func_209(1, iParam0);
}

int func_157(int iParam0) // Position - 0x5CFA
{
	if (iParam0 == 255)
...
int func_158(int iParam0) // Position - 0x5D45
{
...
void func_159(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x5D62
{
	func_211(iParam0);
...
int func_160(int iParam0) // Position - 0x5DC4
{
...
void func_161(var uParam0) // Position - 0x5DE1
{
	var unk;
...
void func_162(float* pfParam0) // Position - 0x5DF3
{
	var unk;
...
void func_164(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x5E5B
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_165(int iParam0) // Position - 0x5E88
{
...
BOOL func_166(int iParam0, int iParam1) // Position - 0x5EE5
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_167(int iParam0, int iParam1) // Position - 0x5EFE
{
	func_166(iParam0, iParam1);
...
void func_168(Hash hParam0) // Position - 0x5F39
{
...
void func_169(int iParam0) // Position - 0x5F59
{
	return;
}

void func_170(int iParam0) // Position - 0x5F61
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_171(int iParam0, int iParam1) // Position - 0x5F76
{
	if (iParam0 == -1)
		return false;
...
void func_172(int iParam0) // Position - 0x5F9D
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_173(int iParam0) // Position - 0x601C
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_174(int iParam0) // Position - 0x6032
{
	var unk;
...
BOOL func_175(Hash hParam0) // Position - 0x6063
{
	return hParam0 != 0;
}

void func_176(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x606F
{
	if (func_107(hParam0))
	{
...
void func_177(Hash hParam0, BOOL bParam1) // Position - 0x60A7
{
	if (func_107(hParam0))
...
void func_178(Hash hParam0, BOOL bParam1) // Position - 0x60D5
{
	if (func_107(hParam0))
...
void func_179(Hash hParam0, BOOL bParam1) // Position - 0x6103
{
	if (func_107(hParam0))
...
BOOL func_180() // Position - 0x6131
{
	return true;
}

BOOL func_181(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x613A
{
	int num;
...
int func_182(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x61C2
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

Ped func_183(int iParam0) // Position - 0x61DC
{
	PersChar persChar;
...
int func_184(int iParam0) // Position - 0x620A
{
	int num;
...
BOOL func_185() // Position - 0x6222
{
	return false;
}

BOOL func_186() // Position - 0x622B
{
	var unk;
	var unk3;
...
BOOL func_187(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6293
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_188(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6409
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_189(var uParam0, var uParam1, var uParam2) // Position - 0x641D
{
	int i;
...
const char* func_190(int iParam0) // Position - 0x644B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_191(int iParam0) // Position - 0x672F
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_192(int iParam0) // Position - 0x6759
{
	if (!func_228(iParam0))
		return false;
...
struct<2> func_193(Player plParam0) // Position - 0x6775
{
	var gamerHandle;
...
const char* func_194(const char* sParam0, int iParam1) // Position - 0x6789
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_195(int iParam0, BOOL bParam1) // Position - 0x67A3
{
	char* StringToTest;
...
void func_196(int iParam0, BOOL bParam1) // Position - 0x67D7
{
	switch (iParam0)
	{
		case 5:
...
void func_197(int iParam0, int iParam1) // Position - 0x680C
{
	func_230(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_198(int iParam0) // Position - 0x6826
{
	if (!func_92(iParam0))
		return false;
...
void func_199(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x684B
{
	PersChar persChar;
...
void func_200(int iParam0, BOOL bParam1) // Position - 0x6937
{
	if (!func_173(iParam0))
		return;
...
void func_201(int iParam0, int iParam1) // Position - 0x698D
{
	if (!func_237(iParam0))
		return;
...
int func_202(int iParam0) // Position - 0x6A00
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_203(int iParam0) // Position - 0x6A16
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_204(int iParam0, BOOL bParam1) // Position - 0x6A2C
{
	if (func_45() != -1)
		return;
...
void func_205(int iParam0) // Position - 0x6A5D
{
	Ped EntityIndex;
...
void func_206(int iParam0) // Position - 0x6AA1
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_207(int iParam0) // Position - 0x6AB6
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_208(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x6ACB
{
	int num;
...
BOOL func_209(int iParam0, int iParam1) // Position - 0x6B06
{
	int num;
...
BOOL func_210(int* piParam0, int iParam1, int iParam2) // Position - 0x6B7A
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_216(BOOL bParam0) // Position - 0x6C49
{
	if (func_241(bParam0))
		return;
...
BOOL func_217(int* piParam0, int iParam1, int iParam2) // Position - 0x6C70
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_218() // Position - 0x6CA3
{
	return 1;
}

BOOL func_219(BOOL bParam0, BOOL bParam1) // Position - 0x6CAC
{
	return bParam0 && bParam1 != false;
}

int func_220(int iParam0) // Position - 0x6CBB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_221(int iParam0, int iParam1, var uParam2) // Position - 0x76A3
{
	var unk;
...
int func_222() // Position - 0x76CA
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_223() // Position - 0x76DF
{
	if (Global_1048576)
		return true;
...
struct<2> func_224() // Position - 0x7737
{
	return Global_1051268;
}

BOOL func_225(var uParam0, var uParam1) // Position - 0x7745
{
	if (!func_244(uParam0))
		return false;
...
struct<2> func_226() // Position - 0x7779
{
...
BOOL func_227(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x77C4
{
	var unk;
	float num;
	float num2;
...
BOOL func_228(int iParam0) // Position - 0x77F4
{
	if (iParam0 == 0)
		return false;
...
BOOL func_229(int iParam0) // Position - 0x7807
{
	int num;
	int num2;
	int offset;
...
void func_230(BOOL bParam0, int iParam1) // Position - 0x7831
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_231(int iParam0) // Position - 0x7846
{
	if (!func_92(iParam0))
		return false;
...
BOOL func_232(Hash hParam0) // Position - 0x786A
{
	return hParam0 != 0;
}

BOOL func_233(int iParam0, BOOL bParam1) // Position - 0x7876
{
	if (!func_173(iParam0))
		return false;
...
void func_234(int iParam0, BOOL bParam1) // Position - 0x789C
{
	if (!func_173(iParam0))
		return;
...
void func_235(int iParam0, BOOL bParam1) // Position - 0x78CA
{
	if (!func_173(iParam0))
		return;
...
void func_236(int iParam0) // Position - 0x7904
{
	func_249(func_248(iParam0));
	return;
}

BOOL func_237(int iParam0) // Position - 0x7916
{
	return iParam0 > -1 && iParam0 < 40;
}

int func_238(int iParam0, var uParam1) // Position - 0x792C
{
	if (iParam0 == 2)
...
BOOL func_239(int* piParam0, int iParam1, int iParam2) // Position - 0x7946
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_240() // Position - 0x797D
{
	return Global_1102813.f_3672;
}

BOOL func_241(BOOL bParam0) // Position - 0x798C
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_242(int iParam0, int iParam1, Any* panParam2) // Position - 0x79A2
{
...
void func_243(Any* panParam0, int iParam1, var uParam2) // Position - 0x79D6
{
	var unk;
...
BOOL func_244(int iParam0) // Position - 0x7A50
{
	switch (iParam0)
	{
		case 2:
...
int func_245(int iParam0) // Position - 0x7A8F
{
	switch (iParam0)
	{
		case 2:
...
void func_246(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7B25
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_247(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x85C7
{
	float num;
	float num2;
	float num3;
...
int func_248(int iParam0) // Position - 0x862D
{
...
void func_249(int iParam0) // Position - 0x8B4A
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_250(var uParam0, var uParam1) // Position - 0x8B5B
{
	var unk;
...
int func_251(int iParam0) // Position - 0x8B87
{
	int num;
...
BOOL func_252(int iParam0, var uParam1, Any* panParam2) // Position - 0x8CFC
{
	if (!func_225(iParam0))
		return false;
...
void func_253(Any* panParam0) // Position - 0x8E07
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
