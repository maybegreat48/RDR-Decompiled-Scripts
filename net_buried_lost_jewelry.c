...
void func_1(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x94
{
...
int func_2() // Position - 0x1BF
{
	return Global_1572887.f_14;
}

struct<2> func_3(int iParam0) // Position - 0x1CD
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_4(int iParam0, var uParam1) // Position - 0x1E1
{
	return iParam0;
}

void func_5(var uParam0) // Position - 0x1EB
{
...
BOOL func_6(var uParam0) // Position - 0x287
{
...
BOOL func_7() // Position - 0x2A1
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x2AA
{
	Hash hash;
	BOOL flag;
	BOOL flag2;
...
int func_9(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xD49
{
	int num;
	int num2;
	int scenario;
...
int func_10(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x16F7
{
	int num;
	int scenario;
...
int func_11(var uParam0) // Position - 0x172A
{
	int num;
...
void func_12(var uParam0) // Position - 0x180E
{
	switch (uParam0->f_1)
	{
		case 1:
...
BOOL func_14(var uParam0, int iParam1) // Position - 0x1A0E
{
	return func_51(uParam0->f_16, iParam1);
}

void func_15(var uParam0, int iParam1) // Position - 0x1A20
{
...
void func_16(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1A40
{
...
void func_17(var uParam0, var uParam1) // Position - 0x1A77
{
	Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_1 = uParam0;
	return;
}

int func_18(var uParam0) // Position - 0x1A8D
{
	int num;
...
int func_19(int iParam0) // Position - 0x27D1
{
	switch (iParam0)
	{
...
int func_20(BOOL bParam0) // Position - 0x2CDC
{
	int MaxInt;
	int randomIntInRange;
...
BOOL func_23(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x2DE6
{
	return !PERSISTENCE::_PERSISTENCE_IS_SCENARIO_MARKED_AS_LOOTED_AT_COORDS(vParam0);
}

BOOL func_24() // Position - 0x2DF7
{
	int i;
	Player Plr;
	Player player;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		else
		{
			...
			if (player2 != player)
				if (Global_1222034[player2 /*9*/].f_1 == Global_1222034[player /*9*/].f_1)
					if (Global_1222034[player2 /*9*/].f_2 == Global_1222034[player /*9*/].f_2)
						if (Global_1222034[player2 /*9*/].f_6)
							return true;
		}
	}
...
void func_25(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2E85
{
	int num;
...
void func_26(var uParam0) // Position - 0x2ED9
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_21))
...
void func_27(var uParam0, var uParam1, var uParam2) // Position - 0x2EFA
{
...
void func_28(var uParam0, var uParam1, BOOL bParam2) // Position - 0x2F1C
{
	var value;
	int num;
	int num2;
...
void func_29(int iParam0, int iParam1, int iParam2) // Position - 0x2FEC
{
	func_84(&Global_1222327[iParam0 /*251*/][iParam1], iParam2);
	return;
}

void func_30() // Position - 0x3006
{
...
void func_32(var uParam0) // Position - 0x3080
{
	func_85(uParam0);
...
void func_33(BOOL bParam0) // Position - 0x3097
{
	if (bParam0)
		func_87(0, 6);
	else
...
void func_34(var uParam0) // Position - 0x30B4
{
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_7))
...
BOOL func_35(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x30CF
{
...
BOOL func_36(var uParam0) // Position - 0x312A
{
	if (!func_14(uParam0, 16))
...
int func_37(var uParam0) // Position - 0x317A
{
	return uParam0->f_2;
}

BOOL func_38(int iParam0, int iParam1, int iParam2) // Position - 0x3186
{
	return func_51(Global_1222327[iParam0 /*251*/][iParam1], iParam2);
}

BOOL func_39(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6, int iParam7) // Position - 0x31A0
{
	var unk;
	var unk3;
	var unk5;
...
void func_40(int iParam0, int iParam1, int iParam2) // Position - 0x3433
{
	func_75(&Global_1222327[iParam0 /*251*/][iParam1], iParam2);
	return;
}

BOOL func_41(int iParam0) // Position - 0x344D
{
	int i;
	Player Plr;
	float num;
	...
	if (Global_1222034[player2 /*9*/].f_1 != iParam0)
		return false;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		else
		{
			...
			if (Global_1222034[player3 /*9*/].f_1 == Global_1222034[player2 /*9*/].f_1)
			{
				...
				{
					if (Global_1222034[player3 /*9*/].f_4)
					{
						if (num == -1f || num >= Global_1222034[player3 /*9*/].f_8)
						{
							num = Global_1222034[player3 /*9*/].f_8;
							player = player3;
						}
					}
				}
	...
	if (num > 0f)
	{
		if (Global_1295666.f_149[Global_1295666] != Global_1295666.f_149[player])
		{
			if (!func_51(Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 1))
				func_75(&Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 1);
		
			return true;
		}
	
		if (!func_51(Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 32))
			func_75(&Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 32);
	}

	return false;
}

void func_42(var uParam0, int iParam1) // Position - 0x35C2
{
	uParam0->f_2 = iParam1;
	return;
}

BOOL func_43(int iParam0) // Position - 0x35D0
{
	if (iParam0 < 0)
		return false;
...
BOOL func_44(int iParam0, BOOL bParam1) // Position - 0x360F
{
	int num;
...
BOOL func_45(BOOL bParam0) // Position - 0x3642
{
...
void func_46(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x3675
{
	if (!func_23(vParam1))
	{
		func_27(vParam1);
...
void func_47(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x36EA
{
	BOOL flag;
	BOOL flag2;
	float num;
...
void func_48(int iParam0) // Position - 0x3914
{
...
void func_49(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0x3A12
{
...
void func_50(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x3A6A
{
	if (!func_103(iParam0))
	{
...
BOOL func_51(int iParam0, int iParam1) // Position - 0x3A9E
{
	return iParam0 && iParam1 != false;
}

BOOL func_52(var uParam0, const char* sParam1, char* sParam2, Vector3 vParam3, var uParam4, var uParam5, Object obParam6, Hash hParam7, Object obParam8, Hash hParam9, Object obParam10, Hash hParam11, BOOL bParam12) // Position - 0x3AAD
{
	if (bParam12)
	{
...
Vector3 func_53(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x3C55
{
	var unk;
	float X;
	float num;
	...
	X = { func_106(func_106(unk, func_105(iParam3 - 90f)), unk) };
	num = MISC::ATAN2(X.f_1, X);
	num2 = -MISC::ATAN2(X.f_2, BUILTIN::SQRT((X * X) + (X.f_1 * X.f_1)));
	vector = { -X.f_1, X, 0f };
	vector2 = { func_106(vector, X) };
	num3 = MISC::ATAN2(func_107(vector, unk) / BUILTIN::VMAG(vector), func_107(vector2, unk) / BUILTIN::VMAG(vector2)) + 180f;
	return num3, num2, num;
}

int func_54(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x3D0B
{
	int i;
...
BOOL func_55(var uParam0, int iParam1) // Position - 0x3DBB
{
	if (func_91(joaat("kit_collector_spade"), 1))
	{
...
int func_56(char* sParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, Hash hParam15, int iParam16) // Position - 0x3E61
{
	int i;
	int num;
	int num2;
...
void func_57(int iParam0, var uParam1) // Position - 0x3F3F
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
BOOL func_58(int iParam0, BOOL bParam1) // Position - 0x3F81
{
	int num;
	int gameTimer;
	float progress;
...
void func_59(Ped pedParam0) // Position - 0x407C
{
	Entity firstEntityPedIsCarrying;
...
float func_60(int iParam0, BOOL bParam1) // Position - 0x40BE
{
	int num;
...
float func_62(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x413F
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
void func_63(float fParam0) // Position - 0x4167
{
	if (!Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_4)
	{
...
int func_64(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x41AB
{
...
float func_65(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x41D1
{
	float num;
	float Y;
	float X;
...
BOOL func_67(var uParam0) // Position - 0x425A
{
	var unk;
	int i;
	int num;
...
void func_68(int iParam0) // Position - 0x42F4
{
...
void func_69(BOOL bParam0, BOOL bParam1) // Position - 0x430E
{
	if (bParam1)
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		else
		{
			...
			if (player2 != player)
				if (Global_1222034[player2 /*9*/].f_1 == Global_1222034[player /*9*/].f_1)
					if (Global_1222034[player2 /*9*/].f_2 == Global_1222034[player /*9*/].f_2)
						if (Global_1222034[player2 /*9*/].f_5)
							return true;
		}
	}
			...
			if (player2 != player)
			{
				if (Global_1222034[player2 /*9*/].f_1 == Global_1222034[player /*9*/].f_1)
				{
					if (Global_1222034[player2 /*9*/].f_2 == Global_1222034[player /*9*/].f_2)
					{
						if (Global_1222034[player2 /*9*/].f_6)
						{
							unk = Global_1222034[player2 /*9*/].f_3;
							return unk;
						}
					}
				}
...
BOOL func_72(Hash hParam0, int iParam1) // Position - 0x446A
{
	if (hParam0 == 0)
		return false;
...
int func_73(int iParam0) // Position - 0x4484
{
	switch (iParam0)
	{
...
int func_74(Hash hParam0) // Position - 0x4AAB
{
	var unk;
...
void func_75(int iParam0, int iParam1) // Position - 0x4AC7
{
	func_117(iParam0, iParam1);
	return;
}

int func_76(int iParam0) // Position - 0x4AD7
{
	return iParam0;
}

void func_77(int iParam0) // Position - 0x4AE1
{
	if (!func_118(iParam0))
		return;
...
int func_78(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x4B94
{
	int i;
	var SourceStruct;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		{
			MISC::COPY_SCRIPT_STRUCT(&Global_1296539[i /*2*/], &SourceStruct, 2);
			return 1;
		}
	}
...
BOOL func_79(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x4C3E
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

var func_80(int iParam0, int iParam1) // Position - 0x4C67
{
	return func_81(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

var func_81(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x4C85
{
	var value;
	Player bitIndex;
	int i;
...
void func_83(Any* panParam0, int* piParam1) // Position - 0x50B2
{
...
void func_84(int iParam0, int iParam1) // Position - 0x50E3
{
	func_126(iParam0, iParam1);
	return;
}

void func_85(var uParam0) // Position - 0x50F3
{
	if (uParam0->f_4 != -1)
	{
...
void func_86(int iParam0, int iParam1) // Position - 0x5127
{
	if (func_103(iParam0))
...
void func_87(int iParam0, int iParam1) // Position - 0x5140
{
...
void func_88(int iParam0, int iParam1, BOOL bParam2) // Position - 0x5184
{
...
float func_89(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x51EB
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
int func_90(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, int iParam6) // Position - 0x5209
{
	Volume volume;
	int num;
...
BOOL func_91(Hash hParam0, int iParam1) // Position - 0x523A
{
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x52BD
{
...
BOOL func_93(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x52E7
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_94() // Position - 0x53E6
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_95(var uParam0, int iParam1) // Position - 0x53FB
{
	*uParam0 = iParam1;
	return;
}

void func_96(int iParam0) // Position - 0x5408
{
	if (iParam0 <= 0)
		return;
...
void func_97(var uParam0) // Position - 0x542F
{
	func_138(uParam0, 0f);
	return;
}

float func_98(var uParam0) // Position - 0x543E
{
	if (!func_139(uParam0))
		return uParam0->f_1;
...
BOOL func_100(Ped pedParam0) // Position - 0x54D8
{
...
BOOL func_101(int iParam0, BOOL bParam1) // Position - 0x5522
{
	if (bParam1 && !func_43(iParam0))
		return false;
...
void func_102(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5547
{
	int num;
...
BOOL func_103(int iParam0) // Position - 0x559B
{
	if (*iParam0 == 0)
		return false;
...
Vector3 func_104(float fParam0, var uParam1, var uParam2) // Position - 0x55B3
{
	float num;
	float num2;
...
Vector3 func_105(float fParam0) // Position - 0x55F2
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Vector3 func_106(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x5608
{
...
float func_107(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x5641
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

BOOL func_108(Entity eParam0) // Position - 0x5662
{
	int num;
	var InputString;
	Hash entityModel;
	...
	for (i = 0; i < 30; i = i + 1)
	{
		...
		if (DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(num.f_1), &num))
		{
			...
			if (DATAFILE::_PARSEDDATA_RQ_FILLOUT_STRING_63(&InputString, &num))
			{
...
BOOL func_109(Hash hParam0) // Position - 0x56FC
{
	var unk;
...
BOOL func_110(int iParam0, int iParam1) // Position - 0x5723
{
	if (iParam0 < 0)
		return false;
...
BOOL func_111(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x5744
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_113(int iParam0, Any anParam1) // Position - 0x5AB3
{
	var unk;
...
struct<2> func_114(int iParam0, int iParam1) // Position - 0x5ADC
{
	int num;
...
void func_115(var uParam0, var uParam1, int iParam2) // Position - 0x5AF2
{
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x5B0F
{
	var unk;
	var unk13;
	var unk26;
...
void func_117(var uParam0, int iParam1) // Position - 0x5B3F
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_118(int iParam0) // Position - 0x5B50
{
	return func_110(iParam0, 2);
}

int func_119() // Position - 0x5B5F
{
	return Global_1051645.f_12;
}

char* func_120() // Position - 0x5B6D
{
	return "unnamed";
}

BOOL func_121(int iParam0) // Position - 0x5B79
{
	int num;
...
BOOL func_122(int iParam0) // Position - 0x5C08
{
...
int func_123(int iParam0) // Position - 0x5C26
{
	if (iParam0 == 255)
...
BOOL func_124(Player plParam0) // Position - 0x5C71
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
int func_125(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x5CB6
{
	if (!func_161(uParam0))
		return 0;
...
void func_126(int iParam0, int iParam1) // Position - 0x5CE6
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_127(int iParam0, int iParam1) // Position - 0x5CFB
{
	return MISC::IS_BIT_SET(Global_1072759.f_22475.f_417[iParam0 /*12*/], iParam1);
}

void func_128() // Position - 0x5D17
{
	SCRIPTS::_SET_ALL_PLAYER_BITS(&(Global_1072759.f_21353.f_260));
	return;
}

int func_129(var uParam0, var uParam1, Volume volParam2, int iParam3) // Position - 0x5D2D
{
	ItemSet itemSet;
...
void func_130(Volume volParam0) // Position - 0x5DE8
{
...
int func_131(Hash hParam0) // Position - 0x5DFF
{
	var unk;
...
BOOL func_132(Hash hParam0, int iParam1) // Position - 0x5E2A
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_133(Hash hParam0) // Position - 0x5ED2
{
	int num;
	int num2;
	int num3;
...
int func_134(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5F8E
{
...
BOOL func_135(BOOL bParam0) // Position - 0x6050
{
	if (bParam0)
...
BOOL func_136() // Position - 0x6080
{
	return func_175() != -1;
}

BOOL func_137() // Position - 0x608E
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_138(var uParam0, float fParam1) // Position - 0x60B3
{
...
BOOL func_139(var uParam0) // Position - 0x60D9
{
	return func_178(*uParam0, 1);
}

BOOL func_140(var uParam0) // Position - 0x60E9
{
	return func_178(*uParam0, 2);
}

float func_141() // Position - 0x60F9
{
...
BOOL func_142(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x612B
{
...
BOOL func_143(Ped pedParam0) // Position - 0x6154
{
	return func_179(pedParam0, 0);
}

BOOL func_144(Ped pedParam0) // Position - 0x6163
{
	return func_179(pedParam0, 3);
}

BOOL func_145(Ped pedParam0) // Position - 0x6172
{
	return func_179(pedParam0, 4) || func_179(pedParam0, 5);
}

BOOL func_146(Ped pedParam0) // Position - 0x618E
{
	return func_179(pedParam0, 6);
}

BOOL func_147(Ped pedParam0) // Position - 0x619D
{
	return func_179(pedParam0, 7);
}

void func_148(int iParam0, int iParam1) // Position - 0x61AC
{
	if (iParam0 < 0)
		return;
...
void func_149(int iParam0, BOOL bParam1) // Position - 0x61DF
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_150(int iParam0, BOOL bParam1) // Position - 0x6237
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_151(int iParam0, int iParam1) // Position - 0x6260
{
	if (iParam0 < 0)
		return;
...
int func_152() // Position - 0x6288
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

struct<4> func_153(BOOL bParam0) // Position - 0x629D
{
	int num;
...
BOOL func_154(Hash hParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x633D
{
	var unk;
	var unk5;
	int num;
...
void func_155(var uParam0, int iParam1) // Position - 0x6471
{
	BOOL flag;
	int i;
...
BOOL func_156(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x659D
{
	var unk;
	int num;
...
int func_157(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x660C
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_158(int iParam0, int iParam1) // Position - 0x66ED
{
	int num;
...
BOOL func_159(Player plParam0) // Position - 0x6761
{
...
void func_160(Player plParam0) // Position - 0x677E
{
	Player player;
...
BOOL func_161(var uParam0) // Position - 0x6801
{
	if (*uParam0 >= 40)
		return false;
...
Hash func_162(Hash hParam0, int iParam1) // Position - 0x6816
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_163(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x6890
{
...
BOOL func_164(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x68B7
{
	if (iParam2 < 0)
		return false;
...
BOOL func_165(Hash hParam0) // Position - 0x68F2
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_166(int iParam0) // Position - 0x690D
{
	if (iParam0 < 0)
		return 0;
...
int func_167(Hash hParam0) // Position - 0x692E
{
	var unk;
...
int func_168(Hash hParam0) // Position - 0x6959
{
	switch (hParam0)
	{
...
int func_169(var uParam0, int iParam1) // Position - 0x6A3C
{
	int i;
...
int func_170(Hash hParam0) // Position - 0x6A79
{
	int num;
...
int func_171(Hash hParam0, BOOL bParam1) // Position - 0x6AE6
{
	var unk;
	int num;
	int num2;
...
int func_172(Hash hParam0, int iParam1) // Position - 0x6B45
{
	if (iParam1 == 0)
		return 0;
...
int func_173(BOOL bParam0) // Position - 0x6B71
{
	if (func_2() == -1)
	{
...
struct<4> func_174(Hash hParam0, BOOL bParam1) // Position - 0x6BB2
{
	var unk;
...
int func_175() // Position - 0x6BD7
{
	return Global_1149172.f_137;
}

void func_176(var uParam0, int iParam1) // Position - 0x6BE5
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_177(var uParam0, int iParam1) // Position - 0x6BF6
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_178(int iParam0, int iParam1) // Position - 0x6C0B
{
	return iParam0 && iParam1 != false;
}

BOOL func_179(Ped pedParam0, int iParam1) // Position - 0x6C1A
{
	var unk;
	int num;
...
struct<4> func_180() // Position - 0x6C59
{
	var unk;
...
struct<4> func_181(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x6C65
{
	var outGuid;
...
int func_182(var uParam0) // Position - 0x6C96
{
...
Hash func_183(Hash hParam0) // Position - 0x6D20
{
	return hParam0;
}

BOOL func_184(Hash hParam0, int iParam1) // Position - 0x6D2A
{
	if (hParam0 == 0)
		return false;
...
BOOL func_185(Hash hParam0) // Position - 0x6D44
{
	return func_131(hParam0) == joaat("WEAPON");
}

struct<4> func_186(BOOL bParam0) // Position - 0x6D58
{
	int num;
...
BOOL func_187(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6DF9
{
	return func_191(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_188(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x6E14
{
	var unk;
...
BOOL func_189(Hash hParam0, BOOL bParam1) // Position - 0x6E35
{
...
int func_190(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6E6C
{
	if (!func_72(hParam0, 0))
	{
		if (func_184(func_183(hParam0), 2))
...
int func_191(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x6EE0
{
...
void func_192(var uParam0) // Position - 0x6F5F
{
...
void func_193(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x6F97
{
	int i;
	var unk;
...
void func_194(int iParam0, int iParam1) // Position - 0x704D
{
	if (iParam1 == 0)
		return;
...
void func_195(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x707D
{
	int i;
	var unk;
...
BOOL func_196(Any* panParam0, int iParam1, int iParam2) // Position - 0x7138
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_197() // Position - 0x716F
{
	return Global_1102813.f_3672;
}

void func_198(Player plParam0) // Position - 0x717E
{
	Player player;
...
void func_199(Player plParam0) // Position - 0x71EA
{
...
BOOL func_200(Hash hParam0, Hash hParam1) // Position - 0x7225
{
	if (!func_72(hParam0, 0))
...
void func_201(Hash hParam0, var uParam1, var uParam2) // Position - 0x7266
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_202(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x7472
{
	Hash hash;
...
void func_203(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7550
{
...
BOOL func_204(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x756B
{
...
struct<5> func_205(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7590
{
	var unk;
	int num;
	var unk6;
...
BOOL func_206(Hash hParam0) // Position - 0x7904
{
	return func_200(hParam0, 1279601681);
}

BOOL func_207(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x7917
{
	int inventoryId;
...
int func_209() // Position - 0x7979
{
	return Global_1953292.f_1;
}

BOOL func_210(Any anParam0) // Position - 0x7987
{
...
BOOL func_211(Hash hParam0, Hash hParam1) // Position - 0x79CD
{
...
struct<4> func_212(BOOL bParam0) // Position - 0x7A03
{
	int num;
...
BOOL func_213(Hash hParam0, int iParam1) // Position - 0x7A6D
{
	Hash hash;
	int num;
	int i;
...
BOOL func_214(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x7ADA
{
	return func_217(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_215(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7AF0
{
...
BOOL func_216(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x7B23
{
...
BOOL func_217(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7B56
{
...
BOOL func_218(Hash hParam0) // Position - 0x7B90
{
