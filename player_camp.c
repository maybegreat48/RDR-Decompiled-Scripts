...
void main() // Position - 0x0
{
	...
	fLocal_27 = 2f;
	unk.f_20.f_9 = 1084227584;
	unk.f_20.f_10 = 1073741824;
	unk.f_20.f_30 = 1;
	unk.f_85 = 5;
	unk.f_97 = 1;
	unk.f_10 = uScriptParam_0;
	func_1(&unk);

	if (!_IS_NULL_VECTOR(uScriptParam_0.f_3))
	{
		unk.f_1 = { uScriptParam_0.f_3 };
		unk.f_4 = uScriptParam_0.f_6;
	}

	unk.f_95 = uScriptParam_0.f_7;
	unk.f_12 = uScriptParam_0.f_1;
	unk.f_13 = uScriptParam_0.f_2;
	func_3(&unk);

	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(555) || func_4(false, false))
	{
		func_5(&unk);
		func_6();
	}
	...
	while (func_8() && UNLOCK::UNLOCK_IS_UNLOCKED(-741705372))
	{
		func_9(&unk);
		BUILTIN::WAIT(0);
	}
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x103
{
...
void func_3(var uParam0) // Position - 0x12D
{
	if (func_13(uParam0))
	{
		func_14();
	...
	func_16();
	uLocal_28.f_49.f_12 = 2133510819;
	return;
}

BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x167
{
	int i;
...
void func_5(var uParam0) // Position - 0x247
{
	Player PlayerIndex;
	Player player;
	...
	Global_1148185[Global_1295666 /*10*/].f_9 = 0;

	if (func_32(512))
		func_29(512);

	if (func_33(uParam0, 16384) || Global_1915656.f_20637 || Global_1915656.f_22504.f_1)
	{
	...
	{
		PLAYER::SET_PLAYER_INVINCIBLE(PlayerIndex, false);
...
void func_6() // Position - 0x48A
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_7(var uParam0, int iParam1) // Position - 0x496
{
...
void func_9(var uParam0) // Position - 0x4F1
{
	if (func_13(uParam0))
		func_38(uParam0);
	else
...
void func_10(int iParam0, int iParam1) // Position - 0x511
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_6();
...
void func_12(BOOL bParam0) // Position - 0x63F
{
	int num;
	var unk;
	int num2;
...
BOOL func_13(var uParam0) // Position - 0x708
{
	Player player;
	...
	if (uniqueIntForPlayer != uParam0->f_10)
		return false;

	return true;
}

void func_14() // Position - 0x72C
{
	if (func_42(Global_33, true, 0, false) != joaat("WEAPON_UNARMED") || func_42(Global_33, true, 1, false) != joaat("WEAPON_UNARMED"))
	{
		WEAPON::_HIDE_PED_WEAPONS(Global_33, 2, true);
		TASK::TASK_SWAP_WEAPON(Global_33, false, true, false, false);
...
BOOL func_15(Ped pedParam0) // Position - 0x791
{
...
void func_16() // Position - 0x7AE
{
	if (!PED::_GET_IS_PED_COMMAND_HASH_PRESENT(Global_33, joaat("IS_BAREBONES_CAMP")))
		PED::_GIVE_PED_HASH_COMMAND(Global_33, joaat("IS_BAREBONES_CAMP"), 30f);

	return;
}

void func_17(var uParam0) // Position - 0x7D7
{
	int i;
	...
	for (i = 0; i < uParam0->f_85; i = i + 1)
	{
		if (func_43(&uParam0->f_85[i]))
			func_44(&uParam0->f_85[i], 1);
	}

	return;
}

void func_18(var uParam0) // Position - 0x84C
{
	if (func_45(uParam0->f_149))
		func_46(&(uParam0->f_149), true, true);

	return;
}

void func_19(var uParam0) // Position - 0x869
{
	if (func_45(uParam0->f_150))
		func_46(&(uParam0->f_150), true, true);

	return;
}

BOOL func_20(var uParam0) // Position - 0x886
{
	return func_33(uParam0, 256);
}

void func_21(var uParam0) // Position - 0x897
{
	func_34(uParam0, 256);
	return;
}

void func_22(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x8A8
{
	int i;
	...
	for (i = 0; i < Global_1913340; i = i + 1)
	{
		volLockRequestId = Global_1913340[i];
	
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(volLockRequestId))
		{
			vector = { VOLUME::_0xC4019CF9AE8E931A(volLockRequestId) };
		
			if (func_47(vector, uParam0, 2f, true))
			{
				if (iParam3 == 0 || VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vector, 2f, 0, iParam3, 8192))
				{
...
void func_23(Vector3 vParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0x92C
{
	...
	vector = { func_48(offsetFromCoordAndHeadingInWorldCoords, offsetFromCoordAndHeadingInWorldCoords2, 0f) };
	vector2 = { func_49(offsetFromCoordAndHeadingInWorldCoords, offsetFromCoordAndHeadingInWorldCoords2, 0f) };

	if (iParam4 == 5)
		PATHFIND::SET_ROADS_BACK_TO_ORIGINAL(vector, vector2, 0, true);
	else
...
void func_24(var uParam0) // Position - 0x9A5
{
	int i;

	for (i = 0; i < uParam0->f_97; i = i + 1)
	{
		if (func_45(uParam0->f_97[i]))
			func_46(&uParam0->f_97[i], true, true);
	}

	return;
}

void func_25(Volume volParam0) // Position - 0x9DF
{
	int i;
...
void func_26(Player plParam0) // Position - 0xA10
{
	Global_1148185[plParam0 /*10*/] = { 0f, 0f, 0f };
	Global_1148185[plParam0 /*10*/].f_3 = 0f;
	Global_1148185[plParam0 /*10*/].f_4 = 0;
	func_50(64, PLAYER::PLAYER_ID());

	if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(Global_1148185[plParam0 /*10*/].f_6))
		VOLUME::_RELEASE_LOCK_VOLUME(Global_1148185[plParam0 /*10*/].f_6);

	return;
}

void func_27(var uParam0, BOOL bParam1) // Position - 0xA64
{
	func_51(uParam0);
	func_52(uParam0);
	func_53(uParam0);
	...
	func_57(&(uParam0->f_49), false, true);
	return;
}

void func_28(var uParam0) // Position - 0xABD
{
	if (UIAPPS::IS_UIAPP_ACTIVE_BY_HASH(joaat("crafting")) || func_58() && func_59(uParam0))
	{
		TASK::CLEAR_PED_TASKS(Global_33, true, false);
		HUD::_DISABLE_HUD_CONTEXT(joaat("HUD_CTX_IN_PLAYER_CAMP"));
		func_60(6, PLAYER::PLAYER_ID(), 0f, 0f, 0f, false, true);
...
void func_29(BOOL bParam0) // Position - 0xB0E
{
	if (func_32(bParam0))
...
void func_30(Volume volParam0) // Position - 0xB2F
{
...
void func_31(var uParam0) // Position - 0xB46
{
...
BOOL func_32(BOOL bParam0) // Position - 0xB63
{
	return Global_1958675 && bParam0 != false;
}

BOOL func_33(var uParam0, int iParam1) // Position - 0xB74
{
	return *uParam0 && iParam1 != false;
}

void func_34(var uParam0, int iParam1) // Position - 0xB84
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_35(var uParam0) // Position - 0xB99
{
	func_61(uParam0, 256);
	return;
}

BOOL func_36(BOOL bParam0) // Position - 0xBAA
{
...
BOOL func_37() // Position - 0xBCB
{
	return func_62(1, 255);
}

void func_38(var uParam0) // Position - 0xBDA
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33) || ENTITY::IS_ENTITY_DEAD(Global_33) || func_4(false, false))
		func_7(uParam0, 13);
	...
	if (uParam0->f_96 < 11)
	{
		...
		if (func_67(0, true, true) && !func_68(1) || Global_1915656.f_20637 || Global_1915656.f_22504.f_1)
			func_7(uParam0, 14);
	}

	if (uParam0->f_96 < 3)
	{
		if (UIAPPS::IS_UIAPP_RUNNING_BY_HASH(joaat("player_menu")))
			UIAPPS::_CLOSE_UIAPP_BY_HASH(joaat("player_menu"));
	
		if (UIAPPS::IS_UIAPP_ACTIVE_BY_HASH(joaat("shop_menu")))
			UIAPPS::_CLOSE_UIAPP_BY_HASH(joaat("shop_menu"));
	}
...
void func_39(var uParam0) // Position - 0xE16
{
	switch (uParam0->f_102)
	{
		case 0:
			...
			uParam0->f_66 = joaat("p_campfire02x_combo");
			uParam0->f_65 = joaat("p_campfireburntout02x");
			func_82(uParam0);
		...
		case 3:
			func_89(&uLocal_28, false);
			ENTITY::DOES_ENTITY_EXIST(uParam0->f_56);
			func_64(&(uParam0->f_20), &(uParam0->f_56));
...
int func_40() // Position - 0xF57
{
	return Global_1572887.f_14;
}

BOOL func_41() // Position - 0xF65
{
	return Global_1051645.f_8;
}

Hash func_42(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xF73
{
...
BOOL func_43(int iParam0) // Position - 0xFB5
{
	if (*iParam0 == 0)
		return false;
...
void func_44(int iParam0, int iParam1) // Position - 0xFCD
{
	if (func_43(iParam0))
...
BOOL func_45(int iParam0) // Position - 0xFE6
{
	if (iParam0 < 0)
		return false;
...
void func_46(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1025
{
	int num;
...
BOOL func_47(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1079
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
Vector3 func_48(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6) // Position - 0x10CE
{
	float num;
...
Vector3 func_49(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6) // Position - 0x113D
{
	float num;
...
void func_50(int iParam0, Player plParam1) // Position - 0x11AC
{
	Player player;
...
void func_51(var uParam0) // Position - 0x11CF
{
	int i;

	for (i = 0; i < 11; i = i + 1)
	{
		if (func_45(uParam0->f_137[i]))
			func_46(&uParam0->f_137[i], true, true);
	}

	return;
}

void func_52(var uParam0) // Position - 0x1207
{
	int i;
...
void func_53(var uParam0) // Position - 0x1238
{
	return;
}

void func_54(var uParam0) // Position - 0x1240
{
	func_46(&(uParam0->f_150), true, true);
	func_46(&(uParam0->f_149), true, true);
	return;
...
void func_55(var uParam0) // Position - 0x125C
{
	uParam0->f_130 = 0;
	uParam0->f_131 = -1;
	uParam0->f_132 = 0;
...
void func_56(var uParam0, int iParam1) // Position - 0x1282
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_57(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1297
{
	func_93(uParam0);
		...
		if (!func_103(false) || func_104())
		{
			if (uParam0->f_28 > 0 && func_105(uParam0->f_62, 0))
			{
				...
				if (uParam0->f_12 == 2133510819)
					func_107(func_106(joaat("MADE"), -444296448), uParam0->f_28);
...
BOOL func_58() // Position - 0x1491
{
	if (!func_32(8))
		return false;

	if (PED::IS_PED_USING_SCENARIO_HASH(Global_33, joaat("world_player_camp_fire_kneel1")) || PED::IS_PED_USING_SCENARIO_HASH(Global_33, joaat("world_player_camp_fire_kneel2")) || PED::IS_PED_USING_SCENARIO_HASH(Global_33, joaat("world_player_camp_fire_kneel3")) || PED::IS_PED_USING_SCENARIO_HASH(Global_33, joaat("world_player_camp_fire_kneel4")))
		return true;

	return false;
}

BOOL func_59(var uParam0) // Position - 0x14F1
{
	return func_108(Global_33, uParam0->f_58, true, 0);
}

void func_60(int iParam0, Player plParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1506
{
	int data;
	var playerBits;
	int hostOfThisScript;
	...
	if (bParam5)
	{
		...
		playerBits = func_109(NETWORK::NETWORK_GET_PLAYER_INDEX(hostOfThisScript));
	}
	else if (bParam6)
	{
		playerBits = func_110(0, 8);
	}
	else
	{
		playerBits = func_109(plParam1);
	}

	data.f_1 = PLAYER::PLAYER_ID();
	data.f_2 = NETWORK::GET_NETWORK_TIME_ACCURATE();
	SCRIPTS::TRIGGER_SCRIPT_EVENT(SCRIPT_EVENT_QUEUE_NETWORK, &data, 9, 44, &playerBits);
	return;
}

void func_61(var uParam0, int iParam1) // Position - 0x1578
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_62(int iParam0, int iParam1) // Position - 0x1589
{
	int num;
...
void func_63(var uParam0) // Position - 0x15FD
{
	Player Plr;
	var value;
	int i;
	...
	if (value != uParam0->f_115)
	{
		uParam0->f_115 = value;
		VOLUME::_0xEBA87B9273835CF3(Global_1148185[player /*10*/].f_6, &value);
	}

	return;
}

void func_64(var uParam0, var uParam1) // Position - 0x165F
{
	float fSignal;
	float rainLevel;
			...
			if (TASK::IS_TASK_MOVE_NETWORK_READY_FOR_TRANSITION(*uParam0))
			{
				...
				if (uParam0->f_1 && MISC::GET_RAIN_LEVEL() <= 0f)
					if (uParam0->f_9 <= 2f)
						...
						TASK::SET_TASK_MOVE_NETWORK_SIGNAL_FLOAT(*uParam0, "LogBurnRate", fSignal);
				else
					uParam0->f_30 = 0;
			}
			break;
...
void func_66(BOOL bParam0) // Position - 0x1B7A
{
	if (bParam0)
		func_119(4);
...
BOOL func_67(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1B9C
{
	if (Global_1572887.f_14 != -1)
	{
...
BOOL func_68(int iParam0) // Position - 0x1D12
{
	return Global_1915633.f_22 && iParam0 != false;
}

void func_69(var uParam0) // Position - 0x1D25
{
	if (func_20(uParam0))
	{
	...
	if (HUD::TEXT_BLOCK_IS_LOADED("CAMP") && func_42(Global_33, true, 0, false) == joaat("WEAPON_UNARMED") && func_42(Global_33, true, 1, false) == joaat("WEAPON_UNARMED"))
	{
		if (!PED::IS_PED_ON_MOUNT(Global_33) || PED::IS_PED_FULLY_ON_MOUNT(Global_33, true) && !func_124(Global_33, SCRIPT_TASK_MOUNT_ANIMAL) && !PED::IS_PED_ENTERING_ANY_TRANSPORT(Global_33))
		{
			if (TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_33) == joaat("world_player_dynamic_kneel"))
			{
...
void func_70(var uParam0) // Position - 0x1E33
{
	Player player;
	Player player2;
	...
	if (func_20(uParam0))
	{
		func_126(&(uParam0->f_107), 0f, true);
		func_21(uParam0);
	}

	func_127(uParam0);
	Global_1148185[player2 /*10*/] = { uParam0->f_1 };
	Global_1148185[player2 /*10*/].f_3 = uParam0->f_4;
	func_128(uParam0->f_1, 20f, false);
	uParam0->f_18 = func_84(uParam0->f_1);
	func_85(uParam0);
...
void func_71(var uParam0) // Position - 0x1EE4
{
	if (func_20(uParam0))
	{
		func_82(uParam0);
...
void func_72(var uParam0) // Position - 0x1F15
{
	if (func_20(uParam0))
	{
		if (func_132(Global_33, 0) != joaat("WEAPON_UNARMED"))
		{
			WEAPON::SET_CURRENT_PED_WEAPON(Global_33, joaat("WEAPON_UNARMED"), true, 0, false, false);
			WEAPON::SET_CURRENT_PED_WEAPON(Global_33, joaat("WEAPON_UNARMED"), true, 1, false, false);
		}
...
void func_73(var uParam0) // Position - 0x1FBD
{
	if (func_20(uParam0))
	{
		func_136(uParam0);
		!ENTITY::DOES_ENTITY_EXIST(uParam0->f_93);
		func_21(uParam0);
	}
	else
	{
...
void func_74(var uParam0) // Position - 0x205D
{
	if (func_20(uParam0))
		func_21(uParam0);
...
void func_75(var uParam0) // Position - 0x20AA
{
	...
	if (!func_33(uParam0, 512) && CAM::IS_SCREEN_FADED_OUT())
	{
		if (func_132(Global_33, 0) == joaat("WEAPON_UNARMED"))
		{
			...
			if (!func_124(Global_33, -76381094))
			{
				func_146(uParam0);
				func_147(uParam0);
			}
			...
			func_150(uParam0->f_99, false, false, false, false, false);
			MISC::CLEAR_AREA(uParam0->f_1, 100f, 2097152);
			PED::_0x9851DE7AEC10B4E1(uParam0->f_1, 15f, 1, 0);
			uParam0->f_57 = MAP::BLIP_ADD_FOR_COORDS(-336063235, uParam0->f_1);
			MAP::SET_BLIP_SPRITE(uParam0->f_57, joaat("blip_campfire"), true);
			MAP::SET_BLIP_NAME_FROM_TEXT_FILE(uParam0->f_57, "CAMP_BLIP");
			GRAPHICS::USE_PARTICLE_FX_ASSET("scr_distance_smoke");
			uParam0->f_101 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD("scr_campfire_distance_smoke_script", uParam0->f_1, 0f, 0f, uParam0->f_4, 1065353216, false, false, false, false);
			func_61(uParam0, 512);
		}
	}
...
void func_76(var uParam0) // Position - 0x2331
{
	if (func_20(uParam0))
	{
		func_118(&uLocal_24);
	...
	if (!func_124(Global_33, -76381094) && !TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_33, 0))
		func_146(uParam0);
...
void func_77(var uParam0) // Position - 0x2407
{
	if (func_20(uParam0))
	{
		func_118(&uLocal_24);
	...
	if (func_124(Global_33, -76381094) || func_116(&uLocal_24, fLocal_27))
...
void func_78(var uParam0) // Position - 0x2475
{
	int Sequence;
	float num;
	...
	if (func_59(uParam0))
	{
		...
		if (!func_33(uParam0, 2048))
		{
			...
			{
				func_161(&(uLocal_28.f_127), 64);
				func_61(uParam0, 2048);
			}
		}
		else if (!func_160(Global_33, 0))
		{
			func_161(&(uLocal_28.f_127), 128);
		...
		if (func_162(uParam0))
		{
			if (!func_45(uParam0->f_97[0]) && !func_33(uParam0, 64))
			{
				...
				{
					uParam0->f_97[0] = func_163("CAMP_TEARDOWN", joaat("INPUT_CONTEXT_B"), 0, 1, 0, 5, 570, 4000, 10, 1073741824, joaat("LONG_TIMED_EVENT"), false);
					func_164(uParam0->f_97[0], true, true, true);
					func_165(uParam0->f_97[0], true, true);
				}
			}
			else if (TASK::PED_HAS_USE_SCENARIO_TASK(Global_33) || func_33(uParam0, 64))
			{
				func_46(&uParam0->f_97[0], true, true);
			}
		}
		else
		{
		...
		if (func_32(32))
			if (func_45(uParam0->f_97[0]))
				func_164(uParam0->f_97[0], false, true, true);
	...
	if (func_167(uParam0->f_97[0], true) || func_168(uLocal_28.f_128, 16384))
	{
		...
		if (!func_169(Global_33, uParam0->f_1, 0))
		{
			...
			TASK::TASK_LOOK_AT_COORD(0, uParam0->f_1 + { 1f, 0f, 0f }, 2500, SLF_SLOW_TURN_RATE, 51, true);
			TASK::TASK_PAUSE(0, 400);
			TASK::TASK_TURN_PED_TO_FACE_COORD(0, uParam0->f_1, 0);
			TASK::CLOSE_SEQUENCE_TASK(Sequence);
			TASK::CLEAR_PED_TASKS(Global_33, true, false);
			TASK::TASK_PERFORM_SEQUENCE(Global_33, Sequence);
	...
	num = func_171(Global_33, uParam0->f_1, true);

	if (num > 9f && num < 25f)
		if (func_45(uParam0->f_97[0]))
			func_172(uParam0->f_97[0], -523698323, 0, true);
	else if (func_45(uParam0->f_97[0]))
		func_172(uParam0->f_97[0], 1754796591, 0, true);

	if (!func_59(uParam0))
		if (func_173(uParam0, true))
			func_7(uParam0, 14);
...
void func_79(var uParam0) // Position - 0x28F9
{
	if (func_20(uParam0))
	{
		func_24(uParam0);
	...
	if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("player_camp")) > 1)
		func_7(uParam0, 14);

	return;
}

void func_80(var uParam0) // Position - 0x295A
{
	func_18(&uLocal_28);
	func_19(&uLocal_28);
	func_174(uParam0->f_58, false);
...
void func_81(var uParam0) // Position - 0x29F8
{
	HUD::_DISABLE_HUD_CONTEXT(joaat("HUD_CTX_IN_PLAYER_CAMP"));
	func_5(uParam0);
	func_51(&uLocal_28);
...
void func_82(var uParam0) // Position - 0x2A1E
{
...
BOOL func_83(var uParam0) // Position - 0x2A3C
{
...
int func_84(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x2A8F
{
	return func_175(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

void func_85(var uParam0) // Position - 0x2AA5
{
	func_176(&(uParam0->f_1), 1, 10, true, false);
	return;
}

void func_86(var uParam0) // Position - 0x2ABB
{
	int num;
	var scenarioPointCoords;

	num = func_84(uParam0->f_1);

	if (num == 7)
		if (!func_43(&(uParam0->f_91)))
			func_177(&(uParam0->f_91), uParam0->f_1, 1.75f);

	if (!func_43(&(uParam0->f_83)))
	{
		scenarioPointCoords = { uParam0->f_1 };
		func_178(&(uParam0->f_83), scenarioPointCoords, 1.5f, 0, false);
	}

	if (!func_43(&(uParam0->f_84)))
	{
		scenarioPointCoords = { uParam0->f_1 };
		func_179(&(uParam0->f_84), scenarioPointCoords, 3f);
	}

	if (!func_43(&uParam0->f_85[0]))
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(uLocal_28[0]))
		{
			scenarioPointCoords = { TASK::_GET_SCENARIO_POINT_COORDS(uLocal_28[0], true) };
			func_180(&uParam0->f_85[0], scenarioPointCoords, 0.94f);
		}
	}

	if (!func_43(&uParam0->f_85[1]))
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(uLocal_28[1]))
		{
			scenarioPointCoords = { TASK::_GET_SCENARIO_POINT_COORDS(uLocal_28[1], true) };
			func_180(&uParam0->f_85[1], scenarioPointCoords, 1f);
		}
	}

	if (!func_43(&uParam0->f_85[2]))
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(uLocal_28[2]))
		{
			scenarioPointCoords = { TASK::_GET_SCENARIO_POINT_COORDS(uLocal_28[2], true) };
			func_180(&uParam0->f_85[2], scenarioPointCoords, 1.1f);
		}
	}

	if (!func_43(&uParam0->f_85[3]))
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(uLocal_28[3]))
		{
			scenarioPointCoords = { TASK::_GET_SCENARIO_POINT_COORDS(uLocal_28[3], true) };
			func_180(&uParam0->f_85[3], scenarioPointCoords, 0.9f);
		}
	}
	...
	{
		scenarioPointCoords = { uParam0->f_1 };
		func_180(&uParam0->f_85[4], scenarioPointCoords, 2.25f);
	}
...
void func_87(var uParam0) // Position - 0x2C5D
{
	...
	ENTITY::SET_ENTITY_ROTATION(uParam0->f_56, 0f, 0f, uParam0->f_4 + 26f, 2, true);
	ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_56, true);
	uLocal_28.f_129 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(uParam0->f_56);
	return;
}

void func_88(var uParam0) // Position - 0x2CF3
{
	uParam0->f_58 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(uParam0->f_1, 0f, 0f, 0f, 7f, 7f, 7f, "volPlayerCamp");
	func_143(uParam0, false);
	return;
}

int func_89(var uParam0, BOOL bParam1) // Position - 0x2D19
{
	int num;
	ItemSet itemSet;
	...
	{
		if (func_42(Global_33, true, 0, false) != joaat("WEAPON_UNARMED"))
		{
	...
	switch (uParam0->f_130)
	{
		...
		case 3:
			if (func_186(uParam0))
			{
				...
				func_57(&(uParam0->f_49), true, TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_33) != joaat("WORLD_PLAYER_MP_STEW_POT_DONATION"));
			...
			if (func_195(Global_33, uParam0->f_129, true) > 36f)
			{
				func_51(uParam0);
				func_54(uParam0);
				func_29(8);
			...
			if (uParam0->f_131 != -1)
			{
				...
				if (func_198(&itemSet, uParam0->f_5[uParam0->f_131 /*3*/], 0.75f) && !TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_33, 1))
				{
			...
			if (func_199(false) && uParam0->f_131 != -1)
			{
			...
			else
			{
				...
				{
					if (func_168(uParam0->f_128, 131072) && func_195(Global_33, uParam0->f_129, true) <= 9f)
					{
						uParam0->f_151 = func_204(HUD::_UI_PROMPT_GET_GROUP_ACTIVE_PAGE(1754796591));
						HUD::_UI_PROMPT_SET_AMBIENT_GROUP_THIS_FRAME(uParam0->f_129, func_168(uParam0->f_127, 16384) ? 1.75f : 3f, 1, 1, 1754796591, uParam0->f_151, 2);
					}
				}
		...
		case 6:
			...
			if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 1070143458) && MISC::GET_GAME_TIMER() - uParam0->f_153 > 2000 && !func_168(uParam0->f_128, 4) && uParam0->f_134 != 1)
			{
				if (func_210(uParam0, true, uParam0->f_134, uParam0->f_133))
				{
					if (uParam0->f_134 == 0)
					{
						func_190(uParam0, 10);
		...
		case 7:
			...
			if (func_186(uParam0))
			{
				func_216(joaat("consumable_coffee"), 1, true, -142743235);
				func_187(uParam0);
			}
			...
			if (func_217(uParam0, uParam0->f_132) || !TASK::PED_HAS_USE_SCENARIO_TASK(Global_33) || TASK::IS_PED_SCENARIO_REACT_LOOKING(Global_33, true) || FIRE::IS_ENTITY_ON_FIRE(Global_33) || TASK::IS_PED_EXITING_SCENARIO(Global_33, false))
			{
				...
				func_216(joaat("consumable_coffee"), 1, true, -142743235);
				func_57(&(uParam0->f_49), true, true);
		...
		case 9:
			...
			if (func_212(uParam0) && MISC::GET_GAME_TIMER() - uParam0->f_153 > 500)
			{
				if (activeDynamicScenario2 == joaat("world_player_dynamic_camp_fire_kneel_arthur") || activeDynamicScenario2 == joaat("world_player_dynamic_camp_fire_kneel_mp_female_a") || activeDynamicScenario2 == joaat("world_player_camp_fire_squat_male_a") || activeDynamicScenario2 == joaat("world_player_camp_fire_squat_female_a"))
				{
					if (uParam0->f_134 == 11)
					{
						if (INVENTORY::_INVENTORY_IS_INVENTORY_ITEM_EQUIPPED(func_213(false), joaat("document_player_journal"), false))
							INVENTORY::_INVENTORY_ENABLE_ITEM(func_213(false), joaat("document_player_journal"));
					
						func_214(joaat("document_player_journal"), false, 0, 0, true, false, false);
						uParam0->f_153 = MISC::GET_GAME_TIMER();
						uParam0->f_134 = 0;
					}
					else if (uParam0->f_134 == 10)
					{
						func_214(1259508039, false, 0, 0, true, false, false);
						uParam0->f_153 = MISC::GET_GAME_TIMER();
						uParam0->f_134 = 0;
					}
					else
				...
				{
					func_215(joaat("SIT_TRANS_KNEEL"), 0.5f);
					uParam0->f_153 = MISC::GET_GAME_TIMER();
				}
				...
				{
					func_215(joaat("KNIFE1_TRANS_KNEEL1"), 2f);
					uParam0->f_153 = MISC::GET_GAME_TIMER();
				}
				...
				{
					func_215(joaat("KNEELFIRECRAFTCUP_TRANS_KNEEL1"), 2f);
					uParam0->f_153 = MISC::GET_GAME_TIMER();
				}
			}
...
BOOL func_90(var uParam0) // Position - 0x38DA
{
	if (func_171(Global_33, uParam0->f_1, true) > 30625f)
		return true;

	if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(uParam0->f_95) || !Global_1148185[uParam0->f_12 /*10*/].f_4)
	{
		if (func_195(Global_33, uParam0->f_56, true) < 25f)
		{
			func_61(uParam0, 8192);
			func_61(uParam0, 16384);
			CAM::DO_SCREEN_FADE_OUT(500);
			func_218("NET_WCAMP_OWNER_SHUTDOWN", 10000, 0, 0, 0, true);
		}
...
int func_91(int iParam0) // Position - 0x395F
{
	return iParam0;
}

void func_92(int iParam0) // Position - 0x3969
{
	if (!func_219(iParam0))
		return;
...
void func_93(var uParam0) // Position - 0x3A1C
{
	int i;

	for (i = 0; i < uParam0->f_1; i = i + 1)
	{
		func_46(&uParam0->f_1[i], true, true);
	}

	return;
}

void func_94(var uParam0, BOOL bParam1) // Position - 0x3A47
{
	if (bParam1)
	{
...
void func_96(BOOL bParam0) // Position - 0x3AB1
{
	if (bParam0)
	{
	}
...
void func_97(var uParam0) // Position - 0x3AD8
{
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_49))
...
BOOL func_98(Object* pobParam0, var uParam1) // Position - 0x3BBB
{
...
BOOL func_99(var uParam0, int iParam1) // Position - 0x3BF3
{
	return func_168(*uParam0, iParam1);
}

void func_100(var uParam0, int iParam1) // Position - 0x3C04
{
...
int func_101(Hash hParam0, Hash hParam1, int iParam2, Any anParam3) // Position - 0x3C21
{
	var unk;
	var unk3;
	int num;
	...
	if (func_222(hParam0))
		if (!func_224(func_223(hParam0), hParam1, &unk, false, false))
			return -1;
	else if (func_225(hParam0, hParam1, false, false) < iParam2)
		return -1;

	unk3 = { func_226(hParam0, true, 0) };

	if (func_227(hParam0, &unk3, iParam2, false, true, -1, false))
		return -1;
	...
	if (num2 == 1388422710)
	{
		num = func_229(hParam0, "SPEND STEW FEE", 1, true, false, hParam1);
	}
	else
	{
		unk8 = -1;
		...
		if (func_222(hParam0))
		{
			...
			if (!func_230(&unk8, func_223(hParam0), &unk18, true, hParam1, -1, false, false))
				return -1;
		}
		else
		{
			...
			if (!func_231(&unk8, hParam0, unk3, unk3.f_4, iParam2, &unk36, true, hParam1, -1, true))
				return -1;
		}
	...
	if (func_222(hParam0))
		if (func_232(func_223(hParam0), hParam1) == 1400824947)
			unk53.f_1 = 0;
	else if (func_233(hParam0, hParam1) == 1400824947)
		unk53.f_1 = 0;
...
void func_102(Hash hParam0, int iParam1) // Position - 0x3DC1
{
	int i;
...
BOOL func_103(BOOL bParam0) // Position - 0x3E00
{
	if (func_40() == -1)
		return true;
...
BOOL func_105(Hash hParam0, int iParam1) // Position - 0x3E3A
{
	if (hParam0 == 0)
		return false;
...
struct<2> func_106(int iParam0, Hash hParam1) // Position - 0x3E54
{
	int num;
...
void func_107(var uParam0, var uParam1, int iParam2) // Position - 0x3E6A
{
...
BOOL func_108(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x3E87
{
...
var func_109(Player plParam0) // Position - 0x3EBD
{
	var value;
...
var func_110(int iParam0, int iParam1) // Position - 0x3ECF
{
	return func_238(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

BOOL func_111(int* piParam0, int iParam1, int iParam2) // Position - 0x3EED
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_112() // Position - 0x3F24
{
	return Global_1102813.f_3672;
}

void func_113(var uParam0) // Position - 0x3F33
{
	BOOL flag;
...
void func_114(var uParam0, int iParam1) // Position - 0x4432
{
	switch (iParam1)
	{
		case 0:
...
float func_115() // Position - 0x46E4
{
	if (func_239(Global_1940199, 4194304) || func_240() == 5)
		return 1f;

	return 0.5f;
}

BOOL func_116(var uParam0, float fParam1) // Position - 0x4710
{
	if (!func_241(uParam0))
		return false;
...
void func_117(var uParam0) // Position - 0x4737
{
	int clockHours;
...
void func_118(var uParam0) // Position - 0x47E3
{
	func_242(uParam0, 0f);
	return;
}

void func_119(int iParam0) // Position - 0x47F2
{
	Global_1902887.f_302 = Global_1902887.f_302 || iParam0;
	return;
}

BOOL func_120() // Position - 0x480B
{
	if (Global_1048576)
		return true;
...
struct<2> func_121(int iParam0) // Position - 0x4863
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_122(var uParam0, var uParam1) // Position - 0x4877
{
	if (!func_243(uParam0))
		return false;
	...
	if (uParam0.f_1 >= func_244(uParam0))
		return false;

	return true;
}

int func_123(var uParam0, var uParam1) // Position - 0x48AB
{
	return uParam0;
}

BOOL func_124(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x48B5
{
...
int func_125(var uParam0) // Position - 0x490E
{
	int Sequence;
...
void func_126(var uParam0, float fParam1, BOOL bParam2) // Position - 0x49A4
{
...
void func_127(var uParam0) // Position - 0x49C6
{
	uParam0->f_65 = joaat("p_campfireburntout02x");
	uParam0->f_66 = joaat("p_campfire02x_combo");
	func_161(&(uLocal_28.f_128), 8192);
	func_161(&(uLocal_28.f_128), 64);
	return;
}

void func_128(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0x49F5
{
	int iFlags;
	...
	if (bParam4)
		iFlags = iFlags | 524288;

	MISC::CLEAR_AREA(vParam0, fParam3, iFlags);
	return;
}

BOOL func_129(var uParam0) // Position - 0x4A1C
{
	if (_IS_NULL_VECTOR(uParam0->f_1) || MISC::GET_DISTANCE_BETWEEN_COORDS(uParam0->f_1, Global_34, true) > 150f)
	{
		func_218("NET_WCAMP_OWNER_NO_CLOSE_CAMP", 10000, 0, 0, 0, true);
		return false;
	}

	if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 1))
	{
		func_218("NET_WCAMP_OWNER_WANTED", 10000, 0, 0, 0, true);
		return false;
	}
...
int func_130(var uParam0) // Position - 0x4A82
{
	if (!func_33(uParam0, 32))
		return 1;

	if (ENTITY::GET_ENTITY_SPEED(Global_33) <= 1f || func_246(&(uParam0->f_107), 1.1f))
		return 1;

	return 0;
}

int func_131(var uParam0) // Position - 0x4ABE
{
...
int func_132(Ped pedParam0, int iParam1) // Position - 0x4AF4
{
...
void func_133(var uParam0) // Position - 0x4B0B
{
	PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, joaat("INPUT_AIM"), false);
	return;
}

BOOL func_134() // Position - 0x4B1E
{
	int num;

	num = func_247(7);

	if (num == 0 || num == SCRIPTS::GET_ID_OF_THIS_THREAD())
		return true;

	return false;
}

void func_135(var uParam0, BOOL bParam1) // Position - 0x4B46
{
...
void func_136(var uParam0) // Position - 0x4B66
{
...
float func_137(var uParam0) // Position - 0x4B9A
{
	if (!func_241(uParam0))
		return uParam0->f_1;
...
void func_138(var uParam0) // Position - 0x4BCF
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_139(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x4BE5
{
	uParam0->f_65 == 0;

	if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(vParam1, 15f, uParam0->f_65, true))
		func_251(vParam1, 15f, 2);

	return;
}

void func_140(var uParam0) // Position - 0x4C18
{
...
BOOL func_141(Entity eParam0, int iParam1, var uParam2) // Position - 0x4C9A
{
	...
	DECORATOR::DECOR_SET_INT(eParam0, "fast_travel_camp_barker", iParam1);
	*uParam2 = BRAIN::_START_PRELOADED_SCRIPT_BRAIN(eParam0, "net_fast_travel_barker", 1024, false);
	DECORATOR::DECOR_SET_BOOL(eParam0, "bHasScriptBrain", true);
	SCRIPTS::SET_SCRIPT_AS_NO_LONGER_NEEDED("net_fast_travel_barker");
	return true;
}

void func_142(var uParam0) // Position - 0x4D17
{
	Vector3 vector;
	...
	uParam0->f_62 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_1, uParam0->f_8, vector) };
	return;
}

void func_143(var uParam0, BOOL bParam1) // Position - 0x4D91
{
	if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_99))
		if (!_IS_NULL_VECTOR(uParam0->f_1))
	...
	func_253(uParam0->f_1, 175f, "Player Camp", true, 0, 0, false, -1082130432);

	if (bParam1)
	{
		func_254(uParam0->f_1, 30f, 0, 0, 5, true);
		func_255(uParam0->f_1, 60f, false, false);
		func_128(uParam0->f_1, 60f, false);
	}
	...
	uParam0->f_92 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(joaat("volCylinder"), uParam0->f_1, 0f, 0f, 0f, 0.3f, 0.3f, 2f);
	return;
}

void func_144(var uParam0) // Position - 0x4ED8
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_93))
...
void func_145(var uParam0) // Position - 0x4F32
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_93))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_93))
		{
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_93, false);
			func_257(uParam0->f_93, uParam0->f_62, uParam0->f_8 - 90f, 2, 1073741824);
			PHYSICS::_UNHITCH_HORSE(uParam0->f_93);
			ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_93, false);
			POPULATION::_SET_PED_SHOULD_IGNORE_AVOIDANCE_VOLUMES(uParam0->f_93, 2);
		}
...
int func_146(var uParam0) // Position - 0x4F92
{
	if (!CAM::IS_SCREEN_FADED_OUT())
		return 0;
	...
	if (!func_124(Global_33, -76381094))
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(uLocal_28[0]))
		{
			if (!func_258(Global_34, uParam0->f_1, 5f, true))
				func_257(Global_33, TASK::_GET_SCENARIO_POINT_COORDS(uLocal_28[0], true), uParam0->f_4, 2, 1073741824);
...
void func_147(var uParam0) // Position - 0x4FF7
{
	if (!func_124(uParam0->f_93, 1139527981))
	{
		if (!func_124(uParam0->f_93, SCRIPT_TASK_START_SCENARIO_AT_POSITION))
		{
			TASK::CLEAR_PED_TASKS(uParam0->f_93, true, false);
			TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_93, joaat("world_animal_horse_grazing_camp"), uParam0->f_62, uParam0->f_4, 0, false, true, 0, -1082130432, false);
		}
	}

	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_94))
	{
		if (!func_124(uParam0->f_94, 1139527981))
		{
			if (!func_124(uParam0->f_94, SCRIPT_TASK_START_SCENARIO_AT_POSITION))
			{
				TASK::CLEAR_PED_TASKS(uParam0->f_94, true, false);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_94, joaat("world_animal_horse_grazing_camp"), uParam0->f_62, uParam0->f_4, 0, false, true, 0, -1082130432, false);
			}
		}
	}
...
void func_148(Volume volParam0, int iParam1) // Position - 0x50A4
{
	if (func_260(volParam0))
		return;

	if (func_261(volParam0) == iParam1)
		return;
...
int func_149(Ped pedParam0, Volume volParam1) // Position - 0x50F0
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam1))
		return 0;
...
void func_150(Volume volParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5136
{
	int num;
...
BOOL func_151(var uParam0) // Position - 0x518A
{
...
void func_152(var uParam0) // Position - 0x51D5
{
	if (uParam0->f_18 != 7)
...
void func_153(var uParam0) // Position - 0x51FC
{
	...
	if (PED::IS_PED_CARRYING_SOMETHING(Global_33))
	{
		...
		{
			func_257(Global_33, uParam0->f_1 + 5f, uParam0->f_1.f_1 + 5f, uParam0->f_1.f_2 + 0.5f, uParam0->f_4, 32, 1073741824);
			PED::DETACH_CARRIABLE_ENTITY(firstEntityPedIsCarrying, false, false);
		}
		else
		{
			PED::DETACH_CARRIABLE_ENTITY(firstEntityPedIsCarrying, false, false);
			func_257(firstEntityPedIsCarrying, uParam0->f_1 + 5f, uParam0->f_1.f_1 + 5f, uParam0->f_1.f_2 + 0.5f, uParam0->f_4, 32, 1073741824);
		}
	}
...
int func_154() // Position - 0x528A
{
	return Global_1896646.f_41;
}

BOOL func_155(int iParam0) // Position - 0x5298
{
	if (!func_262(iParam0))
		return false;
...
int func_156() // Position - 0x52B4
{
	...
	func_267(Global_1953292.f_83[func_266(num, 1) /*12*/], 8);
	func_268(23, 0, 0, 0, false);
	return 1;
}

void func_157(var uParam0) // Position - 0x5312
{
...
void func_158(var uParam0) // Position - 0x535F
{
	if (func_108(uParam0->f_93, uParam0->f_60, true, 0))
	{
...
void func_159(BOOL bParam0) // Position - 0x538E
{
	if (!func_32(bParam0))
...
BOOL func_160(Ped pedParam0, Ped pedParam1) // Position - 0x53AB
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
void func_161(var uParam0, int iParam1) // Position - 0x53CD
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_162(var uParam0) // Position - 0x53DE
{
	...
	if (FIRE::GET_NUMBER_OF_FIRES_IN_RANGE(ENTITY::GET_ENTITY_COORDS(uLocal_28.f_129, true, false), 1.5f) > 2)
		return false;

	return true;
}

int func_163(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, Hash hParam10, BOOL bParam11) // Position - 0x547B
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_271(num, hParam1, sParam0, 1, iParam2, iParam3, 0f, 0f, 0f, 0f, 0, 0, 0, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9, 0, 1065353216, false, false, 0, hParam10, bParam11);
		return num;
	}
...
void func_164(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5504
{
	int num;
...
void func_165(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5558
{
	int num;
	...
	num = func_91(iParam0);
	func_273(num, bParam1);
	return;
}

BOOL func_166(Volume volParam0, int iParam1, Ped pedParam2, Ped pedParam3, int iParam4) // Position - 0x5584
{
	...
	entitiesInVolume = ENTITY::_GET_ENTITIES_IN_VOLUME(volParam0, Global_26391, iParam1);

	for (i = 0; i < entitiesInVolume; i = i + 1)
	{
		indexedItemInItemset = ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(i, Global_26391);
		entityFromItem = MISC::_GET_ENTITY_FROM_ITEM(indexedItemInItemset);
	
		if (iParam4 == 1 && ENTITY::IS_ENTITY_DEAD(entityFromItem))
		{
		}
		else if (pedParam2 != entityFromItem && pedParam3 != entityFromItem)
		{
			return true;
		}
	}
...
BOOL func_167(int iParam0, BOOL bParam1) // Position - 0x5605
{
	int num;
	int gameTimer;
	float progress;
...
BOOL func_168(int iParam0, int iParam1) // Position - 0x56FF
{
	return iParam0 && iParam1 != false;
}

BOOL func_169(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x570E
{
...
void func_170(var uParam0) // Position - 0x574F
{
	Hash activeDynamicScenario2;
	...
	if (func_212(uParam0) && MISC::GET_GAME_TIMER() - uParam0->f_153 > 250)
	{
		...
		{
			func_215(joaat("KNIFE1_TRANS_KNEEL1"), 1086324736);
			uParam0->f_153 = MISC::GET_GAME_TIMER();
		}
		else if (activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_CUP") || activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_CUP_MP_FEMALE_A"))
		{
			func_215(joaat("KNEELFIRECRAFTCUP_TRANS_KNEEL1"), 1086324736);
			uParam0->f_153 = MISC::GET_GAME_TIMER();
		}
...
float func_171(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x5800
{
	...
	return func_276(entityCoords, vParam1);
}

void func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x5850
{
	int num;
...
BOOL func_173(var uParam0, BOOL bParam1) // Position - 0x589B
{
	if (bParam1)
		return !func_108(Global_33, uParam0->f_59, true, 0);

	return false;
}

void func_174(Volume volParam0, BOOL bParam1) // Position - 0x58BA
{
	int num;
...
int func_175(Hash hParam0) // Position - 0x58DB
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
int func_176(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5995
{
	var ReturnZ;
	int num;
	BOOL flag;
...
void func_177(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x5A99
{
	int num;

	num = -1;
	func_278(iParam0, uParam1, fParam4, 4, num, 0);
	return;
}

void func_178(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5, BOOL bParam6) // Position - 0x5AB4
{
	int num;
	...
	func_278(iParam0, uParam1, fParam4, 1, num, 0);
	return;
}

void func_179(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x5ADF
{
	int num;

	num = 258;
	func_278(iParam0, uParam1, fParam4, 2, num, 0);
	return;
}

void func_180(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x5AFC
{
	int num;
...
void func_181(var uParam0) // Position - 0x5B19
{
	if (uParam0->f_65)
...
BOOL func_182(Ped pedParam0, int iParam1) // Position - 0x5B72
{
	int num;
...
void func_183(var uParam0) // Position - 0x5C71
{
	int num;
...
void func_184(var uParam0) // Position - 0x5CD7
{
	var args;
	BOOL flag;
	BOOL flag2;
...
int func_185(var uParam0) // Position - 0x5DBB
{
...
BOOL func_186(var uParam0) // Position - 0x5E14
{
	return func_168(uParam0->f_128, 512);
}

void func_187(var uParam0) // Position - 0x5E27
{
	func_56(&(uParam0->f_128), 512);
	return;
}

void func_188(var uParam0) // Position - 0x5E3A
{
...
void func_189(var uParam0, int iParam1) // Position - 0x5E58
{
	func_161(uParam0, iParam1);
	return;
}

void func_190(var uParam0, int iParam1) // Position - 0x5E68
{
...
BOOL func_191(var uParam0) // Position - 0x5E81
{
	return true;
}

BOOL func_192(var uParam0) // Position - 0x5E8A
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_129))
	{
		if (func_168(uParam0->f_127, 512))
		{
			...
			func_176(&offsetFromEntityInWorldCoords, 1, 10, false, false);
...
void func_193(var uParam0) // Position - 0x6059
{
	if (!CAM::_IS_CAM_DATA_DICT_LOADED(&(uParam0->f_18)))
...
BOOL func_194(var uParam0) // Position - 0x6081
{
	Entity firstEntityPedIsCarrying;
	Ped pedIndexFromEntityIndex;
	...
	if (!func_283(Global_33, uParam0->f_129, -0.5f))
		return false;
	...
	if (func_40() == -1)
		if (func_284())
			return false;
	else if (func_284() && !(Global_1915656.f_20241 == 28 || Global_1915656.f_20241 == 27 || Global_1915656.f_20241 == 29))
		return false;
...
float func_195(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x6211
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
	...
	return func_276(ENTITY::GET_ENTITY_COORDS(pedParam0, false, false), ENTITY::GET_ENTITY_COORDS(pedParam1, false, false));
}

void func_196(var uParam0, BOOL bParam1) // Position - 0x6268
{
	int i;
...
BOOL func_198(var uParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4) // Position - 0x62C7
{
	Volume volume;
	...
	if (func_286(&vParam1, 1073741824))
	{
		func_30(volume);
		return true;
	}
...
BOOL func_199(BOOL bParam0) // Position - 0x6367
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_33))
		if (TASK::PED_HAS_USE_SCENARIO_TASK(Global_33) && !TASK::IS_PED_EXITING_SCENARIO(Global_33, true))
			if (TASK::_PED_IS_IN_SCENARIO_BASE(Global_33) || bParam0 && TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_33, 0) || TASK::IS_TASK_MOVE_NETWORK_ACTIVE(Global_33) && TASK::GET_TASK_MOVE_NETWORK_EVENT(Global_33, "SCENARIO_POINT_TRANS_COMPLETE") || func_32(16) && ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, joaat("showMenu")))
				return true;

	return false;
}

int func_200() // Position - 0x63F0
{
	Hash activeDynamicScenario2;
...
void func_201(var uParam0, int iParam1) // Position - 0x6465
{
	uParam0->f_125 = iParam1;
	return;
}

void func_202(var uParam0) // Position - 0x6473
{
	if (!TASK::PED_HAS_USE_SCENARIO_TASK(Global_33) && func_168(uParam0->f_128, 131072) && !PED::IS_PED_CARRYING_SOMETHING(Global_33) && !WEAPON::_0x0DE0944ECCB3DF5D(Global_33))
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_129))
		{
			if (!func_45(uParam0->f_149))
			{
				uParam0->f_149 = func_287("REST_BY_FIRE", joaat("INPUT_CONTEXT_Y"), uParam0->f_129, 1, 1, true, 0, 5, 7f, 570, 4000, 10, 1073741824, 0, joaat("MEDIUM_TIMED_EVENT"), false, 0);
			}
			else if (func_167(uParam0->f_149, true))
			{
				func_206(uParam0);
				func_54(uParam0);
				func_56(&(uParam0->f_128), 131072);
	...
	if (func_45(uParam0->f_149))
		func_172(uParam0->f_149, 1754796591, 0, true);

	return;
}

void func_203(var uParam0) // Position - 0x6542
{
	if (func_168(uParam0->f_128, 131072))
	{
		if (!func_45(uParam0->f_150))
		{
			if (func_288(uParam0))
			{
				uParam0->f_150 = func_287("CRAFT_COOK", joaat("INPUT_CONTEXT_X"), uParam0->f_129, 1, 1, true, 0, 5, 7f, 570, 4000, 10, 1073741824, 0, joaat("MEDIUM_TIMED_EVENT"), false, 0);
				...
				if (func_168(uParam0->f_128, 1024))
				{
					if (func_289(uParam0))
					{
						func_290(uParam0->f_150, "CAMP_REC_COOK", true);
					}
					else
					{
						MISC::CLEAR_BIT(&(Global_1958634.f_1), 2);
						func_164(uParam0->f_150, false, true, true);
					}
				}
			}
		}
		else if (TASK::PED_HAS_USE_SCENARIO_TASK(Global_33) || WEAPON::_0x0DE0944ECCB3DF5D(Global_33) || func_291(872480335) || func_291(joaat("camera_item")) || func_292() || Global_1940199.f_38 == 332793555)
		{
			func_54(uParam0);
			func_56(&(uParam0->f_128), 131072);
		}
		...
		else
		{
			if (func_168(uParam0->f_128, 1024) != func_168(uParam0->f_128, 2048))
			{
				if (func_168(uParam0->f_128, 1024))
				{
					if (func_289(uParam0) && !func_45(Global_1940085.f_85))
					{
						func_290(uParam0->f_150, "CAMP_REC_COOK", true);
						func_164(uParam0->f_150, true, true, true);
						func_161(&(uParam0->f_128), 4096);
					}
					else
					{
						func_46(&(uParam0->f_150), true, true);
						uParam0->f_150 = func_287("CRAFT_COOK", joaat("INPUT_CONTEXT_X"), uParam0->f_129, 0, 1, true, 0, 5, 7f, 570, 4000, 10, 1073741824, 0, joaat("MEDIUM_TIMED_EVENT"), false, 0);
						func_164(uParam0->f_150, false, true, true);
			...
			if (func_167(uParam0->f_150, true))
			{
				func_161(&(uParam0->f_128), 32768);
				MISC::CLEAR_BIT(&(Global_1958634.f_1), 2);
				func_54(uParam0);
	...
	if (func_45(uParam0->f_150))
		func_172(uParam0->f_150, 1754796591, 0, true);

	return;
}

char* func_204(int iParam0) // Position - 0x687F
{
	return "CAMPFIRE";
}

var func_205(BOOL bParam0, var uParam1, var uParam2) // Position - 0x688B
{
	if (bParam0)
		return uParam1;
...
void func_206(var uParam0) // Position - 0x68A2
{
	int num;
	int num2;
	BOOL flag;
	...
	else
	{
		switch (num)
		{
			...
			case 3:
				...
				if (func_32(16) || func_168(uParam0->f_128, 32768) || func_294(684307653, &num2) || func_294(562107429, &num2))
				{
					flag = true;
...
void func_207() // Position - 0x6B2C
{
	if (func_105(joaat("weapon_kit_binoculars"), 0))
		func_297(32);

	if (func_105(joaat("weapon_kit_binoculars_improved"), 0))
		func_297(32);

	if (func_105(joaat("weapon_kit_camera"), 0))
		func_297(64);

	if (func_105(332793555, 0))
		func_297(131072);

	return;
}

void func_208(var uParam0, BOOL bParam1) // Position - 0x6B82
{
	int i;
	...
	for (i = 0; i < 11; i = i + 1)
	{
		if (func_45(uParam0->f_137[i]))
		{
			if (func_298(uParam0->f_137[i], false) == bParam1)
			{
			}
			else
			{
				func_164(uParam0->f_137[i], bParam1, true, true);
			}
		}
	}
...
void func_209(var uParam0) // Position - 0x6BD1
{
	Hash activeDynamicScenario2;
	int num;
	...
	{
		if (func_212(uParam0) && MISC::GET_GAME_TIMER() - uParam0->f_153 > 500 && !func_168(uParam0->f_128, 32768) && !func_32(16) && uParam0->f_134 != 1 && !func_294(684307653, &num) && !func_294(562107429, &num))
		{
			func_118(&(uParam0->f_161));
			func_215(joaat("KNEEL_TRANS_SQUAT"), 0.5f);
			uParam0->f_153 = MISC::GET_GAME_TIMER();
		}
	}
	else if (activeDynamicScenario2 == joaat("world_player_camp_fire_squat_male_a") || activeDynamicScenario2 == joaat("world_player_camp_fire_squat_female_a"))
	{
		if (func_212(uParam0) && MISC::GET_GAME_TIMER() - uParam0->f_153 > 500)
		{
			...
			if (func_116(&(uParam0->f_161), 180f))
			{
				func_118(&(uParam0->f_161));
			
				if (!func_296())
				{
					func_215(joaat("SQUAT_TRANS_SIT"), 0.5f);
					uParam0->f_153 = MISC::GET_GAME_TIMER();
				}
			}
		}
	...
	else if (activeDynamicScenario2 == joaat("world_player_camp_fire_sit_male_a") || activeDynamicScenario2 == joaat("world_player_camp_fire_sit_female_a"))
	{
		if (func_212(uParam0) && MISC::GET_GAME_TIMER() - uParam0->f_153 > 500)
		{
			...
			if (func_116(&(uParam0->f_161), 10f))
			{
				if (func_296())
				{
					func_118(&(uParam0->f_161));
					uParam0->f_153 = MISC::GET_GAME_TIMER();
					func_215(joaat("SIT_TRANS_SQUAT"), 0.5f);
				}
			}
		}
	}
...
BOOL func_210(var uParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x6E1A
{
	int num;
	int num2;
	int num3;
	...
	func_300(uParam0, num);
	num4 = func_301(uParam0);
...
BOOL func_211(var uParam0) // Position - 0x7096
{
...
BOOL func_212(var uParam0) // Position - 0x70F7
{
	BOOL flag;
	BOOL flag2;
	int num;
...
int func_213(BOOL bParam0) // Position - 0x7186
{
	if (func_40() == -1)
	{
...
int func_214(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x71C7
{
	int num;
	var unk10;
	Hash HashOfScriptName;
	var unk26;
	BOOL flag;
	int num2;
	BOOL flag2;
	...
	if (func_307())
	{
		...
		func_308(hParam0, 1, -142743235, false, false);
		return 0;
	}

	if (!func_309(hParam0, bParam4))
		return 0;
	...
	if (func_312(hParam0, -2081717885))
		func_313(hParam0, unk10, num, unk26, flag, num2);
	else if (func_312(hParam0, -1909684001))
		func_314(hParam0, unk10, num, flag, num2);
	else if (func_312(hParam0, 587975446))
		func_315(hParam0, unk10);
	else if (func_312(hParam0, 566155764))
		if (!func_316(hParam0))
			return 0;
	...
	if (func_318(hParam0, bParam5, bParam6, bParam1))
	{
		Global_1913442 = hParam0;
		Global_1913633 = MISC::GET_GAME_TIMER();
		return 1;
	...
	if (func_312(hParam0, -1227898937))
	{
		num.f_2 = hParam0;
		unk10 = { num };
	...
	else if (func_312(hParam0, -1472964441) || func_312(hParam0, -228153877) || func_312(hParam0, 566155764))
	{
	}
	else if (func_312(hParam0, 1919582297))
	{
	...
	else if (func_321(hParam0))
	{
		num.f_3 = 0;
		num.f_1 = hParam0;
		num.f_2 = 0;
		num = func_322(Global_1072759.f_28313.f_25.f_67);
		unk10 = { num };
	...
	else if (func_323(hParam0) == joaat("CLOTHING"))
	{
		if (!func_324(hParam0))
		{
			func_218("SI_ITEM_OUTFIT_IS_LOCKED", 10000, 0, 0, 0, true);
			return num2;
		}
	
		num3 = func_228(hParam0);
		...
		if (!flag2)
		{
			if (func_326(PLAYER::PLAYER_ID()))
				func_218("SI_ITEM_USE_OUTFITS_STATIONARY", 10000, 0, 0, 0, true);
			else
				func_218("SI_ITEM_USE_OUTFITS_NEAR_HORSE", 10000, 0, 0, 0, true);
		...
		else
		{
			switch (num3)
			{
				...
				case 1388798186:
					...
					{
						func_329(Global_33, Global_1953292.f_83[10 /*12*/], 0, -358215195, true, true, true, true, false, true, true, false);
						func_330(hParam0, false, false);
						return 1;
					}
					else
					{
						func_330(hParam0, true, false);
						func_331(-2061583405, false);
					
						if (num3 == 1388798186)
							func_331(119907797, false);
						else if (num3 == 119907797)
							func_331(1388798186, false);
					}
					break;
			
				default:
					if (!func_312(hParam0, 160827531))
						break;
			...
			func_329(Global_33, hParam0, 0, -358215195, true, true, true, false, false, true, true, false);
		}
	}
	else
	{
		switch (hParam0)
		{
			...
			case joaat("kit_camp_simple"):
				if (func_324(joaat("kit_camp")))
				{
					...
					{
						func_218("GC_SELECT_HELP_FOLLOWER_DEAD", 10000, 0, 0, 0, true);
					}
					else if (func_340())
					{
						func_218("NET_CAMP_SET_LOC_CONTENT_LOCK", 10000, 0, 0, 0, true);
					}
					else
					{
						if (GANG::NETWORK_IS_GANG_LEADER(PLAYER::PLAYER_ID()))
							...
							func_218("GC_SELECT_HELP_NOT_LEADER", 10000, 0, 0, 0, true);
				...
				{
					func_218("GC_SELECT_HELP_DISABLED", 10000, 0, 0, 0, true);
				}
				break;
			...
			case -1115561122:
				if (Global_1148185[PLAYER::PLAYER_ID() /*10*/].f_4)
					func_218("NET_WCAMP_OWNER_CAMP_RUNNING", 10000, 0, 0, 0, true);
				else
					func_344();
			...
			case 332793555:
				if (func_42(Global_33, true, 0, false) != hParam0)
			...
			case joaat("kit_wardrobe"):
				...
				if (!func_324(hParam0))
				{
					func_218("SI_ITEM_WARDROBE_IS_LOCKED", 10000, 0, 0, 0, true);
					break;
				}
			
				flag2 = func_333(7, hParam0);
				flag3 = func_333(1, hParam0);
				...
				if (flag3 && !flag2)
				{
					...
					func_218(MISC::VAR_STRING(0, -1680440926, Global_17339), 10000, 0, 0, 0, true);
					break;
				}
			
				if (!func_334(7))
				{
					func_218("SI_ITEM_USE_WARDROBE_NO_SADDLE", 10000, 0, 0, 0, true);
					break;
				}
			
				if (!flag2)
				{
					if (func_335(Global_33, func_245(7), false))
					{
						func_218("SI_ITEM_USE_WARDROBE_STATIONARY", 10000, 0, 0, 0, true);
					}
					else
					{
						if (MAP::DOES_BLIP_EXIST(Global_17339))
						...
						Global_17339 = MAP::_BLIP_ADD_FOR_STYLE(joaat("BLIP_STYLE_PLAYER_HORSE"));
						MAP::BLIP_ADD_MODIFIER(Global_17339, 673950256);
						func_218(MISC::VAR_STRING(0, -482898802, Global_17339), 10000, 0, 0, 0, true);
					}
				
					break;
				}
			
				HashOfScriptName = joaat("player_wardrobe");
			
				if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(HashOfScriptName) > 0)
				{
				}
				else
				{
			...
			case joaat("weapon_kit_binoculars_improved"):
				if (!WEAPON::_IS_WEAPON_BINOCULARS(func_42(Global_33, true, 0, false)))
					WEAPON::SET_CURRENT_PED_WEAPON(Global_33, hParam0, false, 0, false, false);
...
BOOL func_215(Hash hParam0, int iParam1) // Position - 0x7B5A
{
...
BOOL func_216(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x7B89
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	if (AmmoType != 0)
	{
		...
		if (!bParam2)
			func_347(hParam0, -iParam1, flag, flag2, flag3, false, false);
	...
	statId = { func_349(hParam0) };

	if (STATS::STAT_ID_IS_VALID(&statId))
	{
		if (func_350(hParam0, false, false, false) - iParam1 >= 0)
		{
			STATS::_STAT_ID_DECREMENT_INT(&statId, iParam1);
		}
		else if (func_350(hParam0, false, false, false) - iParam1 < 0)
		{
			func_216(hParam0, func_350(hParam0, false, false, false), bParam2, hParam3);
			return false;
		}
	}

	if (func_323(hParam0) == joaat("WEAPON"))
	{
		if (!func_351(hParam0, iParam1, false, hParam3))
			return false;
	}
	else if (!func_308(hParam0, iParam1, hParam3, bParam2, false))
	{
		return false;
	}
	else
	{
		unk2 = { func_226(hParam0, false, 0) };
	
		if (func_103(false) && unk2.f_4 == 1084182731)
			func_352(1, false, 0);
	}
...
BOOL func_217(var uParam0, var uParam1) // Position - 0x7D3B
{
	if (func_353(uParam0))
		return true;
...
int func_218(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x7D51
{
	int num;
	var unk13;
	int num2;
...
BOOL func_219(int iParam0) // Position - 0x7D8C
{
	return func_270(iParam0, 2);
}

void func_220(var uParam0, int iParam1) // Position - 0x7D9B
{
	func_56(uParam0, iParam1);
	return;
}

void func_221(var uParam0) // Position - 0x7DAB
{
	func_189(uParam0, 1);
	return;
}

BOOL func_222(Hash hParam0) // Position - 0x7DBA
{
	return func_354(hParam0) && func_312(hParam0, 1584357097);
}

int func_223(Hash hParam0) // Position - 0x7DD8
{
	if (!func_222(hParam0))
		return 0;
...
BOOL func_224(int iParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8293
{
	var unk;
	int num;
	int i;
	...
	if (!func_355(iParam0, hParam1, &unk, &num, false, true))
		return false;
	...
	for (i = 0; i < num; i = i + 1)
	{
		...
		{
			if (!bParam4 && !func_356(unk[i /*2*/].f_1))
				return false;
		}
		...
		{
			num2 = func_358(num3, unk[i /*2*/]);
		
			if (num2 != 0)
				num4 = func_359(unk[i /*2*/], num2);
			else
				num4 = func_350(unk[i /*2*/], false, bParam3, true);
...
int func_225(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x839A
{
	var unk;
	int num;
	int i;
	...
	if (!func_360(hParam0, hParam1, &unk, &num, true, false))
		return 0;

	flag = !bParam3 && func_103(false) && !func_104();
	num2 = -1;
	num3 = -1;
	...
	for (i = 0; i < num; i = i + 1)
	{
		...
		num4 = func_358(num3, unk[i /*2*/]);
	
		if (num4 != 0)
		{
			bParam2 = false;
			num5 = func_359(unk[i /*2*/], num4);
		}
		else
		{
			num5 = func_350(unk[i /*2*/], false, !flag, true);
		}
	
		if (flag)
		{
			if (func_361(unk[i /*2*/]) || func_362(unk[i /*2*/]))
			{
				num5 = num5 + func_363(unk[i /*2*/], 0);
			
				if (bParam2)
				{
					num6 = 0;
					num5 = num5 + func_364(7, unk[i /*2*/], &num6);
				}
			}
			else if (bParam2)
			{
				num5 = num5 + func_365(7, unk[i /*2*/]) + func_366(unk[i /*2*/]);
			}
		}
...
struct<5> func_226(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x84F1
{
	var unk;
	int num;
	var unk6;
	...
	switch (num)
	{
		case joaat("UPGRADE"):
		case joaat("DOG"):
			if (func_374(hParam0, -1823706425))
			{
				unk = { func_368(joaat("kit_camp"), unk, 1084182731, bParam1) };
				unk.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(hParam0, joaat("kit_camp"));
			}
			else if (func_374(hParam0, -1483207246))
			{
				unk = { func_368(joaat("WARDROBE"), unk, 1034665895, bParam1) };
			...
			else if (func_374(hParam0, -1653629781))
			{
				unk = { func_368(1384535894, unk, 1784584921, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (iParam2 && func_370(hParam0, true))
			{
				unk6.f_9 = -1591664384;
			
				if (!func_371(hParam0, &unk, 1728382685, false, false))
					unk.f_4 = 1728382685;
				else if (!func_371(hParam0, &unk, -649335959, false, false))
					unk.f_4 = -649335959;
				else if (func_372(hParam0, &unk6, 1728382685))
					unk.f_4 = 1728382685;
				else
					unk.f_4 = -649335959;
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(hParam0, -833319691))
			{
				...
				if (!func_375(unk, &unk28, bParam1, false, -1))
				{
					unk.f_4 = 0;
				}
				else
...
BOOL func_227(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x8865
{
	var unk;
	var unk5;
	int num;
	...
	if (!func_105(hParam0, 0) && !func_378(func_377(hParam0), 2))
		return false;

	if (!bParam3 && func_379(hParam0, joaat("DEFAULT")) == 0)
		bParam3 = true;
	...
	if (func_380(hParam0) && WEAPON::IS_WEAPON_A_GUN(hParam0))
	{
		...
		if (!func_371(hParam0, &unk, 1728382685, false, false))
			return false;
		else if (func_372(hParam0, &unk5, 1728382685))
			return false;
	
		if (func_370(hParam0, true))
			if (!func_371(hParam0, &unk, -649335959, false, false))
				return false;
			else if (func_372(hParam0, &unk5, -649335959))
				return false;
	...
	if (iParam5 < 0)
		num = func_381(hParam0, panParam1, bParam3, bParam4);
	...
	num2 = func_382(hParam0, *panParam1, panParam1->f_4, bParam4, bParam3, bParam6);
...
int func_228(Hash hParam0) // Position - 0x8999
{
	var unk;
...
int func_229(Hash hParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, Hash hParam5) // Position - 0x89C4
{
	int cashBalance;
	int goldBarBalance;
	var unk;
	...
	{
		cashBalance = func_383(hParam0, hParam5, true, false, true, joaat("currency_cash")) * iParam2;
		goldBarBalance = 0;
	
		if (cashBalance <= 0)
		{
			goldBarBalance = func_383(hParam0, hParam5, true, false, true, joaat("currency_gold_bar")) * iParam2;
	...
	else if (func_360(hParam0, hParam5, &unk, &num, true, false))
	{
		for (i = 0; i < num; i = i + 1)
		{
	...
	if (!bParam3 && func_103(false))
	{
		if (cashBalance > 0)
		{
			func_308(joaat("currency_cash"), cashBalance, -142743235, 0, false);
		}
		else if (goldBarBalance > 0)
		{
			func_308(joaat("currency_gold_bar"), goldBarBalance, -142743235, 0, false);
		}
		else if (func_384(hParam5))
		{
			for (i = 0; i < num; i = i + 1)
			{
				num2 = unk[i /*2*/].f_1 * iParam2;
				func_308(unk[i /*2*/], num2, -142743235, 0, false);
			}
		}
	...
	num3 = func_385(joaat("spend"), &unk32, bParam4);
...
BOOL func_230(int* piParam0, int iParam1, Any* panParam2, BOOL bParam3, Hash hParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x8BB4
{
	Hash hash;

	if (!func_386(piParam0, false))
		return false;

	if (hParam4 == 0)
		hParam4 = func_387(iParam1, 0, true, iParam5, bParam6);

	if (!func_388(iParam1, hParam4, iParam5))
		return false;
	...
	if (!func_389(piParam0, panParam2, hash, hParam4, bParam3))
		return false;

	return true;
}

BOOL func_231(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, int iParam7, var uParam8, BOOL bParam9, Hash hParam10, int iParam11, BOOL bParam12) // Position - 0x8C3B
{
	var unk;
	...
	if (!func_390(piParam0, hParam1, uParam2, hParam6, hParam10, iParam7, iParam11, bParam12))
		return false;

	unk = { func_391(hParam1, uParam2, hParam6, iParam7, bParam12) };
	unk.f_13 = hParam10;
	unk.f_12 = 1248274121;
	*uParam8 = { unk };

	if (!func_392(piParam0, &unk, 2113164098, bParam9, iParam11))
		return false;

	return true;
}

int func_232(int iParam0, Hash hParam1) // Position - 0x8CB8
{
	Hash data;
...
int func_233(Hash hParam0, Hash hParam1) // Position - 0x8D15
{
	var unk;

	if (func_393(hParam0) || func_312(hParam0, 1077060302))
		return func_232(func_394(hParam0, true), hParam1);
...
void func_234(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x8D6E
{
	int i;
...
int func_235(int iParam0, BOOL bParam1, int iParam2) // Position - 0x8DEC
{
	if (func_395(255))
		return 1;
	...
	if (!func_398(func_397(iParam0), !bParam1, iParam2, 0, false))
		return 0;

	return 1;
}

BOOL func_236(Hash hParam0, int iParam1) // Position - 0x8E3A
{
	int num;
	...
	{
		case 0:
			if (func_399(hParam0) || func_400(hParam0, -1636519629) == -701492487 || hParam0 == joaat("provision_moonshine_poison"))
				return true;
			break;
	
		case 1:
			if (func_312(hParam0, -537818634) || func_312(hParam0, -458578204) && !func_312(hParam0, -1242251796) && !func_312(hParam0, 127710288))
				return true;
			break;
		...
		case 2:
			if (num == joaat("AMMO"))
			{
				if (func_312(hParam0, -1588156645))
					return false;
		...
		case 4:
			if (func_312(hParam0, 127710288))
				return true;
			break;
	
		case 5:
			if (func_312(hParam0, -1242251796))
				return true;
			break;
	}
...
int func_237(int iParam0) // Position - 0x8F80
{
	int num;
	int num2;
	...
	if (!func_398(func_405(iParam0), false, 255, 0, false))
		return 0;

	return 1;
}

var func_238(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x8FDD
{
	var value;
	Player bitIndex;
	int i;
	...
	else
	{
		...
		{
			case joaat("volBox"):
				volume = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(fParam0, fParam3, fParam6, func_407());
				break;
		
			case joaat("volSphere"):
				volume = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(fParam0, fParam3, fParam6, func_407());
				break;
		
			case joaat("volCylinder"):
				volume = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(fParam0, fParam3, fParam6, func_407());
				break;
		}
	}

	if (flag4 & 8 != 0)
		flag4 = flag4 || func_408(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
BOOL func_239(int iParam0, int iParam1) // Position - 0x9370
{
	return iParam0 && iParam1 != false;
}

int func_240() // Position - 0x937F
{
	return Global_1893611.f_2;
}

BOOL func_241(var uParam0) // Position - 0x938D
{
	return func_411(*uParam0, 1);
}

void func_242(var uParam0, float fParam1) // Position - 0x939D
{
...
BOOL func_243(int iParam0) // Position - 0x93C3
{
	switch (iParam0)
	{
		case 2:
...
int func_244(int iParam0) // Position - 0x9402
{
	switch (iParam0)
	{
		case 2:
...
Ped func_245(int iParam0) // Position - 0x9498
{
...
BOOL func_246(var uParam0, float fParam1) // Position - 0x94C4
{
...
int func_247(int iParam0) // Position - 0x94E2
{
	iParam0 = func_414(iParam0);
...
BOOL func_248(var uParam0) // Position - 0x9510
{
	Ped riderOfMount;
	...
	riderOfMount = PED::_GET_RIDER_OF_MOUNT(uParam0->f_93, true);

	if (ENTITY::DOES_ENTITY_EXIST(riderOfMount))
		if (riderOfMount != Global_33)
			return false;

	if (!func_415(Global_33, uParam0->f_93, 50f, true, true))
		return false;

	return true;
}

BOOL func_249(var uParam0) // Position - 0x9575
{
	return func_411(*uParam0, 2);
}

float func_250() // Position - 0x9585
{
...
void func_251(Vector3 vParam0, var uParam1, var uParam2, float fParam3, int iParam4) // Position - 0x95B7
{
	int iFlags;
...
BOOL func_252(int iParam0) // Position - 0x9623
{
...
Volume func_253(Vector3 vParam0, var uParam1, var uParam2, float fParam3, char* sParam4, BOOL bParam5, Entity eParam6, int iParam7, BOOL bParam8, int iParam9) // Position - 0x9642
{
	Volume volume;
	int num;
	var entityCoords;
...
void func_254(Vector3 vParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x96FC
{
	var offsetFromCoordAndHeadingInWorldCoords;
	var offsetFromCoordAndHeadingInWorldCoords2;
	Vector3 vector;
	...
	if (iParam4 == 1)
		PATHFIND::SET_ROADS_BACK_TO_ORIGINAL(vector, vector2, iParam5, true);
	else if (iParam6 == 5)
		PATHFIND::SET_ROADS_IN_AREA(vector, vector2, iParam4, bParam7, iParam5);
	else
		PATHFIND::_0xAFE2AE66F6251C66(vector, vector2, iParam6, bParam7);

	return;
}

void func_255(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4, BOOL bParam5) // Position - 0x9792
{
	int iFlags;
...
int func_256(Ped pedParam0) // Position - 0x97C8
{
	int attributeRank;
...
void func_257(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x97FE
{
	...
	pedParam0 == func_418(Global_33) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE();

	if (func_419(pedParam0))
		if (func_420(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0)))
			PHYSICS::_UNHITCH_HORSE(pedParam0);

	if (func_279(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(pedParam0))
	{
		pedIndexFromEntityIndex = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0);
		...
		if (PED::IS_PED_ON_VEHICLE(pedIndexFromEntityIndex, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && !ENTITY::IS_ENTITY_DEAD(vehiclePedIsIn))
			{
				...
				func_257(vehiclePedIsIn, fParam1, fParam4, iParam5, iParam6);
			}
		...
		else if (PED::IS_PED_ON_MOUNT(pedIndexFromEntityIndex))
		{
			...
			{
				iParam5 = iParam5 - iParam5 & 4;
				func_257(mount, fParam1, fParam4, iParam5, iParam6);
			}
	...
	if (func_279(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, fParam1, fParam4, true, func_279(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, fParam1, fParam4, true, func_279(iParam5, 32), true);
	...
	else if (func_279(iParam5, 129))
	{
		...
		ENTITY::_SET_ENTITY_COORDS_AND_HEADING_NO_OFFSET(pedParam0, fParam1, fParam4, func_279(iParam5, 32), true);
	}
	else
	{
		ENTITY::_SET_ENTITY_COORDS_AND_HEADING(pedParam0, fParam1, fParam4, true, func_279(iParam5, 32), true);
	...
	if (isEntityAPed)
	{
		...
		PED::SET_PED_CLOTH_PIN_FRAMES(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0), 1);
	
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0) == Global_33 && !func_279(iParam5, 64))
		{
...
BOOL func_258(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x9A79
{
	if (bParam7)
...
void func_259() // Position - 0x9AAD
{
	...
	if (func_294(684307653, &num) || func_294(562107429, &num))
	{
		TASK::TASK_USE_SCENARIO_POINT(Global_33, uLocal_28[0], "WORLD_PLAYER_DYNAMIC_CAMP_FIRE_KNEEL_MP_FEMALE_A", 0, false, true, 0, false, -1082130432, false);
	}
	else if (func_296())
	{
		if (PED::IS_PED_MALE(Global_33))
			conditionalAnim = "WORLD_PLAYER_CAMP_FIRE_SQUAT_MALE_A";
		else
			conditionalAnim = "WORLD_PLAYER_CAMP_FIRE_SQUAT_FEMALE_A";
	
		TASK::TASK_USE_SCENARIO_POINT(Global_33, uLocal_28[0], conditionalAnim, 0, false, true, 0, false, -1082130432, false);
	}
	else
	{
...
BOOL func_260(Volume volParam0) // Position - 0x9B44
{
	int i;
...
int func_261(Volume volParam0) // Position - 0x9B70
{
	int i;
...
BOOL func_262(int iParam0) // Position - 0x9BA5
{
	if (iParam0 == 0)
		return false;
...
BOOL func_263(int iParam0) // Position - 0x9BB8
{
	int num;
	int num2;
	int offset;
...
BOOL func_264(var uParam0) // Position - 0x9BE2
{
	if (func_294(81053684, uParam0))
		return true;

	if (func_294(-525676072, uParam0))
		return true;

	return false;
}

int func_265(Hash hParam0) // Position - 0x9C0F
{
	var unk;

	unk = { func_226(hParam0, true, 0) };
	return func_422(unk.f_4);
}

int func_266(Hash hParam0, int iParam1) // Position - 0x9C2B
{
	switch (hParam0)
	{
		case -1944638739:
...
void func_267(Hash hParam0, int iParam1) // Position - 0x9DFC
{
	var unk;
	int num;
	int num2;
	...
	num = func_265(hParam0);
	num2 = func_266(num, 1);

	if (num2 == 39)
		return;

	if (func_423(hParam0) && func_424(hParam0))
		iParam1 = iParam1 | 64;

	if (num == 1108822547 && func_425(32768) || hParam0 != Global_1953292.f_1676.f_1[num2 /*3*/])
	{
		if (func_423(Global_1953292.f_1676.f_1[num2 /*3*/]) && func_424(Global_1953292.f_1676.f_1[num2 /*3*/]))
			iParam1 = iParam1 | 32;
		...
		switch (func_228(hParam0))
		{
			case -525676072:
				if (func_425(32768))
					func_428(func_427(num2, 1));
			
				if (func_294(81053684, &unk2))
				{
					num3 = func_266(func_426(81053684), 1);
			...
			case 81053684:
				if (func_294(-525676072, &unk))
				{
					num3 = func_266(func_426(-525676072), 1);
				...
				if (func_312(hParam0, -180472385) && func_294(1024667707, &unk))
				{
					num3 = func_266(func_426(1024667707), 1);
	...
	func_429(num, iParam1, 6);
	return;
}

void func_268(int iParam0, Hash hParam1, int iParam2, Ped pedParam3, BOOL bParam4) // Position - 0xA016
{
	int num;
...
BOOL func_269(Ped pedParam0) // Position - 0xA048
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
BOOL func_270(int iParam0, int iParam1) // Position - 0xA063
{
	if (iParam0 < 0)
		return false;
...
void func_271(int iParam0, Hash hParam1, char* sParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, float fParam9, Volume volParam10, Ped pedParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, BOOL bParam21, BOOL bParam22, Hash hParam23, Hash hParam24, BOOL bParam25) // Position - 0xA084
{
	Prompt prompt;
...
void func_272(int iParam0, int iParam1) // Position - 0xA39E
{
	if (iParam0 < 0)
		return;
...
void func_273(int iParam0, BOOL bParam1) // Position - 0xA3D1
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
		if (Global_1951910[iParam0 /*23*/].f_5 == 5 && !func_270(iParam0, 8))
...
void func_274(int iParam0, BOOL bParam1) // Position - 0xA429
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_275(int iParam0, int iParam1) // Position - 0xA452
{
	if (iParam0 < 0)
		return;
...
float func_276(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xA47A
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_277(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0xA498
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

void func_278(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0xA4C1
{
	if (!func_43(iParam0))
	{
...
BOOL func_279(int iParam0, int iParam1) // Position - 0xA4F5
{
	return iParam0 && iParam1 != false;
}

BOOL func_280(Ped pedParam0) // Position - 0xA504
{
	return func_432(pedParam0, 4) || func_432(pedParam0, 5);
}

BOOL func_281(Ped pedParam0) // Position - 0xA520
{
	return func_432(pedParam0, 7);
}

BOOL func_282(Ped pedParam0) // Position - 0xA52F
{
	return func_432(pedParam0, 6);
}

BOOL func_283(Ped pedParam0, Entity eParam1, float fParam2) // Position - 0xA53E
{
	return func_169(pedParam0, ENTITY::GET_ENTITY_COORDS(eParam1, false, false), fParam2);
}

BOOL func_284() // Position - 0xA556
{
	return Global_1915656.f_20637 || Global_1915656.f_22504.f_1;
}

int func_285(var uParam0) // Position - 0xA574
{
	float num;
	int num2;
	ItemSet itemSet;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(uParam0->[i]))
		{
			...
			else if (!PED::_CAN_PED_USE_SCENARIO_POINT(Global_33, uParam0->[i], 0, 0, 1) && !func_32(64))
			{
			}
			else
			{
				...
				if (func_198(&itemSet, TASK::_GET_SCENARIO_POINT_COORDS(uParam0->[i], true), 1065353216))
				{
				}
				else
				{
					num3 = func_276(Global_34, uParam0->f_5[i /*3*/]);
...
BOOL func_286(var uParam0, int iParam1) // Position - 0xA62F
{
	Volume volume;
...
int func_287(char* sParam0, Hash hParam1, Ped pedParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, int iParam16) // Position - 0xA676
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_271(num, hParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, pedParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, false, bParam5, 0, hParam14, iParam16);
		return num;
	}
...
BOOL func_288(var uParam0) // Position - 0xA74D
{
...
BOOL func_289(var uParam0) // Position - 0xA792
{
	Entity firstEntityPedIsCarrying;
	Hash entityModel;
	Hash hash;
	...
	if (ENTITY::IS_ENTITY_A_PED(firstEntityPedIsCarrying))
	{
		...
		hash = func_434(entityModel);
	
		if (func_399(hash) && !ENTITY::_IS_ENTITY_FULLY_LOOTED(firstEntityPedIsCarrying) && FLOCK::_GET_ANIMAL_RARITY(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(firstEntityPedIsCarrying)) != 2 && !FIRE::_IS_ENTITY_CONSUMED_BY_FIRE(firstEntityPedIsCarrying))
		{
			uParam0->f_49.f_62 = hash;
			uParam0->f_49.f_63 = -214678071;
		
			if (func_45(uParam0->f_150))
				func_172(uParam0->f_150, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(firstEntityPedIsCarrying), 0, true);
...
void func_290(int iParam0, char* sParam1, BOOL bParam2) // Position - 0xA821
{
	int num;
...
BOOL func_291(Hash hParam0) // Position - 0xA86A
{
	int i;
...
void func_293(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA8CF
{
	Ped EntityIndex;
	Hash entityModel;
	var unk;
	...
	EntityIndex = func_435(pedParam0);
	...
	if (!func_103(false) || func_104())
	{
		entityModel = ENTITY::GET_ENTITY_MODEL(EntityIndex);
		func_436(entityModel, 0);
	}
	else if (PED::IS_PED_HUMAN(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(EntityIndex)))
	{
		unk.f_1 = 10;
		unk.f_12 = 10;
		MISC::_LOOT_TABLES_GET_INFO(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(EntityIndex), true, true, ENTITY::GET_ENTITY_MODEL(EntityIndex), &unk, 0);
		...
		for (i = 0; i < 10; i = i + 1)
		{
			...
			if (func_105(hash, 0))
				if (!bParam1 || func_361(hash))
					func_437(hash, unk.f_12[i], bParam2, false, false, 752097756, 0, 0, 0, false);
		}
	}
	else
	{
		outInventoryItemArray = 10;
		pedDamageCleanliness = PED::_GET_PED_DAMAGE_CLEANLINESS(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(EntityIndex));
	
		if (func_348(joaat("provision_trinket_buck_antler"), 1))
		{
		...
		animalRarity = FLOCK::_GET_ANIMAL_RARITY(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(EntityIndex));
		skinningQuality = func_438(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(EntityIndex), animalRarity);
		PED::_COMPUTE_SATCHEL_ITEM_FOR_PED_CARCASS(&outInventoryItemArray, ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(EntityIndex), pedDamageCleanliness, skinningQuality);
	
		for (j = 0; j < outInventoryItemArray; j = j + 1)
		{
			if (outInventoryItemArray[j] != 0)
				if (func_439(EntityIndex) && !func_440(outInventoryItemArray[j]))
					outInventoryItemArray[j] = 0;
				else if (!bParam1 || func_361(outInventoryItemArray[j]))
					func_437(outInventoryItemArray[j], 1, bParam2, false, false, 752097756, 0, 0, 0, false);
		}
	}

	hash2 = func_441(&EntityIndex);

	if (!func_105(hash2, 0))
		hash2 = func_442(EntityIndex);

	if (func_105(hash2, 0))
		func_443(hash2, 1, pedParam0, true, -142743235);

	ENTITY::_DELETE_CARRIABLE(&EntityIndex);
	return;
}

BOOL func_294(int iParam0, var uParam1) // Position - 0xAABF
{
	Hash hash;
	int num;

	num = func_266(func_426(iParam0), 1);
	...
	if (Global_1953292.f_1676.f_1[num /*3*/] != 0 && Global_1953292.f_1676.f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		...
		if (func_228(hash) == iParam0 || iParam0 == 81053684 && func_312(hash, 160827531))
		{
			*uParam1 = hash;
			return true;
		}
...
int func_295(int iParam0) // Position - 0xAB55
{
	Hash ReturnWeaponType;

	ReturnWeaponType = 0;

	if (WEAPON::GET_CURRENT_PED_WEAPON(Global_33, &ReturnWeaponType, true, iParam0, false))
		if (func_105(ReturnWeaponType, 0))
			if (WEAPON::_IS_WEAPON_TWO_HANDED(ReturnWeaponType) || func_444(ReturnWeaponType))
				return 1;

	return 0;
}

BOOL func_296() // Position - 0xAB94
{
...
void func_297(int iParam0) // Position - 0xAC83
{
	Global_1940085.f_39 = Global_1940085.f_39 || iParam0;
	return;
}

BOOL func_298(int iParam0, BOOL bParam1) // Position - 0xAC9A
{
	if (bParam1 && !func_45(iParam0))
		return false;
...
void func_299(int iParam0, BOOL bParam1) // Position - 0xACBF
{
	int num;
	int num2;

	func_445(iParam0, &num, &num2);

	if (!func_446(iParam0, num, num2, bParam1))
		return;
...
void func_300(var uParam0, int iParam1) // Position - 0xACEC
{
	int num;
	...
	if (func_168(iParam1, 1))
	{
		...
		{
			uParam0->f_137[0] = func_163("KNEEL_FIRE", joaat("INPUT_CONTEXT_B"), 2, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
			func_172(uParam0->f_137[0], 1754796591, 0, true);
		}
	}
	else if (func_45(uParam0->f_137[0]))
	{
		func_46(&uParam0->f_137[0], true, true);
	}
	...
	if (func_168(iParam1, 4096) && func_168(uParam0->f_127, 16) && !func_32(128) && uParam0->f_134 != 2)
	{
		...
		{
			uParam0->f_137[2] = func_163("CRAFT_COOK", joaat("INPUT_CONTEXT_X"), 2, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
			func_172(uParam0->f_137[2], 1754796591, 0, true);
		}
	}
	else
	{
		...
		if (func_45(uParam0->f_137[2]))
			func_46(&uParam0->f_137[2], true, true);
	}
	...
	if (func_45(uParam0->f_137[6]))
		func_46(&uParam0->f_137[6], true, true);

	if (func_32(32))
		if (func_45(uParam0->f_137[6]))
			func_164(uParam0->f_137[6], false, true, true);
	else if (func_45(uParam0->f_137[6]) && !func_298(uParam0->f_137[6], false))
		func_164(uParam0->f_137[6], true, true, true);

	if (func_32(32) || func_168(uParam0->f_128, 2) && uParam0->f_134 != 2)
		if (func_45(uParam0->f_137[2]))
			func_164(uParam0->f_137[2], false, true, true);
	else if (func_45(uParam0->f_137[2]))
		func_164(uParam0->f_137[2], true, true, true);

	if (func_168(iParam1, 16) && !func_32(128) && uParam0->f_134 != 2)
	{
		if (!func_45(uParam0->f_137[1]))
		{
			uParam0->f_137[1] = func_163("LEAVE", joaat("INPUT_CONTEXT_B"), 1, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
		
			if (func_168(iParam1, 524288) && func_168(uParam0->f_128, 8192))
			{
				func_165(uParam0->f_137[1], false, true);
				func_448(uParam0->f_137[1], 20, true, true);
				func_448(uParam0->f_137[1], 13, true, true);
			}
		
			func_172(uParam0->f_137[1], 1754796591, 0, true);
		}
		...
		if (func_168(iParam1, 524288) && func_168(uParam0->f_128, 8192))
		{
			...
			{
				uParam0->f_137[8] = func_163("LEAVE", joaat("INPUT_CONTEXT_B"), 2, 0, 0, 5, 570, 4000, 10, 1073741824, joaat("MEDIUM_TIMED_EVENT"), false);
				func_448(uParam0->f_137[8], 19, true, true);
				func_448(uParam0->f_137[8], 20, true, true);
				func_448(uParam0->f_137[8], 13, true, true);
				func_449(&uParam0->f_137[8], "INPUT_PCAMP_TEARDWN");
				func_172(uParam0->f_137[8], 1754796591, 0, true);
			}
		}
		else if (func_45(uParam0->f_137[8]))
		{
			func_46(&uParam0->f_137[8], true, true);
		}
	}
	else
	{
		if (func_45(uParam0->f_137[1]))
			func_46(&uParam0->f_137[1], true, true);
	...
	{
		if (func_45(uParam0->f_137[1]) && func_298(uParam0->f_137[1], false))
		{
			func_164(uParam0->f_137[1], false, true, true);
		
			if (func_168(iParam1, 524288) && func_168(uParam0->f_128, 8192))
				func_165(uParam0->f_137[1], false, true);
		}
	}
	else if (func_45(uParam0->f_137[1]) && !func_298(uParam0->f_137[1], false))
	{
		func_164(uParam0->f_137[1], true, true, true);
	
		if (func_168(iParam1, 524288) && func_168(uParam0->f_128, 8192))
			func_165(uParam0->f_137[1], false, true);
	}

	if (func_168(iParam1, 1048576) && !func_32(128) && uParam0->f_134 != 12 && func_348(-1993676214, 1))
	{
		if (!func_45(uParam0->f_137[10]))
		{
			uParam0->f_137[10] = func_163("CAMP_FAST_TRAVEL", joaat("INPUT_CONTEXT_Y"), 2, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
			func_172(uParam0->f_137[10], 1754796591, 0, true);
		}
	}
	else if (func_45(uParam0->f_137[10]))
	{
		func_46(&uParam0->f_137[10], true, true);
	}
...
int func_301(var uParam0) // Position - 0xB297
{
	int i;
	...
	for (i = 0; i < 11; i = i + 1)
	{
		if (func_45(uParam0->f_137[i]))
		{
			if (i == 1)
			{
				if (func_298(uParam0->f_137[i], false))
				{
					if (func_450(uParam0->f_137[i], true))
					{
						return i;
					}
					else if (func_451())
					{
						...
						if (func_246(&(uParam0->f_155), 0.5f))
							return i;
					}
			...
			{
				if (func_167(uParam0->f_137[i], true))
				{
					return i;
				}
				else if (i == 8)
				{
					if (func_452(uParam0->f_137[8], true))
					{
						if (!func_241(&(uParam0->f_49.f_71)))
							func_118(&(uParam0->f_49.f_71));
						else if (func_116(&(uParam0->f_49.f_71), 0.1f))
							func_290(uParam0->f_137[8], "CAMP_TEARDOWN", true);
					}
					else
					{
						if (func_241(&(uParam0->f_49.f_71)))
						...
						func_290(uParam0->f_137[8], "LEAVE", true);
					}
				}
			}
			else if (func_450(uParam0->f_137[i], true))
			{
				if (i == 2)
...
BOOL func_302(var uParam0) // Position - 0xB445
{
	...
	switch (uParam0->f_134)
	{
		case 1:
			...
			{
				case 6:
					if (func_215(joaat("KNEEL1_TRANS_COFFEE1"), 1f))
						return 1;
					break;
				...
				case 8:
					func_215(joaat("SQUAT_TRANS_KNEEL"), 0.5f);
					break;
...
BOOL func_303(var uParam0) // Position - 0xB4F8
{
	if (func_453(uParam0) && !func_168(uParam0->f_128, 4))
		return 1;
	...
	switch (uParam0->f_134)
	{
		case 1:
			...
			{
				case 6:
					func_215(joaat("KNEEL2_TRANS_COFFEE2"), 1f);
					return 1;
...
BOOL func_304(var uParam0) // Position - 0xB5A9
{
	if (func_453(uParam0) && !func_168(uParam0->f_128, 4))
		return 1;
...
BOOL func_305(var uParam0) // Position - 0xB65F
{
	if (func_453(uParam0) && !func_168(uParam0->f_128, 4))
		return 1;
...
BOOL func_306() // Position - 0xB715
{
	return Global_1940252.f_2 || Global_1940252 == 1;
}

BOOL func_307() // Position - 0xB72F
{
...
BOOL func_308(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB746
{
	int num;
	var unk;
	var unk6;
	...
	num = func_379(hParam0, joaat("DEFAULT"));

	if (num != 0)
		return func_458(hParam0, iParam1, hParam2, bParam3, bParam4);

	unk = { func_226(hParam0, bParam4, 0) };
	unk6 = { func_368(hParam0, unk, unk.f_4, bParam4) };
	return func_459(hParam0, &unk6, &unk, iParam1, hParam2, bParam3, bParam4);
}

BOOL func_309(Hash hParam0, BOOL bParam1) // Position - 0xB7BE
{
	BOOL flag;
	int num;

	flag = func_312(hParam0, 1816455607);
	...
	if (hParam0 != 1259508039 && hParam0 != joaat("kit_camp") && hParam0 != joaat("kit_camp_simple") && bParam1)
	{
		...
		if (func_312(hParam0, 1147021565))
			num = num | 64;
	
		if (!func_461(true, num))
			return false;
	}
...
BOOL func_310(Hash hParam0) // Position - 0xB890
{
	if (func_321(hParam0))
		return false;

	if (!INVENTORY::_INVENTORY_IS_INVENTORY_ITEM_EQUIPPED(func_213(false), hParam0, func_463(false)))
		return false;
	...
	switch (hParam0)
	{
		...
		case joaat("KIT_HANDHELD_CATALOG"):
			if (func_465() != -1)
			{
				func_218(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(func_465()), 10000, 0, 0, 0, true);
				func_467(-1);
			}
			break;
	}
...
BOOL func_311(Hash hParam0) // Position - 0xB90F
{
	var unk;
...
BOOL func_312(Hash hParam0, Hash hParam1) // Position - 0xB941
{
	if (!func_105(hParam0, 0))
		return func_468(func_377(hParam0), hParam1);
...
void func_313(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, BOOL bParam28, int iParam29) // Position - 0xB982
{
	return;
}

void func_314(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, BOOL bParam27, int iParam28) // Position - 0xB98A
{
	return;
}

void func_315(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0xB992
{
	return;
}

BOOL func_316(Hash hParam0) // Position - 0xB99A
{
	if (func_40() == 0 && func_470(func_469(hParam0), true, false) != 0)
	{
		func_218("NET_ALOOT_HELP_OPEN_FAIL", 10000, 0, 0, 0, true);
		return false;
	}
...
BOOL func_317(Hash hParam0) // Position - 0xB9D3
{
	if (func_400(hParam0, 1120943070) == 1816455607)
	{
		func_471(0);
		func_473(func_472(hParam0));
		return true;
	}
...
BOOL func_318(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xBA02
{
	if (func_474(hParam0, bParam1, false, 0, -1082130432))
	{
		Global_1913443 = MISC::GET_GAME_TIMER() + 3000;
		return true;
	}

	switch (func_400(hParam0, -949239683))
	{
		case -1919515848:
			if (!bParam1)
			{
		...
		case 845883585:
			if (!bParam1)
			{
				...
				{
					func_218("SI_ITEM_USE_POMADE_IS_ALREADY_APPLIED", 10000, 0, 0, 0, true);
				}
			}
			break;
...
void func_319(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, int iParam16) // Position - 0xBE1F
{
	int i;
	...
	if (!func_491(iParam16, 2))
		if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&(uParam0.f_10))) > 0 || func_492(&(uParam0.f_10)))
			return;
...
BOOL func_320() // Position - 0xBEBB
{
	return Global_1893611 & 2 != 0;
}

BOOL func_321(Hash hParam0) // Position - 0xBECB
{
	if (!func_105(hParam0, 0))
		return false;

	if (func_323(hParam0) == joaat("emote"))
		return true;

	return false;
}

int func_322(int iParam0) // Position - 0xBEF5
{
	return func_494(iParam0);
}

int func_323(Hash hParam0) // Position - 0xBF03
{
	var unk;
...
BOOL func_324(Hash hParam0) // Position - 0xBF2E
{
	if (hParam0 == 0)
		return false;

	if (func_323(hParam0) == joaat("CLOTHING"))
		func_228(hParam0) == -999503751;

	return true;
}

BOOL func_325() // Position - 0xBF5D
{
	Player PlayerIndex;
...
BOOL func_326(Player plParam0) // Position - 0xC012
{
	Ped playerPed;
	Ped mountOwnedByPlayer;
...
int func_327(Hash hParam0, BOOL bParam1) // Position - 0xC044
{
	int num;
	...
	if (func_497(hParam0))
	{
		...
		if (func_228(hParam0) == 81053684 || func_312(hParam0, 160827531) && !func_312(hParam0, -1303648999))
			if (bParam1)
				func_498(&num, 2);
	
		return func_499(hParam0, num);
	}

	return 0;
}

void func_328(Hash hParam0) // Position - 0xC0BB
{
	int num;
	Hash hash;
	...
	if (hash == hParam0)
	{
		...
		func_329(Global_33, -2065815962, 0, -358215195, true, true, true, true, false, true, true, true);
		func_330(hParam0, false, false);
		return;
	}

	PED::_SET_PED_BLACKBOARD_BOOL(Global_33, "PlayEquipHatFidget", true, 15);
	func_329(Global_33, hParam0, 0, -358215195, true, true, true, true, false, true, true, true);
	...
	if (func_501(-2061583405, false))
	{
		if (func_424(hash))
			func_330(hash, false, false);
		else
			func_502(hash, true, true, false, false, false);
	...
	else if (func_424(hParam0))
	{
		if (hParam0 != func_503(0))
		{
			func_504(hParam0, hash, false, false, false);
			func_330(hParam0, false, false);
			func_330(hash, false, false);
		}
		else
...
int func_329(Ped pedParam0, Hash hParam1, Hash hParam2, Hash hParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0xC211
{
	var unk;
	int num;
	...
	{
		unk = { func_226(hParam1, true, 0) };
		hParam3 = func_422(unk.f_4);
	
		if (hParam3 == -358215195)
			return 0;
	}

	if (!func_505(hParam1, hParam2, func_266(hParam3, 1), bParam4, true, false, true))
		return 0;

	func_506(true, bParam5, bParam9, true, bParam11);

	if (bParam10)
		if (func_507(hParam1, false))
			func_508(Global_1953292.f_1676.f_1[func_266(hParam3, 1) /*3*/], false, false);
		else
			func_508(hParam1, true, false);
	...
	switch (hParam3)
	{
		case 1108822547:
			...
			{
				func_500();
				func_268(21, hParam3, 256, 0, false);
			}
		...
		case 1145151482:
		case 1742327865:
			if (bParam7 && hParam1 != Global_1953292.f_83[func_266(hParam3, 1) /*12*/])
				func_268(27, 0, 0, 0, false);
			break;
	}
	...
	{
		func_268(19, 0, num, 0, false);
	}
	else
	{
		num = num | 1;
		func_268(19, 0, num, pedParam0, false);
	}

	return 1;
}

void func_330(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC36A
{
	var unk;
	var guid;

	unk = { func_226(hParam0, bParam2, 0) };
	guid = { func_368(hParam0, unk, unk.f_4, bParam2) };

	if (func_382(hParam0, unk, unk.f_4, bParam2, false, false) <= 0)
		return;

	INVENTORY::_INVENTORY_SET_INVENTORY_ITEM_IN_USE(func_213(bParam2), &guid, bParam1);
	return;
}

Hash func_331(int iParam0, BOOL bParam1) // Position - 0xC3BA
{
	int i;
	Hash hash;
	Hash hash2;
	...
	unk4 = { func_368(joaat("WARDROBE"), func_367(bParam1), 1034665895, bParam1) };
	...
	for (i = 0; i < Global_1953292.f_3352.f_26; i = i + 1)
	{
		...
		if (func_228(hash) == iParam0 || iParam0 == 81053684 && func_312(hash, 160827531))
		{
			guid = { func_368(hash, unk4, hash3, bParam1) };
		
			if (INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_IN_USE(func_213(bParam1), &guid))
			{
				hash2 = hash;
				INVENTORY::_INVENTORY_SET_INVENTORY_ITEM_IN_USE(func_213(bParam1), &guid, false);
			}
		}
	}
...
void func_332(BOOL bParam0, int iParam1) // Position - 0xC475
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
BOOL func_333(int iParam0, Hash hParam1) // Position - 0xC497
{
	Ped EntityIndex;
	...
	EntityIndex = func_245(iParam0);

	if (!ENTITY::DOES_ENTITY_EXIST(EntityIndex))
		return 0;

	if (ENTITY::IS_ENTITY_DEAD(EntityIndex) || PED::IS_PED_INJURED(EntityIndex))
		return 0;

	if (PED::IS_PED_SWIMMING(Global_33) || PED::IS_PED_SWIMMING(EntityIndex))
		return 0;

	if (PED::IS_PED_ON_MOUNT(Global_33))
		if (PED::_GET_RIDER_OF_MOUNT(EntityIndex, false) == Global_33)
...
BOOL func_334(int iParam0) // Position - 0xC53E
{
	Ped EntityIndex;
	...
	if (EntityIndex == PLAYER::_GET_SADDLE_HORSE_FOR_PLAYER(PLAYER::PLAYER_ID()))
		return true;

	return false;
}

BOOL func_335(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0xC597
{
...
void func_336() // Position - 0xC601
{
	...
	{
		num = func_520(func_519());
	
		if (num != -1)
		{
			func_218(AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(num), 10000, 0, 0, 0, true);
...
BOOL func_337(int iParam0, int iParam1) // Position - 0xC6F8
{
	Any gangId;
	...
	if (iParam0 == 1 && func_279(Global_1147183.f_8, 1))
		return false;
...
int func_338(int iParam0, BOOL bParam1) // Position - 0xC7B8
{
	if (bParam1)
		func_526();
...
BOOL func_339(int iParam0) // Position - 0xC7F4
{
	return func_279(Global_1147183.f_8, iParam0);
}

BOOL func_340() // Position - 0xC808
{
	int num;

	num = func_529(PLAYER::PLAYER_ID());

	if (num != -1)
		if (Global_1141332[num /*27*/].f_18.f_1 != 0 && func_279(Global_1141332[num /*27*/].f_18, 1))
			return true;

	return false;
}

void func_341() // Position - 0xC84A
{
	int num;
	int num2;
	...
	if (func_122(num))
	{
		if (num == 6)
		{
			num2 = func_530(PLAYER::PLAYER_ID(), false);
		
			if (num2 != -1)
				if (func_531(num2) == joaat("posse_versus"))
					func_218("GC_SELECT_FAIL_POSSE_VERSUS", 10000, 0, 0, 0, true);
				else if (num2 == 1)
					func_218("GC_SELECT_FAIL_CHALLENGE", 10000, 0, 0, 0, true);
				else
					func_218("GC_SELECT_FAIL_EVENT", 10000, 0, 0, 0, true);
		}
		else
		{
			func_218("GC_SELECT_GENERAL_FAIL", 10000, 0, 0, 0, true);
		}
	}
...
void func_342(Any anParam0) // Position - 0xC8DA
{
	var unk;
	...
	unk.f_6 = anParam0;
	unk.f_4 = 56;
	func_532(unk, func_110(0, 8), false, false);
	return;
}

void func_343(BOOL bParam0) // Position - 0xC91F
{
...
BOOL func_345(Hash hParam0) // Position - 0xC96E
{
	return func_323(hParam0) == joaat("consumable");
}

Hash func_346(Hash hParam0, int iParam1) // Position - 0xC982
{
	int num;
	var unk;
	Hash hash;
	...
	if (func_312(hParam0, 1399091007))
	{
		func_534(hParam0, &unk, &hash);
		return hash;
	}
...
void func_347(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xC9FC
{
	BOOL flag;
	int value;
	var unk;
	...
	if (!func_535() || bParam6)
	{
		func_536(hParam0, iParam1, bParam2, bParam4, bParam3, bParam5);
		return;
	}
	...
	else if (bParam2 && func_538(hParam0, 2097152))
	{
	...
	if (num == joaat("AMMO") && hParam0 != joaat("ammo_hatchet") && hParam0 != joaat("ammo_hatchet_cleaver") && hParam0 != joaat("ammo_hatchet_hunter") && hParam0 != joaat("ammo_tomahawk_ancient") && hParam0 != joaat("ammo_poisonbottle") && hParam0 != joaat("AMMO_MOONSHINEJUG_MP") && !func_312(hParam0, -1982291600) && !func_312(hParam0, 137764179))
	{
		num2 = joaat("ammo_types");
		num3 = joaat("ammo_types");
	}

	num4 = func_228(hParam0);
	...
	else if (!func_539(hParam0, &InputString, num3, num2, 0, joaat("ui_itemviewer")))
	{
	...
	if (func_312(hParam0, 474910316))
	{
		StringToTest = func_540(hParam0);
	...
	if (func_312(hParam0, 1816585950))
	...
	hash = func_542(hParam0, false);

	if (func_543(num4) && func_312(hParam0, -306684263) && hash != 0)
	{
		hash = func_544(hParam0);
	}
	else if (func_323(hParam0) == joaat("CLOTHING"))
	{
		hash2 = func_545(hParam0);
	
		if (func_105(hash2, 0))
			hash = func_542(hash2, false);
	}

	if (func_546(hParam0, 1443104131) && bParam3)
	{
		value2 = 1;
		func_547(hParam0, -915411861, &value2, false);
	...
	str3 = func_548(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash), value), num5);
	...
	if (num4 == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || num4 == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || num4 == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || num4 == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str3 = MISC::VAR_STRING(0, func_549(hParam0, -442898163));

	if (num4 == -126813555 || num4 == 1946043663)
	{
		TEXT_LABEL_ASSIGN_STRING(&unk7, "", 128);
	
		if (func_550(hParam0, &unk7))
			str3 = func_552(func_551(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_553(str3, InputString.f_1, MISC::GET_HASH_KEY(InputString), num6, num5, str2, str, 0, true);
	return;
}

BOOL func_348(Hash hParam0, int iParam1) // Position - 0xCED7
{
	int num;
...
struct<2> func_349(Hash hParam0) // Position - 0xCF5A
{
	var unk;
	var unk3;
	...
	if (func_312(hParam0, -305066475))
		if (func_40() == -1)
			if (func_312(hParam0, -537818634))
				return func_556(joaat("MEDICINE_AND_DEADEYE_ITEMS"));
			else
				return func_556(joaat("deadeye_items"));
	else if (func_312(hParam0, -537818634))
		return func_556(joaat("medicine_items"));

	if (func_312(hParam0, 2084895747))
		return func_556(joaat("lock_breaker_items"));

	return unk3;
}

int func_350(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xCFEE
{
	...
	{
		return func_557(hParam0, false);
	}

	if (func_379(hParam0, joaat("DEFAULT")) != 0)
	{
		inventoryItemCountWithItemid = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_213(bParam2), hParam0, bParam3);
	}
	else
	{
		guid = { func_558(hParam0, bParam2) };
	
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&guid))
			return 0;
	
		inventoryItemCountWithItemid = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_213(bParam2), &guid, bParam3);
	}

	return inventoryItemCountWithItemid;
}

BOOL func_351(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0xD0B0
{
	var unk;
	int num;
	int num2;
	...
	unk = { func_559(hParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };

	if (bParam2)
		func_560(&unk, func_369(false));

	if (!func_561(&unk, &num, &num2, false))
		return false;
	...
	for (i = 0; i < num2; i = i + 1)
	{
		...
		else
		{
			...
			if (func_459(hParam0, &unk19, &unk33, 1, hParam3, 0, false))
				num3 = num3 + 1;
		}
	}
...
void func_352(BOOL bParam0, BOOL bParam1, int iParam2) // Position - 0xD17C
{
...
BOOL func_353(var uParam0) // Position - 0xD1B6
{
	Hash activeDynamicScenario2;
	int num;
	int num2;
	...
	if (func_32(64) && uParam0->f_125 < 9)
	{
		...
		if (MISC::GET_GAME_TIMER() - uParam0->f_154 > 1000 && func_569(&(uParam0->f_49)))
		{
			...
			func_93(&(uParam0->f_49));
			func_100(&(uParam0->f_49), 2);
			uParam0->f_137[3] = func_163("CRAFT_FASTER", joaat("INPUT_GAME_MENU_ACCEPT"), 2, 0, 0, 6, 7000, 10000, 25, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
			func_571(uParam0, 3, false, false, false);
			func_164(uParam0->f_137[3], false, true, true);
			func_172(uParam0->f_137[3], -1067771379, 0, true);
	...
	PED::SET_PED_CAN_PLAY_GESTURE_ANIMS(Global_33, false, 1);
	...
	switch (uParam0->f_125)
	{
		case 0:
			...
			if (func_212(uParam0) || ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, joaat("showMenu")) && func_578(activeDynamicScenario2) || func_576(&(uParam0->f_49)) == 12)
			{
				...
				if (func_576(&(uParam0->f_49)) == 11)
				{
					...
					else if (func_99(&(uParam0->f_49), 8192))
					{
						...
						func_93(&(uParam0->f_49));
						func_46(&uParam0->f_137[3], true, true);
						num = 6000;
						num2 = 10000;
						...
						uParam0->f_137[3] = func_163("CRAFT_FASTER", joaat("INPUT_GAME_MENU_ACCEPT"), 2, 0, 0, 6, num, num2, 25, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
						func_571(uParam0, 3, false, false, false);
						func_164(uParam0->f_137[3], false, true, true);
						func_172(uParam0->f_137[3], -1067771379, 0, true);
						func_581();
		...
		case 1:
			if (func_212(uParam0) && MISC::GET_GAME_TIMER() - uParam0->f_153 > 250)
			{
				...
				{
					func_215(joaat("KNEELFIRECRAFTCUP_TRANS_KNEELFIRECRAFT"), 1086324736);
					func_201(uParam0, 2);
				}
				else
				{
					func_215(joaat("KNEEL1_TRANS_KNEELFIRECRAFT"), 1086324736);
					func_201(uParam0, 2);
				}
		...
		case 2:
			if (!func_298(uParam0->f_137[3], false) && MISC::GET_GAME_TIMER() - uParam0->f_153 > 500)
				if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 1070143458) || func_212(uParam0))
					func_164(uParam0->f_137[3], true, true, true);
		
			if (func_167(uParam0->f_137[3], true))
			{
				if (PAD::_0x1252C029FC8EBB4D())
					PAD::_0x709BA8C08C5C008D();
			
				func_571(uParam0, 3, true, false, false);
				func_46(&uParam0->f_137[3], true, true);
			
				if (func_323(uParam0->f_49.f_62) == joaat("consumable") && !func_312(uParam0->f_49.f_62, -1242251796) && !func_312(uParam0->f_49.f_62, 1919582297) && !func_312(uParam0->f_49.f_62, -651046900) && !func_312(uParam0->f_49.f_62, 127710288))
				{
					uParam0->f_137[5] = func_163("USE_ITEM", joaat("INPUT_GAME_MENU_TAB_RIGHT_SECONDARY"), 1, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
					func_172(uParam0->f_137[5], -1067771379, 0, true);
					func_448(uParam0->f_137[5], 10, true, true);
					uParam0->f_137[4] = func_163("STOW_ITEM", joaat("INPUT_GAME_MENU_OPTION"), 1, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
					func_448(uParam0->f_137[4], 10, true, true);
					func_172(uParam0->f_137[4], -1067771379, 0, true);
				
					if (func_400(uParam0->f_49.f_62, -1636519629) == -701492487)
					{
						func_290(uParam0->f_137[5], "DRINK", true);
						func_164(uParam0->f_137[4], false, true, true);
					}
				
					if (!func_582(2))
						func_164(uParam0->f_137[5], false, true, true);
				...
				{
					func_584(uParam0->f_49.f_62, uParam0->f_49.f_63, true, func_583(), uParam0->f_49.f_12);
					func_585(uParam0->f_49.f_62, 1, 1, true, 0);
				}
			...
			else if (func_298(uParam0->f_137[3], false))
			{
				func_586(uParam0, activeDynamicScenario2);
			}
			break;
		...
		case 3:
			if (func_212(uParam0))
			{
				if (func_246(&(uParam0->f_158), 0.1f))
				{
					...
					{
						uParam0->f_153 = MISC::GET_GAME_TIMER();
						func_215(joaat("KNEELFIRECRAFTACTIVE_TRANS_KNEELFIRECRAFT"), 1f);
						func_118(&(uParam0->f_158));
					}
					else
					{
						uParam0->f_153 = MISC::GET_GAME_TIMER();
						func_215(joaat("KNEELFIRECRAFT_TRANS_KNEELPOSTFIRECRAFT"), 1086324736);
					}
				}
			}
			...
			if (func_45(uParam0->f_137[5]))
			{
				if (func_298(uParam0->f_137[5], false) && func_450(uParam0->f_137[5], true) || PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, joaat("INPUT_CRAFTING_EAT")))
				{
					func_216(uParam0->f_49.f_62, 1, false, -142743235);
					ATTRIBUTE::STOP_ITEM_PREVIEW();
					func_585(uParam0->f_49.f_62, 1, 1, false, 0);
					func_46(&uParam0->f_137[5], true, true);
					func_46(&uParam0->f_137[4], true, true);
					func_588(uParam0, true, false);
			...
			if (!func_45(uParam0->f_137[5]) || func_298(uParam0->f_137[4], false) && func_589(uParam0->f_137[4], true) || PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, joaat("INPUT_GAME_MENU_OPTION")) || func_160(Global_33, 0))
			{
				func_46(&uParam0->f_137[5], true, true);
				func_46(&uParam0->f_137[4], true, true);
				ATTRIBUTE::STOP_ITEM_PREVIEW();
		...
		case 4:
			if (func_212(uParam0) && MISC::GET_GAME_TIMER() - uParam0->f_153 > 100 || func_241(&(uParam0->f_158)))
			{
				if (activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_ACTIVE") || activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_ACTIVE_MP_FEMALE_A"))
				{
					func_215(joaat("KNEELFIRECRAFTACTIVE_TRANS_KNEELFIRECRAFTCUP_STOW"), 1086324736);
				}
				...
				{
					func_215(joaat("KNEELFIRECRAFT_TRANS_KNEELFIRECRAFTCUP_STOW"), 1086324736);
					func_215(joaat("KNEELPOSTFIRECRAFT_TRANS_KNEELFIRECRAFTCUP_STOW"), 1086324736);
				}
				else
				{
					func_215(joaat("KNEELPOSTFIRECRAFT_TRANS_KNEELFIRECRAFTCUP_STOW"), 1086324736);
		...
		case 5:
			...
			if (func_212(uParam0) && MISC::GET_GAME_TIMER() - uParam0->f_153 > 100 || func_241(&(uParam0->f_158)))
			{
				if (activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_ACTIVE") || activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_ACTIVE_MP_FEMALE_A"))
				{
					func_215(joaat("KNEELFIRECRAFTACTIVE_TRANS_KNEELFIRECRAFTCUP_CONSUME"), 1086324736);
				}
				else if (activeDynamicScenario2 == joaat("world_player_dynamic_kneel_fire_craft") || activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_MP_FEMALE_A"))
				{
					func_215(joaat("KNEELFIRECRAFT_TRANS_KNEELFIRECRAFTCUP_CONSUME"), 1086324736);
					func_215(joaat("KNEELPOSTFIRECRAFT_TRANS_KNEELFIRECRAFTCUP_CONSUME"), 1086324736);
				}
				else
				{
					func_215(joaat("KNEELPOSTFIRECRAFT_TRANS_KNEELFIRECRAFTCUP_CONSUME"), 1086324736);
		...
		case 15:
			...
			{
				func_598(uParam0, true);
			
				if (uParam0->f_125 == 14 || uParam0->f_125 == 15)
				{
					if (func_32(256))
						func_107(func_106(joaat("cooked"), -444296448), 1);
				...
				{
					if (func_32(256))
						func_107(func_106(joaat("MADE"), -444296448), 1);
		...
		case 12:
			...
			if (func_298(uParam0->f_137[3], false))
				if (func_160(Global_33, 0))
					func_164(uParam0->f_137[3], false, true, true);
		
			if (func_45(uParam0->f_137[9]))
			{
				if (func_450(uParam0->f_137[9], true))
				{
					if (func_99(&(uParam0->f_49), 131072))
					{
						func_220(&(uParam0->f_49), 131072);
						func_571(uParam0, 3, false, true, false);
					}
					else
					{
			...
			if (func_450(uParam0->f_137[3], true))
			{
			...
			else if (func_450(uParam0->f_137[7], true))
			{
				func_599(&(uParam0->f_137));
				func_201(uParam0, 0);
				func_100(&(uParam0->f_49), 15);
			...
			else if (func_167(uParam0->f_137[1], true))
			{
				func_599(&(uParam0->f_137));
				func_201(uParam0, 0);
				func_56(&(uParam0->f_128), 128);
			...
			else if (func_452(uParam0->f_137[1], true))
			{
				if (!func_241(&(uParam0->f_49.f_71)))
					func_118(&(uParam0->f_49.f_71));
				else if (func_116(&(uParam0->f_49.f_71), 0.1f))
					func_290(uParam0->f_137[1], "CAMP_REC_QUIT", true);
			}
			else
			{
				if (func_241(&(uParam0->f_49.f_71)))
				...
				if (func_45(uParam0->f_137[1]))
					func_290(uParam0->f_137[1], "CAMP_REC_BACK", true);
			}
			break;
		...
		case 9:
			if (func_212(uParam0))
			{
				...
				if (activeDynamicScenario2 == joaat("world_player_dynamic_kneel_knife") || activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_KNIFE_MP_FEMALE_A"))
				{
					func_215(joaat("KNIFE1_TRANS_COOKKNIFE"), 1086324736);
					func_159(2);
					func_201(uParam0, 10);
				}
				else
				{
					func_215(joaat("KNEEL1_TRANS_COOKKNIFE"), 1086324736);
					func_159(2);
					func_201(uParam0, 10);
				}
			}
		...
		case 10:
			...
			if (func_167(uParam0->f_137[3], true))
			{
				...
				uParam0->f_137[4] = func_163("STOW_ITEM", joaat("INPUT_GAME_MENU_OPTION"), 1, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
				uParam0->f_137[5] = func_163("EAT_MEAT", joaat("INPUT_CRAFTING_EAT"), 1, 0, 0, 0, 570, 4000, 1, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
				func_448(uParam0->f_137[5], 10, true, true);
				func_448(uParam0->f_137[4], 10, true, true);
				func_172(uParam0->f_137[4], -1067771379, 0, true);
				func_172(uParam0->f_137[5], -1067771379, 0, true);
			
				if (func_592(uParam0->f_49.f_62, 1, false))
					func_164(uParam0->f_137[4], false, true, true);
				else if (!func_582(2))
					func_164(uParam0->f_137[5], false, true, true);
				...
				if (!func_103(false) || func_104())
				{
					num3 = func_99(&(uParam0->f_49), 131072) ? func_593(3, uParam0->f_49.f_27) : 1;
					uParam0->f_49.f_24 = func_101(uParam0->f_49.f_62, uParam0->f_49.f_63, num3, uParam0->f_49.f_12);
					func_164(uParam0->f_137[5], false, true, true);
					func_164(uParam0->f_137[4], false, true, true);
				}
				else
				{
					...
					func_585(uParam0->f_49.f_62, num3, 1, true, 0);
				}
			...
			else
			{
				...
				{
					num4 = func_595(uParam0->f_137[3], true);
					num4 = func_596(num4, 0f, 1f);
		...
		case 11:
			if (func_212(uParam0))
			{
				if (func_246(&(uParam0->f_158), 0.1f))
				{
					...
					if (activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ACTIVE_ARTHUR") || activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ACTIVE_MP_FEMALE_A"))
						func_215(joaat("COOKKNIFE_SEAR_TRANS_BETWEEN_BITES"), 2f);
					else
						func_215(joaat("COOKKNIFE_TRANS_BETWEEN_BITES"), 2f);
				}
			}
			...
			if (func_45(uParam0->f_137[5]))
			{
				if (func_298(uParam0->f_137[5], false) && func_450(uParam0->f_137[5], true) || PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, joaat("INPUT_CRAFTING_EAT")))
				{
					...
					func_46(&uParam0->f_137[5], true, true);
					func_46(&uParam0->f_137[4], true, true);
					func_46(&uParam0->f_137[9], true, true);
					func_588(uParam0, true, true);
					PAD::_SET_CONTROL_CONTEXT(5, 417620729);
					func_216(uParam0->f_49.f_62, 1, false, -142743235);
					uParam0->f_153 = MISC::GET_GAME_TIMER();
					func_201(uParam0, 13);
			...
			{
				if (func_298(uParam0->f_137[4], false) && func_450(uParam0->f_137[4], true) || PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, joaat("INPUT_GAME_MENU_OPTION")) || func_160(Global_33, 0) || TASK::IS_PED_SCENARIO_REACT_LOOKING(Global_33, true))
				{
					ATTRIBUTE::STOP_ITEM_PREVIEW();
					func_46(&uParam0->f_137[4], true, true);
					func_46(&uParam0->f_137[5], true, true);
		...
		case 13:
			...
			{
				if (activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ACTIVE_ARTHUR") || activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ACTIVE_MP_FEMALE_A"))
					func_215(joaat("COOKKNIFE_SEAR_TRANS_KNIFE1_EAT"), 1f);
					...
					func_215(joaat("COOKKNIFE_TRANS_KNIFE1_EAT"), 1f);
				else
					func_215(joaat("BETWEEN_BITES_TRANS_KNIFE1_EAT"), 2f);
		...
		case 16:
			...
			{
				if (activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ACTIVE_ARTHUR") || activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ACTIVE_MP_FEMALE_A"))
					func_215(joaat("COOKKNIFE_SEAR_TRANS_KNIFE1_STOW"), 1f);
				else if (activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ARTHUR") || activeDynamicScenario2 == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_MP_FEMALE_A"))
					func_215(joaat("COOKKNIFE_TRANS_KNIFE1_STOW"), 1f);
				else
					func_215(joaat("BETWEEN_BITES_TRANS_KNIFE1_STOW"), 1f);
...
BOOL func_354(Hash hParam0) // Position - 0xE767
{
	return func_228(hParam0) == 1868067663;
}

// Unhandled jump detected. Output should be considered invalid
BOOL func_355(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xE77B
{
	int i;
	...
	*uParam3 = ITEMDATABASE::_0xF540239F9937033B(iParam0, hParam1);
	...
	if (bParam5)
		func_602(iParam0, hParam1, uParam2, *uParam3);

	return true;
}

BOOL func_356(int iParam0) // Position - 0xE80A
{
	if (iParam0 < 0)
		return false;
...
BOOL func_357(int iParam0) // Position - 0xE837
{
	if (iParam0 < 0)
		return false;
...
int func_358(int iParam0, Hash hParam1) // Position - 0xE85A
{
	if (iParam0 == 15 && func_312(hParam1, -2051813666))
		return 1;

	return 0;
}

int func_359(Hash hParam0, int iParam1) // Position - 0xE87F
{
	var unk;
	var guid;
	...
	unk = { func_367(false) };
	unk.f_4 = func_605(iParam1);
	guid = { func_368(hParam0, unk, unk.f_4, false) };

	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&guid))
		return 0;

	inventoryItemCountWithGuid = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_213(false), &guid, false);
	return inventoryItemCountWithGuid;
}

// Unhandled jump detected. Output should be considered invalid
BOOL func_360(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xE8DA
{
	int i;
	...
	*uParam3 = ITEMDATABASE::_0xDEE7B3C76ED664BE(hParam0, hParam1);
	...
	if (bParam4)
		func_606(hParam0, hParam1, uParam2, *uParam3);

	return true;
}

BOOL func_361(Hash hParam0) // Position - 0xE96A
{
	if (!func_105(hParam0, 0))
		return false;

	if (func_312(hParam0, joaat("ci_tag_item_meat_animal")))
		return true;

	return func_362(hParam0);
}

BOOL func_362(Hash hParam0) // Position - 0xE999
{
	if (!func_105(hParam0, 0))
		return 0;

	if (func_312(hParam0, -839724752))
		return 1;

	return 0;
}

int func_363(Hash hParam0, int iParam1) // Position - 0xE9C3
{
	int num;
	int num2;
	int num3;
	...
	if (!func_361(hParam0) && !func_362(hParam0))
		return 0;
	...
	unk.f_7 = -1;
	unk.f_8 = -1;
	num4 = func_400(hParam0, 1697966752);

	if (num4 == 0)
		return 0;

	unk = { func_607(-1591664384, -1591664384, 0, 235313564, 0, 0, -1, num4, 0) };

	if (func_608(unk, &num2, &num3, 0))
	{
		for (i = 0; i < num3; i = i + 1)
		{
			hash = func_609(i, num2);
		
			if (func_105(hash, 0) && hParam0 != hash)
			{
				hash2 = func_610(hash);
			
				if (hash2 != 0)
				{
					num5 = func_359(hash, iParam1);
				
					if (num5 > 0)
						num = num + (num5 * func_612(hash2, func_611(hash), hParam0));
				}
			}
		}
...
int func_364(int iParam0, Hash hParam1, var uParam2) // Position - 0xEAE0
{
	Ped EntityIndex;
	ItemSet itemSet;
	int itemsetSize;
	...
	if (PED::IS_PED_INJURED(EntityIndex))
		return 0;

	if (TASK::IS_PED_IN_WRITHE(EntityIndex))
		return 0;

	itemSet = ITEMSET::CREATE_ITEMSET(true);
	PED::FIND_ALL_ATTACHED_CARRIABLE_ENTITIES(EntityIndex, itemSet);
...
int func_365(int iParam0, Hash hParam1) // Position - 0xEC0D
{
	Ped EntityIndex;
	Hash hash;
	int num;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (PED::_GET_PELT_FROM_HORSE(EntityIndex, i) != hash)
		{
		}
		else
		{
...
int func_366(Hash hParam0) // Position - 0xECAB
{
	int num;
	Entity firstEntityPedIsCarrying;
...
struct<4> func_367(BOOL bParam0) // Position - 0xECFD
{
	int num;
	...
	if (Global_1572887.f_14 == 0)
	{
		...
		if (num == 2)
		{
			if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Global_1292143))
				Global_1292143 = { func_368(joaat("character"), func_616(), -1591664384, bParam0) };
		...
		else if (num == 3)
		{
			if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&(Global_1292143.f_12)))
				Global_1292143.f_12 = { func_368(joaat("character"), func_616(), -1591664384, false) };
		
			return Global_1292143.f_12;
		}
	}

	return func_368(joaat("character"), func_616(), -1591664384, bParam0);
}

struct<4> func_368(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xED9D
{
	var outGuid;
...
struct<4> func_369(BOOL bParam0) // Position - 0xEDCE
{
	int num;
	...
	if (num == 2)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&(Global_1292143.f_4)))
			Global_1292143.f_4 = { func_368(923904168, func_367(bParam0), -740156546, bParam0) };
	...
	else if (num == 3)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&(Global_1292143.f_16)))
			Global_1292143.f_16 = { func_368(923904168, func_367(bParam0), -740156546, false) };
	
		return Global_1292143.f_16;
	}

	return func_368(923904168, func_367(bParam0), -740156546, false);
}

BOOL func_370(Hash hParam0, BOOL bParam1) // Position - 0xEE6F
{
	if (func_228(hParam0) == 1779021115)
		return 0;
...
BOOL func_371(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEEA6
{
	return func_382(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_372(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0xEEC1
{
	var unk;

	if (func_618(hParam0, &unk, panParam1, hParam2))
		return panParam1->f_17 > 0f;

	return false;
}

struct<4> func_373(BOOL bParam0) // Position - 0xEEE2
{
	int num;
	...
	if (num == 2 || num == 3)
	{
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&(Global_1292143.f_8)))
			Global_1292143.f_8 = { func_368(271701509, func_367(bParam0), 12999093, false) };
	
		return Global_1292143.f_8;
	}

	return func_368(271701509, func_367(bParam0), 12999093, false);
}

BOOL func_374(Hash hParam0, int iParam1) // Position - 0xEF4C
{
	Hash hash;
	int num;
	int i;
	...
	for (i = 0; i < fitsSlotCount; i = i + 1)
	{
		if (ITEMDATABASE::_ITEMDATABASE_GET_FITS_SLOT_INFO(num, i, &hash))
			if (func_619(hParam0, iParam1, hash))
				return true;
	}
...
BOOL func_375(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0xEFB9
{
	return func_620(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_376(var uParam0) // Position - 0xEFCF
{
	if (!func_105(*uParam0, 0))
		return 0;
...
Hash func_377(Hash hParam0) // Position - 0xF059
{
	return hParam0;
}

BOOL func_378(Hash hParam0, int iParam1) // Position - 0xF063
{
	if (hParam0 == 0)
		return false;
...
int func_379(Hash hParam0, int iParam1) // Position - 0xF07D
{
	if (iParam1 == 0)
		return 0;

	if (func_378(func_377(hParam0), 2))
		return 0;

	return ITEMDATABASE::_ITEMDATABASE_GET_ITEM_PATHSET(hParam0, iParam1);
}

BOOL func_380(Hash hParam0) // Position - 0xF0A9
{
	return func_323(hParam0) == joaat("WEAPON");
}

int func_381(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF0BD
{
	if (!func_105(hParam0, 0))
	{
		if (func_378(func_377(hParam0), 2))
	...
	if (!bParam2 && func_379(hParam0, joaat("DEFAULT")) == 0)
		bParam2 = true;
...
int func_382(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xF131
{
	int inventoryItemCountWithGuid;
	var guid;
	...
	if (!bParam7 && func_379(hParam0, joaat("DEFAULT")) == 0)
		bParam7 = true;
	...
	if (bParam7)
	{
		guid = { func_368(hParam0, uParam1, hParam5, bParam6) };
	
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&guid))
			return 0;
	
		inventoryItemCountWithGuid = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_213(bParam6), &guid, bParam8);
	}
	else
	{
		inventoryItemCountWithGuid = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_213(bParam6), hParam0, bParam8);
	}
...
// Unhandled jump detected. Output should be considered invalid
int func_383(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0xF1B0
{
	var unk;
	int num;
	int i;
	...
	if (bParam4 && hParam1 == -915411861 && func_622(hParam0, 59806960))
		hParam1 = 59806960;

	if (func_393(hParam0) || func_312(hParam0, 1077060302))
		return func_623(func_394(hParam0, false), hParam1, bParam3, true);

	if (!func_360(hParam0, hParam1, &unk, &num, bParam2, bParam3))
	{
		!bParam3;
		return 0;
	}
...
BOOL func_384(Hash hParam0) // Position - 0xF2A0
{
	switch (hParam0)
	{
		case -1551258934:
...
int func_385(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0xF2CD
{
	int num;
	...
	if (bParam2)
		if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_START(&num, joaat("basket"), hParam0))
			return func_626(func_625(num, hParam0, panParam1), num, panParam1);
	else
		return func_627(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(hParam0, &num, panParam1, 17), num, panParam1);

	return -1;
}

BOOL func_386(int* piParam0, BOOL bParam1) // Position - 0xF337
{
	if (!bParam1)
		if (func_628(piParam0))
			return false;

	if (func_629(&(piParam0->f_6)))
...
Hash func_387(int iParam0, int iParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0xF3D3
{
	int num;
	BOOL flag;
	BOOL flag2;
	...
	flag = func_168(iParam3, 2);
	flag2 = func_630(iParam0, -570078785, flag);
	flag3 = func_630(iParam0, -915411861, flag);

	if (func_630(iParam0, 997808187, flag))
		iParam1 = 997808187;
	else if (bParam4 && func_631(iParam0, &num) || func_632(iParam0, &num))
		iParam1 = num;
	else if (flag2 && !flag3)
		iParam1 = -570078785;
	else if (flag2 && flag3)
		...
		iParam1 = -915411861;
	else if (func_634(15) && func_630(iParam0, 369710026, flag))
		iParam1 = 369710026;
...
BOOL func_388(int iParam0, Hash hParam1, int iParam2) // Position - 0xF4D8
{
	if (iParam0 == 0)
		return false;

	if (!func_630(iParam0, hParam1, false))
		return false;

	if (func_168(iParam2, 2))
		if (func_635(iParam0, hParam1))
			return false;
	...
	if (func_168(iParam2, 8))
		return func_636(iParam0, hParam1);

	return true;
}

BOOL func_389(int* piParam0, Any* panParam1, Hash hParam2, Hash hParam3, BOOL bParam4) // Position - 0xF538
{
	var unk;
	int num;
	...
	if (!func_355(panParam1->f_17, hParam3, &unk, &num, false, true))
		return false;

	switch (num)
	{
		case 1:
			return func_637(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 2:
			return func_638(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 3:
			return func_639(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 4:
			return func_640(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 5:
			return func_641(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 6:
			return func_642(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 7:
			return func_643(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 8:
			return func_644(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 9:
			return func_645(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 10:
			return func_646(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 11:
			return func_647(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 12:
			return func_648(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 13:
			return func_649(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 14:
			return func_650(piParam0, panParam1, hParam2, &unk, bParam4);
	
		case 15:
			return func_651(piParam0, panParam1, hParam2, &unk, bParam4);
...
BOOL func_390(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, Hash hParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xF6C0
{
	Hash hash;
	...
	if (func_652(hParam1))
	{
		...
		return func_653(piParam0, hash, hParam7, iParam8, iParam9);
	}

	if (func_168(iParam9, 32))
		if (!func_654(hParam1, uParam2, hParam6))
			return false;

	if (!func_655(hParam1, hParam7, iParam9))
		return false;

	if (func_168(iParam9, 4))
		if (!func_656(piParam0, hParam1, uParam2, hParam6, hParam7, iParam8, false, bParam10))
			return false;

	if (func_168(iParam9, 8))
		return func_657(piParam0, hParam1, hParam7, iParam8);

	return true;
}

struct<17> func_391(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, int iParam6, BOOL bParam7) // Position - 0xF75D
{
	var unk;
	...
	unk.f_11 = -1591664384;
	unk.f_4 = { uParam1 };
	unk = { func_368(hParam0, unk.f_4, hParam5, true) };
	unk.f_8 = hParam0;
	unk.f_9 = iParam6;
	unk.f_11 = hParam5;
	...
	if (bParam7)
	{
		unk.f_15 = func_379(hParam0, joaat("DEFAULT"));
...
BOOL func_392(int* piParam0, Any* panParam1, Hash hParam2, BOOL bParam3, int iParam4) // Position - 0xF7D7
{
	var unk;
	int num;
	...
	if (!func_360(panParam1->f_8, panParam1->f_13, &unk, &num, true, false))
		return false;

	switch (num)
	{
		case 1:
			return func_658(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 2:
			return func_659(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 3:
			return func_660(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 4:
			return func_661(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 5:
			return func_662(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 6:
			return func_663(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 7:
			return func_664(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 8:
			return func_665(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 9:
			return func_666(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 10:
			return func_667(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 11:
			return func_668(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 12:
			return func_669(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 13:
			return func_670(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 14:
			return func_671(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
	
		case 15:
			return func_672(piParam0, panParam1, hParam2, &unk, bParam3, iParam4);
...
BOOL func_393(Hash hParam0) // Position - 0xF97F
{
	if (func_312(hParam0, 75135761))
		return true;

	return false;
}

int func_394(Hash hParam0, BOOL bParam1) // Position - 0xF99A
{
	var unk;

	if (!func_105(hParam0, 0))
		return func_673(func_377(hParam0), bParam1);
...
BOOL func_395(int iParam0) // Position - 0xF9F2
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_396(int iParam0) // Position - 0xFA10
{
...
int func_397(int iParam0) // Position - 0xFA2E
{
	if (!func_396(iParam0))
		return 0;
...
BOOL func_398(int iParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0xFA50
{
	var unk;
	var unk13;
	var unk26;
	...
	unk.f_1 = 10;
	unk13.f_1 = 11;
	return func_674(iParam0, &unk26, &unk13, &unk, bParam1, iParam2, iParam3, bParam4);
}

BOOL func_399(Hash hParam0) // Position - 0xFA80
{
	if (func_323(hParam0) == joaat("consumable") && INVENTORY::_INVENTORY_IS_INVENTORY_ITEM_FLAG_ENABLED(hParam0, 16777216))
		return true;

	return false;
}

int func_400(Hash hParam0, int iParam1) // Position - 0xFAAC
{
	var unk;
	int num;
	int i;
...
int func_404(int iParam0, int iParam1) // Position - 0xFB86
{
	if (iParam1 == 2)
		iParam1 = func_676(1);
...
int func_405(int iParam0) // Position - 0xFBD2
{
	switch (iParam0)
	{
		case 1:
...
int func_406() // Position - 0xFDA3
{
	return Global_1051645.f_12;
}

char* func_407() // Position - 0xFDB1
{
	return "unnamed";
}

BOOL func_408(int iParam0) // Position - 0xFDBD
{
	int num;
...
int func_409(int iParam0) // Position - 0xFE4C
{
	if (iParam0 == 255)
...
BOOL func_410(Player plParam0) // Position - 0xFE97
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_411(int iParam0, int iParam1) // Position - 0xFEDC
{
	return iParam0 && iParam1 != false;
}

void func_412(var uParam0, int iParam1) // Position - 0xFEEB
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_413(var uParam0, int iParam1) // Position - 0xFEFC
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_414(int iParam0) // Position - 0xFF11
{
	if (iParam0 == 7)
...
BOOL func_415(Ped pedParam0, Entity eParam1, float fParam2, BOOL bParam3, BOOL bParam4) // Position - 0xFF2A
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
	...
	if (bParam4)
		if (BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam3, false), ENTITY::GET_ENTITY_COORDS(eParam1, bParam3, false)) <= fParam2 * fParam2)
			return true;
	else if (func_276(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam3, false), ENTITY::GET_ENTITY_COORDS(eParam1, bParam3, false)) <= fParam2 * fParam2)
		return true;

	return false;
}

BOOL func_416(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xFF9D
{
	return VOLUME::_IS_POINT_NEAR_VOLUME_LOCK_CENTER(vParam0, 0.5f, 0, 0, 8192);
}

int func_417(Volume volParam0, BOOL bParam1) // Position - 0xFFB7
{
...
Ped func_418(Ped pedParam0) // Position - 0x10020
{
	return pedParam0;
}

BOOL func_419(Ped pedParam0) // Position - 0x1002A
{
	Hash entityModel;
...
BOOL func_420(Ped pedParam0) // Position - 0x1005C
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
void func_421(int iParam0) // Position - 0x1009E
{
	char* conditionalAnim;
	...
	switch (iParam0)
	{
		case 0:
			if (PED::IS_PED_MALE(Global_33))
				conditionalAnim = "WORLD_PLAYER_CAMP_FIRE_SIT_MALE_A";
			else
				conditionalAnim = "WORLD_PLAYER_CAMP_FIRE_SIT_FEMALE_A";
...
int func_422(Hash hParam0) // Position - 0x10124
{
	int i;
...
BOOL func_423(Hash hParam0) // Position - 0x1015F
{
	switch (func_228(hParam0))
	{
		case -2061583405:
...
BOOL func_424(Hash hParam0) // Position - 0x101CC
{
	var unk;

	return func_679(hParam0, &unk);
}

BOOL func_425(BOOL bParam0) // Position - 0x101DC
{
	return Global_1953292 && bParam0 != false;
}

int func_426(int iParam0) // Position - 0x101ED
{
	var unk;
...
int func_427(int iParam0, int iParam1) // Position - 0x10210
{
	switch (iParam0)
	{
		case 0:
...
void func_428(int iParam0) // Position - 0x1045F
{
	func_680(iParam0, 8, 6);
	return;
}

void func_429(int iParam0, int iParam1, int iParam2) // Position - 0x10470
{
	Global_1953292.f_2686[func_266(iParam0, 1) /*2*/].f_1 = Global_1953292.f_2686[func_266(iParam0, 1) /*2*/].f_1 || iParam1;
	return;
}

void func_430(BOOL bParam0) // Position - 0x1049F
{
	Global_1953292 = Global_1953292 || bParam0;
	return;
}

void func_431(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x104B2
{
	int i;
	int num;
...
BOOL func_432(Ped pedParam0, int iParam1) // Position - 0x107AE
{
	var unk;
	int num;
...
BOOL func_433(var uParam0) // Position - 0x107ED
{
	ItemSet itemSet;
	int matchingEntities;
	int i;
...
Hash func_434(Hash hParam0) // Position - 0x1084A
{
	switch (hParam0)
	{
...
Ped func_435(Ped pedParam0) // Position - 0x10BAC
{
	Ped EntityIndex;

	EntityIndex = func_683(pedParam0);

	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex) && PED::IS_PED_INJURED(EntityIndex))
		return EntityIndex;

	return 0;
}

int func_436(Hash hParam0, int iParam1) // Position - 0x10BD6
{
	var unk;
	var unk5;
	...
	unk5.f_1 = 10;
	func_684(&unk5, joaat("LOOT_TYPE_NORMAL"));
	return func_685(hParam0, &unk5, &unk, iParam1, 0);
}

int func_437(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, Hash hParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x10C0A
{
	int value;
	Hash TypeOfWeapon;
	Hash lootTableKey;
	...
	if (!func_686(hParam0, iParam1, bParam2, hParam5))
		return 0;

	if (!func_687(hParam0, &value, iParam1))
		return 0;

	func_688(hParam0, bParam2);
	lootTableKey = 0;

	if (func_323(hParam0) == joaat("CLOTHING"))
		if (!func_312(hParam0, 866047851) && !func_312(hParam0, -1979000645))
			flag = true;

	if (func_538(hParam0, 8388608) && !func_155(27))
		func_689(27);
	...
	if (!flag)
	{
		if (func_312(hParam0, -1588156645))
		{
			bParam2 = true;
			flag2 = true;
			TypeOfWeapon = func_692(func_691(hParam0, true), false);
		
			if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
			{
				if (func_40() == -1)
					func_693(TypeOfWeapon);
			
				if (func_103(false) && func_694(TypeOfWeapon, 0, false, true, 0, false, hParam5, false))
				{
					func_695(hParam0, value, hParam5);
				...
				{
					func_696(hParam0, value, hParam5);
				}
			}
		}
		else if (func_323(hParam0) == joaat("WEAPON"))
		{
			if (!func_697(hParam0, hParam5, &bParam2, bParam3, bParam4))
				bParam2 = true;
		
			flag2 = true;
		}
		else if (func_323(hParam0) == joaat("AMMO") && func_698(hParam0))
		{
			if (!func_699(hParam0, &value, hParam5))
				bParam2 = true;
		
			flag2 = true;
		}
		else if (func_312(hParam0, -103750053))
		{
			func_107(func_700(joaat("claws_collected")), value);
		}
		else if (hParam0 == joaat("provision_alligator_tooth"))
		{
			func_107(func_106(joaat("COLLECTED"), joaat("alligator_tooth")), value);
		}
		else if (func_312(hParam0, -121341956) && !func_312(hParam0, 606799272))
		{
			if (hParam0 != joaat("weapon_kit_detector"))
				func_299(536, false);
		
			func_312(hParam0, -2017733358) || func_312(hParam0, -1369131378);
		}
		else if (func_312(hParam0, -136654233))
		{
			if (func_312(hParam0, -1021472396))
			{
			}
		}
		else if (func_312(hParam0, -1466706512) && func_312(hParam0, 1147021565))
		{
			func_299(519, false);
		}
		else if (func_312(hParam0, 1147021565) && func_312(hParam0, -524514947))
		{
		}
		else if (func_312(hParam0, 554195525))
		{
		}
		else if (func_312(hParam0, 589988438))
		{
			if (func_701())
			{
				func_702(joaat("reward_small"), false, 1065353216, 1, 0, 0, false, -1);
				bParam2 = true;
				flag2 = true;
			}
		}
		else if (func_312(hParam0, 787083290) && func_312(hParam0, 949916894))
		{
			func_703(hParam0);
		}
		else if (func_312(hParam0, -1718133314))
		{
			func_704(hParam0);
		}
		else if (func_312(hParam0, -1738650224))
		{
			func_705(hParam0);
		}
		else if (func_312(hParam0, -1112814642) && func_312(hParam0, 949916894))
		{
			func_706(hParam0);
		}
		...
		else if (func_312(hParam0, 1841149704))
		{
			func_707();
		}
		else if (func_312(hParam0, -1979000645))
		{
		}
		else if (func_312(hParam0, 606799272))
		{
		}
		else if (func_312(hParam0, -1112814642) && func_312(hParam0, -1697809989))
		{
		}
		else if (func_312(hParam0, -2017733358) || func_312(hParam0, -1369131378))
		{
		}
		else if (func_312(hParam0, -1921346699))
		{
			return 0;
		}
		else if (func_312(hParam0, 1192444843))
		{
			switch (hParam0)
			{
				case joaat("upgrade_fsh_bait_lure_swamp"):
					if (!func_348(471514780, 1))
						func_437(471514780, 1, false, false, false, 752097756, 0, 0, 0, false);
					break;
			
				case joaat("upgrade_fsh_bait_lure_lake"):
					if (!func_348(526074061, 1))
						func_437(526074061, 1, false, false, false, 752097756, 0, 0, 0, false);
					break;
			
				case joaat("upgrade_fsh_bait_leg_lure_swamp"):
					if (!func_348(-967317137, 1))
						func_437(-967317137, 1, false, false, false, 752097756, 0, 0, 0, false);
					break;
			
				case joaat("upgrade_fsh_bait_leg_lure_river"):
					if (!func_348(670273567, 1))
						func_437(670273567, 1, false, false, false, 752097756, 0, 0, 0, false);
					break;
			
				case joaat("upgrade_fsh_bait_leg_lure_lake"):
					if (!func_348(215778062, 1))
						func_437(215778062, 1, false, false, false, 752097756, 0, 0, 0, false);
					break;
			
				case joaat("upgrade_fsh_bait_lure_river"):
					if (!func_348(-1045488665, 1))
						func_437(-1045488665, 1, false, false, false, 752097756, 0, 0, 0, false);
					break;
			}
		}
		else if (func_312(hParam0, -839724752) && func_538(hParam0, 4))
		{
		}
		else if (func_312(hParam0, 1399091007))
		{
		...
		switch (hParam0)
		{
			...
			case -399865011:
				if (MISC::GET_GAME_TIMER() >= Global_1940252.f_11598 + 60000)
				{
					func_710(686, -1531530025, true, true);
					Global_1940252.f_11598 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("consumable_potent_tonic"):
				if (MISC::GET_GAME_TIMER() >= Global_1940252.f_11598 + 60000)
				{
					func_710(685, -1228016946, true, true);
					Global_1940252.f_11598 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("consumable_moonshine"):
				if (MISC::GET_GAME_TIMER() >= Global_1940252.f_11598 + 60000)
				{
					func_710(685, 1934060482, true, true);
					Global_1940252.f_11598 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("consumable_restorative"):
				if (MISC::GET_GAME_TIMER() >= Global_1940252.f_11598 + 60000)
				{
					func_710(685, 1110018439, true, true);
					Global_1940252.f_11598 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("consumable_chewing_tobacco_used"):
				if (MISC::GET_GAME_TIMER() >= Global_1940252.f_11598 + 60000)
				{
					func_710(685, 1408511260, true, true);
					Global_1940252.f_11598 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("consumable_valerian_root"):
				func_709(271, func_542(joaat("consumable_valerian_root"), false), false);
				break;
			...
			case joaat("consumable_aged_pirate_rum"):
				func_709(272, func_542(joaat("consumable_aged_pirate_rum"), false), false);
				break;
			...
			case joaat("consumable_ginseng_elixier"):
				func_709(270, func_542(joaat("consumable_ginseng_elixier"), false), false);
				break;
	...
	if (!flag2)
	{
		...
		if (!func_696(hash, value, hParam5))
			return 0;
	...
	else if (lootTableKey != 0)
	{
		if (func_103(false) && !func_104())
		{
			...
			for (i = 0; i < num; i = i + 1)
			{
				func_437(num.f_1[i], num.f_12[i], false, false, false, -897553835, 0, 0, 0, false);
			}
		}
		else
		{
	...
	{
		if (func_312(hParam0, -839724752))
			func_714(hParam0, iParam6);
	}
	else if (!bParam2)
	{
		flag3 = hParam5 == 1248274121;
		func_347(hParam0, value, false, flag3, 0, false, false);
	}

	return 1;
}

int func_438(Ped pedParam0, int iParam1) // Position - 0x116BE
{
	int num;
	int pedQuality;
...
BOOL func_439(Ped pedParam0) // Position - 0x1171A
{
...
BOOL func_440(Hash hParam0) // Position - 0x1180B
{
	!func_105(hParam0, 0);

	if (func_312(hParam0, 1286414894))
		return true;

	return false;
}

Hash func_441(var uParam0) // Position - 0x11831
{
	Ped pedIndexFromEntityIndex;
	...
	return func_715(pedIndexFromEntityIndex);
}

Hash func_442(Ped pedParam0) // Position - 0x11857
{
	...
	if (carriableFromEntity == 0)
		if (ENTITY::IS_ENTITY_A_PED(pedParam0))
			carriableFromEntity = func_715(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedParam0));

	return carriableFromEntity;
}

int func_443(Hash hParam0, int iParam1, Ped pedParam2, BOOL bParam3, Hash hParam4) // Position - 0x118B5
{
	iParam1 = func_716(hParam0, iParam1, pedParam2, true, true, -142743235, 0, 1);

	if (iParam1 <= 0)
		return 1;

	return func_717(hParam0, iParam1, bParam3, hParam4);
}

BOOL func_444(Hash hParam0) // Position - 0x118E8
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

void func_445(int iParam0, var uParam1, var uParam2) // Position - 0x118F6
{
	int num;
...
BOOL func_446(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x11912
{
	if (iParam1 < 0 || iParam1 > 32)
		return false;
	...
	if (Global_1900460.f_67 && !func_721(iParam0, 1) || func_722(32768))
		if (!func_721(iParam0, 262144) || !Global_1904402.f_8875)
			return false;
...
void func_447(int iParam0, int iParam1) // Position - 0x119B4
{
	int Variable;
...
void func_448(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x119D8
{
	int num;
...
void func_449(var uParam0, char* sParam1) // Position - 0x11A23
{
	int num;
...
BOOL func_450(int iParam0, BOOL bParam1) // Position - 0x11A5F
{
	int num;
...
BOOL func_451() // Position - 0x11A92
{
...
BOOL func_452(int iParam0, BOOL bParam1) // Position - 0x11AD5
{
	int num;
...
BOOL func_453(var uParam0) // Position - 0x11B2C
{
	int num;
	...
	if (uParam0->f_133 == -1 || num == uParam0->f_133 && uParam0->f_134 == 0 || func_724(uParam0->f_132, uParam0->f_134) || uParam0->f_133 == -1 && func_724(uParam0->f_132, uParam0->f_134) && !(PED::_IS_PED_DOING_SCENARIO_TRANSITION(Global_33) || PED::_0x2DC0E8DCBD3546E9(Global_33)))
	{
		uParam0->f_131 = num;
		return true;
	}
...
void func_454(var uParam0) // Position - 0x11BB9
{
	Hash activeDynamicScenario2;
...
int func_455(var uParam0) // Position - 0x11C5B
{
	if (uParam0->f_132 == 6 && func_199(true))
	{
		return 1;
	}
	else
	{
		...
		{
			case 1:
				func_215(joaat("COFFEE_TRANS_KNEEL"), 1086324736);
				break;
		}
	}
...
int func_456(var uParam0) // Position - 0x11CA0
{
	if (uParam0->f_132 == 6 && func_199(true))
	{
		return 1;
...
BOOL func_457(Ped pedParam0, Any anParam1, char* sParam2, char* sParam3, char* sParam4) // Position - 0x11D15
{
	PED::_ADD_SCENARIO_TRANSITION(pedParam0);
	return TASK::_0x79197F7D2BB5E73A(pedParam0, anParam1, sParam2, sParam3, sParam4, 0);
}

BOOL func_458(Hash hParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x11D32
{
	int num;
	var unk;
	int num2;
	...
	if (!func_103(bParam4))
	{
		...
		if (!func_726(&unk, &num2, hParam0, num, iParam1, true) || num2 < 1)
			return 0;
		...
		for (i = 0; i < num2; i = i + 1)
		{
			unk62 = { func_727(hParam0, &unk[i /*6*/]) };
			unk62.f_12 = hParam2;
			num3 = func_385(joaat("use"), &unk62, true);
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_213(bParam4), hParam0, iParam1, hParam2))
		return 0;

	return 1;
}

BOOL func_459(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6) // Position - 0x11E4A
{
	var unk;
	int num;
	var unk15;
	...
	if (!func_375(*panParam1, &unk, bParam6, false, -1))
		return false;
	...
	if (!func_103(bParam6))
	{
		...
		else if (func_40() == 0)
		{
			...
			unk15.f_9 = iParam3;
			unk15.f_12 = hParam4;
			num = func_385(joaat("use"), &unk15, true);
...
int func_460(Hash hParam0) // Position - 0x11F68
{
	if (func_312(hParam0, 1573112293))
		return func_728(hParam0);

	if (func_312(hParam0, 1816455607))
		return func_729();
...
BOOL func_461(BOOL bParam0, int iParam1) // Position - 0x1212F
{
	Ped mount;
	...
	if (!func_168(iParam1, 2) && func_746(32))
		return false;

	if (!func_168(iParam1, 4))
		if (func_746(4096))
			return false;

	if (!func_168(iParam1, 8) && func_746(512))
		return false;

	if (!func_168(iParam1, 512) && !func_747(bParam0))
		return false;

	if (!func_168(iParam1, 262144) && !func_748(bParam0, func_168(iParam1, 524288)))
		return false;

	if (!func_168(iParam1, 64) && !func_749(bParam0, iParam1, true))
		return false;

	if (!func_168(iParam1, 128))
	{
		if (func_124(Global_33, SCRIPT_TASK_MOUNT_ANIMAL) || PED::IS_PED_ON_MOUNT(Global_33))
		{
			if (bParam0)
				func_218("ITEM_UNUSABLE_FULLY_MOUNTED", 10000, 0, 0, 0, true);
		
			return false;
		}
	}

	if (!func_168(iParam1, 16))
	{
		if (func_15(Global_33))
		{
			mount = PED::GET_MOUNT(Global_33);
		
			if (!func_750(mount, true))
			{
				if (bParam0)
					func_218("ITEM_UNUSABLE_HORSE_SPEED", 10000, 0, 0, 0, true);
	...
	if (!func_168(iParam1, 256) && func_746(8192))
		return false;

	if (!func_168(iParam1, 1024) && func_746(65536))
	{
		if (bParam0)
			func_218("ITEM_UNUSABLE_CINEMATIC_CAM", 10000, 0, 0, 0, true);
	
		return false;
	}

	if (!func_168(iParam1, 2048))
		if (func_746(32768))
			return false;

	if (!func_168(iParam1, 4096))
		if (func_746(16384))
			return false;

	if (!func_168(iParam1, 8192))
		if (!func_746(16))
			return false;

	if (!func_168(iParam1, 67108864))
		if (!func_746(268435456))
			return false;

	if (!func_168(iParam1, 16384))
		if (func_746(256))
			return false;

	if (!func_168(iParam1, 32768))
	{
		if (func_306())
		{
			if (bParam0)
				func_218("ITEM_UNUSABLE_SATCHEL_OPEN", 10000, 0, 0, 0, true);
		
			return false;
		}
	}

	if (!func_168(iParam1, 131072))
		if (!func_746(524288))
			return false;

	if (!func_168(iParam1, 65536))
		if (!func_746(262144))
			return false;
	...
	if (!func_168(iParam1, 2097152))
		if (!func_746(8388608))
			return false;

	if (!func_168(iParam1, 4194304))
		if (!func_746(16777216))
			return false;

	if (!func_168(iParam1, 8388608))
		if (func_746(33554432))
			return false;

	if (!func_168(iParam1, 16777216))
		if (func_746(67108864))
			return false;

	if (!func_168(iParam1, 33554432))
		if (func_746(134217728))
			return false;
	...
	if (!func_168(iParam1, 134217728))
		if (func_32(256))
			return false;

	if (!func_168(iParam1, 268435456))
		if (func_746(536870912))
			return false;

	if (!func_168(iParam1, 536870912))
		if (func_746(1073741824))
			return false;

	return true;
}

BOOL func_462() // Position - 0x1256B
{
...
BOOL func_463(BOOL bParam0) // Position - 0x125B6
{
	if (bParam0)
...
Any func_464(int iParam0, int iParam1) // Position - 0x125E6
{
	return DATABINDING::_DATABINDING_READ_DATA_BOOL(Global_1940252.f_1556.f_44.f_87);
}

int func_465() // Position - 0x125FD
{
	return Global_1915656.f_22504.f_5;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x1260E
{
	var unk;
	int num;
	...
	switch (iParam0)
	{
		...
		case 46:
			...
			if (!func_752(num, 461218520, true))
				return "SHOPS_HANDHELD_FAIL_SHOP_CL";
		
			return func_754(func_753(num, 461218520));
	}

	return "";
}

void func_467(int iParam0) // Position - 0x128A8
{
	Global_1915656.f_22504.f_5 = iParam0;
	return;
}

int func_468(Hash hParam0, Hash hParam1) // Position - 0x128BB
{
	if (!func_378(hParam0, 2))
		return 0;
...
int func_469(Hash hParam0) // Position - 0x128F1
{
	int i;

	for (i = 0; i <= 49; i = i + 1)
	{
		if (func_755(i, hParam0))
			return i;
	}
...
int func_470(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1291D
{
	if (!func_756(iParam0))
		return 1;
...
void func_471(int iParam0) // Position - 0x1299F
{
	Global_1940252.f_11599 = iParam0;
	return;
}

Hash func_472(Hash hParam0) // Position - 0x129B0
{
	if (!func_105(hParam0, 0))
		return 0;
...
void func_473(Hash hParam0) // Position - 0x129CD
{
	Global_1940252.f_11605 = hParam0;
	return;
}

BOOL func_474(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3, int iParam4) // Position - 0x129DE
{
...
BOOL func_475() // Position - 0x12D31
{
	return Global_1953292.f_1676.f_1[1 /*3*/].f_1 == joaat("pomade");
}

BOOL func_476(Ped pedParam0) // Position - 0x12D4D
{
	if (!ENTITY::DOES_ENTITY_EXIST(*pedParam0) || ENTITY::IS_ENTITY_DEAD(*pedParam0))
		return false;

	if (func_761(*pedParam0, joaat("HATS"), false))
		return true;

	return false;
}

void func_477(Hash hParam0) // Position - 0x12D86
{
	Hash hash;
	...
	{
		if (func_312(hParam0, 1573112293))
			func_764(func_763(hParam0), true, 1);
	
		func_765(Global_33, hParam0, hash, 1, 0);
	}
	else
	{
		func_766(hParam0);
		func_216(hParam0, 1, false, 562618531);
	}

	return;
}

void func_478(Hash hParam0) // Position - 0x12E20
{
	Hash hash;
	...
	if (hash != 0)
	{
		func_765(Global_33, hParam0, hash, 1, false);
	}
	else
	{
		func_766(hParam0);
...
void func_479(Hash hParam0, BOOL bParam1) // Position - 0x12EA0
{
	Hash hash;
...
void func_480(Hash hParam0, BOOL bParam1) // Position - 0x12F4D
{
	Hash hash;
...
void func_481(Hash hParam0) // Position - 0x12FFA
{
	Hash hash;
...
void func_482(Hash hParam0) // Position - 0x1307A
{
	Hash hash;
...
void func_483(Hash hParam0) // Position - 0x130FA
{
	Hash hash;
...
void func_484(Hash hParam0) // Position - 0x1317A
{
	Hash hash;
...
void func_485(Hash hParam0) // Position - 0x131FA
{
	Hash hash;
...
void func_486(Hash hParam0) // Position - 0x1327A
{
	Hash hash;
...
void func_487(Hash hParam0) // Position - 0x132FA
{
	Hash hash;
...
void func_488(Hash hParam0) // Position - 0x1337A
{
	Hash hash;
...
void func_489(Hash hParam0, BOOL bParam1) // Position - 0x133FA
{
	Hash hash;
	...
	if (hash != 0)
	{
		if (!func_765(Global_33, hParam0, hash, 1, 0) && bParam1)
		{
			func_766(hParam0);
			func_216(hParam0, 1, false, 562618531);
		}
...
void func_490(Hash hParam0, BOOL bParam1) // Position - 0x13498
{
	Hash hash;
	...
	if (hash != 0)
	{
		if (!func_765(Global_33, hParam0, hash, 1, bParam1) && bParam1)
		{
			func_766(hParam0);
			func_216(hParam0, 1, false, 562618531);
		}
...
BOOL func_491(int iParam0, int iParam1) // Position - 0x13537
{
	return iParam0 && iParam1 != false;
}

BOOL func_492(const char* sParam0) // Position - 0x13546
{
	int i;
...
void func_493(int iParam0) // Position - 0x13580
{
...
int func_494(int iParam0) // Position - 0x13597
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_495() // Position - 0x135D4
{
	return Global_1953292.f_3502;
}

BOOL func_496(Hash hParam0) // Position - 0x135E3
{
	if (func_768())
		return false;
...
BOOL func_497(Hash hParam0) // Position - 0x13619
{
	return func_769(hParam0);
}

void func_498(var uParam0, int iParam1) // Position - 0x13627
{
	func_770(uParam0, iParam1);
	return;
}

int func_499(Hash hParam0, int iParam1) // Position - 0x13637
{
	Hash interactionAnimHash;
	BOOL flag;
	Hash hash;
	...
	flag2 = func_771(hParam0);

	if (func_228(hParam0) == -525676072 || func_312(hParam0, -1303648999))
		flag = true;

	if (flag2)
		if (func_772(&hash))
			if (flag)
				interactionAnimHash = func_773();
			else
				interactionAnimHash = func_774();
		else if (flag)
			interactionAnimHash = func_775();
		else
			interactionAnimHash = func_776();
	else if (func_264(&hash))
		if (func_312(hash, -1303648999) || func_228(hash) == -525676072)
			interactionAnimHash = func_773();
		else
			interactionAnimHash = func_774();
	else if (flag)
...
void func_500() // Position - 0x1371E
{
	...
	func_777(32768);
	func_680(1108822547, 8, 6);
	return;
}

BOOL func_501(int iParam0, BOOL bParam1) // Position - 0x137D5
{
	return func_778(iParam0, false) < func_779(iParam0, bParam1);
}

void func_502(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x137ED
{
	int num;
	BOOL flag;
	...
	{
		case -2061583405:
			if (func_312(hParam0, 1584357097))
				return;
		
			flag = func_780(hParam0, &(Global_1953292.f_3352.f_28), Global_1953292.f_3352.f_33.f_1, bParam1, bParam5);
			break;
	
		case -1719060085:
			flag = func_780(hParam0, &(Global_1953292.f_3352.f_31), 1, bParam1, bParam5);
			break;
	
		case -999503751:
			flag = func_780(hParam0, &(Global_1953292.f_3352.f_27), Global_1953292.f_3352.f_33, bParam1, bParam5);
			break;
	
		case -525676072:
			flag = func_780(hParam0, &(Global_1953292.f_3352.f_29), Global_1953292.f_3352.f_33.f_2, bParam1, bParam5);
			break;
	
		case 81053684:
			flag = func_780(hParam0, &(Global_1953292.f_3352.f_30), 1, bParam1, bParam5);
			break;
	
		case 119907797:
			flag = func_780(hParam0, &(Global_1953292.f_3352.f_32), 1, bParam1, bParam5);
			break;
	
		case 1388798186:
			flag = func_780(hParam0, &(Global_1953292.f_3352.f_33.f_7), 1, bParam1, bParam5);
			break;
	...
	if (func_782(num) || num != -999503751 && func_312(hParam0, -166674229))
		INVENTORY::_INVENTORY_DISABLE_ITEM(func_213(bParam5), hParam0, 0);

	func_330(hParam0, bParam3, bParam5);

	if (bParam4)
		func_783(true, hParam0);

	if (bParam2)
		func_784(false, false);

	return;
}

Hash func_503(int iParam0) // Position - 0x13999
{
	if (iParam0 == 0)
		iParam0 = func_785();
...
void func_504(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x139C4
{
	if (func_786(hParam0, hParam1))
	{
		func_787(hParam0, hParam1, true, bParam2, bParam3, bParam4);
		return;
	}
...
BOOL func_505(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x139E9
{
	var unk;
	int num;
	int i;
	...
	{
		unk = { func_226(hParam0, true, 0) };
		iParam2 = func_266(func_422(unk.f_4), 1);
	}
	...
	if (func_507(hParam0, true))
		func_789(&(Global_1953292.f_1557), &hParam0, iParam2, bParam5);

	if (bParam6)
		func_790(iParam2);

	func_791(iParam2, num);
	func_792(&Global_1953292.f_1557.f_1[iParam2 /*3*/], 4, 6);
	func_792(&Global_1953292.f_1676.f_1[iParam2 /*3*/], 4, 6);
	func_793(&(Global_1953292.f_1557), hParam0, iParam2, true, num);

	if (hParam1 == 0)
		hParam1 = Global_1953292.f_1557.f_1[iParam2 /*3*/].f_1;

	Global_1953292.f_1557.f_1[iParam2 /*3*/] = hParam0;
	Global_1953292.f_1557.f_1[iParam2 /*3*/].f_1 = func_794(hParam0, iParam2, hParam1);
	...
	if (bParam3)
	{
		for (i = 0; i < Global_1953292.f_2938; i = i + 1)
		{
			if (Global_1953292.f_2938.f_2[i /*2*/] >= 0 && Global_1953292.f_2938.f_2[i /*2*/] < 39)
			{
				...
				func_680(func_427(Global_1953292.f_2938.f_2[i /*2*/], 1), 1, 6);
			}
		}
	}
...
void func_506(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x13B88
{
	func_795(&(Global_1953292.f_2938), bParam0, bParam1, bParam2, bParam3, bParam4);
	return;
}

BOOL func_507(Hash hParam0, BOOL bParam1) // Position - 0x13BA5
{
	!func_105(hParam0, 0);
	...
	if (func_312(hParam0, 265372629))
		return true;

	return false;
}

BOOL func_508(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x13BF0
{
	var unk;
	var unk5;
	Hash hash;

	unk5 = { func_226(hParam0, bParam2, 0) };

	if (func_507(hParam0, false))
	{
		hash = func_796(unk5, unk5.f_4, bParam2, -1);
	
		if (hash != 0)
		{
			unk5 = { func_226(hash, bParam2, 0) };
			unk = { func_368(hash, unk5, unk5.f_4, bParam2) };
			return func_797(unk, false, bParam2);
		}
	
		return true;
	}

	unk = { func_368(hParam0, unk5, unk5.f_4, bParam2) };
	return func_797(unk, bParam1, bParam2);
}

int func_509(Hash hParam0) // Position - 0x13C79
{
	int num;
	int num2;

	num = 0;
	num2 = func_266(hParam0, 1);
...
void func_510(var uParam0, int iParam1) // Position - 0x13CDD
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_511(int iParam0) // Position - 0x13CEE
{
	Ped EntityIndex;
	...
	if (func_798(EntityIndex))
		return true;

	return false;
}

int func_512() // Position - 0x13D4F
{
	return Global_38.f_289.f_3222;
}

BOOL func_513() // Position - 0x13D60
{
	return Global_1915656.f_22504.f_1;
}

BOOL func_514(int iParam0) // Position - 0x13D71
{
	return Global_1051832.f_3648 && iParam0 != false;
}

void func_515(int iParam0) // Position - 0x13D85
{
	Global_1051832.f_3648 = Global_1051832.f_3648 - Global_1051832.f_3648 && iParam0;
	return;
}

void func_516(int iParam0) // Position - 0x13DA6
{
	Global_1051832.f_3649 = iParam0;
	return;
}

BOOL func_517() // Position - 0x13DB7
{
	return Global_1915656.f_22504;
}

void func_518() // Position - 0x13DC6
{
	PAD::_SET_CONTROL_CONTEXT(4, joaat("HandheldCatalogue"));
	return;
}

BOOL func_519() // Position - 0x13DD8
{
	return func_514(4);
}

int func_520(BOOL bParam0) // Position - 0x13DE5
{
	Player playerIndex;
	...
	if (func_800(1106247680, 0) || PED::IS_PED_HOGTIED(Global_33) || PED::IS_PED_HOGTYING(Global_33))
		return 13;
...
void func_521(int iParam0) // Position - 0x14046
{
	int num;
...
BOOL func_522() // Position - 0x14084
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_523(int iParam0) // Position - 0x140A0
{
	return func_279(Global_1144526[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*83*/].f_73, iParam0);
}

BOOL func_524() // Position - 0x140BA
{
	if (NETWORK::_NETWORK_HAS_COMPLETED_MP_INTRO_FLOW_ON_CURRENT_SLOT())
		return true;
...
BOOL func_525() // Position - 0x140CE
{
	return !func_523(2);
}

void func_526() // Position - 0x140DC
{
...
BOOL func_527(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x140F3
{
	BOOL flag;

	flag = func_806(bParam2, func_805(), true, false, true, true, true, bParam0, bParam1);
...
void func_528(int iParam0) // Position - 0x1411B
{
	Global_1896762.f_365 = iParam0;
	return;
}

int func_529(Player plParam0) // Position - 0x1412C
{
	Player player;
...
int func_530(Player plParam0, BOOL bParam1) // Position - 0x1415C
{
	Player player;
	int i;
	...
	if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0))
	{
		...
		for (i = 0; i <= 7; i = i + 1)
		{
			if (Global_1205938.f_1[i /*26*/].f_1 != -1 && func_807(i, 64, player))
				if (bParam1)
...
int func_531(int iParam0) // Position - 0x141E6
{
	if (iParam0 == -1)
		return 0;
	...
	if (!bParam20)
	{
		if (iParam0.f_18)
		{
			if (bParam21)
			{
				...
				func_808(&(Global_1072759.f_22981), unk);
				return;
			}
		}
	}
...
void func_533() // Position - 0x1429C
{
...
void func_534(Hash hParam0, var uParam1, var uParam2) // Position - 0x142B7
{
	*uParam1 = 0;
	*uParam2 = 0;
...
BOOL func_535() // Position - 0x144C3
{
	return !Global_1913444;
}

void func_536(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x144D0
{
	int i;
...
var func_537(BOOL bParam0, var uParam1, var uParam2) // Position - 0x145F3
{
	if (bParam0)
		return uParam1;
...
BOOL func_538(Hash hParam0, int iParam1) // Position - 0x1460A
{
	if (!func_105(hParam0, 0))
		return false;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_539(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x14629
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_540(Hash hParam0) // Position - 0x1471C
{
	if (func_312(hParam0, -1995062316))
		return "collectible_arrowheads";

	if (func_312(hParam0, 1239889275))
		return "collectible_liquor_bottles";

	if (func_312(hParam0, 143267379))
		return "collectible_coins";

	if (func_312(hParam0, -944041124))
		return "colectible_heirlooms";

	if (func_312(hParam0, 1562621600))
		return "collectible_jewelry";

	if (func_312(hParam0, -149719013))
		return "collectible_bird_eggs";

	if (func_312(hParam0, 1940829793))
		return "collectible_tarot_cards";

	if (func_312(hParam0, 781094263))
		return "collectible_flowers";

	if (func_312(hParam0, -352095726) || func_312(hParam0, -2014783736) || func_312(hParam0, -545064757) || func_312(hParam0, 679186220))
		return "collectible_found_fossil";

	return "";
}

BOOL func_541(Hash hParam0) // Position - 0x14818
{
	if (func_312(hParam0, -189374246))
		if (func_809(hParam0, -1305775593) || func_809(hParam0, 1384151091) || func_809(hParam0, 2075388272) || func_809(hParam0, -1738780413))
			return true;

	if (func_312(hParam0, -753854379) || func_312(hParam0, 173360570))
		return true;

	return false;
}

Hash func_542(Hash hParam0, BOOL bParam1) // Position - 0x14897
{
	Hash hash;
...
BOOL func_543(int iParam0) // Position - 0x148C5
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_544(Hash hParam0) // Position - 0x148EC
{
	var unk;
	int i;
...
Hash func_545(Hash hParam0) // Position - 0x1495A
{
	int num;
	var unk;
	int collectionId;
	...
	num = func_811(hParam0);

	if (num == 0)
		return 0;

	unk = { func_607(-1591664384, -1591664384, 0, 0, 0, 0, -1, num, 0) };

	if (func_608(unk, &collectionId, &num2, 0))
	{
		for (i = 0; i < num2; i = i + 1)
		{
			if (ITEMDATABASE::_ITEMDATABASE_GET_COMPONENT_ITEM(collectionId, i, &hash) && func_812(hash))
			{
				func_613(collectionId);
				return hash;
			}
		}
...
BOOL func_546(Hash hParam0, Hash hParam1) // Position - 0x149DF
{
	if (hParam0 == 0)
		return false;
...
BOOL func_547(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3) // Position - 0x14A10
{
	var unk;
...
const char* func_548(const char* sParam0, int iParam1) // Position - 0x14A6F
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_549(Hash hParam0, int iParam1) // Position - 0x14A89
{
	 num;

	num = func_813(hParam0, iParam1);
...
BOOL func_550(Hash hParam0, char* sParam1) // Position - 0x14AA7
{
	...
	TEXT_LABEL_ASSIGN_STRING(sParam1, func_814(hParam0), 128);
	lengthOfLiteralString = HUD::GET_LENGTH_OF_LITERAL_STRING(sParam1);

	if (!func_815(hParam0))
		return false;

	TEXT_LABEL_ASSIGN_STRING(&StringToTest, func_816(hParam0), 128);
...
const char* func_551(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x14B24
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_552(const char* sParam0, int iParam1) // Position - 0x14B38
{
...
int func_553(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x14B6E
{
	int num;
	var unk13;
	int num2;
	...
	func_817(sParam0, sParam1, hParam2);
	return num2;
}

BOOL func_554(Hash hParam0, int iParam1) // Position - 0x14BD1
{
	Hash hash;
	int num;
	int num2;
	...
	hash = func_346(hParam0, iParam1);
	unk.f_9 = -1591664384;

	if (func_818("ALL WEAPONS", &num, &num2, -1591664384, false))
	{
		for (i = 0; i < num2; i = i + 1)
		{
			if (!func_562(&unk, i, num, num2))
			{
			}
			else if (!func_819(unk.f_4))
			{
			}
...
BOOL func_555(Hash hParam0) // Position - 0x14C79
{
	int num;
	int num2;
	int num3;
	...
	num2 = func_820(hParam0);

	if (!(num2 == 0))
	{
		num3 = func_821(&(Global_17418.f_55.f_664.f_1354.f_5), num2);
	
		if (num3 == -1)
			return true;
	}

	num2 = func_822(hParam0);
	num3 = func_821(&(Global_17418.f_55.f_664.f_1354.f_5), num2);
...
struct<2> func_556(int iParam0) // Position - 0x14D35
{
	int num;
...
int func_557(Hash hParam0, BOOL bParam1) // Position - 0x14D45
{
	var unk;
	int num;
	int num2;
...
struct<4> func_558(Hash hParam0, BOOL bParam1) // Position - 0x14DA4
{
	var unk;

	unk = { func_226(hParam0, bParam1, false) };
	return func_368(hParam0, unk, unk.f_4, bParam1);
}

struct<18> func_559(Hash hParam0, Hash hParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x14DC9
{
	Hash hash;
...
void func_560(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x14EA7
{
...
BOOL func_561(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x14EC2
{
...
BOOL func_562(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x14EE7
{
	if (iParam2 < 0)
		return false;
...
int func_563(int iParam0) // Position - 0x14F22
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_564() // Position - 0x14F43
{
	if (Global_1940252.f_11596 != Global_1940252.f_41.f_203 - 1 || func_824(func_823(0), Global_1940252.f_11588, false, true, true) > 0 || Global_1940252.f_11596 == 15)
		return true;
...
void func_565(int iParam0) // Position - 0x14FA2
{
	Global_1940252.f_11 = iParam0;
	return;
}

void func_566(int iParam0) // Position - 0x14FB2
{
	Global_1940252.f_10 = iParam0;
	return;
}

void func_567(var uParam0) // Position - 0x14FC2
{
	TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_21), "CAMP", 8);
	return;
}

void func_568(var uParam0) // Position - 0x14FD3
{
	if (HUD::_DOES_TEXT_BLOCK_EXIST(&(uParam0->f_21)))
...
BOOL func_569(var uParam0) // Position - 0x150EC
{
...
Hash func_570(Hash hParam0) // Position - 0x15306
{
	Hash num;

	num = func_829(hParam0);
...
void func_571(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x15326
{
	if (bParam2)
		uParam0->f_49.f_23 = uParam0->f_49.f_23 + 1;

	func_830(uParam0, true, bParam4);

	if (func_399(uParam0->f_49.f_62))
		if (func_831() && func_99(&(uParam0->f_49), 131072) && uParam0->f_49.f_27 > 1)
			func_832(uParam0->f_137[iParam1], "CAMP_REC_COOK_MLT", func_593(3, uParam0->f_49.f_27), true);
		else if (bParam3)
			func_290(uParam0->f_137[iParam1], "CAMP_REC_COOK_AGN", true);
		else
			func_290(uParam0->f_137[iParam1], "CAMP_REC_COOK", true);
	else if (bParam3)
		if (func_400(uParam0->f_49.f_62, -1636519629) == -701492487)
			func_290(uParam0->f_137[iParam1], "CAMP_REC_BREW_AGN", true);
		else
			func_290(uParam0->f_137[iParam1], "CAMP_REC_MAKE_AGN", true);
	else if (func_400(uParam0->f_49.f_62, -1636519629) == -701492487)
		func_290(uParam0->f_137[iParam1], "CAMP_REC_BREW", true);
	else
		func_290(uParam0->f_137[iParam1], "CAMP_REC_MAKE", true);

	return;
}

BOOL func_572() // Position - 0x15448
{
	return Global_1940026 == 2;
}

void func_573(int iParam0) // Position - 0x15456
{
...
BOOL func_574() // Position - 0x15472
{
	return Global_1940026 == 1;
}

void func_575(Hash hParam0, float fParam1, BOOL bParam2) // Position - 0x15480
{
	int i;
	float health;
	float stamina;
	...
	if (func_312(hParam0, 1573112293) || func_312(hParam0, 672467738) || func_312(hParam0, -550842268))
		flag3 = true;
	...
	if (ITEMDATABASE::_ITEMDATABASE_FILLOUT_ITEM_EFFECT_IDS(hParam0, &num2))
	{
		for (i = 0; i < num2; i = i + 1)
		{
			if (ITEMDATABASE::ITEMDATABASE_FILLOUT_ITEM_EFFECT_ID_INFO(num2.f_1[i], &unk22[i /*7*/]))
			{
				...
				{
					case -1104847406:
						deadeye = func_833(2, (float)unk22[i /*7*/].f_2 / fParam1);
						func_835((float)unk22[i /*7*/].f_2 / fParam1, false);
						flag = true;
						break;
				
					case -943921969:
						health = func_833(0, (float)unk22[i /*7*/].f_2 / fParam1);
						func_834((float)unk22[i /*7*/].f_2 / fParam1);
						flag2 = true;
						break;
				
					case -816334026:
						func_839(BUILTIN::TO_FLOAT(unk22[i /*7*/].f_2) / fParam1, true);
						break;
				
					case joaat("EFFECT_HEALTH_CORE"):
						value = func_837((float)unk22[i /*7*/].f_2 / fParam1, unk22[i /*7*/].f_5 / fParam1);
						func_838(0, value, true, true, flag3);
						flag2 = true;
						break;
				
					case 381158954:
						stamina = func_833(1, (float)unk22[i /*7*/].f_2 / fParam1);
						func_836((float)unk22[i /*7*/].f_2 / fParam1);
						break;
				
					case joaat("EFFECT_STAMINA_CORE"):
						value3 = func_837((float)unk22[i /*7*/].f_2 / fParam1, unk22[i /*7*/].f_5 / fParam1);
						func_838(1, value3, true, true, flag3);
						break;
				
					case joaat("EFFECT_DEADEYE_CORE"):
						value2 = func_837((float)unk22[i /*7*/].f_2 / fParam1, unk22[i /*7*/].f_5 / fParam1);
						func_838(2, value2, true, true, flag3);
						flag = true;
						break;
					...
					default:
						if (bParam2)
						{
							...
							{
								case -1240225157:
									num = func_840(BUILTIN::TO_FLOAT(unk22[i /*7*/].f_3), unk22[i /*7*/].f_4);
									func_841(1, num, true, true);
									break;
							
								case joaat("Effect_Stamina_Core_Gold"):
									num = func_840(BUILTIN::TO_FLOAT(unk22[i /*7*/].f_3), unk22[i /*7*/].f_4);
									func_841(18, num, true, true);
									break;
							
								case joaat("Effect_Deadeye_Core_Gold"):
									num = func_840(BUILTIN::TO_FLOAT(unk22[i /*7*/].f_3), unk22[i /*7*/].f_4);
									func_841(20, num, true, true);
									flag = true;
									break;
							
								case 1342237631:
									num = func_840(BUILTIN::TO_FLOAT(unk22[i /*7*/].f_3), unk22[i /*7*/].f_4);
									func_841(2, num, true, true);
									flag = true;
									break;
							
								case 1869697234:
									num = func_840(BUILTIN::TO_FLOAT(unk22[i /*7*/].f_3), unk22[i /*7*/].f_4);
									func_841(0, num, true, true);
									flag2 = true;
									break;
							
								case joaat("Effect_Health_Core_Gold"):
									num = func_840(BUILTIN::TO_FLOAT(unk22[i /*7*/].f_3), unk22[i /*7*/].f_4);
									func_841(19, num, true, true);
									flag2 = true;
									break;
							}
						}
		...
		if (bParam2)
			func_842(hParam0, flag, flag2, 562618531);
...
int func_576(var uParam0) // Position - 0x157BB
{
	return uParam0->f_11;
}

BOOL func_577(int iParam0) // Position - 0x157C7
{
	int num;

	num = func_843(iParam0);
...
BOOL func_578(Hash hParam0) // Position - 0x157ED
{
	switch (hParam0)
	{
...
void func_579(var uParam0, int iParam1) // Position - 0x1583E
{
	var unk;
	Hash hash;
	int eventData;
	...
	{
		if (func_298(uParam0->f_1[0], false))
		{
			func_93(uParam0);
			func_221(uParam0);
		}
	...
	switch (func_576(uParam0))
	{
		...
		case 1:
			...
			if (func_845(uParam0))
			{
				if (func_45(uParam0->f_1[0]))
					func_164(uParam0->f_1[0], false, true, true);
		...
		case 3:
			...
			if (func_99(uParam0, 16) || func_450(uParam0->f_1[0], true) || func_99(uParam0, 32))
				func_847(uParam0);
			break;
		...
		case 7:
			...
			if (func_852(uParam0, false))
			{
				if (func_853(uParam0, func_99(uParam0, 65536)) || func_99(uParam0, 2) || func_99(uParam0, 65536) && UIAPPS::IS_UIAPP_ACTIVE_BY_HASH(joaat("crafting")))
				{
		...
		case 10:
			...
			if (Global_1913634.f_1580)
			{
				...
				func_164(uParam0->f_1[5], false, true, true);
				func_100(uParam0, 9);
			}
			else if (func_861(uParam0->f_1[2], true) || !UIAPPS::IS_UIAPP_RUNNING_BY_HASH(joaat("crafting")))
			{
				...
				{
					func_94(uParam0, false);
					func_862("Exit", "SSCRFT_Sounds", true);
			...
			else if (func_450(uParam0->f_1[7], true))
			{
				func_863(uParam0);
			}
			else if (func_450(uParam0->f_1[1], true))
			{
				func_864(uParam0);
			}
			else if (func_450(uParam0->f_1[3], true))
			{
				ATTRIBUTE::STOP_ITEM_PREVIEW();
				...
				func_859(uParam0);
				func_862("toggle_craftable_all", "SSCRFT_Sounds", true);
				uParam0->f_62 = 0;
				uParam0->f_63 = 0;
				func_860(uParam0, 0, 0);
				func_164(uParam0->f_1[5], false, true, true);
			...
			else if (func_865(uParam0->f_1[5], 0, true))
			{
				if (func_99(uParam0, 4096))
				{
					func_862("Nav_Left", "SSCRFT_Sounds", true);
					func_866(uParam0, false);
				}
			}
			else if (func_865(uParam0->f_1[5], 1, true))
			{
				if (func_99(uParam0, 4096))
				{
					func_862("Nav_Right", "SSCRFT_Sounds", true);
					func_866(uParam0, true);
				}
			}
			else if (func_861(uParam0->f_1[6], true))
			{
				func_862("toggle_ingredients_effects", "SSCRFT_Sounds", true);
				func_867(uParam0, true);
			}
			else if (func_450(uParam0->f_1[8], true))
			{
				func_862("toggle_craftable_all", "SSCRFT_Sounds", true);
		...
		case 12:
			...
			func_855(false);
			activeDynamicScenario2 = PED::_GET_ACTIVE_DYNAMIC_SCENARIO_2(Global_33);
			num = func_400(uParam0->f_62, -1636519629);
			...
			{
				func_846(uParam0);
				func_871(uParam0, false, &unk);
				func_870(uParam0);
			
				if (func_45(uParam0->f_1[1]))
					func_46(&uParam0->f_1[1], true, true);
			
				if (func_872(num))
				{
					uParam0->f_43 = 250;
					uParam0->f_1[1] = func_163("CAMP_REC_MAKE", joaat("INPUT_GAME_MENU_ACCEPT"), 3, 0, 0, 0, uParam0->f_43, uParam0->f_43 + 1, 1, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
					func_860(uParam0, uParam0->f_62, uParam0->f_63);
					func_172(uParam0->f_1[1], -1067771379, 0, true);
					func_448(uParam0->f_1[1], 10, true, true);
					func_448(uParam0->f_1[1], 11, true, true);
					func_164(uParam0->f_1[1], false, true, true);
				}
				else
				{
					uParam0->f_1[1] = func_163("CAMP_REC_MAKE", joaat("INPUT_GAME_MENU_ACCEPT"), 3, 0, 0, 0, 250, 251, 1, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
					func_172(uParam0->f_1[1], -1067771379, 0, true);
					func_165(uParam0->f_1[1], true, true);
					func_448(uParam0->f_1[1], 10, true, true);
					func_448(uParam0->f_1[1], 11, true, true);
					func_164(uParam0->f_1[1], false, true, true);
				}
			...
			if (func_872(num))
			{
				...
				{
					if (func_298(uParam0->f_1[1], false))
					{
						if (func_589(uParam0->f_1[1], true) || PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, joaat("INPUT_GAME_MENU_ACCEPT")))
						{
							func_189(uParam0, 64);
							func_164(uParam0->f_1[1], false, true, true);
							func_164(uParam0->f_1[4], false, true, true);
						}
					}
				}
				...
				if (num == -1136843638 || num == -732326901 || num == 786205940 || num == -1141771998 || num == 364689687 || num == -842117252 || num == -1610298873)
				{
					if (uParam0->f_70 != 0)
					{
						if (uParam0->f_70 == joaat("s_cft_arrow_smallgame") && ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, -1011038463) || uParam0->f_70 != joaat("s_cft_arrow_smallgame") && ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 2024314131))
						{
							...
							if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_66))
							{
								if (func_312(uParam0->f_62, -1588156645) && num != -842117252)
								{
									uParam0->f_66 = WEAPON::_CREATE_WEAPON_OBJECT(func_691(uParam0->f_62, false), 1, Global_34, true, 1065353216);
									ENTITY::SET_ENTITY_COMPLETELY_DISABLE_COLLISION(uParam0->f_66, false, false);
								
									if (num == -1610298873)
										ANIMSCENE::SET_ANIM_SCENE_ENTITY(func_873(uParam0, num), "DYNAMITE" /*DYNAMITE*/, uParam0->f_66, 0);
								}
								else
								{
				...
				if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, -61921192))
				{
					if (func_103(false) && !func_104())
					{
						func_584(uParam0->f_62, uParam0->f_63, true, func_583(), uParam0->f_12);
						func_585(uParam0->f_62, 1, 0, true, 0);
					}
					...
					if (!func_874(uParam0->f_62, uParam0->f_63, false, func_583(), false) || func_592(uParam0->f_62, 1, false) || uParam0->f_23 >= uParam0->f_27)
					{
						if (!func_103(false) || func_104())
						{
							uParam0->f_24 = func_101(uParam0->f_62, uParam0->f_63, uParam0->f_28, uParam0->f_12);
				...
				if (!func_99(uParam0, 64))
				{
					if (!(func_298(uParam0->f_1[1], false) && PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, joaat("INPUT_GAME_MENU_ACCEPT"))))
					{
				...
				{
					func_164(uParam0->f_1[1], true, true, true);
					func_164(uParam0->f_1[4], true, true, true);
					func_220(uParam0, 64);
				}
			
				if (ANIMSCENE::HAS_ENTITY_EXITED_ANIM_SCENE(func_873(uParam0, num), "player"))
				{
					if (!func_103(false) || func_104())
					{
						uParam0->f_24 = func_101(uParam0->f_62, uParam0->f_63, uParam0->f_28, uParam0->f_12);
			...
			else if (func_116(&(uParam0->f_71), (float)uParam0->f_43 / 1000f))
			{
				if (!func_103(false) || func_104())
				{
					if (uParam0->f_24 == -1)
				...
				{
					func_584(uParam0->f_62, uParam0->f_63, true, func_583(), uParam0->f_12);
					func_585(uParam0->f_62, 1, 1, true, 0);
				}
				...
				if (!func_874(uParam0->f_62, uParam0->f_63, false, func_583(), false) || func_592(uParam0->f_62, 1, false))
					flag = false;
			
				func_875(uParam0, num, flag);
			}
			break;
		...
		case 13:
			...
			if (!func_298(uParam0->f_1[2], false))
			{
				func_164(uParam0->f_1[2], true, true, true);
				func_165(uParam0->f_1[2], false, true);
			}
		
			if (!func_298(uParam0->f_1[4], false))
			{
				func_164(uParam0->f_1[4], true, true, true);
				func_165(uParam0->f_1[4], true, true);
			}
		
			if (func_861(uParam0->f_1[2], true))
			{
				func_93(uParam0);
			...
			else if (func_167(uParam0->f_1[4], true))
			{
				func_93(uParam0);
				func_98(&(uParam0->f_66), &(uParam0->f_67));
				func_98(&(uParam0->f_64), &(uParam0->f_65));
				...
				num = func_400(uParam0->f_62, -1636519629);
				animScene = func_873(uParam0, num);
			...
			{
				func_164(uParam0->f_1[4], false, true, true);
				func_164(uParam0->f_1[2], false, true, true);
				func_164(uParam0->f_1[1], false, true, true);
				num = func_400(uParam0->f_62, -1636519629);
				animScene2 = func_873(uParam0, num);
			...
			if (func_452(uParam0->f_1[4], true))
			{
				if (!func_241(&(uParam0->f_71)))
					func_118(&(uParam0->f_71));
				else if (func_116(&(uParam0->f_71), 0.1f))
					func_290(uParam0->f_1[4], "CAMP_REC_QUIT", true);
			}
			else
			{
				if (func_241(&(uParam0->f_71)))
				...
				func_290(uParam0->f_1[4], "CAMP_REC_BACK", true);
			}
			break;
		...
		case 14:
			...
			num = func_400(uParam0->f_62, -1636519629);
			animScene3 = func_873(uParam0, num);
		...
		case 16:
			...
			else if (NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(Plr) && NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr))
			{
				func_100(uParam0, 10);
			}
		...
		case 17:
			if (!func_577(uParam0->f_24) && func_877(true))
			{
				...
				else
				{
					...
					if (func_312(uParam0->f_62, -2011345500))
						func_398(-1266356243, false, 255, 0, false);
...
void func_580(var uParam0) // Position - 0x171C5
{
	BOOL flag;
	int num;
	int num2;
	...
	if (flag)
		func_107(func_700(joaat("food_seasoned")), func_99(&(uParam0->f_49), 131072) ? func_593(3, uParam0->f_49.f_27) : 1);
	...
	if (flag)
	{
		...
		uParam0->f_137[3] = func_163("CRAFT_FASTER", joaat("INPUT_GAME_MENU_ACCEPT"), 2, 0, 0, 6, num, num2, 35, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
	}
	else
	{
		num = 7000;
...
int func_581() // Position - 0x173A6
{
	...
	func_498(&num2, 1);
	return func_499(hash, num2);
}

BOOL func_582(int iParam0) // Position - 0x173FB
{
	return func_279(Global_1940085.f_38, iParam0);
}

BOOL func_583() // Position - 0x1740F
{
	Ped PedIndex;
	BOOL num;
	...
	if (!PED::IS_PED_INJURED(PedIndex))
		if (func_195(Global_33, PedIndex, true) < 400f)
			num = 1;

	return num;
}

int func_584(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, Any anParam4) // Position - 0x17440
{
	TELEMETRY::_TELEMETRY_CRAFT_ITEM(hParam0, hParam1, anParam4, 1);
	return func_883(hParam0, hParam1, bParam2, bParam3);
}

void func_585(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x1745F
{
	Hash TypeOfWeapon;
	...
	func_107(func_700(joaat("items_crafted")), iParam1);
	...
	if (bParam3)
	{
		if (func_40() == -1)
		{
			if (func_312(hParam0, -1588156645))
			{
				TypeOfWeapon = func_692(func_691(hParam0, false), false);
		...
		if (iParam4 == 0)
			if (func_323(hParam0) == joaat("horse_equipment"))
				if (func_884(hParam0, false))
					func_347(hParam0, 1, false, true, false, false, false);
			else
				func_437(hParam0, iParam1, false, false, false, 752097756, 0, 0, 0, false);
		else
			func_885(hParam0, iParam4, iParam1);
	}
...
void func_586(var uParam0, Hash hParam1) // Position - 0x17530
{
	BOOL flag;

	if (func_452(uParam0->f_137[3], true))
		flag = true;
	...
	switch (hParam1)
	{
		...
		case joaat("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_ACTIVE_ARTHUR"):
			if (!flag)
				if (func_212(uParam0))
					if (func_215(joaat("COOKKNIFE_ACTIVE_TRANS_COOKKNIFE"), 0.5f))
						uParam0->f_153 = MISC::GET_GAME_TIMER();
			break;
		...
		case joaat("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_ACTIVE_MP_FEMALE_A"):
			if (!flag)
				if (func_212(uParam0))
					if (func_215(joaat("KNEELFIRECRAFTACTIVE_TRANS_KNEELFIRECRAFT"), 0.5f))
						uParam0->f_153 = MISC::GET_GAME_TIMER();
			break;
		...
		case joaat("WORLD_PLAYER_DYNAMIC_KNEEL_FIRE_CRAFT_MP_FEMALE_A"):
			if (flag)
				if (func_212(uParam0))
					if (func_215(joaat("KNEELFIRECRAFT_TRANS_KNEELFIRECRAFTACTIVE"), 0.5f))
						uParam0->f_153 = MISC::GET_GAME_TIMER();
			break;
		...
		case joaat("WORLD_PLAYER_DYNAMIC_KNEEL_COOK_KNIFE_MP_FEMALE_A"):
			if (flag)
				if (func_212(uParam0))
					if (func_215(joaat("COOKKNIFE_TRANS_COOKKNIFE_ACTIVE"), 0.5f))
						uParam0->f_153 = MISC::GET_GAME_TIMER();
			break;
	}
...
void func_587(var uParam0) // Position - 0x17688
{
	if (!func_45(uParam0->f_137[5]))
		return;
	...
	func_590();
	func_164(uParam0->f_137[5], true, true, true);
	return;
}

void func_588(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x176EC
{
	if (bParam1)
	{
		uParam0->f_137[3] = func_163("CRAFT_FASTER", joaat("INPUT_GAME_MENU_ACCEPT"), 2, 0, 0, 0, 7000, 10000, 25, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
		func_571(uParam0, 3, false, true, bParam2);
		func_164(uParam0->f_137[3], false, true, true);
		func_172(uParam0->f_137[3], -1067771379, 0, true);
	
		if (func_831() && func_886(&(uParam0->f_49), uParam0->f_49.f_62) && uParam0->f_49.f_27 > 1)
		{
			uParam0->f_137[9] = func_163("CAMP_REC_BATCH", joaat("INPUT_GAME_MENU_LS"), 1, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
			func_172(uParam0->f_137[9], -1067771379, 0, true);
			func_164(uParam0->f_137[9], false, true, true);
		}
	}

	uParam0->f_137[7] = func_163("CAMP_REC_BACK", joaat("INPUT_CONTEXT_B"), 1, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
	uParam0->f_137[1] = func_163("CAMP_REC_BACK", joaat("INPUT_CONTEXT_B"), 1, 0, 0, 5, 570, 4000, 10, 1073741824, joaat("MEDIUM_TIMED_EVENT"), false);
	func_449(&uParam0->f_137[1], "INPUT_PCRAFT_EXIT");
	func_165(uParam0->f_137[7], false, true);
	func_172(uParam0->f_137[7], -1067771379, 0, true);
	func_172(uParam0->f_137[1], -1067771379, 0, true);
	func_448(uParam0->f_137[1], 19, true, true);
	func_448(uParam0->f_137[1], 20, true, true);
	func_448(uParam0->f_137[1], 13, true, true);
	func_448(uParam0->f_137[7], 13, true, true);
	func_164(uParam0->f_137[7], false, true, true);
	func_164(uParam0->f_137[1], false, true, true);
	return;
}

BOOL func_589(int iParam0, BOOL bParam1) // Position - 0x178B2
{
	int num;
...
void func_590() // Position - 0x178E5
{
...
void func_591(int iParam0, BOOL bParam1) // Position - 0x17923
{
	int num;
...
BOOL func_592(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x17955
{
	var unk;

	unk = { func_226(hParam0, false, 0) };
	return func_227(hParam0, &unk, iParam1, false, bParam2, -1, false);
}

int func_593(int iParam0, int iParam1) // Position - 0x17978
{
	if (iParam0 > iParam1)
		return iParam1;
...
var func_594(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1798E
{
	if (bParam0)
		return uParam1;
...
float func_595(int iParam0, BOOL bParam1) // Position - 0x179A5
{
	int num;
...
float func_596(float fParam0, float fParam1, float fParam2) // Position - 0x179FD
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_597(var uParam0) // Position - 0x17A24
{
	if (!func_45(uParam0->f_137[4]))
		return;
	...
	func_164(uParam0->f_137[4], true, true, true);
	return;
}

void func_598(var uParam0, BOOL bParam1) // Position - 0x17A6A
{
	func_830(uParam0, true, false);

	if (bParam1)
		if (!func_298(uParam0->f_137[3], false))
			if (func_45(uParam0->f_137[3]) && uParam0->f_49.f_62 == joaat("consumable_coffee") || !func_592(uParam0->f_49.f_62, 1, false) && !func_577(uParam0->f_49.f_24) && uParam0->f_49.f_27 > 0)
				func_164(uParam0->f_137[3], true, true, true);

	if (!func_298(uParam0->f_137[7], false))
	{
		func_164(uParam0->f_137[7], true, true, true);
		func_165(uParam0->f_137[7], false, true);
	}

	if (!func_298(uParam0->f_137[1], false))
		func_164(uParam0->f_137[1], true, true, true);

	if (func_45(uParam0->f_137[9]))
		if (!func_298(uParam0->f_137[9], false) && uParam0->f_49.f_27 > 0)
			func_164(uParam0->f_137[9], true, true, true);
		else
			func_164(uParam0->f_137[9], false, true, true);
...
void func_599(var uParam0) // Position - 0x17B83
{
	int i;

	for (i = 0; i < *uParam0; i = i + 1)
	{
		func_46(&uParam0->[i], true, true);
	}

	return;
}

void func_600(var uParam0) // Position - 0x17BAB
{
	int num;
	int num2;
...
BOOL func_601(int iParam0) // Position - 0x17C6A
{
	if (iParam0 == 0)
		return false;
...
void func_602(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x17C82
{
	int i;
	int j;
	int k;
	...
	for (i = 0; i < iParam3; i = i + 1)
	{
		if (unk14[i] != 1f && uParam2->[i /*2*/].f_1 > 0)
		{
			...
			if (uParam2->[i /*2*/].f_1 == 0 && func_228(uParam2->[i /*2*/]) != -829303394)
				uParam2->[i /*2*/].f_1 = 1;
		}
	}
...
BOOL func_603(int iParam0) // Position - 0x17E58
{
	if (iParam0 < 0)
		return false;
...
int func_605(int iParam0) // Position - 0x17E96
{
	switch (iParam0)
	{
		case 0:
...
void func_606(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x17EC7
{
	int i;
	int j;
	int k;
...
struct<10> func_607(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1809E
{
	int num;
...
BOOL func_608(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x18172
{
...
Hash func_609(int iParam0, int iParam1) // Position - 0x18193
{
	int num;
...
Hash func_610(Hash hParam0) // Position - 0x181D6
{
	int num;
...
int func_611(Hash hParam0) // Position - 0x18548
{
	if (func_312(hParam0, 1064293907))
		return 2;
	else if (func_312(hParam0, -1218707194))
		return 1;
	else if (func_312(hParam0, 1888974372))
		return 0;

	return 1;
}

int func_612(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1858D
{
	var unk;
	int num;
	int i;
	...
	for (i = 0; i < 15; i = i + 1)
	{
		if (func_105(unk[i], 0) && hParam2 == unk[i])
			num = num + 1;
	}
...
int func_613(int iParam0) // Position - 0x185E1
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_614(int iParam0) // Position - 0x18602
{
	iParam0 = func_414(iParam0);
...
BOOL func_615(Ped pedParam0) // Position - 0x1863A
{
	Ped pedIndexFromEntityIndex;
...
struct<4> func_616() // Position - 0x1869D
{
	var unk;
...
int func_617() // Position - 0x186A9
{
	if (func_889(joaat("upgrade_offhand_holster"), false, false, false) == 0)
		return 0;

	return 1;
}

BOOL func_618(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x186C6
{
	int inventoryId;

	inventoryId = func_213(false);
	*panParam1 = { func_368(hParam0, func_369(false), hParam3, false) };
...
BOOL func_619(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1870B
{
...
BOOL func_620(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1873E
{
...
BOOL func_621(Hash hParam0) // Position - 0x18778
{
	return func_312(hParam0, 1279601681);
}

BOOL func_622(Hash hParam0, Hash hParam1) // Position - 0x1878B
{
	if (!func_105(hParam0, 0))
		return false;

	if (func_393(hParam0) || func_312(hParam0, 1077060302))
		return func_630(func_394(hParam0, false), hParam1, false);

	return ITEMDATABASE::_0xDEE7B3C76ED664BE(hParam0, hParam1) > 0;
}

int func_623(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x187D7
{
	var unk;
	int num;
	int i;
	...
	if (!func_355(iParam0, hParam1, &unk, &num, bParam2, bParam3))
	{
		!bParam2;
		return 0;
	}
...
BOOL func_624(Hash hParam0, Any* panParam1) // Position - 0x1886B
{
	int num;
	...
	if (hParam0 == joaat("use"))
		if (func_890(panParam1->f_8, hParam0, num, 2048) || func_890(panParam1->f_8, hParam0, num, 32768) || func_890(panParam1->f_8, hParam0, num, 65536))
			return false;
	else if (hParam0 == 1168099063)
		if (func_890(panParam1->f_8, hParam0, num, 4) || func_890(panParam1->f_8, hParam0, num, 256) || func_890(panParam1->f_8, hParam0, num, 65536) || func_890(panParam1->f_8, hParam0, num, 131072))
			return false;
	else if (hParam0 == joaat("spend"))
		if (func_890(panParam1->f_8, hParam0, num, 1) || func_890(panParam1->f_8, hParam0, num, 8) || func_890(panParam1->f_8, hParam0, num, 65536) || func_890(panParam1->f_8, hParam0, num, 32))
			return false;
	else if (hParam0 == joaat("Sell"))
		if (func_890(panParam1->f_8, hParam0, num, 1) || func_890(panParam1->f_8, hParam0, num, 16) || func_890(panParam1->f_8, hParam0, num, 2) || func_890(panParam1->f_8, hParam0, num, 65536))
			return false;
	else if (func_890(panParam1->f_8, hParam0, num, 8) || func_890(panParam1->f_8, hParam0, num, 4096) || func_890(panParam1->f_8, hParam0, num, 256) || func_890(panParam1->f_8, hParam0, num, 65536))
		return false;

	return true;
}

BOOL func_625(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x18A41
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_626(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x18A58
{
	if (bParam0)
	{
...
int func_627(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x18AA1
{
	if (bParam0)
	{
		func_891(iParam1, 1, 0, 0);
...
BOOL func_628(int* piParam0) // Position - 0x18ABD
{
	int num;
...
BOOL func_629(Any anParam0) // Position - 0x18AEF
{
...
BOOL func_630(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x18B35
{
	if (!func_601(iParam0))
		return false;
	...
	if (bParam2)
		return !func_635(iParam0, hParam1);

	return true;
}

BOOL func_631(int iParam0, var uParam1) // Position - 0x18B6D
{
	*uParam1 = func_893(iParam0, true);
	return *uParam1 != 0;
}

BOOL func_632(int iParam0, var uParam1) // Position - 0x18B84
{
	*uParam1 = func_894(iParam0, true, false);
	return *uParam1 != 0;
}

BOOL func_633() // Position - 0x18B9C
{
	return Global_1915656.f_22477;
}

BOOL func_634(int iParam0) // Position - 0x18BAB
{
...
BOOL func_635(int iParam0, Hash hParam1) // Position - 0x18BE6
{
	var unk;
	int num;
	Hash unlockHash;
...
BOOL func_636(int iParam0, Hash hParam1) // Position - 0x18D2F
{
	int num;
	int num2;
	var unk;
	...
	{
		num = func_623(iParam0, -570078785, false, true);
		num == 0;
	
		if (!func_357(num))
		{
			if (Global_1915656.f_20644)
				func_896(MISC::VAR_STRING(2, "SHOP_H_TOO_POOR_GOLD", func_895(num)));
	...
	{
		num2 = func_623(iParam0, -915411861, false, true);
		num2 == 0;
	...
	if (!func_224(iParam0, hParam1, &unk, true, false))
		return 0;

	return 1;
}

BOOL func_637(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x18DE9
{
	var unk;

	unk = 1;
	unk.f_1.f_1 = 10;
	return func_897(piParam0, panParam1, hParam2, uParam3, unk, &unk, bParam4);
}

BOOL func_638(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x18E15
{
	int num;
	...
	num.f_1.f_1 = 10;
	num.f_1.f_42.f_1 = 10;
	return func_897(piParam0, panParam1, hParam2, uParam3, num, &num, bParam4);
}

BOOL func_639(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x18E4A
{
	int num;
...
BOOL func_640(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x18E88
{
	int num;
...
BOOL func_641(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x18ECF
{
	int num;
...
BOOL func_642(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x18F1F
{
	int num;
...
BOOL func_643(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x18F78
{
	int num;
...
BOOL func_644(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x18FDA
{
	int num;
...
BOOL func_645(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x19046
{
	int num;
...
BOOL func_646(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x190BB
{
	int num;
...
BOOL func_647(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x19139
{
	int num;
...
BOOL func_648(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x191C0
{
	int num;
...
BOOL func_649(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x19250
{
	int num;
...
BOOL func_650(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x192E9
{
	int num;
...
BOOL func_651(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x1938B
{
	int num;
...
BOOL func_652(Hash hParam0) // Position - 0x19436
{
	Hash hash;

	hash = func_377(hParam0);
...
BOOL func_653(int* piParam0, Hash hParam1, Hash hParam2, int iParam3, int iParam4) // Position - 0x19455
{
	int num;
	var unk;
	var unk2;
	...
	if (!func_378(hParam1, 2))
		return 0;

	unk2 = 1;
	unk4 = 16;
	func_898(hParam1, &unk2, &unk, &unk4, &num);

	if (func_168(iParam4, 8) && !func_899(hParam1, hParam2, iParam3))
		return 0;
	...
	for (i = 0; i < num; i = i + 1)
	{
		if (unk4[i /*5*/].f_1 == -1591664384)
		{
			...
			if (func_168(iParam4, 4))
				if (!func_656(piParam0, hash, unk85, unk89, hParam2, iParam3 * unk4[i /*5*/].f_4, true, true))
					return 0;
		}
	}
...
BOOL func_654(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5) // Position - 0x19500
{
	var unk;
	...
	if (!func_375(uParam1, &unk, true, false, -1))
		return false;

	if (!func_619(hParam0, func_228(unk.f_4), hParam5))
		return false;

	return true;
}

BOOL func_655(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x19551
{
	...
	if (func_168(iParam2, 2))
		if (func_901(hParam0, hParam1, true))
			return false;

	return true;
}

BOOL func_656(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, Hash hParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x1958C
{
	var unk;
	int num;
	int num2;
	...
	unk.f_4 = hParam6;
	unk = { uParam2 };
	num = func_382(hParam1, uParam2, hParam6, true, !bParam10, false);
	num2 = func_381(hParam1, &unk, !bParam10, true);

	if (bParam9)
		num3 = 1;
	else
		func_547(hParam1, hParam7, &num3, false);

	num4 = func_902(piParam0, hParam1) * num3;
	num4 > 0;
...
BOOL func_657(int* piParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x19643
{
	int num;
	int num2;
	int num3;
	...
	if (func_903(hParam1, true) && !func_904(hParam1, true))
	{
		if (Global_1915656.f_20644)
	...
	{
		num = func_383(hParam1, -570078785, true, false, true, 0);
		num == 0;
		num2 = num * iParam3;
	
		if (!func_357(num2 + func_905(piParam0, hParam2)))
		{
			if (Global_1915656.f_20644)
				func_896(MISC::VAR_STRING(2, "SHOP_H_TOO_POOR_GOLD", num2 / 100));
	...
	{
		num3 = func_383(hParam1, -915411861, true, false, true, 0);
		num3 == 0;
		num4 = num3 * iParam3;
	
		if (!func_356(num4 + func_905(piParam0, hParam2)))
		{
			if (Global_1915656.f_20644)
				func_896("SHOP_H_TOO_POOR");
	...
	if (func_378(func_377(hParam1), 2))
		if (!func_906(func_377(hParam1), iParam3, hParam2, &unk, true))
			return 0;
	else if (func_105(hParam1, 0))
		if (!func_907(hParam1, iParam3, hParam2, &unk, &unk3, false, true, false))
			return 0;

	return 1;
}

BOOL func_658(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x1978B
{
	var unk;

	unk = 1;
	unk.f_1.f_1 = 10;
	return func_908(piParam0, panParam1, hParam2, uParam3, unk, &unk, bParam4, iParam5);
}

BOOL func_659(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x197B9
{
	int num;
	...
	num.f_1.f_1 = 10;
	num.f_1.f_42.f_1 = 10;
	return func_908(piParam0, panParam1, hParam2, uParam3, num, &num, bParam4, iParam5);
}

BOOL func_660(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x197F0
{
	int num;
...
BOOL func_661(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19830
{
	int num;
...
BOOL func_662(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19879
{
	int num;
...
BOOL func_663(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x198CB
{
	int num;
...
BOOL func_664(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19926
{
	int num;
...
BOOL func_665(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x1998A
{
	int num;
...
BOOL func_666(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x199F8
{
	int num;
...
BOOL func_667(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19A6F
{
	int num;
...
BOOL func_668(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19AEF
{
	int num;
...
BOOL func_669(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19B78
{
	int num;
...
BOOL func_670(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19C0A
{
	int num;
...
BOOL func_671(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19CA5
{
	int num;
...
BOOL func_672(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x19D49
{
	int num;
...
int func_673(Hash hParam0, BOOL bParam1) // Position - 0x19DF6
{
	int num;
...
BOOL func_674(int iParam0, Any anParam1, int iParam2, var uParam3, BOOL bParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x19E2F
{
	BOOL flag;
	int num;
	var unk;
	...
	unk2.f_14 = iParam6;
	unk2 = { *iParam2 };
	func_910(anParam1, iParam0, unk2);
	return 1;
}

BOOL func_675(int iParam0) // Position - 0x19F10
{
	return func_111(&(Global_1956875.f_1565), iParam0, 1);
}

int func_676(int iParam0) // Position - 0x19F26
{
	return func_911(func_675(iParam0));
}

BOOL func_677(Player plParam0) // Position - 0x19F38
{
...
void func_678(Player plParam0) // Position - 0x19F55
{
	Player player;
...
BOOL func_679(Hash hParam0, var uParam1) // Position - 0x19FD8
{
	*uParam1 = 0;
	*uParam1 = 0;
...
void func_680(int iParam0, int iParam1, int iParam2) // Position - 0x1A018
{
	Global_1953292.f_83[func_266(iParam0, 1) /*12*/].f_11 = Global_1953292.f_83[func_266(iParam0, 1) /*12*/].f_11 - Global_1953292.f_83[func_266(iParam0, 1) /*12*/].f_11 && iParam1;
	return;
}

BOOL func_681(int iParam0) // Position - 0x1A057
{
	return Global_1953292.f_595[iParam0] > 0;
}

void func_682(int iParam0) // Position - 0x1A06C
{
	Global_1953292.f_595[iParam0] = Global_1953292.f_595[iParam0] + 1;
	return;
}

Ped func_683(Ped pedParam0) // Position - 0x1A08C
{
	Entity firstEntityPedIsCarrying;
	Ped pedIndexFromEntityIndex;
...
void func_684(var uParam0, int iParam1) // Position - 0x1A0D7
{
	BOOL flag;
	int i;
...
BOOL func_685(Hash hParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x1A203
{
	var unk;
	int num;
	...
	num.f_3 = { *uParam1 };
	num.f_2 = iParam4;
	func_915(anParam2, hParam0, num);
	return 1;
}

BOOL func_686(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1A272
{
	if (func_40() == -1)
	{
		if (func_380(hParam0) && func_916(hParam0))
		{
			func_917(hParam0, iParam1, true, &bParam2, hParam3);
			return false;
		}
	}
...
BOOL func_687(Hash hParam0, var uParam1, int iParam2) // Position - 0x1A2C9
{
	var unk;
	int num;
	int num2;
	...
	*uParam1 = iParam2;
	func_918(hParam0, uParam1);
	unk = { func_226(hParam0, false, 1) };
	num = func_381(hParam0, &unk, false, false);
	num2 = func_889(hParam0, false, false, false);

	if (num > 1 && num2 + iParam2 >= num)
		if (func_312(hParam0, -2051813666))
			func_299(674, true);
		else if (func_40() == -1)
			func_299(673, false);

	if (func_227(hParam0, &unk, *uParam1, false, false, -1, false))
		if (num2 < num)
			*uParam1 = num - num2;
		else
			return false;
...
void func_688(Hash hParam0, BOOL bParam1) // Position - 0x1A367
{
	if (bParam1)
		return;
...
void func_689(int iParam0) // Position - 0x1A418
{
	if (!func_262(iParam0))
		return;
...
void func_690(Hash hParam0) // Position - 0x1A439
{
	if (func_312(hParam0, -1522723129))
		func_398(-848633709, false, 255, 0, false);
	else if (func_312(hParam0, -283942357))
		func_398(-981153234, false, 255, 0, false);
	else if (func_312(hParam0, 683680997))
		func_398(-756350192, false, 255, 0, false);
	else if (func_312(hParam0, 1307628809))
		func_398(603094518, false, 255, 0, false);

	return;
}

Hash func_691(Hash hParam0, BOOL bParam1) // Position - 0x1A4BE
{
	Hash hash;
	...
	if (func_105(hash, 0))
		if (bParam1)
			if (func_922(hash) || func_923(hash))
				return hash;
		else
			return hash;
...
Hash func_692(Hash hParam0, BOOL bParam1) // Position - 0x1A6B4
{
	if (!func_105(hParam0, 0))
		return 0;
...
void func_693(Hash hParam0) // Position - 0x1A6E0
{
	Hash weaponUnlock;
...
BOOL func_694(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, Hash hParam6, BOOL bParam7) // Position - 0x1A71A
{
	var unk;
	var unk6;
	var unk28;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_33, hParam0, 0, false))
	{
		...
		if (func_371(hParam0, &unk, unk.f_4, false, false))
		{
			unk6.f_9 = -1591664384;
		
			if (func_372(hParam0, &unk6, unk.f_4))
			{
				unk28 = { func_368(hParam0, unk, unk.f_4, false) };
				func_459(hParam0, &unk28, &unk, 1, -142743235, 1, false);
			}
		}
	}
	...
	if (func_103(false))
	{
		...
		func_695(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0), iParam1, hParam6);
		func_924(hParam0, iParam1);
		return 1;
	}
...
BOOL func_695(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1A84A
{
	if (iParam1 < 1)
		return true;
...
BOOL func_696(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1A885
{
	int num;
	var unk;
	var unk6;
	...
	if (num != 0)
		return func_925(hParam0, iParam1, hParam2);

	unk = { func_226(hParam0, false, 1) };
	unk6 = { func_368(hParam0, unk, unk.f_4, false) };
	return func_926(hParam0, &unk6, &unk, iParam1, hParam2, false);
}

BOOL func_697(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1A8F4
{
	Hash TypeOfWeapon;
	var unk;
	int num;
	...
	TypeOfWeapon = func_692(hParam0, false);
	...
	if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
	{
		if (func_40() == -1)
		{
			...
			if (hParam1 == 1248274121)
				func_927(TypeOfWeapon);
		}
	
		if (!func_227(hParam0, &unk, 1, false, false, -1, false))
		{
			func_917(hParam0, 1, false, uParam2, hParam1);
			num = func_928(TypeOfWeapon);
		
			if (WEAPON::_IS_WEAPON_SNIPER(TypeOfWeapon))
			{
				func_694(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (TypeOfWeapon == joaat("weapon_fishingrod") || WEAPON::_IS_WEAPON_BINOCULARS(TypeOfWeapon))
			{
				func_694(TypeOfWeapon, 0, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::_IS_WEAPON_LASSO(TypeOfWeapon))
			{
				func_694(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::IS_WEAPON_MELEE_WEAPON(TypeOfWeapon))
			{
				if (TypeOfWeapon == joaat("weapon_melee_knife_john") && !func_929())
					return false;
			
				if (WEAPON::SHOULD_WEAPON_BE_DISCARDED_WHEN_SWAPPED(hParam0))
				{
				}
				else if (!func_930(TypeOfWeapon))
				{
					func_694(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
				}
				else
				{
					func_694(TypeOfWeapon, WEAPON::GET_WEAPON_CLIP_SIZE(TypeOfWeapon) * 4, bParam3, bParam4, 0, false, hParam1, false);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(TypeOfWeapon))
			{
				weaponHash = func_931(Global_33, 2, false, true);
			
				if (func_819(weaponHash) && !Global_26688 && weaponHash != TypeOfWeapon && !func_348(joaat("upgrade_offhand_holster"), 1) && bParam4)
					WEAPON::_SEND_WEAPON_TO_INVENTORY(Global_33, weaponHash);
			
				if (func_819(weaponHash) && func_348(joaat("upgrade_offhand_holster"), 1))
					if (!func_694(TypeOfWeapon, num, bParam3, bParam4, 3, true, hParam1, false))
						return false;
				else if (!func_694(TypeOfWeapon, num, bParam3, bParam4, 0, true, hParam1, false))
					return false;
			}
			else if (!func_694(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false))
			{
				return false;
			}
		}
...
BOOL func_698(Hash hParam0) // Position - 0x1AB02
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_699(Hash hParam0, var uParam1, Hash hParam2) // Position - 0x1AB10
{
	int num;
	int weaponClipSize;
	int ReturnMaxAmmo;
	...
	if (func_819(weaponTypeFromAmmoType))
		WEAPON::GET_MAX_AMMO(Global_33, &ReturnMaxAmmo, weaponTypeFromAmmoType);

	num2 = ReturnMaxAmmo - pedAmmoByType;
	...
	{
		func_709(func_932(hParam0), func_542(hParam0, false), true);
		return false;
	}

	ReturnMaxAmmo == pedAmmoByType + num;
	...
	if (func_103(false))
	{
		if (func_695(hParam0, num, hParam2))
		{
			*uParam1 = num;
			return true;
		}
	...
	{
		return func_696(hParam0, *uParam1, hParam2);
	}

	return false;
}

struct<2> func_700(int iParam0) // Position - 0x1AC0E
{
	var unk;
...
BOOL func_701() // Position - 0x1AC20
{
	return false;
}

int func_702(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, int iParam5, BOOL bParam6, int iParam7) // Position - 0x1AC29
{
	int num;
	...
	num = func_933(hParam0, bParam6, iParam7);

	if (!bParam1)
		func_934(num, sParam4, iParam5, false);

	func_935(num, bParam1, iParam2, iParam3);
	return num;
}

void func_703(Hash hParam0) // Position - 0x1AC70
{
	return;
}

void func_704(Hash hParam0) // Position - 0x1AC78
{
	return;
}

void func_705(Hash hParam0) // Position - 0x1AC80
{
	return;
}

void func_706(Hash hParam0) // Position - 0x1AC88
{
	return;
}

void func_707() // Position - 0x1AC90
{
...
void func_708(Hash hParam0, var uParam1) // Position - 0x1ACB4
{
	var unk;

	func_534(hParam0, uParam1, &unk);
	return;
}

void func_709(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x1ACC6
{
	int num;
	int num2;
	...
	if (!func_446(iParam0, num, num2, bParam2))
		return;
...
void func_710(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1AD26
{
	int num;
	int num2;
...
void func_711(var uParam0) // Position - 0x1ADA1
{
	switch (*uParam0)
	{
		case joaat("CONSUMABLE_CIGARETTE_BOX_USED"):
...
void func_712(Hash hParam0) // Position - 0x1ADE5
{
	if (func_40() != -1)
		return;
...
void func_713(Hash hParam0) // Position - 0x1ADF8
{
	switch (hParam0)
	{
...
void func_714(Hash hParam0, int iParam1) // Position - 0x1AE11
{
	char* str;

	str = AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(Global_1902822.f_37);
	func_553(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", iParam1, str), "inventory_items", func_937(hParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, true);
	return;
}

Hash func_715(Ped pedParam0) // Position - 0x1AE52
{
	Ped EntityIndex;
	int pedDamageCleanliness;
	int num;
...
int func_716(Hash hParam0, int iParam1, Ped pedParam2, BOOL bParam3, BOOL bParam4, Hash hParam5, int iParam6, int iParam7) // Position - 0x1AF25
{
	int num;

	if (ENTITY::DOES_ENTITY_EXIST(pedParam2))
	{
		num = func_940(pedParam2, hParam0);
		...
		if (num > 0)
		{
			...
			iParam1 = iParam1 - num;
			func_941(&pedParam2, hParam0, &num, bParam4, hParam5, iParam6);
			iParam1 = iParam1 + num;
		}
	}

	iParam1 = func_942(PLAYER::PLAYER_PED_ID(), hParam0, iParam1, bParam3, iParam6);
...
int func_717(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1AF8F
{
	int num;
	int num2;
	int num3;

	num = func_350(hParam0, false, false, false);
	...
	if (num2 > 0)
		if (!func_216(hParam0, num2, bParam2, hParam3))
			return 0;
		else
			func_943(hParam0, num2, false);

	if (num3 > 0)
	{
		if (!func_944(hParam0, num3, bParam2, hParam3))
			return 0;
		else
			func_943(hParam0, num2, false);
	
		if (!bParam2)
			func_218("SHOP_SELL_HORSE_SATCHEL", 10000, 0, 0, 0, true);
	}

	return 1;
}

BOOL func_718(int iParam0, int iParam1) // Position - 0x1B01E
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_719(int iParam0) // Position - 0x1B036
{
...
BOOL func_720(int iParam0) // Position - 0x1B04D
{
	int i;
	int cloudTimeAsInt;
	int num;
	...
	for (i = 0; i < Global_38.f_3542; i = i + 1)
	{
		if (Global_38.f_3542[i /*3*/].f_2 == iParam0)
		{
			...
			if (num < &func_13 && Global_1904402.f_33[iParam0 /*9*/].f_2 & 32768 != 0)
				return true;
		}
	}
...
BOOL func_721(int iParam0, int iParam1) // Position - 0x1B119
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_722(int iParam0) // Position - 0x1B132
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_723() // Position - 0x1B145
{
	if (!func_524())
		return false;
...
BOOL func_724(int iParam0, int iParam1) // Position - 0x1B160
{
	if (iParam0 == iParam1)
		return true;
...
BOOL func_725(Hash hParam0) // Position - 0x1B188
{
...
BOOL func_726(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x1B19E
{
	*uParam1 = 0;
	...
	if (iParam3 == 0)
	{
		iParam3 = func_379(hParam2, joaat("DEFAULT"));
	...
	if (!func_945(anParam0, uParam1, iParam4, bParam5))
		return false;

	return true;
}

struct<17> func_727(Hash hParam0, var uParam1) // Position - 0x1B20B
{
	var unk;

	unk.f_9 = 1;
	unk.f_11 = -1591664384;
	unk = { func_368(hParam0, *uParam1, uParam1->f_4, true) };
	unk.f_4 = { *uParam1 };
	unk.f_8 = hParam0;
	unk.f_9 = uParam1->f_5;
...
int func_728(Hash hParam0) // Position - 0x1B25E
{
	if (func_105(hParam0, 0))
	{
		if (func_312(hParam0, -1242251796))
		{
			if (func_312(hParam0, 2060589226))
				return func_946();
		...
		else if (func_312(hParam0, 1647670816))
		{
			return func_948();
		}
		else if (func_312(hParam0, 1147021565))
...
int func_729() // Position - 0x1B300
{
	return 225949718;
}

BOOL func_730(Hash hParam0) // Position - 0x1B30D
{
	return hParam0 == 1401465909 || hParam0 == joaat("kit_collectors_bag");
}

int func_731() // Position - 0x1B32B
{
	return 1039657088;
}

BOOL func_732(Hash hParam0) // Position - 0x1B338
{
	if (func_312(hParam0, 1147021565) || func_312(hParam0, -136654233) || func_312(hParam0, -524514947) || func_312(hParam0, -1238310989) || func_312(hParam0, 1765172170) || func_312(hParam0, 1490540191) || func_312(hParam0, 1573112293) || func_312(hParam0, -1242251796) || func_312(hParam0, 1919582297) || func_312(hParam0, -2085281117) || hParam0 == joaat("consumable_offal"))
		return true;

	return false;
}

int func_733() // Position - 0x1B3FA
{
	return 1039392896;
}

int func_734() // Position - 0x1B407
{
	return 1039645941;
}

int func_735() // Position - 0x1B414
{
	return 1039907016;
}

int func_736() // Position - 0x1B421
{
	return 1039902864;
}

int func_737() // Position - 0x1B42E
{
	return 955497620;
}

int func_738() // Position - 0x1B43B
{
	return 1022861303;
}

int func_739() // Position - 0x1B448
{
	return 1039902720;
}

int func_740() // Position - 0x1B455
{
	return 972554239;
}

int func_741() // Position - 0x1B462
{
	return 905165831;
}

int func_742() // Position - 0x1B46F
{
	return 1038298244;
}

int func_743() // Position - 0x1B47C
{
	return 1037713383;
}

int func_744() // Position - 0x1B489
{
	return 1039645911;
}

int func_745() // Position - 0x1B496
{
	return 1039655040;
}

BOOL func_746(int iParam0) // Position - 0x1B4A3
{
	return func_279(Global_1940085.f_7, iParam0);
}

BOOL func_747(BOOL bParam0) // Position - 0x1B4B7
{
	Entity entity;
	...
	{
		if (bParam0)
			func_218("ITEM_UNUSABLE_PICKING_UP", 10000, 0, 0, 0, true);
	...
	if (func_746(2) && MISC::GET_GAME_TIMER() >= Global_17395)
	{
		if (bParam0)
		{
			entity = func_949(Global_33);
		
			if (entity != 0)
			{
				if (ENTITY::GET_IS_ANIMAL(entity))
				{
					func_218("ITEM_UNUSABLE_SKINNING", 10000, 0, 0, 0, true);
					return false;
				}
			}
		
			func_218("ITEM_UNUSABLE_LOOTING", 10000, 0, 0, 0, true);
		}
...
BOOL func_748(BOOL bParam0, BOOL bParam1) // Position - 0x1B54A
{
	var unk;
	...
	if (PED::IS_PED_CARRYING_SOMETHING(Global_33))
	{
		...
		if (bParam0)
			func_218("ITEM_UNUSABLE_CARRYING", 10000, 0, 0, 0, true);
...
BOOL func_749(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x1B59A
{
	Vehicle vehiclePedIsUsing;
	Hash entityModel;
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_33, true))
	{
		...
		switch (entityModel)
		{
			...
			case joaat("hotchkiss_cannon"):
				if (bParam0)
					func_218("ITEM_UNUSABLE_CANNON", 10000, 0, 0, 0, true);
			...
			case joaat("handcart"):
				if (bParam0)
					func_218("ITEM_UNUSABLE_VEHICLE", 10000, 0, 0, 0, true);
			
				return false;
		}
	
		if (!func_168(iParam1, 32) && !PED::IS_PED_ON_MOUNT(Global_33))
...
BOOL func_750(Ped pedParam0, BOOL bParam1) // Position - 0x1B687
{
	float entitySpeed;
	float num;
...
int func_751(var uParam0, int iParam1) // Position - 0x1B6DD
{
	int num;
	int num2;
	int num3;
...
BOOL func_752(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1B760
{
	return !MISC::IS_STRING_NULL_OR_EMPTY_OR_SPACES(func_754(func_956(iParam0, iParam1, bParam2)));
}

struct<8> func_753(int iParam0, int iParam1) // Position - 0x1B77B
{
	return func_956(iParam0, iParam1, true);
}

char* func_754(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x1B78C
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

BOOL func_755(int iParam0, Hash hParam1) // Position - 0x1B7A0
{
	int i;
...
BOOL func_756(int iParam0) // Position - 0x1B7EC
{
	return iParam0 >= 0 && iParam0 < 50;
}

BOOL func_757(int iParam0) // Position - 0x1B802
{
	float num;
	int i;
	int j;
		...
		for (i = 0; i <= 2; i = i + 1)
		{
			...
			else
			{
				for (j = 0; j <= 3; j = j + 1)
				{
					...
					{
						num = func_957(Global_17418.f_2992.f_1[i /*5*/].f_1, Global_1220826.f_48[iParam0 /*21*/][j /*4*/].f_1);
	...
	if (func_122(func_961()) && Global_1220826.f_1.f_20 != 3)
		return false;

	return true;
}

BOOL func_758(int iParam0) // Position - 0x1B913
{
	int i;

	for (i = 0; i <= 1; i = i + 1)
	{
		if (Global_1220826.f_48[iParam0 /*21*/].f_18[i] != 0 && func_348(Global_1220826.f_48[iParam0 /*21*/].f_18[i], 1))
			return true;
	}
...
BOOL func_759(int iParam0) // Position - 0x1B961
{
	int i;

	for (i = 0; i <= 1; i = i + 1)
	{
		if (Global_1220826.f_48[iParam0 /*21*/].f_18[i] != 0 && func_962(Global_1220826.f_48[iParam0 /*21*/].f_18[i]))
			return true;
	}
...
BOOL func_760() // Position - 0x1B9AE
{
	return func_963(func_121(0));
}

BOOL func_761(Ped pedParam0, Hash hParam1, BOOL bParam2) // Position - 0x1B9BF
{
	if (!bParam2)
		if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
			return false;
...
int func_762() // Position - 0x1B9E3
{
	Hash ReturnWeaponType;
	int ReturnWeaponType2;

	if (PED::IS_PED_CARRYING_SOMETHING(Global_33))
		return 1;

	WEAPON::GET_CURRENT_PED_WEAPON(Global_33, &ReturnWeaponType, true, 0, false);
	WEAPON::GET_CURRENT_PED_WEAPON(Global_33, &ReturnWeaponType2, true, 1, false);

	if (ReturnWeaponType2 == joaat("WEAPON_UNARMED"))
		if (ReturnWeaponType == joaat("WEAPON_UNARMED"))
			return 1;
		else if (WEAPON::IS_WEAPON_VALID(ReturnWeaponType) && WEAPON::_IS_WEAPON_TWO_HANDED(ReturnWeaponType) && !func_444(ReturnWeaponType) && !PED::IS_PED_FULLY_ON_MOUNT(Global_33, true) && !(PED::IS_PED_IN_ANY_VEHICLE(Global_33, false) && !CAM::IS_FIRST_PERSON_CAMERA_ACTIVE(1, 0, 0)))
			return 3;
		else if (WEAPON::_IS_WEAPON_BINOCULARS(ReturnWeaponType))
			return 1;
		else if (WEAPON::IS_WEAPON_VALID(ReturnWeaponType) && func_444(ReturnWeaponType) || WEAPON::_IS_WEAPON_LASSO(ReturnWeaponType))
			return 1;
		else
			return 0;
	else if (ReturnWeaponType == joaat("WEAPON_UNARMED"))
		return 1;
	else
		return 0;
...
int func_763(Hash hParam0) // Position - 0x1BAD6
{
	switch (hParam0)
	{
...
void func_764(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1BCB1
{
	Hash hash;
	int num;
	...
	if (!func_969(iParam0))
		func_970(iParam0, true, false);

	if (bParam1)
		if (!func_67(0, false, true))
			func_971(true, 6);

	return;
}

BOOL func_765(Ped pedParam0, Hash hParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x1BD27
{
...
void func_766(Hash hParam0) // Position - 0x1BD60
{
	int num;
	var unk22;
	int i;
	...
	if (func_323(hParam0) == joaat("consumable"))
	{
		...
		for (i = 0; i < num; i = i + 1)
		{
			...
			{
				health = func_972(0, unk22.f_2);
				func_973(unk22.f_2);
				flag3 = true;
			}
			else if (-1104847406 == unk22.f_1)
			{
				deadeye = func_972(2, unk22.f_2);
				func_974(unk22.f_2, false);
				flag2 = true;
			}
			else if (381158954 == unk22.f_1)
			{
				stamina = func_972(1, unk22.f_2);
				func_975(unk22.f_2);
			}
			else if (joaat("EFFECT_HEALTH_CORE") == unk22.f_1)
			{
				num2 = func_837(BUILTIN::TO_FLOAT(unk22.f_2), unk22.f_5);
				func_838(0, num2, true, true, flag);
				flag3 = true;
			}
			else if (joaat("EFFECT_DEADEYE_CORE") == unk22.f_1)
			{
				num3 = func_837(BUILTIN::TO_FLOAT(unk22.f_2), unk22.f_5);
				func_838(2, num3, true, true, flag);
				flag2 = true;
			}
			else if (joaat("EFFECT_STAMINA_CORE") == unk22.f_1)
			{
				num4 = func_837(BUILTIN::TO_FLOAT(unk22.f_2), unk22.f_5);
				func_838(1, num4, true, true, flag);
			}
			else if (joaat("Effect_Health_Core_Gold") == unk22.f_1)
			{
				num5 = func_840(BUILTIN::TO_FLOAT(unk22.f_3), unk22.f_4);
				func_841(19, num5, true, true);
				flag3 = true;
			}
			else if (joaat("Effect_Deadeye_Core_Gold") == unk22.f_1)
			{
				num5 = func_840(BUILTIN::TO_FLOAT(unk22.f_3), unk22.f_4);
				func_841(20, num5, true, true);
				flag2 = true;
			}
			else if (joaat("Effect_Stamina_Core_Gold") == unk22.f_1)
			{
				num5 = func_840(BUILTIN::TO_FLOAT(unk22.f_3), unk22.f_4);
				func_841(18, num5, true, true);
			}
			else if (1869697234 == unk22.f_1)
			{
				num5 = func_840(BUILTIN::TO_FLOAT(unk22.f_3), unk22.f_4);
				func_841(0, num5, true, true);
				flag3 = true;
			}
			else if (1342237631 == unk22.f_1)
			{
				num5 = func_840(BUILTIN::TO_FLOAT(unk22.f_3), unk22.f_4);
				func_841(2, num5, true, true);
				flag2 = true;
			}
			else if (-1240225157 == unk22.f_1)
			{
				num5 = func_840(BUILTIN::TO_FLOAT(unk22.f_3), unk22.f_4);
				func_841(1, num5, true, true);
			}
			else if (-816334026 == unk22.f_1)
			{
				func_839(BUILTIN::TO_FLOAT(unk22.f_2), true);
			}
		}
	
		if (flag3 || func_312(hParam0, -537818634))
			func_107(func_556(joaat("medicine_items_used")), 1);
	
		if (func_312(hParam0, -1457797660))
			func_107(func_556(joaat("provision_items_used")), 1);
	
		if (flag2)
			func_107(func_556(joaat("DEADEYE_ITEMS_USED")), 1);
...
void func_767(int iParam0) // Position - 0x1C0A5
{
...
BOOL func_768() // Position - 0x1C0EB
{
...
BOOL func_769(Hash hParam0) // Position - 0x1C135
{
	int num;

	num = func_228(hParam0);

	if (num == 81053684 || num == -525676072 || func_312(hParam0, 160827531) || func_312(hParam0, -1303648999))
		return 1;

	return 0;
}

void func_770(var uParam0, int iParam1) // Position - 0x1C185
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_771(Hash hParam0) // Position - 0x1C196
{
	Hash hash;
...
BOOL func_772(var uParam0) // Position - 0x1C1C0
{
	if (-1829635046 == func_977(81053684))
		if (func_264(uParam0))
			return true;
	else if (func_294(-525676072, uParam0) || func_312(func_978(1742327865), -1303648999))
		if (func_264(uParam0))
			return true;
...
Hash func_773() // Position - 0x1C21D
{
	int num;
...
Hash func_774() // Position - 0x1C274
{
	int num;
...
Hash func_775() // Position - 0x1C2CB
{
	int num;
...
Hash func_776() // Position - 0x1C322
{
	int num;
...
void func_777(BOOL bParam0) // Position - 0x1C379
{
	Global_1953292 = Global_1953292 - Global_1953292 && bParam0;
	return;
}

int func_778(int iParam0, BOOL bParam1) // Position - 0x1C391
{
	switch (iParam0)
	{
		case -2061583405:
...
int func_779(int iParam0, BOOL bParam1) // Position - 0x1C434
{
	int num;
...
BOOL func_780(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1C4E3
{
	var unk;
	Hash hash;
	...
	if (func_679(hash, &unk))
		return 0;

	if (!func_980(hParam0, 0))
		return 0;

	if (bParam3 && !func_981(hParam0, false, bParam4))
		return 0;
...
void func_781() // Position - 0x1C574
{
	int i;
...
BOOL func_782(int iParam0) // Position - 0x1C632
{
	return func_983(func_982(iParam0));
}

void func_783(BOOL bParam0, Hash hParam1) // Position - 0x1C644
{
	char* StringToTest;
	char* str;
	char* str2;
	...
	if (!func_539(hParam1, &StringToTest, joaat("Inventory"), 0, 0, joaat("ui_itemviewer")))
	{
		StringToTest = "_PLACEHOLDER";
		StringToTest.f_1 = "inventory_items";
	}
	...
	if (bParam0)
	{
		...
		num2 = func_984(hParam1);
	
		if (num2 > 0 && num2 < 11 && func_985(4, num2))
		{
			str = "OUTFIT_STORED_LITERAL";
			str3 = func_754(func_986(num2));
		}
		else
		{
			hash = func_545(hParam1);
		
			if (func_105(hash, 0))
				hParam1 = hash;
		
			str = "ITEM_STORED";
			str3 = MISC::VAR_STRING(0, func_542(hParam1, false));
		}
	}
	else
	{
		...
		if (num2 > 0 && num2 < 11 && func_985(4, num2))
		{
			str = "OUTFIT_REMOVED_LITERAL";
			str3 = func_754(func_986(num2));
		}
		else
		{
			hash2 = func_545(hParam1);
	...
	str4 = func_548(MISC::VAR_STRING(10, str, str3), num);
	func_553(str4, StringToTest.f_1, MISC::GET_HASH_KEY(StringToTest), 0, num, "Transaction_Feed_Sounds", str2, 0, true);
	return;
}

void func_784(BOOL bParam0, BOOL bParam1) // Position - 0x1C7A7
{
	if (bParam1)
		func_987();
...
int func_785() // Position - 0x1C7D9
{
	return Global_1953292.f_1;
}

BOOL func_786(Hash hParam0, Hash hParam1) // Position - 0x1C7E7
{
	int num;
	int num2;

	num = func_228(hParam1);
	num2 = func_228(hParam0);

	if (num == num2)
		return true;

	if (func_988(hParam1) && func_988(hParam0))
		return true;

	return false;
}

void func_787(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1C823
{
	func_989(hParam0, 0, 0, bParam3, bParam5);
	func_502(hParam1, true, bParam2, bParam4, bParam3, bParam5);
	return;
}

void func_788() // Position - 0x1C846
{
	int i;
...
void func_789(Hash hParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x1C88D
{
	int num;
	Hash hash;
	...
	if (bParam3)
	{
		if (*uParam1 == 832230214 || *uParam1 == 30652334 || *uParam1 == 750544038)
		{
			...
			if (func_228(hParam0->f_1[num /*3*/]) != 1882579758)
				return;
		
			hash = func_990(hParam0->f_1[num /*3*/]);
...
void func_790(int iParam0) // Position - 0x1C93B
{
	func_992(&(Global_1953292.f_2938), iParam0);
	return;
}

void func_791(int iParam0, int iParam1) // Position - 0x1C950
{
	if (iParam1 & 8 != 0)
		return;

	func_993(&(Global_1953292.f_2938), iParam0, iParam1);
	return;
}

void func_792(Hash hParam0, int iParam1, int iParam2) // Position - 0x1C973
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

void func_793(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x1C986
{
	Hash hash;
	BOOL flag;

	hash = hParam1;
	flag = func_507(hash, true);

	if (bParam3 && func_312(hParam0->f_1[iParam2 /*3*/], 343781202))
		func_994(hParam0, hParam0->f_1[iParam2 /*3*/]);

	switch (func_427(iParam2, 1))
	{
		case -1944638739:
			func_1010(hParam0, flag, hash, iParam4);
			break;
	
		case -1197751823:
			func_1003(hParam0, flag, hash, iParam4);
			break;
	
		case joaat("MP_COMPONENT_TYPE_HAIR"):
			func_995(hParam0, hash, iParam2, iParam4);
			break;
	
		case -893163968:
			func_1001(hParam0, flag, hash, iParam4);
			break;
	
		case -450913544:
			func_1002(hParam0, flag, hash, iParam2, iParam4);
			break;
	
		case -426430150:
			func_1007(hParam0, flag, iParam4);
			break;
	
		case -338487716:
			func_997(hParam0, hash, flag, iParam4);
			break;
	
		case joaat("MP_COMPONENT_TYPE_LOADOUT_2"):
			func_1006(hParam0, flag, hash, iParam4);
			break;
	
		case 304805134:
			func_1004(hParam0, flag, hash, iParam4);
			break;
	
		case 788010710:
			func_1008(hParam0, flag, hash, iParam4);
			break;
	
		case 1108822547:
			func_998(hParam0, flag, hash, iParam4);
			break;
	
		case 1145151482:
			func_1005(hParam0, flag, hash, iParam4);
			break;
	
		case 1250092473:
			func_1000(hParam0, flag, hash, iParam4);
			break;
	
		case joaat("MP_COMPONENT_TYPE_BEARD"):
			func_996(hParam0, hash, iParam2);
			break;
	
		case 1742327865:
			func_999(hParam0, flag, hash, iParam4);
			break;
	
		case 1958421083:
			func_1009(hParam0, flag, hash, iParam4);
			break;
	}
...
Hash func_794(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1CB1F
{
	BOOL flag;

	flag = false;

	if (func_785() == joaat("MPC_PLAYER_TYPE_MP_FEMALE"))
		flag = true;

	if (hParam2 == 289238755)
		return 289238755;

	if (hParam2 != 0 && func_1011(hParam0, flag, hParam2) != -1)
		return hParam2;

	if (func_1012(hParam0, func_427(iParam1, 1), &hParam2))
		return hParam2;

	return 0;
}

void func_795(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1CB80
{
	int i;
	int num;
	BOOL flag;
	...
	if (bParam5)
	{
		num = func_1013(Global_1953292.f_1676);
	...
	{
		if (func_425(4718592) && !func_1014(func_228(Global_1953292.f_1557.f_1[iParam0->f_2[i /*2*/] /*3*/])))
		{
		}
		else
		{
			func_1015(iParam0->f_2[i /*2*/], bParam1, bParam2, num);
			flag = true;
		}
	}
	...
	if (bParam4)
	{
		...
		if (Global_1953292.f_1676 != 491602716 || !func_985(2, -1))
			flag2 = true;
		else if (!func_312(Global_1953292.f_1676, -166674229) && Global_1953292.f_1676 != 491602716 || !func_985(2, -1))
			flag2 = true;
		...
		if (flag2)
		{
			...
			func_1016(491602716, true, true);
			func_1017(-1, false, 6);
			func_268(27, 0, 65536, 0, false);
		}
	}
...
Hash func_796(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0x1CCBF
{
	return func_1018(&uParam0, hParam4, bParam5, iParam6);
}

BOOL func_797(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1CCD3
{
	var unk;
	...
	if (!func_375(uParam0, &unk, bParam5, false, -1))
		return false;

	if (unk.f_10 == bParam4)
		return true;

	if (!INVENTORY::_INVENTORY_EQUIP_ITEM_WITH_GUID(func_213(bParam5), &uParam0, bParam4))
		return false;

	return true;
}

BOOL func_798(Ped pedParam0) // Position - 0x1CD47
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;

	if (func_1020(Global_33, pedParam0, false, true) < 2f && PED::IS_ANIMAL_INTERACTION_POSSIBLE(Global_33, pedParam0))
		return true;

	return false;
}

BOOL func_799() // Position - 0x1CD7F
{
	int num;
	int num2;
	int num3;
	...
	if (func_122(num))
	{
		...
		switch (num)
		{
			...
			case 4:
				...
				if (num4 != -1)
					if (func_752(num4, 461218520, false))
						num2 = 46;
				break;
		
			case 6:
				num3 = func_530(PLAYER::PLAYER_ID(), false);
	...
	if (func_960(4, PLAYER::NETWORK_PLAYER_ID_TO_INT()) && Global_1051832.f_92[34 /*75*/].f_49 & 1073741824 == 0)
	{
		func_467(5);
		return false;
	}
...
BOOL func_800(int iParam0, int iParam1) // Position - 0x1CEB3
{
	if (PED::IS_PED_IN_COMBAT(Global_33, 0) || PED::IS_PED_IN_MELEE_COMBAT(Global_33) || func_168(iParam1, 1024) && PED::COUNT_PEDS_IN_COMBAT_WITH_TARGET_WITHIN_RADIUS(Global_33, Global_34, iParam0, iParam1) > 0)
		return true;

	return false;
}

BOOL func_801(Player plParam0) // Position - 0x1CEFE
{
	if (plParam0 == 255)
		return Global_1102813.f_3 & 32 != 0;

	return func_1023(32, plParam0);
}

BOOL func_802(int iParam0) // Position - 0x1CF23
{
...
void func_803(BOOL bParam0) // Position - 0x1CF4B
{
	if (bParam0)
		func_1025(4);
	else
...
void func_804(BOOL bParam0) // Position - 0x1CF65
{
...
BOOL func_805() // Position - 0x1CFA5
{
	return Global_1915656.f_20643;
}

BOOL func_806(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x1CFB4
{
	Player PlayerIndex;
	Ped EntityIndex;
	BOOL isEntityDead;
...
BOOL func_807(int iParam0, int iParam1, Player plParam2) // Position - 0x1D1DA
{
	return func_279(Global_1206166[plParam2 /*10*/][iParam0], iParam1);
}

int func_808(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x1D1F4
{
...
BOOL func_809(Hash hParam0, Hash hParam1) // Position - 0x1D224
{
	if (hParam1 == 0)
		return false;
...
Hash func_810(Hash hParam0, BOOL bParam1) // Position - 0x1D24B
{
	switch (hParam0)
	{
...
int func_811(Hash hParam0) // Position - 0x1D2ED
{
	var unk;
	int num;
...
BOOL func_812(Hash hParam0) // Position - 0x1D327
{
	!func_105(hParam0, 0);

	if (func_312(hParam0, -393037696))
		return true;

	return false;
}

int func_813(Hash hParam0, int iParam1) // Position - 0x1D34D
{
	var unk;
	int num;
	int num2;
...
char* func_814(Hash hParam0) // Position - 0x1D39B
{
	Hash labelHash;
	...
	labelHash = func_542(hParam0, false);
...
BOOL func_815(Hash hParam0) // Position - 0x1D3D1
{
	if (func_228(hParam0) == -126813555 || func_228(hParam0) == 1946043663)
		return true;

	return false;
}

char* func_816(Hash hParam0) // Position - 0x1D3FF
{
	Hash labelHash;
...
void func_817(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x1D434
{
...
BOOL func_818(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x1D465
{
...
BOOL func_819(Hash hParam0) // Position - 0x1D48C
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_820(Hash hParam0) // Position - 0x1D4A7
{
	switch (hParam0)
	{
...
int func_821(var uParam0, int iParam1) // Position - 0x1D58A
{
	int i;
...
int func_822(Hash hParam0) // Position - 0x1D5C7
{
	int num;
...
Ped func_823(int iParam0) // Position - 0x1D634
{
	return PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::GET_PLAYER_INDEX());
}

int func_824(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1D644
{
	int num;

	num = func_350(hParam1, bParam2, false, false);
	num = num + func_1028(pedParam0, hParam1);

	if (bParam3)
		num = num + func_1029(hParam1, bParam4);

	return num;
}

void func_825(int iParam0) // Position - 0x1D679
{
	if (!func_105(Global_1940252.f_11588, 0))
		Global_1940252.f_7 = iParam0;
	else if (func_400(Global_1940252.f_11588, 1224357681) != 0 && Global_1940252.f_11587 != 0 && Global_1940252.f_11587 != -2074770370 && !Global_1915656.f_20638 && !Global_1915656.f_22504.f_1)
...
void func_826(var uParam0) // Position - 0x1D6FE
{
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_49))
	{
		if (PED::IS_PED_MALE(Global_33))
...
BOOL func_827(const char* sParam0) // Position - 0x1D985
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
}

BOOL func_828(var uParam0, var uParam1) // Position - 0x1D994
{
...
int func_829(Hash hParam0) // Position - 0x1D9DE
{
	var unk;
...
void func_830(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1D9FA
{
	int num;
	int num2;
	int num3;
	...
	num = func_350(uParam0->f_49.f_62, false, false, false);

	if (bParam2)
		num = num - 1;

	num2 = func_1030(uParam0->f_49.f_62, false);
	num3 = func_225(uParam0->f_49.f_62, uParam0->f_49.f_63, func_583(), false);
	...
	uParam0->f_49.f_27 = func_593(num2, num3);
	return;
}

BOOL func_831() // Position - 0x1DA78
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(-768274665);
}

void func_832(int iParam0, char* sParam1, int iParam2, BOOL bParam3) // Position - 0x1DA89
{
	int num;
...
float func_833(int iParam0, float fParam1) // Position - 0x1DAD9
{
	float pedStamina;
	float pedMaxStamina;
	float num;
...
void func_834(float fParam0) // Position - 0x1DB6A
{
	Ped ped;
	int num;
	...
	num = func_1031(2);
	func_1032(fParam0 * (float)num, 0);
	return;
}

void func_835(float fParam0, BOOL bParam1) // Position - 0x1DBAA
{
	int num;
	...
	num = func_1033(2);
	func_1034(fParam0 * (float)num, false, bParam1);
	return;
}

void func_836(float fParam0) // Position - 0x1DBE2
{
	Ped ped;
	int num;
	...
	num = func_1035(2);
	func_1036(fParam0 * (float)num, 0);
	return;
}

float func_837(float fParam0, float fParam1) // Position - 0x1DC22
{
	if (fParam1 != 0f)
...
void func_838(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1DC50
{
	if (fParam1 == 0f)
		return;

	if (bParam4)
		fParam1 = func_1037(iParam0, fParam1, true);

	func_1039(iParam0, func_1038(iParam0, 2) + fParam1, bParam2, bParam3, true, 2);
	return;
}

void func_839(float fParam0, BOOL bParam1) // Position - 0x1DC89
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
float func_840(float fParam0, int iParam1) // Position - 0x1DCE1
{
	switch (iParam1)
	{
		case 0:
...
int func_841(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1DD33
{
	if (!ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		return 0;
...
void func_842(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x1DD57
{
	if (bParam2 || func_312(hParam0, -537818634))
		func_107(func_556(joaat("medicine_items_used")), 1);
	...
	if (func_312(hParam0, 1573112293))
		func_1043(func_763(hParam0), 1);

	if (func_312(hParam0, 1939071949))
		func_107(func_106(joaat("USED"), joaat("tonic")), 1);

	if (func_312(hParam0, 1992556171))
		func_107(func_556(joaat("camp_stews_consumed")), 1);

	if (func_312(hParam0, 1239889275))
		func_107(func_556(joaat("antique_bottles_drunk")), 1);
	...
	switch (hParam0)
	{
		...
		case joaat("consumable_haycube"):
			func_107(func_106(joaat("USED"), joaat("feed_bag")), 1);
			break;
	}
	...
	switch (hParam0)
	{
		...
		case joaat("consumable_potent_horse_medicine"):
			func_107(func_106(joaat("USED"), joaat("horse_pills")), 1);
			break;
	
		case joaat("consumable_whiskey_used"):
		case joaat("consumable_whiskey"):
			func_107(func_106(joaat("USED"), joaat("Whiskey")), 1);
			break;
	
		case joaat("consumable_predator_bait"):
		case joaat("consumable_potent_predator_bait"):
			func_107(func_106(joaat("USED"), joaat("potent_predator_bait")), 1);
			break;
	
		case joaat("consumable_snake_oil"):
		case joaat("consumable_potent_snake_oil"):
		case joaat("consumable_snake_oil_used"):
			func_107(func_106(joaat("USED"), joaat("Snake_Oil")), 1);
			break;
	
		case -611782825:
			func_107(func_106(joaat("USED"), -1875859641), 1);
			break;
	
		case joaat("consumable_cocaine_chewing_gum_used"):
		case joaat("consumable_cocaine_chewing_gum"):
			func_107(func_106(joaat("USED"), joaat("cocaine_gum")), 1);
			break;
	
		case joaat("consumable_chewing_tobacco"):
		case joaat("consumable_chewing_tobacco_used"):
			func_107(func_106(joaat("USED"), joaat("chewing_tobacco")), 1);
			break;
	
		case joaat("consumable_moonshine"):
			func_107(func_106(joaat("USED"), joaat("moonshine")), 1);
			break;
	
		case joaat("consumable_herbivore_bait"):
		case joaat("consumable_potent_herbivore_bait"):
			func_107(func_106(joaat("USED"), joaat("potent_herbivore_bait")), 1);
			break;
	}

	if (func_40() == -1)
		if (hParam0 == joaat("CONSUMABLE_SPECIAL_TONIC_CRAFTED"))
			func_107(func_106(joaat("USED"), joaat("special_tonic")), 1);

	if (bParam1)
		func_107(func_556(joaat("DEADEYE_ITEMS_USED")), 1);

	func_1044(hParam0, iParam3);
	return;
}

int func_843(int iParam0) // Position - 0x1DFC1
{
	int i;
...
BOOL func_844() // Position - 0x1E00D
{
	return Global_1896762.f_352;
}

BOOL func_845(var uParam0) // Position - 0x1E01C
{
	return func_99(uParam0, 1);
}

void func_846(var uParam0) // Position - 0x1E02B
{
	func_220(uParam0, 1);
	return;
}

void func_847(var uParam0) // Position - 0x1E03A
{
	func_96(true);
	func_100(uParam0, 4);
	return;
...
BOOL func_848(var uParam0) // Position - 0x1E04E
{
	Player gangLeader;
	...
	if (func_99(uParam0, 2))
	{
		...
		uParam0->f_25 = func_1045(gangLeader);
		uParam0->f_26 = func_1046(gangLeader);
		func_1047(uParam0, uParam0->f_25, 1472825031);
		func_1047(uParam0, -1171462349, 1472825031);
		func_1047(uParam0, 1689071181, 1472825031);
		func_1047(uParam0, -1612693182, 1472825031);
		func_1047(uParam0, 1856073229, 1472825031);
		return true;
	}
	...
	if (uParam0->f_44 == 0)
	{
		Global_1913634.f_1576 = 0;
		uParam0->f_45 = 0;
		func_1048(uParam0, 600942249);
		uParam0->f_44 = uParam0->f_44 + 1;
		return false;
	}
	else if (uParam0->f_44 == 1)
	{
		func_1048(uParam0, -257768755);
		uParam0->f_44 = uParam0->f_44 + 1;
		return false;
	}
	else
	{
		func_1048(uParam0, -214678071);
		uParam0->f_44 = 0;
	}
...
BOOL func_849(var uParam0) // Position - 0x1E183
{
	int i;
	var unk;
	...
	DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam0->f_29, "filter", func_99(uParam0, 2) ? joaat("recipes") : func_1049(uParam0->f_42));
	...
	for (i = 0; i < 4; i = i + 1)
	{
		...
		func_1050(&uParam0->f_31[i], &unk, uParam0);
...
BOOL func_850(var uParam0) // Position - 0x1E377
{
	Hash i;
	int num;
	BOOL flag;
	...
	{
		if (func_105(Global_1913634[i /*9*/].f_6, 0))
		{
			func_1051(uParam0, false, i, flag, true, false);
...
void func_851(var uParam0) // Position - 0x1E3F5
{
...
BOOL func_852(var uParam0, BOOL bParam1) // Position - 0x1E437
{
	Hash i;
	int num;
	BOOL flag;
	...
	for (i = uParam0->f_45; i <= Global_1913634.f_1576 - 1; i = i + 1)
	{
		if (func_99(uParam0, 128) && Global_1913634[i /*9*/].f_2 || !func_99(uParam0, 128))
		{
			if (Global_1913634.f_1585 != 0)
			{
				uParam0->f_74 = Global_1913634.f_1585;
				flag2 = func_312(Global_1913634[i /*9*/].f_6, Global_1913634.f_1585);
			
				if (func_99(uParam0, 16384) == flag2)
				{
				}
				else
				{
					func_1051(uParam0, true, i, flag, false, bParam1);
	...
	if (!func_99(uParam0, 16384) && Global_1913634.f_1585 != 0)
	{
...
BOOL func_853(var uParam0, BOOL bParam1) // Position - 0x1E52C
{
	int num;
...
BOOL func_854(var uParam0) // Position - 0x1E585
{
	int i;
	int num;
	BOOL flag;
	...
	for (i = uParam0->f_45; i <= Global_1913634.f_1576 - 1; i = i + 1)
	{
		func_1052(uParam0, i, flag, 0, true, false, true);
...
void func_855(BOOL bParam0) // Position - 0x1E5E6
{
	Ped EntityIndex;
	...
	EntityIndex = func_1053(Global_33);

	if (!ENTITY::IS_ENTITY_DEAD(EntityIndex))
		PED::SET_PED_MAX_MOVE_BLEND_RATIO(EntityIndex, 1f);
...
void func_856(var uParam0) // Position - 0x1E6C8
{
	int num;

	func_93(uParam0);
	func_1054(uParam0, true);
	uParam0->f_1[2] = func_163("CAMP_REC_QUIT", joaat("INPUT_GAME_MENU_CANCEL"), 3, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
	func_164(uParam0->f_1[2], true, true, true);
	uParam0->f_1[1] = func_163("CAMP_REC_MAKE", joaat("INPUT_GAME_MENU_ACCEPT"), 3, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
	...
	if (!func_99(uParam0, 2))
	{
		...
		if (func_105(uParam0->f_60, 0))
			if (func_399(uParam0->f_60))
				func_290(uParam0->f_1[1], "CAMP_REC_COOK", true);
			else if (func_400(uParam0->f_60, -1636519629) == -701492487)
				func_290(uParam0->f_1[1], "CAMP_REC_BREW", true);
			else
				func_290(uParam0->f_1[1], "CAMP_REC_MAKE", true);
	
		uParam0->f_1[3] = func_163(func_1056(uParam0), joaat("INPUT_GAME_MENU_EXTRA_OPTION"), 1, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
	}
	else
	{
		uParam0->f_1[7] = func_163("CAMP_ADD_TASK", joaat("INPUT_GAME_MENU_RS"), 3, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
	}

	uParam0->f_1[5] = func_1057("RECIPE", joaat("INPUT_GAME_MENU_LEFT"), joaat("INPUT_GAME_MENU_RIGHT"), 0);
	func_1058(uParam0->f_1[5], joaat("INPUT_GAME_MENU_LEFT"));
	func_1058(uParam0->f_1[5], joaat("INPUT_GAME_MENU_RIGHT"));
	...
	if (num > 1 && func_105(uParam0->f_62, 0))
		func_164(uParam0->f_1[5], true, true, true);
	else
		func_164(uParam0->f_1[5], false, true, true);

	uParam0->f_1[6] = func_163("INFO", joaat("INPUT_GAME_MENU_OPTION"), 1, 0, 0, 2, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);

	if (!func_99(uParam0, 32768))
		func_290(uParam0->f_1[6], "INFO", true);
	else
		func_290(uParam0->f_1[6], "INGREDIENTS", true);

	if (DATABINDING::_DATABINDING_GET_ARRAY_COUNT(uParam0->f_30) == 0)
	{
		func_859(uParam0);
		func_164(uParam0->f_1[6], false, true, true);
...
BOOL func_857(var uParam0) // Position - 0x1E95D
{
	Player gangLeader;
	...
	if (uParam0->f_26 != func_1046(gangLeader))
	{
		uParam0->f_26 = func_1046(gangLeader);
		func_100(uParam0, 15);
		return true;
	...
	if (uParam0->f_25 != func_1045(gangLeader))
	{
		func_100(uParam0, 4);
		return true;
	}
...
BOOL func_858(var uParam0) // Position - 0x1E9BE
{
...
void func_859(var uParam0) // Position - 0x1EA13
{
	int i;
...
void func_860(var uParam0, Hash hParam1, Hash hParam2) // Position - 0x1EA74
{
	var unk;
	var unk2;
	BOOL flag;
	...
	if (!Global_1913634.f_1579 && func_901(hParam1, hParam2, true))
	{
		flag3 = true;
		flag2 = false;
	}
	else if (!func_1059(hParam1, hParam2, &unk2, &unk, &entity, false, flag, false) || func_577(uParam0->f_24))
	{
		flag2 = false;
	}
	else if (func_99(uParam0, 2) && !func_1060(hParam1))
	{
		flag2 = false;
	}
	...
	if (flag2)
	{
		if (hParam1 != joaat("consumable_coffee") && func_592(hParam1, 1, false) || !func_99(uParam0, 4) && func_99(uParam0, 8192) || hParam2 == -214678071 || hParam2 == joaat("cost_crafting_grill"))
		{
			flag2 = false;
		}
		else if (!func_582(2) && func_400(hParam1, -1636519629) == -701492487)
		{
			flag2 = false;
		}
		else if (uParam0->f_27 == -1)
		{
			num = func_350(hParam1, false, false, false);
			num2 = func_1030(hParam1, false);
			num3 = func_225(hParam1, hParam2, flag, false);
			...
			uParam0->f_27 = func_593(num2, num3);
		}
	}

	if (func_886(uParam0, hParam1) && uParam0->f_27 > 1)
		if (!func_45(uParam0->f_1[8]))
			uParam0->f_1[8] = func_163("CAMP_REC_BATCH", joaat("INPUT_GAME_MENU_LS"), 1, 0, 0, 0, 570, 4000, 10, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
	else if (func_45(uParam0->f_1[8]))
		func_46(&uParam0->f_1[8], true, true);

	if (func_45(uParam0->f_1[1]))
	{
		if (func_99(uParam0, 2))
			func_290(uParam0->f_1[1], "DONATE_ING", true);
		else if (func_399(hParam1))
			if (func_99(uParam0, 131072) && uParam0->f_27 > 1)
				func_290(uParam0->f_1[1], MISC::VAR_STRING(2, "CAMP_REC_COOK_MLT", func_593(uParam0->f_27, 3)), true);
			else
				func_290(uParam0->f_1[1], "CAMP_REC_COOK", true);
		else if (func_400(hParam1, -1636519629) == -701492487)
			func_290(uParam0->f_1[1], "CAMP_REC_BREW", true);
		else
			func_290(uParam0->f_1[1], "CAMP_REC_MAKE", true);
	
		func_164(uParam0->f_1[1], flag2, true, true);
	}

	func_1061(hParam1, hParam2, uParam0, entity, flag3);

	if (func_45(uParam0->f_1[6]))
		func_164(uParam0->f_1[6], !flag3, true, true);

	func_1062(uParam0);
	return;
}

BOOL func_861(int iParam0, BOOL bParam1) // Position - 0x1ED4A
{
	int num;
...
void func_862(char* sParam0, char* sParam1, BOOL bParam2) // Position - 0x1ED7D
{
	int soundId;
...
void func_863(var uParam0) // Position - 0x1EDBC
{
	int num;
	var unk;
	int num2;
	...
	if (func_105(uParam0->f_62, 0))
	{
		...
		unk = 15;
		func_360(uParam0->f_62, uParam0->f_63, &unk, &num, true, false);
		...
		if (func_1063(uParam0->f_62, &icon, joaat("Inventory"), 0, 0, 0))
		{
...
void func_864(var uParam0) // Position - 0x1EF1E
{
	int num;
	AnimScene animScene;
	...
	func_46(&uParam0->f_1[1], true, true);
	func_46(&uParam0->f_1[5], true, true);
	func_46(&uParam0->f_1[6], true, true);
	func_46(&uParam0->f_1[3], true, true);
	func_46(&uParam0->f_1[7], true, true);
	func_189(uParam0, 64);
	...
	if (!func_99(uParam0, 8192) && !func_399(uParam0->f_62))
	{
		...
		if (animScene != 0)
		{
			...
			if (num != -1610298873)
				...
				else if (func_312(uParam0->f_62, -1588156645))
					uParam0->f_70 = func_829(func_691(uParam0->f_62, false));
				else if (func_312(uParam0->f_62, 457423347))
					uParam0->f_70 = joaat("s_cft_arrow_dynamite");
				else if (func_312(uParam0->f_62, -1846429632))
					uParam0->f_70 = joaat("s_cft_arrow_fire");
				else if (func_312(uParam0->f_62, -1067199465))
		...
		func_290(uParam0->f_1[2], "CAMP_REC_BACK", true);
		func_172(uParam0->f_1[2], -1067771379, 0, true);
		func_164(uParam0->f_1[2], false, true, true);
		func_165(uParam0->f_1[2], false, true);
		uParam0->f_1[4] = func_163("CAMP_REC_BACK", joaat("INPUT_GAME_MENU_CANCEL"), 1, 0, 0, 5, 570, 4000, 10, 1073741824, joaat("MEDIUM_TIMED_EVENT"), false);
		func_449(&uParam0->f_1[4], "INPUT_PCRAFT_EXIT");
		func_172(uParam0->f_1[4], -1067771379, 0, true);
		func_164(uParam0->f_1[4], false, true, true);
		func_448(uParam0->f_1[4], 19, true, true);
		func_448(uParam0->f_1[4], 20, true, true);
		func_448(uParam0->f_1[4], 13, true, true);
		func_448(uParam0->f_1[2], 13, true, true);
...
BOOL func_865(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1F1E6
{
	int num;
...
void func_866(var uParam0, BOOL bParam1) // Position - 0x1F21B
{
	int num;
	int num2;
	BOOL flag;
	...
	if (DATABINDING::DATABINDING_IS_ENTRY_VALID(uParam0->f_58))
	{
		...
		if (uParam0->f_63 == -214678071 || uParam0->f_63 == joaat("cost_crafting_grill"))
		{
			...
			if (num == 0)
			{
				unk = { func_607(-1591664384, -1591664384, 0, 0, -214678071, 0, -1, func_400(uParam0->f_62, 1697966752), 0) };
			
				if (func_608(unk, &num3, &num4, 0))
				{
					if (num4 > 0)
					{
						uParam0->f_63 = -214678071;
						uParam0->f_62 = func_609(0, num3);
						flag = true;
					}
			...
			{
				unk = { func_607(-1591664384, -1591664384, 0, 0, joaat("cost_crafting_grill"), 0, -1, func_400(uParam0->f_62, 1697966752), 0) };
				...
				if (func_608(unk, &num3, &num4, 0))
				{
					if (num4 > 0)
					{
						...
						{
							hash2 = func_609(i, num3);
						
							if (func_312(hash2, hash))
							{
		...
		else
		{
			...
			while (hash3.f_2 != joaat("cost_type_craft") || hash3 == -489628648 || hash3 == -2141192156 || !Global_1913634.f_1579 && func_901(uParam0->f_62, hash3, true) && num5 < acquireCostsCount)
			{
				num5 = num5 + 1;
		...
		func_1052(uParam0, -1, func_583(), uParam0->f_58, false, flag, false);
		func_860(uParam0, uParam0->f_62, uParam0->f_63);
	}
...
void func_867(var uParam0, BOOL bParam1) // Position - 0x1F580
{
	int num;
	...
	if (uParam0->f_63 == -214678071)
	{
		if (DATABINDING::_DATABINDING_READ_DATA_INT_FROM_PARENT(uParam0->f_58, "enabled") == 1)
		{
			...
			{
				num = func_225(uParam0->f_62, uParam0->f_63, func_583(), false);
...
void func_868(var uParam0) // Position - 0x1F6B9
{
	if (func_99(uParam0, 2))
		return;
...
void func_869(var uParam0, var uParam1) // Position - 0x1F718
{
	func_859(uParam0);
	func_1065(uParam0);
	func_1055(uParam0, &(uParam1->f_3));
	return;
}

void func_870(var uParam0) // Position - 0x1F736
{
	int num;
	Hash ModelIndex;
	Hash ModelIndex2;
	...
	if (num == 414472632)
	{
		...
		{
			ModelIndex = func_1068(uParam0->f_62);
		
			if (ModelIndex != 0)
			{
				uParam0->f_64 = OBJECT::CREATE_OBJECT(ModelIndex, Global_34, true, NETWORK::NETWORK_GET_THIS_SCRIPT_IS_NETWORK_SCRIPT() && NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT(), false, false, false);
	...
	else if (num == -715814988)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_64))
		{
			ModelIndex2 = func_1068(uParam0->f_62);
		
			if (ModelIndex2 != 0)
			{
				uParam0->f_64 = OBJECT::CREATE_OBJECT(ModelIndex2, Global_34, true, NETWORK::NETWORK_GET_THIS_SCRIPT_IS_NETWORK_SCRIPT() && NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT(), false, false, false);
	...
	{
		uParam0->f_43 = BUILTIN::ROUND(ENTITY::GET_ANIM_DURATION(func_1070(uParam0->f_62), func_1071(uParam0->f_62)) * 1000f);
		func_118(&(uParam0->f_71));
		TASK::TASK_PLAY_ANIM(Global_33, func_1070(uParam0->f_62), func_1071(uParam0->f_62), 1090519040, -1056964608, -1, 67108880, 0, false, 4096, false, "Satchel_Only_filter", false);
	}

	return;
}

void func_871(var uParam0, BOOL bParam1, var uParam2) // Position - 0x1FBAD
{
	int i;
	int j;
	...
	for (i = 0; i < uParam0->f_1; i = i + 1)
	{
		if (func_45(uParam0->f_1[i]))
		{
			for (j = 0; j < *uParam2; j = j + 1)
			{
				if (func_45(uParam2->[j]))
				{
			...
			func_164(uParam0->f_1[i], bParam1, true, true);
		}
	}
...
BOOL func_872(int iParam0) // Position - 0x1FC1E
{
...
AnimScene func_873(var uParam0, int iParam1) // Position - 0x1FCA6
{
	switch (iParam1)
	{
		case -1610298873:
...
BOOL func_874(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1FD2C
{
	var unk;
	var unk2;
	var unk3;

	return func_1059(hParam0, hParam1, &unk, &unk2, &unk3, bParam2, bParam3, bParam4);
}

void func_875(var uParam0, int iParam1, BOOL bParam2) // Position - 0x1FD48
{
	AnimScene animScene;
	...
	func_98(&(uParam0->f_66), &(uParam0->f_67));
	func_98(&(uParam0->f_64), &(uParam0->f_65));
	animScene = func_873(uParam0, iParam1);
	ANIMSCENE::SET_ANIM_SCENE_BOOL(animScene, "bStopLoop", true, false);
	func_164(uParam0->f_1[2], true, true, true);
	func_164(uParam0->f_1[4], true, true, true);
	func_165(uParam0->f_1[2], false, true);
	func_165(uParam0->f_1[4], true, true);
	func_591(uParam0->f_1[1], true);
	func_46(&uParam0->f_1[1], true, true);
	uParam0->f_1[1] = func_163("CAMP_REC_MAKE", joaat("INPUT_GAME_MENU_ACCEPT"), 3, 0, 0, 0, uParam0->f_43, uParam0->f_43 + 1, 1, 1073741824, joaat("SHORT_TIMED_EVENT"), false);
	func_448(uParam0->f_1[1], 11, true, true);
	func_448(uParam0->f_1[1], 19, true, true);
	func_172(uParam0->f_1[1], -1067771379, 0, true);
	func_164(uParam0->f_1[1], bParam2, true, true);
	func_100(uParam0, 13);
	return;
}

Player func_876() // Position - 0x1FE49
{
	Player gangLeader;
...
BOOL func_877(BOOL bParam0) // Position - 0x1FE7B
{
	if (bParam0)
...
void func_878(BOOL bParam0) // Position - 0x1FEF3
{
	var unk;
	int num;
	...
	func_1072(num, unk, func_109(GANG::NETWORK_GET_GANG_LEADER(GANG::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()))));
	return;
}

void func_879(var uParam0) // Position - 0x1FF26
{
	Player gangLeader;
	...
	{
		func_1073(gangLeader, true);
		func_1074(gangLeader, uParam0);
...
void func_880(Hash hParam0, int iParam1) // Position - 0x1FF6F
{
	var statId;

	statId = { func_1078(hParam0) };
	STATS::_STAT_ID_INCREMENT_INT(&statId, iParam1);

	if (!func_312(hParam0, 1714518167))
	{
		statId = { func_1079(hParam0) };
...
void func_881(var uParam0) // Position - 0x1FFB5
{
	var requestId;
	var unk4;
	int num;
	...
	{
		unk4 = { func_1080(Global_1295666) };
		num = 0;
		flag = func_312(uParam0->f_62, -2011345500);
	
		if (!flag)
		{
			unk7 = 15;
		
			if (func_360(uParam0->f_62, uParam0->f_63, &unk7, &num2, true, false) && num2 > 0)
				num = unk7[0 /*2*/];
		}
...
void func_882(int iParam0) // Position - 0x20038
{
...
int func_883(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2005A
{
	int num;
	var unk;
	Hash hash;
	...
	if (!func_907(hParam0, 1, hParam1, &hash, &unk33, bParam3, false, false))
	{
		hash2 = hash;
		return 0;
	}

	if (func_360(hParam0, hParam1, &unk, &num2, true, false))
	{
		for (i = 0; i < num2; i = i + 1)
		{
			hash2 = unk[i /*2*/];
			num3 = func_358(num, hash2);
			...
			if (func_105(hash2, 0))
			{
				...
				{
					func_1081(unk[i /*2*/].f_1, 0, 0, bParam2, false);
				}
				else if (bParam3)
				{
					if (func_361(hash2) || func_362(hash2))
					{
						if (!func_348(hash2, unk[i /*2*/].f_1))
							num4 = func_1082(7, hash2, unk[i /*2*/].f_1);
					
						func_308(hash2, num4, 562618531, false, false);
						unk[i /*2*/].f_1 = unk[i /*2*/].f_1 - num4;
					
						if (unk[i /*2*/].f_1 > 0)
						{
							if (!func_348(hash2, unk[i /*2*/].f_1))
								func_1083(hash2, unk[i /*2*/].f_1);
						
							if (func_348(hash2, unk[i /*2*/].f_1))
								func_216(hash2, unk[i /*2*/].f_1, bParam2, -142743235);
						}
					}
					else
					{
						...
						if (unk[i /*2*/].f_1 > 0)
						{
							if (func_365(7, hash2) > 0)
							{
								func_1085(7, hash2, unk[i /*2*/].f_1);
								unk[i /*2*/].f_1 = unk[i /*2*/].f_1 - func_1085(7, hash2, unk[i /*2*/].f_1);
							}
						}
					
						if (unk[i /*2*/].f_1 > 0)
							func_216(hash2, unk[i /*2*/].f_1, bParam2, 562618531);
					}
				}
				else if (num3 == 0)
				{
				...
				{
					func_1086(hash2, num3, unk[i /*2*/].f_1, 562618531);
				}
				...
				{
					num6 = func_1087(num5);
					func_107(func_106(joaat("used_in_recipe"), num6), unk[i /*2*/].f_1);
				}
			}
		}
...
BOOL func_884(Hash hParam0, BOOL bParam1) // Position - 0x20300
{
	var unk;
	var unk6;
	var unk10;
	...
	if (!func_1088(hParam0, 856287005, &unk10, &unk6, &unk, true, 0))
		return false;

	unk11 = { func_1089() };
	unk11.f_4 = unk10;

	if (func_926(hParam0, &unk16, &unk11, 1, 752097756, false))
	{
		if (bParam1)
			!func_1090(hParam0, 1);
	
		if (func_1091(hParam0))
			func_884(func_1092(hParam0), true);
...
int func_885(Hash hParam0, int iParam1, int iParam2) // Position - 0x20383
{
	var unk;
	var unk6;

	if (!func_1094(hParam0, iParam1))
		return 0;

	unk.f_4 = func_605(iParam1);
	unk = { func_367(false) };

	if (!func_926(hParam0, &unk6, &unk, iParam2, 752097756, true))
		return 0;

	return 1;
}

BOOL func_886(var uParam0, Hash hParam1) // Position - 0x203C9
{
	if (!func_99(uParam0, 4))
		return false;

	if (func_399(hParam1) && func_831())
		return true;

	return false;
}

Hash func_887(int iParam0) // Position - 0x203F7
{
	switch (iParam0)
	{
		case 0:
...
Hash func_888(int iParam0) // Position - 0x20436
{
	switch (iParam0)
	{
		case 0:
...
int func_889(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x20475
{
	if (func_698(hParam0) && !bParam2)
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_33, hParam0);

	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_213(bParam1), hParam0, bParam3);
}

BOOL func_890(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x204A8
{
...
void func_891(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x204C0
{
	int i;
...
int func_892(int* piParam0) // Position - 0x2055E
{
	return func_1096(piParam0->f_1);
}

Hash func_893(int iParam0, BOOL bParam1) // Position - 0x2056E
{
	int i;
	int num;
	var unk;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		hash = func_1097(i, true, false);
	
		if (!func_355(iParam0, hash, &unk, &num, false, true))
		{
		}
		else
		{
			for (j = 0; j < num; j = j + 1)
			{
				if (func_1098(unk[j /*2*/]))
				{
					if (!bParam1 || func_350(unk[j /*2*/], false, true, true) > 0)
						return hash;
...
Hash func_894(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x20601
{
	int i;
	int num;
	var unk;
	...
	for (i = 0; i < 5; i = i + 1)
	{
		hash3 = func_1097(i, false, true);
	
		if (!func_355(iParam0, hash3, &unk3, &num, false, true))
		{
		}
		else
		{
			...
			for (j = 0; j < num; j = j + 1)
			{
				if (func_1099(unk3[j /*2*/]))
				{
					if (!bParam1 || func_350(unk3[j /*2*/], false, true, true) > 0)
						flag3 = true;
				}
...
int func_895(int iParam0) // Position - 0x20760
{
	return iParam0 / 100;
}

void func_896(const char* sParam0) // Position - 0x2076D
{
	Global_1915656.f_22470 = func_218(sParam0, 10000, 0, 0, 0, true);
	return;
}

BOOL func_897(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, int iParam4, Any* panParam5, BOOL bParam6) // Position - 0x20789
{
	int i;
	...
	for (i = 0; i < iParam4; i = i + 1)
	{
		...
		if (!func_1100(uParam3->[i /*2*/], uParam3->[i /*2*/].f_1, &panParam5->[i /*42*/]))
			return false;
	}

	return func_1101(piParam0, panParam1, panParam5, hParam2, bParam6);
}

int func_898(Hash hParam0, Any anParam1, var uParam2, var uParam3, var uParam4) // Position - 0x207FF
{
	Hash hash;
	Hash hash2;
	int i;
...
BOOL func_899(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x208E4
{
	var unk;
	var unk48;
	...
	unk.f_4 = 15;
	unk.f_36 = 10;
	func_1102(hParam0, hParam1, &unk);

	if (hParam1 == -570078785)
	{
		unk.f_3 == 0;
	
		if (!func_357(unk.f_3 * iParam2))
		{
			if (Global_1915656.f_20644)
				func_896(MISC::VAR_STRING(2, "SHOP_H_TOO_POOR_GOLD", func_895(unk.f_3 * iParam2)));
	...
	if (!func_906(hParam0, iParam2, hParam1, &unk48, true))
		return false;

	return true;
}

BOOL func_900(Hash hParam0) // Position - 0x209B0
{
	BOOL flag;
	Hash weaponUnlock;
...
BOOL func_901(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x209FA
{
	var unk;
	int num;
	int i;
	...
	if (!func_105(hParam0, 0))
		return func_1103(func_377(hParam0), hParam1, bParam2);

	if (func_393(hParam0) || func_312(hParam0, 1077060302))
		return func_635(func_394(hParam0, true), hParam1);

	unk = 10;

	if (bParam2 && func_40() == 0 && !UNLOCK::UNLOCK_IS_VISIBLE(hParam0))
		return true;

	if (!func_1104(hParam0, hParam1, &unk, &num) || num < 1)
		return false;
...
int func_902(int* piParam0, Hash hParam1) // Position - 0x20ABF
{
	int num;
	int i;
	int numOfItems;
...
BOOL func_903(Hash hParam0, BOOL bParam1) // Position - 0x20B29
{
	if (!func_312(hParam0, 947377998))
		return false;

	if (bParam1)
	{
		if (func_312(hParam0, -1090933859))
			return func_394(hParam0, true) != 0;
	
		if (func_901(hParam0, -915411861, false) || func_901(hParam0, 600942249, false) || func_901(hParam0, -570078785, false))
			return true;
		else
			return false;
	}
...
BOOL func_904(Hash hParam0, BOOL bParam1) // Position - 0x20BA2
{
	int num;
	var unk;

	num = func_1105(hParam0, true);

	if (num == 0)
		return false;

	if (func_635(num, -2141192156))
		return false;

	if (bParam1)
		if (!func_224(num, -2141192156, &unk, false, false))
			return false;

	return true;
}

int func_905(int* piParam0, Hash hParam1) // Position - 0x20BEC
{
	int num;
	int i;
	int numOfItems;
	...
	if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_GET_BASKET_IS_VALID(*piParam0))
	{
		...
		for (i = 0; i < numOfItems; i = i + 1)
		{
			...
			{
				num = num + (func_383(itemInfo.f_8, hParam1, true, false, true, 0) * itemInfo.f_9);
			}
		}
	}
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_906(Hash hParam0, int iParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x20C65
{
	var unk;
	int num;
	int num2;
	...
	if (!func_1106(hParam0, hParam2, &unk, &num, true, false))
		return false;

	flag = !bParam4 && func_103(false) && !func_104();
	...
	for (i = 0; i < num; i = i + 1)
	{
		...
		if (unk[i /*2*/] == joaat("currency_cash") && func_356(num2))
			goto 0xD9;
	
		if (unk[i /*2*/] == joaat("currency_gold_bar") && func_357(num2))
		{
		}
		else
		{
			num3 = func_350(unk[i /*2*/], false, !flag, false);
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_907(Hash hParam0, int iParam1, Hash hParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x20D4B
{
	var unk;
	int num;
	int num2;
	...
	if (func_393(hParam0) || func_312(hParam0, 1077060302))
		return func_224(func_394(hParam0, true), hParam2, uParam3, true, false);

	unk = 15;

	if (!func_360(hParam0, hParam2, &unk, &num, true, false))
		return false;

	flag = !bParam6 && func_103(false) && !func_104();
	num5 = -1;
	...
	for (i = 0; i < num; i = i + 1)
	{
		...
		if (unk[i /*2*/] == joaat("currency_cash") && bParam7 || func_356(num2))
			goto 0x1F3;
	
		if (unk[i /*2*/] == joaat("currency_gold_bar") && bParam7 || func_357(num2))
		{
		}
		else
		{
			num4 = func_358(num5, unk[i /*2*/]);
		
			if (num4 != 0)
			{
				bParam5 = false;
				num3 = func_359(unk[i /*2*/], num4);
			}
			else
			{
				num3 = func_350(unk[i /*2*/], false, !flag, true);
			}
			...
			else
			{
				if (flag)
				{
					if (func_361(unk[i /*2*/]) || func_362(unk[i /*2*/]))
					{
						...
						if (bParam5)
							num6 = func_364(7, unk[i /*2*/], &EntityIndex);
					
						num7 = func_363(unk[i /*2*/], num4);
					
						if (num3 + num6 + num7 >= num2)
							if (num3 + num7 < num2 && ENTITY::DOES_ENTITY_EXIST(EntityIndex))
								*uParam4 = EntityIndex;
						else
							goto 0x1E3;
					}
				
					if (bParam5 && num3 + func_365(7, unk[i /*2*/]) + func_366(unk[i /*2*/]) >= num2)
					{
					}
					else
					{
...
BOOL func_908(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, int iParam4, Any* panParam5, BOOL bParam6, int iParam7) // Position - 0x20F4B
{
	int i;
	...
	for (i = 0; i < iParam4; i = i + 1)
	{
		...
		if (!func_1100(uParam3->[i /*2*/], uParam3->[i /*2*/].f_1 * panParam1->f_9, &panParam5->[i /*42*/]))
			return false;
	}

	return func_1107(piParam0, panParam1, panParam5, hParam2, bParam6, iParam7);
}

void func_909(int iParam0, int iParam1) // Position - 0x20FC8
{
	if (iParam1 == 0)
		return;
...
void func_910(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x20FF8
{
	int i;
	var unk;

	if (!func_629(anParam0))
		return;
...
int func_911(BOOL bParam0) // Position - 0x210B3
{
	if (bParam0)
		return 1;
...
void func_912(Player plParam0) // Position - 0x210C5
{
	Player player;
...
void func_913(Player plParam0) // Position - 0x21131
{
...
void func_914(var uParam0) // Position - 0x2116C
{
	func_684(uParam0, joaat("MULTIPLAYER_GAME"));

	if (func_785() == joaat("MPC_PLAYER_TYPE_MP_MALE"))
		func_684(uParam0, joaat("LOOTER_PED_IS_MALE"));
	else
		func_684(uParam0, joaat("LOOTER_PED_IS_FEMALE"));

	return;
}

void func_915(Any anParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x211A4
{
	int i;
	var unk;
...
BOOL func_916(Hash hParam0) // Position - 0x2125A
{
	var unk;
	...
	if (func_538(hParam0, 1048576))
		return false;

	if (WEAPON::IS_WEAPON_VALID(hParam0))
		return func_227(hParam0, &unk, 1, false, false, -1, false);

	return func_348(hParam0, 1);
}

void func_917(Hash hParam0, int iParam1, BOOL bParam2, var uParam3, Hash hParam4) // Position - 0x2129F
{
	Hash TypeOfWeapon;
	...
	if (bParam2 || !func_923(TypeOfWeapon))
	{
		if (bParam2 || !WEAPON::HAS_PED_GOT_WEAPON(Global_33, TypeOfWeapon, 0, false) && func_350(hParam0, false, false, false) == 0)
		{
			if (func_40() == -1)
				func_693(TypeOfWeapon);
			...
			{
				func_347(hParam0, iParam1, false, 0, 0, false, false);
...
void func_918(Hash hParam0, var uParam1) // Position - 0x21349
{
	if (func_312(hParam0, 58855631))
		func_547(hParam0, -915411861, uParam1, true);

	return;
}

BOOL func_919() // Position - 0x2136E
{
	if (!ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_33, -1) && !PED::IS_PED_USING_ANY_SCENARIO(Global_33) && !func_1108(Global_33, 1369124074) && !func_1108(Global_33, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD) && !TASK::IS_PED_RUNNING_TASK_ITEM_INTERACTION(Global_33) && !PED::IS_PED_IN_ANY_VEHICLE(Global_33, false))
		return true;

	return false;
}

void func_920(int iParam0) // Position - 0x213D3
{
	int num;
	int num2;
	int BitIndex;
	...
	num2 = num / 31;
	BitIndex = num % 31;
	Variable = Global_38.f_3651[num2];
	MISC::SET_BIT(&Variable, BitIndex);
	Global_38.f_3651[num2] = Variable;
	return;
}

void func_921(int iParam0) // Position - 0x2140D
{
	switch (iParam0)
	{
		case 1:
		...
		case 2:
			if (func_1117() && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2))
				func_1118("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", joaat("hud_toasts"), 1963346246, 8000, 0, 0, 0, 0, true, true);
		...
		case 3:
			if (func_1117() && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3))
				func_1118("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", joaat("hud_toasts"), 1963346246, 8000, 0, 0, 0, 0, true, true);
		...
		case 4:
			if (func_1117() && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 4))
				func_1118("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", joaat("hud_toasts"), 1963346246, 8000, 0, 0, 0, 0, true, true);
		...
		case 5:
			if (func_1117() && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 5))
				func_1118("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", joaat("hud_toasts"), 1963346246, 8000, 0, 0, 0, 0, true, true);
		...
		case 47:
			if (func_40() == -1)
				if (!func_348(1013902307, 1))
					func_696(1013902307, 1, 752097756);
			break;
	
		case 48:
			if (func_40() == -1)
				if (!func_348(786809402, 1))
					func_696(786809402, 1, 752097756);
			break;
		...
		case 49:
			if (func_40() == -1)
			{
				...
				if (!func_348(142640135, 1))
					func_696(142640135, 1, 752097756);
			}
			break;
		...
		case 50:
			if (func_40() == -1)
			{
				...
				if (!func_348(-518019409, 1))
					func_696(-518019409, 1, 752097756);
			}
			break;
...
BOOL func_922(Hash hParam0) // Position - 0x21989
{
	Hash weaponUnlock;
...
BOOL func_923(Hash hParam0) // Position - 0x219B1
{
	Hash weaponUnlock;
...
void func_924(Hash hParam0, int iParam1) // Position - 0x219D9
{
	...
	{
		AmmoInClip = func_593(WEAPON::GET_WEAPON_CLIP_SIZE(hParam0), iParam1);
...
BOOL func_925(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x21A4B
{
	int num;
	var guid2;
	var guid1;
	...
	guid2 = { func_226(hParam0, false, 0) };

	if (func_227(hParam0, &guid2, iParam1, false, false, -1, false))
		return 0;

	if (!func_103(false))
		return 0;

	if (!INVENTORY::_INVENTORY_ADD_ITEM_WITH_GUID(func_213(false), &guid1, &guid2, hParam0, guid2.f_4, iParam1, hParam2))
		return 0;

	return 1;
}

BOOL func_926(Hash hParam0, Any* panParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x21AC7
{
	if (!func_105(hParam0, 0))
		return 0;
	...
	if (func_227(hParam0, panParam2, iParam3, bParam5, false, -1, false))
		return 0;
...
void func_927(Hash hParam0) // Position - 0x21B2F
{
	char* decoratorName;
	char* decoratorName2;
	int value;
	...
	decoratorName = "player_newWeaponType";
	decoratorName2 = "player_newWeaponTime";

	if (WEAPON::IS_WEAPON_PISTOL(hParam0))
	{
		decoratorName = "player_newPistolWeaponType";
		decoratorName2 = "player_newPistolWeaponTime";
	}
	else if (WEAPON::IS_WEAPON_REVOLVER(hParam0))
	{
		decoratorName = "player_newRevolverWeaponType";
		decoratorName2 = "player_newRevolverWeaponTime";
	}
	else if (WEAPON::IS_WEAPON_RIFLE(hParam0))
	{
		decoratorName = "player_newRifleWeaponType";
		decoratorName2 = "player_newRifleWeaponTime";
	}
	else if (WEAPON::IS_WEAPON_SHOTGUN(hParam0))
	{
		decoratorName = "player_newShotgunWeaponType";
		decoratorName2 = "player_newShotgunWeaponTime";
	}

	DECORATOR::DECOR_SET_INT(Global_33, decoratorName, hParam0);
	value = func_1119();
	func_1120(&value, 0, 0, 0, 1, 0, 0, false);
	DECORATOR::DECOR_SET_INT(Global_33, decoratorName2, value);
	return;
}

int func_928(Hash hParam0) // Position - 0x21BFE
{
	int num;
	int pedAmmoByType;
...
BOOL func_929() // Position - 0x21C7A
{
	return false;
}

BOOL func_930(Hash hParam0) // Position - 0x21C83
{
	return WEAPON::_IS_AMMO_VALID(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0));
}

Hash func_931(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x21C95
{
	int ReturnWeaponType;
	...
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
		WEAPON::GET_CURRENT_PED_WEAPON(pedParam0, &ReturnWeaponType, bParam2, iParam1, bParam3);

	return ReturnWeaponType;
}

int func_932(Hash hParam0) // Position - 0x21CBB
{
	Hash weaponTypeFromAmmoType;
...
int func_933(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x21D27
{
	float num;
	int num2;
	int i;
	...
	if (bParam1 && func_348(joaat("provision_trinket_elk_antler"), 1))
		num = num + 0.1f;
	...
	for (i = 0; i < num2; i = i + 1)
	{
		...
		else
		{
			...
			if (func_105(hash, 0) && func_312(hash, -1921346699))
				return BUILTIN::CEIL((float)num2.f_12[i] * num);
		}
	}
...
void func_934(int iParam0, const char* sParam1, int iParam2, BOOL bParam3) // Position - 0x21DF7
{
	if (iParam0 == 0)
		return;
	...
	func_553(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("itemtype_cash"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, true);
	return;
}

void func_935(int iParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x21E49
{
	int num;
	int value;
	int num2;
	...
	if (bParam1)
	{
		...
		value = value + num2;
		func_553(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", joaat("itemtype_total_take"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, true);
		iParam0 = iParam0 - num;
		num > 0;
		func_553(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", value), "ITEMTYPE_TEXTURES", joaat("itemtype_cash"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, true);
	}
	else
	{
		value = iParam0;
	...
	if (value > 0)
	{
		...
		func_107(func_556(joaat("CAREER_CASH")), value);
	}

	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x21F24
{
	switch (iParam0)
	{
		case 0:
...
Hash func_937(Hash hParam0) // Position - 0x21FFB
{
	Hash num;

	if (!func_1063(hParam0, &num, joaat("Inventory"), 0, 0, joaat("ui_itemviewer")))
		return joaat("_placeholder");

	return num;
}

int func_938(Ped pedParam0) // Position - 0x22025
{
	int num;
	int pedQuality;
...
int func_939(int iParam0) // Position - 0x2207B
{
	switch (iParam0)
	{
...
int func_940(Ped pedParam0, Hash hParam1) // Position - 0x22AB8
{
	int i;
	int num;

	if (func_1124(hParam1))
	{
		num = 0;
	...
	return func_1028(pedParam0, hParam1);
}

int func_941(var uParam0, Hash hParam1, var uParam2, BOOL bParam3, Hash hParam4, int iParam5) // Position - 0x22B2E
{
	var statId;
	int num;
	...
	if (func_1125(*uParam0, hParam1, *uParam2, bParam3, hParam4))
	{
		statId = { func_349(hParam1) };
	
		if (STATS::STAT_ID_IS_VALID(&statId))
			STATS::_STAT_ID_DECREMENT_INT(&statId, *uParam2);
	
		*uParam2 = func_942(*uParam0, hParam1, *uParam2, true, iParam5);
	
		if (*uParam2 > 0)
		{
			if (func_1126(hParam1))
			{
				!func_1127(0, hParam1, *uParam2);
			
				if (func_1128(PLAYER::PLAYER_ID(), 1, false))
					ENTITY::_SET_ENTITY_CARRYING_FLAG(*uParam0, 32, true);
				else
					ENTITY::_SET_ENTITY_CARRYING_FLAG(*uParam0, 32, false);
			
				*uParam2 = func_1129(*uParam0, hParam1, *uParam2);
			}
		}
	
		if (*uParam2 > 0)
		{
			num = func_1130(*uParam0, hParam1);
...
int func_942(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x22C02
{
	Hash hash;
	ItemSet itemSet;
	Ped entityFromItem;
	...
	for (i = 0; i < itemsetSize; i = i + 1)
	{
		...
		{
			hash = func_1131(entityFromItem);
		
			if (!func_1132(hash, &unk97))
			{
				if (ENTITY::IS_ENTITY_A_PED(entityFromItem))
				{
					...
					else if (hash == hParam1)
					{
						if (pedParam0 == PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::PLAYER_ID()))
						{
							for (j = 0; j < 3; j = j + 1)
							{
								...
								{
									func_1133(&unk, &Global_1903838.f_113[j /*96*/]);
									break;
								}
							}
						}
						...
						if (bParam3)
						{
							if (Global_1915656.f_20638 || Global_1915656.f_22504.f_1)
							{
								...
								{
									if (func_312(hash, -753854379) || func_312(hash, 173360570))
								...
								if (pedParam0 == PLAYER::PLAYER_PED_ID())
									func_347(hash, -1, false, true, false, false, false);
							}
...
void func_943(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x22DB4
{
	int i;
	int slot;
	...
	if (Global_1915656.f_20637)
	{
		if (Global_1915656.f_20241 == 29)
		{
			if (func_440(hParam0))
			{
				...
				{
					STATS::_STAT_DONATE_INCREMENT_ITEM(func_1135(hParam0), slot, func_312(hParam0, 1064293907), 0);
				}
			}
		}
	}
...
BOOL func_944(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x22E40
{
	var statId;
	...
	func_1136(hParam0, iParam1);
	return func_1137(hParam0, iParam1, bParam2, hParam3);
}

// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_945(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x22E77
{
	int i;
...
int func_946() // Position - 0x22F8E
{
	return 1037647863;
}

int func_947() // Position - 0x22F9B
{
	return 1037746167;
}

int func_948() // Position - 0x22FA8
{
	return 1035451607;
}

Entity func_949(Ped pedParam0) // Position - 0x22FB5
{
	int lootTarget;
...
int func_950(var uParam0, var uParam1) // Position - 0x23015
{
	var unk;
	...
	if (func_1139(uParam0, &unk))
		return unk.f_1;

	return -1;
}

int func_951(int iParam0) // Position - 0x23041
{
	int num;
	int num2;
	...
	if (func_1140(&num2, iParam0))
		num = func_1141() - DATAFILE::_0xE13634BB6BAF0734(num2, num2.f_1) - 1;

	return num;
}

int func_952(int iParam0) // Position - 0x2306C
{
	if (iParam0 == -1)
		return -1;
...
int func_953(int iParam0) // Position - 0x23088
{
	switch (iParam0)
	{
		case 0:
...
int func_954(int iParam0) // Position - 0x2323D
{
	int num;

	num = func_1143(0, func_1142() - 1, &iParam0);

	if (num == -1)
		return -1;

	return func_1144(num);
}

int func_955(int iParam0) // Position - 0x23264
{
	return Global_1110244.f_3667[iParam0 /*7*/];
}

struct<8> func_956(int iParam0, int iParam1, BOOL bParam2) // Position - 0x23277
{
	var unk;
	var unk6;
	...
	if (!func_1147(unk, &(unk.f_1), 13, 0, 0, 1))
		return unk6;

	if (!func_1147(unk, &(unk.f_1), 14, iParam0, 0, 1))
		return unk6;

	if (!func_1147(unk, &(unk.f_1), 19, 0, 0, 1))
		return unk6;

	if (!func_1147(unk, &(unk.f_1), 21, iParam1, 0, bParam2))
	{
		if (bParam2)
		{
		}
	...
	return func_1148(unk);
}

float func_957(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x2332A
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_958(int iParam0) // Position - 0x23348
{
	return func_279(Global_1220826.f_1196, iParam0);
}

BOOL func_959() // Position - 0x2335D
{
	return Global_263042[Global_1295666 /*65*/] > 2;
}

BOOL func_960(BOOL bParam0, int iParam1) // Position - 0x23371
{
...
struct<2> func_961() // Position - 0x233AD
{
...
BOOL func_962(Hash hParam0) // Position - 0x233F8
{
...
BOOL func_963(var uParam0, var uParam1) // Position - 0x2340F
{
	return func_1150(uParam0, 1, 4);
}

Hash func_964(int iParam0) // Position - 0x23421
{
	switch (iParam0)
	{
		case 2:
...
void func_965(int iParam0, BOOL bParam1) // Position - 0x236DC
{
	if (!func_966(iParam0))
		return;
...
BOOL func_966(int iParam0) // Position - 0x23702
{
	return !(iParam0 <= 0);
}

BOOL func_967(int iParam0) // Position - 0x2370F
{
	if (!func_966(iParam0))
		return false;

	return func_1151(iParam0, 4, true);
}

void func_968(int iParam0, BOOL bParam1) // Position - 0x2372D
{
	if (!func_966(iParam0))
		return;
	...
	if (bParam1)
		if (!func_67(0, false, true))
			func_1153(true, 1017438712);

	return;
}

BOOL func_969(int iParam0) // Position - 0x23770
{
	if (!func_966(iParam0))
		return false;

	return func_1151(iParam0, true, true);
}

void func_970(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2378E
{
	if (!func_966(iParam0))
		return;
	...
	func_965(iParam0, true);
	func_968(iParam0, true);
...
void func_971(BOOL bParam0, int iParam1) // Position - 0x237F0
{
...
float func_972(int iParam0, int iParam1) // Position - 0x23836
{
	int num;
	float pedStamina;
	float pedMaxStamina;
...
void func_973(int iParam0) // Position - 0x238EB
{
	Ped ped;
	int num;
	...
	num = func_1031(2);
	func_1032(BUILTIN::TO_FLOAT(iParam0 * num), 0);
	return;
}

void func_974(int iParam0, BOOL bParam1) // Position - 0x23928
{
	int num;
	...
	num = func_1033(2);
	func_1034(BUILTIN::TO_FLOAT(iParam0 * num), false, bParam1);
	return;
}

void func_975(int iParam0) // Position - 0x2395D
{
	Ped ped;
	int num;
	...
	num = func_1035(2);
	func_1036(BUILTIN::TO_FLOAT(iParam0 * num), 0);
	return;
}

BOOL func_976() // Position - 0x2399A
{
	int num;
...
int func_977(int iParam0) // Position - 0x23A30
{
	int num;
...
Hash func_978(int iParam0) // Position - 0x23A5F
{
	return Global_1953292.f_1676.f_1[func_266(iParam0, 1) /*3*/];
}

int func_979() // Position - 0x23A79
{
	int i;
	Hash hash;
	int num;
...
BOOL func_980(Hash hParam0, int iParam1) // Position - 0x23ACA
{
	if (iParam1 == 0)
		iParam1 = func_1158(false);

	if (func_228(hParam0) == -999503751 && func_984(hParam0) != -1)
		return true;

	if (iParam1 == joaat("MPC_PLAYER_TYPE_MP_MALE"))
		return func_312(hParam0, -287432114);
	else if (iParam1 == joaat("MPC_PLAYER_TYPE_MP_FEMALE"))
		return func_312(hParam0, -133342564);

	return false;
}

BOOL func_981(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x23B33
{
	var unk;
	var guid;
	...
	INVENTORY::_INVENTORY_SET_INVENTORY_ITEM_HIDDEN(func_213(bParam2), &guid, bParam1);
	return true;
}

int func_982(int iParam0) // Position - 0x23B85
{
	switch (iParam0)
	{
		case -2061583405:
...
BOOL func_983(int iParam0) // Position - 0x23BE0
{
	return Global_1953292.f_3352.f_33.f_6 && iParam0 != false;
}

int func_984(Hash hParam0) // Position - 0x23BF8
{
	switch (hParam0)
	{
		case -2011879201:
...
BOOL func_985(BOOL bParam0, int iParam1) // Position - 0x23C7A
{
	if (iParam1 == -1)
...
struct<8> func_986(int iParam0) // Position - 0x23CBD
{
	var unk;
	...
	TEXT_LABEL_ASSIGN_STRING(&unk, HUD::GET_STRING_FROM_HASH_KEY(func_1159(iParam0)), 64);
	return unk;
}

void func_987() // Position - 0x23CF2
{
	Global_1953292.f_1046 = 0;
	return;
}

BOOL func_988(Hash hParam0) // Position - 0x23D02
{
	if (!func_105(hParam0, 0))
		return false;

	if (func_312(hParam0, 160827531) || func_228(hParam0) == 81053684)
		return true;

	return false;
}

void func_989(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x23D3E
{
	BOOL flag;
	var unk;
	var unk120;
	...
	{
		case -2061583405:
			flag = func_1160(hParam0, &(Global_1953292.f_3352.f_28), bParam4);
			break;
	
		case -1719060085:
			flag = func_1160(hParam0, &(Global_1953292.f_3352.f_31), bParam4);
			break;
	
		case -999503751:
			flag = func_1160(hParam0, &(Global_1953292.f_3352.f_27), bParam4);
		
			if (func_312(hParam0, -166674229))
			{
				unk.f_1 = 39;
			
				if (func_1161(&unk, hParam0, &unk120, false, true, false, 0, false, true, 8))
				{
					for (i = 0; i < 39; i = i + 1)
					{
						hash = unk.f_1[i /*3*/];
						...
						if (func_105(hash, 0))
							func_989(hash, false, false, false, false);
					}
				}
			}
			break;
		...
		case -525676072:
			flag = func_1160(hParam0, &(Global_1953292.f_3352.f_29), bParam4);
			break;
	
		case 81053684:
			flag = func_1160(hParam0, &(Global_1953292.f_3352.f_30), bParam4);
			break;
	
		case 119907797:
			flag = func_1160(hParam0, &(Global_1953292.f_3352.f_32), bParam4);
			break;
	
		case 1388798186:
			flag = func_1160(hParam0, &(Global_1953292.f_3352.f_33.f_7), bParam4);
			break;
...
Hash func_990(Hash hParam0) // Position - 0x23EC4
{
	int num;
	var unk;

	func_1162(&unk, 9044914, hParam0, 0, 0, 0);
...
BOOL func_991(Hash hParam0, int iParam1) // Position - 0x23F08
{
	int num;

	num = func_228(Global_1953292.f_1676.f_1[iParam1 /*3*/]);

	if (func_228(hParam0) == num)
		return true;
	else if (hParam0 == -992705550)
		return func_312(Global_1953292.f_1676.f_1[iParam1 /*3*/], 160827531);
...
void func_992(int iParam0, int iParam1) // Position - 0x23FAF
{
	int i;
	int num;
	var unk;
	...
	for (i = 0; i < 16; i = i + 1)
	{
		...
		if (i < *iParam0)
		{
			if (func_1163(&iParam0->f_2[i /*2*/], 2) || iParam0->f_2[i /*2*/] == iParam1 || iParam0->f_2[i /*2*/] == 39)
			{
				iParam0->f_2[i /*2*/] = { unk };
			}
			else
			{
				if (func_1163(&iParam0->f_2[i /*2*/], 1))
					func_1164(&iParam0->f_2[i /*2*/], 2, 6);
...
void func_993(int iParam0, int iParam1, int iParam2) // Position - 0x240AD
{
	int i;
	int j;
...
void func_994(Hash hParam0, var uParam1) // Position - 0x24193
{
	int num;
	int num2;
	int num3;
...
void func_995(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x24246
{
	int num;
	int num2;
	...
	num = 10;
	num2 = func_228(hParam0->f_1[num /*3*/]);

	if (num2 == 119907797)
	{
		if (func_312(hParam1, 458991572))
		{
			hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
			hParam0->f_1[num /*3*/].f_1 = 0;
			func_791(num, iParam3);
		}
	}
	else if (num2 == 2086043523)
	{
		if (func_312(hParam1, -93469181))
		{
			hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
			hParam0->f_1[num /*3*/].f_1 = 0;
			func_791(num, iParam3);
	...
	if (func_312(hParam0->f_1[num /*3*/], -1446529222) && func_312(hParam1, -93469181))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_312(hParam1, -93469181) && func_312(hParam0->f_1[num /*3*/], -1303648999))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
...
void func_996(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x2441B
{
...
void func_997(Hash hParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0x24460
{
	int num;
	Hash hash;
	...
	if (!func_507(hash, false) && func_312(hash, -180472385))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (hash != Global_1953292.f_83[num /*12*/] && func_228(hash) == 2086043523 && func_312(hParam1, -93469181))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
...
void func_998(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x24529
{
	switch (func_228(hParam2))
	{
		case -525676072:
			func_1168(hParam0, bParam1, iParam3);
			break;
	
		case 2086043523:
			func_1169(hParam0, bParam1, iParam3);
			break;
	}
...
void func_999(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x24563
{
	int num;

	num = 18;

	if (func_228(hParam0->f_1[num /*3*/]) == 912453393)
		func_791(num, iParam3);
	...
	if (func_988(hParam2))
		func_1170(hParam0, bParam1, iParam3);

	num = 11;

	if (func_312(hParam2, -180472385) && !func_507(hParam0->f_1[num /*3*/], false))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (func_312(hParam2, -1303648999))
		return;
...
void func_1000(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x246A3
{
	int num;
	int metapedType;
	Hash hash;
	...
	{
		if (bParam1 || func_312(hParam2, 1872585553) || func_228(hParam2) == 1882579758)
		{
			hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
			hParam0->f_1[num /*3*/].f_1 = 0;
			func_791(num, iParam3);
	...
	if (!func_507(hash, false) && !func_312(hash, -1303648999) && func_312(hParam2, -1527414429))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (!func_507(hParam0->f_1[num /*3*/], false) && func_312(hParam2, 1467402774))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (!func_507(hParam0->f_1[num /*3*/], false) && func_312(hParam2, 1126863852))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (func_228(hash) == 1759215194 && func_228(hParam2) == 1882579758)
	{
		hParam0->f_1[num /*3*/] = func_990(hParam2);
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	}
	else if (func_1171(hash, bParam1, metapedType))
	{
		hash = hParam0->f_1[18 /*3*/];
		num2 = 0;
	
		if (func_228(hash) == 912453393 && func_1172(32))
			num2 = num2 | 1;
	
		if (func_312(hParam2, 525391395))
			num2 = num2 | 2;
	
		hash = func_1173(Global_1953292.f_83[num /*12*/].f_9, num2);
		...
		if (hash != 0)
		{
			...
			hParam0->f_1[num /*3*/].f_1 = 0;
			func_791(num, iParam3);
			func_1008(hParam0, false, hash, iParam3);
		}
	}

	num = 21;

	if (!func_507(hParam0->f_1[num /*3*/], false) && func_312(hParam2, 196770179))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (!func_507(hParam0->f_1[num /*3*/], false) || hParam0->f_1[num3 /*3*/] != Global_1953292.f_83[num3 /*12*/] && func_312(hParam0->f_1[num3 /*3*/], -1655064541))
		func_1174(hParam0, iParam3);

	return;
}

void func_1001(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x2498C
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_312(hParam2, 358628372))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
...
void func_1002(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3, int iParam4) // Position - 0x249EB
{
	switch (func_228(hParam2))
	{
		case 698653232:
			func_1175(hParam0, bParam1, hParam2, iParam4);
			break;
	
		case 912453393:
			func_1176(hParam0, bParam1, iParam3, iParam4);
			break;
	}
...
void func_1003(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x24A29
{
	switch (func_228(hParam2))
	{
		case -1080198344:
		case 1868067663:
			func_1177(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 294388917:
			func_1178(hParam0, bParam1, hParam2, iParam3);
			break;
	}
...
void func_1004(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x24A6D
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_312(hParam2, 1537768121))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
...
void func_1005(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x24B09
{
	int num;
	...
	if (!bParam1)
	{
		...
		if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
		{
			if (func_312(hParam0->f_1[num /*3*/], 1537768121))
			{
				hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
				hParam0->f_1[num /*3*/].f_1 = 0;
			}
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
		if (func_312(hParam2, -1655064541))
			func_1174(hParam0, iParam3);
		else
			func_791(num, iParam3 | 16);
...
void func_1006(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x24C18
{
	int num;
	...
	if (func_1179(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) && func_312(hParam2, -1230785684))
	{
		num = 27;
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
	...
	if (!func_507(hParam0->f_1[num /*3*/], false) && func_312(hParam2, 1016511012))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
...
void func_1007(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x24CB7
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_312(hParam0->f_1[num /*3*/], 358628372))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam2);
	}

	return;
}

void func_1008(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x24D1C
{
	switch (func_228(hParam2))
	{
		case -1740828670:
			func_1184(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 344283346:
			func_1185(hParam0, bParam1, iParam3);
			break;
	
		case 502936876:
			func_1183(hParam0, bParam1, iParam3);
			break;
	
		case 684307653:
			func_1182(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 1223979091:
		case 2047428024:
			func_1181(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 1759215194:
			func_1180(hParam0, iParam3);
			break;
	}
...
void func_1009(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x24DAC
{
	switch (func_228(hParam2))
	{
		case -923693316:
			func_1187(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 1769055947:
			func_1186(hParam0, bParam1, hParam2, iParam3);
			break;
	}
...
void func_1010(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x24DEA
{
	int num;
	Hash hash;
	...
	if (bParam1)
	{
		func_1188(hParam0, iParam3, false, true);
		return;
	}
	...
	if (func_312(hParam2, 813132419) && hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_228(hash) == -923693316)
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (func_312(hParam2, -1650340550) && hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_228(hash) == 1769055947)
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (func_312(hParam2, -1278198125) && hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
...
int func_1011(Hash hParam0, BOOL bParam1, Hash hParam2) // Position - 0x24F19
{
	int i;
...
BOOL func_1012(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x24F5B
{
	*uParam2 = joaat("base");
	return true;
}

int func_1013(Hash hParam0) // Position - 0x24F6C
{
	int num;
...
BOOL func_1014(int iParam0) // Position - 0x24F88
{
...
void func_1015(int iParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x25016
{
	if (bParam1)
	...
	func_1189(&Global_1953292.f_1676.f_1[iParam0 /*3*/], iParam0, iParam3);
	return;
}

BOOL func_1016(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x25072
{
	var unk;
	var unk6;

	unk = { func_226(hParam0, bParam2, 0) };
	unk6 = { func_368(hParam0, unk, unk.f_4, bParam2) };
	return func_797(unk6, bParam1, bParam2);
}

void func_1017(int iParam0, BOOL bParam1, int iParam2) // Position - 0x250A7
{
	func_1190(&(Global_1953292.f_1557), iParam0);
...
int func_1018(Any* panParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0x250CF
{
	var unk;

	unk.f_9 = -1591664384;

	if (func_1192(panParam0, hParam1, &unk, bParam2, iParam3))
		return unk.f_4;

	return 0;
}

int func_1019(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0x250FD
{
	int num;
	var unk;
	int num2;
	...
	if (!func_375(*panParam0, &unk, true, false, -1))
		return num;
	...
	num2 = func_323(unk.f_4);

	if (num2 == joaat("HORSE"))
	{
		unk15 = { func_1193(*panParam0, true, false) };
		unk15.f_10 = iParam1;
		num = func_1194(joaat("UPDATE"), &unk15, bParam2);
	...
	{
		unk44 = { func_1195(*panParam0, true, false) };
		unk44.f_10 = iParam1;
		num = func_1196(joaat("UPDATE"), &unk44, bParam2);
	...
	{
		unk70 = { func_1197(*panParam0, true, false) };
		unk70.f_10 = iParam1;
		num = func_1198(joaat("UPDATE"), &unk70, bParam2);
	...
	{
		unk88 = { func_1199(&unk, false) };
		unk88.f_10 = iParam1;
		num = func_385(joaat("UPDATE"), &unk88, bParam2);
...
float func_1020(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x25240
{
...
int func_1021(int iParam0) // Position - 0x25288
{
	switch (iParam0)
	{
		case 0:
	...
	if (func_531(iParam0) == joaat("posse_versus"))
		return 37;

	return 23;
}

BOOL func_1022() // Position - 0x2535D
{
	if (func_120() || Global_1572887.f_72.f_40 > 10 || func_1200())
		if (!func_760() && Global_265213.f_122484.f_80.f_16.f_2 != -504335712 && !func_1201(Global_265213.f_122484.f_80.f_16.f_3))
			return true;

	return false;
}

BOOL func_1023(int iParam0, Player plParam1) // Position - 0x253C7
{
	if (plParam1 == 255)
...
BOOL func_1024() // Position - 0x253F3
{
	int frameCount;
...
int func_1028(Ped pedParam0, Hash hParam1) // Position - 0x25467
{
	int num;
	int i;
	...
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		...
		{
			return func_1202(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(pedParam0), hParam1);
		}
	}
...
int func_1029(Hash hParam0, BOOL bParam1) // Position - 0x254C5
{
	if (!bParam1 || func_1203())
		return func_382(hParam0, func_367(true), -2015960939, true, true, false);

	return 0;
}

int func_1030(Hash hParam0, BOOL bParam1) // Position - 0x254F4
{
	var unk;

	unk = { func_226(hParam0, false, 0) };
	return func_381(hParam0, &unk, false, bParam1);
}

int func_1031(int iParam0) // Position - 0x25513
{
	if (iParam0 == 2)
		iParam0 = func_676(1);
...
void func_1032(float fParam0, Ped pedParam1) // Position - 0x25553
{
	if (fParam0 == 0f)
		return;
...
int func_1033(int iParam0) // Position - 0x25597
{
	if (iParam0 == 2)
		iParam0 = func_676(1);
...
void func_1034(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x255DB
{
	Player player;
	Ped EntityIndex;
	...
	if (fParam0 > 0f && func_1204(player))
		return;
...
int func_1035(int iParam0) // Position - 0x2568C
{
	if (iParam0 == 2)
		iParam0 = func_676(1);
...
void func_1036(float fParam0, Ped pedParam1) // Position - 0x256D0
{
	if (fParam0 == 0f)
		return;
...
float func_1037(int iParam0, float fParam1, BOOL bParam2) // Position - 0x25712
{
	int num;
	int num2;

	num = func_1119();
	func_1205(&num, 0, 0, 0, 1, 0, 0);
	num2 = func_1206(iParam0, 2);

	if (func_1208(num, func_1207(iParam0, 2), true))
	{
	...
	func_1209(iParam0, num2 + 1, 2);
	return fParam1;
}

float func_1038(int iParam0, int iParam1) // Position - 0x2577B
{
	if (iParam1 == 2)
		iParam1 = func_676(2);
...
int func_1039(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x257C7
{
	Ped ped;
	...
	if (func_1211(ped, iParam0, fParam1))
	{
		if (bParam2)
			if (fParam1 >= 100f)
...
BOOL func_1040() // Position - 0x25845
{
	if (Global_1956875.f_1431.f_107 == -15)
		return true;

	return func_1215(Global_1956875.f_1431.f_107, false);
}

void func_1041(float fParam0, int iParam1) // Position - 0x2586E
{
	float num;
	int num2;
	int num3;
	...
	num2 = func_1217(num);
	num = num + fParam0;
	num = func_596(num, 0f, 100f);
	num3 = func_1217(num);

	if (num2 != num3)
	{
		Global_1956875.f_1431.f_107 = func_1119();
		func_1120(&(Global_1956875.f_1431.f_107), 0, 0, 1, 0, 0, 0, false);
	}
...
int func_1042(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x258E1
{
	char* effectName;
	Ped ped;
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			func_1221(joaat("STATUS_EFFECT__TRACKING"));
			func_975(-1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(ped, iParam0, fParam1, bParam3);
		...
		case 18:
			func_1222(1, true, true);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(ped, iParam0, fParam1, bParam3);
			Global_17418.f_55.f_2459.f_34[1 /*2*/].f_1 = fParam1;
			break;
	
		case 19:
			func_1221(joaat("STATUS_EFFECT__POISON"));
			func_1222(0, true, true);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(ped, iParam0, fParam1, bParam3);
			Global_17418.f_55.f_2459.f_34[0 /*2*/].f_1 = fParam1;
			break;
	
		case 20:
			func_1222(2, true, true);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(ped, iParam0, fParam1, bParam3);
...
void func_1043(int iParam0, int iParam1) // Position - 0x25A97
{
	var statId;

	statId = { func_106(joaat("eaten"), func_1087(iParam0)) };
	STATS::_STAT_ID_INCREMENT_INT(&statId, iParam1);
	func_107(func_700(joaat("herbs_eaten")), iParam1);
	return;
}

void func_1044(Hash hParam0, int iParam1) // Position - 0x25AC9
{
	int num;

	if (func_40() == 0)
	{
		num = func_400(hParam0, -949239683);
	
		if (iParam1 == -1387038764)
			return;
	
		if (func_312(hParam0, -136654233))
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(joaat("FEATURE_PM_DAILY_CHALLENGES"), joaat("MPDC_Consumable_CannedGoodsEaten_00"), 1);
	
		if (func_312(hParam0, 1765172170) || 1443104131 == num || -1919515848 == num)
...
int func_1045(Player plParam0) // Position - 0x25C6A
{
...
Hash func_1046(Player plParam0) // Position - 0x25C94
{
	if (plParam0 < 0 || plParam0 >= 32)
		return 0;
...
void func_1047(var uParam0, Hash hParam1, int iParam2) // Position - 0x25CC0
{
	...
	if (iParam2 == 600942249 || iParam2 == -257768755 || iParam2 == 1472825031)
		func_1223(uParam0, hParam1, iParam2);
	else if (iParam2 == -214678071)
		func_1224(uParam0, hParam1);

	return;
}

int func_1048(var uParam0, int iParam1) // Position - 0x25D5E
{
	var unk;
	int num;
	int num2;
	...
	unk = { func_607(-1591664384, -1591664384, 0, 0, iParam1, 0, -1, Global_1913634.f_1584, 0) };

	if (func_608(unk, &num, &num2, 0))
	{
		for (i = 0; i < num2; i = i + 1)
		{
			hash = func_609(i, num);
			...
			if (func_105(hash, 0))
			{
				...
				if (Global_1913634.f_1584 == 0 && func_312(hash, 302810039))
				{
					if (!(Global_1913634.f_1585 != 0 && func_312(hash, Global_1913634.f_1585)))
					{
					}
					else if (func_312(hash, 266762988))
					{
					}
					else
					{
						func_1047(uParam0, hash, iParam1);
						func_1225(uParam0, hash, iParam1);
					}
				}
			
				if (func_312(hash, 266762988))
				{
				}
				else
				{
...
Hash func_1049(int iParam0) // Position - 0x25E3C
{
	switch (iParam0)
	{
		case 0:
...
void func_1050(var uParam0, const char* sParam1, var uParam2) // Position - 0x25EA1
{
...
void func_1051(var uParam0, BOOL bParam1, Hash hParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x25F0A
{
	Hash hash;

	hash = Global_1913634[hParam2 /*9*/].f_6;

	if (bParam4 || func_99(uParam0, 2) || func_236(hash, uParam0->f_42))
	{
		if (bParam1)
		{
			...
			{
				if (bParam5)
					func_1052(uParam0, -1, bParam3, Global_1913634[hParam2 /*9*/].f_1, true, false, true);
			...
			{
				func_1227(uParam0, hParam2, bParam1, bParam3);
			}
		}
		else
		{
			...
			func_1227(uParam0, hParam2, false, bParam3);
		}
...
void func_1052(var uParam0, int iParam1, BOOL bParam2, Hash hParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x26004
{
	Hash entryId;
	Hash hash;
	Hash hash2;
	...
	hash3 = hash;
	hash4 = hash2;
	num = func_225(hash3, hash4, bParam2, false);
	num2 = func_350(hash3, false, false, false);
	num3 = func_1030(hash3, false);
	...
	TEXT_LABEL_APPEND_INT(&unk, func_593(num3, num), 8);
	...
	if (func_99(uParam0, 2))
		num4 = num > 0 && func_1060(hash3) ? 1 : 0;
	else
		num4 = num3 > 0 && num > 0 ? 1 : 0;

	flag = false;

	if (num4 == 0 && func_1228(hash3))
	{
		if (func_1229(hash3, hash4, uParam0, bParam2, &hash5, &hash6, &num5))
		{
			num4 = 1;
			flag = true;
	...
	if (!Global_1913634.f_1579 && func_901(hash3, hash4, true))
	{
		num4 = 0;
		flag2 = true;
	}
	...
	if (num4 == 1)
	{
		if (!func_582(2) && func_400(hash3, -1636519629) == -701492487)
		{
	...
	{
		if (func_99(uParam0, 128) && num4 == 0 && Global_1913634[iParam1 /*9*/].f_2 && bParam4)
	...
	if (bParam5)
	{
		if (func_539(hash3, &str, joaat("Inventory"), 0, 0, 0))
		{
	...
	if (!func_99(uParam0, 4) && DATABINDING::_DATABINDING_READ_DATA_BOOL_FROM_PARENT(entryId, "bFireCrafting"))
		num4 = 0;
...
Ped func_1053(Ped pedParam0) // Position - 0x265B6
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
void func_1054(var uParam0, BOOL bParam1) // Position - 0x265D2
{
...
void func_1055(var uParam0, var uParam1) // Position - 0x26601
{
	Hash hash;
	Any any;
	Hash hash2;
	...
	if (func_105(hash2, 0) && func_99(uParam0, 2) || func_236(hash2, uParam0->f_42))
	{
		uParam0->f_27 = -1;
		uParam0->f_23 = 0;
		uParam0->f_62 = hash2;
		...
		if (Global_1913634.f_1579 || !func_901(uParam0->f_62, uParam0->f_63, true))
		{
			DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT(uParam0->f_29, "RPGDescription", func_1064(hash2));
...
char* func_1056(var uParam0) // Position - 0x2687A
{
	if (func_99(uParam0, 128))
		return "CAMP_REC_ALL";
...
int func_1057(char* sParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x2689B
{
	int i;
	int num;
	...
	if (num != 0)
	{
		func_271(num, hParam1, sParam0, 0, 3, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam3, 570, 4000, 10, 1073741824, 0, 1065353216, false, false, hParam2, joaat("SHORT_TIMED_EVENT"), false);
		return num;
	}
...
void func_1058(int iParam0, Hash hParam1) // Position - 0x26929
{
	int num;
...
BOOL func_1059(Hash hParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2696B
{
	var unk;
	...
	*uParam3 = 0;
	...
	if (!Global_1913634.f_1579 && !bParam5)
		if (func_222(hParam0))
			if (func_635(func_223(hParam0), hParam1))
				return 0;
		else if (func_901(hParam0, hParam1, true))
			return 0;

	if (func_222(hParam0))
		if (func_224(func_223(hParam0), hParam1, &unk, false, bParam7))
			return 1;
	else if (func_907(hParam0, 1, hParam1, &unk, uParam4, bParam6, false, bParam7))
		return 1;
...
BOOL func_1060(Hash hParam0) // Position - 0x26A16
{
	int num;
	int num2;

	num = func_1231(func_1230());
	num2 = func_1231(hParam0);
	return num2 > num;
}

BOOL func_1061(Hash hParam0, Hash hParam1, var uParam2, Entity eParam3, BOOL bParam4) // Position - 0x26A35
{
	var unk;
	Hash hash;
	int num;
	...
	if (!bParam4 && func_360(hParam0, hParam1, &unk, &num, true, false))
	{
		for (i = 0; i < num; i = i + 1)
		{
			if (i >= 4)
			...
			if (func_105(hash, 0))
			{
				...
				if (func_539(hash, &str, joaat("Inventory"), 0, 0, 0))
				{
				...
				num2 = func_350(hash, false, false, false);
				...
				str2 = MISC::VAR_STRING(10, "CRFT_ING_LIST", MISC::VAR_STRING(0, unk[i /*2*/]), func_99(uParam2, 131072) && uParam2->f_27 > 1 ? func_593(3, uParam2->f_27) : unk[i /*2*/].f_1);
	...
	if (flag)
	{
		if (!func_99(uParam2, 4) && func_99(uParam2, 8192) || uParam2->f_63 == -214678071 || uParam2->f_63 == joaat("cost_crafting_grill"))
		{
			flag = false;
		...
		{
			num3 = func_350(hParam0, false, false, false);
			num4 = func_1030(hParam0, false);
		
			if (func_99(uParam2, 2) && !func_1060(hParam0))
			{
				flag = false;
				hash2 = func_1230();
			...
			{
				num5 = func_400(hParam0, -1636519629);
			
				if (!func_582(2) && num5 == -701492487)
				{
					flag = false;
				...
				{
					num6 = func_225(hParam0, uParam2->f_63, func_583(), false);
				
					if (func_99(uParam2, 2))
						DATABINDING::DATABINDING_WRITE_STRING_FROM_PARENT(uParam2->f_29, "tipText", MISC::VAR_STRING(2, func_1232(hParam0)));
	...
	else if (!func_99(uParam2, 4) && func_99(uParam2, 8192) || uParam2->f_63 == -214678071 || uParam2->f_63 == joaat("cost_crafting_grill"))
	{
		flag = false;
	...
	else if (func_99(uParam2, 2) && !func_1060(hParam0))
	{
		hash3 = func_1230();
...
void func_1062(var uParam0) // Position - 0x26FB0
{
	if (func_99(uParam0, 2))
	{
		if (!func_312(uParam0->f_62, -2011345500))
		...
		if (uParam0->f_27 > 0 || uParam0->f_62 == Global_1147183.f_339.f_16 || !func_1060(uParam0->f_62))
			func_164(uParam0->f_1[7], false, true, true);
		else
			func_164(uParam0->f_1[7], true, true, true);
	}
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_1063(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x27068
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
Hash func_1064(Hash hParam0) // Position - 0x2715E
{
	var unk;
...
void func_1065(var uParam0) // Position - 0x27189
{
...
void func_1066(var uParam0) // Position - 0x271AB
{
	if (func_312(uParam0->f_62, 1147021565) || func_99(uParam0, 2) && !func_312(uParam0->f_62, 1919582297))
	{
...
void func_1067(var uParam0) // Position - 0x27259
{
	Any any;
...
Hash func_1068(Hash hParam0) // Position - 0x27289
{
	Hash weaponTypeFromAmmoType;
...
Vector3 func_1069(Hash hParam0) // Position - 0x272FB
{
	Hash weaponTypeFromAmmoType;
...
char* func_1070(var uParam0) // Position - 0x27371
{
	if (PED::IS_PED_MALE(Global_33))
...
char* func_1071(var uParam0) // Position - 0x27391
{
	return "craft_trans_stow";
}

void func_1072(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x2739D
{
...
void func_1073(Player plParam0, BOOL bParam1) // Position - 0x273E5
{
	Player gangLeader;
...
void func_1074(Player plParam0, var uParam1) // Position - 0x27458
{
	var outTime;
	var timeToAdd;
...
int func_1075(Any anParam0) // Position - 0x274BA
{
	...
	return func_1233(GANG::NETWORK_GET_GANG_LEADER(anParam0));
}

void func_1076(int iParam0, var uParam1) // Position - 0x274F2
{
	var unk;

	unk.f_8 = iParam0;
	unk.f_12 = uParam1;
	func_1072(17, unk, func_110(0, 8));
	return;
}

void func_1077(var uParam0) // Position - 0x27517
{
	var unk;

	unk.f_12 = uParam0;
	func_1072(13, unk, func_109(GANG::NETWORK_GET_GANG_LEADER(GANG::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()))));
	return;
}

struct<2> func_1078(Hash hParam0) // Position - 0x2753F
{
	return func_106(joaat("MADE"), hParam0);
}

struct<2> func_1079(Hash hParam0) // Position - 0x27552
{
	var unk;

	if (func_236(hParam0, 0))
		unk = { func_106(joaat("made_recipe_type"), joaat("FOOD")) };
	else if (func_236(hParam0, 2))
		unk = { func_106(joaat("made_recipe_type"), joaat("AMMO")) };
	else if (func_236(hParam0, 5))
		unk = { func_106(joaat("made_recipe_type"), joaat("horse_care")) };
	else if (func_236(hParam0, 1))
		unk = { func_106(joaat("made_recipe_type"), joaat("remedies")) };
	else if (func_236(hParam0, 3))
		unk = { func_106(joaat("made_recipe_type"), joaat("WEAPONS")) };
	else if (func_236(hParam0, 4))
		unk = { func_106(joaat("made_recipe_type"), joaat("Hunting")) };

	return unk;
}

Vector3 func_1080(Player plParam0) // Position - 0x27615
{
	if (plParam0 == 255)
		return Global_1144526[func_112() /*83*/].f_38;

	return Global_1144526[plParam0 /*83*/].f_38;
}

void func_1081(int iParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x27641
{
	int num;
	...
	if (func_40() == 0)
	{
		...
		func_1234(iParam0, sParam1, -142743235, bParam4);
	}
	else
	{
		func_1235(iParam0);
...
int func_1082(int iParam0, Hash hParam1, int iParam2) // Position - 0x2768A
{
	Ped EntityIndex;
	ItemSet itemSet;
	int itemsetSize;
	...
	for (i = 0; i < itemsetSize; i = i + 1)
	{
		...
		else
		{
			...
			for (j = 0; j < 10; j = j + 1)
			{
				...
				if (hash == hParam1)
				{
					func_696(hParam1, 1, 752097756);
				
					if (ENTITY::DOES_ENTITY_EXIST(entityFromItem))
					{
						hash2 = func_441(&entityFromItem);
					
						if (!func_105(hash2, 0))
							hash2 = func_442(entityFromItem);
					
						if (func_105(hash2, 0))
							func_443(hash2, 1, EntityIndex, true, -142743235);
...
void func_1083(Hash hParam0, int iParam1) // Position - 0x277FE
{
	int num;
	int num2;
	var unk;
	...
	if (iParam1 > 0)
	{
		...
		unk.f_7 = -1;
		unk.f_8 = -1;
		num3 = func_400(hParam0, 1697966752);
	
		if (num3 == 0)
			return;
	
		unk = { func_607(-1591664384, -1591664384, 0, 235313564, 0, 0, -1, num3, 0) };
		...
		if (func_608(unk, &num, &num2, 0))
		{
			for (i = 0; i < num2; i = i + 1)
			{
				...
				if (func_105(hash, 0) && hParam0 != hash)
				{
					for (j = func_350(hash, false, false, false); j > 0 && iParam1 > 0; j = j - 1)
					{
						iParam1 = iParam1 - func_1237(hash, hParam0, false);
					}
				}
			}
...
void func_1084(Hash hParam0) // Position - 0x278FC
{
	Entity firstEntityPedIsCarrying;
	Ped pedIndexFromEntityIndex;
	var unk;
	...
	if (PED::IS_PED_CARRYING_SOMETHING(Global_33))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(firstEntityPedIsCarrying))
		{
			...
			{
				unk = 10;
				num = func_1238(pedIndexFromEntityIndex, &unk);
...
int func_1085(int iParam0, Hash hParam1, int iParam2) // Position - 0x27997
{
	Ped EntityIndex;
	Hash hash;
	int num;
	...
	for (i = 0; i < iParam2; i = i + 1)
	{
		...
		else if (func_1137(hParam1, iParam2, true, -142743235))
		{
			num = num + 1;
		}
	}
...
int func_1086(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x27A4D
{
	var unk;
	var unk6;
	...
	if (!func_459(hParam0, &unk6, &unk, iParam2, hParam3, false, false))
		return 0;

	return 1;
}

int func_1087(int iParam0) // Position - 0x27AB9
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_1088(Hash hParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, int iParam6) // Position - 0x27E4F
{
	int i;
	int num;
	Hash hash;
	...
	{
		num = func_228(hParam1);
		hasSlotCount = func_1239(hParam1);
	
		for (i = 0; i < hasSlotCount; i = i + 1)
		{
			if (ITEMDATABASE::_ITEMDATABASE_GET_HAS_SLOT_INFO(num, i, &hash))
			{
				if (func_619(hParam0, num, hash))
				{
					*uParam4 = { func_226(hParam1, false, 0) };
				
					if (iParam6 != 0)
						uParam4->f_4 = iParam6;
				
					*uParam3 = { func_368(hParam1, *uParam4, uParam4->f_4, false) };
					*uParam2 = hash;
					return true;
				}
			}
		...
		if (bParam5)
		{
			...
			inventoryId = func_213(false);
			unk30 = { func_226(hParam1, false, 0) };
		
			if (iParam6 != 0)
				unk30.f_4 = iParam6;
		
			parentGuid = { func_368(hParam1, unk30, unk30.f_4, false) };
			...
			for (j = 0; j < childrenCount; j = j + 1)
			{
				...
				{
					num = func_228(outInventoryItem.f_4);
					...
					for (i = 0; i < hasSlotCount; i = i + 1)
					{
						if (ITEMDATABASE::_ITEMDATABASE_GET_HAS_SLOT_INFO(num, i, &hash))
						{
							if (func_619(hParam0, num, hash))
							{
								if (func_1240(parentGuid, outInventoryItem.f_9, &unk16, false, -1))
								{
...
struct<4> func_1089() // Position - 0x27FCF
{
	var unk;

	unk = { func_367(false) };
	return func_368(856287005, unk, -218846335, false);
}

BOOL func_1090(Hash hParam0, int iParam1) // Position - 0x27FF3
{
	var unk;
	var unk6;
	Hash hash;
	...
	if (!func_1088(hParam0, 856287005, &hash, &unk6, &unk, true, 0))
		return false;

	unk10 = { func_1089() };
	unk14 = { func_368(hParam0, unk10, hash, false) };

	if (func_797(unk14, iParam1, false))
	{
		if (func_1241(hParam0))
		{
			if (func_1242(joaat("SLOTID_HORSE_HORN"), &hash2))
				func_1090(hash2, 0);
		}
		else if (func_1243(hParam0))
		{
			if (func_1242(joaat("SLOTID_HORSE_HORN"), &hash3))
				func_1090(hash3, 0);
		
			if (func_1242(joaat("SLOTID_HORSE_BLANKET"), &hash4))
				func_1090(hash4, 0);
		}
		else if (func_1244(hParam0))
		{
			if (func_1242(joaat("SLOTID_HORSE_HORN"), &hash5))
				func_1090(hash5, 0);
		
			if (func_1242(joaat("SLOTID_HORSE_BLANKET"), &hash6))
				func_1090(hash6, 0);
		
			if (func_1242(joaat("SLOTID_HORSE_BEDROLL"), &hash7))
				func_1090(hash7, 0);
		}
		else if (func_1245(hParam0))
		{
			if (func_1242(joaat("SLOTID_HORSE_HORN"), &hash8))
				func_1090(hash8, 0);
		
			if (func_1242(joaat("SLOTID_HORSE_BLANKET"), &hash9))
				func_1090(hash9, 0);
		
			if (func_1242(joaat("SLOTID_HORSE_BEDROLL"), &hash10))
				func_1090(hash10, 0);
		
			if (func_1242(joaat("SLOTID_HORSE_STIRRUP"), &hash11))
				func_1090(hash11, 0);
		
			if (func_1242(joaat("SLOTID_HORSE_SADDLEBAG"), &hash12))
				func_1090(hash12, 0);
		}
		else if (func_1091(hParam0))
		{
			if (func_1242(joaat("SLOTID_HORSE_HORN"), &hash13))
				func_1090(hash13, 0);
		
			if (func_1242(joaat("SLOTID_HORSE_STIRRUP"), &hash14))
				func_1090(hash14, 0);
		
			hash15 = func_1092(hParam0);
		
			if (func_105(hash15, 0))
				func_1090(hash15, 1);
		}
...
BOOL func_1091(Hash hParam0) // Position - 0x281E4
{
	if (!func_105(hParam0, 0))
		return false;

	if (func_312(hParam0, -251515357))
		return true;

	return false;
}

Hash func_1092(Hash hParam0) // Position - 0x2820E
{
	switch (hParam0)
	{
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
int func_1093() // Position - 0x28274
{
	var unk;
	var unk6;
	int i;
	...
	unk = { func_226(856287005, false, 0) };
	unk6 = { func_368(856287005, unk, unk.f_4, false) };
	num = func_228(856287005);

	if (ITEMDATABASE::_ITEMDATABASE_GET_HAS_SLOT_INFO(num, 0, &hash))
		hash2 = func_796(unk6, joaat("SLOTID_HORSE_SADDLE"), false, -1);

	if (!func_105(hash2, 0))
		return 0;

	flag = false;
	num2 = func_1239(856287005);
	...
	for (i = 0; i < num2; i = i + 1)
	{
		...
		{
			flag = false;
			hash3 = func_796(unk6, hash, false, -1);
		
			if (!func_105(hash3, 0))
			{
				if (hash == joaat("SLOTID_HORSE_HORN"))
				{
					if (func_1091(hash2) || func_1241(hash2) || func_1243(hash2) || func_1244(hash2) || func_1245(hash2))
					{
					}
					else
					{
				...
				{
					if (func_1243(hash2) || func_1244(hash2) || func_1245(hash2))
					{
					}
					else
					{
				...
				{
					if (func_1244(hash2) || func_1245(hash2))
					{
					}
					else
					{
				...
				{
					if (func_1091(hash2) || func_1245(hash2))
					{
					}
					else
					{
			...
			{
				if (!func_1091(hash2) && func_1246(hash3))
					flag = true;
			}
		
			if (flag)
			{
				if (func_1247(hash, &unk12, true))
				{
					if (!func_797(unk12, true, false))
					{
					}
				}
			}
...
BOOL func_1094(Hash hParam0, int iParam1) // Position - 0x28463
{
	var unk;
	int num;
	int num2;
...
void func_1095(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x284C3
{
	int i;
	...
	func_1249(&Global_1292143.f_20.f_1[Global_1292143.f_20 - 1 /*21*/]);
...
int func_1096(int iParam0) // Position - 0x2859F
{
	int num;
	int status;
...
Hash func_1097(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x28629
{
	int num;
...
BOOL func_1098(Hash hParam0) // Position - 0x286C5
{
	return func_228(hParam0) == 1946043663;
}

BOOL func_1099(Hash hParam0) // Position - 0x286D9
{
	return func_228(hParam0) == -126813555;
}

BOOL func_1100(Hash hParam0, int iParam1, var uParam2) // Position - 0x286ED
{
	var unk;
	int num;
	int num2;
	...
	*uParam2 = hParam0;
	...
	if (func_463(false))
	{
		num = func_358(func_1250(), hParam0);
	
		if (num != 0)
		{
			unk = { func_367(true) };
			unk.f_4 = func_605(num);
			uParam2->f_1[0 /*4*/] = { func_368(hParam0, unk, unk.f_4, true) };
	...
	num2 = func_379(hParam0, joaat("DEFAULT"));

	if (num2 != 0)
	{
		unk6 = 10;
	
		if (!func_726(&unk6, &num3, hParam0, num2, iParam1, true) || num3 < 1)
			return false;
	
		for (i = 0; i < num3; i = i + 1)
		{
			uParam2->f_1[i /*4*/] = { func_368(hParam0, unk6[i /*6*/], unk6[i /*6*/].f_4, true) };
...
BOOL func_1101(int* piParam0, Any* panParam1, Any* panParam2, Hash hParam3, BOOL bParam4) // Position - 0x2880F
{
	if (hParam3 != 541670136 && hParam3 != joaat("batch"))
		return false;

	if (!func_1251(*panParam1))
		return false;

	if (!func_1252(piParam0, hParam3))
		return false;
	...
	return func_1253(piParam0, bParam4);
}

BOOL func_1102(Hash hParam0, Hash hParam1, Any anParam2) // Position - 0x2887B
{
	int i;
	int num;
...
BOOL func_1103(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x288BB
{
	var unk;
	int num;
	int i;
	...
	if (!func_1254(hParam0, hParam1, &unk, &num) || num < 1)
		return 0;
...
BOOL func_1104(Hash hParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0x28949
{
	var unk;
	int i;
...
int func_1105(Hash hParam0, BOOL bParam1) // Position - 0x289CD
{
	if (!func_903(hParam0, bParam1))
		return 0;

	if (hParam0 == joaat("document_pamphlet_tracking_arrow"))
		return func_394(joaat("ammo_arrow_tracking"), true);
	else if (hParam0 == joaat("document_pamphlet_poison_bottle"))
		return func_394(joaat("ammo_poisonbottle"), true);
	else if (hParam0 == 318000298)
		return func_394(-1939515319, true);
	else if (hParam0 == -1771777013)
		return func_394(-1903059161, true);
	else if (hParam0 == 375366730)
		return func_394(-252071901, true);
	else if (hParam0 == -1309887827)
		return func_394(-611782825, true);

	return func_394(hParam0, true);
}

// Unhandled jump detected. Output should be considered invalid
BOOL func_1106(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x28A85
{
	int i;
	...
	*uParam3 = ITEMDATABASE::_0x388088BFF3681189(hParam0, hParam1);
	...
	if (bParam4)
		func_1255(hParam0, hParam1, uParam2, *uParam3);

	return true;
}

BOOL func_1107(int* piParam0, Any* panParam1, Any* panParam2, Hash hParam3, BOOL bParam4, int iParam5) // Position - 0x28B15
{
	if (hParam3 != 2113164098 && hParam3 != joaat("Sell") && hParam3 != joaat("use"))
		return false;

	if (!func_1256(hParam3, panParam1, iParam5))
		return false;

	if (!func_1252(piParam0, hParam3))
		return false;

	if (func_1257(*piParam0, hParam3, panParam1, panParam2))
	{
	}
	else
	{
...
BOOL func_1108(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x28B87
{
...
void func_1109(BOOL bParam0) // Position - 0x28BB0
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_1110(int iParam0) // Position - 0x28BEE
{
...
void func_1111(BOOL bParam0) // Position - 0x28C5C
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_1112(BOOL bParam0) // Position - 0x28C96
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_1113(BOOL bParam0) // Position - 0x28CD0
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_1114(BOOL bParam0) // Position - 0x28D0A
{
	Hash hash;
...
void func_1115(BOOL bParam0) // Position - 0x28D2D
{
	int promptType;
	Player player;
...
void func_1116(BOOL bParam0) // Position - 0x28D6F
{
	int promptType;
	Player player;
...
BOOL func_1117() // Position - 0x28DB1
{
	return true;
}

int func_1118(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x28DD0
{
	int num;
	int num2;
	int num3;
...
int func_1119() // Position - 0x28E36
{
	return Global_1902569;
}

void func_1120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x28E42
{
	int num;
	int i;
	int num2;
	...
	num = func_1258(*iParam0);
	i = func_1259(*iParam0);
	num2 = func_1260(*iParam0);
	j = func_1261(*iParam0);
	k = func_1262(*iParam0);
	l = func_1263(*iParam0);
	...
	for (m = func_1264(i, num); num2 > m; m = func_1264(i, num))
	{
		iParam5 = iParam5 + 1;
		num2 = num2 - m;
	...
	func_1265(iParam0, l, k, j, num2, i, num);
	return;
}

void func_1121(int iParam0, int iParam1) // Position - 0x28FCA
{
	if (iParam0 <= 0)
		return;
...
BOOL func_1122() // Position - 0x29006
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_1123() // Position - 0x29017
{
	return DLC::IS_DLC_PRESENT(joaat("dlc_ultimateedition"));
}

BOOL func_1124(Hash hParam0) // Position - 0x29028
{
	if (!func_546(hParam0, 1955773996))
		return false;

	if (!func_1267(hParam0, 1))
		return false;

	return true;
}

BOOL func_1125(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4) // Position - 0x29053
{
	return func_1268(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(pedParam0), hParam1, iParam2, bParam3, hParam4);
}

BOOL func_1126(Hash hParam0) // Position - 0x2906D
{
	int i;
	int num;
	Hash hash;

	if (!func_1269(hParam0))
		return false;
...
BOOL func_1127(int iParam0, Hash hParam1, int iParam2) // Position - 0x290AF
{
	Hash hash;
	int num;
	int num2;
	...
	hash = func_1271(hParam1);

	if (hash != 0)
	{
		num = func_1272(hash, 1);
...
BOOL func_1128(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x29147
{
	Player player;
	...
	return func_1274(player, bParam2) >= func_1275(bParam2);
}

int func_1129(Ped pedParam0, Hash hParam1, int iParam2) // Position - 0x29188
{
	int i;
	Hash peltFromHorse;
...
int func_1130(Ped pedParam0, Hash hParam1) // Position - 0x2923A
{
	int num;
	ItemSet itemSet;
	int itemsetSize;
	...
	for (i = 0; i < itemsetSize; i = i + 1)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(entityFromItem) && !NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(entityFromItem) && hParam1 == func_1131(entityFromItem))
			num = num + 1;
	}
...
Hash func_1131(Ped pedParam0) // Position - 0x292D8
{
	Hash hash;
	...
	{
		hash = func_441(&pedParam0);
	
		if (!func_105(hash, 0))
			hash = func_442(pedParam0);
	}
	else
	{
		hash = func_442(pedParam0);
...
BOOL func_1132(Hash hParam0, var uParam1) // Position - 0x2932B
{
	*uParam1 = func_1276(hParam0);
	return *uParam1 != 0;
}

void func_1133(Any* panParam0, Hash hParam1) // Position - 0x29341
{
	MISC::COPY_SCRIPT_STRUCT(hParam1, panParam0, 96);
	return;
}

int func_1134(Hash hParam0) // Position - 0x29353
{
	int num;
	Hash hash;

	if (func_1132(hParam0, &hash))
		hParam0 = hash;
...
int func_1135(Hash hParam0) // Position - 0x293AC
{
	switch (hParam0)
	{
		case joaat("PROVISION_ANIMAL_CARCASS_CHICKEN_PERFECT"):
...
void func_1136(Hash hParam0, int iParam1) // Position - 0x29EBD
{
	Ped mountOwnedByPlayer;

	if (func_40() == -1)
		mountOwnedByPlayer = func_245(7);
	else
		mountOwnedByPlayer = PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::PLAYER_ID());

	func_1129(mountOwnedByPlayer, hParam0, iParam1);
	return;
}

BOOL func_1137(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x29EEC
{
	var unk;
	var unk6;
	...
	unk.f_4 = 724026534;
	unk6 = { func_368(hParam0, unk, unk.f_4, false) };
	return func_459(hParam0, &unk6, &unk, iParam1, hParam3, bParam2, false);
}

BOOL func_1138(Any* panParam0) // Position - 0x29F43
{
	if (!func_1277(panParam0))
		return false;

	return INVENTORY::_INVENTORY_IS_ITEM_EXPIRED(panParam0);
}

BOOL func_1139(int iParam0, var uParam1, Any* panParam2) // Position - 0x29F5F
{
	if (!func_122(iParam0))
		return false;
...
BOOL func_1140(Any* panParam0, int iParam1) // Position - 0x2A06A
{
...
int func_1141() // Position - 0x2A0A1
{
	int numChildren;
	int num;
...
int func_1142() // Position - 0x2A0D9
{
	return Global_1110244.f_3667.f_938;
}

int func_1143(int iParam0, int iParam1, var uParam2) // Position - 0x2A0EB
{
	int num;
	...
	if (*uParam2 < Global_1110244.f_3667.f_729[num /*2*/])
		return func_1143(iParam0, num - 1, uParam2);

	if (*uParam2 > Global_1110244.f_3667.f_729[num /*2*/])
		return func_1143(num + 1, iParam1, uParam2);

	return num;
}

int func_1144(int iParam0) // Position - 0x2A155
{
	return Global_1110244.f_3667.f_729[iParam0 /*2*/].f_1;
}

BOOL func_1145(int iParam0) // Position - 0x2A16D
{
	return iParam0 > -1 && iParam0 < 83;
}

BOOL func_1146(Any* panParam0) // Position - 0x2A183
{
	int fileHandle;
	var SourceStruct;

	fileHandle = func_1279();
...
BOOL func_1147(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int* piParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x2A1BC
{
	uParam0.f_2 = iParam6;
	uParam0.f_3 = iParam7;
	uParam0.f_4 = iParam8;
...
struct<8> func_1148(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x2A1E7
{
	return func_1280(uParam0, 52, 1);
}

int func_1149(Hash hParam0) // Position - 0x2A1FA
{
	switch (hParam0)
	{
...
BOOL func_1150(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2A293
{
	int num;
	...
	num = func_1281(iParam0);
	return num >= iParam2 && num <= iParam3;
}

BOOL func_1151(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2A2CE
{
	if (bParam2)
		if (!func_966(iParam0))
			return false;
...
BOOL func_1152(int iParam0) // Position - 0x2A311
{
	if (!func_966(iParam0))
		return false;

	return func_1151(iParam0, 2, true);
}

int func_1153(BOOL bParam0, Hash hParam1) // Position - 0x2A32F
{
	if (!NETWORK::NETWORK_IS_IN_SESSION())
		return 0;
...
BOOL func_1154(int iParam0) // Position - 0x2A385
{
	switch (iParam0)
	{
		case 1:
...
void func_1155(int iParam0) // Position - 0x2A3F2
{
	switch (iParam0)
	{
		case 2:
...
void func_1156(Hash hParam0, int iParam1) // Position - 0x2A5F8
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

Hash func_1157() // Position - 0x2A60B
{
	return Global_1953292.f_1676;
}

int func_1158(BOOL bParam0) // Position - 0x2A61A
{
	var unk;
	int num;
	var unk15;
	...
	unk.f_9 = -1591664384;
	num = 0;
	unk15 = { func_368(joaat("WARDROBE"), func_367(true), 1034665895, true) };
	hash = func_796(unk15, 552979403, true, -1);
	...
	unk19 = { func_559(0, -1591664384, 552979403, -1591664384, 0, 0, 0) };

	if (func_561(&unk19, &num2, &num3, true))
	{
		if (num3 > 0 && func_562(&unk, 0, num2, num3))
		{
...
Hash func_1159(int iParam0) // Position - 0x2A727
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_1160(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x2A7C4
{
	int i;
	BOOL flag;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_1161(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6, BOOL bParam7, BOOL bParam8, int iParam9) // Position - 0x2A8A4
{
	Hash hash;
	int num;
	BOOL flag;
	...
	*uParam2 = flag;
	...
	if (!flag && !bParam3)
		func_1284(hParam0, func_1283(hash), true, true, bParam7);
		...
		else
		{
			...
			else
			{
				...
				if (!DATAFILE::_PARSEDDATA_GET_SECTION(&hash, &num2, 1194786549))
					if (func_1286(hash2) && func_1012(hParam0->f_1[num /*3*/], hash2, &hash))
	...
	{
		if (!bParam8)
			func_1288(hParam0, num3, func_1287(hParam1) != 0, iParam9);
	}
	else if (func_785() == joaat("MPC_PLAYER_TYPE_MP_FEMALE") && hParam0->f_1[num /*3*/] == Global_1953292.f_83[num /*12*/] && func_1287(hParam0->f_1[34 /*3*/]) == 0 && !func_425(32) && !func_425(64))
	{
		hParam0->f_1[num /*3*/] = func_1173(-1293064293, 0);
		hParam0->f_1[num /*3*/].f_1 = joaat("base");
		func_793(hParam0, hParam0->f_1[num /*3*/], num, false, iParam9);
	}
...
void func_1162(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4, Hash hParam5) // Position - 0x2AAD3
{
	*panParam0 = iParam1;
...
BOOL func_1163(var uParam0, int iParam1) // Position - 0x2AB02
{
	return uParam0->f_1 && iParam1 != false;
}

void func_1164(var uParam0, int iParam1, int iParam2) // Position - 0x2AB13
{
	uParam0->f_1 = uParam0->f_1 || iParam1;
	return;
}

BOOL func_1165(int iParam0, int iParam1) // Position - 0x2AB26
{
	return iParam0->f_1 && iParam1 != false;
}

void func_1166(int iParam0, int iParam1) // Position - 0x2AB37
{
	iParam0->f_1 = iParam0->f_1 || iParam1;
	return;
}

int func_1167(int iParam0) // Position - 0x2AB4A
{
	if (iParam0 == 0)
		iParam0 = func_785();
...
void func_1168(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x2AB86
{
	int num;
	Hash hash;
	...
	if (func_312(hash, 160827531) || func_228(hash) == 81053684)
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam2);
...
void func_1169(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x2ABE9
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_312(hParam0->f_1[num /*3*/], -93469181))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam2);
...
void func_1170(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x2AC4E
{
	int num;
	...
	if (-525676072 == func_228(hParam0->f_1[num /*3*/]))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam2);
...
BOOL func_1171(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x2AC9B
{
	int num;
...
BOOL func_1172(int iParam0) // Position - 0x2ACE8
{
	return Global_17418.f_55.f_664.f_1734 && iParam0 != false;
}

Hash func_1173(Hash hParam0, int iParam1) // Position - 0x2AD00
{
	int num;
	int num2;
	int num3;
	...
	num3 = 0;
	unk = { func_559(0, -1591664384, hParam0, -1591664384, 0, 0, 0) };

	if (func_561(&unk, &num, &num2, true))
	{
		if (num2 > 0)
			num3 = func_1289(num, num2, iParam1);
...
void func_1174(Hash hParam0, int iParam1) // Position - 0x2AD4D
{
	int num;
	BOOL flag;
	...
	{
		if (func_1011(hParam0->f_1[num /*3*/], flag, -1539589426) >= 0)
		{
			hParam0->f_1[num /*3*/].f_1 = -1539589426;
			return;
		}
	...
	if (func_1011(hParam0->f_1[num /*3*/], flag, 1334603721) >= 0)
		hParam0->f_1[num /*3*/].f_1 = 1334603721;

	return;
}

void func_1175(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x2AE13
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_312(hParam2, -1527414429) && !func_312(hParam0->f_1[num /*3*/], -1303648999))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/].f_1 == 1530758430 || hParam0->f_1[num /*3*/].f_1 == 1334603721 && func_312(hParam2, -985549034))
	{
		if (hParam0->f_1[num /*3*/].f_1 == 1530758430)
		{
			hParam0->f_1[num /*3*/].f_1 = joaat("base");
...
void func_1176(Hash hParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x2AF1B
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[iParam2 /*3*/].f_1 != -2081918609)
	{
		...
		else
		{
			...
			if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && 1769055947 == func_228(hash))
			{
				hParam0->f_1[iParam2 /*3*/].f_1 = -2081918609;
				func_791(iParam2, iParam3);
			}
...
void func_1177(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x2AFFD
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		if (func_312(hParam2, 1889502862) && func_228(hash) == 698653232)
		{
			hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
			hParam0->f_1[num /*3*/].f_1 = 0;
			func_791(num, iParam3);
		}
		else if (func_312(hParam2, 449467137) && func_228(hash) == 912453393)
		{
			hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
			hParam0->f_1[num /*3*/].f_1 = 0;
			func_791(num, iParam3);
	...
	if (bParam1)
	{
		...
		{
			func_791(num, iParam3);
			func_1004(hParam0, false, hParam0->f_1[num /*3*/], iParam3);
		}
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_312(hParam2, 1126863852))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_312(hParam2, -985549034))
		if (hParam0->f_1[num /*3*/].f_1 == 1530758430)
			hParam0->f_1[num /*3*/].f_1 = joaat("base");
		else if (hParam0->f_1[num /*3*/].f_1 == 1334603721)
			hParam0->f_1[num /*3*/].f_1 = -1539589426;
...
void func_1178(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x2B26A
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && !func_312(hParam0->f_1[num /*3*/], -1303648999))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_312(hParam2, 675650051))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
...
BOOL func_1179(int iParam0) // Position - 0x2B37E
{
	return Global_1953292.f_1676.f_1[func_266(iParam0, 1) /*3*/] != Global_1953292.f_83[func_266(iParam0, 1) /*12*/];
}

void func_1180(Hash hParam0, int iParam1) // Position - 0x2B3A8
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		if (func_312(hParam0->f_1[num /*3*/], -928740153))
		{
			hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
			hParam0->f_1[num /*3*/].f_1 = 0;
		}
...
void func_1181(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x2B473
{
	int num;
	Hash hash;
	BOOL flag;
	...
	if (func_785() == joaat("MPC_PLAYER_TYPE_MP_FEMALE"))
	{
		...
		if (hParam0->f_1[num /*3*/] == Global_1953292.f_83[num /*12*/] && func_228(hParam0->f_1[18 /*3*/]) != 912453393)
		{
			hParam0->f_1[num /*3*/] = func_1173(Global_1953292.f_83[num /*12*/].f_9, 0);
			hParam0->f_1[num /*3*/].f_1 = 0;
			func_791(num, iParam3);
		}
	}
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_312(hParam2, -1473580422))
	{
		hash = hParam0->f_1[num /*3*/];
	
		if (func_312(hash, 1469783911))
		{
			hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
			hParam0->f_1[num /*3*/].f_1 = 0;
		}
		else if (func_1011(hParam0->f_1[num /*3*/], flag2, -2081918609) != -1)
		{
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		...
		if (func_228(hash) == 912453393)
		{
			flag = true;
		
			if (func_312(hParam2, 1583165364))
			{
				hParam0->f_1[num /*3*/].f_1 = -2081918609;
				func_791(num, iParam3);
			}
	...
	if (hash != Global_1953292.f_83[num /*12*/])
		if (func_228(hash) == 1868067663 && func_312(hParam2, -1016441646))
			func_1290(hParam0, num, iParam3);
		else if (flag)
			func_791(num, iParam3);

	num = 34;

	if (1759215194 == func_228(hParam0->f_1[num /*3*/]))
		func_791(16, iParam3);

	num = 35;

	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_312(hParam2, -1650340550))
	{
		hash = hParam0->f_1[num /*3*/];
	
		if (func_228(hash) == 1769055947)
		{
			hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
			hParam0->f_1[num /*3*/].f_1 = 0;
			func_791(num, iParam3);
...
void func_1182(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x2B71B
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
		if (func_312(hParam0->f_1[num /*3*/], -2093434733))
			func_1188(hParam0, iParam3, true, false);
		else if (func_312(hParam2, 1718965018))
			hParam0->f_1[num /*3*/].f_1 = joaat("base");
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		...
		if (func_312(hash, 1090938458) && func_312(hParam2, 475297062))
			func_1290(hParam0, num, iParam3);
	}
...
void func_1183(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x2B87C
{
	int num;
	Hash hash;
	...
	if (hash != Global_1953292.f_83[num /*12*/] && func_312(hash, 353024991))
		func_1290(hParam0, num, iParam2);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && 1769055947 == func_228(hParam0->f_1[num /*3*/]))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam2);
...
void func_1184(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x2BA31
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_228(hash) == 294388917)
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
...
void func_1185(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x2BC6C
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		if (func_312(hParam0->f_1[num /*3*/], -2093434733))
		{
			func_1188(hParam0, iParam2, true, false);
		}
		else
		{
			hParam0->f_1[num /*3*/].f_1 = joaat("base");
...
void func_1186(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x2BE64
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_312(hParam2, -1278198125))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		...
		if (912453393 == func_228(hash) && hParam0->f_1[num /*3*/].f_1 != -2081918609)
		{
			hParam0->f_1[num /*3*/].f_1 = -2081918609;
			func_791(num, iParam3);
		}
...
void func_1187(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x2BF81
{
	int num;
...
void func_1188(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2BFE0
{
	int num;
	...
	if (bParam3 && -923693316 == func_228(hParam0->f_1[num /*3*/]))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_791(num, iParam1);
...
void func_1189(Hash hParam0, int iParam1, int iParam2) // Position - 0x2C0D9
{
	Global_17418.f_55.f_664.f_33[iParam2 /*120*/].f_1.f_1[iParam1 /*3*/] = { *hParam0 };
	return;
}

void func_1190(Hash hParam0, int iParam1) // Position - 0x2C0FD
{
	int i;
	...
	for (i = 0; i < 39; i = i + 1)
	{
		func_1189(&hParam0->f_1[i /*3*/], i, iParam1);
	}

	return;
}

void func_1191(BOOL bParam0, int iParam1, int iParam2) // Position - 0x2C14E
{
	if (iParam1 == -1)
		iParam1 = Global_17418.f_55.f_664.f_1777;
...
BOOL func_1192(Any* panParam0, Hash hParam1, Any* panParam2, BOOL bParam3, int iParam4) // Position - 0x2C199
{
	var outGuid;
	...
	if (!func_620(&outGuid, panParam2, bParam3, false, iParam4))
		return 0;

	return 1;
}

struct<29> func_1193(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x2C1E7
{
	var unk;
	var unk30;
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_213(bParam4), &uParam0, &unk30, 29, 1))
		return unk;

	unk = { func_1199(&unk30, bParam5) };
	unk.f_17 = { unk30.f_16 };
	unk.f_25 = unk30.f_25;
	unk.f_26 = unk30.f_27;
	unk.f_27 = unk30.f_28;
...
int func_1194(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x2C282
{
	int num;
	...
	if (bParam2)
		if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_START(&num, joaat("basket"), hParam0))
			return func_626(func_1291(num, hParam0, panParam1), num, panParam1);
	else
		return func_627(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(hParam0, &num, panParam1, 29), num, panParam1);

	return -1;
}

struct<26> func_1195(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x2C2EC
{
	var unk;
	var unk27;
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_213(bParam4), &uParam0, &unk27, 24, 1))
		return unk;

	unk = { func_1199(&unk27, bParam5) };
	unk.f_17 = { unk27.f_15 };
	unk.f_25 = unk27.f_23;
	return unk;
}

int func_1196(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x2C36F
{
	int num;
	...
	if (bParam2)
		if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_START(&num, joaat("basket"), hParam0))
			return func_626(func_1292(num, hParam0, panParam1), num, panParam1);
	else
		return func_627(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(hParam0, &num, panParam1, 26), num, panParam1);

	return -1;
}

struct<18> func_1197(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x2C3BF
{
	var unk;
	var unk19;
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_213(bParam4), &uParam0, &unk19, 15, 1))
		return unk;

	unk = { func_1199(&unk19, bParam5) };
	unk.f_17 = unk19.f_14;
	return unk;
}

int func_1198(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x2C434
{
	int num;
	...
	if (bParam2)
		if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_START(&num, joaat("basket"), hParam0))
			return func_626(func_1293(num, hParam0, panParam1), num, panParam1);
	else
		return func_627(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(hParam0, &num, panParam1, 18), num, panParam1);

	return -1;
}

struct<17> func_1199(var uParam0, BOOL bParam1) // Position - 0x2C49E
{
	var unk;
	...
	if (bParam1)
	{
		unk.f_15 = func_379(uParam0->f_4, joaat("DEFAULT"));
...
BOOL func_1200() // Position - 0x2C51F
{
	return func_122(Global_1051268);
}

BOOL func_1201(int iParam0) // Position - 0x2C531
{
	return iParam0 == -1759663922 || iParam0 == -318976023 || iParam0 == 772881414 || iParam0 == 31269700 || iParam0 == -133550749;
}

int func_1202(int iParam0, Hash hParam1) // Position - 0x2C579
{
	var guid;
	int inventoryItemCountWithGuid;
	...
	guid = { func_1294(iParam0, hParam1) };
...
BOOL func_1203() // Position - 0x2C5B7
{
	...
	if (!func_1295(vehicleOwnedByPlayer))
		return false;

	return true;
}

BOOL func_1204(Player plParam0) // Position - 0x2C606
{
	float num;

	num = func_1296(plParam0) - PLAYER::_GET_PLAYER_CACHED_DEAD_EYE_AMOUNT(plParam0);
	return num <= 1f;
}

void func_1205(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2C621
{
	int num;
	int i;
	int j;
	...
	num = num - iParam6;
	func_1265(uParam0, m, l, k, j, i, num);
	return;
}

int func_1206(int iParam0, int iParam1) // Position - 0x2C794
{
	if (iParam1 == 2)
		iParam1 = func_676(2);
...
int func_1207(int iParam0, int iParam1) // Position - 0x2C7E4
{
	if (iParam1 == 2)
		iParam1 = func_676(2);
...
BOOL func_1208(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2C836
{
	if (bParam2)
...
void func_1209(int iParam0, int iParam1, int iParam2) // Position - 0x2C863
{
	if (iParam2 == 2)
		iParam2 = func_676(2);
...
void func_1210(int iParam0, int iParam1, int iParam2) // Position - 0x2C8B9
{
	if (iParam2 == 2)
		iParam2 = func_676(2);
...
BOOL func_1211(Ped pedParam0, int iParam1, float fParam2) // Position - 0x2C90F
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(pedParam0, func_1298(iParam1), BUILTIN::CEIL(fParam2));
	return true;
}

void func_1212(int iParam0, int iParam1, int iParam2) // Position - 0x2C964
{
	if (iParam2 == 2)
		iParam2 = func_676(2);
...
void func_1213(Ped pedParam0, int iParam1, float fParam2) // Position - 0x2C9C5
{
	char* StringToTest;

	StringToTest = func_1299(iParam1);

	if (!MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		PED::_SET_PED_BLACKBOARD_FLOAT(pedParam0, func_1300(iParam1), fParam2, -1);

	return;
}

void func_1214(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x2C9F1
{
	int num;
	...
	if (bParam2)
		func_1302(iParam0, num, iParam3);

	return;
}

BOOL func_1215(int iParam0, BOOL bParam1) // Position - 0x2CA27
{
	return func_1208(func_1119(), iParam0, bParam1);
}

float func_1216(int iParam0, int iParam1) // Position - 0x2CA3B
{
	if (iParam1 == 2)
		iParam1 = func_676(1);
...
int func_1217(float fParam0) // Position - 0x2CA87
{
	float num;
...
int func_1218(int iParam0, float fParam1, int iParam2) // Position - 0x2CAB2
{
...
BOOL func_1219(int iParam0) // Position - 0x2CB03
{
	switch (iParam0)
	{
		case 0:
...
char* func_1220(int iParam0) // Position - 0x2CB32
{
	switch (iParam0)
	{
		case 0:
...
void func_1221(int iParam0) // Position - 0x2CB6D
{
	int num;
	int num2;
	int i;
...
void func_1222(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2CC3D
{
	func_1039(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

void func_1223(var uParam0, Hash hParam1, Hash hParam2) // Position - 0x2CC57
{
	int acquireCostsCount;
	Hash hash;
	int i;
	...
	for (i = 0; i < acquireCostsCount; i = i + 1)
	{
		if (ITEMDATABASE::_ITEMDATABASE_GET_ACQUIRE_COST(hParam1, i, &hash))
			if (hash != hParam2)
				if (hash.f_2 == joaat("cost_type_craft") && hash != -489628648 && hash != -2141192156 && Global_1913634.f_1579 || !func_901(hParam1, hash, true))
...
void func_1224(var uParam0, Hash hParam1) // Position - 0x2CD13
{
	int num;
	int num2;
	int num3;
	...
	num3 = func_400(hParam1, 1697966752);

	if (num3 == 0)
		return;

	unk = { func_607(-1591664384, -1591664384, 0, 0, joaat("cost_crafting_grill"), 0, -1, num3, 0) };
	...
	if (func_608(unk, &num, &num2, 0))
	{
		for (i = 0; i < num2; i = i + 1)
		{
			...
			if (func_105(hash, 0))
				if (Global_1913634.f_1579 || !func_901(hash, joaat("cost_crafting_grill"), true))
					Global_1913634[uParam0->f_45 - 1 /*9*/].f_7 = Global_1913634[uParam0->f_45 - 1 /*9*/].f_7 + 1;
		}
...
void func_1225(var uParam0, Hash hParam1, int iParam2) // Position - 0x2CDCA
{
	int num;
	int num2;
	int num3;
	...
	num3 = func_400(hParam1, -1859264326);

	if (num3 == 0)
		return;

	unk = { func_607(-1591664384, -1591664384, 0, 0, 0, 0, -1, num3, 0) };
	...
	if (func_608(unk, &num, &num2, 0))
	{
		for (i = 0; i < num2; i = i + 1)
		{
			...
			if (func_105(hash, 0) && hash != hParam1)
				func_1047(uParam0, hash, iParam2);
		}
...
void func_1226(var uParam0) // Position - 0x2CE62
{
	func_613(*uParam0);
	*uParam0 = -1;
	return;
...
void func_1227(var uParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2CE76
{
	Hash hash;
	var unk;
	Hash hash2;
	...
	num = func_225(hash, hash3, bParam3, false);
	num2 = func_350(hash, false, false, false);
	num3 = func_1030(hash, false);
	...
	if (!Global_1913634.f_1579 && func_901(hash, hash3, true))
	{
		flag = true;
	...
	TEXT_LABEL_APPEND_INT(&unk5, func_593(num3, num), 8);
	DATABINDING::_DATABINDING_ADD_DATA_STRING(hash2, "count", &unk5);
	DATABINDING::_DATABINDING_ADD_DATA_BOOL(hash2, "visible", false);
	flag2 = false;

	if (func_99(uParam0, 2))
		hash4 = num > 0 && func_1060(hash) && !flag ? 1 : 0;
	else
		hash4 = num3 > 0 && num > 0 && !flag ? 1 : 0;

	if (hash4 == 0 && func_1228(hash))
	{
		if (func_1229(hash, hash3, uParam0, bParam3, &hash5, &hash6, &num4))
		{
			hash4 = 1;
			flag2 = true;
			hash = hash5;
	...
	if (hash4 == 1)
	{
		if (!func_582(2) && func_400(hash, -1636519629) == -701492487)
		{
...
BOOL func_1228(Hash hParam0) // Position - 0x2D4A9
{
	return true;
}

BOOL func_1229(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, var uParam4, var uParam5, var uParam6) // Position - 0x2D4B2
{
	int num;
	int num2;
	var unk;
	...
	if (!Global_1913634.f_1579 && func_901(hParam0, hParam1, true))
		return false;
	...
	if (hParam1 == -214678071 || hParam1 == joaat("cost_crafting_grill"))
	{
		...
		if (func_608(unk, &num, &num2, 0))
		{
			for (i = 0; i < num2; i = i + 1)
			{
				...
				else if (!Global_1913634.f_1579 && func_901(hash, joaat("cost_crafting_grill"), true))
				{
				}
				else if (func_874(hash, joaat("cost_crafting_grill"), false, bParam3, false) && !func_592(hash, 1, false))
				{
					func_613(num);
					*uParam4 = hash;
					...
					*uParam6 = i;
					...
					if (func_312(*uParam4, 2127114599))
						*uParam6 = 1;
					else if (func_312(*uParam4, -1864584831))
						*uParam6 = 2;
					else if (func_312(*uParam4, 1967571132))
						*uParam6 = 3;
		...
		{
			unk = { func_607(-1591664384, -1591664384, 0, 0, -214678071, 0, -1, num3, 0) };
		
			if (func_608(unk, &num, &num2, 0))
			{
				for (j = 0; j < num2; j = j + 1)
				{
					hash2 = func_609(j, num);
				
					if (hParam0 == hash2)
					{
					}
					else if (!Global_1913634.f_1579 && func_901(hash2, -214678071, true))
					{
					}
					else if (func_874(hash2, -214678071, false, bParam3, false) && !func_592(hash2, 1, false))
					{
						func_613(num);
						*uParam4 = hash2;
						*uParam5 = -214678071;
	...
	else
	{
		...
		for (k = 0; k < acquireCostsCount; k = k + 1)
		{
			if (ITEMDATABASE::_ITEMDATABASE_GET_ACQUIRE_COST(hParam0, k, &hash3))
			{
				...
				{
					if (hash3 != -489628648 && hash3 != -2141192156 && Global_1913634.f_1579 || !func_901(hParam0, hash3, true))
					{
						if (func_874(hParam0, hash3, false, bParam3, false) && !func_592(hParam0, 1, false))
						{
							*uParam4 = hParam0;
							*uParam5 = hash3;
							*uParam6 = k;
...
Hash func_1230() // Position - 0x2D7D1
{
	Player gangLeader;

	gangLeader = GANG::NETWORK_GET_GANG_LEADER(GANG::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()));
	return func_1046(gangLeader);
}

int func_1231(Hash hParam0) // Position - 0x2D7ED
{
	switch (hParam0)
	{
		case -1612693182:
	...
	if (func_312(hParam0, -2011345500))
		return 5;

	return 0;
}

char* func_1232(Hash hParam0) // Position - 0x2D845
{
	switch (func_1231(hParam0))
	{
		case 1:
			return "STEW_TIP_LOW";
...
int func_1233(Player plParam0) // Position - 0x2D89E
{
	int i;
...
int func_1234(int iParam0, char* sParam1, int iParam2, BOOL bParam3) // Position - 0x2D901
{
	int num;
	var unk;
	var unk6;
	...
	num = -1;
	unk = { func_226(joaat("currency_cash"), true, 0) };
	unk6 = { func_1307(joaat("currency_cash"), unk, unk.f_4, iParam0, true) };
	unk6.f_12 = iParam2;
	num = func_385(joaat("use"), &unk6, bParam3);
...
void func_1235(int iParam0) // Position - 0x2D97A
{
	var statId;
	...
	statId = { func_556(joaat("CAREER_CASH")) };
	STATS::_STAT_ID_DECREMENT_INT(&statId, iParam0);
	return;
}

void func_1236(int iParam0, char* sParam1, int iParam2) // Position - 0x2D9B6
{
	if (iParam0 == 0)
		return;
	...
	func_553(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("itemtype_cash"), 1, joaat("COLOR_RED"), 0, 0, 0, true);
	return;
}

int func_1237(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x2D9F7
{
	int num;
	int num2;
	Hash hash;
	...
	num = -1;
	num2 = func_611(hParam0);
	hash = func_610(hParam0);
	...
	if (hash != 0)
	{
		if (!func_103(false) || func_104())
		{
			if (bParam2)
			{
				func_107(func_106(joaat("broken_down"), joaat("small_animals")), 1);
				return func_1308(hash, num2, hParam0, hParam1);
			}
		
			unk = { func_226(hParam0, true, 0) };
			unk6 = { func_368(hParam0, unk, unk.f_4, true) };
			num3 = func_1309(hParam0, &unk6, 1, -142743235, false, true);
		...
		if (func_216(hParam0, 1, true, -142743235))
			num = func_1308(hash, num2, hParam0, hParam1);
	}

	return num;
}

int func_1238(Ped pedParam0, Any* panParam1) // Position - 0x2DAD3
{
	int pedDamageCleanliness;
	int animalRarity;
	int skinningQuality;
...
int func_1239(Hash hParam0) // Position - 0x2DB85
{
	int num;
...
BOOL func_1240(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, Any* panParam5, BOOL bParam6, int iParam7) // Position - 0x2DBB4
{
	return func_1192(&uParam0, hParam4, panParam5, bParam6, iParam7);
}

BOOL func_1241(Hash hParam0) // Position - 0x2DBCA
{
	!func_105(hParam0, 0);

	if (func_312(hParam0, 162787671))
		return true;

	return false;
}

BOOL func_1242(Hash hParam0, var uParam1) // Position - 0x2DBF0
{
	var unk;

	if (!func_1310(856287005, hParam0))
		return false;

	unk = { func_1089() };
	*uParam1 = func_796(unk, hParam0, false, -1);
...
BOOL func_1247(Hash hParam0, var uParam1, BOOL bParam2) // Position - 0x2DCFE
{
	int num;
	int num2;
	var unk;
	...
	unk = { func_559(0, hParam0, -1591664384, -1591664384, 0, 0, 0) };
	func_560(&unk, func_1089());
	...
	if (func_561(&unk, &num, &num2, false))
	{
		...
		for (i = 0; i < num2; i = i + 1)
		{
			if (func_562(&unk19, i, num, num2))
			{
				if (func_105(unk19.f_4, 0) && !unk19.f_10)
				{
					if (bParam2 && func_1246(unk19.f_4))
					{
					}
					else
					{
...
BOOL func_1248(Hash hParam0, var uParam1) // Position - 0x2DDB6
{
	int i;
	var unk;
	var unk2;
...
void func_1249(int iParam0) // Position - 0x2DE0A
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
	iParam0->f_3 = 0;
	func_1312(&(iParam0->f_4));
	return;
}

int func_1250() // Position - 0x2DE2D
{
	return Global_1915656.f_20241;
}

BOOL func_1251(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x2DE3C
{
	if (!func_601(uParam0.f_17))
		return false;

	return true;
}

BOOL func_1252(int* piParam0, Hash hParam1) // Position - 0x2DE55
{
	Hash action;

	if (!NETSHOPPING::_CASHINVENTORY_TRANSACTION_GET_BASKET_IS_VALID(*piParam0))
		if (!func_1313(piParam0, hParam1))
			return false;
...
BOOL func_1253(int* piParam0, BOOL bParam1) // Position - 0x2DEB8
{
	piParam0->f_2 = piParam0->f_2 + 1;

	if (bParam1)
		return func_1314(piParam0);

	return true;
}

BOOL func_1254(Hash hParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0x2DED9
{
	var unk;
	int i;
	...
	*uParam3 = 0;
	...
	if (!func_1102(hParam0, hParam1, &unk))
		return false;
...
void func_1255(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x2DF5D
{
	int i;
	int j;
	int k;
...
BOOL func_1256(Hash hParam0, Any* panParam1, int iParam2) // Position - 0x2E133
{
	if (panParam1->f_9 < 1)
		return false;

	if (!func_105(panParam1->f_8, 0) && !func_378(func_377(panParam1->f_8), 2))
		return false;

	if (func_168(iParam2, 128))
		if (!func_378(func_377(panParam1->f_8), 2))
			if (func_228(panParam1->f_8) == 0)
				return false;
...
BOOL func_1257(int iParam0, Hash hParam1, Any* panParam2, Any* panParam3) // Position - 0x2E1B3
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam3, *panParam3);
}

int func_1258(int iParam0) // Position - 0x2E1CC
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_1259(int iParam0) // Position - 0x2E1F1
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_1260(int iParam0) // Position - 0x2E204
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_1261(int iParam0) // Position - 0x2E217
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_1262(int iParam0) // Position - 0x2E22A
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_1263(int iParam0) // Position - 0x2E23C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_1264(int iParam0, int iParam1) // Position - 0x2E24E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_1265(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x2E2E8
{
	func_1315(uParam0, iParam6);
	func_1316(uParam0, iParam5);
	func_1317(uParam0, iParam4);
	func_1318(uParam0, iParam3);
	func_1319(uParam0, iParam2);
	func_1320(uParam0, iParam1);
	return;
}

BOOL func_1266() // Position - 0x2E320
{
	return Global_1913444.f_127 == 0;
}

BOOL func_1267(Hash hParam0, int iParam1) // Position - 0x2E330
{
	int num;
...
BOOL func_1268(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4) // Position - 0x2E34F
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	if (!func_1322(iParam0, hParam1, 1))
		return 0;
	...
	if (STATS::STAT_ID_IS_VALID(&statId))
	{
		if (func_1202(iParam0, hParam1) - iParam2 >= 0)
		{
			STATS::_STAT_ID_DECREMENT_INT(&statId, iParam2);
		}
		else if (func_1202(iParam0, hParam1) - iParam2 < 0)
		{
			func_1268(iParam0, hParam1, func_350(hParam1, false, false, false), bParam3, hParam4);
			return 0;
		}
	}

	if (!func_1323(iParam0, hParam1, iParam2, hParam4, bParam3))
		return 0;

	if (!bParam3 && hParam1 != 1309979101)
		func_347(hParam1, -iParam2, flag, flag2, flag3, false, false);

	return 1;
}

BOOL func_1269(Hash hParam0) // Position - 0x2E429
{
	if (!func_105(hParam0, 0))
		return false;

	return func_312(hParam0, 1686880204) || INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_IS_ANIMAL_PELT(hParam0);
}

int func_1270(int iParam0, int iParam1) // Position - 0x2E457
{
	switch (iParam0)
	{
		case 0:
...
Hash func_1271(Hash hParam0) // Position - 0x2E8A8
{
	if (!func_1126(hParam0))
		return 0;

	return hParam0;
}

int func_1272(Hash hParam0, int iParam1) // Position - 0x2E8C0
{
	switch (hParam0)
	{
...
BOOL func_1273(int iParam0, BOOL bParam1) // Position - 0x2EC28
{
	Player player;
	Player player2;
	int num;
	...
	if (func_1274(player2, bParam1) == 0)
		return false;

	num = iParam0;

	if (num > func_1274(player2, bParam1))
		num = func_1274(player2, bParam1);
	...
	else if (func_1274(player2, bParam1) > func_1275(bParam1))
		if (!bParam1)
			Global_1289643[player2 /*19*/] = func_1275(bParam1);
		else
			Global_1289643[player2 /*19*/].f_1 = func_1275(bParam1);

	return true;
}

int func_1274(Player plParam0, BOOL bParam1) // Position - 0x2ED21
{
	return bParam1 ? Global_1289643[plParam0 /*19*/].f_1 : Global_1289643[plParam0 /*19*/];
}

int func_1275(BOOL bParam0) // Position - 0x2ED41
{
	return bParam0 ? Global_1901671.f_701.f_30 : Global_1901671.f_701.f_29;
}

int func_1276(Hash hParam0) // Position - 0x2ED61
{
	switch (hParam0)
	{
...
BOOL func_1277(Any* panParam0) // Position - 0x2F79D
{
...
void func_1278(Any* panParam0) // Position - 0x2F7D3
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
int func_1279() // Position - 0x2F7E9
{
	return Global_1072759.f_28418[32 /*4*/].f_3;
}

struct<8> func_1280(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6) // Position - 0x2F7FE
{
	var unk;
...
int func_1281(int iParam0, var uParam1) // Position - 0x2F81C
{
	if (iParam0 == 2)
...
BOOL func_1282() // Position - 0x2F836
{
	return !Global_1572887.f_10;
}

int func_1283(int iParam0) // Position - 0x2F845
{
	switch (iParam0)
	{
		case -1932005642:
...
// Unhandled jump detected. Output should be considered invalid
void func_1284(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2F9E6
{
	int i;
	Hash hash;
	Hash hash2;
	...
	for (i = 0; i < 39; i = i + 1)
	{
		if (func_1324(&hParam0->f_1[i /*3*/], 2))
		{
			if (func_1325(i, iParam1))
			{
				hash2 = { func_1326(i, -1) };
...
void func_1285(Hash hParam0, int iParam1, int iParam2) // Position - 0x2FABF
{
	Global_1953292.f_83[func_266(hParam0, 1) /*12*/].f_11 = Global_1953292.f_83[func_266(hParam0, 1) /*12*/].f_11 || iParam1;
	return;
}

BOOL func_1286(Hash hParam0) // Position - 0x2FAEC
{
	int num;
	var unk;
	...
	num = 1226838104;
	func_1162(&(Global_1953292.f_1039), num, -367421157, 1409451727, 1, hParam0);
...
int func_1287(Hash hParam0) // Position - 0x2FB45
{
	var unk;
	int num;
...
void func_1288(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x2FB7F
{
	int i;
	BOOL flag;

	if (func_312(hParam0->f_1[34 /*3*/], -166674229))
		return;
	...
	for (i = 0; i < 39; i = i + 1)
	{
		...
		else
		{
			...
			if (!bParam2 && func_1287(hParam0->f_1[i /*3*/]) != 0)
			{
			}
			else if (func_1325(i, iParam1) && !flag)
			{
				hParam0->f_1[i /*3*/] = Global_1953292.f_83[i /*12*/];
				hParam0->f_1[i /*3*/].f_1 = 0;
				func_793(hParam0, hParam0->f_1[i /*3*/], i, true, iParam3);
				func_791(i, iParam3);
			}
			else if (flag && !bParam2)
			{
				func_793(hParam0, hParam0->f_1[i /*3*/], i, false, iParam3);
			}
		}
	}
...
int func_1289(int iParam0, int iParam1, int iParam2) // Position - 0x2FC8B
{
	int i;
	var unk;
	int num;
	...
	for (i = 0; i < iParam1; i = i + 1)
	{
		if (!func_562(&unk, i, iParam0, iParam1))
		{
		}
		else if (func_1330(unk.f_4) && PED::_GET_SHOP_ITEM_COMPONENT_CATEGORY(unk.f_4, metapedType, true) == 0)
		{
		}
		else if (func_1287(unk.f_4) != 0)
		{
		}
		else if (func_312(unk.f_4, -166674229))
		{
		}
		else if (func_312(unk.f_4, 525391395))
		{
		}
		else
		{
			num = func_228(unk.f_4);
		
			if (func_1332(iParam2, func_1331(num)))
			{
			}
			else
			{
...
void func_1290(Hash hParam0, int iParam1, int iParam2) // Position - 0x2FD58
{
	int num;

	if (func_312(hParam0->f_1[iParam1 /*3*/], 343781202))
	{
		func_994(hParam0, hParam0->f_1[iParam1 /*3*/]);
	}
	else
	{
...
BOOL func_1291(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x2FDEC
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 29, panParam2, 0);
}

BOOL func_1292(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x2FE03
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 26, panParam2, 0);
}

BOOL func_1293(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x2FE1A
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

struct<4> func_1294(int iParam0, Hash hParam1) // Position - 0x2FE31
{
	var unk;

	unk = { func_1333(iParam0) };
	return func_1334(iParam0, hParam1, unk, unk.f_4);
}

BOOL func_1295(Vehicle veParam0) // Position - 0x2FE53
{
...
float func_1296(Player plParam0) // Position - 0x2FE72
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_1335(2);
}

BOOL func_1297(int iParam0) // Position - 0x2FE88
{
	int num;
	int num2;
	int num3;
	...
	num = func_1263(iParam0);

	if (num < 0 || num >= 60)
		return false;

	num2 = func_1262(iParam0);

	if (num2 < 0 || num2 >= 60)
		return false;

	num3 = func_1261(iParam0);

	if (num3 < 0 || num3 > 23)
		return false;

	num4 = func_1258(iParam0);

	if (num4 <= 0 || num4 > 1930 || num4 < 1866)
		return false;

	num5 = func_1259(iParam0);

	if (num5 < 0 || num5 > 11)
		return false;

	num6 = func_1260(iParam0);

	if (num6 < 1 || num6 > func_1264(num5, num4))
		return false;

	return true;
}

int func_1298(int iParam0) // Position - 0x2FF64
{
	switch (iParam0)
	{
		case 0:
...
char* func_1299(int iParam0) // Position - 0x2FF93
{
	switch (iParam0)
	{
		case 0:
...
char* func_1300(int iParam0) // Position - 0x2FFCE
{
	switch (iParam0)
	{
		case 0:
...
void func_1301(int iParam0, float fParam1, int iParam2) // Position - 0x3000A
{
	if (iParam2 == 2)
		iParam2 = func_676(2);
...
void func_1302(int iParam0, int iParam1, int iParam2) // Position - 0x3005C
{
	if (iParam2 == 2)
		iParam2 = func_676(2);
...
BOOL func_1303(int iParam0) // Position - 0x300B2
{
	if (func_1219(iParam0))
		return true;
...
void func_1304(int iParam0, float fParam1, int iParam2) // Position - 0x300D8
{
	if (fParam1 < 0f)
		return;
...
int func_1305(int iParam0, int iParam1) // Position - 0x30134
{
	switch (iParam0)
	{
		case -2101912686:
...
// Unhandled jump detected. Output should be considered invalid
int func_1306(int iParam0) // Position - 0x30935
{
	int num;
	int num2;
	int num3;
	...
	num = func_1305(iParam0, 1);

	if (!func_1338(Global_1156111.f_35859.f_919[num /*12*/]))
		return 1;

	num4 = func_1339(Global_1156111.f_35859.f_919[num /*12*/], 1);

	for (i = 0; i < Global_1156111.f_35859[num4 /*6*/].f_5; i = i + 1)
	{
		num2 = Global_1156111.f_35859[num4 /*6*/][i];
	
		switch (func_1340(iParam0, num2))
		{
			case 0:
				func_1341(num2, iParam0, i);
				break;
			...
			case 1:
				for (j = 0; j < Global_1156111.f_35859.f_11700; j = j + 1)
				{
					...
					{
						func_1341(num2, iParam0, i);
						func_1342(&Global_1156111.f_35859.f_9503[j /*3*/]);
						...
						func_1342(&Global_1156111.f_35859.f_9503[Global_1156111.f_35859.f_11700 /*3*/]);
						break;
					}
				}
				break;
	...
	func_1346(&Global_1156111.f_35859.f_919[num /*12*/]);
	return 1;
}

struct<17> func_1307(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, int iParam6, BOOL bParam7) // Position - 0x30BC5
{
	var unk;
...
int func_1308(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x30C3F
{
	Hash hash;
	var unk;
	var unk13;
	...
	if (!func_103(false) || func_104())
	{
		hash = hParam0;
		unk.f_1 = 10;
		func_1348(iParam1, func_1347(hParam2), &unk, true);
		func_1349(hash, &unk, 0, 0);
		func_299(501, false);
		return 0;
	}

	unk13 = 15;
	PED::_0xB29C553BA582D09E(&unk13, hParam0, iParam1, func_1347(hParam2));

	for (i = 0; i < 15; i = i + 1)
	{
		if (func_105(unk13[i], 0) && !func_312(unk13[i], 1286414894) && !(unk13[i] == hParam2))
		{
			func_437(unk13[i], 1, false, false, false, 752097756, 0, 0, 0, false);
	...
	func_352(func_103(false), false, 0);
	return num;
}

int func_1309(Hash hParam0, Any* panParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5) // Position - 0x30D3D
{
	var unk;
	var unk15;
	int num;
	...
	if (!func_375(*panParam1, &unk, true, false, -1))
		return -1;
	...
	unk15 = { func_1199(&unk, false) };
	unk15.f_9 = iParam2;
	unk15.f_12 = iParam3;
	num = -1;
	num = func_385(joaat("use"), &unk15, bParam5);
...
BOOL func_1310(Hash hParam0, int iParam1) // Position - 0x30E06
{
	int i;
	int num;
	int num2;
...
int func_1311(Hash hParam0) // Position - 0x30E5A
{
	int num;
...
void func_1312(var uParam0) // Position - 0x30E89
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_1313(int* piParam0, Hash hParam1) // Position - 0x30EE5
{
...
BOOL func_1314(int* piParam0) // Position - 0x30F03
{
	Hash action;

	if (!NETSHOPPING::_CASHINVENTORY_TRANSACTION_GET_BASKET_IS_VALID(*piParam0))
	{
		func_891(*piParam0, 0, 0, 0);
		return true;
	}
	...
	if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_GET_NUM_OF_ITEMS(*piParam0) == 0)
	{
		...
		func_891(*piParam0, 4, 0, 0);
		return true;
	}

	if (!NETSHOPPING::_CASHINVENTORY_TRANSACTION_CHECKOUT(*piParam0))
	{
		func_891(*piParam0, 2, 0, 0);
		return false;
	}

	func_891(*piParam0, 1, 0, 0);
	action = NETSHOPPING::_CASHINVENTORY_TRANSACTION_GET_ACTION(*piParam0);
...
void func_1315(var uParam0, int iParam1) // Position - 0x30FA0
{
	if (iParam1 < 0)
		return;
...
void func_1316(var uParam0, int iParam1) // Position - 0x31026
{
...
void func_1317(var uParam0, int iParam1) // Position - 0x31062
{
	int num;
	int num2;

	num = func_1259(*uParam0);
	num2 = func_1258(*uParam0);

	if (iParam1 < 1 || iParam1 > func_1264(num, num2))
		return;
...
void func_1318(var uParam0, int iParam1) // Position - 0x310B5
{
...
void func_1319(var uParam0, int iParam1) // Position - 0x310F0
{
...
void func_1320(var uParam0, int iParam1) // Position - 0x31129
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
int func_1321(Hash hParam0) // Position - 0x31161
{
	int num;
...
BOOL func_1322(int iParam0, Hash hParam1, int iParam2) // Position - 0x3117B
{
	if (!func_105(hParam1, 0))
		return false;

	return func_1202(iParam0, hParam1) >= iParam2;
}

BOOL func_1323(int iParam0, Hash hParam1, int iParam2, Hash hParam3, BOOL bParam4) // Position - 0x3119D
{
	var unk;
	var unk6;
	...
	unk = { func_1333(iParam0) };
	unk6 = { func_1334(iParam0, hParam1, unk, unk.f_4) };
	return func_1350(iParam0, hParam1, &unk6, iParam2, hParam3, bParam4);
}

BOOL func_1324(var uParam0, int iParam1) // Position - 0x311EC
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_1325(int iParam0, int iParam1) // Position - 0x311FD
{
...
Vector3 func_1326(int iParam0, int iParam1) // Position - 0x3122C
{
	if (iParam1 == -1)
		iParam1 = Global_17418.f_55.f_664.f_1777;
...
BOOL func_1327(int iParam0, int iParam1) // Position - 0x3125F
{
	return Global_1953292.f_83[iParam0 /*12*/].f_11 && iParam1 != false;
}

void func_1328(int iParam0, int iParam1, int iParam2) // Position - 0x31278
{
	Global_1953292.f_83[iParam0 /*12*/].f_11 = Global_1953292.f_83[iParam0 /*12*/].f_11 - Global_1953292.f_83[iParam0 /*12*/].f_11 && iParam1;
	return;
}

void func_1329(int iParam0, int iParam1, int iParam2) // Position - 0x312A8
{
	Global_1953292.f_83[iParam0 /*12*/].f_11 = Global_1953292.f_83[iParam0 /*12*/].f_11 || iParam1;
	return;
}

BOOL func_1330(Hash hParam0) // Position - 0x312CB
{
	return hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != -230310728 && hParam0 != 1326838792 && !func_812(hParam0);
}

int func_1331(int iParam0) // Position - 0x31301
{
	switch (iParam0)
	{
		case -1740828670:
...
BOOL func_1332(int iParam0, int iParam1) // Position - 0x31346
{
	return iParam0 && iParam1 != false;
}

struct<5> func_1333(int iParam0) // Position - 0x31355
{
	var unk;

	unk = { func_1334(iParam0, joaat("character"), func_616(), -1591664384) };
	unk.f_4 = 1084182731;
	return unk;
}

struct<4> func_1334(int iParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6) // Position - 0x31382
{
	var outGuid;
...
int func_1335(int iParam0) // Position - 0x313AF
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_1336(int iParam0) // Position - 0x313F0
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_1337(int iParam0) // Position - 0x31415
{
	int num;
...
BOOL func_1338(int iParam0) // Position - 0x3143D
{
	int num;

	num = func_1339(iParam0, 1);
...
int func_1339(int iParam0, int iParam1) // Position - 0x31465
{
	switch (iParam0)
	{
...
int func_1340(int iParam0, int iParam1) // Position - 0x31B1C
{
	Player player;
	Player player2;
	int num;

	player = func_1351(iParam0);
	player2 = Global_1295666;
	num = func_1343(iParam1, 1);
...
int func_1341(int iParam0, int iParam1, int iParam2) // Position - 0x31B9F
{
	int num;
	int num2;
	...
	num = func_1343(iParam0, 1);
	func_1353(iParam0, iParam1, iParam2);

	if (func_1354(Global_1156111.f_35859.f_3116[num /*31*/]) && func_1355(iParam0, Global_1156111.f_35859.f_3116[num /*31*/].f_4))
	{
		num2 = { func_1356(Global_1156111.f_35859.f_3116[num /*31*/].f_4) };
	
		if (func_1357(num2))
			if (func_1358(num2, num2.f_1, num2.f_2))
				func_1359(Global_1156111.f_35859.f_3116[num /*31*/].f_4, num2, num2.f_1, num2.f_2);
			else
				func_1360(Global_1156111.f_35859.f_3116[num /*31*/].f_4);
		else
			func_1360(Global_1156111.f_35859.f_3116[num /*31*/].f_4);
	}
...
void func_1342(int iParam0) // Position - 0x31C97
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_1343(int iParam0, int iParam1) // Position - 0x31CAD
{
	switch (iParam0)
	{
...
void func_1344(int iParam0, int iParam1) // Position - 0x3255E
{
	Global_1156111.f_35859.f_3116[iParam0 /*31*/].f_29 = Global_1156111.f_35859.f_3116[iParam0 /*31*/].f_29 + iParam1;
	return;
}

void func_1345(int iParam0, int iParam1) // Position - 0x3258D
{
	Global_1156111.f_35859.f_3116[iParam0 /*31*/].f_29 = iParam1;
	return;
}

void func_1346(int iParam0) // Position - 0x325A9
{
	int i;
...
int func_1347(Hash hParam0) // Position - 0x325D7
{
	if (func_312(hParam0, 1064293907))
		return 2;
	else if (func_312(hParam0, -1218707194))
...
struct<12> func_1348(int iParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x3261C
{
	int num;
	...
	if (bParam3)
		func_684(uParam2, joaat("LOOT_TYPE_BREAKDOWN"));
	else
		func_684(uParam2, joaat("LOOT_TYPE_SKINNING"));

	func_684(uParam2, num);
	return *uParam2;
}

BOOL func_1349(Hash hParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3277D
{
	var unk;
	...
	return func_685(hParam0, uParam1, &unk, iParam2, iParam3);
}

BOOL func_1350(int iParam0, Hash hParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x3279D
{
	var unk;
	...
	if (!func_1361(iParam0, *panParam2, &unk, false))
		return 0;
...
Player func_1351(int iParam0) // Position - 0x32815
{
...
BOOL func_1352(int iParam0) // Position - 0x32836
{
	int num;
...
int func_1353(int iParam0, int iParam1, int iParam2) // Position - 0x3285E
{
	int num;
	int num2;
	int num3;
	...
	num = func_1305(iParam1, 1);
	num2 = func_1343(iParam0, 1);
	num3 = func_1339(Global_1156111.f_35859.f_919[num /*12*/], 1);
	...
	for (i = 0; i < Global_1156111.f_35859.f_3116[num2 /*31*/].f_16; i = i + 1)
	{
		...
		else
		{
			...
			Global_1156111.f_2169[num5 /*205*/].f_201 = Global_1156111.f_2169[num5 /*205*/].f_201 - func_1366(&Global_1156111.f_35859.f_3116[num2 /*31*/].f_6[i /*3*/]);
			func_1367(num4);
		}
	}
...
BOOL func_1354(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x32A4F
{
	return uParam0.f_4 != 0;
}

BOOL func_1355(int iParam0, int iParam1) // Position - 0x32A5D
{
	int num;
	...
	num = func_1372(iParam1, 1);
	return Global_1156111.f_35859.f_9286[num /*3*/] == iParam0;
}

Vector3 func_1356(int iParam0) // Position - 0x32A9D
{
	int num;
	var unk;

	num = func_1373(iParam0);
...
BOOL func_1357(int iParam0, var uParam1, var uParam2) // Position - 0x32AD9
{
	if (!func_1352(iParam0))
		return false;

	if (!func_1337(iParam0.f_1))
		return false;

	if (!func_1374(iParam0.f_2))
		return false;

	return true;
}

BOOL func_1358(int iParam0, int iParam1, int iParam2) // Position - 0x32B10
{
	int num;
	int num2;
	int num3;
	...
	for (j = 0; j < Global_1156111.f_35859.f_3116[num2 /*31*/].f_28; j = j + 1)
	{
		...
		else if (!func_1376(&Global_1156111.f_35859.f_3116[num2 /*31*/].f_17[j /*2*/]))
		{
		}
		else
		{
	...
	func_1378(Global_1156111.f_35859.f_3116[num2 /*31*/].f_2);
	return true;
}

void func_1359(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x32D3E
{
	int num;
...
void func_1360(int iParam0) // Position - 0x32DBD
{
	int num;
...
BOOL func_1361(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, Any* panParam5, BOOL bParam6) // Position - 0x32E12
{
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&uParam1))
		return false;
...
BOOL func_1362(int iParam0) // Position - 0x32E3E
{
	int num;
...
int func_1363(int iParam0) // Position - 0x32E65
{
	int num;
...
int func_1364(int iParam0, int iParam1) // Position - 0x32EFF
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_1365(int iParam0) // Position - 0x33338
{
	int num;

	num = func_1364(iParam0, 1);
...
float func_1366(int iParam0) // Position - 0x33360
{
	float num;

	if (iParam0->f_2 != 0)
	{
		num = func_1385(794259616, iParam0->f_2, iParam0->f_1, "");
		return num;
	}
...
void func_1367(int iParam0) // Position - 0x33390
{
	int num;
	int num2;
	int i;
	...
	if (!func_1386(Global_1156111.f_2169[num /*205*/]))
		return;
	...
	if (!func_1387(Global_1156111.f_2169[num /*205*/].f_203))
		return;

	num2 = func_1388(Global_1156111.f_2169[num /*205*/].f_203, 1);
...
BOOL func_1368(int iParam0) // Position - 0x3356F
{
	int num;

	num = func_1369(iParam0, 1);
...
int func_1369(int iParam0, int iParam1) // Position - 0x33597
{
	switch (iParam0)
	{
...
void func_1370(int iParam0) // Position - 0x338A7
{
	Ped ped;
	Player player;
...
BOOL func_1371(int iParam0) // Position - 0x33AB7
{
	int num;
...
int func_1372(int iParam0, int iParam1) // Position - 0x33ADE
{
	switch (iParam0)
	{
...
int func_1373(int iParam0) // Position - 0x33B3B
{
	int num;
	var unk;
	var unk32;
	...
	{
		num3 = func_1343(Global_1156111.f_35859.f_9503[i /*3*/], 1);
		...
		else if (!func_1396(Global_1156111.f_35859.f_9503[i /*3*/], Global_1156111.f_35859.f_9503[i /*3*/].f_1))
		{
		}
		else
		{
			unk = { func_1397(Global_1156111.f_35859.f_9503[i /*3*/]) };
...
BOOL func_1374(int iParam0) // Position - 0x33C7F
{
...
void func_1375(int iParam0) // Position - 0x33C9D
{
	int num;
	int num2;
	int i;
...
BOOL func_1376(int iParam0) // Position - 0x33DF2
{
	BOOL flag;

	if (iParam0->f_1 != 0)
	{
		flag = func_1398(794259616, iParam0->f_1, true, "");
		return flag;
	}
...
void func_1377(int iParam0) // Position - 0x33E1C
{
	Ped EntityIndex;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
			num = func_1392(iParam0);
			func_1400(num, 3, 1, -1, 1);
			break;
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_1392(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_1399(iParam0, 0));
			func_1400(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_1399(iParam0, 1));
			func_1400(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_1399(iParam0, 2));
			func_1400(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_1399(iParam0, 3));
			func_1400(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_1378(int iParam0) // Position - 0x340BB
{
	char* StringToTest;
	char* StringToTest2;
	...
	StringToTest = func_1402(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	StringToTest2 = func_1403(iParam0);
...
BOOL func_1379(int iParam0) // Position - 0x34105
{
	int num;
...
BOOL func_1380(int iParam0) // Position - 0x3412D
{
	int num;
...
BOOL func_1381(int iParam0) // Position - 0x34155
{
	int num;
...
BOOL func_1382(int iParam0) // Position - 0x3417D
{
	int num;
...
BOOL func_1383(int iParam0) // Position - 0x341A5
{
	int num;
...
BOOL func_1384(int iParam0) // Position - 0x341CD
{
	int num;
...
float func_1385(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x341F5
{
	var unk;
	float num;

	if (func_1404(hParam0, hParam1, &unk))
...
BOOL func_1386(int iParam0) // Position - 0x3422B
{
...
BOOL func_1387(int iParam0) // Position - 0x3429A
{
	int num;

	num = func_1388(iParam0, 1);
...
int func_1388(int iParam0, int iParam1) // Position - 0x342C1
{
	switch (iParam0)
	{
...
void func_1389() // Position - 0x3431E
{
	BOOL bTrue;
	BOOL bTrue2;
	...
	if (Global_1156111.f_21645[4 /*209*/].f_208)
		if (!func_279(Global_1297600[Global_1295666 /*87*/].f_86, 1))
			bTrue2 = true;
...
void func_1390() // Position - 0x34380
{
	BOOL bTrue;
...
char* func_1391(int iParam0) // Position - 0x343B0
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_1392(int iParam0) // Position - 0x343F8
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_1393(int iParam0) // Position - 0x34433
{
	int i;
...
void func_1394() // Position - 0x34473
{
...
int func_1395(int iParam0) // Position - 0x34493
{
	int num;
...
BOOL func_1396(int iParam0, int iParam1) // Position - 0x344C2
{
	int num;
	Player player;
	int num2;
	...
	if (func_1354(Global_1156111.f_35859.f_3116[num /*31*/]))
	{
		num3 = Global_1156111.f_35859.f_9286[func_1372(num2, 1) /*3*/];
		unk = { func_1397(num3) };
	...
	switch (Global_1156111.f_35859.f_3116[num /*31*/])
	{
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (player != Global_1295666 && !func_410(Global_1295666.f_149[player]))
				return false;
		
			if (!func_1023(512, player))
				return false;
...
struct<31> func_1397(int iParam0) // Position - 0x34797
{
	int num;
...
BOOL func_1398(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0x347BB
{
	var unk;
	BOOL flag;
...
char* func_1399(int iParam0, int iParam1) // Position - 0x347F1
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_1400(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x3484A
{
	int i;
...
void func_1401() // Position - 0x348CF
{
...
char* func_1402(int iParam0) // Position - 0x348F4
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_1403(int iParam0) // Position - 0x34915
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_1404(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x34936
{
	int num;
	int num2;
	...
	if (DATAFILE::_PARSEDDATA_GET_SECTION(&num2, &num, joaat("name")))
	{
		*uParam2 = hParam0;
		...
		uParam2->f_10.f_3 = func_1407(num2);
...
BOOL func_1405() // Position - 0x34B58
{
	return Global_1572887.f_7;
}

BOOL func_1406() // Position - 0x34B66
{
	if (!Global_1048577)
		return false;
...
int func_1407(int iParam0) // Position - 0x34BB1
{
	int num;
