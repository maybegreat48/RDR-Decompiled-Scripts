...
int func_4() // Position - 0xA08
{
	return Global_1572887.f_14;
}

BOOL func_5(BOOL bParam0, BOOL bParam1) // Position - 0xA16
{
	int i;
...
void func_6() // Position - 0xAF6
{
	FLOCK::_0xFB16F08F47B83B4C(joaat("SPECIES_BIRD_CROW"));
	return;
}

void func_7(Volume volParam0) // Position - 0xB07
{
...
BOOL func_8() // Position - 0xB48
{
	return false;
}

void func_9(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xB51
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_10(Volume volParam0) // Position - 0xBC4
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0) // Position - 0xC0B
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xC4C
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_13(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xCCB
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_14(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0xD41
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_15(var uParam0, int iParam1) // Position - 0xDB7
{
