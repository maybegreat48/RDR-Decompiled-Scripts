...
Hash func_2(Ped pedParam0, int iParam1) // Position - 0x23A
{
...
BOOL func_3(BOOL bParam0) // Position - 0x251
{
	if (bParam0)
...
int func_5() // Position - 0x2A4
{
	return Global_1940252.f_11642;
}

BOOL func_6() // Position - 0x2B3
{
...
void func_8(int iParam0) // Position - 0x2D2
{
...
BOOL func_9(int iParam0) // Position - 0x2F3
{
	return !func_16(iParam0);
}

BOOL func_10(int iParam0) // Position - 0x302
{
	return Global_1940252.f_11561 && iParam0 != false;
}

void func_11() // Position - 0x316
{
...
void func_12(BOOL bParam0, int iParam1) // Position - 0x397
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
void func_13(int iParam0) // Position - 0x3B9
{
	Global_1940252.f_11561 = Global_1940252.f_11561 - Global_1940252.f_11561 && iParam0;
	return;
}

BOOL func_14(BOOL bParam0, BOOL bParam1) // Position - 0x3DA
{
	int i;
...
void func_15() // Position - 0x4BA
{
	Global_1940252.f_11643 = 1;
	return;
}

BOOL func_16(int iParam0) // Position - 0x4CA
{
	return func_17(1, iParam0);
}

BOOL func_17(int iParam0, int iParam1) // Position - 0x4D9
{
	int num;
...
BOOL func_18(Any* panParam0, int iParam1, int iParam2) // Position - 0x54D
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_19() // Position - 0x584
{
