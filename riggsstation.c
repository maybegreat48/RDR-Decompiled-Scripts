...
void _DEBUG_PRINT(int iParam0) // Position - 0x89C
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x8A8
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x8B5
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x8C1
{
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x8CA
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x8D6
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x8EB
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x8FC
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x93B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x947
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x94F
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0x9FF
{
	return;
}

void func_26() // Position - 0xA07
{
	return;
}

void func_27() // Position - 0xA0F
{
	return;
}

void func_28() // Position - 0xA17
{
	return;
}

void func_29(int iParam0) // Position - 0xA1F
{
...
void func_30(int iParam0) // Position - 0xA54
{
	func_61(795, volLocal_19, true);
	return;
}

void func_31() // Position - 0xA67
{
	return;
}

void func_32() // Position - 0xA6F
{
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0xA77
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xA83
{
...
void func_35(var uParam0) // Position - 0xAB4
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xAFA
{
	func_62(uParam1, volLocal_19, 10);
	return;
}

void func_37(int iParam0) // Position - 0xB0C
{
	if (!func_63(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xB25
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xB36
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xB4E
{
	func_65(28, volLocal_19, &uLocal_22);
	return true;
}

void func_41(var uParam0, int iParam1) // Position - 0xB61
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xCA0
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xCAD
{
...
BOOL func_44(int iParam0) // Position - 0xCE3
{
	if (iParam0 == 0)
	{
		func_78();
...
int func_45() // Position - 0xDF7
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xE05
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xE11
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xE7E
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xF5E
{
	if (!func_63(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xF7C
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xF8F
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xFAD
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x10A5
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x10B6
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x10CA
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x10DE
{
	return uParam0;
}

void func_58(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x10E8
{
...
void func_59(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1297
{
	int num;
...
int func_60(int iParam0, BOOL bParam1) // Position - 0x133B
{
	int num;
	Hash hash;
	float num2;
...
int func_61(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x1462
{
	PersChar persChar;
...
void func_62(var uParam0, Volume volParam1, int iParam2) // Position - 0x14B0
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_63(int iParam0) // Position - 0x1509
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_64() // Position - 0x151F
{
	int i;
...
void func_65(int iParam0, Volume volParam1, var uParam2) // Position - 0x154C
{
	if (!*uParam2)
	{
...
BOOL func_66(int iParam0, int iParam1) // Position - 0x158E
{
	return iParam0 && iParam1 != false;
}

BOOL func_67(var uParam0, int iParam1) // Position - 0x159D
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_68() // Position - 0x15AE
{
	return func_66(Global_1940199, 8192);
}

BOOL func_69(var uParam0, int iParam1) // Position - 0x15C1
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_70(int iParam0) // Position - 0x15D2
{
	if (!func_63(iParam0))
		return false;
...
BOOL func_71(int iParam0, int iParam1) // Position - 0x1612
{
...
int func_72() // Position - 0x163F
{
	return Global_1896646.f_41;
}

void func_73(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x164D
{
	BOOL flag;
	...
	StringToTest = func_124(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_136(&unk, joaat("COLOR_PURE_WHITE")), str3, func_136(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_136(&unk, joaat("COLOR_PURE_WHITE")), func_136(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_137(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_74(var uParam0, int iParam1) // Position - 0x18B3
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_75(int iParam0, BOOL bParam1) // Position - 0x18C6
{
...
void func_76(BOOL bParam0) // Position - 0x1F2F
{
	if (bParam0)
...
BOOL func_77(int iParam0) // Position - 0x1F58
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_78() // Position - 0x1F9D
{
	return;
}

Hash func_79(int iParam0, BOOL bParam1) // Position - 0x1FA5
{
	switch (iParam0)
	{
		case 0:
...
void func_80(int iParam0, BOOL bParam1) // Position - 0x276A
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_81(BOOL bParam0) // Position - 0x27BD
{
	if (bParam0)
...
void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x27E6
{
	iParam0 = iParam0;
	return;
}

void func_83(int iParam0) // Position - 0x27F2
{
	int i;
...
void func_84(int iParam0) // Position - 0x2823
{
	int i;
...
BOOL func_85(int iParam0, BOOL bParam1) // Position - 0x2856
{
	int num;
	int num2;
	int num3;
...
BOOL func_86(int iParam0) // Position - 0x290C
{
	int i;
...
BOOL func_87(int iParam0, BOOL bParam1) // Position - 0x2986
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_88(int iParam0) // Position - 0x29B7
{
	if (!func_63(iParam0))
		return false;
...
BOOL func_89(int iParam0) // Position - 0x29D8
{
	if (!func_63(iParam0))
		return false;
...
BOOL func_90(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2A2B
{
	BOOL flag;
...
BOOL func_91(int iParam0) // Position - 0x30EB
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_92(int iParam0) // Position - 0x3102
{
	switch (iParam0)
	{
		case 64:
...
int func_93(int iParam0, BOOL bParam1) // Position - 0x3145
{
	if (!func_91(iParam0))
		return 0;
...
BOOL func_95() // Position - 0x3244
{
	return func_153(func_56(0));
}

BOOL func_96(int iParam0) // Position - 0x3255
{
	return !func_154(iParam0);
}

void func_97(BOOL bParam0, BOOL bParam1) // Position - 0x3264
{
	if (func_155(255) == 4)
		return;
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x33AF
{
	BOOL flag;
...
int func_99(int iParam0, int iParam1) // Position - 0x375E
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_100(int iParam0) // Position - 0x40C5
{
	if (!func_171(iParam0))
		return 0;
...
void func_102(int iParam0, int iParam1) // Position - 0x41A3
{
...
void func_103(int iParam0) // Position - 0x41D2
{
...
int func_104(int iParam0) // Position - 0x420B
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

Hash func_105(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x421F
{
...
BOOL func_106(Hash hParam0) // Position - 0x42C3
{
	if (func_173(hParam0))
...
BOOL func_107(Hash hParam0) // Position - 0x42DE
{
...
void func_108(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4307
{
	func_105(hParam0, false, false);
...
BOOL func_109(int iParam0, int iParam1) // Position - 0x4392
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x43AB
{
...
int func_111() // Position - 0x43D5
{
	return Global_1893611.f_2;
}

BOOL func_112(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x43E3
{
	return func_179(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_113(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4403
{
	return func_179(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_114(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x4423
{
	if (bParam6)
...
BOOL func_115(int iParam0, BOOL bParam1) // Position - 0x449F
{
	if (func_45() != -1)
		return false;
...
PersChar func_116(int iParam0) // Position - 0x44F7
{
	if (!func_91(iParam0))
		return 0;
...
BOOL func_117(int iParam0) // Position - 0x4517
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_118(int iParam0) // Position - 0x452D
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_119(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x4543
{
...
struct<2> func_120(int iParam0) // Position - 0x4579
{
	int num;
...
void func_121(var uParam0, var uParam1, int iParam2) // Position - 0x4594
{
...
BOOL func_122(int iParam0) // Position - 0x45B1
{
...
const char* func_124(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x4629
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_186(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_188(func_187(Global_34));
...
BOOL func_125(int iParam0) // Position - 0x508F
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_126(int iParam0) // Position - 0x50A4
{
	switch (iParam0)
	{
		case 0:
...
int func_127(int iParam0) // Position - 0x515F
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_128(int iParam0) // Position - 0x51CD
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_129(int iParam0) // Position - 0x5328
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_130(int iParam0, BOOL bParam1) // Position - 0x5363
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_131(int iParam0, int iParam1) // Position - 0x53A5
{
	if (!func_125(iParam0))
		return false;
...
int func_132() // Position - 0x53EA
{
	return Global_1902569;
}

int func_133(int iParam0) // Position - 0x53F6
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_134(int iParam0) // Position - 0x5409
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_135(float fParam0) // Position - 0x541B
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_136(var uParam0, int iParam1) // Position - 0x5431
{
...
int func_137(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x5467
{
	int duration;
	var data;
	int num;
...
BOOL func_138(int iParam0) // Position - 0x54AA
{
	if (func_189(iParam0))
		if (!func_190(44))
			return false;
...
void func_139(int iParam0, int iParam1) // Position - 0x54CA
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_140(int iParam0, int iParam1) // Position - 0x54DB
{
	int num;
...
void func_141(int iParam0) // Position - 0x54F1
{
...
void func_142(int iParam0) // Position - 0x55D1
{
	int i;
	int num;
...
BOOL func_143(int iParam0, BOOL bParam1) // Position - 0x57A9
{
	if (func_45() != -1)
		return false;
...
int func_144(int iParam0, BOOL bParam1) // Position - 0x57D7
{
	if (!func_91(iParam0))
		return 0;
...
int func_145(int iParam0) // Position - 0x585A
{
	switch (iParam0)
	{
		case 27:
...
int func_146(int iParam0) // Position - 0x5881
{
	switch (iParam0)
	{
		case 33:
...
Hash func_149(int iParam0) // Position - 0x5AE4
{
	if (!func_91(iParam0))
		return 0;
...
void func_150(int iParam0, PersChar pchParam1) // Position - 0x5B02
{
	if (!func_91(iParam0))
		return;
...
void func_151(int iParam0, BOOL bParam1) // Position - 0x5B23
{
	if (func_45() != -1)
		return;
...
BOOL func_152(int iParam0) // Position - 0x5B5C
{
	if (!func_91(iParam0))
		return false;
...
BOOL func_153(var uParam0, var uParam1) // Position - 0x5B82
{
	return func_206(uParam0, 5, 8);
}

BOOL func_154(int iParam0) // Position - 0x5B95
{
	return func_207(1, iParam0);
}

int func_155(int iParam0) // Position - 0x5BA4
{
	if (iParam0 == 255)
...
int func_156(int iParam0) // Position - 0x5BEF
{
...
void func_157(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x5C0C
{
	func_209(iParam0);
...
int func_158(int iParam0) // Position - 0x5C6E
{
...
void func_159(var uParam0) // Position - 0x5C8B
{
	var unk;
...
void func_160(float* pfParam0) // Position - 0x5C9D
{
	var unk;
...
void func_162(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x5D05
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_163(int iParam0) // Position - 0x5D32
{
...
BOOL func_164(int iParam0, int iParam1) // Position - 0x5D8F
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_165(int iParam0, int iParam1) // Position - 0x5DA8
{
	func_164(iParam0, iParam1);
...
void func_166(Hash hParam0) // Position - 0x5DE3
{
...
void func_167(int iParam0) // Position - 0x5E03
{
	return;
}

void func_168(int iParam0) // Position - 0x5E0B
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_169(int iParam0, int iParam1) // Position - 0x5E20
{
	if (iParam0 == -1)
		return false;
...
void func_170(int iParam0) // Position - 0x5E47
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_171(int iParam0) // Position - 0x5EC6
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_172(int iParam0) // Position - 0x5EDC
{
	var unk;
...
BOOL func_173(Hash hParam0) // Position - 0x5F0D
{
	return hParam0 != 0;
}

void func_174(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5F19
{
	if (func_106(hParam0))
	{
...
void func_175(Hash hParam0, BOOL bParam1) // Position - 0x5F51
{
	if (func_106(hParam0))
...
void func_176(Hash hParam0, BOOL bParam1) // Position - 0x5F7F
{
	if (func_106(hParam0))
...
void func_177(Hash hParam0, BOOL bParam1) // Position - 0x5FAD
{
	if (func_106(hParam0))
...
BOOL func_178() // Position - 0x5FDB
{
	return true;
}

BOOL func_179(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x5FE4
{
	int num;
...
int func_180(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x606C
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

Ped func_181(int iParam0) // Position - 0x6086
{
	PersChar persChar;
...
int func_182(int iParam0) // Position - 0x60B4
{
	int num;
...
BOOL func_183() // Position - 0x60CC
{
	return false;
}

BOOL func_184() // Position - 0x60D5
{
	var unk;
	var unk3;
...
BOOL func_185(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x613D
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_186(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x62B3
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_187(var uParam0, var uParam1, var uParam2) // Position - 0x62C7
{
	int i;
...
const char* func_188(int iParam0) // Position - 0x62F5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_189(int iParam0) // Position - 0x65D9
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_190(int iParam0) // Position - 0x6603
{
	if (!func_226(iParam0))
		return false;
...
struct<2> func_191(Player plParam0) // Position - 0x661F
{
	var gamerHandle;
...
const char* func_192(const char* sParam0, int iParam1) // Position - 0x6633
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_193(int iParam0, BOOL bParam1) // Position - 0x664D
{
	char* StringToTest;
...
void func_194(int iParam0, BOOL bParam1) // Position - 0x6681
{
	switch (iParam0)
	{
		case 5:
...
void func_195(int iParam0, int iParam1) // Position - 0x66B6
{
	func_228(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_196(int iParam0) // Position - 0x66D0
{
	if (!func_91(iParam0))
		return false;
...
void func_197(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x66F5
{
	PersChar persChar;
...
void func_198(int iParam0, BOOL bParam1) // Position - 0x67E1
{
	if (!func_171(iParam0))
		return;
...
void func_199(int iParam0, int iParam1) // Position - 0x6837
{
	if (!func_235(iParam0))
		return;
...
int func_200(int iParam0) // Position - 0x68AA
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_201(int iParam0) // Position - 0x68C0
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_202(int iParam0, BOOL bParam1) // Position - 0x68D6
{
	if (func_45() != -1)
		return;
...
void func_203(int iParam0) // Position - 0x6907
{
	Ped EntityIndex;
...
void func_204(int iParam0) // Position - 0x694B
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_205(int iParam0) // Position - 0x6960
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_206(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x6975
{
	int num;
...
BOOL func_207(int iParam0, int iParam1) // Position - 0x69B0
{
	int num;
...
BOOL func_208(Any* panParam0, int iParam1, int iParam2) // Position - 0x6A24
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_214(BOOL bParam0) // Position - 0x6AF3
{
	if (func_239(bParam0))
		return;
...
BOOL func_215(Any* panParam0, int iParam1, int iParam2) // Position - 0x6B1A
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_216() // Position - 0x6B4D
{
	return 1;
}

BOOL func_217(BOOL bParam0, BOOL bParam1) // Position - 0x6B56
{
	return bParam0 && bParam1 != false;
}

int func_218(int iParam0) // Position - 0x6B65
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_219(int iParam0, int iParam1, var uParam2) // Position - 0x754D
{
	var unk;
...
int func_220() // Position - 0x7574
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_221() // Position - 0x7589
{
	if (Global_1048576)
		return true;
...
struct<2> func_222() // Position - 0x75E1
{
	return Global_1051268;
}

BOOL func_223(var uParam0, var uParam1) // Position - 0x75EF
{
	if (!func_242(uParam0))
		return false;
...
struct<2> func_224() // Position - 0x7623
{
...
BOOL func_225(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x766E
{
	var unk;
	float num;
	float num2;
...
BOOL func_226(int iParam0) // Position - 0x769E
{
	if (iParam0 == 0)
		return false;
...
BOOL func_227(int iParam0) // Position - 0x76B1
{
	int num;
	int num2;
	int offset;
...
void func_228(BOOL bParam0, int iParam1) // Position - 0x76DB
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_229(int iParam0) // Position - 0x76F0
{
	if (!func_91(iParam0))
		return false;
...
BOOL func_230(Hash hParam0) // Position - 0x7714
{
	return hParam0 != 0;
}

BOOL func_231(int iParam0, BOOL bParam1) // Position - 0x7720
{
	if (!func_171(iParam0))
		return false;
...
void func_232(int iParam0, BOOL bParam1) // Position - 0x7746
{
	if (!func_171(iParam0))
		return;
...
void func_233(int iParam0, BOOL bParam1) // Position - 0x7774
{
	if (!func_171(iParam0))
		return;
...
void func_234(int iParam0) // Position - 0x77AE
{
	func_247(func_246(iParam0));
	return;
}

BOOL func_235(int iParam0) // Position - 0x77C0
{
	return iParam0 > -1 && iParam0 < 40;
}

int func_236(int iParam0, var uParam1) // Position - 0x77D6
{
	if (iParam0 == 2)
...
BOOL func_237(Any* panParam0, int iParam1, int iParam2) // Position - 0x77F0
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_238() // Position - 0x7827
{
	return Global_1102813.f_3672;
}

BOOL func_239(BOOL bParam0) // Position - 0x7836
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_240(int iParam0, int iParam1, Any* panParam2) // Position - 0x784C
{
...
void func_241(Any* panParam0, int iParam1, var uParam2) // Position - 0x7880
{
	var unk;
...
BOOL func_242(int iParam0) // Position - 0x78FA
{
	switch (iParam0)
	{
		case 2:
...
int func_243(int iParam0) // Position - 0x7939
{
	switch (iParam0)
	{
		case 2:
...
void func_244(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x79CF
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_245(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x846D
{
	float num;
	float num2;
	float num3;
...
int func_246(int iParam0) // Position - 0x84D3
{
...
void func_247(int iParam0) // Position - 0x89F0
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_248(var uParam0, var uParam1) // Position - 0x8A01
{
	var unk;
...
int func_249(int iParam0) // Position - 0x8A2D
{
	int num;
...
BOOL func_250(int iParam0, var uParam1, Any* panParam2) // Position - 0x8BA2
{
	if (!func_223(iParam0))
		return false;
...
void func_251(Any* panParam0) // Position - 0x8CAD
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
