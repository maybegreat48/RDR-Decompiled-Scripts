...
void _DEBUG_PRINT(int iParam0) // Position - 0x927
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x933
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x940
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x94C
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x959
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x965
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x97A
{
	return func_54(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x98B
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x9CA
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x9D6
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x9DE
{
	if (func_55(iParam0))
		return true;
...
void func_25() // Position - 0xA8E
{
	return;
}

void func_26() // Position - 0xA96
{
	return;
}

void func_27() // Position - 0xA9E
{
	return;
}

void func_28() // Position - 0xAA6
{
	return;
}

void func_29(int iParam0) // Position - 0xAAE
{
	if (func_45() == -1)
	{
...
void func_30(int iParam0) // Position - 0xBDB
{
...
void func_31() // Position - 0xC2F
{
	return;
}

void func_32() // Position - 0xC37
{
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0xC3F
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xC4B
{
...
void func_35(var uParam0) // Position - 0xC7C
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xCC2
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xCD6
{
	if (!func_69(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xCEF
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xD00
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xD18
{
...
void func_41(var uParam0, int iParam1) // Position - 0xD52
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xE91
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xE9E
{
...
BOOL func_44(int iParam0) // Position - 0xED4
{
	if (iParam0 == 0)
	{
		func_86();
...
int func_45() // Position - 0xFE8
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xFF6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0x1002
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0x106F
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x114F
{
	if (!func_69(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x116D
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x1180
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

void func_53(int iParam0, Volume volParam1) // Position - 0x119E
{
	Global_1915656.f_3[iParam0 /*447*/].f_32 = volParam1;
	return;
}

BOOL func_54(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x11B5
{
	int num;
	int num2;
	int num3;
...
BOOL func_55(int iParam0) // Position - 0x12AD
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_56(int iParam0) // Position - 0x12BE
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_57(int iParam0) // Position - 0x12D2
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_58(var uParam0, var uParam1) // Position - 0x12E6
{
	return uParam0;
}

void func_59(int iParam0, int iParam1, Volume volParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x12F0
{
	int num;
	var unk;
	var unk4;
...
void func_60(int iParam0, int iParam1) // Position - 0x14FE
{
	func_117(&(Global_1915656.f_3[iParam0 /*447*/].f_5), iParam1);
	return;
}

void func_61(int iParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x1519
{
	int num;
...
void func_62(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x15B5
{
	if (!bParam3)
		if (func_119(iParam0))
			return;
...
void func_63(int iParam0, Volume volParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x15F6
{
...
void func_64(int iParam0, int iParam1) // Position - 0x17A5
{
	func_117(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

BOOL func_65() // Position - 0x17BF
{
...
BOOL func_66() // Position - 0x17D3
{
	return func_131(func_57(0));
}

void func_67(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x17E4
{
	int num;
...
int func_68(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x1888
{
	PersChar persChar;
...
BOOL func_69(int iParam0) // Position - 0x18D6
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_70() // Position - 0x18EC
{
	int i;
...
void func_71(int iParam0, int iParam1, Volume volParam2, int iParam3, var uParam4) // Position - 0x1919
{
	Ped EntityIndex;
...
BOOL func_72(var uParam0) // Position - 0x19F7
{
	if (func_145())
	{
		if (!*uParam0)
...
void func_73(Hash hParam0, int iParam1) // Position - 0x1A27
{
	func_136(hParam0, true, 0, false, false, 0, false, false);
	return;
}

BOOL func_74(int iParam0, int iParam1) // Position - 0x1A3C
{
	return iParam0 && iParam1 != false;
}

BOOL func_75(var uParam0, int iParam1) // Position - 0x1A4B
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_76() // Position - 0x1A5C
{
	return func_74(Global_1940199, 8192);
}

BOOL func_77(var uParam0, int iParam1) // Position - 0x1A6F
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_78(int iParam0) // Position - 0x1A80
{
	if (!func_69(iParam0))
		return false;
...
BOOL func_79(int iParam0, int iParam1) // Position - 0x1AC0
{
...
int func_80() // Position - 0x1AED
{
	return Global_1896646.f_41;
}

void func_81(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1AFB
{
	BOOL flag;
	...
	StringToTest = func_148(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_160(&unk, joaat("COLOR_PURE_WHITE")), str3, func_160(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_160(&unk, joaat("COLOR_PURE_WHITE")), func_160(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_161(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_82(var uParam0, int iParam1) // Position - 0x1D69
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_83(int iParam0, BOOL bParam1) // Position - 0x1D7C
{
...
void func_84(BOOL bParam0) // Position - 0x23E5
{
	if (bParam0)
...
BOOL func_85(int iParam0) // Position - 0x240E
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_86() // Position - 0x2453
{
	return;
}

Hash func_87(int iParam0, BOOL bParam1) // Position - 0x245B
{
	switch (iParam0)
	{
		case 0:
...
void func_88(int iParam0, BOOL bParam1) // Position - 0x2C20
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_89(BOOL bParam0) // Position - 0x2C73
{
	if (bParam0)
...
void func_90(int iParam0) // Position - 0x2C9C
{
	if (func_45() == -1)
...
void func_91(int iParam0) // Position - 0x2CCA
{
	int i;
...
void func_92(int iParam0) // Position - 0x2CFB
{
	int i;
...
BOOL func_93(int iParam0, BOOL bParam1) // Position - 0x2D2E
{
	int num;
	int num2;
	int num3;
...
BOOL func_94(int iParam0) // Position - 0x2DE4
{
	int i;
...
BOOL func_95(int iParam0, BOOL bParam1) // Position - 0x2E5E
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_96(int iParam0) // Position - 0x2E8F
{
	if (!func_69(iParam0))
		return false;
...
BOOL func_97(int iParam0) // Position - 0x2EB0
{
	if (!func_69(iParam0))
		return false;
...
BOOL func_98(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2F03
{
	BOOL flag;
...
BOOL func_99(int iParam0) // Position - 0x35C3
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_100(int iParam0) // Position - 0x35DA
{
	switch (iParam0)
	{
		case 64:
...
int func_101(int iParam0, BOOL bParam1) // Position - 0x361D
{
	if (!func_99(iParam0))
		return 0;
...
int func_102(int iParam0, int iParam1) // Position - 0x3708
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
Vector3 func_103(int iParam0) // Position - 0x4070
{
	if (!func_177(iParam0))
		return 0f, 0f, 0f;
...
Vector3 func_104(int iParam0) // Position - 0x47EF
{
	if (!func_177(iParam0))
		return 0f, 0f, 0f;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4F16
{
...
BOOL func_106(int iParam0, BOOL bParam1) // Position - 0x4F40
{
	return func_178(Global_1915656.f_3[iParam0 /*447*/].f_5, bParam1);
}

void func_107(int iParam0) // Position - 0x4F5B
{
	int i;
	int num;
...
int func_108(int iParam0) // Position - 0x5133
{
	switch (iParam0)
	{
		case 3:
...
BOOL func_109(int iParam0, int iParam1) // Position - 0x51D0
{
	Ped EntityIndex;
	Ped EntityIndex2;
	Ped EntityIndex3;
...
void func_110(int iParam0) // Position - 0x5307
{
...
void func_111(int iParam0) // Position - 0x5418
{
	if (iParam0 == 81)
	{
...
void func_112() // Position - 0x54C2
{
	TEXT_LABEL_ASSIGN_STRING(&Global_1960050.f_327[15 /*8*/], "GUS", 64);
	return;
}

void func_113() // Position - 0x54DB
{
	int randomIntInRange;
	int randomIntInRange2;
...
void func_114(int iParam0) // Position - 0x553C
{
	if (!func_177(iParam0))
		return;
...
void func_115(int iParam0, int iParam1) // Position - 0x55B6
{
	if (!func_186(iParam0))
		return;
...
void func_116(int iParam0, int iParam1) // Position - 0x5629
{
	if (!func_186(iParam0))
		return;
...
void func_117(BOOL bParam0, int iParam1) // Position - 0x5681
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

int func_118(int iParam0) // Position - 0x5692
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

BOOL func_119(int iParam0) // Position - 0x56A8
{
	int num;
...
BOOL func_120(int iParam0, BOOL bParam1) // Position - 0x5778
{
	if (!func_177(iParam0))
		return false;
...
void func_121(int iParam0, BOOL bParam1) // Position - 0x579D
{
	if (!func_177(iParam0))
	{
	}
...
void func_122(int iParam0, BOOL bParam1) // Position - 0x57C9
{
	if (!func_177(iParam0))
	{
	}
...
void func_123(int iParam0) // Position - 0x5800
{
	if (iParam0 != -1)
...
BOOL func_124() // Position - 0x5817
{
	return func_188(func_57(0));
}

BOOL func_125(int iParam0) // Position - 0x5828
{
	return !func_189(iParam0);
}

void func_126(BOOL bParam0, BOOL bParam1) // Position - 0x5837
{
	if (func_190(255) == 4)
		return;
...
void func_127(int iParam0, BOOL bParam1) // Position - 0x5982
{
	BOOL flag;
...
int func_128(int iParam0) // Position - 0x5D31
{
	if (!func_177(iParam0))
		return 0;
...
void func_129(int iParam0, int iParam1) // Position - 0x5D72
{
...
void func_130(int iParam0) // Position - 0x5DA1
{
...
BOOL func_131(var uParam0, var uParam1) // Position - 0x5DDA
{
	return func_207(uParam0, 9, 12);
}

int func_132(int iParam0) // Position - 0x5DED
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

Hash func_133(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5E01
{
...
BOOL func_134(Hash hParam0) // Position - 0x5EA5
{
	if (func_208(hParam0))
...
BOOL func_135(Hash hParam0) // Position - 0x5EC0
{
...
void func_136(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x5EE9
{
	func_133(hParam0, false, false);
...
BOOL func_137(int iParam0, BOOL bParam1) // Position - 0x5F74
{
	if (func_45() != -1)
		return false;
...
PersChar func_138(int iParam0) // Position - 0x5FCC
{
	if (!func_99(iParam0))
		return 0;
...
BOOL func_139(int iParam0) // Position - 0x5FEC
{
	return iParam0 > -1 && iParam0 < 16;
}

Ped func_140(int iParam0) // Position - 0x6002
{
	PersChar persChar;
...
BOOL func_141(Ped pedParam0) // Position - 0x6030
{
	Hash entityModel;
...
BOOL func_142(Ped pedParam0) // Position - 0x6062
{
	int num;
...
BOOL func_143(Ped pedParam0) // Position - 0x60A0
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
void func_144(Ped pedParam0, int iParam1) // Position - 0x60D1
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
BOOL func_146(int iParam0) // Position - 0x6118
{
...
const char* func_148(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x6190
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_218(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_220(func_219(Global_34));
...
BOOL func_149(int iParam0) // Position - 0x6BF6
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_150(int iParam0) // Position - 0x6C0B
{
	switch (iParam0)
	{
		case 0:
...
Hash func_151(int iParam0) // Position - 0x6CC6
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_152(int iParam0) // Position - 0x6D34
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_153(int iParam0) // Position - 0x6E8F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_154(int iParam0, BOOL bParam1) // Position - 0x6EC9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_155(int iParam0, int iParam1) // Position - 0x6F0B
{
	if (!func_149(iParam0))
		return false;
...
int func_156() // Position - 0x6F50
{
	return Global_1902569;
}

int func_157(int iParam0) // Position - 0x6F5C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_158(int iParam0) // Position - 0x6F6F
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_159(float fParam0) // Position - 0x6F81
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_160(var uParam0, int iParam1) // Position - 0x6F97
{
...
int func_161(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x6FCD
{
	int duration;
	var data;
	int num;
...
BOOL func_162(int iParam0) // Position - 0x7010
{
	if (func_221(iParam0))
		if (!func_222(44))
			return false;
...
void func_163(int iParam0, int iParam1) // Position - 0x7030
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_164(int iParam0, int iParam1) // Position - 0x7041
{
	int num;
...
void func_165(var uParam0, var uParam1, int iParam2) // Position - 0x7057
{
...
void func_166(int iParam0) // Position - 0x7074
{
...
BOOL func_167(int iParam0, BOOL bParam1) // Position - 0x7154
{
	if (func_45() != -1)
		return false;
...
int func_168(int iParam0, BOOL bParam1) // Position - 0x7182
{
	if (!func_99(iParam0))
		return 0;
...
int func_169(int iParam0) // Position - 0x7205
{
	switch (iParam0)
	{
		case 27:
...
int func_170(int iParam0) // Position - 0x722C
{
	switch (iParam0)
	{
		case 33:
...
Hash func_173(int iParam0) // Position - 0x748F
{
	if (!func_99(iParam0))
		return 0;
...
void func_174(int iParam0, PersChar pchParam1) // Position - 0x74AD
{
	if (!func_99(iParam0))
		return;
...
void func_175(int iParam0, BOOL bParam1) // Position - 0x74CE
{
	if (func_45() != -1)
		return;
...
BOOL func_176(int iParam0) // Position - 0x7507
{
	if (!func_99(iParam0))
		return false;
...
BOOL func_177(int iParam0) // Position - 0x752D
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_178(BOOL bParam0, BOOL bParam1) // Position - 0x7543
{
	return bParam0 && bParam1 != false;
}

BOOL func_179(int iParam0) // Position - 0x7552
{
	if (!func_99(iParam0))
		return false;
...
void func_180(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7577
{
	PersChar persChar;
...
void func_181(int iParam0, BOOL bParam1) // Position - 0x7663
{
	if (!func_177(iParam0))
		return;
...
void func_182(Hash hParam0) // Position - 0x76B9
{
...
void func_183(int iParam0) // Position - 0x76D9
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

BOOL func_184(int iParam0, BOOL bParam1) // Position - 0x76EF
{
	if (!func_177(iParam0))
		return false;
...
void func_185(int iParam0, BOOL bParam1) // Position - 0x7715
{
	if (!func_177(iParam0))
		return;
...
BOOL func_186(int iParam0) // Position - 0x7743
{
	return iParam0 > -1 && iParam0 < 40;
}

int func_187(int iParam0) // Position - 0x7759
{
...
BOOL func_188(var uParam0, var uParam1) // Position - 0x7C76
{
	return func_207(uParam0, 5, 8);
}

BOOL func_189(int iParam0) // Position - 0x7C89
{
	return func_237(1, iParam0);
}

int func_190(int iParam0) // Position - 0x7C98
{
	if (iParam0 == 255)
...
int func_191(int iParam0) // Position - 0x7CE3
{
...
void func_192(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x7D00
{
	func_239(iParam0);
...
int func_193(int iParam0) // Position - 0x7D62
{
...
void func_194(var uParam0) // Position - 0x7D7F
{
	var unk;
...
void func_195(float* pfParam0) // Position - 0x7D91
{
	var unk;
...
void func_197(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x7DF9
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_198(int iParam0) // Position - 0x7E26
{
...
BOOL func_199(int iParam0, int iParam1) // Position - 0x7E83
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_200(int iParam0, int iParam1) // Position - 0x7E9C
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_201(int iParam0, int iParam1) // Position - 0x7EB5
{
	func_200(iParam0, iParam1);
	Global_1051832.f_92[iParam0 /*75*/].f_1 = Global_1051832.f_92[iParam0 /*75*/].f_1 - Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1;
	return;
...
void func_202(int iParam0) // Position - 0x7EF0
{
	return;
}

void func_203(int iParam0) // Position - 0x7EF8
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_204(int iParam0, int iParam1) // Position - 0x7F0D
{
	if (iParam0 == -1)
		return false;
...
void func_205(int iParam0) // Position - 0x7F34
{
	int i;
	int num;
	BOOL flag;
...
int func_206(int iParam0) // Position - 0x7FB3
{
	var unk;
...
BOOL func_207(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x7FE4
{
	int num;
...
BOOL func_208(Hash hParam0) // Position - 0x8020
{
	return hParam0 != 0;
}

void func_209(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x802C
{
	if (func_134(hParam0))
	{
...
void func_210(Hash hParam0, BOOL bParam1) // Position - 0x8064
{
	if (func_134(hParam0))
...
void func_211(Hash hParam0, BOOL bParam1) // Position - 0x8092
{
	if (func_134(hParam0))
...
void func_212(Hash hParam0, BOOL bParam1) // Position - 0x80C0
{
	if (func_134(hParam0))
...
BOOL func_213() // Position - 0x80EE
{
	return true;
}

int func_214(Ped pedParam0) // Position - 0x80F7
{
	int i;
...
BOOL func_215() // Position - 0x813C
{
	return false;
}

BOOL func_216() // Position - 0x8145
{
	var unk;
	var unk3;
...
BOOL func_217(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x81AD
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_218(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x8323
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_219(var uParam0, var uParam1, var uParam2) // Position - 0x8337
{
	int i;
...
const char* func_220(int iParam0) // Position - 0x8365
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_221(int iParam0) // Position - 0x8647
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_222(int iParam0) // Position - 0x8671
{
	if (!func_254(iParam0))
		return false;
...
struct<2> func_223(Player plParam0) // Position - 0x868D
{
	var gamerHandle;
...
const char* func_224(const char* sParam0, int iParam1) // Position - 0x86A1
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_225(int iParam0, BOOL bParam1) // Position - 0x86BB
{
	char* StringToTest;
...
void func_226(int iParam0, BOOL bParam1) // Position - 0x86EF
{
	switch (iParam0)
	{
		case 5:
...
void func_227(int iParam0, int iParam1) // Position - 0x8724
{
	func_256(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

void func_228(int iParam0, BOOL bParam1) // Position - 0x873E
{
	if (func_45() != -1)
		return;
...
void func_229(int iParam0) // Position - 0x876F
{
	Ped EntityIndex;
...
void func_230(int iParam0) // Position - 0x87B3
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_231(int iParam0) // Position - 0x87C8
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_232(int iParam0) // Position - 0x87DD
{
	if (!func_99(iParam0))
		return false;
...
BOOL func_233(Hash hParam0) // Position - 0x8801
{
	return hParam0 != 0;
}

void func_234(int iParam0, BOOL bParam1) // Position - 0x880D
{
	if (!func_177(iParam0))
		return;
...
void func_235(int iParam0) // Position - 0x8847
{
	func_257(func_187(iParam0));
	return;
}

BOOL func_236() // Position - 0x8859
{
	return 1;
}

BOOL func_237(int iParam0, int iParam1) // Position - 0x8862
{
	int num;
...
BOOL func_238(Any* panParam0, int iParam1, int iParam2) // Position - 0x88D6
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_244(BOOL bParam0) // Position - 0x89A5
{
	if (func_260(bParam0))
		return;
...
BOOL func_245(Any* panParam0, int iParam1, int iParam2) // Position - 0x89CC
{
	int num;
	int offset;
	BOOL isBitSet;
...
int func_246(int iParam0) // Position - 0x89FF
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_247(int iParam0, int iParam1, var uParam2) // Position - 0x93E7
{
	var unk;
...
BOOL func_248(var uParam0, var uParam1) // Position - 0x940E
{
	if (!func_263(uParam0))
		return false;
...
int func_249(int iParam0, var uParam1) // Position - 0x9442
{
	if (iParam0 == 2)
...
struct<2> func_251() // Position - 0x94B4
{
	return Global_1051268;
}

struct<2> func_252() // Position - 0x94C2
{
...
BOOL func_253(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x950D
{
	var unk;
	float num;
	float num2;
...
BOOL func_254(int iParam0) // Position - 0x953D
{
	if (iParam0 == 0)
		return false;
...
BOOL func_255(int iParam0) // Position - 0x9550
{
	int num;
	int num2;
	int offset;
...
void func_256(BOOL bParam0, int iParam1) // Position - 0x957A
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

void func_257(int iParam0) // Position - 0x958F
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_258(Any* panParam0, int iParam1, int iParam2) // Position - 0x95A0
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_259() // Position - 0x95D7
{
	return Global_1102813.f_3672;
}

BOOL func_260(BOOL bParam0) // Position - 0x95E6
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_261(int iParam0, int iParam1, Any* panParam2) // Position - 0x95FC
{
...
void func_262(Any* panParam0, int iParam1, var uParam2) // Position - 0x9630
{
	var unk;
...
BOOL func_263(int iParam0) // Position - 0x96AA
{
	switch (iParam0)
	{
		case 2:
...
int func_264(int iParam0) // Position - 0x96E9
{
	switch (iParam0)
	{
		case 2:
...
int func_265(var uParam0, var uParam1) // Position - 0x977F
{
	var unk;
...
void func_266(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x97AB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_267(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0xA248
{
	float num;
	float num2;
	float num3;
...
int func_268(int iParam0) // Position - 0xA2AE
{
	int num;
...
BOOL func_269(int iParam0, var uParam1, Any* panParam2) // Position - 0xA423
{
	if (!func_248(iParam0))
		return false;
...
void func_270(Any* panParam0) // Position - 0xA52E
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
