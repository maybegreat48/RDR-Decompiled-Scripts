...
int func_1() // Position - 0x18F
{
	return Global_1572887.f_14;
}

void func_2(var uParam0) // Position - 0x19D
{
	var unk;
...
void func_3(var uParam0) // Position - 0x23F
{
	func_2(uParam0);
	return;
}

void func_4(var uParam0) // Position - 0x24D
{
	if (func_1() == -1)
		func_16(uParam0);
	else
...
void func_5(var uParam0, var uParam1) // Position - 0x270
{
	switch (uParam0->f_2)
	{
...
int func_6(var uParam0) // Position - 0x332
{
...
void func_7(var uParam0) // Position - 0x3A2
{
	func_25(uParam0);
	return;
}

int func_8(var uParam0) // Position - 0x3B0
{
...
void func_9(var uParam0) // Position - 0x4B6
{
	var unk;
...
int func_10(var uParam0) // Position - 0x4E3
{
...
void func_11(var uParam0) // Position - 0x53F
{
	if (uParam0->f_37)
	{
		func_33(uParam0);
...
void func_12(var uParam0) // Position - 0x559
{
	if (func_34(uParam0))
	{
		switch (uParam0->f_23)
...
BOOL func_13(BOOL bParam0, BOOL bParam1) // Position - 0x5F3
{
	int i;
...
void func_14(Hash hParam0, var uParam1) // Position - 0x6D3
{
	int eventData;
...
void func_15(var uParam0) // Position - 0x7CA
{
	var unk;
...
void func_16(var uParam0) // Position - 0x865
{
	DATABINDING::_DATABINDING_REMOVE_DATA_ENTRY(uParam0->f_8);
	return;
}

void func_17(var uParam0) // Position - 0x875
{
	DATABINDING::_DATABINDING_REMOVE_DATA_ENTRY(uParam0->f_8);
	return;
}

int func_18(var uParam0) // Position - 0x885
{
	if (uParam0->f_1 != 0)
		return uParam0->f_1;
...
int func_19(int iParam0) // Position - 0x8A0
{
	switch (iParam0)
	{
		case joaat("riobravo"):
...
int func_20(int iParam0) // Position - 0x95A
{
	switch (iParam0)
	{
		case joaat("butcher"):
...
int func_21(var uParam0) // Position - 0xA6A
{
	if (uParam0->f_19 == -1)
		return -1;
...
int func_22(int iParam0) // Position - 0xACD
{
	switch (iParam0)
	{
...
int func_23(int iParam0, BOOL bParam1) // Position - 0xB4E
{
	switch (iParam0)
	{
		case 0:
...
int func_24(int iParam0) // Position - 0x1313
{
	switch (iParam0)
	{
		case 0:
...
void func_25(var uParam0) // Position - 0x1412
{
	BOOL flag;
	int num;
	char* str;
...
BOOL func_26(Blip blParam0, var uParam1) // Position - 0x14EE
{
	var unk;
	var unk2;
	BOOL flag;
...
BOOL func_27(Blip blParam0, var uParam1) // Position - 0x150F
{
	int i;
...
Hash func_28(int iParam0) // Position - 0x1594
{
	switch (iParam0)
	{
		case joaat("tumbleweed"):
...
int func_29() // Position - 0x163F
{
	return joaat("ZONE_VALENTINE");
}

Hash func_30(int iParam0, Blip blParam1) // Position - 0x164C
{
	var unk;
	var InputString;
	Hash hashKey;
	...
	switch (iParam0)
	{
		...
		case 11:
		case 12:
			TEXT_LABEL_ASSIGN_STRING(&InputString, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(iParam0), 128);
		...
		case 68:
		case 69:
			InputString = { func_70(blParam1, iParam0, &unk) };
			hashKey = MISC::GET_HASH_KEY(&InputString);
			break;
		...
		case 83:
		case 84:
			InputString = { func_72(iParam0, blParam1, &unk) };
			hashKey = MISC::GET_HASH_KEY(&InputString);
			break;
		...
		case 90:
		case 91:
			MAP::SET_BLIP_FLASHES(blParam1, &unk17, &unk18);
			TEXT_LABEL_ASSIGN_STRING(&InputString, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(unk18), 128);
			hashKey = MISC::GET_HASH_KEY(&InputString);
			break;
...
void func_31(var uParam0) // Position - 0x197C
{
...
void func_32(var uParam0) // Position - 0x1994
{
...
void func_33(var uParam0) // Position - 0x19BB
{
	char* StringToTest;
	char* StringToTest2;
	char* StringToTest3;
	...
	StringToTest = func_75(uParam0->f_35, uParam0->f_36);
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
	{
		...
		if (uParam0->f_34 != -1)
			StringToTest2 = func_76(uParam0->f_34);
	
		if (uParam0->f_33 != -1)
		{
			StringToTest3 = AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0(uParam0->f_33);
			StringToTest4 = AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0(uParam0->f_33);
		}
	
		if (!MISC::IS_STRING_NULL_OR_EMPTY(StringToTest2) && !MISC::IS_STRING_NULL_OR_EMPTY(StringToTest3))
			StringToTest = MISC::VAR_STRING(42, "MAP_CARD_TOWN_FOOTER", StringToTest2, StringToTest3);
		else if (!MISC::IS_STRING_NULL_OR_EMPTY(StringToTest3) && !MISC::IS_STRING_NULL_OR_EMPTY(StringToTest4))
			StringToTest = MISC::VAR_STRING(42, "MAP_CARD_TOWN_FOOTER", StringToTest3, StringToTest4);
		else
			StringToTest = "";
	}

	DATABINDING::_DATABINDING_WRITE_DATA_STRING(uParam0->f_10, StringToTest);
	return;
}

BOOL func_34(var uParam0) // Position - 0x1A84
{
	if (uParam0->f_39)
		func_32(uParam0);
...
void func_35(Blip blParam0, var uParam1) // Position - 0x1B28
{
	var pTextLabel;
	Hash hashKey;
	...
	TEXT_LABEL_COPY(&pTextLabel, { Global_1835011[uParam1->f_29 /*72*/].f_9 }, 2);
	TEXT_LABEL_APPEND_STRING(&pTextLabel, "_DESC_PM", 16);

	if (!HUD::DOES_TEXT_LABEL_EXIST(&pTextLabel))
		TEXT_LABEL_ASSIGN_STRING(&pTextLabel, "", 16);

	hashKey = MISC::GET_HASH_KEY(&(Global_1835011[uParam1->f_29 /*72*/].f_9));
	DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam1->f_9, "description", MISC::GET_HASH_KEY(&pTextLabel));
...
void func_36(int iParam0, var uParam1) // Position - 0x1C28
{
	int num;
	int num2;
	Hash hash;
...
void func_37(Blip blParam0, var uParam1) // Position - 0x1D6B
{
	var unk;
	var unk2;
...
void func_38(Blip blParam0, var uParam1) // Position - 0x1E0A
{
	var unk;
	int num;
...
void func_39(Blip blParam0, var uParam1) // Position - 0x1EAE
{
	var unk;
	int num;
...
void func_40(int iParam0, var uParam1) // Position - 0x1F49
{
	int num;
	var InputString;
	var InputString2;
	...
	func_31(uParam1);
	uParam1->f_9 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(uParam1->f_8, "BLIP" /*Blip*/);
	TEXT_LABEL_ASSIGN_STRING(&InputString2, func_84(iParam0), 128);

	switch (func_85(iParam0))
	{
		case 1:
			InputString = { func_70(uParam1->f_25, iParam0, &num) };
		
			if (iParam0 == 16)
				TEXT_LABEL_ASSIGN_STRING(&InputString, "MAP_CARD_BOUNTY", 128);
		
			TEXT_LABEL_ASSIGN_STRING(&InputString3, func_76(num), 128);
			DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam1->f_9, "name", MISC::GET_HASH_KEY(&InputString2));
			DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam1->f_9, "description", MISC::GET_HASH_KEY(&InputString));
			DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam1->f_9, "description_title", MISC::GET_HASH_KEY(&InputString3));
			break;
		...
		case 2:
			...
			TEXT_LABEL_ASSIGN_STRING(&InputString3, func_76(num), 128);
			DATABINDING::_DATABINDING_ADD_DATA_STRING(uParam1->f_9, "name", &InputString2);
			DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam1->f_9, "description", MISC::GET_HASH_KEY(&InputString));
			DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam1->f_9, "description_title", MISC::GET_HASH_KEY(&InputString3));
			break;
	
		case 5:
			InputString = { func_87(num) };
			DATABINDING::_DATABINDING_ADD_DATA_STRING(uParam1->f_9, "name", &InputString2);
			DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam1->f_9, "description", MISC::GET_HASH_KEY(&InputString));
			DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam1->f_9, "description_title", 0);
			break;
...
int func_41(var uParam0) // Position - 0x20F4
{
	var unk;
...
void func_42(var uParam0) // Position - 0x212E
{
	func_88(uParam0);
	return;
}

int func_43(var uParam0) // Position - 0x213C
{
	var unk;
...
void func_44(var uParam0) // Position - 0x2277
{
	func_9(uParam0);
	func_91(uParam0);
	return;
...
int func_45(var uParam0) // Position - 0x228B
{
	return func_10(uParam0);
}

BOOL func_46(var uParam0) // Position - 0x2299
{
	var unk;
...
int func_47(var uParam0) // Position - 0x22D6
{
	return func_94(uParam0);
}

int func_48(Blip blParam0) // Position - 0x22E4
{
	int num;
	int num2;
...
BOOL func_49(int iParam0, int iParam1, var uParam2) // Position - 0x2381
{
	Any any;

	any = Global_1072759.f_28417;
	any.f_2 = -1629667380;
	any.f_3 = iParam0;
	any.f_4 = iParam1;
	...
	if (DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(any.f_1), &any))
	{
		*uParam2 = iParam0;
		uParam2->f_1 = iParam1;
		any.f_2 = -178053467;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_3), &any);
		any.f_2 = 2068408867;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_2), &any);
		any.f_2 = -2015838779;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_4), &any);
		any.f_2 = -837877152;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_5), &any);
		any.f_2 = -1422707781;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_6), &any);
		any.f_2 = -875438543;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_7), &any);
		any.f_2 = 680824008;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_8), &any);
		any.f_2 = -1832584664;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_9), &any);
		any.f_2 = 1926839997;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_10), &any);
		any.f_2 = -839757535;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_11), &any);
		any.f_2 = 378321223;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_12), &any);
		any.f_2 = -865732538;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_13), &any);
		any.f_2 = -1361232962;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_14), &any);
		any.f_2 = 680460752;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_15), &any);
		any.f_2 = 1929921658;
		DATAFILE::PARSEDDATA_RQ_FILLOUT_HASH(&(uParam2->f_16), &any);
		any.f_2 = 1969633495;
		DATAFILE::_PARSEDDATA_RQ_FILLOUT_STRING_63(&(uParam2->f_17), &any);
		any.f_2 = -1607031478;
		DATAFILE::_PARSEDDATA_RQ_FILLOUT_STRING_63(&(uParam2->f_25), &any);
		return true;
	}
...
void func_50(Blip blParam0, var uParam1) // Position - 0x2518
{
	var unk;
	int Arg;
	var unk2;
	...
	MAP::SET_BLIP_FLASHES(blParam0, &unk, &Arg);
	func_31(uParam1);
	uParam1->f_9 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(uParam1->f_8, "BLIP" /*Blip*/);
	unk2 = { func_95(PLAYER::INT_TO_PLAYERINDEX(Arg)) };
	uParam1->f_15 = DATABINDING::_DATABINDING_ADD_DATA_STRING(uParam1->f_9, "name", func_96(PLAYER::GET_PLAYER_NAME(PLAYER::INT_TO_PLAYERINDEX(Arg)), joaat("COLOR_PURE_WHITE")));
	...
	func_97(&InputString, unk2, 0);
	DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam1->f_9, "imageTXD", MISC::GET_HASH_KEY(&InputString));
	DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam1->f_9, "hint_name", -486609646);
	DATABINDING::_DATABINDING_ADD_DATA_INT(uParam1->f_9, "hint_value", func_98(Arg));
	DATABINDING::_DATABINDING_INSERT_UI_ITEM_TO_LIST_FROM_CONTEXT_STRING_ALIAS(uParam1->f_8, -1, "map_card_player", uParam1->f_9);
	return;
}

void func_51(var uParam0, var uParam1) // Position - 0x25E6
{
	func_31(uParam0);
...
void func_52(var uParam0, var uParam1) // Position - 0x269A
{
	func_31(uParam0);
	uParam0->f_9 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(uParam0->f_8, "BLIP" /*Blip*/);
	uParam0->f_15 = DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam0->f_9, "name", uParam1->f_4);
...
void func_53(var uParam0, var uParam1) // Position - 0x2741
{
	func_31(uParam0);
	uParam0->f_9 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(uParam0->f_8, "BLIP" /*Blip*/);
	uParam0->f_15 = DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam0->f_9, "name", uParam1->f_4);
...
void func_54(var uParam0, var uParam1) // Position - 0x27FF
{
	Hash hashKey;
	Hash hash;
	Hash hash2;
...
void func_55(var uParam0) // Position - 0x2BA6
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
void func_56(var uParam0) // Position - 0x2C62
{
	int num;
	char* str;
	const char* str2;
...
BOOL func_57(int iParam0) // Position - 0x2CDE
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_58(int iParam0) // Position - 0x2CF4
{
	return iParam0 > -1 && iParam0 < 17;
}

int func_59(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2D0A
{
	int num;
...
int func_60(int iParam0) // Position - 0x2FD7
{
	switch (iParam0)
	{
...
int func_61(int iParam0) // Position - 0x3139
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_62(int iParam0) // Position - 0x31F4
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_63(int iParam0) // Position - 0x3211
{
	if (!func_65(iParam0))
		return false;
...
BOOL func_64(int iParam0) // Position - 0x322E
{
	if (!func_57(iParam0))
		return false;
...
BOOL func_65(int iParam0) // Position - 0x324F
{
	return iParam0 > -1 && iParam0 < 6;
}

Hash func_66(int iParam0) // Position - 0x3264
{
	return func_120(iParam0);
}

BOOL func_67(var uParam0, var uParam1) // Position - 0x3272
{
	if (!func_121(uParam0))
		return false;
...
int func_68(var uParam0, var uParam1) // Position - 0x32A6
{
	var unk;
...
BOOL func_69(int iParam0) // Position - 0x32D2
{
	return iParam0 > -1 && iParam0 <= 80;
}

struct<16> func_70(Blip blParam0, int iParam1, var uParam2) // Position - 0x32E8
{
	var unk;
	var blipCoords;
	char* str;
...
struct<16> func_71() // Position - 0x3397
{
	var unk;
...
struct<16> func_72(int iParam0, Blip blParam1, var uParam2) // Position - 0x33AC
{
	var unk;
	var blipCoords;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x34FA
{
	switch (iParam0)
	{
		case 1:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x35A8
{
	switch (iParam0)
	{
...
char* func_75( Param0,  Param1) // Position - 0x3670
{
	 Var0;
	Hash discoveryHash;
...
char* func_76(int iParam0) // Position - 0x36B9
{
	if (!func_57(iParam0))
	{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0(int iParam0) // Position - 0x36F9
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0(int iParam0) // Position - 0x37F9
{
	switch (iParam0)
	{
		case 0:
...
Hash func_80(int iParam0) // Position - 0x39F5
{
	char* StringToTest;

	StringToTest = AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return 0;

	return MISC::GET_HASH_KEY(StringToTest);
}

Hash func_81(int iParam0) // Position - 0x3A18
{
	var StringToTest;
	var InputString;

	TEXT_LABEL_ASSIGN_STRING(&StringToTest, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0(iParam0), 64);

	if (MISC::IS_STRING_NULL_OR_EMPTY(&StringToTest))
		return 0;

	TEXT_LABEL_ASSIGN_STRING(&InputString, "MAP_CARD_", 64);
	TEXT_LABEL_APPEND_STRING(&InputString, &StringToTest, 64);
	TEXT_LABEL_APPEND_STRING(&InputString, "_DESC", 64);
	return MISC::GET_HASH_KEY(&InputString);
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0(int iParam0) // Position - 0x3A53
{
	switch (iParam0)
	{
		case 0:
...
Hash func_83(int iParam0) // Position - 0x3B6B
{
	int num;
...
char* func_84(int iParam0) // Position - 0x3BA4
{
	switch (iParam0)
	{
		case 1:
...
int func_85(int iParam0) // Position - 0x40CE
{
	switch (iParam0)
	{
		case 1:
...
int func_86(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x4265
{
	int num;
...
struct<16> func_87(int iParam0) // Position - 0x42B3
{
	var unk;
...
void func_88(var uParam0) // Position - 0x4328
{
	BOOL flag;
	Hash hash;
	char* str;
...
int func_89(Blip blParam0) // Position - 0x43F4
{
	int i;
	int num;
...
Hash func_90(int iParam0) // Position - 0x4476
{
	switch (iParam0)
	{
...
void func_91(var uParam0) // Position - 0x4541
{
	uParam0->f_30 = 0;
	uParam0->f_30.f_1 = 0;
	uParam0->f_30.f_2 = 0;
...
int func_92(int iParam0) // Position - 0x455C
{
	switch (iParam0)
	{
...
void func_93(int iParam0, int iParam1) // Position - 0x464C
{
	int num;
	int num2;
	int num3;
...
int func_94(int iParam0) // Position - 0x46F6
{
	switch (iParam0)
	{
		case 1:
...
struct<2> func_95(Player plParam0) // Position - 0x48EB
{
	var gamerHandle;
...
const char* func_96(const char* sParam0, int iParam1) // Position - 0x48FF
{
...
int func_97(char* sParam0, var uParam1, var uParam2, int iParam3) // Position - 0x493D
{
...
Hash func_98(int iParam0) // Position - 0x49A3
{
...
void func_99(var uParam0, Hash hParam1) // Position - 0x49CF
{
	int num;
...
int func_100(var uParam0) // Position - 0x49FC
{
	return func_146(13, uParam0);
}

BOOL func_101(int iParam0) // Position - 0x4A0C
{
	return iParam0 >= 0 && iParam0 < 36;
}

int func_102(int iParam0) // Position - 0x4A22
{
...
Hash func_104(int iParam0) // Position - 0x4A4C
{
	return Global_1119235[iParam0 /*35*/];
}

BOOL func_105(Hash hParam0) // Position - 0x4A5C
{
	var unk;

	unk = { func_148(joaat("has_been_interacted_with"), func_147(hParam0)) };
	return func_149(unk);
}

Hash func_106(int iParam0, int iParam1) // Position - 0x4A7F
{
	return Global_1119235[iParam0 /*35*/].f_2[func_150(iParam1, 1) /*2*/];
}

int func_107(int iParam0, int iParam1) // Position - 0x4A9A
{
	return Global_1119235[iParam0 /*35*/].f_2[func_150(iParam1, 1) /*2*/].f_1;
}

Hash func_108(int iParam0, int iParam1) // Position - 0x4AB7
{
	return Global_1119235[iParam0 /*35*/].f_13[func_131(iParam1, 1)];
}

void func_109(int iParam0) // Position - 0x4AD2
{
	int num;
...
BOOL func_110() // Position - 0x4B14
{
	return func_152(Global_1572887.f_8, true);
}

char* func_111(Hash hParam0, var uParam1) // Position - 0x4B27
{
...
BOOL func_112(int iParam0) // Position - 0x4C0B
{
	if (!func_57(iParam0))
		return false;
...
Hash func_113() // Position - 0x4C2C
{
	return Global_1939102.f_26;
}

BOOL func_114(int iParam0) // Position - 0x4C3A
{
	if (!func_154(iParam0))
		return false;
...
int func_115(int iParam0) // Position - 0x4C56
{
	if (iParam0 < 0)
		return -1;
	else if (iParam0 <= 10)
...
int func_116(int iParam0, BOOL bParam1) // Position - 0x4D52
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_117(int iParam0, BOOL bParam1) // Position - 0x4ECC
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_118(int iParam0, int iParam1) // Position - 0x4F0E
{
	if (!func_65(iParam0))
		return false;
...
BOOL func_119(int iParam0, BOOL bParam1) // Position - 0x4F53
{
	if (Global_1572887.f_14 == -1)
...
int func_120(int iParam0) // Position - 0x4F84
{
	int i;
	var gamerHandle;
	int bountyData;
...
BOOL func_121(int iParam0) // Position - 0x4FF2
{
	switch (iParam0)
	{
		case 2:
...
int func_122(int iParam0) // Position - 0x5031
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_123(int iParam0, var uParam1, Any* panParam2) // Position - 0x50C7
{
	if (!func_67(iParam0))
		return false;
...
char* func_124(int iParam0) // Position - 0x51D2
{
	char* str;
...
char* func_125(int iParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4) // Position - 0x51FB
{
	switch (iParam0)
	{
		case 16:
...
int func_126(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5440
{
	var ReturnZ;
	int num;
	BOOL flag;
...
char* func_127(var uParam0) // Position - 0x5544
{
...
Hash func_128(int iParam0) // Position - 0x55DA
{
	switch (iParam0)
	{
...
char* func_129(char* sParam0) // Position - 0x5D69
{
	return HUD::_GET_TEXT_SUBSTRING_2(&sParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&sParam0));
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0(int iParam0) // Position - 0x5D7D
{
	switch (iParam0)
	{
		case joaat("tumbleweed"):
...
int func_131(int iParam0, int iParam1) // Position - 0x5E1E
{
	switch (iParam0)
	{
...
int func_132() // Position - 0x5E53
{
	return Global_1893611.f_2;
}

int func_133(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x5E61
{
	int num;
	int num2;
	int num3;
...
BOOL func_134() // Position - 0x5F18
{
	return Global_263042[Global_1295666 /*65*/] > 2;
}

BOOL func_135() // Position - 0x5F2C
{
	if (Global_1048576)
		return 1;
	...
	if (!func_67(Global_1051268) && Global_1572887.f_8 & true != 0)
		return 1;

	return 0;
}

BOOL func_136() // Position - 0x5F84
{
	if (func_160(255) <= 2)
		return false;
...
BOOL func_137(int iParam0) // Position - 0x5FD1
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(func_162(iParam0));
}

int func_138(int iParam0) // Position - 0x5FE3
{
	int num;
	int num2;
	var unk;
...
void func_139(int iParam0) // Position - 0x6197
{
	Global_1572887.f_72.f_14 = iParam0;
	return;
}

Hash func_140(int iParam0) // Position - 0x61A9
{
	int i;
...
struct<2> func_141() // Position - 0x622C
{
	var unk;
...
int func_142(int iParam0, int iParam1, int iParam2, Hash hParam3, var uParam4, var uParam5, int iParam6, int iParam7, BOOL bParam8, int iParam9, int iParam10) // Position - 0x6245
{
	int num;
	var unk22;
	var unk30;
...
const char* func_143(const char* sParam0, int iParam1) // Position - 0x64C8
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

int func_144(char* sParam0, Player plParam1, int iParam2) // Position - 0x64E2
{
	Player Plr;
		...
		case 2:
			switch (num)
			{
				...
				case 2:
					...
					func_192(plParam1, iParam2, textureDownloadHandle);
					break;
			
				case 3:
					textureDownloadHandle = func_193(plParam1, iParam2);
...
int func_145(Hash hParam0) // Position - 0x66D0
{
	int i;
...
int func_146(int iParam0, var uParam1) // Position - 0x6727
{
	var unk;
...
int func_147(Hash hParam0) // Position - 0x6744
{
	switch (hParam0)
	{
...
struct<2> func_148(int iParam0, int iParam1) // Position - 0x695E
{
	int num;
...
BOOL func_149(var uParam0, var uParam1) // Position - 0x6974
{
	int value;
...
int func_150(int iParam0, int iParam1) // Position - 0x699C
{
	switch (iParam0)
	{
		case joaat("SECONDARY"):
...
void func_151(int iParam0, int iParam1) // Position - 0x69DB
{
	int num;
...
BOOL func_152(BOOL bParam0, BOOL bParam1) // Position - 0x6A67
{
	return bParam0 && bParam1 != false;
}

void func_153(int iParam0) // Position - 0x6A76
{
	Global_265213.f_122353 = iParam0;
	return;
}

BOOL func_154(int iParam0) // Position - 0x6A8A
{
	if (iParam0 == 0)
		return false;
...
BOOL func_155(int iParam0) // Position - 0x6A9D
{
	int num;
	int num2;
	int offset;
...
void func_156(Any* panParam0) // Position - 0x6AC7
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
BOOL func_157(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x6ADD
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

int func_158(int iParam0) // Position - 0x6B06
{
	switch (iParam0)
	{
		case -1:
...
int func_159(var uParam0, var uParam1, var uParam2) // Position - 0x6B7C
{
	int num;
...
int func_160(Player plParam0) // Position - 0x6BB7
{
	if (plParam0 == 255)
...
int func_163() // Position - 0x6D55
{
	return Global_1102813.f_3673;
}

int func_164(int iParam0) // Position - 0x6D64
{
	int i;
...
BOOL func_165(int iParam0, Hash hParam1) // Position - 0x6DE1
{
...
BOOL func_166() // Position - 0x6E05
{
	return Global_1572887.f_72.f_40 != 1;
}

BOOL func_167(Player plParam0) // Position - 0x6E17
{
	Any gangId;
...
void func_168(Any* panParam0) // Position - 0x6E41
{
	MISC::COPY_SCRIPT_STRUCT(&(Global_1572887.f_72.f_17), panParam0, 22);
	return;
}

void func_169(int iParam0, BOOL bParam1) // Position - 0x6E59
{
...
void func_170(int iParam0, Hash hParam1, int iParam2, BOOL bParam3) // Position - 0x6E74
{
...
void func_171(var uParam0, var uParam1, BOOL bParam2) // Position - 0x6EA1
{
...
void func_172(int iParam0) // Position - 0x6EC0
{
	Global_1572887.f_72.f_15 = iParam0;
	return;
}

void func_173(int iParam0) // Position - 0x6ED2
{
	Global_1572887.f_72.f_13 = iParam0;
	return;
}

void func_174() // Position - 0x6EE4
{
	Ped PedIndex;
	var entityCoords;
...
int func_176(var uParam0, var uParam1) // Position - 0x6F4E
{
	if (func_198())
		return 0;
...
void func_177() // Position - 0x6F7C
{
	Global_1056554[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*491*/].f_15.f_12 = 0;
	return;
}

void func_178(var uParam0, var uParam1) // Position - 0x6F94
{
	int num;
	int num2;
	int num3;
...
BOOL func_179(BOOL bParam0) // Position - 0x703C
{
	return Global_1572887.f_72.f_15 && bParam0 != false;
}

int func_180(int iParam0, BOOL bParam1) // Position - 0x7051
{
	if (bParam1)
		func_203();
...
int func_181(var uParam0, Hash hParam1, int iParam2, int iParam3, int iParam4) // Position - 0x708D
{
	int num;
	int num2;
	int num3;
...
const char* func_182(var uParam0, int iParam1) // Position - 0x7353
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
...
char* func_183(Hash hParam0) // Position - 0x7389
{
	Hash hash;

	hash = func_221(hParam0);
...
int func_184() // Position - 0x74DF
{
	return Global_1572887.f_72;
}

char* func_185(int iParam0, Hash hParam1) // Position - 0x74ED
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_186(int iParam0, BOOL bParam1) // Position - 0x75C8
{
	BOOL flag;
...
int func_187(char* sParam0) // Position - 0x764F
{
	const char* str;
	int num;
...
void func_188(int iParam0) // Position - 0x7671
{
	Global_1572887.f_72.f_40 = iParam0;
	return;
}

int func_189(Player plParam0, int iParam1) // Position - 0x7683
{
...
int func_190(int iParam0) // Position - 0x76BC
{
	switch (iParam0)
	{
		case 1:
...
void func_191(Player plParam0, int iParam1, int iParam2) // Position - 0x76E1
{
	Player Plr;
...
void func_192(Player plParam0, int iParam1, int iParam2) // Position - 0x7738
{
	Player Plr;
...
int func_193(Player plParam0, int iParam1) // Position - 0x7784
{
	Player Plr;
...
BOOL func_194(int iParam0, var uParam1, var uParam2) // Position - 0x77D1
{
	var unk;
...
Hash func_195(int iParam0) // Position - 0x77F8
{
	switch (iParam0)
	{
		case 1:
...
int func_196(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x78DB
{
	if (fParam0 < fParam3)
...
BOOL func_198() // Position - 0x7A38
{
	return func_67(Global_1051268);
}

int func_199(var uParam0, var uParam1) // Position - 0x7A4A
{
	int i;
...
int func_200(int iParam0) // Position - 0x7A83
{
	return Global_1206497.f_78[iParam0 /*20*/].f_3;
}

int func_201(int iParam0) // Position - 0x7A97
{
	return Global_1205938.f_1[iParam0 /*26*/].f_3;
}

struct<8> func_202(int iParam0, int iParam1) // Position - 0x7AAB
{
	var unk;
	var unk9;
...
BOOL func_204(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7B0E
{
	BOOL flag;
...
void func_205(int iParam0) // Position - 0x7B36
{
	Global_1896762.f_365 = iParam0;
	return;
}

void func_206(var uParam0, int iParam1) // Position - 0x7B47
{
	uParam0->f_15 = uParam0->f_15 || iParam1;
	return;
}

void func_207(char* sParam0) // Position - 0x7B5A
{
	TEXT_LABEL_ASSIGN_STRING(&(Global_1572887.f_72.f_60.f_6), sParam0, 32);
	return;
}

BOOL func_208(int iParam0) // Position - 0x7B70
{
...
BOOL func_209(int iParam0) // Position - 0x7B88
{
...
int func_210(Hash hParam0) // Position - 0x7BA0
{
	int i;
...
Vector3 func_211(int iParam0) // Position - 0x7BD9
{
	int num;
	int num2;
	int i;
...
struct<2> func_212(int iParam0) // Position - 0x7CBE
{
...
BOOL func_213(int iParam0) // Position - 0x7CEB
{
	if (iParam0 == 0)
		return false;
...
int func_214(int iParam0) // Position - 0x7D05
{
	int i;
	int num;
...
struct<2> func_215(int iParam0) // Position - 0x7D37
{
	return func_243(iParam0);
}

struct<2> func_216(var uParam0) // Position - 0x7D45
{
	var unk;
	var unk6;
...
struct<2> func_217(int iParam0) // Position - 0x7DDF
{
	var unk;
...
struct<2> func_218(int iParam0) // Position - 0x7EAF
{
	var unk;
	var unk6;
...
int func_219(int iParam0) // Position - 0x7F01
{
	switch (iParam0)
	{
		case -933924539:
...
void func_220(var uParam0) // Position - 0x7F3C
{
	uParam0->f_15 = 0;
	return;
}

Hash func_221(Hash hParam0) // Position - 0x7F49
{
	int i;
...
int func_222() // Position - 0x7F8D
{
	return Global_1102813.f_3672;
}

int func_223(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x7F9C
{
	int num;
	var unk13;
	int num2;
...
BOOL func_224(int iParam0, var uParam1, Any* panParam2) // Position - 0x7FD7
{
...
void func_225(Any* panParam0, int iParam1, var uParam2) // Position - 0x800D
{
	var unk;
...
void func_226(BOOL bParam0, int iParam1) // Position - 0x8087
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

void func_227(BOOL bParam0, int iParam1) // Position - 0x8098
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_228(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x80AD
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

BOOL func_229(Any* panParam0, int iParam1) // Position - 0x80C8
{
...
BOOL func_230(Any* panParam0) // Position - 0x810A
{
	panParam0->f_2 = -310067910;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam0->f_1), panParam0);
}

BOOL func_231(Any* panParam0, int iParam1) // Position - 0x8125
{
...
BOOL func_232(Any* panParam0) // Position - 0x8146
{
	panParam0->f_2 = 1701407264;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam0->f_1), panParam0);
}

int func_233(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, char* sParam6, BOOL bParam7) // Position - 0x8161
{
	uParam0.f_2 = iParam5;
...
BOOL func_234() // Position - 0x8187
{
	return Global_1915656.f_20643;
}

BOOL func_235(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x8196
{
	Player PlayerIndex;
	Ped EntityIndex;
	BOOL isEntityDead;
...
int func_236(int iParam0, int iParam1) // Position - 0x83BC
{
	switch (iParam0)
	{
		case -1957416901:
...
int func_237(int iParam0, int iParam1) // Position - 0x844E
{
	switch (iParam0)
	{
		case -1918441640:
...
Hash func_238(int iParam0) // Position - 0x8538
{
	if (!func_69(iParam0))
		return 0;
...
BOOL func_239(Any* panParam0) // Position - 0x8564
{
	int fileHandle;
	var SourceStruct;
...
BOOL func_240(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x85A6
{
	var unk;
...
int func_241(Any anParam0, int iParam1) // Position - 0x85DF
{
	anParam0->f_2 = iParam1;
	return DATAFILE::_PARSEDDATA_RQ_GET_NUM_NODES(anParam0);
}

int func_242(int iParam0) // Position - 0x85F3
{
	return Global_1295849[iParam0 /*37*/].f_9;
}

struct<2> func_243(int iParam0) // Position - 0x8605
{
	var DestStruct;
...
var func_244(Any* panParam0) // Position - 0x862F
{
	return func_251(panParam0, 67, 1);
}

struct<2> func_245(var uParam0, int iParam1) // Position - 0x8640
{
	int num;
...
BOOL func_246(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8766
{
...
void func_247(int iParam0, Any* panParam1, var uParam2) // Position - 0x8797
{
	int num;
...
int func_248(int iParam0) // Position - 0x89F2
{
	int num;
...
int func_249(int iParam0) // Position - 0x8B67
{
	switch (iParam0)
	{
		case 0:
...
int func_252(var uParam0, Any* panParam1, int iParam2) // Position - 0x8CB9
{
	int num;
	int num2;
	int num3;
...
int func_253(int iParam0, var uParam1) // Position - 0x8D0E
{
	var unk;
...
int func_254(int iParam0) // Position - 0x8D2B
{
	switch (iParam0)
	{
		case joaat("IWD_INF"):
...
int func_255(int iParam0) // Position - 0x8E81
{
	switch (iParam0)
	{
...
int func_256(int iParam0) // Position - 0x8ED8
{
	switch (iParam0)
	{
...
int func_257(int iParam0) // Position - 0x8FB2
{
	switch (iParam0)
	{
		case -1641798436:
...
int func_258(int iParam0) // Position - 0x904A
{
	switch (iParam0)
	{
		case -1968391995:
...
BOOL func_259(int iParam0, var uParam1, var uParam2) // Position - 0x91F4
{
	var unk;
...
BOOL func_260(int iParam0, var uParam1, Any* panParam2) // Position - 0x921B
{
	*panParam2 = Global_1149432.f_7;
