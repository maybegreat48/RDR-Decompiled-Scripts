...
int func_5() // Position - 0x48C
{
	return Global_1572887.f_14;
}

BOOL func_6(BOOL bParam0, BOOL bParam1) // Position - 0x49A
{
	int i;
...
void func_7() // Position - 0x57A
{
	LAW::_REMOVE_GUARD_ZONE(sLocal_22);
	return;
}

void func_8(Volume volParam0) // Position - 0x588
{
...
void func_9(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x5CF
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x64E
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0) // Position - 0x6C4
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12(Hash hParam0, int iParam1) // Position - 0x705
{
	func_14(hParam0, true, 0, false, false, 0, false, false);
	return;
}

void func_13(var uParam0, int iParam1) // Position - 0x71A
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_14(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x72F
{
...
Hash func_15(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7BA
{
...
BOOL func_16(Hash hParam0) // Position - 0x85E
{
	if (func_22(hParam0))
...
void func_17(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x879
{
	if (func_16(hParam0))
	{
...
void func_18(Hash hParam0, BOOL bParam1) // Position - 0x8B1
{
	if (func_16(hParam0))
...
void func_19(Hash hParam0, BOOL bParam1) // Position - 0x8DF
{
	if (func_16(hParam0))
...
void func_20(Hash hParam0, BOOL bParam1) // Position - 0x90D
{
	if (func_16(hParam0))
...
BOOL func_21() // Position - 0x93B
{
	return true;
}

BOOL func_22(Hash hParam0) // Position - 0x944
{
	return hParam0 != 0;
}
