...
BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0x63
{
	int i;
...
void func_5() // Position - 0x205
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_6(int iParam0, int iParam1) // Position - 0x211
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_5();
...
void func_10(BOOL bParam0) // Position - 0x3EF
{
	int num;
	var unk;
	int num2;
...
char* func_14() // Position - 0x565
{
	return "FMUI";
}

void func_15(int iParam0, int iParam1) // Position - 0x570
{
	func_35(&(Global_1206497.f_78[iParam0 /*20*/].f_6), iParam1);
	return;
}

void func_16(int iParam0) // Position - 0x58A
{
	var unk;
...
void func_17(int iParam0) // Position - 0x597
{
	var unk;
...
int func_18() // Position - 0x5CC
{
	return Global_1572887.f_14;
}

BOOL func_19() // Position - 0x5DA
{
	return Global_1051645.f_8;
}

void func_20(int* piParam0) // Position - 0x5E8
{
	var unk;
...
int func_21(int iParam0, int iParam1, char* sParam2) // Position - 0x6F0
{
	return 1;
}

BOOL func_22() // Position - 0x6F9
{
	return !Global_1572887.f_10;
}

int func_23() // Position - 0x708
{
	return Global_1102813.f_3672;
}

void func_24(Any* panParam0) // Position - 0x717
{
	int i;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		func_36(&panParam0->[i /*10*/]);
	}

	return;
}

int func_25(int iParam0, int iParam1, char* sParam2) // Position - 0x73F
{
	return 1;
}

void func_26(int iParam0) // Position - 0x748
{
	var unk;
...
void func_27() // Position - 0x97B
{
	func_37(1);
	return;
}

void func_28() // Position - 0x988
{
	if (func_38())
		func_37(2);
...
void func_35(int iParam0, int iParam1) // Position - 0xABE
{
	func_51(iParam0, iParam1);
	return;
}

void func_36(var uParam0) // Position - 0xACE
{
	int i;
...
void func_37(int iParam0) // Position - 0xAF2
{
	Global_1205938 = iParam0;
	return;
}

BOOL func_38() // Position - 0xB00
{
	BOOL num;
...
void func_40() // Position - 0xBC9
{
	...
	num = Global_1901671.f_319.f_185;
	CLOCK::_GET_POSIX_TIME_STRUCT(&outTime);
	inDateTime = { outTime };
	inDateTime.f_3 = 0;
	inDateTime.f_4 = num;
...
void func_49(int* piParam0) // Position - 0xE16
{
...
void func_51(int iParam0, int iParam1) // Position - 0xEAC
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_52() // Position - 0xEBD
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_54() // Position - 0xEF5
{
	return DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1206497.f_455);
}

int func_55() // Position - 0xF08
{
	int num;

	num = Global_1901671.f_319.f_183;
	return num;
}

BOOL func_56(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13) // Position - 0xF1D
{
	if (uParam0 > uParam7)
		return true;
...
int func_57() // Position - 0x1005
{
	int num;

	num = Global_1901671.f_319.f_184;
	return num;
}

BOOL func_58() // Position - 0x101A
{
...
BOOL func_59(int iParam0, int iParam1) // Position - 0x102E
{
...
BOOL func_60() // Position - 0x106F
{
	return Global_1572887.f_72.f_40 != 1;
}

void func_61(int iParam0) // Position - 0x1081
{
...
BOOL func_62(int iParam0) // Position - 0x10A8
{
	int NewSeed;
	int num;
	int num2;
	...
	NewSeed = func_75(func_74(iParam0));
	...
	flag = func_78(num, PLAYER::PLAYER_ID(), num2, num3, NewSeed, 0);
	MISC::SET_RANDOM_SEED(MISC::GET_GAME_TIMER());
...
void func_63(int iParam0) // Position - 0x115C
{
	var outTime;
	var outDateTime;
	var timeToAdd;
...
void func_64(int iParam0) // Position - 0x11BF
{
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x1215
{
	return iParam0 && iParam1 != false;
}

void func_66() // Position - 0x1224
{
...
BOOL func_68(BOOL bParam0, BOOL bParam1) // Position - 0x16EC
{
	return bParam0 && bParam1 != false;
}

void func_69(BOOL bParam0, int iParam1) // Position - 0x16FB
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

void func_70(int iParam0) // Position - 0x170C
{
...
Player func_71() // Position - 0x17BD
{
...
int func_72(int iParam0) // Position - 0x1811
{
	return Global_1205938.f_1[iParam0 /*26*/];
}

void func_73(int iParam0, int iParam1) // Position - 0x1823
{
...
struct<7> func_74(int iParam0) // Position - 0x1846
{
	switch (iParam0)
	{
		case joaat("standard"):
...
int func_75(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1880
{
	int num;
...
BOOL func_76(var uParam0, var uParam1, var uParam2) // Position - 0x18A6
{
	int num;
	int num2;
	int i;
...
BOOL func_77(var uParam0, var uParam1, var uParam2) // Position - 0x19BD
{
	int num;
	int num2;
	int i;
...
BOOL func_78(int iParam0, Player plParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1AD4
{
	int num;
	int num2;
	var unk;
...
void func_79(int iParam0) // Position - 0x1C42
{
	BOOL flag;
...
void func_80(int iParam0) // Position - 0x1C97
{
	var outTime;
...
void func_81(int iParam0) // Position - 0x1CFB
{
	if (!func_111(iParam0, 1))
	{
...
void func_82(int iParam0) // Position - 0x1D43
{
...
BOOL func_83(int iParam0) // Position - 0x1D90
{
...
void func_84(int iParam0) // Position - 0x1E7A
{
...
void func_85(int iParam0) // Position - 0x1EA9
{
	var unk;
	var unk4;
	var outTime;
...
void func_86(int iParam0) // Position - 0x200B
{
	if (Global_1205938.f_1[iParam0 /*26*/] >= 6)
	{
		func_121(iParam0, 6);
...
void func_87(int iParam0) // Position - 0x204D
{
	if (Global_1205938.f_1[iParam0 /*26*/] >= 6)
	{
...
void func_88(int iParam0) // Position - 0x20E4
{
	int num;
	var unk;
	var scriptname;
...
void func_89(int iParam0) // Position - 0x229E
{
	if (Global_1205938.f_1[iParam0 /*26*/] >= 6)
	{
		func_121(iParam0, 6);
...
void func_90(int iParam0) // Position - 0x230C
{
...
int func_92(int iParam0) // Position - 0x25CD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(var uParam0, int iParam1, var uParam2, var uParam3) // Position - 0x28E3
{
	Any any;
	Any any2;
	var unk9;
...
BOOL func_95(int iParam0, var uParam1, var uParam2) // Position - 0x2B13
{
	int num;
	Any any;
	Any any2;
...
int func_97(int iParam0) // Position - 0x2DF6
{
	switch (iParam0)
	{
		case 0:
...
int func_98(int iParam0) // Position - 0x2FAB
{
	switch (iParam0)
	{
		case 0:
...
int func_99(int iParam0, Player plParam1, var uParam2) // Position - 0x3148
{
	Any gangId;
	int num;
	int num2;
...
int func_100(int iParam0, int iParam1) // Position - 0x3276
{
	Vector3 vector;
...
int func_101(int iParam0) // Position - 0x32DA
{
	if (iParam0 == 0)
		return 5;
...
struct<2> func_102(int iParam0, int iParam1, int iParam2) // Position - 0x32ED
{
	var unk;
	var unk6;
	var unk7;
...
int func_103(var uParam0, var uParam1) // Position - 0x335D
{
	if (!func_122(uParam0))
	{
...
BOOL func_104(int iParam0) // Position - 0x3412
{
	switch (iParam0)
	{
		case 15:
...
Vector3 func_105(Player plParam0) // Position - 0x3439
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

int func_106(int iParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x344D
{
	int num;
	Any any;
	var unk5;
...
int func_107(int iParam0, int iParam1) // Position - 0x35A4
{
	int num;
	Any any;
	Any numChildren;
...
BOOL func_108(int iParam0, int iParam1) // Position - 0x3615
{
	int i;
...
int func_109(int iParam0) // Position - 0x365D
{
	if (iParam0 == -1)
		return 0;
...
BOOL func_110(int iParam0, var uParam1) // Position - 0x3679
{
	Vector3 vector;
	var args;
...
BOOL func_111(int iParam0, int iParam1) // Position - 0x3785
{
	int i;
...
void func_112(int iParam0) // Position - 0x37CC
{
	var unk;
...
int func_113(int iParam0) // Position - 0x37FC
{
	int num;
	var unk;
...
int func_114(int iParam0) // Position - 0x3828
{
	int num;
	var unk;
...
BOOL func_115(int iParam0, int iParam1, Player plParam2) // Position - 0x3854
{
	return func_65(Global_1206166[plParam2 /*10*/][iParam0], iParam1);
}

void func_116(int iParam0, int iParam1, int iParam2) // Position - 0x386E
{
	func_35(&Global_1206166[iParam2 /*10*/][iParam0], iParam1);
	return;
}

void func_117(var uParam0, int iParam1) // Position - 0x3888
{
	var unk;
...
void func_118(int iParam0, int iParam1, int iParam2) // Position - 0x3902
{
	func_163(&Global_1206166[iParam2 /*10*/][iParam0], iParam1);
	return;
}

BOOL func_119(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x391C
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

BOOL func_120() // Position - 0x3937
{
	int i;
...
void func_121(int iParam0, int iParam1) // Position - 0x3961
{
...
BOOL func_122(int iParam0, var uParam1) // Position - 0x3984
{
	if (!func_164(iParam0))
		return false;
...
BOOL func_123(Any* panParam0, int iParam1) // Position - 0x39B8
{
	if (!DATAFILE::PARSEDDATA_IS_FILE_VALID(Global_1206497.f_455))
		return false;
...
BOOL func_124(Any* panParam0) // Position - 0x39FA
{
	*panParam0 = Global_1206497.f_455;
...
BOOL func_125(Any* panParam0, int iParam1) // Position - 0x3A1F
{
...
int func_126(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, Vector3* pvParam6, BOOL bParam7) // Position - 0x3A40
{
	uParam0.f_2 = iParam5;
...
void func_127(int iParam0) // Position - 0x3A66
{
	func_69(&(Global_1572887.f_72.f_16), iParam0);
	return;
}

void func_128(int iParam0) // Position - 0x3A7C
{
...
void func_129(int iParam0) // Position - 0x3AAD
{
	Any gangId;
	int numGangMembers;
	int num;
		...
		else if (func_171(&(Global_1206497.f_78[iParam0 /*20*/].f_16)) > 15000)
		{
			...
			else
			{
				...
				for (i = 0; i <= 31; i = i + 1)
				{
					...
					if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr) && Plr != PLAYER::PLAYER_ID() && GANG::_NETWORK_IS_GANG_MEMBER(gangId, Plr) && !func_115(iParam0, 64, i))
						func_173(Plr, false, 120);
				}
			}
		}
	}
...
BOOL func_130() // Position - 0x3C3E
{
	return func_68(Global_1572887.f_8, 1);
}

int func_131(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, char* sParam6, BOOL bParam7) // Position - 0x3C51
{
	uParam0.f_2 = iParam5;
...
BOOL func_132(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, var uParam6, BOOL bParam7) // Position - 0x3C77
{
	var unk;
...
eStackSize func_133(int iParam0) // Position - 0x3CA7
{
	switch (iParam0)
	{
...
BOOL func_134(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x402A
{
...
BOOL func_135(Player plParam0, int iParam1) // Position - 0x4153
{
	switch (iParam1)
	{
		case 15:
...
BOOL func_136(Any* panParam0) // Position - 0x4186
{
	panParam0->f_2 = -310067910;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam0->f_1), panParam0);
}

BOOL func_137(Any* panParam0, int iParam1) // Position - 0x41A1
{
...
BOOL func_138(Any* panParam0, int iParam1) // Position - 0x41C2
{
...
BOOL func_139(Player plParam0, BOOL bParam1) // Position - 0x41E3
{
	Player player;
	int i;
...
BOOL func_140(Any anParam0) // Position - 0x4257
{
	Player gangLeader;
	int num;
	var unk;
...
BOOL func_141(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x42E3
{
	var data;
	int i;
	Hash crimeType;
...
int func_142(int iParam0) // Position - 0x4418
{
	int num;
	int num2;
	int i;
...
int func_143(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int* piParam6, BOOL bParam7) // Position - 0x447D
{
	uParam0.f_2 = iParam5;
...
int func_144() // Position - 0x44A3
{
	return Global_1902569;
}

int func_145(int iParam0) // Position - 0x44AF
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

Vector3 func_146(int iParam0, int iParam1) // Position - 0x44C2
{
	var unk;
	var unk4;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4502
{
...
BOOL func_148(Any* panParam0, int iParam1) // Position - 0x452C
{
...
BOOL func_149(int iParam0, var uParam1, var uParam2) // Position - 0x454D
{
	var unk;
...
struct<2> func_150(var uParam0, int iParam1) // Position - 0x4582
{
	int num;
...
struct<2> func_151() // Position - 0x46A8
{
	var unk;
...
Hash func_152(var uParam0, var uParam1) // Position - 0x46C1
{
	Hash num;
...
void func_153(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x46EB
{
	Player PlayerIndex;
	int num;
	int num2;
...
int func_154(var uParam0, var uParam1) // Position - 0x472D
{
	int i;
...
BOOL func_155(var uParam0, var uParam1) // Position - 0x4766
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(func_152(uParam0));
}

BOOL func_156(var uParam0, var uParam1) // Position - 0x477A
{
	return UNLOCK::UNLOCK_IS_VISIBLE(func_152(uParam0));
}

int func_157(int iParam0, int iParam1) // Position - 0x478E
{
	int i;
...
float func_158(int iParam0, int iParam1) // Position - 0x47D4
{
	float num;
	var unk;
...
var func_159(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x4819
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_188(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
void func_160(var uParam0, int iParam1, Player plParam2) // Position - 0x4BAC
{
	int num;
...
var func_161(BOOL bParam0, int iParam1) // Position - 0x4C23
{
	return func_159(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), bParam0, iParam1);
}

void func_162(Any* panParam0, var uParam1) // Position - 0x4C41
{
...
void func_163(int iParam0, int iParam1) // Position - 0x4C7E
{
	func_194(iParam0, iParam1);
	return;
}

BOOL func_164(int iParam0) // Position - 0x4C8E
{
	switch (iParam0)
	{
		case 2:
...
int func_165(int iParam0) // Position - 0x4CCD
{
	switch (iParam0)
	{
		case 2:
...
int func_166(int iParam0) // Position - 0x4D63
{
	switch (iParam0)
	{
		case 0:
...
void func_167(int iParam0) // Position - 0x4E7E
{
	int num;
	int num2;
...
int func_168(int iParam0, int iParam1, Any anParam2) // Position - 0x4F00
{
	Player Plr;
	int num;
	int i;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr) && GANG::_NETWORK_IS_GANG_MEMBER(anParam2, Plr) && func_65(Global_1206166[i /*10*/][iParam0], iParam1))
			num = num + 1;
	}
...
BOOL func_169(var uParam0) // Position - 0x4F6C
{
	return func_199(*uParam0, 1);
}

void func_170(var uParam0, BOOL bParam1) // Position - 0x4F7C
{
...
int func_171(var uParam0) // Position - 0x4F9C
{
	if (!func_169(uParam0))
		return 0;
...
void func_172(BOOL bParam0) // Position - 0x4FCD
{
	int num;
	Any gangId;
...
int func_173(Player plParam0, BOOL bParam1, int iParam2) // Position - 0x50A1
{
	BOOL flag;
	Any gangId;
	var unk;
...
BOOL func_174(int iParam0) // Position - 0x5138
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_175(BOOL bParam0, int iParam1) // Position - 0x5159
{
...
struct<2> func_177(Player plParam0) // Position - 0x51ED
{
	var gamerHandle;
...
BOOL func_178(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5201
{
...
BOOL func_179(int iParam0) // Position - 0x529F
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_180(int iParam0, var uParam1, Any* panParam2) // Position - 0x52DE
{
...
void func_181(int iParam0, Any* panParam1, var uParam2) // Position - 0x5312
{
	int num;
...
int func_182(var uParam0, Any* panParam1, int iParam2) // Position - 0x556D
{
	int num;
	int num2;
	int num3;
...
BOOL func_183(int iParam0, var uParam1, Any* panParam2) // Position - 0x55C2
{
	if (!func_122(iParam0))
		return false;
...
int func_184(int iParam0) // Position - 0x56CD
{
	switch (iParam0)
	{
		case 0:
...
int func_185(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float* pfParam6, BOOL bParam7) // Position - 0x575C
{
	uParam0.f_2 = iParam5;
...
int func_186() // Position - 0x5782
{
	return Global_1051645.f_12;
}

char* func_187() // Position - 0x5790
{
	return "unnamed";
}

BOOL func_188(int iParam0) // Position - 0x579C
{
	int num;
...
BOOL func_189(int iParam0) // Position - 0x582B
{
	if (Global_1572887.f_14 == -1)
		return false;
...
int func_190(int iParam0) // Position - 0x5849
{
	if (iParam0 == 255)
...
BOOL func_191(Player plParam0) // Position - 0x5894
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
void func_192(var uParam0, int iParam1, int iParam2, Player plParam3) // Position - 0x58D9
{
	var unk;
	var value;
...
void func_193(Any* panParam0) // Position - 0x5958
{
	panParam0->f_1 != 255;
...
void func_194(int iParam0, int iParam1) // Position - 0x597D
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

int func_195(int iParam0, int iParam1) // Position - 0x5992
{
	int num;
	var unk;
...
int func_196(int iParam0) // Position - 0x59D4
{
	switch (iParam0)
	{
		case 8:
...
BOOL func_197(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, int iParam6, int iParam7, BOOL bParam8, int iParam9, int iParam10) // Position - 0x5A1D
{
	int num;
	var unk22;
	var unk30;
...
void func_198(var uParam0) // Position - 0x5CA0
{
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
	*uParam0 = 0;
...
BOOL func_199(int iParam0, int iParam1) // Position - 0x5CB6
{
	return iParam0 && iParam1 != false;
}

void func_200(var uParam0) // Position - 0x5CC5
{
	func_239(uParam0, 0);
	return;
}

BOOL func_201(var uParam0) // Position - 0x5CD4
{
	return func_199(*uParam0, 2);
}

int func_202(int iParam0) // Position - 0x5CE4
{
	return NETWORK::GET_TIME_DIFFERENCE(iParam0, NETWORK::GET_NETWORK_TIME_ACCURATE());
}

BOOL func_203(int iParam0, var uParam1, var uParam2) // Position - 0x5CF6
{
	var unk;
	var gamerHandle2;
	BOOL flag;
...
int func_204(int iParam0) // Position - 0x5D97
{
	int num;
...
int func_205(int iParam0, var uParam1) // Position - 0x5F0C
{
	var unk;
...
int func_206(int iParam0) // Position - 0x5F29
{
	switch (iParam0)
	{
		case joaat("IWD_INF"):
...
int func_207(int iParam0) // Position - 0x607F
{
	switch (iParam0)
	{
...
int func_208(int iParam0) // Position - 0x60D6
{
	switch (iParam0)
	{
...
int func_209(int iParam0) // Position - 0x61B0
{
	switch (iParam0)
	{
		case -1641798436:
...
int func_210(int iParam0) // Position - 0x6248
{
	switch (iParam0)
	{
		case -1968391995:
...
void func_211(Any* panParam0) // Position - 0x63F2
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
BOOL func_212(int iParam0, int iParam1) // Position - 0x6408
{
	int num;
...
BOOL func_213(Player plParam0) // Position - 0x647C
{
...
void func_214(Player plParam0) // Position - 0x6499
{
	Player player;
...
void func_215(var uParam0, int iParam1, int iParam2) // Position - 0x651C
{
	func_246(iParam2, 8);
...
BOOL func_216(int iParam0, int iParam1) // Position - 0x65F6
{
...
BOOL func_217(Player plParam0) // Position - 0x661A
{
	Any gangId;
...
void func_218(Any* panParam0) // Position - 0x6644
{
	MISC::COPY_SCRIPT_STRUCT(&(Global_1572887.f_72.f_17), panParam0, 22);
	return;
}

void func_219(int iParam0, BOOL bParam1) // Position - 0x665C
{
...
void func_220(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x6677
{
...
void func_221(var uParam0, var uParam1, BOOL bParam2) // Position - 0x66A4
{
...
void func_222(int iParam0) // Position - 0x66C3
{
	Global_1572887.f_72.f_15 = iParam0;
	return;
}

void func_223(int iParam0) // Position - 0x66D5
{
	Global_1572887.f_72.f_13 = iParam0;
	return;
}

void func_224() // Position - 0x66E7
{
	Ped PedIndex;
	var entityCoords;
...
int func_226(var uParam0, var uParam1) // Position - 0x6751
{
	if (func_248())
		return 0;
...
void func_227() // Position - 0x677F
{
	Global_1056554[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*491*/].f_15.f_12 = 0;
	return;
}

void func_228(var uParam0, var uParam1) // Position - 0x6797
{
	int num;
	int num2;
	int num3;
...
BOOL func_229(BOOL bParam0) // Position - 0x683F
{
	return Global_1572887.f_72.f_15 && bParam0 != false;
}

int func_230(int iParam0, BOOL bParam1) // Position - 0x6854
{
	if (bParam1)
		func_253();
...
int func_231(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x6890
{
	int num;
	int num2;
	int num3;
...
const char* func_232(var uParam0, int iParam1) // Position - 0x6B56
{
...
char* func_233(int iParam0) // Position - 0x6B8C
{
	Hash hash;
...
int func_234() // Position - 0x6CE2
{
	return Global_1572887.f_72;
}

char* func_235(int iParam0, int iParam1) // Position - 0x6CF0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_236(int iParam0, BOOL bParam1) // Position - 0x6DCB
{
	BOOL flag;
...
int func_237(char* sParam0) // Position - 0x6E52
{
	const char* str;
	int num;
...
void func_238(int iParam0) // Position - 0x6E74
{
	Global_1572887.f_72.f_40 = iParam0;
	return;
}

void func_239(var uParam0, int iParam1) // Position - 0x6E86
{
...
struct<2> func_240() // Position - 0x6EC2
{
	var gamerHandle;
...
BOOL func_241(var uParam0, var uParam1) // Position - 0x6ED4
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0);
}

BOOL func_242(int iParam0, var uParam1, var uParam2) // Position - 0x6EE2
{
	var unk;
...
BOOL func_243(Any* panParam0, int iParam1, int iParam2) // Position - 0x6F09
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

void func_244(Player plParam0) // Position - 0x6F40
{
	Player player;
...
void func_245(Player plParam0) // Position - 0x6FAC
{
...
void func_246(int iParam0, int iParam1) // Position - 0x6FE7
{
	func_163(&(Global_1206497.f_78[iParam0 /*20*/].f_6), iParam1);
	return;
}

void func_247() // Position - 0x7001
{
	Player player;
...
BOOL func_248() // Position - 0x7116
{
	return func_122(Global_1051268);
}

int func_249(var uParam0, var uParam1) // Position - 0x7128
{
	int i;
...
int func_250(int iParam0) // Position - 0x7161
{
	return Global_1206497.f_78[iParam0 /*20*/].f_3;
}

int func_251(int iParam0) // Position - 0x7175
{
	return Global_1205938.f_1[iParam0 /*26*/].f_3;
}

struct<8> func_252(int iParam0, int iParam1) // Position - 0x7189
{
	var unk;
	var unk9;
...
BOOL func_254(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x71EC
{
	BOOL flag;
...
void func_255(int iParam0) // Position - 0x7214
{
	Global_1896762.f_365 = iParam0;
	return;
}

void func_256(var uParam0, int iParam1) // Position - 0x7225
{
	uParam0->f_15 = uParam0->f_15 || iParam1;
	return;
}

int func_257(Hash hParam0) // Position - 0x7238
{
	int i;
...
void func_258(char* sParam0) // Position - 0x728F
{
	TEXT_LABEL_ASSIGN_STRING(&(Global_1572887.f_72.f_60.f_6), sParam0, 32);
	return;
}

BOOL func_259(int iParam0) // Position - 0x72A5
{
...
BOOL func_260(int iParam0) // Position - 0x72BD
{
...
int func_261(Hash hParam0) // Position - 0x72D5
{
	int i;
...
Vector3 func_262(int iParam0) // Position - 0x730E
{
	int num;
	int num2;
	int i;
...
struct<2> func_263(int iParam0) // Position - 0x73F3
{
...
BOOL func_264(int iParam0) // Position - 0x7420
{
	if (iParam0 == 0)
		return false;
...
int func_265(int iParam0) // Position - 0x743A
{
	int i;
	int num;
...
struct<2> func_266(int iParam0) // Position - 0x746C
{
	return func_290(iParam0);
}

struct<2> func_267(var uParam0) // Position - 0x747A
{
	var unk;
	var unk6;
...
struct<2> func_268(int iParam0) // Position - 0x7514
{
	var unk;
...
struct<2> func_269(int iParam0) // Position - 0x75E4
{
	var unk;
	var unk6;
...
int func_270(int iParam0) // Position - 0x7636
{
	switch (iParam0)
	{
		case -933924539:
...
void func_271(var uParam0) // Position - 0x7671
{
	uParam0->f_15 = 0;
	return;
}

const char* func_272(const char* sParam0, int iParam1) // Position - 0x767E
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

Hash func_273(Hash hParam0) // Position - 0x7698
{
	int i;
...
int func_274(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x76DC
{
	int num;
	var unk13;
	int num2;
...
void func_275(var uParam0, int iParam1) // Position - 0x7717
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_276(var uParam0, int iParam1) // Position - 0x7728
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_277(int iParam0, var uParam1, Any* panParam2) // Position - 0x773D
{
	*panParam2 = Global_1149432.f_7;
...
void func_278(Any* panParam0, int iParam1, var uParam2) // Position - 0x7771
{
	var unk;
...
void func_279(BOOL bParam0, int iParam1) // Position - 0x77EB
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_280(Any* panParam0) // Position - 0x7800
{
	panParam0->f_2 = 1701407264;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam0->f_1), panParam0);
}

BOOL func_281() // Position - 0x781B
{
	return Global_1915656.f_20643;
}

BOOL func_282(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x782A
{
	Player PlayerIndex;
	Ped EntityIndex;
	BOOL isEntityDead;
...
int func_283(int iParam0, int iParam1) // Position - 0x7A50
{
	switch (iParam0)
	{
		case -1957416901:
...
int func_284(int iParam0, int iParam1) // Position - 0x7AE2
{
	switch (iParam0)
	{
		case -1918441640:
...
Hash func_285(int iParam0) // Position - 0x7BCC
{
	if (!func_294(iParam0))
		return 0;
...
BOOL func_286(Any* panParam0) // Position - 0x7BF8
{
	int fileHandle;
	var SourceStruct;
...
BOOL func_287(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x7C3A
{
	var unk;
...
int func_288(Any anParam0, int iParam1) // Position - 0x7C73
{
	anParam0->f_2 = iParam1;
	return DATAFILE::_PARSEDDATA_RQ_GET_NUM_NODES(anParam0);
}

int func_289(int iParam0) // Position - 0x7C87
{
	return Global_1295849[iParam0 /*37*/].f_9;
}

struct<2> func_290(int iParam0) // Position - 0x7C99
{
	var DestStruct;
...
var func_291(Any* panParam0) // Position - 0x7CC3
{
	return func_295(panParam0, 67, 1);
}

BOOL func_292(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7CD4
{
...
BOOL func_293() // Position - 0x7D05
{
	return ANIMSCENE::DOES_ANIM_SCENE_EXIST(Global_26573) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(Global_26573, false);
}

BOOL func_294(int iParam0) // Position - 0x7D21
{
	return iParam0 > -1 && iParam0 <= 80;
}

var func_295(Any* panParam0, int iParam1, int iParam2) // Position - 0x7D37
{
	var unk;
