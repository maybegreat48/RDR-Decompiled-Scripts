...
void func_7() // Position - 0x292
{
	return;
}

void func_8() // Position - 0x29A
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x2A6
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x2CE
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x2F6
{
	struct<2> data;
...
BOOL func_12(var uParam0) // Position - 0x31E
{
	return func_18(*uParam0, 1);
}

void func_13(var uParam0) // Position - 0x32E
{
	func_19(uParam0, 0f);
	return;
}

float func_14(var uParam0) // Position - 0x33D
{
	if (!func_12(uParam0))
		return uParam0->f_1;
...
void func_15(var uParam0) // Position - 0x372
{
	return;
}

void func_16(var uParam0) // Position - 0x37A
{
	return;
}

void func_17(var uParam0) // Position - 0x382
{
	return;
}

BOOL func_18(int iParam0, int iParam1) // Position - 0x38A
{
	return iParam0 && iParam1 != false;
}

void func_19(var uParam0, float fParam1) // Position - 0x399
{
...
BOOL func_20(var uParam0) // Position - 0x3BF
{
	return func_18(*uParam0, 2);
}

float func_21() // Position - 0x3CF
{
...
void func_22(var uParam0, int iParam1) // Position - 0x401
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_23(var uParam0, int iParam1) // Position - 0x412
{
