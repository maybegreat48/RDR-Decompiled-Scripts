...
void func_1(BOOL bParam0) // Position - 0x406
{
...
void func_3(var uParam0, var uParam1) // Position - 0x455
{
	*uParam1 = uParam0->f_2;
...
float func_4(var uParam0, var uParam1) // Position - 0x473
{
	float num;
	Hash entityModel;
...
void func_6(var uParam0) // Position - 0x6A1
{
...
void func_7(var uParam0) // Position - 0x7B2
{
...
void func_8(var uParam0) // Position - 0x7E1
{
	if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 574156416))
	{
		PED::_ADD_SCENARIO_TRANSITION(Global_33);
...
int func_9(var uParam0) // Position - 0x810
{
...
BOOL func_10(Hash hParam0, int iParam1) // Position - 0x87F
{
	if (hParam0 == 0)
		return false;
...
void func_11(var uParam0) // Position - 0x899
{
	int i;
...
void func_12(var uParam0, int iParam1) // Position - 0x8D9
{
	*uParam0 = iParam1;
	return;
}

void func_13(Hash hParam0) // Position - 0x8E6
{
...
void func_14(float fParam0) // Position - 0x9D4
{
	if (fParam0 > 0f)
	{
		if (func_23())
...
void func_15(var uParam0, BOOL bParam1) // Position - 0x9FB
{
	int i;
	float num;
	float num2;
...
void func_16(int iParam0, BOOL bParam1) // Position - 0xDA2
{
	var unk;
	var unk11;
...
Hash func_17(Hash hParam0, Hash hParam1) // Position - 0xF6D
{
...
int func_18() // Position - 0xFBF
{
	return Global_1572887.f_14;
}

BOOL func_19(int iParam0) // Position - 0xFCD
{
	return false;
}

BOOL func_20(Hash hParam0, Hash hParam1) // Position - 0xFD6
{
...
BOOL func_21(Ped pedParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x1017
{
	char* str;
...
void func_22(var uParam0) // Position - 0x105E
{
	if (!uParam0->f_176)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_174))
...
void func_24(float fParam0, BOOL bParam1) // Position - 0x109C
{
	func_53(Global_1940026.f_9 + fParam0, bParam1);
	return;
}

BOOL func_25(int iParam0) // Position - 0x10B3
{
	switch (iParam0)
	{
...
float func_26(int iParam0, float fParam1) // Position - 0x112B
{
	float pedStamina;
	float pedMaxStamina;
	float num;
...
void func_27(float fParam0) // Position - 0x11BC
{
	Ped ped;
	int num;
...
void func_28(float fParam0, BOOL bParam1) // Position - 0x11FC
{
	int num;
...
void func_29(float fParam0) // Position - 0x1234
{
	Ped ped;
	int num;
...
float func_30(float fParam0, float fParam1) // Position - 0x1274
{
	if (fParam1 != 0f)
...
void func_31(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x12A2
{
	if (fParam1 == 0f)
		return;
...
void func_32(float fParam0, BOOL bParam1) // Position - 0x12DB
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
float func_33(float fParam0, int iParam1) // Position - 0x1333
{
	switch (iParam1)
	{
		case 0:
...
int func_34(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1385
{
...
void func_35(var uParam0) // Position - 0x13A9
{
	switch (*uParam0)
	{
		case -2109344034:
...
void func_36(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x1429
{
...
int func_37(int iParam0) // Position - 0x1693
{
	var unk;
...
void func_38(int iParam0) // Position - 0x16EB
{
	func_74(iParam0);
	func_75(true, true);
	return;
...
int func_39(int iParam0, int iParam1, int iParam2) // Position - 0x16FF
{
	int num;
...
struct<2> func_42(int iParam0, int iParam1) // Position - 0x17CF
{
	int num;
...
void func_43(var uParam0, var uParam1, int iParam2) // Position - 0x17E5
{
...
void func_44(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, int iParam16) // Position - 0x1802
{
	int i;
...
void func_45(int iParam0) // Position - 0x189E
{
	int num;
	int num2;
	int i;
...
BOOL func_46() // Position - 0x196E
{
	return func_89(1);
}

void func_47() // Position - 0x197B
{
	func_45(joaat("STATUS_EFFECT__POISON"));
...
int func_48(Hash hParam0, int iParam1) // Position - 0x1995
{
	var unk;
	int num;
	int i;
...
Hash func_49(Hash hParam0) // Position - 0x19DF
{
	return hParam0;
}

BOOL func_50(Hash hParam0, Hash hParam1) // Position - 0x19E9
{
...
BOOL func_51(Ped pedParam0, Any* panParam1) // Position - 0x1A1F
{
	return AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, panParam1);
}

BOOL func_52() // Position - 0x1A2F
{
	return func_92(func_91(0));
}

void func_53(float fParam0, BOOL bParam1) // Position - 0x1A40
{
...
int func_54(int iParam0) // Position - 0x1AE3
{
	if (iParam0 == 2)
		iParam0 = func_94(1);
...
void func_55(float fParam0, Ped pedParam1) // Position - 0x1B23
{
	if (fParam0 == 0f)
		return;
...
int func_56(int iParam0) // Position - 0x1B67
{
	if (iParam0 == 2)
		iParam0 = func_94(1);
...
void func_57(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1BAB
{
	Player player;
	Ped EntityIndex;
...
int func_58(int iParam0) // Position - 0x1C5C
{
	if (iParam0 == 2)
		iParam0 = func_94(1);
...
void func_59(float fParam0, Ped pedParam1) // Position - 0x1CA0
{
	if (fParam0 == 0f)
		return;
...
float func_60(int iParam0, float fParam1, BOOL bParam2) // Position - 0x1CE2
{
	int num;
	int num2;
...
float func_61(int iParam0, int iParam1) // Position - 0x1D4B
{
	if (iParam1 == 2)
		iParam1 = func_94(2);
...
int func_62(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x1D97
{
	Ped ped;
...
void func_64(float fParam0, int iParam1) // Position - 0x1E3A
{
	float num;
	int num2;
	int num3;
...
void func_65(int iParam0, BOOL bParam1) // Position - 0x1EAD
{
	int num;
	int num2;
...
int func_66(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1EDA
{
	char* effectName;
	Ped ped;
...
struct<2> func_67(int iParam0) // Position - 0x2090
{
	int num;
...
int func_68(Hash hParam0) // Position - 0x20A0
{
	switch (hParam0)
	{
		case joaat("consumable_herb_common_bulrush"):
...
void func_69(int iParam0, int iParam1) // Position - 0x227B
{
	var statId;
...
void func_70(Hash hParam0, int iParam1) // Position - 0x22AD
{
	int num;
...
BOOL func_71(Any* panParam0) // Position - 0x244E
{
	var SourceStruct;
...
BOOL func_72(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x247D
{
	var unk;
...
int func_73(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x24B6
{
	return func_125(&uParam0, 61, 1);
}

void func_74(int iParam0) // Position - 0x24C7
{
	int num;
...
void func_75(BOOL bParam0, BOOL bParam1) // Position - 0x2516
{
	if (func_132(255) == 4)
		return;
...
BOOL func_76(int iParam0) // Position - 0x2661
{
	int num;
...
BOOL func_77(int iParam0) // Position - 0x2689
{
	int num;
...
BOOL func_78(int iParam0) // Position - 0x26B1
{
	int num;
...
BOOL func_79(int iParam0) // Position - 0x26D9
{
	int num;
...
BOOL func_80(int iParam0) // Position - 0x2701
{
	if (!func_79(iParam0))
		return false;
...
int func_81(int iParam0) // Position - 0x272E
{
	int num;
	int num2;
	int num3;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_82(int iParam0, int iParam1) // Position - 0x29BE
{
	int num;
	int num2;
	int num3;
...
int func_83(int iParam0) // Position - 0x2B76
{
	int num;
...
BOOL func_84() // Position - 0x2C10
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

BOOL func_85(int iParam0, int iParam1) // Position - 0x2C35
{
	return iParam0 && iParam1 != false;
}

BOOL func_86(const char* sParam0) // Position - 0x2C44
{
	int i;
...
void func_87(int iParam0) // Position - 0x2C7E
{
...
int func_88(int iParam0, int iParam1) // Position - 0x2C95
{
	switch (iParam0)
	{
		case -2101912686:
...
BOOL func_89(int iParam0) // Position - 0x3496
{
	return func_158(iParam0);
}

BOOL func_90(Hash hParam0, int iParam1) // Position - 0x34A4
{
	if (hParam0 == 0)
		return false;
...
struct<2> func_91(int iParam0) // Position - 0x34BE
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_92(var uParam0, var uParam1) // Position - 0x34D2
{
	return func_159(uParam0, 1, 4);
}

float func_93() // Position - 0x34E4
{
	return 0.75f;
}

int func_94(int iParam0) // Position - 0x34F1
{
	return func_161(func_160(iParam0));
}

BOOL func_95(Player plParam0) // Position - 0x3503
{
	float num;
...
int func_96() // Position - 0x351E
{
	return Global_1902569;
}

void func_97(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x352A
{
	int num;
	int i;
	int j;
...
int func_98(int iParam0, int iParam1) // Position - 0x369D
{
	if (iParam1 == 2)
		iParam1 = func_94(2);
...
int func_99(int iParam0, int iParam1) // Position - 0x36ED
{
	if (iParam1 == 2)
		iParam1 = func_94(2);
...
BOOL func_100(int iParam0, int iParam1, BOOL bParam2) // Position - 0x373F
{
	if (bParam2)
...
void func_101(int iParam0, int iParam1, int iParam2) // Position - 0x376C
{
	if (iParam2 == 2)
		iParam2 = func_94(2);
...
void func_102(int iParam0, int iParam1, int iParam2) // Position - 0x37C2
{
	if (iParam2 == 2)
		iParam2 = func_94(2);
...
BOOL func_103(Ped pedParam0, int iParam1, float fParam2) // Position - 0x3818
{
...
void func_104(int iParam0, int iParam1, int iParam2) // Position - 0x386D
{
	if (iParam2 == 2)
		iParam2 = func_94(2);
...
void func_105(Ped pedParam0, int iParam1, float fParam2) // Position - 0x38CE
{
	char* StringToTest;

	StringToTest = func_173(iParam1);
...
void func_106(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x38FA
{
	int num;
...
BOOL func_107(int iParam0, BOOL bParam1) // Position - 0x3930
{
	return func_100(func_96(), iParam0, bParam1);
}

float func_108(int iParam0, int iParam1) // Position - 0x3944
{
	if (iParam1 == 2)
		iParam1 = func_94(1);
...
int func_109(float fParam0) // Position - 0x3990
{
	float num;
...
float func_110(float fParam0, float fParam1, float fParam2) // Position - 0x39BB
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_111(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x39E2
{
	int num;
	int i;
	int num2;
...
int func_112(int iParam0, float fParam1, int iParam2) // Position - 0x3B6A
{
	if (!func_177(iParam0))
		return 0;
...
void func_113(int iParam0, var uParam1, var uParam2) // Position - 0x3BBB
{
	int num;
...
BOOL func_114(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3BD7
{
...
void func_115(int iParam0, int iParam1) // Position - 0x3C79
{
	int Variable;
...
BOOL func_116(int iParam0) // Position - 0x3C9D
{
	switch (iParam0)
	{
		case 0:
...
char* func_117(int iParam0) // Position - 0x3CCC
{
	switch (iParam0)
	{
		case 0:
...
void func_118(int iParam0) // Position - 0x3D03
{
	Ped ped;
	int num;
...
void func_119(int iParam0) // Position - 0x3D40
{
	Ped ped;
	int num;
...
void func_120(int iParam0, BOOL bParam1) // Position - 0x3D7D
{
	int num;
...
void func_121(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3DB2
{
	func_62(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

int func_122(int iParam0) // Position - 0x3DCC
{
	switch (iParam0)
	{
		case 1:
...
struct<2> func_123(int iParam0) // Position - 0x4164
{
	var unk;
...
BOOL func_124(int iParam0) // Position - 0x4176
{
...
var func_125(Any* panParam0, int iParam1, int iParam2) // Position - 0x41B1
{
	var unk;
...
void func_126(int iParam0) // Position - 0x41CC
{
	Global_1953292.f_1 = iParam0;
	return;
}

void func_127() // Position - 0x41DC
{
	func_185(128);
	return;
}

void func_128(BOOL bParam0) // Position - 0x41EA
{
	Global_1953292 = Global_1953292 - Global_1953292 && bParam0;
	return;
}

BOOL func_129(int iParam0, var uParam1) // Position - 0x4202
{
	int num;
...
int func_130(int iParam0) // Position - 0x425F
{
...
void func_131(int iParam0) // Position - 0x42F1
{
	Global_1953292.f_3 = iParam0;
	return;
}

int func_132(int iParam0) // Position - 0x4301
{
	if (iParam0 == 255)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x434C
{
...
int func_134(int iParam0) // Position - 0x4376
{
...
void func_135(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x4393
{
	func_191(iParam0);
...
int func_136(int iParam0) // Position - 0x43F5
{
...
void func_137(var uParam0) // Position - 0x4412
{
	var unk;
...
void func_138(float* pfParam0) // Position - 0x4424
{
	var unk;
...
void func_140(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x448C
{
	switch (uParam0.f_5)
	{
		case 1:
...
int func_141(int iParam0, int iParam1) // Position - 0x44B9
{
	switch (iParam0)
	{
...
int func_142(int iParam0, int iParam1) // Position - 0x4B70
{
	Player player;
	Player player2;
	int num;
...
int func_143(int iParam0, int iParam1, int iParam2) // Position - 0x4BF3
{
	int num;
	int num2;
...
void func_144(int iParam0) // Position - 0x4CEB
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_145(int iParam0, int iParam1) // Position - 0x4D01
{
	switch (iParam0)
	{
...
int func_149(int iParam0, int iParam1) // Position - 0x562B
{
	Player player;
	Player player2;
	int num;
...
int func_150(int iParam0, int iParam1, int iParam2) // Position - 0x56A6
{
	int num;
	BOOL flag;
	int num2;
...
BOOL func_151(int iParam0) // Position - 0x577D
{
	int num;
...
BOOL func_152(int iParam0) // Position - 0x57A4
{
	int num;
...
BOOL func_153(int iParam0) // Position - 0x57CC
{
	int num;
...
BOOL func_154(int iParam0) // Position - 0x57F4
{
	int num;
...
BOOL func_155(int iParam0) // Position - 0x581C
{
	int num;
...
BOOL func_156(int iParam0) // Position - 0x5844
{
	int num;
...
void func_157(int iParam0) // Position - 0x586C
{
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		if (iParam0 == 1)
...
BOOL func_158(int iParam0) // Position - 0x58AF
{
	return func_211(Global_1940085.f_38, iParam0);
}

BOOL func_159(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x58C3
{
	int num;
...
BOOL func_160(int iParam0) // Position - 0x58FE
{
	return func_214(&(Global_1956875.f_1565), iParam0, 1);
}

int func_161(BOOL bParam0) // Position - 0x5914
{
	if (bParam0)
		return 1;
...
float func_162(Player plParam0) // Position - 0x5926
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_215(2);
}

int func_163(int iParam0) // Position - 0x593C
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_164(int iParam0) // Position - 0x5961
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_165(int iParam0) // Position - 0x5974
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_166(int iParam0) // Position - 0x5987
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_167(int iParam0) // Position - 0x599A
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_168(int iParam0) // Position - 0x59AC
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_169(int iParam0, int iParam1) // Position - 0x59BE
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5A58
{
...
BOOL func_171(int iParam0) // Position - 0x5A90
{
	int num;
	int num2;
	int num3;
...
int func_172(int iParam0) // Position - 0x5B6C
{
	switch (iParam0)
	{
		case 0:
...
char* func_173(int iParam0) // Position - 0x5B9B
{
	switch (iParam0)
	{
		case 0:
...
char* func_174(int iParam0) // Position - 0x5BD5
{
	switch (iParam0)
	{
		case 0:
...
void func_175(int iParam0, float fParam1, int iParam2) // Position - 0x5C0F
{
	if (iParam2 == 2)
		iParam2 = func_94(2);
...
void func_176(int iParam0, int iParam1, int iParam2) // Position - 0x5C61
{
	if (iParam2 == 2)
		iParam2 = func_94(2);
...
BOOL func_177(int iParam0) // Position - 0x5CB7
{
	if (func_116(iParam0))
		return true;
...
void func_178(int iParam0, float fParam1, int iParam2) // Position - 0x5CDD
{
	if (fParam1 < 0f)
		return;
...
BOOL func_179(int iParam0, int iParam1) // Position - 0x5D39
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_180(int iParam0) // Position - 0x5D51
{
...
BOOL func_181(int iParam0) // Position - 0x5D68
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_182(int iParam0, int iParam1) // Position - 0x5E34
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_183(int iParam0) // Position - 0x5E4D
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_184() // Position - 0x5E60
{
	if (!func_224())
		return false;
...
void func_185(int iParam0) // Position - 0x5E7B
{
	func_225(&Global_1300385, iParam0);
	return;
}

int func_186(int iParam0, int iParam1) // Position - 0x5E8D
{
	int num;
...
int func_187(int iParam0) // Position - 0x5EBA
{
	return Global_1300387.f_52[iParam0 /*3*/].f_1;
}

int func_188(Any anParam0, int iParam1) // Position - 0x5ECE
{
	anParam0->f_2 = iParam1;
	return DATAFILE::_PARSEDDATA_RQ_GET_NUM_NODES(anParam0);
}

int func_189(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x5EE2
{
	return func_125(&uParam0, 61, 0);
}

BOOL func_190(Any* panParam0, int iParam1, int iParam2) // Position - 0x5EF3
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_196(BOOL bParam0) // Position - 0x5FC2
{
	if (func_228(bParam0))
		return;
...
BOOL func_197(Any* panParam0, int iParam1, int iParam2) // Position - 0x5FE9
{
	int num;
	int offset;
	BOOL isBitSet;
...
Player func_198(int iParam0) // Position - 0x601C
{
	if (func_151(iParam0))
...
BOOL func_199(int iParam0) // Position - 0x603D
{
	int num;
...
BOOL func_200(int iParam0, int iParam1, int iParam2) // Position - 0x6065
{
	int num;
	int num2;
	int num3;
...
BOOL func_201(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x6256
{
	return uParam0.f_4 != 0;
}

BOOL func_202(int iParam0, int iParam1) // Position - 0x6264
{
	int num;
...
Vector3 func_203(int iParam0) // Position - 0x62A4
{
	int num;
	var unk;
...
BOOL func_204(int iParam0, var uParam1, var uParam2) // Position - 0x62E0
{
	if (!func_199(iParam0))
		return false;
...
BOOL func_205(int iParam0, int iParam1, int iParam2) // Position - 0x6317
{
	int num;
	int num2;
	int num3;
...
void func_206(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6545
{
	int num;
...
void func_207(int iParam0) // Position - 0x65C4
{
	int num;
...
BOOL func_208(int iParam0) // Position - 0x6619
{
...
BOOL func_209(int iParam0) // Position - 0x6637
{
	int num;
...
Vector3 func_210(int iParam0) // Position - 0x6664
{
	var unk;
	int num;
...
BOOL func_211(int iParam0, int iParam1) // Position - 0x66A5
{
	return iParam0 && iParam1 != false;
}

BOOL func_212(var uParam0, var uParam1) // Position - 0x66B4
{
	if (!func_244(uParam0))
		return false;
...
int func_213(int iParam0, var uParam1) // Position - 0x66E8
{
	if (iParam0 == 2)
...
BOOL func_214(Any* panParam0, int iParam1, int iParam2) // Position - 0x6702
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_215(int iParam0) // Position - 0x6739
{
	switch (iParam0)
	{
		case 0:
...
var func_216(BOOL bParam0, var uParam1, var uParam2) // Position - 0x677A
{
	if (bParam0)
		return uParam1;
...
void func_217(int iParam0, int iParam1) // Position - 0x6791
{
	if (iParam1 < 0)
		return;
...
void func_218(int iParam0, int iParam1) // Position - 0x6817
{
...
void func_219(int iParam0, int iParam1) // Position - 0x6853
{
	int num;
	int num2;
...
void func_220(int iParam0, int iParam1) // Position - 0x68A6
{
...
void func_221(int iParam0, int iParam1) // Position - 0x68E1
{
...
void func_222(int iParam0, int iParam1) // Position - 0x691A
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_223(int iParam0) // Position - 0x6952
{
	switch (iParam0)
	{
		case 12:
...
void func_225(int iParam0, int iParam1) // Position - 0x698B
{
	func_247(iParam0, iParam1);
	return;
}

int func_226(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x699B
{
	int num;
...
int func_227(int iParam0, int iParam1) // Position - 0x6A07
{
	return Global_1300387.f_84[iParam0 /*21*/][iParam1 /*2*/].f_1;
}

BOOL func_228(BOOL bParam0) // Position - 0x6A1F
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

int func_229(int iParam0, int iParam1) // Position - 0x6A35
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_230(int iParam0) // Position - 0x6E6E
{
	int num;
...
float func_231(int iParam0) // Position - 0x6E96
{
	float num;
...
void func_232(int iParam0) // Position - 0x6EC5
{
	int num;
	int num2;
	int i;
...
BOOL func_233(int iParam0) // Position - 0x70A4
{
	int num;
...
int func_234(int iParam0, int iParam1) // Position - 0x70CC
{
	switch (iParam0)
	{
...
void func_235(int iParam0) // Position - 0x73DC
{
	Ped ped;
	Player player;
...
BOOL func_236(int iParam0) // Position - 0x75EB
{
	int num;
...
int func_237(int iParam0, int iParam1) // Position - 0x7612
{
	switch (iParam0)
	{
...
int func_238(int iParam0) // Position - 0x766F
{
	int num;
	var unk;
	var unk32;
...
void func_239(int iParam0) // Position - 0x77B3
{
	int num;
	int num2;
	int i;
...
BOOL func_240(int iParam0) // Position - 0x7908
{
	BOOL flag;
...
void func_241(int iParam0) // Position - 0x7931
{
	Ped EntityIndex;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_255(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_261(iParam0, 0));
			func_262(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_261(iParam0, 1));
			func_262(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_261(iParam0, 2));
			func_262(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_261(iParam0, 3));
			func_262(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_242(int iParam0) // Position - 0x7BCC
{
	char* StringToTest;
	char* StringToTest2;
	...
	StringToTest = func_264(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	StringToTest2 = func_265(iParam0);
...
int func_243(int iParam0) // Position - 0x7C16
{
	int num;
...
BOOL func_244(int iParam0) // Position - 0x7C45
{
	switch (iParam0)
	{
		case 2:
...
int func_245(int iParam0) // Position - 0x7C84
{
	switch (iParam0)
	{
		case 2:
...
int func_246(var uParam0, var uParam1) // Position - 0x7D1A
{
	var unk;
...
void func_247(int iParam0, int iParam1) // Position - 0x7D46
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

float func_248(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x7D57
{
	var unk;
	float num;
...
BOOL func_249(int iParam0) // Position - 0x7D8D
{
...
BOOL func_250(int iParam0) // Position - 0x7DFC
{
	int num;
...
int func_251(int iParam0, int iParam1) // Position - 0x7E23
{
	switch (iParam0)
	{
...
char* func_254(int iParam0) // Position - 0x7F12
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_255(int iParam0) // Position - 0x7F59
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_256(int iParam0) // Position - 0x7F94
{
	int i;
...
BOOL func_258(int iParam0, int iParam1) // Position - 0x7FF4
{
	int num;
	Player player;
	int num2;
...
struct<31> func_259(int iParam0) // Position - 0x82CA
{
	int num;
...
BOOL func_260(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0x82EE
{
	var unk;
	BOOL flag;
...
char* func_261(int iParam0, int iParam1) // Position - 0x8324
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_262(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x837C
{
	int i;
...
char* func_264(int iParam0) // Position - 0x8426
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_265(int iParam0) // Position - 0x8446
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_266(int iParam0, var uParam1, Any* panParam2) // Position - 0x8466
{
	if (!func_212(iParam0))
		return false;
...
BOOL func_267(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x8571
{
	int num;
	int num2;
...
BOOL func_268() // Position - 0x8792
{
	return Global_1572887.f_7;
}

BOOL func_269() // Position - 0x87A0
{
	if (!Global_1048577)
		return false;
...
BOOL func_270(Player plParam0) // Position - 0x87EB
{
...
BOOL func_271(int iParam0, Player plParam1) // Position - 0x8830
{
	if (plParam1 == 255)
...
void func_272(Any* panParam0) // Position - 0x885C
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
int func_273(int iParam0) // Position - 0x8872
{
	int num;
...
void func_276(Player plParam0) // Position - 0x890D
{
	Player player;
...
void func_277(Player plParam0) // Position - 0x8990
{
	Player player;
...
void func_278(Player plParam0) // Position - 0x89FC
{
