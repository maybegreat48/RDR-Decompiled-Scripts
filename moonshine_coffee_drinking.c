...
void func_1(BOOL bParam0) // Position - 0x339
{
...
void func_2(var uParam0) // Position - 0x374
{
	return;
}

void func_3() // Position - 0x37C
{
	func_21(&(Global_1072759.f_28313.f_1), 1073741824);
	return;
}

int func_4(var uParam0) // Position - 0x396
{
	int i;
	int num;
...
BOOL func_5(Hash hParam0, int iParam1) // Position - 0x423
{
	if (hParam0 == 0)
		return false;
...
void func_6(var uParam0) // Position - 0x43D
{
	int i;
...
void func_7(var uParam0, int iParam1) // Position - 0x47D
{
	*uParam0 = iParam1;
	return;
}

void func_8(var uParam0) // Position - 0x48A
{
...
BOOL func_9(int iParam0, int iParam1) // Position - 0x50F
{
	return iParam0 && iParam1 != false;
}

void func_10(var uParam0, int iParam1) // Position - 0x51E
{
	func_30(uParam0, iParam1);
	return;
}

void func_11(var uParam0, BOOL bParam1) // Position - 0x52E
{
	int i;
...
void func_12(var uParam0, int iParam1) // Position - 0x567
{
	func_32(uParam0, iParam1);
	return;
}

BOOL func_13(int iParam0, BOOL bParam1) // Position - 0x577
{
	int num;
...
void func_14(var uParam0) // Position - 0x5AA
{
	func_34(&(uParam0->f_180));
	return;
}

BOOL func_15(int iParam0) // Position - 0x5BA
{
	return iParam0 > -1 && iParam0 < 2;
}

void func_16(float fParam0, BOOL bParam1) // Position - 0x5CF
{
	func_35(Global_1940026.f_9 + fParam0, bParam1);
	return;
}

BOOL func_17() // Position - 0x5E6
{
	return Global_1940026 == 2;
}

void func_18(int iParam0) // Position - 0x5F4
{
...
BOOL func_19() // Position - 0x610
{
	return Global_1940026 == 1;
}

void func_20(var uParam0, BOOL bParam1) // Position - 0x61E
{
	int i;
	float num;
	float num2;
...
void func_21(BOOL bParam0, int iParam1) // Position - 0x9C5
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

BOOL func_22(int iParam0) // Position - 0x9D6
{
	if (iParam0 < 0)
		return false;
...
char* func_23(int iParam0) // Position - 0xA15
{
...
void func_24(int iParam0, char* sParam1, BOOL bParam2) // Position - 0xB16
{
	int num;
...
Hash func_25(int iParam0) // Position - 0xB5F
{
	switch (iParam0)
	{
		case 0:
...
int func_26(int iParam0) // Position - 0xB8C
{
	switch (iParam0)
	{
		case 0:
...
int func_27(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, Hash hParam10, int iParam11) // Position - 0xBB1
{
	int i;
	int num;
...
void func_28(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xC3A
{
	int num;
...
BOOL func_29() // Position - 0xC85
{
	return func_19() || func_17();
}

void func_30(var uParam0, int iParam1) // Position - 0xC9B
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_31(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xCAC
{
	int num;
...
void func_32(var uParam0, int iParam1) // Position - 0xD00
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_33(int iParam0) // Position - 0xD15
{
	return iParam0;
}

void func_34(var uParam0) // Position - 0xD1F
{
	int i;
...
void func_35(float fParam0, BOOL bParam1) // Position - 0xD47
{
...
BOOL func_36(Hash hParam0, Hash hParam1) // Position - 0xDEA
{
	if (!func_5(hParam0, 0))
...
BOOL func_37(int iParam0) // Position - 0xE2B
{
	switch (iParam0)
	{
...
float func_38(int iParam0, float fParam1) // Position - 0xEA3
{
	float pedStamina;
	float pedMaxStamina;
	float num;
...
void func_39(float fParam0) // Position - 0xF34
{
	Ped ped;
	int num;
...
void func_40(float fParam0, BOOL bParam1) // Position - 0xF74
{
	int num;
...
void func_41(float fParam0) // Position - 0xFAC
{
	Ped ped;
	int num;
...
float func_42(float fParam0, float fParam1) // Position - 0xFEC
{
	if (fParam1 != 0f)
...
void func_43(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x101A
{
	if (fParam1 == 0f)
		return;
...
void func_44(float fParam0, BOOL bParam1) // Position - 0x1053
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
float func_45(float fParam0, int iParam1) // Position - 0x10AB
{
	switch (iParam1)
	{
		case 0:
...
int func_46(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10FD
{
...
void func_47(var uParam0) // Position - 0x1121
{
	switch (*uParam0)
	{
		case -2109344034:
...
void func_48(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0x11A1
{
...
void func_49(var uParam0) // Position - 0x140B
{
	if (!uParam0->f_176)
	{
...
const char* func_50(int iParam0) // Position - 0x1435
{
	return MISC::_GET_STRING_FROM_FLOAT(BUILTIN::TO_FLOAT(iParam0), 0);
}

char* func_51(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1448
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x145C
{
	if (iParam0 < 0)
		return false;
...
void func_54(int iParam0, int iParam1) // Position - 0x1797
{
	if (iParam0 < 0)
		return;
...
void func_55(int iParam0, BOOL bParam1) // Position - 0x17CA
{
...
void func_56(int iParam0, BOOL bParam1) // Position - 0x1822
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_57(int iParam0, int iParam1) // Position - 0x184B
{
	if (iParam0 < 0)
		return;
...
void func_58(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1873
{
	int num;
...
float func_59() // Position - 0x18C7
{
	return 0.75f;
}

Hash func_60(Hash hParam0) // Position - 0x18D4
{
	return hParam0;
}

BOOL func_61(Hash hParam0, Hash hParam1) // Position - 0x18DE
{
...
int func_62(int iParam0) // Position - 0x1914
{
	if (iParam0 == 2)
		iParam0 = func_85(1);
...
void func_63(float fParam0, Ped pedParam1) // Position - 0x1954
{
	if (fParam0 == 0f)
		return;
...
int func_64(int iParam0) // Position - 0x1998
{
	if (iParam0 == 2)
		iParam0 = func_85(1);
...
void func_65(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x19DC
{
	Player player;
	Ped EntityIndex;
...
int func_66(int iParam0) // Position - 0x1A8D
{
	if (iParam0 == 2)
		iParam0 = func_85(1);
...
void func_67(float fParam0, Ped pedParam1) // Position - 0x1AD1
{
	if (fParam0 == 0f)
		return;
...
float func_68(int iParam0, float fParam1, BOOL bParam2) // Position - 0x1B13
{
	int num;
	int num2;
...
float func_69(int iParam0, int iParam1) // Position - 0x1B7C
{
	if (iParam1 == 2)
		iParam1 = func_85(2);
...
int func_70(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x1BC8
{
	Ped ped;
...
void func_72(float fParam0, int iParam1) // Position - 0x1C6B
{
	float num;
	int num2;
	int num3;
...
void func_73(int iParam0, BOOL bParam1) // Position - 0x1CDE
{
	int num;
	int num2;
...
int func_74(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1D0B
{
	char* effectName;
	Ped ped;
...
int func_75(int iParam0, int iParam1, int iParam2) // Position - 0x1EC1
{
	int num;
...
struct<2> func_76(int iParam0) // Position - 0x1F55
{
	int num;
...
void func_77(var uParam0, var uParam1, int iParam2) // Position - 0x1F65
{
...
int func_78(Hash hParam0) // Position - 0x1F82
{
	switch (hParam0)
	{
...
void func_79(int iParam0, int iParam1) // Position - 0x215D
{
	var statId;
...
struct<2> func_80(int iParam0, int iParam1) // Position - 0x218F
{
	int num;
...
int func_81() // Position - 0x21A5
{
	return Global_1572887.f_14;
}

void func_82(Hash hParam0, int iParam1) // Position - 0x21B3
{
	int num;
...
void func_83(int iParam0) // Position - 0x2354
{
	if (!func_125(iParam0))
		return;
...
BOOL func_84(Hash hParam0, int iParam1) // Position - 0x2407
{
	if (hParam0 == 0)
		return false;
...
int func_85(int iParam0) // Position - 0x2421
{
	return func_127(func_126(iParam0));
}

BOOL func_86(Player plParam0) // Position - 0x2433
{
	float num;
...
int func_87() // Position - 0x244E
{
	return Global_1902569;
}

void func_88(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x245A
{
	int num;
	int i;
	int j;
...
int func_89(int iParam0, int iParam1) // Position - 0x25CD
{
	if (iParam1 == 2)
		iParam1 = func_85(2);
...
int func_90(int iParam0, int iParam1) // Position - 0x261D
{
	if (iParam1 == 2)
		iParam1 = func_85(2);
...
BOOL func_91(int iParam0, int iParam1, BOOL bParam2) // Position - 0x266F
{
	if (bParam2)
...
void func_92(int iParam0, int iParam1, int iParam2) // Position - 0x269C
{
	if (iParam2 == 2)
		iParam2 = func_85(2);
...
void func_93(int iParam0, int iParam1, int iParam2) // Position - 0x26F2
{
	if (iParam2 == 2)
		iParam2 = func_85(2);
...
BOOL func_94(Ped pedParam0, int iParam1, float fParam2) // Position - 0x2748
{
...
void func_95(int iParam0, int iParam1, int iParam2) // Position - 0x279D
{
	if (iParam2 == 2)
		iParam2 = func_85(2);
...
void func_96(Ped pedParam0, int iParam1, float fParam2) // Position - 0x27FE
{
	char* StringToTest;

	StringToTest = func_139(iParam1);
...
void func_97(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x282A
{
	int num;
...
BOOL func_98(int iParam0, BOOL bParam1) // Position - 0x2860
{
	return func_91(func_87(), iParam0, bParam1);
}

float func_99(int iParam0, int iParam1) // Position - 0x2874
{
	if (iParam1 == 2)
		iParam1 = func_85(1);
...
int func_100(float fParam0) // Position - 0x28C0
{
	float num;
...
float func_101(float fParam0, float fParam1, float fParam2) // Position - 0x28EB
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_102(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x2912
{
	int num;
	int i;
	int num2;
...
int func_103(int iParam0, float fParam1, int iParam2) // Position - 0x2A9A
{
	if (!func_143(iParam0))
		return 0;
...
void func_104(int iParam0, var uParam1, var uParam2) // Position - 0x2AEB
{
	int num;
...
BOOL func_105(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x2B07
{
...
void func_106(int iParam0, int iParam1) // Position - 0x2BA9
{
	int Variable;
...
BOOL func_107(int iParam0) // Position - 0x2BCD
{
	switch (iParam0)
	{
		case 0:
...
char* func_108(int iParam0) // Position - 0x2BFC
{
	switch (iParam0)
	{
		case 0:
...
void func_109(int iParam0) // Position - 0x2C33
{
	Ped ped;
	int num;
...
void func_110(int iParam0) // Position - 0x2C70
{
	int num;
	int num2;
	int i;
...
void func_111(int iParam0) // Position - 0x2D40
{
	Ped ped;
	int num;
...
void func_112(int iParam0, BOOL bParam1) // Position - 0x2D7D
{
	int num;
...
void func_113(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2DB2
{
	func_70(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

BOOL func_114(int iParam0) // Position - 0x2DCC
{
	int num;
...
BOOL func_115(int iParam0) // Position - 0x2DF4
{
	int num;
...
BOOL func_116(int iParam0) // Position - 0x2E1C
{
	int num;
...
BOOL func_117(int iParam0) // Position - 0x2E44
{
	int num;
...
BOOL func_118(int iParam0) // Position - 0x2E6C
{
	if (!func_117(iParam0))
		return false;
...
int func_119(int iParam0) // Position - 0x2E99
{
	int num;
	int num2;
	int num3;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_120(int iParam0, int iParam1) // Position - 0x3129
{
	int num;
	int num2;
	int num3;
...
int func_121(int iParam0) // Position - 0x32E1
{
	int num;
...
int func_122(int iParam0) // Position - 0x337B
{
	switch (iParam0)
	{
		case 1:
...
struct<2> func_123(int iParam0) // Position - 0x3711
{
	var unk;
...
int func_124(Hash hParam0, int iParam1) // Position - 0x3723
{
	var unk;
	int num;
	int i;
...
BOOL func_125(int iParam0) // Position - 0x376D
{
	return func_52(iParam0, 2);
}

BOOL func_126(int iParam0) // Position - 0x377C
{
	return func_168(&(Global_1956875.f_1565), iParam0, 1);
}

int func_127(BOOL bParam0) // Position - 0x3792
{
	if (bParam0)
		return 1;
...
float func_128(Player plParam0) // Position - 0x37A4
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_169(2);
}

int func_129(int iParam0) // Position - 0x37BA
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_130(int iParam0) // Position - 0x37DF
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_131(int iParam0) // Position - 0x37F2
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_132(int iParam0) // Position - 0x3805
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_133(int iParam0) // Position - 0x3818
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_134(int iParam0) // Position - 0x382A
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_135(int iParam0, int iParam1) // Position - 0x383C
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_136(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x38D6
{
...
BOOL func_137(int iParam0) // Position - 0x390E
{
	int num;
	int num2;
	int num3;
...
int func_138(int iParam0) // Position - 0x39EA
{
	switch (iParam0)
	{
		case 0:
...
char* func_139(int iParam0) // Position - 0x3A19
{
	switch (iParam0)
	{
		case 0:
...
char* func_140(int iParam0) // Position - 0x3A50
{
	switch (iParam0)
	{
		case 0:
...
void func_141(int iParam0, float fParam1, int iParam2) // Position - 0x3A89
{
	if (iParam2 == 2)
		iParam2 = func_85(2);
...
void func_142(int iParam0, int iParam1, int iParam2) // Position - 0x3ADB
{
	if (iParam2 == 2)
		iParam2 = func_85(2);
...
BOOL func_143(int iParam0) // Position - 0x3B31
{
	if (func_107(iParam0))
		return true;
...
void func_144(int iParam0, float fParam1, int iParam2) // Position - 0x3B57
{
	if (fParam1 < 0f)
		return;
...
BOOL func_145(int iParam0, int iParam1) // Position - 0x3BB3
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_146(int iParam0) // Position - 0x3BCB
{
...
BOOL func_147(int iParam0) // Position - 0x3BE2
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_148(int iParam0, int iParam1) // Position - 0x3CAE
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_149(int iParam0) // Position - 0x3CC7
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_150() // Position - 0x3CDA
{
	if (!func_178())
		return false;
...
int func_151(int iParam0, int iParam1) // Position - 0x3CF5
{
	switch (iParam0)
	{
		case -2101912686:
...
int func_152(int iParam0, int iParam1) // Position - 0x47FA
{
	switch (iParam0)
	{
...
int func_153(int iParam0, int iParam1) // Position - 0x4EB1
{
	Player player;
	Player player2;
	int num;
...
int func_154(int iParam0, int iParam1, int iParam2) // Position - 0x4F34
{
	int num;
	int num2;
...
void func_155(int iParam0) // Position - 0x502C
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_156(int iParam0, int iParam1) // Position - 0x5042
{
	switch (iParam0)
	{
...
int func_160(int iParam0, int iParam1) // Position - 0x596C
{
	Player player;
	Player player2;
	int num;
...
int func_161(int iParam0, int iParam1, int iParam2) // Position - 0x59E7
{
	int num;
	BOOL flag;
	int num2;
...
BOOL func_162(int iParam0) // Position - 0x5ABE
{
	int num;
...
BOOL func_163(int iParam0) // Position - 0x5AE5
{
	int num;
...
BOOL func_164(int iParam0) // Position - 0x5B0D
{
	int num;
...
BOOL func_165(int iParam0) // Position - 0x5B35
{
	int num;
...
BOOL func_166(int iParam0) // Position - 0x5B5D
{
	int num;
...
BOOL func_167(int iParam0) // Position - 0x5B85
{
	int num;
...
BOOL func_168(Any* panParam0, int iParam1, int iParam2) // Position - 0x5BAD
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_169(int iParam0) // Position - 0x5BE4
{
	switch (iParam0)
	{
		case 0:
...
var func_170(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5C25
{
	if (bParam0)
		return uParam1;
...
void func_171(int iParam0, int iParam1) // Position - 0x5C3C
{
	if (iParam1 < 0)
		return;
...
void func_172(int iParam0, int iParam1) // Position - 0x5CC2
{
...
void func_173(int iParam0, int iParam1) // Position - 0x5CFE
{
	int num;
	int num2;
...
void func_174(int iParam0, int iParam1) // Position - 0x5D51
{
...
void func_175(int iParam0, int iParam1) // Position - 0x5D8C
{
...
void func_176(int iParam0, int iParam1) // Position - 0x5DC5
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_177(int iParam0) // Position - 0x5DFD
{
	switch (iParam0)
	{
		case 12:
...
Player func_179(int iParam0) // Position - 0x5E36
{
	if (func_162(iParam0))
...
BOOL func_180(int iParam0) // Position - 0x5E57
{
	int num;
...
BOOL func_181(int iParam0, int iParam1, int iParam2) // Position - 0x5E7F
{
	int num;
	int num2;
	int num3;
...
BOOL func_182(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x6070
{
	return uParam0.f_4 != 0;
}

BOOL func_183(int iParam0, int iParam1) // Position - 0x607E
{
	int num;
...
Vector3 func_184(int iParam0) // Position - 0x60BE
{
	int num;
	var unk;
...
BOOL func_185(int iParam0, var uParam1, var uParam2) // Position - 0x60FA
{
	if (!func_180(iParam0))
		return false;
...
BOOL func_186(int iParam0, int iParam1, int iParam2) // Position - 0x6131
{
	int num;
	int num2;
	int num3;
...
void func_187(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x635F
{
	int num;
...
void func_188(int iParam0) // Position - 0x63DE
{
	int num;
...
BOOL func_189(int iParam0) // Position - 0x6433
{
...
BOOL func_190(int iParam0) // Position - 0x6451
{
	int num;
...
Vector3 func_191(int iParam0) // Position - 0x647E
{
	var unk;
	int num;
...
int func_192(int iParam0, int iParam1) // Position - 0x64BF
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_193(int iParam0) // Position - 0x68F8
{
	int num;
...
float func_194(int iParam0) // Position - 0x6920
{
	float num;
...
void func_195(int iParam0) // Position - 0x694F
{
	int num;
	int num2;
	int i;
...
BOOL func_196(int iParam0) // Position - 0x6B2E
{
	int num;
...
int func_197(int iParam0, int iParam1) // Position - 0x6B56
{
	switch (iParam0)
	{
...
void func_198(int iParam0) // Position - 0x6E66
{
	Ped ped;
	Player player;
...
BOOL func_199(int iParam0) // Position - 0x7075
{
	int num;
...
int func_200(int iParam0, int iParam1) // Position - 0x709C
{
	switch (iParam0)
	{
...
int func_201(int iParam0) // Position - 0x70F9
{
	int num;
	var unk;
	var unk32;
...
void func_202(int iParam0) // Position - 0x723D
{
	int num;
	int num2;
	int i;
...
BOOL func_203(int iParam0) // Position - 0x7392
{
	BOOL flag;
...
void func_204(int iParam0) // Position - 0x73BB
{
	Ped EntityIndex;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_214(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_220(iParam0, 0));
			func_221(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_220(iParam0, 1));
			func_221(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_220(iParam0, 2));
			func_221(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_220(iParam0, 3));
			func_221(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_205(int iParam0) // Position - 0x7656
{
	char* StringToTest;
	char* StringToTest2;
	...
	StringToTest = func_223(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	StringToTest2 = func_224(iParam0);
...
int func_206(int iParam0) // Position - 0x76A0
{
	int num;
...
float func_207(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x76CF
{
	var unk;
	float num;
...
BOOL func_208(int iParam0) // Position - 0x7705
{
...
BOOL func_209(int iParam0) // Position - 0x7774
{
	int num;
...
int func_210(int iParam0, int iParam1) // Position - 0x779B
{
	switch (iParam0)
	{
...
char* func_213(int iParam0) // Position - 0x788A
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_214(int iParam0) // Position - 0x78D1
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_215(int iParam0) // Position - 0x790C
{
	int i;
...
BOOL func_217(int iParam0, int iParam1) // Position - 0x796C
{
	int num;
	Player player;
	int num2;
...
struct<31> func_218(int iParam0) // Position - 0x7C41
{
	int num;
...
BOOL func_219(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0x7C65
{
	var unk;
	BOOL flag;
...
char* func_220(int iParam0, int iParam1) // Position - 0x7C9B
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_221(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x7CF3
{
	int i;
...
char* func_223(int iParam0) // Position - 0x7D9D
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_224(int iParam0) // Position - 0x7DBD
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_225(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x7DDD
{
	int num;
	int num2;
...
BOOL func_226() // Position - 0x7FFE
{
	return Global_1572887.f_7;
}

BOOL func_227() // Position - 0x800E
{
	if (!Global_1048577)
		return false;
...
BOOL func_228(Player plParam0) // Position - 0x8059
{
...
BOOL func_229(int iParam0, Player plParam1) // Position - 0x809E
{
	if (plParam1 == 255)
...
int func_230(int iParam0) // Position - 0x80CA
{
	int num;
...
struct<2> func_231(int iParam0) // Position - 0x8100
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_232(var uParam0, var uParam1) // Position - 0x8114
{
	if (!func_236(uParam0))
		return false;
...
void func_235(Player plParam0) // Position - 0x81AD
{
	Player player;
...
BOOL func_236(int iParam0) // Position - 0x8230
{
	switch (iParam0)
	{
		case 2:
...
int func_237(int iParam0) // Position - 0x826F
{
	switch (iParam0)
	{
		case 2:
...
void func_238(Player plParam0) // Position - 0x8305
{
	Player player;
...
void func_239(Player plParam0) // Position - 0x8371
{
