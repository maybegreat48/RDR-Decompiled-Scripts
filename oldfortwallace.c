...
void _DEBUG_PRINT(int iParam0) // Position - 0x817
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x823
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x830
{
	return;
}

BOOL func_17(int iParam0) // Position - 0x838
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x845
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x851
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x866
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x877
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x8B6
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x8C2
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x8CA
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0x97A
{
	return;
}

void func_26() // Position - 0x982
{
	return;
}

void func_27() // Position - 0x98A
{
	return;
}

void func_28() // Position - 0x992
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x99A
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x9A6
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x9B2
{
	return;
}

void func_32() // Position - 0x9BA
{
	return;
}

void func_33(int iParam0) // Position - 0x9C2
{
	func_58(0.775f, 0.2f, 0.025f, 0f);
	return;
}

void func_34() // Position - 0x9DE
{
...
void func_35(var uParam0) // Position - 0xA0F
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA55
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xA6A
{
	if (!func_60(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xA83
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xA94
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xAAC
{
	iParam0 = iParam0;
...
void func_41(var uParam0, int iParam1) // Position - 0xAD1
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xC10
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xC1D
{
...
BOOL func_44(int iParam0) // Position - 0xC53
{
	if (iParam0 == 0)
	{
		func_76();
...
int func_45() // Position - 0xD67
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xD75
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xD81
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xDEE
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xECE
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xEEC
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xEFF
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF1D
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x1015
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x1026
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x103A
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x104E
{
	return uParam0;
}

void func_58(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1058
{
...
void func_59(var uParam0, Volume volParam1, int iParam2) // Position - 0x1080
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_60(int iParam0) // Position - 0x10D9
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_61() // Position - 0x10EF
{
	int i;
...
BOOL func_62(var uParam0) // Position - 0x111C
{
	if (func_94())
	{
		if (!*uParam0)
...
void func_63(Hash hParam0, int iParam1) // Position - 0x114C
{
	func_95(hParam0, true, 0, false, true, 0, false, false);
	return;
}

BOOL func_64(int iParam0, int iParam1) // Position - 0x1161
{
	return iParam0 && iParam1 != false;
}

BOOL func_65(var uParam0, int iParam1) // Position - 0x1170
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_66() // Position - 0x1181
{
	return func_64(Global_1940199, 8192);
}

BOOL func_67(var uParam0, int iParam1) // Position - 0x1194
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_68(int iParam0) // Position - 0x11A5
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_69(int iParam0, int iParam1) // Position - 0x11E5
{
...
int func_70() // Position - 0x1212
{
	return Global_1896646.f_41;
}

void func_71(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1220
{
	BOOL flag;
	...
	StringToTest = func_98(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_110(&unk, joaat("COLOR_PURE_WHITE")), str3, func_110(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_110(&unk, joaat("COLOR_PURE_WHITE")), func_110(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_111(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_72(var uParam0, int iParam1) // Position - 0x1484
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_73(int iParam0, BOOL bParam1) // Position - 0x1497
{
...
void func_74(BOOL bParam0) // Position - 0x1B00
{
	if (bParam0)
...
BOOL func_75(int iParam0) // Position - 0x1B29
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_76() // Position - 0x1B6E
{
	return;
}

Hash func_77(int iParam0, BOOL bParam1) // Position - 0x1B76
{
	switch (iParam0)
	{
		case 0:
...
void func_78(int iParam0, BOOL bParam1) // Position - 0x233B
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_79(BOOL bParam0) // Position - 0x238E
{
	if (bParam0)
...
void func_80(int iParam0) // Position - 0x23B7
{
	func_58(0.775f, 0.2f, 0.025f, 0f);
...
void func_81(int iParam0) // Position - 0x23E2
{
	int i;
...
void func_82(int iParam0) // Position - 0x2413
{
	int i;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x2446
{
	int num;
	int num2;
	int num3;
...
BOOL func_84(int iParam0) // Position - 0x24FC
{
	int i;
...
BOOL func_85(int iParam0, BOOL bParam1) // Position - 0x2576
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_86(int iParam0) // Position - 0x25A7
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_87(int iParam0) // Position - 0x25C8
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_88(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x261B
{
	BOOL flag;
...
BOOL func_89(int iParam0) // Position - 0x2CDB
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_90(int iParam0) // Position - 0x2CF2
{
	switch (iParam0)
	{
		case 64:
...
int func_91(int iParam0, BOOL bParam1) // Position - 0x2D35
{
	if (!func_89(iParam0))
		return 0;
...
BOOL func_92(int iParam0) // Position - 0x2E20
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_93(int iParam0) // Position - 0x2E36
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_94() // Position - 0x2E4C
{
	if (Global_1572887.f_14 == -1)
		return false;
...
void func_95(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2E68
{
...
BOOL func_96(int iParam0) // Position - 0x2EF3
{
...
const char* func_98(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x2F6B
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_140(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_142(func_141(Global_34));
...
BOOL func_99(int iParam0) // Position - 0x39CA
{
...
int func_101(int iParam0) // Position - 0x3A9A
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_102(int iParam0) // Position - 0x3B08
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_103(int iParam0) // Position - 0x3C63
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_104(int iParam0, BOOL bParam1) // Position - 0x3C9E
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x3CE0
{
	if (!func_99(iParam0))
		return false;
...
int func_106() // Position - 0x3D25
{
	return Global_1902569;
}

int func_107(int iParam0) // Position - 0x3D31
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_108(int iParam0) // Position - 0x3D44
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_109(float fParam0) // Position - 0x3D56
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_110(var uParam0, int iParam1) // Position - 0x3D6C
{
...
int func_111(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3DA2
{
	int duration;
	var data;
	int num;
...
BOOL func_112(int iParam0) // Position - 0x3DE5
{
	if (func_143(iParam0))
		if (!func_144(44))
			return false;
...
void func_113(int iParam0, int iParam1) // Position - 0x3E05
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_114(int iParam0, int iParam1) // Position - 0x3E16
{
	int num;
...
void func_115(var uParam0, var uParam1, int iParam2) // Position - 0x3E2C
{
...
void func_116(int iParam0) // Position - 0x3E49
{
...
void func_117(int iParam0) // Position - 0x3F29
{
	int i;
	int num;
...
BOOL func_118(int iParam0, BOOL bParam1) // Position - 0x4101
{
	if (func_45() != -1)
		return false;
...
int func_119(int iParam0, BOOL bParam1) // Position - 0x412F
{
	if (!func_89(iParam0))
		return 0;
...
int func_120(int iParam0) // Position - 0x41B2
{
	switch (iParam0)
	{
		case 27:
...
int func_121(int iParam0) // Position - 0x41D9
{
	switch (iParam0)
	{
		case 33:
...
void func_124(int iParam0, BOOL bParam1) // Position - 0x443C
{
	BOOL flag;
...
Hash func_125(int iParam0) // Position - 0x47EB
{
	if (!func_89(iParam0))
		return 0;
...
void func_126(int iParam0, PersChar pchParam1) // Position - 0x4809
{
	if (!func_89(iParam0))
		return;
...
PersChar func_127(int iParam0) // Position - 0x482A
{
	if (!func_89(iParam0))
		return 0;
...
void func_128(int iParam0, BOOL bParam1) // Position - 0x484A
{
	if (func_45() != -1)
		return;
...
BOOL func_129(int iParam0) // Position - 0x4883
{
	if (!func_89(iParam0))
		return false;
...
Hash func_130(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x48A9
{
...
BOOL func_131(Hash hParam0) // Position - 0x494D
{
	if (func_170(hParam0))
...
void func_132(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4968
{
	if (func_131(hParam0))
	{
...
void func_133(Hash hParam0, BOOL bParam1) // Position - 0x49A0
{
	if (func_131(hParam0))
...
void func_134(Hash hParam0, BOOL bParam1) // Position - 0x49CE
{
	if (func_131(hParam0))
...
void func_135(Hash hParam0, BOOL bParam1) // Position - 0x49FC
{
	if (func_131(hParam0))
...
BOOL func_136() // Position - 0x4A2A
{
	return true;
}

BOOL func_137() // Position - 0x4A33
{
	return false;
}

BOOL func_138() // Position - 0x4A3C
{
	var unk;
	var unk3;
...
BOOL func_139(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4AA4
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_140(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4C1A
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_141(var uParam0, var uParam1, var uParam2) // Position - 0x4C2E
{
	int i;
...
const char* func_142(int iParam0) // Position - 0x4C5C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_143(int iParam0) // Position - 0x4F40
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_144(int iParam0) // Position - 0x4F6A
{
	if (!func_176(iParam0))
		return false;
...
struct<2> func_145(Player plParam0) // Position - 0x4F86
{
	var gamerHandle;
...
const char* func_146(const char* sParam0, int iParam1) // Position - 0x4F9A
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_147(int iParam0, BOOL bParam1) // Position - 0x4FB4
{
	char* StringToTest;
...
void func_148(int iParam0, BOOL bParam1) // Position - 0x4FE8
{
	switch (iParam0)
	{
		case 5:
...
void func_149(int iParam0, int iParam1) // Position - 0x501D
{
	func_178(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_150(int iParam0) // Position - 0x5037
{
	if (!func_89(iParam0))
		return false;
...
void func_151(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x505C
{
	PersChar persChar;
...
void func_152(int iParam0, BOOL bParam1) // Position - 0x5148
{
	if (!func_181(iParam0))
		return;
...
void func_153(int iParam0, int iParam1) // Position - 0x519E
{
	if (!func_186(iParam0))
		return;
...
int func_154(int iParam0) // Position - 0x5211
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_155(Hash hParam0) // Position - 0x5227
{
...
void func_156(int iParam0) // Position - 0x5247
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_157(int iParam0, BOOL bParam1) // Position - 0x525D
{
	if (func_45() != -1)
		return;
...
void func_158(int iParam0) // Position - 0x528E
{
	Ped EntityIndex;
...
void func_159(int iParam0) // Position - 0x52D2
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_160(int iParam0) // Position - 0x52E7
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_161(int iParam0) // Position - 0x52FC
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_162(int iParam0) // Position - 0x5311
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_163(int iParam0) // Position - 0x5390
{
...
BOOL func_164(int iParam0, int iParam1) // Position - 0x53ED
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_165(int iParam0, int iParam1) // Position - 0x5406
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_166(int iParam0, int iParam1) // Position - 0x541F
{
...
int func_167(int iParam0) // Position - 0x545A
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_168(int iParam0) // Position - 0x546E
{
	return;
}

BOOL func_169(int iParam0, int iParam1) // Position - 0x5476
{
	if (iParam0 == -1)
		return false;
...
BOOL func_170(Hash hParam0) // Position - 0x549D
{
	return hParam0 != 0;
}

BOOL func_171() // Position - 0x54A9
{
	if (Global_1048576)
		return true;
...
struct<2> func_172() // Position - 0x5501
{
	return Global_1051268;
}

BOOL func_173(var uParam0, var uParam1) // Position - 0x550F
{
	if (!func_190(uParam0))
		return false;
...
struct<2> func_174() // Position - 0x5543
{
...
BOOL func_175(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x558E
{
	var unk;
	float num;
	float num2;
...
BOOL func_176(int iParam0) // Position - 0x55BE
{
	if (iParam0 == 0)
		return false;
...
BOOL func_177(int iParam0) // Position - 0x55D1
{
	int num;
	int num2;
	int offset;
...
void func_178(BOOL bParam0, int iParam1) // Position - 0x55FB
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_179(int iParam0) // Position - 0x5610
{
	if (!func_89(iParam0))
		return false;
...
BOOL func_180(Hash hParam0) // Position - 0x5634
{
	return hParam0 != 0;
}

BOOL func_181(int iParam0) // Position - 0x5640
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_182(int iParam0, BOOL bParam1) // Position - 0x5656
{
	if (!func_181(iParam0))
		return false;
...
void func_183(int iParam0, BOOL bParam1) // Position - 0x567C
{
	if (!func_181(iParam0))
		return;
...
void func_184(int iParam0, BOOL bParam1) // Position - 0x56AA
{
	if (!func_181(iParam0))
		return;
...
void func_185(int iParam0) // Position - 0x56E4
{
	func_195(func_194(iParam0));
	return;
}

BOOL func_186(int iParam0) // Position - 0x56F6
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_187() // Position - 0x570C
{
	return 1;
}

Ped func_188(int iParam0) // Position - 0x5715
{
	PersChar persChar;
...
BOOL func_189(BOOL bParam0, BOOL bParam1) // Position - 0x5743
{
	return bParam0 && bParam1 != false;
}

BOOL func_190(int iParam0) // Position - 0x5752
{
	switch (iParam0)
	{
		case 2:
...
int func_191(int iParam0) // Position - 0x5791
{
	switch (iParam0)
	{
		case 2:
...
void func_192(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5827
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_193(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x62C4
{
	float num;
	float num2;
	float num3;
...
int func_194(int iParam0) // Position - 0x632A
{
...
void func_195(int iParam0) // Position - 0x6847
{
