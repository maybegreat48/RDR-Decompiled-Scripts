...
int func_3() // Position - 0x154
{
	return Global_1572887.f_14;
}

BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x162
{
	int i;
...
void func_5() // Position - 0x242
{
	return;
}

void func_6(Volume volParam0) // Position - 0x24A
{
...
void func_7(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x291
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_8(var uParam0, int iParam1) // Position - 0x307
{
