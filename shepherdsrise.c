...
void func_70(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x141A
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_118(&unk, joaat("COLOR_PURE_WHITE")), str3, func_118(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_118(&unk, joaat("COLOR_PURE_WHITE")), func_118(&unk2, joaat("COLOR_PURE_WHITE")));
		}
...
void func_101(BOOL bParam0, int iParam1) // Position - 0x3FDC
{
...
Hash func_109(int iParam0) // Position - 0x4BC8
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
BOOL func_149(int iParam0, BOOL bParam1) // Position - 0x585F
{
...
BOOL func_185(int* piParam0, int iParam1, int iParam2) // Position - 0x6362
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_192(int* piParam0, int iParam1, int iParam2) // Position - 0x6458
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_205(BOOL bParam0, int iParam1) // Position - 0x701F
{
...
BOOL func_214(int* piParam0, int iParam1, int iParam2) // Position - 0x714C
{
