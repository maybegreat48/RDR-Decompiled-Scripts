...
void _DEBUG_PRINT(int iParam0) // Position - 0xB3C
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0xB48
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0xB55
{
	func_56(-306246697, true, false);
	return;
}

BOOL func_17(int iParam0) // Position - 0xB68
{
	BOOL num;
...
void _DEBUG_PRINT_0(int iParam0) // Position - 0xBFA
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0xC06
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0xC1B
{
	return func_57(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0xC2C
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0xC6B
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0xC77
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0xC7F
{
	if (func_58(iParam0))
		return true;
...
void func_25() // Position - 0xD2F
{
	return;
}

void func_26() // Position - 0xD37
{
	return;
}

void func_27() // Position - 0xD3F
{
...
void func_29(int iParam0) // Position - 0xD67
{
...
void func_30(int iParam0) // Position - 0xE9B
{
	iParam0 = iParam0;
...
void func_31() // Position - 0xEB2
{
	return;
}

void func_32() // Position - 0xEBA
{
	return;
}

void func_33(int iParam0) // Position - 0xEC2
{
	func_72(0.8f, 0.2f, 0f, 0f);
	return;
}

void func_34() // Position - 0xEDA
{
...
void func_35(var uParam0) // Position - 0xF0B
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xF51
{
	iParam0 = iParam0;
...
BOOL func_38(BOOL bParam0) // Position - 0xFA6
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xFB7
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xFCF
{
	func_77();
...
void func_41(var uParam0, int iParam1) // Position - 0x102A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0x1169
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0x1176
{
...
int func_45() // Position - 0x12C0
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0x12CE
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0x12DA
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0x1347
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x1427
{
	if (!func_74(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x1445
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x1458
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

void func_53() // Position - 0x1476
{
...
void func_54(Hash hParam0, int iParam1) // Position - 0x153E
{
	func_80(hParam0, true, 0, false, false, 0, false, false);
	return;
}

void func_55(int iParam0, Volume volParam1) // Position - 0x1553
{
	Global_1915656.f_3[iParam0 /*447*/].f_32 = volParam1;
	return;
}

void func_56(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x156A
{
	!bParam2;
...
BOOL func_57(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x20AF
{
	int num;
	int num2;
	int num3;
...
BOOL func_58(int iParam0) // Position - 0x21A7
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_59(int iParam0) // Position - 0x21B8
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_60(int iParam0) // Position - 0x21CC
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_61(var uParam0, var uParam1) // Position - 0x21E0
{
	return uParam0;
}

void func_62(int iParam0, float fParam1, float fParam2, float fParam3, Volume volParam4, int iParam5) // Position - 0x21EA
{
...
void func_63(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x2248
{
...
void func_64(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x23F7
{
	int num;
...
void func_65(int iParam0, int iParam1) // Position - 0x249B
{
	func_131(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

int func_66(int iParam0, BOOL bParam1) // Position - 0x24B5
{
	int num;
	Hash hash;
	float num2;
...
BOOL func_68() // Position - 0x25F0
{
	return func_137(func_60(0));
}

void func_69() // Position - 0x2601
{
	int i;
	var unk;
...
void func_70(int iParam0) // Position - 0x27C8
{
	int i;
	Hash hash;
	float num;
...
int func_71(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x2945
{
	PersChar persChar;
...
void func_72(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x2993
{
...
void func_73(var uParam0, Volume volParam1, int iParam2) // Position - 0x29BB
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_74(int iParam0) // Position - 0x2A14
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_75() // Position - 0x2A2A
{
	int i;
...
void func_76(int iParam0, Hash hParam1) // Position - 0x2A57
{
	if (!func_148(iParam0))
		return;
...
void func_78(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, Hash hParam5) // Position - 0x2AB4
{
...
BOOL func_79(var uParam0) // Position - 0x2B4D
{
	if (func_151())
	{
		if (!*uParam0)
...
void func_80(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2B7D
{
...
BOOL func_81(int iParam0, int iParam1) // Position - 0x2C08
{
	return iParam0 && iParam1 != false;
}

BOOL func_82(var uParam0, int iParam1) // Position - 0x2C17
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_83() // Position - 0x2C28
{
	return func_81(Global_1940199, 8192);
}

BOOL func_84(var uParam0, int iParam1) // Position - 0x2C3B
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_85(int iParam0) // Position - 0x2C4C
{
	if (!func_74(iParam0))
		return false;
...
BOOL func_86(int iParam0, int iParam1) // Position - 0x2C8C
{
...
int func_87() // Position - 0x2CB9
{
	return Global_1896646.f_41;
}

void func_88(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x2CC7
{
	BOOL flag;
	...
	StringToTest = func_159(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_171(&unk, joaat("COLOR_PURE_WHITE")), str3, func_171(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_171(&unk, joaat("COLOR_PURE_WHITE")), func_171(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_172(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_89(var uParam0, int iParam1) // Position - 0x2F38
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_90(int iParam0, BOOL bParam1) // Position - 0x2F4B
{
...
void func_91(BOOL bParam0) // Position - 0x35B4
{
	if (bParam0)
...
BOOL func_92(int iParam0) // Position - 0x35DD
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_93() // Position - 0x3622
{
	return;
}

Hash func_94(int iParam0, BOOL bParam1) // Position - 0x362A
{
	switch (iParam0)
	{
		case 0:
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x3DEF
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_96(BOOL bParam0) // Position - 0x3E42
{
	if (bParam0)
...
void func_97(int iParam0) // Position - 0x3E6B
{
...
void func_98(int iParam0) // Position - 0x3F4B
{
	int i;
...
void func_99(int iParam0) // Position - 0x3F7C
{
	int i;
...
BOOL func_100(int iParam0, BOOL bParam1) // Position - 0x3FAF
{
	int num;
	int num2;
	int num3;
...
BOOL func_101(int iParam0) // Position - 0x4067
{
	int i;
...
BOOL func_102(int iParam0, BOOL bParam1) // Position - 0x40E1
{
	if (Global_1572887.f_14 == -1)
...
void func_103(int iParam0) // Position - 0x4112
{
	int num;
	int num2;
	int BitIndex;
...
void func_104(int iParam0) // Position - 0x4145
{
	int num;
	int num2;
	int BitIndex;
...
BOOL func_107(int iParam0) // Position - 0x4221
{
	int num;
	int num2;
	int offset;
...
void func_108(Hash hParam0) // Position - 0x42A0
{
...
BOOL func_109(int iParam0) // Position - 0x42C0
{
	if (!func_74(iParam0))
		return false;
...
BOOL func_110(int iParam0) // Position - 0x42E1
{
	if (!func_74(iParam0))
		return false;
...
BOOL func_111(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4334
{
	BOOL flag;
...
BOOL func_112(int iParam0) // Position - 0x49F4
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_113(int iParam0) // Position - 0x4A0B
{
	switch (iParam0)
	{
		case 64:
...
int func_114(int iParam0, BOOL bParam1) // Position - 0x4A4E
{
	if (!func_112(iParam0))
		return 0;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4B39
{
...
void func_116(int iParam0) // Position - 0x4B63
{
...
int func_117(int iParam0, int iParam1) // Position - 0x4C43
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_118() // Position - 0x4D26
{
	return func_194(func_60(0));
}

BOOL func_119(int iParam0) // Position - 0x4D37
{
	return !func_195(iParam0);
}

void func_120(BOOL bParam0, BOOL bParam1) // Position - 0x4D46
{
	if (func_196(255) == 4)
		return;
...
void func_121(int iParam0, BOOL bParam1) // Position - 0x4E91
{
	BOOL flag;
...
int func_122(Hash hParam0, int iParam1) // Position - 0x5240
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_123(int iParam0) // Position - 0x5BA6
{
	if (!func_208(iParam0))
		return 0;
...
int func_124(int iParam0) // Position - 0x5BE7
{
	switch (iParam0)
	{
		case 3:
...
void func_125(int iParam0, int iParam1) // Position - 0x5C84
{
...
void func_126(int iParam0) // Position - 0x5CB3
{
...
int func_127(int iParam0) // Position - 0x5CEC
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

Hash func_128(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5D00
{
...
BOOL func_129(Hash hParam0) // Position - 0x5DA4
{
	if (func_210(hParam0))
...
BOOL func_130(Hash hParam0) // Position - 0x5DBF
{
	func_128(hParam0, false, false);
...
void func_131(BOOL bParam0, int iParam1) // Position - 0x5DE8
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

BOOL func_132(int iParam0, BOOL bParam1) // Position - 0x5DF9
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

Hash func_133() // Position - 0x5E12
{
	return Global_1893611.f_2;
}

BOOL func_134(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x5E20
{
	return func_211(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_135(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x5E40
{
	return func_211(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_136(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x5E60
{
	if (bParam6)
...
BOOL func_137(var uParam0, var uParam1) // Position - 0x5EDC
{
	return func_212(uParam0, 9, 12);
}

void func_138(int iParam0) // Position - 0x5EEF
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_139(int iParam0) // Position - 0x5F04
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_140(int iParam0) // Position - 0x5F19
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_141(int iParam0) // Position - 0x5F2E
{
	int i;
	int num;
	BOOL flag;
...
int func_142(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5FAD
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

int func_143(int iParam0) // Position - 0x5FC7
{
	switch (iParam0)
	{
		case 10:
...
BOOL func_144(int iParam0, int iParam1) // Position - 0x6025
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

BOOL func_145(int iParam0, BOOL bParam1) // Position - 0x603E
{
	if (func_45() != -1)
		return false;
...
PersChar func_146(int iParam0) // Position - 0x6096
{
	if (!func_112(iParam0))
		return 0;
...
BOOL func_147(int iParam0) // Position - 0x60B6
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_148(int iParam0) // Position - 0x60CC
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_149(int iParam0) // Position - 0x60E2
{
	return iParam0 != 0;
}

void func_150() // Position - 0x60EE
{
...
void func_152(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6173
{
	if (func_129(hParam0))
	{
...
void func_153(Hash hParam0, BOOL bParam1) // Position - 0x61AB
{
	if (func_129(hParam0))
...
void func_154(Hash hParam0, BOOL bParam1) // Position - 0x61D9
{
	if (func_129(hParam0))
...
void func_155(Hash hParam0, BOOL bParam1) // Position - 0x6207
{
	if (func_129(hParam0))
...
BOOL func_156() // Position - 0x6235
{
	return true;
}

BOOL func_157(int iParam0) // Position - 0x623E
{
...
const char* func_159(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x62B6
{
	const char* StringToTest;
...
BOOL func_160(int iParam0) // Position - 0x6D1E
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_161(int iParam0) // Position - 0x6D33
{
	switch (iParam0)
	{
		case 0:
...
Hash func_162(int iParam0) // Position - 0x6DEE
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_163(int iParam0) // Position - 0x6E5C
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_164(int iParam0) // Position - 0x6FB7
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_165(int iParam0, BOOL bParam1) // Position - 0x6FF2
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_166(int iParam0, int iParam1) // Position - 0x7034
{
	if (!func_160(iParam0))
		return false;
...
BOOL func_167() // Position - 0x7079
{
	return Global_1902569;
}

int func_168(BOOL bParam0) // Position - 0x7085
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 12) & 31;
}

int func_169(BOOL bParam0) // Position - 0x7098
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 6) & 63;
}

float func_170(float fParam0) // Position - 0x70AA
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_171(var uParam0, int iParam1) // Position - 0x70C0
{
...
int func_172(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x70F6
{
	int duration;
	var data;
	int num;
...
BOOL func_173(int iParam0) // Position - 0x7139
{
	if (func_220(iParam0))
		if (!func_221(44))
			return false;
...
void func_174(int iParam0, int iParam1) // Position - 0x7159
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_175(int iParam0, int iParam1) // Position - 0x716A
{
	int num;
...
void func_176(var uParam0, var uParam1, int iParam2) // Position - 0x7180
{
...
void func_177(int iParam0) // Position - 0x719D
{
	int i;
	int num;
...
BOOL func_178(int iParam0, BOOL bParam1) // Position - 0x7375
{
	if (func_45() != -1)
		return false;
...
int func_179(int iParam0, BOOL bParam1) // Position - 0x73A3
{
	if (!func_112(iParam0))
		return 0;
...
int func_180(int iParam0) // Position - 0x7426
{
	switch (iParam0)
	{
		case 27:
...
int func_181(int iParam0) // Position - 0x744D
{
	switch (iParam0)
	{
		case 33:
...
int func_183(int iParam0, int iParam1) // Position - 0x74E9
{
	switch (iParam0)
	{
...
BOOL func_184(int iParam0) // Position - 0x989E
{
	int num;
...
BOOL func_185(int iParam0) // Position - 0x98BB
{
...
BOOL func_186() // Position - 0x98D2
{
	return 1;
}

Hash func_187(int iParam0) // Position - 0x98DB
{
	if (!func_112(iParam0))
		return 0;
...
void func_188(int iParam0, PersChar pchParam1) // Position - 0x98F9
{
	if (!func_112(iParam0))
		return;
...
void func_189(int iParam0, BOOL bParam1) // Position - 0x991A
{
	if (func_45() != -1)
		return;
...
BOOL func_190(int iParam0) // Position - 0x9953
{
	if (!func_112(iParam0))
		return false;
...
void func_191(int iParam0, BOOL bParam1) // Position - 0x9979
{
	char* StringToTest;
...
void func_192(int iParam0, BOOL bParam1) // Position - 0x99AD
{
	switch (iParam0)
	{
		case 5:
...
void func_193(int iParam0, int iParam1) // Position - 0x99E2
{
	func_233(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_194(var uParam0, var uParam1) // Position - 0x99FC
{
	return func_212(uParam0, 5, 8);
}

BOOL func_195(int iParam0) // Position - 0x9A0F
{
	return func_234(1, iParam0);
}

int func_196(int iParam0) // Position - 0x9A1E
{
	if (iParam0 == 255)
...
int func_197(int iParam0) // Position - 0x9A69
{
...
void func_198(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x9A86
{
	func_236(iParam0);
...
int func_199(int iParam0) // Position - 0x9AE8
{
...
void func_200(var uParam0) // Position - 0x9B05
{
	var unk;
...
void func_201(float* pfParam0) // Position - 0x9B17
{
	var unk;
...
void func_203(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x9B7F
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_204(int iParam0) // Position - 0x9BAC
{
...
void func_205(int iParam0, int iParam1) // Position - 0x9C09
{
	func_144(iParam0, iParam1);
...
void func_206(int iParam0) // Position - 0x9C44
{
	return;
}

BOOL func_207(int iParam0, int iParam1) // Position - 0x9C4C
{
	if (iParam0 == -1)
		return false;
...
BOOL func_208(int iParam0) // Position - 0x9C73
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_209(int iParam0) // Position - 0x9C89
{
	var unk;
...
BOOL func_210(Hash hParam0) // Position - 0x9CBA
{
	return hParam0 != 0;
}

BOOL func_211(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x9CC6
{
	int num;
...
BOOL func_212(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x9D4E
{
	int num;
...
Ped func_213(int iParam0) // Position - 0x9D89
{
	PersChar persChar;
...
BOOL func_214() // Position - 0x9DB7
{
	return false;
}

BOOL func_215() // Position - 0x9DC0
{
	var unk;
	var unk3;
...
BOOL func_216(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9E28
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_217(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x9F9E
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_218(var uParam0, var uParam1, var uParam2) // Position - 0x9FB2
{
	int i;
...
const char* func_219(int iParam0) // Position - 0x9FE0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_220(int iParam0) // Position - 0xA2C4
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_221(int iParam0) // Position - 0xA2EE
{
	if (!func_253(iParam0))
		return false;
...
struct<2> func_222(Player plParam0) // Position - 0xA30A
{
	var gamerHandle;
...
const char* func_223(const char* sParam0, int iParam1) // Position - 0xA31E
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

BOOL func_224(int iParam0) // Position - 0xA338
{
	if (!func_112(iParam0))
		return false;
...
void func_225(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xA35D
{
	PersChar persChar;
...
void func_226(int iParam0, BOOL bParam1) // Position - 0xA449
{
	if (!func_208(iParam0))
		return;
...
void func_227(int iParam0, int iParam1) // Position - 0xA49F
{
	if (!func_261(iParam0))
		return;
...
int func_228(int iParam0) // Position - 0xA512
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_229(int iParam0) // Position - 0xA528
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_230(int iParam0, BOOL bParam1) // Position - 0xA53E
{
	if (func_45() != -1)
		return;
...
void func_231(int iParam0) // Position - 0xA56F
{
	Ped EntityIndex;
...
int func_232(int iParam0) // Position - 0xA5B3
{
	return func_262(iParam0) + 30;
}

void func_233(BOOL bParam0, int iParam1) // Position - 0xA5C3
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_234(int iParam0, int iParam1) // Position - 0xA5D8
{
	int num;
...
BOOL func_235(int* piParam0, int iParam1, int iParam2) // Position - 0xA64C
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_241(BOOL bParam0) // Position - 0xA71B
{
	if (func_265(bParam0))
		return;
...
BOOL func_242(int* piParam0, int iParam1, int iParam2) // Position - 0xA742
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_243(BOOL bParam0, BOOL bParam1) // Position - 0xA775
{
	return bParam0 && bParam1 != false;
}

int func_244(int iParam0) // Position - 0xA784
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_245(int iParam0, int iParam1, var uParam2) // Position - 0xB16C
{
	var unk;
...
int func_246() // Position - 0xB193
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_247(var uParam0, var uParam1) // Position - 0xB1A8
{
	if (!func_268(uParam0))
		return false;
...
int func_248(int iParam0, var uParam1) // Position - 0xB1DC
{
	if (iParam0 == 2)
...
struct<2> func_250() // Position - 0xB24E
{
	return Global_1051268;
}

struct<2> func_251() // Position - 0xB25C
{
...
BOOL func_252(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0xB2A7
{
	var unk;
	float num;
	float num2;
...
BOOL func_253(int iParam0) // Position - 0xB2D7
{
	if (iParam0 == 0)
		return false;
...
BOOL func_254(int iParam0) // Position - 0xB2EA
{
	int num;
	int num2;
	int offset;
...
BOOL func_255(int iParam0) // Position - 0xB314
{
	if (!func_112(iParam0))
		return false;
...
BOOL func_256(Hash hParam0) // Position - 0xB338
{
	return hParam0 != 0;
}

BOOL func_257(int iParam0, BOOL bParam1) // Position - 0xB344
{
	if (!func_208(iParam0))
		return false;
...
void func_258(int iParam0, BOOL bParam1) // Position - 0xB36A
{
	if (!func_208(iParam0))
		return;
...
void func_259(int iParam0, BOOL bParam1) // Position - 0xB398
{
	if (!func_208(iParam0))
		return;
...
void func_260(int iParam0) // Position - 0xB3D2
{
	func_274(func_273(iParam0));
	return;
}

BOOL func_261(int iParam0) // Position - 0xB3E4
{
	return iParam0 > -1 && iParam0 < 40;
}

int func_262(int iParam0) // Position - 0xB3FA
{
	return iParam0 * 31;
}

BOOL func_263(int* piParam0, int iParam1, int iParam2) // Position - 0xB406
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_264() // Position - 0xB43D
{
	return Global_1102813.f_3672;
}

BOOL func_265(BOOL bParam0) // Position - 0xB44C
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_266(int iParam0, int iParam1, Any* panParam2) // Position - 0xB462
{
...
void func_267(Any* panParam0, int iParam1, var uParam2) // Position - 0xB496
{
	var unk;
...
BOOL func_268(int iParam0) // Position - 0xB510
{
	switch (iParam0)
	{
		case 2:
...
int func_269(int iParam0) // Position - 0xB54F
{
	switch (iParam0)
	{
		case 2:
...
int func_270(var uParam0, var uParam1) // Position - 0xB5E5
{
	var unk;
...
void func_271(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xB611
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_272(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0xC0B1
{
	float num;
	float num2;
	float num3;
...
int func_273(int iParam0) // Position - 0xC117
{
...
void func_274(int iParam0) // Position - 0xC634
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_275(int iParam0) // Position - 0xC645
{
	int num;
...
BOOL func_276(int iParam0, var uParam1, Any* panParam2) // Position - 0xC7BA
{
	if (!func_247(iParam0))
		return false;
...
void func_277(Any* panParam0) // Position - 0xC8C5
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
