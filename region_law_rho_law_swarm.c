...
BOOL func_3(var uParam0) // Position - 0x70
{
	return false;
}

void func_4() // Position - 0x79
{
	switch (iLocal_47)
	{
		case 1:
...
int func_5(int iParam0) // Position - 0xE5
{
	int num;
...
BOOL func_6() // Position - 0x137
{
	...
	PedIndex = func_8(eptLocal_48, uLocal_44, 0, true, true, 0, true, true, true, false, false);
	PED::SET_PED_AS_COP(PedIndex, true);
	func_9(&PedIndex, true, false, true);
...
Ped func_8(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x216
{
	Ped EntityIndex;
	...
	func_13(EntityIndex, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return EntityIndex;
}

void func_9(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x256
{
...
void func_10(var uParam0, int iParam1, BOOL bParam2) // Position - 0x2C4
{
	uParam0->f_2 = 0;
...
int func_11(var uParam0, var uParam1) // Position - 0x2FF
{
	if (uParam0 > uParam1)
		return uParam0;
...
BOOL func_12(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0x315
{
	int num;
...
void func_13(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x43A
{
	BOOL flag;
...
void func_14(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10) // Position - 0x504
{
	int num;
	int num2;
...
void func_15(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1312
{
	switch (iParam1)
	{
		case 0:
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1AD2
{
...
Vector3 func_17(float fParam0, var uParam1, var uParam2) // Position - 0x1AFC
{
	float num;
	float num2;
...
void func_18(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1B3B
{
...
void func_19(Ped pedParam0, BOOL bParam1) // Position - 0x1B80
{
...
void func_20(Ped pedParam0, int iParam1) // Position - 0x1BC5
{
	if (iParam1 == 1)
...
float func_21(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x1BEC
{
	float num;
...
int func_22(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1C11
{
	int num;
...
int func_23(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1C5F
{
	return func_27(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

int func_24() // Position - 0x1C75
{
	return Global_1893611.f_2;
}

BOOL func_25(int iParam0) // Position - 0x1C83
{
	return iParam0 >= 0 && iParam0 <= 150;
}

int func_26(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1C99
{
	int num;
	int num2;
	int num3;
...
int func_27(Hash hParam0) // Position - 0x1D50
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
int func_28(var uParam0, var uParam1, var uParam2) // Position - 0x1E0A
{
	int num;
...
int func_29(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x1E45
{
	if (fParam0 < fParam3)
