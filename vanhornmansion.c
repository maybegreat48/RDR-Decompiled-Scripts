...
BOOL func_60(int iParam0, int iParam1) // Position - 0x1038
{
	return iParam0 && iParam1 != false;
}

BOOL func_61(var uParam0, int iParam1) // Position - 0x1047
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_62() // Position - 0x1058
{
	return func_60(Global_1940199, 8192);
}

BOOL func_63(var uParam0, int iParam1) // Position - 0x106B
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_64(int iParam0) // Position - 0x107C
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x10BC
{
...
int func_66() // Position - 0x10E9
{
	return Global_1896646.f_41;
}

void func_67(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x10F7
{
	BOOL flag;
	...
	StringToTest = func_91(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_103(&unk, joaat("COLOR_PURE_WHITE")), str3, func_103(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_103(&unk, joaat("COLOR_PURE_WHITE")), func_103(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_104(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_68(var uParam0, int iParam1) // Position - 0x135B
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_69(int iParam0, BOOL bParam1) // Position - 0x136E
{
...
void func_70(BOOL bParam0) // Position - 0x19D7
{
	if (bParam0)
...
BOOL func_71(int iParam0) // Position - 0x1A00
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_72() // Position - 0x1A45
{
	return;
}

Hash func_73(int iParam0, BOOL bParam1) // Position - 0x1A4D
{
	switch (iParam0)
	{
		case 0:
...
void func_74(int iParam0, BOOL bParam1) // Position - 0x2212
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_75(BOOL bParam0) // Position - 0x2265
{
	if (bParam0)
...
void _DEBUG_PRINT_0_0_0_0_0_0_0(int iParam0) // Position - 0x228E
{
	iParam0 = iParam0;
	return;
}

void func_77(int iParam0) // Position - 0x229A
{
	int i;
...
void func_78(int iParam0) // Position - 0x22CB
{
	int i;
...
BOOL func_79(int iParam0, BOOL bParam1) // Position - 0x22FE
{
	int num;
	int num2;
	int num3;
...
BOOL func_80(int iParam0) // Position - 0x23B4
{
	int i;
...
BOOL func_81(int iParam0, BOOL bParam1) // Position - 0x242E
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_82(int iParam0) // Position - 0x245F
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_83(int iParam0) // Position - 0x2480
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_84(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x24D3
{
	BOOL flag;
...
BOOL func_85(int iParam0) // Position - 0x2B93
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_86(int iParam0) // Position - 0x2BAA
{
	switch (iParam0)
	{
		case 64:
...
int func_87(int iParam0, BOOL bParam1) // Position - 0x2BED
{
	if (!func_85(iParam0))
		return 0;
...
BOOL func_88(int iParam0) // Position - 0x2CD8
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_89(int iParam0) // Position - 0x2CEE
{
...
const char* func_91(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x2D66
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_126(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_128(func_127(Global_34));
...
BOOL func_92(int iParam0) // Position - 0x37C5
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_93(int iParam0) // Position - 0x37DA
{
	switch (iParam0)
	{
		case 0:
...
Hash func_94(int iParam0) // Position - 0x3895
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_95(int iParam0) // Position - 0x3903
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_96(int iParam0) // Position - 0x3A5E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_97(int iParam0, BOOL bParam1) // Position - 0x3A99
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_98(int iParam0, int iParam1) // Position - 0x3ADB
{
	if (!func_92(iParam0))
		return false;
...
BOOL func_99() // Position - 0x3B20
{
	return Global_1902569;
}

int func_100(BOOL bParam0) // Position - 0x3B2C
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 12) & 31;
}

int func_101(BOOL bParam0) // Position - 0x3B3F
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 6) & 63;
}

float func_102(float fParam0) // Position - 0x3B51
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_103(var uParam0, int iParam1) // Position - 0x3B67
{
...
int func_104(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3B9D
{
	int duration;
	var data;
	int num;
...
BOOL func_105(int iParam0) // Position - 0x3BE0
{
	if (func_129(iParam0))
		if (!func_130(44))
			return false;
...
void func_106(int iParam0, int iParam1) // Position - 0x3C00
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_107(int iParam0, int iParam1) // Position - 0x3C11
{
	int num;
...
void func_108(var uParam0, var uParam1, int iParam2) // Position - 0x3C27
{
...
void func_109(int iParam0) // Position - 0x3C44
{
...
void func_110(int iParam0) // Position - 0x3D24
{
	int i;
	int num;
...
BOOL func_111(int iParam0, BOOL bParam1) // Position - 0x3EFC
{
	if (func_45() != -1)
		return false;
...
int func_112(int iParam0, BOOL bParam1) // Position - 0x3F2A
{
	if (!func_85(iParam0))
		return 0;
...
int func_113(int iParam0) // Position - 0x3FAD
{
	switch (iParam0)
	{
		case 27:
...
int func_114(int iParam0) // Position - 0x3FD4
{
	switch (iParam0)
	{
		case 33:
...
void func_117(int iParam0, BOOL bParam1) // Position - 0x4237
{
	BOOL flag;
...
Hash func_118(int iParam0) // Position - 0x45E6
{
	if (!func_85(iParam0))
		return 0;
...
void func_119(int iParam0, PersChar pchParam1) // Position - 0x4604
{
	if (!func_85(iParam0))
		return;
...
PersChar func_120(int iParam0) // Position - 0x4625
{
	if (!func_85(iParam0))
		return 0;
...
void func_121(int iParam0, BOOL bParam1) // Position - 0x4645
{
	if (func_45() != -1)
		return;
...
BOOL func_122(int iParam0) // Position - 0x467E
{
	if (!func_85(iParam0))
		return false;
...
BOOL func_123() // Position - 0x46A4
{
	return false;
}

BOOL func_124() // Position - 0x46AD
{
	var unk;
	var unk3;
...
BOOL func_125(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4715
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_126(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x488B
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_127(var uParam0, var uParam1, var uParam2) // Position - 0x489F
{
	int i;
...
const char* func_128(int iParam0) // Position - 0x48CD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_129(int iParam0) // Position - 0x4BB1
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_130(int iParam0) // Position - 0x4BDB
{
	if (!func_161(iParam0))
		return false;
...
struct<2> func_131(Player plParam0) // Position - 0x4BF7
{
	var gamerHandle;
...
const char* func_132(const char* sParam0, int iParam1) // Position - 0x4C0B
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_133(int iParam0, BOOL bParam1) // Position - 0x4C25
{
	char* StringToTest;
...
void func_134(int iParam0, BOOL bParam1) // Position - 0x4C59
{
	switch (iParam0)
	{
		case 5:
...
void func_135(int iParam0, int iParam1) // Position - 0x4C8E
{
	func_163(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_136(int iParam0) // Position - 0x4CA8
{
	if (!func_85(iParam0))
		return false;
...
void func_137(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4CCD
{
	PersChar persChar;
...
void func_138(int iParam0, BOOL bParam1) // Position - 0x4DB9
{
	if (!func_166(iParam0))
		return;
...
void func_139(int iParam0, int iParam1) // Position - 0x4E0F
{
	if (!func_171(iParam0))
		return;
...
int func_140(int iParam0) // Position - 0x4E82
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_141(Hash hParam0) // Position - 0x4E98
{
...
void func_142(int iParam0) // Position - 0x4EB8
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_143(int iParam0, BOOL bParam1) // Position - 0x4ECE
{
	if (func_45() != -1)
		return;
...
void func_144(int iParam0) // Position - 0x4EFF
{
	Ped EntityIndex;
...
void func_145(int iParam0) // Position - 0x4F43
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_146(int iParam0) // Position - 0x4F58
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_147(int iParam0) // Position - 0x4F6D
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_148(int iParam0) // Position - 0x4F82
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_149(int iParam0) // Position - 0x5001
{
...
BOOL func_150(int iParam0, BOOL bParam1) // Position - 0x505E
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL func_151(int iParam0, int iParam1) // Position - 0x5077
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_152(int iParam0, int iParam1) // Position - 0x5090
{
...
int func_153(int iParam0) // Position - 0x50CB
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_154(int iParam0) // Position - 0x50DF
{
	return;
}

BOOL func_155(int iParam0, int iParam1) // Position - 0x50E7
{
	if (iParam0 == -1)
		return false;
...
struct<2> func_157() // Position - 0x5166
{
	return Global_1051268;
}

BOOL func_158(var uParam0, var uParam1) // Position - 0x5174
{
	if (!func_176(uParam0))
		return false;
...
struct<2> func_159() // Position - 0x51A8
{
...
BOOL func_160(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x51F3
{
	var unk;
	float num;
	float num2;
...
BOOL func_161(int iParam0) // Position - 0x5223
{
	if (iParam0 == 0)
		return false;
...
BOOL func_162(int iParam0) // Position - 0x5236
{
	int num;
	int num2;
	int offset;
...
void func_163(BOOL bParam0, int iParam1) // Position - 0x5260
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_164(int iParam0) // Position - 0x5275
{
	if (!func_85(iParam0))
		return false;
...
BOOL func_165(Hash hParam0) // Position - 0x5299
{
	return hParam0 != 0;
}

BOOL func_166(int iParam0) // Position - 0x52A5
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_167(int iParam0, BOOL bParam1) // Position - 0x52BB
{
	if (!func_166(iParam0))
		return false;
...
void func_168(int iParam0, BOOL bParam1) // Position - 0x52E1
{
	if (!func_166(iParam0))
		return;
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x530F
{
	if (!func_166(iParam0))
		return;
...
void func_170(int iParam0) // Position - 0x5349
{
	func_181(func_180(iParam0));
	return;
}

BOOL func_171(int iParam0) // Position - 0x535B
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_172(Hash hParam0) // Position - 0x5371
{
	if (func_182(hParam0))
...
BOOL func_173() // Position - 0x538C
{
	return 1;
}

Ped func_174(int iParam0) // Position - 0x5395
{
	PersChar persChar;
...
BOOL func_175(BOOL bParam0, BOOL bParam1) // Position - 0x53C3
{
	return bParam0 && bParam1 != false;
}

BOOL func_176(int iParam0) // Position - 0x53D2
{
	switch (iParam0)
	{
		case 2:
...
int func_177(int iParam0) // Position - 0x5411
{
	switch (iParam0)
	{
		case 2:
...
void func_178(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x54A7
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_179(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x5F44
{
	float num;
	float num2;
	float num3;
...
int func_180(int iParam0) // Position - 0x5FAA
{
...
void func_181(int iParam0) // Position - 0x64C7
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_182(Hash hParam0) // Position - 0x64D8
{
	return hParam0 != 0;
}
