...
void func_24(var uParam0) // Position - 0x8F4
{
	int i;
...
BOOL func_25(Vehicle veParam0) // Position - 0x976
{
...
void func_26(Vehicle veParam0, BOOL bParam1) // Position - 0x9BA
{
...
BOOL func_27(var uParam0, Entity eParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xA12
{
	int i;
...
void func_28(int iParam0) // Position - 0xB42
{
	int num;
...
BOOL func_30() // Position - 0xBBE
{
	return Global_1149432.f_5568.f_132;
}

void func_31(int iParam0, Player plParam1, Player plParam2, BOOL bParam3) // Position - 0xBCF
{
	BOOL flag;
	Player bitIndex;
	var value;
...
void func_32(Hash hParam0, int iParam1, char* sParam2) // Position - 0xD52
{
	int cashBalance;
	int num;
...
void func_33() // Position - 0xDB6
{
	Global_1149432.f_5568.f_132 = 0;
	return;
}

BOOL func_34(int iParam0, int iParam1) // Position - 0xDC8
{
	if (iParam1 == 255)
...
void func_35(int iParam0, int iParam1) // Position - 0xE02
{
	int data;
	var value;
	Player Plr;
...
BOOL func_36(int iParam0, int iParam1) // Position - 0xF26
{
	return iParam0 && iParam1 != false;
}

BOOL func_37(BOOL bParam0, BOOL bParam1) // Position - 0xF35
{
	int i;
...
BOOL func_38(var uParam0, var uParam1) // Position - 0x1015
{
	return false;
}

void func_39(var uParam0) // Position - 0x101E
{
	BOOL flag;
...
void func_40(var uParam0) // Position - 0x10BB
{
	Player player;
	Any gangId;
	Any gangId2;
...
BOOL func_41(var uParam0, var uParam1) // Position - 0x11FC
{
	func_85(uParam0);
	return false;
}

BOOL func_42(var uParam0, var uParam1) // Position - 0x120B
{
...
BOOL func_43() // Position - 0x1282
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_44(var uParam0) // Position - 0x12A7
{
	func_90(uParam0, 0f);
	return;
}

BOOL func_45(var uParam0, int iParam1) // Position - 0x12B6
{
	if (!func_4(uParam0))
		return false;
...
void func_46(var uParam0, int iParam1) // Position - 0x12DD
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_47(var uParam0) // Position - 0x12F2
{
	return true;
}

BOOL func_48(var uParam0) // Position - 0x12FB
{
	int expected;
	var actual;
	int i;
...
BOOL func_49(var uParam0) // Position - 0x1413
{
	BOOL flag;
...
BOOL func_51(BOOL bParam0) // Position - 0x156F
{
	if (func_96())
		return false;
...
void func_52(int iParam0, var uParam1, var uParam2) // Position - 0x1647
{
	int num;
...
BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1663
{
	if (iParam1 < 0 || iParam1 > 32)
		return false;
...
void func_54(int iParam0, int iParam1) // Position - 0x1705
{
	int Variable;
...
BOOL func_55(var uParam0) // Position - 0x1729
{
...
void func_56(var uParam0) // Position - 0x1903
{
...
void func_57(var uParam0) // Position - 0x197A
{
	func_127(uParam0);
	return;
}

void func_58(var uParam0) // Position - 0x1988
{
	Vehicle EntityIndex;
	int num;
	int flags;
...
void func_59(var uParam0) // Position - 0x1B77
{
	Vehicle EntityIndex;
	Ped ped;
	var unk;
	...
	if (!func_130(EntityIndex, ped, &unk))
		return;

	func_131(EntityIndex);
	num = uParam0->f_2;
...
void func_60(var uParam0) // Position - 0x1C02
{
	Vehicle EntityIndex;
	Ped EntityIndex2;
	...
	for (i = 0; i < 6; i = i + 1)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(EntityIndex3))
			func_132(playerPed, EntityIndex3);
	}
...
void func_61(int iParam0) // Position - 0x1CC6
{
	func_35(2, iParam0);
	return;
}

void func_62(int iParam0) // Position - 0x1CD5
{
	func_35(3, iParam0);
	return;
}

BOOL func_63(var uParam0, var uParam1, var uParam2) // Position - 0x1CE4
{
	return 0;
}

BOOL func_64(var uParam0, var uParam1, var uParam2) // Position - 0x1CED
{
	int num;
...
void func_65(Volume volParam0) // Position - 0x1E3A
{
...
void func_66(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1E51
{
	int num;
...
int func_67(Vehicle veParam0, int iParam1) // Position - 0x1EA5
{
...
BOOL func_68(Vehicle veParam0) // Position - 0x1EC5
{
...
void func_69(int iParam0) // Position - 0x1EE0
{
	int num;
	int BitIndex;
...
struct<4> func_70() // Position - 0x1F14
{
	var unk;
...
BOOL func_71(Player plParam0, BOOL bParam1) // Position - 0x1F20
{
	if (Global_1048576)
		return true;
...
BOOL func_72(Player plParam0, Player plParam1) // Position - 0x1FB0
{
	Player bitIndex;
...
BOOL func_73(int iParam0) // Position - 0x2024
{
	switch (iParam0)
	{
		case 7:
...
int func_74(int iParam0) // Position - 0x206B
{
	switch (iParam0)
	{
		case 7:
...
void func_75(Any* panParam0, var uParam1) // Position - 0x20B4
{
...
float func_76(Player plParam0, BOOL bParam1) // Position - 0x20F4
{
	Player player;
...
BOOL func_77(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2194
{
	Player player;
...
int func_78(Hash hParam0, BOOL bParam1, Hash hParam2) // Position - 0x225D
{
...
BOOL func_79(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x2281
{
	int num;
	BOOL flag;
...
int func_80(Hash hParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, Hash hParam5) // Position - 0x22B0
{
	int cashBalance;
	int goldBarBalance;
	var unk;
...
void func_81(int iParam0, int iParam1, BOOL bParam2) // Position - 0x24A0
{
	char* str;
...
int func_82(int iParam0) // Position - 0x24E5
{
	if (iParam0 == 255)
...
BOOL func_83(int iParam0) // Position - 0x252C
{
...
BOOL func_84(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x2544
{
...
void func_85(var uParam0) // Position - 0x259D
{
...
BOOL func_86(var uParam0) // Position - 0x2672
{
	return func_8(*uParam0, 64);
}

void func_87(var uParam0, BOOL bParam1) // Position - 0x2683
{
...
void func_88(var uParam0, var uParam1) // Position - 0x26A3
{
	return;
}

void func_89(var uParam0) // Position - 0x26AB
{
	if (func_14(uParam0))
		func_17(70, true);
...
void func_90(var uParam0, float fParam1) // Position - 0x26C3
{
...
float func_91(var uParam0) // Position - 0x26E9
{
	if (!func_4(uParam0))
		return uParam0->f_1;
...
Ped func_92(Vehicle veParam0, int iParam1) // Position - 0x271E
{
	Ped pedInDraftHarness;
...
void func_94(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2794
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return;
...
BOOL func_95() // Position - 0x27C8
{
	return Global_1904402.f_8872 != -1;
}

BOOL func_96() // Position - 0x27D9
{
	int currentMessage;
...
BOOL func_97(Any* panParam0, int iParam1, int iParam2) // Position - 0x27F9
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

BOOL func_98() // Position - 0x2830
{
	return Global_1072759.f_28644.f_23.f_3 != 0;
}

BOOL func_99() // Position - 0x2845
{
	if (!func_170())
		return false;
...
BOOL func_100() // Position - 0x2860
{
	return Global_1896762.f_352;
}

BOOL func_101() // Position - 0x286F
{
	BOOL num;
...
BOOL func_102(int iParam0, int iParam1) // Position - 0x2896
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_103(int iParam0) // Position - 0x28AE
{
...
BOOL func_104(int iParam0) // Position - 0x28C5
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x2991
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_106(int iParam0) // Position - 0x29AA
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_107(int iParam0) // Position - 0x29BD
{
	if (iParam0 < 0)
		return false;
...
BOOL func_108(var uParam0) // Position - 0x29FC
{
	Ped EntityIndex;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PED::_GET_FIRST_ENTITY_PED_IS_CARRYING(EntityIndex)))
		return false;
...
int func_110(char* sParam0, Hash hParam1, Volume volParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, Hash hParam12, int iParam13) // Position - 0x2AA1
{
	int i;
	int num;
...
BOOL func_111() // Position - 0x2B61
{
	return Global_1940252.f_2 || Global_1940252 == 1;
}

BOOL func_112(BOOL bParam0) // Position - 0x2B7B
{
	if (bParam0)
...
BOOL func_113(int iParam0) // Position - 0x2BAB
{
...
BOOL func_114(int iParam0) // Position - 0x2BC3
{
	int i;
...
void func_116(int iParam0) // Position - 0x2C12
{
	Global_1940252.f_40 = iParam0;
	return;
}

BOOL func_117(int iParam0, BOOL bParam1) // Position - 0x2C22
{
	int num;
	int gameTimer;
	float progress;
...
void func_118(BOOL bParam0, int iParam1) // Position - 0x2D1C
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
BOOL func_119() // Position - 0x2D3E
{
	return Global_1940252.f_2;
}

Hash func_120(Entity eParam0) // Position - 0x2D4C
{
	Hash hash;
...
BOOL func_121() // Position - 0x2D9F
{
	return func_176() || func_177();
}

BOOL func_122(Hash hParam0) // Position - 0x2DB5
{
	switch (hParam0)
	{
...
BOOL func_123(Hash hParam0) // Position - 0x2DD6
{
...
BOOL func_124(int iParam0) // Position - 0x2DF8
{
...
int func_125(var uParam0) // Position - 0x2E0F
{
	return func_181(uParam0, 1086324736, 1094713344, 1077936128, 1090519040);
}

void func_126(var uParam0) // Position - 0x2E31
{
	if (func_14(uParam0))
		func_35(15, 3);
...
void func_127(var uParam0) // Position - 0x2E49
{
...
BOOL func_128(int iParam0, int iParam1) // Position - 0x2FE3
{
	return iParam0 && iParam1 != false;
}

BOOL func_129(var uParam0) // Position - 0x2FF2
{
	Vehicle EntityIndex;
	Ped EntityIndex2;
	var unk;
	...
	if (!func_130(EntityIndex, EntityIndex2, &unk))
		return false;
...
BOOL func_130(Vehicle veParam0, Ped pedParam1, var uParam2) // Position - 0x3164
{
	Ped pedInTransportSeat;
	int seatIndex;
	int i;
...
void func_131(Vehicle veParam0) // Position - 0x31D5
{
	Ped EntityIndex;
	var unk;
	var args;
	...
	if (!func_130(veParam0, EntityIndex, &unk))
		return;
...
void func_132(Ped pedParam0, Ped pedParam1) // Position - 0x325C
{
...
BOOL func_133(var uParam0, var uParam1) // Position - 0x32A4
{
...
void func_134(var uParam0) // Position - 0x32BC
{
	if (!func_8(*uParam0, 4))
		func_13(uParam0, 4);
...
void func_135(var uParam0) // Position - 0x32D7
{
	if (!func_8(*uParam0, 4))
		func_13(uParam0, 2);
...
void func_136(var uParam0, var uParam1) // Position - 0x32F2
{
	if (func_4(&(uParam0->f_13)))
		func_5(&(uParam0->f_13));
...
void func_137(var uParam0, var uParam1, BOOL bParam2) // Position - 0x336A
{
	Vehicle EntityIndex;
	Player player;
	Ped ped;
...
void func_138(var uParam0, var uParam1) // Position - 0x3415
{
	Player player;
	Ped ped;
	Vehicle EntityIndex;
...
int func_139(int iParam0) // Position - 0x347E
{
	return iParam0;
}

void func_140(int iParam0) // Position - 0x3488
{
	if (!func_196(iParam0))
		return;
...
BOOL func_141(int iParam0) // Position - 0x353B
{
...
BOOL func_142(var uParam0, var uParam1) // Position - 0x355A
{
	if (!func_197(uParam0))
		return false;
...
struct<2> func_143() // Position - 0x358E
{
...
BOOL func_144(Player plParam0, BOOL bParam1) // Position - 0x35D9
{
	Player player;
...
void func_145(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x3655
{
	return;
}

BOOL func_146(Hash hParam0, int iParam1) // Position - 0x365D
{
	if (hParam0 == 0)
		return false;
...
int func_147(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x3677
{
	var unk;
	int num;
	int i;
...
BOOL func_148(int iParam0) // Position - 0x3767
{
	if (iParam0 < 0)
		return false;
...
int func_149(Hash hParam0) // Position - 0x3794
{
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_151(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x37DB
{
	int i;
...
int func_152(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x386B
{
...
BOOL func_153(BOOL bParam0) // Position - 0x392D
{
	if (func_207() == -1)
		return true;
...
BOOL func_154(Hash hParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x394B
{
	int num;
	var unk;
	var unk6;
...
BOOL func_155(Hash hParam0) // Position - 0x39C3
{
	switch (hParam0)
	{
		case -1551258934:
...
int func_156(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x39F0
{
	int num;
...
void func_157(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x3A5A
{
	int i;
...
char* func_158(int iParam0) // Position - 0x3AD8
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_159(int iParam0) // Position - 0x3C7D
{
	return func_224(Global_1290271.f_11.f_755[iParam0]);
}

int func_160(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x3C96
{
	int num;
	var unk13;
	int num2;
...
float func_161() // Position - 0x3CD1
{
...
void func_162(var uParam0, int iParam1) // Position - 0x3D03
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_163(var uParam0, int iParam1) // Position - 0x3D14
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_164(var uParam0) // Position - 0x3D29
{
	return func_36(*uParam0, 2);
}

BOOL func_165(Vehicle veParam0) // Position - 0x3D39
{
...
void func_166(BOOL bParam0) // Position - 0x3D58
{
	int num;
	int num2;
	int i;
...
int func_167() // Position - 0x3E0F
{
	return Global_1290271.f_814.f_280;
}

int func_168(Player plParam0, BOOL bParam1) // Position - 0x3E21
{
	Player player;
...
void func_169(Vehicle veParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3E61
{
	float num;
	float num2;
...
BOOL func_171(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3ECF
{
	float fScreenPosX;
	float fScreenPosY;
	...
	if (hudScreenPositionFromWorldPosition == 0)
		if (fScreenPosX > iParam3 && fScreenPosX < iParam4 && fScreenPosY > iParam5 && fScreenPosY < iParam6)
			return true;

	return false;
}

BOOL func_172(int iParam0, int iParam1) // Position - 0x3F19
{
	if (iParam0 < 0)
		return false;
...
Hash func_174(var uParam0) // Position - 0x4255
{
	Ped pedIndexFromEntityIndex;
...
Hash func_175(Entity eParam0) // Position - 0x427B
{
...
BOOL func_176() // Position - 0x42D9
{
	return Global_1290271.f_814.f_284;
}

BOOL func_177() // Position - 0x42EB
{
	return Global_1290271.f_814.f_283 != -1;
}

int func_178(Hash hParam0) // Position - 0x42FF
{
	switch (hParam0)
	{
...
BOOL func_179(int iParam0) // Position - 0x5E58
{
	return iParam0 != 0;
}

int func_180(Hash hParam0) // Position - 0x5E64
{
	if (func_228(hParam0))
		return 1;
...
int func_181(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x5E7F
{
	var unk;
	var unk2;
	Vector3 vector;
...
void func_182(var uParam0) // Position - 0x5FB8
{
	if (MAP::DOES_BLIP_EXIST(uParam0->f_1))
...
BOOL func_183(Player plParam0, BOOL bParam1) // Position - 0x5FD3
{
	Player bitIndex;
	int playerTeam;
	int playerTeam2;
...
Hash func_184(Hash hParam0) // Position - 0x60D5
{
...
Hash func_185(Hash hParam0, BOOL bParam1) // Position - 0x6113
{
	Hash hash;
...
char* func_186(int iParam0) // Position - 0x6141
{
	var unk;
...
int func_187(Player plParam0) // Position - 0x6195
{
	return Global_1283730[plParam0 /*2*/];
}

BOOL func_188(Player plParam0) // Position - 0x61A5
{
	return Global_1283730[plParam0 /*2*/].f_1;
}

int func_189(int iParam0) // Position - 0x61B7
{
...
BOOL func_190(int iParam0, Vehicle veParam1) // Position - 0x66D4
{
	int num;
	var unk;
	float num2;
...
struct<2> func_191(Player plParam0) // Position - 0x6776
{
	var gamerHandle;
...
BOOL func_192(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x678A
{
	var memberInfo;
	var memberInfo2;
...
BOOL func_193(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x67E6
{
	if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam0->f_3))
		return false;
...
void func_194(int iParam0) // Position - 0x6833
{
	int num;
...
void func_195(Vehicle veParam0) // Position - 0x6858
{
	Ped EntityIndex;
	var unk;
	var args;
...
BOOL func_196(int iParam0) // Position - 0x68DD
{
	return func_172(iParam0, 2);
}

BOOL func_197(int iParam0) // Position - 0x68EC
{
	switch (iParam0)
	{
		case 2:
...
int func_198(int iParam0) // Position - 0x692B
{
	switch (iParam0)
	{
		case 2:
...
struct<2> func_199(int iParam0) // Position - 0x69C1
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_200() // Position - 0x69D5
{
...
BOOL func_201(int iParam0) // Position - 0x6A02
{
	int i;
...
BOOL func_202(Hash hParam0, Hash hParam1) // Position - 0x6AF4
{
	if (!func_146(hParam0, 0))
		return false;
...
BOOL func_203(Hash hParam0) // Position - 0x6B40
{
...
BOOL func_204(Hash hParam0, Hash hParam1) // Position - 0x6B5B
{
	if (!func_146(hParam0, 0))
...
int func_205(Hash hParam0, BOOL bParam1) // Position - 0x6B9C
{
	var unk;
...
int func_206(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6BF4
{
	var unk;
	int num;
	int i;
...
int func_207() // Position - 0x6C88
{
	return Global_1572887.f_14;
}

BOOL func_208(int iParam0) // Position - 0x6C96
{
	if (iParam0 < 0)
		return false;
...
void func_210(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x6CD4
{
	int i;
	int j;
	int k;
...
Hash func_211(Hash hParam0, int iParam1) // Position - 0x6EAA
{
	int num;
	var unk;
	Hash hash;
...
int func_212(Hash hParam0, BOOL bParam1) // Position - 0x6F24
{
	var unk;
	int num;
	int num2;
...
int func_213(Hash hParam0, int iParam1) // Position - 0x6F83
{
	if (iParam1 == 0)
		return 0;
...
int func_214(BOOL bParam0) // Position - 0x6FAF
{
	if (func_207() == -1)
	{
...
struct<4> func_215(Hash hParam0, BOOL bParam1) // Position - 0x6FF0
{
	var unk;
...
BOOL func_216(Hash hParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x7015
{
	int num;
	var unk;
	int num2;
...
struct<5> func_217(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x712D
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_218(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x74A1
{
	var outGuid;
...
BOOL func_219(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x74D2
{
	var unk;
	int num;
	var unk15;
...
BOOL func_220(Hash hParam0, Any* panParam1) // Position - 0x75F0
{
	int num;
...
BOOL func_221(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x77C6
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_222(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x77DD
{
	if (bParam0)
	{
...
int func_223(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x7826
{
	if (bParam0)
	{
		func_279(iParam1, 1, 0, 0);
...
BOOL func_224(int iParam0) // Position - 0x7842
{
	if (iParam0 == 0)
		return false;
...
void func_225(BOOL bParam0) // Position - 0x785C
{
	Player player;
...
BOOL func_226(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x78AB
{
...
BOOL func_227(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x78D2
{
	if (iParam2 < 0)
		return false;
...
BOOL func_228(Hash hParam0) // Position - 0x790D
{
	int i;
	int num;
	Hash hash;
...
int func_229(int iParam0, BOOL bParam1) // Position - 0x794F
{
	Player player;
	Player player2;
	int num;
...
int func_230(Hash hParam0) // Position - 0x7A05
{
	int num;
	Any any;
...
int func_231(int iParam0) // Position - 0x7A5E
{
	if (iParam0 < 0)
		return 0;
...
int func_232(BOOL bParam0) // Position - 0x7A7F
{
	return bParam0 ? Global_1901671.f_701.f_30 : Global_1901671.f_701.f_29;
}

int func_233(Player plParam0, BOOL bParam1) // Position - 0x7A9F
{
	return bParam1 ? Global_1289643[plParam0 /*19*/].f_1 : Global_1289643[plParam0 /*19*/];
}

float func_234(BOOL bParam0, int iParam1) // Position - 0x7ABF
{
	float num;
...
void func_235(int iParam0, BOOL bParam1) // Position - 0x7B17
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_236(int iParam0, BOOL bParam1) // Position - 0x7B6F
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_237(int iParam0, int iParam1) // Position - 0x7B98
{
	if (iParam0 < 0)
		return;
...
Hash func_238(Ped pedParam0) // Position - 0x7BC0
{
	Ped EntityIndex;
...
Vector3 func_239(var uParam0) // Position - 0x7C93
{
	int _int;
	var unk;
...
BOOL func_240(var uParam0) // Position - 0x7CD3
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_3))
		return false;
...
BOOL func_241(var uParam0, var uParam1, int iParam2) // Position - 0x7D1F
{
	Ped playerPed;
...
BOOL func_242(var uParam0, int iParam1) // Position - 0x7D8F
{
	Ped playerPed;
	int num;
...
BOOL func_243(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3* pvParam4) // Position - 0x7E1E
{
	var unk;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x7E83
{
...
int func_245(var uParam0, int iParam1) // Position - 0x7EAD
{
...
Hash func_246(Hash hParam0, BOOL bParam1) // Position - 0x7F01
{
	switch (hParam0)
	{
...
int func_248(int iParam0) // Position - 0x7FE2
{
	switch (iParam0)
	{
		case -1:
...
char* func_249(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x806C
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

Vector3 func_250(Player plParam0) // Position - 0x8080
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

float func_251(int iParam0) // Position - 0x8094
{
	int num;
...
float func_252(Vehicle veParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x80FE
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return 0f;
...
BOOL func_253(float fParam0, var uParam1, var uParam2) // Position - 0x8126
{
	BOOL flag;
...
BOOL func_254(int iParam0) // Position - 0x817B
{
...
BOOL func_256(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x81CE
{
	if (!func_292(iParam0))
		return false;
...
Hash func_257(Hash hParam0) // Position - 0x8206
{
	return hParam0;
}

BOOL func_258(Hash hParam0, Hash hParam1) // Position - 0x8210
{
...
int func_259(Hash hParam0, BOOL bParam1) // Position - 0x8246
{
	int num;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_260(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x827F
{
	int i;
...
int func_261(Hash hParam0) // Position - 0x830E
{
	var unk;
...
void func_262(Hash hParam0, var uParam1, var uParam2) // Position - 0x8339
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_263(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x8545
{
	Hash hash;
...
struct<4> func_264(BOOL bParam0) // Position - 0x8623
{
	int num;
...
void func_265(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x86C4
{
...
BOOL func_266(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x86DF
{
...
BOOL func_267(Hash hParam0, int iParam1) // Position - 0x8704
{
	if (hParam0 == 0)
		return false;
...
BOOL func_268(Hash hParam0) // Position - 0x871E
{
...
BOOL func_269(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x8734
{
	*uParam1 = 0;
...
struct<17> func_270(Hash hParam0, var uParam1) // Position - 0x87A1
{
	var unk;
...
struct<4> func_271(BOOL bParam0) // Position - 0x87F4
{
	int num;
...
int func_272(Hash hParam0, BOOL bParam1) // Position - 0x8894
{
...
BOOL func_273(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x88CB
{
	return func_297(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_274(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x88E6
{
	var unk;
...
struct<4> func_275(BOOL bParam0) // Position - 0x8907
{
	int num;
...
BOOL func_276(Hash hParam0, int iParam1) // Position - 0x8971
{
	Hash hash;
	int num;
	int i;
...
BOOL func_277(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x89DE
{
	return func_300(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_278(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x89F4
{
...
void func_279(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8A0C
{
	int i;
...
BOOL func_280(Hash hParam0) // Position - 0x8AAA
{
	if (!func_146(hParam0, 0))
		return false;
...
int func_281(int iParam0, int iParam1) // Position - 0x8AD8
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_282(Any anParam0, var uParam1) // Position - 0x8F29
{
	*uParam1 = func_302(anParam0);
	return *uParam1 != 0;
}

var func_283(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8F3F
{
	if (bParam0)
		return uParam1;
...
int func_284(float fParam0, float fParam1, float fParam2) // Position - 0x8F56
{
	if (fParam0 > fParam2)
		return fParam2;
...
var func_285(BOOL bParam0, var uParam1, var uParam2) // Position - 0x8F7D
{
	if (bParam0)
		return uParam1;
...
int func_286(Ped pedParam0) // Position - 0x8F94
{
	int num;
	int pedQuality;
...
int func_287(int iParam0) // Position - 0x8FEA
{
	switch (iParam0)
	{
		case joaat("PROVISION_ANIMAL_CARCASS_CHICKEN_PERFECT"):
...
Vector3 func_288(int iParam0) // Position - 0x9A27
{
	float num;
	int value;
	int value2;
...
int func_289(Entity eParam0, Ped pedParam1, int iParam2) // Position - 0x9A83
{
	var entityCoords;
...
BOOL func_290(Player plParam0, Entity eParam1, Vector3* pvParam2, float* pfParam3) // Position - 0x9AA3
{
	Ped playerPed;
...
BOOL func_291(var uParam0, int iParam1) // Position - 0x9B66
{
...
BOOL func_292(int iParam0) // Position - 0x9B84
{
	if (iParam0 == 0)
		return false;
...
BOOL func_293(int iParam0, Hash hParam1) // Position - 0x9B9C
{
	var unk;
	int num;
	Hash unlockHash;
...
void func_294(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x9CE5
{
	int i;
	int j;
	int k;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_295(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x9EBB
{
	int i;
...
int func_297(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x9FEF
{
...
BOOL func_298(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0xA06E
{
	int inventoryId;
...
BOOL func_299(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xA0B3
{
...
BOOL func_300(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xA0E6
{
...
void func_301(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA120
{
	int i;
...
int func_302(int iParam0) // Position - 0xA1FC
{
	switch (iParam0)
	{
		case joaat("PROVISION_SKINNED_CARCASS_OWL_HIGH_QUALITY"):
...
int func_303(Entity eParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0xAC38
{
	var entityCoords;
	...
	n = func_308(entityForwardVector, unk5);
...
BOOL func_304(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3* pvParam6, float* pfParam7) // Position - 0xACC7
{
	...
	if (PATHFIND::GET_CLOSEST_ROAD(vParam0, 2f, 1, &SouthEndNode, &NorthEndNode, &LanesGoingSouth, &LanesGoingNorth, &CentralReservationWidth, true))
	{
		*pvParam6 = { { 0.5f, 0.5f, 0.5f } * (SouthEndNode + NorthEndNode) };
		...
		if (BUILTIN::VDIST(vParam3, SouthEndNode) < BUILTIN::VDIST(vParam3, NorthEndNode))
			*pfParam7 = func_310(NorthEndNode, SouthEndNode, 1);
		else
			*pfParam7 = func_310(SouthEndNode, NorthEndNode, 1);
...
BOOL func_305(Any* panParam0) // Position - 0xAD51
{
...
int func_306(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAD6D
{
...
void func_307(int iParam0) // Position - 0xADA0
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
float func_308(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0xADC3
{
	float num;
...
BOOL func_309(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6, var uParam7, var uParam8) // Position - 0xAE2A
{
	return ((fParam3 - uParam0) * (fParam6.f_1 - uParam0.f_1)) - ((fParam3.f_1 - uParam0.f_1) * (fParam6 - uParam0)) > 0f;
}

float func_310(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0xAE53
{
	float num;
	float Y;
	float X;
...
BOOL func_311(Any* panParam0) // Position - 0xAEB8
{
...
BOOL func_312(Hash hParam0) // Position - 0xAEEE
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

void func_313(var uParam0) // Position - 0xAEFC
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
