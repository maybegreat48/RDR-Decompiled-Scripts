...
void func_1(var uParam0) // Position - 0x3A
{
	int gameTimer;
...
BOOL func_3(var uParam0) // Position - 0xB3
{
...
void func_4(var uParam0, var uParam1, var uParam2) // Position - 0xD8
{
...
void func_5(var uParam0, var uParam1) // Position - 0xFB
{
	int i;
...
void func_6(int iParam0, int iParam1) // Position - 0x18A
{
...
void func_9() // Position - 0x2E6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

int func_10(int iParam0, int iParam1, char* sParam2) // Position - 0x2F2
{
	return 1;
}

int func_11(int iParam0, int iParam1, char* sParam2) // Position - 0x2FB
{
	return 1;
}

void func_12(BOOL bParam0) // Position - 0x304
{
	int num;
	var unk;
	int num2;
...
BOOL func_13(BOOL bParam0, BOOL bParam1) // Position - 0x3CD
{
	int i;
...
void func_14(var uParam0, var uParam1, var uParam2) // Position - 0x4AD
{
	switch (*uParam0)
	{
		case 0:
...
void func_15(var uParam0, var uParam1, var uParam2) // Position - 0x515
{
...
void func_16(var uParam0, var uParam1) // Position - 0x598
{
	Vehicle TrainIndex;
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			TrainIndex = NETWORK::NET_TO_VEH(uParam0->f_1);
...
void func_17(Hash hParam0) // Position - 0x610
{
...
int func_18() // Position - 0x64E
{
	return Global_1572887.f_14;
}

BOOL func_19() // Position - 0x65C
{
	return Global_1051645.f_8;
}

void func_20(var uParam0, var uParam1) // Position - 0x66A
{
	func_33(uParam0, uParam1, 1);
	return;
}

void func_21(var uParam0, var uParam1) // Position - 0x67B
{
...
void func_22(var uParam0, var uParam1) // Position - 0x697
{
	var unk;
	BOOL flag;
	BOOL flag2;
	...
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(uParam0->f_1))
	{
		...
		EntityIndex = NETWORK::NET_TO_VEH(uParam0->f_1);
	
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(EntityIndex))
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(EntityIndex, true, false);
	
		NewTrainSpeed = func_39(uParam1->f_1);
		VEHICLE::SET_TRAIN_SPEED(EntityIndex, NewTrainSpeed);
		VEHICLE::SET_TRAIN_CRUISE_SPEED(EntityIndex, NewTrainSpeed);
		VEHICLE::_0x160C1B5AB48AB87C(EntityIndex, func_40(uParam1->f_1));
		VEHICLE::_SET_TRAIN_STOPS_FOR_STATIONS(EntityIndex, func_41(uParam1->f_1));
		VEHICLE::_0xE6BD7DD3FD474415(EntityIndex, func_42(uParam1->f_1));
		VEHICLE::_0x06A09A6E0C6D2A84(EntityIndex, false);
	
		if (!func_43(uParam1->f_1))
			VEHICLE::_0xA72B1BF3857B94D7(EntityIndex, true);
	
		if (func_44(uParam1->f_1))
			VEHICLE::_0x1BFBAFCC6760FF02(EntityIndex, false);
	}
	else
	{
		EntityIndex2 = NETWORK::NET_TO_VEH(uParam0->f_1);
	
		if (!ENTITY::DOES_ENTITY_EXIST(EntityIndex2))
			func_33(uParam0, uParam1, 4);
		else if (ENTITY::IS_ENTITY_DEAD(EntityIndex2))
			func_33(uParam0, uParam1, 4);
		else if (VEHICLE::_HAS_TRAIN_LOADED(EntityIndex2))
...
void func_23(var uParam0, var uParam1, var uParam2) // Position - 0x7D2
{
	int Participant;
	int i;
	...
	if (uParam0->f_2 == 255)
	{
		...
		for (i = 0; i <= 31; i = i + 1)
		{
			if (func_48(uParam1, 1, i))
			{
				...
				{
					uParam0->f_2 = NETWORK::NETWORK_GET_PLAYER_INDEX(Participant);
					return;
				}
			}
		}
...
void func_24(var uParam0, var uParam1) // Position - 0x883
{
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(uParam0->f_1))
...
void func_25(var uParam0, int iParam1) // Position - 0x8A0
{
...
void func_26(var uParam0, var uParam1) // Position - 0x8B7
{
	if (*uParam0 > 0)
		func_25(uParam1, 1);
...
void func_27(var uParam0, var uParam1) // Position - 0x8CD
{
...
void func_28(var uParam0, var uParam1) // Position - 0x8F1
{
	Vehicle EntityIndex;
	...
	if (*uParam0 > 2 && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(uParam0->f_1))
	{
		...
		else if (VEHICLE::_HAS_TRAIN_LOADED(EntityIndex))
		{
			func_49(*uParam1, EntityIndex);
			...
			if (func_50(uParam1->f_1))
			{
				...
				{
					uParam1->f_3 = MAP::BLIP_ADD_FOR_ENTITY(-399496385, EntityIndex);
				}
			...
			if (!func_54(uParam1->f_1))
			{
				...
				VEHICLE::SET_VEHICLE_DOORS_LOCKED_FOR_PLAYER(EntityIndex, PLAYER::PLAYER_ID(), true);
				VEHICLE::SET_DONT_ALLOW_PLAYER_TO_ENTER_VEHICLE_IF_LOCKED_FOR_PLAYER(EntityIndex, true);
			}
		
			trainCarriageTrailerNumber = VEHICLE::_GET_TRAIN_CARRIAGE_TRAILER_NUMBER(EntityIndex);
			func_55(*uParam1, trainCarriageTrailerNumber);
			i = 0;
		
			for (i = 0; i <= trainCarriageTrailerNumber - 1; i = i + 1)
			{
				uParam1->f_4[i] = VEHICLE::GET_TRAIN_CARRIAGE(EntityIndex, i);
				...
				if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_4[i]) && !ENTITY::IS_ENTITY_DEAD(uParam1->f_4[i]))
				{
					...
					MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(uParam1->f_4[i]), &returnMin, &returnMax);
					num = { returnMax - returnMin };
					num = num * 0.9f;
...
void func_29(var uParam0, var uParam1, var uParam2) // Position - 0xB3D
{
	if (func_45(uParam0, uParam2))
	{
		func_25(uParam2, 4);
...
void func_30(var uParam0, var uParam1) // Position - 0xBBE
{
	func_16(uParam0, uParam1);
...
void func_31(var uParam0) // Position - 0xBDC
{
	Entity EntityIndex;
	Vector3 entityCoords;
	Vector3 vector;

	EntityIndex = uParam0->f_4[0];

	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(EntityIndex) && !ENTITY::IS_ENTITY_DEAD(EntityIndex))
	{
...
int func_32(int iParam0, BOOL bParam1) // Position - 0xC9C
{
	var unk;
...
void func_33(var uParam0, var uParam1, int iParam2) // Position - 0xCE8
{
	if (*uParam0 != iParam2)
		*uParam0 = iParam2;
...
BOOL func_34(Hash hParam0) // Position - 0xCFD
{
	BOOL num;
	Hash trainModelFromTrainConfigByCarIndex;
	int numCarsFromTrainConfig;
...
Vector3 func_35(int iParam0) // Position - 0xD4E
{
	return Global_1148506.f_2[iParam0 /*18*/].f_3;
}

BOOL func_36(int iParam0) // Position - 0xD64
{
	return Global_1148506.f_2[iParam0 /*18*/].f_6;
}

BOOL func_37(var uParam0) // Position - 0xD78
{
	if (func_69(uParam0))
		return 1;
...
BOOL func_38(var uParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0xD8E
{
	int i;
	int numCarsFromTrainConfig;
	BOOL flag;
	...
	EntityIndex = VEHICLE::_CREATE_MISSION_TRAIN(hParam1, vParam2, bParam5, bParam6, true, bParam8);

	if (!ENTITY::DOES_ENTITY_EXIST(EntityIndex))
		return false;

	VEHICLE::_0x06A09A6E0C6D2A84(EntityIndex, false);
	*uParam0 = NETWORK::VEH_TO_NET(EntityIndex);
...
float func_39(int iParam0) // Position - 0xE45
{
	if (func_69(iParam0))
		return 4.5f;
...
float func_40(int iParam0) // Position - 0xEA7
{
	if (func_69(iParam0))
		return 5f;
...
BOOL func_41(int iParam0) // Position - 0xEC1
{
	if (func_69(iParam0))
		return true;
...
BOOL func_42(int iParam0) // Position - 0xED7
{
	if (func_69(iParam0))
		return true;
...
BOOL func_43(int iParam0) // Position - 0xEED
{
	switch (iParam0)
	{
		case -735194130:
...
BOOL func_44(int iParam0) // Position - 0xF12
{
	switch (iParam0)
	{
		case -343202759:
...
BOOL func_45(var uParam0, var uParam1) // Position - 0xF2D
{
	if (func_71(1))
		return true;
...
BOOL func_46(var uParam0) // Position - 0xFAF
{
	int i;
	int num;
...
void func_47(var uParam0, var uParam1) // Position - 0xFF3
{
	Vehicle EntityIndex;
	int trainCarriageTrailerNumber;
	int num;
...
BOOL func_48(var uParam0, int iParam1, int iParam2) // Position - 0x10A1
{
...
void func_49(int iParam0, Vehicle veParam1) // Position - 0x10CB
{
	Global_1149035.f_2[iParam0 /*43*/].f_2 = veParam1;
	return;
}

BOOL func_50(int iParam0) // Position - 0x10E1
{
	if (func_69(iParam0))
		return false;
...
Blip func_51(int iParam0) // Position - 0x1113
{
	return Global_1149035.f_2[iParam0 /*43*/].f_6;
}

BOOL func_52(int iParam0, int iParam1) // Position - 0x1127
{
	int i;
...
void func_53(int iParam0, var uParam1) // Position - 0x116E
{
	Global_1149035.f_2[iParam0 /*43*/].f_6 = uParam1;
	return;
}

BOOL func_54(int iParam0) // Position - 0x1184
{
	switch (iParam0)
	{
		case -735194130:
...
void func_55(int iParam0, int iParam1) // Position - 0x11A9
{
	Global_1149035.f_2[iParam0 /*43*/].f_5 = iParam1;
	return;
}

BOOL func_56(var uParam0) // Position - 0x11BF
{
	return true;
}

void func_57(int iParam0, int iParam1, Entity eParam2) // Position - 0x11C8
{
	Global_1149035.f_2[iParam0 /*43*/].f_12[iParam1 /*2*/] = eParam2;
	return;
}

void func_58(int iParam0, int iParam1, Volume volParam2) // Position - 0x11E2
{
	Global_1149035.f_2[iParam0 /*43*/].f_12[iParam1 /*2*/].f_1 = volParam2;
	return;
}

void func_59(int iParam0, int iParam1) // Position - 0x11FE
{
...
BOOL func_60(var uParam0, var uParam1) // Position - 0x1232
{
	Vehicle EntityIndex;
	Ped driverOfVehicle;

	EntityIndex = uParam1->f_4[0];
	...
	driverOfVehicle = VEHICLE::GET_DRIVER_OF_VEHICLE(EntityIndex);
...
void func_61(var uParam0, int iParam1, int iParam2) // Position - 0x1272
{
	if (iParam2 < 0 || iParam2 >= 32)
		return;
...
BOOL func_63(var uParam0) // Position - 0x1385
{
	Entity EntityIndex;
	Vector3 entityCoords;
	float num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1427
{
...
BOOL func_65(int iParam0, BOOL bParam1) // Position - 0x1451
{
	if (!func_82())
		return false;
...
void func_66(int iParam0) // Position - 0x148C
{
	Global_1149035.f_2[iParam0 /*43*/].f_10 = Global_1295666.f_16 + 60;
	return;
}

var func_67(int iParam0, int iParam1) // Position - 0x14A8
{
	return func_84(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

int func_68(Any* panParam0, var uParam1) // Position - 0x14C6
{
...
BOOL func_69(int iParam0) // Position - 0x14FF
{
	switch (iParam0)
	{
		case -1865722934:
...
BOOL func_70(Hash hParam0) // Position - 0x1532
{
	if (hParam0 == 0)
		return true;
...
BOOL func_71(int iParam0) // Position - 0x1551
{
	return func_73(Global_1149035.f_1, iParam0);
}

int func_72(int iParam0) // Position - 0x1565
{
	return Global_1148506.f_2[iParam0 /*18*/].f_1;
}

BOOL func_73(int iParam0, int iParam1) // Position - 0x1579
{
	return iParam0 && iParam1 != false;
}

void func_74(var uParam0, var uParam1, int iParam2, Entity eParam3) // Position - 0x1588
{
	Vector3 entityCoords;
	float radius;
	Hash hashKey;
...
void func_75(int iParam0, int iParam1) // Position - 0x16AD
{
	func_85(iParam0, iParam1);
	return;
}

int func_76(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, Hash hParam10, BOOL bParam11, BOOL bParam12, int iParam13, BOOL bParam14, BOOL bParam15) // Position - 0x16BD
{
	Volume volume;
	int num;
...
Hash func_77() // Position - 0x171B
{
	return Global_1939102.f_26;
}

void func_78(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x1729
{
...
BOOL func_79(var uParam0, int iParam1) // Position - 0x180D
{
	return func_73(uParam0->f_20, iParam1);
}

void func_80(var uParam0, int iParam1) // Position - 0x181F
{
...
BOOL func_81(int iParam0) // Position - 0x183F
{
	int frameCount;
...
void func_83(int iParam0, int iParam1) // Position - 0x18CC
{
...
var func_84(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x18EF
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_91(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
void func_85(int iParam0, int iParam1) // Position - 0x1C82
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

int func_86(var uParam0, var uParam1, int iParam2, Volume volParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, Hash hParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0x1C93
{
	ItemSet itemSet;
	...
	if (entitiesInVolume > 0)
	{
		for (i = 0; i < entitiesInVolume; i = i + 1)
		{
			...
			{
				if (func_95(EntityIndex, bParam4, bParam6, bParam8, bParam9, bParam10) && !DECORATOR::DECOR_EXIST_ON(EntityIndex, "bIgnoreThisPed"))
				{
					if (!func_96(EntityIndex, uParam1))
					{
						flag = false;
...
void func_87(Volume volParam0) // Position - 0x1DA7
{
...
BOOL func_88(Ped pedParam0, int iParam1) // Position - 0x1DBE
{
	int num;
...
int func_89() // Position - 0x1EBD
{
	return Global_1051645.f_12;
}

char* func_90() // Position - 0x1ECB
{
	return "unnamed";
}

BOOL func_91(int iParam0) // Position - 0x1ED6
{
	int num;
...
BOOL func_92(int iParam0) // Position - 0x1F65
{
...
int func_93(int iParam0) // Position - 0x1F83
{
	if (iParam0 == 255)
...
BOOL func_94(Player plParam0) // Position - 0x1FCE
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_95(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x2013
{
...
BOOL func_96(Ped pedParam0, var uParam1) // Position - 0x208B
{
	int i;
...
BOOL func_97(int iParam0, int iParam1) // Position - 0x20B7
{
	int num;
...
BOOL func_98(Player plParam0) // Position - 0x212B
{
...
void func_99(Player plParam0) // Position - 0x2148
{
	Player player;
...
int func_100(Ped pedParam0, BOOL bParam1) // Position - 0x21CB
{
	return func_105(pedParam0, Global_1893611.f_2, bParam1);
}

BOOL func_101(Any* panParam0, int iParam1, int iParam2) // Position - 0x21E1
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_102() // Position - 0x2218
{
	return Global_1102813.f_3672;
}

void func_103(Player plParam0) // Position - 0x2227
{
	Player player;
...
void func_104(Player plParam0) // Position - 0x2293
{
...
int func_105(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x22CE
{
	var unk;
	var unk2;
...
BOOL func_106(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2300
{
	BOOL flag;
...
int func_107(Ped pedParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x29C0
{
...
Hash func_108(int iParam0) // Position - 0x2A3A
{
	if (!func_110(iParam0))
		return 0;
...
PersChar func_109(int iParam0) // Position - 0x2A58
{
	if (!func_110(iParam0))
		return 0;
...
BOOL func_110(int iParam0) // Position - 0x2A78
{
