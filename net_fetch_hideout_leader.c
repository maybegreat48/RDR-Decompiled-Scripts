...
void func_1(int iParam0) // Position - 0x3D
{
	func_7(32, iParam0);
	func_8();
...
void func_2(var uParam0) // Position - 0x78
{
	Entity EntityIndex;
...
void func_7(int iParam0, int iParam1) // Position - 0x1AA
{
...
int func_9(int iParam0, int iParam1, char* sParam2) // Position - 0x2D8
{
	return 1;
}

void func_10(BOOL bParam0) // Position - 0x2E1
{
	int num;
	var unk;
	int num2;
...
void func_11(int iParam0) // Position - 0x3AA
{
	if (iLocal_0 != iParam0)
		iLocal_0 = iParam0;
...
void func_12(var uParam0, BOOL bParam1) // Position - 0x3BD
{
...
BOOL func_13(BOOL bParam0, BOOL bParam1) // Position - 0x3DD
{
	int i;
...
BOOL func_14(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x4BD
{
...
int func_17() // Position - 0x69F
{
	return Global_1572887.f_14;
}

BOOL func_18() // Position - 0x6AD
{
	return Global_1051645.f_8;
}

BOOL func_19(var uParam0) // Position - 0x6BB
{
	return func_29(*uParam0, 1);
}

void func_20(var uParam0) // Position - 0x6CB
{
	func_30(uParam0, 0);
	return;
}

BOOL func_21(var uParam0, var uParam1) // Position - 0x6DA
{
	if (!func_31(uParam0))
		return false;
...
BOOL func_22(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x70E
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

BOOL func_23(int iParam0) // Position - 0x729
{
...
BOOL func_24(BOOL bParam0, int iParam1) // Position - 0x74A
{
...
BOOL func_25() // Position - 0x786
{
	...
	if (!func_21(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

BOOL func_26() // Position - 0x7DE
{
	int i;
	struct<32> data;
	...
	for (i = 0; i < SCRIPTS::GET_NUMBER_OF_EVENTS(SCRIPT_EVENT_QUEUE_NETWORK); i = i + 1)
	{
		switch (SCRIPTS::GET_EVENT_AT_INDEX(SCRIPT_EVENT_QUEUE_NETWORK, i))
		{
			case -1315570756:
				...
				if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(data) != iLocal_0.f_13)
					return false;
			
				if (!data.f_3 && !ENTITY::IS_ENTITY_DEAD(data))
					return false;
			
				if (data.f_24)
					return false;
			
				if (!PED::IS_PED_A_PLAYER(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(data.f_1)))
					return false;
			
				return GANG::NETWORK_GET_GANG_ID(NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(data.f_1))) == GANG::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID());
		}
	}
...
void func_28(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x94A
{
	var unk;
	var value;
	int i;
...
BOOL func_29(int iParam0, int iParam1) // Position - 0xA8B
{
	return iParam0 && iParam1 != false;
}

void func_30(var uParam0, int iParam1) // Position - 0xA9A
{
...
BOOL func_31(int iParam0) // Position - 0xAD6
{
	switch (iParam0)
	{
		case 2:
...
int func_32(int iParam0) // Position - 0xB15
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_33(int iParam0, int iParam1) // Position - 0xBAB
{
	return iParam0 && iParam1 != false;
}

BOOL func_34(var uParam0, int iParam1) // Position - 0xBBA
{
	if (!func_19(uParam0))
		return false;
...
BOOL func_35() // Position - 0xBE0
{
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr) && GANG::NETWORK_GET_GANG_ID(Plr) == iLocal_0.f_12)
		{
...
BOOL func_36(Ped pedParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0xC61
{
	char* str;
...
void func_37(var uParam0, int iParam1) // Position - 0xCA8
{
	func_45(uParam0, iParam1);
	return;
}

BOOL func_38() // Position - 0xCB8
{
	if (func_17() != 0)
		return true;
...
int func_39(int iParam0, int iParam1) // Position - 0xD10
{
	switch (iParam0)
	{
		case -2086327823:
...
void func_40(Any* panParam0, var uParam1) // Position - 0x11B7
{
...
void func_41(var uParam0, int iParam1) // Position - 0x11EE
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_42(var uParam0, int iParam1) // Position - 0x11FF
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_43(var uParam0) // Position - 0x1214
{
	if (!func_19(uParam0))
		return 0;
...
BOOL func_44(Ped pedParam0, Any* panParam1) // Position - 0x1245
{
	return AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, panParam1);
}

void func_45(var uParam0, int iParam1) // Position - 0x1255
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_46(var uParam0) // Position - 0x1266
{
	return func_29(*uParam0, 2);
}

int func_47(int iParam0) // Position - 0x1276
{
