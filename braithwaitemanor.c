...
void _DEBUG_PRINT(int iParam0) // Position - 0x814
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x820
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x82D
{
	Volume volume;
	ItemSet itemSet;
...
BOOL func_17(int iParam0) // Position - 0xA2D
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0xA3A
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0xA46
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0xA5B
{
	return func_54(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0xA6C
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0xAAB
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0xAB7
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0xABF
{
	if (func_55(iParam0))
		return true;
...
void func_25() // Position - 0xB6F
{
	return;
}

void func_26() // Position - 0xB77
{
	return;
}

void func_27() // Position - 0xB7F
{
	return;
}

void func_28() // Position - 0xB87
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xB8F
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0xB9B
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0xBA7
{
	return;
}

void func_32() // Position - 0xBAF
{
	return;
}

void func_33(int iParam0) // Position - 0xBB7
{
	func_59(0.775f, 0.2f, 0.025f, 0f);
	return;
}

void func_34() // Position - 0xBD3
{
...
void func_35(var uParam0) // Position - 0xC04
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xC4A
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xC5F
{
	if (!func_61(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xC78
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xC89
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xCA1
{
	int i;
...
void func_41(var uParam0, int iParam1) // Position - 0xD4E
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xE8D
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xE9A
{
...
BOOL func_44(int iParam0) // Position - 0xED0
{
	if (iParam0 == 0)
	{
		func_80();
...
int func_45() // Position - 0xFE4
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xFF2
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xFFE
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0x106B
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x114B
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x1169
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x117C
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x119A
{
	BOOL flag;
...
BOOL func_54(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x11F1
{
	int num;
	int num2;
	int num3;
...
BOOL func_55(int iParam0) // Position - 0x12E9
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_56(int iParam0) // Position - 0x12FA
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_57(int iParam0) // Position - 0x130E
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_58(var uParam0, var uParam1) // Position - 0x1322
{
	return uParam0;
}

void func_59(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x132C
{
...
void func_60(var uParam0, Volume volParam1, int iParam2) // Position - 0x1354
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_61(int iParam0) // Position - 0x13AD
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_62() // Position - 0x13C3
{
	int i;
...
BOOL func_63(var uParam0) // Position - 0x13F0
{
	if (func_99())
	{
		if (!*uParam0)
...
void func_64(Hash hParam0, BOOL bParam1, float fParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x1420
{
...
BOOL func_65(int iParam0) // Position - 0x14AB
{
	int num;
	int num2;
	int offset;
...
BOOL func_66(int iParam0) // Position - 0x152A
{
	if (!func_110(iParam0))
		return false;
...
BOOL func_67(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x1546
{
...
BOOL func_68(int iParam0, int iParam1) // Position - 0x157C
{
	return iParam0 && iParam1 != false;
}

BOOL func_69(var uParam0, int iParam1) // Position - 0x158B
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_70() // Position - 0x159C
{
	return func_68(Global_1940199, 8192);
}

BOOL func_71(var uParam0, int iParam1) // Position - 0x15AF
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_72(int iParam0) // Position - 0x15C0
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_73(int iParam0, int iParam1) // Position - 0x1600
{
...
int func_74() // Position - 0x162D
{
	return Global_1896646.f_41;
}

void func_75(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x163B
{
	BOOL flag;
	...
	StringToTest = func_114(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_126(&unk, joaat("COLOR_PURE_WHITE")), str3, func_126(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_126(&unk, joaat("COLOR_PURE_WHITE")), func_126(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_127(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_76(var uParam0, int iParam1) // Position - 0x18A0
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_77(int iParam0, BOOL bParam1) // Position - 0x18B3
{
...
void func_78(BOOL bParam0) // Position - 0x1F1C
{
	if (bParam0)
...
BOOL func_79(int iParam0) // Position - 0x1F45
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_80() // Position - 0x1F8A
{
	return;
}

Hash func_81(int iParam0, BOOL bParam1) // Position - 0x1F92
{
	switch (iParam0)
	{
		case 0:
...
void func_82(int iParam0, BOOL bParam1) // Position - 0x2757
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_83(BOOL bParam0) // Position - 0x27AA
{
	if (bParam0)
...
void func_84(int iParam0) // Position - 0x27D3
{
	func_59(0.775f, 0.2f, 0.025f, 0f);
...
void func_85(int iParam0) // Position - 0x283A
{
	int i;
...
void func_86(int iParam0) // Position - 0x286B
{
	int i;
...
BOOL func_87(int iParam0, BOOL bParam1) // Position - 0x289E
{
	int num;
	int num2;
	int num3;
...
BOOL func_88(int iParam0) // Position - 0x2954
{
	int i;
...
BOOL func_89(int iParam0, BOOL bParam1) // Position - 0x29CE
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_90(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x29FF
{
	int num;
	int num2;
	int value;
...
BOOL func_91(int iParam0) // Position - 0x2A47
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_92(int iParam0) // Position - 0x2A68
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_93(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2ABB
{
	BOOL flag;
...
BOOL func_94(int iParam0) // Position - 0x317B
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_95(int iParam0) // Position - 0x3192
{
	switch (iParam0)
	{
		case 64:
...
int func_96(int iParam0, BOOL bParam1) // Position - 0x31D5
{
	if (!func_94(iParam0))
		return 0;
...
BOOL func_97(int iParam0) // Position - 0x32C0
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_98(int iParam0) // Position - 0x32D6
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_99() // Position - 0x32EC
{
	if (Global_1572887.f_14 == -1)
		return false;
...
Hash func_100(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3308
{
...
BOOL func_101(Hash hParam0) // Position - 0x33AC
{
	if (func_146(hParam0))
...
void func_102(Hash hParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x33C7
{
	if (func_101(hParam0))
	{
...
void func_103(Hash hParam0, BOOL bParam1) // Position - 0x33FF
{
	if (func_101(hParam0))
...
void func_104(Hash hParam0, BOOL bParam1) // Position - 0x342D
{
	if (func_101(hParam0))
...
void func_105(Hash hParam0, BOOL bParam1) // Position - 0x345B
{
	if (func_101(hParam0))
...
BOOL func_106() // Position - 0x3489
{
	return true;
}

int func_107(int iParam0, int iParam1) // Position - 0x3492
{
	switch (iParam0)
	{
...
BOOL func_108(int iParam0) // Position - 0x589E
{
	int num;
...
BOOL func_109(int iParam0) // Position - 0x58BB
{
...
BOOL func_110(int iParam0) // Position - 0x58D2
{
	if (iParam0 == 0)
		return false;
...
BOOL func_111(int iParam0) // Position - 0x58E5
{
	int num;
	int num2;
	int offset;
...
BOOL func_112(int iParam0) // Position - 0x590F
{
...
const char* func_114(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x5987
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_151(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_153(func_152(Global_34));
...
BOOL func_115(int iParam0) // Position - 0x63EB
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_116(int iParam0) // Position - 0x6400
{
	switch (iParam0)
	{
		case 0:
...
int func_117(int iParam0) // Position - 0x64BB
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_118(int iParam0) // Position - 0x6529
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_119(int iParam0) // Position - 0x6684
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_120(int iParam0, BOOL bParam1) // Position - 0x66BF
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_121(int iParam0, int iParam1) // Position - 0x6701
{
	if (!func_115(iParam0))
		return false;
...
int func_122() // Position - 0x6746
{
	return Global_1902569;
}

int func_123(int iParam0) // Position - 0x6752
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_124(int iParam0) // Position - 0x6765
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_125(float fParam0) // Position - 0x6777
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_126(var uParam0, int iParam1) // Position - 0x678D
{
...
int func_127(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x67C3
{
	int duration;
	var data;
	int num;
...
BOOL func_128(int iParam0) // Position - 0x6806
{
	if (func_154(iParam0))
		if (!func_66(44))
			return false;
...
void func_129(int iParam0, int iParam1) // Position - 0x6826
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_130(int iParam0, int iParam1) // Position - 0x6837
{
	int num;
...
void func_131(var uParam0, var uParam1, int iParam2) // Position - 0x684D
{
...
void func_132(int iParam0) // Position - 0x686A
{
...
void func_133(int iParam0) // Position - 0x694A
{
	int i;
	int num;
...
BOOL func_134(int iParam0, BOOL bParam1) // Position - 0x6B22
{
	if (func_45() != -1)
		return false;
...
int func_135(int iParam0, BOOL bParam1) // Position - 0x6B50
{
	if (!func_94(iParam0))
		return 0;
...
int func_136(int iParam0) // Position - 0x6BD3
{
	switch (iParam0)
	{
		case 27:
...
int func_137(int iParam0) // Position - 0x6BFA
{
	switch (iParam0)
	{
		case 33:
...
void func_140(int iParam0, BOOL bParam1) // Position - 0x6E5D
{
	BOOL flag;
...
Hash func_141(int iParam0) // Position - 0x720C
{
	if (!func_94(iParam0))
		return 0;
...
void func_142(int iParam0, PersChar pchParam1) // Position - 0x722A
{
	if (!func_94(iParam0))
		return;
...
PersChar func_143(int iParam0) // Position - 0x724B
{
	if (!func_94(iParam0))
		return 0;
...
void func_144(int iParam0, BOOL bParam1) // Position - 0x726B
{
	if (func_45() != -1)
		return;
...
BOOL func_145(int iParam0) // Position - 0x72A4
{
	if (!func_94(iParam0))
		return false;
...
BOOL func_146(Hash hParam0) // Position - 0x72CA
{
	return hParam0 != 0;
}

int func_147(int iParam0) // Position - 0x72D6
{
	return func_180(iParam0) + 30;
}

BOOL func_148() // Position - 0x72E6
{
	return false;
}

BOOL func_149() // Position - 0x72EF
{
	var unk;
	var unk3;
...
BOOL func_150(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7357
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_151(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x74CD
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_152(var uParam0, var uParam1, var uParam2) // Position - 0x74E1
{
	int i;
...
const char* func_153(int iParam0) // Position - 0x750F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_154(int iParam0) // Position - 0x77F3
{
	switch (iParam0)
	{
		case 22:
...
struct<2> func_155(Player plParam0) // Position - 0x781D
{
	var gamerHandle;
...
const char* func_156(const char* sParam0, int iParam1) // Position - 0x7831
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_157(int iParam0, BOOL bParam1) // Position - 0x784B
{
	char* StringToTest;
...
void func_158(int iParam0, BOOL bParam1) // Position - 0x787F
{
	switch (iParam0)
	{
		case 5:
...
void func_159(int iParam0, int iParam1) // Position - 0x78B4
{
	func_186(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_160(int iParam0) // Position - 0x78CE
{
	if (!func_94(iParam0))
		return false;
...
void func_161(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x78F3
{
	PersChar persChar;
...
void func_162(int iParam0, BOOL bParam1) // Position - 0x79DF
{
	if (!func_189(iParam0))
		return;
...
void func_163(int iParam0, int iParam1) // Position - 0x7A35
{
	if (!func_194(iParam0))
		return;
...
int func_164(int iParam0) // Position - 0x7AA8
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_165(Hash hParam0) // Position - 0x7ABE
{
...
void func_166(int iParam0) // Position - 0x7ADE
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_167(int iParam0, BOOL bParam1) // Position - 0x7AF4
{
	if (func_45() != -1)
		return;
...
void func_168(int iParam0) // Position - 0x7B25
{
	Ped EntityIndex;
...
void func_169(int iParam0) // Position - 0x7B69
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_170(int iParam0) // Position - 0x7B7E
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_171(int iParam0) // Position - 0x7B93
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_172(int iParam0) // Position - 0x7BA8
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_173(int iParam0) // Position - 0x7C27
{
...
BOOL func_174(int iParam0, int iParam1) // Position - 0x7C84
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_175(int iParam0, int iParam1) // Position - 0x7C9D
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_176(int iParam0, int iParam1) // Position - 0x7CB6
{
...
int func_177(int iParam0) // Position - 0x7CF1
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_178(int iParam0) // Position - 0x7D05
{
	return;
}

BOOL func_179(int iParam0, int iParam1) // Position - 0x7D0D
{
	if (iParam0 == -1)
		return false;
...
int func_180(int iParam0) // Position - 0x7D34
{
	return iParam0 * 31;
}

BOOL func_181() // Position - 0x7D40
{
	if (Global_1048576)
		return true;
	...
	if (!func_183(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_182() // Position - 0x7D98
{
	return Global_1051268;
}

BOOL func_183(var uParam0, var uParam1) // Position - 0x7DA6
{
	if (!func_198(uParam0))
		return false;
...
struct<2> func_184() // Position - 0x7DDA
{
...
BOOL func_185(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7E25
{
	var unk;
	float num;
	float num2;
...
void func_186(var uParam0, int iParam1) // Position - 0x7E55
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_187(int iParam0) // Position - 0x7E6A
{
	if (!func_94(iParam0))
		return false;
...
BOOL func_188(Hash hParam0) // Position - 0x7E8E
{
	return hParam0 != 0;
}

BOOL func_189(int iParam0) // Position - 0x7E9A
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_190(int iParam0, BOOL bParam1) // Position - 0x7EB0
{
	if (!func_189(iParam0))
		return false;
...
void func_191(int iParam0, BOOL bParam1) // Position - 0x7ED6
{
	if (!func_189(iParam0))
		return;
...
void func_192(int iParam0, BOOL bParam1) // Position - 0x7F04
{
	if (!func_189(iParam0))
		return;
...
void func_193(int iParam0) // Position - 0x7F3E
{
	func_203(func_202(iParam0));
	return;
}

BOOL func_194(int iParam0) // Position - 0x7F50
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_195() // Position - 0x7F66
{
	return 1;
}

Ped func_196(int iParam0) // Position - 0x7F6F
{
	PersChar persChar;
...
BOOL func_197(BOOL bParam0, BOOL bParam1) // Position - 0x7F9D
{
	return bParam0 && bParam1 != false;
}

BOOL func_198(int iParam0) // Position - 0x7FAC
{
	switch (iParam0)
	{
		case 2:
...
int func_199(int iParam0) // Position - 0x7FEB
{
	switch (iParam0)
	{
		case 2:
...
void func_200(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x808F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_201(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x8B2C
{
	float num;
	float num2;
	float num3;
...
int func_202(int iParam0) // Position - 0x8B92
{
...
void func_203(int iParam0) // Position - 0x90AF
{
