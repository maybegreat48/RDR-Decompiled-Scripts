...
void func_4() // Position - 0xCC
{
	return;
}

void func_5() // Position - 0xD4
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_6(int iParam0, int iParam1) // Position - 0xE0
{
...
void func_10(BOOL bParam0) // Position - 0x2A4
{
	int num;
	var unk;
	int num2;
...
BOOL func_11(BOOL bParam0, BOOL bParam1) // Position - 0x36D
{
	int i;
...
BOOL func_13() // Position - 0x461
{
	...
	if (!func_29(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

void func_14() // Position - 0x4B9
{
	int i;
...
int func_20() // Position - 0x807
{
	return Global_1572887.f_14;
}

BOOL func_21() // Position - 0x815
{
	return Global_1051645.f_8;
}

void func_22() // Position - 0x823
{
	func_60();
	func_61();
	return;
...
BOOL func_23(int iParam0, int iParam1, char* sParam2) // Position - 0x833
{
	return true;
}

void func_24() // Position - 0x83C
{
	int i;
...
BOOL func_26(int iParam0, int iParam1, char* sParam2) // Position - 0x88E
{
	return true;
}

BOOL func_27() // Position - 0x897
{
	return !Global_1572887.f_10;
}

void func_28() // Position - 0x8A6
{
...
BOOL func_29(var uParam0, var uParam1) // Position - 0x8C2
{
	if (!func_66(uParam0))
		return false;
...
BOOL func_30(int iParam0) // Position - 0x8F6
{
	return iParam0 != 0;
}

int func_31(int iParam0) // Position - 0x902
{
	return (Global_1295666.f_16 - iParam0) * 1000;
}

int func_32(int iParam0) // Position - 0x916
{
	return Global_1260806.f_3357[iParam0];
}

void func_33(int iParam0) // Position - 0x929
{
	*iParam0 = 0;
	return;
}

BOOL func_34(int iParam0) // Position - 0x935
{
	switch (iParam0)
	{
		case joaat("OVERCAST"):
...
BOOL func_35(int iParam0) // Position - 0x96E
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
BOOL func_36(int iParam0) // Position - 0x9B3
{
	switch (iParam0)
	{
		case joaat("snow"):
...
BOOL func_37(int iParam0) // Position - 0x9E6
{
	switch (iParam0)
	{
		case joaat("Fog"):
...
BOOL func_38(int iParam0) // Position - 0xA01
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
BOOL func_39(int iParam0) // Position - 0xA28
{
	switch (iParam0)
	{
		case joaat("SNOWLIGHT"):
...
BOOL func_40(int iParam0) // Position - 0xA49
{
	switch (iParam0)
	{
...
BOOL func_41(int iParam0) // Position - 0xA64
{
	return MISC::IS_BIT_SET(Global_1260806.f_3486, iParam0);
}

void func_42(int iParam0) // Position - 0xA79
{
	MISC::SET_BIT(&(Global_1260806.f_3486), iParam0);
	return;
}

BOOL func_43(int iParam0) // Position - 0xA8E
{
	Hash unlockHash;
	int num;
...
struct<2> func_44() // Position - 0xAE8
{
...
int func_45(var uParam0, var uParam1) // Position - 0xB33
{
	var unk;
...
int func_46(int iParam0) // Position - 0xB5F
{
	var unk;
	var unk2;
...
BOOL func_50(int iParam0) // Position - 0xC1F
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_51(int iParam0, Vector3* pvParam1, var uParam2) // Position - 0xC35
{
	int num;
	float num2;
...
void func_62(int iParam0) // Position - 0xFD0
{
	var unk;
...
BOOL func_63(int iParam0) // Position - 0x100A
{
	var statId;
	int num;
...
void func_64(var uParam0) // Position - 0x1033
{
	int i;
	var SourceStruct;
	var SourceStruct2;
	...
	for (i = 0; i < 837; i = i + 1)
	{
		MISC::COPY_SCRIPT_STRUCT(&uParam0->[i /*4*/], &SourceStruct, 4);
	}
	...
	SourceStruct2 = 47;
	MISC::COPY_SCRIPT_STRUCT(&(uParam0->f_3432), &SourceStruct2, 48);
	return;
}

void func_65() // Position - 0x1110
{
	var unk;
	int i;
...
BOOL func_66(int iParam0) // Position - 0x113A
{
	switch (iParam0)
	{
		case 2:
...
int func_67(int iParam0) // Position - 0x1179
{
	switch (iParam0)
	{
		case 2:
...
Hash func_68(int iParam0) // Position - 0x120F
{
	switch (iParam0)
	{
		case 1:
...
int func_69(int iParam0, int iParam1) // Position - 0x129E
{
	switch (iParam1)
	{
		case 1:
...
struct<2> func_70(int iParam0) // Position - 0x1540
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_71(int iParam0, var uParam1, Any* panParam2) // Position - 0x1554
{
	if (!func_29(iParam0))
		return false;
...
BOOL func_72(Any* panParam0, int iParam1) // Position - 0x165F
{
...
int func_73(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, var uParam6, BOOL bParam7) // Position - 0x1696
{
	var unk;
...
int func_74(int iParam0) // Position - 0x16C6
{
	switch (iParam0)
	{
...
int func_75(int iParam0) // Position - 0x1753
{
	switch (iParam0)
	{
		case 0:
...
void func_76(int iParam0) // Position - 0x213B
{
...
BOOL func_77() // Position - 0x2158
{
	return func_107(1);
}

void func_78() // Position - 0x2165
{
	int i;
...
void func_81(int iParam0, BOOL bParam1) // Position - 0x2248
{
	if (func_82(iParam0))
	{
		bParam1;
...
BOOL func_82(int iParam0) // Position - 0x226D
{
	return func_110(Global_1254993.f_2512.f_1, iParam0);
}

void func_83(BOOL bParam0, int iParam1) // Position - 0x2284
{
	int num;
	int i;
	int num2;
...
void func_84(int iParam0, BOOL bParam1) // Position - 0x230A
{
	if (!func_82(iParam0))
	{
		bParam1;
...
BOOL func_86(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x238E
{
	float num;
	int i;
...
void func_87(Any* panParam0, int iParam1, int iParam2, int iParam3, Player plParam4) // Position - 0x2436
{
	var SourceStruct;
	int i;
...
BOOL func_88(Vector3 vParam0, var uParam1, var uParam2, int iParam3, float fParam4) // Position - 0x275C
{
...
void func_89(Any anParam0, int iParam1) // Position - 0x27A3
{
	func_151(anParam0, 1, iParam1, 255);
	return;
}

int func_90(int iParam0) // Position - 0x27B6
{
	return Global_1260806.f_3432[iParam0];
}

BOOL func_91(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x27C9
{
	var unk;
	var unk6;
	int num;
...
void func_92(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2825
{
	var unk;
...
void func_93(int iParam0, int iParam1, int iParam2) // Position - 0x2871
{
	var unk;
...
int func_94(int iParam0, int iParam1, var uParam2, Player plParam3) // Position - 0x28B1
{
...
int func_95(int iParam0, int iParam1, int iParam2) // Position - 0x28DE
{
	var unk;
...
BOOL func_96(int iParam0, int iParam1, int iParam2, int iParam3, Player plParam4) // Position - 0x2927
{
	var unk;
	var unk41;
...
void func_97(int iParam0) // Position - 0x2AF5
{
	*iParam0 = Global_1295666.f_16;
	return;
}

void func_98() // Position - 0x2B06
{
	int num;
	var unk;
	int i;
...
void func_99(int iParam0) // Position - 0x2B7A
{
...
void func_101(BOOL bParam0) // Position - 0x2BF0
{
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x2C3F
{
...
BOOL func_103(var uParam0) // Position - 0x2C69
{
	int num;
	int num2;
	BOOL flag;
...
void func_104(int iParam0, BOOL bParam1) // Position - 0x2D8D
{
	if (!func_169(iParam0, 255))
	{
		bParam1;
...
struct<2> func_105(int iParam0, int iParam1) // Position - 0x2DB8
{
	var statId;
	var unk2;
	int num;
...
void func_106(Any* panParam0) // Position - 0x2E03
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
BOOL func_107(int iParam0) // Position - 0x2E19
{
	int i;
...
BOOL func_108(int iParam0) // Position - 0x2E53
{
	int i;
...
void func_109(int iParam0, int iParam1) // Position - 0x2E99
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_110(BOOL bParam0, int iParam1) // Position - 0x2EAE
{
	return bParam0 && iParam1 != false;
}

void func_111(var uParam0, int iParam1, int iParam2) // Position - 0x2EBD
{
...
void func_112(var uParam0, int iParam1) // Position - 0x2ED9
{
	func_176(uParam0, iParam1);
	return;
}

void func_113(int iParam0, int iParam1) // Position - 0x2EE9
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

int func_114(int iParam0, var uParam1, var uParam2) // Position - 0x2EFA
{
	int num;
	int i;
	int num2;
...
void func_115(Any* panParam0, int iParam1) // Position - 0x2F8C
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 4;
...
void func_116(Any* panParam0, int iParam1) // Position - 0x313E
{
	panParam0->f_6 = 1;
	*panParam0 = 20;
	panParam0->f_1 = 2;
...
void func_117(Any* panParam0, int iParam1) // Position - 0x34EB
{
	panParam0->f_6 = 1;
	*panParam0 = 21;
	panParam0->f_1 = 8;
...
void func_118(Any* panParam0, int iParam1) // Position - 0x3AB1
{
	panParam0->f_6 = 1;
	*panParam0 = 11;
	panParam0->f_1 = 1;
...
void func_119(Any* panParam0, int iParam1) // Position - 0x3CD6
{
	panParam0->f_6 = 1;
	*panParam0 = 15;
	panParam0->f_1 = 3;
...
void func_120(Any* panParam0, int iParam1) // Position - 0x3FA3
{
	panParam0->f_6 = 1;
	*panParam0 = 16;
	panParam0->f_1 = 2;
...
void func_121(Any* panParam0, int iParam1, int iParam2) // Position - 0x42E9
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 12;
...
void func_122(Any* panParam0, int iParam1) // Position - 0x46EE
{
	panParam0->f_6 = 1;
	*panParam0 = 21;
	panParam0->f_1 = 1;
...
void func_123(Any* panParam0, int iParam1) // Position - 0x4AC9
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 4;
...
void func_124(Any* panParam0, int iParam1, int iParam2) // Position - 0x4CBC
{
	panParam0->f_6 = 1;
	*panParam0 = 12;
	panParam0->f_1 = 4;
...
void func_125(Any* panParam0, int iParam1) // Position - 0x4F14
{
	panParam0->f_6 = 1;
	*panParam0 = 20;
	panParam0->f_1 = 1;
...
void func_126(Any* panParam0, int iParam1) // Position - 0x52C2
{
	panParam0->f_6 = 1;
	*panParam0 = 9;
	panParam0->f_1 = 2;
...
void func_127(Any* panParam0, int iParam1, Player plParam2) // Position - 0x548A
{
	panParam0->f_6 = 1;
	*panParam0 = 1;
	panParam0->f_1 = 6;
...
void func_128(Any* panParam0, int iParam1, int iParam2) // Position - 0x54F9
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 5;
...
void func_129(Any* panParam0, int iParam1) // Position - 0x56F3
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 1;
	*panParam0 = 12;
...
void func_130(Any* panParam0, int iParam1, int iParam2) // Position - 0x593E
{
	panParam0->f_6 = 1;
	*panParam0 = 15;
	panParam0->f_1 = 2;
...
void func_131(Any* panParam0, int iParam1) // Position - 0x5BB3
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 15;
...
void func_132(Any* panParam0, int iParam1) // Position - 0x5EDC
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 13;
...
void func_133(Any* panParam0, int iParam1) // Position - 0x61A0
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_134(Any* panParam0, int iParam1) // Position - 0x6423
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_135(Any* panParam0, int iParam1) // Position - 0x6657
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 11;
...
void func_136(Any* panParam0, int iParam1) // Position - 0x68B9
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 20;
...
void func_137(Any* panParam0, int iParam1) // Position - 0x6DF0
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 15;
...
void func_138(Any* panParam0, int iParam1) // Position - 0x71F1
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_139(Any* panParam0, int iParam1) // Position - 0x74C8
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 20;
...
void func_140(Any* panParam0, int iParam1) // Position - 0x78EE
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 10;
...
void func_141(Any* panParam0, int iParam1) // Position - 0x7B59
{
	panParam0->f_6 = 1;
	panParam0->f_7 = 2;
	*panParam0 = 25;
...
void func_142(Any* panParam0, int iParam1, int iParam2) // Position - 0x8063
{
	BOOL flag;
...
void func_143(Any* panParam0, int iParam1, int iParam2) // Position - 0x8259
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 3;
...
void func_144(Any* panParam0, int iParam1) // Position - 0x8463
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 2;
...
void func_145(Any* panParam0, int iParam1) // Position - 0x86A3
{
	panParam0->f_6 = 1;
	*panParam0 = 11;
	panParam0->f_1 = 1;
...
void func_146(Any* panParam0, int iParam1) // Position - 0x88BC
{
	panParam0->f_6 = 1;
	*panParam0 = 10;
	panParam0->f_1 = 1;
...
void func_147(Any* panParam0, int iParam1) // Position - 0x8AA8
{
	panParam0->f_6 = 1;
	*panParam0 = 7;
	panParam0->f_1 = 3;
...
void func_148(Any* panParam0, int iParam1) // Position - 0x8C24
{
	panParam0->f_6 = 1;
	*panParam0 = 8;
	panParam0->f_1 = 2;
...
void func_149(Any* panParam0, int iParam1, int iParam2) // Position - 0x8DC0
{
	int num;
...
Vector3 func_150(Player plParam0) // Position - 0x8F73
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

void func_151(Any anParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8F87
{
	Player PlayerIndex;
	int num;
	int num2;
	...
	num = iParam2;
	num2 && num != false;
	TELEMETRY::_TELEMETRY_MISSION_FAILED_TO_LAUNCH(anParam0, 0, ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(PlayerIndex), false, false), num2 || num);
	return;
}

struct<2> func_152(int iParam0, int iParam1) // Position - 0x8FC9
{
	var unk;
	var unk2;
	var unk35;
...
int func_153(int iParam0, var uParam1) // Position - 0x9025
{
	int num;
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_154(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x905B
{
	int num;
	...
	for (i = 0; i <= MaxInt - 1; i = i + 1)
	{
		...
		{
			MaxInt2 = func_212(0, num4);
			randomIntInRange2 = MISC::GET_RANDOM_INT_IN_RANGE(0, MaxInt2);
		
			for (j = 0; j <= MaxInt2 - 1; j = j + 1)
			{
				num2 = (randomIntInRange2 + j) % MaxInt2;
...
void func_155(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x926E
{
	uParam0->f_4 = 1;
	uParam0->f_6 = iParam1;
...
void func_156(Any* panParam0) // Position - 0x92AD
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
...
BOOL func_157(var uParam0, int iParam1) // Position - 0x9319
{
	return func_221(uParam0->f_25, iParam1);
}

int func_158(int iParam0, var uParam1, Player plParam2) // Position - 0x932B
{
	int num;
	BOOL flag;
	int i;
...
int func_159(int iParam0, int iParam1, var uParam2) // Position - 0x9388
{
	int num;
	var unk;
	int i;
	...
	for (j = 0; j <= 31; j = j + 1)
	{
		...
		else if (func_224(func_150(Plr), uParam2->f_11) > Global_1901671.f_245.f_64)
		{
		}
		else
		{
...
int func_160(BOOL bParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9490
{
	int randomIntInRange;
	int MinInt;
	int i;
	...
	iParam1 > 32;
	MinInt = func_228(iParam3);

	if (iParam2 == 0)
	{
		randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(MinInt, iParam1);
		return randomIntInRange;
	}

	unk = 32;

	for (i = MinInt; i <= (MinInt + iParam1) - 1; i = i + 1)
	{
...
void func_161(var uParam0, var uParam1) // Position - 0x952E
{
	uParam0->f_9 = 2;
...
int func_162(int iParam0) // Position - 0x9551
{
	switch (iParam0)
	{
		case 0:
...
int func_163(int iParam0) // Position - 0x9748
{
	return 2452;
}

BOOL func_164(float fParam0, var uParam1, var uParam2) // Position - 0x9753
{
	BOOL flag;
...
BOOL func_165(int* piParam0) // Position - 0x97A8
{
	return *piParam0 == piParam0->f_2;
}

BOOL func_166(int* piParam0, var uParam1, BOOL bParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x97B8
{
	int num;
	int num2;
...
void func_167(var uParam0) // Position - 0x98A9
{
	var unk;
...
int func_168(int iParam0) // Position - 0x997A
{
	int num;
	int num2;
...
BOOL func_169(int iParam0, int iParam1) // Position - 0x99A5
{
	if (iParam1 == 255)
...
void func_170(var uParam0) // Position - 0x99CA
{
	int num;
...
void func_171(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x9A00
{
	float num;
	int num2;
	int num3;
...
int func_172(int iParam0) // Position - 0x9B17
{
	switch (iParam0)
	{
		case 1:
...
struct<2> func_173(int iParam0, int iParam1) // Position - 0x9D03
{
	int num;
...
void func_174(var uParam0, int iParam1, int iParam2) // Position - 0x9D19
{
	if (func_240(iParam1, iParam2))
		func_241(uParam0, iParam1, 8192, "host" /*Host*/);

	return;
}

void func_175(var uParam0, int iParam1, int iParam2) // Position - 0x9D3A
{
	if (func_242(iParam1, iParam2))
		Global_1254993[iParam1 /*3*/].f_1 = Global_1254993[iParam1 /*3*/].f_1 + 1;

	if (Global_1254993[iParam1 /*3*/].f_1 > 7)
		func_241(uParam0, iParam1, 4096, "host" /*Host*/);

	return;
}

void func_176(var uParam0, int iParam1) // Position - 0x9D7F
{
	float num;
	int i;
	float num2;
	...
	if (num < 1f)
	{
		...
		{
			func_241(uParam0, iParam1, 32, "host" /*Host*/);
...
void func_177(Any* panParam0, int iParam1) // Position - 0x9ECA
{
	switch (iParam1)
	{
		case 0:
...
void func_178(Any* panParam0) // Position - 0x9F7F
{
	int i;
...
void func_179(Any* panParam0) // Position - 0x9FA6
{
	int i;
...
void func_180(Any* panParam0, int iParam1) // Position - 0x9FCD
{
	MISC::SET_BIT(&(panParam0->f_3), iParam1);
	return;
}

void func_181(Any* panParam0, int iParam1) // Position - 0x9FDF
{
	switch (iParam1)
	{
		case 0:
...
void func_182(Any* panParam0, int iParam1) // Position - 0xA070
{
	switch (iParam1)
	{
		case 0:
...
void func_183(Any* panParam0, int iParam1) // Position - 0xA111
{
	func_249(&(panParam0->f_25), iParam1);
	return;
}

void func_184(Any* panParam0, int iParam1) // Position - 0xA123
{
	switch (iParam1)
	{
		case 0:
...
int func_185(Player plParam0) // Position - 0xA17E
{
	Player player;
...
Vector3 func_186(int iParam0) // Position - 0xA1AE
{
	if (!func_254(iParam0))
		return 0f, 0f, 0f;
...
void func_187(Any* panParam0, int iParam1) // Position - 0xA1D2
{
	switch (iParam1)
	{
		case 0:
...
void func_188(Any* panParam0, int iParam1) // Position - 0xA22A
{
	switch (iParam1)
	{
		case 0:
...
void func_189(Any* panParam0, int iParam1) // Position - 0xA277
{
	switch (iParam1)
	{
		case 0:
...
void func_190(Any* panParam0, int iParam1) // Position - 0xA30F
{
	switch (iParam1)
	{
		case 0:
...
void func_191(Any* panParam0, int iParam1) // Position - 0xA39A
{
	switch (iParam1)
	{
		case 0:
...
void func_192(Any* panParam0, int iParam1) // Position - 0xA466
{
	switch (iParam1)
	{
		case 0:
...
void func_193(Any* panParam0, int iParam1) // Position - 0xA525
{
	switch (iParam1)
	{
		case 0:
...
void func_194(Any* panParam0, int iParam1) // Position - 0xA5DE
{
	switch (iParam1)
	{
		case 0:
...
void func_195(Any* panParam0, int iParam1, int iParam2) // Position - 0xA6C6
{
	switch (iParam1)
	{
		case 0:
...
void func_196(Any* panParam0, int iParam1, int iParam2) // Position - 0xA753
{
	switch (iParam1)
	{
		case 0:
...
void func_197(Any* panParam0, int iParam1) // Position - 0xA7D9
{
	switch (iParam1)
	{
		case 0:
...
int func_198(int iParam0) // Position - 0xA80D
{
	if (iParam0 == -1)
		return -1;
...
int func_199(int iParam0) // Position - 0xA829
{
	if (iParam0 == -1)
		return 0;
...
var func_200(int iParam0, int iParam1) // Position - 0xA843
{
	var unk;
	var unk2;
...
int func_201(int iParam0, int iParam1) // Position - 0xA876
{
	int num;
	var unk;
...
Hash func_202(int iParam0, int iParam1) // Position - 0xA8AC
{
	int num;
...
Vector3 func_203(int iParam0, int iParam1) // Position - 0xA8D3
{
	int num;
...
int func_204(int iParam0) // Position - 0xA900
{
	switch (iParam0)
	{
		case 0:
...
var func_205(int iParam0, int iParam1) // Position - 0xA98F
{
	var unk;
	var unk2;
...
struct<33> func_206(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA9C2
{
	var unk;
...
struct<2> func_207(int iParam0, int iParam1) // Position - 0xA9DC
{
	int num;
...
struct<2> func_208() // Position - 0xAB02
{
	var unk;
...
BOOL func_209(Any* panParam0, var uParam1) // Position - 0xAB1B
{
...
int func_210(int iParam0) // Position - 0xAB3C
{
	var unk;
...
int func_211(int iParam0, int iParam1) // Position - 0xABA8
{
	var unk;
...
int func_212(int iParam0, int iParam1) // Position - 0xAC28
{
	var unk;
...
int func_213(int iParam0, int iParam1, int iParam2) // Position - 0xACBB
{
	var unk;
...
int func_214(int iParam0) // Position - 0xAD62
{
	var unk;
	int num;
...
int func_215(int iParam0, int iParam1, int iParam2) // Position - 0xAE09
{
	var unk;
	int num;
...
BOOL func_216(int iParam0) // Position - 0xAEDE
{
	int i;
	int j;
	var Variable;
	...
	for (i = 0; i <= func_271() - 1; i = i + 1)
	{
		...
		for (j = 0; j <= 3 - 1; j = j + 1)
		{
			...
			{
				MISC::SET_BIT(&Variable, func_273(num, num2));
			}
		}
	}
...
int func_217(int iParam0) // Position - 0xAF3D
{
	var unk;
	int num;
...
int func_218(int iParam0) // Position - 0xAFE2
{
	int i;
	int num;
	var unk;
...
int func_219(int iParam0) // Position - 0xB0DC
{
	var unk;
	int num;
	int num2;
...
void func_220(Any* panParam0, var uParam1) // Position - 0xB1CE
{
	int i;
	int num;
	int j;
...
BOOL func_221(int iParam0, int iParam1) // Position - 0xB210
{
	return iParam0 && iParam1 != false;
}

BOOL func_222(BOOL bParam0, BOOL bParam1) // Position - 0xB21F
{
	BOOL flag;
...
int func_223(BOOL bParam0) // Position - 0xB233
{
...
float func_224(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xB403
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
int func_225(BOOL bParam0, int iParam1) // Position - 0xB421
{
	int i;
...
int func_226(BOOL bParam0) // Position - 0xB44E
{
	int i;
...
int func_227(int iParam0, int iParam1) // Position - 0xB473
{
	var unk;
...
int func_228(int iParam0) // Position - 0xB4BB
{
	int num;
	int num2;
...
BOOL func_229(var uParam0) // Position - 0xB4FB
{
	if (uParam0->f_1 == -1)
		return false;
...
int func_230(int* piParam0, var uParam1) // Position - 0xB520
{
	int i;
	int num;
...
BOOL func_231(var uParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB561
{
	var unk;
	var unk34;
	BOOL flag;
...
void func_232(var uParam0, int iParam1) // Position - 0xB7BA
{
	*uParam0 = iParam1;
	return;
}

var func_233(int iParam0, int iParam1) // Position - 0xB7C7
{
	return func_281(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

void func_234(Any* panParam0, var uParam1) // Position - 0xB7E5
{
...
float func_236(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4) // Position - 0xB84B
{
	int i;
	float num;
...
BOOL func_237(int iParam0) // Position - 0xB896
{
	switch (iParam0)
	{
		case 1:
...
int func_238(int iParam0) // Position - 0xB8E1
{
	switch (iParam0)
	{
		case 2:
...
void func_239(int iParam0) // Position - 0xB903
{
	func_285(&(Global_1257509[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*103*/].f_29), iParam0, 28);
	return;
}

BOOL func_240(int iParam0, int iParam1) // Position - 0xB920
{
	return func_286(&(Global_1257509[iParam1 /*103*/].f_29), iParam0, 28);
}

void func_241(var uParam0, int iParam1, int iParam2, char* sParam3) // Position - 0xB93A
{
...
BOOL func_242(int iParam0, int iParam1) // Position - 0xB95F
{
	return func_286(&(Global_1257509[iParam1 /*103*/].f_29), iParam0, 28);
}

float func_243(float fParam0, float fParam1, float fParam2) // Position - 0xB979
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_244(Any* panParam0) // Position - 0xB9A0
{
	func_180(panParam0, 0);
	func_180(panParam0, 1);
	func_180(panParam0, 3);
...
void func_245(Any* panParam0) // Position - 0xB9C3
{
	func_179(panParam0);
...
void func_246(Any* panParam0, int iParam1) // Position - 0xB9D9
{
	MISC::SET_BIT(&(panParam0->f_4), iParam1);
	return;
}

void func_247(Any* panParam0) // Position - 0xB9EB
{
	func_180(panParam0, 0);
	func_246(panParam0, 0);
	func_246(panParam0, 1);
...
void func_248(Any* panParam0) // Position - 0xBA16
{
	func_180(panParam0, 1);
	func_246(panParam0, 2);
	func_246(panParam0, 3);
...
void func_249(var uParam0, int iParam1) // Position - 0xBA48
{
	func_289(uParam0, iParam1);
	return;
}

void func_250(Any* panParam0) // Position - 0xBA58
{
	func_180(panParam0, 0);
	func_246(panParam0, 0);
	func_246(panParam0, 1);
...
void func_251(Any* panParam0) // Position - 0xBA7C
{
	func_180(panParam0, 1);
	func_178(panParam0);
	return;
...
void func_252(Any* panParam0) // Position - 0xBA91
{
	func_180(panParam0, 2);
	func_246(panParam0, 3);
	return;
...
void func_253(Any* panParam0) // Position - 0xBAA7
{
	func_180(panParam0, 3);
	func_246(panParam0, 4);
	return;
...
BOOL func_254(int iParam0) // Position - 0xBABD
{
...
void func_255(Any* panParam0) // Position - 0xBADC
{
	func_246(panParam0, 0);
	func_246(panParam0, 1);
	return;
...
void func_256(Any* panParam0) // Position - 0xBAF2
{
	func_246(panParam0, 2);
	func_246(panParam0, 3);
	return;
...
void func_257(Any* panParam0) // Position - 0xBB08
{
	func_246(panParam0, 4);
	func_246(panParam0, 5);
	return;
...
BOOL func_258(Any* panParam0, int iParam1) // Position - 0xBB1E
{
...
int func_259(int iParam0, int iParam1) // Position - 0xBB3F
{
	if (iParam0 == -1)
		return -1;
...
BOOL func_260(int iParam0, int iParam1, var uParam2) // Position - 0xBB5E
{
	var unk;
...
int func_261(var uParam0, Any* panParam1, int iParam2) // Position - 0xBB93
{
	int num;
	int num2;
	int num3;
...
BOOL func_262(Any* panParam0) // Position - 0xBBE8
{
	var SourceStruct;
	int fileHandle;
...
BOOL func_263(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xBC2A
{
	var unk;
...
int func_264(int iParam0) // Position - 0xBC63
{
	switch (iParam0)
	{
		case 0:
...
int func_265(Any anParam0, int iParam1) // Position - 0xBCBD
{
	Any numNodes;
...
int func_266(Any* panParam0, int iParam1) // Position - 0xBCD5
{
	return func_293(panParam0, 31, iParam1);
}

int func_267(Any* panParam0, int iParam1) // Position - 0xBCE7
{
	return func_293(panParam0, 31, iParam1);
}

int func_268(int iParam0) // Position - 0xBCF9
{
	var unk;
...
int func_269(int iParam0) // Position - 0xBD61
{
	switch (iParam0)
	{
		case 0:
...
int func_270(int iParam0) // Position - 0xBD91
{
	switch (iParam0)
	{
		case 0:
...
int func_271() // Position - 0xBDEB
{
	return Global_1140770.f_235;
}

int func_272(int iParam0, int iParam1) // Position - 0xBDF9
{
	return Global_1140770[iParam0 /*18*/].f_2[iParam1 /*5*/];
}

int func_273(int iParam0, int iParam1) // Position - 0xBE0F
{
	return Global_1140770[iParam0 /*18*/].f_2[iParam1 /*5*/].f_2;
}

int func_274(Any* panParam0, int iParam1) // Position - 0xBE27
{
	return func_295(func_293(panParam0, 39, iParam1));
}

int func_275(int iParam0) // Position - 0xBE3D
{
	return BUILTIN::SHIFT_LEFT(1, iParam0);
}

BOOL func_276(var uParam0) // Position - 0xBE4C
{
	if (func_29(*uParam0))
		return true;
...
BOOL func_277(var uParam0, var uParam1) // Position - 0xBE90
{
	if (uParam1->f_2 == -1)
		return false;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xBF53
{
...
int func_279(var uParam0, var uParam1) // Position - 0xBF7D
{
	int num;
...
BOOL func_280(int iParam0, var uParam1) // Position - 0xBFA7
{
	int num;
...
var func_281(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0xBFD5
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_300(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
float func_282(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0xC369
{
	switch (iParam5)
	{
		case 0:
...
BOOL func_283(var uParam0) // Position - 0xC492
{
	return *uParam0 == 0;
}

void func_284(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xC49F
{
	int num;
...
BOOL func_285(int* piParam0, int iParam1, int iParam2) // Position - 0xC4E5
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_286(Any* panParam0, int iParam1, int iParam2) // Position - 0xC517
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

void func_287(int iParam0, int iParam1) // Position - 0xC54E
{
	int num;
	int num2;
...
void func_288(Any* panParam0, int iParam1, int iParam2) // Position - 0xC5F7
{
	int i;
...
void func_289(var uParam0, int iParam1) // Position - 0xC633
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_290(int iParam0) // Position - 0xC644
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_291(int iParam0, var uParam1, Any* panParam2) // Position - 0xC683
{
...
void func_292(int iParam0, Any* panParam1, var uParam2) // Position - 0xC6B7
{
	int num;
...
var func_293(Any* panParam0, int iParam1, int iParam2) // Position - 0xC912
{
	var unk;
...
int func_294(Any* panParam0, int iParam1) // Position - 0xC92E
{
	return func_328(func_293(panParam0, 40, iParam1));
}

int func_295(int iParam0) // Position - 0xC944
{
	switch (iParam0)
	{
...
BOOL func_296(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xC976
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

struct<2> func_297(int iParam0) // Position - 0xC991
{
	var unk;
...
int func_298() // Position - 0xCA61
{
	return Global_1051645.f_12;
}

char* func_299() // Position - 0xCA6F
{
	return "unnamed";
}

BOOL func_300(int iParam0) // Position - 0xCA7A
{
	int num;
...
BOOL func_301(int iParam0) // Position - 0xCB09
{
...
int func_302(int iParam0) // Position - 0xCB27
{
	if (iParam0 == 255)
...
BOOL func_303(Player plParam0) // Position - 0xCB72
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
float func_304(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4) // Position - 0xCBB7
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
float func_305(var uParam0, int iParam1) // Position - 0xCCAC
{
...
float func_306(var uParam0, int iParam1, var uParam2) // Position - 0xCCCD
{
	int num;
...
float func_307(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4) // Position - 0xCD2B
{
	float num;
	Vector3 vector;
	int num2;
...
float func_308(var uParam0, int iParam1, var uParam2) // Position - 0xCE63
{
...
float func_309(var uParam0, int iParam1, var uParam2) // Position - 0xCEAD
{
	int num;
	var unk;
	int num2;
...
float func_310(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xCFA0
{
	int num;
...
float func_311(var uParam0, int iParam1, int iParam2) // Position - 0xCFDA
{
...
float func_312(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xD027
{
	int num;
	int num2;
...
float func_313(var uParam0, int iParam1, var uParam2) // Position - 0xD07A
{
	int i;
	int num;
	int num2;
...
float func_314(var uParam0, int iParam1, var uParam2) // Position - 0xD18C
{
	if (uParam2->f_14 == 0)
		return 0f;
...
float func_315(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xD1C4
{
	int num;
...
float func_316(var uParam0, int iParam1) // Position - 0xD1F2
{
...
float func_317(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0xD216
{
	int i;
	int num;
	int num2;
...
void func_318(Any anParam0, int iParam1) // Position - 0xD385
{
	func_151(anParam0, 0, iParam1, 255);
	return;
}

int func_319(int iParam0) // Position - 0xD398
{
	switch (iParam0)
	{
		case 1:
...
void func_320(int iParam0) // Position - 0xD597
{
	func_361(&(Global_1257509[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*103*/].f_29), iParam0, 28);
	return;
}

int func_321(int iParam0) // Position - 0xD5B4
{
	int num;
...
int func_322(int iParam0, var uParam1) // Position - 0xD729
{
	var unk;
...
int func_323(int iParam0) // Position - 0xD746
{
	switch (iParam0)
	{
		case joaat("IWD_INF"):
...
int func_324(int iParam0) // Position - 0xD89C
{
	switch (iParam0)
	{
...
int func_325(int iParam0) // Position - 0xD8F3
{
	switch (iParam0)
	{
...
int func_326(int iParam0) // Position - 0xD9CD
{
	switch (iParam0)
	{
		case -1641798436:
...
int func_327(int iParam0) // Position - 0xDA65
{
	switch (iParam0)
	{
		case -1968391995:
...
int func_328(int iParam0) // Position - 0xDC0F
{
	switch (iParam0)
	{
		case -1340981006:
...
BOOL func_329(int iParam0, int iParam1) // Position - 0xDC55
{
	int num;
...
BOOL func_330(Player plParam0) // Position - 0xDCC9
{
...
void func_331(Player plParam0) // Position - 0xDCE6
{
	Player player;
...
BOOL func_332(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xDD69
{
	float num;
...
void func_333(int iParam0) // Position - 0xDDAF
{
	func_361(&Global_1257509[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*103*/], iParam0, 28);
	return;
}

int func_334(int iParam0, int iParam1) // Position - 0xDDCA
{
	int num;
...
Vector3 func_335(int iParam0, int iParam1, int iParam2) // Position - 0xDDF3
{
	var unk;
	var unk4;
...
Vector3 func_339(int iParam0) // Position - 0xDE91
{
	return Global_1235687[iParam0 /*697*/].f_614;
}

BOOL func_340(var uParam0, var uParam1, var uParam2, int iParam3, float fParam4) // Position - 0xDEA7
{
	float num;
	int num2;
	int num3;
...
BOOL func_341(int iParam0) // Position - 0xDF8B
{
	int num;
	int num2;
...
int func_342(var uParam0) // Position - 0xDFC8
{
	switch (uParam0->f_6)
	{
		case 1:
...
struct<2> func_343(int iParam0) // Position - 0xE003
{
	var unk;
...
int func_344(var uParam0, var uParam1) // Position - 0xE015
{
	var unk;
...
int func_345(int iParam0) // Position - 0xE028
{
	int num;
...
BOOL func_346(int iParam0, int iParam1) // Position - 0xE04C
{
	var statId;
	int num;
...
float func_347(int iParam0) // Position - 0xE09A
{
	int value;
	int value2;
...
float func_348(int iParam0) // Position - 0xE0D9
{
	switch (iParam0)
	{
		case 2:
...
int func_349(int iParam0) // Position - 0xE0F4
{
	if (iParam0 == -1)
		return 0;
...
void func_350(int iParam0, var uParam1, var uParam2) // Position - 0xE110
{
	switch (iParam0)
	{
		case joaat("Dusk"):
...
BOOL func_351(int iParam0, int iParam1) // Position - 0xE298
{
	int clockHours;
...
BOOL func_352(int iParam0) // Position - 0xE2EB
{
	if (iParam0 == 0)
		return 0;
	else if (iParam0 == -1)
...
int func_353(int iParam0) // Position - 0xE31D
{
	return Global_1148506.f_2[iParam0 /*18*/].f_1;
}

BOOL func_354(int iParam0) // Position - 0xE331
{
	return false;
}

BOOL func_355(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE33A
{
	var data;
	int i;
	Hash crimeType;
...
int func_356() // Position - 0xE46F
{
	return Global_1902569;
}

BOOL func_357(int iParam0, int iParam1, BOOL bParam2) // Position - 0xE47B
{
	if (bParam2)
...
BOOL func_358(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4) // Position - 0xE4A8
{
	*uParam4 = 0f;
...
int func_359(int iParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, int iParam9) // Position - 0xE5C8
{
	int num;
	int num2;
	int num3;
...
int func_360(int iParam0) // Position - 0xE79F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_361(int* piParam0, int iParam1, int iParam2) // Position - 0xE868
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_362(int iParam0, var uParam1, var uParam2) // Position - 0xE89B
{
	var unk;
...
int func_363() // Position - 0xE8C2
{
	return Global_1102813.f_3672;
}

void func_364(Player plParam0) // Position - 0xE8D1
{
	Player player;
...
void func_365(Player plParam0) // Position - 0xE93D
{
...
BOOL func_366(Any* panParam0, int iParam1) // Position - 0xE978
{
...
int func_367(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, Vector3* pvParam6, BOOL bParam7) // Position - 0xE999
{
	uParam0.f_2 = iParam5;
...
BOOL func_368(int iParam0) // Position - 0xE9BF
{
	int num;
...
int func_369(int iParam0) // Position - 0xE9EA
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_370(int iParam0, int iParam1) // Position - 0xEA25
{
	return func_393(Global_1207480.f_231.f_1066[iParam0 /*17*/].f_8[iParam1 /*4*/]);
}

int func_371(int iParam0, int iParam1) // Position - 0xEA44
{
	return Global_1207480.f_231.f_1066[iParam0 /*17*/].f_8[iParam1 /*4*/].f_3;
}

BOOL func_372(int iParam0, int* piParam1, var uParam2) // Position - 0xEA61
{
	var statId;
...
int func_373(int iParam0) // Position - 0xEABB
{
	switch (iParam0)
	{
		case 1:
...
float func_374(int iParam0) // Position - 0xEB10
{
	switch (iParam0)
	{
		case 7:
...
BOOL func_375(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEB43
{
...
BOOL func_376(int iParam0) // Position - 0xEBE1
{
	int num;
	int num2;
	int num3;
...
int func_377(int iParam0, Player plParam1, BOOL bParam2, BOOL bParam3) // Position - 0xECBD
{
	int num;
	int i;
...
int func_379(int iParam0, var uParam1) // Position - 0xEDA0
{
	int num;
	int num2;
...
BOOL func_380(int iParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0xEDDA
{
	BOOL flag;
	var unk;
	float num;
...
BOOL func_381(int iParam0, var uParam1) // Position - 0xEE5D
{
	BOOL num;
	var unk;
...
Vector3 func_382(int iParam0, var uParam1) // Position - 0xEE93
{
	var unk;
	var unk4;
...
int func_383(int iParam0, int iParam1) // Position - 0xEEC8
{
	int num;
	var unk;
	int num2;
...
BOOL func_384(int iParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xEF0D
{
	float minRadius;
	float maxRadius;
	Player Plr;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(playerPed))
			{
				...
				if (num < maxRadius && !func_417(iParam0))
					return false;
			}
		}
	}
...
int func_385(int iParam0) // Position - 0xF00D
{
	int i;
...
BOOL func_386(int iParam0) // Position - 0xF045
{
	switch (iParam0)
	{
...
BOOL func_387(Player plParam0) // Position - 0xF072
{
	var memberHandles;
	int i;
	int gangMembers;
...
BOOL func_388(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xF0F9
{
	var unk;
	var unk3;
...
Hash func_389(int iParam0, int iParam1) // Position - 0xF1A0
{
	int num;
...
BOOL func_390(int iParam0, var uParam1, Any* panParam2) // Position - 0xF1C9
{
	*panParam2 = Global_1149432.f_7;
...
void func_391(Any* panParam0, int iParam1, var uParam2) // Position - 0xF1FD
{
	var unk;
...
int func_392(int iParam0) // Position - 0xF277
{
	if (!func_254(iParam0))
		return 0;
...
Vector3 func_393(BOOL bParam0) // Position - 0xF299
{
	float num;
	int value;
	int value2;
...
struct<2> func_394(int iParam0) // Position - 0xF2F5
{
	var unk;
...
int func_395(int iParam0) // Position - 0xF35D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_396(int iParam0) // Position - 0xF36F
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_397(int iParam0) // Position - 0xF381
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_398(int iParam0) // Position - 0xF394
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_399(int iParam0) // Position - 0xF3B9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_400(int iParam0) // Position - 0xF3CC
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_401(int iParam0, int iParam1) // Position - 0xF3DF
{
	if (iParam1 < 0)
		iParam1 = 0;
...
BOOL func_402(int iParam0) // Position - 0xF479
{
	switch (iParam0)
	{
...
BOOL func_403(int iParam0) // Position - 0xF4B2
{
	switch (iParam0)
	{
		case -1086711901:
...
BOOL func_404(int iParam0) // Position - 0xF4DC
{
	switch (iParam0)
	{
		case -2096602762:
...
BOOL func_405(int iParam0, int iParam1, Player plParam2) // Position - 0xF506
{
	if (plParam2 == 255)
...
int func_406(int iParam0) // Position - 0xF53B
{
	int numChildren;
	Any any;
...
BOOL func_407(int iParam0, int iParam1, int iParam2) // Position - 0xF575
{
	int num;
...
BOOL func_408(int iParam0, int iParam1, BOOL bParam2) // Position - 0xF5A4
{
	int i;
	var unk;
	float num;
...
float func_409(int iParam0, int iParam1) // Position - 0xF60B
{
	float num;
	var unk;
	...
	if (func_72(&unk, iParam0) && func_258(&unk, iParam1))
		func_425(unk, -364402952, &num, false);

	return num;
}

BOOL func_410(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0xF648
{
	int i;
	Player Plr;
...
BOOL func_411(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0xF695
{
	int num;
...
int func_412(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL* pbParam6, BOOL bParam7) // Position - 0xF6B8
{
	uParam0.f_2 = iParam5;
...
int func_413(int iParam0) // Position - 0xF6DE
{
	switch (iParam0)
	{
...
BOOL func_414(int iParam0) // Position - 0xF716
{
	return func_426(iParam0, 4);
}

BOOL func_415(int iParam0) // Position - 0xF725
{
	int frameCount;
...
float func_416(int iParam0) // Position - 0xF761
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_417(int iParam0) // Position - 0xF7A0
{
	int frameCount;
...
BOOL func_418(int iParam0) // Position - 0xF7DC
{
	int num;
...
BOOL func_419(int iParam0) // Position - 0xF814
{
	return Global_1225099[iParam0 /*28*/] == -1;
}

BOOL func_420(int iParam0, Player plParam1) // Position - 0xF826
{
	if (plParam1 == 255)
...
struct<2> func_421() // Position - 0xF852
{
	return Global_1051268;
}

var func_422(BOOL bParam0, var uParam1, var uParam2) // Position - 0xF860
{
	if (bParam0)
		return uParam1;
...
BOOL func_423(int iParam0) // Position - 0xF877
{
	return iParam0 >= 0 && iParam0 <= 12;
}

float func_424(int iParam0, int iParam1, int iParam2) // Position - 0xF88D
{
	float num;
	var unk;
	...
	if (func_72(&unk, iParam0) && func_258(&unk, iParam1) && func_366(&unk, iParam2))
		func_425(unk, -364402952, &num, false);

	return num;
}

int func_425(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float* pfParam6, BOOL bParam7) // Position - 0xF8D7
{
	uParam0.f_2 = iParam5;
...
BOOL func_426(int iParam0, int iParam1) // Position - 0xF8FD
{
	int i;
...
int func_427(int iParam0) // Position - 0xF944
{
	switch (iParam0)
	{
		case -2096602762:
...
BOOL func_428(int iParam0) // Position - 0xF9E2
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_429() // Position - 0xFA03
{
	return func_430(func_70(0));
}

BOOL func_430(var uParam0, var uParam1) // Position - 0xFA14
{
	return func_431(uParam0, 1, 4);
}

BOOL func_431(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0xFA26
{
	int num;
...
int func_432(int iParam0, var uParam1) // Position - 0xFA61
{
	if (iParam0 == 2)
