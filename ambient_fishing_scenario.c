...
void func_7() // Position - 0x1BD
{
	func_14();
	return;
}

void func_8() // Position - 0x1C9
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x1D5
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x1FD
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x225
{
	struct<2> data;
...
void func_12(Ped pedParam0, Entity eParam1) // Position - 0x24D
{
	switch (iLocal_18)
	{
		case 0:
...
void func_15(var uParam0) // Position - 0x3A8
{
	return;
}

void func_16(var uParam0) // Position - 0x3B0
{
	return;
}

void func_17(var uParam0) // Position - 0x3B8
{
	return;
}

int func_18() // Position - 0x3C0
{
	return Global_1572887.f_14;
}

BOOL func_19() // Position - 0x3CE
{
...
BOOL func_20(Entity eParam0) // Position - 0x41B
{
...
void func_21(int iParam0) // Position - 0x66F
{
...
BOOL func_22(Ped pedParam0) // Position - 0x682
{
...
void func_24(Object* pobParam0) // Position - 0x789
{
...
void func_25(Ped pedParam0) // Position - 0x7DB
{
	Vector3 entityCoords;
	float entityHeading;
...
Vector3 func_26(float fParam0, var uParam1, float fParam2) // Position - 0x8D5
{
	float num;
	float num2;
...
void func_27(var uParam0, var uParam1, float fParam2) // Position - 0x914
{
	float num;
	float num2;
