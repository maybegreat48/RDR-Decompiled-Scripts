...
void func_41(var uParam0, int iParam1) // Position - 0xA6A
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xBA9
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xBB6
{
...
BOOL func_44(int iParam0) // Position - 0xBEC
{
	if (iParam0 == 0)
	{
		func_72();
...
int func_45() // Position - 0xD00
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xD0E
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xD1A
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xD87
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xE67
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xE85
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xE98
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xEB6
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0xFAE
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0xFBF
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0xFD3
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0xFE7
{
	return uParam0;
}

BOOL func_58(int iParam0) // Position - 0xFF1
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_59() // Position - 0x1007
{
	int i;
...
BOOL func_60(int iParam0, int iParam1) // Position - 0x1034
{
	return iParam0 && iParam1 != false;
}

BOOL func_61(var uParam0, int iParam1) // Position - 0x1043
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_62() // Position - 0x1054
{
	return func_60(Global_1940199, 8192);
}

BOOL func_63(var uParam0, int iParam1) // Position - 0x1067
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_64(int iParam0) // Position - 0x1078
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x10B8
{
...
int func_66() // Position - 0x10E5
{
	return Global_1896646.f_41;
}

void func_67(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x10F3
{
	BOOL flag;
...
void func_68(var uParam0, int iParam1) // Position - 0x1357
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_69(int iParam0, BOOL bParam1) // Position - 0x136A
{
...
void func_70(BOOL bParam0) // Position - 0x19D3
{
	if (bParam0)
...
BOOL func_71(int iParam0) // Position - 0x19FC
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_72() // Position - 0x1A41
{
	return;
}

Hash func_73(int iParam0, BOOL bParam1) // Position - 0x1A49
{
	switch (iParam0)
	{
		case 0:
...
void func_74(int iParam0, BOOL bParam1) // Position - 0x220E
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_75(BOOL bParam0) // Position - 0x2261
{
	if (bParam0)
...
void _DEBUG_PRINT_0_0_0_0_0_0_0(int iParam0) // Position - 0x228A
{
	iParam0 = iParam0;
	return;
}

void func_77(int iParam0) // Position - 0x2296
{
	int i;
...
void func_78(int iParam0) // Position - 0x22C7
{
	int i;
...
BOOL func_79(int iParam0, BOOL bParam1) // Position - 0x22FA
{
	int num;
	int num2;
	int num3;
...
BOOL func_80(int iParam0) // Position - 0x23B0
{
	int i;
...
BOOL func_81(int iParam0, BOOL bParam1) // Position - 0x242A
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_82(int iParam0) // Position - 0x245B
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_83(int iParam0) // Position - 0x247C
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_84(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x24CF
{
	BOOL flag;
...
BOOL func_85(int iParam0) // Position - 0x2B8F
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_86(int iParam0) // Position - 0x2BA6
{
	switch (iParam0)
	{
		case 64:
...
int func_87(int iParam0, BOOL bParam1) // Position - 0x2BE9
{
	if (!func_85(iParam0))
		return 0;
...
BOOL func_88(int iParam0) // Position - 0x2CD4
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_89(int iParam0) // Position - 0x2CEA
{
...
const char* func_91(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x2D62
{
	const char* StringToTest;
...
BOOL func_92(int iParam0) // Position - 0x37C1
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_93(int iParam0) // Position - 0x37D6
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0) // Position - 0x3891
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_95(int iParam0) // Position - 0x38FF
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_96(int iParam0) // Position - 0x3A5A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_97(int iParam0, BOOL bParam1) // Position - 0x3A95
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_98(int iParam0, int iParam1) // Position - 0x3AD7
{
	if (!func_92(iParam0))
		return false;
...
int func_99() // Position - 0x3B1C
{
	return Global_1902569;
}

int func_100(int iParam0) // Position - 0x3B28
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_101(int iParam0) // Position - 0x3B3B
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_102(float fParam0) // Position - 0x3B4D
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_103(var uParam0, int iParam1) // Position - 0x3B63
{
...
int func_104(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3B99
{
	int duration;
	var data;
	int num;
...
BOOL func_105(int iParam0) // Position - 0x3BDC
{
	if (func_129(iParam0))
		if (!func_130(44))
			return false;
...
void func_106(int iParam0, int iParam1) // Position - 0x3BFC
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_107(int iParam0, int iParam1) // Position - 0x3C0D
{
	int num;
...
void func_108(var uParam0, var uParam1, int iParam2) // Position - 0x3C23
{
...
void func_109(int iParam0) // Position - 0x3C40
{
...
void func_110(int iParam0) // Position - 0x3D20
{
	int i;
	int num;
...
BOOL func_111(int iParam0, BOOL bParam1) // Position - 0x3EF8
{
	if (func_45() != -1)
		return false;
...
int func_112(int iParam0, BOOL bParam1) // Position - 0x3F26
{
	if (!func_85(iParam0))
		return 0;
...
int func_113(int iParam0) // Position - 0x3FA9
{
	switch (iParam0)
	{
		case 27:
...
int func_114(int iParam0) // Position - 0x3FD0
{
	switch (iParam0)
	{
		case 33:
...
void func_117(int iParam0, BOOL bParam1) // Position - 0x4235
{
	BOOL flag;
...
Hash func_118(int iParam0) // Position - 0x45E4
{
	if (!func_85(iParam0))
		return 0;
...
void func_119(int iParam0, PersChar pchParam1) // Position - 0x4602
{
	if (!func_85(iParam0))
		return;
...
PersChar func_120(int iParam0) // Position - 0x4623
{
	if (!func_85(iParam0))
		return 0;
...
void func_121(int iParam0, BOOL bParam1) // Position - 0x4643
{
	if (func_45() != -1)
		return;
...
BOOL func_122(int iParam0) // Position - 0x467C
{
	if (!func_85(iParam0))
		return false;
...
BOOL func_123() // Position - 0x46A2
{
	return false;
}

BOOL func_124() // Position - 0x46AB
{
	var unk;
	var unk3;
...
BOOL func_125(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4713
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_126(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4889
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_127(var uParam0, var uParam1, var uParam2) // Position - 0x489D
{
	int i;
...
const char* func_128(int iParam0) // Position - 0x48CB
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_129(int iParam0) // Position - 0x4BAF
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_130(int iParam0) // Position - 0x4BD9
{
	if (!func_161(iParam0))
		return false;
...
struct<2> func_131(Player plParam0) // Position - 0x4BF5
{
	var gamerHandle;
...
const char* func_132(const char* sParam0, int iParam1) // Position - 0x4C09
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_133(int iParam0, BOOL bParam1) // Position - 0x4C23
{
	char* StringToTest;
...
void func_134(int iParam0, BOOL bParam1) // Position - 0x4C57
{
	switch (iParam0)
	{
		case 5:
...
void func_135(int iParam0, int iParam1) // Position - 0x4C8C
{
	func_163(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_136(int iParam0) // Position - 0x4CA6
{
	if (!func_85(iParam0))
		return false;
...
void func_137(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4CCB
{
	PersChar persChar;
...
void func_138(int iParam0, BOOL bParam1) // Position - 0x4DB7
{
	if (!func_166(iParam0))
		return;
...
void func_139(int iParam0, int iParam1) // Position - 0x4E0D
{
	if (!func_171(iParam0))
		return;
...
int func_140(int iParam0) // Position - 0x4E80
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_141(Hash hParam0) // Position - 0x4E96
{
...
void func_142(int iParam0) // Position - 0x4EB6
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_143(int iParam0, BOOL bParam1) // Position - 0x4ECC
{
	if (func_45() != -1)
		return;
...
void func_144(int iParam0) // Position - 0x4EFD
{
	Ped EntityIndex;
...
void func_145(int iParam0) // Position - 0x4F41
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_146(int iParam0) // Position - 0x4F56
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_147(int iParam0) // Position - 0x4F6B
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_148(int iParam0) // Position - 0x4F80
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_149(int iParam0) // Position - 0x4FFF
{
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x505C
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_151(int iParam0, int iParam1) // Position - 0x5075
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_152(int iParam0, int iParam1) // Position - 0x508E
{
...
int func_153(int iParam0) // Position - 0x50C9
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_154(int iParam0) // Position - 0x50DD
{
	return;
}

BOOL func_155(int iParam0, int iParam1) // Position - 0x50E5
{
	if (iParam0 == -1)
		return false;
...
struct<2> func_157() // Position - 0x5164
{
	return Global_1051268;
}

BOOL func_158(var uParam0, var uParam1) // Position - 0x5172
{
	if (!func_176(uParam0))
		return false;
...
struct<2> func_159() // Position - 0x51A6
{
...
BOOL func_160(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x51F1
{
	var unk;
	float num;
	float num2;
...
BOOL func_161(int iParam0) // Position - 0x5221
{
	if (iParam0 == 0)
		return false;
...
BOOL func_162(int iParam0) // Position - 0x5234
{
	int num;
	int num2;
	int offset;
...
void func_163(var uParam0, int iParam1) // Position - 0x525E
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_164(int iParam0) // Position - 0x5273
{
	if (!func_85(iParam0))
		return false;
...
BOOL func_165(Hash hParam0) // Position - 0x5297
{
	return hParam0 != 0;
}

BOOL func_166(int iParam0) // Position - 0x52A3
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_167(int iParam0, BOOL bParam1) // Position - 0x52B9
{
	if (!func_166(iParam0))
		return false;
...
void func_168(int iParam0, BOOL bParam1) // Position - 0x52DF
{
	if (!func_166(iParam0))
		return;
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x530D
{
	if (!func_166(iParam0))
		return;
...
void func_170(int iParam0) // Position - 0x5347
{
	func_181(func_180(iParam0));
	return;
}

BOOL func_171(int iParam0) // Position - 0x5359
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_172(Hash hParam0) // Position - 0x536F
{
	if (func_182(hParam0))
...
BOOL func_173() // Position - 0x538A
{
	return 1;
}

Ped func_174(int iParam0) // Position - 0x5393
{
	PersChar persChar;
...
BOOL func_175(BOOL bParam0, BOOL bParam1) // Position - 0x53C1
{
	return bParam0 && bParam1 != false;
}

BOOL func_176(int iParam0) // Position - 0x53D0
{
	switch (iParam0)
	{
		case 2:
...
int func_177(int iParam0) // Position - 0x540F
{
	switch (iParam0)
	{
		case 2:
...
void func_178(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x54A5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_179(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x5F42
{
	float num;
	float num2;
	float num3;
...
int func_180(int iParam0) // Position - 0x5FA8
{
...
void func_181(int iParam0) // Position - 0x64C5
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_182(Hash hParam0) // Position - 0x64D6
{
	return hParam0 != 0;
}
