...
void _DEBUG_PRINT(int iParam0) // Position - 0x85E
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x86A
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x877
{
	return;
}
...
void _DEBUG_PRINT_0(int iParam0) // Position - 0x88C
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x898
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x8AD
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x8BE
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x8FD
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x909
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x911
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0x9C1
{
	return;
}

void func_26() // Position - 0x9C9
{
	return;
}

void func_27() // Position - 0x9D1
{
	return;
}

void func_28() // Position - 0x9D9
{
	return;
}

void func_29(int iParam0) // Position - 0x9E1
{
...
void func_30(int iParam0) // Position - 0xA2B
{
	return;
}

void func_31() // Position - 0xA33
{
	return;
}

void func_32() // Position - 0xA3B
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xA43
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xA4F
{
...
void func_35(var uParam0) // Position - 0xA80
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xAC6
{
	return;
}

void func_37(int iParam0) // Position - 0xACE
{
	if (!func_61(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xAE7
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xAF8
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xB10
{
	func_45() == -1;
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xB21
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xC60
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xC6D
{
...
BOOL func_44(int iParam0) // Position - 0xCA3
{
	if (iParam0 == 0)
	{
		func_75();
...
int func_45() // Position - 0xDB7
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xDC5
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xDD1
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xE3E
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xF1E
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xF3C
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xF4F
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF6D
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x1065
{
...
struct<2> func_56(int iParam0) // Position - 0x108A
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x109E
{
	return uParam0;
}

void func_58(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x10A8
{
...
void func_59(int iParam0, int iParam1) // Position - 0x1257
{
	func_101(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

int func_60(int iParam0, BOOL bParam1) // Position - 0x1271
{
	int num;
	Hash hash;
	float num2;
...
BOOL func_61(int iParam0) // Position - 0x1398
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_62() // Position - 0x13AE
{
	int i;
...
BOOL func_63(int iParam0, int iParam1) // Position - 0x13DB
{
	return iParam0 && iParam1 != false;
}

BOOL func_64(var uParam0, int iParam1) // Position - 0x13EA
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_65() // Position - 0x13FB
{
	return func_63(Global_1940199, 8192);
}

BOOL func_66(var uParam0, int iParam1) // Position - 0x140E
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_67(int iParam0) // Position - 0x141F
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_68(int iParam0, int iParam1) // Position - 0x145F
{
...
int func_69() // Position - 0x148C
{
	return Global_1896646.f_41;
}

void func_70(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x149A
{
	BOOL flag;
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_123(&unk, joaat("COLOR_PURE_WHITE")), str3, func_123(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_123(&unk, joaat("COLOR_PURE_WHITE")), func_123(&unk2, joaat("COLOR_PURE_WHITE")));
		}
...
void func_71(var uParam0, int iParam1) // Position - 0x1702
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_72(int iParam0, BOOL bParam1) // Position - 0x1715
{
...
void func_73(BOOL bParam0) // Position - 0x1D7E
{
	if (bParam0)
...
BOOL func_74(int iParam0) // Position - 0x1DA7
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_75() // Position - 0x1DEC
{
	return;
}

Hash func_76(int iParam0, BOOL bParam1) // Position - 0x1DF4
{
	switch (iParam0)
	{
		case 0:
...
void func_77(int iParam0, BOOL bParam1) // Position - 0x25B9
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_78(BOOL bParam0) // Position - 0x260C
{
	if (bParam0)
...
void func_79(int iParam0) // Position - 0x2635
{
	AUDIO::SET_AMBIENT_ZONE_STATE("AZ_Naturalist_Camp", false, true);
	return;
}

void func_80(int iParam0) // Position - 0x2646
{
	int i;
...
void func_81(int iParam0) // Position - 0x2677
{
	int i;
...
BOOL func_82(int iParam0, BOOL bParam1) // Position - 0x26AA
{
	int num;
	int num2;
	int num3;
...
BOOL func_83(int iParam0) // Position - 0x2760
{
	int i;
...
BOOL func_84(int iParam0, BOOL bParam1) // Position - 0x27DA
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_85(int iParam0) // Position - 0x280B
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_86(int iParam0) // Position - 0x282C
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_87(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x287F
{
	BOOL flag;
...
BOOL func_88(int iParam0) // Position - 0x2F3F
{
...
int func_90(int iParam0, BOOL bParam1) // Position - 0x2F99
{
	if (!func_88(iParam0))
		return 0;
...
BOOL func_92() // Position - 0x3098
{
	return func_142(func_56(0));
}

BOOL func_93(int iParam0) // Position - 0x30A9
{
	return !func_143(iParam0);
}

void func_94(BOOL bParam0, BOOL bParam1) // Position - 0x30B8
{
	if (func_144(255) == 4)
		return;
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x3203
{
	BOOL flag;
...
int func_96(Hash hParam0, int iParam1) // Position - 0x35B2
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_97(int iParam0) // Position - 0x3F18
{
	if (!func_161(iParam0))
		return 0;
...
int func_98(int iParam0) // Position - 0x3F59
{
	switch (iParam0)
	{
		case 3:
...
void func_99(int iParam0, int iParam1) // Position - 0x3FF6
{
...
void func_101(BOOL bParam0, int iParam1) // Position - 0x405F
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

BOOL func_102(int iParam0, BOOL bParam1) // Position - 0x4070
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4089
{
...
Hash func_104() // Position - 0x40B3
{
	return Global_1893611.f_2;
}

BOOL func_105(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x40C1
{
	return func_163(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_106(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x40E1
{
	return func_163(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_107(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x4101
{
	if (bParam6)
...
BOOL func_108(int iParam0) // Position - 0x417D
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_109(int iParam0) // Position - 0x4193
{
...
const char* func_111(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x420B
{
	const char* StringToTest;
...
BOOL func_112(int iParam0) // Position - 0x4C71
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_113(int iParam0) // Position - 0x4C86
{
	switch (iParam0)
	{
		case 0:
...
Hash func_114(int iParam0) // Position - 0x4D41
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_115(int iParam0) // Position - 0x4DAF
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_116(int iParam0) // Position - 0x4F0A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_117(int iParam0, BOOL bParam1) // Position - 0x4F45
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_118(int iParam0, int iParam1) // Position - 0x4F87
{
	if (!func_112(iParam0))
		return false;
...
int func_119() // Position - 0x4FCC
{
	return Global_1902569;
}

int func_120(int iParam0) // Position - 0x4FD8
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_121(int iParam0) // Position - 0x4FEB
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_122(float fParam0) // Position - 0x4FFD
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_123(var uParam0, int iParam1) // Position - 0x5013
{
...
int func_124(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x5049
{
	int duration;
	var data;
	int num;
...
BOOL func_125(int iParam0) // Position - 0x508C
{
	if (func_171(iParam0))
		if (!func_172(44))
			return false;
...
void func_126(int iParam0, int iParam1) // Position - 0x50AC
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_127(int iParam0, int iParam1) // Position - 0x50BD
{
	int num;
...
void func_128(var uParam0, var uParam1, int iParam2) // Position - 0x50D3
{
...
void func_129(int iParam0) // Position - 0x50F0
{
...
void func_130(int iParam0) // Position - 0x51D0
{
	int i;
	int num;
...
BOOL func_131(int iParam0, BOOL bParam1) // Position - 0x53A8
{
	if (func_45() != -1)
		return false;
...
int func_132(int iParam0, BOOL bParam1) // Position - 0x53D6
{
	if (!func_88(iParam0))
		return 0;
...
int func_133(int iParam0) // Position - 0x5459
{
	switch (iParam0)
	{
		case 27:
...
int func_134(int iParam0) // Position - 0x5480
{
	switch (iParam0)
	{
		case 33:
...
Hash func_137(int iParam0) // Position - 0x56E3
{
	if (!func_88(iParam0))
		return 0;
...
void func_138(int iParam0, PersChar pchParam1) // Position - 0x5701
{
	if (!func_88(iParam0))
		return;
...
PersChar func_139(int iParam0) // Position - 0x5722
{
	if (!func_88(iParam0))
		return 0;
...
void func_140(int iParam0, BOOL bParam1) // Position - 0x5742
{
	if (func_45() != -1)
		return;
...
BOOL func_141(int iParam0) // Position - 0x577B
{
	if (!func_88(iParam0))
		return false;
...
BOOL func_142(var uParam0, var uParam1) // Position - 0x57A1
{
	return func_188(uParam0, 5, 8);
}

BOOL func_143(int iParam0) // Position - 0x57B4
{
	return func_189(1, iParam0);
}

int func_144(int iParam0) // Position - 0x57C3
{
	if (iParam0 == 255)
...
int func_145(int iParam0) // Position - 0x580E
{
...
void func_146(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x582B
{
	func_191(iParam0);
...
int func_147(int iParam0) // Position - 0x588D
{
...
void func_148(var uParam0) // Position - 0x58AA
{
	var unk;
...
void func_149(float* pfParam0) // Position - 0x58BC
{
	var unk;
...
void func_151(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x5924
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_152(int iParam0) // Position - 0x5951
{
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x59AE
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_154(int iParam0, int iParam1) // Position - 0x59C7
{
	func_153(iParam0, iParam1);
...
int func_155(int iParam0) // Position - 0x5A02
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_156(Hash hParam0) // Position - 0x5A16
{
...
void func_157(int iParam0) // Position - 0x5A36
{
	return;
}

void func_158(int iParam0) // Position - 0x5A3E
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_159(int iParam0, int iParam1) // Position - 0x5A53
{
	if (iParam0 == -1)
		return false;
...
void func_160(int iParam0) // Position - 0x5A7A
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_161(int iParam0) // Position - 0x5AF9
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_162(int iParam0) // Position - 0x5B0F
{
	var unk;
...
BOOL func_163(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x5B40
{
	int num;
...
int func_164(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5BC8
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

BOOL func_165() // Position - 0x5BE2
{
	return false;
}

BOOL func_166() // Position - 0x5BEB
{
	var unk;
	var unk3;
...
BOOL func_167(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5C53
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_168(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5DC9
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_169(var uParam0, var uParam1, var uParam2) // Position - 0x5DDD
{
	int i;
...
const char* func_170(int iParam0) // Position - 0x5E0B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_171(int iParam0) // Position - 0x60EF
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_172(int iParam0) // Position - 0x6119
{
	if (!func_209(iParam0))
		return false;
...
struct<2> func_173(Player plParam0) // Position - 0x6135
{
	var gamerHandle;
...
const char* func_174(const char* sParam0, int iParam1) // Position - 0x6149
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_175(int iParam0, BOOL bParam1) // Position - 0x6163
{
	char* StringToTest;
...
void func_176(int iParam0, BOOL bParam1) // Position - 0x6197
{
	switch (iParam0)
	{
		case 5:
...
void func_177(int iParam0, int iParam1) // Position - 0x61CC
{
	func_211(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_178(int iParam0) // Position - 0x61E6
{
	if (!func_88(iParam0))
		return false;
...
void func_179(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x620B
{
	PersChar persChar;
...
void func_180(int iParam0, BOOL bParam1) // Position - 0x62F7
{
	if (!func_161(iParam0))
		return;
...
void func_181(int iParam0, int iParam1) // Position - 0x634D
{
	if (!func_218(iParam0))
		return;
...
int func_182(int iParam0) // Position - 0x63C0
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_183(int iParam0) // Position - 0x63D6
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_184(int iParam0, BOOL bParam1) // Position - 0x63EC
{
	if (func_45() != -1)
		return;
...
void func_185(int iParam0) // Position - 0x641D
{
	Ped EntityIndex;
...
void func_186(int iParam0) // Position - 0x6461
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_187(int iParam0) // Position - 0x6476
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_188(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x648B
{
	int num;
...
BOOL func_189(int iParam0, int iParam1) // Position - 0x64C6
{
	int num;
...
BOOL func_190(int* piParam0, int iParam1, int iParam2) // Position - 0x653A
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_196(BOOL bParam0) // Position - 0x6609
{
	if (func_223(bParam0))
		return;
...
BOOL func_197(int* piParam0, int iParam1, int iParam2) // Position - 0x6630
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_198(Hash hParam0) // Position - 0x6663
{
	if (func_224(hParam0))
...
BOOL func_199() // Position - 0x667E
{
	return 1;
}

BOOL func_200(BOOL bParam0, BOOL bParam1) // Position - 0x6687
{
	return bParam0 && bParam1 != false;
}

int func_201(int iParam0) // Position - 0x6696
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_202(int iParam0, int iParam1, var uParam2) // Position - 0x707E
{
	var unk;
...
int func_203() // Position - 0x70A5
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_204() // Position - 0x70BA
{
	if (Global_1048576)
		return true;
...
struct<2> func_205() // Position - 0x7112
{
	return Global_1051268;
}

BOOL func_206(var uParam0, var uParam1) // Position - 0x7120
{
	if (!func_227(uParam0))
		return false;
...
struct<2> func_207() // Position - 0x7154
{
...
BOOL func_208(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x719F
{
	var unk;
	float num;
	float num2;
...
BOOL func_209(int iParam0) // Position - 0x71CF
{
	if (iParam0 == 0)
		return false;
...
BOOL func_210(int iParam0) // Position - 0x71E2
{
	int num;
	int num2;
	int offset;
...
void func_211(BOOL bParam0, int iParam1) // Position - 0x720C
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_212(int iParam0) // Position - 0x7221
{
	if (!func_88(iParam0))
		return false;
...
BOOL func_213(Hash hParam0) // Position - 0x7245
{
	return hParam0 != 0;
}

BOOL func_214(int iParam0, BOOL bParam1) // Position - 0x7251
{
	if (!func_161(iParam0))
		return false;
...
void func_215(int iParam0, BOOL bParam1) // Position - 0x7277
{
	if (!func_161(iParam0))
		return;
...
void func_216(int iParam0, BOOL bParam1) // Position - 0x72A5
{
	if (!func_161(iParam0))
		return;
...
void func_217(int iParam0) // Position - 0x72DF
{
	func_232(func_231(iParam0));
	return;
}

BOOL func_218(int iParam0) // Position - 0x72F1
{
	return iParam0 > -1 && iParam0 < 40;
}

Ped func_219(int iParam0) // Position - 0x7307
{
	PersChar persChar;
...
int func_220(int iParam0, var uParam1) // Position - 0x7335
{
	if (iParam0 == 2)
...
BOOL func_221(int* piParam0, int iParam1, int iParam2) // Position - 0x734F
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_222() // Position - 0x7386
{
	return Global_1102813.f_3672;
}

BOOL func_223(BOOL bParam0) // Position - 0x7395
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_224(Hash hParam0) // Position - 0x73AB
{
	return hParam0 != 0;
}

BOOL func_225(int iParam0, int iParam1, Any* panParam2) // Position - 0x73B7
{
...
void func_226(Any* panParam0, int iParam1, var uParam2) // Position - 0x73EB
{
	var unk;
...
BOOL func_227(int iParam0) // Position - 0x7465
{
	switch (iParam0)
	{
		case 2:
...
int func_228(int iParam0) // Position - 0x74A4
{
	switch (iParam0)
	{
		case 2:
...
void func_229(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x753A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_230(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x7FD7
{
	float num;
	float num2;
	float num3;
...
int func_231(int iParam0) // Position - 0x803F
{
...
void func_232(int iParam0) // Position - 0x855C
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_233(var uParam0, var uParam1) // Position - 0x856D
{
	var unk;
...
int func_234(int iParam0) // Position - 0x8599
{
	int num;
...
BOOL func_235(int iParam0, var uParam1, Any* panParam2) // Position - 0x870E
{
	if (!func_206(iParam0))
		return false;
...
void func_236(Any* panParam0) // Position - 0x8819
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
