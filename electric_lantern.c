...
BOOL func_3() // Position - 0x152
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(obLocal_0))
		if (WEAPON::GET_CURRENT_PED_WEAPON(Global_33, &ReturnWeaponType, true, 0, false))
			if (ReturnWeaponType == joaat("weapon_melee_lantern_electric"))
...
Vector3 func_4(float fParam0, var uParam1, var uParam2) // Position - 0x1A5
{
	float num;
	float num2;
...
Vector3 func_5() // Position - 0x1E4
{
	return -1502.098f, 2458.125f, 418.487f;
}

float func_6(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x1FB
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

float func_7(float fParam0, float fParam1, float fParam2) // Position - 0x21C
{
	if (fParam0 > fParam2)
		return fParam2;
...
float func_8(float fParam0, float fParam1, float fParam2) // Position - 0x243
{
