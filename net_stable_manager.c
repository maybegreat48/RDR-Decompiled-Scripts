...
BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0x15B
{
	int i;
...
void func_5(int iParam0, int iParam1) // Position - 0x292
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_19();
...
void func_8(int iParam0) // Position - 0x3EE
{
	*iParam0 = 0;
	return;
}

BOOL func_9(int iParam0, int iParam1, char* sParam2) // Position - 0x3FA
{
	return true;
}

int func_10() // Position - 0x403
{
	return Global_1102813.f_3672;
}

BOOL func_11() // Position - 0x412
{
	return !Global_1572887.f_10;
}

BOOL func_12(int iParam0, int iParam1, char* sParam2) // Position - 0x421
{
	return true;
}

void func_13(Any* panParam0) // Position - 0x42A
{
	int i;

	for (i = 0; i < *panParam0; i = i + 1)
	{
		func_22(&panParam0->[i /*19*/]);
	}

	return;
}

void func_14(int iParam0) // Position - 0x450
{
	int i;
...
void func_15(BOOL bParam0) // Position - 0x4D3
{
	int num;
	var unk;
	int num2;
...
void func_18(Player plParam0, int iParam1) // Position - 0x1690
{
	var unk;
	var unk5;
	Player player;
	...
	else
	{
		...
		{
			num2 = PED::_0x4642182A298187D0(EntityIndex, 5, &unk, 4, 2);
		
			if (num2 == 0)
				num2 = PED::_0x4642182A298187D0(EntityIndex, 7, &unk, 4, 2);
		}
...
void func_19() // Position - 0x1857
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

int func_20() // Position - 0x1863
{
	return Global_1572887.f_14;
}

BOOL func_21() // Position - 0x1871
{
	return Global_1051645.f_8;
}

void func_22(var uParam0) // Position - 0x187F
{
	uParam0->f_8 = 0;
	uParam0->f_9 = 0;
	uParam0->f_10 = 0;
...
void func_23(var uParam0) // Position - 0x18C7
{
	int i;
...
void func_24(var uParam0) // Position - 0x19E3
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	func_50(&(uParam0->f_2));
...
void func_25(var uParam0) // Position - 0x1B33
{
	*uParam0 = 0;
	uParam0->f_1 = -1;
	uParam0->f_2 = 0;
...
void func_26(var uParam0) // Position - 0x1B56
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_27(var uParam0) // Position - 0x1B76
{
	*uParam0 = -1;
	return;
}

void func_28(var uParam0) // Position - 0x1B82
{
	func_53(uParam0);
	uParam0->f_4 = -1;
	uParam0->f_5 = 0;
...
void func_29(var uParam0) // Position - 0x1BA4
{
	uParam0->f_2 = 0f;
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_30(var uParam0) // Position - 0x1BF4
{
	int i;
...
void func_31(var uParam0) // Position - 0x1C1D
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	return;
...
void func_32(int iParam0) // Position - 0x1C2E
{
	int num;
...
void func_33(int iParam0) // Position - 0x1C5E
{
	int num;
...
BOOL func_34(int iParam0) // Position - 0x1C8E
{
	int num;
	int offset;
...
void func_35(int iParam0) // Position - 0x1CCB
{
	int num;
	int BitIndex;
...
BOOL func_36() // Position - 0x1CFF
{
	return Global_1896762.f_352;
}

void func_37() // Position - 0x1D0E
{
	int num;
	int num2;
...
int func_39(int iParam0, var uParam1, BOOL bParam2) // Position - 0x1DE2
{
...
int func_40(int iParam0, Any* panParam1, BOOL bParam2) // Position - 0x1E6F
{
	int num;
...
void func_41() // Position - 0x1F6D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex) && !ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_MOUNT_OWNED_BY_PLAYER(playerIndex)))
	{
...
BOOL func_42(Player plParam0, Player plParam1, int iParam2) // Position - 0x1FBA
{
	var unk;
	int num;
...
int func_43(Player plParam0) // Position - 0x2016
{
	var unk;
	int num;
...
BOOL func_44(Ped pedParam0, var uParam1) // Position - 0x2064
{
...
int func_45(int iParam0) // Position - 0x2096
{
	switch (iParam0)
	{
		case 0:
...
int func_46(Player plParam0, int iParam1) // Position - 0x20CE
{
	var unk;
	int num;
...
BOOL func_47(int iParam0, int iParam1) // Position - 0x211D
{
	return iParam0 && iParam1 != false;
}

void func_48(int iParam0, int iParam1) // Position - 0x212C
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_49(int iParam0, int iParam1) // Position - 0x213D
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_50(var uParam0) // Position - 0x2152
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_51(var uParam0) // Position - 0x217A
{
	func_68(uParam0);
	uParam0->f_5 = -1;
	uParam0->f_6 = -1;
...
int func_52(int iParam0) // Position - 0x21EA
{
	int num;
	int year;
	var month;
...
void func_53(var uParam0) // Position - 0x2232
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_54(var uParam0) // Position - 0x224D
{
	func_53(uParam0);
	uParam0->f_4 = 0;
	uParam0->f_5 = { func_69() };
...
void func_55(var uParam0) // Position - 0x2291
{
	*uParam0 = { func_69() };
	uParam0->f_4 = -1;
	uParam0->f_5 = -1;
...
void func_56(var uParam0) // Position - 0x22B0
{
	int i;
...
void func_57(var uParam0) // Position - 0x22D6
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_58(int iParam0) // Position - 0x22EC
{
	if (iParam0 <= -1 || iParam0 >= 117)
		return false;
...
BOOL func_59(var uParam0, BOOL bParam1) // Position - 0x230B
{
...
BOOL func_60(var uParam0) // Position - 0x23D4
{
	return func_74(*uParam0, 1);
}

BOOL func_61(Any* panParam0, BOOL bParam1) // Position - 0x23E4
{
...
BOOL func_62(Any* panParam0, var uParam1) // Position - 0x2487
{
	int i;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		if (flag4 || func_79(mountOwnedByPlayer, i, num2, &flag2, &flag3, &flag))
		{
			...
			else
			{
				...
				MISC::COPY_SCRIPT_STRUCT(&Global_1290271.f_1171.f_245[i /*4*/], &SourceStruct, 4);
		...
		{
			EntityIndex = Global_1290271.f_1171.f_245[i /*4*/].f_3;
		
			if (ENTITY::DOES_ENTITY_EXIST(EntityIndex))
				Global_1290271.f_1171.f_258[i] = !ENTITY::_GET_ENTITY_CARRYING_FLAG(EntityIndex, 2) || ENTITY::_GET_ENTITY_CARRYING_FLAG(EntityIndex, 27);
		
			func_83(EntityIndex, &unk);
...
BOOL func_66(Player plParam0, var uParam1) // Position - 0x28C5
{
...
void func_67(var uParam0) // Position - 0x28F0
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_68(var uParam0) // Position - 0x2918
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
struct<4> func_69() // Position - 0x2938
{
	var unk;
...
void func_70(var uParam0) // Position - 0x2944
{
	int i;
...
void func_71(var uParam0) // Position - 0x296B
{
	func_86(uParam0, 0f);
	return;
}

BOOL func_72(var uParam0, float fParam1) // Position - 0x297A
{
	if (!func_60(uParam0))
		return false;
...
BOOL func_73(Vehicle veParam0) // Position - 0x29A1
{
...
BOOL func_74(int iParam0, int iParam1) // Position - 0x2A19
{
	return iParam0 && iParam1 != false;
}

BOOL func_75(Any* panParam0) // Position - 0x2A28
{
	BOOL flag;
	Player playerFromGamerHandle;
	var EntityIndex;
...
BOOL func_76(Any* panParam0) // Position - 0x2AC7
{
	BOOL flag;
...
BOOL func_77(Any* panParam0, BOOL bParam1) // Position - 0x2BE3
{
	BOOL flag;
...
void func_78(var uParam0) // Position - 0x2E21
{
	int i;
...
BOOL func_79(Ped pedParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5) // Position - 0x2ECD
{
	var SourceStruct;
	Ped EntityIndex;
	Ped EntityIndex2;
	...
	*uParam3 = 0;
	*uParam4 = 0;
	EntityIndex = Global_1290271.f_1171.f_245[iParam1 /*4*/].f_3;

	if (!PED::GET_CARRIED_ATTACHED_INFO_FOR_SLOT(&SourceStruct, pedParam0, iParam2, 0))
	{
		if (ENTITY::DOES_ENTITY_EXIST(EntityIndex))
			Global_1290271.f_1171.f_258[iParam1] = !ENTITY::_GET_ENTITY_CARRYING_FLAG(EntityIndex, 2) || ENTITY::_GET_ENTITY_CARRYING_FLAG(EntityIndex, 27);
	...
	MISC::COPY_SCRIPT_STRUCT(&Global_1290271.f_1171.f_245[iParam1 /*4*/], &SourceStruct, 4);
	EntityIndex2 = SourceStruct.f_3;
	...
	{
		if (EntityIndex != EntityIndex2)
		{
			*uParam3 = 1;
			return 1;
		}
		else if (ENTITY::IS_ENTITY_A_PED(EntityIndex) && PED::_IS_PED_QUEUED_FOR_DELETION(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(EntityIndex)))
		{
			*uParam4 = 1;
			return 0;
		}
	...
	carriableEntityState = ENTITY::GET_CARRIABLE_ENTITY_STATE(EntityIndex2);
	...
	if (ENTITY::IS_ENTITY_A_PED(EntityIndex2) && PED::IS_PED_HUMAN(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(EntityIndex2)))
		return 1;

	return 0;
}

BOOL func_80(Ped pedParam0, Hash hParam1, int iParam2) // Position - 0x3037
{
	int num;
	int num2;
...
int func_81(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4) // Position - 0x3119
{
	return func_97(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(pedParam0), hParam1, iParam2, bParam3, hParam4);
}

void func_82(Any* panParam0, Any* panParam1) // Position - 0x3133
{
	MISC::COPY_SCRIPT_STRUCT(panParam1, panParam0, 96);
	return;
}

void func_83(Ped pedParam0, var uParam1) // Position - 0x3145
{
	Ped pedIndexFromEntityIndex;
	int i;
	var drawable;
...
BOOL func_84(Ped pedParam0, Hash hParam1, int iParam2) // Position - 0x330B
{
	int num;
	int num2;
...
int func_85(int iParam0, Hash hParam1, int iParam2) // Position - 0x3386
{
	var guid2;
	var guid1;
...
void func_86(var uParam0, float fParam1) // Position - 0x33DD
{
...
float func_87(var uParam0) // Position - 0x3403
{
	if (!func_60(uParam0))
		return uParam0->f_1;
...
BOOL func_91(Vehicle veParam0) // Position - 0x3649
{
...
void func_92(Vehicle veParam0, BOOL bParam1) // Position - 0x3672
{
...
BOOL func_93(Ped pedParam0) // Position - 0x36CA
{
	var unk;
	int num;
	int num2;
...
BOOL func_94(Hash hParam0) // Position - 0x37B8
{
	int i;
	int num;
	Hash hash;
...
int func_95(Hash hParam0) // Position - 0x37FA
{
	Hash hash;
	int num;
...
int func_96(int iParam0, Hash hParam1) // Position - 0x383B
{
	var guid;
...
int func_97(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4) // Position - 0x3879
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
Hash func_98(Ped pedParam0) // Position - 0x3953
{
	Hash hash;
...
BOOL func_99(Hash hParam0) // Position - 0x39A6
{
	!func_100(hParam0, 0);
...
BOOL func_100(Hash hParam0, int iParam1) // Position - 0x39CC
{
	if (hParam0 == 0)
		return false;
...
struct<5> func_101(int iParam0) // Position - 0x39E6
{
	var unk;
...
struct<4> func_102(int iParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6) // Position - 0x3A13
{
	var outGuid;
...
float func_103() // Position - 0x3A40
{
...
void func_104(var uParam0, int iParam1) // Position - 0x3A72
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_105(var uParam0, int iParam1) // Position - 0x3A83
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_106(var uParam0) // Position - 0x3A98
{
	return func_74(*uParam0, 2);
}

char* func_107() // Position - 0x3AA8
{
	return "NetStableMount";
}

BOOL func_108(Entity eParam0, char* sParam1) // Position - 0x3AB4
{
...
char* func_109() // Position - 0x3AD4
{
	return "NetStableGUID1";
}

char* func_110() // Position - 0x3AE0
{
	return "NetStableGUID2";
}

char* func_111() // Position - 0x3AEC
{
	return "NetStableGUID3";
}

char* func_112() // Position - 0x3AF8
{
	return "NetStableGUID4";
}

BOOL func_113(Vehicle veParam0) // Position - 0x3B04
{
...
BOOL func_114(Ped pedParam0) // Position - 0x3B1F
{
	Hash entityModel;
...
int func_115(Ped pedParam0, var uParam1, int iParam2) // Position - 0x3B4B
{
	ItemSet itemSet;
...
BOOL func_116(Hash hParam0) // Position - 0x3BC7
{
	if (!func_100(hParam0, 0))
		return false;
...
int func_117(int iParam0, int iParam1) // Position - 0x3BF5
{
	switch (iParam0)
	{
		case 0:
...
Hash func_118(Hash hParam0) // Position - 0x4046
{
	if (!func_94(hParam0))
		return 0;
...
int func_119(Hash hParam0, int iParam1) // Position - 0x405E
{
	switch (hParam0)
	{
...
struct<4> func_120(int iParam0, Hash hParam1) // Position - 0x43C6
{
	var unk;
...
BOOL func_121(int iParam0, Hash hParam1, int iParam2) // Position - 0x43E8
{
	if (!func_100(hParam1, 0))
		return false;
...
struct<2> func_122(Hash hParam0) // Position - 0x440A
{
	var unk;
	var unk3;
...
int func_123(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x449E
{
...
BOOL func_124(int iParam0, Hash hParam1, int iParam2, Hash hParam3, BOOL bParam4) // Position - 0x4560
{
	var unk;
	var unk6;
...
void func_125(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x45AF
{
	BOOL flag;
	int value;
	var unk;
	...
	else if (!func_142(hParam0, &InputString, num3, num2, 0, joaat("ui_itemviewer")))
	{
	...
	str3 = func_151(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash), value), num5);
	...
	if (num4 == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || num4 == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || num4 == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || num4 == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str3 = MISC::VAR_STRING(0, func_152(hParam0, -442898163));
	...
	if (num4 == -126813555 || num4 == 1946043663)
	{
		...
		if (func_153(hParam0, &unk7))
			str3 = func_155(func_154(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_156(str3, InputString.f_1, MISC::GET_HASH_KEY(InputString), num6, num5, str2, str, 0, true);
	return;
}

Hash func_126(var uParam0) // Position - 0x4A89
{
	Ped pedIndexFromEntityIndex;
...
Hash func_127(Ped pedParam0) // Position - 0x4AAF
{
...
BOOL func_128(Hash hParam0, Hash hParam1) // Position - 0x4B0D
{
	if (!func_100(hParam0, 0))
...
struct<2> func_129(int iParam0) // Position - 0x4B4E
{
	int num;
...
int func_130(Hash hParam0) // Position - 0x4B5E
{
	var unk;
...
Hash func_131(Hash hParam0, int iParam1) // Position - 0x4B89
{
	int num;
	var unk;
	Hash hash;
...
int func_132(Hash hParam0, BOOL bParam1) // Position - 0x4C03
{
	var unk;
	int num;
	int num2;
...
int func_133(Hash hParam0, int iParam1) // Position - 0x4C62
{
	if (iParam1 == 0)
		return 0;
...
int func_134(BOOL bParam0) // Position - 0x4C8E
{
	if (func_20() == -1)
	{
...
struct<4> func_135(Hash hParam0, BOOL bParam1) // Position - 0x4CCF
{
	var unk;
...
BOOL func_136(int iParam0, Hash hParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4CF4
{
	var unk;
...
BOOL func_137() // Position - 0x4D6C
{
	return !Global_1913444;
}

void func_138(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x4D79
{
	int i;
...
var func_139(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4E9C
{
	if (bParam0)
		return uParam1;
...
BOOL func_140(Hash hParam0, int iParam1) // Position - 0x4EB3
{
	if (!func_100(hParam0, 0))
		return false;
...
int func_141(Hash hParam0) // Position - 0x4ED2
{
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_142(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x4EFD
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_143(Hash hParam0) // Position - 0x4FF0
{
...
BOOL func_144(Hash hParam0) // Position - 0x50EB
{
...
Hash func_145(Hash hParam0, BOOL bParam1) // Position - 0x516A
{
	Hash hash;
...
BOOL func_146(int iParam0) // Position - 0x5198
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_147(Hash hParam0) // Position - 0x51BF
{
	var unk;
	int i;
...
Hash func_148(Hash hParam0) // Position - 0x522D
{
	int num;
	var unk;
	int collectionId;
...
BOOL func_149(Hash hParam0, Hash hParam1) // Position - 0x52B2
{
	if (hParam0 == 0)
		return false;
...
int func_150(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x52E3
{
	var unk;
...
const char* func_151(const char* sParam0, int iParam1) // Position - 0x5342
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_152(Hash hParam0, int iParam1) // Position - 0x535C
{
	 num;
...
BOOL func_153(Hash hParam0, char* sParam1) // Position - 0x537A
{
	...
	TEXT_LABEL_ASSIGN_STRING(&StringToTest, func_181(hParam0), 128);
...
const char* func_154(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x53F7
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_155(const char* sParam0, int iParam1) // Position - 0x540B
{
...
int func_156(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x5441
{
	int num;
	var unk13;
	int num2;
...
Hash func_157(Ped pedParam0) // Position - 0x54A4
{
	Ped EntityIndex;
...
Hash func_158(Hash hParam0) // Position - 0x5577
{
	return hParam0;
}

BOOL func_159(Hash hParam0, Hash hParam1) // Position - 0x5581
{
...
void func_160(Hash hParam0, var uParam1, var uParam2) // Position - 0x55B7
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_161(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x57C3
{
	Hash hash;
...
struct<4> func_162(BOOL bParam0) // Position - 0x58A1
{
	int num;
...
void func_163(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x5942
{
...
BOOL func_164(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x595D
{
...
int func_165(int iParam0) // Position - 0x5982
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_166(Hash hParam0, int iParam1) // Position - 0x59A3
{
	if (hParam0 == 0)
		return false;
...
struct<5> func_167(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x59BD
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_168(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x5D31
{
	var outGuid;
...
BOOL func_169(Hash hParam0) // Position - 0x5D62
{
...
BOOL func_170(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, Any* panParam5, BOOL bParam6) // Position - 0x5D78
{
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&uParam1))
		return false;
...
BOOL func_171(Hash hParam0, Hash hParam1) // Position - 0x5DA4
{
	if (hParam1 == 0)
		return false;
...
Hash func_172(Hash hParam0, BOOL bParam1) // Position - 0x5DCB
{
	switch (hParam0)
	{
...
int func_173(Hash hParam0) // Position - 0x5E6D
{
	var unk;
	int num;
...
struct<10> func_174(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x5EA7
{
	int num;
...
BOOL func_175(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x5F7B
{
...
BOOL func_176(Hash hParam0) // Position - 0x5F9C
{
	!func_100(hParam0, 0);
...
int func_177(int iParam0) // Position - 0x5FC2
{
	if (iParam0 < 0)
		return 0;
...
int func_178(Hash hParam0, int iParam1) // Position - 0x5FE3
{
	var unk;
	int num;
	int num2;
...
char* func_179(Hash hParam0) // Position - 0x6031
{
	Hash labelHash;
...
BOOL func_180(Hash hParam0) // Position - 0x6065
{
...
char* func_181(Hash hParam0) // Position - 0x6093
{
	Hash labelHash;
...
void func_182(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x60C6
{
...
int func_183(Ped pedParam0) // Position - 0x60F7
{
	int num;
	int pedQuality;
...
int func_184(int iParam0) // Position - 0x614D
{
	switch (iParam0)
	{
...
struct<4> func_185(BOOL bParam0) // Position - 0x6B8A
{
	int num;
...
int func_186(Hash hParam0, BOOL bParam1) // Position - 0x6C2A
{
...
BOOL func_187(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6C61
{
	return func_193(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_188(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x6C7C
{
	var unk;
...
struct<4> func_189(BOOL bParam0) // Position - 0x6C9D
{
	int num;
...
BOOL func_190(Hash hParam0, int iParam1) // Position - 0x6D07
{
	Hash hash;
	int num;
	int i;
...
BOOL func_191(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6D74
{
	return func_196(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_192() // Position - 0x6D8A
{
...
int func_193(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x6DA7
{
	int inventoryItemCountWithGuid;
	var guid;
...
BOOL func_194(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x6E26
{
	int inventoryId;
...
BOOL func_195(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x6E6B
{
...
BOOL func_196(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x6E9E
{
...
int func_197(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6ED8
{
...
BOOL func_198(Hash hParam0) // Position - 0x6F0B
{
