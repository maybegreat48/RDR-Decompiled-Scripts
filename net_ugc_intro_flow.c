...
BOOL func_2(BOOL bParam0) // Position - 0x19B
{
	return Global_262153 && bParam0 != false;
}

void func_3() // Position - 0x1AC
{
...
void func_4(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1EA
{
	if (bParam1)
...
void func_5(var uParam0, BOOL bParam1) // Position - 0x234
{
...
BOOL func_8(BOOL bParam0) // Position - 0x2F9
{
	return Global_262151 && bParam0 != false;
}

BOOL func_9() // Position - 0x30A
{
...
void func_15(BOOL bParam0) // Position - 0x751
{
	if (bParam0)
		func_50(16);
	else
...
void func_17(BOOL bParam0) // Position - 0x9B4
{
	if (bParam0)
...
BOOL func_23(BOOL bParam0, BOOL bParam1) // Position - 0xA5F
{
	int i;
...
void func_24(BOOL bParam0) // Position - 0xB3F
{
	Global_262153 = Global_262153 || bParam0;
	return;
}

void func_25(BOOL bParam0) // Position - 0xB52
{
	if (!bParam0)
		func_59(20);
	else
...
const char* func_29() // Position - 0xF84
{
	if (bLocal_35)
	{
...
const char* func_30() // Position - 0x1028
{
	int num;
...
const char* func_31() // Position - 0x107E
{
...
BOOL func_32(var uParam0) // Position - 0x10A7
{
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x10E4
{
	return uParam0->f_1;
}

int func_34(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x10F0
{
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x1137
{
...
void func_37(BOOL bParam0) // Position - 0x11DE
{
	if (bParam0)
		if (!Global_1896762.f_352)
...
int func_38(var uParam0) // Position - 0x1215
{
	if (!UISTATEMACHINE::_UIFLOWBLOCK_IS_LOADED(*uParam0))
		return 0;
...
BOOL func_41() // Position - 0x12B5
{
	return Global_1072759.f_28644.f_8.f_14 != 0;
}

void func_42(BOOL bParam0) // Position - 0x12CA
{
	if (!bParam0)
		func_59(18);
	else
...
void func_43(var uParam0, const char* sParam1, const char* sParam2, const char* sParam3) // Position - 0x12E9
{
...
void func_44(int iParam0) // Position - 0x131D
{
	iLocal_13 = iParam0;
	return;
}

void func_45() // Position - 0x1329
{
	int i;
	int num;
	int offset;
...
void func_47(BOOL bParam0) // Position - 0x16BA
{
	int i;
			...
			if (func_84())
			{
				...
				if (!MISC::IS_BIT_SET(iLocal_46, 3))
				{
					if (iLocal_42 != -1)
					{
						...
						GraphTypePos = Global_3145858.f_48737[iLocal_42 /*25*/].f_23;
					}
					else
					{
						Duration = 3750;
					...
					CAM::SET_CAM_ACTIVE_WITH_INTERP(uLocal_53[1], uLocal_53[0], Duration, GraphTypePos, 1);
...
void func_49(var uParam0) // Position - 0x1F0C
{
	var unk;
...
void func_50(BOOL bParam0) // Position - 0x1F73
{
	Global_262151 = Global_262151 || bParam0;
	return;
}

void func_51(BOOL bParam0) // Position - 0x1F86
{
...
BOOL func_53(int iParam0) // Position - 0x1FA7
{
...
const char* func_54(int iParam0) // Position - 0x1FED
{
...
void func_55() // Position - 0x206E
{
	Global_262153 = false;
	return;
}

void func_56() // Position - 0x207B
{
...
void func_57(Any anParam0) // Position - 0x2097
{
	var unk;
...
void func_58(BOOL bParam0) // Position - 0x20CD
{
	Global_1940085.f_19 = !bParam0;
	return;
}

int func_59(int iParam0) // Position - 0x20DE
{
...
int func_60(int iParam0) // Position - 0x20FB
{
...
const char* func_61(int iParam0, const char* sParam1, const char* sParam2) // Position - 0x2118
{
	const char* string1;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x21A8
{
	switch (iParam0)
	{
		case -1918441640:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x22A6
{
	switch (iParam0)
	{
		case -1957416901:
...
const char* func_64(const char* sParam0) // Position - 0x2349
{
	return sParam0;
}

int func_65(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2353
{
	int num;
...
const char* func_66(int iParam0) // Position - 0x23A1
{
	var unk;
...
BOOL func_67() // Position - 0x23CA
{
	return Global_1896762.f_352;
}

void func_68() // Position - 0x23D9
{
	func_37(false);
	return;
}

BOOL func_69() // Position - 0x23E6
{
	return Global_1940252.f_2;
}

void func_70() // Position - 0x23F4
{
...
BOOL func_72(int iParam0) // Position - 0x2434
{
	return func_102(Global_1072759.f_28644.f_8.f_1, iParam0);
}

void func_73() // Position - 0x244D
{
	iLocal_14 > 0 && iLocal_15 < 3;
	return;
}

void func_74() // Position - 0x2465
{
	var pedBoneCoords;
	var entityRotation;
	BOOL isPedOnMount;
...
const char* func_75(int iParam0) // Position - 0x2535
{
	if (Global_3145858.f_48737[iParam0 /*25*/] == 0 && Global_3145858.f_48737[iParam0 /*25*/].f_6 > -1)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x25B7
{
...
BOOL func_77(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x25E1
{
	Vector3 vector;
	float num;
...
void func_78(int iParam0) // Position - 0x2611
{
	iLocal_14 = iParam0;
	return;
}

BOOL func_79() // Position - 0x261D
{
	if (iLocal_43 == -1)
		return true;
	...
	if (!bLocal_80 && func_53(iLocal_42) && !MISC::IS_STRING_NULL_OR_EMPTY(func_54(iLocal_42)) && !MISC::IS_STRING_NULL_OR_EMPTY(func_75(iLocal_42)))
	{
		if (!CAM::_IS_CINEMATIC_CAM_LOCATION_LOADED(func_54(iLocal_42)))
		{
			if (!CAM::_IS_CINEMATIC_CAM_LOCATION_LOADED_2(func_54(iLocal_42)))
			{
				...
				if (Global_3145858.f_48737[iLocal_42 /*25*/] == 0)
				{
					TEXT_LABEL_ASSIGN_STRING(&cutsceneName, "mp@establishers@", 128);
					TEXT_LABEL_APPEND_STRING(&cutsceneName, func_75(iLocal_42), 128);
					TEXT_LABEL_APPEND_STRING(&cutsceneName, "_SRL", 128);
					STREAMING::PREFETCH_SRL(&cutsceneName);
				}
			}
...
void func_85(int iParam0) // Position - 0x2B54
{
...
void func_86(BOOL bParam0) // Position - 0x2B8D
{
	if (bParam0)
...
char* func_87(int iParam0) // Position - 0x2BA7
{
...
int func_88(int iParam0) // Position - 0x2BE8
{
	var dictionary;
	var shotName;
...
const char* func_93(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x31F7
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_94(int iParam0) // Position - 0x320B
{
	var unk;
...
BOOL func_95(Any* panParam0, int iParam1, int iParam2) // Position - 0x324D
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_96(Any* panParam0, int iParam1, int iParam2) // Position - 0x327F
{
	int num;
	int offset;
	BOOL isBitSet;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0(int iParam0) // Position - 0x32B2
{
	switch (iParam0)
	{
		case -1759663922:
...
int func_98() // Position - 0x33B0
{
	return Global_1893611.f_2;
}

BOOL func_99(int iParam0) // Position - 0x33BE
{
	return iParam0 >= 0 && iParam0 <= 150;
}

int func_100(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x33D4
{
	int num;
	int num2;
	int num3;
...
char* func_101(int iParam0) // Position - 0x348B
{
	if (!func_99(iParam0))
		return "";
...
BOOL func_102(int iParam0, int iParam1) // Position - 0x3B26
{
	return iParam0 && iParam1 != false;
}

void func_103(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, int iParam6) // Position - 0x3B35
{
...
BOOL func_104() // Position - 0x3B71
{
	...
	if (!bLocal_58)
	{
		if (shLocal_59 == 0)
		{
			...
			shLocal_59 = SHAPETEST::START_SHAPE_TEST_CAPSULE(offsetFromCoordAndHeadingInWorldCoords, gameplayCamCoord, 0.25f, LOSFlags, pedLocal_33, 4);
		}
		else
		{
			shapeTestResult = SHAPETEST::GET_SHAPE_TEST_RESULT(shLocal_59, &bHitSomething, &vPos, &vNormal, &EntityIndex);
...
void func_105(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3BF9
{
	Vector3 gameplayCamCoord;
...
const char* func_106(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3C45
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_107(int iParam0) // Position - 0x3C59
{
	var unk;
...
Vector3 func_112() // Position - 0x3D6A
{
	return Global_3145858.f_48319[iLocal_43 /*13*/].f_3;
}

void func_113(Ped pedParam0) // Position - 0x3D83
{
	Hash ReturnWeaponType;
	Hash ReturnWeaponType2;
	int num;
	int value;
	BOOL flag;
	int randomIntInRange;
	...
	value = 0;
	WEAPON::GET_CURRENT_PED_WEAPON(pedParam0, &ReturnWeaponType, true, 0, true);
	WEAPON::GET_CURRENT_PED_WEAPON(pedParam0, &ReturnWeaponType2, true, 1, true);

	if (ReturnWeaponType != joaat("WEAPON_UNARMED"))
	{
		WEAPON::REMOVE_WEAPON_FROM_PED(pedParam0, ReturnWeaponType, true, -142743235);
		ReturnWeaponType = joaat("WEAPON_UNARMED");
	}

	if (ReturnWeaponType2 != joaat("WEAPON_UNARMED"))
	{
		WEAPON::REMOVE_WEAPON_FROM_PED(pedParam0, ReturnWeaponType2, true, -142743235);
		ReturnWeaponType2 = joaat("WEAPON_UNARMED");
	}

	flag = func_127(ReturnWeaponType) && func_127(ReturnWeaponType2);
	num = func_128(ReturnWeaponType);

	if (!WEAPON::IS_WEAPON_VALID(ReturnWeaponType) || ReturnWeaponType == joaat("WEAPON_UNARMED"))
	{
		value = 0;
	}
	else if (flag)
	...
	else if (num == joaat("group_repeater") || num == joaat("GROUP_RIFLE") || num == joaat("GROUP_SNIPER") || num == joaat("GROUP_SHOTGUN") && ReturnWeaponType != joaat("weapon_shotgun_sawedoff"))
	{
		value = 3;
	}
	else if (WEAPON::_IS_WEAPON_LASSO(ReturnWeaponType))
	{
		WEAPON::REMOVE_WEAPON_FROM_PED(pedParam0, ReturnWeaponType, true, -142743235);
		value = 6;
	}
	else if (ReturnWeaponType == joaat("weapon_thrown_molotov"))
	{
		value = 7;
	}
	else if (ReturnWeaponType == joaat("weapon_thrown_bolas"))
	{
		value = 8;
	}
	else if (WEAPON::_IS_WEAPON_THROWABLE(ReturnWeaponType) || WEAPON::IS_WEAPON_MELEE_WEAPON(ReturnWeaponType))
	{
		value = 5;
	}
	else if (func_129(ReturnWeaponType))
	{
		value = 4;
	}
	else if (WEAPON::_IS_WEAPON_ONE_HANDED(ReturnWeaponType) || num == joaat("GROUP_SHOTGUN") && ReturnWeaponType == joaat("weapon_shotgun_sawedoff"))
	{
		value = 1;
	}
	else
...
void func_114(Ped pedParam0) // Position - 0x3F33
{
	Hash ReturnWeaponType;
	Hash ReturnWeaponType2;
	int num;
	...
	else if (num == joaat("group_repeater") || num == joaat("GROUP_RIFLE") || num == joaat("GROUP_SNIPER") || num == joaat("GROUP_SHOTGUN") && ReturnWeaponType != joaat("weapon_shotgun_sawedoff"))
	{
		...
		if (randomIntInRange % 2 == 0)
			if (ReturnWeaponType == joaat("weapon_rifle_boltaction"))
				value = 12;
			else if (ReturnWeaponType == joaat("weapon_repeater_winchester"))
				value = 11;
			else if (num == joaat("GROUP_SHOTGUN"))
				if (ReturnWeaponType == joaat("WEAPON_SHOTGUN_PUMP"))
					value = 9;
				else if (ReturnWeaponType == joaat("weapon_shotgun_doublebarrel") || ReturnWeaponType == joaat("weapon_shotgun_doublebarrel_exotic") || ReturnWeaponType == joaat("weapon_shotgun_doublebarrel_uncle"))
					value = 10;
	}
	else if (WEAPON::_IS_WEAPON_LASSO(ReturnWeaponType))
	{
...
void func_115(Ped pedParam0, int iParam1) // Position - 0x412D
{
	Hash ReturnWeaponType;
	Hash ReturnWeaponType2;
	int num;
...
void func_116(Ped pedParam0, int iParam1) // Position - 0x4287
{
	Hash ReturnWeaponType;
	Hash ReturnWeaponType2;
	int num;
...
void func_117(int iParam0, int iParam1) // Position - 0x4481
{
	func_130(iParam0, iParam1);
	return;
}

char* func_118(int iParam0, int iParam1) // Position - 0x4491
{
	switch (iParam0)
	{
		case 0:
...
void func_120(int iParam0) // Position - 0x471A
{
	iLocal_15 = iParam0;
	return;
}

Hash func_121(Player plParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x4726
{
	BOOL flag;
	BOOL isBitSet;
	Player player;
...
void func_122(var uParam0, const char* sParam1, const char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, Hash hParam7) // Position - 0x497A
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(uParam0->f_3))
		uParam0->f_3 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER_FROM_PATH("", "transitionData");
...
void func_123(int iParam0) // Position - 0x4AE6
{
	int idOfThisThread;
...
int func_125(var uParam0, var uParam1, var uParam2) // Position - 0x4B40
{
	int num;
...
// Unhandled jump detected. Output should be considered invalid
Vector3 func_126(int iParam0, BOOL bParam1) // Position - 0x4B7B
{
	if (bParam1)
	{
		switch (iParam0)
...
BOOL func_127(Hash hParam0) // Position - 0x4E1A
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_128(Hash hParam0) // Position - 0x4E35
{
...
BOOL func_129(Hash hParam0) // Position - 0x4EB3
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

void func_130(int iParam0, int iParam1) // Position - 0x4EC1
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

struct<2> func_131(int iParam0) // Position - 0x4ED6
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_132(var uParam0, var uParam1) // Position - 0x4EEA
{
	int num;
...
int func_133(int iParam0, var uParam1) // Position - 0x4F0A
{
	return iParam0;
}

int func_134(Player plParam0) // Position - 0x4F14
{
...
int func_135(Player plParam0) // Position - 0x4FAB
{
...
int func_136(Player plParam0, BOOL bParam1) // Position - 0x4FDA
{
	int num;
	int num2;
	int num3;
...
BOOL func_137(Player plParam0, BOOL bParam1) // Position - 0x50A7
{
	Player bitIndex;
	int playerTeam;
	int playerTeam2;
...
BOOL func_138(Player plParam0, BOOL bParam1) // Position - 0x51A9
{
	Player bitIndex;
...
BOOL func_139(Player plParam0, BOOL bParam1) // Position - 0x5233
{
	Player bitIndex;
...
int func_140(var uParam0, var uParam1) // Position - 0x52D5
{
	var unk;
...
int func_141(int iParam0, int iParam1) // Position - 0x5301
{
	switch (iParam0)
	{
		case 0:
...
int func_142(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x5358
{
	if (fParam0 < fParam3)
...
int func_143(var uParam0, var uParam1) // Position - 0x53A0
{
	int num;
...
float func_145(Player plParam0, BOOL bParam1) // Position - 0x5433
{
	Player player;
...
BOOL func_146(Player plParam0) // Position - 0x54D3
{
...
BOOL func_147(Player plParam0) // Position - 0x54F0
{
...
BOOL func_148(Player plParam0) // Position - 0x550D
{
...
BOOL func_149(Player plParam0) // Position - 0x552A
{
	if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0))
	{
		func_153(plParam0);
...
BOOL func_150(int iParam0, var uParam1, Any* panParam2) // Position - 0x558E
{
	if (!func_151(iParam0))
		return false;
...
BOOL func_151(var uParam0, var uParam1) // Position - 0x5699
{
	if (!func_156(uParam0))
		return false;
...
int func_152(var uParam0, var uParam1) // Position - 0x56CD
{
	var unk;
	var unk4;
	int num;
...
void func_153(Player plParam0) // Position - 0x5774
{
	Player player;
...
void func_154(Player plParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x57E0
{
	Player player;
	int num;
	Player i;
		...
		for (i = 0; i <= 31; i = i + 1)
		{
			...
			if (i != Global_1295666 && NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr))
			{
				...
				else if (GANG::NETWORK_IS_IN_SAME_GANG(Plr, plParam0))
				{
					...
					if (i != player)
						func_154(Plr, iParam1, 0, true, false, 0);
				}
			}
		}
...
void func_155(Any* panParam0) // Position - 0x591B
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
BOOL func_156(int iParam0) // Position - 0x5931
{
	switch (iParam0)
	{
		case 2:
...
int func_157(int iParam0) // Position - 0x5970
{
	switch (iParam0)
	{
		case 2:
...
void func_158(Player plParam0) // Position - 0x5A06
{
...
BOOL func_159(Player plParam0, int iParam1, int iParam2) // Position - 0x5A41
{
...
void func_160(Any* panParam0, var uParam1) // Position - 0x5AD2
{
...
void func_161(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5B12
{
	return;
}
