...
int func_3() // Position - 0x27A
{
	return Global_1572887.f_14;
}

BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x288
{
	int i;
...
void func_5() // Position - 0x368
{
	ENTITY::REMOVE_MODEL_HIDE(3366.87f, -680.8071f, 41.6795f, 1f, joaat("ann_jail_main_door_01"), false);
	return;
}

void func_6(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x38A
{
...
void func_7(Volume volParam0) // Position - 0x409
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_8(var uParam0, int iParam1) // Position - 0x44A
{
