...
void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x970
{
	iParam0 = iParam0;
	return;
}
...
void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x98C
{
	iParam0 = iParam0;
	return;
}
...
void func_41(var uParam0, int iParam1) // Position - 0xA72
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xBB1
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xBBE
{
...
BOOL func_44(int iParam0) // Position - 0xBF4
{
	if (iParam0 == 0)
	{
		func_72();
...
int func_45() // Position - 0xD08
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xD16
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xD22
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xD8F
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xE6F
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xE8D
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xEA0
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xEBE
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0xFB6
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0xFC7
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0xFDB
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0xFEF
{
	return uParam0;
}

BOOL func_58(int iParam0) // Position - 0xFF9
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_59() // Position - 0x100F
{
	int i;
...
BOOL func_60(int iParam0, int iParam1) // Position - 0x103C
{
	return iParam0 && iParam1 != false;
}

BOOL func_61(var uParam0, int iParam1) // Position - 0x104B
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_62() // Position - 0x105C
{
	return func_60(Global_1940199, 8192);
}

BOOL func_63(var uParam0, int iParam1) // Position - 0x106F
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_64(int iParam0) // Position - 0x1080
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_65(int iParam0, int iParam1) // Position - 0x10C0
{
...
int func_66() // Position - 0x10ED
{
	return Global_1896646.f_41;
}

void func_67(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x10FB
{
	BOOL flag;
...
void func_68(var uParam0, int iParam1) // Position - 0x135F
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_69(int iParam0, BOOL bParam1) // Position - 0x1372
{
...
void func_70(BOOL bParam0) // Position - 0x19DB
{
	if (bParam0)
...
BOOL func_71(int iParam0) // Position - 0x1A04
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_72() // Position - 0x1A49
{
	return;
}

Hash func_73(int iParam0, BOOL bParam1) // Position - 0x1A51
{
	switch (iParam0)
	{
		case 0:
...
void func_74(int iParam0, BOOL bParam1) // Position - 0x2216
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_75(BOOL bParam0) // Position - 0x2269
{
	if (bParam0)
...
void _DEBUG_PRINT_0_0_0_0_0_0(int iParam0) // Position - 0x2292
{
	iParam0 = iParam0;
	return;
}

void func_77(int iParam0) // Position - 0x229E
{
	int i;
...
void func_78(int iParam0) // Position - 0x22CF
{
	int i;
...
BOOL func_79(int iParam0, BOOL bParam1) // Position - 0x2302
{
	int num;
	int num2;
	int num3;
...
BOOL func_80(int iParam0) // Position - 0x23B8
{
	int i;
...
BOOL func_81(int iParam0, BOOL bParam1) // Position - 0x2432
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_82(int iParam0) // Position - 0x2463
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_83(int iParam0) // Position - 0x2484
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_84(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x24D7
{
	BOOL flag;
...
BOOL func_85(int iParam0) // Position - 0x2B97
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_86(int iParam0) // Position - 0x2BAE
{
	switch (iParam0)
	{
		case 64:
...
int func_87(int iParam0, BOOL bParam1) // Position - 0x2BF1
{
	if (!func_85(iParam0))
		return 0;
...
BOOL func_88(int iParam0) // Position - 0x2CDC
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_89(int iParam0) // Position - 0x2CF2
{
...
const char* func_91(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x2D6A
{
	const char* StringToTest;
...
BOOL func_92(int iParam0) // Position - 0x37C9
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_93(int iParam0) // Position - 0x37DE
{
	switch (iParam0)
	{
		case 0:
...
int func_94(int iParam0) // Position - 0x3899
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_95(int iParam0) // Position - 0x3907
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_96(int iParam0) // Position - 0x3A62
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_97(int iParam0, BOOL bParam1) // Position - 0x3A9D
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_98(int iParam0, int iParam1) // Position - 0x3ADF
{
	if (!func_92(iParam0))
		return false;
...
int func_99() // Position - 0x3B24
{
	return Global_1902569;
}

int func_100(int iParam0) // Position - 0x3B30
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_101(int iParam0) // Position - 0x3B43
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_102(float fParam0) // Position - 0x3B55
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_103(var uParam0, int iParam1) // Position - 0x3B6B
{
...
int func_104(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3BA1
{
	int duration;
	var data;
	int num;
...
BOOL func_105(int iParam0) // Position - 0x3BE4
{
	if (func_129(iParam0))
		if (!func_130(44))
			return false;
...
void func_106(int iParam0, int iParam1) // Position - 0x3C04
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_107(int iParam0, int iParam1) // Position - 0x3C15
{
	int num;
...
void func_108(var uParam0, var uParam1, int iParam2) // Position - 0x3C2B
{
...
void func_109(int iParam0) // Position - 0x3C48
{
...
void func_110(int iParam0) // Position - 0x3D28
{
	int i;
	int num;
...
BOOL func_111(int iParam0, BOOL bParam1) // Position - 0x3F00
{
	if (func_45() != -1)
		return false;
...
int func_112(int iParam0, BOOL bParam1) // Position - 0x3F2E
{
	if (!func_85(iParam0))
		return 0;
...
int func_113(int iParam0) // Position - 0x3FB1
{
	switch (iParam0)
	{
		case 27:
...
int func_114(int iParam0) // Position - 0x3FD8
{
	switch (iParam0)
	{
		case 33:
...
void func_117(int iParam0, BOOL bParam1) // Position - 0x423D
{
	BOOL flag;
...
Hash func_118(int iParam0) // Position - 0x45EC
{
	if (!func_85(iParam0))
		return 0;
...
void func_119(int iParam0, PersChar pchParam1) // Position - 0x460A
{
	if (!func_85(iParam0))
		return;
...
PersChar func_120(int iParam0) // Position - 0x462B
{
	if (!func_85(iParam0))
		return 0;
...
void func_121(int iParam0, BOOL bParam1) // Position - 0x464B
{
	if (func_45() != -1)
		return;
...
BOOL func_122(int iParam0) // Position - 0x4684
{
	if (!func_85(iParam0))
		return false;
...
BOOL func_123() // Position - 0x46AA
{
	return false;
}

BOOL func_124() // Position - 0x46B3
{
	var unk;
	var unk3;
...
BOOL func_125(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x471B
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_126(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4891
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_127(var uParam0, var uParam1, var uParam2) // Position - 0x48A5
{
	int i;
...
const char* func_128(int iParam0) // Position - 0x48D3
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_129(int iParam0) // Position - 0x4BB7
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_130(int iParam0) // Position - 0x4BE1
{
	if (!func_161(iParam0))
		return false;
...
struct<2> func_131(Player plParam0) // Position - 0x4BFD
{
	var gamerHandle;
...
const char* func_132(const char* sParam0, int iParam1) // Position - 0x4C11
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_133(int iParam0, BOOL bParam1) // Position - 0x4C2B
{
	char* StringToTest;
...
void func_134(int iParam0, BOOL bParam1) // Position - 0x4C5F
{
	switch (iParam0)
	{
		case 5:
...
void func_135(int iParam0, int iParam1) // Position - 0x4C94
{
	func_163(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_136(int iParam0) // Position - 0x4CAE
{
	if (!func_85(iParam0))
		return false;
...
void func_137(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4CD3
{
	PersChar persChar;
...
void func_138(int iParam0, BOOL bParam1) // Position - 0x4DBF
{
	if (!func_166(iParam0))
		return;
...
void func_139(int iParam0, int iParam1) // Position - 0x4E15
{
	if (!func_171(iParam0))
		return;
...
int func_140(int iParam0) // Position - 0x4E88
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_141(Hash hParam0) // Position - 0x4E9E
{
...
void func_142(int iParam0) // Position - 0x4EBE
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_143(int iParam0, BOOL bParam1) // Position - 0x4ED4
{
	if (func_45() != -1)
		return;
...
void func_144(int iParam0) // Position - 0x4F05
{
	Ped EntityIndex;
...
void func_145(int iParam0) // Position - 0x4F49
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_146(int iParam0) // Position - 0x4F5E
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_147(int iParam0) // Position - 0x4F73
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_148(int iParam0) // Position - 0x4F88
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_149(int iParam0) // Position - 0x5007
{
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x5064
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_151(int iParam0, int iParam1) // Position - 0x507D
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_152(int iParam0, int iParam1) // Position - 0x5096
{
...
int func_153(int iParam0) // Position - 0x50D1
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_154(int iParam0) // Position - 0x50E5
{
	return;
}

BOOL func_155(int iParam0, int iParam1) // Position - 0x50ED
{
	if (iParam0 == -1)
		return false;
...
struct<2> func_157() // Position - 0x516C
{
	return Global_1051268;
}

BOOL func_158(var uParam0, var uParam1) // Position - 0x517A
{
	if (!func_176(uParam0))
		return false;
...
struct<2> func_159() // Position - 0x51AE
{
...
BOOL func_160(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x51F9
{
	var unk;
	float num;
	float num2;
...
BOOL func_161(int iParam0) // Position - 0x5229
{
	if (iParam0 == 0)
		return false;
...
BOOL func_162(int iParam0) // Position - 0x523C
{
	int num;
	int num2;
	int offset;
...
void func_163(BOOL bParam0, int iParam1) // Position - 0x5266
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_164(int iParam0) // Position - 0x527B
{
	if (!func_85(iParam0))
		return false;
...
BOOL func_165(Hash hParam0) // Position - 0x529F
{
	return hParam0 != 0;
}

BOOL func_166(int iParam0) // Position - 0x52AB
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_167(int iParam0, BOOL bParam1) // Position - 0x52C1
{
	if (!func_166(iParam0))
		return false;
...
void func_168(int iParam0, BOOL bParam1) // Position - 0x52E7
{
	if (!func_166(iParam0))
		return;
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x5315
{
	if (!func_166(iParam0))
		return;
...
void func_170(int iParam0) // Position - 0x534F
{
	func_181(func_180(iParam0));
	return;
}

BOOL func_171(int iParam0) // Position - 0x5361
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_172(Hash hParam0) // Position - 0x5377
{
	if (func_182(hParam0))
...
BOOL func_173() // Position - 0x5392
{
	return 1;
}

Ped func_174(int iParam0) // Position - 0x539B
{
	PersChar persChar;
...
BOOL func_175(BOOL bParam0, BOOL bParam1) // Position - 0x53C9
{
	return bParam0 && bParam1 != false;
}

BOOL func_176(int iParam0) // Position - 0x53D8
{
	switch (iParam0)
	{
		case 2:
...
int func_177(int iParam0) // Position - 0x5417
{
	switch (iParam0)
	{
		case 2:
...
void func_178(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x54AD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_179(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x5F4A
{
	float num;
	float num2;
	float num3;
...
int func_180(int iParam0) // Position - 0x5FB0
{
...
void func_181(int iParam0) // Position - 0x64CD
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_182(Hash hParam0) // Position - 0x64DE
{
	return hParam0 != 0;
}
