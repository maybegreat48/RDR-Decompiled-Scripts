...
void func_4() // Position - 0xAF
{
	return;
}

void func_5() // Position - 0xB7
{
	int i;
...
void func_7() // Position - 0x48D
{
	return;
}

void func_8() // Position - 0x495
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x4A1
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x4C9
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x4F1
{
	struct<2> data;
...
BOOL func_12(Ped pedParam0, int iParam1) // Position - 0x519
{
	int num;
...
BOOL func_13(int iParam0, int iParam1) // Position - 0x618
{
	switch (iParam1)
	{
...
float func_14(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x807
{
...
BOOL func_16(var uParam0) // Position - 0x910
{
	return func_27(*uParam0, 1);
}

void func_17(var uParam0, BOOL bParam1) // Position - 0x920
{
...
BOOL func_18(var uParam0, float fParam1) // Position - 0x940
{
	if (!func_16(uParam0))
		return false;
...
void func_19(var uParam0) // Position - 0x967
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_20(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x97D
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
...
void func_21(var uParam0) // Position - 0x9D6
{
	return;
}

void func_22(var uParam0) // Position - 0x9DE
{
	return;
}

void func_23(var uParam0) // Position - 0x9E6
{
	return;
}

BOOL func_24(int iParam0, int iParam1) // Position - 0x9EE
{
	return iParam0 && iParam1 != false;
}

void func_25(var uParam0, int iParam1, int iParam2, float fParam3) // Position - 0x9FD
{
	uParam0->f_1 = iParam1;
...
float func_26(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xA43
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_27(int iParam0, int iParam1) // Position - 0xA61
{
	return iParam0 && iParam1 != false;
}

void func_28(var uParam0) // Position - 0xA70
{
	func_34(uParam0, 0f);
	return;
}

float func_29(var uParam0) // Position - 0xA7F
{
	if (!func_16(uParam0))
		return uParam0->f_1;
...
char* func_30(int iParam0, int iParam1) // Position - 0xAB4
{
	switch (iParam0)
	{
...
char* func_31(int iParam0, int iParam1) // Position - 0xBBC
{
	switch (iParam0)
	{
		case joaat("world_human_push_broom_working"):
...
Vector3 func_32(int iParam0, int iParam1) // Position - 0xC4F
{
	switch (iParam0)
	{
		case joaat("world_human_push_broom_working"):
...
float func_33(int iParam0, int iParam1) // Position - 0xD01
{
	switch (iParam0)
	{
		case joaat("world_human_push_broom_working"):
...
void func_34(var uParam0, float fParam1) // Position - 0xD81
{
...
BOOL func_35(var uParam0) // Position - 0xDA7
{
	return func_27(*uParam0, 2);
}

float func_36() // Position - 0xDB7
{
...
void func_37(var uParam0, int iParam1) // Position - 0xDE9
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_38(var uParam0, int iParam1) // Position - 0xDFA
{
