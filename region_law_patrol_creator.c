...
BOOL func_2(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x12C
{
	var data;
	int i;
	Hash crimeType;
...
BOOL func_4() // Position - 0x2B1
{
	return func_20(1, 255);
}

BOOL func_5() // Position - 0x2C0
{
	return Global_1893611 & 2 != 0;
}

int func_6() // Position - 0x2D0
{
	return Global_1896646.f_41;
}

BOOL func_7(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2DE
{
	if (Global_1572887.f_14 != -1)
	{
			...
			else
			{
				for (i = 0; i < iLocal_35; i = i + 1)
				{
					...
					if (func_11(iLocal_35[i], 0))
					{
						...
						TASK::TASK_PERFORM_SEQUENCE(iLocal_35[i], Sequence);
...
int func_10() // Position - 0x791
{
	return func_39(func_38(func_6()));
}

BOOL func_11(Ped pedParam0, int iParam1) // Position - 0x7A5
{
	int num;
...
void func_12(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8A4
{
...
void func_13(Volume volParam0) // Position - 0x912
{
...
BOOL func_14(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x929
{
...
int func_15() // Position - 0x9C7
{
	return Global_1939102.f_4;
}

BOOL func_16(int iParam0, BOOL bParam1) // Position - 0x9D5
{
	if (!func_34(iParam0))
		return false;
...
BOOL func_17(int iParam0, BOOL bParam1) // Position - 0xA11
{
	if (!func_42(iParam0))
		return false;
...
BOOL func_18(int iParam0) // Position - 0xA4D
{
	if (!func_44(iParam0))
		return false;
...
BOOL func_20(int iParam0, int iParam1) // Position - 0xAE4
{
	int num;
...
struct<2> func_22(int iParam0) // Position - 0xBB0
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_23(var uParam0, var uParam1) // Position - 0xBC4
{
	if (!func_50(uParam0))
		return false;
...
int func_24(var uParam0, var uParam1) // Position - 0xBF8
{
	return uParam0;
}

float func_25(var uParam0) // Position - 0xC02
{
	if (!func_52(uParam0))
		return 0f;
...
void func_27(var uParam0) // Position - 0xD09
{
	func_56(uParam0, 0f);
	return;
}

BOOL func_28(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, float fParam9, float fParam10, int iParam11) // Position - 0xD18
{
	int num;
...
BOOL func_29(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE3D
{
	var unk;
	var unk6;
...
void func_30(var uParam0, int iParam1, BOOL bParam2) // Position - 0xE8A
{
	uParam0->f_2 = 0;
...
int func_33(Ped pedParam0, Ped pedParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0xF38
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return 0;
...
BOOL func_34(int iParam0) // Position - 0xF7D
{
	return iParam0 > -1 && iParam0 < 6;
}

Vector3 func_35(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0xF92
{
	var unk;
	float MaxFloat;
...
void func_36(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xFDA
{
...
float func_37(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1045
{
...
int func_38(int iParam0) // Position - 0x108D
{
	switch (iParam0)
	{
		case 0:
...
int func_39(int iParam0) // Position - 0x1148
{
	if (!func_34(iParam0))
		return 0;
...
BOOL func_40(int iParam0, int iParam1) // Position - 0x1194
{
	return iParam0 && iParam1 != false;
}

BOOL func_41(int iParam0, int iParam1) // Position - 0x11A3
{
	if (!func_34(iParam0))
		return false;
...
BOOL func_42(int iParam0) // Position - 0x11E8
{
	return iParam0 > -1 && iParam0 < 17;
}

BOOL func_43(int iParam0, BOOL bParam1) // Position - 0x11FE
{
	if (!func_42(iParam0))
		return false;
...
BOOL func_44(int iParam0) // Position - 0x1240
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_45(int iParam0, BOOL bParam1) // Position - 0x1256
{
	if (Global_1572887.f_14 == -1)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1287
{
...
BOOL func_47(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x12B1
{
...
BOOL func_48(Any* panParam0, int iParam1, int iParam2) // Position - 0x130C
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_49() // Position - 0x1343
{
	return Global_1102813.f_3672;
}

BOOL func_50(int iParam0) // Position - 0x1352
{
	switch (iParam0)
	{
		case 2:
...
int func_51(int iParam0) // Position - 0x1391
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_52(var uParam0) // Position - 0x1427
{
	return func_66(*uParam0, 1);
}

BOOL func_53(var uParam0) // Position - 0x1437
{
	return func_66(*uParam0, 2);
}

float func_54() // Position - 0x1447
{
...
BOOL func_55(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x1479
{
...
void func_56(var uParam0, float fParam1) // Position - 0x14AF
{
...
void func_57(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, float fParam8, float fParam9, int iParam10) // Position - 0x14D5
{
	int num;
	int num2;
...
void func_58(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x22E3
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_59(float fParam0, var uParam1, var uParam2) // Position - 0x2AA3
{
	float num;
	float num2;
...
Ped func_60(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x2AE2
{
	Ped EntityIndex;
	...
	func_72(EntityIndex, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return EntityIndex;
}

void func_61(Ped pedParam0) // Position - 0x2B22
{
...
Vector3 func_62(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2BAB
{
	float num;
...
int func_63(int iParam0) // Position - 0x2BE2
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_64(int iParam0) // Position - 0x2C50
{
	int i;
...
float func_65(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x2C7B
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_66(int iParam0, int iParam1) // Position - 0x2C99
{
	return iParam0 && iParam1 != false;
}

void func_67(var uParam0, int iParam1) // Position - 0x2CA8
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_68(var uParam0, int iParam1) // Position - 0x2CB9
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_69(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x2CCE
{
	float num;
...
int func_70(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2CF3
{
	int num;
...
int func_71(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x2D41
{
	return func_75(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

void func_72(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2D57
{
	BOOL flag;
...
struct<2> func_73(Player plParam0) // Position - 0x2E21
{
	var gamerHandle;
...
int func_74(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2E35
{
	int num;
	int num2;
	int num3;
...
int func_75(Hash hParam0) // Position - 0x2EEC
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
void func_76(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2FA6
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_77(Ped pedParam0, BOOL bParam1) // Position - 0x2FEB
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_78(Ped pedParam0, int iParam1) // Position - 0x3030
{
	if (iParam1 == 1)
...
int func_79(var uParam0, var uParam1, var uParam2) // Position - 0x3057
{
	int num;
...
int func_80(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x3092
{
	if (fParam0 < fParam3)
