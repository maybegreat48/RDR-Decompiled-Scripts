...
void func_9(int iParam0) // Position - 0x69E
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x6C6
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x6EE
{
	struct<2> data;
...
void func_13(var uParam0, int iParam1) // Position - 0x723
{
	*uParam0 = iParam1;
	return;
}

int func_14() // Position - 0x730
{
	return Global_1572887.f_14;
}

BOOL func_15(Hash hParam0, int iParam1) // Position - 0x73E
{
	int num;
...
BOOL func_16(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7C1
{
...
BOOL func_17() // Position - 0x937
{
	return Global_1913634.f_1578;
}

int func_18(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, Hash hParam10, int iParam11) // Position - 0x946
{
	int i;
	int num;
...
void func_19(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x9CF
{
	int num;
...
BOOL func_20(char* sParam0) // Position - 0xA1A
{
	int i;
...
BOOL func_22(int iParam0, int iParam1) // Position - 0xA7B
{
	return DATABINDING::_DATABINDING_READ_DATA_BOOL(Global_1940252.f_1556.f_44.f_87);
}

void func_23(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA92
{
	int num;
...
BOOL func_25(Hash hParam0) // Position - 0xB18
{
	int i;
...
BOOL func_26() // Position - 0xB52
{
	return Global_1940252.f_2 || Global_1940252 == 1;
}

BOOL func_27() // Position - 0xB6C
{
	return Global_1896762.f_352;
}

BOOL func_28(int iParam0, BOOL bParam1) // Position - 0xB7B
{
	int num;
...
void func_29(BOOL bParam0) // Position - 0xBAE
{
...
BOOL func_30(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xBDC
{
	int num;
	var unk10;
...
BOOL func_31(int iParam0, BOOL bParam1) // Position - 0x1567
{
	int num;
	int gameTimer;
	float progress;
...
BOOL func_32(var uParam0) // Position - 0x1661
{
	return func_99(*uParam0, 1);
}

BOOL func_33() // Position - 0x1671
{
...
void func_34(var uParam0) // Position - 0x16B4
{
	func_100(uParam0, 0f);
	return;
}

void func_35(var uParam0) // Position - 0x16C3
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_36(var uParam0, float fParam1) // Position - 0x16D9
{
...
void func_37(var uParam0) // Position - 0x16F7
{
	return;
}

void func_38(var uParam0) // Position - 0x16FF
{
	return;
}

void func_39(var uParam0) // Position - 0x1707
{
	return;
}

void func_40(BOOL bParam0) // Position - 0x170F
{
	if (bParam0)
		func_102(4);
...
BOOL func_41(Hash hParam0, int iParam1) // Position - 0x1731
{
	if (hParam0 == 0)
		return false;
...
int func_42(Hash hParam0) // Position - 0x174B
{
	var unk;
...
BOOL func_43(Hash hParam0, int iParam1) // Position - 0x1776
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_44(Hash hParam0) // Position - 0x181E
{
	int num;
	int num2;
	int num3;
...
int func_45(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x18DA
{
...
BOOL func_46() // Position - 0x199C
{
	...
	if (!func_48(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_47(int iParam0) // Position - 0x19F4
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_48(var uParam0, var uParam1) // Position - 0x1A08
{
	if (!func_115(uParam0))
		return false;
...
int func_49(var uParam0, var uParam1) // Position - 0x1A3C
{
	return uParam0;
}

BOOL func_50(int iParam0, int iParam1) // Position - 0x1A46
{
	if (iParam0 < 0)
		return false;
...
BOOL func_52(int iParam0) // Position - 0x1D81
{
	if (iParam0 < 0)
		return false;
...
int func_53(int iParam0) // Position - 0x1DC0
{
	return iParam0;
}

void func_54(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1DCA
{
	int num;
...
BOOL func_55(Ped pedParam0) // Position - 0x1E1E
{
...
BOOL func_58(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1E6B
{
	int num;
	var unk;
	var unk6;
...
BOOL func_59(Hash hParam0, BOOL bParam1) // Position - 0x1EE3
{
	BOOL flag;
	int num;
...
BOOL func_60(Hash hParam0) // Position - 0x1FB5
{
	if (func_71(hParam0))
		return false;
...
BOOL func_61(Hash hParam0) // Position - 0x2034
{
	var unk;
...
BOOL func_62(Hash hParam0, Hash hParam1) // Position - 0x2066
{
	if (!func_41(hParam0, 0))
...
void func_65(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x20B7
{
	return;
}

BOOL func_66(Hash hParam0) // Position - 0x20BF
{
...
BOOL func_67(Hash hParam0) // Position - 0x20F8
{
...
BOOL func_68(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2127
{
...
void func_69(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, int iParam16) // Position - 0x2544
{
	int i;
...
BOOL func_70() // Position - 0x25E0
{
	return Global_1893611 & 2 != 0;
}

BOOL func_71(Hash hParam0) // Position - 0x25F0
{
	if (!func_41(hParam0, 0))
		return false;
...
int func_72(int iParam0) // Position - 0x261A
{
	return func_159(iParam0);
}

BOOL func_73(Hash hParam0) // Position - 0x2628
{
	if (hParam0 == 0)
		return false;
...
int func_74(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x2657
{
	int num;
	var unk13;
	int num2;
...
int func_75(Hash hParam0) // Position - 0x2692
{
	var unk;
...
BOOL func_77(Player plParam0) // Position - 0x2770
{
	Ped playerPed;
	Ped mountOwnedByPlayer;
...
void func_78(int iParam0, Hash hParam1, int iParam2, Ped pedParam3, BOOL bParam4) // Position - 0x27A2
{
	int num;
...
int func_79(Hash hParam0, BOOL bParam1) // Position - 0x27D4
{
	int num;
...
void func_80(Hash hParam0) // Position - 0x284B
{
	int num;
	Hash hash;
...
int func_81(Ped pedParam0, Hash hParam1, Hash hParam2, Hash hParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0x29A1
{
	var unk;
	int num;
...
void func_82(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2AFA
{
	var unk;
	var guid;
...
Hash func_83(int iParam0, BOOL bParam1) // Position - 0x2B4A
{
	int i;
	Hash hash;
	Hash hash2;
...
void func_84(BOOL bParam0, int iParam1) // Position - 0x2C05
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
BOOL func_85(int iParam0, Hash hParam1) // Position - 0x2C27
{
	Ped EntityIndex;
...
BOOL func_86(int iParam0) // Position - 0x2CCE
{
	Ped EntityIndex;
...
Ped func_87(int iParam0) // Position - 0x2D27
{
	iParam0 = func_184(iParam0);
...
BOOL func_88(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x2D53
{
...
BOOL func_90(int iParam0, int iParam1) // Position - 0x2EB4
{
	Any gangId;
...
int func_91(int iParam0, BOOL bParam1) // Position - 0x2F74
{
	if (bParam1)
		func_202();
...
BOOL func_92(int iParam0) // Position - 0x2FB0
{
	return func_201(Global_1147183.f_8, iParam0);
}

BOOL func_93() // Position - 0x2FC4
{
	int num;
...
void func_95(Any anParam0) // Position - 0x3096
{
	var unk;
...
Hash func_96(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x30DB
{
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x311D
{
	int num;
	int num2;
...
BOOL func_99(int iParam0, int iParam1) // Position - 0x316B
{
	return iParam0 && iParam1 != false;
}

void func_100(var uParam0, float fParam1) // Position - 0x317A
{
...
BOOL func_101(var uParam0, float fParam1) // Position - 0x31A0
{
	if (!func_32(uParam0))
		return false;
...
void func_102(int iParam0) // Position - 0x31C7
{
	Global_1902887.f_302 = Global_1902887.f_302 || iParam0;
	return;
}

Hash func_103(Hash hParam0, int iParam1) // Position - 0x31E0
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_104(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x325A
{
...
BOOL func_105(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3281
{
	if (iParam2 < 0)
		return false;
...
BOOL func_106(Hash hParam0) // Position - 0x32BC
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_107(int iParam0) // Position - 0x32D7
{
	if (iParam0 < 0)
		return 0;
...
int func_108(Hash hParam0) // Position - 0x32F8
{
	switch (hParam0)
	{
...
int func_109(var uParam0, int iParam1) // Position - 0x33DB
{
	int i;
...
int func_110(Hash hParam0) // Position - 0x3418
{
	int num;
...
int func_111(Hash hParam0, BOOL bParam1) // Position - 0x3485
{
	var unk;
	int num;
	int num2;
...
int func_112(Hash hParam0, int iParam1) // Position - 0x34E4
{
	if (iParam1 == 0)
		return 0;
...
int func_113(BOOL bParam0) // Position - 0x3510
{
	if (func_14() == -1)
	{
...
struct<4> func_114(Hash hParam0, BOOL bParam1) // Position - 0x3551
{
	var unk;
...
BOOL func_115(int iParam0) // Position - 0x3576
{
	switch (iParam0)
	{
		case 2:
...
int func_116(int iParam0) // Position - 0x35B5
{
	switch (iParam0)
	{
		case 2:
...
void func_117(int iParam0, BOOL bParam1) // Position - 0x364B
{
...
void func_118(int iParam0, BOOL bParam1) // Position - 0x36A3
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_119(int iParam0, int iParam1) // Position - 0x36CC
{
	if (iParam0 < 0)
		return;
...
void func_120(int iParam0) // Position - 0x36F4
{
	if (!func_224(iParam0))
		return;
...
BOOL func_121(Hash hParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x37A7
{
	int num;
	var unk;
	int num2;
...
struct<5> func_122(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x38BF
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_123(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x3C33
{
	var outGuid;
...
BOOL func_124(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x3C64
{
	var unk;
	int num;
	var unk15;
...
int func_125(Hash hParam0) // Position - 0x3D82
{
...
BOOL func_126(BOOL bParam0, int iParam1) // Position - 0x3F49
{
	Ped mount;
...
BOOL func_128(BOOL bParam0) // Position - 0x43D1
{
	if (bParam0)
...
int func_129() // Position - 0x4401
{
	return Global_1915656.f_22504.f_5;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x4412
{
	var unk;
	int num;
...
void func_131(int iParam0) // Position - 0x46AC
{
	Global_1915656.f_22504.f_5 = iParam0;
	return;
}

Hash func_132(Hash hParam0) // Position - 0x46BF
{
	return hParam0;
}

BOOL func_133(Hash hParam0, Hash hParam1) // Position - 0x46C9
{
...
int func_134(Hash hParam0) // Position - 0x46FF
{
	int i;
...
int func_135(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x472B
{
	if (!func_269(iParam0))
		return 1;
...
int func_136(Hash hParam0, int iParam1) // Position - 0x47AD
{
	var unk;
	int num;
	int i;
...
void func_137(int iParam0) // Position - 0x47F7
{
	Global_1940252.f_11599 = iParam0;
	return;
}

Hash func_138(Hash hParam0) // Position - 0x4808
{
	if (!func_41(hParam0, 0))
		return 0;
...
void func_139(Hash hParam0) // Position - 0x4825
{
	Global_1940252.f_11605 = hParam0;
	return;
}

BOOL func_140(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3, int iParam4) // Position - 0x4836
{
...
BOOL func_141() // Position - 0x4B89
{
	return Global_1953292.f_1676.f_1[1 /*3*/].f_1 == joaat("pomade");
}

BOOL func_142(Ped pedParam0) // Position - 0x4BA5
{
	if (!ENTITY::DOES_ENTITY_EXIST(*pedParam0) || ENTITY::IS_ENTITY_DEAD(*pedParam0))
		return false;
...
void func_143(Hash hParam0) // Position - 0x4BDE
{
	Hash hash;
...
void func_144(Hash hParam0) // Position - 0x4C78
{
	Hash hash;
...
void func_145(Hash hParam0, BOOL bParam1) // Position - 0x4CF8
{
	Hash hash;
...
void func_146(Hash hParam0, BOOL bParam1) // Position - 0x4DA5
{
	Hash hash;
...
void func_147(Hash hParam0) // Position - 0x4E52
{
	Hash hash;
...
void func_148(Hash hParam0) // Position - 0x4ED2
{
	Hash hash;
...
void func_149(Hash hParam0) // Position - 0x4F52
{
	Hash hash;
...
void func_150(Hash hParam0) // Position - 0x4FD2
{
	Hash hash;
...
void func_151(Hash hParam0) // Position - 0x5052
{
	Hash hash;
...
void func_152(Hash hParam0) // Position - 0x50D2
{
	Hash hash;
...
void func_153(Hash hParam0) // Position - 0x5152
{
	Hash hash;
...
void func_154(Hash hParam0) // Position - 0x51D2
{
	Hash hash;
...
void func_155(Hash hParam0, BOOL bParam1) // Position - 0x5252
{
	Hash hash;
...
void func_156(Hash hParam0, BOOL bParam1) // Position - 0x52F0
{
	Hash hash;
...
BOOL func_157(int iParam0, int iParam1) // Position - 0x538F
{
	return iParam0 && iParam1 != false;
}

void func_158(int iParam0) // Position - 0x539E
{
...
int func_159(int iParam0) // Position - 0x53B5
{
	switch (iParam0)
	{
		case 0:
...
void func_160(BOOL bParam0) // Position - 0x53F2
{
	Global_1953292 = Global_1953292 || bParam0;
	return;
}

void func_161(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5405
{
	int i;
	int num;
...
BOOL func_162() // Position - 0x5701
{
	return Global_1953292.f_3502;
}

BOOL func_163(Hash hParam0) // Position - 0x5710
{
	if (func_284())
		return false;
...
BOOL func_164(Hash hParam0) // Position - 0x5746
{
	return func_285(hParam0);
}

void func_165(var uParam0, int iParam1) // Position - 0x5754
{
	func_286(uParam0, iParam1);
	return;
}

int func_166(Hash hParam0, int iParam1) // Position - 0x5764
{
	Hash interactionAnimHash;
	BOOL flag;
	Hash hash;
...
BOOL func_167(BOOL bParam0) // Position - 0x584B
{
	return Global_1953292 && bParam0 != false;
}

void func_168() // Position - 0x585C
{
...
BOOL func_169(int iParam0, BOOL bParam1) // Position - 0x5913
{
	return func_296(iParam0, false) < func_297(iParam0, bParam1);
}

BOOL func_170(Hash hParam0) // Position - 0x592B
{
	var unk;
...
void func_171(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x593B
{
	int num;
	BOOL flag;
...
Hash func_172(int iParam0) // Position - 0x5AE7
{
	if (iParam0 == 0)
		iParam0 = func_304();
...
void func_173(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5B12
{
...
Hash func_174(Hash hParam0) // Position - 0x5B37
{
	int i;
...
int func_175(Hash hParam0, int iParam1) // Position - 0x5B72
{
	switch (hParam0)
	{
		case -1944638739:
...
BOOL func_176(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5D43
{
	var unk;
	int num;
	int i;
...
void func_177(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5EE2
{
	func_316(&(Global_1953292.f_2938), bParam0, bParam1, bParam2, bParam3, bParam4);
	return;
}

BOOL func_178(Hash hParam0, BOOL bParam1) // Position - 0x5EFF
{
	!func_41(hParam0, 0);
...
BOOL func_179(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5F4A
{
	var unk;
	var unk5;
	Hash hash;
...
int func_180(Hash hParam0) // Position - 0x5FD3
{
	int num;
	int num2;
...
void func_181(var uParam0, int iParam1) // Position - 0x6037
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

int func_182(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x6048
{
...
struct<4> func_183(BOOL bParam0) // Position - 0x60C7
{
	int num;
...
int func_184(int iParam0) // Position - 0x6167
{
	if (iParam0 == 7)
...
BOOL func_185(int iParam0) // Position - 0x6180
{
	Ped EntityIndex;
...
int func_186() // Position - 0x61E1
{
	return Global_38.f_289.f_3222;
}

BOOL func_187() // Position - 0x61F2
{
	return Global_1915656.f_22504.f_1;
}

BOOL func_188(int iParam0) // Position - 0x6203
{
	return Global_1051832.f_3648 && iParam0 != false;
}

void func_189(int iParam0) // Position - 0x6217
{
	Global_1051832.f_3648 = Global_1051832.f_3648 - Global_1051832.f_3648 && iParam0;
	return;
}

void func_190(int iParam0) // Position - 0x6238
{
	Global_1051832.f_3649 = iParam0;
	return;
}

BOOL func_191() // Position - 0x6249
{
	return Global_1915656.f_22504;
}

void func_192() // Position - 0x6258
{
	PAD::_SET_CONTROL_CONTEXT(4, joaat("HandheldCatalogue"));
	return;
}

BOOL func_193() // Position - 0x626A
{
	return func_188(4);
}

int func_194(BOOL bParam0) // Position - 0x6277
{
	Player playerIndex;
...
void func_195(int iParam0) // Position - 0x64D6
{
	int num;
...
BOOL func_199() // Position - 0x655E
{
	return !func_197(2);
}

BOOL func_200(int iParam0) // Position - 0x656C
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_201(int iParam0, int iParam1) // Position - 0x658D
{
	return iParam0 && iParam1 != false;
}

void func_202() // Position - 0x659C
{
...
BOOL func_203(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x65B3
{
	BOOL flag;
...
void func_204(int iParam0) // Position - 0x65DB
{
	Global_1896762.f_365 = iParam0;
	return;
}

int func_205(Player plParam0) // Position - 0x65EC
{
	Player player;
...
int func_206(Player plParam0, BOOL bParam1) // Position - 0x661C
{
	Player player;
	int i;
...
int func_207(int iParam0) // Position - 0x66A6
{
	if (iParam0 == -1)
		return 0;
...
var func_208(int iParam0, int iParam1) // Position - 0x66C2
{
...
void func_210(int iParam0, var uParam1, var uParam2) // Position - 0x677A
{
	int num;
...
BOOL func_211(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x6796
{
...
void func_212(int iParam0, int iParam1) // Position - 0x6838
{
	int Variable;
...
void func_213(int iParam0, Player plParam1) // Position - 0x685C
{
	Player player;
...
float func_214() // Position - 0x687F
{
...
void func_215(var uParam0, int iParam1) // Position - 0x68B1
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_216(var uParam0, int iParam1) // Position - 0x68C2
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_217(var uParam0) // Position - 0x68D7
{
	if (!func_32(uParam0))
		return uParam0->f_1;
...
void func_218(Hash hParam0, var uParam1, var uParam2) // Position - 0x690C
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_219(Hash hParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x6B18
{
	Hash hash;
...
struct<4> func_220(BOOL bParam0) // Position - 0x6BF6
{
	int num;
...
void func_221(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x6C97
{
...
BOOL func_222(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x6CB2
{
...
BOOL func_223(Hash hParam0, int iParam1) // Position - 0x6CD7
{
	if (hParam0 == 0)
		return false;
...
BOOL func_224(int iParam0) // Position - 0x6CF1
{
	return func_50(iParam0, 2);
}

BOOL func_225(Hash hParam0) // Position - 0x6D00
{
...
BOOL func_226(BOOL bParam0) // Position - 0x6D16
{
	if (func_14() == -1)
		return true;
...
BOOL func_227(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x6D34
{
	*uParam1 = 0;
...
struct<17> func_228(Hash hParam0, var uParam1) // Position - 0x6DA1
{
	var unk;
...
int func_229(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x6DF4
{
	int num;
...
void func_230(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x6E5E
{
	int i;
...
int func_231(Hash hParam0, BOOL bParam1) // Position - 0x6EDC
{
...
BOOL func_232(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6F13
{
	return func_182(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_233(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x6F2E
{
	var unk;
...
struct<4> func_234(BOOL bParam0) // Position - 0x6F4F
{
	int num;
...
BOOL func_235(Hash hParam0, int iParam1) // Position - 0x6FB9
{
	Hash hash;
	int num;
	int i;
...
BOOL func_236(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x7026
{
	return func_348(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_237(Hash hParam0) // Position - 0x703C
{
	if (func_41(hParam0, 0))
	{
...
int func_238() // Position - 0x70DE
{
	return 225949718;
}

BOOL func_239(Hash hParam0) // Position - 0x70EB
{
	return hParam0 == 1401465909 || hParam0 == joaat("kit_collectors_bag");
}

int func_240() // Position - 0x7109
{
	return 1039657088;
}

BOOL func_241(Hash hParam0) // Position - 0x7116
{
...
int func_242() // Position - 0x71D8
{
	return 1039392896;
}

int func_243() // Position - 0x71E5
{
	return 1039645941;
}

int func_244() // Position - 0x71F2
{
	return 1039907016;
}

int func_245() // Position - 0x71FF
{
	return 1039902864;
}

int func_246() // Position - 0x720C
{
	return 955497620;
}

int func_247() // Position - 0x7219
{
	return 1022861303;
}

int func_248() // Position - 0x7226
{
	return 1039902720;
}

int func_249() // Position - 0x7233
{
	return 972554239;
}

int func_250() // Position - 0x7240
{
	return 905165831;
}

int func_251() // Position - 0x724D
{
	return 1038298244;
}

int func_252() // Position - 0x725A
{
	return 1037713383;
}

int func_253() // Position - 0x7267
{
	return 1039645911;
}

int func_254() // Position - 0x7274
{
	return 1039655040;
}

BOOL func_255(int iParam0) // Position - 0x7281
{
	return func_201(Global_1940085.f_7, iParam0);
}

BOOL func_256(int iParam0, int iParam1) // Position - 0x7295
{
	return iParam0 && iParam1 != false;
}

BOOL func_257(BOOL bParam0) // Position - 0x72A4
{
	Entity entity;
...
BOOL func_258(BOOL bParam0, BOOL bParam1) // Position - 0x7337
{
	var unk;
...
BOOL func_259(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x7387
{
	Vehicle vehiclePedIsUsing;
	Hash entityModel;
...
BOOL func_260(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x7474
{
...
BOOL func_261(Ped pedParam0) // Position - 0x74CD
{
...
BOOL func_262(Ped pedParam0, BOOL bParam1) // Position - 0x74EA
{
	float entitySpeed;
	float num;
...
BOOL func_263(BOOL bParam0) // Position - 0x7540
{
	return Global_1958675 && bParam0 != false;
}

int func_264(var uParam0, int iParam1) // Position - 0x7551
{
	int num;
	int num2;
	int num3;
...
BOOL func_265(int iParam0, int iParam1, BOOL bParam2) // Position - 0x75D4
{
	return !MISC::IS_STRING_NULL_OR_EMPTY_OR_SPACES(func_267(func_359(iParam0, iParam1, bParam2)));
}

struct<8> func_266(int iParam0, int iParam1) // Position - 0x75EF
{
	return func_359(iParam0, iParam1, true);
}

char* func_267(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x7600
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

BOOL func_268(int iParam0, Hash hParam1) // Position - 0x7614
{
	int i;
...
BOOL func_269(int iParam0) // Position - 0x7660
{
	return iParam0 >= 0 && iParam0 < 50;
}

BOOL func_270(int iParam0) // Position - 0x7676
{
	float num;
	int i;
	int j;
...
BOOL func_271(int iParam0) // Position - 0x7787
{
	int i;
...
BOOL func_272(int iParam0) // Position - 0x77D5
{
	int i;
...
BOOL func_273() // Position - 0x7822
{
	return func_367(func_47(0));
}

BOOL func_274(Ped pedParam0, Hash hParam1, BOOL bParam2) // Position - 0x7833
{
	if (!bParam2)
		if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
			return false;
...
int func_275() // Position - 0x7857
{
	...
	if (ReturnWeaponType2 == joaat("WEAPON_UNARMED"))
		if (ReturnWeaponType == joaat("WEAPON_UNARMED"))
			return 1;
		else if (WEAPON::IS_WEAPON_VALID(ReturnWeaponType) && WEAPON::_IS_WEAPON_TWO_HANDED(ReturnWeaponType) && !func_368(ReturnWeaponType) && !PED::IS_PED_FULLY_ON_MOUNT(Global_33, true) && !(PED::IS_PED_IN_ANY_VEHICLE(Global_33, false) && !CAM::IS_FIRST_PERSON_CAMERA_ACTIVE(1, 0, 0)))
			return 3;
		else if (WEAPON::_IS_WEAPON_BINOCULARS(ReturnWeaponType))
			return 1;
		else if (WEAPON::IS_WEAPON_VALID(ReturnWeaponType) && func_368(ReturnWeaponType) || WEAPON::_IS_WEAPON_LASSO(ReturnWeaponType))
			return 1;
		else
			return 0;
...
int func_276(Hash hParam0) // Position - 0x794A
{
	switch (hParam0)
	{
...
void func_277(int iParam0, BOOL bParam1, int iParam2) // Position - 0x7B25
{
	Hash hash;
	int num;
...
BOOL func_278(Ped pedParam0, Hash hParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x7B9B
{
...
void func_279(Hash hParam0) // Position - 0x7BD4
{
	int num;
	var unk22;
	int i;
...
int func_280(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x7F18
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
void func_281(int iParam0) // Position - 0x80CB
{
...
BOOL func_282(int iParam0) // Position - 0x8111
{
	return Global_1953292.f_595[iParam0] > 0;
}

void func_283(int iParam0) // Position - 0x8126
{
	Global_1953292.f_595[iParam0] = Global_1953292.f_595[iParam0] + 1;
	return;
}

BOOL func_284() // Position - 0x8146
{
...
BOOL func_285(Hash hParam0) // Position - 0x8190
{
	int num;
...
void func_286(var uParam0, int iParam1) // Position - 0x81E0
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_287(Hash hParam0) // Position - 0x81F1
{
	Hash hash;
...
BOOL func_288(var uParam0) // Position - 0x821B
{
...
BOOL func_293(var uParam0) // Position - 0x83D4
{
...
void func_294(BOOL bParam0) // Position - 0x8401
{
	Global_1953292 = Global_1953292 - Global_1953292 && bParam0;
	return;
}

void func_295(int iParam0, int iParam1, int iParam2) // Position - 0x8419
{
...
int func_296(int iParam0, BOOL bParam1) // Position - 0x8458
{
	switch (iParam0)
	{
		case -2061583405:
...
int func_297(int iParam0, BOOL bParam1) // Position - 0x84FB
{
	int num;
...
BOOL func_298(Hash hParam0, var uParam1) // Position - 0x85AA
{
	*uParam1 = 0;
	*uParam1 = 0;
...
BOOL func_299(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x85EA
{
	var unk;
	Hash hash;
...
BOOL func_301(int iParam0) // Position - 0x8739
{
	return func_401(func_400(iParam0));
}

void func_302(BOOL bParam0, Hash hParam1) // Position - 0x874B
{
	char* StringToTest;
	char* str;
	char* str2;
	...
	if (!func_402(hParam1, &StringToTest, joaat("Inventory"), 0, 0, joaat("ui_itemviewer")))
	{
	...
	if (bParam0)
	{
		...
		else
		{
			...
			str = "ITEM_STORED";
			str3 = MISC::VAR_STRING(0, func_407(hParam1, false));
		}
	}
	else
	{
	...
	str4 = func_408(MISC::VAR_STRING(10, str, str3), num);
	func_409(str4, StringToTest.f_1, MISC::GET_HASH_KEY(StringToTest), 0, num, "Transaction_Feed_Sounds", str2, 0, true);
	return;
}

void func_303(BOOL bParam0, BOOL bParam1) // Position - 0x88AE
{
	if (bParam1)
		func_410();
...
int func_304() // Position - 0x88E0
{
	return Global_1953292.f_1;
}

BOOL func_305(Hash hParam0, Hash hParam1) // Position - 0x88EE
{
	int num;
	int num2;
...
void func_306(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x892A
{
...
int func_307(int iParam0, int iParam1) // Position - 0x894D
{
	switch (iParam0)
	{
		case 0:
...
void func_309(int iParam0) // Position - 0x8BE3
{
	func_295(iParam0, 8, 6);
	return;
}

void func_310(Hash hParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x8BF4
{
	int num;
	Hash hash;
	...
	if (bParam3)
	{
		if (*uParam1 == 832230214 || *uParam1 == 30652334 || *uParam1 == 750544038)
		{
			...
			if (func_75(hParam0->f_1[num /*3*/]) != 1882579758)
				return;
		
			hash = func_413(hParam0->f_1[num /*3*/]);
...
void func_311(int iParam0) // Position - 0x8CA2
{
	func_415(&(Global_1953292.f_2938), iParam0);
	return;
}

void func_312(int iParam0, int iParam1) // Position - 0x8CB7
{
	if (iParam1 & 8 != 0)
		return;
...
void func_313(Hash hParam0, int iParam1, int iParam2) // Position - 0x8CDA
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

void func_314(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x8CED
{
	Hash hash;
	BOOL flag;
	...
	if (bParam3 && func_62(hParam0->f_1[iParam2 /*3*/], 343781202))
		func_417(hParam0, hParam0->f_1[iParam2 /*3*/]);

	switch (func_307(iParam2, 1))
	{
		case -1944638739:
			func_433(hParam0, flag, hash, iParam4);
			break;
	
		case -1197751823:
			func_426(hParam0, flag, hash, iParam4);
			break;
	
		case joaat("MP_COMPONENT_TYPE_HAIR"):
			func_418(hParam0, hash, iParam2, iParam4);
			break;
	
		case -893163968:
			func_424(hParam0, flag, hash, iParam4);
			break;
	
		case -450913544:
			func_425(hParam0, flag, hash, iParam2, iParam4);
			break;
	
		case -426430150:
			func_430(hParam0, flag, iParam4);
			break;
	
		case -338487716:
			func_420(hParam0, hash, flag, iParam4);
			break;
	
		case joaat("MP_COMPONENT_TYPE_LOADOUT_2"):
			func_429(hParam0, flag, hash, iParam4);
			break;
	
		case 304805134:
			func_427(hParam0, flag, hash, iParam4);
			break;
	
		case 788010710:
			func_431(hParam0, flag, hash, iParam4);
			break;
	
		case 1108822547:
			func_421(hParam0, flag, hash, iParam4);
			break;
	
		case 1145151482:
			func_428(hParam0, flag, hash, iParam4);
			break;
	
		case 1250092473:
			func_423(hParam0, flag, hash, iParam4);
			break;
	
		case joaat("MP_COMPONENT_TYPE_BEARD"):
			func_419(hParam0, hash, iParam2);
			break;
	
		case 1742327865:
			func_422(hParam0, flag, hash, iParam4);
			break;
	
		case 1958421083:
			func_432(hParam0, flag, hash, iParam4);
			break;
	}
...
Hash func_315(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x8E86
{
	BOOL flag;
...
void func_316(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x8EE7
{
	int i;
	int num;
	BOOL flag;
...
Hash func_317(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0x9026
{
	return func_441(&uParam0, hParam4, bParam5, iParam6);
}

BOOL func_318(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x903A
{
	var unk;
...
struct<4> func_319() // Position - 0x90AE
{
	var unk;
...
BOOL func_320(Ped pedParam0) // Position - 0x90BA
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
BOOL func_322(int iParam0, int iParam1) // Position - 0x9226
{
...
BOOL func_323(Player plParam0) // Position - 0x9271
{
	if (plParam0 == 255)
		return Global_1102813.f_3 & 32 != 0;

	return func_446(32, plParam0);
}

BOOL func_324(int iParam0) // Position - 0x9296
{
...
void func_327(BOOL bParam0) // Position - 0x92FD
{
...
BOOL func_328() // Position - 0x933D
{
	return Global_1915656.f_20643;
}

BOOL func_329(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x934C
{
	Player PlayerIndex;
	Ped EntityIndex;
	BOOL isEntityDead;
...
BOOL func_330(int iParam0, int iParam1, Player plParam2) // Position - 0x9572
{
	return func_201(Global_1206166[plParam2 /*10*/][iParam0], iParam1);
}

var func_331(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x958C
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_452(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
int func_332(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x991F
{
	if (!func_456(uParam0))
		return 0;
...
BOOL func_333(int iParam0, int iParam1) // Position - 0x994F
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_334(int iParam0) // Position - 0x9967
{
...
BOOL func_335(int iParam0) // Position - 0x997E
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_336(int iParam0, int iParam1) // Position - 0x9A4A
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_337(int iParam0) // Position - 0x9A63
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_338() // Position - 0x9A76
{
	if (!func_198())
		return false;
...
BOOL func_339(var uParam0) // Position - 0x9A91
{
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_340(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x9AA1
{
	int i;
...
BOOL func_341(Hash hParam0, Any* panParam1) // Position - 0x9BB8
{
	int num;
...
BOOL func_342(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x9D8E
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_343(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x9DA5
{
	if (bParam0)
	{
...
int func_344(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x9DEE
{
	if (bParam0)
	{
		func_459(iParam1, 1, 0, 0);
...
BOOL func_346(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x9E27
{
	int inventoryId;
...
BOOL func_347(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x9E6C
{
...
BOOL func_348(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x9E9F
{
...
int func_349() // Position - 0x9ED9
{
	return 1037647863;
}

int func_350() // Position - 0x9EE6
{
	return 1037746167;
}

int func_351() // Position - 0x9EF3
{
	return 1035451607;
}

Entity func_352(Ped pedParam0) // Position - 0x9F00
{
	int lootTarget;
...
int func_353(var uParam0, var uParam1) // Position - 0x9F60
{
	var unk;
...
int func_354(int iParam0) // Position - 0x9F8C
{
	int num;
	int num2;
...
int func_355(int iParam0) // Position - 0x9FB7
{
	if (iParam0 == -1)
		return -1;
...
int func_356(int iParam0) // Position - 0x9FD3
{
	switch (iParam0)
	{
		case 0:
...
int func_357(int iParam0) // Position - 0xA188
{
	int num;
...
int func_358(int iParam0) // Position - 0xA1AF
{
	return Global_1110244.f_3667[iParam0 /*7*/];
}

struct<8> func_359(int iParam0, int iParam1, BOOL bParam2) // Position - 0xA1C2
{
	var unk;
	var unk6;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xA275
{
...
float func_361(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xA29F
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_362(int iParam0) // Position - 0xA2BD
{
	return func_201(Global_1220826.f_1196, iParam0);
}

BOOL func_363() // Position - 0xA2D2
{
	return Global_263042[Global_1295666 /*65*/] > 2;
}

BOOL func_364(BOOL bParam0, int iParam1) // Position - 0xA2E6
{
...
struct<2> func_365() // Position - 0xA322
{
...
BOOL func_366(Hash hParam0) // Position - 0xA36D
{
...
BOOL func_367(var uParam0, var uParam1) // Position - 0xA384
{
	return func_472(uParam0, 1, 4);
}

BOOL func_368(Hash hParam0) // Position - 0xA396
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

Hash func_369(int iParam0) // Position - 0xA3A4
{
	switch (iParam0)
	{
		case 2:
...
void func_370(int iParam0, BOOL bParam1) // Position - 0xA65F
{
	if (!func_371(iParam0))
		return;
...
BOOL func_371(int iParam0) // Position - 0xA685
{
	return !(iParam0 <= 0);
}

BOOL func_372(int iParam0) // Position - 0xA692
{
	if (!func_371(iParam0))
		return false;
...
void func_373(int iParam0, BOOL bParam1) // Position - 0xA6B0
{
	if (!func_371(iParam0))
		return;
...
BOOL func_374(int iParam0) // Position - 0xA6F3
{
	if (!func_371(iParam0))
		return false;
...
void func_375(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA711
{
	if (!func_371(iParam0))
		return;
...
void func_376(BOOL bParam0, int iParam1) // Position - 0xA773
{
...
float func_377(int iParam0, int iParam1) // Position - 0xA7B9
{
	int num;
	float pedStamina;
	float pedMaxStamina;
...
void func_378(int iParam0) // Position - 0xA86E
{
	Ped ped;
	int num;
...
void func_379(int iParam0, BOOL bParam1) // Position - 0xA8AB
{
	int num;
...
void func_380(int iParam0) // Position - 0xA8E0
{
	Ped ped;
	int num;
...
float func_381(float fParam0, float fParam1) // Position - 0xA91D
{
	if (fParam1 != 0f)
...
void func_382(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xA94B
{
	if (fParam1 == 0f)
		return;
...
float func_383(float fParam0, int iParam1) // Position - 0xA984
{
	switch (iParam1)
	{
		case 0:
...
int func_384(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA9D6
{
	if (!ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		return 0;
...
void func_385(float fParam0, BOOL bParam1) // Position - 0xA9FA
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
struct<2> func_386(int iParam0) // Position - 0xAA52
{
	int num;
...
void func_387(var uParam0, var uParam1, int iParam2) // Position - 0xAA62
{
...
BOOL func_388(Hash hParam0) // Position - 0xAA7F
{
	return func_42(hParam0) == joaat("consumable");
}

void func_389(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xAA93
{
	BOOL flag;
	int value;
	var unk;
	...
	else if (!func_402(hParam0, &InputString, num3, num2, 0, joaat("ui_itemviewer")))
	{
	...
	str3 = func_408(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash), value), num5);
	...
	if (num4 == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || num4 == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || num4 == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || num4 == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str3 = MISC::VAR_STRING(0, func_502(hParam0, -442898163));
	...
	if (num4 == -126813555 || num4 == 1946043663)
	{
		...
		if (func_503(hParam0, &unk7))
			str3 = func_505(func_504(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_409(str3, InputString.f_1, MISC::GET_HASH_KEY(InputString), num6, num5, str2, str, 0, true);
	return;
}

struct<2> func_390(Hash hParam0) // Position - 0xAF6E
{
	var unk;
	var unk3;
...
BOOL func_391(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0xB002
{
	var unk;
	int num;
	int num2;
...
void func_392(int iParam0, BOOL bParam1, int iParam2) // Position - 0xB0CE
{
...
int func_394(int iParam0) // Position - 0xB19E
{
	int num;
...
BOOL func_395(int iParam0, var uParam1) // Position - 0xB1CD
{
	Hash hash;
	int num;
...
Hash func_396(Hash hParam0) // Position - 0xB263
{
	return Global_1953292.f_1676.f_1[func_175(hParam0, 1) /*3*/];
}

int func_397() // Position - 0xB27D
{
	int i;
	Hash hash;
	int num;
...
BOOL func_398(Hash hParam0, int iParam1) // Position - 0xB2CE
{
	if (iParam1 == 0)
...
BOOL func_399(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB337
{
	var unk;
	var guid;
...
int func_400(int iParam0) // Position - 0xB389
{
	switch (iParam0)
	{
		case -2061583405:
...
BOOL func_401(int iParam0) // Position - 0xB3E4
{
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_402(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0xB3FC
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
int func_403(Hash hParam0) // Position - 0xB4EF
{
	switch (hParam0)
	{
		case -2011879201:
...
BOOL func_404(BOOL bParam0, int iParam1) // Position - 0xB571
{
	if (iParam1 == -1)
...
struct<8> func_405(int iParam0) // Position - 0xB5B4
{
	var unk;
...
Hash func_406(Hash hParam0) // Position - 0xB5E9
{
	int num;
	var unk;
	int collectionId;
...
Hash func_407(Hash hParam0, BOOL bParam1) // Position - 0xB66E
{
	Hash hash;
...
const char* func_408(const char* sParam0, int iParam1) // Position - 0xB69C
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

int func_409(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0xB6B6
{
	int num;
	var unk13;
	int num2;
...
void func_410() // Position - 0xB719
{
	Global_1953292.f_1046 = 0;
	return;
}

BOOL func_411(Hash hParam0) // Position - 0xB729
{
	if (!func_41(hParam0, 0))
		return false;
...
void func_412(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB765
{
	BOOL flag;
	var unk;
	var unk120;
...
Hash func_413(Hash hParam0) // Position - 0xB8EB
{
	int num;
	var unk;
...
BOOL func_414(Hash hParam0, int iParam1) // Position - 0xB92F
{
	int num;
...
void func_415(int iParam0, int iParam1) // Position - 0xB9D6
{
	int i;
	int num;
	var unk;
	...
	for (i = 0; i < 16; i = i + 1)
	{
		...
		if (i < *iParam0)
		{
			if (func_523(&iParam0->f_2[i /*2*/], 2) || iParam0->f_2[i /*2*/] == iParam1 || iParam0->f_2[i /*2*/] == 39)
			{
				iParam0->f_2[i /*2*/] = { unk };
			}
			else
			{
				if (func_523(&iParam0->f_2[i /*2*/], 1))
					func_524(&iParam0->f_2[i /*2*/], 2, 6);
...
void func_416(int iParam0, int iParam1, int iParam2) // Position - 0xBAD3
{
	int i;
	int j;
...
void func_417(Hash hParam0, var uParam1) // Position - 0xBBB9
{
	int num;
	int num2;
	int num3;
...
void func_418(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xBC6C
{
	int num;
	int num2;
	...
	num = 10;
	num2 = func_75(hParam0->f_1[num /*3*/]);
	...
	if (func_62(hParam0->f_1[num /*3*/], -1446529222) && func_62(hParam1, -93469181))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_62(hParam1, -93469181) && func_62(hParam0->f_1[num /*3*/], -1303648999))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
...
void func_419(Hash hParam0, Hash hParam1, int iParam2) // Position - 0xBE41
{
...
void func_420(Hash hParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0xBE86
{
	int num;
	Hash hash;
...
void func_421(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xBF4F
{
	switch (func_75(hParam2))
	{
		case -525676072:
			func_528(hParam0, bParam1, iParam3);
			break;
	
		case 2086043523:
			func_529(hParam0, bParam1, iParam3);
			break;
	}
...
void func_422(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xBF89
{
	int num;

	num = 18;

	if (func_75(hParam0->f_1[num /*3*/]) == 912453393)
		func_312(num, iParam3);
	...
	if (func_411(hParam2))
		func_530(hParam0, bParam1, iParam3);

	num = 11;

	if (func_62(hParam2, -180472385) && !func_178(hParam0->f_1[num /*3*/], false))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
...
void func_423(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xC0CA
{
	int num;
	int metapedType;
	Hash hash;
	...
	if (!func_178(hParam0->f_1[num /*3*/], false) && func_62(hParam2, 1467402774))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
	...
	if (!func_178(hParam0->f_1[num /*3*/], false) && func_62(hParam2, 1126863852))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
	...
	{
		hParam0->f_1[num /*3*/] = func_413(hParam2);
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
	}
	else if (func_531(hash, bParam1, metapedType))
	{
		...
		if (hash != 0)
		{
			...
			hParam0->f_1[num /*3*/].f_1 = 0;
			func_312(num, iParam3);
			func_431(hParam0, false, hash, iParam3);
		}
	}

	num = 21;

	if (!func_178(hParam0->f_1[num /*3*/], false) && func_62(hParam2, 196770179))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
	...
	if (!func_178(hParam0->f_1[num /*3*/], false) || hParam0->f_1[num3 /*3*/] != Global_1953292.f_83[num3 /*12*/] && func_62(hParam0->f_1[num3 /*3*/], -1655064541))
		func_534(hParam0, iParam3);

	return;
}

void func_424(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xC3B3
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_62(hParam2, 358628372))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
...
void func_425(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3, int iParam4) // Position - 0xC412
{
	switch (func_75(hParam2))
	{
		case 698653232:
			func_535(hParam0, bParam1, hParam2, iParam4);
			break;
	
		case 912453393:
			func_536(hParam0, bParam1, iParam3, iParam4);
			break;
	}
...
void func_426(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xC450
{
	switch (func_75(hParam2))
	{
		case -1080198344:
		case 1868067663:
			func_537(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 294388917:
			func_538(hParam0, bParam1, hParam2, iParam3);
			break;
	}
...
void func_427(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xC494
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_62(hParam2, 1537768121))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
...
void func_428(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xC530
{
	int num;
	...
	if (!bParam1)
	{
		...
		if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
		{
			if (func_62(hParam0->f_1[num /*3*/], 1537768121))
			{
				hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
				hParam0->f_1[num /*3*/].f_1 = 0;
			}
...
void func_429(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xC63F
{
	int num;
	...
	if (!func_178(hParam0->f_1[num /*3*/], false) && func_62(hParam2, 1016511012))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
...
void func_430(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xC6DE
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_62(hParam0->f_1[num /*3*/], 358628372))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
...
void func_431(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xC743
{
	switch (func_75(hParam2))
	{
		case -1740828670:
			func_544(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 344283346:
			func_545(hParam0, bParam1, iParam3);
			break;
	
		case 502936876:
			func_543(hParam0, bParam1, iParam3);
			break;
	
		case 684307653:
			func_542(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 1223979091:
		case 2047428024:
			func_541(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 1759215194:
			func_540(hParam0, iParam3);
			break;
	}
...
void func_432(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xC7D3
{
	switch (func_75(hParam2))
	{
		case -923693316:
			func_547(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 1769055947:
			func_546(hParam0, bParam1, hParam2, iParam3);
			break;
	}
...
void func_433(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xC811
{
	int num;
	Hash hash;
	...
	if (bParam1)
	{
		func_548(hParam0, iParam3, false, true);
		return;
	}
	...
	if (func_62(hParam2, 813132419) && hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_75(hash) == -923693316)
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
	...
	if (func_62(hParam2, -1650340550) && hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_75(hash) == 1769055947)
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
	...
	if (func_62(hParam2, -1278198125) && hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
...
int func_434(Hash hParam0, BOOL bParam1, Hash hParam2) // Position - 0xC940
{
	int i;
...
BOOL func_435(Hash hParam0, Hash hParam1, var uParam2) // Position - 0xC982
{
	*uParam2 = joaat("base");
	return true;
}

int func_436(Hash hParam0) // Position - 0xC993
{
	int num;
...
BOOL func_437(int iParam0) // Position - 0xC9AF
{
...
void func_438(int iParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0xCA3D
{
	if (bParam1)
...
BOOL func_439(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xCA99
{
	var unk;
	var unk6;
...
void func_440(int iParam0, BOOL bParam1, int iParam2) // Position - 0xCACE
{
...
int func_441(Any* panParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0xCAF6
{
	var unk;
...
int func_442(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xCB24
{
	int num;
	var unk;
	int num2;
...
float func_443(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0xCC67
{
...
int func_444(int iParam0) // Position - 0xCCAF
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_446(int iParam0, Player plParam1) // Position - 0xCDEE
{
	if (plParam1 == 255)
...
void func_448(int iParam0) // Position - 0xCE44
{
	Global_1051832.f_3648 = Global_1051832.f_3648 || iParam0;
	return;
}

BOOL func_449() // Position - 0xCE5D
{
	return ANIMSCENE::DOES_ANIM_SCENE_EXIST(Global_26573) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(Global_26573, false);
}

int func_450() // Position - 0xCE79
{
	return Global_1051645.f_12;
}

char* func_451() // Position - 0xCE87
{
	return "unnamed";
}

BOOL func_452(int iParam0) // Position - 0xCE93
{
	int num;
...
BOOL func_453(int iParam0) // Position - 0xCF22
{
	if (Global_1572887.f_14 == -1)
		return false;
...
int func_454(int iParam0) // Position - 0xCF40
{
	if (iParam0 == 255)
...
BOOL func_455(Player plParam0) // Position - 0xCF8B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_456(var uParam0) // Position - 0xCFD0
{
	if (*uParam0 >= 40)
		return false;
...
BOOL func_457(Any* panParam0) // Position - 0xCFE5
{
...
BOOL func_458(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xD001
{
...
void func_459(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xD019
{
	int i;
...
int func_460(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xD0B7
{
...
BOOL func_461(int iParam0, var uParam1, Any* panParam2) // Position - 0xD0EA
{
	if (!func_48(iParam0))
		return false;
...
BOOL func_462(Any* panParam0, int iParam1) // Position - 0xD1F5
{
...
int func_464() // Position - 0xD264
{
	return Global_1110244.f_3667.f_938;
}

int func_465(int iParam0, int iParam1, var uParam2) // Position - 0xD276
{
	int num;
...
int func_466(int iParam0) // Position - 0xD2E0
{
	return Global_1110244.f_3667.f_729[iParam0 /*2*/].f_1;
}

BOOL func_467(int iParam0) // Position - 0xD2F8
{
	return iParam0 > -1 && iParam0 < 83;
}

BOOL func_468(Any* panParam0) // Position - 0xD30E
{
	int fileHandle;
	var SourceStruct;
...
BOOL func_469(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int* piParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0xD347
{
	uParam0.f_2 = iParam6;
	uParam0.f_3 = iParam7;
	uParam0.f_4 = iParam8;
...
struct<8> func_470(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD372
{
	return func_570(uParam0, 52, 1);
}

int func_471(Hash hParam0) // Position - 0xD385
{
	switch (hParam0)
	{
...
BOOL func_472(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0xD41E
{
	int num;
...
BOOL func_473(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD459
{
	if (bParam2)
		if (!func_371(iParam0))
			return false;
...
BOOL func_474(int iParam0) // Position - 0xD49C
{
	if (!func_371(iParam0))
		return false;
...
int func_475(BOOL bParam0, int iParam1) // Position - 0xD4BA
{
	if (!NETWORK::NETWORK_IS_IN_SESSION())
		return 0;
...
BOOL func_476(int iParam0) // Position - 0xD510
{
	switch (iParam0)
	{
		case 1:
...
void func_477(int iParam0) // Position - 0xD57D
{
	switch (iParam0)
	{
		case 2:
...
void func_478(int iParam0, int iParam1) // Position - 0xD783
{
	iParam0->f_2 = iParam0->f_2 || iParam1;
	return;
}

BOOL func_479() // Position - 0xD796
{
	return true;
}

int func_480(int iParam0) // Position - 0xD7B5
{
	if (iParam0 == 2)
		iParam0 = func_573(1);
...
void func_481(float fParam0, Ped pedParam1) // Position - 0xD7F5
{
	if (fParam0 == 0f)
		return;
...
int func_482(int iParam0) // Position - 0xD839
{
	if (iParam0 == 2)
		iParam0 = func_573(1);
...
void func_483(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD87D
{
	Player player;
	Ped EntityIndex;
...
int func_484(int iParam0) // Position - 0xD92E
{
	if (iParam0 == 2)
		iParam0 = func_573(1);
...
void func_485(float fParam0, Ped pedParam1) // Position - 0xD972
{
	if (fParam0 == 0f)
		return;
...
float func_486(int iParam0, float fParam1, BOOL bParam2) // Position - 0xD9B4
{
	int num;
	int num2;
...
float func_487(int iParam0, int iParam1) // Position - 0xDA1D
{
	if (iParam1 == 2)
		iParam1 = func_573(2);
...
int func_488(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0xDA69
{
	Ped ped;
...
int func_489(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xDAE7
{
	char* effectName;
	Ped ped;
...
void func_491(float fParam0, int iParam1) // Position - 0xDCC6
{
	float num;
	int num2;
	int num3;
...
BOOL func_492() // Position - 0xDD39
{
	return !Global_1913444;
}

void func_493(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0xDD46
{
	int i;
...
var func_494(BOOL bParam0, var uParam1, var uParam2) // Position - 0xDE69
{
	if (bParam0)
		return uParam1;
...
BOOL func_495(Hash hParam0, int iParam1) // Position - 0xDE80
{
	if (!func_41(hParam0, 0))
		return false;
...
char* func_496(Hash hParam0) // Position - 0xDE9F
{
...
BOOL func_497(Hash hParam0) // Position - 0xDF9B
{
...
BOOL func_498(int iParam0) // Position - 0xE01A
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_499(Hash hParam0) // Position - 0xE041
{
	var unk;
	int i;
...
BOOL func_500(Hash hParam0, Hash hParam1) // Position - 0xE0AF
{
	if (hParam0 == 0)
		return false;
...
int func_501(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0xE0E0
{
	var unk;
 ...
 func_502(Hash hParam0, int iParam1) // Position - 0xE13F
{
	 num;
...
BOOL func_503(Hash hParam0, char* sParam1) // Position - 0xE15D
{
	...
	TEXT_LABEL_ASSIGN_STRING(&StringToTest, func_600(hParam0), 128);
...
const char* func_504(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0xE1DA
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_505(const char* sParam0, int iParam1) // Position - 0xE1EE
{
...
void func_507(int iParam0) // Position - 0xE283
{
	Global_1940252.f_11 = iParam0;
	return;
}

void func_508(int iParam0) // Position - 0xE293
{
	Global_1940252.f_10 = iParam0;
	return;
}

Hash func_509(int iParam0) // Position - 0xE2A3
{
	Hash hash;
	...
	return func_174(hash);
}

Hash func_510() // Position - 0xE2C6
{
	return Global_1953292.f_1676;
}

int func_511(BOOL bParam0) // Position - 0xE2D5
{
	var unk;
	int num;
	var unk15;
...
Hash func_512(int iParam0) // Position - 0xE3E2
{
	switch (iParam0)
	{
		case 1:
...
int func_513(Hash hParam0) // Position - 0xE47F
{
	var unk;
	int num;
...
struct<10> func_514(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0xE4B9
{
	int num;
...
BOOL func_515(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0xE58D
{
...
BOOL func_516(Hash hParam0) // Position - 0xE5AE
{
	!func_41(hParam0, 0);
...
int func_517(int iParam0) // Position - 0xE5D4
{
	if (iParam0 < 0)
		return 0;
...
Hash func_518(Hash hParam0, BOOL bParam1) // Position - 0xE5F5
{
	switch (hParam0)
	{
...
void func_519(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0xE697
{
...
BOOL func_520(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xE6C8
{
	int i;
	BOOL flag;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_521(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6, BOOL bParam7, BOOL bParam8, int iParam9) // Position - 0xE7A8
{
	Hash hash;
	int num;
	BOOL flag;
	...
	*uParam2 = flag;
	...
	if (!flag && !bParam3)
		func_605(hParam0, func_604(hash), true, true, bParam7);
		...
		else
		{
			...
			else
			{
				...
				if (!DATAFILE::_PARSEDDATA_GET_SECTION(&hash, &num2, 1194786549))
					if (func_607(hash2) && func_435(hParam0->f_1[num /*3*/], hash2, &hash))
	...
	{
		if (!bParam8)
			func_609(hParam0, num3, func_608(hParam1) != 0, iParam9);
	}
	else if (func_304() == joaat("MPC_PLAYER_TYPE_MP_FEMALE") && hParam0->f_1[num /*3*/] == Global_1953292.f_83[num /*12*/] && func_608(hParam0->f_1[34 /*3*/]) == 0 && !func_167(32) && !func_167(64))
	{
		hParam0->f_1[num /*3*/] = func_533(-1293064293, 0);
		hParam0->f_1[num /*3*/].f_1 = joaat("base");
		func_314(hParam0, hParam0->f_1[num /*3*/], num, false, iParam9);
	}
...
void func_522(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4, Hash hParam5) // Position - 0xE9D7
{
	*panParam0 = iParam1;
...
BOOL func_523(var uParam0, int iParam1) // Position - 0xEA06
{
	return uParam0->f_1 && iParam1 != false;
}

void func_524(var uParam0, int iParam1, int iParam2) // Position - 0xEA17
{
	uParam0->f_1 = uParam0->f_1 || iParam1;
	return;
}

BOOL func_525(int iParam0, int iParam1) // Position - 0xEA2A
{
	return iParam0->f_1 && iParam1 != false;
}

void func_526(int iParam0, int iParam1) // Position - 0xEA3B
{
	iParam0->f_1 = iParam0->f_1 || iParam1;
	return;
}

int func_527(int iParam0) // Position - 0xEA4E
{
	if (iParam0 == 0)
		iParam0 = func_304();
...
void func_528(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xEA8A
{
	int num;
	Hash hash;
...
void func_529(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xEAED
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_62(hParam0->f_1[num /*3*/], -93469181))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam2);
...
void func_530(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xEB52
{
	int num;
	...
	if (-525676072 == func_75(hParam0->f_1[num /*3*/]))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam2);
...
BOOL func_531(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xEB9F
{
	int num;
...
BOOL func_532(int iParam0) // Position - 0xEBEC
{
	return Global_17418.f_55.f_664.f_1734 && iParam0 != false;
}

Hash func_533(Hash hParam0, int iParam1) // Position - 0xEC04
{
	int num;
	int num2;
	int num3;
	...
	num3 = 0;
	unk = { func_219(0, -1591664384, hParam0, -1591664384, 0, 0, 0) };
...
void func_534(Hash hParam0, int iParam1) // Position - 0xEC51
{
	int num;
	BOOL flag;
	...
	{
		if (func_434(hParam0->f_1[num /*3*/], flag, -1539589426) >= 0)
		{
			hParam0->f_1[num /*3*/].f_1 = -1539589426;
			return;
		}
	...
	if (func_434(hParam0->f_1[num /*3*/], flag, 1334603721) >= 0)
		hParam0->f_1[num /*3*/].f_1 = 1334603721;

	return;
}

void func_535(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xED17
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_62(hParam2, -1527414429) && !func_62(hParam0->f_1[num /*3*/], -1303648999))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/].f_1 == 1530758430 || hParam0->f_1[num /*3*/].f_1 == 1334603721 && func_62(hParam2, -985549034))
	{
		if (hParam0->f_1[num /*3*/].f_1 == 1530758430)
		{
			hParam0->f_1[num /*3*/].f_1 = joaat("base");
...
void func_536(Hash hParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xEE1F
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[iParam2 /*3*/].f_1 != -2081918609)
	{
		...
		else
		{
			...
			if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && 1769055947 == func_75(hash))
			{
				hParam0->f_1[iParam2 /*3*/].f_1 = -2081918609;
				func_312(iParam2, iParam3);
			}
...
void func_537(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xEF01
{
	int num;
	Hash hash;
	...
	if (bParam1)
	{
		...
		{
			func_312(num, iParam3);
			func_427(hParam0, false, hParam0->f_1[num /*3*/], iParam3);
		}
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_62(hParam2, 1126863852))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_62(hParam2, -985549034))
		if (hParam0->f_1[num /*3*/].f_1 == 1530758430)
			hParam0->f_1[num /*3*/].f_1 = joaat("base");
		else if (hParam0->f_1[num /*3*/].f_1 == 1334603721)
			hParam0->f_1[num /*3*/].f_1 = -1539589426;
...
void func_538(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF16E
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && !func_62(hParam0->f_1[num /*3*/], -1303648999))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_62(hParam2, 675650051))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
...
BOOL func_539(int iParam0) // Position - 0xF282
{
	return Global_1953292.f_1676.f_1[func_175(iParam0, 1) /*3*/] != Global_1953292.f_83[func_175(iParam0, 1) /*12*/];
}

void func_540(Hash hParam0, int iParam1) // Position - 0xF2AC
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		if (func_62(hParam0->f_1[num /*3*/], -928740153))
		{
			hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
			hParam0->f_1[num /*3*/].f_1 = 0;
		}
...
void func_541(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF377
{
	int num;
	Hash hash;
	BOOL flag;
	...
	if (func_304() == joaat("MPC_PLAYER_TYPE_MP_FEMALE"))
	{
		...
		if (hParam0->f_1[num /*3*/] == Global_1953292.f_83[num /*12*/] && func_75(hParam0->f_1[18 /*3*/]) != 912453393)
		{
			hParam0->f_1[num /*3*/] = func_533(Global_1953292.f_83[num /*12*/].f_9, 0);
			hParam0->f_1[num /*3*/].f_1 = 0;
			func_312(num, iParam3);
		}
	}
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_62(hParam2, -1473580422))
	{
		hash = hParam0->f_1[num /*3*/];
		...
		else if (func_434(hParam0->f_1[num /*3*/], flag2, -2081918609) != -1)
		{
	...
	if (hash != Global_1953292.f_83[num /*12*/])
		if (func_75(hash) == 1868067663 && func_62(hParam2, -1016441646))
			func_611(hParam0, num, iParam3);
		else if (flag)
			func_312(num, iParam3);

	num = 34;

	if (1759215194 == func_75(hParam0->f_1[num /*3*/]))
		func_312(16, iParam3);

	num = 35;

	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_62(hParam2, -1650340550))
	{
		hash = hParam0->f_1[num /*3*/];
...
void func_542(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF61F
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
		if (func_62(hParam0->f_1[num /*3*/], -2093434733))
			func_548(hParam0, iParam3, true, false);
...
void func_543(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xF780
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && 1769055947 == func_75(hParam0->f_1[num /*3*/]))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam2);
...
void func_544(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF935
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_75(hash) == 294388917)
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
...
void func_545(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xFB70
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		if (func_62(hParam0->f_1[num /*3*/], -2093434733))
		{
			func_548(hParam0, iParam2, true, false);
		}
		else
		{
			hParam0->f_1[num /*3*/].f_1 = joaat("base");
...
void func_546(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xFD68
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_62(hParam2, -1278198125))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		...
		if (912453393 == func_75(hash) && hParam0->f_1[num /*3*/].f_1 != -2081918609)
		{
			hParam0->f_1[num /*3*/].f_1 = -2081918609;
			func_312(num, iParam3);
		}
...
void func_547(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xFE85
{
	int num;
...
void func_548(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFEE4
{
	int num;
	...
	if (bParam3 && -923693316 == func_75(hParam0->f_1[num /*3*/]))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_312(num, iParam1);
...
void func_549(Hash hParam0, int iParam1, int iParam2) // Position - 0xFFDB
{
	Global_17418.f_55.f_664.f_33[iParam2 /*120*/].f_1.f_1[iParam1 /*3*/] = { *hParam0 };
	return;
}

void func_550(Hash hParam0, int iParam1) // Position - 0xFFFF
{
	int i;
	...
	for (i = 0; i < 39; i = i + 1)
	{
		func_549(&hParam0->f_1[i /*3*/], i, iParam1);
	}

	return;
}

void func_551(BOOL bParam0, int iParam1, int iParam2) // Position - 0x10051
{
	if (iParam1 == -1)
		iParam1 = Global_17418.f_55.f_664.f_1777;
...
BOOL func_552(Any* panParam0, Hash hParam1, Any* panParam2, BOOL bParam3, int iParam4) // Position - 0x1009C
{
	var outGuid;
...
struct<29> func_553(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x100EA
{
	var unk;
	var unk30;
...
int func_554(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x10185
{
	int num;
...
struct<26> func_555(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x101EF
{
	var unk;
	var unk27;
...
int func_556(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x10272
{
	int num;
...
struct<18> func_557(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x102C2
{
	var unk;
	var unk19;
...
int func_558(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x10337
{
	int num;
...
struct<17> func_559(var uParam0, BOOL bParam1) // Position - 0x103A1
{
	var unk;
...
BOOL func_560() // Position - 0x10422
{
	return func_48(Global_1051268);
}

BOOL func_561(int iParam0) // Position - 0x10434
{
	return iParam0 == -1759663922 || iParam0 == -318976023 || iParam0 == 772881414 || iParam0 == 31269700 || iParam0 == -133550749;
}

BOOL func_562(int iParam0, int iParam1) // Position - 0x1047C
{
	int num;
...
BOOL func_563(Player plParam0) // Position - 0x104F0
{
...
void func_564(Player plParam0) // Position - 0x1050D
{
	Player player;
...
BOOL func_565(Any* panParam0) // Position - 0x10590
{
...
void func_566(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x105C6
{
	int i;
...
BOOL func_567(Hash hParam0) // Position - 0x106A2
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

void func_568(Any* panParam0) // Position - 0x106B0
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
int func_569() // Position - 0x106C6
{
	return Global_1072759.f_28418[32 /*4*/].f_3;
}

struct<8> func_570(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6) // Position - 0x106DB
{
	var unk;
...
int func_571(int iParam0, var uParam1) // Position - 0x106F9
{
	if (iParam0 == 2)
...
BOOL func_572() // Position - 0x10713
{
	return !Global_1572887.f_10;
}

int func_573(int iParam0) // Position - 0x10722
{
	return func_621(func_620(iParam0));
}

BOOL func_574(Player plParam0) // Position - 0x10734
{
	float num;
...
int func_575() // Position - 0x1074F
{
	return Global_1902569;
}

void func_576(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1075B
{
	int num;
	int i;
	int j;
...
int func_577(int iParam0, int iParam1) // Position - 0x108CE
{
	if (iParam1 == 2)
		iParam1 = func_573(2);
...
int func_578(int iParam0, int iParam1) // Position - 0x1091E
{
	if (iParam1 == 2)
		iParam1 = func_573(2);
...
BOOL func_579(int iParam0, int iParam1, BOOL bParam2) // Position - 0x10970
{
	if (bParam2)
...
void func_580(int iParam0, int iParam1, int iParam2) // Position - 0x1099D
{
	if (iParam2 == 2)
		iParam2 = func_573(2);
...
void func_581(int iParam0, int iParam1, int iParam2) // Position - 0x109F3
{
	if (iParam2 == 2)
		iParam2 = func_573(2);
...
BOOL func_582(Ped pedParam0, int iParam1, float fParam2) // Position - 0x10A49
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
void func_583(int iParam0, int iParam1, int iParam2) // Position - 0x10A9E
{
	if (iParam2 == 2)
		iParam2 = func_573(2);
...
void func_584(Ped pedParam0, int iParam1, float fParam2) // Position - 0x10AFF
{
	char* StringToTest;

	StringToTest = func_633(iParam1);
...
void func_585(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x10B2B
{
	int num;
...
BOOL func_586(int iParam0) // Position - 0x10B61
{
	switch (iParam0)
	{
		case 0:
...
char* func_587(int iParam0) // Position - 0x10B90
{
	switch (iParam0)
	{
		case 0:
...
void func_588(int iParam0) // Position - 0x10BCB
{
	int num;
	int num2;
	int i;
...
void func_589(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x10C9B
{
	func_488(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

BOOL func_590(int iParam0, BOOL bParam1) // Position - 0x10CB5
{
	return func_579(func_575(), iParam0, bParam1);
}

float func_591(int iParam0, int iParam1) // Position - 0x10CC9
{
	if (iParam1 == 2)
		iParam1 = func_573(1);
...
int func_592(float fParam0) // Position - 0x10D15
{
	float num;
...
float func_593(float fParam0, float fParam1, float fParam2) // Position - 0x10D40
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_594(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x10D67
{
	int num;
	int i;
	int num2;
...
int func_595(int iParam0, float fParam1, int iParam2) // Position - 0x10EEF
{
	if (!func_639(iParam0))
		return 0;
...
BOOL func_596(Hash hParam0, Hash hParam1) // Position - 0x10F40
{
	if (hParam1 == 0)
		return false;
...
int func_597(Hash hParam0, int iParam1) // Position - 0x10F67
{
	var unk;
	int num;
	int num2;
...
char* func_598(Hash hParam0) // Position - 0x10FB5
{
	Hash labelHash;
...
BOOL func_599(Hash hParam0) // Position - 0x10FEB
{
...
char* func_600(Hash hParam0) // Position - 0x11019
{
	Hash labelHash;
...
Ped func_601(int iParam0) // Position - 0x1104E
{
	return PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::GET_PLAYER_INDEX());
}

int func_602(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1105E
{
	int num;
...
void func_603(int iParam0) // Position - 0x11093
{
...
int func_604(int iParam0) // Position - 0x11118
{
	switch (iParam0)
	{
		case -1932005642:
...
// Unhandled jump detected. Output should be considered invalid
void func_605(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x112B9
{
	int i;
	Hash hash;
	Hash hash2;
...
void func_606(Hash hParam0, int iParam1, int iParam2) // Position - 0x11392
{
	Global_1953292.f_83[func_175(hParam0, 1) /*12*/].f_11 = Global_1953292.f_83[func_175(hParam0, 1) /*12*/].f_11 || iParam1;
	return;
}

BOOL func_607(Hash hParam0) // Position - 0x113BF
{
	int num;
	var unk;
...
int func_608(Hash hParam0) // Position - 0x11418
{
	var unk;
	int num;
...
void func_609(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x11452
{
	int i;
	BOOL flag;

	if (func_62(hParam0->f_1[34 /*3*/], -166674229))
		return;
	...
	for (i = 0; i < 39; i = i + 1)
	{
		...
		else
		{
			...
			if (!bParam2 && func_608(hParam0->f_1[i /*3*/]) != 0)
			{
			}
			else if (func_644(i, iParam1) && !flag)
			{
				...
				func_314(hParam0, hParam0->f_1[i /*3*/], i, true, iParam3);
				func_312(i, iParam3);
			}
			else if (flag && !bParam2)
			{
				func_314(hParam0, hParam0->f_1[i /*3*/], i, false, iParam3);
			}
		}
	}
...
int func_610(int iParam0, int iParam1, int iParam2) // Position - 0x1155E
{
	int i;
	var unk;
	int num;
...
void func_611(Hash hParam0, int iParam1, int iParam2) // Position - 0x1162B
{
	int num;

	if (func_62(hParam0->f_1[iParam1 /*3*/], 343781202))
	{
		func_417(hParam0, hParam0->f_1[iParam1 /*3*/]);
	}
	else
	{
...
BOOL func_612(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x116BF
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 29, panParam2, 0);
}

BOOL func_613(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x116D6
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 26, panParam2, 0);
}

BOOL func_614(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x116ED
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

BOOL func_615(Any* panParam0, int iParam1, int iParam2) // Position - 0x11704
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_616() // Position - 0x1173B
{
	return Global_1102813.f_3672;
}

void func_617(Player plParam0) // Position - 0x1174A
{
	Player player;
...
void func_618(Player plParam0) // Position - 0x117B6
{
...
void func_619(int iParam0) // Position - 0x117F1
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
BOOL func_620(int iParam0) // Position - 0x11814
{
	return func_615(&(Global_1956875.f_1565), iParam0, 1);
}

int func_621(BOOL bParam0) // Position - 0x1182A
{
	if (bParam0)
		return 1;
...
float func_622(Player plParam0) // Position - 0x1183C
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_653(2);
}

int func_623(int iParam0) // Position - 0x11852
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_624(int iParam0) // Position - 0x11877
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_625(int iParam0) // Position - 0x1188A
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_626(int iParam0) // Position - 0x1189D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_627(int iParam0) // Position - 0x118B0
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_628(int iParam0) // Position - 0x118C2
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_629(int iParam0, int iParam1) // Position - 0x118D4
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_630(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1196E
{
...
BOOL func_631(int iParam0) // Position - 0x119A6
{
	int num;
	int num2;
	int num3;
...
int func_632(int iParam0) // Position - 0x11A82
{
	switch (iParam0)
	{
		case 0:
...
char* func_633(int iParam0) // Position - 0x11AB1
{
	switch (iParam0)
	{
		case 0:
...
char* func_634(int iParam0) // Position - 0x11AEC
{
	switch (iParam0)
	{
		case 0:
...
void func_635(int iParam0, float fParam1, int iParam2) // Position - 0x11B27
{
	if (iParam2 == 2)
		iParam2 = func_573(2);
...
void func_636(int iParam0, int iParam1, int iParam2) // Position - 0x11B79
{
	if (iParam2 == 2)
		iParam2 = func_573(2);
...
int func_637(int iParam0, int iParam1) // Position - 0x11BCF
{
	switch (iParam0)
	{
		case -2101912686:
...
// Unhandled jump detected. Output should be considered invalid
int func_638(int iParam0) // Position - 0x123D0
{
	int num;
	int num2;
	int num3;
...
BOOL func_639(int iParam0) // Position - 0x12660
{
	if (func_586(iParam0))
		return true;
...
void func_640(int iParam0, float fParam1, int iParam2) // Position - 0x12686
{
	if (fParam1 < 0f)
		return;
...
int func_641(Ped pedParam0, Hash hParam1) // Position - 0x126E2
{
	int num;
	int i;
...
int func_642(Hash hParam0, BOOL bParam1) // Position - 0x12740
{
	if (!bParam1 || func_674())
...
BOOL func_643(var uParam0, int iParam1) // Position - 0x1276F
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_644(int iParam0, int iParam1) // Position - 0x12780
{
...
Vector3 func_645(int iParam0, int iParam1) // Position - 0x127AF
{
	if (iParam1 == -1)
		iParam1 = Global_17418.f_55.f_664.f_1777;
...
BOOL func_651(int iParam0, int iParam1) // Position - 0x128C9
{
	return iParam0 && iParam1 != false;
}

void func_652(var uParam0) // Position - 0x128D8
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_653(int iParam0) // Position - 0x12934
{
	switch (iParam0)
	{
		case 0:
...
var func_654(BOOL bParam0, var uParam1, var uParam2) // Position - 0x12975
{
	if (bParam0)
		return uParam1;
...
void func_655(var uParam0, int iParam1) // Position - 0x1298C
{
	if (iParam1 < 0)
		return;
...
void func_656(var uParam0, int iParam1) // Position - 0x12A12
{
...
void func_657(var uParam0, int iParam1) // Position - 0x12A4E
{
	int num;
	int num2;
...
void func_658(var uParam0, int iParam1) // Position - 0x12AA1
{
...
void func_659(var uParam0, int iParam1) // Position - 0x12ADC
{
...
void func_660(var uParam0, int iParam1) // Position - 0x12B15
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_661(int iParam0) // Position - 0x12B4D
{
	int num;
...
BOOL func_662(int iParam0) // Position - 0x12B75
{
	int num;
...
int func_663(int iParam0, int iParam1) // Position - 0x12B9D
{
	switch (iParam0)
	{
...
int func_664(int iParam0, int iParam1) // Position - 0x13254
{
	Player player;
	Player player2;
	int num;

	player = func_675(iParam0);
	player2 = Global_1295666;
	num = func_667(iParam1, 1);
...
int func_665(int iParam0, int iParam1, int iParam2) // Position - 0x132D7
{
	int num;
	int num2;
...
void func_666(int iParam0) // Position - 0x133CF
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_667(int iParam0, int iParam1) // Position - 0x133E5
{
	switch (iParam0)
	{
...
BOOL func_671(int iParam0) // Position - 0x13D0F
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_672(Hash hParam0) // Position - 0x13D34
{
...
int func_673(int iParam0, Hash hParam1) // Position - 0x13D5F
{
	var guid;
	int inventoryItemCountWithGuid;
...
BOOL func_674() // Position - 0x13D9D
{
...
Player func_675(int iParam0) // Position - 0x13DEC
{
	if (func_688(iParam0))
...
BOOL func_676(int iParam0) // Position - 0x13E0D
{
	int num;
...
int func_677(int iParam0, int iParam1, int iParam2) // Position - 0x13E35
{
	int num;
	int num2;
	int num3;
...
BOOL func_678(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x14029
{
	return uParam0.f_4 != 0;
}

BOOL func_679(int iParam0, int iParam1) // Position - 0x14037
{
	int num;
...
Vector3 func_680(int iParam0) // Position - 0x14077
{
	int num;
	var unk;
...
BOOL func_681(int iParam0, var uParam1, var uParam2) // Position - 0x140B3
{
	if (!func_676(iParam0))
		return false;
...
BOOL func_682(int iParam0, int iParam1, int iParam2) // Position - 0x140EA
{
	int num;
	int num2;
	int num3;
...
void func_683(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x14318
{
	int num;
...
void func_684(int iParam0) // Position - 0x14397
{
	int num;
...
BOOL func_685(Hash hParam0, int iParam1) // Position - 0x143EC
{
	int num;
...
struct<4> func_686(int iParam0, Hash hParam1) // Position - 0x1440B
{
	var unk;
...
BOOL func_687(Vehicle veParam0) // Position - 0x1442D
{
...
BOOL func_688(int iParam0) // Position - 0x1444C
{
	int num;
...
int func_689(int iParam0) // Position - 0x14473
{
	int num;
...
int func_690(int iParam0, int iParam1) // Position - 0x1450D
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_691(int iParam0) // Position - 0x14946
{
	int num;
...
float func_692(int iParam0) // Position - 0x1496E
{
	float num;
...
void func_693(int iParam0) // Position - 0x1499E
{
	int num;
	int num2;
	int i;
...
BOOL func_694(int iParam0) // Position - 0x14B7D
{
	int num;
...
int func_695(int iParam0, int iParam1) // Position - 0x14BA5
{
	switch (iParam0)
	{
...
void func_696(int iParam0) // Position - 0x14EB5
{
	Ped ped;
	Player player;
...
BOOL func_697(int iParam0) // Position - 0x150C5
{
	int num;
...
int func_698(int iParam0, int iParam1) // Position - 0x150EC
{
	switch (iParam0)
	{
...
int func_699(int iParam0) // Position - 0x15149
{
	int num;
	var unk;
	var unk32;
...
BOOL func_700(int iParam0) // Position - 0x1528D
{
...
void func_701(int iParam0) // Position - 0x152AB
{
	int num;
	int num2;
	int i;
...
BOOL func_702(int iParam0) // Position - 0x15400
{
	BOOL flag;
...
void func_703(int iParam0) // Position - 0x1542A
{
	Ped EntityIndex;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_721(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_728(iParam0, 0));
			func_729(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_728(iParam0, 1));
			func_729(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_728(iParam0, 2));
			func_729(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_728(iParam0, 3));
			func_729(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_704(int iParam0) // Position - 0x156C5
{
	char* StringToTest;
	char* StringToTest2;
	...
	StringToTest = func_731(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	StringToTest2 = func_732(iParam0);
...
int func_705(Hash hParam0) // Position - 0x1570F
{
	int num;
...
struct<5> func_706(int iParam0) // Position - 0x15729
{
	var unk;
...
struct<4> func_707(int iParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6) // Position - 0x15756
{
	var outGuid;
...
BOOL func_708(int iParam0) // Position - 0x15783
{
	int num;
...
BOOL func_709(int iParam0) // Position - 0x157AB
{
	int num;
...
BOOL func_710(int iParam0) // Position - 0x157D3
{
	int num;
...
BOOL func_711(int iParam0) // Position - 0x157FB
{
	int num;
...
BOOL func_712(int iParam0) // Position - 0x15823
{
	int num;
...
BOOL func_713(int iParam0) // Position - 0x1584B
{
	int num;
...
float func_714(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x15873
{
	var unk;
	float num;
...
BOOL func_715(int iParam0) // Position - 0x158A9
{
...
BOOL func_716(int iParam0) // Position - 0x15918
{
	int num;
...
int func_717(int iParam0, int iParam1) // Position - 0x1593F
{
	switch (iParam0)
	{
...
void func_718() // Position - 0x1599C
{
	BOOL bTrue;
	BOOL bTrue2;
...
void func_719() // Position - 0x159FE
{
	BOOL bTrue;
...
char* func_720(int iParam0) // Position - 0x15A2E
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_721(int iParam0) // Position - 0x15A76
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_722(int iParam0) // Position - 0x15AB1
{
	int i;
...
void func_723() // Position - 0x15AF1
{
...
int func_724(int iParam0) // Position - 0x15B11
{
	int num;
...
BOOL func_725(int iParam0, int iParam1) // Position - 0x15B40
{
	int num;
	Player player;
	int num2;
	...
	{
		num3 = Global_1156111.f_35859.f_9286[func_698(num2, 1) /*3*/];
		unk = { func_726(num3) };
	...
	switch (Global_1156111.f_35859.f_3116[num /*31*/])
	{
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (player != Global_1295666 && !func_455(Global_1295666.f_149[player]))
				return false;
		
			if (!func_446(512, player))
				return false;
...
struct<31> func_726(int iParam0) // Position - 0x15E15
{
	int num;
...
BOOL func_727(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0x15E39
{
	var unk;
	BOOL flag;
...
char* func_728(int iParam0, int iParam1) // Position - 0x15E6F
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_729(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x15EC8
{
	int i;
...
void func_730() // Position - 0x15F4D
{
...
char* func_731(int iParam0) // Position - 0x15F72
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_732(int iParam0) // Position - 0x15F93
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_733(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x15FB4
{
	int num;
	int num2;
...
BOOL func_734() // Position - 0x161D6
{
	return Global_1572887.f_7;
}

BOOL func_735() // Position - 0x161E4
{
	if (!Global_1048577)
		return false;
...
int func_736(int iParam0) // Position - 0x1622F
{
	int num;
