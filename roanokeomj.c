...
void _DEBUG_PRINT(int iParam0) // Position - 0x834
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x840
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x84D
{
	return;
}

BOOL func_17(int iParam0) // Position - 0x855
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x862
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x86E
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x883
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x894
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x8D3
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x8DF
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x8E7
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0x997
{
	return;
}

void func_26() // Position - 0x99F
{
	return;
}

void func_27() // Position - 0x9A7
{
	return;
}

void func_28() // Position - 0x9AF
{
	return;
}

void func_29(int iParam0) // Position - 0x9B7
{
	if (func_45() != -1)
	{
...
void func_30(int iParam0) // Position - 0x9E5
{
	return;
}

void func_31() // Position - 0x9ED
{
	return;
}

void func_32() // Position - 0x9F5
{
	return;
}

void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x9FD
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xA09
{
...
void func_35(var uParam0) // Position - 0xA3A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA80
{
	return;
}

void func_37(int iParam0) // Position - 0xA88
{
	if (!func_60(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xAA1
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xAB2
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xACA
{
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xAD3
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xC12
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xC1F
{
...
BOOL func_44(int iParam0) // Position - 0xC55
{
	if (iParam0 == 0)
	{
		func_74();
...
int func_45() // Position - 0xD69
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xD77
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xD83
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xDF0
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xED0
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xEEE
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xF01
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF1F
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x1017
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x1028
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x103C
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x1050
{
	return uParam0;
}

void func_58(int iParam0, Volume volParam1, int iParam2, Volume volParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x105A
{
...
int func_59(int iParam0, BOOL bParam1) // Position - 0x1209
{
	int num;
	Hash hash;
	float num2;
...
BOOL func_60(int iParam0) // Position - 0x1330
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_61() // Position - 0x1346
{
	int i;
...
BOOL func_62(int iParam0, int iParam1) // Position - 0x1373
{
	return iParam0 && iParam1 != false;
}

BOOL func_63(var uParam0, int iParam1) // Position - 0x1382
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_64() // Position - 0x1393
{
	return func_62(Global_1940199, 8192);
}

BOOL func_65(var uParam0, int iParam1) // Position - 0x13A6
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_66(int iParam0) // Position - 0x13B7
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_67(int iParam0, int iParam1) // Position - 0x13F7
{
...
int func_68() // Position - 0x1424
{
	return Global_1896646.f_41;
}

void func_69(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1432
{
	BOOL flag;
	...
	StringToTest = func_109(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_121(&unk, joaat("COLOR_PURE_WHITE")), str3, func_121(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_121(&unk, joaat("COLOR_PURE_WHITE")), func_121(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_122(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_70(var uParam0, int iParam1) // Position - 0x1697
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_71(int iParam0, BOOL bParam1) // Position - 0x16AA
{
...
void func_72(BOOL bParam0) // Position - 0x1D13
{
	if (bParam0)
...
BOOL func_73(int iParam0) // Position - 0x1D3C
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_74() // Position - 0x1D81
{
	return;
}

Hash func_75(int iParam0, BOOL bParam1) // Position - 0x1D89
{
	switch (iParam0)
	{
		case 0:
...
void func_76(int iParam0, BOOL bParam1) // Position - 0x254E
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_77(BOOL bParam0) // Position - 0x25A1
{
	if (bParam0)
...
void func_78(int iParam0) // Position - 0x25CA
{
	return;
}

void func_79(int iParam0) // Position - 0x25D2
{
	int i;
...
void func_80(int iParam0) // Position - 0x2603
{
	int i;
...
BOOL func_81(int iParam0, BOOL bParam1) // Position - 0x2636
{
	int num;
	int num2;
	int num3;
...
BOOL func_82(int iParam0) // Position - 0x26EC
{
	int i;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x2766
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_84(int iParam0) // Position - 0x2797
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_85(int iParam0) // Position - 0x27B8
{
	if (!func_60(iParam0))
		return false;
...
BOOL func_86(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x280B
{
	BOOL flag;
...
BOOL func_87(int iParam0) // Position - 0x2ECB
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_88(int iParam0) // Position - 0x2EE2
{
	switch (iParam0)
	{
		case 64:
...
int func_89(int iParam0, BOOL bParam1) // Position - 0x2F25
{
	if (!func_87(iParam0))
		return 0;
...
BOOL func_91() // Position - 0x3024
{
	return func_140(func_56(0));
}

BOOL func_92(int iParam0) // Position - 0x3035
{
	return !func_141(iParam0);
}

void func_93(BOOL bParam0, BOOL bParam1) // Position - 0x3044
{
	if (func_142(255) == 4)
		return;
...
void func_94(int iParam0, BOOL bParam1) // Position - 0x318F
{
	BOOL flag;
...
int func_95(int iParam0, int iParam1) // Position - 0x353D
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_96(int iParam0) // Position - 0x3EA3
{
	if (!func_159(iParam0))
		return 0;
...
int func_97(int iParam0) // Position - 0x3EE4
{
	switch (iParam0)
	{
		case 3:
...
void func_98(int iParam0, int iParam1) // Position - 0x3F81
{
...
void func_99(int iParam0) // Position - 0x3FB0
{
...
BOOL func_100(int iParam0, int iParam1) // Position - 0x3FE9
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4003
{
...
int func_102() // Position - 0x402D
{
	return Global_1893611.f_2;
}

BOOL func_103(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x403B
{
	return func_161(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_104(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x405B
{
	return func_161(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_105(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x407B
{
	if (bParam6)
...
BOOL func_106(int iParam0) // Position - 0x40F7
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_107(int iParam0) // Position - 0x410D
{
...
const char* func_109(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x4185
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_166(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_168(func_167(Global_34));
...
BOOL func_110(int iParam0) // Position - 0x4BEB
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_111(int iParam0) // Position - 0x4C00
{
	switch (iParam0)
	{
		case 0:
...
int func_112(int iParam0) // Position - 0x4CBB
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_113(int iParam0) // Position - 0x4D29
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_114(int iParam0) // Position - 0x4E84
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_115(int iParam0, BOOL bParam1) // Position - 0x4EBF
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_116(int iParam0, int iParam1) // Position - 0x4F01
{
	if (!func_110(iParam0))
		return false;
...
int func_117() // Position - 0x4F46
{
	return Global_1902569;
}

int func_118(int iParam0) // Position - 0x4F52
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_119(int iParam0) // Position - 0x4F65
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_120(float fParam0) // Position - 0x4F77
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_121(var uParam0, int iParam1) // Position - 0x4F8D
{
...
int func_122(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4FC3
{
	int duration;
	var data;
	int num;
...
BOOL func_123(int iParam0) // Position - 0x5006
{
	if (func_169(iParam0))
		if (!func_170(44))
			return false;
...
void func_124(int iParam0, int iParam1) // Position - 0x5026
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_125(int iParam0, int iParam1) // Position - 0x5037
{
	int num;
...
void func_126(var uParam0, var uParam1, int iParam2) // Position - 0x504D
{
...
void func_127(int iParam0) // Position - 0x506A
{
...
void func_128(int iParam0) // Position - 0x514A
{
	int i;
	int num;
...
BOOL func_129(int iParam0, BOOL bParam1) // Position - 0x5322
{
	if (func_45() != -1)
		return false;
...
int func_130(int iParam0, BOOL bParam1) // Position - 0x5350
{
	if (!func_87(iParam0))
		return 0;
...
int func_131(int iParam0) // Position - 0x53D3
{
	switch (iParam0)
	{
		case 27:
...
int func_132(int iParam0) // Position - 0x53FA
{
	switch (iParam0)
	{
		case 33:
...
Hash func_135(int iParam0) // Position - 0x565D
{
	if (!func_87(iParam0))
		return 0;
...
void func_136(int iParam0, PersChar pchParam1) // Position - 0x567B
{
	if (!func_87(iParam0))
		return;
...
PersChar func_137(int iParam0) // Position - 0x569C
{
	if (!func_87(iParam0))
		return 0;
...
void func_138(int iParam0, BOOL bParam1) // Position - 0x56BC
{
	if (func_45() != -1)
		return;
...
BOOL func_139(int iParam0) // Position - 0x56F5
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_140(var uParam0, var uParam1) // Position - 0x571B
{
	return func_186(uParam0, 5, 8);
}

BOOL func_141(int iParam0) // Position - 0x572E
{
	return func_187(1, iParam0);
}

int func_142(int iParam0) // Position - 0x573D
{
	if (iParam0 == 255)
...
int func_143(int iParam0) // Position - 0x5788
{
...
void func_144(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x57A5
{
	func_189(iParam0);
...
int func_145(int iParam0) // Position - 0x5807
{
...
void func_146(var uParam0) // Position - 0x5824
{
	var unk;
...
void func_147(float* pfParam0) // Position - 0x5836
{
	var unk;
...
void func_149(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x589E
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_150(int iParam0) // Position - 0x58CB
{
...
BOOL func_151(int iParam0, int iParam1) // Position - 0x5928
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_152(int iParam0, int iParam1) // Position - 0x5941
{
	func_151(iParam0, iParam1);
...
int func_153(int iParam0) // Position - 0x597C
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_154(Hash hParam0) // Position - 0x5990
{
...
void func_155(int iParam0) // Position - 0x59B0
{
	return;
}

void func_156(int iParam0) // Position - 0x59B8
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_157(int iParam0, int iParam1) // Position - 0x59CD
{
	if (iParam0 == -1)
		return false;
...
void func_158(int iParam0) // Position - 0x59F4
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_159(int iParam0) // Position - 0x5A73
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_160(int iParam0) // Position - 0x5A89
{
	var unk;
...
BOOL func_161(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x5ABA
{
	int num;
...
int func_162(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5B42
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

BOOL func_163() // Position - 0x5B5C
{
	return false;
}

BOOL func_164() // Position - 0x5B65
{
	var unk;
	var unk3;
...
BOOL func_165(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5BCD
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_166(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5D43
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_167(var uParam0, var uParam1, var uParam2) // Position - 0x5D57
{
	int i;
...
const char* func_168(int iParam0) // Position - 0x5D85
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_169(int iParam0) // Position - 0x6069
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_170(int iParam0) // Position - 0x6093
{
	if (!func_207(iParam0))
		return false;
...
struct<2> func_171(Player plParam0) // Position - 0x60AF
{
	var gamerHandle;
...
const char* func_172(const char* sParam0, int iParam1) // Position - 0x60C3
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_173(int iParam0, BOOL bParam1) // Position - 0x60DD
{
	char* StringToTest;
...
void func_174(int iParam0, BOOL bParam1) // Position - 0x6111
{
	switch (iParam0)
	{
		case 5:
...
void func_175(int iParam0, int iParam1) // Position - 0x6146
{
	func_209(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_176(int iParam0) // Position - 0x6160
{
	if (!func_87(iParam0))
		return false;
...
void func_177(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6185
{
	PersChar persChar;
...
void func_178(int iParam0, BOOL bParam1) // Position - 0x6271
{
	if (!func_159(iParam0))
		return;
...
void func_179(int iParam0, int iParam1) // Position - 0x62C7
{
	if (!func_216(iParam0))
		return;
...
int func_180(int iParam0) // Position - 0x633A
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_181(int iParam0) // Position - 0x6350
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_182(int iParam0, BOOL bParam1) // Position - 0x6366
{
	if (func_45() != -1)
		return;
...
void func_183(int iParam0) // Position - 0x6397
{
	Ped EntityIndex;
...
void func_184(int iParam0) // Position - 0x63DB
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_185(int iParam0) // Position - 0x63F0
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_186(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x6405
{
	int num;
...
BOOL func_187(int iParam0, int iParam1) // Position - 0x6440
{
	int num;
...
BOOL func_188(Any* panParam0, int iParam1, int iParam2) // Position - 0x64B4
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_194(BOOL bParam0) // Position - 0x6583
{
	if (func_221(bParam0))
		return;
...
BOOL func_195(Any* panParam0, int iParam1, int iParam2) // Position - 0x65AA
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_196(Hash hParam0) // Position - 0x65DD
{
	if (func_222(hParam0))
...
BOOL func_197() // Position - 0x65F8
{
	return 1;
}

BOOL func_198(BOOL bParam0, BOOL bParam1) // Position - 0x6601
{
	return bParam0 && bParam1 != false;
}

int func_199(int iParam0) // Position - 0x6610
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_200(int iParam0, int iParam1, var uParam2) // Position - 0x6FF8
{
	var unk;
...
int func_201() // Position - 0x701F
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_202() // Position - 0x7034
{
	if (Global_1048576)
		return true;
...
struct<2> func_203() // Position - 0x708C
{
	return Global_1051268;
}

BOOL func_204(var uParam0, var uParam1) // Position - 0x709A
{
	if (!func_225(uParam0))
		return false;
...
struct<2> func_205() // Position - 0x70CE
{
...
BOOL func_206(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7119
{
	var unk;
	float num;
	float num2;
...
BOOL func_207(int iParam0) // Position - 0x7149
{
	if (iParam0 == 0)
		return false;
...
BOOL func_208(int iParam0) // Position - 0x715C
{
	int num;
	int num2;
	int offset;
...
void func_209(BOOL bParam0, int iParam1) // Position - 0x7186
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_210(int iParam0) // Position - 0x719B
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_211(Hash hParam0) // Position - 0x71BF
{
	return hParam0 != 0;
}

BOOL func_212(int iParam0, BOOL bParam1) // Position - 0x71CB
{
	if (!func_159(iParam0))
		return false;
...
void func_213(int iParam0, BOOL bParam1) // Position - 0x71F1
{
	if (!func_159(iParam0))
		return;
...
void func_214(int iParam0, BOOL bParam1) // Position - 0x721F
{
	if (!func_159(iParam0))
		return;
...
void func_215(int iParam0) // Position - 0x7259
{
	func_230(func_229(iParam0));
	return;
}

BOOL func_216(int iParam0) // Position - 0x726B
{
	return iParam0 > -1 && iParam0 < 40;
}

Ped func_217(int iParam0) // Position - 0x7281
{
	PersChar persChar;
...
int func_218(int iParam0, var uParam1) // Position - 0x72AF
{
	if (iParam0 == 2)
...
BOOL func_219(Any* panParam0, int iParam1, int iParam2) // Position - 0x72C9
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_220() // Position - 0x7300
{
	return Global_1102813.f_3672;
}

BOOL func_221(BOOL bParam0) // Position - 0x730F
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_222(Hash hParam0) // Position - 0x7325
{
	return hParam0 != 0;
}

BOOL func_223(int iParam0, int iParam1, Any* panParam2) // Position - 0x7331
{
...
void func_224(Any* panParam0, int iParam1, var uParam2) // Position - 0x7365
{
	var unk;
...
BOOL func_225(int iParam0) // Position - 0x73DF
{
	switch (iParam0)
	{
		case 2:
...
int func_226(int iParam0) // Position - 0x741E
{
	switch (iParam0)
	{
		case 2:
...
void func_227(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x74B4
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_228(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x7F51
{
	float num;
	float num2;
	float num3;
...
int func_229(int iParam0) // Position - 0x7FB7
{
...
void func_230(int iParam0) // Position - 0x8500
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_231(var uParam0, var uParam1) // Position - 0x8511
{
	var unk;
...
int func_232(int iParam0) // Position - 0x853D
{
	int num;
...
BOOL func_233(int iParam0, var uParam1, Any* panParam2) // Position - 0x86B2
{
	if (!func_204(iParam0))
		return false;
...
void func_234(Any* panParam0) // Position - 0x87BD
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
