...
int func_9(int iParam0) // Position - 0x5CE
{
	if (iParam0 < 0)
		return -1;
	else if (iParam0 <= 10)
...
BOOL func_10(int iParam0) // Position - 0x6CA
{
	return iParam0 > -1 && iParam0 < 17;
}

void func_11(int iParam0, BOOL bParam1) // Position - 0x6E0
{
	Global_1896646[iParam0 /*2*/] = Global_1896646[iParam0 /*2*/] || bParam1;
	return;
}

Hash func_12(int iParam0) // Position - 0x6FB
{
	Hash num;
...
void _DEBUG_PRINT(int iParam0) // Position - 0xD09
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0xD15
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0xD22
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0xD2E
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0xD3B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0xD47
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0xD5C
{
	return func_56(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0xD6D
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xDAC
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0xDB8
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0xDC0
{
	if (func_57(iParam0))
		return true;
...
void func_25() // Position - 0xE70
{
	return;
}

void func_26() // Position - 0xE78
{
	NETWORK::NETWORK_IS_IN_SESSION();
	return;
}

void func_27() // Position - 0xE87
{
	return;
}
...
void func_29(int iParam0) // Position - 0xE97
{
...
void func_30(int iParam0) // Position - 0x102D
{
	iParam0 = iParam0;
...
void func_31() // Position - 0x1090
{
	return;
}

void func_32() // Position - 0x1098
{
	return;
}

void func_33(int iParam0) // Position - 0x10A0
{
	func_69(1f, 0f, 0f, 0f);
...
void func_35(var uParam0) // Position - 0x110E
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0x1154
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0x1185
{
	if (!func_71(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0x11B2
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0x11C3
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0x11DB
{
	func_74();
...
void func_41(var uParam0, int iParam1) // Position - 0x1224
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0x1363
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0x1370
{
...
BOOL func_44(int iParam0) // Position - 0x13A6
{
	if (iParam0 == 0)
	{
		func_90();
...
int func_45() // Position - 0x14BA
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0x14C8
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0x14D4
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0x1541
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x1621
{
	if (!func_71(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x163F
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x1652
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

Vector3 func_53(int iParam0) // Position - 0x1670
{
	switch (iParam0)
	{
		case 5:
...
void func_54(int iParam0, Volume volParam1) // Position - 0x1713
{
	Global_1915656.f_3[iParam0 /*447*/].f_32 = volParam1;
	return;
}

void func_55() // Position - 0x172A
{
...
BOOL func_56(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1792
{
	int num;
	int num2;
	int num3;
...
BOOL func_57(int iParam0) // Position - 0x188A
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_58(int iParam0) // Position - 0x189B
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_59(int iParam0) // Position - 0x18AF
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_60(var uParam0, var uParam1) // Position - 0x18C3
{
	return uParam0;
}

void func_61(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x18CD
{
...
void func_62(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1A7C
{
	int num;
...
void func_63(int iParam0, int iParam1) // Position - 0x1B20
{
	func_119(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

int func_64(int iParam0, BOOL bParam1) // Position - 0x1B3A
{
	int num;
	Hash hash;
	float num2;
...
BOOL func_66() // Position - 0x1C75
{
	return func_126(func_59(0));
}

void func_67(int iParam0) // Position - 0x1C86
{
	int i;
...
BOOL func_68(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x1D7D
{
	PersChar persChar;
...
void func_69(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1DCB
{
...
void func_70(var uParam0, Volume volParam1, int iParam2) // Position - 0x1DF3
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_71(int iParam0) // Position - 0x1E4C
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_72() // Position - 0x1E62
{
	int i;
...
void func_73(int iParam0, Hash hParam1) // Position - 0x1E8F
{
	if (!func_131(iParam0))
		return;
...
BOOL func_75(var uParam0) // Position - 0x1ED6
{
	if (func_135())
	{
		if (!*uParam0)
...
void func_76(Hash hParam0, int iParam1) // Position - 0x1F06
{
	func_77(hParam0, true, 0, false, false, 0, false, false);
	return;
}

void func_77(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x1F1B
{
...
BOOL func_78(int iParam0, int iParam1) // Position - 0x1FA6
{
	return iParam0 && iParam1 != false;
}

BOOL func_79(var uParam0, int iParam1) // Position - 0x1FB5
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_80() // Position - 0x1FC6
{
	return func_78(Global_1940199, 8192);
}

BOOL func_81(var uParam0, int iParam1) // Position - 0x1FD9
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_82(int iParam0) // Position - 0x1FEA
{
	if (!func_71(iParam0))
		return false;
...
BOOL func_83(int iParam0, int iParam1) // Position - 0x202A
{
...
int func_84() // Position - 0x2057
{
	return Global_1896646.f_41;
}

void func_85(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x2065
{
	BOOL flag;
	...
	StringToTest = func_143(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_155(&unk, joaat("COLOR_PURE_WHITE")), str3, func_155(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_155(&unk, joaat("COLOR_PURE_WHITE")), func_155(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_156(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_86(var uParam0, int iParam1) // Position - 0x22D6
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_87(int iParam0, BOOL bParam1) // Position - 0x22E9
{
...
void func_88(BOOL bParam0) // Position - 0x2952
{
	if (bParam0)
...
BOOL func_89(int iParam0) // Position - 0x297B
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_90() // Position - 0x29C0
{
	return;
}

Hash func_91(int iParam0, BOOL bParam1) // Position - 0x29C8
{
	switch (iParam0)
	{
		case 0:
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x318D
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_93(BOOL bParam0) // Position - 0x31E0
{
	if (bParam0)
...
void func_94(int iParam0) // Position - 0x3209
{
	...
	ENTITY::REMOVE_MODEL_HIDE(uLocal_46, 5f, joaat("str_01_pronghornsign"), false);
	iParam0 = iParam0;
	return;
}

void func_95(int iParam0) // Position - 0x324E
{
	int i;
...
void func_96(int iParam0) // Position - 0x327F
{
	int i;
...
BOOL func_97(int iParam0, BOOL bParam1) // Position - 0x32B2
{
	int num;
	int num2;
	int num3;
...
BOOL func_98(int iParam0) // Position - 0x3368
{
	int i;
...
BOOL func_99(int iParam0, BOOL bParam1) // Position - 0x33E2
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_100(int iParam0) // Position - 0x3413
{
	if (!func_71(iParam0))
		return false;
...
BOOL func_101(int iParam0) // Position - 0x3434
{
	if (!func_71(iParam0))
		return false;
...
BOOL func_102(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3487
{
	BOOL flag;
...
BOOL func_103(int iParam0) // Position - 0x3B47
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_104(int iParam0) // Position - 0x3B5E
{
	switch (iParam0)
	{
		case 64:
...
int func_105(int iParam0, BOOL bParam1) // Position - 0x3BA1
{
	if (!func_103(iParam0))
		return 0;
...
BOOL func_106() // Position - 0x3C8C
{
	return func_173(func_59(0));
}

BOOL func_107(int iParam0) // Position - 0x3C9D
{
	return !func_174(iParam0);
}

void func_108(BOOL bParam0, BOOL bParam1) // Position - 0x3CAC
{
	if (func_175(255) == 4)
		return;
...
void func_109(int iParam0, BOOL bParam1) // Position - 0x3DF7
{
	BOOL flag;
...
int func_110(Hash hParam0, int iParam1) // Position - 0x41A8
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_111(int iParam0) // Position - 0x4B0E
{
	if (!func_191(iParam0))
		return 0;
...
int func_112(int iParam0) // Position - 0x4B4F
{
	switch (iParam0)
	{
		case 3:
...
void func_113(int iParam0, int iParam1) // Position - 0x4BEC
{
...
void func_114(int iParam0) // Position - 0x4C1B
{
...
int func_115(int iParam0) // Position - 0x4C54
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

Hash func_116(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4C68
{
...
BOOL func_117(Hash hParam0) // Position - 0x4D0C
{
	if (func_193(hParam0))
...
BOOL func_118(Hash hParam0) // Position - 0x4D27
{
	func_116(hParam0, false, false);
...
void func_119(BOOL bParam0, int iParam1) // Position - 0x4D50
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

BOOL func_120(int iParam0, BOOL bParam1) // Position - 0x4D61
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4D7A
{
...
Hash func_122() // Position - 0x4DA4
{
	return Global_1893611.f_2;
}

BOOL func_123(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4DB2
{
	return func_194(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_124(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4DD2
{
	return func_194(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_125(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x4DF2
{
	if (bParam6)
...
BOOL func_126(var uParam0, var uParam1) // Position - 0x4E6E
{
	return func_196(uParam0, 9, 12);
}

int func_127(int iParam0) // Position - 0x4E81
{
	Hash hash;
	float num;
	var unk;
...
BOOL func_128(int iParam0, BOOL bParam1) // Position - 0x4F80
{
	if (func_45() != -1)
		return false;
...
PersChar func_129(int iParam0) // Position - 0x4FD8
{
	if (!func_103(iParam0))
		return 0;
...
BOOL func_130(int iParam0) // Position - 0x4FF8
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_131(int iParam0) // Position - 0x500E
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_132(int iParam0) // Position - 0x5024
{
	return iParam0 != 0;
}

BOOL func_133(int iParam0) // Position - 0x5030
{
	return false;
}

void func_134(Hash hParam0) // Position - 0x5039
{
	if (!func_199(1, 1))
		return;
...
void func_136(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x50EE
{
	if (func_117(hParam0))
	{
...
void func_137(Hash hParam0, BOOL bParam1) // Position - 0x5126
{
	if (func_117(hParam0))
...
void func_138(Hash hParam0, BOOL bParam1) // Position - 0x5154
{
	if (func_117(hParam0))
...
void func_139(Hash hParam0, BOOL bParam1) // Position - 0x5182
{
	if (func_117(hParam0))
...
BOOL func_140() // Position - 0x51B0
{
	return true;
}

BOOL func_141(int iParam0) // Position - 0x51B9
{
...
const char* func_143(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x5231
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_206(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_208(func_207(Global_34));
...
BOOL func_144(int iParam0) // Position - 0x5C99
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_145(int iParam0) // Position - 0x5CAE
{
	switch (iParam0)
	{
		case 0:
...
Hash func_146(int iParam0) // Position - 0x5D69
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_147(int iParam0) // Position - 0x5DD7
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_148(int iParam0) // Position - 0x5F32
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_149(int iParam0, BOOL bParam1) // Position - 0x5F6D
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x5FAF
{
	if (!func_144(iParam0))
		return false;
...
int func_151() // Position - 0x5FF4
{
	return Global_1902569;
}

int func_152(int iParam0) // Position - 0x6000
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_153(int iParam0) // Position - 0x6013
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_154(float fParam0) // Position - 0x6025
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_155(var uParam0, int iParam1) // Position - 0x603B
{
...
int func_156(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x6071
{
	int duration;
	var data;
	int num;
...
BOOL func_157(int iParam0) // Position - 0x60B4
{
	if (func_209(iParam0))
		if (!func_210(44))
			return false;
...
void func_158(int iParam0, int iParam1) // Position - 0x60D4
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_159(int iParam0, int iParam1) // Position - 0x60E5
{
	int num;
...
void func_160(var uParam0, var uParam1, int iParam2) // Position - 0x60FB
{
...
void func_161(int iParam0) // Position - 0x6118
{
...
void func_162(int iParam0) // Position - 0x61F8
{
	int i;
	int num;
...
BOOL func_163(int iParam0, BOOL bParam1) // Position - 0x63D0
{
	if (func_45() != -1)
		return false;
...
int func_164(int iParam0, BOOL bParam1) // Position - 0x63FE
{
	if (!func_103(iParam0))
		return 0;
...
int func_165(int iParam0) // Position - 0x6481
{
	switch (iParam0)
	{
		case 27:
...
int func_166(int iParam0) // Position - 0x64A8
{
	switch (iParam0)
	{
		case 33:
...
Hash func_169(int iParam0) // Position - 0x670B
{
	if (!func_103(iParam0))
		return 0;
...
void func_170(int iParam0, PersChar pchParam1) // Position - 0x6729
{
	if (!func_103(iParam0))
		return;
...
void func_171(int iParam0, BOOL bParam1) // Position - 0x674A
{
	if (func_45() != -1)
		return;
...
BOOL func_172(int iParam0) // Position - 0x6783
{
	if (!func_103(iParam0))
		return false;
...
BOOL func_173(var uParam0, var uParam1) // Position - 0x67A9
{
	return func_196(uParam0, 5, 8);
}

BOOL func_174(int iParam0) // Position - 0x67BC
{
	return func_226(1, iParam0);
}

int func_175(int iParam0) // Position - 0x67CB
{
	if (iParam0 == 255)
...
int func_176(int iParam0) // Position - 0x6816
{
...
void func_177(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x6833
{
	func_228(iParam0);
...
int func_178(int iParam0) // Position - 0x6895
{
...
void func_179(var uParam0) // Position - 0x68B2
{
	var unk;
...
void func_180(float* pfParam0) // Position - 0x68C4
{
	var unk;
...
void func_182(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x692C
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_183(int iParam0) // Position - 0x6959
{
...
BOOL func_184(int iParam0, int iParam1) // Position - 0x69B6
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_185(int iParam0, int iParam1) // Position - 0x69CF
{
	func_184(iParam0, iParam1);
...
void func_186(Hash hParam0) // Position - 0x6A0A
{
...
void func_187(int iParam0) // Position - 0x6A2A
{
	return;
}

void func_188(int iParam0) // Position - 0x6A32
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_189(int iParam0, int iParam1) // Position - 0x6A47
{
	if (iParam0 == -1)
		return false;
...
void func_190(int iParam0) // Position - 0x6A6E
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_191(int iParam0) // Position - 0x6AED
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_192(int iParam0) // Position - 0x6B03
{
	var unk;
...
BOOL func_193(Hash hParam0) // Position - 0x6B34
{
	return hParam0 != 0;
}

BOOL func_194(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x6B40
{
	int num;
...
int func_195(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x6BC8
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

BOOL func_196(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x6BE2
{
	int num;
...
BOOL func_197(int iParam0, int* piParam1, int* piParam2) // Position - 0x6C1D
{
	int num;
...
Ped func_198(int iParam0) // Position - 0x6C8D
{
	PersChar persChar;
...
BOOL func_199(int iParam0, int iParam1) // Position - 0x6CBB
{
	return false;
}

int func_200(int iParam0) // Position - 0x6CC4
{
	int num;
...
BOOL func_201(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6D16
{
	if (Global_1572887.f_14 != -1)
	{
...
float func_202(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x6E8C
{
...
void func_203(int iParam0, Hash hParam1) // Position - 0x6EB4
{
	return;
}

BOOL func_204() // Position - 0x6EBC
{
	return false;
}

BOOL func_205() // Position - 0x6EC5
{
	var unk;
	var unk3;
...
const char* func_206(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6F2D
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_207(var uParam0, var uParam1, var uParam2) // Position - 0x6F41
{
	int i;
...
const char* func_208(int iParam0) // Position - 0x6F6F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_209(int iParam0) // Position - 0x7253
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_210(int iParam0) // Position - 0x727D
{
	if (!func_246(iParam0))
		return false;
...
struct<2> func_211(Player plParam0) // Position - 0x7299
{
	var gamerHandle;
...
const char* func_212(const char* sParam0, int iParam1) // Position - 0x72AD
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_213(int iParam0, BOOL bParam1) // Position - 0x72C7
{
	char* StringToTest;
...
void func_214(int iParam0, BOOL bParam1) // Position - 0x72FB
{
	switch (iParam0)
	{
		case 5:
...
void func_215(int iParam0, int iParam1) // Position - 0x7330
{
	func_248(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_216(int iParam0) // Position - 0x734A
{
	if (!func_103(iParam0))
		return false;
...
void func_217(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x736F
{
	PersChar persChar;
...
void func_218(int iParam0, BOOL bParam1) // Position - 0x745B
{
	if (!func_191(iParam0))
		return;
...
void func_219(int iParam0, int iParam1) // Position - 0x74B1
{
	if (!func_255(iParam0))
		return;
...
int func_220(int iParam0) // Position - 0x7524
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_221(int iParam0) // Position - 0x753A
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_222(int iParam0, BOOL bParam1) // Position - 0x7550
{
	if (func_45() != -1)
		return;
...
void func_223(int iParam0) // Position - 0x7581
{
	Ped EntityIndex;
...
void func_224(int iParam0) // Position - 0x75C5
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_225(int iParam0) // Position - 0x75DA
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_226(int iParam0, int iParam1) // Position - 0x75EF
{
	int num;
...
BOOL func_227(int* piParam0, int iParam1, int iParam2) // Position - 0x7663
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_233(BOOL bParam0) // Position - 0x7732
{
	if (func_258(bParam0))
		return;
...
BOOL func_234(int* piParam0, int iParam1, int iParam2) // Position - 0x7759
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_235() // Position - 0x778C
{
	return 1;
}

BOOL func_236(BOOL bParam0, BOOL bParam1) // Position - 0x7795
{
	return bParam0 && bParam1 != false;
}

int func_237(int iParam0) // Position - 0x77A4
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_238(int iParam0, int iParam1, var uParam2) // Position - 0x818C
{
	var unk;
...
int func_239() // Position - 0x81B3
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_240(var uParam0, var uParam1) // Position - 0x81C8
{
	if (!func_261(uParam0))
		return false;
...
int func_241(int iParam0, var uParam1) // Position - 0x81FC
{
	if (iParam0 == 2)
...
struct<2> func_243() // Position - 0x826E
{
	return Global_1051268;
}

struct<2> func_244() // Position - 0x827C
{
...
BOOL func_245(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x82C7
{
	var unk;
	float num;
	float num2;
...
BOOL func_246(int iParam0) // Position - 0x82F7
{
	if (iParam0 == 0)
		return false;
...
BOOL func_247(int iParam0) // Position - 0x830A
{
	int num;
	int num2;
	int offset;
...
void func_248(BOOL bParam0, int iParam1) // Position - 0x8334
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_249(int iParam0) // Position - 0x8349
{
	if (!func_103(iParam0))
		return false;
...
BOOL func_250(Hash hParam0) // Position - 0x836D
{
	return hParam0 != 0;
}

BOOL func_251(int iParam0, BOOL bParam1) // Position - 0x8379
{
	if (!func_191(iParam0))
		return false;
...
void func_252(int iParam0, BOOL bParam1) // Position - 0x839F
{
	if (!func_191(iParam0))
		return;
...
void func_253(int iParam0, BOOL bParam1) // Position - 0x83CD
{
	if (!func_191(iParam0))
		return;
...
void func_254(int iParam0) // Position - 0x8407
{
	func_267(func_266(iParam0));
	return;
}

BOOL func_255(int iParam0) // Position - 0x8419
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_256(int* piParam0, int iParam1, int iParam2) // Position - 0x842F
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_257() // Position - 0x8466
{
	return Global_1102813.f_3672;
}

BOOL func_258(BOOL bParam0) // Position - 0x8475
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_259(int iParam0, int iParam1, Any* panParam2) // Position - 0x848B
{
...
void func_260(Any* panParam0, int iParam1, var uParam2) // Position - 0x84BF
{
	var unk;
...
BOOL func_261(int iParam0) // Position - 0x8539
{
	switch (iParam0)
	{
		case 2:
...
int func_262(int iParam0) // Position - 0x8578
{
	switch (iParam0)
	{
		case 2:
...
int func_263(var uParam0, var uParam1) // Position - 0x860E
{
	var unk;
...
void func_264(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x863A
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_265(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x90D7
{
	float num;
	float num2;
	float num3;
...
int func_266(int iParam0) // Position - 0x913D
{
...
void func_267(int iParam0) // Position - 0x965A
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_268(int iParam0) // Position - 0x966B
{
	int num;
...
BOOL func_269(int iParam0, var uParam1, Any* panParam2) // Position - 0x97E0
{
	if (!func_240(iParam0))
		return false;
...
void func_270(Any* panParam0) // Position - 0x98EB
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
