...
int func_4() // Position - 0x27C
{
	return Global_1572887.f_14;
}

BOOL func_5(BOOL bParam0, BOOL bParam1) // Position - 0x28A
{
	int i;
...
void func_7() // Position - 0x4D2
{
	return;
}

void func_8() // Position - 0x4DA
{
...
void func_9(Volume volParam0) // Position - 0x4EC
{
...
void func_10(Volume volParam0) // Position - 0x52D
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
BOOL func_11() // Position - 0x574
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_12() // Position - 0x585
{
	return DLC::IS_DLC_PRESENT(joaat("dlc_ultimateedition"));
}

BOOL func_13(int iParam0) // Position - 0x596
{
	int num;
	int num2;
	int offset;
...
void func_14(int iParam0) // Position - 0x615
{
	int num;
	int num2;
	int BitIndex;
...
int func_17(int iParam0, int iParam1) // Position - 0x860
{
	switch (iParam0)
	{
...
BOOL func_18(int iParam0) // Position - 0x2105
{
	int num;
...
BOOL func_19(int iParam0) // Position - 0x2122
{
...
void func_20(Hash hParam0) // Position - 0x2139
{
...
int func_21(int iParam0) // Position - 0x2151
{
	return func_23(iParam0) + 30;
}

int func_22(Hash hParam0) // Position - 0x2161
{
	if (!STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		return 1;
...
int func_23(int iParam0) // Position - 0x2189
{
	return iParam0 * 31;
}

BOOL func_24() // Position - 0x2195
{
	return func_25() == 4;
}

int func_25() // Position - 0x21A3
{
	if (Global_1102813 <= 5)
