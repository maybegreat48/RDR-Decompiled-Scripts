...
void func_1() // Position - 0x82
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_2() // Position - 0x8E
{
	func_7(32, -1);
	func_8();
...
BOOL func_3(BOOL bParam0, BOOL bParam1) // Position - 0xE8
{
	int i;
...
BOOL func_4(int iParam0) // Position - 0x1C8
{
	return Global_1572864.f_3 && iParam0 != false;
}

void func_5() // Position - 0x1DB
{
	int* p_num;
...
void func_7(int iParam0, int iParam1) // Position - 0x2F7
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_10();
...
void func_10() // Position - 0x453
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_11(int* piParam0) // Position - 0x45F
{
	var unk;
	int i;
...
int func_12(int iParam0, int iParam1, char* sParam2) // Position - 0x49A
{
	return 1;
}

void func_13(BOOL bParam0) // Position - 0x4A3
{
	int num;
	var unk;
	int num2;
...
void func_14(var uParam0, int iParam1) // Position - 0x56C
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_15() // Position - 0x57D
{
	if (!NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		return;
...
void func_16(var uParam0) // Position - 0x5D4
{
	int num;
...
BOOL func_17(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6B3
{
...
void func_18(Hash hParam0, BOOL bParam1) // Position - 0x829
{
	int num;
	int num2;
	int num3;
...
int func_19() // Position - 0x920
{
	return Global_1572887.f_14;
}

BOOL func_20() // Position - 0x92E
{
	return Global_1051645.f_8;
}

BOOL func_21(int* piParam0) // Position - 0x93C
{
	int i;
	Player Plr;
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(Plr) || !NETWORK::NETWORK_IS_PLAYER_CONNECTED(Plr) || !NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr))
		{
		}
...
int func_23(int* piParam0) // Position - 0x9DE
{
	Vector3 vector;
	float radius;
	var args;
...
int func_24(int* piParam0) // Position - 0xB5B
{
	var args;
	int volLockRequestId;
...
int func_26() // Position - 0xC9A
{
	return Global_1878407.f_6;
}

void func_27(int iParam0) // Position - 0xCA8
{
	Global_1878407.f_6 = iParam0;
	return;
}

void func_28() // Position - 0xCB8
{
	int i;
	int j;
...
struct<2> func_30(int iParam0) // Position - 0xDE6
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_31(var uParam0, var uParam1) // Position - 0xDFA
{
	if (!func_57(uParam0))
		return 0;
...
int func_32(var uParam0, var uParam1) // Position - 0xE2E
{
	return uParam0;
}

Hash func_33(Hash hParam0, int iParam1) // Position - 0xE38
{
	Hash hash;
	int num;
	Hash hash2;
...
BOOL func_34(int iParam0) // Position - 0x11B6
{
	int* p_num;
...
BOOL func_35() // Position - 0x11D0
{
	return func_31(Global_1051268);
}

BOOL func_36(Hash hParam0) // Position - 0x11E2
{
	return hParam0 > -1 && hParam0 <= 80;
}

BOOL func_37(int iParam0) // Position - 0x11F8
{
	switch (iParam0)
	{
		case 13:
...
Vector3 func_38(int* piParam0) // Position - 0x125B
{
	switch (piParam0)
	{
		case 13:
...
float func_39(int* piParam0) // Position - 0x12CC
{
	switch (piParam0)
	{
		case 13:
...
int func_40(int* piParam0) // Position - 0x1393
{
	if (!func_36(piParam0))
		return 4;
...
BOOL func_41(Any* panParam0, int* piParam1) // Position - 0x13B5
{
	var SourceStruct;
...
void func_43(int* piParam0, int iParam1) // Position - 0x1454
{
	if (!NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		return;
...
void func_44(int* piParam0, int iParam1) // Position - 0x1496
{
	if (!NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		return;
...
int func_45(int* piParam0) // Position - 0x14D8
{
	if (!func_36(piParam0))
		return -1;
...
void func_46(int* piParam0, int iParam1) // Position - 0x14FA
{
	if (!NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		return;
...
int func_47(int iParam0) // Position - 0x1538
{
	if (!func_36(iParam0))
		return -1;
...
void func_48(int iParam0, BOOL bParam1) // Position - 0x1558
{
	int num;
...
void func_49(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, int iParam6) // Position - 0x1600
{
	var StringToTest;
...
void func_50(int iParam0) // Position - 0x16FE
{
	var StringToTest;

	TEXT_LABEL_COPY(&StringToTest, { Global_1835011[iParam0 /*72*/].f_4 }, 3);

	if (func_19() != -1 && !MISC::IS_STRING_NULL_OR_EMPTY(&StringToTest) && SCRIPTS::IS_THREAD_ACTIVE(Global_1835011[iParam0 /*72*/].f_8, false))
		SCRIPTS::_REQUEST_THREAD_EXIT(Global_1835011[iParam0 /*72*/].f_8);

	return;
}

void func_51(int iParam0) // Position - 0x174E
{
	Player playerIndex;
...
BOOL func_52(Hash hParam0) // Position - 0x17A5
{
...
BOOL func_53(int iParam0) // Position - 0x17C4
{
	switch (iParam0)
	{
		case 1:
...
void func_54(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x182F
{
...
BOOL func_55(int iParam0) // Position - 0x188A
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_57(int iParam0) // Position - 0x19CC
{
	switch (iParam0)
	{
		case 2:
...
int func_58(int iParam0) // Position - 0x1A0B
{
	switch (iParam0)
	{
		case 2:
...
Hash func_59(Hash hParam0) // Position - 0x1AA1
{
	Hash hash;
...
Hash func_60(Hash hParam0) // Position - 0x1B2D
{
	Hash hash;
...
Hash func_61(Hash hParam0) // Position - 0x1BBA
{
	int num;
...
Hash func_62(Hash hParam0) // Position - 0x1BE7
{
	Hash hash;
	Hash hash2;
	int num;
	...
	num = Global_1878407.f_7185.f_1[hash /*4*/].f_1;
	num2 = Global_1878407.f_7134[hash /*2*/];
	num3 = Global_1878407.f_7134[hash /*2*/].f_1;
	...
	while (num4 <= num3)
	{
		if (Global_1878407.f_1823[num4 /*3*/] == 531432813)
		{
			...
			hash3 = Global_1878407.f_123[num5 /*4*/];
		
			if (hash3 == hash2)
			{
				Global_1878407.f_7185.f_1[hash /*4*/].f_1 = num4;
				return -2;
			}
		}
...
Hash func_63(Hash hParam0) // Position - 0x1D18
{
	Hash hash;
	int num;
...
Hash func_64(Hash hParam0) // Position - 0x1D70
{
	Hash hash;
	Hash hash2;
...
Hash func_65(Hash hParam0) // Position - 0x1DC0
{
	int num;
	int num2;
	int num3;
...
Hash func_66(Hash hParam0) // Position - 0x1E40
{
	int num;
	int num2;
	int num3;
...
Hash func_67(Hash hParam0) // Position - 0x1EA8
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
Hash func_68(Hash hParam0) // Position - 0x1F1B
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
Hash func_69(Hash hParam0) // Position - 0x1FA6
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
Hash func_70(Hash hParam0) // Position - 0x201B
{
	int num;
...
Hash func_71(Hash hParam0) // Position - 0x205B
{
	int num;
...
Hash func_72(Hash hParam0) // Position - 0x2094
{
	int address;
	int num;
...
Hash func_73(Hash hParam0, Hash hParam1) // Position - 0x217A
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
Hash func_74(Hash hParam0, Hash hParam1) // Position - 0x22A9
{
	if (!func_134())
		return -2;
...
Hash func_75(Hash hParam0, int iParam1) // Position - 0x231B
{
	int num;
	int num2;
...
Hash func_76(Hash hParam0, int iParam1) // Position - 0x23D8
{
	int num;
...
Hash func_77(Hash hParam0) // Position - 0x2430
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
Hash func_78(Hash hParam0, int iParam1) // Position - 0x2497
{
	int num;
	int num2;
...
Hash func_79(Hash hParam0, Hash hParam1) // Position - 0x2502
{
	Hash hash;
...
Hash func_80(Hash hParam0, Hash hParam1) // Position - 0x258D
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
Hash func_81(Hash hParam0) // Position - 0x2641
{
	func_151(hParam0);
	return -2;
}

Hash func_82(Hash hParam0) // Position - 0x2652
{
	Hash hash;
...
Hash func_84() // Position - 0x26AA
{
	NETWORK::NETWORK_SET_COMPLETED_MP_INTRO_FLOW_ON_CURRENT_SLOT(true);
	return -2;
}

Hash func_85(Hash hParam0) // Position - 0x26BB
{
	Hash hash;
	Hash hash2;
	Hash hash3;
...
Hash func_86(Hash hParam0) // Position - 0x279A
{
	Hash hash;
	Hash unlockHash;
...
Hash func_87(Hash hParam0) // Position - 0x27E0
{
	Hash hash;
	int num;
...
Hash func_88(Hash hParam0) // Position - 0x282C
{
	Hash hash;
...
Hash func_89(Hash hParam0) // Position - 0x285D
{
	int num;
...
Hash func_90(Hash hParam0) // Position - 0x28C5
{
	Hash hash;
...
Hash func_91(Hash hParam0) // Position - 0x28F6
{
	int num;
	BOOL flag;
	int i;
...
Hash func_92(Hash hParam0) // Position - 0x2B12
{
	Hash hash;
	Hash hash2;
	BOOL flag;
...
Hash func_93(Hash hParam0) // Position - 0x2B80
{
	Hash unlockHash;
...
Hash func_95(int iParam0) // Position - 0x2CAB
{
	int flagIndex;
	int num;
...
Hash func_96(int iParam0) // Position - 0x2CDD
{
	int flagIndex;
	int num;
...
Hash func_99(Hash hParam0) // Position - 0x2D83
{
	Hash hash;
...
void func_100(int iParam0, Hash hParam1) // Position - 0x2DA9
{
	int num;
	int num2;
	int num3;
...
Vector3 func_101() // Position - 0x2EF8
{
	return 0f, 0f, 0f;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2F03
{
...
int func_103(int iParam0) // Position - 0x2F2D
{
	switch (iParam0)
	{
		case 13:
...
int func_104() // Position - 0x2F91
{
	return -1360426452;
}

int func_105() // Position - 0x2F9E
{
	return Global_1110244.f_21.f_13.f_1;
}

struct<2> func_106() // Position - 0x2FB0
{
...
int func_107(var uParam0, var uParam1) // Position - 0x2FFB
{
	int i;
...
BOOL func_108(int iParam0) // Position - 0x3044
{
...
BOOL func_109(int iParam0, int iParam1) // Position - 0x3063
{
	return func_108(iParam0) && Global_1900562[iParam0 /*2*/].f_1 && iParam1 != false;
}

int func_110(int iParam0, int iParam1) // Position - 0x3085
{
	switch (iParam1)
	{
		case 0:
...
int func_111(Hash hParam0, int iParam1) // Position - 0x36F5
{
	int num;
...
void func_112(var uParam0, var uParam1, BOOL bParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x3759
{
	int num;
...
void func_113(int iParam0) // Position - 0x38C0
{
...
struct<2> func_114(int iParam0) // Position - 0x3917
{
	if (!func_36(iParam0))
		return func_189();
...
int func_115(int iParam0, int iParam1, int iParam2) // Position - 0x393C
{
	int num;
	BOOL flag;
	BOOL flag2;
...
void func_116(var uParam0, var uParam1) // Position - 0x3BAC
{
	int num;
	int num2;
	var unk;
...
void func_117(int iParam0, int iParam1) // Position - 0x3C8A
{
	if (!func_108(iParam0))
		return;
...
BOOL func_118(int iParam0, Player plParam1) // Position - 0x3CC1
{
	if (!func_34(iParam0))
		return false;
...
int func_119(int iParam0, Player plParam1) // Position - 0x3D05
{
...
Hash func_120(int iParam0, Hash hParam1) // Position - 0x3D42
{
	switch (hParam1)
	{
		case 1:
...
Hash func_121(Hash hParam0) // Position - 0x3FE4
{
	switch (hParam0)
	{
		case 1:
...
void func_122(Hash hParam0, BOOL bParam1) // Position - 0x4088
{
...
void func_123(Hash hParam0, Hash hParam1) // Position - 0x40CC
{
	if (hParam0 == 1 || hParam0 == -1)
		return;
...
void func_124(int iParam0, int iParam1, BOOL bParam2) // Position - 0x4110
{
	BOOL isBitSet;
...
BOOL func_125(int iParam0) // Position - 0x4194
{
	if (iParam0 == 1 || iParam0 == -1)
		return false;
...
Hash func_126(Hash hParam0) // Position - 0x41C0
{
	if (hParam0 == 1 || hParam0 == -1)
		return 0;
...
BOOL func_127(Hash hParam0, Hash hParam1) // Position - 0x41EC
{
	BOOL isBitSet;
...
int func_128(int iParam0) // Position - 0x4238
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_129(int iParam0) // Position - 0x424B
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_130(int iParam0) // Position - 0x425D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_131(int iParam0) // Position - 0x426F
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_132(int iParam0) // Position - 0x4282
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_133(int iParam0) // Position - 0x4295
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

BOOL func_134() // Position - 0x42BA
{
	return true;
}

BOOL func_135(int iParam0) // Position - 0x42D9
{
	int num;
	int num2;
	int num3;
...
int func_136() // Position - 0x43B5
{
	return Global_1902569;
}

void func_137(int iParam0, Hash hParam1, Hash hParam2, Hash hParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x43C1
{
	int num;
	int i;
	int num2;
...
BOOL func_138(int iParam0, int iParam1, BOOL bParam2) // Position - 0x4549
{
	if (bParam2)
...
void func_139(var uParam0, int iParam1) // Position - 0x4576
{
...
void func_140(var uParam0, int iParam1) // Position - 0x45AE
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_141(var uParam0, int iParam1) // Position - 0x45E7
{
	if (iParam1 < 0 || iParam1 > 23)
		return;
...
BOOL func_142(int iParam0, BOOL bParam1) // Position - 0x4622
{
	return func_138(func_136(), iParam0, bParam1);
}

int func_143(int iParam0) // Position - 0x4636
{
	switch (iParam0)
	{
		case 13:
...
BOOL func_144(Hash hParam0) // Position - 0x4699
{
	int num;
...
void func_145(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x46D0
{
	if (iParam0 == 0)
		return;
...
BOOL func_147(Hash hParam0, BOOL bParam1) // Position - 0x476F
{
	int num;
	int num2;
...
BOOL func_148(int iParam0, int iParam1) // Position - 0x4958
{
	return iParam0 && iParam1 != false;
}

BOOL func_149(int iParam0, int iParam1) // Position - 0x4967
{
	return iParam0->f_2 && iParam1 != false;
}

int func_150(var uParam0, var uParam1) // Position - 0x4978
{
	int unk;
...
void func_151(Hash hParam0) // Position - 0x498B
{
	Hash hash;
...
BOOL func_152(Hash hParam0) // Position - 0x49E8
{
	return hParam0 != 0;
}

BOOL func_153(Hash hParam0) // Position - 0x49F4
{
	int i;
...
BOOL func_154(Hash hParam0, int iParam1, Player plParam2, int iParam3, BOOL bParam4) // Position - 0x4A48
{
	var unk;
	var unk13;
	var unk26;
...
BOOL func_155(int iParam0) // Position - 0x4A78
{
...
BOOL func_156(Hash hParam0) // Position - 0x4AD9
{
	Hash unlockHash;
	int num;
...
int func_157(Hash hParam0) // Position - 0x4B33
{
	switch (hParam0)
	{
		case 1:
...
Vector3 func_158(Hash hParam0) // Position - 0x4B97
{
	switch (hParam0)
	{
		case 1:
...
void func_159(Hash hParam0, int iParam1) // Position - 0x4C5F
{
	Hash unlockHash;
	Hash hash;
	BOOL flag;
...
BOOL func_160(Player plParam0) // Position - 0x4D6E
{
	int num;
...
BOOL func_161(Hash hParam0) // Position - 0x4D9D
{
	int num;
	Any gangId;
	Player gangLeader;
...
int func_162(int iParam0) // Position - 0x4E68
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_163(int iParam0) // Position - 0x4F83
{
...
int func_164(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4FB1
{
...
BOOL func_165(Hash hParam0) // Position - 0x4FE4
{
	if (!func_52(hParam0))
		return false;
...
Vector3 func_167(Player plParam0) // Position - 0x5031
{
	if (plParam0 == 255)
...
BOOL func_168(int iParam0) // Position - 0x505D
{
	int num;
	int num2;
	var unk;
...
void func_169(BOOL bParam0) // Position - 0x516F
{
	if (bParam0)
...
int func_170(int iParam0) // Position - 0x51A4
{
	switch (iParam0)
	{
		case 2:
...
int func_171(int iParam0, int iParam1) // Position - 0x51FB
{
	var unk;
	var statId;
...
BOOL func_172(Hash hParam0, int iParam1) // Position - 0x521A
{
	int num;
...
BOOL func_173(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x529D
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

void func_174() // Position - 0x52B8
{
	return;
}

int func_175() // Position - 0x52C0
{
...
BOOL func_177(var uParam0, var uParam1) // Position - 0x539C
{
	int num;
...
BOOL func_178(var uParam0, var uParam1) // Position - 0x53BC
{
	int num;
...
Hash func_179(var uParam0, var uParam1) // Position - 0x53DC
{
	return func_255(uParam0);
}

int func_180(var uParam0, var uParam1) // Position - 0x53EC
{
	int num;
...
int func_181(BOOL bParam0, int iParam1) // Position - 0x5427
{
...
void func_182(var uParam0, var uParam1, int iParam2, int iParam3, Player plParam4, int iParam5) // Position - 0x547D
{
	int deedType;
	Hash deedHash;
	int data;
...
void func_183(var uParam0, var uParam1, int iParam2) // Position - 0x554C
{
	if (!func_31(uParam0))
		return;
...
void func_184(BOOL bParam0) // Position - 0x558F
{
	if (bParam0)
	{
...
void func_185(BOOL bParam0) // Position - 0x5632
{
	int i;
	Hash crimeType;
	var unk;
...
int func_186(BOOL bParam0) // Position - 0x56A3
{
...
void func_187(BOOL bParam0) // Position - 0x56D0
{
	Global_1900460 = Global_1900460 || bParam0;
	return;
}

int func_188(var uParam0, var uParam1) // Position - 0x56E3
{
	return func_272(func_271(uParam0));
}

struct<2> func_189() // Position - 0x56F7
{
	var unk;
...
BOOL func_190(var uParam0, int iParam1) // Position - 0x5710
{
	BOOL flag;
...
BOOL func_192(int iParam0, int iParam1) // Position - 0x5750
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_193(int iParam0) // Position - 0x5780
{
	return Global_1835011[iParam0 /*72*/].f_19;
}

Vector3 func_194(int iParam0) // Position - 0x5794
{
	return Global_1835011[iParam0 /*72*/].f_19;
}

Vector3 func_195(int iParam0) // Position - 0x57A8
{
	return Global_1835011[iParam0 /*72*/].f_19;
}

void func_196(int iParam0, int iParam1) // Position - 0x57BC
{
	if (!func_108(iParam0))
		return;
...
void func_197(int iParam0) // Position - 0x57E8
{
	if (func_19() == -1)
		return;
...
void func_198(var uParam0, int iParam1) // Position - 0x5832
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_199(int iParam0) // Position - 0x5843
{
	*iParam0 = -1;
	iParam0->f_1 = -1;
	return;
...
var func_200(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5854
{
	if (bParam0)
		return uParam1;
...
int func_201(int iParam0, int iParam1) // Position - 0x586B
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_202(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5905
{
...
BOOL func_203(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x593D
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

BOOL func_204() // Position - 0x5966
{
	return !Global_1572887.f_10;
}

BOOL func_205() // Position - 0x5975
{
	if (Global_1572887.f_14 == -1)
		return false;
...
int func_208(int iParam0) // Position - 0x59D8
{
	if (!func_36(iParam0))
		return 0;
...
void func_209(int iParam0, int iParam1) // Position - 0x59F8
{
	if (!func_36(iParam0))
		return;
...
BOOL func_210(int iParam0) // Position - 0x5A2B
{
...
BOOL func_211(int iParam0) // Position - 0x5A4D
{
	return VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(func_47(iParam0));
}

int func_212(int iParam0) // Position - 0x5A5F
{
	if (!func_36(iParam0))
		return 0;
...
void func_213(int iParam0, int iParam1) // Position - 0x5A7F
{
	if (!func_36(iParam0))
		return;
...
int func_214(int iParam0, BOOL bParam1) // Position - 0x5AB2
{
	int i;
...
Hash func_215(Hash hParam0) // Position - 0x5B6D
{
	int num;
...
int func_216(int iParam0, int iParam1) // Position - 0x5BBE
{
	Hash chalHash;
	Hash goalHash;
...
BOOL func_217(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, Player plParam5, int iParam6, BOOL bParam7) // Position - 0x5BE3
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_218(int iParam0, int iParam1) // Position - 0x5CC4
{
	if (iParam1 == 255)
...
BOOL func_219(int iParam0) // Position - 0x5CFC
{
	int i;
...
BOOL func_220(Hash hParam0) // Position - 0x5D64
{
	if (hParam0 == 0)
		return false;
...
BOOL func_221(Hash hParam0) // Position - 0x5D81
{
	if (hParam0 == 0)
		return false;
...
int func_222(Hash hParam0) // Position - 0x5DA0
{
	int i;
...
int func_223(Hash hParam0) // Position - 0x5E0E
{
	int i;
...
int func_224(Hash hParam0) // Position - 0x5E59
{
	if (hParam0 <= 0 || hParam0 >= 10)
		return -1;
...
void func_225(Hash hParam0, int iParam1) // Position - 0x5E7F
{
	if (!func_52(hParam0))
		return;
...
void func_226(Hash hParam0, BOOL bParam1) // Position - 0x5E9E
{
	if (!func_52(hParam0))
		return;
...
int func_227(Player plParam0) // Position - 0x5EF1
{
	if (plParam0 == 255)
...
BOOL func_228(int iParam0, int iParam1) // Position - 0x5F28
{
	return iParam0->f_3 && iParam1 != false;
}

BOOL func_229(Hash hParam0, int* piParam1) // Position - 0x5F39
{
	var statId;
...
BOOL func_230(Hash hParam0, int* piParam1) // Position - 0x5FB6
{
	var statId;
...
int func_231(Hash hParam0) // Position - 0x6021
{
	if (hParam0 == -1)
		return 0;
...
int func_232(Hash hParam0) // Position - 0x6052
{
	if (hParam0 == -1)
		return 0;
...
BOOL func_233(Hash hParam0) // Position - 0x606C
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_234(BOOL bParam0) // Position - 0x607A
{
	if (func_19() == -1)
	{
...
int func_235() // Position - 0x60BB
{
	return Global_1102813.f_3672;
}

BOOL func_236() // Position - 0x60CA
{
	switch (func_281())
	{
		case 0:
...
BOOL func_237(Any* panParam0, int iParam1) // Position - 0x615C
{
	int i;
	int j;
	int num;
	...
	for (i = 0; i <= 204; i = i + 1)
	{
		...
		else if (!func_293(&unk381, num2, &DestStruct2))
		{
		}
		else
		{
			unk393 = { func_294(DestStruct2.f_1) };
		
			if (!func_295(DestStruct2, 1))
			{
			}
			else
			{
				...
				else
				{
					...
					if (!func_298(&unk386, &DestStruct2, &DestStruct, false))
					{
					}
					else if (func_299(&DestStruct, num2, &unk377, gangId, num, num3, &unk212, num7, -1))
					{
					}
					else
					{
						if (flag2)
						{
							MISC::COPY_SCRIPT_STRUCT(panParam0, &DestStruct, 33);
							return true;
						}
					
						MISC::COPY_SCRIPT_STRUCT(&unk277[num6 /*33*/], &DestStruct, 33);
					}
				}
			}
		}
	...
	for (i = 0; i <= 3 - 1; i = i + 1)
	{
		...
		{
			MISC::COPY_SCRIPT_STRUCT(&DestStruct, &unk277[i /*33*/], 33);
			break;
		}
	}
...
BOOL func_238(int iParam0) // Position - 0x6651
{
	return iParam0 > -1 && iParam0 < 104;
}

int func_239(int iParam0) // Position - 0x6667
{
	return func_300(13, iParam0);
}

int func_240(int iParam0) // Position - 0x6677
{
	return func_300(14, iParam0);
}

BOOL func_241(Any* panParam0, int iParam1) // Position - 0x6687
{
	return func_302(panParam0, func_301(iParam1, 1), 1);
}

void func_242(var uParam0, int iParam1) // Position - 0x669D
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_243() // Position - 0x66AE
{
...
void func_244(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10) // Position - 0x66D5
{
	var unk;
	var unk32;
	var unk33;
...
struct<2> func_245(int iParam0, int iParam1) // Position - 0x67D6
{
	int num;
...
BOOL func_246(Hash hParam0, int iParam1) // Position - 0x67EC
{
	if (hParam0 == 0)
		return false;
...
int func_247(Hash hParam0) // Position - 0x6806
{
	var unk;
...
BOOL func_248(Hash hParam0, int iParam1) // Position - 0x6831
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_249(Hash hParam0) // Position - 0x68D8
{
	int num;
	int num2;
	int num3;
...
int func_250(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6994
{
...
void func_252(int iParam0) // Position - 0x6A95
{
...
void func_254(int iParam0) // Position - 0x6AFD
{
	if (iParam0 >= 10 || iParam0 < 0)
		iParam0 = 0;
...
Hash func_255(var uParam0, var uParam1) // Position - 0x6B26
{
	int num;
...
int func_256(var uParam0, var uParam1) // Position - 0x6B50
{
	var unk;
	var unk4;
	int num;
...
void func_258(int iParam0, int iParam1) // Position - 0x6C0B
{
	iParam0->f_2 = iParam0->f_2 || iParam1;
	return;
}

int func_259(int iParam0) // Position - 0x6C1E
{
	switch (iParam0)
	{
		case 2:
...
char* func_260(var uParam0, var uParam1, var uParam2) // Position - 0x6C91
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

void func_261(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x6CA5
{
	int num;
	int i;
	int num2;
...
int func_262(var uParam0, var uParam1) // Position - 0x6DB7
{
	int num;
...
int func_263(var uParam0, var uParam1, int iParam2) // Position - 0x6DD9
{
	var unk;
	var unk4;
	var unk7;
...
void func_265(int iParam0, int iParam1) // Position - 0x6F8F
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_266(int iParam0, int iParam1) // Position - 0x6FA4
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

Hash func_267(int iParam0, int iParam1) // Position - 0x6FB5
{
	switch (iParam0)
	{
		case 0:
...
void func_268(var uParam0, var uParam1, var uParam2) // Position - 0x730A
{
	Global_1939102.f_75.f_67 = { uParam0 };
	return;
}

void func_269() // Position - 0x7320
{
	TEXT_LABEL_ASSIGN_STRING(&(Global_1939102.f_75.f_67), "", 24);
	return;
}

BOOL func_270(int iParam0) // Position - 0x7335
{
	int num;
	int num2;
	int offset;
...
int func_271(var uParam0, var uParam1) // Position - 0x73B4
{
	int i;
...
int func_272(int iParam0) // Position - 0x73FF
{
	if (iParam0 < 0)
		return 0;
...
void func_273(var uParam0, int iParam1) // Position - 0x746A
{
	if (iParam1 < 0)
		return;
...
void func_274(var uParam0, int iParam1) // Position - 0x74F0
{
...
void func_275(var uParam0, int iParam1) // Position - 0x752C
{
	int num;
	int num2;
...
int func_276(int iParam0) // Position - 0x757F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_277(int iParam0, var uParam1, var uParam2) // Position - 0x75FE
{
	if (!func_334(iParam0))
		return false;
...
void func_278(int iParam0, int iParam1) // Position - 0x7670
{
	if (iParam1 == 0)
		return;
...
void func_279(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x76A0
{
	int i;
	var unk;
...
struct<2> func_280(int iParam0) // Position - 0x775B
{
	var unk;
...
int func_281() // Position - 0x776D
{
	return Global_1120497.f_18173;
}

void func_282(int iParam0) // Position - 0x777C
{
	Global_1120497.f_18173 = iParam0;
	return;
}

int func_283() // Position - 0x778D
{
	return Global_1120497.f_18173.f_1;
}

int func_284() // Position - 0x779E
{
	return Global_1120497.f_18173.f_2;
}

void func_285(int iParam0) // Position - 0x77AF
{
	int i;
	int num;
...
void func_286(int iParam0) // Position - 0x77E2
{
	int i;
	int num;
...
int func_287(Player plParam0) // Position - 0x7815
{
	int num;
	int num2;
...
void func_288(var uParam0, int iParam1, BOOL bParam2) // Position - 0x784B
{
	var unk;
...
BOOL func_289(Any* panParam0, int iParam1) // Position - 0x78B8
{
	var SourceStruct;
...
BOOL func_290(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int* piParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x78EB
{
	uParam0.f_2 = iParam6;
	uParam0.f_3 = iParam7;
	uParam0.f_4 = iParam8;
...
BOOL func_291(Any* panParam0, int iParam1) // Position - 0x7916
{
	var SourceStruct;
...
Any func_292(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x7949
{
	uParam0.f_2 = iParam5;
	return DATAFILE::_PARSEDDATA_RQ_GET_NUM_NODES(&uParam0);
}

BOOL func_293(Any* panParam0, int iParam1, var uParam2) // Position - 0x795D
{
...
struct<2> func_294(var uParam0) // Position - 0x7986
{
	var unk;
...
BOOL func_295(int iParam0, int iParam1) // Position - 0x7A56
{
	return func_348(&(Global_1110244.f_3667[iParam0 /*7*/].f_2), iParam1);
}

float func_296(int iParam0) // Position - 0x7A71
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_297(var uParam0, var uParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x7ABB
{
	int num;
	var unk;
...
BOOL func_298(var uParam0, Any* panParam1, var uParam2, BOOL bParam3) // Position - 0x7AED
{
...
BOOL func_299(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, var uParam6, int iParam7, int iParam8) // Position - 0x7B7F
{
	int num;
	int num2;
	int num3;
...
int func_300(int iParam0, int iParam1) // Position - 0x7D61
{
	var unk;
...
int func_301(int iParam0, int iParam1) // Position - 0x7D7E
{
	switch (iParam0)
	{
...
BOOL func_302(Any* panParam0, int iParam1, int iParam2) // Position - 0x7E7E
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

void func_303(int iParam0) // Position - 0x7EB5
{
	Global_1120497.f_18173.f_1 = iParam0;
	return;
}

void func_304(int iParam0) // Position - 0x7EC8
{
	Global_1120497.f_18173.f_2 = iParam0;
	return;
}

var func_305(int iParam0, int iParam1) // Position - 0x7EDB
{
	return func_376(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

Vector3 func_306(int iParam0) // Position - 0x7EF9
{
	return Global_1114893[iParam0 /*70*/].f_7.f_1;
}

float func_307(int iParam0) // Position - 0x7F0F
{
	return Global_1114893[iParam0 /*70*/].f_7;
}

// Unhandled jump detected. Output should be considered invalid
void func_308(var uParam0, Any anParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x7F21
{
	int num;
	int num2;
	int i;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		else
		{
			...
			if (func_377(Plr, uParam2, fParam5))
			{
				if (num + 1 < 7)
				{
					uParam0->[1 + num] = Plr;
...
void func_309(Any* panParam0, var uParam1) // Position - 0x800C
{
...
Hash func_310(Hash hParam0, int iParam1) // Position - 0x8043
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_311(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x80BD
{
...
BOOL func_312(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x80E4
{
	if (iParam2 < 0)
		return false;
...
BOOL func_313(Hash hParam0) // Position - 0x811F
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_314(int iParam0) // Position - 0x813A
{
	if (iParam0 < 0)
		return 0;
...
int func_315(Hash hParam0) // Position - 0x815B
{
	var unk;
...
int func_316(Hash hParam0) // Position - 0x8186
{
	switch (hParam0)
	{
...
int func_317(var uParam0, int iParam1) // Position - 0x8269
{
	int i;
...
int func_318(Hash hParam0) // Position - 0x82A6
{
	int num;
...
int func_319(Hash hParam0, BOOL bParam1) // Position - 0x8313
{
	var unk;
	int num;
	int num2;
...
int func_320(Hash hParam0, int iParam1) // Position - 0x8372
{
	if (iParam1 == 0)
		return 0;
...
struct<4> func_321(Hash hParam0, BOOL bParam1) // Position - 0x839E
{
	var unk;
...
BOOL func_322(int iParam0, var uParam1, Any* panParam2) // Position - 0x83C3
{
	if (!func_31(iParam0))
		return false;
...
int func_323(var uParam0, var uParam1) // Position - 0x84CE
{
	var unk;
...
int func_324(int iParam0) // Position - 0x84FA
{
	int num;
	int num2;
...
int func_325(int iParam0) // Position - 0x8525
{
	if (iParam0 == -1)
		return 0;
...
int func_326(int iParam0) // Position - 0x853F
{
	if (iParam0 == -1)
		return 0;
...
BOOL func_327(int iParam0, BOOL bParam1) // Position - 0x855B
{
	switch (iParam0)
	{
...
int func_328(int iParam0) // Position - 0x85C3
{
	int i;
	var unk;
...
int func_329(int iParam0) // Position - 0x8664
{
	int num;
	var unk;
...
int func_330(int iParam0, int iParam1) // Position - 0x86F8
{
	switch (iParam0)
	{
...
BOOL func_331(int iParam0) // Position - 0x9F9D
{
	int num;
...
BOOL func_332(int iParam0) // Position - 0x9FBA
{
...
void func_333(int iParam0, int iParam1) // Position - 0x9FD1
{
	int i;
...
BOOL func_334(int iParam0) // Position - 0xA04B
{
...
BOOL func_335(int iParam0, var uParam1, var uParam2) // Position - 0xA06A
{
	if (!func_334(iParam0))
		return false;
...
BOOL func_336(Any anParam0) // Position - 0xA3F3
{
...
int func_337(int iParam0, int iParam1) // Position - 0xA439
{
	switch (iParam0)
	{
		case 0:
...
char* func_338(int iParam0) // Position - 0xB194
{
	switch (iParam0)
	{
		case -2137705453:
...
int func_339(int iParam0, int iParam1) // Position - 0xBDDF
{
	switch (iParam0)
	{
		case 0:
...
char* func_340(int iParam0) // Position - 0xC112
{
	switch (iParam0)
	{
		case -2017210649:
...
int func_341(Player plParam0) // Position - 0xC3FF
{
	return Global_1138673[plParam0 /*56*/];
}

int func_342(Player plParam0, int iParam1) // Position - 0xC40F
{
	int gangId;
	int i;
...
BOOL func_343(int iParam0) // Position - 0xC45C
{
	return iParam0 >= 0 && iParam0 < 32;
}

void func_344(int iParam0) // Position - 0xC472
{
	if (!func_343(iParam0))
		return;
...
BOOL func_345(Any* panParam0, Any anParam1) // Position - 0xC493
{
...
BOOL func_346(Any* panParam0, var uParam1) // Position - 0xC4C7
{
	int num;
...
struct<2> func_347(var uParam0, int iParam1) // Position - 0xC525
{
	int num;
...
BOOL func_348(var uParam0, int iParam1) // Position - 0xC64B
{
	return *uParam0 && iParam1 != false;
}

void func_349(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xC65B
{
...
Vector3 func_350(int iParam0, int iParam1) // Position - 0xC688
{
	int num;
...
BOOL func_351(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int* piParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xC6B5
{
	uParam0.f_2 = iParam6;
	uParam0.f_3 = iParam7;
	uParam0.f_4 = iParam8;
...
int func_352(int iParam0) // Position - 0xC6E0
{
	return Global_1110244.f_3667[iParam0 /*7*/].f_1;
}

BOOL func_353(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6) // Position - 0xC6F5
{
	var unk;
	int num;
	var unk2;
...
int func_354(int iParam0) // Position - 0xC85B
{
	return Global_1110244.f_3667[iParam0 /*7*/];
}

var func_355(int iParam0) // Position - 0xC86E
{
	return func_407(iParam0);
}

int func_356(int iParam0) // Position - 0xC87C
{
	return Global_1114893[iParam0 /*70*/].f_1;
}

int func_357(var uParam0) // Position - 0xC88E
{
	if (func_31(*uParam0))
		return 0;
...
int func_358(int iParam0, int iParam1) // Position - 0xC8A6
{
	Hash unlockHash;
...
int func_359(var uParam0, int iParam1) // Position - 0xC911
{
...
int func_360(var uParam0, int iParam1, var uParam2, int iParam3) // Position - 0xC963
{
...
int func_361(var uParam0, int iParam1) // Position - 0xC9A6
{
	int offset;
...
int func_362(int iParam0, int iParam1) // Position - 0xC9DD
{
	Any gangId;
	Player player;
...
int func_363(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xCA35
{
	Player gangLeader;
...
int func_364(var uParam0, int iParam1, int iParam2) // Position - 0xCACC
{
	Player gangLeader;
...
int func_365(int iParam0, int iParam1, int iParam2) // Position - 0xCB67
{
	if (iParam1 == -1)
	{
...
int func_366(int iParam0) // Position - 0xCBA8
{
	Player gangLeader;
...
int func_367(int iParam0, var uParam1, int iParam2) // Position - 0xCC19
{
	Player gangLeader;
	int num;
...
int func_368(var uParam0, int iParam1, int iParam2) // Position - 0xCCB7
{
...
int func_369(var uParam0, int iParam1) // Position - 0xCCE5
{
	var unk;
	int i;
	BOOL flag;
...
int func_370(var uParam0, int iParam1) // Position - 0xCDD7
{
...
int func_371(int iParam0, int iParam1) // Position - 0xCEA0
{
	Player gangLeader;
...
int func_372(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xCEE8
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
int func_373(var uParam0, int iParam1) // Position - 0xCFC7
{
	Hash hash;
	int num;
	BOOL flag;
...
int func_374(var uParam0, int iParam1, int iParam2) // Position - 0xD046
{
	int num;
	int num2;
	Hash hash;
...
BOOL func_375(int iParam0, int iParam1, var uParam2) // Position - 0xD161
{
	var unk;
...
var func_376(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0xD188
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_433(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
BOOL func_377(Player plParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4) // Position - 0xD51B
{
	return BUILTIN::VDIST(func_426(plParam0), vParam1) <= fParam4;
}

BOOL func_378(Hash hParam0, Hash hParam1) // Position - 0xD534
{
	if (!func_246(hParam0, 0))
...
void func_379(Hash hParam0, var uParam1, var uParam2) // Position - 0xD575
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_380(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD781
{
	Hash hash;
...
struct<4> func_381(BOOL bParam0) // Position - 0xD85F
{
	int num;
...
void func_382(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD900
{
...
BOOL func_383(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0xD91B
{
...
Hash func_384(Hash hParam0) // Position - 0xD940
{
	return hParam0;
}

BOOL func_385(Hash hParam0, int iParam1) // Position - 0xD94A
{
	if (hParam0 == 0)
		return false;
...
struct<5> func_386(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xD964
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_387(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xDCD8
{
	var outGuid;
...
void func_388(Any* panParam0) // Position - 0xDD09
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
BOOL func_389(Any* panParam0, int iParam1) // Position - 0xDD1F
{
...
int func_391(int iParam0) // Position - 0xDD8E
{
	return func_445(iParam0) + 30;
}

void func_392(int iParam0, int iParam1) // Position - 0xDD9E
{
	var unk;
...
int func_393(int iParam0) // Position - 0xDDEB
{
	return Global_1107816.f_33[iParam0 /*16*/];
}

int func_394(int iParam0) // Position - 0xDDFD
{
	int num;
...
int func_395(var uParam0, Any* panParam1, int iParam2) // Position - 0xDE24
{
	int num;
	int num2;
	int num3;
...
int func_396(int iParam0, Hash hParam1) // Position - 0xDE79
{
	int num;
	int num2;
...
int func_397(int iParam0, int iParam1) // Position - 0xDEB3
{
	if (iParam0 == -1)
		return -1;
...
int func_398(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8) // Position - 0xDED2
{
	int num;
...
int func_399(int iParam0) // Position - 0xDEF8
{
	return Global_1296644[iParam0 /*5*/].f_3;
}

var func_400(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6) // Position - 0xDF0A
{
	var unk;
...
void func_401(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xDF26
{
	int i;
	int num;
	int j;
...
void func_402(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xE073
{
	int i;
	int num;
	int BitIndex;
	...
	for (i = 0; i <= num - 1; i = i + 1)
	{
		...
		{
			BitIndex = func_398(uParam0, -1108141625, 1, true, -1);
...
int func_403(int iParam0) // Position - 0xE118
{
	return func_458(func_457(iParam0, joaat("UNLOCK_GROUP"), 1));
}

int func_404(int iParam0, int iParam1) // Position - 0xE130
{
	return func_459(iParam0, iParam1);
}

var func_405(int iParam0, int iParam1) // Position - 0xE140
{
	var unk;
	var unk2;
...
void func_406(int iParam0, int iParam1, int* piParam2) // Position - 0xE15C
{
	var unk;
...
var func_407(int iParam0) // Position - 0xE1DB
{
	return Global_1296644[iParam0 /*5*/].f_2;
}

BOOL func_408(int iParam0) // Position - 0xE1ED
{
	return iParam0 >= 0 && iParam0 < 36;
}

Hash func_409(int iParam0) // Position - 0xE203
{
	return Global_1119235[iParam0 /*35*/];
}

BOOL func_410(int iParam0, int iParam1) // Position - 0xE213
{
	return iParam0 && iParam1 != false;
}

BOOL func_411(var uParam0, int iParam1) // Position - 0xE222
{
	return func_302(uParam0, iParam1, 3);
}

var func_412(int iParam0) // Position - 0xE233
{
	return Global_1119235[iParam0 /*35*/].f_1;
}

BOOL func_413(var uParam0) // Position - 0xE245
{
	return true;
}

BOOL func_414(Player plParam0, int iParam1) // Position - 0xE24E
{
...
BOOL func_415(Player plParam0, int iParam1) // Position - 0xE290
{
	if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(plParam0))
		return false;
...
int func_416(int iParam0) // Position - 0xE2CA
{
	int i;
...
int func_417(int iParam0) // Position - 0xE300
{
	return Global_1107816.f_33[iParam0 /*16*/].f_2;
}

int func_418(Player plParam0) // Position - 0xE314
{
	return Global_1138673[plParam0 /*56*/].f_47;
}

void func_419(Any* panParam0) // Position - 0xE326
{
	MISC::COPY_SCRIPT_STRUCT(panParam0, &(Global_1110244.f_21.f_43.f_1), 33);
	return;
}

BOOL func_420(Player plParam0) // Position - 0xE340
{
	var memberHandles;
	int i;
	int gangMembers;
...
BOOL func_421(int iParam0) // Position - 0xE3C7
{
	return iParam0 >= 0 && iParam0 < 62;
}

BOOL func_422(int iParam0, int iParam1) // Position - 0xE3DD
{
	return iParam0 && iParam1 != false;
}

BOOL func_423(int iParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xE3EC
{
	int i;
	Player Plr;
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		else if (func_465(Plr))
		{
		}
		else if (!bParam4 && !func_466(Plr, uParam1))
		{
		}
		else
		{
...
int func_424(int iParam0, Hash hParam1) // Position - 0xE454
{
	Any any;
...
Vector3 func_425(int iParam0, Hash hParam1, int iParam2) // Position - 0xE4A8
{
	var unk;
	var unk4;
...
Vector3 func_426(Player plParam0) // Position - 0xE534
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

void func_427(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xE548
{
	*uParam2 = func_324(func_323(uParam0));
...
int func_428(int iParam0, Hash hParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, int iParam9) // Position - 0xE56A
{
	int num;
	int num2;
	int num3;
...
BOOL func_429(int iParam0, int iParam1, Any* panParam2) // Position - 0xE741
{
...
void func_430(Any* panParam0, int iParam1, var uParam2) // Position - 0xE775
{
	var unk;
...
int func_431() // Position - 0xE7EF
{
	return Global_1051645.f_12;
}

char* func_432() // Position - 0xE7FD
{
	return "unnamed";
}

BOOL func_433(int iParam0) // Position - 0xE809
{
	int num;
...
BOOL func_434(int iParam0) // Position - 0xE898
{
	if (Global_1572887.f_14 == -1)
		return false;
...
int func_435(int iParam0) // Position - 0xE8B6
{
	if (iParam0 == 255)
...
BOOL func_436(Player plParam0) // Position - 0xE901
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_437(Hash hParam0, Hash hParam1) // Position - 0xE946
{
...
struct<4> func_438(BOOL bParam0) // Position - 0xE97C
{
	int num;
...
int func_439(Hash hParam0, BOOL bParam1) // Position - 0xEA1C
{
...
BOOL func_440(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEA53
{
	return func_489(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_441(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0xEA6E
{
	var unk;
...
struct<4> func_442(BOOL bParam0) // Position - 0xEA8F
{
	int num;
...
BOOL func_443(Hash hParam0, int iParam1) // Position - 0xEAF9
{
	Hash hash;
	int num;
	int i;
...
BOOL func_444(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0xEB66
{
	return func_492(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_445(int iParam0) // Position - 0xEB7C
{
	return iParam0 * 31;
}

int func_446() // Position - 0xEB88
{
	return Global_1110244.f_3667.f_938;
}

int func_447(int iParam0, int iParam1, var uParam2) // Position - 0xEB9A
{
	int num;
...
int func_448(int iParam0) // Position - 0xEC04
{
	return Global_1110244.f_3667.f_729[iParam0 /*2*/].f_1;
}

BOOL func_449(Any* panParam0, Hash hParam1) // Position - 0xEC1C
{
...
int func_450(int iParam0) // Position - 0xEC3D
{
	int numChildren;
	Any any;
...
int func_451(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEC77
{
	uParam1.f_2 = iParam0;
	return DATAFILE::_PARSEDDATA_RQ_GET_NUM_NODES(&uParam1);
}

var func_452(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xEC8B
{
	return func_400(uParam0, -419812745, true);
}

int func_453(var uParam0) // Position - 0xECA1
{
	int num;
	int numNodes;
	int num2;
...
int func_454(int iParam0, int iParam1) // Position - 0xECF9
{
	switch (iParam0)
	{
		case 0:
...
void func_455(var uParam0, int iParam1) // Position - 0xEE3E
{
	func_493(uParam0, func_301(iParam1, 1), 1);
	return;
}

void func_456(var uParam0, int iParam1) // Position - 0xEE57
{
	func_493(uParam0, iParam1, 4);
	return;
}

int func_457(int iParam0, int iParam1, int iParam2) // Position - 0xEE6B
{
	var unk;
...
int func_458(int iParam0) // Position - 0xEF01
{
	switch (iParam0)
	{
...
int func_459(int iParam0, int iParam1) // Position - 0xEF59
{
	int num;
	var unk;
	int num2;
...
int func_460(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4) // Position - 0xF082
{
	var unk;
...
BOOL func_461(int iParam0) // Position - 0xF1C7
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_462(Player plParam0, int iParam1) // Position - 0xF206
{
	return func_302(&Global_1140466[plParam0 /*8*/], iParam1, 2);
}

BOOL func_463(Player plParam0, int iParam1) // Position - 0xF21D
{
	return func_302(&(Global_1140466[plParam0 /*8*/].f_3), iParam1, 4);
}

BOOL func_464(int iParam0, Player plParam1) // Position - 0xF236
{
	if (plParam1 == 255)
...
BOOL func_465(Player plParam0) // Position - 0xF262
{
	int num;
...
BOOL func_466(Player plParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xF2B7
{
	Vector3 vector;
	float num;
	float num2;
...
Vector3 func_467(int iParam0, Hash hParam1) // Position - 0xF319
{
	var unk;
	var unk4;
...
BOOL func_468(int iParam0, Any* panParam1, Hash hParam2) // Position - 0xF34C
{
	int numChildren;
	int i;
	var unk;
...
BOOL func_470(int iParam0, int iParam1, BOOL bParam2, var uParam3) // Position - 0xF3ED
{
	BOOL flag;
	var unk;
	float num;
...
BOOL func_471(int iParam0, Hash hParam1) // Position - 0xF470
{
	BOOL num;
	var unk;
...
Vector3 func_472(int iParam0, Hash hParam1) // Position - 0xF4A6
{
	var unk;
	var unk4;
...
int func_473(int iParam0, int iParam1) // Position - 0xF4DB
{
	int num;
	var unk;
	int num2;
...
BOOL func_474(int iParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xF520
{
	float minRadius;
	float maxRadius;
	Player Plr;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(playerPed))
			{
				...
				if (num < maxRadius && !func_518(iParam0))
					return false;
			}
		}
	}
...
int func_475(int iParam0) // Position - 0xF620
{
	int i;
...
BOOL func_476(int iParam0) // Position - 0xF658
{
	switch (iParam0)
	{
		case joaat("CAMP_RESUPPLY"):
...
int func_477(Player plParam0) // Position - 0xF685
{
	Player player;
...
BOOL func_478(int iParam0) // Position - 0xF6B5
{
	if (iParam0 < 0 || iParam0 >= 32)
		return false;
...
BOOL func_479(int iParam0) // Position - 0xF6D4
{
	if (!func_478(iParam0))
		return false;
...
BOOL func_480(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xF703
{
	var unk;
	var unk3;
...
Hash func_481(int iParam0, int iParam1) // Position - 0xF7AA
{
	int num;
...
Hash func_482(int iParam0, int iParam1) // Position - 0xF7D1
{
	int num;
...
int func_483(int iParam0) // Position - 0xF7FA
{
	int num;
...
BOOL func_484(int iParam0, int iParam1) // Position - 0xF96F
{
	int num;
...
BOOL func_485(Player plParam0) // Position - 0xF9E3
{
...
void func_486(Player plParam0) // Position - 0xFA00
{
	Player player;
...
struct<4> func_487() // Position - 0xFA83
{
	var unk;
...
int func_489(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xFAAC
{
...
BOOL func_490(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0xFB2B
{
	int inventoryId;
...
BOOL func_491(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xFB70
{
...
BOOL func_492(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xFBA3
{
...
BOOL func_493(var uParam0, int iParam1, int iParam2) // Position - 0xFBDD
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_494(int iParam0) // Position - 0xFC10
{
	return iParam0 > -1 && iParam0 < 83;
}

BOOL func_495(Any* panParam0) // Position - 0xFC26
{
	int fileHandle;
	var SourceStruct;
...
BOOL func_496(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int* piParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xFC5F
{
	uParam0.f_2 = iParam6;
	uParam0.f_3 = iParam7;
	uParam0.f_4 = iParam8;
...
int func_497(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6) // Position - 0xFC8A
{
	var unk;
...
int func_498(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0xFCA5
{
	uParam0.f_2 = iParam5;
	return DATAFILE::_PARSEDDATA_RQ_GET_NUM_NODES(&uParam0);
}

int func_499(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xFCB9
{
	return func_497(uParam0, 56, 1);
}

int func_500(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xFCCC
{
	return func_497(uParam0, 54, 1);
}

int func_501(Player plParam0) // Position - 0xFCDF
{
	Player player;
...
BOOL func_502(Player plParam0, int iParam1) // Position - 0xFD44
{
	Player player;
...
BOOL func_503(int iParam0, Player plParam1) // Position - 0xFD78
{
	if (plParam1 != 255)
...
BOOL func_504(int iParam0, Any* panParam1) // Position - 0xFDA9
{
	int fileHandle;
...
BOOL func_505(int iParam0, int iParam1, int iParam2) // Position - 0xFE00
{
	int num;
...
BOOL func_506(int iParam0, int iParam1, BOOL bParam2) // Position - 0xFE2F
{
	int i;
	var unk;
	float num;
...
float func_507(int iParam0, int iParam1) // Position - 0xFE96
{
	float num;
	var unk;
	...
	if (func_389(&unk, iParam0) && func_512(&unk, iParam1))
		func_532(unk, -364402952, &num, false);

	return num;
}

BOOL func_508(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0xFED3
{
	int i;
	Player Plr;
...
BOOL func_509(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0xFF20
{
	int num;
...
int func_510(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL* pbParam6, BOOL bParam7) // Position - 0xFF43
{
	uParam0.f_2 = iParam5;
...
int func_511(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, Vector3* pvParam6, BOOL bParam7) // Position - 0xFF69
{
	uParam0.f_2 = iParam5;
...
BOOL func_512(Any* panParam0, int iParam1) // Position - 0xFF8F
{
...
int func_513(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, var uParam6, BOOL bParam7) // Position - 0xFFB0
{
	var unk;
...
int func_514(int iParam0) // Position - 0xFFE0
{
	switch (iParam0)
	{
...
BOOL func_515(int iParam0) // Position - 0x10019
{
	return func_533(iParam0, 4);
}

BOOL func_516(int iParam0) // Position - 0x10028
{
	int frameCount;
...
float func_517(int iParam0) // Position - 0x10064
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_518(int iParam0) // Position - 0x100A3
{
	int frameCount;
...
BOOL func_519(int iParam0) // Position - 0x100DF
{
	int num;
...
BOOL func_520(int iParam0) // Position - 0x10117
{
	return Global_1225099[iParam0 /*28*/] == -1;
}

BOOL func_521(int iParam0) // Position - 0x10129
{
	int num;
...
struct<2> func_522() // Position - 0x10154
{
	return Global_1051268;
}

void func_523(Player plParam0) // Position - 0x10162
{
	Player player;
...
void func_524(Player plParam0) // Position - 0x101CE
{
...
int func_525() // Position - 0x10209
{
	return Global_1072759.f_28418[32 /*4*/].f_3;
}

BOOL func_526(int iParam0, int iParam1) // Position - 0x1021E
{
	return iParam0 && iParam1 != false;
}

BOOL func_527(int iParam0) // Position - 0x1022D
{
	int num;
	int num2;
...
int func_528(int iParam0) // Position - 0x10272
{
	int num;
	int num2;
	int num3;
...
int func_529(int iParam0, int iParam1) // Position - 0x102BF
{
	int num;
...
Vector3 func_530(int iParam0, int iParam1, int iParam2) // Position - 0x102E8
{
	var unk;
	var unk4;
...
float func_531(int iParam0, int iParam1, int iParam2) // Position - 0x1032A
{
	float num;
	var unk;
	...
	if (func_389(&unk, iParam0) && func_512(&unk, iParam1) && func_539(&unk, iParam2))
		func_532(unk, -364402952, &num, false);

	return num;
}

int func_532(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float* pfParam6, BOOL bParam7) // Position - 0x10374
{
	uParam0.f_2 = iParam5;
...
BOOL func_533(int iParam0, int iParam1) // Position - 0x1039A
{
	int i;
...
int func_534(int iParam0) // Position - 0x103E1
{
	switch (iParam0)
	{
		case -2096602762:
...
BOOL func_535(int iParam0) // Position - 0x1047F
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_536() // Position - 0x104A0
{
	return func_540(func_30(0));
}

int func_537(int iParam0) // Position - 0x104B1
{
	if (!func_478(iParam0))
		return 0;
...
int func_538(int iParam0) // Position - 0x104D3
{
	return Global_1110244.f_21.f_3.f_1[iParam0];
}

BOOL func_539(Any* panParam0, int iParam1) // Position - 0x104E9
{
...
BOOL func_540(var uParam0, var uParam1) // Position - 0x1050A
{
	return func_541(uParam0, 1, 4);
}

BOOL func_541(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x1051C
{
	int num;
...
int func_542(int iParam0, var uParam1) // Position - 0x10557
{
	if (iParam0 == 2)
