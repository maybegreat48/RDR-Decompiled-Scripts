...
void func_6(int* piParam0) // Position - 0x203
{
	var unk;
...
void func_7(Any* panParam0) // Position - 0x210
{
	int i;

	for (i = 0; i < 32; i = i + 1)
	{
		func_36(&panParam0->[i /*87*/]);
	}

	return;
}

void func_8(int iParam0) // Position - 0x235
{
	var unk;
...
void func_9(BOOL bParam0) // Position - 0x455
{
	func_37(37, false);
	func_37(33, false);
...
void func_10() // Position - 0x4A6
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_11(int iParam0, int iParam1) // Position - 0x4B2
{
...
void func_15(BOOL bParam0) // Position - 0x682
{
	int num;
	var unk;
	int num2;
...
BOOL func_16(BOOL bParam0, BOOL bParam1) // Position - 0x74B
{
	int i;
...
BOOL func_17(int iParam0, BOOL bParam1) // Position - 0x82B
{
	if (func_43(iParam0))
	{
...
void func_19(Player plParam0) // Position - 0x8D3
{
	Global_1297229.f_200 = plParam0;
	return;
}

void func_20() // Position - 0x8E3
{
	int num;
...
void func_21(int iParam0) // Position - 0x91C
{
	Global_1297229.f_1 = iParam0;
	return;
}

Player func_22() // Position - 0x92C
{
	return Global_1297229.f_200;
}

void func_23() // Position - 0x93A
{
	int num;
	int num2;
...
BOOL func_34(int iParam0, int iParam1) // Position - 0x1060
{
...
void func_35(int iParam0, int iParam1, int iParam2) // Position - 0x10A0
{
	iParam1->f_3 = iParam2;
	return;
}
...
void func_37(int iParam0, BOOL bParam1) // Position - 0x114D
{
	BOOL flag;
...
int func_38() // Position - 0x14FB
{
	return Global_1572887.f_14;
}

BOOL func_39() // Position - 0x1509
{
	return Global_1051645.f_8;
}

BOOL func_40(int iParam0, int iParam1, char* sParam2) // Position - 0x1517
{
	return true;
}

BOOL func_41(int iParam0, int iParam1, char* sParam2) // Position - 0x1520
{
	return true;
}

void func_42() // Position - 0x1529
{
	int num;
...
BOOL func_43(int iParam0) // Position - 0x1541
{
	return iParam0 > -1 && iParam0 < 2;
}

int func_44(int iParam0) // Position - 0x1556
{
	if (func_43(iParam0))
...
void func_46(int iParam0) // Position - 0x15DF
{
	Global_1297600[PLAYER::PLAYER_ID() /*87*/].f_5.f_12 = iParam0;
	return;
}

BOOL func_47(int iParam0) // Position - 0x15F7
{
	Hash unlockHash;
	int num;
...
void func_49(int iParam0) // Position - 0x16BF
{
	int num;
	int num2;
	int num3;
...
BOOL func_50(Player plParam0, int iParam1) // Position - 0x17B6
{
	Player player;
...
int func_51(Player plParam0, BOOL bParam1) // Position - 0x17EA
{
	if (bParam1)
...
void func_52() // Position - 0x180D
{
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr) && i != Global_1295666)
		{
			...
			else if (Global_1297600[i /*87*/].f_3 == num && !func_50(Plr, 256))
			{
...
BOOL func_53(int iParam0) // Position - 0x18EC
{
	return func_140(Global_1297441.f_157, iParam0);
}

int func_54(Player plParam0, int iParam1, BOOL bParam2) // Position - 0x1900
{
	if (bParam2)
...
void func_56(int iParam0) // Position - 0x1953
{
	func_92(&(Global_1297441.f_157), iParam0);
	return;
}

void func_57() // Position - 0x1967
{
	BOOL flag;
...
void func_58() // Position - 0x19DC
{
	...
	Plr = Global_1297229.f_3.f_2[num /*4*/];
	...
	if (flag2)
	{
		...
		unk17.f_26 = 9;
		unk17.f_27 = Plr;
		unk17.f_16 = func_151(PLAYER::GET_PLAYER_NAME(Plr), func_150(Plr, true, -1, false));
		...
		unk17.f_30 = 22;
		unk17.f_33.f_2 = func_151(PLAYER::GET_PLAYER_NAME(Plr), func_150(Plr, true, -1, false));
...
int func_64(Player plParam0, BOOL bParam1) // Position - 0x1FA6
{
	if (bParam1)
		if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(plParam0))
			return -1;
...
float func_65(int iParam0) // Position - 0x1FCD
{
	return Global_1297441.f_6.f_17[iParam0];
}

void func_66(float fParam0) // Position - 0x1FE1
{
	int num;
	int num2;
...
void func_67(Player plParam0, float fParam1) // Position - 0x20A3
{
	int num;
...
BOOL func_68() // Position - 0x226F
{
	return Global_263042[Global_1295666 /*65*/] > 2;
}

BOOL func_69() // Position - 0x2283
{
	if (Global_1048576)
		return true;
...
void func_70(int iParam0) // Position - 0x22DB
{
	func_159(&(Global_1297441.f_157), iParam0);
	return;
}

void func_71(int iParam0) // Position - 0x22EF
{
	func_159(&(Global_1297600[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*87*/].f_86), iParam0);
	return;
}

BOOL func_72(int iParam0) // Position - 0x2309
{
	if (func_43(iParam0))
		if (!MISC::IS_BIT_SET(Global_1297229.f_201, iParam0))
...
BOOL func_74(int iParam0) // Position - 0x23B2
{
	if (func_43(iParam0))
...
void func_75(int iParam0, int iParam1, BOOL bParam2) // Position - 0x23D3
{
	BOOL flag;
...
void func_76(BOOL bParam0) // Position - 0x2507
{
	if (bParam0)
		func_165(1);
...
void func_77() // Position - 0x2529
{
	Global_1896762.f_325.f_5 = 1;
	return;
}

void func_78() // Position - 0x253B
{
	var unk;
	int num;
	int num2;
...
int func_85(Player plParam0) // Position - 0x2A4D
{
	int num;
...
BOOL func_90(BOOL bParam0) // Position - 0x2D70
{
	if (bParam0)
...
void func_91(int iParam0) // Position - 0x2DAF
{
	Global_1297062 = iParam0;
	return;
}

void func_92(int iParam0, int iParam1) // Position - 0x2DBD
{
	func_184(iParam0, iParam1);
	return;
}

BOOL func_93(int iParam0) // Position - 0x2DCD
{
	var unk;
...
BOOL func_96(Player plParam0, int iParam1) // Position - 0x2EB4
{
...
void func_97(int iParam0) // Position - 0x2EE2
{
...
Hash func_98(Player plParam0) // Position - 0x2F15
{
	Player player;
...
Hash func_99(Player plParam0) // Position - 0x2F3B
{
	Player player;
...
int func_102(int* piParam0) // Position - 0x30F9
{
	return func_196(piParam0->f_1);
}

void func_103() // Position - 0x3109
{
	int num;
...
void func_104(Any* panParam0, BOOL bParam1) // Position - 0x3127
{
	var unk;
	int num;
	int num2;
...
float func_106(var uParam0) // Position - 0x320A
{
	if (!func_200(uParam0))
		return 0f;
...
BOOL func_108(int* piParam0) // Position - 0x32F5
{
	int num;
...
void func_110(var uParam0) // Position - 0x3341
{
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
	*uParam0 = 0;
...
void func_111(var uParam0) // Position - 0x3357
{
	func_202(uParam0, 0);
	return;
}

void func_112(int iParam0) // Position - 0x3366
{
	if (func_140(Global_1297600[Global_1295666 /*87*/].f_19, iParam0))
...
BOOL func_117(int iParam0) // Position - 0x354D
{
...
BOOL func_118(int iParam0, int iParam1) // Position - 0x35AA
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_119(int iParam0, int iParam1) // Position - 0x35C3
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_120(int iParam0, int iParam1) // Position - 0x35DC
{
...
int func_121(int iParam0) // Position - 0x3617
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_122(Hash hParam0) // Position - 0x362B
{
...
void func_123(int iParam0) // Position - 0x364B
{
	return;
}

void func_124(int iParam0) // Position - 0x3653
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_125(int iParam0, int iParam1) // Position - 0x3668
{
	if (iParam0 == -1)
		return false;
...
void func_126(int iParam0) // Position - 0x368F
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_128(Any* panParam0) // Position - 0x387F
{
...
Hash func_129(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x38B5
{
	var unk;
...
Hash func_130(int iParam0) // Position - 0x38E5
{
	switch (iParam0)
	{
		case 1:
...
int func_131(int iParam0, int iParam1) // Position - 0x3974
{
	switch (iParam1)
	{
		case 1:
...
int func_132(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0x3C16
{
	return func_216(&uParam0, hParam4, bParam5, iParam6);
}

int func_133() // Position - 0x3C2A
{
	if (func_128(&(Global_1297441.f_62)))
...
int func_137(int iParam0, int iParam1, BOOL bParam2) // Position - 0x3E12
{
	if (bParam2)
		if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(PLAYER::PLAYER_ID()))
			return 0;
...
BOOL func_140(int iParam0, int iParam1) // Position - 0x3E7F
{
	return iParam0 && iParam1 != false;
}

BOOL func_141(int iParam0) // Position - 0x3E8E
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_143() // Position - 0x3FED
{
	return Global_1072759.f_7;
}

void func_144(int iParam0) // Position - 0x3FFB
{
	func_92(&(Global_1297600[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*87*/].f_86), iParam0);
	return;
}

BOOL func_145(int iParam0) // Position - 0x401A
{
	return func_225(1, iParam0);
}

int func_146(char* sParam0, Player plParam1, int iParam2) // Position - 0x4029
{
	Player Plr;
		...
		case 2:
			switch (num)
			{
				...
				case 2:
					...
					func_229(plParam1, iParam2, textureDownloadHandle);
					break;
			
				case 3:
					textureDownloadHandle = func_230(plParam1, iParam2);
...
void func_147(Player plParam0) // Position - 0x4218
{
	int num;
...
void func_148(int iParam0, int iParam1) // Position - 0x423D
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

const char* func_149(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x424E
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_150(Player plParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x4262
{
	BOOL flag;
	BOOL isBitSet;
	Player player;
...
const char* func_151(const char* sParam0, int iParam1) // Position - 0x44B6
{
...
Hash func_152(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54) // Position - 0x44F4
{
	int num;
	int cloudTimeAsInt;
	Hash hash;
...
BOOL func_153(Hash hParam0, Player plParam1) // Position - 0x486B
{
	int i;
...
BOOL func_155(int iParam0) // Position - 0x491A
{
...
void func_159(int iParam0, int iParam1) // Position - 0x49CE
{
	func_252(iParam0, iParam1);
	return;
}

BOOL func_160(Player plParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x49DE
{
	Player player;
...
BOOL func_161(Player plParam0, BOOL bParam1) // Position - 0x4A2A
{
	return func_51(plParam0, bParam1) != -1;
}

BOOL func_162(int iParam0) // Position - 0x4A3C
{
	char* scriptname;
	int instanceId;
	...
	instanceId = Global_1297229.f_201.f_1[iParam0 /*4*/].f_2;
...
void func_163(int iParam0) // Position - 0x4AB7
{
	char* scriptname;
...
BOOL func_164(int iParam0, int iParam1) // Position - 0x4AD9
{
...
void func_165(int iParam0) // Position - 0x4B02
{
	int num;
	int BitIndex;
...
void func_166(int iParam0) // Position - 0x4B36
{
	if (iParam0 < 0)
		iParam0 = 0;
...
void func_167(int iParam0) // Position - 0x4B83
{
	if (iParam0 < 0)
		iParam0 = 0;
...
BOOL func_168(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, Any* panParam5, int iParam6, BOOL bParam7) // Position - 0x4BB7
{
	int inventoryId;
...
void func_170(Hash hParam0) // Position - 0x4C22
{
...
void func_172(int iParam0, BOOL bParam1) // Position - 0x4D75
{
	int num;
	int num2;
...
void func_173(var uParam0, BOOL bParam1) // Position - 0x4DA2
{
...
Hash func_174(Player plParam0) // Position - 0x4DC2
{
	Player player;
...
Hash func_175(Hash hParam0) // Position - 0x4DE6
{
	int num;
...
BOOL func_177(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x4ECC
{
...
BOOL func_178(int iParam0) // Position - 0x4F02
{
	int num;
	int num2;
	int offset;
...
char* func_179(Hash hParam0) // Position - 0x4F2C
{
	char* str;
...
void func_180(int iParam0, char* sParam1, BOOL bParam2) // Position - 0x4FDD
{
...
void func_183(int iParam0) // Position - 0x5061
{
	Global_1297600[Global_1295666 /*87*/].f_19.f_19 = iParam0;
	return;
}

void func_184(int iParam0, int iParam1) // Position - 0x5079
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_185() // Position - 0x508A
{
	Hash provision;
...
BOOL func_186(Hash hParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x5180
{
	int num;
	var unk;
	var unk6;
...
BOOL func_188(Hash hParam0, int iParam1) // Position - 0x5249
{
	if (hParam0 == 0)
		return false;
...
int func_189(Any* panParam0, Hash hParam1, BOOL bParam2) // Position - 0x5263
{
	return INVENTORY::INVENTORY_GET_CHILDREN_IN_SLOT_COUNT(func_258(bParam2), panParam0, hParam1);
}

Hash func_190(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5279
{
	int num;
	BOOL flag;
	BOOL flag2;
...
int func_191(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x53B5
{
	var unk;
	int num;
	int i;
...
BOOL func_192(Hash hParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x54A5
{
	int num;
	int num2;
	BOOL flag;
...
int func_193(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x57BE
{
	var unk;
	int num;
	int i;
...
BOOL func_194(int* piParam0, Hash hParam1, var uParam2, BOOL bParam3, Hash hParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5852
{
...
BOOL func_195(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, int iParam7, var uParam8, BOOL bParam9, Hash hParam10, BOOL bParam11, BOOL bParam12) // Position - 0x58FB
{
	var unk;
	var unk18;
...
int func_196(int iParam0) // Position - 0x59DA
{
	int num;
	int status;
...
int func_197(Any* panParam0, Any* panParam1) // Position - 0x5A64
{
...
int func_198(int iParam0) // Position - 0x5A7C
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_200(var uParam0) // Position - 0x5B5E
{
	return func_296(*uParam0, 1);
}

int func_201(var uParam0) // Position - 0x5B6E
{
	if (!func_200(uParam0))
		return 0;
...
void func_202(var uParam0, int iParam1) // Position - 0x5B9F
{
...
BOOL func_203(Hash hParam0, Hash hParam1) // Position - 0x5BDB
{
	if (!func_188(hParam0, 0))
...
struct<2> func_204(int iParam0, int iParam1) // Position - 0x5C1C
{
	int num;
...
void func_205(var uParam0, var uParam1, int iParam2) // Position - 0x5C32
{
...
Hash func_207(var uParam0) // Position - 0x5CC0
{
...
BOOL func_208(Hash hParam0) // Position - 0x5FA2
{
	if (func_312(hParam0))
...
BOOL func_209() // Position - 0x5FBD
{
	return 1;
}

BOOL func_210(BOOL bParam0, int iParam1) // Position - 0x5FC6
{
	return bParam0 && iParam1 != false;
}

int func_211() // Position - 0x5FD5
{
	Hash hash;
	Hash hash2;
	int num;
...
Hash func_213(int iParam0) // Position - 0x606E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_214(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3) // Position - 0x60C5
{
	var unk;
	var unk3;
...
BOOL func_215(Hash hParam0) // Position - 0x60DF
{
	switch (hParam0)
	{
		case -1551258934:
...
int func_216(Any* panParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0x610C
{
	var unk;
...
BOOL func_217(Hash hParam0, Any* panParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x613A
{
	return func_317(hParam0, *panParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_218() // Position - 0x6155
{
	int num;
...
BOOL func_219() // Position - 0x6198
{
	return Global_1295658.f_2.f_1 == 2 || Global_1295658.f_2.f_1 == 1;
}

BOOL func_220(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x61BA
{
	var data;
	int i;
	Hash crimeType;
...
struct<2> func_221(int iParam0) // Position - 0x62EF
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_222(BOOL bParam0) // Position - 0x6303
{
	if (bParam0)
...
int func_223(int iParam0, Player plParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6333
{
	int i;
...
BOOL func_224(int iParam0) // Position - 0x63A8
{
	return iParam0 >= 0 && iParam0 <= 12;
}

BOOL func_225(int iParam0, int iParam1) // Position - 0x63BE
{
	int num;
...
int func_226(Player plParam0, int iParam1) // Position - 0x6432
{
	if (plParam0 < 0 || plParam0 >= 32)
		return -1;
...
int func_227(int iParam0) // Position - 0x646B
{
	switch (iParam0)
	{
		case 1:
...
void func_228(Player plParam0, int iParam1, int iParam2) // Position - 0x6490
{
	Player Plr;
...
void func_229(Player plParam0, int iParam1, int iParam2) // Position - 0x64E7
{
	Player Plr;
...
int func_230(Player plParam0, int iParam1) // Position - 0x6533
{
	Player Plr;
...
void func_231(var uParam0) // Position - 0x6580
{
	int num;
	int i;
	BOOL flag;
...
BOOL func_232(var uParam0, var uParam1) // Position - 0x6753
{
	int num;
...
int func_233(int iParam0, var uParam1) // Position - 0x6773
{
	return iParam0;
}

int func_234(Player plParam0) // Position - 0x677D
{
...
int func_235(Player plParam0) // Position - 0x6814
{
...
int func_236(Player plParam0, BOOL bParam1) // Position - 0x6843
{
	int num;
	int num2;
	int num3;
...
BOOL func_237(Player plParam0, BOOL bParam1) // Position - 0x6910
{
	Player bitIndex;
	int playerTeam;
	int playerTeam2;
...
BOOL func_238(Player plParam0, BOOL bParam1) // Position - 0x6A12
{
	Player bitIndex;
...
BOOL func_239(Player plParam0, BOOL bParam1) // Position - 0x6A9C
{
	Player bitIndex;
...
int func_240(var uParam0, var uParam1) // Position - 0x6B3E
{
	var unk;
...
int func_241(int iParam0, int iParam1) // Position - 0x6B6A
{
	switch (iParam0)
	{
		case 0:
...
const char* func_242(const char* sParam0, int iParam1) // Position - 0x6BC1
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

int func_243() // Position - 0x6BDB
{
	int i;
	int num;
	Hash hash;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x6D11
{
	switch (iParam0)
	{
		case 0:
...
void func_246(int iParam0) // Position - 0x721F
{
...
BOOL func_247(var uParam0) // Position - 0x7250
{
	return true;
}

int func_248() // Position - 0x7259
{
	return Global_1940252.f_245.f_1305;
}

BOOL func_249(Player plParam0) // Position - 0x726A
{
	int num;
	int num2;
	BOOL flag;
...
BOOL func_250(int iParam0) // Position - 0x72AB
{
	switch (iParam0)
	{
		case 2:
...
int func_251(int iParam0) // Position - 0x72EA
{
	switch (iParam0)
	{
		case 2:
...
void func_252(int iParam0, int iParam1) // Position - 0x7380
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

char* func_253(int iParam0) // Position - 0x7395
{
	switch (iParam0)
	{
		case 0:
...
int func_254(int iParam0) // Position - 0x73C2
{
	switch (iParam0)
	{
		case 0:
...
eStackSize func_255(int iParam0) // Position - 0x73F3
{
	switch (iParam0)
	{
...
void func_256(int iParam0, int iParam1) // Position - 0x7773
{
	struct<5> args;
...
BOOL func_257(int iParam0) // Position - 0x77AF
{
...
int func_258(BOOL bParam0) // Position - 0x77CE
{
	if (func_38() == -1)
	{
...
void func_259(int iParam0, var uParam1, var uParam2) // Position - 0x780F
{
	int num;
...
BOOL func_260(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x782B
{
	if (iParam1 < 0 || iParam1 > 32)
		return false;
...
void func_261(int iParam0, int iParam1) // Position - 0x78CD
{
	int Variable;
...
void func_264(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x7959
{
	int num;
	int num2;
...
Hash func_265(int iParam0) // Position - 0x79B9
{
	Hash hash;
...
int func_266(Hash hParam0, int iParam1) // Position - 0x79F0
{
	if (iParam1 == 0)
		return 0;
...
BOOL func_267(Hash hParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x7A1C
{
	int num;
	var unk;
	int num2;
...
struct<5> func_268(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x7B34
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_269(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x7EA8
{
	var outGuid;
...
BOOL func_270(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x7ED9
{
	var unk;
	int num;
	var unk15;
...
BOOL func_271(Hash hParam0) // Position - 0x7FF7
{
...
int func_272(Hash hParam0, BOOL bParam1) // Position - 0x8014
{
	var unk;
...
BOOL func_273(Hash hParam0) // Position - 0x806C
{
...
Hash func_274(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8094
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_275(Hash hParam0, BOOL bParam1) // Position - 0x8199
{
	return func_279(hParam0, 997808187) && !func_366(hParam0, 997808187, bParam1);
}

BOOL func_276(Hash hParam0) // Position - 0x81BF
{
	int num;
...
BOOL func_277(Hash hParam0, var uParam1) // Position - 0x81F9
{
	*uParam1 = func_367(hParam0, true);
	return *uParam1 != 0;
}

BOOL func_278(Hash hParam0, var uParam1) // Position - 0x8210
{
	*uParam1 = func_368(hParam0, true, false);
	return *uParam1 != 0;
}

BOOL func_279(Hash hParam0, Hash hParam1) // Position - 0x8228
{
	if (!func_188(hParam0, 0))
		return false;
...
BOOL func_280() // Position - 0x8274
{
	return Global_1915656.f_22477;
}

BOOL func_281(int iParam0) // Position - 0x8283
{
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_282(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x82BE
{
	int i;
...
int func_283(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x834E
{
...
BOOL func_284(int iParam0) // Position - 0x8381
{
	if (iParam0 == 0)
		return false;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_285(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x8399
{
	int i;
...
BOOL func_286(int* piParam0, BOOL bParam1) // Position - 0x8428
{
	if (!bParam1)
...
BOOL func_287(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x84C4
{
	if (iParam0 == 0)
		return false;
...
BOOL func_288(int* piParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, Hash hParam19, BOOL bParam20) // Position - 0x8524
{
...
BOOL func_289(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, Hash hParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x8578
{
	Hash hash;
...
struct<17> func_290(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, int iParam6, BOOL bParam7) // Position - 0x8615
{
	var unk;
...
int func_291(Hash hParam0) // Position - 0x868F
{
	var unk;
...
BOOL func_293(int* piParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, Hash hParam18, BOOL bParam19, BOOL bParam20) // Position - 0x872A
{
...
int func_294(int iParam0) // Position - 0x87B4
{
	int i;
...
void func_295(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x8800
{
	int i;
...
BOOL func_296(int iParam0, int iParam1) // Position - 0x889E
{
	return iParam0 && iParam1 != false;
}

BOOL func_297(var uParam0) // Position - 0x88AD
{
	return func_296(*uParam0, 2);
}

int func_298(int iParam0) // Position - 0x88BD
{
	return NETWORK::GET_TIME_DIFFERENCE(iParam0, NETWORK::GET_NETWORK_TIME_ACCURATE());
}

void func_299(var uParam0, int iParam1) // Position - 0x88CF
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_300(var uParam0, int iParam1) // Position - 0x88E0
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

Hash func_301(Hash hParam0) // Position - 0x88F5
{
	return hParam0;
}

BOOL func_302(Hash hParam0, Hash hParam1) // Position - 0x88FF
{
...
const char* func_304(var uParam0, int iParam1) // Position - 0x8985
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
...
int func_305(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12, BOOL bParam13, BOOL bParam14, var uParam15, var uParam16) // Position - 0x89BB
{
	var unk;
	var unk14;
	int num;
...
int func_306(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, int iParam15, int iParam16, int iParam17, var uParam18, var uParam19) // Position - 0x8A48
{
	var unk;
	var unk14;
	int num;
...
int func_307(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, BOOL bParam12, BOOL bParam13) // Position - 0x8AE7
{
	var unk;
	var unk14;
	int num;
...
int func_308(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14, int iParam15, int iParam16) // Position - 0x8B63
{
	var unk;
	var unk14;
	int num;
...
int func_309(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12, BOOL bParam13, BOOL bParam14) // Position - 0x8BF1
{
	var unk;
	var unk14;
	int num;
...
int func_310(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, int iParam12, int iParam13, int iParam14) // Position - 0x8C73
{
	var unk;
	var unk14;
	int num;
...
int func_311(const char* sParam0, const char* sParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x8CF0
{
	var unk;
	var unk14;
	int num;
...
BOOL func_312(Hash hParam0) // Position - 0x8D56
{
	return hParam0 != 0;
}

int func_313(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8D62
{
	var unk;
	int num;
	int i;
...
BOOL func_314(Hash hParam0) // Position - 0x8DFD
{
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_315(Hash hParam0, int iParam1, Hash hParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x8E17
{
	var unk;
	int num;
	int num2;
			...
			else
			{
				if (flag)
				{
					if (func_399(unk[i /*2*/]) || func_400(unk[i /*2*/]))
					{
						...
						if (bParam5)
							num6 = func_401(7, unk[i /*2*/], &EntityIndex);
...
BOOL func_316(Any* panParam0, Hash hParam1, Any* panParam2, BOOL bParam3, int iParam4) // Position - 0x9017
{
	var outGuid;
...
Hash func_317(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x9065
{
...
BOOL func_318(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x90E4
{
...
BOOL func_319(int iParam0, int iParam1, Player plParam2) // Position - 0x9182
{
	if (plParam2 == 255)
...
BOOL func_320(Any* panParam0, int iParam1, int iParam2) // Position - 0x91B7
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_321() // Position - 0x91EE
{
	return Global_1102813.f_3672;
}

void func_322(int iParam0, var uParam1, var uParam2) // Position - 0x91FD
{
...
void func_323(Any* panParam0, var uParam1) // Position - 0x926B
{
...
int func_324(var uParam0, var uParam1) // Position - 0x92A2
{
	int num;
...
float func_325(Player plParam0, BOOL bParam1) // Position - 0x92DD
{
	Player player;
...
BOOL func_326(Player plParam0) // Position - 0x937D
{
...
BOOL func_327(Player plParam0) // Position - 0x939A
{
...
BOOL func_328(Player plParam0) // Position - 0x93B7
{
...
BOOL func_329(Player plParam0) // Position - 0x93D4
{
	if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0))
	{
		func_408(plParam0);
...
BOOL func_330(int iParam0, var uParam1, Any* panParam2) // Position - 0x9438
{
	if (!func_158(iParam0))
		return false;
...
void func_332(Hash hParam0) // Position - 0x9568
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(hParam0))
		return;
...
struct<5> func_335(int iParam0) // Position - 0x97E5
{
	Player Plr;
	int num;

	Plr = func_22();
	num.f_1 = func_51(Plr, true);
	num.f_2 = func_64(Plr, true);
	num = iParam0;

	if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr))
		num.f_3 = { func_412(Plr) };

	return num;
}

BOOL func_336(int iParam0, int iParam1) // Position - 0x9826
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_337(int iParam0) // Position - 0x983E
{
...
BOOL func_338(int iParam0) // Position - 0x9855
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_339(int iParam0, int iParam1) // Position - 0x9921
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_340(int iParam0) // Position - 0x993A
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_341() // Position - 0x994D
{
	if (!func_361())
		return false;
...
BOOL func_342(int iParam0) // Position - 0x9968
{
...
Hash func_343(int iParam0) // Position - 0x9987
{
	if (!func_342(iParam0))
		return 0;
...
Hash func_344(int iParam0, BOOL bParam1) // Position - 0x99A8
{
	Hash hash;
	Hash xp;
...
BOOL func_345(Hash hParam0, int iParam1) // Position - 0x9A67
{
	if (hParam0 == 0)
		return false;
...
BOOL func_346(Hash hParam0) // Position - 0x9A81
{
...
BOOL func_347(BOOL bParam0) // Position - 0x9A97
{
	if (func_38() == -1)
		return true;
...
BOOL func_348(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x9AB5
{
	*uParam1 = 0;
...
struct<17> func_349(Hash hParam0, var uParam1) // Position - 0x9B22
{
	var unk;
...
int func_350(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x9B75
{
	int num;
...
void func_351(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x9BDF
{
	int i;
...
struct<4> func_352(BOOL bParam0) // Position - 0x9C5D
{
	int num;
...
struct<4> func_353(BOOL bParam0) // Position - 0x9CFD
{
	int num;
...
int func_354(Hash hParam0, BOOL bParam1) // Position - 0x9D9E
{
...
BOOL func_355(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x9DD5
{
	var unk;
...
struct<4> func_356(BOOL bParam0) // Position - 0x9DF6
{
	int num;
...
int func_357(Hash hParam0) // Position - 0x9E60
{
	var unk;
...
BOOL func_358(Hash hParam0, int iParam1) // Position - 0x9E8B
{
	Hash hash;
	int num;
	int i;
...
BOOL func_359(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x9EF8
{
	return func_405(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_360(Hash hParam0, BOOL bParam1) // Position - 0x9F0E
{
	int num;
...
BOOL func_362() // Position - 0x9F5B
{
	return func_423(func_221(0));
}

BOOL func_363(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x9F6C
{
	if (!func_284(iParam0))
		return false;
...
BOOL func_364(int iParam0, var uParam1) // Position - 0x9FA4
{
	*uParam1 = func_424(iParam0, true);
	return *uParam1 != 0;
}

BOOL func_365(int iParam0, var uParam1) // Position - 0x9FBB
{
	*uParam1 = func_425(iParam0, true, false);
	return *uParam1 != 0;
}

BOOL func_366(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x9FD3
{
	var unk;
	int num;
	int i;
...
Hash func_367(Hash hParam0, BOOL bParam1) // Position - 0xA098
{
	int i;
	int num;
	var unk;
...
Hash func_368(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA12B
{
	int i;
	int num;
	var unk;
...
void func_369(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0xA28A
{
	int i;
	int j;
	int k;
...
BOOL func_370(Hash hParam0) // Position - 0xA460
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

void func_371(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0xA46E
{
	int i;
	int j;
	int k;
...
BOOL func_372(var uParam0) // Position - 0xA644
{
...
BOOL func_373(int iParam0, Hash hParam1) // Position - 0xA68A
{
	var unk;
	int num;
	Hash unlockHash;
...
BOOL func_374(int iParam0, Hash hParam1) // Position - 0xA7D3
{
	int num;
	int num2;
	var unk;
...
BOOL func_375(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0xA88D
{
...
BOOL func_376(int* piParam0, Hash hParam1) // Position - 0xA8A6
{
	Hash action;
...
BOOL func_377(int iParam0, Hash hParam1, Any* panParam2) // Position - 0xA909
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

BOOL func_378(int* piParam0, BOOL bParam1) // Position - 0xA920
{
...
BOOL func_379(Hash hParam0) // Position - 0xA941
{
	Hash hash;
...
BOOL func_380(int* piParam0, Hash hParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0xA960
{
	int num;
	var unk;
	var unk2;
...
BOOL func_381(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5) // Position - 0xAA0B
{
	var unk;
...
BOOL func_382(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0xAA5C
{
...
BOOL func_383(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, Hash hParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0xAA97
{
	var unk;
	Hash hash;
	int num;
...
BOOL func_384(int* piParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0xAB4E
{
	int num;
	int num2;
	int num3;
...
struct<4> func_385() // Position - 0xAC96
{
	var unk;
...
BOOL func_386(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0xACA2
{
	if (panParam1->f_9 < 1)
		return false;
...
BOOL func_387(int iParam0, Hash hParam1, Any* panParam2) // Position - 0xAD22
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

BOOL func_388(int iParam0, Hash hParam1, Any* panParam2) // Position - 0xAD39
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

void func_389(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xAD50
{
	int i;
...
int func_390(int iParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAE2C
{
	var unk;
	int num;
	int i;
...
BOOL func_391(Hash hParam0) // Position - 0xAE98
{
	switch (hParam0)
	{
		case -1843707398:
...
BOOL func_392(int iParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAEDD
{
	var unk;
	int num;
	int i;
...
BOOL func_394(int iParam0) // Position - 0xB000
{
	if (iParam0 < 0)
		return false;
...
BOOL func_395(int iParam0) // Position - 0xB02D
{
	if (iParam0 < 0)
		return false;
...
int func_396(int iParam0, Hash hParam1) // Position - 0xB050
{
...
int func_397(Hash hParam0, int iParam1) // Position - 0xB075
{
	var unk;
	var guid;
	int inventoryItemCountWithGuid;
...
int func_398(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB0D0
{
...
BOOL func_399(Hash hParam0) // Position - 0xB192
{
	if (!func_188(hParam0, 0))
		return false;
...
BOOL func_400(Hash hParam0) // Position - 0xB1C1
{
	if (!func_188(hParam0, 0))
		return 0;
...
int func_401(int iParam0, Hash hParam1, var uParam2) // Position - 0xB1EB
{
	Ped EntityIndex;
	ItemSet itemSet;
	int itemsetSize;
...
int func_402(Hash hParam0, int iParam1) // Position - 0xB318
{
	int num;
	int num2;
	int num3;
...
int func_403(int iParam0, Hash hParam1) // Position - 0xB435
{
	Ped EntityIndex;
	Hash hash;
	int num;
...
int func_404(Hash hParam0) // Position - 0xB4D3
{
	int num;
...
BOOL func_405(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xB525
{
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(panParam0))
		return 0;
...
BOOL func_406(int iParam0) // Position - 0xB55F
{
	return iParam0 >= 0 && iParam0 <= 12;
}

int func_407(var uParam0, var uParam1) // Position - 0xB575
{
	var unk;
	var unk4;
	int num;
...
void func_408(Player plParam0) // Position - 0xB61C
{
	Player player;
...
void func_409(Player plParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0xB688
{
	Player player;
	int num;
	Player i;
		...
		for (i = 0; i <= 31; i = i + 1)
		{
			...
			if (i != Global_1295666 && NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr))
			{
				...
				else if (GANG::NETWORK_IS_IN_SAME_GANG(Plr, plParam0))
				{
					...
					if (i != player)
						func_409(Plr, iParam1, 0, true, false, 0);
				}
			}
		}
...
void func_410(Any* panParam0) // Position - 0xB7C3
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
void func_411(Hash hParam0) // Position - 0xB7D9
{
	int feedMessage;
...
struct<2> func_412(Player plParam0) // Position - 0xB802
{
	var gamerHandle;
...
Hash func_413(int iParam0) // Position - 0xB816
{
	switch (iParam0)
	{
		case 0:
...
Hash func_414(int iParam0) // Position - 0xB9AF
{
...
Hash func_415(int iParam0) // Position - 0xB9DB
{
	switch (iParam0)
	{
		case 0:
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_416(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0xBB74
{
	int i;
...
BOOL func_417(Hash hParam0, Any* panParam1) // Position - 0xBC8B
{
	int num;
...
int func_418(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0xBE61
{
	if (bParam0)
	{
...
int func_419(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0xBEAA
{
	if (bParam0)
	{
		func_295(iParam1, 1, 0, 0);
...
BOOL func_421(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0xBEE3
{
	int inventoryId;
...
BOOL func_422(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xBF28
{
...
BOOL func_423(var uParam0, var uParam1) // Position - 0xBF5B
{
	return func_470(uParam0, 5, 8);
}

Hash func_424(int iParam0, BOOL bParam1) // Position - 0xBF6E
{
	int i;
	int num;
	var unk;
...
Hash func_425(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC003
{
	int i;
	int num;
	var unk;
...
BOOL func_426(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0xC162
{
	var unk;
	int num;
	int i;
...
BOOL func_427(Hash hParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0xC1F0
{
	var unk;
	int i;
...
Hash func_428(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC274
{
	int num;
...
BOOL func_429(Hash hParam0) // Position - 0xC310
{
	return func_357(hParam0) == 1946043663;
}

BOOL func_430(Hash hParam0) // Position - 0xC324
{
	return func_357(hParam0) == -126813555;
}

int func_431(int iParam0) // Position - 0xC338
{
	return iParam0 / 100;
}

void func_432(const char* sParam0) // Position - 0xC345
{
	Global_1915656.f_22470 = func_472(sParam0, 10000, 0, 0, 0, true);
	return;
}

BOOL func_433(int* piParam0, Hash hParam1) // Position - 0xC361
{
...
BOOL func_434(int* piParam0) // Position - 0xC37F
{
	Hash action;
...
int func_435(Hash hParam0, Any anParam1, var uParam2, var uParam3, var uParam4) // Position - 0xC41C
{
	Hash hash;
	Hash hash2;
	int i;
...
BOOL func_436(Hash hParam0, Hash hParam1, int iParam2) // Position - 0xC501
{
	var unk;
	var unk48;
...
BOOL func_437(Hash hParam0) // Position - 0xC5CD
{
	BOOL flag;
	Hash weaponUnlock;
...
int func_438(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC617
{
	if (!func_188(hParam0, 0))
	{
		if (func_345(func_301(hParam0), 2))
...
BOOL func_439(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3) // Position - 0xC68B
{
	var unk;
...
int func_440(int* piParam0, Hash hParam1) // Position - 0xC6EA
{
	int num;
	int i;
	int numOfItems;
...
BOOL func_441(Hash hParam0, BOOL bParam1) // Position - 0xC754
{
...
BOOL func_442(Hash hParam0, BOOL bParam1) // Position - 0xC7CD
{
	int num;
	var unk;
...
int func_443(int* piParam0, Hash hParam1) // Position - 0xC817
{
	int num;
	int i;
	int numOfItems;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_444(Hash hParam0, int iParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0xC890
{
	var unk;
	int num;
	int num2;
...
void func_445(int iParam0) // Position - 0xC976
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
BOOL func_446(int iParam0) // Position - 0xC999
{
	if (iParam0 < 0)
		return false;
...
int func_448(int iParam0) // Position - 0xC9D7
{
	switch (iParam0)
	{
		case 0:
...
Hash func_449(Hash hParam0, int iParam1) // Position - 0xCA08
{
	int num;
	var unk;
	Hash hash;
...
int func_450(Hash hParam0, BOOL bParam1) // Position - 0xCA82
{
	var unk;
	int num;
	int num2;
...
struct<4> func_451(Hash hParam0, BOOL bParam1) // Position - 0xCAE1
{
	var unk;
...
int func_452(int iParam0) // Position - 0xCB06
{
	if (iParam0 == 7)
...
BOOL func_453(int iParam0) // Position - 0xCB1F
{
	iParam0 = func_452(iParam0);
...
Ped func_454(int iParam0) // Position - 0xCB57
{
	iParam0 = func_452(iParam0);
...
BOOL func_455(Entity eParam0) // Position - 0xCB83
{
...
int func_456(Hash hParam0, int iParam1) // Position - 0xCBE6
{
	var unk;
	int num;
	int i;
...
struct<10> func_457(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0xCC30
{
	int num;
...
BOOL func_458(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0xCD04
{
...
Hash func_459(int iParam0, int iParam1) // Position - 0xCD25
{
	int num;
...
Hash func_460(Hash hParam0) // Position - 0xCD68
{
	int num;
...
int func_461(Hash hParam0) // Position - 0xD0DA
{
...
int func_462(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xD11F
{
	var unk;
	int num;
	int i;
...
int func_463(int iParam0) // Position - 0xD173
{
	if (iParam0 < 0)
		return 0;
...
void func_464(Player plParam0) // Position - 0xD194
{
...
BOOL func_465(Player plParam0, int iParam1, int iParam2) // Position - 0xD1CF
{
...
void func_466(Any* panParam0, var uParam1) // Position - 0xD260
{
	if (!SCRIPTS::_IS_ANY_PLAYER_BIT_SET(&uParam1))
		return;
...
BOOL func_467(int iParam0) // Position - 0xD2A0
{
	return iParam0 != 0;
}

BOOL func_468(Any* panParam0) // Position - 0xD2AC
{
...
BOOL func_469(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xD2C8
{
...
BOOL func_470(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0xD2E0
{
	int num;
...
BOOL func_471(Hash hParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0xD31B
{
	var unk;
	int i;
...
int func_472(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xD39F
{
	int num;
	var unk13;
	int num2;
...
BOOL func_473(Hash hParam0, Hash hParam1, Any anParam2) // Position - 0xD3DA
{
	int i;
	int num;
...
BOOL func_474(Hash hParam0) // Position - 0xD41A
{
	return func_291(hParam0) == joaat("WEAPON");
}

int func_475(Hash hParam0, BOOL bParam1) // Position - 0xD42E
{
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_476(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xD4E6
{
	int i;
...
void func_477(var uParam0) // Position - 0xD576
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_478(Hash hParam0, var uParam1, var uParam2) // Position - 0xD5D1
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_479(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD7DD
{
	Hash hash;
...
void func_480(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD8BB
{
	if (INVENTORY::_INVENTORY_IS_GUID_VALID(&uParam1))
		uParam0->f_9 = { uParam1 };
...
BOOL func_481(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0xD8D6
{
...
int func_482(int iParam0) // Position - 0xD8FB
{
	if (iParam0 < 0)
		return 0;
...
void func_483(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xD91C
{
	return;
}

int func_484(int iParam0, var uParam1) // Position - 0xD924
{
	if (iParam0 == 2)
...
void func_485(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0xD93E
{
	int i;
	int j;
	int k;
