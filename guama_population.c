...
int func_3() // Position - 0x20D
{
	return Global_1572887.f_14;
}

BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x21B
{
	int i;
...
void func_5() // Position - 0x2FB
{
	return;
}

void func_6(Volume volParam0) // Position - 0x303
{
...
void func_7(Volume volParam0) // Position - 0x344
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
