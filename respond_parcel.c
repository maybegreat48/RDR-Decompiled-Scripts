...
void func_1(var uParam0, int iParam1) // Position - 0x152
{
	*uParam0 = iParam1;
	return;
}

int func_2(Ped pedParam0, int iParam1) // Position - 0x15F
{
...
int func_3(var uParam0) // Position - 0x176
{
	return *uParam0;
}

void func_4(var uParam0) // Position - 0x181
{
	int i;
...
int func_5(int iParam0, var uParam1) // Position - 0x1BB
{
	if (!func_12(iParam0))
		return 0;
...
void func_6(var uParam0) // Position - 0x1E8
{
	int num;
	int num2;
...
BOOL func_7(int iParam0, BOOL bParam1) // Position - 0x2AD
{
	int num;
...
void func_8(var uParam0, BOOL bParam1) // Position - 0x2E0
{
	int num;
	int num2;
...
void func_9(var uParam0) // Position - 0x34B
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_10(int iParam0) // Position - 0x357
{
	if (iParam0 < 0)
		return false;
...
void func_11(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x396
{
	int num;
...
BOOL func_12(int iParam0) // Position - 0x3EA
{
	return iParam0 > -1 && iParam0 < 26;
}

BOOL func_13(int iParam0) // Position - 0x400
{
	return iParam0 != 0;
}

BOOL func_14(int iParam0) // Position - 0x40C
{
	int num;
...
int func_15(int iParam0, var uParam1) // Position - 0x45B
{
	var unk;
...
int func_16(int iParam0, var uParam1) // Position - 0x48A
{
	var unk;
...
int func_17(char* sParam0, Hash hParam1, Ped pedParam2, int iParam3, int iParam4, BOOL bParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, BOOL bParam15, int iParam16) // Position - 0x4B9
{
	int i;
	int num;
...
int func_18(int iParam0) // Position - 0x590
{
	return iParam0;
}

int func_19(int iParam0) // Position - 0x59A
{
	int num;
	int i;
...
void func_20(int iParam0, int iParam1) // Position - 0x5DF
{
	iParam0->f_2 = iParam0->f_2 || iParam1;
	return;
}

void func_21(int iParam0, var uParam1, BOOL bParam2) // Position - 0x5F2
{
	int num;
	int i;
	Hash hash;
...
void func_22(int iParam0) // Position - 0x67F
{
	if (!func_31(iParam0))
		return;
...
BOOL func_23(int iParam0, int iParam1) // Position - 0x732
{
	return iParam0->f_2 && iParam1 != false;
}

BOOL func_24(int iParam0, int iParam1) // Position - 0x743
{
	if (iParam0 < 0)
		return false;
...
int func_26(int iParam0, int iParam1, var uParam2, Hash* phParam3, int* piParam4) // Position - 0xA7E
{
	var unk;
...
int func_27(int iParam0, int iParam1, var uParam2, Hash* phParam3, int* piParam4) // Position - 0xAE6
{
	var unk;
...
int func_28(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, Hash hParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0xB4E
{
	int value;
	Hash TypeOfWeapon;
	Hash lootTableKey;
	...
	if (!flag)
	{
		if (func_40(hParam0, -1588156645))
		{
			bParam2 = true;
			flag2 = true;
			TypeOfWeapon = func_46(func_45(hParam0, true), false);
		
			if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
			{
				if (func_47() == -1)
					func_48(TypeOfWeapon);
			
				if (func_49(false) && func_50(TypeOfWeapon, 0, false, true, 0, false, hParam5, false))
				{
...
BOOL func_29() // Position - 0x1602
{
	return Global_1940252.f_2;
}

void func_30(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1610
{
...
BOOL func_31(int iParam0) // Position - 0x164A
{
	return func_24(iParam0, 2);
}

void func_32(int iParam0, BOOL bParam1) // Position - 0x1659
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_33(int iParam0, BOOL bParam1) // Position - 0x16B1
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_34(int iParam0, int iParam1) // Position - 0x16DA
{
	if (iParam0 < 0)
		return;
...
BOOL func_35(Hash hParam0, int iParam1) // Position - 0x1702
{
	if (hParam0 == 0)
		return false;
...
BOOL func_36(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x171C
{
	if (func_47() == -1)
	{
...
BOOL func_37(Hash hParam0, var uParam1, int iParam2) // Position - 0x1773
{
	var unk;
	int num;
	int num2;
...
void func_38(Hash hParam0, BOOL bParam1) // Position - 0x1811
{
	if (bParam1)
		return;
...
int func_39(Hash hParam0) // Position - 0x18C2
{
	var unk;
...
BOOL func_40(Hash hParam0, Hash hParam1) // Position - 0x18ED
{
	if (!func_35(hParam0, 0))
...
BOOL func_41(Hash hParam0, int iParam1) // Position - 0x192E
{
	if (!func_35(hParam0, 0))
		return false;
...
BOOL func_42(int iParam0) // Position - 0x194D
{
	if (!func_95(iParam0))
		return false;
...
void func_43(int iParam0) // Position - 0x1969
{
	if (!func_95(iParam0))
		return;
...
void func_44(Hash hParam0) // Position - 0x198A
{
...
Hash func_45(Hash hParam0, BOOL bParam1) // Position - 0x1A0F
{
	Hash hash;
...
Hash func_46(Hash hParam0, BOOL bParam1) // Position - 0x1C05
{
	if (!func_35(hParam0, 0))
		return 0;
...
int func_47() // Position - 0x1C31
{
	return Global_1572887.f_14;
}

void func_48(Hash hParam0) // Position - 0x1C3F
{
	Hash weaponUnlock;
...
BOOL func_49(BOOL bParam0) // Position - 0x1C79
{
	if (func_47() == -1)
		return true;
...
BOOL func_50(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, Hash hParam6, BOOL bParam7) // Position - 0x1C97
{
	var unk;
	var unk6;
	var unk28;
...
BOOL func_51(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1DC7
{
	if (iParam1 < 1)
		return true;
...
BOOL func_52(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1E02
{
	int num;
	var unk;
	var unk6;
...
BOOL func_53(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1E71
{
	Hash TypeOfWeapon;
	var unk;
	int num;
	...
	TypeOfWeapon = func_46(hParam0, false);
	...
	if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
	{
		if (func_47() == -1)
		{
			...
			if (hParam1 == 1248274121)
				func_112(TypeOfWeapon);
		}
	
		if (!func_90(hParam0, &unk, 1, false, false, -1, false))
		{
			func_85(hParam0, 1, false, uParam2, hParam1);
			num = func_113(TypeOfWeapon);
		
			if (WEAPON::_IS_WEAPON_SNIPER(TypeOfWeapon))
			{
				func_50(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (TypeOfWeapon == joaat("weapon_fishingrod") || WEAPON::_IS_WEAPON_BINOCULARS(TypeOfWeapon))
			{
				func_50(TypeOfWeapon, 0, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::_IS_WEAPON_LASSO(TypeOfWeapon))
			{
				func_50(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::IS_WEAPON_MELEE_WEAPON(TypeOfWeapon))
			{
				if (TypeOfWeapon == joaat("weapon_melee_knife_john") && !func_114())
					return false;
			
				if (WEAPON::SHOULD_WEAPON_BE_DISCARDED_WHEN_SWAPPED(hParam0))
				{
				}
				else if (!func_115(TypeOfWeapon))
				{
					func_50(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
				}
				else
				{
					func_50(TypeOfWeapon, WEAPON::GET_WEAPON_CLIP_SIZE(TypeOfWeapon) * 4, bParam3, bParam4, 0, false, hParam1, false);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(TypeOfWeapon))
			{
				weaponHash = func_116(Global_33, 2, false, true);
			
				if (func_102(weaponHash) && !Global_26688 && weaponHash != TypeOfWeapon && !func_67(joaat("upgrade_offhand_holster"), 1) && bParam4)
					WEAPON::_SEND_WEAPON_TO_INVENTORY(Global_33, weaponHash);
			
				if (func_102(weaponHash) && func_67(joaat("upgrade_offhand_holster"), 1))
					if (!func_50(TypeOfWeapon, num, bParam3, bParam4, 3, true, hParam1, false))
						return false;
				else if (!func_50(TypeOfWeapon, num, bParam3, bParam4, 0, true, hParam1, false))
					return false;
			}
			else if (!func_50(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false))
			{
				return false;
			}
		}
...
BOOL func_54(Hash hParam0) // Position - 0x207F
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_55(Hash hParam0, var uParam1, Hash hParam2) // Position - 0x208D
{
	int num;
	int weaponClipSize;
	int ReturnMaxAmmo;
...
struct<2> func_56(int iParam0) // Position - 0x218B
{
	var unk;
...
void func_57(var uParam0, var uParam1, int iParam2) // Position - 0x219D
{
...
struct<2> func_58(int iParam0, int iParam1) // Position - 0x21BA
{
	int num;
...
void func_59(int iParam0, BOOL bParam1) // Position - 0x21D0
{
	int num;
	int num2;
...
BOOL func_60() // Position - 0x21FD
{
	return false;
}

int func_61(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, int iParam5, BOOL bParam6, int iParam7) // Position - 0x2206
{
	int num;
...
void func_62(Hash hParam0) // Position - 0x224D
{
	return;
}

void func_63(Hash hParam0) // Position - 0x2255
{
	return;
}

void func_64(Hash hParam0) // Position - 0x225D
{
	return;
}

void func_65(Hash hParam0) // Position - 0x2265
{
	return;
}

void func_66() // Position - 0x226D
{
...
BOOL func_67(Hash hParam0, int iParam1) // Position - 0x2291
{
	int num;
...
void func_68(Hash hParam0, var uParam1) // Position - 0x2314
{
	var unk;
...
Hash func_69(Hash hParam0, BOOL bParam1) // Position - 0x2326
{
	Hash hash;
...
void func_70(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x2354
{
	int num;
	int num2;
...
void func_71(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x23B4
{
	int num;
	int num2;
...
void func_72(var uParam0) // Position - 0x242F
{
	switch (*uParam0)
	{
...
void func_73(Hash hParam0) // Position - 0x2473
{
	if (func_47() != -1)
		return;
...
int func_75(Hash hParam0, int iParam1) // Position - 0x24A2
{
	var unk;
	var unk5;
...
struct<2> func_76(Hash hParam0) // Position - 0x24D6
{
	var unk;
	var unk3;
...
void func_77(Hash hParam0) // Position - 0x256A
{
	switch (hParam0)
	{
...
void func_78(Hash hParam0, int iParam1) // Position - 0x2583
{
	char* str;
...
void func_79(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x25BF
{
	BOOL flag;
	int value;
	var unk;
	...
	else if (!func_140(hParam0, &InputString, num3, num2, 0, joaat("ui_itemviewer")))
	{
	...
	str3 = func_148(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash), value), num5);
	...
	if (num4 == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || num4 == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || num4 == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || num4 == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str3 = MISC::VAR_STRING(0, func_149(hParam0, -442898163));
	...
	if (num4 == -126813555 || num4 == 1946043663)
	{
		...
		if (func_150(hParam0, &unk7))
			str3 = func_152(func_151(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_135(str3, InputString.f_1, MISC::GET_HASH_KEY(InputString), num6, num5, str2, str, 0, true);
	return;
}

BOOL func_80() // Position - 0x2A8A
{
...
void func_81(int iParam0) // Position - 0x2AE9
{
	Global_1940252.f_11 = iParam0;
	return;
}

void func_82(int iParam0) // Position - 0x2AF9
{
	Global_1940252.f_10 = iParam0;
	return;
}

BOOL func_83(Hash hParam0) // Position - 0x2B09
{
	return func_39(hParam0) == joaat("WEAPON");
}

BOOL func_84(Hash hParam0) // Position - 0x2B1D
{
	var unk;
...
void func_85(Hash hParam0, int iParam1, BOOL bParam2, var uParam3, Hash hParam4) // Position - 0x2B62
{
	Hash TypeOfWeapon;
	...
	if (bParam2 || !func_101(TypeOfWeapon))
	{
		if (bParam2 || !WEAPON::HAS_PED_GOT_WEAPON(Global_33, TypeOfWeapon, 0, false) && func_126(hParam0, false, false, false) == 0)
		{
			if (func_47() == -1)
				func_48(TypeOfWeapon);
...
void func_86(Hash hParam0, var uParam1) // Position - 0x2C0C
{
...
struct<5> func_87(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2C31
{
	var unk;
	int num;
	var unk6;
...
int func_88(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2FA5
{
	if (!func_35(hParam0, 0))
	{
...
int func_89(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3019
{
...
BOOL func_90(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x304C
{
	var unk;
	var unk5;
	int num;
...
int func_92(Hash hParam0, int iParam1) // Position - 0x31E5
{
	var unk;
	int num;
	int i;
...
Hash func_93(Hash hParam0) // Position - 0x322F
{
	return hParam0;
}

int func_94(Hash hParam0, Hash hParam1) // Position - 0x3239
{
...
BOOL func_95(int iParam0) // Position - 0x326F
{
	if (iParam0 == 0)
		return false;
...
BOOL func_96(int iParam0) // Position - 0x3282
{
	int num;
	int num2;
	int offset;
...
void func_97(int iParam0) // Position - 0x32AC
{
	int num;
	int num2;
	int BitIndex;
...
void func_98(int iParam0) // Position - 0x32E6
{
	switch (iParam0)
	{
		case 1:
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x3862
{
	var unk;
	var unk13;
	var unk26;
...
BOOL func_100(Hash hParam0) // Position - 0x3892
{
	Hash weaponUnlock;
...
BOOL func_101(Hash hParam0) // Position - 0x38BA
{
	Hash weaponUnlock;
...
BOOL func_102(Hash hParam0) // Position - 0x38E2
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_103(BOOL bParam0) // Position - 0x38FD
{
	if (func_47() == -1)
	{
...
BOOL func_104(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x393E
{
	return func_164(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_105(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x3959
{
	var unk;
...
struct<4> func_106(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x397A
{
	var outGuid;
...
BOOL func_107(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x39AB
{
	var unk;
	int num;
	var unk15;
...
void func_108(Hash hParam0, int iParam1) // Position - 0x3AC9
{
	...
	{
		AmmoInClip = func_181(WEAPON::GET_WEAPON_CLIP_SIZE(hParam0), iParam1);
...
int func_109(Hash hParam0, int iParam1) // Position - 0x3B3B
{
	if (iParam1 == 0)
		return 0;
...
int func_110(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x3B67
{
	int num;
	var guid2;
	var guid1;
...
int func_111(Hash hParam0, Any* panParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x3BE3
{
	if (!func_35(hParam0, 0))
		return 0;
...
void func_112(Hash hParam0) // Position - 0x3C4B
{
	char* decoratorName;
	char* decoratorName2;
	int value;
...
int func_113(Hash hParam0) // Position - 0x3D1A
{
	int num;
	int pedAmmoByType;
...
BOOL func_114() // Position - 0x3D96
{
	return false;
}

BOOL func_115(Hash hParam0) // Position - 0x3D9F
{
	return WEAPON::_IS_AMMO_VALID(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0));
}

Hash func_116(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3DB1
{
	int ReturnWeaponType;
...
int func_117(Hash hParam0) // Position - 0x3DD7
{
	Hash weaponTypeFromAmmoType;
...
void func_118(int iParam0, var uParam1, var uParam2) // Position - 0x3E43
{
	int num;
...
BOOL func_119(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3E5F
{
...
void func_120(int iParam0, int iParam1) // Position - 0x3F01
{
	int Variable;
...
int func_121(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x3F25
{
	float num;
	int num2;
	int i;
...
void func_122(int iParam0, const char* sParam1, int iParam2, BOOL bParam3) // Position - 0x3FF5
{
	if (iParam0 == 0)
		return;
...
void func_123(int iParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x404A
{
	int num;
	int value;
	int num2;
...
BOOL func_124(Hash hParam0, int iParam1) // Position - 0x4125
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_125(Hash hParam0) // Position - 0x41CD
{
	int num;
	int num2;
	int num3;
...
int func_126(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4289
{
...
void func_127(Hash hParam0, var uParam1, var uParam2) // Position - 0x434B
{
	*uParam1 = 0;
	*uParam2 = 0;
...
Hash func_128(Hash hParam0, BOOL bParam1) // Position - 0x4557
{
	switch (hParam0)
	{
...
BOOL func_129(int iParam0, int iParam1) // Position - 0x45F9
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

void func_130(var uParam0, int iParam1) // Position - 0x4612
{
	BOOL flag;
	int i;
...
int func_131(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x473E
{
	var unk;
	int num;
...
struct<2> func_132(int iParam0) // Position - 0x47AD
{
	int num;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x47BD
{
	switch (iParam0)
	{
		case 0:
...
Hash func_134(Hash hParam0) // Position - 0x4894
{
	Hash num;
...
int func_135(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x48BE
{
	int num;
	var unk13;
	int num2;
...
BOOL func_136() // Position - 0x4921
{
	return !Global_1913444;
}

void func_137(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x492E
{
	int i;
...
var func_138(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4A51
{
	if (bParam0)
		return uParam1;
...
int func_139(Hash hParam0) // Position - 0x4A68
{
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_140(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x4A93
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_141(Hash hParam0) // Position - 0x4B86
{
...
BOOL func_142(Hash hParam0) // Position - 0x4C82
{
...
BOOL func_143(int iParam0) // Position - 0x4D01
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_144(Hash hParam0) // Position - 0x4D28
{
	var unk;
	int i;
...
Hash func_145(Hash hParam0) // Position - 0x4D96
{
	int num;
	var unk;
	int collectionId;
...
BOOL func_146(Hash hParam0, Hash hParam1) // Position - 0x4E1B
{
	if (hParam0 == 0)
		return false;
...
int func_147(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x4E4C
{
	var unk;
...
const char* func_148(const char* sParam0, int iParam1) // Position - 0x4EAB
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_149(Hash hParam0, int iParam1) // Position - 0x4EC5
{
	 num;
...
BOOL func_150(Hash hParam0, char* sParam1) // Position - 0x4EE3
{
	...
	TEXT_LABEL_ASSIGN_STRING(&StringToTest, func_215(hParam0), 128);
...
const char* func_151(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x4F60
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_152(const char* sParam0, int iParam1) // Position - 0x4F74
{
...
Ped func_153(int iParam0) // Position - 0x4FAA
{
	return PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::GET_PLAYER_INDEX());
}

int func_154(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4FBA
{
	int num;
...
void func_155(int iParam0) // Position - 0x4FEF
{
...
struct<4> func_156(BOOL bParam0) // Position - 0x5074
{
	int num;
...
struct<4> func_157(BOOL bParam0) // Position - 0x5114
{
	int num;
...
BOOL func_158(Hash hParam0, BOOL bParam1) // Position - 0x51B5
{
...
struct<4> func_159(BOOL bParam0) // Position - 0x51EC
{
	int num;
...
BOOL func_160(Hash hParam0, int iParam1) // Position - 0x5256
{
	Hash hash;
	int num;
	int i;
...
BOOL func_161(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x52C3
{
	return func_221(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_162(Hash hParam0, int iParam1) // Position - 0x52D9
{
	if (hParam0 == 0)
		return false;
...
int func_163(var uParam0) // Position - 0x52F3
{
...
int func_164(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x537D
{
...
BOOL func_165(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x53FC
{
...
void func_166(BOOL bParam0) // Position - 0x5425
{
...
void func_167(int iParam0) // Position - 0x5463
{
...
void func_168(BOOL bParam0) // Position - 0x54D1
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_169(BOOL bParam0) // Position - 0x550B
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_170(BOOL bParam0) // Position - 0x5545
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_171(BOOL bParam0) // Position - 0x557F
{
	Hash hash;
...
void func_172(BOOL bParam0) // Position - 0x55A2
{
	int promptType;
	Player player;
...
void func_173(BOOL bParam0) // Position - 0x55E4
{
	int promptType;
	Player player;
...
BOOL func_174() // Position - 0x5626
{
	return true;
}

int func_175(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x5645
{
	int num;
	int num2;
	int num3;
...
int func_176(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x56AB
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_177(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x578C
{
	int inventoryId;
...
BOOL func_178(Hash hParam0) // Position - 0x57D1
{
...
int func_179(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x57E7
{
	int num;
...
void func_180(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x5851
{
	int i;
...
int func_181(int iParam0, int iParam1) // Position - 0x58CF
{
	if (iParam0 > iParam1)
		return iParam1;
...
int func_182() // Position - 0x58E5
{
	return Global_1902569;
}

void func_183(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x58F1
{
	int num;
	int i;
	int num2;
...
BOOL func_184(Hash hParam0) // Position - 0x5A79
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

BOOL func_185(int iParam0, int iParam1) // Position - 0x5A87
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_186(int iParam0) // Position - 0x5A9F
{
...
BOOL func_187(int iParam0) // Position - 0x5AB6
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_188(int iParam0) // Position - 0x5B82
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_189() // Position - 0x5B95
{
	if (!func_237())
		return false;
...
void func_190(int iParam0, int iParam1) // Position - 0x5BB0
{
	if (iParam0 <= 0)
		return;
...
BOOL func_191() // Position - 0x5BEC
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_192() // Position - 0x5BFD
{
	return DLC::IS_DLC_PRESENT(joaat("dlc_ultimateedition"));
}

Hash func_193(Hash hParam0, int iParam1) // Position - 0x5C0E
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_194(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x5C88
{
...
BOOL func_195(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5CAF
{
	if (iParam2 < 0)
		return false;
...
int func_196(int iParam0) // Position - 0x5CEA
{
	if (iParam0 < 0)
		return 0;
...
int func_197(Hash hParam0) // Position - 0x5D0B
{
	switch (hParam0)
	{
...
int func_198(var uParam0, int iParam1) // Position - 0x5DEE
{
	int i;
...
int func_199(Hash hParam0) // Position - 0x5E2B
{
	int num;
...
int func_200(Hash hParam0, BOOL bParam1) // Position - 0x5E98
{
	var unk;
	int num;
	int num2;
...
struct<4> func_201(Hash hParam0, BOOL bParam1) // Position - 0x5EF7
{
	var unk;
...
void func_202(var uParam0) // Position - 0x5F1C
{
...
void func_203(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x5F54
{
	int i;
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_204(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x600A
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
void func_205(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x6100
{
...
BOOL func_206(Hash hParam0, Hash hParam1) // Position - 0x6131
{
	if (hParam1 == 0)
		return false;
...
int func_207(Hash hParam0) // Position - 0x6158
{
	var unk;
	int num;
...
struct<10> func_208(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x6192
{
	int num;
...
BOOL func_209(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x6266
{
...
BOOL func_210(Hash hParam0) // Position - 0x6287
{
	!func_35(hParam0, 0);
...
int func_211(int iParam0) // Position - 0x62AD
{
	if (iParam0 < 0)
		return 0;
...
int func_212(Hash hParam0, int iParam1) // Position - 0x62CE
{
	var unk;
	int num;
	int num2;
...
char* func_213(Hash hParam0) // Position - 0x631C
{
	Hash labelHash;
...
BOOL func_214(Hash hParam0) // Position - 0x6352
{
...
char* func_215(Hash hParam0) // Position - 0x6380
{
	Hash labelHash;
...
int func_216(Ped pedParam0, Hash hParam1) // Position - 0x63B5
{
	int num;
	int i;
...
int func_217(Hash hParam0, BOOL bParam1) // Position - 0x6413
{
	if (!bParam1 || func_246())
...
struct<4> func_218() // Position - 0x6442
{
	var unk;
...
BOOL func_220(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x646B
{
...
BOOL func_221(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x649E
{
...
BOOL func_222(Hash hParam0) // Position - 0x64D8
{
	return func_40(hParam0, 1279601681);
}

void func_223(int iParam0, int iParam1) // Position - 0x64EB
{
	if (iParam1 == 0)
		return;
...
void func_224(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x651B
{
	int i;
	var unk;
...
BOOL func_225(Hash hParam0, Any* panParam1) // Position - 0x65D6
{
	int num;
...
BOOL func_226(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x67AC
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_227(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x67C3
{
	if (bParam0)
	{
...
int func_228(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x680C
{
	if (bParam0)
	{
		func_248(iParam1, 1, 0, 0);
...
int func_229(int iParam0) // Position - 0x6828
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_230(int iParam0) // Position - 0x684D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_231(int iParam0) // Position - 0x6860
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_232(int iParam0) // Position - 0x6873
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_233(int iParam0) // Position - 0x6886
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_234(int iParam0) // Position - 0x6898
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_235(int iParam0, int iParam1) // Position - 0x68AA
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_236(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x6944
{
...
BOOL func_238() // Position - 0x6990
{
	return Global_1913444.f_127 == 0;
}

struct<18> func_239(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x69A0
{
	Hash hash;
...
void func_240(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x6A7E
{
...
BOOL func_241(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x6A99
{
...
int func_242() // Position - 0x6ABE
{
	return Global_1953292.f_1;
}

BOOL func_243(Any anParam0) // Position - 0x6ACC
{
...
BOOL func_244(Hash hParam0) // Position - 0x6B12
{
...
int func_245(int iParam0, Hash hParam1) // Position - 0x6B3D
{
	var guid;
	int inventoryItemCountWithGuid;
...
BOOL func_247(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x6BCA
{
...
void func_248(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6BE2
{
	int i;
...
var func_249(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6C80
{
	if (bParam0)
		return uParam1;
...
void func_250(var uParam0, int iParam1) // Position - 0x6C97
{
	if (iParam1 < 0)
		return;
...
void func_251(var uParam0, int iParam1) // Position - 0x6D1D
{
...
void func_252(var uParam0, int iParam1) // Position - 0x6D59
{
	int num;
	int num2;
...
void func_253(var uParam0, int iParam1) // Position - 0x6DAC
{
...
void func_254(var uParam0, int iParam1) // Position - 0x6DE7
{
...
void func_255(var uParam0, int iParam1) // Position - 0x6E20
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_256(Hash hParam0, int iParam1) // Position - 0x6E58
{
	int num;
...
struct<4> func_257(int iParam0, Hash hParam1) // Position - 0x6E77
{
	var unk;
...
BOOL func_258(Vehicle veParam0) // Position - 0x6E99
{
...
BOOL func_259(int iParam0, int iParam1) // Position - 0x6EB8
{
	return iParam0 && iParam1 != false;
}

void func_260(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6EC7
{
	int i;
...
int func_261(Hash hParam0) // Position - 0x6FA3
{
	int num;
...
struct<5> func_262(int iParam0) // Position - 0x6FBD
{
	var unk;
...
struct<4> func_263(int iParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6) // Position - 0x6FEA
{
	var outGuid;
...
void func_264(int iParam0) // Position - 0x7017
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
void func_265(var uParam0) // Position - 0x703A
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
