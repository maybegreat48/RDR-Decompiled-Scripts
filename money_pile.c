...
void func_7() // Position - 0x17E
{
	return;
}

void func_8() // Position - 0x186
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x192
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x1BA
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x1E2
{
	struct<2> data;
...
int func_12(int iParam0) // Position - 0x20A
{
	var unk;
	int num;
...
void func_13(int iParam0, BOOL bParam1, float fParam2, int iParam3, const char* sParam4, int iParam5, BOOL bParam6) // Position - 0x251
{
	if (func_19() == 0)
	{
...
void func_14(var uParam0) // Position - 0x2B7
{
	return;
}

void func_15(var uParam0) // Position - 0x2BF
{
	return;
}

void func_16(var uParam0) // Position - 0x2C7
{
	return;
}

BOOL func_17() // Position - 0x2CF
{
	return false;
}

BOOL func_18(int iParam0, var uParam1) // Position - 0x2D8
{
	if (!func_25(iParam0))
		return false;
...
int func_19() // Position - 0x305
{
	return Global_1572887.f_14;
}

int func_20(int iParam0, const char* sParam1, BOOL bParam2) // Position - 0x313
{
	if (func_22())
		bParam2 = true;
...
BOOL func_21(BOOL bParam0) // Position - 0x34B
{
	if (func_19() == -1)
		return true;
...
void func_23(int iParam0, const char* sParam1, int iParam2, BOOL bParam3) // Position - 0x385
{
	if (iParam0 == 0)
		return;
...
void func_24(int iParam0, BOOL bParam1, float fParam2, int iParam3) // Position - 0x3D4
{
	int num;
	int value;
	int num2;
...
BOOL func_25(int iParam0) // Position - 0x4AB
{
	return iParam0 > -1 && iParam0 < 26;
}

int func_26(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x4C1
{
	int num;
	var unk;
	var unk6;
...
int func_27(BOOL bParam0) // Position - 0x530
{
	if (func_19() == -1)
	{
...
void func_28(int iParam0, int iParam1) // Position - 0x571
{
	if (iParam0 <= 0)
		return;
...
int func_29(const char* sParam0, char* sParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0x5AD
{
	int num;
	var unk13;
	int num2;
...
BOOL func_30() // Position - 0x610
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_31() // Position - 0x621
{
	return DLC::IS_DLC_PRESENT(joaat("dlc_ultimateedition"));
}

struct<2> func_32(int iParam0) // Position - 0x632
{
	int num;
...
void func_33(var uParam0, var uParam1, int iParam2) // Position - 0x642
{
...
BOOL func_34(Hash hParam0, int iParam1) // Position - 0x65F
{
	if (hParam0 == 0)
		return false;
...
int func_35(Hash hParam0, int iParam1) // Position - 0x679
{
	if (iParam1 == 0)
		return 0;
...
int func_36(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x6A5
{
	int num;
	var guid2;
	var guid1;
...
struct<5> func_37(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x721
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_38(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xA95
{
	var outGuid;
...
int func_39(Hash hParam0, Any* panParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0xAC6
{
	if (!func_34(hParam0, 0))
		return 0;
...
BOOL func_40() // Position - 0xB2E
{
	return Global_1913444.f_127 == 0;
}

void func_41(const char* sParam0, char* sParam1, Hash hParam2) // Position - 0xB3E
{
...
Hash func_42(Hash hParam0) // Position - 0xB6F
{
	return hParam0;
}

BOOL func_43(Hash hParam0, int iParam1) // Position - 0xB79
{
	if (hParam0 == 0)
		return false;
...
BOOL func_44(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0xB93
{
	var unk;
	var unk5;
	int num;
...
struct<4> func_45(BOOL bParam0) // Position - 0xCC7
{
	int num;
...
int func_46(Hash hParam0) // Position - 0xD67
{
	var unk;
...
struct<4> func_47(BOOL bParam0) // Position - 0xD92
{
	int num;
...
BOOL func_48(Hash hParam0, BOOL bParam1) // Position - 0xE33
{
...
BOOL func_49(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE6A
{
	return func_58(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_50(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0xE85
{
	var unk;
...
struct<4> func_51(BOOL bParam0) // Position - 0xEA6
{
	int num;
...
int func_52(Hash hParam0) // Position - 0xF10
{
	var unk;
...
BOOL func_53(Hash hParam0, int iParam1) // Position - 0xF3B
{
	Hash hash;
	int num;
	int i;
...
BOOL func_54(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0xFA8
{
	return func_63(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_55(var uParam0) // Position - 0xFBE
{
...
BOOL func_56(Hash hParam0) // Position - 0x1048
{
	return func_46(hParam0) == joaat("WEAPON");
}

int func_57(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x105C
{
	if (!func_34(hParam0, 0))
	{
		if (func_43(func_42(hParam0), 2))
...
int func_58(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x10D0
{
...
struct<4> func_59() // Position - 0x114F
{
	var unk;
...
BOOL func_61(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x1178
{
	int inventoryId;
...
BOOL func_62(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x11BD
{
...
BOOL func_63(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x11F0
{
...
BOOL func_64(Hash hParam0) // Position - 0x122A
{
	return func_66(hParam0, 1279601681);
}

int func_65(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x123D
{
...
BOOL func_66(Hash hParam0, Hash hParam1) // Position - 0x1270
{
	if (!func_34(hParam0, 0))
...
BOOL func_67(Hash hParam0) // Position - 0x12B1
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_68(Hash hParam0, Hash hParam1) // Position - 0x12BF
{
