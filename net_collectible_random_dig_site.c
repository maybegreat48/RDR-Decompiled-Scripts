...
int func_2() // Position - 0x1BD
{
	return Global_1572887.f_14;
}

struct<2> func_3(int iParam0) // Position - 0x1CB
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_4(int iParam0, var uParam1) // Position - 0x1DF
{
	return iParam0;
}

void func_5(var uParam0) // Position - 0x1E9
{
...
BOOL func_6(var uParam0) // Position - 0x29E
{
...
BOOL func_7() // Position - 0x2B8
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x2C1
{
	Hash hash;
	BOOL flag;
...
int func_9(var uParam0, var uParam1, var uParam2) // Position - 0xCAE
{
	int num;
	int scenario;
...
void func_10(var uParam0) // Position - 0xCE1
{
	if (uParam0->f_1 <= 50)
		func_13(uParam0, 1);
	else
...
BOOL func_11(var uParam0, int iParam1) // Position - 0xD03
{
	return func_69(uParam0->f_13, iParam1);
}

int func_12(int iParam0) // Position - 0xD15
{
	int num;
...
void func_13(var uParam0, int iParam1) // Position - 0x1047
{
...
int func_15(BOOL bParam0) // Position - 0x10B5
{
	int MaxInt;
	int randomIntInRange;
...
void func_17(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1190
{
...
void func_18(var uParam0, var uParam1) // Position - 0x11C7
{
	Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_1 = uParam0;
	return;
}

void func_19() // Position - 0x11DD
{
...
BOOL func_20(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x120C
{
	return !PERSISTENCE::_PERSISTENCE_IS_SCENARIO_MARKED_AS_LOOTED_AT_COORDS(vParam0);
}

BOOL func_21() // Position - 0x121D
{
	int i;
	Player Plr;
	Player player;
...
void func_22(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x12AB
{
	int num;
...
void func_23(var uParam0) // Position - 0x12FF
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_22))
...
void func_24(var uParam0, var uParam1, var uParam2) // Position - 0x1320
{
...
void func_25(int iParam0, int iParam1, int iParam2) // Position - 0x1342
{
	func_75(&Global_1222327[iParam0 /*251*/][iParam1], iParam2);
	return;
}

void func_26() // Position - 0x135C
{
	Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_1 = -1;
	Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_2 = -1;
...
void func_28(var uParam0) // Position - 0x13D6
{
	func_76(uParam0);
...
void func_29(BOOL bParam0) // Position - 0x13ED
{
	if (bParam0)
		func_78(0, 6);
	else
...
int func_31(var uParam0) // Position - 0x1425
{
	return uParam0->f_2;
}

BOOL func_32(int iParam0, int iParam1, int iParam2) // Position - 0x1431
{
	return func_69(Global_1222327[iParam0 /*251*/][iParam1], iParam2);
}

BOOL func_33(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6, int iParam7) // Position - 0x144B
{
	var unk;
	var unk3;
	var unk5;
...
void func_34(int iParam0, int iParam1, int iParam2) // Position - 0x16DE
{
	func_70(&Global_1222327[iParam0 /*251*/][iParam1], iParam2);
	return;
}

BOOL func_35(int iParam0) // Position - 0x16F8
{
	int i;
	Player Plr;
	float num;
...
BOOL func_36(var uParam0) // Position - 0x186D
{
	return Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_1 == *uParam0;
}

void func_37(var uParam0, int iParam1) // Position - 0x1885
{
	uParam0->f_2 = iParam1;
	return;
}

BOOL func_38(int iParam0) // Position - 0x1893
{
	if (iParam0 < 0)
		return false;
...
BOOL func_39(int iParam0, BOOL bParam1) // Position - 0x18D2
{
	int num;
...
BOOL func_40(BOOL bParam0) // Position - 0x1905
{
...
void func_41(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1938
{
	if (!func_20(vParam1))
	{
		func_24(vParam1);
...
void func_42(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x19AD
{
	BOOL flag;
	BOOL flag2;
	float num;
...
void func_43(int iParam0) // Position - 0x1BD6
{
...
void func_44(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1CD4
{
...
void func_45(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x1D2C
{
	if (!func_93(iParam0))
	{
...
BOOL func_46(var uParam0, const char* sParam1, char* sParam2, Vector3 vParam3, var uParam4, var uParam5, Object obParam6, Hash hParam7, Object obParam8, Hash hParam9, Object obParam10, Hash hParam11, BOOL bParam12) // Position - 0x1D60
{
	if (bParam12)
	{
...
Vector3 func_47(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x1F08
{
	var unk;
	float X;
	float num;
	...
	unk = { func_94(uParam0) };
	X = { func_96(func_96(unk, func_95(iParam3 - 90f)), unk) };
	num = MISC::ATAN2(X.f_1, X);
	num2 = -MISC::ATAN2(X.f_2, BUILTIN::SQRT((X * X) + (X.f_1 * X.f_1)));
	vector = { -X.f_1, X, 0f };
	vector2 = { func_96(vector, X) };
	num3 = MISC::ATAN2(func_97(vector, unk) / BUILTIN::VMAG(vector), func_97(vector2, unk) / BUILTIN::VMAG(vector2)) + 180f;
	return num3, num2, num;
}

int func_48(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x1FBE
{
	int i;
...
BOOL func_49(var uParam0, int iParam1) // Position - 0x206E
{
	if (func_81(joaat("kit_collector_spade"), 1))
	{
...
int func_50(char* sParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, Hash hParam15, int iParam16) // Position - 0x20FA
{
	int i;
	int num;
	int num2;
...
void func_51(int iParam0, var uParam1) // Position - 0x21D8
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
BOOL func_52(int iParam0, BOOL bParam1) // Position - 0x2219
{
	int num;
	int gameTimer;
	float progress;
...
void func_53(Ped pedParam0) // Position - 0x2313
{
	Entity firstEntityPedIsCarrying;
...
float func_54(int iParam0, BOOL bParam1) // Position - 0x2355
{
	int num;
...
float func_56(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x23D6
{
...
void func_57(float fParam0) // Position - 0x23FE
{
	if (!Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_4)
	{
...
int func_58(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2442
{
...
float func_59(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x2468
{
	float num;
	float Y;
	float X;
...
BOOL func_61(var uParam0) // Position - 0x24F1
{
	var unk;
...
void func_62(int iParam0) // Position - 0x254C
{
...
void func_63(BOOL bParam0, BOOL bParam1) // Position - 0x2566
{
	if (bParam1)
...
BOOL func_66(Hash hParam0, int iParam1) // Position - 0x26C2
{
	if (hParam0 == 0)
		return false;
...
int func_67(int iParam0) // Position - 0x26DC
{
	switch (iParam0)
	{
...
int func_68(Hash hParam0) // Position - 0x2D03
{
	var unk;
...
BOOL func_69(int iParam0, int iParam1) // Position - 0x2D1F
{
	return iParam0 && iParam1 != false;
}

void func_70(int iParam0, int iParam1) // Position - 0x2D2E
{
	func_106(iParam0, iParam1);
	return;
}

int func_71(int iParam0) // Position - 0x2D3E
{
	return iParam0;
}

void func_72(int iParam0) // Position - 0x2D48
{
	if (!func_107(iParam0))
		return;
...
int func_73(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x2DFB
{
	int i;
	var SourceStruct;
...
BOOL func_74(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x2EA5
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

void func_75(int iParam0, int iParam1) // Position - 0x2ECE
{
	func_108(iParam0, iParam1);
	return;
}

void func_76(var uParam0) // Position - 0x2EDE
{
	if (uParam0->f_4 != -1)
	{
...
void func_77(int iParam0, int iParam1) // Position - 0x2F11
{
	if (func_93(iParam0))
...
void func_78(int iParam0, int iParam1) // Position - 0x2F2A
{
...
void func_79(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2F6E
{
...
int func_80(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, int iParam6) // Position - 0x2FD5
{
	Volume volume;
	int num;
...
BOOL func_81(Hash hParam0, int iParam1) // Position - 0x3006
{
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x3089
{
...
BOOL func_83(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x30B3
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_84() // Position - 0x31B2
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_85(var uParam0, int iParam1) // Position - 0x31C7
{
	*uParam0 = iParam1;
	return;
}

void func_86(int iParam0) // Position - 0x31D4
{
	if (iParam0 <= 0)
		return;
...
void func_87(var uParam0) // Position - 0x31FB
{
	func_120(uParam0, 0f);
	return;
}

float func_88(var uParam0) // Position - 0x320A
{
	if (!func_121(uParam0))
		return uParam0->f_1;
...
BOOL func_90(Ped pedParam0) // Position - 0x32A4
{
...
BOOL func_91(int iParam0, BOOL bParam1) // Position - 0x32EE
{
	if (bParam1 && !func_38(iParam0))
		return false;
...
void func_92(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3313
{
	int num;
...
BOOL func_93(int iParam0) // Position - 0x3367
{
	if (*iParam0 == 0)
		return false;
...
Vector3 func_94(float fParam0, var uParam1, var uParam2) // Position - 0x337F
{
	float num;
	float num2;
...
Vector3 func_95(float fParam0) // Position - 0x33BE
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Vector3 func_96(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x33D4
{
...
float func_97(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x340D
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

BOOL func_98(Entity eParam0) // Position - 0x342E
{
	int num;
	var InputString;
	Hash entityModel;
...
BOOL func_99(int iParam0, int iParam1) // Position - 0x34C8
{
	if (iParam0 < 0)
		return false;
...
BOOL func_100(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x34E9
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_102(int iParam0, Any anParam1) // Position - 0x3858
{
	var unk;
...
struct<2> func_103(int iParam0, int iParam1) // Position - 0x3881
{
	int num;
...
void func_104(var uParam0, var uParam1, int iParam2) // Position - 0x3897
{
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x38B4
{
	var unk;
	var unk13;
	var unk26;
...
BOOL func_107(int iParam0) // Position - 0x38F5
{
	return func_99(iParam0, 2);
}

void func_108(int iParam0, int iParam1) // Position - 0x3904
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_109(int iParam0, int iParam1) // Position - 0x3919
{
	return MISC::IS_BIT_SET(Global_1072759.f_22475.f_417[iParam0 /*12*/], iParam1);
}

void func_110() // Position - 0x3935
{
	SCRIPTS::_SET_ALL_PLAYER_BITS(&(Global_1072759.f_21353.f_260));
	return;
}

int func_111(var uParam0, var uParam1, Volume volParam2, int iParam3) // Position - 0x394B
{
	ItemSet itemSet;
...
void func_112(Volume volParam0) // Position - 0x3A06
{
...
int func_113(Hash hParam0) // Position - 0x3A1D
{
	var unk;
...
BOOL func_114(Hash hParam0, int iParam1) // Position - 0x3A48
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_115(Hash hParam0) // Position - 0x3AF0
{
	int num;
	int num2;
	int num3;
...
int func_116(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3BAC
{
...
BOOL func_117(BOOL bParam0) // Position - 0x3C6E
{
	if (bParam0)
...
BOOL func_118() // Position - 0x3C9E
{
	return func_151() != -1;
}

BOOL func_119() // Position - 0x3CAC
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_120(var uParam0, float fParam1) // Position - 0x3CD1
{
...
BOOL func_121(var uParam0) // Position - 0x3CF7
{
	return func_154(*uParam0, 1);
}

BOOL func_122(var uParam0) // Position - 0x3D07
{
	return func_154(*uParam0, 2);
}

float func_123() // Position - 0x3D17
{
...
BOOL func_124(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x3D49
{
...
BOOL func_125(Ped pedParam0) // Position - 0x3D72
{
	return func_155(pedParam0, 0);
}

BOOL func_126(Ped pedParam0) // Position - 0x3D81
{
	return func_155(pedParam0, 3);
}

BOOL func_127(Ped pedParam0) // Position - 0x3D90
{
	return func_155(pedParam0, 4) || func_155(pedParam0, 5);
}

BOOL func_128(Ped pedParam0) // Position - 0x3DAC
{
	return func_155(pedParam0, 6);
}

BOOL func_129(Ped pedParam0) // Position - 0x3DBB
{
	return func_155(pedParam0, 7);
}

void func_130(int iParam0, int iParam1) // Position - 0x3DCA
{
	if (iParam0 < 0)
		return;
...
void func_131(int iParam0, BOOL bParam1) // Position - 0x3DFD
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_132(int iParam0, BOOL bParam1) // Position - 0x3E55
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_133(int iParam0, int iParam1) // Position - 0x3E7E
{
	if (iParam0 < 0)
		return;
...
int func_134() // Position - 0x3EA6
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

void func_135(var uParam0, int iParam1) // Position - 0x3EBB
{
	BOOL flag;
	int i;
...
BOOL func_136(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x3FE7
{
	var unk;
	int num;
...
int func_137(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x4057
{
	BOOL flag;
	int num;
	var unk;
...
Hash func_138(Hash hParam0, int iParam1) // Position - 0x4138
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_139(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x41B2
{
...
BOOL func_140(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x41D9
{
	if (iParam2 < 0)
		return false;
...
BOOL func_141(Hash hParam0) // Position - 0x4214
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_142(int iParam0) // Position - 0x422F
{
	if (iParam0 < 0)
		return 0;
...
int func_143(Hash hParam0) // Position - 0x4250
{
	var unk;
...
int func_144(Hash hParam0) // Position - 0x427B
{
	switch (hParam0)
	{
...
int func_145(var uParam0, int iParam1) // Position - 0x435E
{
	int i;
...
int func_146(Hash hParam0) // Position - 0x439B
{
	int num;
...
int func_147(Hash hParam0, BOOL bParam1) // Position - 0x4408
{
	var unk;
	int num;
	int num2;
...
int func_148(Hash hParam0, int iParam1) // Position - 0x4467
{
	if (iParam1 == 0)
		return 0;
...
int func_149(BOOL bParam0) // Position - 0x4493
{
	if (func_2() == -1)
	{
...
struct<4> func_150(Hash hParam0, BOOL bParam1) // Position - 0x44D4
{
	var unk;
...
int func_151() // Position - 0x44F9
{
	return Global_1149172.f_137;
}

void func_152(var uParam0, int iParam1) // Position - 0x4507
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_153(var uParam0, int iParam1) // Position - 0x4518
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_154(int iParam0, int iParam1) // Position - 0x452D
{
	return iParam0 && iParam1 != false;
}

BOOL func_155(Ped pedParam0, int iParam1) // Position - 0x453C
{
	var unk;
	int num;
...
void func_156(var uParam0) // Position - 0x457B
{
...
void func_157(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x45B3
{
	int i;
	var unk;
...
void func_158(int iParam0, int iParam1) // Position - 0x4669
{
	if (iParam1 == 0)
		return;
...
void func_159(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x4699
{
	int i;
	var unk;
...
BOOL func_160(Hash hParam0, Hash hParam1) // Position - 0x4754
{
	if (!func_66(hParam0, 0))
...
void func_161(Hash hParam0, var uParam1, var uParam2) // Position - 0x4795
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_162(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x49A1
{
	Hash hash;
...
struct<4> func_163(BOOL bParam0) // Position - 0x4A7F
{
	int num;
...
void func_164(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x4B20
{
...
BOOL func_165(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x4B3B
{
...
Hash func_166(Hash hParam0) // Position - 0x4B60
{
	return hParam0;
}

BOOL func_167(Hash hParam0, int iParam1) // Position - 0x4B6A
{
	if (hParam0 == 0)
		return false;
...
struct<5> func_168(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x4B84
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_169(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x4EF8
{
	var outGuid;
...
int func_170() // Position - 0x4F29
{
	return Global_1953292.f_1;
}

BOOL func_171(Any anParam0) // Position - 0x4F37
{
...
BOOL func_172(Hash hParam0, Hash hParam1) // Position - 0x4F7D
{
...
struct<4> func_173(BOOL bParam0) // Position - 0x4FB3
{
	int num;
...
int func_174(Hash hParam0, BOOL bParam1) // Position - 0x5053
{
...
BOOL func_175(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x508A
{
	return func_182(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_176(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x50A5
{
	var unk;
...
struct<4> func_177(BOOL bParam0) // Position - 0x50C6
{
	int num;
...
BOOL func_178(Hash hParam0, int iParam1) // Position - 0x5130
{
	Hash hash;
	int num;
	int i;
...
BOOL func_179(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x519D
{
	return func_185(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

struct<4> func_180() // Position - 0x51B3
{
	var unk;
...
int func_182(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x51DC
{
...
BOOL func_183(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x525B
{
	int inventoryId;
...
BOOL func_184(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x52A0
{
...
BOOL func_185(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x52D3
{
...
int func_186(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x530D
{
...
BOOL func_187(Hash hParam0) // Position - 0x5340
{
