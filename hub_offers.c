...
void func_2(int* piParam0) // Position - 0x78
{
	BOOL flag;
...
void func_3(int* piParam0) // Position - 0xC5
{
...
void func_4(int* piParam0, Hash hParam1) // Position - 0xF8
{
	piParam0->f_1 = hParam1;
	return;
}

BOOL func_5(var uParam0) // Position - 0x106
{
	int i;
...
void func_6(var uParam0) // Position - 0x135
{
	uParam0->f_90 = -1;
	uParam0->f_90.f_1 = 0;
	return;
...
void func_7(var uParam0) // Position - 0x149
{
	*uParam0 = 0;
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
...
BOOL func_8(int* piParam0) // Position - 0x164
{
	func_21(piParam0, 0);
...
int func_9(var uParam0) // Position - 0x184
{
	int num;
	int num2;
	int i;
...
BOOL func_10(int* piParam0) // Position - 0x1BE
{
	if (SCRIPTS::IS_THREAD_EXIT_REQUESTED())
		return true;
...
void func_11(int* piParam0) // Position - 0x1D2
{
	var eventData;
	int num;
...
void func_12(int* piParam0) // Position - 0x260
{
...
// Unhandled jump detected. Output should be considered invalid
void func_13(var uParam0, var uParam1) // Position - 0x2AF
{
	int num;
	int i;
	int num2;
...
void func_14(var uParam0) // Position - 0x38C
{
	if (!func_33(uParam0))
		return;
...
void func_15(int* piParam0) // Position - 0x3C8
{
...
void func_16(var uParam0) // Position - 0x404
{
	if (*uParam0 == 0)
		return;
...
int func_17(int* piParam0) // Position - 0x420
{
	int num;
	int num2;
	int i;
...
void func_18(int* piParam0) // Position - 0x450
{
...
void func_19(int* piParam0) // Position - 0x483
{
	int arrayCount;
...
void func_20(var uParam0) // Position - 0x4F3
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	return;
...
void func_21(int* piParam0, int iParam1) // Position - 0x504
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

int func_22(int iParam0, int iParam1) // Position - 0x514
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_23(var uParam0, int iParam1) // Position - 0x54B
{
	switch (iParam1)
	{
		case joaat("main"):
...
BOOL func_24(int* piParam0, int iParam1) // Position - 0x56E
{
	return func_41(*piParam0, iParam1);
}

int func_25(int* piParam0, int iParam1) // Position - 0x57F
{
	int unk;
	int n;
	int num;
...
BOOL func_26(int* piParam0, int iParam1, var uParam2) // Position - 0x5C8
{
	int arrayCount;
...
void func_27(int* piParam0, Any* panParam1) // Position - 0x611
{
	switch (*panParam1)
	{
		case -1740156697:
...
void func_28(int* piParam0, int iParam1, BOOL bParam2) // Position - 0x6E3
{
	if (bParam2)
...
var _STOPWATCH_IS_INITIALIZED(int* piParam0) // Position - 0x703
{
	return piParam0->f_1;
}

void func_30(int* piParam0, Hash hParam1) // Position - 0x70F
{
	switch (hParam1)
	{
		case joaat("main"):
...
void func_31(int* piParam0, Hash hParam1) // Position - 0x72E
{
	switch (hParam1)
	{
		case joaat("main"):
...
void func_32(int* piParam0, Hash hParam1) // Position - 0x74E
{
	switch (hParam1)
	{
		case joaat("main"):
...
BOOL func_33(var uParam0) // Position - 0x76D
{
	return *uParam0;
}

BOOL func_34(var uParam0) // Position - 0x778
{
	if (*uParam0 == -1)
		return false;
...
BOOL func_35(var uParam0, float fParam1, int iParam2) // Position - 0x798
{
	if (func_33(uParam0))
		return false;
...
int func_36(var uParam0) // Position - 0x7C6
{
	return func_65(*uParam0);
}

float func_37(var uParam0) // Position - 0x7D5
{
	if (!*uParam0)
		return 0f;
...
void func_38(var uParam0) // Position - 0x7F5
{
...
int func_39(var uParam0, int iParam1) // Position - 0x825
{
	int i;
...
void func_40(int iParam0) // Position - 0x87B
{
...
BOOL func_41(int iParam0, int iParam1) // Position - 0x89D
{
	return MISC::IS_BIT_SET(iParam0, iParam1);
}

void func_42(int* piParam0, int iParam1) // Position - 0x8AD
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

void func_43(var uParam0, var uParam1, int iParam2) // Position - 0x8BD
{
	int num;
...
void func_44(int* piParam0, int iParam1) // Position - 0x8F2
{
	switch (iParam1)
	{
		case joaat("main"):
...
BOOL func_45(int* piParam0) // Position - 0x911
{
	return piParam0->f_90 != -1;
}

int func_46(int* piParam0) // Position - 0x91F
{
	return piParam0->f_90;
}

BOOL func_47(var uParam0) // Position - 0x92B
{
	if (!func_68(uParam0))
		return 0;
...
int func_48(int* piParam0) // Position - 0x942
{
	return piParam0->f_92.f_2;
}

int func_49(int* piParam0) // Position - 0x950
{
	return piParam0->f_92.f_1;
}

void func_50(int* piParam0, Any* panParam1) // Position - 0x95E
{
...
void func_51(int* piParam0, Any* panParam1) // Position - 0x9E1
{
...
void func_52(int* piParam0, Any* panParam1) // Position - 0xA02
{
	switch (panParam1->f_2)
	{
		case -1948187754:
...
void func_53(int* piParam0, var uParam1) // Position - 0xA7C
{
	piParam0->f_92 = uParam1;
	return;
}

BOOL func_54(int* piParam0) // Position - 0xA8A
{
	int collectionId;
	var itemData;
	Hash i;
...
int func_55(int* piParam0) // Position - 0xB83
{
	if (!func_45(piParam0))
		return 0;
...
void func_56(int* piParam0, int iParam1) // Position - 0xBA4
{
	if (!func_87(piParam0))
		return;
...
void func_57(int* piParam0, var uParam1, var uParam2) // Position - 0xBC5
{
...
void func_58(var uParam0) // Position - 0xBDD
{
...
int func_59(int* piParam0, int iParam1, int iParam2) // Position - 0xC09
{
	int num;
	var DestStruct;
	var SourceStruct;
	...
	DestStruct = 1;
	DestStruct.f_1 = 1;
	DestStruct.f_2 = joaat("COLOR_WHITE");
	DestStruct.f_4 = -1;
	DestStruct.f_5 = -1;
	DestStruct.f_6 = -1;
	DestStruct.f_10 = -1;
	...
	SourceStruct = 1;
	SourceStruct.f_1 = 1;
	SourceStruct.f_2 = joaat("COLOR_WHITE");
	SourceStruct.f_4 = -1;
	SourceStruct.f_5 = -1;
	SourceStruct.f_6 = -1;
	SourceStruct.f_10 = -1;
	...
	for (i = 0; i < iParam2; i = i + 1)
	{
		...
		{
			MISC::COPY_SCRIPT_STRUCT(&DestStruct, &SourceStruct, 47);
		
			if (!func_93(&unk136, &DestStruct))
			{
			}
			else
			{
				...
				if (!func_94(&hash, &piParam0->f_2[1], unk128, &DestStruct))
					return 0;
...
void func_60(var uParam0, Hash hParam1, char* sParam2) // Position - 0xD4F
{
...
void func_61(int* piParam0) // Position - 0xD8B
{
	func_69(&(piParam0->f_84));
	func_97(-712383481);
	return;
...
int func_62(int* piParam0) // Position - 0xDA5
{
...
void func_63(int* piParam0) // Position - 0xDD0
{
	int num;
...
int func_65(int iParam0) // Position - 0xEBD
{
	int num;
	int status;
...
void func_66(var uParam0) // Position - 0xF47
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_67(int* piParam0) // Position - 0xF5D
{
	func_61(piParam0);
	return;
}

BOOL func_68(var uParam0) // Position - 0xF6B
{
...
int func_69(var uParam0) // Position - 0x1092
{
...
BOOL func_70(int* piParam0, var uParam1) // Position - 0x10CA
{
	var unk;
	var unk5;
	char* str;
...
void func_71(int* piParam0) // Position - 0x117C
{
...
BOOL func_72(int* piParam0, var uParam1) // Position - 0x1198
{
	var unk;
	var unk5;
	char* str;
...
void func_74() // Position - 0x1296
{
	func_124(false);
	return;
}

void func_75() // Position - 0x12A3
{
...
void func_77(int iParam0) // Position - 0x1303
{
	Global_1960823.f_2 = iParam0;
	return;
}

BOOL func_78() // Position - 0x1313
{
...
void func_79(BOOL bParam0) // Position - 0x133E
{
	if (func_78())
		Global_1958683 = 1;
...
void func_80(BOOL bParam0, BOOL bParam1) // Position - 0x13A1
{
	if (!func_126())
		func_127(true);
...
BOOL func_81(int* piParam0, var uParam1) // Position - 0x13EC
{
	var unk;
	var unk5;
...
void func_82() // Position - 0x1479
{
	!UIAPPS::REQUEST_UIAPP_TRANSITION_BY_HASH(joaat("coupons"), -1633545653);
	return;
}

int func_83(int* piParam0) // Position - 0x1493
{
	if (!func_45(piParam0))
		return 0;
...
BOOL func_84(Any* panParam0) // Position - 0x14AF
{
...
BOOL func_85(int iParam0) // Position - 0x14E5
{
...
BOOL func_86(Hash hParam0) // Position - 0x14FC
{
...
BOOL func_87(int* piParam0) // Position - 0x1526
{
	return DATABINDING::_VIRTUAL_COLLECTION_EXISTS(func_88(piParam0));
}

Any func_88(int* piParam0) // Position - 0x1538
{
	return piParam0->f_92;
}

int func_89(var uParam0) // Position - 0x1544
{
	Hash itemContextByIndex;
	int arrayCount;
	int i;
...
void func_90(int* piParam0) // Position - 0x15B8
{
	int arrayCount;
	Hash itemContextByIndex;
	int i;
...
int func_91(int iParam0, int iParam1, int iParam2) // Position - 0x1600
{
	int num;
...
BOOL func_92(int* piParam0, int iParam1, Any* panParam2) // Position - 0x1630
{
	Hash itemContextByIndex;
	int itemIndex;
	int num;
...
BOOL func_93(Any* panParam0, var uParam1) // Position - 0x16D0
{
	var unk;
...
BOOL func_94(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10) // Position - 0x175A
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(*uParam1))
		return false;
...
BOOL func_95(int* piParam0, Hash hParam1, int iParam2) // Position - 0x1903
{
	if (!func_87(piParam0))
		return false;
...
void func_96(var uParam0) // Position - 0x194E
{
	Hash itemContextByIndex;
	int arrayCount;
	int i;
...
void func_97(int iParam0) // Position - 0x19C1
{
	int num;
...
void func_98(var uParam0, int iParam1) // Position - 0x1A42
{
	uParam0->f_3 = iParam1;
	return;
}

void func_99(int iParam0) // Position - 0x1A50
{
	if (func_139())
		return;
...
BOOL func_100(var uParam0) // Position - 0x1AAC
{
	if (uParam0->f_3 <= 0)
	{
		if (func_142(uParam0))
...
BOOL _STOPWATCH_IS_INITIALIZED_0(var uParam0) // Position - 0x1AFE
{
	return uParam0->f_1;
}

void func_102(int* piParam0) // Position - 0x1B0A
{
	Any* p_any;
	var unk4;
...
BOOL func_103(var uParam0) // Position - 0x1B7D
{
	if (uParam0->f_1)
	{
		uParam0->f_1 = 0;
...
void func_104(int* piParam0) // Position - 0x1B96
{
	if (!func_87(piParam0))
		return;
...
void func_105(int* piParam0) // Position - 0x1BB5
{
	int num;
	int num2;
	var unk;
	...
	for (i = 0; i < num2; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_93(&unk, &DestStruct))
			{
			}
			else if (!func_152(&entryId, &DestStruct))
			{
			}
		}
	}
...
void func_106(int* piParam0) // Position - 0x1CCE
{
	var unk;
...
int func_107(int iParam0) // Position - 0x1D1A
{
	int i;
...
void func_108(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1D66
{
	int i;
...
BOOL func_109(Hash hParam0, int iParam1) // Position - 0x1E04
{
	if (hParam0 == 0)
		return false;
...
BOOL func_110(int iParam0) // Position - 0x1E1E
{
	return UNLOCK::_UNLOCK_IS_NEW(func_161(iParam0));
}

void func_111(Hash hParam0) // Position - 0x1E30
{
	UNLOCK::_UNLOCK_SET_NEW(func_161(hParam0), false);
	return;
}

int func_112(int* piParam0, var uParam1) // Position - 0x1E43
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(*uParam1))
		return 0;
...
BOOL func_113(var uParam0, var uParam1) // Position - 0x1ED3
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(*uParam0))
		return false;
...
BOOL func_114(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x1F2A
{
	return func_162(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_115(int iParam0, var uParam1) // Position - 0x1F40
{
...
int func_116(var uParam0, int iParam1) // Position - 0x1F61
{
...
BOOL func_117(Any* panParam0) // Position - 0x1F8C
{
	if (!func_84(panParam0))
		return false;
...
char* func_118(int iParam0) // Position - 0x1FA8
{
	char* StringToTest;

	StringToTest = func_164(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return "";

	return MISC::VAR_STRING(2, StringToTest);
}

BOOL func_119(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1FCD
{
	if (!func_84(&uParam0))
		return false;
...
char* func_120(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1FFC
{
	var unk;
	var unk4;
	var unk7;
...
void func_121(int* piParam0, BOOL bParam1) // Position - 0x2067
{
	DATABINDING::_DATABINDING_WRITE_DATA_BOOL(piParam0->f_2[4], bParam1);
	return;
}

void func_122(int* piParam0, char* sParam1) // Position - 0x207C
{
	DATABINDING::_DATABINDING_WRITE_DATA_STRING(piParam0->f_2[3], sParam1);
	return;
}

BOOL func_123(Hash hParam0) // Position - 0x2091
{
	int num;
...
void func_124(BOOL bParam0) // Position - 0x20DF
{
	if (bParam0)
...
BOOL func_125(Hash hParam0) // Position - 0x2116
{
	int i;
...
BOOL func_126() // Position - 0x2156
{
	return func_173(4);
}

void func_127(BOOL bParam0) // Position - 0x2163
{
	if (bParam0)
		func_128(4);
	else
...
void func_128(int iParam0) // Position - 0x217D
{
	Global_1051832.f_3648 = Global_1051832.f_3648 || iParam0;
	return;
}

void func_129(var uParam0) // Position - 0x2196
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_130(Hash hParam0) // Position - 0x21AC
{
	return func_175(hParam0) == 1946043663;
}

BOOL func_131(Hash hParam0) // Position - 0x21C0
{
	int num;
...
BOOL func_132(int* piParam0, Hash hParam1) // Position - 0x2224
{
	int num;
	int num2;
	int transactionId;
...
int func_133(Hash hParam0) // Position - 0x2306
{
	var unk;
...
BOOL func_134(int* piParam0, int iParam1) // Position - 0x232E
{
	if (!func_45(piParam0))
		return false;
...
BOOL func_135(Hash hParam0) // Position - 0x235E
{
	return func_175(hParam0) == -126813555;
}

BOOL func_136(Any* panParam0, var uParam1) // Position - 0x2372
{
	Hash hash;
	BOOL flag;
	BOOL flag2;
...
BOOL func_137(Any* panParam0, var uParam1) // Position - 0x240B
{
	Hash hash;
	var unk;
...
void func_140(int iParam0) // Position - 0x273B
{
	*iParam0 = -1;
	iParam0->f_3 = 0;
	iParam0->f_5 = -1;
...
void func_141(int iParam0, BOOL bParam1) // Position - 0x275A
{
	if (func_139())
		return;
...
BOOL func_142(var uParam0) // Position - 0x278A
{
	return func_197(*uParam0, 1);
}

void func_143(var uParam0, BOOL bParam1) // Position - 0x279A
{
...
int func_144(var uParam0) // Position - 0x27BA
{
	if (!func_142(uParam0))
		return 0;
...
void func_145(var uParam0) // Position - 0x2800
{
	func_200(uParam0, 0f);
	return;
}

BOOL func_146(var uParam0, var uParam1) // Position - 0x280F
{
...
int func_147(var uParam0) // Position - 0x282F
{
	return uParam0->f_18.f_1;
}

void func_148(int* piParam0, Any* panParam1) // Position - 0x283D
{
	MISC::COPY_SCRIPT_STRUCT(panParam1, &(piParam0->f_40), 4);
	return;
}

BOOL func_149(Any* panParam0, Any* panParam1) // Position - 0x2850
{
...
int func_150(Hash hParam0) // Position - 0x2868
{
	return func_201(hParam0);
}

BOOL func_151(int* piParam0, int iParam1) // Position - 0x2876
{
	var unk;
	var unk17;
...
BOOL func_152(var uParam0, var uParam1) // Position - 0x28A5
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(*uParam0))
		return false;
...
void func_153(char* sParam0) // Position - 0x2A58
{
...
void func_154(int* piParam0, const char* sParam1) // Position - 0x2A9C
{
	DATABINDING::_DATABINDING_WRITE_DATA_STRING(piParam0->f_2[8], sParam1);
	return;
}

void func_155(int* piParam0, Hash hParam1) // Position - 0x2AB2
{
	DATABINDING::_DATABINDING_WRITE_DATA_INT(piParam0->f_2[9], hParam1);
	return;
}

void func_156(int* piParam0, int iParam1) // Position - 0x2AC8
{
	DATABINDING::_DATABINDING_WRITE_DATA_INT(piParam0->f_2[10], iParam1);
	return;
}

void func_157(int* piParam0, int iParam1) // Position - 0x2ADE
{
	DATABINDING::_DATABINDING_WRITE_DATA_INT(piParam0->f_2[11], iParam1);
	return;
}

void func_158(int* piParam0, BOOL bParam1) // Position - 0x2AF4
{
	DATABINDING::_DATABINDING_WRITE_DATA_BOOL(piParam0->f_2[7], bParam1);
	return;
}

void func_159(int* piParam0, int iParam1, int iParam2) // Position - 0x2B09
{
...
void func_160(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x2B2B
{
	int i;
...
Hash func_161(Hash hParam0) // Position - 0x2C07
{
	return hParam0;
}

BOOL func_162(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x2C11
{
...
BOOL func_163(Any* panParam0) // Position - 0x2C4B
{
	if (!func_84(panParam0))
		return false;
...
char* func_164(int iParam0) // Position - 0x2C67
{
	switch (iParam0)
	{
		case 0:
...
int func_165(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2CF6
{
	if (!func_84(&uParam0))
		return 0;
...
BOOL func_166(int iParam0) // Position - 0x2D12
{
	if (iParam0 <= 0)
		return false;
...
Vector3 func_167(int iParam0, BOOL bParam1) // Position - 0x2D30
{
	var sDate;
	var unk6;
	...
	TEXT_LABEL_ASSIGN_STRING(&unk6, func_207(sDate.f_2), 24);
	return unk6;
}

Vector3 func_168(int iParam0, BOOL bParam1) // Position - 0x2D77
{
	var sDate;
	var unk6;
	...
	TEXT_LABEL_ASSIGN_STRING(&unk6, func_207(sDate.f_1), 24);
	return unk6;
}

Vector3 func_169(int iParam0) // Position - 0x2DBE
{
	int sDate;
	var unk6;

	NETWORK::CONVERT_POSIX_TIME(iParam0, &sDate);
	TEXT_LABEL_ASSIGN_STRING(&unk6, func_207(sDate), 24);
	return unk6;
}

BOOL func_170(Hash hParam0, Hash hParam1) // Position - 0x2DDC
{
	if (!func_109(hParam0, 0))
...
int func_171(Hash hParam0, BOOL bParam1) // Position - 0x2E1D
{
	var unk;
...
void func_172(int iParam0) // Position - 0x2E75
{
	var unk;
...
BOOL func_173(int iParam0) // Position - 0x2ED5
{
	return Global_1051832.f_3648 && iParam0 != false;
}

void func_174(int iParam0) // Position - 0x2EE9
{
	Global_1051832.f_3648 = Global_1051832.f_3648 - Global_1051832.f_3648 && iParam0;
	return;
}

int func_175(Hash hParam0) // Position - 0x2F0A
{
	var unk;
...
BOOL func_176(int iParam0) // Position - 0x2F35
{
	if (iParam0 == 0)
		return false;
...
BOOL func_177(Hash hParam0) // Position - 0x2F4D
{
	int i;
...
Hash func_178(int iParam0, int iParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x2FBB
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_179(int* piParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, int iParam5, Hash hParam6, int iParam7, BOOL bParam8) // Position - 0x30C0
{
	var unk;
...
BOOL func_180(var uParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x3113
{
	int i;
...
int func_181(Hash hParam0) // Position - 0x316E
{
	int num;
	var unk;
	var unk6;
...
int func_182(Hash hParam0) // Position - 0x31D0
{
	Hash award;
	Hash award2;
	int awardItemCount;
...
BOOL func_183(int* piParam0) // Position - 0x321D
{
	Hash action;
...
void func_184(int* piParam0, Any* panParam1) // Position - 0x32BA
{
	MISC::COPY_SCRIPT_STRUCT(&(piParam0->f_40), panParam1, 4);
	return;
}

BOOL func_185(Any* panParam0, var uParam1) // Position - 0x32CD
{
	var unk;
...
BOOL func_186(Any* panParam0, var uParam1) // Position - 0x3332
{
	Hash hash;
	var unk;
	int i;
...
BOOL func_187(Hash hParam0) // Position - 0x3544
{
	if (!func_109(hParam0, 0))
		return 0;
...
BOOL func_188(Hash hParam0, var uParam1) // Position - 0x3577
{
	int num;
...
char* func_189(var uParam0) // Position - 0x35A5
{
	char* StringToTest;
	int num;
	var unk;
...
BOOL func_190(var uParam0) // Position - 0x3633
{
	int i;
	int num;
...
BOOL func_191(Hash hParam0) // Position - 0x3693
{
	int num;
...
BOOL func_192(Hash hParam0) // Position - 0x36FD
{
	if (!func_109(hParam0, 0))
		return false;
...
char* func_193(var uParam0) // Position - 0x372B
{
	char* StringToTest;
	int num;
	var unk;
...
void func_194(char* sParam0) // Position - 0x37B9
{
...
BOOL func_195(Hash hParam0) // Position - 0x3801
{
	Hash hash;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x382F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_197(int iParam0, int iParam1) // Position - 0x3D3D
{
	return iParam0 && iParam1 != false;
}

BOOL func_198(var uParam0) // Position - 0x3D4C
{
	return func_197(*uParam0, 2);
}

int func_199() // Position - 0x3D5C
{
	int networkTimeAccurate;
...
void func_200(var uParam0, float fParam1) // Position - 0x3D7A
{
...
int func_201(Hash hParam0) // Position - 0x3DA0
{
	if (!func_220(hParam0))
		return 0;
...
BOOL func_202(int iParam0, char* sParam1, char* sParam2) // Position - 0x3E33
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_203(int* piParam0, const char* sParam1, const char* sParam2) // Position - 0x3E5E
{
...
void func_204(int iParam0) // Position - 0x3EC3
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
int func_205(BOOL bParam0) // Position - 0x3EE6
{
	if (func_240() == -1)
	{
...
const char* func_207(int iParam0) // Position - 0x3F6B
{
	return MISC::_GET_STRING_FROM_FLOAT(BUILTIN::TO_FLOAT(iParam0), 0);
}

Hash func_208(Hash hParam0) // Position - 0x3F7E
{
	return hParam0;
}

BOOL func_209(Hash hParam0, Hash hParam1) // Position - 0x3F88
{
...
int func_210(Hash hParam0, BOOL bParam1) // Position - 0x3FBE
{
	int num;
...
BOOL func_211(int iParam0) // Position - 0x3FF7
{
	return iParam0 != 0;
}

BOOL func_212(int iParam0, int iParam1) // Position - 0x4004
{
	return iParam0 && iParam1 != false;
}

BOOL func_213(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x4013
{
	if (!func_176(iParam0))
		return false;
...
BOOL func_214(int iParam0, var uParam1) // Position - 0x404B
{
	*uParam1 = func_242(iParam0, true);
	return *uParam1 != 0;
}

BOOL func_215(int iParam0, var uParam1) // Position - 0x4062
{
	*uParam1 = func_243(iParam0, true, false);
	return *uParam1 != 0;
}

BOOL func_216() // Position - 0x407A
{
	return Global_1915656.f_22477;
}

BOOL func_217(int iParam0) // Position - 0x4089
{
...
BOOL func_218(int* piParam0, Hash hParam1, var uParam2, BOOL bParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x40C4
{
...
void func_219(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x416D
{
	int num;
	Hash hash;
...
BOOL func_220(Hash hParam0) // Position - 0x41B2
{
...
struct<5> func_221(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x41E0
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_222(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x4554
{
	var outGuid;
...
BOOL func_223(Any* panParam0) // Position - 0x4585
{
	var unk;
...
char* func_224(var uParam0) // Position - 0x45D6
{
	var unk;
	Hash labelHash;
	var unk17;
...
Hash func_225(Hash hParam0) // Position - 0x463D
{
	if (!func_109(hParam0, 0))
		return 0;
...
int func_226(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x465A
{
	Hash hashKey;
	Hash hashKey2;
...
Hash func_227(Hash hParam0) // Position - 0x46CD
{
...
BOOL func_228(Hash hParam0) // Position - 0x4769
{
	Hash unlockHash;
...
int func_229(Hash hParam0) // Position - 0x478C
{
	var unk;
	int i;
...
char* func_230(int iParam0) // Position - 0x47FB
{
	int num;
	var unk5;
...
Hash func_232(int iParam0) // Position - 0x4847
{
	int num;
	Hash num2;
...
BOOL func_233(int iParam0, Hash hParam1) // Position - 0x4872
{
	var unk;
	int num;
	Hash unlockHash;
...
char* func_234(int iParam0) // Position - 0x49BB
{
	int num;
	var unk5;
...
Hash func_235(Hash hParam0) // Position - 0x49EE
{
	switch (hParam0)
	{
...
BOOL func_236(Hash hParam0, int iParam1) // Position - 0x4AA7
{
	int num;
...
void func_237(var uParam0, int iParam1) // Position - 0x4B2A
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_238(var uParam0, int iParam1) // Position - 0x4B3B
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_239(var uParam0) // Position - 0x4B50
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_240() // Position - 0x4BAA
{
	return Global_1572887.f_14;
}

BOOL func_241(Hash hParam0, int iParam1) // Position - 0x4BB8
{
	if (hParam0 == 0)
		return false;
...
Hash func_242(int iParam0, BOOL bParam1) // Position - 0x4BD2
{
	int i;
	int num;
	var unk;
...
Hash func_243(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4C65
{
	int i;
	int num;
	var unk;
...
BOOL func_244(BOOL bParam0) // Position - 0x4DC4
{
	if (bParam0)
...
BOOL func_245(int* piParam0, BOOL bParam1) // Position - 0x4DF4
{
	if (!bParam1)
...
BOOL func_246(int iParam0, Hash hParam1, int iParam2) // Position - 0x4E90
{
	if (iParam0 == 0)
		return false;
...
BOOL func_247(int* piParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, Hash hParam19, BOOL bParam20) // Position - 0x4EF0
{
...
int func_248(int iParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4F44
{
	var unk;
	int num;
	int i;
...
void func_249(char* sParam0, char* sParam1, BOOL bParam2) // Position - 0x4FB0
{
	int soundId;
...
struct<4> func_250(BOOL bParam0) // Position - 0x4FEF
{
	int num;
...
int func_251(Hash hParam0) // Position - 0x508F
{
	var unk;
...
struct<4> func_252(BOOL bParam0) // Position - 0x50BA
{
	int num;
...
int func_253(Hash hParam0, BOOL bParam1) // Position - 0x515B
{
...
BOOL func_254(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5192
{
	return func_276(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_255(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x51AD
{
	var unk;
...
struct<4> func_256(BOOL bParam0) // Position - 0x51CE
{
	int num;
...
BOOL func_257(Hash hParam0, int iParam1) // Position - 0x5238
{
	Hash hash;
	int num;
	int i;
...
char* func_258(Hash hParam0) // Position - 0x52A5
{
	Hash labelHash;
...
Hash func_259(Hash hParam0) // Position - 0x52D7
{
	var unk;
	int i;
...
char* func_260(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x5345
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_261() // Position - 0x5359
{
	return Global_1072759.f_28418[55 /*4*/].f_3;
}

BOOL func_262(Hash hParam0, int iParam1) // Position - 0x536E
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_263(Hash hParam0) // Position - 0x5416
{
	int num;
	int num2;
	int num3;
...
int func_264(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x54D2
{
...
Hash func_265(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5594
{
	int num;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_266(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5630
{
	int i;
...
BOOL func_267(int* piParam0) // Position - 0x56BF
{
	int num;
...
BOOL func_268(var uParam0) // Position - 0x56F1
{
...
BOOL func_269(int iParam0, Hash hParam1) // Position - 0x5737
{
	int num;
	int num2;
	var unk;
...
BOOL func_270(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x57F1
{
...
BOOL func_271(int* piParam0, Hash hParam1) // Position - 0x580A
{
	Hash action;
...
BOOL func_272(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x586D
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

BOOL func_273(int* piParam0, BOOL bParam1) // Position - 0x5884
{
...
struct<4> func_274() // Position - 0x58A5
{
	var unk;
...
int func_276(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x58CE
{
...
BOOL func_277(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x594D
{
	int inventoryId;
...
BOOL func_278(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x5992
{
...
Hash func_279(Hash hParam0, BOOL bParam1) // Position - 0x59C5
{
	Hash hash;
...
Hash func_280(Hash hParam0, int iParam1) // Position - 0x59F3
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_281(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x5A6D
{
...
BOOL func_282(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5A94
{
	if (iParam2 < 0)
		return false;
...
BOOL func_283(Hash hParam0) // Position - 0x5ACF
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_284(int iParam0) // Position - 0x5AEA
{
	if (iParam0 < 0)
		return 0;
...
int func_285(Hash hParam0) // Position - 0x5B0B
{
	switch (hParam0)
	{
...
int func_286(var uParam0, int iParam1) // Position - 0x5BEE
{
	int i;
...
int func_287(Hash hParam0) // Position - 0x5C2B
{
	int num;
...
int func_288(Hash hParam0, BOOL bParam1) // Position - 0x5C98
{
	var unk;
	int num;
	int num2;
...
int func_289(Hash hParam0, int iParam1) // Position - 0x5CF7
{
	if (iParam1 == 0)
		return 0;
...
struct<4> func_290(Hash hParam0, BOOL bParam1) // Position - 0x5D23
{
	var unk;
...
void func_291(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x5D48
{
	int i;
	int j;
	int k;
...
int func_292(int* piParam0) // Position - 0x5F1E
{
	return func_65(piParam0->f_1);
}

int func_293(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5F2E
{
	var unk;
	int num;
	int i;
...
BOOL func_294(int iParam0) // Position - 0x5FC2
{
	if (iParam0 < 0)
		return false;
...
int func_295(int iParam0) // Position - 0x5FE5
{
	return iParam0 / 100;
}

void func_296(const char* sParam0) // Position - 0x5FF2
{
	Global_1915656.f_22470 = func_306(sParam0, 10000, 0, 0, 0, true);
	return;
}

BOOL func_297(int iParam0) // Position - 0x600E
{
	if (iParam0 < 0)
		return false;
...
BOOL func_298(int iParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x603B
{
	var unk;
	int num;
	int i;
...
BOOL func_299(int* piParam0, Hash hParam1) // Position - 0x6142
{
...
int func_300(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6160
{
...
Hash func_301(Hash hParam0, BOOL bParam1) // Position - 0x6193
{
	switch (hParam0)
	{
...
void func_302(Hash hParam0, var uParam1, var uParam2) // Position - 0x6235
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_303(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x6441
{
	Hash hash;
...
void func_304(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x651F
{
...
BOOL func_305(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x653A
{
...
int func_306(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x655F
{
	int num;
	var unk13;
	int num2;
...
BOOL func_307(int iParam0) // Position - 0x659A
{
	if (iParam0 < 0)
		return false;
...
int func_309(int iParam0, Hash hParam1) // Position - 0x65D8
{
...
int func_310(Hash hParam0, int iParam1) // Position - 0x65FD
{
	var unk;
	var guid;
	int inventoryItemCountWithGuid;
...
BOOL func_311(Hash hParam0) // Position - 0x6658
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_312(int iParam0) // Position - 0x6666
{
	switch (iParam0)
	{
		case 0:
