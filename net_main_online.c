...
void func_1(char* sParam0) // Position - 0x3F9
{
	int systemTime;
	int frameCount;
...
BOOL func_4(BOOL bParam0) // Position - 0x50E
{
	return Global_1572887.f_72.f_15 && bParam0 != false;
}

void func_5(int iParam0) // Position - 0x523
{
	func_59(&(Global_1572887.f_72.f_15), iParam0);
	return;
}

void func_6() // Position - 0x539
{
	Player player;
...
BOOL func_7(BOOL bParam0, BOOL bParam1) // Position - 0x64E
{
	int i;
...
int func_11(Player plParam0) // Position - 0x7CE
{
	if (plParam0 >= 0)
...
int func_12() // Position - 0x7E9
{
	return Global_1072758;
}

BOOL func_13() // Position - 0x7F5
{
	return Global_1572887.f_196 > 0;
}

BOOL func_14() // Position - 0x805
{
	int num;
	Player Plr;
	Player player;
	...
	{
		player = Plr;
		num.f_10 = func_69(player);
		num = func_70(player);
		num.f_1 = func_71(player);
		num.f_2 = func_72(player);
		num.f_3 = { func_73(player) };
	}
...
void func_15() // Position - 0x8DA
{
	Global_1051645.f_15 = 1;
	return;
}

void func_16() // Position - 0x8E9
{
	Global_1051645.f_15 = 0;
	return;
}

BOOL func_17() // Position - 0x8F8
{
	if (func_75() != 0)
		return false;
...
BOOL func_18(var uParam0, var uParam1) // Position - 0x92E
{
	if (!func_76(uParam0))
		return false;
...
Hash func_19(var uParam0, var uParam1) // Position - 0x962
{
	int num;
...
void func_20(BOOL bParam0) // Position - 0x98C
{
	if (func_79())
	{
...
BOOL func_21() // Position - 0xA20
{
	return !Global_1572887.f_10;
}

void func_22(int iParam0) // Position - 0xA2F
{
	int num;
...
int func_23() // Position - 0xA87
{
	return Global_1572887.f_300;
}

void func_24() // Position - 0xA96
{
...
BOOL func_27(int iParam0) // Position - 0xD3D
{
	return func_91(func_90(iParam0));
}

int func_28(var uParam0) // Position - 0xD4F
{
...
void func_29(int iParam0) // Position - 0xE75
{
	func_98(&(Global_1147183.f_8), iParam0);
	return;
}

int func_30() // Position - 0xE89
{
...
BOOL func_31() // Position - 0xEE9
{
	return Global_1572887.f_196 > 19;
}

void func_32() // Position - 0xEFA
{
	float num;
	var unk;
	float num2;
...
void func_36(BOOL bParam0) // Position - 0x1D92
{
	NETWORK::_0x704F92B3AF20D857(bParam0);
	return;
}

void func_37(BOOL bParam0, BOOL bParam1) // Position - 0x1DA0
{
	*bParam0 = *bParam0 || bParam1;
	return;
}

void func_38(var uParam0) // Position - 0x1DB1
{
	var unk;
...
void func_41() // Position - 0x1EC7
{
	func_181();
	return;
}

void func_42() // Position - 0x1ED3
{
	func_182();
	func_49();
	func_50();
...
void func_43(int* piParam0) // Position - 0x1EEB
{
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
...
void func_45(char* sParam0, int iParam1) // Position - 0x1F1B
{
	iParam1 = iParam1;
	sParam0 = sParam0;
...
void func_48() // Position - 0x1FB0
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_49() // Position - 0x1FBC
{
...
void func_51() // Position - 0x1FDA
{
	Global_1072759.f_3 = 0;
	return;
}

int func_52() // Position - 0x1FE9
{
	int scriptStatus;
	int gameTimer;
	int timeoutTime;
...
void func_55(BOOL bParam0) // Position - 0x237A
{
	int num;
	var unk;
	int num2;
...
void func_56() // Position - 0x2445
{
	func_207();
	return;
}

void func_57() // Position - 0x2451
{
	int i;
...
void func_59(BOOL bParam0, BOOL bParam1) // Position - 0x251E
{
	*bParam0 = *bParam0 - *bParam0 && bParam1;
	return;
}

int func_60() // Position - 0x2533
{
	return Global_1572887.f_14;
}

BOOL func_61(BOOL bParam0, BOOL bParam1) // Position - 0x2541
{
	return bParam0 && bParam1 != false;
}

void func_62() // Position - 0x2550
{
	int num;
...
int func_63(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x257D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return 0;
...
struct<11> func_67() // Position - 0x2D3F
{
	return Global_1572887.f_196.f_30;
}

Player func_68() // Position - 0x2D52
{
	return Global_1572887.f_196.f_41;
}

BOOL func_69(Player plParam0) // Position - 0x2D62
{
	return Global_1056554[plParam0 /*491*/].f_204.f_10;
}

var func_70(Player plParam0) // Position - 0x2D77
{
	return Global_1056554[plParam0 /*491*/].f_204;
}

var func_71(Player plParam0) // Position - 0x2D8A
{
	return Global_1056554[plParam0 /*491*/].f_204.f_1;
}

var func_72(Player plParam0) // Position - 0x2D9F
{
	return Global_1056554[plParam0 /*491*/].f_204.f_2;
}

struct<2> func_73(Player plParam0) // Position - 0x2DB4
{
	return Global_1056554[plParam0 /*491*/].f_204.f_3;
}

BOOL func_74(Player plParam0, int iParam1) // Position - 0x2DCB
{
	return Global_263042[plParam0 /*65*/].f_63 && iParam1 != false;
}

int func_75() // Position - 0x2DE2
{
	return Global_1572887.f_72;
}

BOOL func_76(int iParam0) // Position - 0x2DF0
{
	switch (iParam0)
	{
		case 2:
...
int func_77(int iParam0) // Position - 0x2E2F
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_78(int iParam0, var uParam1, Any* panParam2) // Position - 0x2EC5
{
	if (!func_18(iParam0))
		return false;
...
void func_81(BOOL bParam0) // Position - 0x305F
{
	Hash hash;
...
char* func_87(int iParam0) // Position - 0x324E
{
	char* str;
...
BOOL func_88(BOOL bParam0) // Position - 0x3325
{
...
BOOL func_89(char* sParam0, int iParam1, eStackSize essParam2) // Position - 0x335F
{
...
int func_90(int iParam0) // Position - 0x33A0
{
	int num;
...
BOOL func_91(int iParam0) // Position - 0x355A
{
	return func_244(&(Global_1572887.f_300.f_1), iParam0, 3);
}

Vector3 func_92() // Position - 0x3572
{
	var unk;
	var unk4;
...
BOOL func_93(int iParam0) // Position - 0x35EC
{
	return func_246(Global_1144526[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*83*/].f_73, iParam0);
}

BOOL func_94(int iParam0) // Position - 0x3606
{
	Player gangLeader;
	int num;
	var unk;
...
int func_95(var uParam0, var uParam1, var uParam2) // Position - 0x3692
{
...
void func_96(int iParam0) // Position - 0x36B2
{
...
int func_97() // Position - 0x36CF
{
	return Global_1142424.f_2018;
}

void func_98(int iParam0, int iParam1) // Position - 0x36DE
{
	func_250(iParam0, iParam1);
	return;
}

int func_99(int iParam0) // Position - 0x36EE
{
	switch (iParam0)
	{
...
void func_100(int iParam0) // Position - 0x377B
{
	int frameCount;
	int systemTime;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x37AF
{
...
int func_102(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x37D9
{
	return func_251(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

int func_103(int iParam0) // Position - 0x37EF
{
	if (iParam0 < 0)
		return -1;
	else if (iParam0 <= 10)
...
BOOL func_104(Vector3* pvParam0, float* pfParam1) // Position - 0x38EB
{
	Hash* p_hash;
	int MaxInt;
	...
	else
	{
		...
		if (func_253(p_hash, randomIntInRange, pvParam0, pfParam1))
			return true;
	}
...
int func_105(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x393B
{
	int num;
...
void func_106(BOOL bParam0) // Position - 0x3989
{
	if (!bParam0)
		func_257(18);
	else
...
void func_107(BOOL bParam0) // Position - 0x39A8
{
	if (!bParam0)
		func_257(24);
	else
...
void func_108(int iParam0, BOOL bParam1) // Position - 0x39C7
{
	var unk;
	float num;
...
void func_109(BOOL bParam0, int iParam1) // Position - 0x3A5C
{
	if (bParam0)
	{
		if (iParam1 != -1)
...
void func_110(int iParam0) // Position - 0x3A9C
{
	func_37(&(Global_1572887.f_196.f_43), iParam0);
	return;
}

void func_111() // Position - 0x3AB2
{
	func_258(94);
	return;
}

void func_112(var uParam0, var uParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x3AC1
{
	if (func_156(255) == 4)
		return;
...
void func_114(BOOL bParam0, BOOL bParam1) // Position - 0x3C0F
{
	if (bParam0)
	{
		func_258(70);
...
void func_115(BOOL bParam0) // Position - 0x3C40
{
	if (bParam0)
		func_258(52);
	else
...
void func_117(BOOL bParam0) // Position - 0x3C71
{
	if (bParam0)
		func_258(60);
	else
...
void func_118(BOOL bParam0) // Position - 0x3C8F
{
	if (bParam0)
		func_258(54);
	else
...
void func_119(BOOL bParam0) // Position - 0x3CAD
{
	if (bParam0)
		func_258(56);
	else
...
void func_120(BOOL bParam0) // Position - 0x3CCB
{
	if (bParam0)
		func_258(58);
	else
...
void func_122(var uParam0) // Position - 0x3CFC
{
	var unk;
...
void func_123(float* pfParam0) // Position - 0x3D0E
{
	var unk;
...
Vector3 func_124() // Position - 0x3D20
{
	int num;
...
BOOL func_125(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0x3DAC
{
	Hash* p_hash;
	int MaxInt;
	int randomIntInRange;

	p_hash = Global_1072759.f_23824.f_383[func_265(uParam0) /*272*/];
	MaxInt = func_252(p_hash);
	...
	else
	{
		...
		if (func_253(p_hash, randomIntInRange, pvParam3, pfParam4))
			return true;
	}
...
void func_126(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0x3DFD
{
	var entityCoords;
	float num;
...
Vector3 func_129(int iParam0) // Position - 0x3F2D
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_130(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0x3F55
{
	int num;
	int i;
	int num2;
...
BOOL func_131(int iParam0, var uParam1) // Position - 0x4037
{
	var unk;
	int num;
	var unk4;
...
void func_132(int iParam0, BOOL bParam1) // Position - 0x41DC
{
	int num;
	int num2;
...
void func_133(BOOL bParam0) // Position - 0x4209
{
	if (!bParam0)
		func_257(20);
	else
...
void func_134(float fParam0, float fParam1, float fParam2, float fParam3, BOOL bParam4) // Position - 0x4228
{
...
Vector3 func_136(int iParam0, BOOL bParam1) // Position - 0x4286
{
...
int func_138(int iParam0) // Position - 0x432A
{
	switch (iParam0)
	{
		case 0:
...
void func_140() // Position - 0x4388
{
	func_275(256);
	return;
}

BOOL func_141() // Position - 0x4397
{
	return false;
}

void func_142(int iParam0) // Position - 0x43A0
{
	Global_1896646.f_41 = iParam0;
	return;
}

void func_143() // Position - 0x43B0
{
	func_276();
	func_277();
	func_278();
...
void func_144(int iParam0) // Position - 0x43C8
{
...
void func_146() // Position - 0x4470
{
	BRAIN::ENABLE_SCRIPT_BRAIN_SET(1);
	return;
}

void func_147() // Position - 0x447D
{
	BRAIN::ENABLE_SCRIPT_BRAIN_SET(4);
	return;
}

void func_148() // Position - 0x448A
{
	BRAIN::DISABLE_SCRIPT_BRAIN_SET(2);
	return;
}

void func_149() // Position - 0x4497
{
	int num;
	int i;
	var unk;
...
void func_151(BOOL bParam0) // Position - 0x453C
{
...
BOOL func_152(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x45C0
{
	Player player;
...
void func_153(int iParam0, int iParam1) // Position - 0x4689
{
	Global_1051829.f_1;
...
var func_157(int iParam0, int iParam1) // Position - 0x4761
{
...
void func_161() // Position - 0x48D2
{
	Global_1155150[Global_1295666 /*30*/] = NETWORK::_NETWORK_GET_RANK();
	return;
}

void func_162() // Position - 0x48E8
{
	Player i;
...
void func_164() // Position - 0x4A37
{
	return;
}

void func_165() // Position - 0x4A3F
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (Global_1203871[i /*8*/].f_6)
		{
			...
			if (Global_1203871[i /*8*/].f_3 >= 0)
				if (!flag)
					ptfxId = GRAPHICS::START_NETWORKED_PARTICLE_FX_LOOPED_ON_ENTITY_BONE(func_318(num), Global_33, 0f, 0f, 0f, 0f, 0f, 0f, boneIndex, 1065353216, false, false, false);
				else
					ptfxId = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY_BONE(func_318(num), Global_33, 0f, 0f, 0f, 0f, 0f, 0f, boneIndex, 1065353216, false, false, false);
			else if (!flag)
				ptfxId = GRAPHICS::START_NETWORKED_PARTICLE_FX_LOOPED_ON_ENTITY(func_318(num), Global_33, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, false, false, false);
			else
				ptfxId = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY(func_318(num), Global_33, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, false, false, false);
...
void func_186() // Position - 0x5DA6
{
	func_441(256);
	return;
}

void func_187() // Position - 0x5DB5
{
	SCRIPTS::_CLEAR_ALL_PLAYER_BITS(&(Global_1056554[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*491*/].f_10));
	return;
}

BOOL func_188() // Position - 0x5DCE
{
	return Global_1051645.f_8;
}

void func_189(int* piParam0) // Position - 0x5DDC
{
	var unk;
...
int func_190(int iParam0, int iParam1, char* sParam2) // Position - 0x5DE9
{
	return 1;
}

int func_191() // Position - 0x5DF2
{
	return Global_1102813.f_3672;
}

void func_192(Any* panParam0) // Position - 0x5E01
{
	int i;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		func_442(&panParam0->[i /*491*/]);
	}

	return;
}

int func_193(int iParam0, int iParam1, char* sParam2) // Position - 0x5E2A
{
	return 1;
}

void func_194() // Position - 0x5E33
{
	if (func_21())
	{
...
void func_208(int iParam0, BOOL bParam1, int iParam2) // Position - 0x6564
{
	int i;
	int num;
	int num2;
...
void func_209(int iParam0, int iParam1) // Position - 0x65F6
{
...
void func_210() // Position - 0x6637
{
	...
	{
		case -1:
			relGroup = func_473(PLAYER::NETWORK_PLAYER_ID_TO_INT());
			break;
...
void func_211(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x672D
{
	int num;
...
void func_212(int iParam0) // Position - 0x6781
{
	Global_1295299.f_1 = iParam0;
	return;
}

BOOL func_213(var uParam0) // Position - 0x6791
{
	BOOL flag;
	int num;
	BOOL flag2;
...
BOOL func_214(var uParam0) // Position - 0x6808
{
	BOOL flag;
	int num;
	BOOL flag2;
...
struct<2> func_215(int iParam0) // Position - 0x6977
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

char* func_216(var uParam0, var uParam1) // Position - 0x698B
{
	var pLiteralString;
	var unk16;
...
BOOL func_217(int iParam0) // Position - 0x69F6
{
	return func_246(Global_1297441.f_157, iParam0);
}

int func_218(Player plParam0, BOOL bParam1) // Position - 0x6A0A
{
	if (bParam1)
...
const char* func_219(int iParam0) // Position - 0x6A31
{
	return MISC::_GET_STRING_FROM_FLOAT(BUILTIN::TO_FLOAT(iParam0), 0);
}

int func_220() // Position - 0x6A44
{
	return Global_1051645.f_80.f_102;
}

const char* func_221(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6A54
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_222(int iParam0) // Position - 0x6A68
{
	if (iParam0 == 255)
...
char* func_223(int iParam0) // Position - 0x6A8A
{
	if (!func_255(iParam0))
		return "Wilderness";
...
const char* func_224() // Position - 0x71CB
{
	if (func_491())
...
const char* func_229() // Position - 0x733D
{
...
struct<30> func_230(int iParam0) // Position - 0x7369
{
	var unk;
...
BOOL func_231(var uParam0) // Position - 0x73C3
{
	if (!*uParam0)
		return false;
...
char* func_232(Player plParam0) // Position - 0x73FF
{
	int num;
	var unk;
	int i;
...
Vector3 func_233() // Position - 0x7460
{
...
const char* func_234() // Position - 0x748C
{
	var unk;
...
void func_235(Any* panParam0) // Position - 0x74A5
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
void func_237(Hash hParam0, BOOL bParam1) // Position - 0x76FF
{
	if (bParam1)
	{
...
BOOL func_241(Hash hParam0) // Position - 0x779A
{
...
void func_242(Hash hParam0) // Position - 0x77B8
{
...
void func_243(Hash hParam0) // Position - 0x77D1
{
	if (STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		func_502(hParam0);
...
BOOL func_244(int* piParam0, int iParam1, int iParam2) // Position - 0x77E9
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

struct<20> func_245(BOOL bParam0) // Position - 0x7820
{
	var unk;
	var guid;
	var unk24;
...
BOOL func_246(int iParam0, int iParam1) // Position - 0x78BC
{
	return iParam0 && iParam1 != false;
}

struct<2> func_247(Player plParam0) // Position - 0x78CB
{
	var gamerHandle;
...
BOOL func_248(int iParam0, var uParam1, var uParam2, int iParam3) // Position - 0x78DF
{
	if (iParam0 < 4)
		iParam0 = 4;
...
void func_249(int iParam0) // Position - 0x79AC
{
	func_98(&(Global_1144526[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*83*/].f_33.f_4), iParam0);
	return;
}

void func_250(int iParam0, int iParam1) // Position - 0x79C8
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

int func_251(Hash hParam0) // Position - 0x79D9
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
int func_252(Hash* phParam0) // Position - 0x7A93
{
	Any any;
...
BOOL func_253(Hash* phParam0, int iParam1, Vector3* pvParam2, float* pfParam3) // Position - 0x7ABF
{
	Any any;
...
int func_254() // Position - 0x7B21
{
	return Global_1893611.f_2;
}

BOOL func_255(int iParam0) // Position - 0x7B2F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

int func_256(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x7B45
{
	int num;
	int num2;
	int num3;
...
int func_257(int iParam0) // Position - 0x7BFC
{
...
int func_258(int iParam0) // Position - 0x7C19
{
...
BOOL func_259(int iParam0, var uParam1) // Position - 0x7C36
{
	var ReturnZ;
	float volumeScale;
	float num;
...
void func_261(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x7D91
{
	switch (uParam0.f_5)
	{
		case 1:
...
void func_262(BOOL bParam0) // Position - 0x7DBE
{
	if (!bParam0)
	{
		func_257(5);
...
void func_263(BOOL bParam0, BOOL bParam1) // Position - 0x7DE8
{
	if (func_156(255) == 4)
		return;
...
void func_264(BOOL bParam0) // Position - 0x7F33
{
	if (!bParam0)
	{
		func_257(6);
...
int func_265(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x7F5D
{
	int i;
	int num;
	float num2;
...
void func_266(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13) // Position - 0x7FBA
{
	if (func_156(255) == 4)
		return;
...
Vector3 func_267() // Position - 0x8190
{
	return 0f, 0f, 0f;
}

struct<10> func_268(int iParam0) // Position - 0x819B
{
	var unk;
...
BOOL func_269(int iParam0, Vector3* pvParam1, var uParam2) // Position - 0x81C8
{
	int num;
	float num2;
...
void func_271(int iParam0, var uParam1, var uParam2) // Position - 0x827E
{
	int num;
...
BOOL func_272(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x829A
{
...
void func_273(int iParam0, int iParam1) // Position - 0x833C
{
	int Variable;
...
BOOL func_274(var uParam0, var uParam1, var uParam2, float fParam3) // Position - 0x8360
{
	if (_IS_NULL_VECTOR(uParam0))
		return false;
...
void func_275(BOOL bParam0) // Position - 0x83E7
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

void func_276() // Position - 0x83FF
{
	func_530();
	func_531();
	func_532();
...
char* func_281(int iParam0) // Position - 0x854B
{
	switch (iParam0)
	{
		case 1:
...
void func_284(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x864B
{
	int num;
	int i;
	int j;
...
struct<10> func_285(int iParam0, int iParam1, var uParam2) // Position - 0x87BE
{
	int num;
	var unk10;
	var unk11;
...
void func_286(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x891B
{
	int num;
	int i;
	int num2;
...
BOOL func_287(Player plParam0, BOOL bParam1) // Position - 0x8AA3
{
	return func_565(plParam0, bParam1) >= 4;
}

BOOL func_288(Player plParam0, BOOL bParam1) // Position - 0x8AB5
{
	return func_565(plParam0, bParam1) >= 2 && func_565(plParam0, bParam1) < 4;
}

BOOL func_289(int iParam0) // Position - 0x8AD6
{
	int num;
...
int func_290(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x8B30
{
	int num;
	var unk13;
	int num2;
...
var func_291(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x8B6B
{
	var value;
	Player bitIndex;
	int i;
...
int func_292(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x8EFE
{
	if (!func_571(uParam0))
		return 0;
...
void func_293(int iParam0) // Position - 0x8F2E
{
	*iParam0 = -1;
	iParam0->f_1 = -1;
	return;
...
BOOL func_295(Player plParam0, BOOL bParam1) // Position - 0x8F5B
{
	Player bitIndex;
	int playerTeam;
	int playerTeam2;
...
struct<30> func_296() // Position - 0x905D
{
	var unk;
	var unk5;
	int i;
...
void func_297(var uParam0) // Position - 0x915D
{
	return;
}

void func_298() // Position - 0x9165
{
	BOOL flag;
...
int func_299() // Position - 0x9183
{
	return Global_1072759.f_23.f_1;
}

void func_300(int iParam0) // Position - 0x9193
{
	Global_1072759.f_23.f_1 = iParam0;
	return;
}

void func_301() // Position - 0x91A5
{
	if (func_572() == -1)
		return;
...
BOOL func_302() // Position - 0x91DE
{
	return func_61(Global_1572887.f_8, true);
}

void func_303() // Position - 0x91F1
{
	func_575(true);
	func_575(2);
	func_575(4);
...
void func_308() // Position - 0x9449
{
	func_64();
	return;
}

void func_309() // Position - 0x9455
{
...
char* func_318(int iParam0) // Position - 0x9B6D
{
	switch (iParam0)
	{
		case 0:
...
int func_320() // Position - 0x9CB4
{
	return Global_1296390;
}

BOOL func_321() // Position - 0x9CC0
{
...
void func_323(int iParam0) // Position - 0x9D82
{
	Global_1296390 = iParam0;
	return;
}

BOOL func_324() // Position - 0x9D90
{
	int i;
	var unk;
...
void func_328(int iParam0) // Position - 0x9FB7
{
	int i;
	int numGangMembers;
	Hash missionId;
...
var func_329() // Position - 0xA19A
{
	return Global_1296390.f_58;
}

BOOL func_330(int iParam0) // Position - 0xA1A8
{
	if (Global_1048577)
		return false;
...
void func_331(int iParam0) // Position - 0xA1E0
{
	Global_1296390.f_58 = iParam0;
	return;
}

BOOL func_332(Player plParam0) // Position - 0xA1F0
{
	return Global_1056554[plParam0 /*491*/].f_204.f_9;
}

void func_333(int iParam0) // Position - 0xA205
{
	Global_1296390.f_58.f_1 = iParam0;
	return;
}

BOOL func_334(BOOL bParam0) // Position - 0xA217
{
	int num;
...
void func_335(int iParam0) // Position - 0xA241
{
	Global_1296390.f_58.f_1.f_2 = Global_1296390.f_58.f_1.f_2 || iParam0;
	return;
}

BOOL func_336() // Position - 0xA260
{
	return Global_1296390.f_58.f_1;
}

int func_337(BOOL bParam0) // Position - 0xA270
{
	var unk;
	int num;
...
void func_341(int iParam0) // Position - 0xA360
{
	Global_1296390.f_58.f_1.f_1 = Global_1296390.f_58.f_1.f_1 || iParam0;
	return;
}

void func_342() // Position - 0xA37F
{
	BOOL flag;
...
BOOL func_343() // Position - 0xA393
{
	return Global_1072759.f_28644.f_23.f_3 != 0;
}

struct<2> func_344(int iParam0) // Position - 0xA3A8
{
	return Global_1296390.f_58.f_4[iParam0 /*10*/];
}

int func_345(var uParam0, var uParam1) // Position - 0xA3BE
{
	var unk;
...
int func_346(int iParam0) // Position - 0xA3EA
{
	return Global_1296390.f_58.f_4[iParam0 /*10*/].f_3;
}

struct<8> func_347(int iParam0) // Position - 0xA400
{
	var unk;
	var unk6;
...
const char* func_348(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xA497
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

void func_349(int iParam0) // Position - 0xA4AB
{
	func_515(&(Global_1296390.f_50.f_3), func_653(iParam0, 1), 1);
	return;
}

void func_350(BOOL bParam0) // Position - 0xA4C8
{
	func_37(&(Global_1572887.f_72.f_16), bParam0);
	return;
}

int func_351(int iParam0) // Position - 0xA4DE
{
	return Global_1296390.f_58.f_4[iParam0 /*10*/].f_3.f_1;
}

int func_352(int iParam0) // Position - 0xA4F6
{
	return Global_1296390.f_58.f_4[iParam0 /*10*/].f_3.f_2;
}

struct<2> func_353(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xA50E
{
	var unk;
	var unk6;
	int num;
...
void func_354(Any* panParam0) // Position - 0xA5DE
{
	MISC::COPY_SCRIPT_STRUCT(&(Global_1296390.f_50.f_5), panParam0, 3);
	return;
}

void func_355() // Position - 0xA5F5
{
	var unk;
...
BOOL func_357() // Position - 0xA653
{
	return Global_1901671.f_1 != -1;
}

BOOL func_358() // Position - 0xA663
{
	if (NETWORK::NETWORK_IS_TUNABLE_CLOUD_REQUEST_PENDING())
	{
		func_660();
...
int func_360() // Position - 0xA68E
{
	return func_661();
}

void func_361() // Position - 0xA69A
{
	func_663(func_662(1));
...
BOOL func_364(int iParam0, int iParam1) // Position - 0xA7D9
{
	BOOL num;
...
BOOL func_366(int iParam0) // Position - 0xA89E
{
	int i;
...
BOOL func_368(int iParam0, Player plParam1) // Position - 0xA922
{
	if (!func_691(iParam0))
		return false;
...
void func_369() // Position - 0xA966
{
	Global_1960746 = false;
	return;
}

void func_370(int iParam0) // Position - 0xA973
{
	Player playerIndex;
...
void func_371(int iParam0) // Position - 0xA9C9
{
	Player playerIndex;
...
int func_372(var uParam0, var uParam1) // Position - 0xAA20
{
	int num;
...
void func_373(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, int iParam6) // Position - 0xAA5B
{
	var StringToTest;
...
int func_374(var uParam0, var uParam1) // Position - 0xAB59
{
	int num;
	int num2;
	var unk;
...
int func_376() // Position - 0xAC30
{
	return Global_1295849.f_492;
}

BOOL func_377(int iParam0) // Position - 0xAC3F
{
	return Global_1295849.f_492.f_1 && iParam0 != false;
}

void func_378(int iParam0) // Position - 0xAC55
{
	Global_1295849.f_492 = iParam0;
	return;
}

void func_379(int iParam0) // Position - 0xAC66
{
	Global_1295849.f_492.f_1 = Global_1295849.f_492.f_1 || iParam0;
	return;
}

BOOL func_380() // Position - 0xAC83
{
	return func_707() == PLAYER::PLAYER_ID();
}

BOOL func_381() // Position - 0xAC94
{
	int num;
	int num2;
	Hash unlockHash;
...
void func_382(int iParam0) // Position - 0xAD26
{
	Player player;
...
BOOL func_385(Player plParam0, int iParam1) // Position - 0xADF2
{
	if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(plParam0))
		return false;
...
void func_387(BOOL bParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAE3A
{
	if (bParam0)
	{
		func_724(1);
...
void func_388(int iParam0) // Position - 0xAE87
{
	func_726(0, 0, iParam0, 129, -1, false, -1);
	return;
}

int func_389() // Position - 0xAE9C
{
	return Global_1295849.f_492.f_2;
}

int func_390(int iParam0) // Position - 0xAEAD
{
	return Global_1295849[iParam0 /*37*/].f_8;
}

int func_391() // Position - 0xAEBF
{
	return Global_1295849.f_492.f_5;
}

int func_392(int iParam0) // Position - 0xAED0
{
	switch (iParam0)
	{
		case 0:
...
void func_393(int iParam0) // Position - 0xAEF8
{
	Global_1295849.f_492.f_10 = iParam0;
	return;
}

void func_394() // Position - 0xAF0B
{
	var SourceStruct;
...
BOOL func_395(int iParam0) // Position - 0xAF3E
{
	Player gangLeader;
...
BOOL func_396() // Position - 0xAF73
{
	return Global_1295849.f_492.f_29;
}

int func_397() // Position - 0xAF84
{
	if (func_60() == 0)
...
void func_398(int iParam0) // Position - 0xAF9F
{
	Global_1295849.f_492.f_14 = iParam0;
	return;
}

struct<4> func_399(BOOL bParam0) // Position - 0xAFB2
{
	int num;
...
Hash func_400(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xB052
{
...
void func_401(int iParam0) // Position - 0xB0D1
{
	Global_1295849.f_492.f_15 = iParam0;
	return;
}

Hash func_402(int iParam0) // Position - 0xB0E4
{
	Hash hash;
...
void func_403(Hash hParam0) // Position - 0xB11B
{
	Global_1295849.f_492.f_12 = hParam0;
	return;
}

void func_404(Hash hParam0) // Position - 0xB12E
{
	Global_1295849.f_492.f_13 = hParam0;
	return;
}

void func_405() // Position - 0xB141
{
	Global_1913444 = true;
	return;
}

void func_406() // Position - 0xB14E
{
	var SourceStruct;
...
BOOL func_407() // Position - 0xB171
{
	return !Global_1913444;
}

void func_408() // Position - 0xB17E
{
	Global_1913444 = false;
	return;
}

void func_409(int iParam0) // Position - 0xB18B
{
	Global_1295849.f_492.f_1 = Global_1295849.f_492.f_1 - Global_1295849.f_492.f_1 && iParam0;
	return;
}

var func_410() // Position - 0xB1B2
{
	return Global_1295849.f_492.f_14;
}

int func_411(const char* sParam0, char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0xB1C3
{
	int num;
	var unk13;
	int num2;
...
var func_412() // Position - 0xB226
{
	return Global_1295849.f_492.f_15;
}

int func_413(int iParam0) // Position - 0xB237
{
	return iParam0 / 100;
}

int func_414(int iParam0, BOOL bParam1) // Position - 0xB244
{
	if (bParam1)
...
var func_415() // Position - 0xB262
{
	return Global_1295849.f_492.f_12;
}

var func_416() // Position - 0xB273
{
	return Global_1295849.f_492.f_13;
}

int func_417() // Position - 0xB284
{
	return Global_1295849.f_492.f_4;
}

void func_418(int iParam0) // Position - 0xB295
{
	Global_1295849.f_537 = Global_1295849.f_537 || iParam0;
	return;
}

void func_419() // Position - 0xB2AE
{
	int num;
	int num2;
...
void func_423(int iParam0) // Position - 0xB3BD
{
	Global_1940252.f_11600 = iParam0;
	return;
}

void func_424(int iParam0) // Position - 0xB3CE
{
	int num;
	int i;
...
void func_425() // Position - 0xB474
{
	func_423(3);
	return;
}

void func_426() // Position - 0xB481
{
	Global_1207339.f_1 = 0;
...
int func_427() // Position - 0xB8E3
{
	return Global_1300387.f_155;
}

int func_428(int iParam0) // Position - 0xB8F1
{
	return Global_1300387.f_155.f_4[iParam0 /*4*/];
}

void func_429() // Position - 0xB905
{
	int Arg;
	Player Plr;
	Ped playerPed;
...
void func_432(int iParam0) // Position - 0xBAE1
{
	Global_1300387.f_155 = iParam0;
	return;
}

void func_433() // Position - 0xBAF1
{
	int Arg;
	int alpha_param;
	int timeDifference;
...
void func_434(Player plParam0) // Position - 0xBC5E
{
	Player Plr;
	int* p_num;
	int num;
...
void func_435(Player plParam0) // Position - 0xBD3F
{
...
void func_437(int iParam0, Player plParam1) // Position - 0xBD97
{
...
void func_438(int iParam0) // Position - 0xBED6
{
	Player Plr;
...
void func_439(int iParam0) // Position - 0xBF66
{
	Player i;
	Player Plr;
	Player player;
...
void func_440(int iParam0, int iParam1) // Position - 0xC033
{
	Player Plr;
...
void func_441(BOOL bParam0) // Position - 0xC0BA
{
	Global_1893611 = Global_1893611 || bParam0;
	return;
}

void func_442(var uParam0) // Position - 0xC0CD
{
	var unk;
	int i;
...
void func_443(Any* panParam0) // Position - 0xC2D1
{
	int i;
...
void func_444(Any* panParam0) // Position - 0xC2F9
{
	int i;
...
void func_445(int* piParam0) // Position - 0xC321
{
	var unk;
	int i;
...
void func_446(Any* panParam0) // Position - 0xC376
{
	int i;
...
void func_447(Any* panParam0) // Position - 0xC39E
{
	var unk;
	int i;
...
void func_448(int* piParam0) // Position - 0xC3E5
{
	var unk;
...
void func_449(Any* panParam0) // Position - 0xC3FF
{
	var unk;
	int i;
...
void func_450(Any* panParam0) // Position - 0xC42D
{
	int i;
...
void func_451(int* piParam0) // Position - 0xC455
{
	var unk;
...
void func_452(int iParam0) // Position - 0xCFC8
{
	var unk;
...
void func_453(int iParam0) // Position - 0xCFD8
{
	var unk;
...
void func_454(Any* panParam0) // Position - 0xD01A
{
	int i;

	for (i = 0; i <= 31; i = i + 1)
	{
		func_453(&panParam0->[i /*56*/]);
	}

	return;
}

void func_455(Any* panParam0) // Position - 0xD03F
{
	var unk;
...
void func_456(Any* panParam0) // Position - 0xD060
{
	int i;

	for (i = 0; i <= 31; i = i + 1)
	{
		func_455(&panParam0->[i /*8*/]);
	}

	return;
}

void func_457(int iParam0) // Position - 0xD085
{
	Global_1107816.f_750 = iParam0;
	return;
}

void func_458() // Position - 0xD096
{
	Global_1107816.f_750.f_1 = NETWORK::GET_NETWORK_TIME_ACCURATE();
	return;
}

void func_459() // Position - 0xD0AB
{
	Global_1138673[PLAYER::PLAYER_ID() /*56*/].f_49.f_4 = 1;
	return;
}

void func_460(int iParam0) // Position - 0xD0C2
{
	Global_1110244.f_4607.f_2 = Global_1110244.f_4607.f_2 || iParam0;
	return;
}

void func_461(int* piParam0) // Position - 0xD0DF
{
	var unk;
...
void func_462(Any* panParam0) // Position - 0xD891
{
	int i;
...
void func_463(int* piParam0) // Position - 0xD8B9
{
	var unk;
...
void func_464(BOOL bParam0) // Position - 0xD905
{
	var unk;
...
void func_465(int iParam0) // Position - 0xD91E
{
	var unk;
...
void func_466(Any* panParam0) // Position - 0xD957
{
	int i;

	for (i = 0; i < *panParam0; i = i + 1)
	{
		func_464(&panParam0->[i /*2*/]);
	}

	return;
}

void func_467() // Position - 0xD97D
{
	func_770(&Global_1220761);
	return;
}

void func_468(Any* panParam0) // Position - 0xD98D
{
	int i;
...
void func_469(int iParam0) // Position - 0xD9B5
{
	var SourceStruct;
...
void func_470(Any* panParam0) // Position - 0xD9E4
{
	int i;

	for (i = 0; i <= 31; i = i + 1)
	{
		func_469(&panParam0->[i /*9*/]);
	}

	return;
}

int func_471(int iParam0) // Position - 0xDA09
{
	if (!func_686(iParam0))
		return -1;
...
BOOL func_472(int iParam0) // Position - 0xDA3C
{
	int num;
	Hash hash;
...
Hash func_473(int iParam0) // Position - 0xE992
{
	if (iParam0 == 255)
		iParam0 = func_191();
...
Hash func_474() // Position - 0xE9D3
{
	return PED::GET_PED_RELATIONSHIP_GROUP_HASH(PLAYER::PLAYER_PED_ID());
}

BOOL func_475(int iParam0) // Position - 0xE9E3
{
	if (iParam0 < 0)
		return false;
...
int func_476(int iParam0) // Position - 0xEA22
{
	return iParam0;
}

void func_477(int iParam0) // Position - 0xEA2C
{
	if (!func_783(iParam0))
		return;
...
BOOL func_478(int iParam0) // Position - 0xEADF
{
	if (iParam0 == 255)
...
BOOL func_480() // Position - 0xEB33
{
	return Global_1900460.f_67;
}

BOOL func_481(int iParam0) // Position - 0xEB41
{
	return func_227(0, iParam0) || func_227(1, iParam0) || func_227(2, iParam0);
}

BOOL func_482(Player plParam0) // Position - 0xEB6A
{
	Player player;
...
int func_484() // Position - 0xEC47
{
	return Global_1572887.f_72.f_40;
}

BOOL func_485() // Position - 0xEC57
{
	return Global_1051645.f_80.f_102 > 0;
}

BOOL func_486() // Position - 0xEC69
{
	return Global_1142424.f_2042 > 0;
}

BOOL func_487() // Position - 0xEC7A
{
	int i;
...
BOOL func_489() // Position - 0xED44
{
	return Global_1235687.f_9478 != -1;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0xED55
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_493(Hash hParam0) // Position - 0xEDFF
{
	if (hParam0 == 0)
		return false;
...
BOOL func_494(var uParam0) // Position - 0xEE1C
{
...
char* func_495(char* sParam0) // Position - 0xEE40
{
	return sParam0;
}

BOOL func_496(int iParam0, int iParam1, int iParam2) // Position - 0xEE4A
{
...
int func_497(Player plParam0) // Position - 0xEE7A
{
	return Global_1138673[plParam0 /*56*/];
}

BOOL func_498(int iParam0) // Position - 0xEE8A
{
	return iParam0 >= 0 && iParam0 < 32;
}

struct<2> func_499(int iParam0) // Position - 0xEEA0
{
	return Global_1107816.f_33[iParam0 /*16*/].f_3.f_5;
}

const char* func_500(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xEEB8
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_501(Hash hParam0) // Position - 0xEECC
{
	if (STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		return 1;
...
int func_502(Hash hParam0) // Position - 0xEEF3
{
	if (!STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		return 1;
...
struct<4> func_503(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xEF1B
{
	var outGuid;
...
int func_504(BOOL bParam0) // Position - 0xEF4C
{
	if (func_60() == -1)
	{
...
struct<17> func_505(var uParam0, BOOL bParam1) // Position - 0xEF8D
{
	var unk;
...
BOOL func_506(int iParam0, int iParam1) // Position - 0xF00E
{
	Any gangId;
...
BOOL func_511(int iParam0) // Position - 0xF1DC
{
	return func_246(Global_1147183.f_8, iParam0);
}

void func_512(int iParam0) // Position - 0xF1F0
{
	Global_1142424.f_2019 = iParam0;
	return;
}

int func_513(var uParam0, var uParam1, var uParam2) // Position - 0xF201
{
	int num;
...
BOOL func_514(int* piParam0, int iParam1, int iParam2) // Position - 0xF23C
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_515(int* piParam0, int iParam1, int iParam2) // Position - 0xF26E
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_516(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xF2A1
{
	func_789(iParam0);
...
int func_517(int iParam0) // Position - 0xF303
{
	switch (iParam0)
	{
		case 0:
...
int func_518(int iParam0, var uParam1) // Position - 0xF34B
{
	*uParam1 = iParam0;
...
int func_519(int iParam0) // Position - 0xF753
{
	switch (iParam0)
	{
		case 0:
...
int func_520(int iParam0, int iParam1) // Position - 0x1013C
{
	var unk;
	var statId;
...
BOOL func_521(int iParam0, int iParam1) // Position - 0x1015B
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_522(int iParam0) // Position - 0x10173
{
...
BOOL func_523(int iParam0) // Position - 0x1018A
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_524(int iParam0, int iParam1) // Position - 0x10256
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_525(int iParam0) // Position - 0x1026F
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_526() // Position - 0x10282
{
	if (!func_26())
		return false;
...
BOOL func_527(int iParam0, int iParam1) // Position - 0x1029D
{
	int num;
...
void func_528(var uParam0) // Position - 0x10311
{
	var unk;
...
void func_529(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x10323
{
	switch (uParam0.f_5)
	{
		case 1:
...
void func_530() // Position - 0x10350
{
	func_793(-1687561002);
	func_793(1957225320);
	func_793(-860696938);
...
void func_531() // Position - 0x103FA
{
	func_793(1209017192);
	func_793(-2143243848);
	func_793(510052409);
...
void func_532() // Position - 0x10489
{
	func_793(-1232260252);
	func_793(1404611977);
	func_793(-1395712024);
...
void func_533() // Position - 0x104AC
{
...
void func_534() // Position - 0x104E1
{
	func_793(531106429);
	func_793(1069611813);
	func_793(1102643191);
...
BOOL func_535(int iParam0, int iParam1) // Position - 0x10531
{
	switch (iParam0)
	{
		case 0:
...
struct<8> func_536(int iParam0, int iParam1) // Position - 0x105A3
{
	var unk;
...
int func_537(int iParam0) // Position - 0x105CC
{
	switch (iParam0)
	{
		case -1:
...
void func_538(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1064F
{
	int i;
	int j;
...
void func_539(var uParam0, int iParam1) // Position - 0x1068A
{
...
void func_540(var uParam0, int iParam1) // Position - 0x106C2
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_541(var uParam0, int iParam1) // Position - 0x106FB
{
...
void func_542(var uParam0, int iParam1) // Position - 0x10736
{
	int num;
	int num2;
...
void func_543(var uParam0, int iParam1) // Position - 0x10789
{
...
void func_544(var uParam0, int iParam1) // Position - 0x107C5
{
	if (iParam1 < 0)
		return;
...
int func_545(int iParam0) // Position - 0x1084B
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_546(int iParam0) // Position - 0x10870
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_547(int iParam0) // Position - 0x10883
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_548(int iParam0) // Position - 0x10896
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_549(int iParam0) // Position - 0x108A9
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_550(int iParam0) // Position - 0x108BB
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_551(int iParam0, int iParam1) // Position - 0x108CD
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_552(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x10967
{
...
void func_553(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1099F
{
...
void func_554(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5) // Position - 0x109CC
{
	int num;
...
int func_555(int iParam0) // Position - 0x10A37
{
	switch (iParam0)
	{
		case 0:
...
int func_556(int iParam0) // Position - 0x10AA0
{
	switch (iParam0)
	{
		case 0:
...
int func_557(int iParam0) // Position - 0x10B09
{
	switch (iParam0)
	{
		case 0:
...
int func_558(int iParam0) // Position - 0x10B72
{
	switch (iParam0)
	{
		case 0:
...
int func_559(int iParam0) // Position - 0x10BDB
{
	switch (iParam0)
	{
		case 0:
...
int func_560(int iParam0) // Position - 0x10C44
{
	switch (iParam0)
	{
		case 0:
...
int func_561(int iParam0) // Position - 0x10CAD
{
	switch (iParam0)
	{
		case 0:
...
int func_562(int iParam0) // Position - 0x10D16
{
	switch (iParam0)
	{
		case 0:
...
int func_563(int iParam0) // Position - 0x10D7F
{
	switch (iParam0)
	{
		case 0:
...
int func_564(int iParam0) // Position - 0x10DE8
{
	switch (iParam0)
	{
		case 0:
...
int func_565(Player plParam0, BOOL bParam1) // Position - 0x10E51
{
	int num;
	int num2;
	int num3;
...
int func_566() // Position - 0x10F1E
{
	return Global_1051645.f_12;
}

char* func_567() // Position - 0x10F2C
{
	return "unnamed";
}

BOOL func_568(int iParam0) // Position - 0x10F38
{
	int num;
...
BOOL func_569(int iParam0) // Position - 0x10FC7
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_570(Player plParam0) // Position - 0x10FE5
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_571(var uParam0) // Position - 0x1102A
{
	if (*uParam0 >= 40)
		return false;
...
int func_572() // Position - 0x1103F
{
	return Global_1072759.f_23.f_2;
}

void func_573() // Position - 0x1104F
{
	var unk;
...
void func_574(int iParam0) // Position - 0x11085
{
	Global_1072759.f_23.f_2 = iParam0;
	return;
}

void func_575(BOOL bParam0) // Position - 0x11097
{
...
void func_576(BOOL bParam0) // Position - 0x110E4
{
	if (!Global_1072759.f_3)
		return;
...
int func_577(int iParam0) // Position - 0x11130
{
	switch (iParam0)
	{
		case 0:
...
void func_578(BOOL bParam0, BOOL bParam1) // Position - 0x111C2
{
...
BOOL func_579(BOOL bParam0, Player plParam1) // Position - 0x111EB
{
	if (plParam1 == 255)
...
void func_580(BOOL bParam0) // Position - 0x11223
{
	int num;
...
int func_581(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, Hash hParam10, int iParam11) // Position - 0x1124E
{
	int i;
	int num;
...
BOOL func_582(int iParam0, BOOL bParam1) // Position - 0x112D7
{
	int num;
	int gameTimer;
	float progress;
...
void func_583(BOOL bParam0) // Position - 0x113D1
{
	int num;
...
BOOL func_584(Player plParam0) // Position - 0x11405
{
...
void func_585(int iParam0) // Position - 0x11421
{
	Global_1295299.f_29 = iParam0;
	return;
}

BOOL func_586(BOOL bParam0) // Position - 0x11431
{
	return Global_1102813.f_26.f_9 && bParam0 != false;
}

BOOL func_587(int iParam0) // Position - 0x11446
{
	return Global_1102813.f_26.f_7 && iParam0 != false;
}

void func_588() // Position - 0x1145B
{
	int num;
...
void func_589() // Position - 0x114AD
{
	int num;
...
int func_590() // Position - 0x11591
{
	return Global_1296390.f_50;
}

var func_591() // Position - 0x1159F
{
	return Global_1296390.f_50.f_1;
}

BOOL func_592(int iParam0) // Position - 0x115AF
{
	int currentMessage;
...
int func_593(int iParam0) // Position - 0x115DA
{
	var unk;
...
int func_594() // Position - 0x11631
{
	return Global_1296390.f_50.f_2;
}

BOOL func_595() // Position - 0x11641
{
	int currentMessage;
...
void func_597(int iParam0) // Position - 0x117D6
{
	Global_1296390.f_50.f_1 = iParam0;
	return;
}

void func_598(int iParam0) // Position - 0x117E8
{
	func_514(&(Global_1296390.f_50.f_3), func_653(iParam0, 1), 1);
	return;
}

void func_599() // Position - 0x11805
{
	var unk;
...
void func_600(int iParam0) // Position - 0x11815
{
	Global_1296390.f_50.f_2 = iParam0;
	return;
}

void func_601() // Position - 0x11827
{
	var unk;
...
int func_602(int iParam0) // Position - 0x11848
{
	return Global_1296390.f_50.f_3[iParam0];
}

int func_603(int iParam0, int iParam1) // Position - 0x1185C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_604(int iParam0) // Position - 0x118F9
{
	return func_244(&(Global_1296390.f_50.f_3), func_653(iParam0, 1), 1);
}

void func_605(int iParam0) // Position - 0x11915
{
	Global_1296390.f_50 = iParam0;
	return;
}

int func_606() // Position - 0x11925
{
	var unk;
...
BOOL func_607(var uParam0) // Position - 0x11968
{
	int i;
	BOOL value;
	int bitShift;
...
int func_608(int iParam0) // Position - 0x11A01
{
	var unk;
...
struct<4> func_609(int iParam0, int iParam1) // Position - 0x11A6C
{
	var unk;
	var unk6;
	int num;
...
void func_610(var uParam0, BOOL bParam1) // Position - 0x11B03
{
	int num;
	var unk;
...
void func_611(int iParam0, Any* panParam1) // Position - 0x11B4C
{
	MISC::COPY_SCRIPT_STRUCT(panParam1, &Global_1296390.f_118[iParam0 /*6*/], 4);
	return;
}

BOOL func_612(Any anParam0) // Position - 0x11B65
{
...
int func_613(int iParam0) // Position - 0x11BAB
{
	var unk;
...
int func_614(int iParam0) // Position - 0x11C15
{
	var unk;
...
BOOL func_615(int iParam0, int iParam1) // Position - 0x11C7F
{
	var unk;
...
int func_616(int iParam0, int iParam1) // Position - 0x11CF7
{
	var unk;
...
BOOL func_617(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x11D88
{
	var unk;
	var unk8;
	var unk13;
...
void func_618(int iParam0, int iParam1, int iParam2) // Position - 0x11EA6
{
	Global_1296390.f_83[iParam0 /*17*/].f_1[iParam1] = iParam2;
	return;
}

void func_619(int iParam0, int iParam1) // Position - 0x11EC0
{
	Global_1296390.f_83[iParam0 /*17*/] = iParam1;
	return;
}

void func_620(int iParam0) // Position - 0x11ED4
{
	Global_1296390.f_2.f_45 = iParam0;
	return;
}

void func_621(int iParam0, int iParam1) // Position - 0x11EE6
{
	Global_1296390.f_2[iParam0 /*22*/].f_16 = iParam1;
	return;
}

int func_622(int iParam0) // Position - 0x11EFC
{
	var unk;
...
void func_623(int iParam0, int iParam1) // Position - 0x11F1F
{
	Global_1296390.f_2[iParam0 /*22*/].f_17 = iParam1;
	return;
}

struct<2> func_624(int iParam0, int iParam1) // Position - 0x11F35
{
	var unk;
	var unk6;
	int num;
...
void func_625(int iParam0, var uParam1, var uParam2) // Position - 0x11FD6
{
	Global_1296390.f_2[iParam0 /*22*/].f_18 = { uParam1 };
	return;
}

BOOL func_626(int iParam0) // Position - 0x11FF0
{
	return func_628(iParam0, 0) != 0;
}

void func_627(int iParam0, BOOL bParam1) // Position - 0x12001
{
	Global_1296390.f_2[iParam0 /*22*/].f_20 = bParam1;
	return;
}

int func_628(int iParam0, int iParam1) // Position - 0x12017
{
	var unk;
...
void func_629(int iParam0, int iParam1) // Position - 0x1206F
{
	Global_1296390.f_2[iParam0 /*22*/].f_21 = iParam1;
	return;
}

Hash func_630(int iParam0, int iParam1) // Position - 0x12085
{
	var unk;
...
void func_631(int iParam0, int iParam1, Hash hParam2) // Position - 0x12102
{
	Global_1296390.f_2[iParam0 /*22*/][iParam1] = hParam2;
	return;
}

int func_632() // Position - 0x1211A
{
	return Global_1296390.f_2.f_45;
}

int func_633(int iParam0) // Position - 0x1212A
{
	return Global_1296390.f_2[iParam0 /*22*/].f_16;
}

void func_634() // Position - 0x1213E
{
	int i;
	int num;
	int j;
...
int func_635() // Position - 0x12200
{
	return Global_1296390.f_48;
}

BOOL func_636(int iParam0) // Position - 0x1220E
{
	return Global_1296390.f_2[iParam0 /*22*/].f_20;
}

int func_637() // Position - 0x12222
{
	return Global_1296390.f_48.f_1;
}

Hash func_638(int iParam0, int iParam1) // Position - 0x12232
{
	return Global_1296390.f_2[iParam0 /*22*/][iParam1];
}

int func_639(int iParam0) // Position - 0x12248
{
	return Global_1296390.f_2[iParam0 /*22*/].f_17 * 60;
}

struct<2> func_640(int iParam0) // Position - 0x1225E
{
	return Global_1296390.f_2[iParam0 /*22*/].f_18;
}

int func_641(int iParam0) // Position - 0x12274
{
	return Global_1296390.f_83[iParam0 /*17*/];
}

Hash func_642(int iParam0) // Position - 0x12286
{
	return Global_1296390.f_2[iParam0 /*22*/].f_21;
}

void func_643(int iParam0) // Position - 0x1229A
{
	Global_1296390.f_48.f_1 = iParam0;
	return;
}

void func_644(int iParam0) // Position - 0x122AC
{
	Global_1296390.f_48 = iParam0;
	return;
}

struct<6> func_645(BOOL bParam0) // Position - 0x122BC
{
	var unk;
	int i;
	int bitShift;
...
int func_646(int iParam0, int iParam1) // Position - 0x1234C
{
	var unk;
...
struct<2> func_647(Hash hParam0, int iParam1) // Position - 0x123C9
{
	int num;
...
void func_648(int iParam0, var uParam1) // Position - 0x124EF
{
...
void func_649(BOOL bParam0) // Position - 0x1254F
{
	int i;
	int num;
	var unk;
...
BOOL func_650(Any* panParam0) // Position - 0x1265D
{
	int fileHandle;
	var SourceStruct;
...
BOOL func_651(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1269F
{
	var unk;
...
struct<8> func_652(Any* panParam0, int iParam1, int iParam2) // Position - 0x126D8
{
	var unk;
...
int func_653(int iParam0, int iParam1) // Position - 0x126F7
{
	switch (iParam0)
	{
...
int func_654(Any* panParam0) // Position - 0x12773
{
	return func_855(panParam0, 77, 1);
}

int func_655(Any* panParam0) // Position - 0x12784
{
	return func_855(panParam0, 78, 1);
}

struct<2> func_656(int iParam0, int iParam1) // Position - 0x12795
{
	int num;
...
struct<10> func_657(int iParam0) // Position - 0x127AB
{
	var DestStruct;
...
BOOL func_658(int iParam0) // Position - 0x12803
{
	return Global_1296390.f_58.f_1.f_2 && iParam0 != false;
}

void func_659(int iParam0) // Position - 0x1281A
{
	var unk;
...
void func_660() // Position - 0x12861
{
...
int func_661() // Position - 0x1287D
{
	return Global_1110244.f_21;
}

int func_662(int iParam0) // Position - 0x1288B
{
	return Global_1110244[iParam0];
}

void func_663(int iParam0) // Position - 0x1289B
{
...
void func_664(int iParam0, int iParam1) // Position - 0x128BB
{
	BOOL flag;
	int num;
...
void func_665() // Position - 0x1293B
{
	int sessionFlags;
	int num;
	int gangId;
...
BOOL func_666() // Position - 0x129EB
{
	return func_865();
}

void func_667(var uParam0, var uParam1) // Position - 0x129F7
{
	int num;
	var unk;
...
void func_668(int iParam0) // Position - 0x12B09
{
	int gangId;
	var unk;
	int num;
...
void func_669(int iParam0) // Position - 0x12BA0
{
	Player Plr;
	int num;
	int i;
...
void func_670(int iParam0) // Position - 0x12C49
{
	var unk;
	BOOL flag;
...
void func_671() // Position - 0x12D44
{
...
void func_672() // Position - 0x12D6A
{
	int num;
	var unk;
	var unk14;
...
void func_673() // Position - 0x12DFF
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
void func_674() // Position - 0x1300D
{
	int num;
...
void func_675() // Position - 0x13034
{
	int num;
	int num2;
...
void func_676() // Position - 0x1305F
{
	if (func_915(255))
		func_916(1);
	else
...
void func_677() // Position - 0x1307D
{
	Player gangLeader;
	int gameTimer;
...
void func_678() // Position - 0x13106
{
	int num;
	var unk;
...
void func_679() // Position - 0x131C5
{
	var unk;
	Player gangLeader;
...
void func_680() // Position - 0x1322A
{
	var unk;
	Player gangLeader;
...
void func_681() // Position - 0x1328F
{
	var unk;
	var unk6;
	int i;
...
void func_682() // Position - 0x1333D
{
	int num;
	int i;
	BOOL flag;
...
void func_684() // Position - 0x133BB
{
...
void func_685() // Position - 0x1340E
{
	Global_1939596 = 3;
...
BOOL func_686(int iParam0) // Position - 0x13423
{
	int num;
...
void func_687(int iParam0, var uParam1) // Position - 0x13440
{
	int num;
	int i;
	Player Plr;
...
void func_688(int iParam0, int iParam1) // Position - 0x13511
{
	BOOL flag;
	int i;
	int offset;
...
BOOL func_689(BOOL bParam0, int iParam1) // Position - 0x13668
{
	var Variable;
	int i;
...
BOOL func_690(int iParam0) // Position - 0x136AF
{
...
BOOL func_691(int iParam0) // Position - 0x136D1
{
	int num;
...
int func_692(var uParam0, var uParam1) // Position - 0x136EB
{
	var unk;
	var unk4;
	int num;
...
BOOL func_693(int iParam0) // Position - 0x13792
{
...
struct<2> func_694(int iParam0) // Position - 0x137B1
{
	if (!func_955(iParam0))
		return func_838();
...
int func_695(var uParam0, var uParam1) // Position - 0x137D6
{
	int i;
...
int func_696(int iParam0, int iParam1, int iParam2) // Position - 0x1381F
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_697(int iParam0, int iParam1) // Position - 0x13A8F
{
	return func_693(iParam0) && Global_1900562[iParam0 /*2*/].f_1 && iParam1 != false;
}

void func_698(var uParam0, var uParam1) // Position - 0x13AB1
{
	int num;
	int num2;
	var unk;
...
void func_699(int iParam0, int iParam1) // Position - 0x13B8F
{
	if (!func_693(iParam0))
		return;
...
BOOL func_700(var uParam0, var uParam1) // Position - 0x13BC6
{
	return func_372(uParam0) == 0;
}

void func_701(var uParam0, var uParam1, BOOL bParam2) // Position - 0x13BD8
{
	if (!func_18(uParam0))
		return;
...
int func_702() // Position - 0x13C18
{
	return Global_1295849.f_537.f_1;
}

void func_703() // Position - 0x13C29
{
	int i;
	int num;
	int num2;
...
Blip func_704() // Position - 0x13C8A
{
	return Global_1295849.f_537.f_2;
}

void func_705(Blip blParam0) // Position - 0x13C9B
{
	Global_1295849.f_537.f_2 = blParam0;
	return;
}

void func_706(int iParam0) // Position - 0x13CAE
{
	Global_1295849.f_537.f_1 = iParam0;
	return;
}

Player func_707() // Position - 0x13CC1
{
	return Global_1102813.f_3674;
}

int func_708() // Position - 0x13CD0
{
	return Global_1295849.f_492.f_3;
}

Hash func_709(int iParam0, int iParam1) // Position - 0x13CE1
{
	return Global_1295849[iParam0 /*37*/][iParam1];
}

int func_710(int iParam0, int iParam1) // Position - 0x13CF5
{
	return Global_1295849[iParam0 /*37*/].f_3[iParam1];
}

Hash func_711(int iParam0) // Position - 0x13D0B
{
	return Global_1295849.f_482[iParam0];
}

void func_712(int iParam0) // Position - 0x13D1E
{
	var unk;
...
void func_713(int iParam0) // Position - 0x13D4A
{
	var unk;
...
void func_714(int iParam0) // Position - 0x13D76
{
	var unk;
...
void func_715(int iParam0) // Position - 0x13DA2
{
	var unk;
...
var func_716(Player plParam0) // Position - 0x13DCE
{
	var unk;
...
void func_717(var uParam0) // Position - 0x13DEF
{
	Global_1295849.f_492.f_2 = uParam0;
	return;
}

var func_718(Player plParam0) // Position - 0x13E02
{
	var unk;
...
void func_719(var uParam0) // Position - 0x13E23
{
	Global_1295849.f_492.f_3 = uParam0;
	return;
}

var func_720(Player plParam0) // Position - 0x13E36
{
	var unk;
...
void func_721(var uParam0) // Position - 0x13E57
{
	Global_1295849.f_492.f_4 = uParam0;
	return;
}

var func_722(Player plParam0) // Position - 0x13E6A
{
	var unk;
...
void func_723(var uParam0) // Position - 0x13E8B
{
	Global_1295849.f_492.f_5 = uParam0;
	return;
}

void func_724(int iParam0) // Position - 0x13E9E
{
	func_98(&(Global_1072759.f_28644.f_8.f_1), iParam0);
	return;
}

void func_725(int iParam0) // Position - 0x13EB7
{
	if (func_974(iParam0))
...
void func_726(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5, Hash hParam6) // Position - 0x13ED9
{
...
struct<4> func_727() // Position - 0x13F33
{
	var unk;
...
BOOL func_728(Hash hParam0, int iParam1) // Position - 0x13F3F
{
	if (hParam0 == 0)
		return false;
...
int func_729(Hash hParam0, int iParam1) // Position - 0x13F59
{
	if (iParam1 == 0)
		return 0;
...
BOOL func_730(int iParam0) // Position - 0x13F85
{
...
Hash func_731(int iParam0) // Position - 0x13FA4
{
	if (!func_730(iParam0))
		return 0;
...
Hash func_732(int iParam0, BOOL bParam1) // Position - 0x13FC5
{
	Hash hash;
	Hash xp;
...
void func_733(const char* sParam0, char* sParam1, Hash hParam2) // Position - 0x14084
{
...
void func_734(int iParam0, int iParam1, int iParam2) // Position - 0x140B5
{
	Global_1295849.f_522[iParam0 /*7*/][iParam1 /*3*/].f_1 = iParam2;
	return;
}

void func_735(int iParam0, int iParam1, int iParam2) // Position - 0x140D0
{
	Global_1295849.f_522[iParam0 /*7*/][iParam1 /*3*/] = iParam2;
	return;
}

void func_736(int iParam0, int iParam1, int iParam2) // Position - 0x140E9
{
	Global_1295849.f_522[iParam0 /*7*/][iParam1 /*3*/].f_2 = iParam2;
	return;
}

Hash func_737() // Position - 0x14104
{
	return Global_1940252.f_11605;
}

int func_738(Hash hParam0) // Position - 0x14113
{
	int i;
...
BOOL func_739() // Position - 0x14149
{
	Hash currency;
	var unk3;
	int num;
...
BOOL func_740(Hash hParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x141AA
{
	var unk;
	var unk13;
	var unk26;
...
BOOL func_741(int iParam0) // Position - 0x141DA
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_742(Player plParam0, int iParam1) // Position - 0x141FB
{
	return Global_1101558[plParam0 /*38*/].f_36.f_1 && iParam1 != false;
}

float func_743(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x14214
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_744() // Position - 0x14232
{
	return 100f;
}

void func_745(int iParam0, int iParam1) // Position - 0x1423F
{
	Global_1300387.f_155.f_4[iParam0 /*4*/] = iParam1;
	return;
}

void func_746(int iParam0, int iParam1) // Position - 0x14255
{
	Global_1300387.f_155.f_4[iParam0 /*4*/].f_3 = iParam1;
	return;
}

void func_747(int iParam0) // Position - 0x1426D
{
	func_984(iParam0);
	func_985(iParam0);
	func_746(iParam0, 0);
...
void func_748(Player plParam0) // Position - 0x14288
{
	Hash i;
	Player player;
	int num;
...
int func_749(Player plParam0) // Position - 0x14334
{
	return Global_1101558[plParam0 /*38*/].f_36;
}

int func_750(int iParam0) // Position - 0x14346
{
	return Global_1300387.f_155.f_4[iParam0 /*4*/].f_3;
}

int func_751() // Position - 0x1435C
{
	return 3000;
}

int func_752(int iParam0, int iParam1, int iParam2) // Position - 0x14367
{
	if (iParam0 > iParam2)
		return iParam2;
...
float func_753(float fParam0, float fParam1, float fParam2) // Position - 0x1438C
{
	if (fParam0 > fParam2)
		return fParam2;
...
float func_754(float fParam0, float fParam1, float fParam2) // Position - 0x143B3
{
	return ((1f - fParam2) * fParam0) + (fParam2 * fParam1);
}

void func_755(Player plParam0, int iParam1) // Position - 0x143C8
{
	Hash i;
	Player player;
	int num;
...
void func_756(Player plParam0) // Position - 0x14517
{
	Hash i;
	Player player;
	int num;
...
void func_757(Player plParam0, int* piParam1, int iParam2) // Position - 0x145B9
{
	float num;
	var unk3;
...
BOOL func_758(Player plParam0, int iParam1) // Position - 0x14681
{
...
BOOL func_759(int* piParam0, int iParam1) // Position - 0x146F4
{
	Player i;
	var unk;
...
void func_760(int iParam0, int iParam1) // Position - 0x147B5
{
	iParam0->f_1 = iParam1;
	return;
}

void func_761(int iParam0, Player plParam1, Player plParam2) // Position - 0x147C3
{
...
void func_762(int iParam0) // Position - 0x14804
{
...
void func_763(var uParam0) // Position - 0x148C9
{
	var unk;
	int i;
...
void func_764(var uParam0) // Position - 0x14911
{
	var unk;
	int i;
	int j;
...
void func_765(var uParam0) // Position - 0x14A6A
{
	var unk;
...
void func_766(var uParam0) // Position - 0x14A8E
{
	var unk;
...
void func_767(var uParam0) // Position - 0x14ADD
{
	var unk;
...
void func_768(var uParam0) // Position - 0x14AFD
{
	var unk;
...
void func_769(var uParam0) // Position - 0x14B0A
{
	var unk;
...
void func_770(Any* panParam0) // Position - 0x14B4B
{
	var unk;
	int i;
...
void func_771(var uParam0) // Position - 0x14B7F
{
	var unk;
...
int func_772(int iParam0) // Position - 0x14C7D
{
	return iParam0 * 31;
}

int func_773(int iParam0) // Position - 0x14C89
{
	return func_772(iParam0) + 30;
}

int func_774(int iParam0, int iParam1) // Position - 0x14C99
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_775(int iParam0) // Position - 0x16A7C
{
...
BOOL func_776(int iParam0) // Position - 0x16A93
{
	int num;
	int num2;
	int offset;
...
BOOL func_777(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x16B12
{
	return BUILTIN::VDIST(Global_34, fParam0) < fParam3;
}

BOOL func_778(Hash hParam0, int iParam1, int iParam2) // Position - 0x16B2A
{
	Vector3 position;
	float radius;
	float num;
...
BOOL func_779() // Position - 0x16B8F
{
...
Hash func_780(int iParam0) // Position - 0x16BD4
{
	switch (iParam0)
	{
		case joaat("WS_MP_TREASURE_MAP_SAN_LUIS_SHORE_01"):
...
Vector3 func_781(int iParam0) // Position - 0x1733C
{
	switch (iParam0)
	{
		case joaat("WS_MP_TREASURE_MAP_BURNT_TOWN_01"):
...
int func_782(int iParam0) // Position - 0x1737F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_783(int iParam0) // Position - 0x17554
{
	return func_804(iParam0, 2);
}

BOOL func_784() // Position - 0x17563
{
	return func_791() == 4;
}

BOOL func_785() // Position - 0x17571
{
	return !func_93(2);
}

BOOL func_786() // Position - 0x1757F
{
	int num;
...
void func_787(int iParam0, int iParam1) // Position - 0x175C1
{
	func_1003(iParam0, iParam1);
	return;
}

int func_788(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x175D1
{
	if (fParam0 < fParam3)
...
void func_792(BOOL bParam0) // Position - 0x1768C
{
...
void func_793(Hash hParam0) // Position - 0x176B3
{
	if (STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		func_502(hParam0);
...
void func_794(Hash hParam0) // Position - 0x176CB
{
...
char* func_795(int iParam0) // Position - 0x176E2
{
	if (iParam0 == 2)
		return "dewclm";
...
char* func_796(int iParam0) // Position - 0x17716
{
	switch (iParam0)
	{
		case 0:
...
void func_797(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1777C
{
...
var func_798(BOOL bParam0, var uParam1, var uParam2) // Position - 0x177F7
{
	if (bParam0)
		return uParam1;
...
int func_799(var uParam0, var uParam1, var uParam2) // Position - 0x1780E
{
	float num;
...
float func_800(Player plParam0, BOOL bParam1) // Position - 0x178A7
{
	Player player;
...
BOOL func_801(Player plParam0) // Position - 0x17947
{
...
void func_802(Player plParam0) // Position - 0x17964
{
	Player player;
...
void func_803(Hash hParam0) // Position - 0x179E7
{
...
BOOL func_804(int iParam0, int iParam1) // Position - 0x17A25
{
	if (iParam0 < 0)
		return false;
...
BOOL func_806(int iParam0) // Position - 0x17D60
{
	return Global_1296390.f_1 && iParam0 != false;
}

BOOL func_807() // Position - 0x17D73
{
	return Global_1048577;
}

BOOL func_808(int iParam0) // Position - 0x17D7F
{
	int num;
	int num2;
	int num3;
...
void func_809(int iParam0) // Position - 0x17DC4
{
	Global_1296390.f_1 = Global_1296390.f_1 - Global_1296390.f_1 && iParam0;
	return;
}

void func_810(Any* panParam0) // Position - 0x17DE2
{
	MISC::COPY_SCRIPT_STRUCT(panParam0, &(Global_1296390.f_50.f_5), 3);
	return;
}

BOOL func_811(int iParam0) // Position - 0x17DF9
{
	return func_1014(iParam0);
}

int func_812(Any anParam0, int iParam1) // Position - 0x17E07
{
	anParam0->f_2 = iParam1;
	return DATAFILE::_PARSEDDATA_RQ_GET_NUM_NODES(anParam0);
}

 func_813(int iParam0, int iParam1) // Position - 0x17E1B
{
	var unk;
...
int func_814(Hash hParam0) // Position - 0x17E85
{
	int i;
...
Hash func_815(int iParam0, int iParam1, int iParam2) // Position - 0x17ED4
{
	var unk;
...
Hash func_816(Hash hParam0, BOOL bParam1) // Position - 0x17F78
{
	Hash hash;
...
const char* func_817(var uParam0, int iParam1) // Position - 0x17FA6
{
...
int func_818() // Position - 0x17FDC
{
	return BUILTIN::FLOOR(func_1020(2f, BUILTIN::TO_FLOAT(func_1019() - 1))) + 1;
}

int func_819(var uParam0, int iParam1, BOOL bParam2) // Position - 0x17FF9
{
	int num;
	int num2;
...
BOOL func_820(var uParam0, int iParam1, var uParam2) // Position - 0x18037
{
	int value;
	int num;
	int num2;
...
int func_821(Any* panParam0) // Position - 0x18091
{
	return func_855(panParam0, 79, 1);
}

struct<4> func_822(int iParam0) // Position - 0x180A2
{
	var unk;
	var unk6;
	var unk10;
...
BOOL func_823(var uParam0, BOOL bParam1) // Position - 0x1811A
{
	var unk;
...
BOOL func_825(int iParam0, Any anParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x1824E
{
	var unk;
	var unk13;
...
void func_826(int iParam0, Any* panParam1, BOOL bParam2, var uParam3) // Position - 0x1827E
{
...
struct<7> func_827(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1829E
{
	int num;
...
BOOL func_828(var uParam0, int iParam1) // Position - 0x18300
{
	Hash hash;
	Any any;
	var unk;
...
BOOL func_829(Any* panParam0, int iParam1, int iParam2) // Position - 0x1841D
{
...
int func_830(Any* panParam0) // Position - 0x18495
{
	return func_1038(panParam0, 83, true);
}

int func_831(Any* panParam0, int iParam1) // Position - 0x184A6
{
	return func_855(panParam0, 93, iParam1);
}

Hash func_832(Any* panParam0) // Position - 0x184B8
{
	return func_855(panParam0, 75, 1);
}

int func_833(int iParam0, int iParam1) // Position - 0x184C9
{
	return Global_1296390.f_83[iParam0 /*17*/].f_1[iParam1];
}

BOOL func_834(BOOL bParam0) // Position - 0x184E1
{
	BOOL flag;
	int num;
	BOOL value;
...
void func_835(int iParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x1850F
{
	int offset;
	BOOL flag;
...
int func_836(Any* panParam0) // Position - 0x18666
{
	return func_855(panParam0, 67, 1);
}

int func_837(int iParam0, Any* panParam1, int iParam2) // Position - 0x18677
{
	int num;
	int num2;
	int num3;
...
struct<2> func_838() // Position - 0x186CC
{
	var unk;
...
void func_839(int iParam0, var uParam1) // Position - 0x186E5
{
	Global_1296390.f_58.f_4[iParam0 /*10*/].f_3.f_2 = uParam1;
	return;
}

void func_840(int iParam0, var uParam1) // Position - 0x186FF
{
	Global_1296390.f_58.f_4[iParam0 /*10*/].f_3.f_4 = uParam1;
	return;
}

void func_841(int iParam0, var uParam1) // Position - 0x18719
{
	Global_1296390.f_58.f_4[iParam0 /*10*/].f_3.f_5 = uParam1;
	return;
}

void func_842(int iParam0, var uParam1) // Position - 0x18733
{
	Global_1296390.f_58.f_4[iParam0 /*10*/].f_3 = uParam1;
	return;
}

void func_843(int iParam0, var uParam1) // Position - 0x1874B
{
	Global_1296390.f_58.f_4[iParam0 /*10*/].f_3.f_1 = uParam1;
	return;
}

void func_844(int iParam0, var uParam1, var uParam2) // Position - 0x18765
{
	Global_1296390.f_58.f_4[iParam0 /*10*/] = { uParam1 };
	return;
}

void func_845(int iParam0, var uParam1) // Position - 0x1877F
{
	Global_1296390.f_58.f_4[iParam0 /*10*/].f_2 = uParam1;
	return;
}

void func_846(int iParam0, var uParam1) // Position - 0x18797
{
	Global_1296390.f_58.f_4[iParam0 /*10*/].f_9 = uParam1;
	return;
}

int func_847(int iParam0, int iParam1, int iParam2) // Position - 0x187AF
{
	var unk;
...
struct<6> func_848(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10) // Position - 0x18868
{
	var unk;
	var unk6;
	int num;
...
void func_849(var uParam0, BOOL bParam1) // Position - 0x18963
{
...
int func_850(int iParam0, int iParam1, int iParam2) // Position - 0x189B2
{
	var unk;
...
struct<5> func_851(var uParam0, int iParam1) // Position - 0x18A6B
{
	var unk;
	int num;
	int num2;
...
void func_852(var uParam0, BOOL bParam1) // Position - 0x18BD6
{
	int rating;
	var unk;
...
int func_853(int iParam0, int iParam1, int iParam2) // Position - 0x18C9B
{
	var unk;
...
struct<4> func_854(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10) // Position - 0x18D54
{
	var unk;
	var unk6;
	int num;
...
var func_855(Any* panParam0, int iParam1, int iParam2) // Position - 0x18E4F
{
	var unk;
...
void func_856(int iParam0) // Position - 0x18E6A
{
	Player player;
	int num;
	int num2;
...
void func_857(int iParam0) // Position - 0x18FB9
{
	Player player;
	int num;
	int num2;
...
BOOL func_858(int iParam0, int iParam1) // Position - 0x190F2
{
	return Global_1207480.f_231.f_1066[iParam0 /*17*/].f_6 && iParam1 != false;
}

BOOL func_859() // Position - 0x1910E
{
	if (!Global_1072759.f_3)
		return false;
...
void func_860(int iParam0) // Position - 0x19177
{
	Player player;
	var unk;
...
void func_861(int iParam0, int iParam1, BOOL bParam2) // Position - 0x193C8
{
...
void func_862(int iParam0) // Position - 0x193FA
{
	int num;
...
BOOL func_863() // Position - 0x195F7
{
	return func_18(Global_1051268);
}

void func_864() // Position - 0x19609
{
	BOOL sessionFlags;
	BOOL flags;
...
BOOL func_865() // Position - 0x1964B
{
	if (Global_1572887.f_14 == -1)
		return false;
...
struct<40> func_866(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40) // Position - 0x19667
{
	var unk;
	int i;
	int num;
...
void func_867(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41) // Position - 0x19796
{
...
int func_868(int iParam0) // Position - 0x198C5
{
	return Global_1107816.f_33[iParam0 /*16*/];
}

int func_869(var uParam0) // Position - 0x198D7
{
	int num;
	int i;
...
int func_870(int iParam0) // Position - 0x19938
{
	return Global_1107816.f_33[iParam0 /*16*/].f_1;
}

BOOL func_871(int iParam0) // Position - 0x1994C
{
	return iParam0 >= 0 && iParam0 < 71;
}

void func_872(int iParam0, int iParam1) // Position - 0x19962
{
	Global_1107816.f_33[iParam0 /*16*/].f_1 = iParam1;
	return;
}

void func_873(int iParam0) // Position - 0x19978
{
	Global_1107816.f_33[iParam0 /*16*/] = 0;
	return;
}

int func_874(Player plParam0, int iParam1) // Position - 0x1998B
{
	int gangId;
	int i;
...
int func_875(int iParam0) // Position - 0x199D8
{
	return Global_1107816.f_33[iParam0 /*16*/].f_2;
}

void func_876(int iParam0, int iParam1) // Position - 0x199EC
{
...
BOOL func_877(int iParam0, var uParam1) // Position - 0x19A10
{
...
BOOL func_878(int iParam0, var uParam1) // Position - 0x19A2B
{
	if (!func_1097(iParam0))
	{
		*uParam1 = 9;
...
BOOL func_879(int iParam0, var uParam1) // Position - 0x19A83
{
	var unk;
	var unk3;
	int num;
...
BOOL func_880(int iParam0, var uParam1) // Position - 0x19B78
{
	BOOL flag;
	int networkTimeAccurate;
...
BOOL func_881(int iParam0, var uParam1) // Position - 0x19C0E
{
	BOOL flag;
...
BOOL func_882(int iParam0, var uParam1) // Position - 0x19C71
{
	BOOL flag;
...
BOOL func_883(int iParam0, var uParam1) // Position - 0x19D03
{
	BOOL flag;
...
BOOL func_884(int iParam0, var uParam1) // Position - 0x19D46
{
	var unk;
	int num;
	int networkTimeAccurate;
...
BOOL func_885(int iParam0, var uParam1) // Position - 0x19DED
{
	if (func_1097(iParam0))
	{
		*uParam1 = 8;
...
BOOL func_886(int iParam0, var uParam1) // Position - 0x19E14
{
	int num;
	BOOL flag;
...
BOOL func_887(int iParam0, var uParam1) // Position - 0x19E99
{
...
int func_888(int iParam0) // Position - 0x19ED3
{
	return Global_1107816.f_33[iParam0 /*16*/].f_3.f_2;
}

void func_889(int iParam0, var uParam1, int iParam2) // Position - 0x19EE9
{
	Global_1107816.f_33[iParam0 /*16*/].f_2 = uParam1;
	return;
}

void func_890(int iParam0, int iParam1) // Position - 0x19EFF
{
	Global_1110244[iParam0] = iParam1;
	return;
}

struct<13> func_891(int iParam0) // Position - 0x19F11
{
	return Global_1107816.f_33[iParam0 /*16*/].f_3;
}

BOOL func_892(var uParam0, var uParam1, var uParam2) // Position - 0x19F28
{
	return !func_929(func_1112(), uParam0) || func_1113() != uParam2;
}

void func_893(var uParam0) // Position - 0x19F4A
{
	Global_1110244.f_11 = { *uParam0 };
	return;
}

BOOL func_894(Player plParam0, int iParam1) // Position - 0x19F5E
{
	return Global_1138673[plParam0 /*56*/].f_34 && iParam1 != false;
}

struct<2> func_895() // Position - 0x19F75
{
	return Global_1140723.f_5.f_3;
}

struct<2> func_896() // Position - 0x19F87
{
	return Global_1110244.f_21.f_13.f_25;
}

int func_897() // Position - 0x19F9B
{
	return Global_1140723.f_5.f_7;
}

int func_898() // Position - 0x19FAB
{
	return Global_1140723.f_24;
}

Any func_899() // Position - 0x19FB9
{
	return Global_1110244.f_21.f_13.f_20;
}

int func_900() // Position - 0x19FCB
{
	return Global_1110244.f_21.f_13.f_2;
}

BOOL func_901(int iParam0) // Position - 0x19FDD
{
	return func_527(1, iParam0);
}

void func_902() // Position - 0x19FEC
{
	func_1114(-1);
	func_1115(-1);
	func_1116(-1);
...
int func_903() // Position - 0x1A00B
{
	return Global_1110244.f_21.f_13.f_8;
}

void func_904(int iParam0) // Position - 0x1A01D
{
	Player player;
...
void func_905(int iParam0) // Position - 0x1A04D
{
	Global_1110244.f_21.f_13.f_8 = iParam0;
	return;
}

void func_906(var uParam0, var uParam1) // Position - 0x1A061
{
	Global_1110244.f_21.f_13.f_9 = { uParam0 };
	return;
}

int func_907() // Position - 0x1A079
{
	return Global_1110244.f_21.f_13;
}

void func_908(int iParam0) // Position - 0x1A089
{
	Player player;
...
void func_916(int iParam0) // Position - 0x1A17F
{
...
BOOL func_917(Player plParam0, int iParam1) // Position - 0x1A1A9
{
	if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(plParam0))
		return false;
...
BOOL func_918(int iParam0) // Position - 0x1A1D0
{
	return Global_1140723.f_24.f_3 && iParam0 != false;
}

var func_919() // Position - 0x1A1E5
{
	return Global_1140723.f_24.f_6;
}

void func_920(Player plParam0) // Position - 0x1A1F5
{
	var unk;
	var value;
...
void func_921(int iParam0) // Position - 0x1A292
{
	Global_1140723.f_24.f_6 = iParam0;
	return;
}

void func_922(int iParam0) // Position - 0x1A2A4
{
	Global_1140723.f_24.f_3 = Global_1140723.f_24.f_3 || iParam0;
	return;
}

BOOL func_923() // Position - 0x1A2BF
{
	return Global_1110244.f_21.f_112.f_6;
}

int func_924() // Position - 0x1A2D1
{
	return Global_1110244.f_21.f_112.f_5;
}

void func_925() // Position - 0x1A2E3
{
	var unk;
...
int func_926(int iParam0) // Position - 0x1A325
{
	int i;
...
BOOL func_927(int iParam0) // Position - 0x1A35B
{
	int num;
...
struct<2> func_928() // Position - 0x1A422
{
	return Global_1110244.f_21.f_112.f_3;
}

BOOL func_929(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1A436
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

BOOL func_930(int iParam0, int iParam1) // Position - 0x1A451
{
	return Global_1107816.f_33[iParam0 /*16*/].f_3.f_8 && iParam1 != false;
}

void func_931(Any* panParam0) // Position - 0x1A46C
{
	MISC::COPY_SCRIPT_STRUCT(panParam0, &(Global_1110244.f_21.f_112.f_9), 4);
	return;
}

int func_932() // Position - 0x1A485
{
	return Global_1110244.f_21.f_112;
}

int func_933() // Position - 0x1A495
{
	return Global_1110244.f_21.f_112.f_1;
}

var func_934() // Position - 0x1A4A7
{
	return Global_1110244.f_21.f_112.f_7;
}

int func_935() // Position - 0x1A4B9
{
	return Global_1110244.f_21.f_112.f_2;
}

void func_936(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10) // Position - 0x1A4CB
{
	var unk;
	var unk32;
	var unk33;
...
BOOL func_955(int iParam0) // Position - 0x1A7CE
{
	return iParam0 > -1 && iParam0 <= 80;
}

BOOL func_956(var uParam0, int iParam1) // Position - 0x1A7E4
{
	BOOL flag;
...
BOOL func_957() // Position - 0x1A804
{
	int currentMessage;
...
BOOL func_958(int iParam0, int iParam1) // Position - 0x1A824
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_959(int iParam0) // Position - 0x1A854
{
	return Global_1835011[iParam0 /*72*/].f_19;
}

Vector3 func_960(int iParam0) // Position - 0x1A868
{
	return Global_1835011[iParam0 /*72*/].f_19;
}

Vector3 func_961(int iParam0) // Position - 0x1A87C
{
	return Global_1835011[iParam0 /*72*/].f_19;
}

void func_962(int iParam0, int iParam1) // Position - 0x1A890
{
	if (!func_693(iParam0))
		return;
...
void func_963(int iParam0) // Position - 0x1A8BC
{
	if (func_60() == -1)
		return;
...
void func_964(var uParam0, int iParam1) // Position - 0x1A906
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_965(var uParam0, var uParam1) // Position - 0x1A917
{
	int num;
...
void func_966(var uParam0, var uParam1, BOOL bParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x1A937
{
	int num;
...
void func_967(var uParam0, var uParam1) // Position - 0x1AA9F
{
...
void func_968(var uParam0, var uParam1, int iParam2) // Position - 0x1AAE2
{
	if (!func_18(uParam0))
		return;
...
BOOL func_969() // Position - 0x1AB25
{
	return Global_1295849.f_537 != 0;
}

BOOL func_970() // Position - 0x1AB36
{
...
BOOL func_971(int iParam0) // Position - 0x1AB58
{
	return Global_1295849.f_537 && iParam0 != false;
}

BOOL func_972(int iParam0) // Position - 0x1AB6C
{
	int num;
	 Var1;
	int num2;
	...
	switch (num2)
	{
		...
		case 1:
			...
			num = func_290(MISC::VAR_STRING(0, Var1, blipIndex), 10000, 0, 0, 0, true);
			break;
	}
...
void func_973(int iParam0) // Position - 0x1AC13
{
	Global_1295849.f_537 = Global_1295849.f_537 - Global_1295849.f_537 && iParam0;
	return;
}

BOOL func_974(int iParam0) // Position - 0x1AC34
{
	return func_246(Global_1072759.f_28644.f_8.f_1, iParam0);
}

Hash func_975(Hash hParam0) // Position - 0x1AC4D
{
	return hParam0;
}

BOOL func_976(Hash hParam0, int iParam1) // Position - 0x1AC57
{
	if (hParam0 == 0)
		return false;
...
Hash func_977(int iParam0) // Position - 0x1AC71
{
	switch (iParam0)
	{
		case 0:
...
Hash func_978(int iParam0) // Position - 0x1AE0A
{
...
Hash func_979(int iParam0) // Position - 0x1AE36
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_980(Hash hParam0, BOOL bParam1) // Position - 0x1AFCF
{
	var unk;
...
int func_981(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1AFF4
{
...
int func_982(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1B0B6
{
...
BOOL func_983(Hash hParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x1B0D2
{
	BOOL flag;
	int num;
	var unk;
...
void func_984(int iParam0) // Position - 0x1B1B3
{
	Global_1300387.f_155.f_4[iParam0 /*4*/].f_1 = 0;
	return;
}

void func_985(int iParam0) // Position - 0x1B1CA
{
	Global_1300387.f_155.f_4[iParam0 /*4*/].f_2 = 0;
	return;
}

void func_986(Player plParam0) // Position - 0x1B1E1
{
	SCRIPTS::_CLEAR_PLAYER_BIT_AT_INDEX(&(Global_1300387.f_155.f_2), plParam0);
	return;
}

int func_987(Hash hParam0) // Position - 0x1B1F7
{
	var unk;
...
int func_993(Hash hParam0) // Position - 0x1B369
{
	var unk;
...
BOOL func_994(Player plParam0, Hash hParam1) // Position - 0x1B3D4
{
	return MISC::IS_BIT_SET(Global_1300387.f_155.f_4[plParam0 /*4*/].f_1, hParam1);
}

BOOL func_995(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x1B3F0
{
	var unk;
...
void func_996(Player plParam0, Hash hParam1) // Position - 0x1B54B
{
	MISC::SET_BIT(&(Global_1300387.f_155.f_4[plParam0 /*4*/].f_1), hParam1);
	return;
}

void func_997(Player plParam0) // Position - 0x1B567
{
	SCRIPTS::_SET_PLAYER_BIT_AT_INDEX(&(Global_1300387.f_155.f_2), plParam0);
	return;
}

void func_998(int iParam0) // Position - 0x1B57D
{
	Global_1300387.f_155.f_3 = Global_1300387.f_155.f_3 || iParam0;
	return;
}

void func_999(Player plParam0, Hash hParam1) // Position - 0x1B598
{
	MISC::SET_BIT(&(Global_1300387.f_155.f_4[plParam0 /*4*/].f_2), hParam1);
	return;
}

void func_1000(int iParam0) // Position - 0x1B5B4
{
	var unk;
...
int func_1001(int iParam0, int iParam1) // Position - 0x1B5D2
{
	switch (iParam0)
	{
		case joaat("WS_MP_TREASURE_MAP_SAN_LUIS_SHORE_01"):
...
int func_1241(int iParam0) // Position - 0x22109
{
	if (!func_871(iParam0))
		return 0;
...
BOOL func_1242(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2212D
{
