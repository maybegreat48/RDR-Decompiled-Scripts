...
BOOL func_2(int iParam0) // Position - 0x7DE
{
	switch (iParam0)
	{
		case 1:
...
void func_3(var uParam0) // Position - 0x84B
{
...
struct<2> func_4(int iParam0) // Position - 0x8AD
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_5(int iParam0, var uParam1) // Position - 0x8C1
{
	return iParam0;
}

BOOL func_6(int iParam0) // Position - 0x8CB
{
	return func_50(&(Global_3145858.f_6), iParam0);
}

void func_7(var uParam0, int iParam1) // Position - 0x8DF
{
	if (!func_45(iParam1))
		return;
...
int func_8() // Position - 0x908
{
	return Global_1902569;
}

int func_9(int iParam0) // Position - 0x914
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

BOOL func_10(int iParam0) // Position - 0x927
{
	switch (iParam0)
	{
		case 40:
...
int func_11(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x952
{
	float num;
	float num2;
	int num3;
...
int func_12(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x9CC
{
	int num;
...
BOOL func_13(var uParam0) // Position - 0xA1D
{
	return uParam0->f_22 != 3;
}

void func_14(var uParam0) // Position - 0xA2B
{
	var unk;
	var unk8;
...
void func_15(var uParam0) // Position - 0xAE3
{
	var unk;
	var unk8;
	int randomIntInRange;
...
BOOL func_16(var uParam0) // Position - 0xB3D
{
...
BOOL func_17(var uParam0) // Position - 0xBB1
{
...
void func_18(var uParam0) // Position - 0xBE0
{
	BOOL flag;
	int i;
...
void func_19(var uParam0) // Position - 0xCCB
{
...
int func_20(var uParam0) // Position - 0xD2A
{
	return uParam0->f_13;
}

void func_21(var uParam0, int iParam1) // Position - 0xD36
{
	uParam0->f_13 = iParam1;
	return;
}

BOOL func_22(int iParam0, var uParam1) // Position - 0xD44
{
	int num;
...
void func_23(int iParam0, BOOL bParam1) // Position - 0xD97
{
	int i;
...
BOOL func_24(int iParam0, int iParam1, int iParam2) // Position - 0xDD9
{
	int i;
...
void func_25(var uParam0) // Position - 0xE55
{
	TASK::_REQUEST_HERB_COMPOSITE_ASSET(uParam0->f_44);
	return;
}

BOOL func_26(var uParam0) // Position - 0xE66
{
...
int func_27(var uParam0) // Position - 0xE7F
{
	int i;
	int num;
	int value;
...
BOOL func_28(var uParam0) // Position - 0xFB2
{
	var unk;
	int groundSetting;
...
BOOL func_29(int iParam0) // Position - 0x118D
{
	switch (iParam0)
	{
		case 40:
...
void func_30(var uParam0) // Position - 0x11DB
{
	func_82(uParam0);
...
BOOL func_31(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6, BOOL bParam7, int iParam8) // Position - 0x11F2
{
	int i;
	int num;
	int value;
...
void func_32(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x1316
{
	BOOL flag;
	BOOL flag2;
	float num;
...
void func_33(int iParam0, BOOL bParam1) // Position - 0x153D
{
	int num;
	int num2;
...
BOOL func_34(int iParam0, int iParam1) // Position - 0x156A
{
	if (iParam0 == -1)
		return false;
...
void func_35(int iParam0, int iParam1) // Position - 0x158A
{
	if (iParam0 == -1)
		return;
...
void func_36(int iParam0) // Position - 0x15BA
{
...
BOOL func_37(int iParam0, int iParam1) // Position - 0x15E5
{
	if (iParam0 <= -1)
		return false;
...
void func_38(int iParam0, int iParam1) // Position - 0x160A
{
	if (iParam0 <= -1)
		return;
...
BOOL func_42(var uParam0, var uParam1, BOOL bParam2, var uParam3) // Position - 0x17B7
{
...
void func_43(var uParam0) // Position - 0x1910
{
	var unk;
	int i;
	int j;
...
int func_44(var uParam0) // Position - 0x19BC
{
	return uParam0->f_10;
}

BOOL func_45(int iParam0) // Position - 0x19C8
{
	return iParam0 != 5;
}

int func_46(var uParam0) // Position - 0x19D4
{
	return uParam0->f_9;
}

void func_47(var uParam0, int iParam1) // Position - 0x19E0
{
	if (!func_45(iParam1))
		return;
...
void func_48(var uParam0) // Position - 0x1A09
{
	BOOL flag;
	int i;
...
void func_49(var uParam0, int iParam1) // Position - 0x1AC2
{
	switch (uParam0->f_7)
	{
		case 0:
...
BOOL func_50(var uParam0, int iParam1) // Position - 0x1B74
{
	int num;
	int offset;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1B98
{
...
BOOL func_52(int iParam0) // Position - 0x1BC2
{
	if (iParam0 == -1)
		return false;
...
int func_53(int iParam0) // Position - 0x1BDD
{
	if (iParam0 == -1)
		return 0;
...
Vector3 func_54(int iParam0) // Position - 0x1BF6
{
	if (iParam0 == -1)
		return -1f, -1f, -1f;
...
float func_55(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x1C17
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_56(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x1C35
{
	var SourceStruct;
...
void func_57(int iParam0, var uParam1, var uParam2) // Position - 0x1C6F
{
	int i;
	int randomIntInRange;
	var unk;
...
void func_58(int iParam0, int iParam1, int iParam2) // Position - 0x1D64
{
	if (iParam0 > 500)
		return;
...
BOOL func_59(Ped pedParam0) // Position - 0x1D86
{
...
BOOL func_60() // Position - 0x1DA3
{
	return Global_1893611 & true != 0 && func_111() != -1;
}

BOOL func_61(BOOL bParam0, BOOL bParam1) // Position - 0x1DBE
{
	int i;
...
BOOL func_62() // Position - 0x1E9E
{
	return func_112(Global_1572887.f_8, 1);
}

BOOL func_63(Player plParam0, int iParam1, BOOL bParam2) // Position - 0x1EB1
{
	Player player;
	int i;
...
int func_64(int iParam0) // Position - 0x1F2F
{
	return Global_1205938.f_1[iParam0 /*26*/].f_3;
}

BOOL func_65(int iParam0) // Position - 0x1F43
{
	if (!func_114(iParam0))
		return false;
...
BOOL func_66(int iParam0) // Position - 0x1F61
{
	return iParam0 != -1;
}

BOOL func_67(Volume volParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1F6D
{
...
BOOL func_68(int iParam0) // Position - 0x1F8D
{
	return Global_20537[iParam0 /*9*/].f_2 != -15;
}

BOOL func_69(int iParam0, var uParam1) // Position - 0x1FA2
{
	return false;
}

int func_70(int iParam0) // Position - 0x1FAB
{
	return Global_20537[iParam0 /*9*/].f_2;
}

void func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x1FBC
{
	int num;
	int i;
	int num2;
...
BOOL func_72(int iParam0, BOOL bParam1) // Position - 0x2144
{
	return func_123(func_8(), iParam0, bParam1);
}

BOOL func_73(int iParam0, int iParam1) // Position - 0x2158
{
	if (iParam0 == -1)
		return false;
...
void func_74(int iParam0, int iParam1) // Position - 0x217F
{
	if (iParam0 <= -1)
		return;
...
void func_75(int iParam0, int iParam1) // Position - 0x21BC
{
	if (iParam0 == -1)
		return;
...
void func_76(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x21E2
{
	if (iParam0 <= -1)
		return;
...
Vector3 func_77(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x2206
{
	float num;
	float num2;
	float num3;
...
float func_78(float fParam0) // Position - 0x224A
{
	return fParam0 * 0.017453292f;
}

BOOL func_79(int iParam0) // Position - 0x225A
{
	switch (iParam0)
	{
		case 4:
...
void func_80(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x2287
{
	int num;
...
void func_81(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x22A2
{
	int i;
...
void func_82(var uParam0) // Position - 0x23C7
{
	if (uParam0->f_4 != -1)
	{
...
void func_83(int iParam0, int iParam1) // Position - 0x23F8
{
	if (func_106(iParam0))
...
BOOL func_84(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2411
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_85() // Position - 0x2510
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_86(var uParam0, int iParam1) // Position - 0x2525
{
	*uParam0 = iParam1;
	return;
}

void func_87(int iParam0) // Position - 0x2532
{
	if (iParam0 <= 0)
		return;
...
void func_88(var uParam0) // Position - 0x2559
{
	func_130(uParam0, 0f);
	return;
}

float func_89(var uParam0) // Position - 0x2568
{
	if (!func_103(uParam0))
		return uParam0->f_1;
...
void func_90(int iParam0, var uParam1, var uParam2) // Position - 0x259D
{
	int num;
...
BOOL func_91(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x25B9
{
...
void func_92(int iParam0, int iParam1) // Position - 0x265B
{
	int Variable;
...
Hash func_93(int iParam0) // Position - 0x267F
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_94(int iParam0) // Position - 0x2A15
{
	if (!func_114(iParam0))
		return false;
...
void func_95(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2A33
{
	if (!func_114(iParam0))
		return;
...
void func_96(int iParam0, int iParam1) // Position - 0x2A95
{
	var statId;
...
void func_97(int iParam0, int iParam1) // Position - 0x2AC7
{
...
void func_98(int iParam0, BOOL bParam1, int iParam2) // Position - 0x2B0B
{
	Hash num;
	int num2;
...
Hash func_99(int iParam0) // Position - 0x2B81
{
	switch (iParam0)
	{
		case 2:
...
void func_100(Hash hParam0) // Position - 0x2E3C
{
	int num;
	var unk22;
	int i;
...
void func_101(Hash hParam0, int iParam1, BOOL bParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3180
{
	BOOL flag;
	int value;
	var unk;
...
void func_102(var uParam0, BOOL bParam1) // Position - 0x364F
{
...
BOOL func_103(var uParam0) // Position - 0x366F
{
	return func_182(*uParam0, 1);
}

void func_104(var uParam0, int iParam1) // Position - 0x367F
{
	*uParam0 = iParam1;
	return;
}

void func_105(var uParam0) // Position - 0x368C
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_106(int iParam0) // Position - 0x36A2
{
	if (*iParam0 == 0)
		return false;
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x36BA
{
	return iParam0 && iParam1 != false;
}

void func_108(var uParam0, int iParam1) // Position - 0x36C9
{
	uParam0->f_7 = iParam1;
	return;
}

Vector3 func_109(int iParam0) // Position - 0x36D7
{
	float num;
	int value;
	int value2;
...
BOOL func_110(float fParam0, var uParam1, var uParam2) // Position - 0x3733
{
	BOOL flag;
...
int func_111() // Position - 0x3788
{
	return Global_1893611.f_2;
}

BOOL func_112(BOOL bParam0, BOOL bParam1) // Position - 0x3796
{
	return bParam0 && bParam1 != false;
}

BOOL func_113(int iParam0, int iParam1, Player plParam2) // Position - 0x37A5
{
	return func_183(Global_1206166[plParam2 /*10*/][iParam0], iParam1);
}

BOOL func_114(int iParam0) // Position - 0x37BF
{
	return !(iParam0 <= 0);
}

BOOL func_115(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x37CC
{
	if (bParam2)
		if (!func_114(iParam0))
			return false;
...
int func_116(int iParam0) // Position - 0x380F
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_117(int iParam0) // Position - 0x3834
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_118(int iParam0) // Position - 0x3847
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_119(int iParam0) // Position - 0x385A
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_120(int iParam0) // Position - 0x386C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_121(int iParam0, int iParam1) // Position - 0x387E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_122(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3918
{
...
BOOL func_123(int iParam0, int iParam1, BOOL bParam2) // Position - 0x3950
{
	if (bParam2)
...
void func_124(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x397D
{
...
void func_125(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x39BF
{
	if (!func_106(uParam0))
	{
...
int func_126(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x39F3
{
...
BOOL func_127(BOOL bParam0) // Position - 0x3AB5
{
	if (bParam0)
...
BOOL func_128() // Position - 0x3AE5
{
	return func_197() != -1;
}

BOOL func_129() // Position - 0x3AF3
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_130(var uParam0, float fParam1) // Position - 0x3B18
{
...
BOOL func_131(var uParam0) // Position - 0x3B3E
{
	return func_182(*uParam0, 2);
}

float func_132() // Position - 0x3B4E
{
...
BOOL func_133(int iParam0, int iParam1) // Position - 0x3B80
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_134(int iParam0) // Position - 0x3B98
{
...
BOOL func_135(int iParam0) // Position - 0x3BAF
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_136(int iParam0, int iParam1) // Position - 0x3C7B
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_137(int iParam0) // Position - 0x3C94
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_138() // Position - 0x3CA7
{
	if (!func_200())
		return false;
...
void func_139(int iParam0) // Position - 0x3CC2
{
	switch (iParam0)
	{
		case 2:
...
void func_140(int iParam0, BOOL bParam1) // Position - 0x3EC8
{
	if (!func_114(iParam0))
		return;
...
void func_141(int iParam0, BOOL bParam1) // Position - 0x3EEE
{
	if (!func_114(iParam0))
		return;
...
BOOL func_142(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3F31
{
	if (Global_1572887.f_14 != -1)
	{
...
void func_143(BOOL bParam0, int iParam1) // Position - 0x40A7
{
...
struct<2> func_144(int iParam0, Hash hParam1) // Position - 0x40ED
{
	int num;
...
struct<2> func_145(int iParam0) // Position - 0x4103
{
	var unk;
...
void func_146(var uParam0, var uParam1, int iParam2) // Position - 0x4115
{
...
BOOL func_147(int iParam0) // Position - 0x4132
{
	switch (iParam0)
	{
		case 4:
...
int func_148(int iParam0) // Position - 0x4162
{
	switch (iParam0)
	{
...
BOOL func_149(Hash hParam0, Hash hParam1) // Position - 0x433D
{
	if (!func_161(hParam0, 0))
...
int func_150(Hash hParam0) // Position - 0x437E
{
	var unk;
...
float func_151(int iParam0, int iParam1) // Position - 0x43A9
{
	int num;
	float pedStamina;
	float pedMaxStamina;
...
void func_152(int iParam0) // Position - 0x445E
{
	Ped ped;
	int num;
...
void func_153(int iParam0, BOOL bParam1) // Position - 0x449B
{
	int num;
...
void func_154(int iParam0) // Position - 0x44D0
{
	Ped ped;
	int num;
...
float func_155(float fParam0, float fParam1) // Position - 0x450D
{
	if (fParam1 != 0f)
...
void func_156(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x453B
{
	if (fParam1 == 0f)
		return;
...
float func_157(float fParam0, int iParam1) // Position - 0x4574
{
	switch (iParam1)
	{
		case 0:
...
int func_158(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x45C6
{
...
void func_159(float fParam0, BOOL bParam1) // Position - 0x45EA
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
struct<2> func_160(int iParam0) // Position - 0x4642
{
	int num;
...
BOOL func_161(Hash hParam0, int iParam1) // Position - 0x4652
{
	if (hParam0 == 0)
		return false;
...
BOOL func_162() // Position - 0x466C
{
	return !Global_1913444;
}

void func_163(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x4679
{
	int i;
...
var func_164(BOOL bParam0, var uParam1, var uParam2) // Position - 0x479C
{
	if (bParam0)
		return uParam1;
...
BOOL func_165(Hash hParam0, int iParam1) // Position - 0x47B3
{
	if (!func_161(hParam0, 0))
		return false;
...
int func_166(Hash hParam0) // Position - 0x47D2
{
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_167(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x47FD
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_168(Hash hParam0) // Position - 0x48F0
{
...
BOOL func_169(Hash hParam0) // Position - 0x49EC
{
...
Hash func_170(Hash hParam0, BOOL bParam1) // Position - 0x4A6B
{
	Hash hash;
...
BOOL func_171(int iParam0) // Position - 0x4A99
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_172(Hash hParam0) // Position - 0x4AC0
{
	var unk;
	int i;
...
Hash func_173(Hash hParam0) // Position - 0x4B2E
{
	int num;
	var unk;
	int collectionId;
...
int func_174(Hash hParam0, Hash hParam1) // Position - 0x4BB3
{
	if (hParam0 == 0)
		return 0;
...
int func_175(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x4BE4
{
	var unk;
...
const char* func_176(const char* sParam0, int iParam1) // Position - 0x4C43
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_177(Hash hParam0, int iParam1) // Position - 0x4C5D
{
	 num;
...
BOOL func_178(Hash hParam0, char* sParam1) // Position - 0x4C7B
{
...
const char* func_179(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x4CF8
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_180(const char* sParam0, int iParam1) // Position - 0x4D0C
{
...
int func_181(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x4D42
{
	int num;
	var unk13;
	int num2;
...
BOOL func_182(int iParam0, int iParam1) // Position - 0x4DA5
{
	return iParam0 && iParam1 != false;
}

BOOL func_183(int iParam0, int iParam1) // Position - 0x4DB4
{
	return iParam0 && iParam1 != false;
}

var func_184(BOOL bParam0, var uParam1, var uParam2) // Position - 0x4DC3
{
	if (bParam0)
		return uParam1;
...
void func_185(var uParam0, int iParam1) // Position - 0x4DDA
{
	if (iParam1 < 0)
		return;
...
void func_186(var uParam0, int iParam1) // Position - 0x4E60
{
...
void func_187(var uParam0, int iParam1) // Position - 0x4E9C
{
	int num;
	int num2;
...
void func_188(var uParam0, int iParam1) // Position - 0x4EEF
{
...
void func_189(var uParam0, int iParam1) // Position - 0x4F2A
{
...
void func_190(var uParam0, int iParam1) // Position - 0x4F63
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_191(int iParam0) // Position - 0x4F9B
{
	int num;
	int num2;
	int num3;
...
Hash func_192(Hash hParam0, int iParam1) // Position - 0x5077
{
	int num;
	var unk;
	Hash hash;
...
int func_193(Hash hParam0, BOOL bParam1) // Position - 0x50F1
{
	var unk;
	int num;
	int num2;
...
int func_194(Hash hParam0, int iParam1) // Position - 0x5150
{
	if (iParam1 == 0)
		return 0;
...
int func_195(BOOL bParam0) // Position - 0x517C
{
	if (func_207() == -1)
	{
...
struct<4> func_196(Hash hParam0, BOOL bParam1) // Position - 0x51BD
{
	var unk;
...
int func_197() // Position - 0x51E2
{
	return Global_1149172.f_137;
}

void func_198(var uParam0, int iParam1) // Position - 0x51F0
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_199(var uParam0, int iParam1) // Position - 0x5201
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_200() // Position - 0x5216
{
...
BOOL func_201(int iParam0) // Position - 0x522A
{
	if (!func_114(iParam0))
		return false;
...
int func_202(BOOL bParam0, int iParam1) // Position - 0x5248
{
...
BOOL func_204(var uParam0, var uParam1) // Position - 0x52F6
{
	if (!func_244(uParam0))
		return false;
...
void func_205(int iParam0, int iParam1) // Position - 0x532A
{
	iParam0->f_2 = iParam0->f_2 || iParam1;
	return;
}

BOOL func_206() // Position - 0x533D
{
	return true;
}

int func_207() // Position - 0x535C
{
	return Global_1572887.f_14;
}

Hash func_208(Hash hParam0) // Position - 0x536A
{
	return hParam0;
}

BOOL func_209(Hash hParam0, Hash hParam1) // Position - 0x5374
{
...
int func_210(int iParam0) // Position - 0x53AA
{
	if (iParam0 == 2)
		iParam0 = func_246(1);
...
void func_211(float fParam0, Ped pedParam1) // Position - 0x53EA
{
	if (fParam0 == 0f)
		return;
...
int func_212(int iParam0) // Position - 0x542E
{
	if (iParam0 == 2)
		iParam0 = func_246(1);
...
void func_213(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5472
{
	Player player;
	Ped EntityIndex;
...
int func_214(int iParam0) // Position - 0x5523
{
	if (iParam0 == 2)
		iParam0 = func_246(1);
...
void func_215(float fParam0, Ped pedParam1) // Position - 0x5567
{
	if (fParam0 == 0f)
		return;
...
float func_216(int iParam0, float fParam1, BOOL bParam2) // Position - 0x55A9
{
	int num;
	int num2;
...
float func_217(int iParam0, int iParam1) // Position - 0x5612
{
	if (iParam1 == 2)
		iParam1 = func_246(2);
...
int func_218(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x565E
{
	Ped ped;
...
int func_219(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x56DC
{
	char* effectName;
	Ped ped;
...
void func_221(float fParam0, int iParam1) // Position - 0x58BB
{
	float num;
	int num2;
	int num3;
...
BOOL func_222(Hash hParam0, Hash hParam1) // Position - 0x592E
{
	if (hParam1 == 0)
		return false;
...
Hash func_223(Hash hParam0, BOOL bParam1) // Position - 0x5955
{
	switch (hParam0)
	{
...
int func_224(Hash hParam0) // Position - 0x59F7
{
	var unk;
	int num;
...
struct<10> func_225(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x5A31
{
	int num;
...
BOOL func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x5B05
{
...
BOOL func_227(Hash hParam0) // Position - 0x5B26
{
	!func_161(hParam0, 0);
...
int func_228(int iParam0) // Position - 0x5B4C
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_229(Hash hParam0, int iParam1) // Position - 0x5B6D
{
	if (hParam0 == 0)
		return false;
...
int func_230(Hash hParam0, int iParam1) // Position - 0x5B87
{
	var unk;
	int num;
	int num2;
...
char* func_231(Hash hParam0) // Position - 0x5BD5
{
	Hash labelHash;
...
BOOL func_232(Hash hParam0) // Position - 0x5C0B
{
...
char* func_233(Hash hParam0) // Position - 0x5C39
{
	Hash labelHash;
...
void func_234(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x5C6E
{
...
void func_235(Hash hParam0, var uParam1, var uParam2) // Position - 0x5C9F
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_236(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5EAB
{
	Hash hash;
...
struct<4> func_237(BOOL bParam0) // Position - 0x5F89
{
	int num;
...
void func_238(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x602A
{
...
BOOL func_239(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x6045
{
...
int func_240(int iParam0) // Position - 0x606A
{
	if (iParam0 < 0)
		return 0;
...
struct<5> func_241(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x608B
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_242(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x63FF
{
	var outGuid;
...
BOOL func_243() // Position - 0x6430
{
	return !Global_1572887.f_10;
}

BOOL func_244(int iParam0) // Position - 0x643F
{
	switch (iParam0)
	{
		case 2:
...
int func_245(int iParam0) // Position - 0x647E
{
	switch (iParam0)
	{
		case 2:
...
int func_246(int iParam0) // Position - 0x6514
{
	return func_273(func_272(iParam0));
}

BOOL func_247(Player plParam0) // Position - 0x6526
{
	float num;
...
void func_248(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x6541
{
	int num;
	int i;
	int j;
...
int func_249(int iParam0, int iParam1) // Position - 0x66B4
{
	if (iParam1 == 2)
		iParam1 = func_246(2);
...
int func_250(int iParam0, int iParam1) // Position - 0x6704
{
	if (iParam1 == 2)
		iParam1 = func_246(2);
...
void func_251(int iParam0, int iParam1, int iParam2) // Position - 0x6756
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
void func_252(int iParam0, int iParam1, int iParam2) // Position - 0x67AC
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
BOOL func_253(Ped pedParam0, int iParam1, float fParam2) // Position - 0x6802
{
...
void func_254(int iParam0, int iParam1, int iParam2) // Position - 0x6857
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
void func_255(Ped pedParam0, int iParam1, float fParam2) // Position - 0x68B8
{
	char* StringToTest;
...
void func_256(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x68E4
{
	int num;
...
BOOL func_257(int iParam0) // Position - 0x691A
{
	switch (iParam0)
	{
		case 0:
...
char* func_258(int iParam0) // Position - 0x6949
{
	switch (iParam0)
	{
		case 0:
...
void func_259(int iParam0) // Position - 0x6984
{
	int num;
	int num2;
	int i;
...
void func_260(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6A54
{
	func_218(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

float func_261(int iParam0, int iParam1) // Position - 0x6A6E
{
	if (iParam1 == 2)
		iParam1 = func_246(1);
...
int func_262(float fParam0) // Position - 0x6ABA
{
	float num;
...
float func_263(float fParam0, float fParam1, float fParam2) // Position - 0x6AE5
{
	if (fParam0 > fParam2)
		return fParam2;
...
int func_264(int iParam0, float fParam1, int iParam2) // Position - 0x6B0C
{
	if (!func_282(iParam0))
		return 0;
...
struct<4> func_265(BOOL bParam0) // Position - 0x6B5D
{
	int num;
...
int func_266(Hash hParam0, BOOL bParam1) // Position - 0x6BFD
{
...
BOOL func_267(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6C34
{
	return func_286(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_268(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x6C4F
{
	var unk;
...
struct<4> func_269(BOOL bParam0) // Position - 0x6C70
{
	int num;
...
BOOL func_270(Hash hParam0, int iParam1) // Position - 0x6CDA
{
	Hash hash;
	int num;
	int i;
...
BOOL func_271(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6D47
{
	return func_289(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_272(int iParam0) // Position - 0x6D5D
{
	return func_290(&(Global_1956875.f_1565), iParam0, 1);
}

int func_273(BOOL bParam0) // Position - 0x6D73
{
	if (bParam0)
		return 1;
...
float func_274(Player plParam0) // Position - 0x6D85
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_291(2);
}

int func_275(int iParam0) // Position - 0x6D9B
{
	switch (iParam0)
	{
		case 0:
...
char* func_276(int iParam0) // Position - 0x6DCA
{
	switch (iParam0)
	{
		case 0:
...
char* func_277(int iParam0) // Position - 0x6E05
{
	switch (iParam0)
	{
		case 0:
...
void func_278(int iParam0, float fParam1, int iParam2) // Position - 0x6E40
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
void func_279(int iParam0, int iParam1, int iParam2) // Position - 0x6E92
{
	if (iParam2 == 2)
		iParam2 = func_246(2);
...
int func_280(int iParam0, int iParam1) // Position - 0x6EE8
{
	switch (iParam0)
	{
		case -2101912686:
...
// Unhandled jump detected. Output should be considered invalid
int func_281(int iParam0) // Position - 0x76E9
{
	int num;
	int num2;
	int num3;
...
BOOL func_282(int iParam0) // Position - 0x7979
{
	if (func_257(iParam0))
		return true;
...
void func_283(int iParam0, float fParam1, int iParam2) // Position - 0x799F
{
	if (fParam1 < 0f)
		return;
...
struct<4> func_284() // Position - 0x79FB
{
	var unk;
...
int func_286(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x7A24
{
...
BOOL func_287(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x7AA3
{
	int inventoryId;
...
BOOL func_288(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x7AE8
{
...
BOOL func_289(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x7B1B
{
...
BOOL func_290(Any* panParam0, int iParam1, int iParam2) // Position - 0x7B55
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_291(int iParam0) // Position - 0x7B8C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_292(int iParam0) // Position - 0x7BCD
{
	int num;
...
BOOL func_293(int iParam0) // Position - 0x7BF5
{
	int num;
...
int func_294(int iParam0, int iParam1) // Position - 0x7C1D
{
	switch (iParam0)
	{
...
int func_295(int iParam0, int iParam1) // Position - 0x82D6
{
	Player player;
	Player player2;
	int num;
...
int func_296(int iParam0, int iParam1, int iParam2) // Position - 0x8359
{
	int num;
	int num2;
...
void func_297(int iParam0) // Position - 0x8451
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_298(int iParam0, int iParam1) // Position - 0x8467
{
	switch (iParam0)
	{
...
BOOL func_302(int iParam0) // Position - 0x8D91
{
	switch (iParam0)
	{
		case 12:
...
int func_303(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8DB6
{
...
Player func_304(int iParam0) // Position - 0x8DE9
{
	if (func_315(iParam0))
...
BOOL func_305(int iParam0) // Position - 0x8E0A
{
	int num;
...
int func_306(int iParam0, int iParam1, int iParam2) // Position - 0x8E32
{
	int num;
	int num2;
	int num3;
...
BOOL func_307(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x9023
{
	return uParam0.f_4 != 0;
}

BOOL func_308(int iParam0, int iParam1) // Position - 0x9031
{
	int num;
...
Vector3 func_309(int iParam0) // Position - 0x9071
{
	int num;
	var unk;
...
BOOL func_310(int iParam0, var uParam1, var uParam2) // Position - 0x90AD
{
	if (!func_305(iParam0))
		return false;
...
BOOL func_311(int iParam0, int iParam1, int iParam2) // Position - 0x90E4
{
	int num;
	int num2;
	int num3;
...
void func_312(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x9312
{
	int num;
...
void func_313(int iParam0) // Position - 0x9391
{
	int num;
...
BOOL func_314(Hash hParam0) // Position - 0x93E6
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_315(int iParam0) // Position - 0x93F4
{
	int num;
...
int func_316(int iParam0) // Position - 0x941B
{
	int num;
...
int func_317(int iParam0, int iParam1) // Position - 0x94B5
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_318(int iParam0) // Position - 0x98EE
{
	int num;
...
float func_319(int iParam0) // Position - 0x9916
{
	float num;
...
void func_320(int iParam0) // Position - 0x9946
{
	int num;
	int num2;
	int i;
...
BOOL func_321(int iParam0) // Position - 0x9B25
{
	int num;
...
int func_322(int iParam0, int iParam1) // Position - 0x9B4D
{
	switch (iParam0)
	{
...
void func_323(int iParam0) // Position - 0x9E5D
{
	Ped ped;
	Player player;
...
BOOL func_324(int iParam0) // Position - 0xA06D
{
	int num;
...
int func_325(int iParam0, int iParam1) // Position - 0xA094
{
	switch (iParam0)
	{
...
int func_326(int iParam0) // Position - 0xA0F1
{
	int num;
	var unk;
	var unk32;
...
BOOL func_327(int iParam0) // Position - 0xA235
{
...
void func_328(int iParam0) // Position - 0xA253
{
	int num;
	int num2;
	int i;
...
BOOL func_329(int iParam0) // Position - 0xA3A8
{
	BOOL flag;
...
void func_330(int iParam0) // Position - 0xA3D2
{
	Ped EntityIndex;
	Player player;
	int num;
...
void func_331(int iParam0) // Position - 0xA66D
{
	char* StringToTest;
	char* StringToTest2;
...
BOOL func_332(int iParam0) // Position - 0xA6B7
{
	int num;
...
BOOL func_333(int iParam0) // Position - 0xA6DF
{
	int num;
...
BOOL func_334(int iParam0) // Position - 0xA707
{
	int num;
...
BOOL func_335(int iParam0) // Position - 0xA72F
{
	int num;
...
BOOL func_336(int iParam0) // Position - 0xA757
{
	int num;
...
BOOL func_337(int iParam0) // Position - 0xA77F
{
	int num;
...
float func_338(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0xA7A7
{
	var unk;
	float num;
...
BOOL func_339(int iParam0) // Position - 0xA7DD
{
...
BOOL func_340(int iParam0) // Position - 0xA84C
{
	int num;
...
int func_341(int iParam0, int iParam1) // Position - 0xA873
{
	switch (iParam0)
	{
...
char* func_344(int iParam0) // Position - 0xA962
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_345(int iParam0) // Position - 0xA9AA
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_346(int iParam0) // Position - 0xA9E5
{
	int i;
...
int func_348(int iParam0) // Position - 0xAA45
{
	int num;
...
BOOL func_349(int iParam0, int iParam1) // Position - 0xAA74
{
	int num;
	Player player;
	int num2;
...
struct<31> func_350(int iParam0) // Position - 0xAD49
{
	int num;
...
BOOL func_351(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0xAD6D
{
	var unk;
	BOOL flag;
...
char* func_352(int iParam0, int iParam1) // Position - 0xADA3
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_353(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xADFC
{
	int i;
...
char* func_355(int iParam0) // Position - 0xAEA6
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_356(int iParam0) // Position - 0xAEC7
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_357(Hash hParam0, Hash hParam1, var uParam2) // Position - 0xAEE8
{
	int num;
	int num2;
...
BOOL func_358() // Position - 0xB10A
{
	return Global_1572887.f_7;
}

BOOL func_359() // Position - 0xB118
{
	if (!Global_1048577)
		return false;
...
BOOL func_360(Player plParam0) // Position - 0xB163
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_361(int iParam0, Player plParam1) // Position - 0xB1A8
{
	if (plParam1 == 255)
...
int func_362(int iParam0) // Position - 0xB1D4
{
	int num;
...
void func_365(Player plParam0) // Position - 0xB26F
{
	Player player;
...
void func_366(Player plParam0) // Position - 0xB2F2
{
	Player player;
...
void func_367(Player plParam0) // Position - 0xB35E
{
