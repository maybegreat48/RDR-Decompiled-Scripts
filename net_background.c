...
BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0x52
{
	int i;
...
void func_3() // Position - 0x132
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

int func_4() // Position - 0x13E
{
	int scriptStatus;
	int gameTimer;
	int timeoutTime;
...
int func_6() // Position - 0x27D
{
	return Global_1572887.f_14;
}

BOOL func_7() // Position - 0x28B
{
