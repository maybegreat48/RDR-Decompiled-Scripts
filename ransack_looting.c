...
void func_8() // Position - 0x4A9
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x4B5
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x4DD
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x505
{
	struct<2> data;
...
void func_12(var uParam0) // Position - 0x52D
{
	int i;
...
BOOL func_14(int iParam0, int iParam1) // Position - 0x59D
{
	return iParam0 && iParam1 != false;
}

BOOL func_15(var uParam0) // Position - 0x5AC
{
...
void func_16(var uParam0, int iParam1) // Position - 0x6A0
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_17(var uParam0) // Position - 0x6B1
{
	int i;
...
void func_18(var uParam0) // Position - 0x70A
{
	func_36(uParam0);
	func_37(uParam0);
	func_38(uParam0);
...
BOOL func_19(var uParam0) // Position - 0x724
{
...
BOOL func_20(ScrHandle shParam0) // Position - 0x77F
{
...
void func_21(Hash hParam0, float fParam1, float fParam2, float fParam3, var uParam4, int iParam5, Hash hParam6) // Position - 0x81F
{
...
int func_22(var uParam0, BOOL bParam1) // Position - 0x854
{
	int _int;
...
void func_23(ScrHandle shParam0) // Position - 0x8DB
{
	int num;
	int value;
...
void func_24(var uParam0) // Position - 0x9D1
{
	int num;
	int i;
	Hash hash;
...
void func_25(var uParam0) // Position - 0xAEF
{
	func_50(uParam0, 0f);
	return;
}

BOOL func_26(var uParam0, float fParam1) // Position - 0xAFE
{
	if (!func_51(uParam0))
		return false;
...
void func_27(var uParam0, var uParam1, int iParam2, var uParam3, const char* sParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xB25
{
...
void func_28(var uParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0xD8E
{
	Object FirstEntityIndex;
	int SecondEntityBoneIndex;
	...
	switch (*uParam0)
	{
		...
		case 1:
			if (STREAMING::HAS_MODEL_LOADED(*uParam1))
			{
				...
				FirstEntityIndex = OBJECT::CREATE_OBJECT(*uParam1, vParam3, func_35(&(uParam2->f_5)), true, false, false, false);
			
				if (ENTITY::DOES_ENTITY_EXIST(uParam2->f_5))
				{
					SecondEntityBoneIndex = uParam2->f_4 ? uParam2->f_154[0] : 0;
					ENTITY::ATTACH_ENTITY_TO_ENTITY(FirstEntityIndex, uParam2->f_5, SecondEntityBoneIndex, 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, true, false);
				}
				else
				{
					ENTITY::_SET_ENTITY_COORDS_AND_HEADING_NO_OFFSET(FirstEntityIndex, vParam3, uParam6.f_2, false, true);
				}
...
void func_29(var uParam0) // Position - 0xE67
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_30(var uParam0) // Position - 0xE7D
{
...
void func_31(Entity eParam0) // Position - 0xEAF
{
...
void func_32(var uParam0) // Position - 0xEF2
{
	return;
}

void func_33(var uParam0) // Position - 0xEFA
{
...
void func_34(var uParam0) // Position - 0xF30
{
	return;
}

BOOL func_35(var uParam0) // Position - 0xF38
{
	return !(DECORATOR::DECOR_EXIST_ON(*uParam0, "chest_local_only") && DECORATOR::DECOR_GET_BOOL(*uParam0, "chest_local_only"));
}

void func_36(var uParam0) // Position - 0xF5C
{
	switch (uParam0->f_7)
	{
...
void func_37(var uParam0) // Position - 0x138F
{
	switch (uParam0->f_8)
	{
		case 0:
...
void func_38(var uParam0) // Position - 0x14FD
{
	int i;
	int MaxInt;
	float num;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		...
		if (MaxInt > 0)
			num7 = (BUILTIN::TO_FLOAT(uParam0->f_99[MISC::GET_RANDOM_INT_IN_RANGE(0, MaxInt)]) / 100f) - num8;
...
BOOL func_39(var uParam0) // Position - 0x1820
{
...
BOOL func_40(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x18D7
{
...
Object func_41(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, Hash hParam5) // Position - 0x1903
{
...
void func_42(Entity eParam0) // Position - 0x198D
{
	if (ENTITY::DOES_ENTITY_EXIST(eParam0))
	{
...
int func_43() // Position - 0x19B6
{
	return joaat("p_dressinglcmhay01x");
}

int func_44() // Position - 0x19C3
{
...
int func_46(var uParam0) // Position - 0x1A2C
{
	int num;
...
int func_47(Entity eParam0) // Position - 0x1A39
{
	if (!ENTITY::DOES_ENTITY_EXIST(eParam0))
		return 0;
...
BOOL func_48(Entity eParam0) // Position - 0x1A60
{
...
void func_49(var uParam0, var uParam1, int iParam2) // Position - 0x1A94
{
	Hash hash;
	var unk;
	var unk2;
...
void func_50(var uParam0, float fParam1) // Position - 0x1B01
{
...
BOOL func_51(var uParam0) // Position - 0x1B27
{
	return func_77(*uParam0, 1);
}

float func_52(var uParam0) // Position - 0x1B37
{
	if (!func_51(uParam0))
		return uParam0->f_1;
...
void func_53(var uParam0, var uParam1, Hash hParam2, int iParam3) // Position - 0x1B6C
{
	if (hParam2 == 0)
...
var func_54(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1BA8
{
	if (bParam0)
		return uParam1;
...
Vector3 func_55(BOOL bParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1BBF
{
	if (bParam0)
		return uParam1;
...
struct<2> func_56(int iParam0) // Position - 0x1BDA
{
	var unk;
...
void func_57(var uParam0, var uParam1, int iParam2) // Position - 0x1BEC
{
...
BOOL func_58(Entity eParam0) // Position - 0x1C09
{
	if (ENTITY::DOES_ENTITY_EXIST(eParam0))
...
int func_59(var uParam0, int iParam1) // Position - 0x1C28
{
...
void func_60(var uParam0, int iParam1) // Position - 0x1C58
{
	int i;
...
void func_61(var uParam0) // Position - 0x1C7D
{
	var unk;
	var unk32;
	int i;
...
void func_62(var uParam0) // Position - 0x1DA1
{
	var unk;
	var unk32;
	int i;
...
void func_63(var uParam0) // Position - 0x1EC5
{
	var unk;
	var unk32;
	int i;
...
void func_64(var uParam0) // Position - 0x1FD4
{
	var unk;
	var unk32;
	int i;
...
void func_65(var uParam0) // Position - 0x20F8
{
	var unk;
	var unk32;
	int i;
...
void func_66(var uParam0) // Position - 0x222D
{
	var unk;
	var unk32;
	int i;
...
void func_67(var uParam0) // Position - 0x2309
{
	var unk;
	var unk32;
	int i;
...
void func_68(var uParam0) // Position - 0x23CF
{
	var unk;
	var unk32;
	float num;
...
void func_69(var uParam0, int iParam1, BOOL bParam2) // Position - 0x245F
{
	var unk;
	int randomIntInRange;
	int i;
...
float func_70(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, var uParam5) // Position - 0x24CC
{
	float num;
	float num2;
...
Hash func_71(Entity eParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x254E
{
...
BOOL func_72(Hash hParam0, int iParam1) // Position - 0x29FE
{
	if (hParam0 == 0)
		return false;
...
void func_73(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, Hash hParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2A18
{
	int i;
...
void func_75(var uParam0, int iParam1) // Position - 0x2B27
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_76(var uParam0, int iParam1) // Position - 0x2B38
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_77(int iParam0, int iParam1) // Position - 0x2B4D
{
	return iParam0 && iParam1 != false;
}

BOOL func_78(var uParam0) // Position - 0x2B5C
{
	return func_77(*uParam0, 2);
}

char* func_79(var uParam0, int iParam1) // Position - 0x2B6C
{
	switch (uParam0->f_8)
	{
		case -1:
...
var func_81(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2CCD
{
	if (bParam0)
		return uParam1;
...
Hash func_82(var uParam0) // Position - 0x2CE4
{
	return 0;
}

Hash func_83(Hash hParam0) // Position - 0x2CED
{
...
BOOL func_84(Hash hParam0) // Position - 0x2D04
{
	return func_89(hParam0) == joaat("WEAPON");
}

BOOL func_85(Hash hParam0) // Position - 0x2D18
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

void func_86(var uParam0, var uParam1) // Position - 0x2D26
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2D50
{
...
char* func_88(int iParam0) // Position - 0x2D7A
{
	switch (iParam0)
	{
		case 0:
...
int func_89(Hash hParam0) // Position - 0x2E0E
{
	var unk;
