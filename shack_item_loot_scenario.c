...
void func_7() // Position - 0x114
{
	return;
}

void func_8() // Position - 0x11C
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x128
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x150
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x178
{
	struct<2> data;
...
void func_12(var uParam0) // Position - 0x1A0
{
	return;
}

void func_13(var uParam0) // Position - 0x1A8
{
	bLocal_13 = false;
	return;
}

void func_14(var uParam0) // Position - 0x1B3
{
...
int func_15(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, Hash hParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x1DC
{
	int value;
	Hash TypeOfWeapon;
	Hash lootTableKey;
	...
	if (!flag)
	{
		if (func_21(hParam0, -1588156645))
		{
			bParam2 = true;
			flag2 = true;
			TypeOfWeapon = func_27(func_26(hParam0, true), false);
		
			if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
			{
				if (func_28() == -1)
					func_29(TypeOfWeapon);
			
				if (func_30(false) && func_31(TypeOfWeapon, 0, false, true, 0, false, hParam5, false))
				{
...
BOOL func_16(Hash hParam0, int iParam1) // Position - 0xC90
{
	if (hParam0 == 0)
		return false;
...
BOOL func_17(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0xCAA
{
	if (func_28() == -1)
	{
...
BOOL func_18(Hash hParam0, var uParam1, int iParam2) // Position - 0xD01
{
	var unk;
	int num;
	int num2;
...
void func_19(Hash hParam0, BOOL bParam1) // Position - 0xD9F
{
	if (bParam1)
		return;
...
int func_20(Hash hParam0) // Position - 0xE50
{
	var unk;
...
BOOL func_21(Hash hParam0, Hash hParam1) // Position - 0xE7B
{
	if (!func_16(hParam0, 0))
...
BOOL func_22(Hash hParam0, int iParam1) // Position - 0xEBC
{
	if (!func_16(hParam0, 0))
		return false;
...
BOOL func_23(int iParam0) // Position - 0xEDB
{
	if (!func_73(iParam0))
		return false;
...
void func_24(int iParam0) // Position - 0xEF7
{
	if (!func_73(iParam0))
		return;
...
void func_25(Hash hParam0) // Position - 0xF18
{
...
Hash func_26(Hash hParam0, BOOL bParam1) // Position - 0xF9D
{
	Hash hash;
...
Hash func_27(Hash hParam0, BOOL bParam1) // Position - 0x1193
{
	if (!func_16(hParam0, 0))
		return 0;
...
int func_28() // Position - 0x11BF
{
	return Global_1572887.f_14;
}

void func_29(Hash hParam0) // Position - 0x11CD
{
	Hash weaponUnlock;
...
BOOL func_30(BOOL bParam0) // Position - 0x1207
{
	if (func_28() == -1)
		return true;
...
BOOL func_31(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, Hash hParam6, BOOL bParam7) // Position - 0x1225
{
	var unk;
	var unk6;
	var unk28;
...
BOOL func_32(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1355
{
	if (iParam1 < 1)
		return true;
...
BOOL func_33(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1390
{
	int num;
	var unk;
	var unk6;
...
BOOL func_34(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x13FF
{
	Hash TypeOfWeapon;
	var unk;
	int num;
	...
	TypeOfWeapon = func_27(hParam0, false);
	...
	if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
	{
		if (func_28() == -1)
		{
			...
			if (hParam1 == 1248274121)
				func_90(TypeOfWeapon);
		}
	
		if (!func_68(hParam0, &unk, 1, false, false, -1, false))
		{
			func_63(hParam0, 1, false, uParam2, hParam1);
			num = func_91(TypeOfWeapon);
		
			if (WEAPON::_IS_WEAPON_SNIPER(TypeOfWeapon))
			{
				func_31(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (TypeOfWeapon == joaat("weapon_fishingrod") || WEAPON::_IS_WEAPON_BINOCULARS(TypeOfWeapon))
			{
				func_31(TypeOfWeapon, 0, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::_IS_WEAPON_LASSO(TypeOfWeapon))
			{
				func_31(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::IS_WEAPON_MELEE_WEAPON(TypeOfWeapon))
			{
				if (TypeOfWeapon == joaat("weapon_melee_knife_john") && !func_92())
					return false;
			
				if (WEAPON::SHOULD_WEAPON_BE_DISCARDED_WHEN_SWAPPED(hParam0))
				{
				}
				else if (!func_93(TypeOfWeapon))
				{
					func_31(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
				}
				else
				{
					func_31(TypeOfWeapon, WEAPON::GET_WEAPON_CLIP_SIZE(TypeOfWeapon) * 4, bParam3, bParam4, 0, false, hParam1, false);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(TypeOfWeapon))
			{
				weaponHash = func_94(Global_33, 2, false, true);
			
				if (func_80(weaponHash) && !Global_26688 && weaponHash != TypeOfWeapon && !func_48(joaat("upgrade_offhand_holster"), 1) && bParam4)
					WEAPON::_SEND_WEAPON_TO_INVENTORY(Global_33, weaponHash);
			
				if (func_80(weaponHash) && func_48(joaat("upgrade_offhand_holster"), 1))
					if (!func_31(TypeOfWeapon, num, bParam3, bParam4, 3, true, hParam1, false))
						return false;
				else if (!func_31(TypeOfWeapon, num, bParam3, bParam4, 0, true, hParam1, false))
					return false;
			}
			else if (!func_31(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false))
			{
				return false;
			}
		}
...
BOOL func_35(Hash hParam0) // Position - 0x160D
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_36(Hash hParam0, var uParam1, Hash hParam2) // Position - 0x161B
{
	int num;
	int weaponClipSize;
	int ReturnMaxAmmo;
...
struct<2> func_37(int iParam0) // Position - 0x1719
{
	var unk;
...
void func_38(var uParam0, var uParam1, int iParam2) // Position - 0x172B
{
...
struct<2> func_39(int iParam0, int iParam1) // Position - 0x1748
{
	int num;
...
void func_40(int iParam0, BOOL bParam1) // Position - 0x175E
{
	int num;
	int num2;
...
BOOL func_41() // Position - 0x178B
{
	return false;
}

int func_42(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, int iParam5, BOOL bParam6, int iParam7) // Position - 0x1794
{
	int num;
...
void func_43(Hash hParam0) // Position - 0x17DB
{
	return;
}

void func_44(Hash hParam0) // Position - 0x17E3
{
	return;
}

void func_45(Hash hParam0) // Position - 0x17EB
{
	return;
}

void func_46(Hash hParam0) // Position - 0x17F3
{
	return;
}

void func_47() // Position - 0x17FB
{
...
BOOL func_48(Hash hParam0, int iParam1) // Position - 0x181F
{
	int num;
...
void func_49(Hash hParam0, var uParam1) // Position - 0x18A2
{
	var unk;
...
Hash func_50(Hash hParam0, BOOL bParam1) // Position - 0x18B4
{
	Hash hash;
...
void func_51(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x18E2
{
	int num;
	int num2;
...
void func_52(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1942
{
	int num;
	int num2;
...
void func_53(var uParam0) // Position - 0x19BD
{
	switch (*uParam0)
	{
...
void func_54(Hash hParam0) // Position - 0x1A01
{
	if (func_28() != -1)
		return;
...
int func_56(Hash hParam0, int iParam1) // Position - 0x1A30
{
	var unk;
	var unk5;
...
struct<2> func_57(Hash hParam0) // Position - 0x1A64
{
	var unk;
	var unk3;
...
void func_58(Hash hParam0) // Position - 0x1AF8
{
	switch (hParam0)
	{
...
void func_59(Hash hParam0, int iParam1) // Position - 0x1B11
{
	char* str;
...
void func_60(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1B4D
{
	BOOL flag;
	int value;
	var unk;
	...
	else if (!func_118(hParam0, &InputString, num3, num2, 0, joaat("ui_itemviewer")))
	{
	...
	str3 = func_126(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash), value), num5);
	...
	if (num4 == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || num4 == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || num4 == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || num4 == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str3 = MISC::VAR_STRING(0, func_127(hParam0, -442898163));
	...
	if (num4 == -126813555 || num4 == 1946043663)
	{
		...
		if (func_128(hParam0, &unk7))
			str3 = func_130(func_129(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_113(str3, InputString.f_1, MISC::GET_HASH_KEY(InputString), num6, num5, str2, str, 0, true);
	return;
}

BOOL func_61(Hash hParam0) // Position - 0x2017
{
	return func_20(hParam0) == joaat("WEAPON");
}

BOOL func_62(Hash hParam0) // Position - 0x202B
{
	var unk;
...
void func_63(Hash hParam0, int iParam1, BOOL bParam2, var uParam3, Hash hParam4) // Position - 0x2070
{
	Hash TypeOfWeapon;
	...
	if (bParam2 || !func_79(TypeOfWeapon))
	{
		if (bParam2 || !WEAPON::HAS_PED_GOT_WEAPON(Global_33, TypeOfWeapon, 0, false) && func_104(hParam0, false, false, false) == 0)
		{
			if (func_28() == -1)
				func_29(TypeOfWeapon);
...
void func_64(Hash hParam0, var uParam1) // Position - 0x211A
{
...
struct<5> func_65(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x213F
{
	var unk;
	int num;
	var unk6;
...
int func_66(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x24B3
{
	if (!func_16(hParam0, 0))
	{
...
int func_67(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2527
{
...
BOOL func_68(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x255A
{
	var unk;
	var unk5;
	int num;
...
int func_70(Hash hParam0, int iParam1) // Position - 0x26F3
{
	var unk;
	int num;
	int i;
...
Hash func_71(Hash hParam0) // Position - 0x273D
{
	return hParam0;
}

int func_72(Hash hParam0, Hash hParam1) // Position - 0x2747
{
...
BOOL func_73(int iParam0) // Position - 0x277D
{
	if (iParam0 == 0)
		return false;
...
BOOL func_74(int iParam0) // Position - 0x2790
{
	int num;
	int num2;
	int offset;
...
void func_75(int iParam0) // Position - 0x27BA
{
	int num;
	int num2;
	int BitIndex;
...
void func_76(int iParam0) // Position - 0x27F4
{
	switch (iParam0)
	{
		case 1:
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x2D70
{
	var unk;
	var unk13;
	var unk26;
...
BOOL func_78(Hash hParam0) // Position - 0x2DA0
{
	Hash weaponUnlock;
...
BOOL func_79(Hash hParam0) // Position - 0x2DC8
{
	Hash weaponUnlock;
...
BOOL func_80(Hash hParam0) // Position - 0x2DF0
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_81(BOOL bParam0) // Position - 0x2E0B
{
	if (func_28() == -1)
	{
...
BOOL func_82(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2E4C
{
	return func_139(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_83(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x2E67
{
	var unk;
...
struct<4> func_84(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x2E88
{
	var outGuid;
...
BOOL func_85(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x2EB9
{
	var unk;
	int num;
	var unk15;
...
void func_86(Hash hParam0, int iParam1) // Position - 0x2FD7
{
	...
	{
		AmmoInClip = func_156(WEAPON::GET_WEAPON_CLIP_SIZE(hParam0), iParam1);
...
int func_87(Hash hParam0, int iParam1) // Position - 0x3049
{
	if (iParam1 == 0)
		return 0;
...
int func_88(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x3075
{
	int num;
	var guid2;
	var guid1;
...
int func_89(Hash hParam0, Any* panParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x30F1
{
	if (!func_16(hParam0, 0))
		return 0;
...
void func_90(Hash hParam0) // Position - 0x3159
{
	char* decoratorName;
	char* decoratorName2;
	int value;
...
int func_91(Hash hParam0) // Position - 0x3228
{
	int num;
	int pedAmmoByType;
...
BOOL func_92() // Position - 0x32A4
{
	return false;
}

BOOL func_93(Hash hParam0) // Position - 0x32AD
{
	return WEAPON::_IS_AMMO_VALID(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0));
}

Hash func_94(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x32BF
{
...
int func_95(Hash hParam0) // Position - 0x32E5
{
	Hash weaponTypeFromAmmoType;
...
void func_96(int iParam0, var uParam1, var uParam2) // Position - 0x3351
{
	int num;
...
BOOL func_97(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x336D
{
...
void func_98(int iParam0, int iParam1) // Position - 0x340F
{
	int Variable;
...
int func_99(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x3433
{
	float num;
	int num2;
	int i;
...
void func_100(int iParam0, const char* sParam1, int iParam2, BOOL bParam3) // Position - 0x3503
{
	if (iParam0 == 0)
		return;
...
void func_101(int iParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x3555
{
	int num;
	int value;
	int num2;
...
BOOL func_102(Hash hParam0, int iParam1) // Position - 0x3630
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_103(Hash hParam0) // Position - 0x36D8
{
	int num;
	int num2;
	int num3;
...
int func_104(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3794
{
...
void func_105(Hash hParam0, var uParam1, var uParam2) // Position - 0x3856
{
	*uParam1 = 0;
	*uParam2 = 0;
...
Hash func_106(Hash hParam0, BOOL bParam1) // Position - 0x3A62
{
	switch (hParam0)
	{
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x3B04
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

void func_108(var uParam0, int iParam1) // Position - 0x3B1D
{
	BOOL flag;
	int i;
...
int func_109(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x3C49
{
	var unk;
	int num;
...
struct<2> func_110(int iParam0) // Position - 0x3CB8
{
	int num;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x3CC8
{
	switch (iParam0)
	{
		case 0:
...
Hash func_112(Hash hParam0) // Position - 0x3D9F
{
	Hash num;
...
int func_113(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x3DC9
{
	int num;
	var unk13;
	int num2;
...
BOOL func_114() // Position - 0x3E2C
{
	return !Global_1913444;
}

void func_115(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x3E39
{
	int i;
...
var func_116(BOOL bParam0, var uParam1, var uParam2) // Position - 0x3F5C
{
	if (bParam0)
		return uParam1;
...
int func_117(Hash hParam0) // Position - 0x3F73
{
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_118(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x3F9E
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_119(Hash hParam0) // Position - 0x4093
{
...
BOOL func_120(Hash hParam0) // Position - 0x418F
{
...
BOOL func_121(int iParam0) // Position - 0x420E
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_122(Hash hParam0) // Position - 0x4235
{
	var unk;
	int i;
...
Hash func_123(Hash hParam0) // Position - 0x42A3
{
	int num;
	var unk;
	int collectionId;
...
int func_124(Hash hParam0, Hash hParam1) // Position - 0x4328
{
	if (hParam0 == 0)
		return 0;
...
int func_125(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x4359
{
	var unk;
...
const char* func_126(const char* sParam0, int iParam1) // Position - 0x43B8
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_127(Hash hParam0, int iParam1) // Position - 0x43D2
{
	 num;
...
BOOL func_128(Hash hParam0, char* sParam1) // Position - 0x43F0
{
	...
	TEXT_LABEL_ASSIGN_STRING(&StringToTest, func_190(hParam0), 128);
...
const char* func_129(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x446D
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_130(const char* sParam0, int iParam1) // Position - 0x4481
{
...
struct<4> func_131(BOOL bParam0) // Position - 0x44B7
{
	int num;
...
struct<4> func_132(BOOL bParam0) // Position - 0x4557
{
	int num;
...
BOOL func_133(Hash hParam0, BOOL bParam1) // Position - 0x45F8
{
...
struct<4> func_134(BOOL bParam0) // Position - 0x462F
{
	int num;
...
BOOL func_135(Hash hParam0, int iParam1) // Position - 0x4699
{
	Hash hash;
	int num;
	int i;
...
BOOL func_136(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x4706
{
	return func_194(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_137(Hash hParam0, int iParam1) // Position - 0x471C
{
	if (hParam0 == 0)
		return false;
...
int func_138(var uParam0) // Position - 0x4736
{
...
int func_139(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x47C0
{
...
BOOL func_140(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x483F
{
...
void func_141(BOOL bParam0) // Position - 0x4868
{
...
void func_142(int iParam0) // Position - 0x48A6
{
...
void func_143(BOOL bParam0) // Position - 0x4914
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_144(BOOL bParam0) // Position - 0x494E
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_145(BOOL bParam0) // Position - 0x4988
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_146(BOOL bParam0) // Position - 0x49C2
{
	Hash hash;
...
void func_147(BOOL bParam0) // Position - 0x49E5
{
	int promptType;
	Player player;
...
void func_148(BOOL bParam0) // Position - 0x4A27
{
	int promptType;
	Player player;
...
BOOL func_149() // Position - 0x4A69
{
	return true;
}

int func_150(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x4A88
{
	int num;
	int num2;
	int num3;
...
int func_151(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x4AEE
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_152(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x4BCF
{
	int inventoryId;
...
BOOL func_153(Hash hParam0) // Position - 0x4C14
{
...
int func_154(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x4C2A
{
	int num;
...
void func_155(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x4C94
{
	int i;
...
int func_156(int iParam0, int iParam1) // Position - 0x4D12
{
	if (iParam0 > iParam1)
		return iParam1;
...
int func_157() // Position - 0x4D28
{
	return Global_1902569;
}

void func_158(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x4D34
{
	int num;
	int i;
	int num2;
...
BOOL func_159(Hash hParam0) // Position - 0x4EBC
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

BOOL func_160(int iParam0, int iParam1) // Position - 0x4ECA
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_161(int iParam0) // Position - 0x4EE2
{
...
BOOL func_162(int iParam0) // Position - 0x4EF9
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_163(int iParam0) // Position - 0x4FC5
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_164() // Position - 0x4FD8
{
	if (!func_210())
		return false;
...
void func_165(int iParam0, int iParam1) // Position - 0x4FF3
{
	if (iParam0 <= 0)
		return;
...
BOOL func_166() // Position - 0x502F
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_167() // Position - 0x5040
{
	return DLC::IS_DLC_PRESENT(joaat("dlc_ultimateedition"));
}

Hash func_168(Hash hParam0, int iParam1) // Position - 0x5051
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_169(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x50CB
{
...
BOOL func_170(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x50F2
{
	if (iParam2 < 0)
		return false;
...
int func_171(int iParam0) // Position - 0x512D
{
	if (iParam0 < 0)
		return 0;
...
int func_172(Hash hParam0) // Position - 0x514E
{
	switch (hParam0)
	{
...
int func_173(var uParam0, int iParam1) // Position - 0x5231
{
	int i;
...
int func_174(Hash hParam0) // Position - 0x526E
{
	int num;
...
int func_175(Hash hParam0, BOOL bParam1) // Position - 0x52DB
{
	var unk;
	int num;
	int num2;
...
struct<4> func_176(Hash hParam0, BOOL bParam1) // Position - 0x533A
{
	var unk;
...
void func_177(var uParam0) // Position - 0x535F
{
...
void func_178(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x5397
{
	int i;
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_179(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x544D
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
void func_180(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x5543
{
...
BOOL func_181(Hash hParam0, Hash hParam1) // Position - 0x5574
{
	if (hParam1 == 0)
		return false;
...
int func_182(Hash hParam0) // Position - 0x559B
{
	var unk;
	int num;
...
struct<10> func_183(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x55D5
{
	int num;
...
BOOL func_184(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x56A9
{
...
BOOL func_185(Hash hParam0) // Position - 0x56CA
{
	!func_16(hParam0, 0);
...
int func_186(int iParam0) // Position - 0x56F0
{
	if (iParam0 < 0)
		return 0;
...
int func_187(Hash hParam0, int iParam1) // Position - 0x5711
{
	var unk;
	int num;
	int num2;
...
char* func_188(Hash hParam0) // Position - 0x575F
{
	Hash labelHash;
...
BOOL func_189(Hash hParam0) // Position - 0x5795
{
...
char* func_190(Hash hParam0) // Position - 0x57C3
{
	Hash labelHash;
...
struct<4> func_191() // Position - 0x57F8
{
	var unk;
...
BOOL func_193(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x5821
{
...
BOOL func_194(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x5854
{
...
BOOL func_195(Hash hParam0) // Position - 0x588E
{
	return func_21(hParam0, 1279601681);
}

void func_196(int iParam0, int iParam1) // Position - 0x58A1
{
	if (iParam1 == 0)
		return;
...
void func_197(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x58D1
{
	int i;
	var unk;
...
BOOL func_198(Hash hParam0, Any* panParam1) // Position - 0x598C
{
	int num;
...
BOOL func_199(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x5B62
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_200(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x5B79
{
	if (bParam0)
	{
...
int func_201(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x5BC2
{
	if (bParam0)
	{
		func_218(iParam1, 1, 0, 0);
...
int func_202(int iParam0) // Position - 0x5BDE
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_203(int iParam0) // Position - 0x5C03
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_204(int iParam0) // Position - 0x5C16
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_205(int iParam0) // Position - 0x5C29
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_206(int iParam0) // Position - 0x5C3C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_207(int iParam0) // Position - 0x5C4E
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_208(int iParam0, int iParam1) // Position - 0x5C60
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_209(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5CFA
{
...
BOOL func_211() // Position - 0x5D46
{
	return Global_1913444.f_127 == 0;
}

struct<18> func_212(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5D56
{
	Hash hash;
...
void func_213(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x5E34
{
...
BOOL func_214(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x5E4F
{
...
int func_215() // Position - 0x5E74
{
	return Global_1953292.f_1;
}

BOOL func_216(Any anParam0) // Position - 0x5E82
{
...
BOOL func_217(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x5EC8
{
...
void func_218(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5EE0
{
	int i;
...
var func_219(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5F7E
{
	if (bParam0)
		return uParam1;
...
void func_220(var uParam0, int iParam1) // Position - 0x5F95
{
	if (iParam1 < 0)
		return;
...
void func_221(var uParam0, int iParam1) // Position - 0x601B
{
...
void func_222(var uParam0, int iParam1) // Position - 0x6057
{
	int num;
	int num2;
...
void func_223(var uParam0, int iParam1) // Position - 0x60AA
{
...
void func_224(var uParam0, int iParam1) // Position - 0x60E5
{
...
void func_225(var uParam0, int iParam1) // Position - 0x611E
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_226(int iParam0, int iParam1) // Position - 0x6156
{
	return iParam0 && iParam1 != false;
}

void func_227(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6165
{
	int i;
...
void func_228(int iParam0) // Position - 0x6241
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
void func_229(var uParam0) // Position - 0x6264
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
