...
BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0x62
{
	int i;
...
void func_5() // Position - 0x192
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_6(int iParam0, int iParam1) // Position - 0x19E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_5();
...
void func_10(BOOL bParam0) // Position - 0x356
{
	int num;
	var unk;
	int num2;
...
void func_11() // Position - 0x41F
{
	func_20();
	return;
}

void func_12() // Position - 0x42B
{
...
int func_13() // Position - 0x484
{
	return Global_1572887.f_14;
}

BOOL func_14() // Position - 0x492
{
	return Global_1051645.f_8;
}

void func_15(int* piParam0) // Position - 0x4A0
{
	var unk;
...
int func_16(int iParam0, int iParam1, char* sParam2) // Position - 0x4B0
{
	return 1;
}

void func_17(Any* panParam0) // Position - 0x4B9
{
	int i;

	for (i = 0; i <= 31; i = i + 1)
	{
		func_25(&panParam0->[i /*17*/]);
	}

	return;
}

int func_18(int iParam0, int iParam1, char* sParam2) // Position - 0x4DE
{
	return 1;
}

void func_19(var uParam0) // Position - 0x4E7
{
	var unk;
...
BOOL func_21(int iParam0) // Position - 0x579
{
...
void func_25(var uParam0) // Position - 0x62B
{
	var unk;
...
BOOL func_26(BOOL bParam0, BOOL bParam1) // Position - 0x646
{
	return bParam0 && bParam1 != false;
}

void func_27(int iParam0) // Position - 0x655
{
	int i;
...
void func_29() // Position - 0x6E5
{
	...
	if (Global_1204759.f_141 != Global_1205149[PLAYER::PLAYER_ID() /*17*/])
	{
		...
		{
			if (CREW::NETWORK_CLAN_GET_MEMBERSHIP_DESC(&memberInfo, i) && memberInfo == Global_1204759.f_141)
			{
				Global_1205149[PLAYER::PLAYER_ID() /*17*/].f_1 = { memberInfo.f_1 };
...
void func_33(int iParam0, BOOL bParam1) // Position - 0x88D
{
	if (bParam1)
...
void func_34(int iParam0, int iParam1) // Position - 0x9C7
{
	Global_1205694.f_1[iParam0 /*3*/].f_1 = iParam1;
	return;
}

BOOL func_35(int iParam0) // Position - 0x9DD
{
	var outTXDName;
	const char* InputString;

	if (CREW::NETWORK_CLAN_IS_EMBLEM_READY(Global_1205694.f_1[iParam0 /*3*/], &outTXDName))
	{
		InputString = func_36(outTXDName);
		Global_1205694.f_1[iParam0 /*3*/].f_2 = MISC::GET_HASH_KEY(InputString);
		return true;
	}
...
const char* func_36(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xA1A
{
