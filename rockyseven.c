...
void func_67(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x10F7
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_103(&unk, joaat("COLOR_PURE_WHITE")), str3, func_103(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_103(&unk, joaat("COLOR_PURE_WHITE")), func_103(&unk2, joaat("COLOR_PURE_WHITE")));
		}
...
int func_94(int iParam0) // Position - 0x3895
{
	int i;
	var gamerHandle;
	int bountyData;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x505E
{
