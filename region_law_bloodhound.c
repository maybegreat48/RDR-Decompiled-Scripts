...
void func_1(int iParam0) // Position - 0x4B
{
	int i;
...
BOOL func_3(int iParam0) // Position - 0x105
{
	return false;
}

void func_4() // Position - 0x10E
{
	int i;
...
BOOL func_5(Ped pedParam0, int iParam1) // Position - 0x27E
{
	int num;
...
void func_6(Entity eParam0) // Position - 0x37D
{
	Blip blipFromEntity;
...
void func_7(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3A0
{
...
Vector3 func_8(int iParam0, BOOL bParam1) // Position - 0x40E
{
...
ePedType func_9(int iParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4, float fParam5, float fParam6, float fParam7) // Position - 0x46E
{
	if (!func_18(iParam0))
		return 0;
...
void func_11(int iParam0) // Position - 0x4EE
{
	var unk;
	int i;
...
void func_12(int iParam0) // Position - 0x5D5
{
	int i;
	Vector3 vector;
...
BOOL func_13(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x6E8
{
...
void func_14(int iParam0) // Position - 0x71E
{
	int i;
...
BOOL func_15(int iParam0, int iParam1) // Position - 0x7A9
{
	return iParam0 && iParam1 != false;
}

void func_16(Blip* pblParam0) // Position - 0x7B8
{
...
BOOL func_17(int iParam0) // Position - 0x7D0
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_18(int iParam0) // Position - 0x7E6
{
	return iParam0 > -1 && iParam0 < 16;
}

Hash func_19(int iParam0) // Position - 0x7FC
{
	int num;
...
BOOL func_20(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, int iParam7, float fParam8, float fParam9, float fParam10, int iParam11) // Position - 0x83F
{
	int num;
...
Vector3 func_21(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x964
{
	var unk;
	float MaxFloat;
...
Ped func_22(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x9AC
{
	Ped EntityIndex;
	...
	func_30(EntityIndex, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return EntityIndex;
}

int func_23() // Position - 0x9EC
{
	return Global_1893611.f_2;
}

int func_24(int iParam0) // Position - 0x9FA
{
	if (!func_17(iParam0))
		return 0;
...
void func_25(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, float fParam7, float fParam8, float fParam9, int iParam10) // Position - 0xA1A
{
	int num;
	int num2;
...
void func_26(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1828
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_28(float fParam0, var uParam1, var uParam2) // Position - 0x2012
{
	float num;
	float num2;
...
Vector3 func_29(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2051
{
	float num;
...
void func_30(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x2088
{
	BOOL flag;
...
float func_31(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x2152
{
	float num;
...
int func_32(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2177
{
	int num;
...
int func_33(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x21C5
{
	return func_38(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

void func_34(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x21DB
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_35(Ped pedParam0, BOOL bParam1) // Position - 0x2220
{
...
void func_36(Ped pedParam0, int iParam1) // Position - 0x2265
{
	if (iParam1 == 1)
...
int func_37(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x228C
{
	int num;
	int num2;
	int num3;
...
int func_38(Hash hParam0) // Position - 0x2343
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x23FD
{
	int num;
...
int func_40(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x2438
{
	if (fParam0 < fParam3)
