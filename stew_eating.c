...
void func_1(BOOL bParam0) // Position - 0x3B3
{
...
BOOL func_2(Hash hParam0, int iParam1) // Position - 0x3EE
{
	if (hParam0 == 0)
		return false;
...
int func_3(Hash hParam0) // Position - 0x408
{
	var unk;
...
void func_4(var uParam0) // Position - 0x424
{
...
BOOL func_5(var uParam0) // Position - 0x4EA
{
	return func_12(*uParam0, 1);
}

BOOL func_6(var uParam0, float fParam1) // Position - 0x4FA
{
...
void func_7(var uParam0) // Position - 0x518
{
	var unk;
	int num;
...
void func_8(var uParam0, BOOL bParam1) // Position - 0x53C
{
	int i;
	float num;
	float num2;
...
void func_9(var uParam0) // Position - 0x8E3
{
	int i;
...
void func_10(var uParam0, int iParam1) // Position - 0x923
{
	*uParam0 = iParam1;
	return;
}

void func_11(Hash hParam0, var uParam1, Hash hParam2, Hash hParam3, BOOL bParam4) // Position - 0x930
{
...
BOOL func_12(int iParam0, int iParam1) // Position - 0x9CF
{
	return iParam0 && iParam1 != false;
}

BOOL func_13(var uParam0, float fParam1) // Position - 0x9DE
{
	if (!func_5(uParam0))
		return false;
...
void func_14(var uParam0) // Position - 0xA05
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
var func_15(int iParam0, int iParam1) // Position - 0xA1B
{
	return func_33(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

void func_16(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0xA39
{
...
BOOL func_17(Hash hParam0, Hash hParam1) // Position - 0xA81
{
	if (!func_2(hParam0, 0))
...
BOOL func_18(int iParam0) // Position - 0xAC2
{
	switch (iParam0)
	{
...
float func_19(int iParam0, float fParam1) // Position - 0xB3A
{
	float pedStamina;
	float pedMaxStamina;
	float num;
...
void func_20(float fParam0) // Position - 0xBCB
{
	Ped ped;
	int num;
...
void func_21(float fParam0, BOOL bParam1) // Position - 0xC0B
{
	int num;
...
void func_22(float fParam0) // Position - 0xC43
{
	Ped ped;
	int num;
...
float func_23(float fParam0, float fParam1) // Position - 0xC83
{
	if (fParam1 != 0f)
...
void func_24(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xCB1
{
	if (fParam1 == 0f)
		return;
...
void func_25(float fParam0, BOOL bParam1) // Position - 0xCEA
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
float func_26(float fParam0, int iParam1) // Position - 0xD42
{
	switch (iParam1)
	{
		case 0:
...
int func_27(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xD94
{
...
void func_28(var uParam0) // Position - 0xDB8
{
	switch (*uParam0)
	{
		case -2109344034:
...
void func_29(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0xE38
{
...
void func_30(var uParam0) // Position - 0x10A2
{
	if (!uParam0->f_176)
	{
...
void func_31(var uParam0) // Position - 0x10CC
{
	func_58(uParam0, 0f);
	return;
}

float func_32(var uParam0) // Position - 0x10DB
{
	if (!func_5(uParam0))
		return uParam0->f_1;
...
var func_33(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x1110
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_63(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
BOOL func_34(BOOL bParam0) // Position - 0x14A3
{
	if (bParam0)
...
Hash func_35(Hash hParam0) // Position - 0x151B
{
	return hParam0;
}

BOOL func_36(Hash hParam0, Hash hParam1) // Position - 0x1525
{
...
int func_37(int iParam0) // Position - 0x155B
{
	if (iParam0 == 2)
		iParam0 = func_68(1);
...
void func_38(float fParam0, Ped pedParam1) // Position - 0x159B
{
	if (fParam0 == 0f)
		return;
...
int func_39(int iParam0) // Position - 0x15DF
{
	if (iParam0 == 2)
		iParam0 = func_68(1);
...
void func_40(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1623
{
	Player player;
	Ped EntityIndex;
...
int func_41(int iParam0) // Position - 0x16D4
{
	if (iParam0 == 2)
		iParam0 = func_68(1);
...
void func_42(float fParam0, Ped pedParam1) // Position - 0x1718
{
	if (fParam0 == 0f)
		return;
...
float func_43(int iParam0, float fParam1, BOOL bParam2) // Position - 0x175A
{
	int num;
	int num2;
...
float func_44(int iParam0, int iParam1) // Position - 0x17C3
{
	if (iParam1 == 2)
		iParam1 = func_68(2);
...
int func_45(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x180F
{
	Ped ped;
...
void func_47(float fParam0, int iParam1) // Position - 0x18B2
{
	float num;
	int num2;
	int num3;
...
void func_48(int iParam0, BOOL bParam1) // Position - 0x1925
{
	int num;
	int num2;
...
int func_49(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1952
{
	char* effectName;
	Ped ped;
...
int func_50(int iParam0, int iParam1, int iParam2) // Position - 0x1B08
{
	int num;
...
struct<2> func_51(int iParam0) // Position - 0x1B9C
{
	int num;
...
void func_52(var uParam0, var uParam1, int iParam2) // Position - 0x1BAC
{
...
int func_53(Hash hParam0) // Position - 0x1BC9
{
	switch (hParam0)
	{
...
void func_54(int iParam0, int iParam1) // Position - 0x1DA4
{
	var statId;
...
struct<2> func_55(int iParam0, int iParam1) // Position - 0x1DD6
{
	int num;
...
int func_56() // Position - 0x1DEC
{
	return Global_1572887.f_14;
}

void func_57(Hash hParam0, int iParam1) // Position - 0x1DFA
{
	int num;
...
void func_58(var uParam0, float fParam1) // Position - 0x1F9B
{
...
BOOL func_59(var uParam0) // Position - 0x1FC1
{
	return func_12(*uParam0, 2);
}

float func_60() // Position - 0x1FD1
{
...
int func_61() // Position - 0x2003
{
	return Global_1051645.f_12;
}

char* func_62() // Position - 0x2011
{
	return "unnamed";
}

BOOL func_63(int iParam0) // Position - 0x201C
{
	int num;
...
BOOL func_64(int iParam0) // Position - 0x20AB
{
...
int func_65(int iParam0) // Position - 0x20C9
{
	if (iParam0 == 255)
...
BOOL func_66(Player plParam0) // Position - 0x2114
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_67(Hash hParam0, int iParam1) // Position - 0x2159
{
	if (hParam0 == 0)
		return false;
...
int func_68(int iParam0) // Position - 0x2173
{
	return func_114(func_113(iParam0));
}

BOOL func_69(Player plParam0) // Position - 0x2185
{
	float num;
...
int func_70() // Position - 0x21A0
{
	return Global_1902569;
}

void func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x21AC
{
	int num;
	int i;
	int j;
...
int func_72(int iParam0, int iParam1) // Position - 0x231F
{
	if (iParam1 == 2)
		iParam1 = func_68(2);
...
int func_73(int iParam0, int iParam1) // Position - 0x236F
{
	if (iParam1 == 2)
		iParam1 = func_68(2);
...
BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x23C1
{
	if (bParam2)
...
void func_75(int iParam0, int iParam1, int iParam2) // Position - 0x23EE
{
	if (iParam2 == 2)
		iParam2 = func_68(2);
...
void func_76(int iParam0, int iParam1, int iParam2) // Position - 0x2444
{
	if (iParam2 == 2)
		iParam2 = func_68(2);
...
BOOL func_77(Ped pedParam0, int iParam1, float fParam2) // Position - 0x249A
{
...
void func_78(int iParam0, int iParam1, int iParam2) // Position - 0x24EF
{
	if (iParam2 == 2)
		iParam2 = func_68(2);
...
void func_79(Ped pedParam0, int iParam1, float fParam2) // Position - 0x2550
{
	char* StringToTest;

	StringToTest = func_126(iParam1);
...
void func_80(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x257C
{
	BOOL flag;
...
BOOL func_81(int iParam0, BOOL bParam1) // Position - 0x25B2
{
	return func_74(func_70(), iParam0, bParam1);
}

float func_82(int iParam0, int iParam1) // Position - 0x25C6
{
	if (iParam1 == 2)
		iParam1 = func_68(1);
...
int func_83(float fParam0) // Position - 0x2612
{
	float num;
...
float func_84(float fParam0, float fParam1, float fParam2) // Position - 0x263D
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x2664
{
	int num;
	int i;
	int num2;
...
int func_86(int iParam0, float fParam1, int iParam2) // Position - 0x27EC
{
	if (!func_130(iParam0))
		return 0;
...
void func_87(int iParam0, var uParam1, var uParam2) // Position - 0x283D
{
	int num;
...
BOOL func_88(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x2859
{
...
void func_89(int iParam0, int iParam1) // Position - 0x28FB
{
	int Variable;
...
BOOL func_90(int iParam0) // Position - 0x291F
{
	switch (iParam0)
	{
		case 0:
...
char* func_91(int iParam0) // Position - 0x294E
{
	switch (iParam0)
	{
		case 0:
...
void func_92(int iParam0) // Position - 0x2985
{
	Ped ped;
	int num;
...
void func_93(int iParam0) // Position - 0x29C2
{
	int num;
	int num2;
	int i;
...
void func_94(int iParam0) // Position - 0x2A92
{
	Ped ped;
	int num;
...
void func_95(int iParam0, BOOL bParam1) // Position - 0x2ACF
{
	int num;
...
void func_96(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2B04
{
	func_45(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

BOOL func_97(int iParam0) // Position - 0x2B1E
{
	int num;
...
BOOL func_98(int iParam0) // Position - 0x2B46
{
	int num;
...
BOOL func_99(int iParam0) // Position - 0x2B6E
{
	int num;
...
BOOL func_100(int iParam0) // Position - 0x2B96
{
	int num;
...
BOOL func_101(int iParam0) // Position - 0x2BBE
{
	if (!func_100(iParam0))
		return false;
...
int func_102(int iParam0) // Position - 0x2BEB
{
	int num;
	int num2;
	int num3;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_103(int iParam0, int iParam1) // Position - 0x2E7B
{
	int num;
	int num2;
	int num3;
...
int func_104(int iParam0) // Position - 0x3033
{
	int num;
...
int func_105(int iParam0) // Position - 0x30CD
{
	switch (iParam0)
	{
		case 1:
...
struct<2> func_106(int iParam0) // Position - 0x3463
{
	var unk;
...
int func_107(Hash hParam0, int iParam1) // Position - 0x3475
{
	var unk;
	int num;
	int i;
...
void func_108(var uParam0, int iParam1) // Position - 0x34BF
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_109(var uParam0, int iParam1) // Position - 0x34D0
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_110(int iParam0, int iParam1) // Position - 0x34E5
{
	int num;
...
BOOL func_111(Player plParam0) // Position - 0x3559
{
...
void func_112(Player plParam0) // Position - 0x3576
{
	Player player;
...
BOOL func_113(int iParam0) // Position - 0x35F9
{
	return func_155(&(Global_1956875.f_1565), iParam0, 1);
}

int func_114(BOOL bParam0) // Position - 0x360F
{
	if (bParam0)
		return 1;
...
float func_115(Player plParam0) // Position - 0x3621
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_159(2);
}

int func_116(int iParam0) // Position - 0x3637
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_117(int iParam0) // Position - 0x365C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_118(int iParam0) // Position - 0x366F
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_119(int iParam0) // Position - 0x3682
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_120(int iParam0) // Position - 0x3695
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_121(int iParam0) // Position - 0x36A7
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_122(int iParam0, int iParam1) // Position - 0x36B9
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3753
{
...
BOOL func_124(int iParam0) // Position - 0x378B
{
	int num;
	int num2;
	int num3;
...
int func_125(int iParam0) // Position - 0x3867
{
	switch (iParam0)
	{
		case 0:
...
char* func_126(int iParam0) // Position - 0x3896
{
	switch (iParam0)
	{
		case 0:
...
char* func_127(int iParam0) // Position - 0x38CD
{
	switch (iParam0)
	{
		case 0:
...
void func_128(int iParam0, float fParam1, int iParam2) // Position - 0x3904
{
	if (iParam2 == 2)
		iParam2 = func_68(2);
...
void func_129(int iParam0, BOOL bParam1, int iParam2) // Position - 0x3956
{
	if (iParam2 == 2)
		iParam2 = func_68(2);
...
BOOL func_130(int iParam0) // Position - 0x39AC
{
	if (func_90(iParam0))
		return true;
...
void func_131(int iParam0, float fParam1, int iParam2) // Position - 0x39D2
{
	if (fParam1 < 0f)
		return;
...
BOOL func_132(int iParam0, int iParam1) // Position - 0x3A2E
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_133(int iParam0) // Position - 0x3A46
{
...
BOOL func_134(int iParam0) // Position - 0x3A5D
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_135(int iParam0, int iParam1) // Position - 0x3B29
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_136(int iParam0) // Position - 0x3B42
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_137() // Position - 0x3B55
{
	if (!func_168())
		return false;
...
int func_138(int iParam0, int iParam1) // Position - 0x3B70
{
	switch (iParam0)
	{
		case -2101912686:
...
int func_139(int iParam0, int iParam1) // Position - 0x4372
{
	switch (iParam0)
	{
...
int func_140(int iParam0, int iParam1) // Position - 0x4A29
{
	Player player;
	Player player2;
	int num;
...
int func_141(int iParam0, int iParam1, int iParam2) // Position - 0x4AAC
{
	int num;
	int num2;
...
void func_142(int iParam0) // Position - 0x4BA4
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_143(int iParam0, int iParam1) // Position - 0x4BBA
{
	switch (iParam0)
	{
...
int func_147(int iParam0, int iParam1) // Position - 0x54E4
{
	Player player;
	Player player2;
	int num;
...
int func_148(int iParam0, int iParam1, int iParam2) // Position - 0x555F
{
	int num;
	BOOL flag;
	int num2;
...
BOOL func_149(int iParam0) // Position - 0x5636
{
	int num;
...
BOOL func_150(int iParam0) // Position - 0x565D
{
	int num;
...
BOOL func_151(int iParam0) // Position - 0x5685
{
	int num;
...
BOOL func_152(int iParam0) // Position - 0x56AD
{
	int num;
...
BOOL func_153(int iParam0) // Position - 0x56D5
{
	int num;
...
BOOL func_154(int iParam0) // Position - 0x56FD
{
	int num;
...
BOOL func_155(int* piParam0, int iParam1, int iParam2) // Position - 0x5725
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_156() // Position - 0x575C
{
	return Global_1102813.f_3672;
}

void func_157(Player plParam0) // Position - 0x576B
{
	Player player;
...
void func_158(Player plParam0) // Position - 0x57D7
{
...
int func_159(int iParam0) // Position - 0x5812
{
	switch (iParam0)
	{
		case 0:
...
var func_160(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5853
{
	if (bParam0)
		return uParam1;
...
void func_161(int iParam0, int iParam1) // Position - 0x586A
{
	if (iParam1 < 0)
		return;
...
void func_162(int iParam0, int iParam1) // Position - 0x58F0
{
...
void func_163(int iParam0, int iParam1) // Position - 0x592C
{
	int num;
	int num2;
...
void func_164(int iParam0, int iParam1) // Position - 0x597F
{
...
void func_165(int iParam0, int iParam1) // Position - 0x59BA
{
...
void func_166(int iParam0, int iParam1) // Position - 0x59F3
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_167(int iParam0) // Position - 0x5A2B
{
	switch (iParam0)
	{
		case 12:
...
Player func_169(int iParam0) // Position - 0x5A64
{
	if (func_149(iParam0))
...
BOOL func_170(int iParam0) // Position - 0x5A85
{
	int num;
...
BOOL func_171(int iParam0, int iParam1, int iParam2) // Position - 0x5AAD
{
	int num;
	int num2;
	int num3;
...
BOOL func_172(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x5C9E
{
	return uParam0.f_4 != 0;
}

BOOL func_173(int iParam0, int iParam1) // Position - 0x5CAC
{
	int num;
...
Vector3 func_174(int iParam0) // Position - 0x5CEC
{
	int num;
	var unk;
...
BOOL func_175(int iParam0, var uParam1, var uParam2) // Position - 0x5D28
{
	if (!func_170(iParam0))
		return false;
...
BOOL func_176(int iParam0, int iParam1, int iParam2) // Position - 0x5D5F
{
	int num;
	int num2;
	int num3;
...
void func_177(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5F8D
{
	int num;
...
void func_178(int iParam0) // Position - 0x600C
{
	int num;
...
BOOL func_179(int iParam0) // Position - 0x6061
{
...
BOOL func_180(int iParam0) // Position - 0x607F
{
	int num;
...
Vector3 func_181(int iParam0) // Position - 0x60AC
{
	var unk;
	int num;
...
int func_182(int iParam0, int iParam1) // Position - 0x60ED
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_183(int iParam0) // Position - 0x6526
{
	int num;
...
float func_184(int iParam0) // Position - 0x654E
{
	float num;
...
void func_185(int iParam0) // Position - 0x657D
{
	int num;
	int num2;
	int i;
...
BOOL func_186(int iParam0) // Position - 0x675C
{
	int num;
...
int func_187(int iParam0, int iParam1) // Position - 0x6784
{
	switch (iParam0)
	{
...
void func_188(int iParam0) // Position - 0x6A94
{
	Ped ped;
	Player player;
...
BOOL func_189(int iParam0) // Position - 0x6CA3
{
	int num;
...
int func_190(int iParam0, int iParam1) // Position - 0x6CCA
{
	switch (iParam0)
	{
...
int func_191(int iParam0) // Position - 0x6D27
{
	int num;
	var unk;
	var unk32;
...
void func_192(int iParam0) // Position - 0x6E6B
{
	int num;
	int num2;
	int i;
...
BOOL func_193(int iParam0) // Position - 0x6FC0
{
	BOOL flag;
...
void func_194(int iParam0) // Position - 0x6FE9
{
	Ped EntityIndex;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_204(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_210(iParam0, 0));
			func_211(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_210(iParam0, 1));
			func_211(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_210(iParam0, 2));
			func_211(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_210(iParam0, 3));
			func_211(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_195(int iParam0) // Position - 0x7283
{
	char* StringToTest;
	char* StringToTest2;
	...
	StringToTest = func_213(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	StringToTest2 = func_214(iParam0);
...
int func_196(int iParam0) // Position - 0x72CD
{
	int num;
...
float func_197(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x72FC
{
	var unk;
	float num;
...
BOOL func_198(int iParam0) // Position - 0x7332
{
...
BOOL func_199(int iParam0) // Position - 0x73A1
{
	int num;
...
int func_200(int iParam0, int iParam1) // Position - 0x73C8
{
	switch (iParam0)
	{
...
char* func_203(int iParam0) // Position - 0x74B7
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_204(int iParam0) // Position - 0x74FD
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_205(int iParam0) // Position - 0x7538
{
	int i;
...
BOOL func_207(int iParam0, int iParam1) // Position - 0x7598
{
	int num;
	Player player;
	int num2;
...
struct<31> func_208(int iParam0) // Position - 0x786D
{
	int num;
...
BOOL func_209(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0x7891
{
	var unk;
	BOOL flag;
...
char* func_210(int iParam0, int iParam1) // Position - 0x78C7
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_211(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x791F
{
	int i;
...
char* func_213(int iParam0) // Position - 0x79C9
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_214(int iParam0) // Position - 0x79E9
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_215(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x7A09
{
	int num;
	int num2;
...
BOOL func_216(BOOL bParam0, BOOL bParam1) // Position - 0x7C2A
{
	return bParam0 && bParam1 != false;
}

BOOL func_217() // Position - 0x7C39
{
	return Global_1572887.f_7;
}

BOOL func_218() // Position - 0x7C47
{
	if (!Global_1048577)
		return false;
...
BOOL func_219(int iParam0, Player plParam1) // Position - 0x7C92
{
	if (plParam1 == 255)
...
int func_220(int iParam0) // Position - 0x7CBE
{
	int num;
...
struct<2> func_221(int iParam0) // Position - 0x7CF4
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_222(var uParam0, var uParam1) // Position - 0x7D08
{
	if (!func_224(uParam0))
		return false;
...
int func_225(int iParam0) // Position - 0x7DC3
{
	switch (iParam0)
	{
		case 2:
