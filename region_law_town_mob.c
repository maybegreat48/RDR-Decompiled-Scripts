...
BOOL func_5(Ped pedParam0, int iParam1) // Position - 0x405
{
	int num;
...
void func_6(Ped* ppedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x504
{
...
Volume func_7(int iParam0) // Position - 0x572
{
	if (!func_18(iParam0))
		return 0;
...
Vector3 func_8(int iParam0, BOOL bParam1) // Position - 0x592
{
...
void func_9(var uParam0, int iParam1) // Position - 0x5F2
{
	int bitShift;
...
float func_10(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x60C
{
...
ePedType func_11(int iParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4, float fParam5, float fParam6, float fParam7) // Position - 0x634
{
	if (!func_19(iParam0))
		return 0;
...
void func_14(var uParam0) // Position - 0xA1B
{
	func_29(uParam0, 0f);
	return;
}

int func_15(int iParam0) // Position - 0xA2A
{
	int num;
...
void func_16(Ped pedParam0) // Position - 0xA7C
{
...
BOOL func_17(int iParam0, int iParam1) // Position - 0xAC6
{
	return iParam0 && iParam1 != false;
}

BOOL func_18(int iParam0) // Position - 0xAD5
{
	return iParam0 >= 0 && iParam0 <= 150;
}

BOOL func_19(int iParam0) // Position - 0xAEB
{
	return iParam0 > -1 && iParam0 < 16;
}

Hash func_20(int iParam0) // Position - 0xB01
{
	int num;
...
BOOL func_21(int iParam0, var uParam1, ePedType eptParam2) // Position - 0xB44
{
	var unk;
	BOOL flag;
	float num;
...
void func_22(Volume volParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0xD3B
{
	int num;
...
void func_23(Volume volParam0, int iParam1) // Position - 0xD8F
{
	int num;
...
Vector3 func_24(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0xDF7
{
	var unk;
	float MaxFloat;
...
Ped func_25(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0xE3F
{
	Ped EntityIndex;
	...
	func_34(EntityIndex, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return EntityIndex;
}
...
int func_27(int iParam0) // Position - 0xE8B
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

void func_28(var uParam0, int iParam1) // Position - 0xE9E
{
	int bitShift;
...
void func_29(var uParam0, float fParam1) // Position - 0xEB8
{
...
void func_30(Ped pedParam0) // Position - 0xEDE
{
	Blip blipFromEntity;
...
int func_31() // Position - 0xF01
{
	return Global_1893611.f_2;
}

int func_32(int iParam0) // Position - 0xF0F
{
	if (!func_18(iParam0))
		return 0;
...
Vector3 func_33(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0xF2F
{
	float num;
...
void func_34(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xF66
{
	BOOL flag;
...
void func_36(var uParam0, int iParam1) // Position - 0x1062
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_37(var uParam0, int iParam1) // Position - 0x1073
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_38(Blip* pblParam0) // Position - 0x1088
{
...
void func_39(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x10A0
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_40(Ped pedParam0, BOOL bParam1) // Position - 0x10E5
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_41(Ped pedParam0, int iParam1) // Position - 0x112A
{
	if (iParam1 == 1)
