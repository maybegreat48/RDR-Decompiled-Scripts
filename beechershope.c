...
void _DEBUG_PRINT(int iParam0) // Position - 0x848
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x854
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x861
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x86D
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x87A
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x886
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x89B
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x8AC
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x8EB
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x8F7
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x8FF
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0x9AF
{
	return;
}

void func_26() // Position - 0x9B7
{
	return;
}

void func_27() // Position - 0x9BF
{
	return;
}

void func_28() // Position - 0x9C7
{
	return;
}

void func_29(int iParam0) // Position - 0x9CF
{
...
void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x9F6
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0xA02
{
	return;
}
...
void func_33(int iParam0) // Position - 0xA12
{
	func_60(0.775f, 0.2f, 0.025f, 0f);
	return;
}

void func_34() // Position - 0xA2E
{
...
void func_35(var uParam0) // Position - 0xA5F
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xAA5
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xABA
{
	if (!func_62(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xAD3
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xAE4
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xAFC
{
	iParam0 = iParam0;
	return false;
}

void func_41(var uParam0, int iParam1) // Position - 0xB09
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xC48
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xC55
{
...
BOOL func_44(int iParam0) // Position - 0xC8B
{
	if (iParam0 == 0)
	{
		func_76();
...
int func_45() // Position - 0xD9F
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xDAD
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xDB9
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xE26
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xF06
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xF24
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xF37
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF55
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x104D
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x105E
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x1072
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x1086
{
	return uParam0;
}

void func_58(int iParam0, Volume volParam1, int iParam2, Volume volParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x1090
{
...
int func_59(int iParam0, BOOL bParam1) // Position - 0x123F
{
	int num;
	Hash hash;
	float num2;
...
void func_60(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1366
{
...
void func_61(var uParam0, Volume volParam1, int iParam2) // Position - 0x138E
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_62(int iParam0) // Position - 0x13E7
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_63() // Position - 0x13FD
{
	int i;
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x142A
{
	return iParam0 && iParam1 != false;
}

BOOL func_65(var uParam0, int iParam1) // Position - 0x1439
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_66() // Position - 0x144A
{
	return func_64(Global_1940199, 8192);
}

BOOL func_67(var uParam0, int iParam1) // Position - 0x145D
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_68(int iParam0) // Position - 0x146E
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_69(int iParam0, int iParam1) // Position - 0x14AE
{
...
int func_70() // Position - 0x14DB
{
	return Global_1896646.f_41;
}

void func_71(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x14E9
{
	BOOL flag;
	...
	StringToTest = func_112(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_124(&unk, joaat("COLOR_PURE_WHITE")), str3, func_124(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_124(&unk, joaat("COLOR_PURE_WHITE")), func_124(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_125(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_72(var uParam0, int iParam1) // Position - 0x1750
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_73(int iParam0, BOOL bParam1) // Position - 0x1763
{
...
void func_74(BOOL bParam0) // Position - 0x1DCC
{
	if (bParam0)
...
BOOL func_75(int iParam0) // Position - 0x1DF5
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_76() // Position - 0x1E3A
{
	return;
}

Hash func_77(int iParam0, BOOL bParam1) // Position - 0x1E42
{
	switch (iParam0)
	{
		case 0:
...
void func_78(int iParam0, BOOL bParam1) // Position - 0x2607
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_79(BOOL bParam0) // Position - 0x265A
{
	if (bParam0)
...
void func_80(int iParam0) // Position - 0x2683
{
	func_60(0.775f, 0.2f, 0.025f, 0f);
	iParam0 = iParam0;
	return;
...
void func_81(int iParam0) // Position - 0x26A3
{
	int i;
...
void func_82(int iParam0) // Position - 0x26D4
{
	int i;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x2707
{
	int num;
	int num2;
	int num3;
...
BOOL func_84(int iParam0) // Position - 0x27BD
{
	int i;
...
BOOL func_85(int iParam0, BOOL bParam1) // Position - 0x2837
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_86(int iParam0) // Position - 0x2868
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_87(int iParam0) // Position - 0x2889
{
	if (!func_62(iParam0))
		return false;
...
BOOL func_88(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x28DC
{
	BOOL flag;
...
BOOL func_89(int iParam0) // Position - 0x2F9C
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_90(int iParam0) // Position - 0x2FB3
{
	switch (iParam0)
	{
		case 64:
...
int func_91(int iParam0, BOOL bParam1) // Position - 0x2FF6
{
	if (!func_89(iParam0))
		return 0;
...
BOOL func_93() // Position - 0x30F5
{
	return func_143(func_56(0));
}

BOOL func_94(int iParam0) // Position - 0x3106
{
	return !func_144(iParam0);
}

void func_95(BOOL bParam0, BOOL bParam1) // Position - 0x3115
{
	if (func_145(255) == 4)
		return;
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x3260
{
	BOOL flag;
...
int func_97(int iParam0, int iParam1) // Position - 0x360F
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_98(int iParam0) // Position - 0x3F75
{
	if (!func_162(iParam0))
		return 0;
...
int func_99(int iParam0) // Position - 0x3FB6
{
	switch (iParam0)
	{
		case 3:
...
void func_100(int iParam0, int iParam1) // Position - 0x4055
{
...
void func_101(int iParam0) // Position - 0x4084
{
...
BOOL func_102(int iParam0, int iParam1) // Position - 0x40BD
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x40D6
{
...
int func_104() // Position - 0x4100
{
	return Global_1893611.f_2;
}

BOOL func_105(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x410E
{
	return func_164(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_106(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x412E
{
	return func_164(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_107(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x414E
{
	if (bParam6)
...
BOOL func_108(int iParam0) // Position - 0x41CA
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_109(int iParam0) // Position - 0x41E0
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_110(int iParam0) // Position - 0x41F6
{
...
const char* func_112(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x426E
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_169(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_171(func_170(Global_34));
...
BOOL func_113(int iParam0) // Position - 0x4CD4
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_114(int iParam0) // Position - 0x4CE9
{
	switch (iParam0)
	{
		case 0:
...
int func_115(int iParam0) // Position - 0x4DA4
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_116(int iParam0) // Position - 0x4E12
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_117(int iParam0) // Position - 0x4F6D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_118(int iParam0, BOOL bParam1) // Position - 0x4FA8
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_119(int iParam0, int iParam1) // Position - 0x4FEA
{
	if (!func_113(iParam0))
		return false;
...
int func_120() // Position - 0x502F
{
	return Global_1902569;
}

int func_121(int iParam0) // Position - 0x503B
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_122(int iParam0) // Position - 0x504E
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_123(float fParam0) // Position - 0x5060
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_124(var uParam0, int iParam1) // Position - 0x5076
{
...
int func_125(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x50AC
{
	int duration;
	var data;
	int num;
...
BOOL func_126(int iParam0) // Position - 0x50EF
{
	if (func_172(iParam0))
		if (!func_173(44))
			return false;
...
void func_127(int iParam0, int iParam1) // Position - 0x510F
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_128(int iParam0, int iParam1) // Position - 0x5120
{
	int num;
...
void func_129(var uParam0, var uParam1, int iParam2) // Position - 0x5136
{
...
void func_130(int iParam0) // Position - 0x5153
{
...
void func_131(int iParam0) // Position - 0x5233
{
	int i;
	int num;
...
BOOL func_132(int iParam0, BOOL bParam1) // Position - 0x540B
{
	if (func_45() != -1)
		return false;
...
int func_133(int iParam0, BOOL bParam1) // Position - 0x5439
{
	if (!func_89(iParam0))
		return 0;
...
int func_134(int iParam0) // Position - 0x54BC
{
	switch (iParam0)
	{
		case 27:
...
int func_135(int iParam0) // Position - 0x54E3
{
	switch (iParam0)
	{
		case 33:
...
Hash func_138(int iParam0) // Position - 0x5746
{
	if (!func_89(iParam0))
		return 0;
...
void func_139(int iParam0, PersChar pchParam1) // Position - 0x5764
{
	if (!func_89(iParam0))
		return;
...
PersChar func_140(int iParam0) // Position - 0x5785
{
	if (!func_89(iParam0))
		return 0;
...
void func_141(int iParam0, BOOL bParam1) // Position - 0x57A5
{
	if (func_45() != -1)
		return;
...
BOOL func_142(int iParam0) // Position - 0x57DE
{
	if (!func_89(iParam0))
		return false;
...
BOOL func_143(var uParam0, var uParam1) // Position - 0x5804
{
	return func_189(uParam0, 5, 8);
}

BOOL func_144(int iParam0) // Position - 0x5817
{
	return func_190(1, iParam0);
}

int func_145(int iParam0) // Position - 0x5826
{
	if (iParam0 == 255)
...
int func_146(int iParam0) // Position - 0x5871
{
...
void func_147(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x588E
{
	func_192(iParam0);
...
int func_148(int iParam0) // Position - 0x58F0
{
...
void func_149(var uParam0) // Position - 0x590D
{
	var unk;
...
void func_150(float* pfParam0) // Position - 0x591F
{
	var unk;
...
void func_152(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x5987
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_153(int iParam0) // Position - 0x59B4
{
...
BOOL func_154(int iParam0, int iParam1) // Position - 0x5A11
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_155(int iParam0, int iParam1) // Position - 0x5A2A
{
	func_154(iParam0, iParam1);
...
int func_156(int iParam0) // Position - 0x5A65
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_157(Hash hParam0) // Position - 0x5A79
{
...
void func_158(int iParam0) // Position - 0x5A99
{
	return;
}

void func_159(int iParam0) // Position - 0x5AA1
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_160(int iParam0, int iParam1) // Position - 0x5AB6
{
	if (iParam0 == -1)
		return false;
...
void func_161(int iParam0) // Position - 0x5ADD
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_162(int iParam0) // Position - 0x5B5C
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_163(int iParam0) // Position - 0x5B72
{
	var unk;
...
BOOL func_164(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x5BA3
{
	int num;
...
int func_165(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5C2B
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

BOOL func_166() // Position - 0x5C45
{
	return false;
}

BOOL func_167() // Position - 0x5C4E
{
	var unk;
	var unk3;
...
BOOL func_168(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5CB6
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_169(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5E2C
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_170(var uParam0, var uParam1, var uParam2) // Position - 0x5E40
{
	int i;
...
const char* func_171(int iParam0) // Position - 0x5E6E
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_172(int iParam0) // Position - 0x6152
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_173(int iParam0) // Position - 0x617C
{
	if (!func_210(iParam0))
		return false;
...
struct<2> func_174(Player plParam0) // Position - 0x6198
{
	var gamerHandle;
...
const char* func_175(const char* sParam0, int iParam1) // Position - 0x61AC
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_176(int iParam0, BOOL bParam1) // Position - 0x61C6
{
	char* StringToTest;
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x61FA
{
	switch (iParam0)
	{
		case 5:
...
void func_178(int iParam0, int iParam1) // Position - 0x622F
{
	func_212(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_179(int iParam0) // Position - 0x6249
{
	if (!func_89(iParam0))
		return false;
...
void func_180(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x626E
{
	PersChar persChar;
...
void func_181(int iParam0, BOOL bParam1) // Position - 0x635A
{
	if (!func_162(iParam0))
		return;
...
void func_182(int iParam0, int iParam1) // Position - 0x63B0
{
	if (!func_219(iParam0))
		return;
...
int func_183(int iParam0) // Position - 0x6423
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_184(int iParam0) // Position - 0x6439
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_185(int iParam0, BOOL bParam1) // Position - 0x644F
{
	if (func_45() != -1)
		return;
...
void func_186(int iParam0) // Position - 0x6480
{
	Ped EntityIndex;
...
void func_187(int iParam0) // Position - 0x64C4
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_188(int iParam0) // Position - 0x64D9
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_189(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x64EE
{
	int num;
...
BOOL func_190(int iParam0, int iParam1) // Position - 0x6529
{
	int num;
...
BOOL func_191(var uParam0, int iParam1, int iParam2) // Position - 0x659D
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_197(BOOL bParam0) // Position - 0x666C
{
	if (func_224(bParam0))
		return;
...
BOOL func_198(var uParam0, int iParam1, int iParam2) // Position - 0x6693
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_199(Hash hParam0) // Position - 0x66C6
{
	if (func_225(hParam0))
...
BOOL func_200() // Position - 0x66E1
{
	return 1;
}

BOOL func_201(BOOL bParam0, BOOL bParam1) // Position - 0x66EA
{
	return bParam0 && bParam1 != false;
}

int func_202(int iParam0) // Position - 0x66F9
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_203(int iParam0, int iParam1, var uParam2) // Position - 0x70E1
{
	var unk;
...
int func_204() // Position - 0x7108
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_205() // Position - 0x711D
{
	if (Global_1048576)
		return true;
...
struct<2> func_206() // Position - 0x7175
{
	return Global_1051268;
}

BOOL func_207(var uParam0, var uParam1) // Position - 0x7183
{
	if (!func_228(uParam0))
		return false;
...
struct<2> func_208() // Position - 0x71B7
{
...
BOOL func_209(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7202
{
	var unk;
	float num;
	float num2;
...
BOOL func_210(int iParam0) // Position - 0x7232
{
	if (iParam0 == 0)
		return false;
...
BOOL func_211(int iParam0) // Position - 0x7245
{
	int num;
	int num2;
	int offset;
...
void func_212(var uParam0, int iParam1) // Position - 0x726F
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_213(int iParam0) // Position - 0x7284
{
	if (!func_89(iParam0))
		return false;
...
BOOL func_214(Hash hParam0) // Position - 0x72A8
{
	return hParam0 != 0;
}

BOOL func_215(int iParam0, BOOL bParam1) // Position - 0x72B4
{
	if (!func_162(iParam0))
		return false;
...
void func_216(int iParam0, BOOL bParam1) // Position - 0x72DA
{
	if (!func_162(iParam0))
		return;
...
void func_217(int iParam0, BOOL bParam1) // Position - 0x7308
{
	if (!func_162(iParam0))
		return;
...
void func_218(int iParam0) // Position - 0x7342
{
	func_233(func_232(iParam0));
	return;
}

BOOL func_219(int iParam0) // Position - 0x7354
{
	return iParam0 > -1 && iParam0 < 40;
}

Ped func_220(int iParam0) // Position - 0x736A
{
	PersChar persChar;
...
int func_221(int iParam0, var uParam1) // Position - 0x7398
{
	if (iParam0 == 2)
...
BOOL func_222(var uParam0, int iParam1, int iParam2) // Position - 0x73B2
{
	return MISC::IS_BIT_SET(uParam0->[iParam1 / 31], iParam1 % 31);
}

int func_223() // Position - 0x73E9
{
	return Global_1102813.f_3672;
}

BOOL func_224(BOOL bParam0) // Position - 0x73F8
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_225(Hash hParam0) // Position - 0x740E
{
	return hParam0 != 0;
}

BOOL func_226(int iParam0, int iParam1, Any* panParam2) // Position - 0x741A
{
...
void func_227(Any* panParam0, int iParam1, var uParam2) // Position - 0x744E
{
	var unk;
...
BOOL func_228(int iParam0) // Position - 0x74C8
{
	switch (iParam0)
	{
		case 2:
...
int func_229(int iParam0) // Position - 0x7507
{
	switch (iParam0)
	{
		case 2:
...
void func_230(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x759D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_231(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x803B
{
	float num;
	float num2;
	float num3;
...
int func_232(int iParam0) // Position - 0x80A1
{
...
void func_233(int iParam0) // Position - 0x85BE
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_234(var uParam0, var uParam1) // Position - 0x85CF
{
	var unk;
...
int func_235(int iParam0) // Position - 0x85FB
{
	int num;
...
BOOL func_236(int iParam0, var uParam1, Any* panParam2) // Position - 0x8770
{
	if (!func_207(iParam0))
		return false;
...
void func_237(Any* panParam0) // Position - 0x887B
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
