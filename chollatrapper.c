...
int func_96(int iParam0, int iParam1) // Position - 0x35B2
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
void func_101(int iParam0, int iParam1) // Position - 0x405F
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_102(int iParam0, int iParam1) // Position - 0x4070
{
...
int func_114(int iParam0) // Position - 0x4D41
{
	int i;
	var gamerHandle;
	int bountyData;
...
BOOL func_190(var uParam0, int iParam1, int iParam2) // Position - 0x653A
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_197(var uParam0, int iParam1, int iParam2) // Position - 0x6630
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_211(var uParam0, int iParam1) // Position - 0x720C
{
...
BOOL func_221(var uParam0, int iParam1, int iParam2) // Position - 0x734F
{
