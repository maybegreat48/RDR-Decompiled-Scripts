...
void _DEBUG_PRINT(int iParam0) // Position - 0x7D9
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x7E5
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x7F2
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x7FE
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x80B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x817
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x82C
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x83D
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x87C
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x888
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x890
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0x940
{
	return;
}

void func_26() // Position - 0x948
{
	return;
}

void func_27() // Position - 0x950
{
	return;
}

void func_28() // Position - 0x958
{
	return;
}

void func_29(int iParam0) // Position - 0x960
{
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0x968
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0x974
{
	return;
}

void func_32() // Position - 0x97C
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x984
{
	iParam0 = iParam0;
	return;
}
...
void func_35(var uParam0) // Position - 0x9C1
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xA07
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xA1B
{
	if (!func_58(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xA34
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xA45
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xA5D
{
	iParam0 = iParam0;
...
void func_41(var uParam0, int iParam1) // Position - 0xA82
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xBC1
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xBCE
{
...
BOOL func_44(int iParam0) // Position - 0xC04
{
	if (iParam0 == 0)
	{
		func_75();
...
int func_45() // Position - 0xD18
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xD26
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xD32
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xD9F
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xE7F
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xE9D
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xEB0
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xECE
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0xFC6
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0xFD7
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0xFEB
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0xFFF
{
	return uParam0;
}

BOOL func_58(int iParam0) // Position - 0x1009
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_59() // Position - 0x101F
{
	int i;
...
BOOL func_60(int iParam0) // Position - 0x104C
{
	return !func_92(iParam0);
}

BOOL func_61() // Position - 0x105B
{
...
void func_62(int iParam0, BOOL bParam1) // Position - 0x106F
{
	var unk;
	float num;
...
BOOL func_63(int iParam0, int iParam1) // Position - 0x1104
{
	return iParam0 && iParam1 != false;
}

BOOL func_64(var uParam0, int iParam1) // Position - 0x1113
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_65() // Position - 0x1124
{
	return func_63(Global_1940199, 8192);
}

BOOL func_66(var uParam0, int iParam1) // Position - 0x1137
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_67(int iParam0) // Position - 0x1148
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_68(int iParam0, int iParam1) // Position - 0x1188
{
...
int func_69() // Position - 0x11B5
{
	return Global_1896646.f_41;
}

void func_70(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x11C3
{
	BOOL flag;
	...
	StringToTest = func_101(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_113(&unk, joaat("COLOR_PURE_WHITE")), str3, func_113(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_113(&unk, joaat("COLOR_PURE_WHITE")), func_113(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_114(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_71(var uParam0, int iParam1) // Position - 0x1427
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_72(int iParam0, BOOL bParam1) // Position - 0x143A
{
...
void func_73(BOOL bParam0) // Position - 0x1AA3
{
	if (bParam0)
...
BOOL func_74(int iParam0) // Position - 0x1ACC
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_75() // Position - 0x1B11
{
	return;
}

Hash func_76(int iParam0, BOOL bParam1) // Position - 0x1B19
{
	switch (iParam0)
	{
		case 0:
...
void func_77(int iParam0, BOOL bParam1) // Position - 0x22DE
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_78(BOOL bParam0) // Position - 0x2331
{
	if (bParam0)
...
void func_79(int iParam0) // Position - 0x235A
{
	iParam0 = iParam0;
...
void func_80(int iParam0) // Position - 0x237B
{
	int i;
...
void func_81(int iParam0) // Position - 0x23AC
{
	int i;
...
BOOL func_82(int iParam0, BOOL bParam1) // Position - 0x23DF
{
	int num;
	int num2;
	int num3;
...
BOOL func_83(int iParam0) // Position - 0x2495
{
	int i;
...
BOOL func_84(int iParam0, BOOL bParam1) // Position - 0x250F
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_85(int iParam0) // Position - 0x2540
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_86(int iParam0) // Position - 0x2561
{
	if (!func_58(iParam0))
		return false;
...
BOOL func_87(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x25B4
{
	BOOL flag;
...
BOOL func_88(int iParam0) // Position - 0x2C74
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_89(int iParam0) // Position - 0x2C8B
{
	switch (iParam0)
	{
		case 64:
...
int func_90(int iParam0, BOOL bParam1) // Position - 0x2CCE
{
	if (!func_88(iParam0))
		return 0;
...
BOOL func_91(int iParam0) // Position - 0x2DB9
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_92(int iParam0) // Position - 0x2DCF
{
	return func_134(1, iParam0);
}

BOOL func_93(Vector3* pvParam0, float* pfParam1) // Position - 0x2DDE
{
	Hash* p_hash;
	int MaxInt;
	...
	else
	{
		...
		if (func_136(p_hash, randomIntInRange, pvParam0, pfParam1))
			return true;
	}
...
int func_94(int iParam0) // Position - 0x2E2E
{
...
BOOL func_95(int iParam0, var uParam1) // Position - 0x2E4B
{
	var ReturnZ;
	float volumeScale;
	float num;
...
void func_96(var uParam0, var uParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x2F50
{
	if (func_138(255) == 4)
		return;
...
int func_97(int iParam0) // Position - 0x3088
{
...
void func_98(var uParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0x30A5
{
	var entityCoords;
	float num;
...
BOOL func_99(int iParam0) // Position - 0x3100
{
...
const char* func_101(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x3178
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_150(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_152(func_151(Global_34));
...
BOOL func_102(int iParam0) // Position - 0x3BD7
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_103(int iParam0) // Position - 0x3BEC
{
	switch (iParam0)
	{
		case 0:
...
Hash func_104(int iParam0) // Position - 0x3CA7
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_105(int iParam0) // Position - 0x3D15
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_106(int iParam0) // Position - 0x3E70
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_107(int iParam0, BOOL bParam1) // Position - 0x3EAB
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_108(int iParam0, int iParam1) // Position - 0x3EED
{
	if (!func_102(iParam0))
		return false;
...
int func_109() // Position - 0x3F32
{
	return Global_1902569;
}

int func_110(int iParam0) // Position - 0x3F3E
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_111(int iParam0) // Position - 0x3F51
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_112(float fParam0) // Position - 0x3F63
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_113(var uParam0, int iParam1) // Position - 0x3F79
{
...
int func_114(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3FAF
{
	int duration;
	var data;
	int num;
...
BOOL func_115(int iParam0) // Position - 0x3FF2
{
	if (func_153(iParam0))
		if (!func_154(44))
			return false;
...
void func_116(int iParam0, int iParam1) // Position - 0x4012
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_117(int iParam0, int iParam1) // Position - 0x4023
{
	int num;
...
void func_118(var uParam0, var uParam1, int iParam2) // Position - 0x4039
{
...
void func_119(var uParam0, BOOL bParam1) // Position - 0x4056
{
...
void func_120(int iParam0) // Position - 0x40A4
{
...
void func_121(int iParam0) // Position - 0x4184
{
	int i;
	int num;
...
BOOL func_122(int iParam0, BOOL bParam1) // Position - 0x435C
{
	if (func_45() != -1)
		return false;
...
int func_123(int iParam0, BOOL bParam1) // Position - 0x438A
{
	if (!func_88(iParam0))
		return 0;
...
int func_124(int iParam0) // Position - 0x440D
{
	switch (iParam0)
	{
		case 27:
...
int func_125(int iParam0) // Position - 0x4434
{
	switch (iParam0)
	{
		case 33:
...
void func_128(int iParam0, BOOL bParam1) // Position - 0x4697
{
	BOOL flag;
...
Hash func_129(int iParam0) // Position - 0x4A46
{
	if (!func_88(iParam0))
		return 0;
...
void func_130(int iParam0, PersChar pchParam1) // Position - 0x4A64
{
	if (!func_88(iParam0))
		return;
...
PersChar func_131(int iParam0) // Position - 0x4A85
{
	if (!func_88(iParam0))
		return 0;
...
void func_132(int iParam0, BOOL bParam1) // Position - 0x4AA5
{
	if (func_45() != -1)
		return;
...
BOOL func_133(int iParam0) // Position - 0x4ADE
{
	if (!func_88(iParam0))
		return false;
...
BOOL func_134(int iParam0, int iParam1) // Position - 0x4B04
{
	int num;
...
int func_135(Hash* phParam0) // Position - 0x4B78
{
	Any any;
...
BOOL func_136(Hash* phParam0, int iParam1, Vector3* pvParam2, float* pfParam3) // Position - 0x4BA4
{
	Any any;
...
BOOL func_137(int* piParam0, int iParam1, int iParam2) // Position - 0x4C06
{
	int num;
	int offset;
	BOOL isBitSet;
...
int func_138(int iParam0) // Position - 0x4C39
{
	if (iParam0 == 255)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4C84
{
...
void func_140(var uParam0) // Position - 0x4CAE
{
	var unk;
...
void func_141(float* pfParam0) // Position - 0x4CC0
{
	var unk;
...
void func_143(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x4D28
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_144(int* piParam0, int iParam1, int iParam2) // Position - 0x4D55
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_145(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0x4D87
{
	Hash* p_hash;
	int MaxInt;
	int randomIntInRange;

	p_hash = Global_1072759.f_23824.f_383[func_186(uParam0) /*272*/];
	MaxInt = func_135(p_hash);
	...
	else
	{
		...
		if (func_136(p_hash, randomIntInRange, pvParam3, pfParam4))
			return true;
	}
...
void func_146(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13) // Position - 0x4DD8
{
	if (func_138(255) == 4)
		return;
...
BOOL func_147() // Position - 0x4FAD
{
	return false;
}

BOOL func_148() // Position - 0x4FB6
{
	var unk;
	var unk3;
...
BOOL func_149(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x501E
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_150(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5194
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_151(var uParam0, var uParam1, var uParam2) // Position - 0x51A8
{
	int i;
...
const char* func_152(int iParam0) // Position - 0x51D6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_153(int iParam0) // Position - 0x54BA
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_154(int iParam0) // Position - 0x54E4
{
	if (!func_193(iParam0))
		return false;
...
struct<2> func_155(Player plParam0) // Position - 0x5500
{
	var gamerHandle;
...
const char* func_156(const char* sParam0, int iParam1) // Position - 0x5514
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

BOOL func_157(Volume volParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x552E
{
	return VOLUME::DOES_VOLUME_EXIST(volParam0);
}

void func_158(Volume volParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x553C
{
...
BOOL func_159(int iParam0) // Position - 0x557A
{
	if (iParam0 < 0)
		return false;
...
void func_160(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x55B9
{
	int num;
...
void func_161(int iParam0, BOOL bParam1) // Position - 0x560D
{
	char* StringToTest;
...
void func_162(int iParam0, BOOL bParam1) // Position - 0x5641
{
	switch (iParam0)
	{
		case 5:
...
void func_163(int iParam0, int iParam1) // Position - 0x5676
{
	func_197(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_164(int iParam0) // Position - 0x5690
{
	if (!func_88(iParam0))
		return false;
...
void func_165(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x56B5
{
	PersChar persChar;
...
void func_166(int iParam0, BOOL bParam1) // Position - 0x57A1
{
	if (!func_200(iParam0))
		return;
...
void func_167(int iParam0, int iParam1) // Position - 0x57F7
{
	if (!func_205(iParam0))
		return;
...
int func_168(int iParam0) // Position - 0x586A
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_169(Hash hParam0) // Position - 0x5880
{
...
void func_170(int iParam0) // Position - 0x58A0
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_171(int iParam0, BOOL bParam1) // Position - 0x58B6
{
	if (func_45() != -1)
		return;
...
void func_172(int iParam0) // Position - 0x58E7
{
	Ped EntityIndex;
...
void func_173(int iParam0) // Position - 0x592B
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_174(int iParam0) // Position - 0x5940
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_175(int iParam0) // Position - 0x5955
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_176(int iParam0) // Position - 0x596A
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_177(int iParam0) // Position - 0x59E9
{
...
BOOL func_178(int iParam0, BOOL bParam1) // Position - 0x5A46
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL func_179(int iParam0, int iParam1) // Position - 0x5A5F
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_180(int iParam0, int iParam1) // Position - 0x5A78
{
...
int func_181(int iParam0) // Position - 0x5AB3
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_182(int iParam0) // Position - 0x5AC7
{
	return;
}

BOOL func_183(int iParam0, int iParam1) // Position - 0x5ACF
{
	if (iParam0 == -1)
		return false;
...
BOOL func_184(int* piParam0, int iParam1, int iParam2) // Position - 0x5AF6
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_185() // Position - 0x5B2D
{
	return Global_1102813.f_3672;
}

int func_186(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x5B3C
{
	int i;
	int num;
	float num2;
...
void func_187(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x5B99
{
	func_210(iParam0);
...
struct<2> func_189() // Position - 0x5C53
{
	return Global_1051268;
}

BOOL func_190(var uParam0, var uParam1) // Position - 0x5C61
{
	if (!func_216(uParam0))
		return false;
...
struct<2> func_191() // Position - 0x5C95
{
...
BOOL func_192(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x5CE0
{
	var unk;
	float num;
	float num2;
...
BOOL func_193(int iParam0) // Position - 0x5D10
{
	if (iParam0 == 0)
		return false;
...
BOOL func_194(int iParam0) // Position - 0x5D23
{
	int num;
	int num2;
	int offset;
...
int func_195(var uParam0) // Position - 0x5D4D
{
	return uParam0;
}

void func_196(int iParam0) // Position - 0x5D57
{
	if (!func_220(iParam0))
		return;
...
void func_197(BOOL bParam0, int iParam1) // Position - 0x5E0A
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_198(int iParam0) // Position - 0x5E1F
{
	if (!func_88(iParam0))
		return false;
...
BOOL func_199(Hash hParam0) // Position - 0x5E43
{
	return hParam0 != 0;
}

BOOL func_200(int iParam0) // Position - 0x5E4F
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_201(int iParam0, BOOL bParam1) // Position - 0x5E65
{
	if (!func_200(iParam0))
		return false;
...
void func_202(int iParam0, BOOL bParam1) // Position - 0x5E8B
{
	if (!func_200(iParam0))
		return;
...
void func_203(int iParam0, BOOL bParam1) // Position - 0x5EB9
{
	if (!func_200(iParam0))
		return;
...
void func_204(int iParam0) // Position - 0x5EF3
{
	func_222(func_221(iParam0));
	return;
}

BOOL func_205(int iParam0) // Position - 0x5F05
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_206(Hash hParam0) // Position - 0x5F1B
{
	if (func_223(hParam0))
...
BOOL func_207() // Position - 0x5F36
{
	return 1;
}

Ped func_208(int iParam0) // Position - 0x5F3F
{
	PersChar persChar;
...
void func_215(BOOL bParam0) // Position - 0x6019
{
	if (func_224(bParam0))
		return;
...
BOOL func_216(int iParam0) // Position - 0x6040
{
	switch (iParam0)
	{
		case 2:
...
int func_217(int iParam0) // Position - 0x607F
{
	switch (iParam0)
	{
		case 2:
...
void func_218(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6115
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_219(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x6BB2
{
	float num;
	float num2;
	float num3;
...
BOOL func_220(int iParam0) // Position - 0x6C18
{
	return func_225(iParam0, 2);
}

int func_221(int iParam0) // Position - 0x6C27
{
...
void func_222(int iParam0) // Position - 0x7144
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_223(Hash hParam0) // Position - 0x7155
{
	return hParam0 != 0;
}

BOOL func_224(BOOL bParam0) // Position - 0x7161
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_225(int iParam0, int iParam1) // Position - 0x7177
{
	if (iParam0 < 0)
		return false;
