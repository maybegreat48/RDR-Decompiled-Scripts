...
void func_1(int iParam0, var uParam1, var uParam2) // Position - 0x48
{
	func_5(32, iParam0);
	func_6();
	func_7(&uLocal_21);
...
BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0xAB
{
	int i;
...
BOOL func_3(var uParam0, var uParam1, int* piParam2, var uParam3, var uParam4, var uParam5) // Position - 0x18B
{
	BOOL flag;
	Ped EntityIndex;
	BOOL flag2;
	...
	{
		EntityIndex = NETWORK::NET_TO_PED(uParam0->f_1);
		flag2 = ENTITY::DOES_ENTITY_EXIST(EntityIndex);
	}

	if (flag2)
		flag3 = NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(EntityIndex);
...
void func_5(int iParam0, int iParam1) // Position - 0x221
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_4();
...
void func_7(var uParam0) // Position - 0x34F
{
	*uParam0 = -1;
	uParam0->f_1 = -1;
	uParam0->f_2 = 255;
...
int func_8(int iParam0, int iParam1, char* sParam2) // Position - 0x397
{
	return 1;
}

void func_9(var uParam0) // Position - 0x3A0
{
	int i;
...
int func_10(int iParam0, int iParam1, char* sParam2) // Position - 0x3C5
{
	return 1;
}

void func_11(BOOL bParam0) // Position - 0x3CE
{
	int num;
	var unk;
	int num2;
...
BOOL func_12(var uParam0, var uParam1, int* piParam2, var uParam3, var uParam4, var uParam5) // Position - 0x497
{
	int num;
	int num2;
	Ped EntityIndex;
...
void func_13(var uParam0, var uParam1, int* piParam2) // Position - 0x5AC
{
	Ped EntityIndex;
	BOOL isEntityDead;
...
int func_14(var uParam0, var uParam1, int* piParam2) // Position - 0x601
{
	Ped EntityIndex;
	int num;
	int num2;
	...
	switch (num)
	{
		...
		case 4:
			PED::_PED_EMOTIONAL_PRESET_LOCO_MOTION(EntityIndex, "Interaction_Happy", 0, 20000, 4);
			break;
...
BOOL func_15(var uParam0, var uParam1, int* piParam2, int iParam3, var uParam4, var uParam5) // Position - 0x6EE
{
	BOOL flag;
	Ped EntityIndex;
	Player player;
	...
	switch (num)
	{
		...
		case 1:
			...
			if (flag)
			{
				func_47(uParam0, EntityIndex);
				func_48(piParam2);
				func_49(uParam0, piParam2);
				func_50(player2, EntityIndex);
				func_51(uParam1, piParam2, uParam0->f_2, EntityIndex);
				func_52(piParam2, uParam0->f_2, 2);
				func_53(uParam1, piParam2, uParam0->f_2, EntityIndex);
				func_52(piParam2, uParam0->f_2, 4);
				func_54(uParam0, &uParam1->[player2 /*2*/], EntityIndex, player);
				func_55(uParam0, &uParam1->[player2 /*2*/]);
				func_56(uParam0, &uParam1->[player2 /*2*/], EntityIndex);
				func_57(uParam0, uParam1, EntityIndex);
				return true;
			}
...
int func_16() // Position - 0x863
{
	return Global_1572887.f_14;
}

BOOL func_17() // Position - 0x871
{
	return Global_1051645.f_8;
}

void func_18(var uParam0) // Position - 0x87F
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	return;
...
void func_19(var uParam0) // Position - 0x893
{
	*uParam0 = 255;
...
void func_20(var uParam0) // Position - 0x8B7
{
	*uParam0 = -15;
	return;
}

void func_21(var uParam0) // Position - 0x8C5
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	return;
...
int func_22(var uParam0) // Position - 0x8D6
{
	return uParam0->f_4;
}

void func_23(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x8E2
{
	*uParam0 = uParam1;
...
void func_24(var uParam0, int iParam1) // Position - 0x8FF
{
...
BOOL func_25(var uParam0, var uParam1, int* piParam2, var uParam3, var uParam4, var uParam5) // Position - 0x919
{
	int num;
	int num2;
	BOOL flag;
...
void func_26(var uParam0, Ped pedParam1) // Position - 0xADB
{
	BOOL flag;
...
int func_27(var uParam0, var uParam1, int* piParam2) // Position - 0xB1D
{
	Ped EntityIndex;
	int num;
	int num2;
...
BOOL func_28(var uParam0, var uParam1, int* piParam2) // Position - 0xCAE
{
	Ped EntityIndex;
	Player PlayerIndex;
	Player player;
	...
	if (flag3)
	{
		flag4 = func_90(PlayerIndex, &unk, &unk2, &unk5);
...
int func_29(var uParam0, var uParam1, int* piParam2) // Position - 0xDBD
{
	Ped EntityIndex;
	BOOL isEntityDead;
	...
	else if (!PED::_IS_PED_QUEUED_FOR_DELETION(EntityIndex))
		PED::FADE_AND_DESTROY_PED(&EntityIndex);

	return 1;
}

BOOL func_30(int* piParam0, int iParam1) // Position - 0xE14
{
...
void func_31(var uParam0) // Position - 0xE2D
{
	var unk;
...
void func_32(int* piParam0, int iParam1) // Position - 0xE50
{
	if (func_92(*piParam0, iParam1))
		return;
...
int func_33(var uParam0) // Position - 0xE6F
{
	return uParam0->f_11;
}

int func_34(var uParam0, var uParam1, int* piParam2) // Position - 0xE7B
{
	Ped ped;
	BOOL flag;
	int num;
...
int func_35(var uParam0, var uParam1, int* piParam2) // Position - 0xEB9
{
	Ped PedIndex;
	Ped playerPed;
	int num;

	PedIndex = NETWORK::NET_TO_PED(uParam0->f_1);

	if (!func_96(PedIndex, joaat("SCRIPT_TASK_FOLLOW_AND_CONVERSE_WITH_PED")))
	{
		playerPed = PLAYER::GET_PLAYER_PED(uParam0->f_12);
		num = func_98(PedIndex, playerPed);
		return num;
	}

	PED::SET_PED_RESET_FLAG(PedIndex, 229, true);
	return 1;
}

int func_36(var uParam0, var uParam1, int* piParam2) // Position - 0xEFD
{
	Ped ped;
	Ped playerPed;
	BOOL flag;
...
int func_37(var uParam0, var uParam1, int* piParam2) // Position - 0xF8E
{
	Ped ped;
	Ped playerPed;
	int num;
...
int func_38(var uParam0, var uParam1, int* piParam2) // Position - 0xFE6
{
	Ped EntityIndex;
	Ped playerPed;
	...
	{
		if (!func_96(EntityIndex, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD))
		{
			num = func_105(EntityIndex, vector, 6f);
			return num;
		}
	...
	flag = func_106(playerPed, entityCoords, 60f, &ped, &unk5);
	player = PLAYER::PLAYER_ID();
	player2 = player;
	...
	if (flag)
	{
		if (!func_96(EntityIndex, -1927882907))
		{
			num2 = func_101(EntityIndex, ped);
			return num2;
		}
	}
	else
	{
		if (!func_109(entityCoords, &PlayerIndex, &distanceBetweenCoords))
			return 0;
		...
		if (!func_96(EntityIndex, -1927882907))
		{
			num3 = func_101(EntityIndex, playerPed2);
			return num3;
		}
	}
...
int func_39(var uParam0) // Position - 0x1121
{
	return *uParam0;
}

void func_40(int* piParam0) // Position - 0x112C
{
	*piParam0 = 0;
...
void func_41(int* piParam0, int iParam1) // Position - 0x114E
{
...
void func_42(var uParam0) // Position - 0x1262
{
	BOOL flag;
...
void func_43(var uParam0, int iParam1) // Position - 0x12AB
{
	if (*uParam0 == iParam1)
		return;
...
void func_44(var uParam0, var uParam1, int* piParam2) // Position - 0x12C3
{
	int i;
...
void func_45(var uParam0, int* piParam1) // Position - 0x1305
{
	var unk;
...
int func_46(var uParam0) // Position - 0x1345
{
	return uParam0->f_5;
}

void func_47(var uParam0, Ped pedParam1) // Position - 0x1351
{
	BOOL flag;
	int num;
	BOOL flag2;
...
void func_48(int* piParam0) // Position - 0x13DD
{
	Ped PedIndex;

	PedIndex = PLAYER::PLAYER_PED_ID();
	func_112(2, PED::GET_PED_RELATIONSHIP_GROUP_HASH(PedIndex), Global_1147587.f_6);
	return;
}

void func_49(var uParam0, int* piParam1) // Position - 0x13FC
{
	Player player;
	Ped EntityIndex;
	BOOL isEntityDead;
	...
	if (flag2)
		if (!MAP::DOES_BLIP_EXIST(piParam1->f_9))
			piParam1->f_9 = MAP::BLIP_ADD_FOR_ENTITY(-89429847, EntityIndex);
...
void func_50(Player plParam0, Ped pedParam1) // Position - 0x149F
{
	BOOL flag;
...
void func_51(var uParam0, int* piParam1, Player plParam2, Ped pedParam3) // Position - 0x14DE
{
	Player PlayerIndex;
	Ped playerPed;
	BOOL isEntityDead;
...
void func_52(int* piParam0, Player plParam1, int iParam2) // Position - 0x15DE
{
	Player player;
	var String1;
	var String2;
...
void func_53(var uParam0, int* piParam1, Player plParam2, Ped pedParam3) // Position - 0x162A
{
	BOOL flag;
...
void func_54(var uParam0, var uParam1, Ped pedParam2, Player plParam3) // Position - 0x1663
{
	Ped playerPed;
	int num;
	int num2;
...
void func_55(var uParam0, var uParam1) // Position - 0x16EE
{
	int num;
...
void func_56(var uParam0, var uParam1, Ped pedParam2) // Position - 0x1713
{
	Player PlayerIndex;
	Ped playerPed;
	Blip blip;
...
void func_57(var uParam0, var uParam1, Ped pedParam2) // Position - 0x17B0
{
	BOOL flag;
	int i;
	...
	if (UsingActionMode != isPedUsingActionMode)
		PED::SET_PED_USING_ACTION_MODE(pedParam2, UsingActionMode, -1, 0);

	return;
}

BOOL func_58(var uParam0, var uParam1, int* piParam2) // Position - 0x184A
{
	PED::REMOVE_RELATIONSHIP_GROUP(Global_1147587.f_6);
	return true;
}

void func_59(var uParam0, var uParam1, int* piParam2) // Position - 0x185D
{
...
void func_60(var uParam0, int iParam1) // Position - 0x1876
{
...
BOOL func_61(var uParam0, var uParam1, int* piParam2) // Position - 0x1890
{
...
BOOL func_62(var uParam0, var uParam1, int* piParam2) // Position - 0x18AA
{
	Hash modelHash;

	modelHash = func_129(uParam0->f_3);
...
BOOL func_63(var uParam0, var uParam1, int* piParam2) // Position - 0x18D2
{
	Hash modelHash;
...
BOOL func_64(Player plParam0) // Position - 0x1908
{
...
BOOL func_65(int iParam0) // Position - 0x193B
{
...
BOOL func_66(var uParam0, Player plParam1) // Position - 0x196E
{
	Player player;
...
void func_67(int iParam0, int iParam1) // Position - 0x199B
{
	var unk;
...
BOOL func_68(var uParam0, int iParam1) // Position - 0x19C3
{
...
BOOL func_69(var uParam0) // Position - 0x19DD
{
	var unk;
	var unk2;
	var unk5;
...
void func_70(int iParam0) // Position - 0x1A0E
{
	var unk;
...
Vector3 func_71(var uParam0) // Position - 0x1A30
{
	return uParam0->f_3.f_3;
}

int func_72(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x1A40
{
	uParam0->f_6 = { uParam1 };
...
void func_73(var uParam0, int iParam1) // Position - 0x1A5B
{
	if (!func_92(uParam0->f_10, iParam1))
		return;
...
BOOL func_74(var uParam0, var uParam1, int* piParam2) // Position - 0x1A7E
{
	Hash hash;
	ePedType type;
	var unk;
	...
	if (!NETWORK::NETWORK_HAS_ENTITY_BEEN_REGISTERED_WITH_THIS_THREAD(EntityIndex))
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(EntityIndex, true, false);
	...
	NETWORK::SET_NETWORK_ID_VISIBLE_IN_CUTSCENE(uParam0->f_1, true, true, 256);
	NETWORK::NETWORK_ALLOW_ENTITY_FADING_FOR_INSTANCES(EntityIndex, false);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(EntityIndex, Global_1147587.f_6);
	ENTITY::SET_ENTITY_VISIBLE(EntityIndex, false);
	func_135(uParam0, 0);
	func_136(EntityIndex);
	func_123(uParam1, piParam2, uParam0->f_2, EntityIndex);
	return true;
}

BOOL func_75(var uParam0) // Position - 0x1B75
{
	int num;
	int num2;
	Ped EntityIndex;
...
void func_76(var uParam0, int iParam1) // Position - 0x1C12
{
...
BOOL func_77(var uParam0, var uParam1) // Position - 0x1C2C
{
	int num;
...
int func_78(var uParam0, var uParam1, int* piParam2) // Position - 0x1C60
{
	Ped ped;
	BOOL flag;
	Player Plr;
	...
	if (func_137(uParam0->f_2, ped, &Plr))
	{
...
int func_79(var uParam0, var uParam1, int* piParam2) // Position - 0x1D02
{
	Ped EntityIndex;
	int num;
	var entityCoords;
	...
	pedMotionFocusEntity = PED::GET_PED_MOTION_FOCUS_ENTITY(EntityIndex);
...
void func_80(var uParam0) // Position - 0x1DE2
{
	var unk;
...
BOOL func_81(var uParam0) // Position - 0x1E05
{
	int i;
...
int func_82(var uParam0, var uParam1, int* piParam2) // Position - 0x1E42
{
	Ped ped;
	Ped playerPed;
	BOOL flag;
...
int func_83(var uParam0, var uParam1, int* piParam2) // Position - 0x1ED5
{
	Ped EntityIndex;
	Vector3 entityCoords;
	Vector3 vector;
...
int func_84(var uParam0, var uParam1, int* piParam2) // Position - 0x1F1E
{
	int num;
	Ped EntityIndex;
	Vector3 entityCoords;
...
Hash func_85(Player plParam0) // Position - 0x1F7A
{
	if (plParam0 < 0 || plParam0 >= 32)
		return 0;
...
BOOL func_86(Hash hParam0, int iParam1) // Position - 0x1FA2
{
	if (hParam0 == 0)
		return false;
...
BOOL func_87(Player plParam0) // Position - 0x1FBC
{
	BOOL flag;
...
BOOL func_88(Player plParam0) // Position - 0x1FEB
{
	BOOL flag;
...
BOOL func_89(Player plParam0) // Position - 0x201A
{
	if (plParam0 < 0 || plParam0 >= 32)
		return 0;
...
BOOL func_90(Player plParam0, var uParam1, var uParam2, var uParam3) // Position - 0x204D
{
	int scenario;
...
BOOL func_91(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x208C
{
	Player playerIndex;
	int Participant;
	float distanceBetweenCoords;
...
BOOL func_92(int iParam0, int iParam1) // Position - 0x20E4
{
	return MISC::IS_BIT_SET(iParam0, iParam1);
}

var func_93(int iParam0, int iParam1) // Position - 0x20F4
{
	return func_145(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

void func_94(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x2112
{
	Player player;
...
void func_95(int* piParam0, int iParam1) // Position - 0x214C
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

BOOL func_96(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x215C
{
...
int func_97(Player plParam0, Ped pedParam1, BOOL bParam2) // Position - 0x21B5
{
	int scenario;
	var unk;
	var unk4;
...
int func_98(Ped pedParam0, Ped pedParam1) // Position - 0x223C
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0;
...
float func_99(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0x22BC
{
...
int func_100(Ped pedParam0, Player plParam1) // Position - 0x2304
{
	Ped playerPed;
...
int func_101(Ped pedParam0, Ped pedParam1) // Position - 0x2360
{
	Hash mood;
...
int func_102(Ped pedParam0, Player plParam1) // Position - 0x23B0
{
	Ped playerPed;
	Vector3 vector;
	int NavFlags;
	...
	NavFlags = 5242884;
	TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedParam0, vector, 2f, -1, 10f, NavFlags, 1193033728);
	return 1;
}

Vector3 func_103(Player plParam0) // Position - 0x242E
{
	if (plParam0 == 255)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x245E
{
...
int func_105(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4) // Position - 0x2488
{
	int NavFlags;
	...
	NavFlags = 5242884;
	TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedParam0, vParam1, 2f, -1, fParam4, NavFlags, 1193033728);
	return 1;
}

BOOL func_106(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, var uParam5, var uParam6) // Position - 0x24C7
{
	ItemSet itemSet;
...
void func_107(var uParam0, int iParam1) // Position - 0x25B7
{
...
void func_108(var uParam0, int iParam1) // Position - 0x25D9
{
	if (!func_92(uParam0->f_1, iParam1))
		return;
...
BOOL func_109(Vector3 vParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x25FC
{
	Player player;
	float num;
	BOOL flag;
...
void func_110(var uParam0) // Position - 0x2696
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_111(int* piParam0, int iParam1) // Position - 0x26BE
{
	var sName;
	BOOL flag;

	TEXT_LABEL_ASSIGN_STRING(&sName, "relGroupCampDog", 64);
	TEXT_LABEL_APPEND_STRING(&sName, "_", 64);
	TEXT_LABEL_APPEND_INT(&sName, iParam1, 64);
	flag = PED::ADD_RELATIONSHIP_GROUP(&sName, &(Global_1147587.f_6));
	return flag;
}

void func_112(int iParam0, Hash hParam1, Hash hParam2) // Position - 0x26EA
{
...
BOOL func_113(var uParam0, int iParam1) // Position - 0x2706
{
	if (func_92(uParam0->f_1, iParam1))
		return true;
...
void func_114(int iParam0, var uParam1, int* piParam2) // Position - 0x2720
{
	struct<4> data;
...
BOOL func_115(var uParam0) // Position - 0x2754
{
	var unk;
	...
	switch (num4)
	{
		...
		case 1:
			for (i = 0; i < 10; i = i + 1)
			{
				if (!PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(vector2, i, &VecReturnNearestNodeCoors, 1, 1077936128, 0))
				{
					func_154(uParam0, 2);
					return false;
				}
			
				if (!func_155(VecReturnNearestNodeCoors))
				{
				}
				else
				{
					func_153(uParam0, VecReturnNearestNodeCoors);
					func_154(uParam0, 3);
					return false;
				}
			}
		...
		case 2:
			if (func_156(vector2, &(uParam0->f_3), &flag, num, false, 1127481344, 1101004800, -1138501878, -1138501878, 0))
			{
				...
				if (MISC::GET_GROUND_Z_FOR_3D_COORD(vector3, &ReturnZ, true))
					vector3 = { vector3, vector3.f_1, ReturnZ };
...
void func_116(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2A6B
{
	var unk;
...
void func_117(int* piParam0, int iParam1) // Position - 0x2A98
{
	if (!func_92(*piParam0, iParam1))
		return;
...
BOOL func_118(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x2AB8
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		if (!PED::IS_PED_INJURED(pedParam0))
...
float func_119(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x2AFF
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
BOOL func_120(var uParam0, int* piParam1, Player plParam2, var uParam3, var uParam4) // Position - 0x2B56
{
	Player player;
	Player player2;
	Player player3;
...
struct<8> func_121(int* piParam0) // Position - 0x2BF3
{
	return piParam0->f_1;
}

BOOL func_122(Player plParam0, var uParam1) // Position - 0x2C02
{
	if (plParam0 < 0 || plParam0 >= 32)
		return 0;
...
BOOL func_123(var uParam0, int* piParam1, Player plParam2, Ped pedParam3) // Position - 0x2C33
{
	var name;
	BOOL flag;
	BOOL flag2;
...
int func_124(Ped pedParam0) // Position - 0x2CB9
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0;
...
void func_125(Ped pedParam0) // Position - 0x2CF8
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_126(int iParam0) // Position - 0x2D37
{
	if (iParam0 < 0 || iParam0 >= 32)
		return;
...
void func_128(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x2D80
{
	int num;
	int num2;
...
ePedType func_129(Hash hParam0) // Position - 0x2DE0
{
	var unk;
...
BOOL func_130(int* piParam0, int iParam1) // Position - 0x2DFC
{
...
var func_131(int iParam0) // Position - 0x2E16
{
	var value;
...
void func_132(int* piParam0, int iParam1) // Position - 0x2E28
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

BOOL func_133(var uParam0, ePedType eptParam1, var uParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10) // Position - 0x2E38
{
	Ped pedID;
	...
	pedID = func_168(eptParam1, uParam2, fParam5, bParam8, true, bParam6, iParam7, bParam9);
...
int func_134(Hash hParam0) // Position - 0x2ED5
{
	int num;
...
void func_135(var uParam0, int iParam1) // Position - 0x2F1E
{
	if (func_92(uParam0->f_10, iParam1))
		return;
...
void func_136(Ped pedParam0) // Position - 0x2F40
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
BOOL func_137(Player plParam0, Ped pedParam1, var uParam2) // Position - 0x2F87
{
	Vector3 entityCoords;
	var unk3;
	Vector3 vector;
...
int func_138() // Position - 0x3038
{
	return Global_1902569;
}

BOOL func_139(int iParam0) // Position - 0x3044
{
	int num;
	int num2;
	int num3;
...
void func_140(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x3120
{
	int num;
	int num2;
	int num3;
...
BOOL func_141(Player plParam0) // Position - 0x3322
{
	Ped playerPed;
...
BOOL func_142(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3366
{
	int Participant;
	Player playerIndex;
...
BOOL func_143(Player plParam0, var uParam1) // Position - 0x33BD
{
	Vector3 vector;
	int scenario;
...
Vector3 func_144(Player plParam0) // Position - 0x341B
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

var func_145(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x342F
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_182(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
int func_146() // Position - 0x37C2
{
	return Global_1102813.f_3672;
}

void func_147(var uParam0) // Position - 0x37D1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_148(int iParam0, var uParam1, int* piParam2) // Position - 0x37F9
{
	struct<20> data;

	if (!SCRIPTS::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_NETWORK, iParam0, &data, 20))
		return;

	switch (data.f_4)
	{
		case 1:
			func_186(&data, uParam1, piParam2);
			break;
	
		case 3:
			func_187(&data, piParam2);
			break;
	
		case 4:
			func_188(&data, uParam1, piParam2);
			break;
	
		case 5:
			func_189(&data, uParam1);
			break;
	
		case 6:
			func_190(&data, uParam1);
			break;
	}
...
float func_149(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x3876
{
	float num;
	float Y;
	float X;
...
var func_150(BOOL bParam0, var uParam1, var uParam2) // Position - 0x38DB
{
	if (bParam0)
		return uParam1;
...
var func_151(var uParam0) // Position - 0x38F2
{
	return *uParam0;
}

Vector3 func_152() // Position - 0x38FD
{
	return 0f, 0f, 0f;
}

void func_153(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x3908
{
	uParam0->f_3.f_3 = { uParam1 };
	return;
}

void func_154(var uParam0, int iParam1) // Position - 0x391C
{
	*uParam0 = iParam1;
	return;
}

BOOL func_155(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x3929
{
	var ReturnZ;
...
BOOL func_156(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, BOOL bParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x39A7
{
	int num;
...
BOOL func_157(int iParam0, int iParam1) // Position - 0x3ACC
{
	return iParam0 && iParam1 != false;
}

float func_158(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x3ADB
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
const char* func_159(const char* sParam0) // Position - 0x3AF9
{
	return sParam0;
}

void func_160(int* piParam0, int iParam1) // Position - 0x3B03
{
	if (func_92(piParam0->f_10, iParam1))
		return;
...
BOOL func_162(BOOL bParam0) // Position - 0x3B5C
{
	if (func_195())
		return false;
...
void func_163(int iParam0, var uParam1, var uParam2) // Position - 0x3C34
{
	int num;
...
BOOL func_164(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x3C50
{
...
BOOL func_165(int iParam0, int iParam1) // Position - 0x3CF2
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

void func_166(int iParam0, int iParam1) // Position - 0x3D0B
{
	int Variable;
...
BOOL func_167(ePedType eptParam0) // Position - 0x3D2F
{
...
Ped func_168(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, int iParam8, BOOL bParam9) // Position - 0x3D4E
{
	Ped ped;
...
BOOL func_169(Hash hParam0, Hash hParam1) // Position - 0x3D7A
{
...
int func_170(int iParam0) // Position - 0x3DBB
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_171(int iParam0) // Position - 0x3DCD
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_172(int iParam0) // Position - 0x3DDF
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_173(int iParam0) // Position - 0x3DF2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_174(int iParam0) // Position - 0x3E17
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_175(int iParam0) // Position - 0x3E2A
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_176(int iParam0, int iParam1) // Position - 0x3E3D
{
	if (iParam1 < 0)
		iParam1 = 0;
...
BOOL func_177(int iParam0, int iParam1, BOOL bParam2) // Position - 0x3ED7
{
	if (bParam2)
...
float func_178(float fParam0, float fParam1, float fParam2) // Position - 0x3F04
{
	float num;
...
BOOL func_179(Player plParam0, var uParam1) // Position - 0x3F46
{
	Player player;
...
int func_180() // Position - 0x3F73
{
	return Global_1051645.f_12;
}

char* func_181() // Position - 0x3F81
{
	return "unnamed";
}

BOOL func_182(int iParam0) // Position - 0x3F8C
{
	int num;
...
BOOL func_183(int iParam0) // Position - 0x401D
{
...
int func_184(int iParam0) // Position - 0x403B
{
	if (iParam0 == 255)
...
BOOL func_185(Player plParam0) // Position - 0x4086
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
void func_186(var uParam0, var uParam1, int* piParam2) // Position - 0x40CB
{
	Ped EntityIndex;
	BOOL flag;
	...
	EntityIndex = NETWORK::NET_TO_PED(uParam1->f_1);

	if (!ENTITY::DOES_ENTITY_EXIST(EntityIndex))
		return;

	func_211(piParam2, uParam0->f_8);
	flag = MISC::UNREGISTER_INTERACTION_LOCKON_PROMPT(EntityIndex);
	func_117(piParam2, 1);
	func_117(piParam2, 3);
	func_32(piParam2, 2);
	func_32(piParam2, 4);
...
void func_187(var uParam0, int* piParam1) // Position - 0x4129
{
	Player player;
...
void func_188(var uParam0, var uParam1, int* piParam2) // Position - 0x4152
{
	if (uParam0->f_7 != uParam1->f_2)
		return;
...
void func_189(var uParam0, var uParam1) // Position - 0x4190
{
	Player player;
	BOOL flag;
...
void func_190(var uParam0, var uParam1) // Position - 0x41C3
{
	if (uParam0->f_7 != uParam1->f_2)
		return;
...
void func_191(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x41FC
{
	int num;
	int num2;
...
void func_192(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x500A
{
	switch (iParam1)
	{
		case 0:
...
Vector3 func_193(float fParam0, var uParam1, var uParam2) // Position - 0x57CA
{
	float num;
	float num2;
...
BOOL func_194() // Position - 0x5809
{
	return Global_1904402.f_8872 != -1;
}

BOOL func_195() // Position - 0x581A
{
	int currentMessage;
...
BOOL func_196(Any* panParam0, int iParam1, int iParam2) // Position - 0x583A
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

BOOL func_197() // Position - 0x5871
{
	return Global_1072759.f_28644.f_23.f_3 != 0;
}

BOOL func_198() // Position - 0x5886
{
	if (!func_216())
		return false;
...
BOOL func_199() // Position - 0x58A1
{
	return Global_1896762.f_352;
}

BOOL func_200() // Position - 0x58B0
{
	BOOL num;
...
BOOL func_201(int iParam0, int iParam1) // Position - 0x58D7
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_202(int iParam0) // Position - 0x58EF
{
...
BOOL func_203(int iParam0) // Position - 0x5906
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_204(int iParam0) // Position - 0x59D2
{
	return Global_1572864.f_3 && iParam0 != false;
}

Hash func_205(Hash hParam0) // Position - 0x59E5
{
	return hParam0;
}

BOOL func_206(Hash hParam0, Hash hParam1) // Position - 0x59EF
{
...
var func_207(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5A25
{
	if (bParam0)
		return uParam1;
...
BOOL func_208(int iParam0, int iParam1) // Position - 0x5A3C
{
	int num;
...
BOOL func_209(Player plParam0) // Position - 0x5AB0
{
...
void func_210(Player plParam0) // Position - 0x5ACD
{
	Player player;
...
void func_211(int* piParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8) // Position - 0x5B50
{
	piParam0->f_1 = { uParam1 };
	return;
}

void func_212(var uParam0, int iParam1, BOOL bParam2) // Position - 0x5B64
{
	var unk;
...
float func_213(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x5B93
{
	float num;
...
int func_214(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x5BB8
{
	int num;
...
int func_215(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x5C06
{
	return func_223(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

BOOL func_216() // Position - 0x5C1C
{
...
BOOL func_217(Hash hParam0, int iParam1) // Position - 0x5C30
{
	if (hParam0 == 0)
		return false;
...
void func_218(Player plParam0) // Position - 0x5C4A
{
	Player player;
...
void func_219(Player plParam0) // Position - 0x5CB6
{
...
int func_220() // Position - 0x5CF1
{
	return Global_1893611.f_2;
}

BOOL func_221(int iParam0) // Position - 0x5CFF
{
	return iParam0 >= 0 && iParam0 <= 150;
}

int func_222(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x5D15
{
	int num;
	int num2;
	int num3;
...
int func_223(Hash hParam0) // Position - 0x5DCC
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
int func_224(var uParam0, var uParam1, var uParam2) // Position - 0x5E86
{
	int num;
...
int func_225(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6) // Position - 0x5EC1
{
	if (fParam0 < fParam3)
