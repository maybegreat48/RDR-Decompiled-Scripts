...
int func_2() // Position - 0x2B6
{
	return Global_1572887.f_14;
}

BOOL func_3(BOOL bParam0, BOOL bParam1) // Position - 0x2C4
{
	int i;
...
void func_5() // Position - 0x429
{
	func_10(false);
	return;
}

void func_6() // Position - 0x436
{
	int data;
	int i;
	...
	for (i = 0; i < SCRIPTS::GET_NUMBER_OF_EVENTS(4); i = i + 1)
	{
		...
		if (SCRIPTS::GET_EVENT_DATA(4, i, &data, 1))
			func_13(data, eventAtIndex);
	}

	return;
}

BOOL func_7() // Position - 0x475
{
	return Global_26044.f_195;
}

int func_8() // Position - 0x482
{
	return Global_26044;
}

BOOL func_9() // Position - 0x48D
{
	return Global_26044.f_1[0 /*19*/].f_17 != 0;
}

void func_10(BOOL bParam0) // Position - 0x4A1
{
	if (bParam0)
	{
...
void func_11(char* sParam0) // Position - 0x4C5
{
	float num;
	float num2;
...
BOOL func_13(int iParam0, eEventType eetParam1) // Position - 0x65E
{
	int i;
	int num;
...
float func_14(float fParam0, float fParam1, float fParam2) // Position - 0x6E9
{
	return ((1f - fParam2) * fParam0) + (fParam2 * fParam1);
}

void func_15(float fParam0) // Position - 0x6FE
{
...
void func_16(int iParam0) // Position - 0x72B
{
	return;
}

char* func_17(int iParam0) // Position - 0x733
{
	switch (iParam0)
	{
		case -1009774763:
...
char* func_18(int iParam0) // Position - 0x791
{
