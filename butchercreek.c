...
void func_5(int iParam0, var uParam1) // Position - 0x458
{
	if (!func_38(16))
		return;
...
void func_6(int iParam0) // Position - 0x588
{
	return;
}

void func_7() // Position - 0x590
{
...
int func_9(int iParam0) // Position - 0x5C9
{
	if (iParam0 < 0)
		return -1;
	else if (iParam0 <= 10)
...
BOOL func_10(int iParam0) // Position - 0x6C5
{
	return iParam0 > -1 && iParam0 < 17;
}

void func_11(int iParam0, BOOL bParam1) // Position - 0x6DB
{
	Global_1896646[iParam0 /*2*/] = Global_1896646[iParam0 /*2*/] || bParam1;
	return;
}

Hash func_12(int iParam0) // Position - 0x6F6
{
	Hash num;
...
void _DEBUG_PRINT(int iParam0) // Position - 0x86E
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x87A
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x887
{
	int i;
...
BOOL func_17(int iParam0) // Position - 0x8CB
{
	if (func_45() == -1)
		return func_55();
...
void _DEBUG_PRINT_0(int iParam0) // Position - 0x8E6
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x8F2
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x907
{
	return func_56(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x918
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x957
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x963
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x96B
{
	if (func_57(iParam0))
		return true;
...
void func_26() // Position - 0xA23
{
	return;
}

void func_27() // Position - 0xA2B
{
	return;
}

void func_28() // Position - 0xA33
{
	return;
}

void func_29(int iParam0) // Position - 0xA3B
{
	if (func_45() != -1)
		func_61(iParam0);
...
void func_30(int iParam0) // Position - 0xA51
{
	if (func_45() != -1)
		return;
...
void func_33(int iParam0) // Position - 0xA74
{
	func_62(0.775f, 0.2f, 0.025f, 0f);
	return;
}

void func_34() // Position - 0xA90
{
...
void func_35(var uParam0) // Position - 0xAC1
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xB07
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xB25
{
	if (!func_64(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xB3E
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xB4F
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xB67
{
	func_66();
...
void func_41(var uParam0, int iParam1) // Position - 0xB8C
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xCCB
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xCD8
{
...
BOOL func_44(int iParam0) // Position - 0xD0E
{
	if (iParam0 == 0)
	{
		func_81();
...
int func_45() // Position - 0xE22
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xE30
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xE3C
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xEA9
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0xF89
{
	if (!func_64(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0xFA7
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0xFBA
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

void func_53() // Position - 0xFD8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
BOOL func_56(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x153C
{
	int num;
	int num2;
	int num3;
...
BOOL func_57(int iParam0) // Position - 0x1634
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_58(int iParam0) // Position - 0x1645
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_59(int iParam0) // Position - 0x1659
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_60(var uParam0, var uParam1) // Position - 0x166D
{
	return uParam0;
}

void func_61(int iParam0) // Position - 0x1677
{
	int i;
...
void func_62(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x176E
{
...
void func_63(var uParam0, Volume volParam1, int iParam2) // Position - 0x1796
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_64(int iParam0) // Position - 0x17EF
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_65() // Position - 0x1805
{
	int i;
...
BOOL func_67(var uParam0) // Position - 0x18E1
{
	if (func_107())
	{
		if (!*uParam0)
...
void func_68(Hash hParam0, int iParam1) // Position - 0x1911
{
	func_108(hParam0, true, 0, false, false, 0, false, false);
	return;
}

BOOL func_69(int iParam0, int iParam1) // Position - 0x1926
{
	return iParam0 && iParam1 != false;
}

BOOL func_70(var uParam0, int iParam1) // Position - 0x1935
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_71() // Position - 0x1946
{
	return func_69(Global_1940199, 8192);
}

BOOL func_72(var uParam0, int iParam1) // Position - 0x1959
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_73(int iParam0) // Position - 0x196A
{
	if (!func_64(iParam0))
		return false;
...
BOOL func_74(int iParam0, int iParam1) // Position - 0x19AA
{
...
int func_75() // Position - 0x19D7
{
	return Global_1896646.f_41;
}

void func_76(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x19E5
{
	BOOL flag;
...
void func_77(var uParam0, int iParam1) // Position - 0x1C55
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_78(int iParam0, BOOL bParam1) // Position - 0x1C68
{
...
void func_79(BOOL bParam0) // Position - 0x22D1
{
	if (bParam0)
...
BOOL func_80(int iParam0) // Position - 0x22FA
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_81() // Position - 0x233F
{
	return;
}

Hash func_82(int iParam0, BOOL bParam1) // Position - 0x2347
{
	switch (iParam0)
	{
		case 0:
...
void func_83(int iParam0, BOOL bParam1) // Position - 0x2B0C
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_84(BOOL bParam0) // Position - 0x2B5F
{
	if (bParam0)
...
void func_85(int iParam0) // Position - 0x2B88
{
	int i;
...
void func_86(int iParam0) // Position - 0x2C2F
{
	int i;
...
void func_87(int iParam0) // Position - 0x2C60
{
	int i;
...
BOOL func_88(int iParam0, BOOL bParam1) // Position - 0x2C93
{
	int num;
	int num2;
	int num3;
...
BOOL func_89(int iParam0) // Position - 0x2D49
{
	int i;
...
BOOL func_90(int iParam0, BOOL bParam1) // Position - 0x2DC3
{
	if (Global_1572887.f_14 == -1)
...
Ped func_91(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x2DF4
{
	Ped EntityIndex;
	...
	func_138(EntityIndex, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return EntityIndex;
}

void func_92(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2E34
{
...
int func_93(int iParam0) // Position - 0x2E70
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
		...
		if (ENTITY::DOES_ENTITY_HAVE_PHYSICS(uLocal_47[iParam0]))
		{
			...
			switch (uLocal_53[iParam0])
			{
				case joaat("A_C_Rabbit_01"):
					vector3 = { -0.0125f, 0f, -0.025f };
					vector = { 0f, 90f, 0f };
					break;
			
				case joaat("a_c_coyote_01"):
					vector3 = { 0f, -0.005f, -0.025f };
					vector = { 0f, 90f, 0f };
					break;
			}
		
			ENTITY::ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(uLocal_47[iParam0], uLocal_29[iParam0], 4, PED::GET_PED_BONE_INDEX(uLocal_29[iParam0], boneTag), vector2, vector3, vector, -1f, false, true, false, false, 0, true, 1065353216, 1065353216);
...
BOOL func_94(int iParam0) // Position - 0x300F
{
	if (!func_64(iParam0))
		return false;
...
BOOL func_95(int iParam0) // Position - 0x3030
{
	if (!func_64(iParam0))
		return false;
...
BOOL func_96(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3083
{
	BOOL flag;
...
BOOL func_97(int iParam0) // Position - 0x3743
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_98(int iParam0) // Position - 0x375A
{
	switch (iParam0)
	{
		case 64:
...
int func_99(int iParam0, BOOL bParam1) // Position - 0x379D
{
	if (!func_97(iParam0))
		return 0;
...
int func_100(int iParam0) // Position - 0x3888
{
	Hash hash;
	float num;
	var unk;
...
void func_101(int iParam0, int iParam1) // Position - 0x3987
{
...
void func_102(int iParam0) // Position - 0x39B6
{
...
BOOL func_103(int iParam0) // Position - 0x39EF
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_104(int iParam0) // Position - 0x3A05
{
	return iParam0 > -1 && iParam0 < 16;
}

Ped func_105(int iParam0) // Position - 0x3A1B
{
	PersChar persChar;
...
BOOL func_106(Ped pedParam0, int iParam1) // Position - 0x3A49
{
	int num;
...
void func_108(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x3B64
{
...
BOOL func_109(int iParam0) // Position - 0x3BEF
{
...
const char* func_111(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x3C67
{
	const char* StringToTest;
...
BOOL func_112(int iParam0) // Position - 0x46CE
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_113(int iParam0) // Position - 0x46E3
{
	switch (iParam0)
	{
		case 0:
...
int func_114(int iParam0) // Position - 0x479E
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_115(int iParam0) // Position - 0x480C
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_116(int iParam0) // Position - 0x4967
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_117(int iParam0, BOOL bParam1) // Position - 0x49A2
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_118(int iParam0, int iParam1) // Position - 0x49E4
{
	if (!func_112(iParam0))
		return false;
...
int func_119() // Position - 0x4A29
{
	return Global_1902569;
}

int func_120(int iParam0) // Position - 0x4A35
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_121(int iParam0) // Position - 0x4A48
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_122(float fParam0) // Position - 0x4A5A
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_123(var uParam0, int iParam1) // Position - 0x4A70
{
...
int func_124(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4AA6
{
	int duration;
	var data;
	int num;
...
BOOL func_125(int iParam0) // Position - 0x4AE9
{
	if (func_163(iParam0))
		if (!func_164(44))
			return false;
...
void func_126(int iParam0, int iParam1) // Position - 0x4B09
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_127(int iParam0, int iParam1) // Position - 0x4B1A
{
	int num;
...
void func_128(var uParam0, var uParam1, int iParam2) // Position - 0x4B30
{
...
void func_129(int iParam0) // Position - 0x4B4D
{
...
void func_130(int iParam0) // Position - 0x4C2D
{
	int i;
	int num;
...
BOOL func_131(int iParam0, BOOL bParam1) // Position - 0x4E05
{
	if (func_45() != -1)
		return false;
...
int func_132(int iParam0, BOOL bParam1) // Position - 0x4E33
{
	if (!func_97(iParam0))
		return 0;
...
int func_133(int iParam0) // Position - 0x4EB6
{
	switch (iParam0)
	{
		case 27:
...
int func_134(int iParam0) // Position - 0x4EDD
{
	switch (iParam0)
	{
		case 33:
...
void func_137(int iParam0, BOOL bParam1) // Position - 0x5140
{
	BOOL flag;
...
void func_138(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x54EF
{
	BOOL flag;
...
Hash func_139(int iParam0) // Position - 0x55B9
{
	if (!func_97(iParam0))
		return 0;
...
void func_140(int iParam0, PersChar pchParam1) // Position - 0x55D7
{
	if (!func_97(iParam0))
		return;
...
PersChar func_141(int iParam0) // Position - 0x55F8
{
	if (!func_97(iParam0))
		return 0;
...
void func_142(int iParam0, BOOL bParam1) // Position - 0x5618
{
	if (func_45() != -1)
		return;
...
BOOL func_143(int iParam0) // Position - 0x5651
{
	if (!func_97(iParam0))
		return false;
...
BOOL func_144(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x5677
{
	return func_192(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x5697
{
...
int func_146(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x56C1
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

BOOL func_147(int iParam0, int* piParam1, int* piParam2) // Position - 0x56DB
{
	int num;
...
BOOL func_148(int iParam0, int iParam1) // Position - 0x574B
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

BOOL func_149(int iParam0, int iParam1) // Position - 0x5764
{
	return iParam0 && iParam1 != false;
}

Hash func_150(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5773
{
...
BOOL func_151(Hash hParam0) // Position - 0x5817
{
	if (func_195(hParam0))
...
void func_152(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5832
{
	if (func_151(hParam0))
	{
...
void func_153(Hash hParam0, BOOL bParam1) // Position - 0x586A
{
	if (func_151(hParam0))
...
void func_154(Hash hParam0, BOOL bParam1) // Position - 0x5898
{
	if (func_151(hParam0))
...
void func_155(Hash hParam0, BOOL bParam1) // Position - 0x58C6
{
	if (func_151(hParam0))
...
BOOL func_156() // Position - 0x58F4
{
	return true;
}

BOOL func_157() // Position - 0x58FD
{
	return false;
}

BOOL func_158() // Position - 0x5906
{
	var unk;
	var unk3;
...
BOOL func_159(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x596E
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_160(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5AE4
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_161(var uParam0, var uParam1, var uParam2) // Position - 0x5AF8
{
	int i;
...
const char* func_162(int iParam0) // Position - 0x5B26
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_163(int iParam0) // Position - 0x5E0A
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_164(int iParam0) // Position - 0x5E34
{
	if (!func_201(iParam0))
		return false;
...
struct<2> func_165(Player plParam0) // Position - 0x5E50
{
	var gamerHandle;
...
const char* func_166(const char* sParam0, int iParam1) // Position - 0x5E64
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_167(int iParam0, BOOL bParam1) // Position - 0x5E7E
{
	char* StringToTest;
...
void func_168(int iParam0, BOOL bParam1) // Position - 0x5EB2
{
	switch (iParam0)
	{
		case 5:
...
void func_169(int iParam0, int iParam1) // Position - 0x5EE7
{
	func_203(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_170(int iParam0) // Position - 0x5F01
{
	if (!func_97(iParam0))
		return false;
...
void func_171(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5F26
{
	PersChar persChar;
...
void func_172(int iParam0, BOOL bParam1) // Position - 0x6012
{
	if (!func_206(iParam0))
		return;
...
void func_173(int iParam0, int iParam1) // Position - 0x6068
{
	if (!func_211(iParam0))
		return;
...
int func_174(int iParam0) // Position - 0x60DB
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_175(Hash hParam0) // Position - 0x60F1
{
...
void func_176(int iParam0) // Position - 0x6111
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_177(int iParam0, BOOL bParam1) // Position - 0x6127
{
	if (func_45() != -1)
		return;
...
void func_178(int iParam0) // Position - 0x6158
{
	Ped EntityIndex;
...
void func_179(int iParam0) // Position - 0x619C
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_180(int iParam0) // Position - 0x61B1
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_181(int iParam0) // Position - 0x61C6
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_182(int iParam0) // Position - 0x61DB
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_183(int iParam0) // Position - 0x625A
{
...
BOOL func_184(int iParam0, int iParam1) // Position - 0x62B7
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

void func_185(int iParam0, int iParam1) // Position - 0x62D0
{
	func_148(iParam0, iParam1);
	Global_1051832.f_92[iParam0 /*75*/].f_1 = Global_1051832.f_92[iParam0 /*75*/].f_1 - Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1;
	return;
...
int func_186(int iParam0) // Position - 0x630B
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_187(int iParam0) // Position - 0x631F
{
	return;
}

BOOL func_188(int iParam0, int iParam1) // Position - 0x6327
{
	if (iParam0 == -1)
		return false;
...
void func_189(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x634E
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_190(Ped pedParam0, BOOL bParam1) // Position - 0x6393
{
...
void func_191(Ped pedParam0, int iParam1) // Position - 0x63D8
{
	if (iParam1 == 1)
...
BOOL func_192(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x63FF
{
	int num;
...
int func_193() // Position - 0x6487
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

int func_194(int iParam0) // Position - 0x649C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_195(Hash hParam0) // Position - 0x6E84
{
	return hParam0 != 0;
}

BOOL func_196() // Position - 0x6E90
{
	if (Global_1048576)
		return true;
	...
	if (!func_198(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_197() // Position - 0x6EE8
{
	return Global_1051268;
}

BOOL func_198(var uParam0, var uParam1) // Position - 0x6EF6
{
	if (!func_214(uParam0))
		return false;
...
struct<2> func_199() // Position - 0x6F2A
{
...
BOOL func_200(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x6F75
{
	var unk;
	float num;
	float num2;
...
BOOL func_201(int iParam0) // Position - 0x6FA5
{
	if (iParam0 == 0)
		return false;
...
BOOL func_202(int iParam0) // Position - 0x6FB8
{
	int num;
	int num2;
	int offset;
...
void func_203(var uParam0, int iParam1) // Position - 0x6FE2
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_204(int iParam0) // Position - 0x6FF7
{
	if (!func_97(iParam0))
		return false;
...
BOOL func_205(Hash hParam0) // Position - 0x701B
{
	return hParam0 != 0;
}

BOOL func_206(int iParam0) // Position - 0x7027
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_207(int iParam0, BOOL bParam1) // Position - 0x703D
{
	if (!func_206(iParam0))
		return false;
...
void func_208(int iParam0, BOOL bParam1) // Position - 0x7063
{
	if (!func_206(iParam0))
		return;
...
void func_209(int iParam0, BOOL bParam1) // Position - 0x7091
{
	if (!func_206(iParam0))
		return;
...
void func_210(int iParam0) // Position - 0x70CB
{
	func_219(func_218(iParam0));
	return;
}

BOOL func_211(int iParam0) // Position - 0x70DD
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_212() // Position - 0x70F3
{
	return 1;
}

BOOL func_213(BOOL bParam0, BOOL bParam1) // Position - 0x70FC
{
	return bParam0 && bParam1 != false;
}

BOOL func_214(int iParam0) // Position - 0x710B
{
	switch (iParam0)
	{
		case 2:
...
int func_215(int iParam0) // Position - 0x714A
{
	switch (iParam0)
	{
		case 2:
...
void func_216(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x71E0
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_217(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x7C7D
{
	float num;
	float num2;
	float num3;
...
int func_218(int iParam0) // Position - 0x7CE3
{
...
void func_219(int iParam0) // Position - 0x8500
{
