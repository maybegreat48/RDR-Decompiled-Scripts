...
void func_9(int iParam0) // Position - 0x508
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x530
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x558
{
	struct<2> data;
...
void func_13(int iParam0) // Position - 0x5A4
{
...
int func_14() // Position - 0x5E7
{
	return pedLocal_18.f_33;
}

BOOL func_15() // Position - 0x5F3
{
	return pedLocal_18.f_32;
}

void func_16() // Position - 0x5FF
{
	pedLocal_18.f_32 = 0;
	return;
}

void func_17(int iParam0) // Position - 0x60C
{
...
int func_20() // Position - 0x695
{
	return Global_1896646.f_41;
}

void func_21(var uParam0) // Position - 0x6A3
{
	pedLocal_18 = uParam0->f_1;
	return;
}

void func_22(var uParam0) // Position - 0x6B1
{
...
void func_23(var uParam0) // Position - 0x6C9
{
	return;
}

void func_24() // Position - 0x6D1
{
	pedLocal_18.f_32 = 1;
	return;
}
