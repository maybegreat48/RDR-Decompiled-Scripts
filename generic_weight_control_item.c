...
BOOL func_1(BOOL bParam0, BOOL bParam1) // Position - 0x3F
{
	int i;
...
void func_3(var uParam0) // Position - 0x133
{
	...
	switch (iLocal_16)
	{
		...
		case 2:
			...
			{
				iLocal_22 = EVENT::ADD_SHOCKING_EVENT_FOR_ENTITY(joaat("event_shocking_unconscious_ped"), Global_33, -1082130432, -1082130432, -1082130432, -1082130432, -1082130432, 1127481344, false, false, -1, -1);
...
void func_4(BOOL bParam0) // Position - 0x4BB
{
...
BOOL func_7(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5A1
{
...
void func_8(int iParam0) // Position - 0x658
{
	Global_1292128.f_13 = iParam0;
	return;
}

void func_9(int iParam0) // Position - 0x668
{
...
void func_10(var uParam0, BOOL bParam1) // Position - 0x6F5
{
...
void func_11(int iParam0) // Position - 0x715
{
	iLocal_16 = iParam0;
	return;
}

float func_12(var uParam0) // Position - 0x721
{
	if (!func_21(uParam0))
		return uParam0->f_1;
...
char* func_13(int iParam0) // Position - 0x756
{
	switch (iParam0)
	{
		case 0:
...
void func_14(var uParam0, int iParam1) // Position - 0x7C9
{
...
char* func_15(int iParam0) // Position - 0x813
{
	switch (iParam0)
	{
		case 0:
...
void func_16(float fParam0) // Position - 0x899
{
...
void func_17(var uParam0) // Position - 0x8E4
{
	float num;
...
BOOL func_18(Ped pedParam0, int iParam1) // Position - 0xA0D
{
	Hash ReturnWeaponType;

	WEAPON::GET_CURRENT_PED_WEAPON(pedParam0, &ReturnWeaponType, true, iParam1, false);
	return func_29(ReturnWeaponType);
}

void func_19(BOOL bParam0) // Position - 0xA28
{
...
BOOL func_20(Ped pedParam0) // Position - 0xA48
{
...
BOOL func_21(var uParam0) // Position - 0xAA4
{
	return func_30(*uParam0, 1);
}

void func_22(var uParam0) // Position - 0xAB4
{
	func_31(uParam0, 0f);
	return;
}

BOOL func_23(var uParam0) // Position - 0xAC3
{
	return func_30(*uParam0, 2);
}

float func_24() // Position - 0xAD3
{
...
float func_25(int iParam0, int iParam1) // Position - 0xB05
{
	if (iParam1 == 2)
		iParam1 = func_32(1);
...
struct<2> func_26(int iParam0, int iParam1) // Position - 0xB51
{
	int num;
...
void func_27(var uParam0, var uParam1, int iParam2) // Position - 0xB67
{
...
void func_28(float fParam0, int iParam1) // Position - 0xB84
{
	float num;
	int num2;
	int num3;
...
BOOL func_29(Hash hParam0) // Position - 0xBF7
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

BOOL func_30(int iParam0, int iParam1) // Position - 0xC12
{
	return iParam0 && iParam1 != false;
}

void func_31(var uParam0, float fParam1) // Position - 0xC21
{
...
int func_32(int iParam0) // Position - 0xC47
{
	return func_41(func_40(iParam0));
}

int func_33(float fParam0) // Position - 0xC59
{
	float num;
...
float func_34(float fParam0, float fParam1, float fParam2) // Position - 0xC84
{
	if (fParam0 > fParam2)
		return fParam2;
...
int func_35() // Position - 0xCAB
{
	return Global_1902569;
}

void func_36(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0xCB7
{
	int num;
	int i;
	int num2;
...
int func_37(int iParam0, float fParam1, int iParam2) // Position - 0xE3F
{
	if (!func_50(iParam0))
		return 0;
...
void func_38(var uParam0, int iParam1) // Position - 0xE90
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_39(var uParam0, int iParam1) // Position - 0xEA1
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_40(int iParam0) // Position - 0xEB6
{
	return func_52(&(Global_1956875.f_1565), iParam0, 1);
}

int func_41(BOOL bParam0) // Position - 0xECC
{
	if (bParam0)
		return 1;
...
int func_42(int iParam0) // Position - 0xEDE
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_43(int iParam0) // Position - 0xF03
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_44(int iParam0) // Position - 0xF16
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_45(int iParam0) // Position - 0xF29
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_46(int iParam0) // Position - 0xF3C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_47(int iParam0) // Position - 0xF4E
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_48(int iParam0, int iParam1) // Position - 0xF60
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_49(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xFFA
{
...
BOOL func_50(int iParam0) // Position - 0x1032
{
	if (func_60(iParam0))
		return true;
...
void func_51(int iParam0, float fParam1, int iParam2) // Position - 0x1058
{
	if (fParam1 < 0f)
		return;
...
BOOL func_52(Any* panParam0, int iParam1, int iParam2) // Position - 0x10B4
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

var func_53(BOOL bParam0, var uParam1, var uParam2) // Position - 0x10EB
{
	if (bParam0)
		return uParam1;
...
void func_54(int iParam0, int iParam1) // Position - 0x1102
{
	if (iParam1 < 0)
		return;
...
void func_55(int iParam0, int iParam1) // Position - 0x1188
{
...
void func_56(int iParam0, int iParam1) // Position - 0x11C4
{
	int num;
	int num2;
...
void func_57(int iParam0, int iParam1) // Position - 0x1217
{
...
void func_58(int iParam0, int iParam1) // Position - 0x1252
{
...
void func_59(int iParam0, int iParam1) // Position - 0x128B
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_60(int iParam0) // Position - 0x12C3
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_61(int iParam0) // Position - 0x12F2
{
	switch (iParam0)
	{
		case 12:
