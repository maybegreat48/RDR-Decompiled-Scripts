...
struct<2> func_3(int iParam0) // Position - 0x129
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_4(int iParam0, var uParam1) // Position - 0x13D
{
	return iParam0;
}

void func_5(var uParam0) // Position - 0x147
{
...
BOOL func_6(var uParam0) // Position - 0x1B7
{
...
BOOL func_7() // Position - 0x1D1
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x1DA
{
	Hash hash;
	BOOL flag;
	BOOL flag2;
	...
	switch (func_26(uParam0))
	{
		...
		case 8:
			...
			TASK::TASK_PERFORM_SEQUENCE(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), Sequence);
			func_29(uParam0, 9);
			break;
...
int func_9(var uParam0, var uParam1, var uParam2) // Position - 0x8C0
{
	int num;
	int scenario;
...
int func_10(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x8F3
{
	int num;
...
void func_11(var uParam0, int iParam1) // Position - 0x93A
{
...
int func_12(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x95A
{
	int num;
	BOOL flag;
...
void func_13(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x9F5
{
...
void func_14(var uParam0, var uParam1) // Position - 0xA2C
{
	Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_1 = uParam0;
	return;
}

void func_15() // Position - 0xA42
{
...
void func_16(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA71
{
	int num;
...
void func_17(var uParam0) // Position - 0xAC5
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20))
...
void func_18(var uParam0, var uParam1, var uParam2) // Position - 0xAE6
{
...
void func_19(int iParam0, int iParam1, int iParam2) // Position - 0xB08
{
	func_70(&Global_1222327[iParam0 /*251*/][iParam1], iParam2);
	return;
}

void func_20() // Position - 0xB22
{
...
void func_22(var uParam0) // Position - 0xB9C
{
	func_71(uParam0);
...
void func_23(BOOL bParam0) // Position - 0xBB3
{
	if (bParam0)
		func_73(0, 6);
	else
...
void func_24(var uParam0) // Position - 0xBD0
{
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_7))
...
BOOL func_25(var uParam0, int iParam1) // Position - 0xBEB
{
	return func_64(uParam0->f_16, iParam1);
}

int func_26(var uParam0) // Position - 0xBFD
{
	return uParam0->f_2;
}

BOOL func_27(int iParam0) // Position - 0xC09
{
	int i;
	Player Plr;
	float num;
...
BOOL func_28(var uParam0) // Position - 0xD7E
{
	if (!func_25(uParam0, 32))
...
void func_29(var uParam0, int iParam1) // Position - 0xDCE
{
	uParam0->f_2 = iParam1;
	return;
}

BOOL func_30(int iParam0) // Position - 0xDDC
{
	if (iParam0 < 0)
		return false;
...
BOOL func_31(int iParam0, BOOL bParam1) // Position - 0xE1B
{
	int num;
...
int func_32(BOOL bParam0) // Position - 0xE4E
{
...
int func_33(var uParam0) // Position - 0xE81
{
	return uParam0->f_39;
}

void func_34(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0xE8D
{
	if (!func_40(vParam1))
	{
		func_18(vParam1);
...
void func_35(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xF02
{
	BOOL flag;
	BOOL flag2;
	float num;
...
void func_36(int iParam0) // Position - 0x112B
{
...
void func_37(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1229
{
...
void func_38(var uParam0) // Position - 0x1281
{
	uParam0->f_39 = func_87();
	return;
}

void func_39(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x1291
{
	if (!func_88(iParam0))
	{
...
BOOL func_40(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x12C5
{
	return !PERSISTENCE::_PERSISTENCE_IS_SCENARIO_MARKED_AS_LOOTED_AT_COORDS(vParam0);
}

Vector3 func_41(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x12D6
{
	var unk;
	float X;
	float num;
	...
	unk = { func_89(uParam0) };
	X = { func_91(func_91(unk, func_90(iParam3 - 90f)), unk) };
	num = MISC::ATAN2(X.f_1, X);
	num2 = -MISC::ATAN2(X.f_2, BUILTIN::SQRT((X * X) + (X.f_1 * X.f_1)));
	vector = { -X.f_1, X, 0f };
	vector2 = { func_91(vector, X) };
	num3 = MISC::ATAN2(func_92(vector, unk) / BUILTIN::VMAG(vector), func_92(vector2, unk) / BUILTIN::VMAG(vector2)) + 180f;
	return num3, num2, num;
}

void func_42(var uParam0) // Position - 0x138C
{
	int value;
...
int func_43(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x13E6
{
	int i;
...
BOOL func_44(var uParam0, int iParam1) // Position - 0x1496
{
	if (func_75(joaat("kit_collector_spade"), 1))
	{
...
int func_45(char* sParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, Hash hParam15, int iParam16) // Position - 0x157A
{
	int i;
	int num;
	int num2;
...
void func_46(int iParam0, var uParam1) // Position - 0x1658
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
BOOL func_47(int iParam0, BOOL bParam1) // Position - 0x1699
{
	int num;
	int gameTimer;
	float progress;
...
BOOL func_48(int iParam0, int iParam1, int iParam2) // Position - 0x1793
{
	return func_64(Global_1222327[iParam0 /*251*/][iParam1], iParam2);
}

void func_49(Ped pedParam0) // Position - 0x17AD
{
	Entity firstEntityPedIsCarrying;
...
float func_50(int iParam0, BOOL bParam1) // Position - 0x17EF
{
	int num;
...
float func_52(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x1870
{
...
void func_53(float fParam0) // Position - 0x1898
{
	if (!Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_4)
	{
...
int func_54(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x18DC
{
...
float func_55(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x1902
{
	float num;
	float Y;
	float X;
...
BOOL func_57(var uParam0) // Position - 0x198B
{
	var unk;
	int i;
	var unk5;
...
void func_58(int iParam0) // Position - 0x1A37
{
...
void func_59(BOOL bParam0, BOOL bParam1) // Position - 0x1A51
{
	if (bParam1)
...
BOOL func_62(Hash hParam0, int iParam1) // Position - 0x1BAD
{
	if (hParam0 == 0)
		return false;
...
int func_63(int iParam0) // Position - 0x1BC7
{
	switch (iParam0)
	{
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x21EE
{
	return iParam0 && iParam1 != false;
}

void func_65(int iParam0, int iParam1) // Position - 0x21FD
{
	func_101(iParam0, iParam1);
	return;
}

int func_66(int iParam0) // Position - 0x220D
{
	return iParam0;
}

void func_67(int iParam0) // Position - 0x2217
{
	if (!func_102(iParam0))
		return;
...
int func_68(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x22CA
{
	int i;
	var SourceStruct;
...
BOOL func_69(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x2374
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

void func_70(int iParam0, int iParam1) // Position - 0x239D
{
	func_103(iParam0, iParam1);
	return;
}

void func_71(var uParam0) // Position - 0x23AD
{
	if (uParam0->f_4 != -1)
	{
...
void func_72(int iParam0, int iParam1) // Position - 0x23E0
{
	if (func_88(iParam0))
...
void func_73(int iParam0, int iParam1) // Position - 0x23F9
{
...
void func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x243D
{
...
BOOL func_75(Hash hParam0, int iParam1) // Position - 0x24A4
{
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x2527
{
...
BOOL func_77(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2551
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_78() // Position - 0x2650
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_79(var uParam0, int iParam1) // Position - 0x2665
{
	*uParam0 = iParam1;
	return;
}

void func_80(int iParam0) // Position - 0x2672
{
	if (iParam0 <= 0)
		return;
...
void func_81(var uParam0) // Position - 0x2699
{
	func_113(uParam0, 0f);
	return;
}

float func_82(var uParam0) // Position - 0x26A8
{
	if (!func_114(uParam0))
		return uParam0->f_1;
...
BOOL func_84(Ped pedParam0) // Position - 0x2742
{
...
BOOL func_85(int iParam0, BOOL bParam1) // Position - 0x278C
{
	if (bParam1 && !func_30(iParam0))
		return false;
...
void func_86(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x27B1
{
	int num;
...
BOOL func_88(int iParam0) // Position - 0x2851
{
	if (*iParam0 == 0)
		return false;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2) // Position - 0x2869
{
	float num;
	float num2;
...
Vector3 func_90(float fParam0) // Position - 0x28A8
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Vector3 func_91(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x28BE
{
...
float func_92(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x28F7
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

BOOL func_93(Entity eParam0) // Position - 0x2918
{
	int num;
	var InputString;
	Hash entityModel;
...
BOOL func_94(int iParam0, int iParam1) // Position - 0x29B2
{
	if (iParam0 < 0)
		return false;
...
BOOL func_95(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x29D3
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
BOOL func_97(int iParam0, Any anParam1) // Position - 0x2D42
{
	var unk;
...
struct<2> func_98(int iParam0, int iParam1) // Position - 0x2D6B
{
	int num;
...
void func_99(var uParam0, var uParam1, int iParam2) // Position - 0x2D81
{
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x2D9E
{
	var unk;
	var unk13;
	var unk26;
...
void func_101(var uParam0, int iParam1) // Position - 0x2DCE
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_102(int iParam0) // Position - 0x2DDF
{
	return func_94(iParam0, 2);
}

void func_103(int iParam0, int iParam1) // Position - 0x2DEE
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_104(int iParam0, int iParam1) // Position - 0x2E03
{
	return MISC::IS_BIT_SET(Global_1072759.f_22475.f_417[iParam0 /*12*/], iParam1);
}

void func_105() // Position - 0x2E1F
{
	SCRIPTS::_SET_ALL_PLAYER_BITS(&(Global_1072759.f_21353.f_260));
	return;
}

int func_106(Hash hParam0) // Position - 0x2E35
{
	var unk;
...
BOOL func_107(Hash hParam0, int iParam1) // Position - 0x2E60
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_108(Hash hParam0) // Position - 0x2F07
{
	int num;
	int num2;
	int num3;
...
int func_109(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2FC3
{
...
BOOL func_110(BOOL bParam0) // Position - 0x3085
{
	if (bParam0)
...
BOOL func_111() // Position - 0x30B5
{
	return func_144() != -1;
}

BOOL func_112() // Position - 0x30C3
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_113(var uParam0, float fParam1) // Position - 0x30E8
{
...
BOOL func_114(var uParam0) // Position - 0x310E
{
	return func_147(*uParam0, 1);
}

BOOL func_115(var uParam0) // Position - 0x311E
{
	return func_147(*uParam0, 2);
}

float func_116() // Position - 0x312E
{
...
BOOL func_117(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x3160
{
...
BOOL func_118(Ped pedParam0) // Position - 0x3189
{
	return func_148(pedParam0, 0);
}

BOOL func_119(Ped pedParam0) // Position - 0x3198
{
	return func_148(pedParam0, 3);
}

BOOL func_120(Ped pedParam0) // Position - 0x31A7
{
	return func_148(pedParam0, 4) || func_148(pedParam0, 5);
}

BOOL func_121(Ped pedParam0) // Position - 0x31C3
{
	return func_148(pedParam0, 6);
}

BOOL func_122(Ped pedParam0) // Position - 0x31D2
{
	return func_148(pedParam0, 7);
}

void func_123(int iParam0, int iParam1) // Position - 0x31E1
{
	if (iParam0 < 0)
		return;
...
void func_124(int iParam0, BOOL bParam1) // Position - 0x3214
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_125(int iParam0, BOOL bParam1) // Position - 0x326C
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_126(int iParam0, int iParam1) // Position - 0x3295
{
	if (iParam0 < 0)
		return;
...
int func_127() // Position - 0x32BD
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

void func_128(var uParam0, int iParam1) // Position - 0x32D2
{
	BOOL flag;
	int i;
...
BOOL func_129(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x33FE
{
	var unk;
	int num;
...
int func_130(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x346D
{
	BOOL flag;
	int num;
	var unk;
...
Hash func_131(Hash hParam0, int iParam1) // Position - 0x354E
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_132(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x35C8
{
...
BOOL func_133(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x35EF
{
	if (iParam2 < 0)
		return false;
...
BOOL func_134(Hash hParam0) // Position - 0x362A
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_135(int iParam0) // Position - 0x3645
{
	if (iParam0 < 0)
		return 0;
...
int func_136(Hash hParam0) // Position - 0x3666
{
	var unk;
...
int func_137(Hash hParam0) // Position - 0x3691
{
	switch (hParam0)
	{
...
int func_138(var uParam0, int iParam1) // Position - 0x3774
{
	int i;
...
int func_139(Hash hParam0) // Position - 0x37B1
{
	int num;
...
int func_140(Hash hParam0, BOOL bParam1) // Position - 0x381E
{
	var unk;
	int num;
	int num2;
...
int func_141(Hash hParam0, int iParam1) // Position - 0x387D
{
	if (iParam1 == 0)
		return 0;
...
int func_142(BOOL bParam0) // Position - 0x38A9
{
	if (func_2() == -1)
	{
...
struct<4> func_143(Hash hParam0, BOOL bParam1) // Position - 0x38EA
{
	var unk;
...
int func_144() // Position - 0x390F
{
	return Global_1149172.f_137;
}

void func_145(var uParam0, int iParam1) // Position - 0x391D
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_146(var uParam0, int iParam1) // Position - 0x392E
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_147(int iParam0, int iParam1) // Position - 0x3943
{
	return iParam0 && iParam1 != false;
}

BOOL func_148(Ped pedParam0, int iParam1) // Position - 0x3952
{
	var unk;
	int num;
...
void func_149(var uParam0) // Position - 0x3991
{
...
void func_150(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x39C9
{
	int i;
	var unk;
...
void func_151(int iParam0, int iParam1) // Position - 0x3A7F
{
	if (iParam1 == 0)
		return;
...
void func_152(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x3AAF
{
	int i;
	var unk;
...
BOOL func_153(Hash hParam0, Hash hParam1) // Position - 0x3B6A
{
	if (!func_62(hParam0, 0))
...
void func_154(Hash hParam0, var uParam1, var uParam2) // Position - 0x3BAB
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_155(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3DB7
{
	Hash hash;
...
struct<4> func_156(BOOL bParam0) // Position - 0x3E95
{
	int num;
...
void func_157(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x3F36
{
...
BOOL func_158(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x3F51
{
...
Hash func_159(Hash hParam0) // Position - 0x3F76
{
	return hParam0;
}

BOOL func_160(Hash hParam0, int iParam1) // Position - 0x3F80
{
	if (hParam0 == 0)
		return false;
...
struct<5> func_161(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x3F9A
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_162(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x430E
{
	var outGuid;
...
int func_163() // Position - 0x433F
{
	return Global_1953292.f_1;
}

BOOL func_164(Any anParam0) // Position - 0x434D
{
...
BOOL func_165(Hash hParam0, Hash hParam1) // Position - 0x4393
{
...
struct<4> func_166(BOOL bParam0) // Position - 0x43C9
{
	int num;
...
int func_167(Hash hParam0, BOOL bParam1) // Position - 0x4469
{
...
BOOL func_168(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x44A0
{
	return func_175(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_169(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x44BB
{
	var unk;
...
struct<4> func_170(BOOL bParam0) // Position - 0x44DC
{
	int num;
...
BOOL func_171(Hash hParam0, int iParam1) // Position - 0x4546
{
	Hash hash;
	int num;
	int i;
...
BOOL func_172(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x45B3
{
	return func_178(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

struct<4> func_173() // Position - 0x45C9
{
	var unk;
...
int func_175(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x45F2
{
...
BOOL func_176(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x4671
{
	int inventoryId;
...
BOOL func_177(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x46B6
{
...
BOOL func_178(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x46E9
{
...
int func_179(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4723
{
...
BOOL func_180(Hash hParam0) // Position - 0x4756
{
