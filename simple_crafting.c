...
BOOL func_1(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2BF
{
...
BOOL func_2() // Position - 0x435
{
	return Global_1913634.f_1578;
}

BOOL func_3(BOOL bParam0) // Position - 0x444
{
	if (bParam0)
...
BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x474
{
	int i;
...
void func_5(var uParam0, int iParam1) // Position - 0x554
{
	func_19(uParam0, iParam1);
	return;
}

void func_6(var uParam0, int iParam1) // Position - 0x564
{
	func_20(uParam0, iParam1);
	return;
}

BOOL func_7() // Position - 0x574
{
...
void func_8(var uParam0, int iParam1) // Position - 0x68A
{
...
BOOL func_9(Ped pedParam0) // Position - 0x6A7
{
...
BOOL func_10(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x6C4
{
...
int func_11(int iParam0) // Position - 0x71D
{
	...
	if (WEAPON::GET_CURRENT_PED_WEAPON(Global_33, &ReturnWeaponType, true, iParam0, false))
		if (func_25(ReturnWeaponType, 0))
			if (WEAPON::_IS_WEAPON_TWO_HANDED(ReturnWeaponType) || func_26(ReturnWeaponType))
				return 1;

	return 0;
}

void func_12(var uParam0, int iParam1) // Position - 0x75C
{
	var unk;
	Hash hash;
	int eventData;
						...
						if (uParam0->f_70 == joaat("s_cft_arrow_smallgame") && ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, -1011038463) || uParam0->f_70 != joaat("s_cft_arrow_smallgame") && ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 2024314131))
						{
							...
							if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_66))
							{
								if (func_76(uParam0->f_62, -1588156645) && num != -842117252)
								{
									...
									if (num == -1610298873)
										ANIMSCENE::SET_ANIM_SCENE_ENTITY(func_78(uParam0, num), "DYNAMITE" /*DYNAMITE*/, uParam0->f_66, 0);
								}
								else
								{
...
int func_13(var uParam0) // Position - 0x20C1
{
	return uParam0->f_11;
}

void func_14(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x20CD
{
	func_30(uParam0);
...
struct<2> func_16(int iParam0) // Position - 0x231F
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_17(var uParam0, var uParam1) // Position - 0x2333
{
	if (!func_110(uParam0))
		return false;
...
int func_18(var uParam0, var uParam1) // Position - 0x2367
{
	return uParam0;
}

void func_19(var uParam0, int iParam1) // Position - 0x2371
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_20(var uParam0, int iParam1) // Position - 0x2382
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_21() // Position - 0x2397
{
	return ANIMSCENE::DOES_ANIM_SCENE_EXIST(Global_26573) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(Global_26573, false);
}

BOOL func_22() // Position - 0x23B3
{
...
void func_24(var uParam0) // Position - 0x2425
{
	func_5(uParam0, 1);
	return;
}

BOOL func_25(Hash hParam0, int iParam1) // Position - 0x2434
{
	if (hParam0 == 0)
		return false;
...
BOOL func_26(Hash hParam0) // Position - 0x244E
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

int func_27() // Position - 0x245C
{
	return Global_1572887.f_14;
}

BOOL func_28() // Position - 0x246A
{
	return Global_1896762.f_352;
}

BOOL func_29(int iParam0, BOOL bParam1) // Position - 0x2479
{
...
void func_30(var uParam0) // Position - 0x249E
{
	int i;
...
BOOL func_31(var uParam0, int iParam1) // Position - 0x24C9
{
	return func_113(*uParam0, iParam1);
}

BOOL func_32(var uParam0) // Position - 0x24DA
{
	return func_31(uParam0, 1);
}

void func_33(var uParam0) // Position - 0x24E9
{
	TEXT_LABEL_ASSIGN_STRING(&(uParam0->f_21), "CAMP", 8);
	return;
}

void func_34(var uParam0) // Position - 0x24FA
{
	if (HUD::_DOES_TEXT_BLOCK_EXIST(&(uParam0->f_21)))
...
void func_35(var uParam0) // Position - 0x2611
{
	func_6(uParam0, 1);
	return;
}

BOOL func_36(var uParam0) // Position - 0x2620
{
...
void func_38(BOOL bParam0) // Position - 0x285F
{
	if (bParam0)
	{
	}
...
BOOL func_39(int iParam0, BOOL bParam1) // Position - 0x2886
{
	int num;
...
void func_40(var uParam0) // Position - 0x28B9
{
	func_38(true);
	func_8(uParam0, 4);
	return;
...
BOOL func_41(var uParam0) // Position - 0x28CD
{
	Player gangLeader;
...
BOOL func_42(var uParam0) // Position - 0x2A02
{
	int i;
	var unk;
...
BOOL func_43(var uParam0) // Position - 0x2BF6
{
	Hash i;
	int num;
	BOOL flag;
...
void func_44(var uParam0) // Position - 0x2C74
{
...
BOOL func_45(var uParam0, BOOL bParam1) // Position - 0x2CB6
{
	Hash i;
	int num;
	BOOL flag;
...
BOOL func_46(var uParam0, BOOL bParam1) // Position - 0x2DAB
{
	int num;
...
BOOL func_47(var uParam0) // Position - 0x2E04
{
	int i;
	int num;
	BOOL flag;
...
void func_48(BOOL bParam0) // Position - 0x2E65
{
	Ped EntityIndex;
	...
	EntityIndex = func_127(Global_33);
...
void func_49(var uParam0) // Position - 0x2F47
{
	int num;
...
BOOL func_50(var uParam0) // Position - 0x31D9
{
	Player gangLeader;
...
BOOL func_51(var uParam0) // Position - 0x323A
{
...
void func_52(var uParam0) // Position - 0x328F
{
	int i;
...
void func_53(var uParam0, Hash hParam1, Hash hParam2) // Position - 0x32F0
{
	var unk;
	var unk2;
	BOOL flag;
...
void func_54(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x35C5
{
	int num;
...
BOOL func_55(int iParam0, BOOL bParam1) // Position - 0x3619
{
	int num;
...
void func_56(var uParam0, BOOL bParam1) // Position - 0x364C
{
	if (bParam1)
	{
...
void func_57(char* sParam0, char* sParam1, BOOL bParam2) // Position - 0x368F
{
	int soundId;
...
void func_58(var uParam0) // Position - 0x36CE
{
	int num;
	var unk;
	int num2;
...
void func_59(var uParam0) // Position - 0x382E
{
	int num;
	AnimScene animScene;
...
BOOL func_60(int iParam0, int iParam1, BOOL bParam2) // Position - 0x3AF3
{
	int num;
...
void func_61(var uParam0, BOOL bParam1) // Position - 0x3B28
{
	int num;
	int num2;
	BOOL flag;
...
void func_62(var uParam0, BOOL bParam1) // Position - 0x3E8D
{
	int num;
...
void func_63(var uParam0) // Position - 0x3FC6
{
	if (func_31(uParam0, 2))
		return;
...
void func_64(var uParam0, var uParam1) // Position - 0x4026
{
	func_52(uParam0);
	func_159(uParam0);
...
int func_65(Hash hParam0, int iParam1) // Position - 0x4044
{
	var unk;
	int num;
	int i;
...
void func_66(var uParam0) // Position - 0x408E
{
	int num;
	Hash ModelIndex;
	Hash ModelIndex2;
	...
	if (num == 414472632)
	{
		...
		{
			ModelIndex = func_162(uParam0->f_62);
	...
	else if (num == -715814988)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_64))
		{
			ModelIndex2 = func_162(uParam0->f_62);
...
void func_67(var uParam0, BOOL bParam1, var uParam2) // Position - 0x44F2
{
	int i;
	int j;
...
BOOL func_68(int iParam0) // Position - 0x4563
{
	if (iParam0 < 0)
		return false;
...
void func_69(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x45A2
{
	int num;
...
BOOL func_70(int iParam0) // Position - 0x45F6
{
...
int func_71(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, Hash hParam10, int iParam11) // Position - 0x467E
{
	int i;
	int num;
...
void func_72(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4707
{
	int num;
...
void func_73(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4752
{
	int num;
...
void func_74(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x479D
{
	int num;
...
BOOL func_75(int iParam0, BOOL bParam1) // Position - 0x47C9
{
	int num;
...
BOOL func_76(Hash hParam0, Hash hParam1) // Position - 0x47FC
{
...
Hash func_77(Hash hParam0, BOOL bParam1) // Position - 0x483D
{
	Hash hash;
...
AnimScene func_78(var uParam0, int iParam1) // Position - 0x4A33
{
	switch (iParam1)
	{
		case -1610298873:
...
int func_79(Object* pobParam0, var uParam1) // Position - 0x4AB9
{
...
BOOL func_80(BOOL bParam0) // Position - 0x4AF1
{
	if (func_27() == -1)
		return true;
...
BOOL func_82() // Position - 0x4B2B
{
	...
	if (!PED::IS_PED_INJURED(PedIndex))
		if (func_174(Global_33, PedIndex, true) < 400f)
			num = 1;

	return num;
}

int func_83(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, Any anParam4) // Position - 0x4B5C
{
	TELEMETRY::_TELEMETRY_CRAFT_ITEM(hParam0, hParam1, anParam4, 1);
	return func_175(hParam0, hParam1, bParam2, bParam3);
}

void func_84(ePedType eptParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x4B7B
{
	Hash TypeOfWeapon;
	...
	if (bParam3)
	{
		if (func_27() == -1)
		{
			...
			{
				TypeOfWeapon = func_177(func_77(eptParam0, false), false);
			
				if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
					func_178(TypeOfWeapon);
			}
		}
...
BOOL func_85(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4C4C
{
	var unk;
	var unk2;
	var unk3;
...
BOOL func_86(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x4C68
{
	var unk;
...
int func_87(Hash hParam0, Hash hParam1, int iParam2, Any anParam3) // Position - 0x4C8B
{
	var unk;
	var unk3;
	int num;
...
struct<2> func_88(int iParam0, Hash hParam1) // Position - 0x4E2B
{
	int num;
...
void func_89(var uParam0, var uParam1, int iParam2) // Position - 0x4E41
{
...
void func_90(var uParam0, int iParam1, BOOL bParam2) // Position - 0x4E5E
{
	AnimScene animScene;
...
BOOL func_91(var uParam0, float fParam1) // Position - 0x4F5E
{
	if (!func_96(uParam0))
		return false;
...
BOOL func_92(int iParam0) // Position - 0x4F85
{
	int num;
...
void func_93(var uParam0) // Position - 0x4FAB
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_94(int iParam0, BOOL bParam1) // Position - 0x4FC1
{
	int num;
	int gameTimer;
	float progress;
...
BOOL func_95(int iParam0, BOOL bParam1) // Position - 0x50BB
{
	int num;
...
BOOL func_96(var uParam0) // Position - 0x5112
{
	return func_198(*uParam0, 1);
}

void func_97(var uParam0) // Position - 0x5122
{
	func_199(uParam0, 0f);
	return;
}

void func_98(int iParam0, char* sParam1, BOOL bParam2) // Position - 0x5131
{
	int num;
...
Player func_99() // Position - 0x517A
{
	Player gangLeader;
...
BOOL func_100(BOOL bParam0) // Position - 0x51AC
{
	if (bParam0)
...
int func_101(int iParam0) // Position - 0x5224
{
	int i;
...
void func_102(BOOL bParam0) // Position - 0x5270
{
	var unk;
	int num;
...
void func_103(var uParam0) // Position - 0x52A3
{
	Player gangLeader;
...
void func_104(Hash hParam0, int iParam1) // Position - 0x52EC
{
	var statId;
...
void func_105(var uParam0) // Position - 0x5332
{
	var requestId;
	var unk4;
	int num;
...
BOOL func_106(int iParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x53B4
{
	var unk;
	var unk13;
	var unk26;
...
void func_107(int iParam0) // Position - 0x53E4
{
...
void func_108(var uParam0) // Position - 0x5406
{
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_49))
...
void func_109(Hash hParam0, int iParam1) // Position - 0x54E9
{
	int i;
...
BOOL func_110(int iParam0) // Position - 0x5528
{
	switch (iParam0)
	{
		case 2:
...
int func_111(int iParam0) // Position - 0x5567
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_112(int iParam0, int iParam1) // Position - 0x55FD
{
	if (iParam0 < 0)
		return false;
...
BOOL func_113(int iParam0, int iParam1) // Position - 0x561E
{
	return iParam0 && iParam1 != false;
}

void func_114(var uParam0) // Position - 0x562D
{
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_49))
	{
		if (PED::IS_PED_MALE(Global_33))
...
BOOL func_115(const char* sParam0) // Position - 0x58A2
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
}

BOOL func_116(var uParam0, var uParam1) // Position - 0x58B1
{
...
int func_117(int iParam0) // Position - 0x58FB
{
	return iParam0;
}

int func_118(Player plParam0) // Position - 0x5905
{
...
Hash func_119(Player plParam0) // Position - 0x592F
{
	if (plParam0 < 0 || plParam0 >= 32)
		return 0;
...
void func_120(var uParam0, Hash hParam1, int iParam2) // Position - 0x595B
{
...
int func_121(var uParam0, int iParam1) // Position - 0x59F9
{
	var unk;
	int num;
	int num2;
...
Hash func_122(int iParam0) // Position - 0x5AD7
{
	switch (iParam0)
	{
		case 0:
...
var func_123(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5B3C
{
	if (bParam0)
		return uParam1;
...
void func_124(var uParam0, const char* sParam1, var uParam2) // Position - 0x5B53
{
...
void func_125(var uParam0, BOOL bParam1, Hash hParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5BBC
{
	Hash hash;
...
void func_126(var uParam0, int iParam1, BOOL bParam2, Hash hParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x5CB6
{
	Hash entryId;
	Hash hash;
	Hash hash2;
...
Ped func_127(Ped pedParam0) // Position - 0x6268
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
void func_128(var uParam0, BOOL bParam1) // Position - 0x6284
{
...
void func_129(var uParam0, var uParam1) // Position - 0x62B3
{
	Hash hash;
	Any any;
	Hash hash2;
...
BOOL func_130(Hash hParam0) // Position - 0x652B
{
...
char* func_131(var uParam0) // Position - 0x6557
{
	if (func_31(uParam0, 128))
		return "CAMP_REC_ALL";
...
int func_132(char* sParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x6578
{
	int i;
	int num;
...
void func_133(int iParam0, Hash hParam1) // Position - 0x6606
{
	int num;
...
BOOL func_134(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x6648
{
	var unk;
	int num;
	int i;
...
BOOL func_135(Hash hParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x670D
{
	var unk;
...
BOOL func_136(Hash hParam0) // Position - 0x67B8
{
	int num;
	int num2;
...
BOOL func_137(int iParam0) // Position - 0x67D7
{
	return func_230(Global_1940085.f_38, iParam0);
}

int func_138(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x67EB
{
...
int func_139(Hash hParam0, BOOL bParam1) // Position - 0x68AD
{
	var unk;
...
int func_140(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x68CC
{
	var unk;
	int num;
	int i;
...
int func_141(int iParam0, int iParam1) // Position - 0x6A23
{
	if (iParam0 > iParam1)
		return iParam1;
...
BOOL func_142(var uParam0, Hash hParam1) // Position - 0x6A39
{
	if (!func_31(uParam0, 4))
		return false;
...
BOOL func_143(Hash hParam0, Hash hParam1, var uParam2, Entity eParam3, BOOL bParam4) // Position - 0x6A67
{
	var unk;
	Hash hash;
	int num;
...
void func_144(var uParam0) // Position - 0x6FE2
{
	if (func_31(uParam0, 2))
	{
		if (!func_76(uParam0->f_62, -2011345500))
...
void func_145(int iParam0, int iParam1) // Position - 0x709A
{
	if (iParam0 < 0)
		return;
...
void func_146(int iParam0, BOOL bParam1) // Position - 0x70CD
{
...
void func_147(int iParam0, BOOL bParam1) // Position - 0x7125
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_148(int iParam0, int iParam1) // Position - 0x714E
{
	if (iParam0 < 0)
		return;
...
BOOL func_149(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x7176
{
	int i;
...
BOOL func_150(Hash hParam0, int iParam1) // Position - 0x7206
{
	int num;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_151(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x7289
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
int func_152(Hash hParam0) // Position - 0x737F
{
	var unk;
...
void func_153(var uParam0, char* sParam1) // Position - 0x739B
{
	int num;
...
struct<10> func_154(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x73D7
{
	int num;
...
BOOL func_155(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x74AB
{
...
Hash func_156(int iParam0, int iParam1) // Position - 0x74CC
{
	int num;
...
int func_157(int iParam0) // Position - 0x750F
{
	if (iParam0 < 0)
		return 0;
...
Hash func_158(Hash hParam0) // Position - 0x7530
{
	var unk;
...
void func_159(var uParam0) // Position - 0x755B
{
...
void func_160(var uParam0) // Position - 0x757D
{
...
void func_161(var uParam0) // Position - 0x762B
{
	Any any;
...
Hash func_162(Hash hParam0) // Position - 0x765B
{
...
Vector3 func_163(Hash hParam0) // Position - 0x76CD
{
	Hash weaponTypeFromAmmoType;
...
char* func_164(var uParam0) // Position - 0x7743
{
	if (PED::IS_PED_MALE(Global_33))
...
char* func_165(var uParam0) // Position - 0x7761
{
	return "craft_trans_stow";
}

void func_166(int iParam0) // Position - 0x776D
{
	if (!func_249(iParam0))
		return;
...
Hash func_168(Hash hParam0) // Position - 0x7B3A
{
	return hParam0;
}

int func_169(Hash hParam0, Hash hParam1) // Position - 0x7B44
{
...
BOOL func_170(Hash hParam0) // Position - 0x7B7A
{
	Hash weaponUnlock;
...
BOOL func_171(Hash hParam0) // Position - 0x7BA2
{
	Hash weaponUnlock;
...
int func_172(BOOL bParam0) // Position - 0x7BCA
{
	if (func_27() == -1)
	{
...
Ped func_173(int iParam0) // Position - 0x7C0B
{
...
float func_174(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x7C37
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
int func_175(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7C8E
{
	int num;
	var unk;
	Hash hash;
...
struct<2> func_176(int iParam0) // Position - 0x7F34
{
	var unk;
...
Hash func_177(Hash hParam0, BOOL bParam1) // Position - 0x7F46
{
	if (!func_25(hParam0, 0))
		return 0;
...
void func_178(Hash hParam0) // Position - 0x7F72
{
	Hash weaponUnlock;
...
int func_179(Hash hParam0) // Position - 0x7FAC
{
	var unk;
...
BOOL func_180(Hash hParam0, BOOL bParam1) // Position - 0x7FD7
{
	var unk;
	var unk6;
	var unk10;
...
void func_181(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x805B
{
	BOOL flag;
	int value;
	var unk;
	...
	else if (!func_221(hParam0, &InputString, num2, hash, 0, joaat("ui_itemviewer")))
	{
	...
	str3 = func_284(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash2), value), num4);

	if (iParam1 == 1)
		str3 = MISC::VAR_STRING(0, hash2);
	...
	if (num3 == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || num3 == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || num3 == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || num3 == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str3 = MISC::VAR_STRING(0, func_285(hParam0, -442898163));
	...
	if (num3 == -126813555 || num3 == 1946043663)
	{
		...
		if (func_286(hParam0, &unk7))
			str3 = func_288(func_287(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_289(str3, InputString.f_1, MISC::GET_HASH_KEY(InputString), num5, num4, str2, str, 0, true);
	return;
}

int func_182(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, Hash hParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x8536
{
	int value;
	Hash TypeOfWeapon;
	Hash lootTableKey;
	...
	if (!flag)
	{
		if (func_76(hParam0, -1588156645))
		{
			bParam2 = true;
			flag2 = true;
			TypeOfWeapon = func_177(func_77(hParam0, true), false);
			...
			if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
			{
				...
				if (func_80(false) && func_296(TypeOfWeapon, 0, false, true, 0, false, hParam5, false))
				{
...
int func_183(Hash hParam0, int iParam1, int iParam2) // Position - 0x8FEA
{
	var unk;
	var unk6;
...
struct<5> func_184(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x9030
{
	var unk;
	int num;
	var unk6;
...
BOOL func_185(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x93A4
{
	var unk;
	var unk5;
	int num;
...
BOOL func_186(Hash hParam0) // Position - 0x94D8
{
	return func_333(hParam0) && func_76(hParam0, 1584357097);
}

int func_187(Hash hParam0) // Position - 0x94F6
{
	if (!func_186(hParam0))
		return 0;
...
BOOL func_188(int iParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x99AC
{
	var unk;
	int num;
	int i;
...
int func_189(Hash hParam0) // Position - 0x9AB3
{
	var unk;
...
int func_190(Hash hParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4, Hash hParam5) // Position - 0x9ADE
{
	int cashBalance;
	int goldBarBalance;
	var unk;
...
BOOL func_191(int* piParam0, int iParam1, Any* panParam2, BOOL bParam3, Hash hParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x9CCE
{
	Hash hash;
...
BOOL func_192(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, int iParam7, var uParam8, BOOL bParam9, Hash hParam10, int iParam11, BOOL bParam12) // Position - 0x9D55
{
	var unk;
...
int func_193(int iParam0, Hash hParam1) // Position - 0x9DD2
{
	Hash data;
...
int func_194(Hash hParam0, Hash hParam1) // Position - 0x9E2F
{
	var unk;
...
void func_195(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x9E88
{
	int i;
...
void func_196(int iParam0, BOOL bParam1) // Position - 0x9F06
{
	int num;
...
float func_197(var uParam0) // Position - 0x9F38
{
	if (!func_96(uParam0))
		return uParam0->f_1;
...
BOOL func_198(int iParam0, int iParam1) // Position - 0x9F6D
{
	return iParam0 && iParam1 != false;
}

void func_199(var uParam0, float fParam1) // Position - 0x9F7C
{
...
var func_200(Player plParam0) // Position - 0x9FA2
{
	var value;
...
void func_201(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x9FB4
{
...
void func_202(Player plParam0, BOOL bParam1) // Position - 0x9FFC
{
	Player gangLeader;
...
void func_203(Player plParam0, var uParam1) // Position - 0xA06F
{
	var outTime;
	var timeToAdd;
...
int func_204(Any anParam0) // Position - 0xA0D1
{
...
void func_205(int iParam0, var uParam1) // Position - 0xA109
{
	var unk;
...
void func_206(var uParam0) // Position - 0xA12E
{
	var unk;
...
struct<2> func_207(Hash hParam0) // Position - 0xA156
{
	return func_88(joaat("MADE"), hParam0);
}

struct<2> func_208(Hash hParam0) // Position - 0xA169
{
	var unk;
...
Vector3 func_209(Player plParam0) // Position - 0xA22C
{
	if (plParam0 == 255)
...
BOOL func_210(int iParam0, Any anParam1, int iParam2, var uParam3, BOOL bParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0xA258
{
	BOOL flag;
	int num;
	var unk;
...
int func_211(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA339
{
	if (func_357(255))
		return 1;
...
BOOL func_212(Hash hParam0, int iParam1) // Position - 0xA387
{
	int num;
...
int func_213(int iParam0) // Position - 0xA4CD
{
	int num;
	int num2;
...
void func_214(var uParam0, Hash hParam1, Hash hParam2) // Position - 0xA52A
{
	int acquireCostsCount;
	Hash hash;
	int i;
...
void func_215(var uParam0, Hash hParam1) // Position - 0xA5E6
{
	int num;
	int num2;
	int num3;
...
void func_216(var uParam0, Hash hParam1, int iParam2) // Position - 0xA69D
{
	int num;
	int num2;
	int num3;
...
void func_217(var uParam0) // Position - 0xA735
{
	func_157(*uParam0);
	*uParam0 = -1;
	return;
...
void func_218(var uParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA749
{
	Hash hash;
	var unk;
	Hash hash2;
...
BOOL func_219(Hash hParam0) // Position - 0xAD7C
{
	return true;
}

BOOL func_220(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, var uParam4, var uParam5, var uParam6) // Position - 0xAD85
{
	int num;
	int num2;
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_221(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0xB0A4
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
BOOL func_222(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0xB197
{
	var unk;
	int num;
	int i;
...
BOOL func_223(Hash hParam0) // Position - 0xB225
{
...
int func_224(Hash hParam0, BOOL bParam1) // Position - 0xB240
{
	var unk;
...
BOOL func_225(int iParam0, Hash hParam1) // Position - 0xB298
{
	var unk;
	int num;
	Hash unlockHash;
...
BOOL func_226(Hash hParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0xB3E1
{
	var unk;
	int i;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_227(Hash hParam0, int iParam1, Hash hParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0xB465
{
	var unk;
	int num;
	int num2;
			...
			else
			{
				if (flag)
				{
					if (func_238(unk[i /*2*/]) || func_239(unk[i /*2*/]))
					{
						...
						if (bParam5)
							num6 = func_241(7, unk[i /*2*/], &EntityIndex);
...
int func_229(Hash hParam0) // Position - 0xB681
{
	switch (hParam0)
	{
		case -1612693182:
...
BOOL func_230(BOOL bParam0, int iParam1) // Position - 0xB6D9
{
	return bParam0 && iParam1 != false;
}

Hash func_231(Hash hParam0, int iParam1) // Position - 0xB6E8
{
	int num;
	var unk;
	Hash hash;
...
int func_232(Hash hParam0, BOOL bParam1) // Position - 0xB762
{
	var unk;
	int num;
	int num2;
...
int func_233(Hash hParam0, int iParam1) // Position - 0xB7C1
{
	if (iParam1 == 0)
		return 0;
...
struct<4> func_234(Hash hParam0, BOOL bParam1) // Position - 0xB7ED
{
	var unk;
...
int func_235(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB812
{
	if (!func_25(hParam0, 0))
	{
		if (func_250(func_168(hParam0), 2))
...
int func_236(int iParam0, Hash hParam1) // Position - 0xB886
{
...
int func_237(Hash hParam0, int iParam1) // Position - 0xB8AB
{
	var unk;
	var guid;
...
BOOL func_238(Hash hParam0) // Position - 0xB906
{
	if (!func_25(hParam0, 0))
		return false;
...
BOOL func_239(Hash hParam0) // Position - 0xB935
{
	if (!func_25(hParam0, 0))
		return 0;
...
int func_240(Hash hParam0, int iParam1) // Position - 0xB95F
{
	int num;
	int num2;
	int num3;
...
int func_241(int iParam0, Hash hParam1, var uParam2) // Position - 0xBA7C
{
	Ped EntityIndex;
	ItemSet itemSet;
	int itemsetSize;
...
int func_242(int iParam0, Hash hParam1) // Position - 0xBBA9
{
	Ped EntityIndex;
	Hash hash;
	int num;
...
int func_243(Hash hParam0) // Position - 0xBC47
{
	int num;
...
BOOL func_244() // Position - 0xBC99
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(-768274665);
}

char* func_245(Hash hParam0) // Position - 0xBCAA
{
...
void func_246(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0xBD03
{
	int i;
	int j;
	int k;
...
BOOL func_247(Hash hParam0, int iParam1) // Position - 0xBED9
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_248(Hash hParam0) // Position - 0xBF81
{
	int num;
	int num2;
	int num3;
...
BOOL func_249(int iParam0) // Position - 0xC03E
{
	return func_112(iParam0, 2);
}

BOOL func_250(Hash hParam0, int iParam1) // Position - 0xC04D
{
	if (hParam0 == 0)
		return false;
...
int func_251(int iParam0) // Position - 0xC067
{
	if (iParam0 == 7)
...
float func_252(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xC080
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_253(int iParam0, char* sParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xC09E
{
	int num;
...
int func_254(int iParam0, Hash hParam1, int iParam2) // Position - 0xC0E7
{
	Ped EntityIndex;
	ItemSet itemSet;
	int itemsetSize;
			...
			for (j = 0; j < 10; j = j + 1)
			{
				...
				if (hash == hParam1)
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(entityFromItem))
					{
						...
						if (func_25(hash2, 0))
							func_388(hash2, 1, EntityIndex, true, -142743235);
...
BOOL func_255(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0xC25B
{
	int num;
	var unk;
	var unk6;
...
void func_256(Hash hParam0, int iParam1) // Position - 0xC2D3
{
	int num;
	int num2;
	var unk;
...
BOOL func_257(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0xC3D1
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
void func_258(Hash hParam0) // Position - 0xC583
{
	Entity firstEntityPedIsCarrying;
...
int func_259(int iParam0, Hash hParam1, int iParam2) // Position - 0xC61E
{
	Ped EntityIndex;
	Hash hash;
	int num;
...
int func_260(Hash hParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xC6D4
{
	var unk;
	var unk6;
...
int func_261(Hash hParam0) // Position - 0xC740
{
	switch (hParam0)
	{
...
BOOL func_262(int iParam0) // Position - 0xC91B
{
	return !(iParam0 <= 0);
}

int func_263(int iParam0) // Position - 0xC928
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_264(Hash hParam0) // Position - 0xCCBE
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

BOOL func_265(Hash hParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, BOOL bParam5, int iParam6) // Position - 0xCCD9
{
	int i;
	int num;
	Hash hash;
...
struct<4> func_266() // Position - 0xCE59
{
	var unk;
...
BOOL func_267(Hash hParam0, Any* panParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0xCE7D
{
	if (!func_25(hParam0, 0))
		return 0;
...
BOOL func_268(Hash hParam0, int iParam1) // Position - 0xCEE5
{
	var unk;
	var unk6;
	Hash hash;
...
BOOL func_269(Hash hParam0) // Position - 0xD0D5
{
	if (!func_25(hParam0, 0))
		return false;
...
Hash func_270(Hash hParam0) // Position - 0xD0FF
{
	switch (hParam0)
	{
...
BOOL func_272() // Position - 0xD354
{
	return !Global_1913444;
}

void func_273(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0xD361
{
	int i;
...
var func_274(BOOL bParam0, var uParam1, var uParam2) // Position - 0xD484
{
	if (bParam0)
		return uParam1;
...
BOOL func_275(Hash hParam0, int iParam1) // Position - 0xD49B
{
	if (!func_25(hParam0, 0))
		return false;
...
char* func_276(Hash hParam0) // Position - 0xD4BA
{
...
BOOL func_277(Hash hParam0) // Position - 0xD5B6
{
...
Hash func_278(Hash hParam0, BOOL bParam1) // Position - 0xD635
{
	Hash hash;
...
BOOL func_279(int iParam0) // Position - 0xD663
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_280(Hash hParam0) // Position - 0xD68A
{
	var unk;
	int i;
...
Hash func_281(Hash hParam0) // Position - 0xD6F8
{
	int num;
	var unk;
	int collectionId;
...
BOOL func_282(Hash hParam0, Hash hParam1) // Position - 0xD77D
{
	if (hParam0 == 0)
		return false;
...
BOOL func_283(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3) // Position - 0xD7AE
{
	var unk;
...
const char* func_284(const char* sParam0, int iParam1) // Position - 0xD80D
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_285(Hash hParam0, int iParam1) // Position - 0xD827
{
	 num;
...
BOOL func_286(Hash hParam0, char* sParam1) // Position - 0xD845
{
	...
	TEXT_LABEL_ASSIGN_STRING(&StringToTest, func_416(hParam0), 128);
...
const char* func_287(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0xD8C2
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_288(const char* sParam0, int iParam1) // Position - 0xD8D6
{
...
int func_289(const char* sParam0, char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0xD90C
{
	int num;
	var unk13;
	int num2;
...
BOOL func_290(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0xD96F
{
	if (func_27() == -1)
	{
...
BOOL func_291(Hash hParam0, var uParam1, int iParam2) // Position - 0xD9C6
{
	var unk;
	int num;
	int num2;
...
void func_292(Hash hParam0, BOOL bParam1) // Position - 0xDA64
{
	if (bParam1)
		return;
...
BOOL func_293(int iParam0) // Position - 0xDB15
{
	if (!func_423(iParam0))
		return false;
...
void func_294(int iParam0) // Position - 0xDB31
{
	if (!func_423(iParam0))
		return;
...
void func_295(Hash hParam0) // Position - 0xDB52
{
...
BOOL func_296(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, Hash hParam6, BOOL bParam7) // Position - 0xDBD7
{
	var unk;
	var unk6;
	var unk28;
...
BOOL func_297(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xDD07
{
	if (iParam1 < 1)
		return true;
...
BOOL func_298(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xDD42
{
	int num;
	var unk;
	var unk6;
...
BOOL func_299(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0xDDB1
{
	Hash TypeOfWeapon;
	var unk;
	int num;
	...
	TypeOfWeapon = func_177(hParam0, false);
	...
	if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
	{
		if (func_27() == -1)
		{
			...
			if (hParam1 == 1248274121)
				func_429(TypeOfWeapon);
		}
	
		if (!func_185(hParam0, &unk, 1, false, false, -1, false))
		{
			func_419(hParam0, 1, false, uParam2, hParam1);
			num = func_430(TypeOfWeapon);
		
			if (WEAPON::_IS_WEAPON_SNIPER(TypeOfWeapon))
			{
				func_296(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (TypeOfWeapon == joaat("weapon_fishingrod") || WEAPON::_IS_WEAPON_BINOCULARS(TypeOfWeapon))
			{
				func_296(TypeOfWeapon, 0, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::_IS_WEAPON_LASSO(TypeOfWeapon))
			{
				func_296(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::IS_WEAPON_MELEE_WEAPON(TypeOfWeapon))
			{
				if (TypeOfWeapon == joaat("weapon_melee_knife_john") && !func_431())
					return false;
			
				if (WEAPON::SHOULD_WEAPON_BE_DISCARDED_WHEN_SWAPPED(hParam0))
				{
				}
				else if (!func_432(TypeOfWeapon))
				{
					func_296(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
				}
				else
				{
					func_296(TypeOfWeapon, WEAPON::GET_WEAPON_CLIP_SIZE(TypeOfWeapon) * 4, bParam3, bParam4, 0, false, hParam1, false);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(TypeOfWeapon))
			{
				weaponHash = func_433(Global_33, 2, false, true);
			
				if (func_264(weaponHash) && !Global_26688 && weaponHash != TypeOfWeapon && !func_150(joaat("upgrade_offhand_holster"), 1) && bParam4)
					WEAPON::_SEND_WEAPON_TO_INVENTORY(Global_33, weaponHash);
			
				if (func_264(weaponHash) && func_150(joaat("upgrade_offhand_holster"), 1))
					if (!func_296(TypeOfWeapon, num, bParam3, bParam4, 3, true, hParam1, false))
						return false;
				else if (!func_296(TypeOfWeapon, num, bParam3, bParam4, 0, true, hParam1, false))
					return false;
			}
			else if (!func_296(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false))
			{
				return false;
			}
		}
...
BOOL func_300(Hash hParam0) // Position - 0xDFBF
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_301(Hash hParam0, var uParam1, Hash hParam2) // Position - 0xDFCD
{
	int num;
	int weaponClipSize;
	int ReturnMaxAmmo;
...
void func_302(int iParam0, BOOL bParam1) // Position - 0xE0CB
{
	int num;
	int num2;
...
BOOL func_303() // Position - 0xE0F8
{
	return false;
}

int func_304(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, int iParam5, BOOL bParam6, int iParam7) // Position - 0xE101
{
	int num;
...
void func_305(Hash hParam0) // Position - 0xE148
{
	return;
}

void func_306(Hash hParam0) // Position - 0xE150
{
	return;
}

void func_307(Hash hParam0) // Position - 0xE158
{
	return;
}

void func_308(Hash hParam0) // Position - 0xE160
{
	return;
}

void func_309() // Position - 0xE168
{
...
void func_310(Hash hParam0, var uParam1) // Position - 0xE18C
{
	var unk;
...
void func_311(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0xE19E
{
	int num;
	int num2;
...
void func_312(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0xE1FE
{
	int num;
	int num2;
...
void func_313(var uParam0) // Position - 0xE279
{
	switch (*uParam0)
	{
...
void func_314(Hash hParam0) // Position - 0xE2BD
{
	if (func_27() != -1)
		return;
...
BOOL func_315(Hash hParam0, int iParam1) // Position - 0xE2D0
{
	var unk;
	var unk5;
...
struct<2> func_316(Hash hParam0) // Position - 0xE304
{
	var unk;
	var unk3;
...
void func_317(Hash hParam0) // Position - 0xE398
{
	switch (hParam0)
	{
...
void func_318(Hash hParam0, int iParam1) // Position - 0xE3B1
{
	char* str;
...
BOOL func_319(Hash hParam0, int iParam1) // Position - 0xE3F2
{
	var unk;
	int num;
	int num2;
...
int func_320(int iParam0) // Position - 0xE452
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_321(BOOL bParam0) // Position - 0xE483
{
	int num;
...
struct<4> func_322(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0xE523
{
	var outGuid;
...
struct<4> func_323(BOOL bParam0) // Position - 0xE554
{
	int num;
...
BOOL func_324(Hash hParam0, BOOL bParam1) // Position - 0xE5F5
{
...
BOOL func_325(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE62C
{
	return func_332(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_326(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0xE647
{
	var unk;
...
struct<4> func_327(BOOL bParam0) // Position - 0xE668
{
	int num;
...
BOOL func_328(Hash hParam0, int iParam1) // Position - 0xE6D2
{
	Hash hash;
	int num;
	int i;
...
BOOL func_329(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0xE73F
{
	return func_451(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_330(var uParam0) // Position - 0xE755
{
...
BOOL func_331(Hash hParam0) // Position - 0xE7DF
{
	return func_179(hParam0) == joaat("WEAPON");
}

int func_332(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xE7F3
{
	int inventoryItemCountWithGuid;
	var guid;
...
BOOL func_333(Hash hParam0) // Position - 0xE872
{
	return func_189(hParam0) == 1868067663;
}

// Unhandled jump detected. Output should be considered invalid
BOOL func_334(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xE886
{
	int i;
...
BOOL func_335(int iParam0) // Position - 0xE915
{
	if (iParam0 < 0)
		return false;
...
BOOL func_336(int iParam0) // Position - 0xE942
{
	if (iParam0 < 0)
		return false;
...
// Unhandled jump detected. Output should be considered invalid
int func_337(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0xE965
{
	var unk;
	int num;
	int i;
...
BOOL func_338(Hash hParam0) // Position - 0xEA55
{
	switch (hParam0)
	{
		case -1551258934:
...
int func_339(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0xEA82
{
	int num;
...
BOOL func_340(int* piParam0, BOOL bParam1) // Position - 0xEAEC
{
	if (!bParam1)
...
Hash func_341(int iParam0, int iParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0xEB88
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_342(int iParam0, Hash hParam1, int iParam2) // Position - 0xEC8D
{
	if (iParam0 == 0)
		return false;
...
BOOL func_343(int* piParam0, Any* panParam1, Hash hParam2, Hash hParam3, BOOL bParam4) // Position - 0xECED
{
	var unk;
	int num;
...
BOOL func_344(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, Hash hParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0xEE75
{
	Hash hash;
...
struct<17> func_345(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, int iParam6, BOOL bParam7) // Position - 0xEF12
{
	var unk;
...
BOOL func_346(int* piParam0, Any* panParam1, Hash hParam2, BOOL bParam3, int iParam4) // Position - 0xEF8C
{
	var unk;
	int num;
...
BOOL func_347(var uParam0) // Position - 0xF134
{
	return func_198(*uParam0, 2);
}

float func_348() // Position - 0xF144
{
...
void func_349(var uParam0, int iParam1) // Position - 0xF176
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_350(var uParam0, int iParam1) // Position - 0xF187
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_351(Player plParam0) // Position - 0xF19C
{
	Player player;
...
int func_352(Player plParam0) // Position - 0xF1CC
{
	int i;
...
var func_353(int iParam0, int iParam1) // Position - 0xF22F
{
	return func_506(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

int func_354() // Position - 0xF24D
{
	return Global_1102813.f_3672;
}

void func_355(int iParam0, int iParam1) // Position - 0xF25C
{
	if (iParam1 == 0)
		return;
...
void func_356(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0xF28C
{
	int i;
	var unk;
...
BOOL func_357(int iParam0) // Position - 0xF347
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_358(int iParam0) // Position - 0xF365
{
...
int func_359(int iParam0) // Position - 0xF383
{
	if (!func_358(iParam0))
		return 0;
...
int func_363(int iParam0, int iParam1) // Position - 0xF435
{
	if (iParam1 == 2)
		iParam1 = func_509(1);
...
int func_364(int iParam0) // Position - 0xF481
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_365(Hash hParam0, Hash hParam1, var uParam2, var uParam3) // Position - 0xF652
{
	var unk;
	int i;
...
int func_366(Hash hParam0, BOOL bParam1) // Position - 0xF6D6
{
	int num;
...
void func_367(Hash hParam0, var uParam1, var uParam2) // Position - 0xF70F
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_368(Hash hParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xF91B
{
	Hash hash;
...
void func_369(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0xF9F9
{
...
BOOL func_370(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0xFA14
{
...
int func_371(int iParam0) // Position - 0xFA39
{
	if (iParam0 < 0)
		return 0;
...
Hash func_372(Hash hParam0) // Position - 0xFA5A
{
	int num;
...
int func_373(Hash hParam0) // Position - 0xFDCC
{
...
int func_374(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xFE11
{
	var unk;
	int num;
	int i;
...
BOOL func_375(int iParam0) // Position - 0xFE65
{
	iParam0 = func_251(iParam0);
...
BOOL func_376(Entity eParam0) // Position - 0xFE9D
{
	Ped pedIndexFromEntityIndex;
...
BOOL func_377(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0xFF00
{
...
BOOL func_378(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0xFF27
{
	if (iParam2 < 0)
		return false;
...
int func_379(Hash hParam0) // Position - 0xFF62
{
	switch (hParam0)
	{
...
int func_380(var uParam0, int iParam1) // Position - 0x10047
{
	int i;
...
int func_381(Hash hParam0) // Position - 0x10084
{
	int num;
...
int func_383(int iParam0, char* sParam1, int iParam2, BOOL bParam3) // Position - 0x1010C
{
	int num;
	var unk;
	var unk6;
...
void func_384(int iParam0) // Position - 0x10185
{
	var statId;
...
void func_385(int iParam0, char* sParam1, int iParam2) // Position - 0x101C1
{
	if (iParam0 == 0)
		return;
...
Hash func_386(var uParam0) // Position - 0x10202
{
	Ped pedIndexFromEntityIndex;
...
Hash func_387(Entity eParam0) // Position - 0x10228
{
...
int func_388(Hash hParam0, int iParam1, Ped pedParam2, BOOL bParam3, Hash hParam4) // Position - 0x10286
{
...
BOOL func_389(Hash hParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x102B9
{
	int num;
	var unk;
	int num2;
...
BOOL func_390(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, BOOL bParam5, BOOL bParam6) // Position - 0x103D1
{
	var unk;
	int num;
	var unk15;
...
int func_391(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x104EF
{
	int num;
	int num2;
	Hash hash;
...
BOOL func_392(Hash hParam0) // Position - 0x105CB
{
	return func_179(hParam0) == joaat("consumable");
}

BOOL func_393(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x105DF
{
	var unk;
	int num;
	int num2;
...
void func_394(BOOL bParam0, BOOL bParam1, int iParam2) // Position - 0x106AB
{
...
int func_395(Ped pedParam0, Any* panParam1) // Position - 0x106E5
{
...
BOOL func_396(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x10797
{
	var unk;
	var unk6;
...
int func_397(Hash hParam0) // Position - 0x107EE
{
	int num;
...
BOOL func_398(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1081D
{
...
BOOL func_399(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, Any* panParam5, BOOL bParam6, int iParam7) // Position - 0x10850
{
	return func_523(&uParam0, hParam4, panParam5, bParam6, iParam7);
}

BOOL func_400(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x10866
{
	var unk;
...
BOOL func_401(Hash hParam0) // Position - 0x108DA
{
	!func_25(hParam0, 0);
...
BOOL func_402(Hash hParam0, var uParam1) // Position - 0x10900
{
	var unk;
...
BOOL func_403(Hash hParam0) // Position - 0x10943
{
	!func_25(hParam0, 0);
	return hParam0 == 1362183957 || hParam0 == 563996796 || hParam0 == joaat("horse_equipment_moonshinersaddle_001_improved_new_saddle_000");
}

BOOL func_404(Hash hParam0) // Position - 0x1097A
{
	!func_25(hParam0, 0);
	return hParam0 == 2031387366 || hParam0 == 1270980548;
}

BOOL func_405(Hash hParam0) // Position - 0x109A3
{
	!func_25(hParam0, 0);
	return hParam0 == -1731781873;
}

Hash func_406(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0x109BE
{
	return func_526(&uParam0, hParam4, bParam5, iParam6);
}

BOOL func_407(Hash hParam0) // Position - 0x109D2
{
...
BOOL func_408(Hash hParam0, var uParam1, BOOL bParam2) // Position - 0x10A22
{
	int num;
	int num2;
	var unk;
...
BOOL func_409(Hash hParam0, Hash hParam1) // Position - 0x10ADA
{
	if (hParam1 == 0)
		return false;
...
Hash func_410(Hash hParam0, BOOL bParam1) // Position - 0x10B01
{
	switch (hParam0)
	{
...
int func_411(Hash hParam0) // Position - 0x10BA3
{
	var unk;
	int num;
...
BOOL func_412(Hash hParam0) // Position - 0x10BDD
{
	!func_25(hParam0, 0);
...
int func_413(Hash hParam0, int iParam1) // Position - 0x10C03
{
	var unk;
	int num;
	int num2;
...
char* func_414(Hash hParam0) // Position - 0x10C51
{
	Hash labelHash;
...
BOOL func_415(Hash hParam0) // Position - 0x10C87
{
...
char* func_416(Hash hParam0) // Position - 0x10CB5
{
	Hash labelHash;
...
void func_417(const char* sParam0, char* sParam1, Hash hParam2) // Position - 0x10CEA
{
...
BOOL func_418(Hash hParam0) // Position - 0x10D1B
{
	var unk;
...
void func_419(Hash hParam0, int iParam1, BOOL bParam2, var uParam3, Hash hParam4) // Position - 0x10D60
{
	Hash TypeOfWeapon;
	...
	if (bParam2 || !func_171(TypeOfWeapon))
	{
		if (bParam2 || !WEAPON::HAS_PED_GOT_WEAPON(Global_33, TypeOfWeapon, 0, false) && func_138(hParam0, false, false, false) == 0)
		{
			if (func_27() == -1)
				func_178(TypeOfWeapon);
...
void func_420(Hash hParam0, var uParam1) // Position - 0x10E0A
{
...
int func_421(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10E2F
{
...
BOOL func_422() // Position - 0x10E62
{
...
BOOL func_423(int iParam0) // Position - 0x10EC7
{
	if (iParam0 == 0)
		return false;
...
BOOL func_424(int iParam0) // Position - 0x10EDA
{
	int num;
	int num2;
	int offset;
...
void func_425(int iParam0) // Position - 0x10F04
{
	int num;
	int num2;
	int BitIndex;
...
void func_426(int iParam0) // Position - 0x10F3E
{
	switch (iParam0)
	{
		case 1:
...
void func_427(Hash hParam0, int iParam1) // Position - 0x114BA
{
	...
	{
		AmmoInClip = func_141(WEAPON::GET_WEAPON_CLIP_SIZE(hParam0), iParam1);
...
BOOL func_428(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1152C
{
	int num;
	var guid2;
	var guid1;
...
void func_429(Hash hParam0) // Position - 0x115A8
{
	char* decoratorName;
	char* decoratorName2;
	int value;
...
int func_430(Hash hParam0) // Position - 0x11677
{
	int num;
	int pedAmmoByType;
...
BOOL func_431() // Position - 0x116F3
{
	return false;
}

BOOL func_432(Hash hParam0) // Position - 0x116FC
{
	return WEAPON::_IS_AMMO_VALID(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0));
}

Hash func_433(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1170E
{
...
int func_434(Hash hParam0) // Position - 0x11734
{
	Hash weaponTypeFromAmmoType;
...
void func_435(int iParam0, var uParam1, var uParam2) // Position - 0x117A0
{
	int num;
...
BOOL func_436(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x117BC
{
...
void func_437(int iParam0, int iParam1) // Position - 0x1185E
{
	int Variable;
...
int func_438(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x11882
{
	float num;
	int num2;
	int i;
...
void func_439(int iParam0, const char* sParam1, int iParam2, BOOL bParam3) // Position - 0x11952
{
	if (iParam0 == 0)
		return;
...
void func_440(int iParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x119A4
{
	int num;
	int value;
	int num2;
...
BOOL func_441(int iParam0, int iParam1) // Position - 0x11A7F
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

void func_442(var uParam0, int iParam1) // Position - 0x11A98
{
	BOOL flag;
	int i;
...
BOOL func_443(Hash hParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x11BC4
{
	var unk;
	int num;
...
struct<2> func_444(int iParam0) // Position - 0x11C33
{
	int num;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x11C43
{
	switch (iParam0)
	{
		case 0:
...
Hash func_446(Hash hParam0) // Position - 0x11D1A
{
	Hash num;
...
BOOL func_447(Hash hParam0, var uParam1) // Position - 0x11D44
{
	int i;
	var unk;
	var unk2;
...
struct<4> func_448() // Position - 0x11D98
{
	var unk;
...
BOOL func_450(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x11DC1
{
	int inventoryId;
...
BOOL func_451(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x11E06
{
...
BOOL func_452(Hash hParam0) // Position - 0x11E40
{
	return func_76(hParam0, 1279601681);
}

BOOL func_453(int iParam0) // Position - 0x11E53
{
	if (iParam0 == 0)
		return false;
...
void func_454(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x11E6B
{
	int i;
	int j;
	int k;
...
BOOL func_455(int iParam0) // Position - 0x12041
{
	if (iParam0 < 0)
		return false;
...
BOOL func_456(Hash hParam0, Hash hParam1) // Position - 0x12064
{
	if (!func_25(hParam0, 0))
		return false;
...
int func_457(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x120B0
{
	var unk;
	int num;
	int i;
...
BOOL func_458(Hash hParam0, Any* panParam1) // Position - 0x12144
{
	int num;
...
BOOL func_459(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x1231A
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_460(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x12331
{
	if (bParam0)
	{
...
int func_461(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x1237A
{
	if (bParam0)
	{
		func_552(iParam1, 1, 0, 0);
...
BOOL func_462(int* piParam0) // Position - 0x12396
{
	int num;
...
BOOL func_463(Any anParam0) // Position - 0x123C8
{
...
BOOL func_464(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x1240E
{
	if (!func_453(iParam0))
		return false;
...
BOOL func_465(int iParam0, var uParam1) // Position - 0x12446
{
	*uParam1 = func_554(iParam0, true);
	return *uParam1 != 0;
}

BOOL func_466(int iParam0, var uParam1) // Position - 0x1245D
{
	*uParam1 = func_555(iParam0, true, false);
	return *uParam1 != 0;
}

BOOL func_467() // Position - 0x12475
{
	return Global_1915656.f_22477;
}

BOOL func_468(int iParam0) // Position - 0x12484
{
...
BOOL func_469(int iParam0, Hash hParam1) // Position - 0x124BF
{
	int num;
	int num2;
	var unk;
...
BOOL func_470(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x12579
{
	var unk;
...
BOOL func_471(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x125A5
{
	int num;
...
BOOL func_472(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x125DA
{
	int num;
...
BOOL func_473(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x12618
{
	int num;
...
BOOL func_474(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x1265F
{
	int num;
...
BOOL func_475(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x126AF
{
	int num;
...
BOOL func_476(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x12708
{
	int num;
...
BOOL func_477(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x1276A
{
	int num;
...
BOOL func_478(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x127D6
{
	int num;
...
BOOL func_479(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x1284B
{
	int num;
...
BOOL func_480(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x128C9
{
	int num;
...
BOOL func_481(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x12950
{
	int num;
...
BOOL func_482(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x129E0
{
	int num;
...
BOOL func_483(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x12A79
{
	int num;
...
BOOL func_484(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x12B1B
{
	int num;
...
BOOL func_485(Hash hParam0) // Position - 0x12BC6
{
	Hash hash;
...
BOOL func_486(int* piParam0, Hash hParam1, Hash hParam2, int iParam3, int iParam4) // Position - 0x12BE5
{
	int num;
	var unk;
	var unk2;
...
BOOL func_487(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5) // Position - 0x12C90
{
	var unk;
...
BOOL func_488(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x12CE1
{
...
BOOL func_489(int* piParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6, Hash hParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x12D1C
{
	var unk;
	int num;
	int num2;
...
BOOL func_490(int* piParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x12DD3
{
	int num;
	int num2;
	int num3;
...
BOOL func_491(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x12F1B
{
	var unk;
...
BOOL func_492(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x12F49
{
	int num;
...
BOOL func_493(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x12F80
{
	int num;
...
BOOL func_494(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x12FC0
{
	int num;
...
BOOL func_495(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13009
{
	int num;
...
BOOL func_496(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x1305B
{
	int num;
...
BOOL func_497(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x130B6
{
	int num;
...
BOOL func_498(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x1311A
{
	int num;
...
BOOL func_499(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13188
{
	int num;
...
BOOL func_500(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x131FF
{
	int num;
...
BOOL func_501(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x1327F
{
	int num;
...
BOOL func_502(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13308
{
	int num;
...
BOOL func_503(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x1339A
{
	int num;
...
BOOL func_504(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x13435
{
	int num;
...
BOOL func_505(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, BOOL bParam4, int iParam5) // Position - 0x134D9
{
	int num;
...
var func_506(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x13586
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_570(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
BOOL func_507(int iParam0, int iParam1) // Position - 0x13919
{
	int num;
...
BOOL func_508(int iParam0) // Position - 0x1398D
{
	return func_573(&(Global_1956875.f_1565), iParam0, 1);
}

int func_509(int iParam0) // Position - 0x139A3
{
	return func_574(func_508(iParam0));
}

BOOL func_510(Hash hParam0, Hash hParam1, Any anParam2) // Position - 0x139B5
{
	int i;
	int num;
...
struct<17> func_511(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, int iParam6, BOOL bParam7) // Position - 0x139F5
{
	var unk;
...
Hash func_512(Ped pedParam0) // Position - 0x13A6F
{
	Ped EntityIndex;
	int pedDamageCleanliness;
	int num;
...
int func_513(Hash hParam0, int iParam1, Ped pedParam2, BOOL bParam3, BOOL bParam4, Hash hParam5, int iParam6, int iParam7) // Position - 0x13B42
{
	int num;
...
int func_514(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x13BAC
{
	int num;
	int num2;
	int num3;
...
BOOL func_515(Hash hParam0) // Position - 0x13C3B
{
...
BOOL func_516(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x13C51
{
	*uParam1 = 0;
...
struct<17> func_517(Hash hParam0, var uParam1) // Position - 0x13CBE
{
	var unk;
...
int func_518(Hash hParam0, int iParam1, Hash hParam2, Hash hParam3) // Position - 0x13D11
{
	Hash hash;
	var unk;
	var unk13;
...
int func_519(Hash hParam0, Any* panParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5) // Position - 0x13E0F
{
	var unk;
	var unk15;
	int num;
...
BOOL func_520() // Position - 0x13ED8
{
...
void func_521(int iParam0) // Position - 0x13F37
{
	Global_1940252.f_11 = iParam0;
	return;
}

void func_522(int iParam0) // Position - 0x13F47
{
	Global_1940252.f_10 = iParam0;
	return;
}

BOOL func_523(Any* panParam0, Hash hParam1, Any* panParam2, BOOL bParam3, int iParam4) // Position - 0x13F57
{
	var outGuid;
...
int func_524(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0x13FA5
{
	int num;
	var unk;
	int num2;
...
BOOL func_525(Hash hParam0, int iParam1) // Position - 0x140EB
{
	int i;
	int num;
	int num2;
...
int func_526(Any* panParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0x1413F
{
	var unk;
...
BOOL func_527(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x1416D
{
...
void func_528(BOOL bParam0) // Position - 0x14196
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_529(int iParam0) // Position - 0x141D4
{
...
void func_530(BOOL bParam0) // Position - 0x14242
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_531(BOOL bParam0) // Position - 0x1427C
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_532(BOOL bParam0) // Position - 0x142B6
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_533(BOOL bParam0) // Position - 0x142F0
{
	Hash hash;
...
void func_534(BOOL bParam0) // Position - 0x14313
{
	int promptType;
	Player player;
...
void func_535(BOOL bParam0) // Position - 0x14355
{
	int promptType;
	Player player;
...
BOOL func_536() // Position - 0x14397
{
	return true;
}

int func_537(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x143B6
{
	int num;
	int num2;
	int num3;
...
int func_538() // Position - 0x1441C
{
	return Global_1902569;
}

void func_539(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x14428
{
	int num;
	int i;
	int num2;
...
BOOL func_540(int iParam0, int iParam1) // Position - 0x145B0
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_541(int iParam0) // Position - 0x145C8
{
...
BOOL func_542(int iParam0) // Position - 0x145DF
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_543(int iParam0) // Position - 0x146AB
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_544() // Position - 0x146BE
{
	if (!func_605())
		return false;
...
void func_545(int iParam0, int iParam1) // Position - 0x146D9
{
	if (iParam0 <= 0)
		return;
...
BOOL func_546() // Position - 0x14715
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_547() // Position - 0x14726
{
	return DLC::IS_DLC_PRESENT(joaat("dlc_ultimateedition"));
}

void func_548(var uParam0) // Position - 0x14737
{
...
void func_549(Any anParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x1476F
{
	int i;
	var unk;
...
int func_550(Hash hParam0) // Position - 0x14825
{
	int num;
...
BOOL func_551(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x14854
{
...
void func_552(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1486C
{
	int i;
...
int func_553(int* piParam0) // Position - 0x1490A
{
	return func_609(piParam0->f_1);
}

Hash func_554(int iParam0, BOOL bParam1) // Position - 0x1491A
{
	int i;
	int num;
	var unk;
...
Hash func_555(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x149AD
{
	int i;
	int num;
	var unk;
...
int func_556(int iParam0) // Position - 0x14B0C
{
	return iParam0 / 100;
}

void func_557(const char* sParam0) // Position - 0x14B19
{
	Global_1915656.f_22470 = func_582(sParam0, 10000, 0, 0, 0, true);
	return;
}

BOOL func_558(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, int iParam4, Any* panParam5, BOOL bParam6) // Position - 0x14B35
{
	int i;
...
int func_559(Hash hParam0, Any anParam1, var uParam2, var uParam3, var uParam4) // Position - 0x14BAB
{
	Hash hash;
	Hash hash2;
	int i;
...
BOOL func_560(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x14C90
{
	var unk;
	var unk48;
...
BOOL func_561(Hash hParam0) // Position - 0x14D5C
{
	BOOL flag;
	Hash weaponUnlock;
...
int func_562(int* piParam0, Hash hParam1) // Position - 0x14DA6
{
	int num;
	int i;
	int numOfItems;
...
BOOL func_563(Hash hParam0, BOOL bParam1) // Position - 0x14E10
{
...
BOOL func_564(Hash hParam0, BOOL bParam1) // Position - 0x14E89
{
	int num;
	var unk;
...
int func_565(int* piParam0, Hash hParam1) // Position - 0x14ED3
{
	int num;
	int i;
	int numOfItems;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_566(Hash hParam0, int iParam1, Hash hParam2, var uParam3, BOOL bParam4) // Position - 0x14F4C
{
	var unk;
	int num;
	int num2;
...
BOOL func_567(int* piParam0, Any* panParam1, Hash hParam2, var uParam3, int iParam4, Any* panParam5, BOOL bParam6, int iParam7) // Position - 0x15032
{
	int i;
...
int func_568() // Position - 0x150AF
{
	return Global_1051645.f_12;
}

char* func_569() // Position - 0x150BD
{
	return "unnamed";
}

BOOL func_570(int iParam0) // Position - 0x150C9
{
	int num;
...
int func_571(int iParam0) // Position - 0x15158
{
	if (iParam0 == 255)
...
BOOL func_572(Player plParam0) // Position - 0x151A3
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_573(int* piParam0, int iParam1, int iParam2) // Position - 0x151E8
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_574(BOOL bParam0) // Position - 0x1521F
{
	if (bParam0)
		return 1;
...
int func_575(Ped pedParam0) // Position - 0x15231
{
	int num;
	int pedQuality;
...
int func_576(int iParam0) // Position - 0x15287
{
	switch (iParam0)
	{
...
int func_577(Ped pedParam0, Hash hParam1) // Position - 0x15CC4
{
	int i;
	int num;
...
int func_578(var uParam0, Hash hParam1, var uParam2, BOOL bParam3, Hash hParam4, int iParam5) // Position - 0x15D3A
{
	var statId;
	int num;
...
int func_579(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x15E0E
{
	Hash hash;
	ItemSet itemSet;
	Ped entityFromItem;
...
void func_580(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x15FC0
{
	int i;
	int slot;
...
BOOL func_581(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x1604C
{
	var statId;
...
int func_582(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x16083
{
	int num;
	var unk13;
	int num2;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_583(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x160BE
{
	int i;
...
int func_584(Hash hParam0) // Position - 0x161D5
{
	if (func_76(hParam0, 1064293907))
		return 2;
	else if (func_76(hParam0, -1218707194))
...
struct<12> func_585(int iParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x1621A
{
	int num;
...
BOOL func_586(Hash hParam0, var uParam1, int iParam2, int iParam3) // Position - 0x1637B
{
	var unk;
...
struct<17> func_587(var uParam0, BOOL bParam1) // Position - 0x1639B
{
	var unk;
...
Ped func_588(int iParam0) // Position - 0x1641C
{
	return PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::GET_PLAYER_INDEX());
}

int func_589(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1642C
{
	int num;
...
void func_590(int iParam0) // Position - 0x16461
{
...
struct<29> func_591(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x164E6
{
	var unk;
	var unk30;
...
int func_592(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x16581
{
	int num;
...
struct<26> func_593(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x165EB
{
	var unk;
	var unk27;
...
int func_594(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x1666E
{
	int num;
...
struct<18> func_595(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x166BE
{
	var unk;
	var unk19;
...
int func_596(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x16733
{
	int num;
...
int func_597(int iParam0) // Position - 0x1679D
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_598(int iParam0) // Position - 0x167C2
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_599(int iParam0) // Position - 0x167D5
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_600(int iParam0) // Position - 0x167E8
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_601(int iParam0) // Position - 0x167FB
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_602(int iParam0) // Position - 0x1680D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_603(int iParam0, int iParam1) // Position - 0x1681F
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_604(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x168B9
{
...
BOOL func_605() // Position - 0x168F1
{
	if (NETWORK::_NETWORK_HAS_COMPLETED_MP_INTRO_FLOW_ON_CURRENT_SLOT())
		return true;
...
BOOL func_606() // Position - 0x16905
{
	return Global_1913444.f_127 == 0;
}

int func_607() // Position - 0x16915
{
	return Global_1953292.f_1;
}

void func_608(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x16923
{
	int i;
...
int func_609(int iParam0) // Position - 0x169FF
{
	int num;
	int status;
...
Hash func_610(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x16A89
{
	int num;
...
BOOL func_611(Hash hParam0) // Position - 0x16B25
{
	return func_189(hParam0) == 1946043663;
}

BOOL func_612(Hash hParam0) // Position - 0x16B39
{
	return func_189(hParam0) == -126813555;
}

BOOL func_613(Hash hParam0, int iParam1, var uParam2) // Position - 0x16B4D
{
	var unk;
	int num;
	int num2;
...
BOOL func_614(int* piParam0, Any* panParam1, Any* panParam2, Hash hParam3, BOOL bParam4) // Position - 0x16C6F
{
...
int func_615(Hash hParam0, BOOL bParam1) // Position - 0x16CDB
{
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_616(Hash hParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x16D93
{
	int i;
...
BOOL func_617(int* piParam0, Any* panParam1, Any* panParam2, Hash hParam3, BOOL bParam4, int iParam5) // Position - 0x16E23
{
...
BOOL func_618(Player plParam0) // Position - 0x16E95
{
...
void func_619(Player plParam0) // Position - 0x16EB2
{
	Player player;
...
BOOL func_620(Hash hParam0) // Position - 0x16F35
{
...
int func_621(Ped pedParam0, Hash hParam1) // Position - 0x16F60
{
	int num;
	int i;
...
BOOL func_622(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4) // Position - 0x16FBE
{
	return func_658(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(pedParam0), hParam1, iParam2, bParam3, hParam4);
}

BOOL func_623(Hash hParam0) // Position - 0x16FD8
{
	int i;
	int num;
	Hash hash;
...
BOOL func_624(int iParam0, Hash hParam1, int iParam2) // Position - 0x1701A
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_625(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x170B2
{
	Player player;
...
int func_626(Ped pedParam0, Hash hParam1, int iParam2) // Position - 0x170F3
{
	int i;
	Hash peltFromHorse;
...
int func_627(Ped pedParam0, Hash hParam1) // Position - 0x171A5
{
	int num;
	ItemSet itemSet;
	int itemsetSize;
...
Hash func_628(Entity eParam0) // Position - 0x17243
{
	Hash hash;
...
BOOL func_629(Hash hParam0, var uParam1) // Position - 0x17296
{
	*uParam1 = func_666(hParam0);
	return *uParam1 != 0;
}

void func_630(Any* panParam0, Hash hParam1) // Position - 0x172AC
{
	MISC::COPY_SCRIPT_STRUCT(hParam1, panParam0, 96);
	return;
}

BOOL func_631(Hash hParam0) // Position - 0x172BE
{
	!func_25(hParam0, 0);
...
int func_632(Hash hParam0) // Position - 0x172E4
{
	int num;
	Hash hash;
...
int func_633(Hash hParam0) // Position - 0x1733D
{
	switch (hParam0)
	{
		case joaat("PROVISION_ANIMAL_CARCASS_CHICKEN_PERFECT"):
...
void func_634(Hash hParam0, int iParam1) // Position - 0x17E4E
{
...
BOOL func_635(Any* panParam0) // Position - 0x17E7D
{
...
int func_636(Hash hParam0, BOOL bParam1) // Position - 0x17E99
{
	if (!bParam1 || func_668())
...
BOOL func_637(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x17EC8
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 29, panParam2, 0);
}

BOOL func_638(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x17EDF
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 26, panParam2, 0);
}

BOOL func_639(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x17EF6
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

void func_640(var uParam0, int iParam1) // Position - 0x17F0D
{
	if (iParam1 < 0)
		return;
...
void func_641(var uParam0, int iParam1) // Position - 0x17F93
{
...
void func_642(var uParam0, int iParam1) // Position - 0x17FCF
{
	int num;
	int num2;
...
void func_643(var uParam0, int iParam1) // Position - 0x18024
{
...
void func_644(var uParam0, int iParam1) // Position - 0x1805F
{
...
void func_645(var uParam0, int iParam1) // Position - 0x18098
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_646(int iParam0) // Position - 0x180D0
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
int func_647() // Position - 0x180F3
{
	return Global_1915656.f_20241;
}

BOOL func_648(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x18102
{
...
BOOL func_649(int* piParam0, Hash hParam1) // Position - 0x1811B
{
	Hash action;
...
BOOL func_650(int* piParam0, BOOL bParam1) // Position - 0x1817E
{
...
void func_651(Hash hParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x1819F
{
	int i;
	int j;
	int k;
...
BOOL func_652(Hash hParam0, Any* panParam1, int iParam2) // Position - 0x18375
{
	if (panParam1->f_9 < 1)
		return false;
...
BOOL func_653(int iParam0, Hash hParam1, Any* panParam2, Any* panParam3) // Position - 0x183F5
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam3, *panParam3);
}

void func_654(Player plParam0) // Position - 0x1840E
{
	Player player;
...
void func_655(Player plParam0) // Position - 0x1847A
{
...
BOOL func_656(Hash hParam0, int iParam1) // Position - 0x184B5
{
	int num;
...
int func_657(int iParam0, Hash hParam1) // Position - 0x184D4
{
	var guid;
	int inventoryItemCountWithGuid;
...
BOOL func_658(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, Hash hParam4) // Position - 0x18512
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
BOOL func_659(Hash hParam0) // Position - 0x185EC
{
	if (!func_25(hParam0, 0))
		return false;
...
int func_660(int iParam0, int iParam1) // Position - 0x1861A
{
	switch (iParam0)
	{
		case 0:
...
Hash func_661(Hash hParam0) // Position - 0x18A6B
{
	if (!func_623(hParam0))
		return 0;
...
int func_662(Hash hParam0, int iParam1) // Position - 0x18A83
{
	switch (hParam0)
	{
...
BOOL func_663(Hash hParam0, BOOL bParam1) // Position - 0x18DEB
{
	Player player;
	Player player2;
	Hash hash;
...
Hash func_664(Player plParam0, BOOL bParam1) // Position - 0x18EE4
{
	return bParam1 ? Global_1289643[plParam0 /*19*/].f_1 : Global_1289643[plParam0 /*19*/];
}

Hash func_665(BOOL bParam0) // Position - 0x18F04
{
	return bParam0 ? Global_1901671.f_701.f_30 : Global_1901671.f_701.f_29;
}

int func_666(Hash hParam0) // Position - 0x18F24
{
	switch (hParam0)
	{
...
BOOL func_667(Any* panParam0) // Position - 0x19960
{
...
BOOL func_668() // Position - 0x19996
{
...
void func_669(var uParam0) // Position - 0x199E5
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_670(int* piParam0, Hash hParam1) // Position - 0x19A41
{
...
BOOL func_671(int* piParam0) // Position - 0x19A5F
{
	Hash action;
...
int func_672(Hash hParam0) // Position - 0x19AFC
{
	int num;
...
struct<4> func_673(int iParam0, Hash hParam1) // Position - 0x19B16
{
	var unk;
...
BOOL func_674(int iParam0, Hash hParam1, int iParam2) // Position - 0x19B38
{
	if (!func_25(hParam1, 0))
		return false;
...
BOOL func_675(int iParam0, Hash hParam1, int iParam2, Hash hParam3, BOOL bParam4) // Position - 0x19B5A
{
	var unk;
	var unk6;
...
BOOL func_676(Vehicle veParam0) // Position - 0x19BA9
{
...
struct<5> func_677(int iParam0) // Position - 0x19BC8
{
	var unk;
...
struct<4> func_678(int iParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6) // Position - 0x19BF5
{
	var outGuid;
...
BOOL func_679(int iParam0, Hash hParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x19C22
{
	var unk;
...
BOOL func_680(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, Any* panParam5, BOOL bParam6) // Position - 0x19C9A
{
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&uParam1))
		return false;
