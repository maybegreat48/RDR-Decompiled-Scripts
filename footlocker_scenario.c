...
void func_1() // Position - 0x5F
{
	return;
}

void func_2() // Position - 0x67
{
	func_7();
...
void func_4() // Position - 0xB5
{
	return;
}

void func_5() // Position - 0xBD
{
	int i;
...
void func_9(int iParam0) // Position - 0x484
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x4AC
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x4D4
{
	struct<2> data;
...
void func_13(var uParam0) // Position - 0x565
{
	int i;
...
void func_14(ScrHandle shParam0) // Position - 0x5BE
{
	int num;
	int value;

	num = OBJECT::_0x250EBB11E81A10BE(shParam0);
	...
	{
		DECORATOR::DECOR_SET_BOOL(shParam0, "loot_empty", true);
		return;
	}
	...
	if (value > 0)
		DECORATOR::DECOR_SET_INT(shParam0, "loot_money", value);

	if (value.f_2 > 0)
	{
		DECORATOR::DECOR_SET_INT(shParam0, "loot_ammo1_type", value.f_1);
		DECORATOR::DECOR_SET_INT(shParam0, "loot_ammo1_amt", value.f_2);
	}

	if (value.f_4 > 0)
	{
		DECORATOR::DECOR_SET_INT(shParam0, "loot_ammo2_type", value.f_3);
		DECORATOR::DECOR_SET_INT(shParam0, "loot_ammo2_amt", value.f_4);
	}

	if (value.f_6 > 0)
	{
		DECORATOR::DECOR_SET_INT(shParam0, "loot_ammo3_type", value.f_5);
		DECORATOR::DECOR_SET_INT(shParam0, "loot_ammo3_amt", value.f_6);
	}

	if (value.f_8 > 0)
	{
		DECORATOR::DECOR_SET_INT(shParam0, "loot_item_type1", value.f_7);
		DECORATOR::DECOR_SET_INT(shParam0, "loot_item_amt1", value.f_8);
	}

	if (value.f_9 != 0)
		DECORATOR::DECOR_SET_INT(shParam0, "loot_weapon", value.f_9);

	return;
}

BOOL func_15(ScrHandle shParam0) // Position - 0x6B4
{
	if (DECORATOR::DECOR_EXIST_ON(shParam0, "loot_empty") || DECORATOR::DECOR_EXIST_ON(shParam0, "loot_money") || DECORATOR::DECOR_EXIST_ON(shParam0, "fLoot_money") || DECORATOR::DECOR_EXIST_ON(shParam0, "loot_item_type1") || DECORATOR::DECOR_EXIST_ON(shParam0, "loot_item_type2") || DECORATOR::DECOR_EXIST_ON(shParam0, "loot_ammo1_type") || DECORATOR::DECOR_EXIST_ON(shParam0, "loot_ammo2_type") || DECORATOR::DECOR_EXIST_ON(shParam0, "loot_ammo3_type") || DECORATOR::DECOR_EXIST_ON(shParam0, "loot_weapon") || DECORATOR::DECOR_EXIST_ON(shParam0, "loot_capitale"))
		return false;

	return true;
}

void func_16(var uParam0) // Position - 0x754
{
	int num;
	int i;
	Hash hash;
...
char* func_20(int iParam0) // Position - 0x91E
{
	switch (iParam0)
	{
		case 0:
...
void func_21(var uParam0, var uParam1, int iParam2, var uParam3, char* sParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x94A
{
		...
		case 1:
			if (STREAMING::HAS_MODEL_LOADED(uParam1->f_12[iParam2]))
			{
				...
				*uParam3 = OBJECT::CREATE_OBJECT(uParam1->f_12[iParam2], offsetFromCoordAndHeadingInWorldCoords, func_39(&(uParam1->f_5)), true, false, false, bParam5);
				...
				if (bParam6)
				{
					SecondEntityBoneIndex = uParam1->f_4 ? uParam1->f_154[iParam2] : 0;
					...
					ENTITY::ATTACH_ENTITY_TO_ENTITY(*uParam3, uParam1->f_5, SecondEntityBoneIndex, offsetFromCoordAndHeadingInWorldCoords, uParam1->f_68[iParam2 /*3*/], false, false, false, false, 2, true, false, false);
				}
				else
				{
...
void func_22(var uParam0, var uParam1, var uParam2) // Position - 0xBB3
{
...
void func_23(Entity eParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC23
{
...
void func_24(var uParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0xC48
{
	int i;
...
BOOL func_25(Entity eParam0) // Position - 0xC87
{
...
void func_26(Entity eParam0) // Position - 0xCA6
{
	if (ENTITY::DOES_ENTITY_EXIST(eParam0))
...
void func_27(var uParam0) // Position - 0xCE9
{
	int i;
...
void func_28(Object* pobParam0, BOOL bParam1) // Position - 0xDDB
{
...
void func_29(var uParam0) // Position - 0xDF9
{
	return;
}

void func_30(var uParam0) // Position - 0xE01
{
	return;
}

void func_31(var uParam0) // Position - 0xE09
{
	return;
}

BOOL func_32(int iParam0, int iParam1) // Position - 0xE11
{
	return iParam0 && iParam1 != false;
}

int func_33(Entity eParam0) // Position - 0xE20
{
	if (!ENTITY::DOES_ENTITY_EXIST(eParam0))
		return 0;
...
BOOL func_34(Entity eParam0) // Position - 0xE47
{
...
void func_35(var uParam0, var uParam1, int iParam2) // Position - 0xE7B
{
	Hash hash;
	var unk;
	var unk2;
...
int func_38(var uParam0, var uParam1, int iParam2) // Position - 0xF6F
{
...
BOOL func_39(var uParam0) // Position - 0xFAA
{
	return !(DECORATOR::DECOR_EXIST_ON(*uParam0, "chest_local_only") && DECORATOR::DECOR_GET_BOOL(*uParam0, "chest_local_only"));
}

void func_40(var uParam0, var uParam1, Hash hParam2, int iParam3) // Position - 0xFCE
{
	if (hParam2 == 0)
...
var func_41(BOOL bParam0, var uParam1, var uParam2) // Position - 0x100B
{
	if (bParam0)
		return uParam1;
...
Vector3 func_42(BOOL bParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x1022
{
	if (bParam0)
		return uParam1;
...
BOOL func_43(Hash hParam0, int iParam1) // Position - 0x103D
{
	if (hParam0 == 0)
		return false;
...
int func_44(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, Hash hParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x1057
{
	int value;
	Hash TypeOfWeapon;
	Hash lootTableKey;
	...
	if (!flag)
	{
		if (func_62(hParam0, -1588156645))
		{
			bParam2 = true;
			flag2 = true;
			TypeOfWeapon = func_50(func_67(hParam0, true), false);
		
			if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
			{
				if (func_68() == -1)
					func_69(TypeOfWeapon);
			
				if (func_70(false) && func_71(TypeOfWeapon, 0, false, true, 0, false, hParam5, false))
				{
...
struct<2> func_45(int iParam0) // Position - 0x1B0B
{
	var unk;
...
void func_46(var uParam0, var uParam1, int iParam2) // Position - 0x1B1D
{
...
BOOL func_47(Hash hParam0, float fParam1, float fParam2, float fParam3, var uParam4, float fParam5, int iParam6, Hash hParam7) // Position - 0x1B3A
{
...
Hash func_48(Hash hParam0, int iParam1) // Position - 0x1B7B
{
	int num;
	var unk;
	Hash hash;
...
void func_49(Hash hParam0, float fParam1, float fParam2, float fParam3, var uParam4, Hash hParam5, int iParam6, int iParam7, Hash hParam8) // Position - 0x1BF5
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam4))
...
Hash func_50(Hash hParam0, BOOL bParam1) // Position - 0x1C35
{
	if (!func_43(hParam0, 0))
		return 0;
...
void func_51(Hash hParam0, float fParam1, float fParam2, float fParam3, var uParam4, Hash hParam5, int iParam6, Hash hParam7) // Position - 0x1C61
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam4))
		*uParam4 = func_99(hParam0, fParam1, iParam6, hParam7);
...
void func_52(Hash hParam0, float fParam1, float fParam2, float fParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, int iParam12, int iParam13, Hash hParam14, int iParam15, int iParam16) // Position - 0x1C9E
{
...
Hash func_53(Entity eParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x1D15
{
	...
	*uParam1 = 1;
	...
	for (i = 1; i <= 3; i = i + 1)
	{
		decoratorName = { unk };
		decoratorName2 = { unk };
		TEXT_LABEL_APPEND_INT(&decoratorName, i, 16);
		TEXT_LABEL_APPEND_INT(&decoratorName2, i, 16);
		TEXT_LABEL_APPEND_STRING(&decoratorName, "_type", 16);
		TEXT_LABEL_APPEND_STRING(&decoratorName2, "_amt", 16);
	
		if (DECORATOR::DECOR_EXIST_ON(eParam0, &decoratorName))
		{
			_int = DECORATOR::DECOR_GET_INT(eParam0, &decoratorName);
		
			if (_int != 0)
			{
				ammoTypeForWeapon = WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(_int);
				DECORATOR::DECOR_REMOVE(eParam0, &decoratorName);
			
				if (DECORATOR::DECOR_EXIST_ON(eParam0, &decoratorName2))
				{
					*uParam1 = DECORATOR::DECOR_GET_INT(eParam0, &decoratorName2);
					DECORATOR::DECOR_REMOVE(eParam0, &decoratorName2);
					*uParam2 = 2;
				}
...
void func_54(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, Hash hParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x21C5
{
	int i;
...
int func_55() // Position - 0x22A2
{
	return Global_1896646.f_41;
}

Vector3 func_56(int iParam0) // Position - 0x22B0
{
	var unk;
...
float func_57(Entity eParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x22FC
{
	if (!ENTITY::DOES_ENTITY_EXIST(eParam0))
		return 0f;
...
BOOL func_58(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x2324
{
	if (func_68() == -1)
	{
...
BOOL func_59(Hash hParam0, var uParam1, int iParam2) // Position - 0x237B
{
	var unk;
	int num;
	int num2;
...
void func_60(Hash hParam0, BOOL bParam1) // Position - 0x2419
{
	if (bParam1)
		return;
...
int func_61(Hash hParam0) // Position - 0x24CA
{
	var unk;
...
BOOL func_62(Hash hParam0, Hash hParam1) // Position - 0x24F5
{
	if (!func_43(hParam0, 0))
...
BOOL func_63(Hash hParam0, int iParam1) // Position - 0x2536
{
	if (!func_43(hParam0, 0))
		return false;
...
BOOL func_64(int iParam0) // Position - 0x2555
{
	if (!func_125(iParam0))
		return false;
...
void func_65(int iParam0) // Position - 0x2571
{
	if (!func_125(iParam0))
		return;
...
void func_66(Hash hParam0) // Position - 0x2592
{
...
Hash func_67(Hash hParam0, BOOL bParam1) // Position - 0x2617
{
	Hash hash;
...
int func_68() // Position - 0x280D
{
	return Global_1572887.f_14;
}

void func_69(Hash hParam0) // Position - 0x281B
{
	Hash weaponUnlock;
...
BOOL func_70(BOOL bParam0) // Position - 0x2855
{
	if (func_68() == -1)
		return true;
...
BOOL func_71(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, Hash hParam6, BOOL bParam7) // Position - 0x2873
{
	var unk;
	var unk6;
	var unk28;
...
BOOL func_72(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x29A3
{
	if (iParam1 < 1)
		return true;
...
BOOL func_73(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x29DE
{
	int num;
	var unk;
	var unk6;
...
BOOL func_74(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2A4D
{
	Hash TypeOfWeapon;
	var unk;
	int num;
	...
	TypeOfWeapon = func_50(hParam0, false);
	...
	if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
	{
		if (func_68() == -1)
		{
			...
			if (hParam1 == 1248274121)
				func_142(TypeOfWeapon);
		}
	
		if (!func_120(hParam0, &unk, 1, false, false, -1, false))
		{
			func_115(hParam0, 1, false, uParam2, hParam1);
			num = func_143(TypeOfWeapon);
		
			if (WEAPON::_IS_WEAPON_SNIPER(TypeOfWeapon))
			{
				func_71(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (TypeOfWeapon == joaat("weapon_fishingrod") || WEAPON::_IS_WEAPON_BINOCULARS(TypeOfWeapon))
			{
				func_71(TypeOfWeapon, 0, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::_IS_WEAPON_LASSO(TypeOfWeapon))
			{
				func_71(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::IS_WEAPON_MELEE_WEAPON(TypeOfWeapon))
			{
				if (TypeOfWeapon == joaat("weapon_melee_knife_john") && !func_144())
					return false;
			
				if (WEAPON::SHOULD_WEAPON_BE_DISCARDED_WHEN_SWAPPED(hParam0))
				{
				}
				else if (!func_145(TypeOfWeapon))
				{
					func_71(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
				}
				else
				{
					func_71(TypeOfWeapon, WEAPON::GET_WEAPON_CLIP_SIZE(TypeOfWeapon) * 4, bParam3, bParam4, 0, false, hParam1, false);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(TypeOfWeapon))
			{
				weaponHash = func_146(Global_33, 2, false, true);
			
				if (func_132(weaponHash) && !Global_26688 && weaponHash != TypeOfWeapon && !func_86(joaat("upgrade_offhand_holster"), 1) && bParam4)
					WEAPON::_SEND_WEAPON_TO_INVENTORY(Global_33, weaponHash);
			
				if (func_132(weaponHash) && func_86(joaat("upgrade_offhand_holster"), 1))
					if (!func_71(TypeOfWeapon, num, bParam3, bParam4, 3, true, hParam1, false))
						return false;
				else if (!func_71(TypeOfWeapon, num, bParam3, bParam4, 0, true, hParam1, false))
					return false;
			}
			else if (!func_71(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false))
			{
				return false;
			}
		}
...
BOOL func_75(Hash hParam0) // Position - 0x2C5B
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_76(Hash hParam0, var uParam1, Hash hParam2) // Position - 0x2C69
{
	int num;
	int weaponClipSize;
	int ReturnMaxAmmo;
...
struct<2> func_77(int iParam0, int iParam1) // Position - 0x2D67
{
	int num;
...
void func_78(int iParam0, BOOL bParam1) // Position - 0x2D7D
{
	int num;
	int num2;
...
BOOL func_79() // Position - 0x2DAA
{
	return false;
}

int func_80(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, int iParam5, BOOL bParam6, int iParam7) // Position - 0x2DB3
{
	int num;
...
void func_81(Hash hParam0) // Position - 0x2DFA
{
	return;
}

void func_82(Hash hParam0) // Position - 0x2E02
{
	return;
}

void func_83(Hash hParam0) // Position - 0x2E0A
{
	return;
}

void func_84(Hash hParam0) // Position - 0x2E12
{
	return;
}

void func_85() // Position - 0x2E1A
{
...
BOOL func_86(Hash hParam0, int iParam1) // Position - 0x2E3E
{
	int num;
...
void func_87(Hash hParam0, var uParam1) // Position - 0x2EC1
{
	var unk;
...
Hash func_88(Hash hParam0, BOOL bParam1) // Position - 0x2ED3
{
	Hash hash;
...
void func_89(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x2F01
{
	int num;
	int num2;
...
void func_90(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2F61
{
	int num;
	int num2;
...
void func_91(var uParam0) // Position - 0x2FDC
{
	switch (*uParam0)
	{
...
void func_92(Hash hParam0) // Position - 0x3020
{
	if (func_68() != -1)
		return;
...
int func_94(Hash hParam0, int iParam1) // Position - 0x304F
{
	var unk;
	var unk5;
...
struct<2> func_95(Hash hParam0) // Position - 0x3083
{
	var unk;
	var unk3;
...
void func_96(Hash hParam0) // Position - 0x3117
{
	switch (hParam0)
	{
...
void func_97(Hash hParam0, int iParam1) // Position - 0x3130
{
	char* str;
...
void func_98(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3171
{
	BOOL flag;
	int value;
	var unk;
	...
	else if (!func_169(hParam0, &InputString, num3, num2, 0, joaat("ui_itemviewer")))
	{
	...
	str3 = func_177(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash), value), num5);
	...
	if (num4 == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || num4 == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || num4 == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || num4 == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str3 = MISC::VAR_STRING(0, func_178(hParam0, -442898163));
	...
	if (num4 == -126813555 || num4 == 1946043663)
	{
		...
		if (func_179(hParam0, &unk7))
			str3 = func_181(func_180(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_164(str3, InputString.f_1, MISC::GET_HASH_KEY(InputString), num6, num5, str2, str, 0, true);
	return;
}

Object func_99(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, int iParam4, Hash hParam5) // Position - 0x364C
{
	Object objectIndexFromEntityIndex;
...
void func_100(var uParam0) // Position - 0x36D6
{
	if (func_182())
...
BOOL func_101(ScrHandle shParam0, float fParam1) // Position - 0x36F2
{
	return DECORATOR::DECOR_SET_FLOAT(shParam0, "fLoot_money", fParam1);
}

void func_102(Hash hParam0, var uParam1, var uParam2) // Position - 0x3705
{
	*uParam1 = 0;
	*uParam2 = 0;
...
void func_103(Ped pedParam0, Hash hParam1, int iParam2, BOOL bParam3) // Position - 0x3911
{
	Hash hash;
...
void func_104(Ped pedParam0, Hash hParam1) // Position - 0x3A05
{
	Hash hash;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x3A44
{
...
void func_106(ScrHandle shParam0, float fParam1, var uParam2, var uParam3, float fParam4, var uParam5, var uParam6) // Position - 0x3A6E
{
...
void func_107(ScrHandle shParam0, int iParam1) // Position - 0x3B3F
{
	if (!DECORATOR::DECOR_EXIST_ON(shParam0, "loot_item_type1"))
		if (iParam1 >= 0)
...
void func_108(Ped pedParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3B8A
{
	Hash hash;
...
Hash func_109(var uParam0) // Position - 0x3C2C
{
	return 0;
}

Hash func_110(Hash hParam0) // Position - 0x3C35
{
	if (WEAPON::IS_WEAPON_VALID(hParam0))
		return hParam0;
...
BOOL func_111(Hash hParam0) // Position - 0x3C4C
{
	return func_61(hParam0) == joaat("WEAPON");
}

BOOL func_112(Hash hParam0) // Position - 0x3C60
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

void func_113(var uParam0, var uParam1) // Position - 0x3C6E
{
...
BOOL func_114(Hash hParam0) // Position - 0x3C98
{
	var unk;
...
void func_115(Hash hParam0, int iParam1, BOOL bParam2, var uParam3, Hash hParam4) // Position - 0x3CDD
{
	Hash TypeOfWeapon;
	...
	if (bParam2 || !func_131(TypeOfWeapon))
	{
		if (bParam2 || !WEAPON::HAS_PED_GOT_WEAPON(Global_33, TypeOfWeapon, 0, false) && func_156(hParam0, false, false, false) == 0)
		{
			if (func_68() == -1)
				func_69(TypeOfWeapon);
...
void func_116(Hash hParam0, var uParam1) // Position - 0x3D87
{
...
struct<5> func_117(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3DAC
{
	var unk;
	int num;
	var unk6;
...
int func_118(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4123
{
	if (!func_43(hParam0, 0))
	{
...
int func_119(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4197
{
...
BOOL func_120(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x41CA
{
	var unk;
	var unk5;
	int num;
...
int func_122(Hash hParam0, int iParam1) // Position - 0x4363
{
	var unk;
	int num;
	int i;
...
Hash func_123(Hash hParam0) // Position - 0x43AD
{
	return hParam0;
}

BOOL func_124(Hash hParam0, Hash hParam1) // Position - 0x43B7
{
...
BOOL func_125(int iParam0) // Position - 0x43ED
{
	if (iParam0 == 0)
		return false;
...
BOOL func_126(int iParam0) // Position - 0x4400
{
	int num;
	int num2;
	int offset;
...
void func_127(int iParam0) // Position - 0x442A
{
	int num;
	int num2;
	int BitIndex;
...
void func_128(int iParam0) // Position - 0x4464
{
	switch (iParam0)
	{
		case 1:
...
int func_129(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x49E0
{
	var unk;
	var unk13;
	var unk26;
...
BOOL func_130(Hash hParam0) // Position - 0x4A10
{
	Hash weaponUnlock;
...
BOOL func_131(Hash hParam0) // Position - 0x4A38
{
	Hash weaponUnlock;
...
BOOL func_132(Hash hParam0) // Position - 0x4A60
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_133(BOOL bParam0) // Position - 0x4A7B
{
	if (func_68() == -1)
	{
...
BOOL func_134(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4ABC
{
	return func_193(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_135(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x4AD7
{
	var unk;
...
struct<4> func_136(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x4AF8
{
	var outGuid;
...
BOOL func_137(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x4B29
{
	var unk;
	int num;
	var unk15;
...
void func_138(Hash hParam0, int iParam1) // Position - 0x4C47
{
	...
	{
		AmmoInClip = func_210(WEAPON::GET_WEAPON_CLIP_SIZE(hParam0), iParam1);
...
int func_139(Hash hParam0, int iParam1) // Position - 0x4CB9
{
	if (iParam1 == 0)
		return 0;
...
int func_140(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x4CE5
{
	int num;
	var guid2;
	var guid1;
...
int func_141(Hash hParam0, Any* panParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x4D61
{
	if (!func_43(hParam0, 0))
		return 0;
...
void func_142(Hash hParam0) // Position - 0x4DC9
{
	char* decoratorName;
	char* decoratorName2;
	int value;
...
int func_143(Hash hParam0) // Position - 0x4E98
{
	int num;
	int pedAmmoByType;
...
BOOL func_144() // Position - 0x4F14
{
	return false;
}

BOOL func_145(Hash hParam0) // Position - 0x4F1D
{
	return WEAPON::_IS_AMMO_VALID(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0));
}

Hash func_146(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4F2F
{
...
int func_147(Hash hParam0) // Position - 0x4F55
{
	Hash weaponTypeFromAmmoType;
...
void func_148(int iParam0, var uParam1, var uParam2) // Position - 0x4FC1
{
	int num;
...
BOOL func_149(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4FDD
{
...
void func_150(int iParam0, int iParam1) // Position - 0x507F
{
	int Variable;
...
int func_151(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x50A3
{
	float num;
	int num2;
	int i;
...
void func_152(int iParam0, const char* sParam1, int iParam2, BOOL bParam3) // Position - 0x5173
{
	if (iParam0 == 0)
		return;
...
void func_153(int iParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x51C5
{
	int num;
	int value;
	int num2;
...
BOOL func_154(Hash hParam0, int iParam1) // Position - 0x52A0
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_155(Hash hParam0) // Position - 0x5348
{
	int num;
	int num2;
	int num3;
...
int func_156(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5404
{
...
Hash func_157(Hash hParam0, BOOL bParam1) // Position - 0x54C6
{
	switch (hParam0)
	{
...
BOOL func_158(int iParam0, int iParam1) // Position - 0x5568
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

void func_159(var uParam0, int iParam1) // Position - 0x5581
{
	BOOL flag;
	int i;
...
int func_160(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x56AD
{
	var unk;
	int num;
...
struct<2> func_161(int iParam0) // Position - 0x571C
{
	int num;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x572C
{
	switch (iParam0)
	{
		case 0:
...
Hash func_163(Hash hParam0) // Position - 0x5803
{
	Hash num;
...
int func_164(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x582D
{
	int num;
	var unk13;
	int num2;
...
BOOL func_165() // Position - 0x5890
{
	return !Global_1913444;
}

void func_166(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x589D
{
	int i;
...
var func_167(BOOL bParam0, var uParam1, var uParam2) // Position - 0x59C0
{
	if (bParam0)
		return uParam1;
...
int func_168(Hash hParam0) // Position - 0x59D7
{
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_169(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x5A02
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_170(Hash hParam0) // Position - 0x5AF5
{
...
BOOL func_171(Hash hParam0) // Position - 0x5BF1
{
...
BOOL func_172(int iParam0) // Position - 0x5C70
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_173(Hash hParam0) // Position - 0x5C97
{
	var unk;
	int i;
...
Hash func_174(Hash hParam0) // Position - 0x5D05
{
	int num;
	var unk;
	int collectionId;
...
int func_175(Hash hParam0, Hash hParam1) // Position - 0x5D8A
{
	if (hParam0 == 0)
		return 0;
...
int func_176(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x5DBB
{
	var unk;
...
const char* func_177(const char* sParam0, int iParam1) // Position - 0x5E1A
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_178(Hash hParam0, int iParam1) // Position - 0x5E34
{
	 num;
...
BOOL func_179(Hash hParam0, char* sParam1) // Position - 0x5E52
{
...
const char* func_180(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x5ECF
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_181(const char* sParam0, int iParam1) // Position - 0x5EE3
{
...
BOOL func_182() // Position - 0x5F19
{
	return Global_3145858 != 371211549;
}

Hash func_183(Ped pedParam0) // Position - 0x5F2B
{
...
BOOL func_184(Ped pedParam0, Hash hParam1, int iParam2, Hash hParam3) // Position - 0x5F77
{
	int argStruct;
	int num;
...
struct<4> func_185(BOOL bParam0) // Position - 0x5FB7
{
	int num;
...
struct<4> func_186(BOOL bParam0) // Position - 0x6057
{
	int num;
...
BOOL func_187(Hash hParam0, BOOL bParam1) // Position - 0x60F8
{
...
struct<4> func_188(BOOL bParam0) // Position - 0x612F
{
	int num;
...
BOOL func_189(Hash hParam0, int iParam1) // Position - 0x6199
{
	Hash hash;
	int num;
	int i;
...
BOOL func_190(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6206
{
	return func_246(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_191(Hash hParam0, int iParam1) // Position - 0x621C
{
	if (hParam0 == 0)
		return false;
...
int func_192(var uParam0) // Position - 0x6236
{
...
int func_193(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x62C0
{
...
BOOL func_194(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x633F
{
...
void func_195(BOOL bParam0) // Position - 0x6368
{
...
void func_196(int iParam0) // Position - 0x63A6
{
...
void func_197(BOOL bParam0) // Position - 0x6414
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_198(BOOL bParam0) // Position - 0x644E
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_199(BOOL bParam0) // Position - 0x6488
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_200(BOOL bParam0) // Position - 0x64C2
{
	Hash hash;
...
void func_201(BOOL bParam0) // Position - 0x64E5
{
	int promptType;
	Player player;
...
void func_202(BOOL bParam0) // Position - 0x6527
{
	int promptType;
	Player player;
...
BOOL func_203() // Position - 0x6569
{
	return true;
}

int func_204(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x6588
{
	int num;
	int num2;
	int num3;
...
int func_205(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x65EE
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_206(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x66CF
{
	int inventoryId;
...
BOOL func_207(Hash hParam0) // Position - 0x6714
{
...
int func_208(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x672A
{
	int num;
...
void func_209(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x6794
{
	int i;
...
int func_210(int iParam0, int iParam1) // Position - 0x6812
{
	if (iParam0 > iParam1)
		return iParam1;
...
int func_211() // Position - 0x6828
{
	return Global_1902569;
}

void func_212(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x6834
{
	int num;
	int i;
	int num2;
...
BOOL func_213(int iParam0, int iParam1) // Position - 0x69BC
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_214(int iParam0) // Position - 0x69D4
{
...
BOOL func_215(int iParam0) // Position - 0x69EB
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_216(int iParam0) // Position - 0x6AB7
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_217() // Position - 0x6ACA
{
	if (!func_262())
		return false;
...
void func_218(int iParam0, int iParam1) // Position - 0x6AE5
{
	if (iParam0 <= 0)
		return;
...
BOOL func_219() // Position - 0x6B21
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_220() // Position - 0x6B32
{
	return DLC::IS_DLC_PRESENT(joaat("dlc_ultimateedition"));
}

BOOL func_221(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x6B43
{
...
BOOL func_222(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x6B6A
{
	if (iParam2 < 0)
		return false;
...
int func_223(int iParam0) // Position - 0x6BA5
{
	if (iParam0 < 0)
		return 0;
...
int func_224(Hash hParam0) // Position - 0x6BC6
{
	switch (hParam0)
	{
...
int func_225(var uParam0, int iParam1) // Position - 0x6CA9
{
	int i;
...
int func_226(Hash hParam0) // Position - 0x6CE6
{
	int num;
...
int func_227(Hash hParam0, BOOL bParam1) // Position - 0x6D53
{
	var unk;
	int num;
	int num2;
...
struct<4> func_228(Hash hParam0, BOOL bParam1) // Position - 0x6DB2
{
	var unk;
...
void func_229(var uParam0) // Position - 0x6DD7
{
...
void func_230(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x6E0F
{
	int i;
	var unk;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_231(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x6EC5
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
void func_232(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x6FBB
{
...
BOOL func_233(Hash hParam0, Hash hParam1) // Position - 0x6FEC
{
	if (hParam1 == 0)
		return false;
...
int func_234(Hash hParam0) // Position - 0x7013
{
	var unk;
	int num;
...
struct<10> func_235(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x704D
{
	int num;
...
BOOL func_236(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x7121
{
...
BOOL func_237(Hash hParam0) // Position - 0x7142
{
	!func_43(hParam0, 0);
...
int func_238(int iParam0) // Position - 0x7168
{
	if (iParam0 < 0)
		return 0;
...
int func_239(Hash hParam0, int iParam1) // Position - 0x7189
{
	var unk;
	int num;
	int num2;
...
char* func_240(Hash hParam0) // Position - 0x71D7
{
	Hash labelHash;
...
BOOL func_241(Hash hParam0) // Position - 0x720D
{
...
char* func_242(Hash hParam0) // Position - 0x723B
{
	Hash labelHash;
...
struct<4> func_243() // Position - 0x7270
{
	var unk;
...
BOOL func_245(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x7299
{
...
BOOL func_246(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x72CC
{
...
BOOL func_247(Hash hParam0) // Position - 0x7306
{
	return func_62(hParam0, 1279601681);
}

void func_248(int iParam0, int iParam1) // Position - 0x7319
{
	if (iParam1 == 0)
		return;
...
void func_249(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x7349
{
	int i;
	var unk;
...
BOOL func_250(Hash hParam0, Any* panParam1) // Position - 0x7404
{
	int num;
...
BOOL func_251(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x75DA
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_252(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x75F1
{
	if (bParam0)
	{
...
int func_253(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0x763A
{
	if (bParam0)
	{
		func_270(iParam1, 1, 0, 0);
...
int func_254(int iParam0) // Position - 0x7656
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_255(int iParam0) // Position - 0x767B
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_256(int iParam0) // Position - 0x768E
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_257(int iParam0) // Position - 0x76A1
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_258(int iParam0) // Position - 0x76B4
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_259(int iParam0) // Position - 0x76C6
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_260(int iParam0, int iParam1) // Position - 0x76D8
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_261(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x7772
{
...
BOOL func_263() // Position - 0x77BE
{
	return Global_1913444.f_127 == 0;
}

struct<18> func_264(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x77CE
{
	Hash hash;
...
void func_265(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x78AC
{
...
BOOL func_266(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x78C7
{
...
int func_267() // Position - 0x78EC
{
	return Global_1953292.f_1;
}

BOOL func_268(Any anParam0) // Position - 0x78FA
{
...
BOOL func_269(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x7940
{
...
void func_270(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7958
{
	int i;
...
void func_271(var uParam0, int iParam1) // Position - 0x79F6
{
	if (iParam1 < 0)
		return;
...
void func_272(var uParam0, int iParam1) // Position - 0x7A7C
{
...
void func_273(var uParam0, int iParam1) // Position - 0x7AB8
{
	int num;
	int num2;
...
void func_274(var uParam0, int iParam1) // Position - 0x7B0B
{
...
void func_275(var uParam0, int iParam1) // Position - 0x7B46
{
...
void func_276(var uParam0, int iParam1) // Position - 0x7B7F
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_277(int iParam0, int iParam1) // Position - 0x7BB7
{
	return iParam0 && iParam1 != false;
}

void func_278(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x7BC6
{
	int i;
...
void func_279(int iParam0) // Position - 0x7CA2
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
void func_280(var uParam0) // Position - 0x7CC5
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
