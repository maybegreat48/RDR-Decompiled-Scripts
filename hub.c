...
void func_2(var uParam0) // Position - 0x4E
{
	BOOL flag;
...
void func_3(var uParam0) // Position - 0x8D
{
	func_12();
	func_13(uParam0);
...
void func_4(var uParam0, Hash hParam1) // Position - 0xAE
{
	uParam0->f_2 = hParam1;
	return;
}

int func_5(var uParam0) // Position - 0xBC
{
	int num;
	int num2;
	int i;
...
BOOL func_7(var uParam0) // Position - 0x11F
{
	if (SCRIPTS::IS_THREAD_EXIT_REQUESTED())
		return true;
...
void func_8(var uParam0) // Position - 0x133
{
	var eventData;
...
void func_9(var uParam0) // Position - 0x16D
{
...
void func_10(var uParam0) // Position - 0x1BC
{
...
void func_11(var uParam0) // Position - 0x204
{
	if (!uParam0->f_3)
		return;
...
int func_13(var uParam0) // Position - 0x27A
{
	int num;
	int num2;
	int i;
...
int func_14(int iParam0, int iParam1) // Position - 0x2AA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_15(var uParam0, int iParam1) // Position - 0x2E1
{
	switch (iParam1)
	{
		case joaat("hub"):
...
void func_17(var uParam0, var uParam1) // Position - 0x33A
{
	switch (*uParam1)
	{
		case -2075827635:
...
BOOL func_18(var uParam0, int iParam1) // Position - 0x36B
{
	return func_30(uParam0->f_1, iParam1);
}

void func_19(var uParam0, int iParam1, BOOL bParam2) // Position - 0x37D
{
	if (bParam2)
...
var func_20(var uParam0) // Position - 0x3A1
{
	return uParam0->f_2;
}

void func_21(var uParam0, Hash hParam1) // Position - 0x3AD
{
	switch (hParam1)
	{
		case joaat("hub"):
...
void func_22(var uParam0, Hash hParam1) // Position - 0x3CC
{
	switch (hParam1)
	{
		case joaat("hub"):
...
void func_23(var uParam0, Hash hParam1) // Position - 0x3EC
{
	switch (hParam1)
	{
		case joaat("hub"):
...
int func_24(var uParam0) // Position - 0x40B
{
...
void func_25(int iParam0) // Position - 0x487
{
	*iParam0 = -1;
	iParam0->f_3 = 0;
	iParam0->f_5 = -1;
...
void func_26(var uParam0, int iParam1) // Position - 0x4A6
{
	switch (iParam1)
	{
		case joaat("hub"):
...
BOOL func_27(var uParam0) // Position - 0x4C5
{
	if (!func_37(uParam0))
		return 0;
...
void func_28(var uParam0, var uParam1) // Position - 0x4DC
{
	switch (uParam1->f_2)
	{
		case -2135129228:
...
void func_29(var uParam0) // Position - 0x5CA
{
	func_47(uParam0);
	return;
}

BOOL func_30(int iParam0, int iParam1) // Position - 0x5D8
{
	return MISC::IS_BIT_SET(iParam0, iParam1);
}

void func_31(int* piParam0, int iParam1) // Position - 0x5E8
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

void func_32(int* piParam0, int iParam1) // Position - 0x5F8
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

void func_33(var uParam0) // Position - 0x608
{
	func_38(1667056592);
	return;
}

int func_34(var uParam0) // Position - 0x619
{
	func_48(uParam0);
...
void func_35(var uParam0) // Position - 0x64B
{
...
void func_36(var uParam0) // Position - 0x6F9
{
	func_33(uParam0);
	func_57(uParam0);
	return;
...
BOOL func_37(var uParam0) // Position - 0x70D
{
...
void func_38(int iParam0) // Position - 0x7F6
{
	int num;
...
void func_39(int iParam0, BOOL bParam1) // Position - 0x877
{
	if (func_16())
		return;
...
void func_40(var uParam0, int iParam1) // Position - 0x8A7
{
	uParam0->f_22 = iParam1;
	return;
}

void func_41(int iParam0) // Position - 0x8B5
{
...
void func_43(var uParam0) // Position - 0x955
{
	var unk;
	BOOL flag;
	float num;
...
void func_47(var uParam0) // Position - 0xAC4
{
	int num;
...
int func_48(var uParam0) // Position - 0xB40
{
...
void func_49(var uParam0, int iParam1) // Position - 0xB5C
{
	uParam0->f_3 = iParam1;
	return;
}

void func_50(var uParam0) // Position - 0xB6A
{
	var unk;
...
void func_51(int iParam0) // Position - 0xBB9
{
	if (func_16())
		return;
...
var func_52(var uParam0) // Position - 0xC15
{
	return uParam0->f_22;
}

BOOL func_53(var uParam0) // Position - 0xC21
{
	if (uParam0->f_3 <= 0)
	{
		if (func_82(uParam0))
...
void func_54(var uParam0) // Position - 0xC73
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(*uParam0))
		return;
...
void func_55(var uParam0) // Position - 0xC9F
{
	int collectionSize;
	int collectionId;
	var itemData;
...
void func_56(var uParam0, Hash hParam1, char* sParam2) // Position - 0xD87
{
...
void func_57(var uParam0) // Position - 0xDC3
{
...
int func_58(int iParam0) // Position - 0xDE4
{
	switch (iParam0)
	{
		case joaat("BUCK"):
...
int func_59(int iParam0) // Position - 0xE87
{
...
void func_61(int iParam0) // Position - 0xF02
{
...
int func_62(BOOL bParam0) // Position - 0xFA8
{
	if (func_101() == -1)
	{
...
Vector3 func_63(int iParam0) // Position - 0xFE9
{
	Blip blipIndex;

	blipIndex = func_102(iParam0);
...
void func_64(float fParam0, float fParam1, float fParam2, int iParam3) // Position - 0x100F
{
...
Vector3 func_66(int iParam0) // Position - 0x104C
{
	if (iParam0 == 255)
...
int func_67(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0x1078
{
	var unk;
	var unk6;
...
float func_68(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x10EE
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
int func_69(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x110C
{
	return func_106(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

void func_70() // Position - 0x1129
{
...
void func_72(int iParam0, int iParam1) // Position - 0x118B
{
	func_107(true, 0);
...
BOOL func_73(int iParam0) // Position - 0x11AF
{
	Hash unlockHash;
	int num;
...
BOOL func_74(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1209
{
...
BOOL func_75(var uParam0) // Position - 0x137F
{
	Hash itemContextByIndex;
	int arrayCount;
	int i;
...
struct<40> func_76(BOOL bParam0) // Position - 0x13D8
{
	var unk;
	int num;
	BOOL flag;
...
void func_77(var uParam0, const char* sParam1, Hash hParam2) // Position - 0x167B
{
...
void func_78(var uParam0, const char* sParam1) // Position - 0x16A1
{
	DATABINDING::_DATABINDING_WRITE_DATA_STRING(uParam0->f_3.f_3[0], sParam1);
	return;
}

void func_79(var uParam0, Hash hParam1, Hash hParam2) // Position - 0x16B8
{
...
void func_80(var uParam0, BOOL bParam1) // Position - 0x16DE
{
	DATABINDING::_DATABINDING_WRITE_DATA_BOOL(uParam0->f_3.f_3[5], bParam1);
	return;
}

void func_81(var uParam0, BOOL bParam1) // Position - 0x16F5
{
	DATABINDING::_DATABINDING_WRITE_DATA_BOOL(uParam0->f_3.f_3[6], bParam1);
	return;
}

BOOL func_82(var uParam0) // Position - 0x170C
{
	return func_121(*uParam0, 1);
}

void func_83(var uParam0) // Position - 0x171C
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_84(var uParam0, BOOL bParam1) // Position - 0x1732
{
...
int func_85(var uParam0) // Position - 0x1752
{
	if (!func_82(uParam0))
		return 0;
...
void func_86(var uParam0) // Position - 0x1798
{
	func_124(uParam0, 0f);
	return;
}

int func_87(var uParam0) // Position - 0x17A7
{
	Hash itemContextByIndex;
	int arrayCount;
	int i;
...
BOOL func_88(Any* panParam0) // Position - 0x181B
{
...
BOOL func_89(int iParam0) // Position - 0x1851
{
...
BOOL func_90(Hash hParam0) // Position - 0x1868
{
...
BOOL func_91(var uParam0, Any* panParam1, int iParam2) // Position - 0x1892
{
	var unk;
	var unk15;
...
BOOL func_92(var uParam0, int iParam1) // Position - 0x1919
{
	var unk;
	var unk37;
...
int func_93(var uParam0) // Position - 0x1948
{
	return DATABINDING::_DATABINDING_GET_ARRAY_COUNT(uParam0->f_3[1]);
}

int func_94(var uParam0, int iParam1) // Position - 0x195B
{
...
void func_95(var uParam0) // Position - 0x1979
{
	Hash itemContextByIndex;
	int arrayCount;
	int i;
...
Hash func_96(var uParam0) // Position - 0x19EC
{
	Hash hashKey;
...
void func_98() // Position - 0x1B36
{
	!UIAPPS::REQUEST_UIAPP_TRANSITION_BY_HASH(joaat("hub"), 1115220099);
	return;
}

int func_99(int iParam0) // Position - 0x1B50
{
	if (func_135())
		return 4;
...
int func_100(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1BB6
{
	int num;
	var unk10;
...
Blip func_102(int iParam0) // Position - 0x2557
{
	return Global_1110244.f_268.f_32[iParam0 /*752*/].f_1;
}

// Unhandled jump detected. Output should be considered invalid
BOOL func_103(BOOL bParam0) // Position - 0x256F
{
	var unk;
	int num;
	int num2;
...
int func_104() // Position - 0x2638
{
	return Global_1102813.f_3672;
}

BOOL func_105(Any* panParam0, var uParam1, var uParam2, var uParam3) // Position - 0x2647
{
	int fileHandle;
...
int func_106(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x26A1
{
	int num;
...
void func_107(BOOL bParam0, int iParam1) // Position - 0x2729
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
void func_108(int iParam0) // Position - 0x274B
{
	int num;
...
Hash func_109(int iParam0) // Position - 0x27B3
{
	switch (iParam0)
	{
		case 1:
...
int func_110(int iParam0, int iParam1) // Position - 0x2842
{
	switch (iParam1)
	{
		case 1:
...
BOOL func_111() // Position - 0x2AE4
{
	...
	if (!func_113(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_112(int iParam0) // Position - 0x2B3C
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_113(var uParam0, var uParam1) // Position - 0x2B50
{
	if (!func_193(uParam0))
		return false;
...
int func_114(var uParam0, var uParam1) // Position - 0x2B84
{
	return uParam0;
}

int func_115(int iParam0) // Position - 0x2B8E
{
	return func_196(func_195(iParam0));
}

BOOL func_116() // Position - 0x2BA0
{
	int num;
...
char* func_118(int iParam0) // Position - 0x2C9D
{
	int num;
	var unk5;
...
struct<2> func_119(int iParam0) // Position - 0x2CDE
{
	var unk;
	int num;
...
const char* func_120(int iParam0) // Position - 0x2D35
{
	return MISC::VAR_STRING(2, func_118(iParam0));
}

BOOL func_121(int iParam0, int iParam1) // Position - 0x2D48
{
	return iParam0 && iParam1 != false;
}

BOOL func_122(var uParam0) // Position - 0x2D57
{
	return func_121(*uParam0, 2);
}

int func_123() // Position - 0x2D67
{
...
void func_124(var uParam0, float fParam1) // Position - 0x2D85
{
...
BOOL func_125(Hash hParam0, int iParam1) // Position - 0x2DAB
{
	if (hParam0 == 0)
		return false;
...
int func_126(Hash hParam0) // Position - 0x2DC5
{
	var unk;
...
BOOL func_127(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x2DED
{
	return func_208(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_128(Hash hParam0) // Position - 0x2E03
{
	return func_159(hParam0) == -126813555;
}

BOOL func_129(Any* panParam0, var uParam1) // Position - 0x2E17
{
	var unk;
...
BOOL func_130(Hash hParam0) // Position - 0x2E40
{
	return func_159(hParam0) == 1946043663;
}

BOOL func_131(Any* panParam0, var uParam1) // Position - 0x2E54
{
	Hash hash;
	var unk;
...
BOOL func_132(var uParam0, var uParam1, int iParam2) // Position - 0x2EA0
{
	int arrayCount;
	var unk;
	var unk9;
...
void func_133(char* sParam0) // Position - 0x2F50
{
...
BOOL func_134(var uParam0, int iParam1) // Position - 0x2F9A
{
	int arrayCount;
	int i;
...
BOOL func_136(int iParam0) // Position - 0x3082
{
	int num;
...
BOOL func_137(int iParam0) // Position - 0x30A2
{
	Hash eInventoryItem;
...
Hash func_138(var uParam0, int iParam1) // Position - 0x30DF
{
	switch (*uParam0)
	{
		case 0:
...
Hash func_139(var uParam0, int iParam1) // Position - 0x32F7
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_141(Hash hParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3526
{
	int num;
	var unk;
	var unk6;
...
BOOL func_142(Hash hParam0, BOOL bParam1) // Position - 0x359E
{
	BOOL flag;
	int num;
...
BOOL func_143(Hash hParam0) // Position - 0x3670
{
	if (func_154(hParam0))
		return false;
...
BOOL func_144(Hash hParam0) // Position - 0x36EF
{
	var unk;
...
BOOL func_145(Hash hParam0, Hash hParam1) // Position - 0x3721
{
	if (!func_125(hParam0, 0))
...
void func_148(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x3772
{
	return;
}

BOOL func_149(Hash hParam0) // Position - 0x377A
{
...
BOOL func_150(Hash hParam0) // Position - 0x37B3
{
...
BOOL func_151(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x37E2
{
...
void func_152(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, int iParam16) // Position - 0x3BFF
{
	int i;
...
BOOL func_153() // Position - 0x3C9B
{
	return Global_1893611 & 2 != 0;
}

BOOL func_154(Hash hParam0) // Position - 0x3CAB
{
	if (!func_125(hParam0, 0))
		return false;
...
int func_155(int iParam0) // Position - 0x3CD5
{
	return func_262(iParam0);
}

int func_156(Hash hParam0) // Position - 0x3CE3
{
	var unk;
...
BOOL func_157(Hash hParam0) // Position - 0x3D0E
{
	if (hParam0 == 0)
		return false;
...
int func_158(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x3D3D
{
	int num;
	var unk13;
	int num2;
...
int func_159(Hash hParam0) // Position - 0x3D78
{
	var unk;
...
BOOL func_161(Player plParam0) // Position - 0x3E56
{
	Ped playerPed;
	Ped mountOwnedByPlayer;
...
void func_162(int iParam0, Hash hParam1, int iParam2, Ped pedParam3, BOOL bParam4) // Position - 0x3E88
{
	int num;
...
int func_163(Hash hParam0, BOOL bParam1) // Position - 0x3EBA
{
	int num;
...
void func_164(Hash hParam0) // Position - 0x3F31
{
	int num;
	Hash hash;
...
int func_165(Ped pedParam0, Hash hParam1, Hash hParam2, Hash hParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11) // Position - 0x4088
{
	var unk;
	int num;
...
void func_166(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x41E1
{
	var unk;
	var guid;
...
Hash func_167(int iParam0, BOOL bParam1) // Position - 0x4231
{
	int i;
	Hash hash;
	Hash hash2;
...
BOOL func_168(int iParam0, Hash hParam1) // Position - 0x42EC
{
	Ped EntityIndex;
...
BOOL func_169(int iParam0) // Position - 0x4393
{
	Ped EntityIndex;
...
Ped func_170(int iParam0) // Position - 0x43EC
{
	iParam0 = func_287(iParam0);
...
BOOL func_171(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x4418
{
...
BOOL func_173(int iParam0, int iParam1) // Position - 0x4579
{
	Any gangId;
...
int func_174(int iParam0, BOOL bParam1) // Position - 0x4639
{
	if (bParam1)
		func_305();
...
BOOL func_175(int iParam0) // Position - 0x4675
{
	return func_304(Global_1147183.f_8, iParam0);
}

BOOL func_176() // Position - 0x4689
{
	int num;
...
void func_178(Any anParam0) // Position - 0x475B
{
	var unk;
...
Hash func_179(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x47A0
{
...
void func_180(int iParam0, BOOL bParam1) // Position - 0x47E2
{
	int num;
	int num2;
...
void func_181(BOOL bParam0) // Position - 0x480F
{
...
struct<10> func_183(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x485E
{
	int num;
...
BOOL func_184(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x4932
{
...
Hash func_185(int iParam0, int iParam1) // Position - 0x4953
{
	int num;
...
BOOL func_186(Hash hParam0) // Position - 0x4996
{
	return NETWORK::NETWORK_AWARD_HAS_REACHED_MAXCLAIM(func_319(hParam0, false));
}

int func_187(int iParam0) // Position - 0x49A9
{
	if (iParam0 < 0)
		return 0;
...
int func_188(int iParam0) // Position - 0x49CA
{
	int num;
	int num2;
...
int func_189() // Position - 0x4A41
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

int func_190(int iParam0) // Position - 0x4A56
{
	switch (iParam0)
	{
		case 0:
...
void func_192(BOOL bParam0) // Position - 0x5474
{
	if (bParam0)
	{
...
BOOL func_193(int iParam0) // Position - 0x5498
{
	switch (iParam0)
	{
		case 2:
...
int func_194(int iParam0) // Position - 0x54D7
{
	switch (iParam0)
	{
		case 2:
...
int func_195(int iParam0) // Position - 0x556D
{
	switch (iParam0)
	{
		case 0:
...
int func_196(int iParam0) // Position - 0x55A6
{
	int num;
...
int func_197() // Position - 0x55DD
{
	return func_325(-1052513930);
}

BOOL func_198(int iParam0) // Position - 0x55EE
{
	return iParam0 != 0;
}

Hash func_199(int iParam0) // Position - 0x55FA
{
	int num;
	Hash num2;
...
int func_200() // Position - 0x5634
{
	return Global_1072759.f_28418[52 /*4*/].f_3;
}

int func_201(int iParam0) // Position - 0x5649
{
	switch (iParam0)
	{
		case 0:
...
char* func_202(int iParam0) // Position - 0x567A
{
	int num;
	var unk5;
...
char* func_203(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x56B4
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

struct<2> func_204(int iParam0) // Position - 0x56C8
{
	var unk;
	int num;
...
float func_205() // Position - 0x5714
{
	int networkTimeAccurate;
...
void func_206(var uParam0, int iParam1) // Position - 0x5746
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_207(var uParam0, int iParam1) // Position - 0x5757
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_208(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x576C
{
...
BOOL func_209(Any* panParam0, var uParam1) // Position - 0x57A6
{
	var unk;
...
BOOL func_210(Any* panParam0, var uParam1) // Position - 0x580B
{
	Any any;
	var unk;
	int i;
...
BOOL func_211(Hash hParam0) // Position - 0x59DC
{
	int num;
...
void func_212(char* sParam0) // Position - 0x5A2B
{
...
BOOL func_213(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10) // Position - 0x5A75
{
...
BOOL func_214(var uParam0, int iParam1, var uParam2) // Position - 0x5B0D
{
	int arrayCount;
...
BOOL func_215(var uParam0, var uParam1) // Position - 0x5B49
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(*uParam0))
		return false;
...
struct<2> func_216() // Position - 0x5BB0
{
...
int func_217(var uParam0, var uParam1) // Position - 0x5BFB
{
	var unk;
...
int func_218(int iParam0) // Position - 0x5C27
{
	switch (iParam0)
	{
		case 0:
...
Hash func_219(int iParam0) // Position - 0x5C6A
{
	switch (iParam0)
	{
		case 0:
...
int func_220(Hash hParam0, int iParam1) // Position - 0x5CC1
{
	if (iParam1 == 0)
		return 0;
...
BOOL func_221(Hash hParam0, int iParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0x5CED
{
	int num;
	var unk;
	int num2;
...
struct<5> func_222(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x5E05
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_223(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x6179
{
	var outGuid;
...
BOOL func_224(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x61AA
{
	var unk;
	int num;
	var unk15;
...
int func_225(Hash hParam0) // Position - 0x62C8
{
...
BOOL func_226(BOOL bParam0, int iParam1) // Position - 0x648F
{
	Ped mount;
...
BOOL func_228(Hash hParam0, int iParam1) // Position - 0x6916
{
	int num;
...
BOOL func_229(BOOL bParam0) // Position - 0x6999
{
	if (bParam0)
...
Any func_230(int iParam0, int iParam1) // Position - 0x69C9
{
	return DATABINDING::_DATABINDING_READ_DATA_BOOL(Global_1940252.f_1556.f_44.f_87);
}

int func_231() // Position - 0x69E0
{
	return Global_1915656.f_22504.f_5;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x69F1
{
	var unk;
	int num;
...
void func_233(int iParam0) // Position - 0x6C8A
{
	Global_1915656.f_22504.f_5 = iParam0;
	return;
}

Hash func_234(Hash hParam0) // Position - 0x6C9D
{
	return hParam0;
}

int func_235(Hash hParam0, Hash hParam1) // Position - 0x6CA7
{
...
int func_236(Hash hParam0) // Position - 0x6CDD
{
	int i;
...
int func_237(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6D09
{
	if (!func_382(iParam0))
		return 1;
...
int func_238(Hash hParam0, int iParam1) // Position - 0x6D8B
{
	var unk;
	int num;
	int i;
...
void func_239(int iParam0) // Position - 0x6DD5
{
	Global_1940252.f_11599 = iParam0;
	return;
}

Hash func_240(Hash hParam0) // Position - 0x6DE6
{
	if (!func_125(hParam0, 0))
		return 0;
...
void func_241(Hash hParam0) // Position - 0x6E03
{
	Global_1940252.f_11605 = hParam0;
	return;
}

BOOL func_242(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3, int iParam4) // Position - 0x6E14
{
...
BOOL func_243() // Position - 0x7167
{
	return Global_1953292.f_1676.f_1[1 /*3*/].f_1 == joaat("pomade");
}

BOOL func_244(Ped pedParam0) // Position - 0x7183
{
	if (!ENTITY::DOES_ENTITY_EXIST(*pedParam0) || ENTITY::IS_ENTITY_DEAD(*pedParam0))
		return false;
...
void func_245(Hash hParam0) // Position - 0x71BC
{
	Hash hash;
...
void func_246(Hash hParam0) // Position - 0x7256
{
	Hash hash;
...
void func_247(Hash hParam0, BOOL bParam1) // Position - 0x72D6
{
	Hash hash;
...
void func_248(Hash hParam0, BOOL bParam1) // Position - 0x7383
{
	Hash hash;
...
void func_249(Hash hParam0) // Position - 0x7430
{
	Hash hash;
...
void func_250(Hash hParam0) // Position - 0x74B0
{
	Hash hash;
...
void func_251(Hash hParam0) // Position - 0x7530
{
	Hash hash;
...
void func_252(Hash hParam0) // Position - 0x75B0
{
	Hash hash;
...
void func_253(Hash hParam0) // Position - 0x7630
{
	Hash hash;
...
void func_254(Hash hParam0) // Position - 0x76B0
{
	Hash hash;
...
void func_255(Hash hParam0) // Position - 0x7730
{
	Hash hash;
...
void func_256(Hash hParam0) // Position - 0x77B0
{
	Hash hash;
...
void func_257(Hash hParam0, BOOL bParam1) // Position - 0x7830
{
	Hash hash;
...
void func_258(Hash hParam0, BOOL bParam1) // Position - 0x78CE
{
	Hash hash;
...
BOOL func_259(int iParam0, int iParam1) // Position - 0x796D
{
	return iParam0 && iParam1 != false;
}

BOOL func_260(const char* sParam0) // Position - 0x797C
{
	int i;
...
void func_261(int iParam0) // Position - 0x79B6
{
...
int func_262(int iParam0) // Position - 0x79CD
{
	switch (iParam0)
	{
		case 0:
...
void func_263(BOOL bParam0) // Position - 0x7A0A
{
	Global_1953292 = Global_1953292 || bParam0;
	return;
}

void func_264(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7A1D
{
	int i;
	int num;
...
BOOL func_265() // Position - 0x7D19
{
	return Global_1953292.f_3502;
}

BOOL func_266(Hash hParam0) // Position - 0x7D28
{
	if (func_397())
		return false;
...
BOOL func_267(Hash hParam0) // Position - 0x7D5E
{
	return func_398(hParam0);
}

void func_268(var uParam0, int iParam1) // Position - 0x7D6C
{
	func_399(uParam0, iParam1);
	return;
}

int func_269(Hash hParam0, int iParam1) // Position - 0x7D7C
{
	Hash interactionAnimHash;
	BOOL flag;
	Hash hash;
...
BOOL func_270(BOOL bParam0) // Position - 0x7E63
{
	return Global_1953292 && bParam0 != false;
}

void func_271() // Position - 0x7E74
{
...
BOOL func_272(int iParam0, BOOL bParam1) // Position - 0x7F2B
{
	return func_409(iParam0, false) < func_410(iParam0, bParam1);
}

BOOL func_273(Hash hParam0) // Position - 0x7F43
{
	var unk;
...
void func_274(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0x7F53
{
	int num;
	BOOL flag;
...
Hash func_275(int iParam0) // Position - 0x8101
{
	if (iParam0 == 0)
		iParam0 = func_417();
...
void func_276(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x812C
{
...
Hash func_277(Hash hParam0) // Position - 0x8151
{
	int i;
...
int func_278(Hash hParam0, int iParam1) // Position - 0x818C
{
	switch (hParam0)
	{
		case -1944638739:
...
BOOL func_279(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x835D
{
	var unk;
	int num;
	int i;
...
void func_280(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x84FC
{
	func_429(&(Global_1953292.f_2938), bParam0, bParam1, bParam2, bParam3, bParam4);
	return;
}

BOOL func_281(Hash hParam0, BOOL bParam1) // Position - 0x8519
{
	!func_125(hParam0, 0);
...
BOOL func_282(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8564
{
	var unk;
	var unk5;
	Hash hash;
...
int func_283(Hash hParam0) // Position - 0x85ED
{
	int num;
	int num2;
...
void func_284(var uParam0, int iParam1) // Position - 0x8651
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

int func_285(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x8662
{
...
struct<4> func_286(BOOL bParam0) // Position - 0x86E1
{
	int num;
...
int func_287(int iParam0) // Position - 0x8781
{
	if (iParam0 == 7)
...
BOOL func_288(int iParam0) // Position - 0x879A
{
	Ped EntityIndex;
...
int func_289() // Position - 0x87FB
{
	return Global_38.f_289.f_3222;
}

BOOL func_290() // Position - 0x880C
{
	return Global_1915656.f_22504.f_1;
}

BOOL func_291(int iParam0) // Position - 0x881D
{
	return Global_1051832.f_3648 && iParam0 != false;
}

void func_292(int iParam0) // Position - 0x8831
{
	Global_1051832.f_3648 = Global_1051832.f_3648 - Global_1051832.f_3648 && iParam0;
	return;
}

void func_293(int iParam0) // Position - 0x8852
{
	Global_1051832.f_3649 = iParam0;
	return;
}

BOOL func_294() // Position - 0x8863
{
	return Global_1915656.f_22504;
}

void func_295() // Position - 0x8872
{
	PAD::_SET_CONTROL_CONTEXT(4, joaat("HandheldCatalogue"));
	return;
}

BOOL func_296() // Position - 0x8884
{
	return func_291(4);
}

int func_297(BOOL bParam0) // Position - 0x8891
{
	Player playerIndex;
...
void func_298(int iParam0) // Position - 0x8AF0
{
	int num;
...
BOOL func_302() // Position - 0x8B78
{
	return !func_300(2);
}

BOOL func_303(int iParam0) // Position - 0x8B86
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_304(int iParam0, int iParam1) // Position - 0x8BA7
{
	return iParam0 && iParam1 != false;
}

void func_305() // Position - 0x8BB6
{
...
BOOL func_306(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8BCD
{
	BOOL flag;
...
void func_307(int iParam0) // Position - 0x8BF5
{
	Global_1896762.f_365 = iParam0;
	return;
}

int func_308(Player plParam0) // Position - 0x8C06
{
	Player player;
...
int func_309(Player plParam0, BOOL bParam1) // Position - 0x8C36
{
	Player player;
	int i;
...
int func_310(int iParam0) // Position - 0x8CC0
{
	if (iParam0 == -1)
		return 0;
...
var func_311(int iParam0, int iParam1) // Position - 0x8CDC
{
...
void func_313(int iParam0, var uParam1, var uParam2) // Position - 0x8D94
{
	int num;
...
BOOL func_314(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x8DB0
{
...
void func_315(int iParam0, int iParam1) // Position - 0x8E52
{
	int Variable;
...
BOOL func_316(Ped pedParam0) // Position - 0x8E76
{
...
void func_318(int iParam0, Player plParam1) // Position - 0x8EAC
{
	Player player;
...
int func_319(Hash hParam0, BOOL bParam1) // Position - 0x8ECF
{
	var unk;
...
int func_320(int iParam0, int iParam1) // Position - 0x8F27
{
	switch (iParam0)
	{
		case joaat("hennigans_stead_camp"):
...
int func_321(int iParam0) // Position - 0x8FCF
{
	switch (iParam0)
	{
		case -2093379718:
...
BOOL func_322(int iParam0) // Position - 0x9112
{
...
int func_323(int iParam0) // Position - 0x9131
{
	if (!func_322(iParam0))
		return 0;
...
int func_324(int iParam0, BOOL bParam1) // Position - 0x9152
{
	Hash hash;
	int xp;
...
int func_325(int iParam0) // Position - 0x9211
{
	int num;
	int num2;
...
Hash func_326(int iParam0) // Position - 0x924B
{
	int num;
	int num2;
...
BOOL func_327(Hash hParam0) // Position - 0x9277
{
...
int func_328(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x92A5
{
	Hash hashKey;
	Hash hashKey2;
...
BOOL func_329(Any* panParam0) // Position - 0x9318
{
	if (!func_88(panParam0))
		return false;
...
BOOL func_330(Any* panParam0) // Position - 0x9334
{
	var unk;
...
BOOL func_331(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x9385
{
	if (!func_88(&uParam0))
		return false;
...
BOOL func_332(int iParam0, var uParam1, Any* panParam2) // Position - 0x93B4
{
	if (!func_113(iParam0))
		return false;
...
BOOL func_333(Hash hParam0, int iParam1) // Position - 0x94BF
{
	if (hParam0 == 0)
		return false;
...
BOOL func_334(Hash hParam0) // Position - 0x94D9
{
...
BOOL func_335(BOOL bParam0) // Position - 0x94EF
{
	if (func_101() == -1)
		return true;
...
BOOL func_336(Any anParam0, var uParam1, Hash hParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x950D
{
	*uParam1 = 0;
...
struct<17> func_337(Hash hParam0, var uParam1) // Position - 0x957A
{
	var unk;
...
int func_338(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x95CD
{
	int num;
...
void func_339(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x9637
{
	int i;
...
struct<4> func_340(BOOL bParam0) // Position - 0x96B5
{
	int num;
...
int func_341(Hash hParam0, BOOL bParam1) // Position - 0x9756
{
...
BOOL func_342(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x978D
{
	return func_285(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_343(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x97A8
{
	var unk;
...
struct<4> func_344(BOOL bParam0) // Position - 0x97C9
{
	int num;
...
BOOL func_345(Hash hParam0, int iParam1) // Position - 0x9833
{
	Hash hash;
	int num;
	int i;
...
int func_346(Hash hParam0) // Position - 0x98A0
{
	if (func_125(hParam0, 0))
	{
...
int func_347() // Position - 0x9942
{
	return 225949718;
}

BOOL func_348(Hash hParam0) // Position - 0x994F
{
	return hParam0 == 1401465909 || hParam0 == joaat("kit_collectors_bag");
}

int func_349() // Position - 0x996D
{
	return 1039657088;
}

BOOL func_350(Hash hParam0) // Position - 0x997A
{
...
int func_351() // Position - 0x9A3C
{
	return 1039392896;
}

int func_352() // Position - 0x9A49
{
	return 1039645941;
}

int func_353() // Position - 0x9A56
{
	return 1039907016;
}

int func_354() // Position - 0x9A63
{
	return 1039902864;
}

int func_355() // Position - 0x9A70
{
	return 955497620;
}

int func_356() // Position - 0x9A7D
{
	return 1022861303;
}

int func_357() // Position - 0x9A8A
{
	return 1039902720;
}

int func_358() // Position - 0x9A97
{
	return 972554239;
}

int func_359() // Position - 0x9AA4
{
	return 905165831;
}

int func_360() // Position - 0x9AB1
{
	return 1038298244;
}

int func_361() // Position - 0x9ABE
{
	return 1037713383;
}

int func_362() // Position - 0x9ACB
{
	return 1039645911;
}

int func_363() // Position - 0x9AD8
{
	return 1039655040;
}

BOOL func_364(int iParam0) // Position - 0x9AE5
{
	return func_304(Global_1940085.f_7, iParam0);
}

BOOL func_365(int iParam0, int iParam1) // Position - 0x9AF9
{
	return iParam0 && iParam1 != false;
}

BOOL func_366(BOOL bParam0) // Position - 0x9B08
{
	Entity entity;
...
BOOL func_367(BOOL bParam0, BOOL bParam1) // Position - 0x9B9B
{
	var unk;
...
BOOL func_368(BOOL bParam0, int iParam1, BOOL bParam2) // Position - 0x9BEB
{
	Vehicle vehiclePedIsUsing;
	Hash entityModel;
...
BOOL func_369(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x9CD8
{
...
BOOL func_370(Ped pedParam0) // Position - 0x9D31
{
...
BOOL func_371(Ped pedParam0, BOOL bParam1) // Position - 0x9D4E
{
	float entitySpeed;
	float num;
...
BOOL func_372() // Position - 0x9DA4
{
	return Global_1940252.f_2 || Global_1940252 == 1;
}

BOOL func_373(BOOL bParam0) // Position - 0x9DBE
{
	return Global_1958675 && bParam0 != false;
}

BOOL func_374(Hash hParam0, int iParam1) // Position - 0x9DCF
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_375(Hash hParam0) // Position - 0x9E77
{
	int num;
	int num2;
	int num3;
...
int func_376(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9F33
{
...
int func_377(var uParam0, int iParam1) // Position - 0x9FF5
{
	int num;
	int num2;
	int num3;
...
BOOL func_378(int iParam0, int iParam1, BOOL bParam2) // Position - 0xA078
{
	return !MISC::IS_STRING_NULL_OR_EMPTY_OR_SPACES(func_380(func_489(iParam0, iParam1, bParam2)));
}

struct<8> func_379(int iParam0, int iParam1) // Position - 0xA093
{
	return func_489(iParam0, iParam1, true);
}

char* func_380(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xA0A4
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

BOOL func_381(int iParam0, Hash hParam1) // Position - 0xA0B8
{
	int i;
...
BOOL func_382(int iParam0) // Position - 0xA104
{
	return iParam0 >= 0 && iParam0 < 50;
}

BOOL func_383(int iParam0) // Position - 0xA11A
{
	float num;
	int i;
	int j;
...
BOOL func_384(int iParam0) // Position - 0xA22B
{
	int i;
...
BOOL func_385(int iParam0) // Position - 0xA279
{
	int i;
...
BOOL func_386() // Position - 0xA2C6
{
	return func_496(func_112(0));
}

BOOL func_387(Ped pedParam0, Hash hParam1, BOOL bParam2) // Position - 0xA2D7
{
	if (!bParam2)
		if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
			return false;
...
int func_388() // Position - 0xA2FB
{
	...
	if (ReturnWeaponType2 == joaat("WEAPON_UNARMED"))
		if (ReturnWeaponType == joaat("WEAPON_UNARMED"))
			return 1;
		else if (WEAPON::IS_WEAPON_VALID(ReturnWeaponType) && WEAPON::_IS_WEAPON_TWO_HANDED(ReturnWeaponType) && !func_497(ReturnWeaponType) && !PED::IS_PED_FULLY_ON_MOUNT(Global_33, true) && !(PED::IS_PED_IN_ANY_VEHICLE(Global_33, false) && !CAM::IS_FIRST_PERSON_CAMERA_ACTIVE(1, 0, 0)))
			return 3;
		else if (WEAPON::_IS_WEAPON_BINOCULARS(ReturnWeaponType))
			return 1;
		else if (WEAPON::IS_WEAPON_VALID(ReturnWeaponType) && func_497(ReturnWeaponType) || WEAPON::_IS_WEAPON_LASSO(ReturnWeaponType))
			return 1;
		else
			return 0;
...
int func_389(Hash hParam0) // Position - 0xA3EE
{
	switch (hParam0)
	{
...
void func_390(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA5C9
{
	Hash hash;
	int num;
...
BOOL func_391(Ped pedParam0, Hash hParam1, Hash hParam2, int iParam3, BOOL bParam4) // Position - 0xA63F
{
...
void func_392(Hash hParam0) // Position - 0xA678
{
	int num;
	var unk22;
	int i;
...
int func_393(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0xA9BC
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
void func_394(int iParam0) // Position - 0xAB6E
{
...
BOOL func_395(int iParam0) // Position - 0xABB4
{
	return Global_1953292.f_595[iParam0] > 0;
}

void func_396(int iParam0) // Position - 0xABC9
{
	Global_1953292.f_595[iParam0] = Global_1953292.f_595[iParam0] + 1;
	return;
}

BOOL func_397() // Position - 0xABE9
{
...
BOOL func_398(Hash hParam0) // Position - 0xAC33
{
	int num;
...
void func_399(var uParam0, int iParam1) // Position - 0xAC83
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_400(Hash hParam0) // Position - 0xAC94
{
	Hash hash;
...
BOOL func_401(var uParam0) // Position - 0xACBE
{
...
BOOL func_406(var uParam0) // Position - 0xAE77
{
...
void func_407(BOOL bParam0) // Position - 0xAEA4
{
	Global_1953292 = Global_1953292 - Global_1953292 && bParam0;
	return;
}

void func_408(int iParam0, int iParam1, int iParam2) // Position - 0xAEBC
{
...
int func_409(int iParam0, BOOL bParam1) // Position - 0xAEFB
{
	switch (iParam0)
	{
		case -2061583405:
...
int func_410(int iParam0, BOOL bParam1) // Position - 0xAF9E
{
	int num;
...
BOOL func_411(Hash hParam0, var uParam1) // Position - 0xB04D
{
	*uParam1 = 0;
	*uParam1 = 0;
...
BOOL func_412(Hash hParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB08D
{
	var unk;
	Hash hash;
...
BOOL func_414(int iParam0) // Position - 0xB1DC
{
	return func_530(func_529(iParam0));
}

void func_415(BOOL bParam0, Hash hParam1) // Position - 0xB1EE
{
	char* StringToTest;
	char* str;
	char* str2;
	...
	if (!func_531(hParam1, &StringToTest, joaat("Inventory"), 0, 0, joaat("ui_itemviewer")))
	{
	...
	if (bParam0)
	{
		...
		else
		{
			...
			str = "ITEM_STORED";
			str3 = MISC::VAR_STRING(0, func_536(hParam1, false));
		}
	}
	else
	{
	...
	str4 = func_537(MISC::VAR_STRING(10, str, str3), num);
	func_538(str4, StringToTest.f_1, MISC::GET_HASH_KEY(StringToTest), 0, num, "Transaction_Feed_Sounds", str2, 0, true);
	return;
}

void func_416(BOOL bParam0, BOOL bParam1) // Position - 0xB351
{
	if (bParam1)
		func_539();
...
int func_417() // Position - 0xB383
{
	return Global_1953292.f_1;
}

BOOL func_418(Hash hParam0, Hash hParam1) // Position - 0xB391
{
	int num;
	int num2;
...
void func_419(Hash hParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0xB3CD
{
...
int func_420(int iParam0, int iParam1) // Position - 0xB3F0
{
	switch (iParam0)
	{
		case 0:
...
void func_422(int iParam0) // Position - 0xB686
{
	func_408(iParam0, 8, 6);
	return;
}

void func_423(Hash hParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0xB697
{
	int num;
	Hash hash;
	...
	if (bParam3)
	{
		if (*uParam1 == 832230214 || *uParam1 == 30652334 || *uParam1 == 750544038)
		{
			...
			if (func_159(hParam0->f_1[num /*3*/]) != 1882579758)
				return;
		
			hash = func_542(hParam0->f_1[num /*3*/]);
...
void func_424(int iParam0) // Position - 0xB745
{
	func_544(&(Global_1953292.f_2938), iParam0);
	return;
}

void func_425(int iParam0, int iParam1) // Position - 0xB75A
{
	if (iParam1 & 8 != 0)
		return;
...
void func_426(Hash hParam0, int iParam1, int iParam2) // Position - 0xB77D
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

void func_427(Hash hParam0, Hash hParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xB790
{
	Hash hash;
	BOOL flag;
	...
	if (bParam3 && func_145(hParam0->f_1[iParam2 /*3*/], 343781202))
		func_546(hParam0, hParam0->f_1[iParam2 /*3*/]);

	switch (func_420(iParam2, 1))
	{
		case -1944638739:
			func_562(hParam0, flag, hash, iParam4);
			break;
	
		case -1197751823:
			func_555(hParam0, flag, hash, iParam4);
			break;
	
		case joaat("MP_COMPONENT_TYPE_HAIR"):
			func_547(hParam0, hash, iParam2, iParam4);
			break;
	
		case -893163968:
			func_553(hParam0, flag, hash, iParam4);
			break;
	
		case -450913544:
			func_554(hParam0, flag, hash, iParam2, iParam4);
			break;
	
		case -426430150:
			func_559(hParam0, flag, iParam4);
			break;
	
		case -338487716:
			func_549(hParam0, hash, flag, iParam4);
			break;
	
		case joaat("MP_COMPONENT_TYPE_LOADOUT_2"):
			func_558(hParam0, flag, hash, iParam4);
			break;
	
		case 304805134:
			func_556(hParam0, flag, hash, iParam4);
			break;
	
		case 788010710:
			func_560(hParam0, flag, hash, iParam4);
			break;
	
		case 1108822547:
			func_550(hParam0, flag, hash, iParam4);
			break;
	
		case 1145151482:
			func_557(hParam0, flag, hash, iParam4);
			break;
	
		case 1250092473:
			func_552(hParam0, flag, hash, iParam4);
			break;
	
		case joaat("MP_COMPONENT_TYPE_BEARD"):
			func_548(hParam0, hash, iParam2);
			break;
	
		case 1742327865:
			func_551(hParam0, flag, hash, iParam4);
			break;
	
		case 1958421083:
			func_561(hParam0, flag, hash, iParam4);
			break;
	}
...
Hash func_428(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xB929
{
	BOOL flag;
...
void func_429(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5) // Position - 0xB98A
{
	int i;
	int num;
	BOOL flag;
...
Hash func_430(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0xBAC9
{
	return func_570(&uParam0, hParam4, bParam5, iParam6);
}

BOOL func_431(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xBADD
{
	var unk;
...
struct<4> func_432() // Position - 0xBB51
{
	var unk;
...
BOOL func_433(Ped pedParam0) // Position - 0xBB5D
{
	if (PED::IS_PED_INJURED(pedParam0))
		return false;
...
BOOL func_435(int iParam0, int iParam1) // Position - 0xBCC9
{
...
BOOL func_436(Player plParam0) // Position - 0xBD14
{
	if (plParam0 == 255)
...
BOOL func_437(int iParam0) // Position - 0xBD39
{
...
void func_440(BOOL bParam0) // Position - 0xBDA0
{
...
BOOL func_441() // Position - 0xBDE0
{
	return Global_1915656.f_20643;
}

BOOL func_442(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0xBDEF
{
	Player PlayerIndex;
	Ped EntityIndex;
	BOOL isEntityDead;
...
BOOL func_443(int iParam0, int iParam1, Player plParam2) // Position - 0xC016
{
	return func_304(Global_1206166[plParam2 /*10*/][iParam0], iParam1);
}

var func_444(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0xC030
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_581(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
int func_445(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0xC3C3
{
	if (!func_585(uParam0))
		return 0;
...
BOOL func_446(int iParam0, int iParam1) // Position - 0xC3F3
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_447(int iParam0) // Position - 0xC40B
{
...
BOOL func_448(int iParam0) // Position - 0xC422
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_449(int iParam0, int iParam1) // Position - 0xC4EE
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_450(int iParam0) // Position - 0xC507
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_451() // Position - 0xC51A
{
	if (!func_301())
		return false;
...
int func_452(Hash hParam0, BOOL bParam1) // Position - 0xC535
{
	int num;
...
Hash func_453(int iParam0) // Position - 0xC56E
{
	switch (iParam0)
	{
		case 0:
...
int func_454(int iParam0) // Position - 0xC707
{
...
Hash func_455(int iParam0) // Position - 0xC733
{
	switch (iParam0)
	{
		case 0:
...
int func_456(int iParam0) // Position - 0xC8CC
{
	int num;
	int num2;
...
BOOL func_457(Any* panParam0) // Position - 0xC8F8
{
	if (!func_88(panParam0))
		return false;
...
BOOL func_458(var uParam0) // Position - 0xC914
{
	return UNLOCK::_UNLOCK_IS_NEW(func_586(uParam0));
}

int func_459(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xC926
{
	if (!func_88(&uParam0))
		return 0;
...
BOOL func_460(int iParam0) // Position - 0xC942
{
	if (iParam0 <= 0)
		return false;
...
void func_461(Any* panParam0) // Position - 0xC960
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_462(Any anParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0xC976
{
	int i;
...
BOOL func_463(Hash hParam0, Any* panParam1) // Position - 0xCA8D
{
	int num;
...
BOOL func_464(int iParam0, Hash hParam1, Any* panParam2) // Position - 0xCC63
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_465(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0xCC7A
{
	if (bParam0)
	{
...
int func_466(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0xCCC3
{
	if (bParam0)
	{
		func_589(iParam1, 1, 0, 0);
...
BOOL func_468(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0xCCFC
{
	int inventoryId;
...
BOOL func_469(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xCD41
{
...
int func_470() // Position - 0xCD74
{
	return 1037647863;
}

int func_471() // Position - 0xCD81
{
	return 1037746167;
}

int func_472() // Position - 0xCD8E
{
	return 1035451607;
}

Entity func_473(Ped pedParam0) // Position - 0xCD9B
{
	int lootTarget;
...
Hash func_474(Hash hParam0, int iParam1) // Position - 0xCDFB
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_475(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0xCE75
{
...
BOOL func_476(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0xCE9C
{
	if (iParam2 < 0)
		return false;
...
BOOL func_477(Hash hParam0) // Position - 0xCED7
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_478(int iParam0) // Position - 0xCEF2
{
	if (iParam0 < 0)
		return 0;
...
int func_479(Hash hParam0) // Position - 0xCF13
{
	switch (hParam0)
	{
...
int func_480(var uParam0, int iParam1) // Position - 0xCFF6
{
	int i;
...
int func_481(Hash hParam0) // Position - 0xD033
{
	int num;
...
int func_482(Hash hParam0, BOOL bParam1) // Position - 0xD0A0
{
	var unk;
	int num;
	int num2;
...
struct<4> func_483(Hash hParam0, BOOL bParam1) // Position - 0xD0FF
{
	var unk;
...
int func_484(int iParam0) // Position - 0xD124
{
	int num;
	int num2;
...
int func_485(int iParam0) // Position - 0xD14F
{
	if (iParam0 == -1)
		return -1;
...
int func_486(int iParam0) // Position - 0xD16B
{
	switch (iParam0)
	{
		case 0:
...
int func_487(int iParam0) // Position - 0xD320
{
	int num;
...
int func_488(int iParam0) // Position - 0xD347
{
	return Global_1110244.f_3667[iParam0 /*7*/];
}

struct<8> func_489(int iParam0, int iParam1, BOOL bParam2) // Position - 0xD35A
{
	var unk;
	var unk6;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xD40D
{
...
float func_491(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xD437
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
BOOL func_492(int iParam0) // Position - 0xD455
{
	return func_304(Global_1220826.f_1196, iParam0);
}

BOOL func_493() // Position - 0xD46A
{
	return Global_263042[Global_1295666 /*65*/] > 2;
}

BOOL func_494(BOOL bParam0, int iParam1) // Position - 0xD47E
{
...
BOOL func_495(Hash hParam0) // Position - 0xD4BA
{
...
BOOL func_496(var uParam0, var uParam1) // Position - 0xD4D1
{
	return func_605(uParam0, 1, 4);
}

BOOL func_497(Hash hParam0) // Position - 0xD4E3
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

Hash func_498(int iParam0) // Position - 0xD4F1
{
	switch (iParam0)
	{
		case 2:
...
void func_499(int iParam0, BOOL bParam1) // Position - 0xD7AC
{
	if (!func_500(iParam0))
		return;
...
BOOL func_500(int iParam0) // Position - 0xD7D2
{
	return !(iParam0 <= 0);
}

BOOL func_501(int iParam0) // Position - 0xD7DF
{
	if (!func_500(iParam0))
		return false;
...
void func_502(int iParam0, BOOL bParam1) // Position - 0xD7FD
{
	if (!func_500(iParam0))
		return;
...
BOOL func_503(int iParam0) // Position - 0xD840
{
	if (!func_500(iParam0))
		return false;
...
void func_504(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xD85E
{
	if (!func_500(iParam0))
		return;
...
void func_505(BOOL bParam0, int iParam1) // Position - 0xD8C0
{
...
float func_506(int iParam0, int iParam1) // Position - 0xD906
{
	int num;
	float pedStamina;
	float pedMaxStamina;
...
void func_507(int iParam0) // Position - 0xD9BB
{
	Ped ped;
	int num;
...
void func_508(int iParam0, BOOL bParam1) // Position - 0xD9F8
{
	int num;
...
void func_509(int iParam0) // Position - 0xDA2D
{
	Ped ped;
	int num;
...
float func_510(float fParam0, float fParam1) // Position - 0xDA6A
{
	if (fParam1 != 0f)
...
void func_511(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xDA98
{
	if (fParam1 == 0f)
		return;
...
float func_512(float fParam0, int iParam1) // Position - 0xDAD1
{
	switch (iParam1)
	{
		case 0:
...
int func_513(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xDB23
{
	if (!ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		return 0;
...
void func_514(float fParam0, BOOL bParam1) // Position - 0xDB47
{
	if (fParam0 > 10f)
		fParam0 = 10f;
...
struct<2> func_515(int iParam0) // Position - 0xDB9F
{
	int num;
...
void func_516(var uParam0, var uParam1, int iParam2) // Position - 0xDBAF
{
...
BOOL func_517(Hash hParam0) // Position - 0xDBCC
{
	return func_156(hParam0) == joaat("consumable");
}

void func_518(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xDBE0
{
	BOOL flag;
	int value;
	var unk;
	...
	else if (!func_531(hParam0, &InputString, num3, num2, 0, joaat("ui_itemviewer")))
	{
	...
	str3 = func_537(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash), value), num5);
	...
	if (num4 == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || num4 == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || num4 == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || num4 == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str3 = MISC::VAR_STRING(0, func_635(hParam0, -442898163));
	...
	if (num4 == -126813555 || num4 == 1946043663)
	{
		...
		if (func_636(hParam0, &unk7))
			str3 = func_638(func_637(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_538(str3, InputString.f_1, MISC::GET_HASH_KEY(InputString), num6, num5, str2, str, 0, true);
	return;
}

struct<2> func_519(Hash hParam0) // Position - 0xE0BA
{
	var unk;
	var unk3;
...
BOOL func_520(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0xE14E
{
	var unk;
	int num;
	int num2;
...
void func_521(int iParam0, BOOL bParam1, int iParam2) // Position - 0xE21A
{
...
int func_523(int iParam0) // Position - 0xE2EA
{
	int num;
...
BOOL func_524(int iParam0, var uParam1) // Position - 0xE319
{
	Hash hash;
	int num;
...
Hash func_525(Hash hParam0) // Position - 0xE3AF
{
	return Global_1953292.f_1676.f_1[func_278(hParam0, 1) /*3*/];
}

int func_526() // Position - 0xE3C9
{
	int i;
	Hash hash;
	int num;
...
BOOL func_527(Hash hParam0, int iParam1) // Position - 0xE41A
{
	if (iParam1 == 0)
...
BOOL func_528(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE483
{
	var unk;
	var guid;
...
int func_529(int iParam0) // Position - 0xE4D5
{
	switch (iParam0)
	{
		case -2061583405:
...
BOOL func_530(int iParam0) // Position - 0xE530
{
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_531(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0xE548
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
int func_532(Hash hParam0) // Position - 0xE63B
{
	switch (hParam0)
	{
		case -2011879201:
...
BOOL func_533(BOOL bParam0, int iParam1) // Position - 0xE6BD
{
	if (iParam1 == -1)
...
struct<8> func_534(int iParam0) // Position - 0xE700
{
	var unk;
...
Hash func_535(Hash hParam0) // Position - 0xE735
{
	int num;
	var unk;
	int collectionId;
...
Hash func_536(Hash hParam0, BOOL bParam1) // Position - 0xE7BA
{
	Hash hash;
...
const char* func_537(const char* sParam0, int iParam1) // Position - 0xE7E8
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

int func_538(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0xE802
{
	int num;
	var unk13;
	int num2;
...
void func_539() // Position - 0xE865
{
	Global_1953292.f_1046 = 0;
	return;
}

BOOL func_540(Hash hParam0) // Position - 0xE875
{
	if (!func_125(hParam0, 0))
		return false;
...
void func_541(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE8B1
{
	BOOL flag;
	var unk;
	var unk120;
...
Hash func_542(Hash hParam0) // Position - 0xEA37
{
	int num;
	var unk;
...
BOOL func_543(Hash hParam0, int iParam1) // Position - 0xEA7B
{
	int num;
...
void func_544(int iParam0, int iParam1) // Position - 0xEB22
{
	int i;
	int num;
	var unk;
...
void func_545(int iParam0, int iParam1, int iParam2) // Position - 0xEC1F
{
	int i;
	int j;
...
void func_546(Hash hParam0, var uParam1) // Position - 0xED05
{
	int num;
	int num2;
	int num3;
...
void func_547(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xEDB8
{
	int num;
	int num2;
	...
	num = 10;
	num2 = func_159(hParam0->f_1[num /*3*/]);
	...
	if (func_145(hParam0->f_1[num /*3*/], -1446529222) && func_145(hParam1, -93469181))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_145(hParam1, -93469181) && func_145(hParam0->f_1[num /*3*/], -1303648999))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
...
void func_548(Hash hParam0, Hash hParam1, int iParam2) // Position - 0xEF8D
{
...
void func_549(Hash hParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0xEFD2
{
	int num;
	Hash hash;
...
void func_550(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF09B
{
	switch (func_159(hParam2))
	{
		case -525676072:
			func_658(hParam0, bParam1, iParam3);
			break;
	
		case 2086043523:
			func_659(hParam0, bParam1, iParam3);
			break;
	}
...
void func_551(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF0D5
{
	int num;

	num = 18;

	if (func_159(hParam0->f_1[num /*3*/]) == 912453393)
		func_425(num, iParam3);
	...
	if (func_540(hParam2))
		func_660(hParam0, bParam1, iParam3);

	num = 11;

	if (func_145(hParam2, -180472385) && !func_281(hParam0->f_1[num /*3*/], false))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
...
void func_552(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF215
{
	int num;
	int metapedType;
	Hash hash;
	...
	if (!func_281(hParam0->f_1[num /*3*/], false) && func_145(hParam2, 1467402774))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
	...
	if (!func_281(hParam0->f_1[num /*3*/], false) && func_145(hParam2, 1126863852))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
	...
	{
		hParam0->f_1[num /*3*/] = func_542(hParam2);
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
	}
	else if (func_661(hash, bParam1, metapedType))
	{
		...
		if (hash != 0)
		{
			...
			hParam0->f_1[num /*3*/].f_1 = 0;
			func_425(num, iParam3);
			func_560(hParam0, false, hash, iParam3);
		}
	}

	num = 21;

	if (!func_281(hParam0->f_1[num /*3*/], false) && func_145(hParam2, 196770179))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
	...
	if (!func_281(hParam0->f_1[num /*3*/], false) || hParam0->f_1[num3 /*3*/] != Global_1953292.f_83[num3 /*12*/] && func_145(hParam0->f_1[num3 /*3*/], -1655064541))
		func_664(hParam0, iParam3);

	return;
}

void func_553(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF4FE
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_145(hParam2, 358628372))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
...
void func_554(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3, int iParam4) // Position - 0xF55D
{
	switch (func_159(hParam2))
	{
		case 698653232:
			func_665(hParam0, bParam1, hParam2, iParam4);
			break;
	
		case 912453393:
			func_666(hParam0, bParam1, iParam3, iParam4);
			break;
	}
...
void func_555(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF59B
{
	switch (func_159(hParam2))
	{
		case -1080198344:
		case 1868067663:
			func_667(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 294388917:
			func_668(hParam0, bParam1, hParam2, iParam3);
			break;
	}
...
void func_556(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF5DF
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_145(hParam2, 1537768121))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
...
void func_557(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF67B
{
	int num;
	...
	if (!bParam1)
	{
		...
		if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
		{
			if (func_145(hParam0->f_1[num /*3*/], 1537768121))
			{
				hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
				hParam0->f_1[num /*3*/].f_1 = 0;
			}
...
void func_558(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF78A
{
	int num;
	...
	if (!func_281(hParam0->f_1[num /*3*/], false) && func_145(hParam2, 1016511012))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
...
void func_559(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xF829
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_145(hParam0->f_1[num /*3*/], 358628372))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
...
void func_560(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF88E
{
	switch (func_159(hParam2))
	{
		case -1740828670:
			func_674(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 344283346:
			func_675(hParam0, bParam1, iParam3);
			break;
	
		case 502936876:
			func_673(hParam0, bParam1, iParam3);
			break;
	
		case 684307653:
			func_672(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 1223979091:
		case 2047428024:
			func_671(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 1759215194:
			func_670(hParam0, iParam3);
			break;
	}
...
void func_561(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF91E
{
	switch (func_159(hParam2))
	{
		case -923693316:
			func_677(hParam0, bParam1, hParam2, iParam3);
			break;
	
		case 1769055947:
			func_676(hParam0, bParam1, hParam2, iParam3);
			break;
	}
...
void func_562(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0xF95C
{
	int num;
	Hash hash;
	...
	if (bParam1)
	{
		func_678(hParam0, iParam3, false, true);
		return;
	}
	...
	if (func_145(hParam2, 813132419) && hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_159(hash) == -923693316)
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
	...
	if (func_145(hParam2, -1650340550) && hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_159(hash) == 1769055947)
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
	...
	if (func_145(hParam2, -1278198125) && hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
...
int func_563(Hash hParam0, BOOL bParam1, Hash hParam2) // Position - 0xFA8B
{
	int i;
...
BOOL func_564(Hash hParam0, Hash hParam1, var uParam2) // Position - 0xFACD
{
	*uParam2 = joaat("base");
	return true;
}

int func_565(Hash hParam0) // Position - 0xFADE
{
	int num;
...
BOOL func_566(int iParam0) // Position - 0xFAFA
{
...
void func_567(int iParam0, BOOL bParam1, BOOL bParam2, int iParam3) // Position - 0xFB88
{
	if (bParam1)
...
BOOL func_568(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0xFBE4
{
	var unk;
	var unk6;
...
void func_569(int iParam0, BOOL bParam1, int iParam2) // Position - 0xFC19
{
...
int func_570(Any* panParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0xFC41
{
	var unk;
...
int func_571(Any* panParam0, int iParam1, BOOL bParam2) // Position - 0xFC6F
{
	int num;
	var unk;
	int num2;
...
float func_572(Ped pedParam0, Ped pedParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFDB2
{
...
int func_573(int iParam0) // Position - 0xFDFA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_575(int iParam0, Player plParam1) // Position - 0xFF39
{
	if (plParam1 == 255)
...
void func_577(int iParam0) // Position - 0xFF8F
{
	Global_1051832.f_3648 = Global_1051832.f_3648 || iParam0;
	return;
}

BOOL func_578() // Position - 0xFFA8
{
	return ANIMSCENE::DOES_ANIM_SCENE_EXIST(Global_26573) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(Global_26573, false);
}

int func_579() // Position - 0xFFC4
{
	return Global_1051645.f_12;
}

char* func_580() // Position - 0xFFD2
{
	return "unnamed";
}

BOOL func_581(int iParam0) // Position - 0xFFDE
{
	int num;
...
BOOL func_582(int iParam0) // Position - 0x10085
{
	if (Global_1572887.f_14 == -1)
		return false;
...
int func_583(int iParam0) // Position - 0x100A3
{
	if (iParam0 == 255)
...
BOOL func_584(Player plParam0) // Position - 0x100EE
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_585(var uParam0) // Position - 0x10133
{
	if (*uParam0 >= 40)
		return false;
...
Hash func_586(Hash hParam0) // Position - 0x10148
{
	return hParam0;
}

int func_587() // Position - 0x10152
{
	int value;
...
BOOL func_588(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x10196
{
...
void func_589(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x101AE
{
	int i;
...
int func_590(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1024C
{
...
void func_591(Hash hParam0, var uParam1, var uParam2) // Position - 0x1027F
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_592(Hash hParam0, int iParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1048B
{
	Hash hash;
...
void func_593(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x10569
{
...
BOOL func_594(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x10584
{
...
BOOL func_595(Any* panParam0, int iParam1) // Position - 0x105A9
{
...
int func_597() // Position - 0x10618
{
	return Global_1110244.f_3667.f_938;
}

int func_598(int iParam0, int iParam1, var uParam2) // Position - 0x1062A
{
	int num;
...
int func_599(int iParam0) // Position - 0x10694
{
	return Global_1110244.f_3667.f_729[iParam0 /*2*/].f_1;
}

BOOL func_600(int iParam0) // Position - 0x106AC
{
	return iParam0 > -1 && iParam0 < 83;
}

BOOL func_601(Any* panParam0) // Position - 0x106C2
{
	int fileHandle;
	var SourceStruct;
...
BOOL func_602(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int* piParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x106FB
{
	uParam0.f_2 = iParam6;
	uParam0.f_3 = iParam7;
	uParam0.f_4 = iParam8;
...
struct<8> func_603(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x10726
{
	return func_698(uParam0, 52, 1);
}

int func_604(Hash hParam0) // Position - 0x10739
{
	switch (hParam0)
	{
...
BOOL func_605(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x107D2
{
	int num;
...
BOOL func_606(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1080D
{
	if (bParam2)
		if (!func_500(iParam0))
			return false;
...
BOOL func_607(int iParam0) // Position - 0x10850
{
	if (!func_500(iParam0))
		return false;
...
int func_608(BOOL bParam0, int iParam1) // Position - 0x1086E
{
	if (!NETWORK::NETWORK_IS_IN_SESSION())
		return 0;
...
BOOL func_609(int iParam0) // Position - 0x108C4
{
	switch (iParam0)
	{
		case 1:
...
void func_610(int iParam0) // Position - 0x10931
{
	switch (iParam0)
	{
		case 2:
...
void func_611(int iParam0, int iParam1) // Position - 0x10B37
{
	iParam0->f_2 = iParam0->f_2 || iParam1;
	return;
}

BOOL func_612() // Position - 0x10B4A
{
	return true;
}

int func_613(int iParam0) // Position - 0x10B69
{
	if (iParam0 == 2)
		iParam0 = func_701(1);
...
void func_614(float fParam0, Ped pedParam1) // Position - 0x10BA9
{
	if (fParam0 == 0f)
		return;
...
int func_615(int iParam0) // Position - 0x10BED
{
	if (iParam0 == 2)
		iParam0 = func_701(1);
...
void func_616(float fParam0, BOOL bParam1, BOOL bParam2) // Position - 0x10C31
{
	Player player;
	Ped EntityIndex;
...
int func_617(int iParam0) // Position - 0x10CE2
{
	if (iParam0 == 2)
		iParam0 = func_701(1);
...
void func_618(float fParam0, Ped pedParam1) // Position - 0x10D26
{
	if (fParam0 == 0f)
		return;
...
float func_619(int iParam0, float fParam1, BOOL bParam2) // Position - 0x10D68
{
	int num;
	int num2;
...
float func_620(int iParam0, int iParam1) // Position - 0x10DD1
{
	if (iParam1 == 2)
		iParam1 = func_701(2);
...
int func_621(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x10E1D
{
	Ped ped;
...
int func_622(int iParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10E9B
{
	char* effectName;
	Ped ped;
...
BOOL func_623() // Position - 0x11051
{
...
void func_624(float fParam0, int iParam1) // Position - 0x1107A
{
	float num;
	int num2;
	int num3;
...
BOOL func_625() // Position - 0x110ED
{
	return !Global_1913444;
}

void func_626(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x110FA
{
	int i;
...
var func_627(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1121D
{
	if (bParam0)
		return uParam1;
...
BOOL func_628(Hash hParam0, int iParam1) // Position - 0x11234
{
	if (!func_125(hParam0, 0))
		return false;
...
char* func_629(Hash hParam0) // Position - 0x11253
{
...
BOOL func_630(Hash hParam0) // Position - 0x1134E
{
...
BOOL func_631(int iParam0) // Position - 0x113CD
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_632(Hash hParam0) // Position - 0x113F4
{
	var unk;
	int i;
...
BOOL func_633(Hash hParam0, Hash hParam1) // Position - 0x11462
{
	if (hParam0 == 0)
		return false;
...
int func_634(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x11493
{
	var unk;
 ...
 func_635(Hash hParam0, int iParam1) // Position - 0x114F2
{
	 num;
...
BOOL func_636(Hash hParam0, char* sParam1) // Position - 0x11510
{
	...
	TEXT_LABEL_ASSIGN_STRING(&StringToTest, func_727(hParam0), 128);
...
const char* func_637(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x1158D
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_638(const char* sParam0, int iParam1) // Position - 0x115A1
{
...
BOOL func_639() // Position - 0x115D7
{
...
void func_640(int iParam0) // Position - 0x11636
{
	Global_1940252.f_11 = iParam0;
	return;
}

void func_641(int iParam0) // Position - 0x11646
{
	Global_1940252.f_10 = iParam0;
	return;
}

Hash func_642(int iParam0) // Position - 0x11656
{
	Hash hash;
	...
	return func_277(hash);
}

Hash func_643() // Position - 0x11679
{
	return Global_1953292.f_1676;
}

int func_644(BOOL bParam0) // Position - 0x11688
{
	var unk;
	int num;
	var unk15;
...
Hash func_645(int iParam0) // Position - 0x11795
{
	switch (iParam0)
	{
		case 1:
...
int func_646(Hash hParam0) // Position - 0x11832
{
	var unk;
	int num;
...
BOOL func_647(Hash hParam0) // Position - 0x1186C
{
	!func_125(hParam0, 0);
...
Hash func_648(Hash hParam0, BOOL bParam1) // Position - 0x11892
{
	switch (hParam0)
	{
...
void func_649(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x11934
{
...
BOOL func_650(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x11965
{
	int i;
	BOOL flag;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_651(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6, BOOL bParam7, BOOL bParam8, int iParam9) // Position - 0x11A45
{
	Hash hash;
	int num;
	BOOL flag;
	...
	*uParam2 = flag;
	...
	if (!flag && !bParam3)
		func_732(hParam0, func_731(hash), true, true, bParam7);
		...
		else
		{
			...
			else
			{
				...
				if (!DATAFILE::_PARSEDDATA_GET_SECTION(&hash, &num2, 1194786549))
					if (func_734(hash2) && func_564(hParam0->f_1[num /*3*/], hash2, &hash))
	...
	{
		if (!bParam8)
			func_736(hParam0, num3, func_735(hParam1) != 0, iParam9);
	}
	else if (func_417() == joaat("MPC_PLAYER_TYPE_MP_FEMALE") && hParam0->f_1[num /*3*/] == Global_1953292.f_83[num /*12*/] && func_735(hParam0->f_1[34 /*3*/]) == 0 && !func_270(32) && !func_270(64))
	{
		hParam0->f_1[num /*3*/] = func_663(-1293064293, 0);
		hParam0->f_1[num /*3*/].f_1 = joaat("base");
		func_427(hParam0, hParam0->f_1[num /*3*/], num, false, iParam9);
	}
...
void func_652(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4, Hash hParam5) // Position - 0x11C74
{
	*panParam0 = iParam1;
...
BOOL func_653(var uParam0, int iParam1) // Position - 0x11CA3
{
	return uParam0->f_1 && iParam1 != false;
}

void func_654(var uParam0, int iParam1, int iParam2) // Position - 0x11CB4
{
	uParam0->f_1 = uParam0->f_1 || iParam1;
	return;
}

BOOL func_655(int iParam0, int iParam1) // Position - 0x11CC7
{
	return iParam0->f_1 && iParam1 != false;
}

void func_656(int iParam0, int iParam1) // Position - 0x11CD8
{
	iParam0->f_1 = iParam0->f_1 || iParam1;
	return;
}

int func_657(int iParam0) // Position - 0x11CEB
{
	if (iParam0 == 0)
		iParam0 = func_417();
...
void func_658(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x11D27
{
	int num;
	Hash hash;
...
void func_659(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x11D8A
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_145(hParam0->f_1[num /*3*/], -93469181))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam2);
...
void func_660(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x11DEF
{
	int num;
	...
	if (-525676072 == func_159(hParam0->f_1[num /*3*/]))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam2);
...
BOOL func_661(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x11E3C
{
	int num;
...
BOOL func_662(int iParam0) // Position - 0x11E89
{
	return Global_17418.f_55.f_664.f_1734 && iParam0 != false;
}

Hash func_663(Hash hParam0, int iParam1) // Position - 0x11EA1
{
	int num;
	int num2;
	int num3;
	...
	num3 = 0;
	unk = { func_592(0, -1591664384, hParam0, -1591664384, 0, 0, 0) };
...
void func_664(Hash hParam0, int iParam1) // Position - 0x11EEE
{
	int num;
	BOOL flag;
	...
	{
		if (func_563(hParam0->f_1[num /*3*/], flag, -1539589426) >= 0)
		{
			hParam0->f_1[num /*3*/].f_1 = -1539589426;
			return;
		}
	...
	if (func_563(hParam0->f_1[num /*3*/], flag, 1334603721) >= 0)
		hParam0->f_1[num /*3*/].f_1 = 1334603721;

	return;
}

void func_665(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x11FB4
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_145(hParam2, -1527414429) && !func_145(hParam0->f_1[num /*3*/], -1303648999))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/].f_1 == 1530758430 || hParam0->f_1[num /*3*/].f_1 == 1334603721 && func_145(hParam2, -985549034))
	{
		if (hParam0->f_1[num /*3*/].f_1 == 1530758430)
		{
			hParam0->f_1[num /*3*/].f_1 = joaat("base");
...
void func_666(Hash hParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x120BC
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[iParam2 /*3*/].f_1 != -2081918609)
	{
		...
		else
		{
			...
			if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && 1769055947 == func_159(hash))
			{
				hParam0->f_1[iParam2 /*3*/].f_1 = -2081918609;
				func_425(iParam2, iParam3);
			}
...
void func_667(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1219E
{
	int num;
	Hash hash;
	...
	if (bParam1)
	{
		...
		{
			func_425(num, iParam3);
			func_556(hParam0, false, hParam0->f_1[num /*3*/], iParam3);
		}
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_145(hParam2, 1126863852))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_145(hParam2, -985549034))
		if (hParam0->f_1[num /*3*/].f_1 == 1530758430)
			hParam0->f_1[num /*3*/].f_1 = joaat("base");
		else if (hParam0->f_1[num /*3*/].f_1 == 1334603721)
			hParam0->f_1[num /*3*/].f_1 = -1539589426;
...
void func_668(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x1240B
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && !func_145(hParam0->f_1[num /*3*/], -1303648999))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_145(hParam2, 675650051))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
...
BOOL func_669(int iParam0) // Position - 0x1251F
{
	return Global_1953292.f_1676.f_1[func_278(iParam0, 1) /*3*/] != Global_1953292.f_83[func_278(iParam0, 1) /*12*/];
}

void func_670(Hash hParam0, int iParam1) // Position - 0x12549
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		if (func_145(hParam0->f_1[num /*3*/], -928740153))
		{
			hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
			hParam0->f_1[num /*3*/].f_1 = 0;
		}
...
void func_671(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x12614
{
	int num;
	Hash hash;
	BOOL flag;
	...
	if (func_417() == joaat("MPC_PLAYER_TYPE_MP_FEMALE"))
	{
		...
		if (hParam0->f_1[num /*3*/] == Global_1953292.f_83[num /*12*/] && func_159(hParam0->f_1[18 /*3*/]) != 912453393)
		{
			hParam0->f_1[num /*3*/] = func_663(Global_1953292.f_83[num /*12*/].f_9, 0);
			hParam0->f_1[num /*3*/].f_1 = 0;
			func_425(num, iParam3);
		}
	}
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_145(hParam2, -1473580422))
	{
		hash = hParam0->f_1[num /*3*/];
		...
		else if (func_563(hParam0->f_1[num /*3*/], flag2, -2081918609) != -1)
		{
	...
	if (hash != Global_1953292.f_83[num /*12*/])
		if (func_159(hash) == 1868067663 && func_145(hParam2, -1016441646))
			func_738(hParam0, num, iParam3);
		else if (flag)
			func_425(num, iParam3);

	num = 34;

	if (1759215194 == func_159(hParam0->f_1[num /*3*/]))
		func_425(16, iParam3);

	num = 35;

	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_145(hParam2, -1650340550))
	{
		hash = hParam0->f_1[num /*3*/];
...
void func_672(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x128BC
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
		if (func_145(hParam0->f_1[num /*3*/], -2093434733))
			func_678(hParam0, iParam3, true, false);
...
void func_673(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x12A1D
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && 1769055947 == func_159(hParam0->f_1[num /*3*/]))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam2);
...
void func_674(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x12BD2
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_159(hash) == 294388917)
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
...
void func_675(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x12E0D
{
	int num;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		if (func_145(hParam0->f_1[num /*3*/], -2093434733))
		{
			func_678(hParam0, iParam2, true, false);
		}
		else
		{
			hParam0->f_1[num /*3*/].f_1 = joaat("base");
...
void func_676(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x13005
{
	int num;
	Hash hash;
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/] && func_145(hParam2, -1278198125))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam3);
	...
	if (hParam0->f_1[num /*3*/] != Global_1953292.f_83[num /*12*/])
	{
		...
		if (912453393 == func_159(hash) && hParam0->f_1[num /*3*/].f_1 != -2081918609)
		{
			hParam0->f_1[num /*3*/].f_1 = -2081918609;
			func_425(num, iParam3);
		}
...
void func_677(Hash hParam0, BOOL bParam1, Hash hParam2, int iParam3) // Position - 0x13122
{
	int num;
...
void func_678(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x13181
{
	int num;
	...
	if (bParam3 && -923693316 == func_159(hParam0->f_1[num /*3*/]))
	{
		hParam0->f_1[num /*3*/] = Global_1953292.f_83[num /*12*/];
		hParam0->f_1[num /*3*/].f_1 = 0;
		func_425(num, iParam1);
...
void func_679(Hash hParam0, int iParam1, int iParam2) // Position - 0x13278
{
	Global_17418.f_55.f_664.f_33[iParam2 /*120*/].f_1.f_1[iParam1 /*3*/] = { *hParam0 };
	return;
}

void func_680(Hash hParam0, int iParam1) // Position - 0x1329C
{
	int i;
	...
	for (i = 0; i < 39; i = i + 1)
	{
		func_679(&hParam0->f_1[i /*3*/], i, iParam1);
	}

	return;
}

void func_681(BOOL bParam0, int iParam1, int iParam2) // Position - 0x132ED
{
	if (iParam1 == -1)
		iParam1 = Global_17418.f_55.f_664.f_1777;
...
BOOL func_682(Any* panParam0, Hash hParam1, Any* panParam2, BOOL bParam3, int iParam4) // Position - 0x13338
{
	var outGuid;
...
struct<29> func_683(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x13386
{
	var unk;
	var unk30;
...
int func_684(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x13421
{
	int num;
...
struct<26> func_685(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1348B
{
	var unk;
	var unk27;
...
int func_686(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x1350E
{
	int num;
...
struct<18> func_687(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x1355E
{
	var unk;
	var unk19;
...
int func_688(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x135D3
{
	int num;
...
struct<17> func_689(var uParam0, BOOL bParam1) // Position - 0x1363D
{
	var unk;
...
BOOL func_690() // Position - 0x136BE
{
	return func_113(Global_1051268);
}

BOOL func_691(int iParam0) // Position - 0x136D0
{
	return iParam0 == -1759663922 || iParam0 == -318976023 || iParam0 == 772881414 || iParam0 == 31269700 || iParam0 == -133550749;
}

BOOL func_692(int iParam0, int iParam1) // Position - 0x13718
{
	int num;
...
BOOL func_693(Player plParam0) // Position - 0x1378C
{
...
void func_694(Player plParam0) // Position - 0x137A9
{
	Player player;
...
void func_695(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1382C
{
	int i;
...
BOOL func_696(Hash hParam0) // Position - 0x13908
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_697() // Position - 0x13916
{
	return Global_1072759.f_28418[32 /*4*/].f_3;
}

struct<8> func_698(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6) // Position - 0x1392B
{
	var unk;
...
int func_699(int iParam0, var uParam1) // Position - 0x13949
{
	if (iParam0 == 2)
...
BOOL func_700() // Position - 0x13963
{
	return !Global_1572887.f_10;
}

int func_701(int iParam0) // Position - 0x13972
{
	return func_747(func_746(iParam0));
}

BOOL func_702(Player plParam0) // Position - 0x13984
{
	float num;
...
int func_703() // Position - 0x1399F
{
	return Global_1902569;
}

void func_704(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x139AB
{
	int num;
	int i;
	int j;
...
int func_705(int iParam0, int iParam1) // Position - 0x13B1E
{
	if (iParam1 == 2)
		iParam1 = func_701(2);
...
int func_706(int iParam0, int iParam1) // Position - 0x13B6E
{
	if (iParam1 == 2)
		iParam1 = func_701(2);
...
BOOL func_707(int iParam0, int iParam1, BOOL bParam2) // Position - 0x13BC0
{
	if (bParam2)
...
void func_708(int iParam0, int iParam1, int iParam2) // Position - 0x13BED
{
	if (iParam2 == 2)
		iParam2 = func_701(2);
...
void func_709(int iParam0, int iParam1, int iParam2) // Position - 0x13C43
{
	if (iParam2 == 2)
		iParam2 = func_701(2);
...
BOOL func_710(Ped pedParam0, int iParam1, float fParam2) // Position - 0x13C99
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
void func_711(int iParam0, int iParam1, int iParam2) // Position - 0x13CEE
{
	if (iParam2 == 2)
		iParam2 = func_701(2);
...
void func_712(Ped pedParam0, int iParam1, float fParam2) // Position - 0x13D4F
{
	char* StringToTest;

	StringToTest = func_759(iParam1);
...
void func_713(int iParam0, float fParam1, BOOL bParam2, int iParam3) // Position - 0x13D7B
{
	int num;
...
BOOL func_714(int iParam0) // Position - 0x13DB1
{
	switch (iParam0)
	{
		case 0:
...
char* func_715(int iParam0) // Position - 0x13DE0
{
	switch (iParam0)
	{
		case 0:
...
void func_716(int iParam0) // Position - 0x13E1A
{
	int num;
	int num2;
	int i;
...
void func_717(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x13EEA
{
	func_621(iParam0, 100f, bParam1, bParam2, true, 2);
	return;
}

BOOL func_718(int iParam0, BOOL bParam1) // Position - 0x13F04
{
	return func_707(func_703(), iParam0, bParam1);
}

float func_719(int iParam0, int iParam1) // Position - 0x13F18
{
	if (iParam1 == 2)
		iParam1 = func_701(1);
...
int func_720(float fParam0) // Position - 0x13F64
{
	float num;
...
float func_721(float fParam0, float fParam1, float fParam2) // Position - 0x13F8F
{
	if (fParam0 > fParam2)
		return fParam2;
...
void func_722(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x13FB6
{
	int num;
	int i;
	int num2;
...
int func_723(int iParam0, float fParam1, int iParam2) // Position - 0x1413F
{
	if (!func_765(iParam0))
		return 0;
...
BOOL func_724(Hash hParam0, Hash hParam1) // Position - 0x14190
{
	if (hParam1 == 0)
		return false;
...
int func_725(Hash hParam0, int iParam1) // Position - 0x141B7
{
	var unk;
	int num;
	int num2;
...
char* func_726(Hash hParam0) // Position - 0x14205
{
	Hash labelHash;
...
char* func_727(Hash hParam0) // Position - 0x14239
{
	Hash labelHash;
...
Ped func_728(int iParam0) // Position - 0x1426C
{
	return PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::GET_PLAYER_INDEX());
}

int func_729(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x1427C
{
	int num;
...
void func_730(int iParam0) // Position - 0x142B1
{
...
int func_731(int iParam0) // Position - 0x14336
{
	switch (iParam0)
	{
		case -1932005642:
...
// Unhandled jump detected. Output should be considered invalid
void func_732(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x144D7
{
	int i;
	Hash hash;
	Hash hash2;
...
void func_733(Hash hParam0, int iParam1, int iParam2) // Position - 0x145B0
{
	Global_1953292.f_83[func_278(hParam0, 1) /*12*/].f_11 = Global_1953292.f_83[func_278(hParam0, 1) /*12*/].f_11 || iParam1;
	return;
}

BOOL func_734(Hash hParam0) // Position - 0x145DD
{
	int num;
	var unk;
...
int func_735(Hash hParam0) // Position - 0x14636
{
	var unk;
	int num;
...
void func_736(Hash hParam0, int iParam1, BOOL bParam2, int iParam3) // Position - 0x14670
{
	int i;
	BOOL flag;

	if (func_145(hParam0->f_1[34 /*3*/], -166674229))
		return;
	...
	for (i = 0; i < 39; i = i + 1)
	{
		...
		else
		{
			...
			if (!bParam2 && func_735(hParam0->f_1[i /*3*/]) != 0)
			{
			}
			else if (func_770(i, iParam1) && !flag)
			{
				...
				func_427(hParam0, hParam0->f_1[i /*3*/], i, true, iParam3);
				func_425(i, iParam3);
			}
			else if (flag && !bParam2)
			{
				func_427(hParam0, hParam0->f_1[i /*3*/], i, false, iParam3);
			}
		}
	}
...
int func_737(int iParam0, int iParam1, int iParam2) // Position - 0x1477C
{
	int i;
	var unk;
	int num;
...
void func_738(Hash hParam0, int iParam1, int iParam2) // Position - 0x14849
{
	int num;

	if (func_145(hParam0->f_1[iParam1 /*3*/], 343781202))
	{
		func_546(hParam0, hParam0->f_1[iParam1 /*3*/]);
	}
	else
	{
...
BOOL func_739(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x148DD
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 29, panParam2, 0);
}

BOOL func_740(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x148F4
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 26, panParam2, 0);
}

BOOL func_741(int iParam0, Hash hParam1, Any* panParam2) // Position - 0x1490B
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

BOOL func_742(Any* panParam0, int iParam1, int iParam2) // Position - 0x14922
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

void func_743(Player plParam0) // Position - 0x14959
{
	Player player;
...
void func_744(Player plParam0) // Position - 0x149C5
{
...
void func_745(int iParam0) // Position - 0x14A00
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
BOOL func_746(int iParam0) // Position - 0x14A23
{
	return func_742(&(Global_1956875.f_1565), iParam0, 1);
}

int func_747(BOOL bParam0) // Position - 0x14A39
{
	if (bParam0)
		return 1;
...
float func_748(Player plParam0) // Position - 0x14A4B
{
	return PLAYER::_GET_PLAYER_MAX_DEAD_EYE(plParam0, 0) - (float)func_779(2);
}

int func_749(int iParam0) // Position - 0x14A61
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_750(int iParam0) // Position - 0x14A86
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_751(int iParam0) // Position - 0x14A99
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_752(int iParam0) // Position - 0x14AAC
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_753(int iParam0) // Position - 0x14ABF
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_754(int iParam0) // Position - 0x14AD1
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_755(int iParam0, int iParam1) // Position - 0x14AE3
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_756(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x14B7D
{
...
BOOL func_757(int iParam0) // Position - 0x14BB5
{
	int num;
	int num2;
	int num3;
...
int func_758(int iParam0) // Position - 0x14C91
{
	switch (iParam0)
	{
		case 0:
...
char* func_759(int iParam0) // Position - 0x14CC0
{
	switch (iParam0)
	{
		case 0:
...
char* func_760(int iParam0) // Position - 0x14CFA
{
	switch (iParam0)
	{
		case 0:
...
void func_761(int iParam0, float fParam1, int iParam2) // Position - 0x14D34
{
	if (iParam2 == 2)
		iParam2 = func_701(2);
...
void func_762(int iParam0, int iParam1, int iParam2) // Position - 0x14D86
{
	if (iParam2 == 2)
		iParam2 = func_701(2);
...
int func_763(int iParam0, int iParam1) // Position - 0x14DDC
{
	switch (iParam0)
	{
		case -2101912686:
...
// Unhandled jump detected. Output should be considered invalid
int func_764(int iParam0) // Position - 0x155DD
{
	int num;
	int num2;
	int num3;
...
BOOL func_765(int iParam0) // Position - 0x1586D
{
	if (func_714(iParam0))
		return true;
...
void func_766(int iParam0, float fParam1, int iParam2) // Position - 0x15893
{
	if (fParam1 < 0f)
		return;
...
int func_767(Ped pedParam0, Hash hParam1) // Position - 0x158EF
{
	int num;
	int i;
...
int func_768(Hash hParam0, BOOL bParam1) // Position - 0x1594D
{
	if (!bParam1 || func_800())
...
BOOL func_769(var uParam0, int iParam1) // Position - 0x1597C
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_770(int iParam0, int iParam1) // Position - 0x1598D
{
...
Vector3 func_771(int iParam0, int iParam1) // Position - 0x159BC
{
	if (iParam1 == -1)
		iParam1 = Global_17418.f_55.f_664.f_1777;
...
BOOL func_777(int iParam0, int iParam1) // Position - 0x15AD6
{
	return iParam0 && iParam1 != false;
}

void func_778(var uParam0) // Position - 0x15AE5
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_779(int iParam0) // Position - 0x15B40
{
	switch (iParam0)
	{
		case 0:
...
var func_780(BOOL bParam0, var uParam1, var uParam2) // Position - 0x15B81
{
	if (bParam0)
		return uParam1;
...
void func_781(var uParam0, int iParam1) // Position - 0x15B98
{
	if (iParam1 < 0)
		return;
...
void func_782(var uParam0, int iParam1) // Position - 0x15C1E
{
...
void func_783(var uParam0, int iParam1) // Position - 0x15C5A
{
	int num;
	int num2;
...
void func_784(var uParam0, int iParam1) // Position - 0x15CAD
{
...
void func_785(var uParam0, int iParam1) // Position - 0x15CE8
{
...
void func_786(var uParam0, int iParam1) // Position - 0x15D21
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_787(int iParam0) // Position - 0x15D59
{
	int num;
...
BOOL func_788(int iParam0) // Position - 0x15D81
{
	int num;
...
int func_789(int iParam0, int iParam1) // Position - 0x15DA9
{
	switch (iParam0)
	{
...
int func_790(int iParam0, int iParam1) // Position - 0x16460
{
	Player player;
	Player player2;
	int num;
...
int func_791(int iParam0, int iParam1, int iParam2) // Position - 0x164E3
{
	int num;
	int num2;
...
void func_792(int iParam0) // Position - 0x165DB
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = -1;
...
int func_793(int iParam0, int iParam1) // Position - 0x165F1
{
	switch (iParam0)
	{
...
BOOL func_797(int iParam0) // Position - 0x16F1B
{
	switch (iParam0)
	{
		case 12:
...
BOOL func_798(Hash hParam0) // Position - 0x16F40
{
...
int func_799(int iParam0, Hash hParam1) // Position - 0x16F6B
{
	var guid;
	int inventoryItemCountWithGuid;
...
BOOL func_800() // Position - 0x16FA9
{
...
Player func_801(int iParam0) // Position - 0x16FF8
{
	if (func_814(iParam0))
...
BOOL func_802(int iParam0) // Position - 0x17019
{
	int num;
...
int func_803(int iParam0, int iParam1, int iParam2) // Position - 0x17041
{
	int num;
	int num2;
	int num3;
...
BOOL func_804(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30) // Position - 0x17232
{
	return uParam0.f_4 != 0;
}

BOOL func_805(int iParam0, int iParam1) // Position - 0x17240
{
	int num;
...
Vector3 func_806(int iParam0) // Position - 0x17280
{
	int num;
	var unk;
...
BOOL func_807(int iParam0, var uParam1, var uParam2) // Position - 0x172BC
{
	if (!func_802(iParam0))
		return false;
...
BOOL func_808(int iParam0, int iParam1, int iParam2) // Position - 0x172F3
{
	int num;
	int num2;
	int num3;
...
void func_809(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x17521
{
	int num;
...
void func_810(int iParam0) // Position - 0x175A0
{
	int num;
...
BOOL func_811(Hash hParam0, int iParam1) // Position - 0x175F5
{
	int num;
...
struct<4> func_812(int iParam0, Hash hParam1) // Position - 0x17614
{
	var unk;
...
BOOL func_813(Vehicle veParam0) // Position - 0x17636
{
...
BOOL func_814(int iParam0) // Position - 0x17655
{
	int num;
...
int func_815(int iParam0) // Position - 0x1767C
{
	int num;
...
int func_816(int iParam0, int iParam1) // Position - 0x17716
{
	switch (iParam0)
	{
		case -2123992989:
...
BOOL func_817(int iParam0) // Position - 0x17B4F
{
	int num;
...
float func_818(int iParam0) // Position - 0x17B77
{
	float num;
...
void func_819(int iParam0) // Position - 0x17BA6
{
	int num;
	int num2;
	int i;
...
BOOL func_820(int iParam0) // Position - 0x17D85
{
	int num;
...
int func_821(int iParam0, int iParam1) // Position - 0x17DAD
{
	switch (iParam0)
	{
...
void func_822(int iParam0) // Position - 0x180BD
{
	Ped ped;
	Player player;
...
BOOL func_823(int iParam0) // Position - 0x182CC
{
	int num;
...
int func_824(int iParam0, int iParam1) // Position - 0x182F3
{
	switch (iParam0)
	{
...
int func_825(int iParam0) // Position - 0x18350
{
	int num;
	var unk;
	var unk32;
...
BOOL func_826(int iParam0) // Position - 0x18494
{
...
void func_827(int iParam0) // Position - 0x184B2
{
	int num;
	int num2;
	int i;
...
BOOL func_828(int iParam0) // Position - 0x18607
{
	BOOL flag;
...
void func_829(int iParam0) // Position - 0x18630
{
	Ped EntityIndex;
	Player player;
	int num;
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			num = func_847(iParam0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_854(iParam0, 0));
			func_855(num, 0, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_854(iParam0, 1));
			func_855(num, 1, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_854(iParam0, 2));
			func_855(num, 2, 1, entityBoneIndexByName, 0);
			entityBoneIndexByName = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(EntityIndex, func_854(iParam0, 3));
			func_855(num, 2, 1, entityBoneIndexByName, 0);
			break;
...
void func_830(int iParam0) // Position - 0x188CB
{
	char* StringToTest;
	char* StringToTest2;
	...
	StringToTest = func_857(iParam0);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	StringToTest2 = func_858(iParam0);
...
int func_831(Hash hParam0) // Position - 0x18915
{
	int num;
...
struct<5> func_832(int iParam0) // Position - 0x1892F
{
	var unk;
...
struct<4> func_833(int iParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, Hash hParam6) // Position - 0x1895C
{
	var outGuid;
...
BOOL func_834(int iParam0) // Position - 0x18989
{
	int num;
...
BOOL func_835(int iParam0) // Position - 0x189B1
{
	int num;
...
BOOL func_836(int iParam0) // Position - 0x189D9
{
	int num;
...
BOOL func_837(int iParam0) // Position - 0x18A01
{
	int num;
...
BOOL func_838(int iParam0) // Position - 0x18A29
{
	int num;
...
BOOL func_839(int iParam0) // Position - 0x18A51
{
	int num;
...
float func_840(Hash hParam0, Hash hParam1, float fParam2, char* sParam3) // Position - 0x18A79
{
	var unk;
	float num;
...
BOOL func_841(int iParam0) // Position - 0x18AAF
{
...
BOOL func_842(int iParam0) // Position - 0x18B1E
{
	int num;
...
int func_843(int iParam0, int iParam1) // Position - 0x18B45
{
	switch (iParam0)
	{
...
void func_844() // Position - 0x18BA2
{
	BOOL bTrue;
	BOOL bTrue2;
...
void func_845() // Position - 0x18C04
{
	BOOL bTrue;
...
char* func_846(int iParam0) // Position - 0x18C34
{
	switch (iParam0)
	{
		case joaat("TOXIC_MOONSHINE_EFFECT"):
...
int func_847(int iParam0) // Position - 0x18C7B
{
	switch (iParam0)
	{
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
...
void func_848(int iParam0) // Position - 0x18CB6
{
	int i;
...
void func_849() // Position - 0x18CF6
{
...
int func_850(int iParam0) // Position - 0x18D16
{
	int num;
...
BOOL func_851(int iParam0, int iParam1) // Position - 0x18D45
{
	int num;
	Player player;
	int num2;
...
struct<31> func_852(int iParam0) // Position - 0x1901A
{
	int num;
...
BOOL func_853(Hash hParam0, Hash hParam1, BOOL bParam2, char* sParam3) // Position - 0x1903E
{
	var unk;
	BOOL flag;
...
char* func_854(int iParam0, int iParam1) // Position - 0x19074
{
	switch (iParam0)
	{
		case joaat("SLIPPERY_BASTARD_VFX"):
...
void func_855(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x190CC
{
	int i;
...
void func_856() // Position - 0x19151
{
...
char* func_857(int iParam0) // Position - 0x19176
{
	switch (iParam0)
	{
		case -1822335806:
...
char* func_858(int iParam0) // Position - 0x19196
{
	switch (iParam0)
	{
		case -1822335806:
...
BOOL func_859(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x191B6
{
	int num;
	int num2;
...
BOOL func_860() // Position - 0x193D7
{
	return Global_1572887.f_7;
}

BOOL func_861() // Position - 0x193E5
{
	if (!Global_1048577)
		return false;
...
int func_862(int iParam0) // Position - 0x19430
{
	int num;
