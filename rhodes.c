...
void _DEBUG_PRINT(int iParam0) // Position - 0x11DE
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x11EA
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0x11F7
{
	var unk;
...
BOOL func_17(int iParam0) // Position - 0x124D
{
	iParam0 = iParam0;
...
void func_18(int iParam0) // Position - 0x12BB
{
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x12C3
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x12D8
{
	return func_62(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x12E9
{
...
void _DEBUG_PRINT_0(int iParam0) // Position - 0x1328
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x1334
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x133C
{
	if (func_63(iParam0))
		return true;
...
void func_25() // Position - 0x13EC
{
	return;
}

void func_26() // Position - 0x13F4
{
	func_45() != -1;
	return;
}

void func_27() // Position - 0x1404
{
	func_67(2, 1343.574f, -1375.6398f, 79.4806f, volLocal_77, 111);
	return;
}

void func_28() // Position - 0x1424
{
	return;
}

void func_29(int iParam0) // Position - 0x142C
{
...
void func_30(int iParam0) // Position - 0x15D1
{
	if (func_45() != -1)
		return;
...
void func_31() // Position - 0x15E4
{
	return;
}

void func_32() // Position - 0x15EC
{
	return;
}

void func_33(int iParam0) // Position - 0x15F4
{
	func_75(0.8f, 0.2f, 0f, 0f);
	return;
}

void func_34() // Position - 0x160C
{
...
void func_35(var uParam0) // Position - 0x163D
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0x1683
{
...
void func_37(int iParam0) // Position - 0x16A6
{
	if (!func_77(iParam0))
		return;
...
void func_39(BOOL bParam0) // Position - 0x16E4
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0x16FC
{
	func_80();
...
void func_41(var uParam0, int iParam1) // Position - 0x1735
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0x1874
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0x1881
{
...
BOOL func_44(int iParam0) // Position - 0x18B7
{
	if (iParam0 == 0)
	{
		func_96();
...
int func_45() // Position - 0x19CB
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0x19D9
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0x19E5
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0x1A52
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x1B32
{
	if (!func_77(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x1B50
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x1B63
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

Vector3 func_53(int iParam0) // Position - 0x1B81
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_54() // Position - 0x1C24
{
	return false;
}

void func_55(Volume volParam0) // Position - 0x1C2D
{
...
void func_56() // Position - 0x1C74
{
	return;
}

void func_57() // Position - 0x1C7C
{
...
BOOL func_59(char* sParam0) // Position - 0x1CC8
{
	int i;
...
void func_60(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, int iParam16) // Position - 0x1D02
{
	int i;
...
BOOL func_61(int iParam0) // Position - 0x1D9E
{
	int num;
	int num2;
	int offset;
...
BOOL func_62(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1E1D
{
	int num;
	int num2;
	int num3;
...
BOOL func_63(int iParam0) // Position - 0x1F15
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_64(int iParam0) // Position - 0x1F26
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_65(int iParam0) // Position - 0x1F3A
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_66(var uParam0, var uParam1) // Position - 0x1F4E
{
	return uParam0;
}

void func_67(int iParam0, float fParam1, float fParam2, float fParam3, Volume volParam4, int iParam5) // Position - 0x1F58
{
...
void func_68(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x1FB6
{
...
void func_69(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2165
{
	int num;
...
void func_70(int iParam0, int iParam1) // Position - 0x2209
{
	func_135(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

int func_71(int iParam0, BOOL bParam1) // Position - 0x2223
{
	int num;
	Hash hash;
	float num2;
...
void func_73(int iParam0) // Position - 0x2511
{
	int i;
	Hash hash;
	float num;
...
void func_74(int iParam0) // Position - 0x268E
{
	int i;
...
void func_75(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x2785
{
...
void func_76(var uParam0, Volume volParam1, int iParam2) // Position - 0x27AD
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_77(int iParam0) // Position - 0x2806
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_78() // Position - 0x281C
{
	int i;
...
void func_79(int iParam0, Hash hParam1) // Position - 0x2849
{
	if (!func_150(iParam0))
		return;
...
BOOL func_81(var uParam0) // Position - 0x2915
{
	if (func_152())
	{
		if (!*uParam0)
...
void func_82(Hash hParam0, int iParam1) // Position - 0x2945
{
	func_134(hParam0, true, 0, false, false, 0, false, false);
	return;
}

void func_83(int iParam0, Volume volParam1, var uParam2) // Position - 0x295A
{
	if (!*uParam2)
	{
...
BOOL func_84(int iParam0, int iParam1) // Position - 0x299C
{
	return iParam0 && iParam1 != false;
}

BOOL func_85(var uParam0, int iParam1) // Position - 0x29AB
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_86() // Position - 0x29BC
{
	return func_84(Global_1940199, 8192);
}

BOOL func_87(var uParam0, int iParam1) // Position - 0x29CF
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_88(int iParam0) // Position - 0x29E0
{
	if (!func_77(iParam0))
		return false;
...
BOOL func_89(int iParam0, int iParam1) // Position - 0x2A20
{
...
int func_90() // Position - 0x2A4D
{
	return Global_1896646.f_41;
}

void func_91(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x2A5B
{
	BOOL flag;
	...
	StringToTest = func_158(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_170(&unk, joaat("COLOR_PURE_WHITE")), str3, func_170(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_170(&unk, joaat("COLOR_PURE_WHITE")), func_170(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_171(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_92(var uParam0, int iParam1) // Position - 0x2CCC
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_93(int iParam0, BOOL bParam1) // Position - 0x2CDF
{
...
void func_94(BOOL bParam0) // Position - 0x3348
{
	if (bParam0)
...
BOOL func_95(int iParam0) // Position - 0x3371
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_96() // Position - 0x33B6
{
	func_175();
	return;
}

Hash func_97(int iParam0, BOOL bParam1) // Position - 0x33C2
{
	switch (iParam0)
	{
		case 0:
...
void func_98(int iParam0, BOOL bParam1) // Position - 0x3B87
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_99(BOOL bParam0) // Position - 0x3BDA
{
	if (bParam0)
...
void func_100(int iParam0) // Position - 0x3C03
{
...
void func_101(int iParam0) // Position - 0x3D19
{
	int i;
...
void func_102(int iParam0) // Position - 0x3D4A
{
	int i;
...
BOOL func_103(int iParam0, BOOL bParam1) // Position - 0x3D7D
{
	int num;
	int num2;
	int num3;
...
BOOL func_104(int iParam0) // Position - 0x3E33
{
	int i;
...
BOOL func_105(int iParam0, BOOL bParam1) // Position - 0x3EAD
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_106(int iParam0, int iParam1) // Position - 0x3EDE
{
	return iParam0 && iParam1 != false;
}

void func_107(int iParam0) // Position - 0x3EED
{
...
int func_108(int iParam0, int iParam1) // Position - 0x3F04
{
	switch (iParam0)
	{
...
BOOL func_109(int iParam0) // Position - 0x589E
{
	int num;
...
BOOL func_110(int iParam0) // Position - 0x58BB
{
...
BOOL func_111(int iParam0) // Position - 0x58D2
{
	if (!func_77(iParam0))
		return false;
...
BOOL func_112(int iParam0) // Position - 0x58F3
{
	if (!func_77(iParam0))
		return false;
...
BOOL func_113(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5946
{
	BOOL flag;
...
BOOL func_114(int iParam0) // Position - 0x6006
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_115(int iParam0) // Position - 0x601D
{
	switch (iParam0)
	{
		case 64:
...
int func_116(int iParam0, BOOL bParam1) // Position - 0x6060
{
	if (!func_114(iParam0))
		return 0;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x614B
{
...
void func_118(int iParam0) // Position - 0x6175
{
...
int func_119(int iParam0, int iParam1) // Position - 0x6255
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_121() // Position - 0x634C
{
	return func_196(func_65(0));
}

BOOL func_122(int iParam0) // Position - 0x635D
{
	return !func_197(iParam0);
}

void func_123(BOOL bParam0, BOOL bParam1) // Position - 0x636C
{
	if (func_198(255) == 4)
		return;
...
void func_124(int iParam0, BOOL bParam1) // Position - 0x64B7
{
	BOOL flag;
...
int func_125(int iParam0, int iParam1) // Position - 0x6866
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_126(int iParam0) // Position - 0x71CC
{
	if (!func_211(iParam0))
		return 0;
...
int func_127(int iParam0) // Position - 0x720D
{
	switch (iParam0)
	{
		case 3:
...
void func_128(int iParam0, int iParam1) // Position - 0x72AA
{
...
void func_129(int iParam0) // Position - 0x72D9
{
...
int func_130(int iParam0) // Position - 0x7312
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

Hash func_131(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7326
{
...
BOOL func_132(Hash hParam0) // Position - 0x73CA
{
	if (func_213(hParam0))
...
BOOL func_133(Hash hParam0) // Position - 0x73E5
{
...
void func_134(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x740E
{
	func_131(hParam0, false, false);
...
void func_135(int iParam0, int iParam1) // Position - 0x7499
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_136(int iParam0, int iParam1) // Position - 0x74AA
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

int func_137() // Position - 0x74C3
{
	return Global_1893611.f_2;
}

BOOL func_138(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x74D1
{
	return func_219(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_139(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x74F1
{
	return func_219(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_140(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x7511
{
	if (bParam6)
...
void func_141(int iParam0) // Position - 0x758D
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_142(int iParam0) // Position - 0x75A2
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_143(int iParam0) // Position - 0x75B7
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_144(int iParam0) // Position - 0x75CC
{
	int i;
	int num;
	BOOL flag;
...
int func_145(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x764B
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

int func_146(int iParam0) // Position - 0x7665
{
	switch (iParam0)
	{
		case 10:
...
BOOL func_147(int iParam0, int iParam1) // Position - 0x76C3
{
...
BOOL func_149(int iParam0) // Position - 0x77DB
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_150(int iParam0) // Position - 0x77F1
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_151(int iParam0) // Position - 0x7807
{
	return iParam0 != 0;
}

BOOL func_152() // Position - 0x7813
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_153(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x782F
{
...
struct<2> func_154(int iParam0) // Position - 0x7865
{
	int num;
...
void func_155(var uParam0, var uParam1, int iParam2) // Position - 0x7880
{
...
BOOL func_156(int iParam0) // Position - 0x789D
{
...
const char* func_158(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x7915
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_225(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_227(func_226(Global_34));
...
BOOL func_159(int iParam0) // Position - 0x8411
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_160(int iParam0) // Position - 0x8426
{
	switch (iParam0)
	{
		case 0:
...
int func_161(int iParam0) // Position - 0x84E1
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_162(int iParam0) // Position - 0x854F
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_163(int iParam0) // Position - 0x86AA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_164(int iParam0, BOOL bParam1) // Position - 0x86E5
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_165(int iParam0, int iParam1) // Position - 0x8727
{
	if (!func_159(iParam0))
		return false;
...
int func_166() // Position - 0x876C
{
	return Global_1902569;
}

int func_167(int iParam0) // Position - 0x8778
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_168(int iParam0) // Position - 0x878B
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_169(float fParam0) // Position - 0x879D
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_170(var uParam0, int iParam1) // Position - 0x87B3
{
...
int func_171(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x87E9
{
	int duration;
	var data;
	int num;
...
BOOL func_172(int iParam0) // Position - 0x882C
{
	if (func_228(iParam0))
		if (!func_229(44))
			return false;
...
void func_173(int iParam0, int iParam1) // Position - 0x884C
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_174(int iParam0, int iParam1) // Position - 0x885D
{
	int num;
...
void func_176(BOOL bParam0) // Position - 0x88C2
{
	if (bParam0)
	{
...
void func_177(Volume volParam0, var uParam1) // Position - 0x8965
{
...
void func_178(Volume volParam0) // Position - 0x89CC
{
	if (VOLUME::DOES_VOLUME_EXIST(volParam0))
...
void func_179(var uParam0, Volume volParam1, BOOL bParam2) // Position - 0x89E3
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam1))
		return;
...
void func_180(int iParam0) // Position - 0x8A1B
{
	int i;
	int num;
...
BOOL func_181(int iParam0, BOOL bParam1) // Position - 0x8BF3
{
	if (func_45() != -1)
		return false;
...
int func_182(int iParam0, BOOL bParam1) // Position - 0x8C21
{
	if (!func_114(iParam0))
		return 0;
...
int func_183(int iParam0) // Position - 0x8CA4
{
	switch (iParam0)
	{
		case 27:
...
int func_184(int iParam0) // Position - 0x8CCB
{
	switch (iParam0)
	{
		case 33:
...
void func_186(int iParam0) // Position - 0x8D67
{
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		if (iParam0 == 1)
...
int func_187(int iParam0) // Position - 0x8DAD
{
	return func_242(iParam0) + 30;
}

Hash func_188(int iParam0) // Position - 0x8DBD
{
	if (!func_114(iParam0))
		return 0;
...
void func_189(int iParam0, PersChar pchParam1) // Position - 0x8DDB
{
	if (!func_114(iParam0))
		return;
...
PersChar func_190(int iParam0) // Position - 0x8DFC
{
	if (!func_114(iParam0))
		return 0;
...
void func_191(int iParam0, BOOL bParam1) // Position - 0x8E1C
{
	if (func_45() != -1)
		return;
...
BOOL func_192(int iParam0) // Position - 0x8E55
{
	if (!func_114(iParam0))
		return false;
...
void func_193(int iParam0, BOOL bParam1) // Position - 0x8E7B
{
	char* StringToTest;
...
void func_194(int iParam0, BOOL bParam1) // Position - 0x8EAF
{
	switch (iParam0)
	{
		case 5:
...
void func_195(int iParam0, int iParam1) // Position - 0x8EE4
{
	func_243(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_196(var uParam0, var uParam1) // Position - 0x8EFE
{
	return func_244(uParam0, 5, 8);
}

BOOL func_197(int iParam0) // Position - 0x8F11
{
	return func_245(1, iParam0);
}

int func_198(int iParam0) // Position - 0x8F20
{
	if (iParam0 == 255)
...
int func_199(int iParam0) // Position - 0x8F6B
{
...
void func_200(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x8F88
{
	func_247(iParam0);
...
int func_201(int iParam0) // Position - 0x8FEA
{
...
void func_202(var uParam0) // Position - 0x9007
{
	var unk;
...
void func_203(float* pfParam0) // Position - 0x9019
{
	var unk;
...
void func_205(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x9081
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_206(int iParam0) // Position - 0x90AE
{
...
void func_207(int iParam0, int iParam1) // Position - 0x910B
{
	func_147(iParam0, iParam1);
...
void func_208(Hash hParam0) // Position - 0x9146
{
...
void func_209(int iParam0) // Position - 0x9166
{
	return;
}

BOOL func_210(int iParam0, int iParam1) // Position - 0x916E
{
	if (iParam0 == -1)
		return false;
...
BOOL func_211(int iParam0) // Position - 0x9195
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_212(int iParam0) // Position - 0x91AB
{
	var unk;
...
BOOL func_213(Hash hParam0) // Position - 0x91DC
{
	return hParam0 != 0;
}

void func_214(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x91E8
{
	if (func_132(hParam0))
	{
...
void func_215(Hash hParam0, BOOL bParam1) // Position - 0x9220
{
	if (func_132(hParam0))
...
void func_216(Hash hParam0, BOOL bParam1) // Position - 0x924E
{
	if (func_132(hParam0))
...
void func_217(Hash hParam0, BOOL bParam1) // Position - 0x927C
{
	if (func_132(hParam0))
...
BOOL func_218() // Position - 0x92AA
{
	return true;
}

BOOL func_219(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x92B3
{
	int num;
...
BOOL func_220(int iParam0, int* piParam1, int* piParam2) // Position - 0x933B
{
	int num;
...
int func_221(int iParam0) // Position - 0x93AB
{
	int num;
...
BOOL func_222() // Position - 0x93C3
{
	return false;
}

BOOL func_223() // Position - 0x93CC
{
	var unk;
	var unk3;
...
BOOL func_224(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x9434
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_225(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x95AA
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_226(var uParam0, var uParam1, var uParam2) // Position - 0x95BE
{
	int i;
...
const char* func_227(int iParam0) // Position - 0x95EC
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_228(int iParam0) // Position - 0x98D0
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_229(int iParam0) // Position - 0x98FA
{
	if (!func_264(iParam0))
		return false;
...
struct<2> func_230(Player plParam0) // Position - 0x9916
{
	var gamerHandle;
...
const char* func_231(const char* sParam0, int iParam1) // Position - 0x992A
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_232(Volume volParam0) // Position - 0x9944
{
	if (VOLUME::DOES_VOLUME_EXIST(volParam0))
...
void func_233(int iParam0, int iParam1) // Position - 0x995B
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_234(int iParam0) // Position - 0x9970
{
	if (!func_114(iParam0))
		return false;
...
void func_235(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x9995
{
	PersChar persChar;
...
void func_236(int iParam0, BOOL bParam1) // Position - 0x9A81
{
	if (!func_211(iParam0))
		return;
...
void func_237(int iParam0, int iParam1) // Position - 0x9AD7
{
	if (!func_272(iParam0))
		return;
...
int func_238(int iParam0) // Position - 0x9B4A
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_239(int iParam0) // Position - 0x9B60
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_240(int iParam0, BOOL bParam1) // Position - 0x9B76
{
	if (func_45() != -1)
		return;
...
void func_241(int iParam0) // Position - 0x9BA7
{
	Ped EntityIndex;
...
int func_242(int iParam0) // Position - 0x9BEB
{
	return iParam0 * 31;
}

void func_243(BOOL bParam0, int iParam1) // Position - 0x9BF7
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_244(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x9C0C
{
	int num;
...
BOOL func_245(int iParam0, int iParam1) // Position - 0x9C47
{
	int num;
...
BOOL func_246(Any* panParam0, int iParam1, int iParam2) // Position - 0x9CBB
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_252(BOOL bParam0) // Position - 0x9D8A
{
	if (func_277(bParam0))
		return;
...
BOOL func_253(Any* panParam0, int iParam1, int iParam2) // Position - 0x9DB1
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_254() // Position - 0x9DE4
{
	return 1;
}

BOOL func_255(BOOL bParam0, BOOL bParam1) // Position - 0x9DED
{
	return bParam0 && bParam1 != false;
}

int func_256(int iParam0) // Position - 0x9DFC
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_257(int iParam0, int iParam1, var uParam2) // Position - 0xA7E4
{
	var unk;
...
int func_258() // Position - 0xA80B
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_259() // Position - 0xA820
{
	if (Global_1048576)
		return true;
...
struct<2> func_260() // Position - 0xA878
{
	return Global_1051268;
}

BOOL func_261(var uParam0, var uParam1) // Position - 0xA886
{
	if (!func_280(uParam0))
		return false;
...
struct<2> func_262() // Position - 0xA8BA
{
...
BOOL func_263(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0xA905
{
	var unk;
	float num;
	float num2;
...
BOOL func_264(int iParam0) // Position - 0xA935
{
	if (iParam0 == 0)
		return false;
...
BOOL func_265(int iParam0) // Position - 0xA948
{
	int num;
	int num2;
	int offset;
...
BOOL func_266(int iParam0) // Position - 0xA972
{
	if (!func_114(iParam0))
		return false;
...
BOOL func_267(Hash hParam0) // Position - 0xA996
{
	return hParam0 != 0;
}

BOOL func_268(int iParam0, BOOL bParam1) // Position - 0xA9A2
{
	if (!func_211(iParam0))
		return false;
...
void func_269(int iParam0, BOOL bParam1) // Position - 0xA9C8
{
	if (!func_211(iParam0))
		return;
...
void func_270(int iParam0, BOOL bParam1) // Position - 0xA9F6
{
	if (!func_211(iParam0))
		return;
...
void func_271(int iParam0) // Position - 0xAA30
{
	func_285(func_284(iParam0));
	return;
}

BOOL func_272(int iParam0) // Position - 0xAA42
{
	return iParam0 > -1 && iParam0 < 40;
}

Ped func_273(int iParam0) // Position - 0xAA58
{
	PersChar persChar;
...
int func_274(int iParam0, var uParam1) // Position - 0xAA86
{
	if (iParam0 == 2)
...
BOOL func_275(Any* panParam0, int iParam1, int iParam2) // Position - 0xAAA0
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_276() // Position - 0xAAD7
{
	return Global_1102813.f_3672;
}

BOOL func_277(BOOL bParam0) // Position - 0xAAE6
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_278(int iParam0, int iParam1, Any* panParam2) // Position - 0xAAFC
{
...
void func_279(Any* panParam0, int iParam1, var uParam2) // Position - 0xAB30
{
	var unk;
...
BOOL func_280(int iParam0) // Position - 0xABAA
{
	switch (iParam0)
	{
		case 2:
...
int func_281(int iParam0) // Position - 0xABE9
{
	switch (iParam0)
	{
		case 2:
...
void func_282(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xAC7F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_283(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0xB71C
{
	float num;
	float num2;
	float num3;
...
int func_284(int iParam0) // Position - 0xB782
{
...
void func_285(int iParam0) // Position - 0xBC9F
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_286(var uParam0, var uParam1) // Position - 0xBCB0
{
	var unk;
...
int func_287(int iParam0) // Position - 0xBCDC
{
	int num;
...
BOOL func_288(int iParam0, var uParam1, Any* panParam2) // Position - 0xBE51
{
	if (!func_261(iParam0))
		return false;
...
void func_289(Any* panParam0) // Position - 0xBF5C
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
