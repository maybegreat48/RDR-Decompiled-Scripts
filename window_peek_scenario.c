...
void func_4() // Position - 0xDD
{
	return;
}

void func_5() // Position - 0xE5
{
	int i;
...
void func_8() // Position - 0x2B1
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x2BD
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x2E5
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x30D
{
	struct<2> data;
...
BOOL func_12(int iParam0) // Position - 0x335
{
	return bLocal_18 && iParam0 != false;
}

void func_13() // Position - 0x344
{
	if (func_12(2))
		return;
...
void func_15(BOOL bParam0) // Position - 0x3D1
{
	if (func_12(bParam0))
		return;
...
void func_16(int iParam0) // Position - 0x3EC
{
	iLocal_19 = iParam0;
	return;
}

void func_17(var uParam0, BOOL bParam1) // Position - 0x3F8
{
	float num;
	float num2;
	...
	CAM::SET_CAM_PARAMS(*uParam0, uLocal_32, uLocal_35 + fLocal_42, 40f, 0, 1, 1, 2, true, false);
	return;
}

void func_18(var uParam0) // Position - 0x5CC
{
	return;
}

void func_19(var uParam0) // Position - 0x5D4
{
	return;
}

void func_20(var uParam0) // Position - 0x5DC
{
	return;
}

void func_21() // Position - 0x5E4
{
...
void func_22(int iParam0, int iParam1) // Position - 0x602
{
...
void func_23(var uParam0, var uParam1, var uParam2, var uParam3, eControlAction ecaParam4, eControlAction ecaParam5, eControlAction ecaParam6, eControlAction ecaParam7, eControlType ectParam8) // Position - 0x620
{
...
float func_24(float fParam0, float fParam1, float fParam2) // Position - 0x67C
{
	if (fParam0 > fParam2)
		return fParam2;
