...
int func_9(int iParam0) // Position - 0x5C5
{
	if (iParam0 < 0)
		return -1;
	else if (iParam0 <= 10)
...
BOOL func_10(int iParam0) // Position - 0x6C1
{
	return iParam0 > -1 && iParam0 < 17;
}

void func_11(int iParam0, BOOL bParam1) // Position - 0x6D7
{
	Global_1896646[iParam0 /*2*/] = Global_1896646[iParam0 /*2*/] || bParam1;
	return;
}

Hash func_12(int iParam0) // Position - 0x6F2
{
	Hash num;
...
void _DEBUG_PRINT(int iParam0) // Position - 0xAD9
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0xAE5
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0xAF2
{
	return;
}

BOOL func_17(int iParam0) // Position - 0xAFA
{
...
void _DEBUG_PRINT_0(int iParam0) // Position - 0xB28
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0xB34
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0xB49
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0xB5A
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0xB99
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0xBA5
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0xBAD
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0xC5D
{
	return;
}

void func_26() // Position - 0xC65
{
	return;
}

void func_27() // Position - 0xC6D
{
	func_58(0, -3701.0564f, -2595.4563f, -14.373728f, volLocal_23, 127);
	return;
}

void func_28() // Position - 0xC8D
{
	return;
}

void func_29(int iParam0) // Position - 0xC95
{
...
void func_30(int iParam0) // Position - 0xD09
{
	return;
}

void func_31() // Position - 0xD11
{
	return;
}

void func_32() // Position - 0xD19
{
	return;
}

void func_33(int iParam0) // Position - 0xD21
{
	func_64(0.8f, 0.2f, 0f, 0f);
	return;
}

void func_34() // Position - 0xD39
{
...
void func_35(var uParam0) // Position - 0xD6A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xDB0
{
...
void func_37(int iParam0) // Position - 0xDCB
{
	if (!func_66(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xDE4
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xDF5
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xE0D
{
...
void func_41(var uParam0, int iParam1) // Position - 0xE4C
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xF8B
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xF98
{
...
BOOL func_44(int iParam0) // Position - 0xFCE
{
	if (iParam0 == 0)
	{
		func_83();
...
int func_45() // Position - 0x10E2
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0x10F0
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0x10FC
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0x1169
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x1249
{
	if (!func_66(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x1267
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x127A
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1298
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x1390
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x13A1
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x13B5
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x13C9
{
	return uParam0;
}

void func_58(int iParam0, float fParam1, float fParam2, float fParam3, Volume volParam4, int iParam5) // Position - 0x13D3
{
...
void func_59(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x1431
{
...
void func_60(int iParam0, int iParam1) // Position - 0x15E0
{
	func_112(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

int func_61(int iParam0, BOOL bParam1) // Position - 0x15FA
{
	int num;
	Hash hash;
	float num2;
...
void func_63(int iParam0) // Position - 0x18E8
{
	int i;
	Hash hash;
	float num;
...
void func_64(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1A65
{
...
void func_65(var uParam0, Volume volParam1, int iParam2) // Position - 0x1A8D
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_66(int iParam0) // Position - 0x1AE6
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_67() // Position - 0x1AFC
{
	int i;
...
BOOL func_68(var uParam0) // Position - 0x1B29
{
	if (func_127())
	{
		if (!*uParam0)
...
void func_69(Hash hParam0, int iParam1) // Position - 0x1B59
{
	func_128(hParam0, true, 0, false, false, 0, false, false);
	return;
}

void func_70(int iParam0, Volume volParam1, var uParam2) // Position - 0x1B6E
{
	if (!*uParam2)
	{
...
BOOL func_71(int iParam0, int iParam1) // Position - 0x1BB0
{
	return iParam0 && iParam1 != false;
}

BOOL func_72(var uParam0, int iParam1) // Position - 0x1BBF
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_73() // Position - 0x1BD0
{
	return func_71(Global_1940199, 8192);
}

BOOL func_74(var uParam0, int iParam1) // Position - 0x1BE3
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_75(int iParam0) // Position - 0x1BF4
{
	if (!func_66(iParam0))
		return false;
...
BOOL func_76(int iParam0, int iParam1) // Position - 0x1C34
{
...
void func_78(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1C6F
{
	BOOL flag;
	...
	StringToTest = func_134(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_146(&unk, joaat("COLOR_PURE_WHITE")), str3, func_146(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_146(&unk, joaat("COLOR_PURE_WHITE")), func_146(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_147(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_79(var uParam0, int iParam1) // Position - 0x1EDF
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_80(int iParam0, BOOL bParam1) // Position - 0x1EF2
{
...
void func_81(BOOL bParam0) // Position - 0x255B
{
	if (bParam0)
...
BOOL func_82(int iParam0) // Position - 0x2584
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_83() // Position - 0x25C9
{
	return;
}

Hash func_84(int iParam0, BOOL bParam1) // Position - 0x25D1
{
	switch (iParam0)
	{
		case 0:
...
void func_85(int iParam0, BOOL bParam1) // Position - 0x2D96
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_86(BOOL bParam0) // Position - 0x2DE9
{
	if (bParam0)
...
void func_87(int iParam0) // Position - 0x2E12
{
	int i;
	Interior interiorAtCoords;
...
void func_88(int iParam0) // Position - 0x2EE1
{
	int i;
...
void func_89(int iParam0) // Position - 0x2F12
{
	int i;
...
BOOL func_90(int iParam0, BOOL bParam1) // Position - 0x2F45
{
	int num;
	int num2;
	int num3;
...
BOOL func_91(int iParam0) // Position - 0x2FFB
{
	int i;
...
BOOL func_92(int iParam0, BOOL bParam1) // Position - 0x3075
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_93(int iParam0) // Position - 0x30A6
{
	if (!func_66(iParam0))
		return false;
...
BOOL func_94(int iParam0) // Position - 0x30C7
{
	if (!func_66(iParam0))
		return false;
...
BOOL func_95(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x311A
{
	BOOL flag;
...
BOOL func_96(int iParam0) // Position - 0x37DA
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_97(int iParam0) // Position - 0x37F1
{
	switch (iParam0)
	{
		case 64:
...
int func_98(int iParam0, BOOL bParam1) // Position - 0x3834
{
	if (!func_96(iParam0))
		return 0;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x391F
{
...
void func_100(int iParam0) // Position - 0x3949
{
...
int func_101(int iParam0, int iParam1) // Position - 0x3A29
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_103() // Position - 0x3B20
{
	return func_165(func_56(0));
}

BOOL func_104(int iParam0) // Position - 0x3B31
{
	return !func_166(iParam0);
}

void func_105(BOOL bParam0, BOOL bParam1) // Position - 0x3B40
{
	if (func_167(255) == 4)
		return;
...
int func_107(int iParam0, int iParam1) // Position - 0x403E
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_108(int iParam0) // Position - 0x49A4
{
	if (!func_181(iParam0))
		return 0;
...
int func_109(int iParam0) // Position - 0x49E5
{
	switch (iParam0)
	{
		case 3:
...
void func_110(int iParam0, int iParam1) // Position - 0x4A82
{
...
void func_111(int iParam0) // Position - 0x4AB1
{
...
void func_112(int iParam0, int iParam1) // Position - 0x4AEA
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_113(int iParam0, int iParam1) // Position - 0x4AFB
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

int func_114() // Position - 0x4B14
{
	return Global_1893611.f_2;
}

BOOL func_115(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4B22
{
	return func_183(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_116(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4B42
{
	return func_183(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_117(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x4B62
{
	if (bParam6)
...
void func_118(int iParam0) // Position - 0x4BDE
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_119(int iParam0) // Position - 0x4BF3
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_120(int iParam0) // Position - 0x4C08
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_121(int iParam0) // Position - 0x4C1D
{
	int i;
	int num;
	BOOL flag;
...
int func_122(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x4C9C
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

int func_123(int iParam0) // Position - 0x4CB6
{
	switch (iParam0)
	{
		case 10:
...
BOOL func_124(int iParam0, int iParam1) // Position - 0x4D14
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

BOOL func_125(int iParam0) // Position - 0x4D2D
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_126(int iParam0) // Position - 0x4D43
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_127() // Position - 0x4D59
{
	if (Global_1572887.f_14 == -1)
		return false;
...
void func_128(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4D75
{
...
BOOL func_129(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x4E00
{
...
struct<2> func_130(int iParam0) // Position - 0x4E36
{
	int num;
...
void func_131(var uParam0, var uParam1, int iParam2) // Position - 0x4E51
{
...
BOOL func_132(int iParam0) // Position - 0x4E6E
{
...
const char* func_134(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x4EE6
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_195(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_197(func_196(Global_34));
...
BOOL func_135(int iParam0) // Position - 0x594C
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_136(int iParam0) // Position - 0x5961
{
	switch (iParam0)
	{
		case 0:
...
int func_137(int iParam0) // Position - 0x5A1C
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_138(int iParam0) // Position - 0x5A8A
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_139(int iParam0) // Position - 0x5BE5
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_140(int iParam0, BOOL bParam1) // Position - 0x5C20
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_141(int iParam0, int iParam1) // Position - 0x5C62
{
	if (!func_135(iParam0))
		return false;
...
int func_142() // Position - 0x5CA7
{
	return Global_1902569;
}

int func_143(int iParam0) // Position - 0x5CB3
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_144(int iParam0) // Position - 0x5CC6
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_145(float fParam0) // Position - 0x5CD8
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_146(var uParam0, int iParam1) // Position - 0x5CEE
{
...
int func_147(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x5D24
{
	int duration;
	var data;
	int num;
...
BOOL func_148(int iParam0) // Position - 0x5D67
{
	if (func_198(iParam0))
		if (!func_199(44))
			return false;
...
void func_149(int iParam0, int iParam1) // Position - 0x5D87
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_150(int iParam0, int iParam1) // Position - 0x5D98
{
	int num;
...
void func_151(int iParam0) // Position - 0x5DAE
{
	int i;
	int num;
...
BOOL func_152(int iParam0, BOOL bParam1) // Position - 0x5F86
{
	if (func_45() != -1)
		return false;
...
int func_153(int iParam0, BOOL bParam1) // Position - 0x5FB4
{
	if (!func_96(iParam0))
		return 0;
...
int func_154(int iParam0) // Position - 0x6037
{
	switch (iParam0)
	{
		case 27:
...
int func_155(int iParam0) // Position - 0x605E
{
	switch (iParam0)
	{
		case 33:
...
Hash func_157(int iParam0) // Position - 0x60FA
{
	if (!func_96(iParam0))
		return 0;
...
void func_158(int iParam0, PersChar pchParam1) // Position - 0x6118
{
	if (!func_96(iParam0))
		return;
...
PersChar func_159(int iParam0) // Position - 0x6139
{
	if (!func_96(iParam0))
		return 0;
...
void func_160(int iParam0, BOOL bParam1) // Position - 0x6159
{
	if (func_45() != -1)
		return;
...
BOOL func_161(int iParam0) // Position - 0x6192
{
	if (!func_96(iParam0))
		return false;
...
void func_162(int iParam0, BOOL bParam1) // Position - 0x61B8
{
	char* StringToTest;
...
void func_163(int iParam0, BOOL bParam1) // Position - 0x61EC
{
	switch (iParam0)
	{
		case 5:
...
void func_164(int iParam0, int iParam1) // Position - 0x6221
{
	func_210(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_165(var uParam0, var uParam1) // Position - 0x623B
{
	return func_211(uParam0, 5, 8);
}

BOOL func_166(int iParam0) // Position - 0x624E
{
	return func_212(1, iParam0);
}

int func_167(int iParam0) // Position - 0x625D
{
	if (iParam0 == 255)
...
int func_168(int iParam0) // Position - 0x62A8
{
...
void func_169(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x62C5
{
	func_214(iParam0);
...
int func_170(int iParam0) // Position - 0x6327
{
...
void func_171(var uParam0) // Position - 0x6344
{
	var unk;
...
void func_172(float* pfParam0) // Position - 0x6356
{
	var unk;
...
void func_174(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x63BE
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_175(int iParam0) // Position - 0x63EB
{
...
void func_176(int iParam0, int iParam1) // Position - 0x6448
{
	func_124(iParam0, iParam1);
...
int func_177(int iParam0) // Position - 0x6483
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_178(Hash hParam0) // Position - 0x6497
{
...
void func_179(int iParam0) // Position - 0x64B7
{
	return;
}

BOOL func_180(int iParam0, int iParam1) // Position - 0x64BF
{
	if (iParam0 == -1)
		return false;
...
BOOL func_181(int iParam0) // Position - 0x64E6
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_182(int iParam0) // Position - 0x64FC
{
	var unk;
...
BOOL func_183(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x652D
{
	int num;
...
Hash func_184(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x65B5
{
...
BOOL func_185(Hash hParam0) // Position - 0x6659
{
	if (func_226(hParam0))
...
void func_186(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6674
{
	if (func_185(hParam0))
	{
...
void func_187(Hash hParam0, BOOL bParam1) // Position - 0x66AC
{
	if (func_185(hParam0))
...
void func_188(Hash hParam0, BOOL bParam1) // Position - 0x66DA
{
	if (func_185(hParam0))
...
void func_189(Hash hParam0, BOOL bParam1) // Position - 0x6708
{
	if (func_185(hParam0))
...
BOOL func_190() // Position - 0x6736
{
	return true;
}

int func_191(int iParam0) // Position - 0x673F
{
	int num;
...
BOOL func_192() // Position - 0x6757
{
	return false;
}

BOOL func_193() // Position - 0x6760
{
	var unk;
	var unk3;
...
BOOL func_194(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x67C8
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_195(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x693E
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_196(var uParam0, var uParam1, var uParam2) // Position - 0x6952
{
	int i;
...
const char* func_197(int iParam0) // Position - 0x6980
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_198(int iParam0) // Position - 0x6C64
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_199(int iParam0) // Position - 0x6C8E
{
	if (!func_232(iParam0))
		return false;
...
struct<2> func_200(Player plParam0) // Position - 0x6CAA
{
	var gamerHandle;
...
const char* func_201(const char* sParam0, int iParam1) // Position - 0x6CBE
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

BOOL func_202(int iParam0) // Position - 0x6CD8
{
	if (!func_96(iParam0))
		return false;
...
void func_203(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6CFD
{
	PersChar persChar;
...
void func_204(int iParam0, BOOL bParam1) // Position - 0x6DE9
{
	if (!func_181(iParam0))
		return;
...
void func_205(int iParam0, int iParam1) // Position - 0x6E3F
{
	if (!func_240(iParam0))
		return;
...
int func_206(int iParam0) // Position - 0x6EB2
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_207(int iParam0) // Position - 0x6EC8
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_208(int iParam0, BOOL bParam1) // Position - 0x6EDE
{
	if (func_45() != -1)
		return;
...
void func_209(int iParam0) // Position - 0x6F0F
{
	Ped EntityIndex;
...
void func_210(var uParam0, int iParam1) // Position - 0x6F53
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_211(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x6F68
{
	int num;
...
BOOL func_212(int iParam0, int iParam1) // Position - 0x6FA3
{
	int num;
...
BOOL func_213(var uParam0, int iParam1, int iParam2) // Position - 0x7017
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_219(BOOL bParam0) // Position - 0x70E6
{
	if (func_245(bParam0))
		return;
...
BOOL func_220(var uParam0, int iParam1, int iParam2) // Position - 0x710D
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_221() // Position - 0x7140
{
	return 1;
}

BOOL func_222(BOOL bParam0, BOOL bParam1) // Position - 0x7149
{
	return bParam0 && bParam1 != false;
}

int func_223(int iParam0) // Position - 0x7158
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_224(int iParam0, int iParam1, var uParam2) // Position - 0x7B40
{
	var unk;
...
int func_225() // Position - 0x7B67
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_226(Hash hParam0) // Position - 0x7B7C
{
	return hParam0 != 0;
}

BOOL func_227() // Position - 0x7B88
{
	if (Global_1048576)
		return true;
	...
	if (!func_229(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_228() // Position - 0x7BE0
{
	return Global_1051268;
}

BOOL func_229(var uParam0, var uParam1) // Position - 0x7BEE
{
	if (!func_248(uParam0))
		return false;
...
struct<2> func_230() // Position - 0x7C22
{
...
BOOL func_231(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7C6D
{
	var unk;
	float num;
	float num2;
...
BOOL func_232(int iParam0) // Position - 0x7C9D
{
	if (iParam0 == 0)
		return false;
...
BOOL func_233(int iParam0) // Position - 0x7CB0
{
	int num;
	int num2;
	int offset;
...
BOOL func_234(int iParam0) // Position - 0x7CDA
{
	if (!func_96(iParam0))
		return false;
...
BOOL func_235(Hash hParam0) // Position - 0x7CFE
{
	return hParam0 != 0;
}

BOOL func_236(int iParam0, BOOL bParam1) // Position - 0x7D0A
{
	if (!func_181(iParam0))
		return false;
...
void func_237(int iParam0, BOOL bParam1) // Position - 0x7D30
{
	if (!func_181(iParam0))
		return;
...
void func_238(int iParam0, BOOL bParam1) // Position - 0x7D5E
{
	if (!func_181(iParam0))
		return;
...
void func_239(int iParam0) // Position - 0x7D98
{
	func_253(func_252(iParam0));
	return;
}

BOOL func_240(int iParam0) // Position - 0x7DAA
{
	return iParam0 > -1 && iParam0 < 40;
}

Ped func_241(int iParam0) // Position - 0x7DC0
{
	PersChar persChar;
...
int func_242(int iParam0, var uParam1) // Position - 0x7DEE
{
	if (iParam0 == 2)
...
BOOL func_243(var uParam0, int iParam1, int iParam2) // Position - 0x7E08
{
	return MISC::IS_BIT_SET(uParam0->[iParam1 / 31], iParam1 % 31);
}

int func_244() // Position - 0x7E3F
{
	return Global_1102813.f_3672;
}

BOOL func_245(BOOL bParam0) // Position - 0x7E4E
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_246(int iParam0, int iParam1, Any* panParam2) // Position - 0x7E64
{
...
void func_247(Any* panParam0, int iParam1, var uParam2) // Position - 0x7E98
{
	var unk;
...
BOOL func_248(int iParam0) // Position - 0x7F12
{
	switch (iParam0)
	{
		case 2:
...
int func_249(int iParam0) // Position - 0x7F51
{
	switch (iParam0)
	{
		case 2:
...
void func_250(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x7FE7
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_251(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x8A96
{
	float num;
	float num2;
	float num3;
...
int func_252(int iParam0) // Position - 0x8AFC
{
...
void func_253(int iParam0) // Position - 0x9019
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_254(var uParam0, var uParam1) // Position - 0x902A
{
	var unk;
...
int func_255(int iParam0) // Position - 0x9056
{
	int num;
...
BOOL func_256(int iParam0, var uParam1, Any* panParam2) // Position - 0x91CB
{
	if (!func_229(iParam0))
		return false;
...
void func_257(Any* panParam0) // Position - 0x92D6
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
