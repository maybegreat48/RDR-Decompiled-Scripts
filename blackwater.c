...
void func_3() // Position - 0x43A
{
	return;
}

BOOL func_4() // Position - 0x442
{
	if (func_45() != -1)
...
void func_5(int iParam0, var uParam1) // Position - 0x45D
{
	if (!func_38(16))
		return;
...
void func_6(int iParam0) // Position - 0x58D
{
	func_53();
	return;
}

void func_7() // Position - 0x599
{
...
int func_9(int iParam0) // Position - 0x5D2
{
	if (iParam0 < 0)
		return -1;
	else if (iParam0 <= 10)
...
BOOL func_10(int iParam0) // Position - 0x6CE
{
	return iParam0 > -1 && iParam0 < 17;
}

void func_11(int iParam0, BOOL bParam1) // Position - 0x6E4
{
	Global_1896646[iParam0 /*2*/] = Global_1896646[iParam0 /*2*/] || bParam1;
	return;
}

Hash func_12(int iParam0) // Position - 0x6FF
{
	Hash num;
...
BOOL func_13() // Position - 0x7E7
{
	...
	iLocal_89 = MISC::_ADD_DISPATCH_SPAWN_BLOCKING_AREA(volLocal_88);
...
void _DEBUG_PRINT(int iParam0) // Position - 0xEFB
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0xF07
{
	iParam0 = iParam0;
	return true;
}

void func_16(int iParam0) // Position - 0xF14
{
	iParam0 = iParam0;
	...
	func_57(12, 0, 0);
	func_57(19, 0, 0);
	func_58(uLocal_99, 5f, 0, 0, 5, false);
	return;
}

BOOL func_17(int iParam0) // Position - 0xF87
{
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0xF90
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0xF9C
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0xFB1
{
	return func_59(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0xFC2
{
...
void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x1001
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x100D
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x1015
{
	if (func_60(iParam0))
		return true;
...
void func_25() // Position - 0x10C5
{
	return;
}

void func_26() // Position - 0x10CD
{
	return;
}

void func_27() // Position - 0x10D5
{
	func_64(0, -815.3443f, -1315.5991f, 42.6788f, volLocal_86, 40);
	return;
}

void func_28() // Position - 0x10F5
{
	return;
}

void func_29(int iParam0) // Position - 0x10FD
{
...
void func_30(int iParam0) // Position - 0x13B7
{
	iParam0 = iParam0;
...
void func_31() // Position - 0x1426
{
	return;
}

void func_32() // Position - 0x142E
{
	return;
}

void func_33(int iParam0) // Position - 0x1436
{
...
void func_35(var uParam0) // Position - 0x149A
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0x14E0
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0x1522
{
	if (!func_80(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0x154F
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0x1560
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0x1578
{
	func_83();
	func_84();
...
void func_41(var uParam0, int iParam1) // Position - 0x160B
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0x174A
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0x1757
{
...
BOOL func_44(int iParam0) // Position - 0x178D
{
	if (iParam0 == 0)
	{
		func_103();
...
int func_45() // Position - 0x18A1
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0x18AF
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0x18BB
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0x1928
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x1A08
{
	if (!func_80(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x1A26
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x1A39
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

void func_53() // Position - 0x1A57
{
...
int func_54(Volume volParam0, int iParam1) // Position - 0x1ADB
{
	int i;
...
void func_55(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1B65
{
	!bParam2;
...
void func_56(Hash hParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, float fParam5, float fParam6, float fParam7, char* sParam8) // Position - 0x26AA
{
...
void func_57(int iParam0, int iParam1, int iParam2) // Position - 0x26F1
{
	var unk;
	int i;
...
void func_58(Vector3 vParam0, var uParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x27B6
{
...
BOOL func_59(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x284C
{
	int num;
	int num2;
	int num3;
...
BOOL func_60(int iParam0) // Position - 0x2944
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_61(int iParam0) // Position - 0x2955
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_62(int iParam0) // Position - 0x2969
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_63(var uParam0, var uParam1) // Position - 0x297D
{
	return uParam0;
}

void func_64(int iParam0, float fParam1, float fParam2, float fParam3, Volume volParam4, int iParam5) // Position - 0x2987
{
...
void func_65(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x29E5
{
...
void func_66(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2B94
{
	int num;
...
void func_67(int iParam0, int iParam1) // Position - 0x2C38
{
	func_148(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

int func_68(int iParam0, BOOL bParam1) // Position - 0x2C52
{
	int num;
	Hash hash;
	float num2;
...
BOOL func_70() // Position - 0x2D8D
{
	return func_154(func_62(0));
}

void func_71() // Position - 0x2D9E
{
	int i;
	var unk;
...
void func_72(int iParam0) // Position - 0x2F65
{
	int i;
	Hash hash;
	float num;
...
void func_73(int iParam0) // Position - 0x30E2
{
	int i;
...
int func_74(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x31D9
{
	PersChar persChar;
...
void func_75(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x3227
{
...
BOOL func_76(int iParam0) // Position - 0x324F
{
	if (!func_165(iParam0))
		return false;
...
BOOL func_77(int iParam0) // Position - 0x326B
{
	int num;
	int num2;
	int offset;
...
void func_78(int iParam0, BOOL bParam1) // Position - 0x3295
{
	int num;
	int num2;
...
void func_79(var uParam0, Volume volParam1, int iParam2) // Position - 0x32C2
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_80(int iParam0) // Position - 0x331B
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_81() // Position - 0x3331
{
	int i;
...
void func_82(int iParam0, int iParam1) // Position - 0x335E
{
	if (!func_171(iParam0))
		return;
...
BOOL func_85(Hash hParam0) // Position - 0x3698
{
	if (CAM::IS_SCREEN_FADED_OUT())
		return false;
...
BOOL func_86(BOOL bParam0) // Position - 0x36B6
{
	int num;
...
void func_87(Hash hParam0) // Position - 0x390A
{
...
void func_88(Hash hParam0) // Position - 0x3923
{
	if (STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		func_184(hParam0);
...
BOOL func_89(var uParam0) // Position - 0x393B
{
	if (func_185())
	{
		if (!*uParam0)
...
void func_90(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x396B
{
...
BOOL func_91(int iParam0, int iParam1) // Position - 0x39F6
{
	return iParam0 && iParam1 != false;
}

BOOL func_92(var uParam0, int iParam1) // Position - 0x3A05
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_93() // Position - 0x3A16
{
	return func_91(Global_1940199, 8192);
}

BOOL func_94(var uParam0, int iParam1) // Position - 0x3A29
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_95(int iParam0) // Position - 0x3A3A
{
	if (!func_80(iParam0))
		return false;
...
BOOL func_96(int iParam0, int iParam1) // Position - 0x3A7A
{
...
int func_97() // Position - 0x3AA7
{
	return Global_1896646.f_41;
}

void func_98(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x3AB5
{
	BOOL flag;
	...
	StringToTest = func_193(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_203(&unk, joaat("COLOR_PURE_WHITE")), str3, func_203(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_203(&unk, joaat("COLOR_PURE_WHITE")), func_203(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_204(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_99(var uParam0, int iParam1) // Position - 0x3D26
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_100(int iParam0, BOOL bParam1) // Position - 0x3D39
{
...
void func_101(BOOL bParam0) // Position - 0x4514
{
	if (bParam0)
...
BOOL func_102(int iParam0) // Position - 0x453D
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_103() // Position - 0x4582
{
	return;
}

Hash func_104(int iParam0, BOOL bParam1) // Position - 0x458A
{
	switch (iParam0)
	{
		case 0:
...
void func_105(int iParam0, BOOL bParam1) // Position - 0x4D4F
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_106(BOOL bParam0) // Position - 0x4DA2
{
	if (bParam0)
...
void func_107(int iParam0) // Position - 0x4DCB
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(volLocal_88))
		MISC::REMOVE_DISPATCH_SPAWN_BLOCKING_AREA(iLocal_89);

	iParam0 = iParam0;
	func_58(uLocal_99, 5f, 1, 0, 5, false);
	return;
}

void func_108(int iParam0) // Position - 0x4E37
{
	int i;
...
void func_109(int iParam0) // Position - 0x4E68
{
	int i;
...
BOOL func_110(int iParam0, BOOL bParam1) // Position - 0x4E9B
{
	int num;
	int num2;
	int num3;
...
BOOL func_111(int iParam0) // Position - 0x4F51
{
	int i;
...
BOOL func_112(int iParam0, BOOL bParam1) // Position - 0x4FCB
{
	if (Global_1572887.f_14 == -1)
...
void func_113(int iParam0) // Position - 0x4FFC
{
	int num;
	int num2;
	int BitIndex;
...
void func_114(int iParam0) // Position - 0x502F
{
	int num;
	int num2;
	int BitIndex;
...
BOOL func_117(int iParam0) // Position - 0x510B
{
	int num;
	int num2;
	int offset;
...
void func_118(Hash hParam0) // Position - 0x518A
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x51AA
{
...
void func_120(var uParam0, int iParam1) // Position - 0x51D4
{
...
void func_121(var uParam0, int iParam1) // Position - 0x520F
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_122(var uParam0, int iParam1) // Position - 0x5248
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_123(var uParam0) // Position - 0x5280
{
	int num;
...
void func_124(var uParam0, int iParam1) // Position - 0x52BE
{
	BOOL flag;
	int i;
	int j;
...
Vector3 func_125(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6) // Position - 0x5341
{
	float num;
...
Vector3 func_126(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, float fParam6) // Position - 0x53B0
{
	float num;
...
BOOL func_127(int iParam0) // Position - 0x541F
{
	if (!func_80(iParam0))
		return false;
...
BOOL func_128(int iParam0) // Position - 0x5440
{
	if (!func_80(iParam0))
		return false;
...
BOOL func_129(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5493
{
	BOOL flag;
...
BOOL func_130(int iParam0) // Position - 0x5B53
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_131(int iParam0) // Position - 0x5B6A
{
	switch (iParam0)
	{
		case 64:
...
int func_132(int iParam0, BOOL bParam1) // Position - 0x5BAD
{
	if (!func_130(iParam0))
		return 0;
...
void func_133(int iParam0) // Position - 0x5C98
{
...
int func_134(int iParam0, int iParam1) // Position - 0x5D78
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_135() // Position - 0x5E5B
{
	return func_237(func_62(0));
}

BOOL func_136(int iParam0) // Position - 0x5E6C
{
	return !func_238(iParam0);
}

void func_137(BOOL bParam0, BOOL bParam1) // Position - 0x5E7B
{
	if (func_239(255) == 4)
		return;
...
void func_138(int iParam0, BOOL bParam1) // Position - 0x5FC6
{
	BOOL flag;
...
int func_139(int iParam0, int iParam1) // Position - 0x6375
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_140(int iParam0) // Position - 0x6CDB
{
	if (!func_251(iParam0))
		return 0;
...
int func_141(int iParam0) // Position - 0x6D1C
{
	switch (iParam0)
	{
		case 3:
...
void func_142(int iParam0, int iParam1) // Position - 0x6DB9
{
...
int func_144(int iParam0) // Position - 0x6E21
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

Hash func_145(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6E35
{
...
BOOL func_146(Hash hParam0) // Position - 0x6ED9
{
	if (func_253(hParam0))
...
BOOL func_147(Hash hParam0) // Position - 0x6EF4
{
	func_145(hParam0, false, false);
...
void func_148(int iParam0, int iParam1) // Position - 0x6F1D
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

BOOL func_149(int iParam0, int iParam1) // Position - 0x6F2E
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

int func_150() // Position - 0x6F47
{
	return Global_1893611.f_2;
}

BOOL func_151(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x6F55
{
	return func_254(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_152(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x6F75
{
	return func_254(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_153(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x6F95
{
	if (bParam6)
...
BOOL func_154(var uParam0, var uParam1) // Position - 0x7011
{
	return func_255(uParam0, 9, 12);
}

void func_155(int iParam0) // Position - 0x7024
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_156(int iParam0) // Position - 0x7039
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_157(int iParam0) // Position - 0x704E
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_158(int iParam0) // Position - 0x7063
{
	int i;
	int num;
	BOOL flag;
...
int func_159(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x70E2
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

int func_160(int iParam0) // Position - 0x70FC
{
	switch (iParam0)
	{
		case 10:
...
BOOL func_161(int iParam0, int iParam1) // Position - 0x715A
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

int func_162(int iParam0) // Position - 0x7173
{
	Hash hash;
	float num;
	var unk;
...
BOOL func_163(int iParam0, BOOL bParam1) // Position - 0x7272
{
	if (func_45() != -1)
		return false;
...
PersChar func_164(int iParam0) // Position - 0x72CA
{
	if (!func_130(iParam0))
		return 0;
...
BOOL func_165(int iParam0) // Position - 0x72EA
{
	if (iParam0 == 0)
		return false;
...
BOOL func_166(int iParam0) // Position - 0x72FD
{
	int num;
	int num2;
	int offset;
...
void func_167(int iParam0, var uParam1, var uParam2) // Position - 0x7327
{
	int num;
...
BOOL func_168(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x7343
{
...
void func_169(int iParam0, int iParam1) // Position - 0x73E5
{
	int Variable;
...
BOOL func_170(int iParam0) // Position - 0x7409
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_171(int iParam0) // Position - 0x741F
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_172(int iParam0) // Position - 0x7435
{
	return iParam0 != 0;
}

BOOL func_173() // Position - 0x7441
{
	if (func_45() == -1)
		return true;
...
float func_174(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x745A
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
int func_178() // Position - 0x7534
{
	return Global_1902569;
}

int func_179(int iParam0) // Position - 0x7540
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

BOOL func_180(Entity eParam0, const char* sParam1, const char* sParam2, int iParam3) // Position - 0x7553
{
	float entityAnimCurrentTime;
...
BOOL func_182(BOOL bParam0, BOOL bParam1) // Position - 0x75D0
{
	return bParam0 && bParam1 != false;
}

int func_183(Hash hParam0) // Position - 0x75DF
{
	if (STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		return 1;
...
int func_184(Hash hParam0) // Position - 0x7606
{
	if (!STREAMING::IS_IPL_ACTIVE_HASH(hParam0))
		return 1;
...
void func_186(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x764A
{
	if (func_146(hParam0))
	{
...
void func_187(Hash hParam0, BOOL bParam1) // Position - 0x7682
{
	if (func_146(hParam0))
...
void func_188(Hash hParam0, BOOL bParam1) // Position - 0x76B0
{
	if (func_146(hParam0))
...
void func_189(Hash hParam0, BOOL bParam1) // Position - 0x76DE
{
	if (func_146(hParam0))
...
BOOL func_190() // Position - 0x770C
{
	return true;
}

BOOL func_191(int iParam0) // Position - 0x7715
{
...
const char* func_193(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x778D
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_268(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_270(func_269(Global_34));
...
BOOL func_194(int iParam0) // Position - 0x81F6
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_195(int iParam0) // Position - 0x820B
{
	switch (iParam0)
	{
		case 0:
...
int func_196(int iParam0) // Position - 0x82C6
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_197(int iParam0) // Position - 0x8334
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_198(int iParam0) // Position - 0x848F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_199(int iParam0, BOOL bParam1) // Position - 0x84CA
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_200(int iParam0, int iParam1) // Position - 0x850C
{
	if (!func_194(iParam0))
		return false;
...
int func_201(int iParam0) // Position - 0x8551
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_202(float fParam0) // Position - 0x8563
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_203(var uParam0, int iParam1) // Position - 0x8579
{
...
int func_204(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x85AF
{
	int duration;
	var data;
	int num;
...
BOOL func_205(int iParam0) // Position - 0x85F2
{
	if (func_271(iParam0))
		if (!func_76(44))
			return false;
...
void func_206(int iParam0, int iParam1) // Position - 0x8612
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_207(int iParam0, int iParam1) // Position - 0x8623
{
	int num;
...
void func_208(var uParam0, var uParam1, int iParam2) // Position - 0x8639
{
...
int func_209(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8656
{
	int num;
...
void func_210(Hash hParam0) // Position - 0x8923
{
	int num;
...
void func_211(var uParam0, BOOL bParam1) // Position - 0x899F
{
...
void func_214(int iParam0) // Position - 0x8ADF
{
	int i;
	int num;
...
BOOL func_215(int iParam0, BOOL bParam1) // Position - 0x8CB7
{
	if (func_45() != -1)
		return false;
...
int func_216(int iParam0, BOOL bParam1) // Position - 0x8CE5
{
	if (!func_130(iParam0))
		return 0;
...
int func_217(int iParam0) // Position - 0x8D68
{
	switch (iParam0)
	{
		case 27:
...
int func_218(int iParam0) // Position - 0x8D8F
{
	switch (iParam0)
	{
		case 33:
...
int func_220(int iParam0, int iParam1) // Position - 0x8E2B
{
	switch (iParam0)
	{
...
BOOL func_221(int iParam0) // Position - 0xA6D0
{
	int num;
...
BOOL func_222(int iParam0) // Position - 0xA6ED
{
...
BOOL func_223() // Position - 0xA704
{
	return 1;
}

int func_224(int iParam0) // Position - 0xA70D
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

void func_225(var uParam0, int iParam1) // Position - 0xA720
{
	int num;
	int num2;
...
int func_226(int iParam0) // Position - 0xA773
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

void func_227(var uParam0, int iParam1) // Position - 0xA786
{
...
int func_228(int iParam0) // Position - 0xA7C2
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

void func_229(var uParam0, int iParam1) // Position - 0xA7E7
{
	if (iParam1 < 0)
		return;
...
Hash func_230(int iParam0) // Position - 0xA86D
{
	if (!func_130(iParam0))
		return 0;
...
void func_231(int iParam0, PersChar pchParam1) // Position - 0xA88B
{
	if (!func_130(iParam0))
		return;
...
void func_232(int iParam0, BOOL bParam1) // Position - 0xA8AC
{
	if (func_45() != -1)
		return;
...
BOOL func_233(int iParam0) // Position - 0xA8E5
{
	if (!func_130(iParam0))
		return false;
...
void func_234(int iParam0, BOOL bParam1) // Position - 0xA90B
{
	char* StringToTest;
...
void func_235(int iParam0, BOOL bParam1) // Position - 0xA93F
{
	switch (iParam0)
	{
		case 5:
...
void func_236(int iParam0, int iParam1) // Position - 0xA974
{
	func_293(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_237(var uParam0, var uParam1) // Position - 0xA98E
{
	return func_255(uParam0, 5, 8);
}

BOOL func_238(int iParam0) // Position - 0xA9A1
{
	return func_294(1, iParam0);
}

int func_239(int iParam0) // Position - 0xA9B0
{
	if (iParam0 == 255)
...
int func_240(int iParam0) // Position - 0xA9FB
{
...
void func_241(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xAA18
{
	func_296(iParam0);
...
int func_242(int iParam0) // Position - 0xAA7A
{
...
void func_243(var uParam0) // Position - 0xAA97
{
	var unk;
...
void func_244(float* pfParam0) // Position - 0xAAA9
{
	var unk;
...
void func_246(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0xAB11
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_247(int iParam0) // Position - 0xAB3E
{
...
void func_248(int iParam0, int iParam1) // Position - 0xAB9B
{
	func_161(iParam0, iParam1);
...
void func_249(int iParam0) // Position - 0xABD6
{
	return;
}

BOOL func_250(int iParam0, int iParam1) // Position - 0xABDE
{
	if (iParam0 == -1)
		return false;
...
BOOL func_251(int iParam0) // Position - 0xAC05
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_252(int iParam0) // Position - 0xAC1B
{
	var unk;
...
BOOL func_253(Hash hParam0) // Position - 0xAC4C
{
	return hParam0 != 0;
}

BOOL func_254(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0xAC58
{
	int num;
...
BOOL func_255(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0xACE0
{
	int num;
...
BOOL func_256(int iParam0, int* piParam1, int* piParam2) // Position - 0xAD1B
{
	int num;
...
Ped func_257(int iParam0) // Position - 0xAD8B
{
	PersChar persChar;
...
BOOL func_258(int iParam0, int iParam1) // Position - 0xADB9
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_259(int iParam0) // Position - 0xADD1
{
...
BOOL func_260(int iParam0) // Position - 0xADE8
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_261(int iParam0, int iParam1) // Position - 0xAEB4
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_262(int iParam0) // Position - 0xAECD
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_263() // Position - 0xAEE0
{
	if (!func_69())
		return false;
...
BOOL func_264() // Position - 0xAEFB
{
	return func_300() == 4;
}

BOOL func_265() // Position - 0xAF09
{
	return false;
}

BOOL func_266() // Position - 0xAF12
{
	var unk;
	var unk3;
...
BOOL func_267(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAF7A
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_268(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0xB0F0
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_269(var uParam0, var uParam1, var uParam2) // Position - 0xB104
{
	int i;
...
const char* func_270(int iParam0) // Position - 0xB132
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_271(int iParam0) // Position - 0xB416
{
	switch (iParam0)
	{
		case 22:
...
struct<2> func_272(Player plParam0) // Position - 0xB440
{
	var gamerHandle;
...
const char* func_273(const char* sParam0, int iParam1) // Position - 0xB454
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

Hash func_274() // Position - 0xB46E
{
	return Global_1939102.f_26;
}

int func_275(int iParam0) // Position - 0xB47C
{
	if (iParam0 < 0)
		return -1;
	else if (iParam0 <= 10)
...
int func_276(int iParam0, BOOL bParam1) // Position - 0xB578
{
	switch (iParam0)
	{
		case 0:
...
void func_277(int iParam0, int iParam1) // Position - 0xB6F2
{
	if (iParam0 == 0)
...
BOOL func_278(Volume volParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0xB71B
{
	return VOLUME::DOES_VOLUME_EXIST(volParam0);
}

void func_279(Volume volParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0xB729
{
...
BOOL func_280(int iParam0) // Position - 0xB767
{
	if (iParam0 < 0)
		return false;
...
void func_281(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB7A6
{
	int num;
...
BOOL func_282(int iParam0) // Position - 0xB7FA
{
	if (!func_130(iParam0))
		return false;
...
void func_283(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB81F
{
	PersChar persChar;
...
void func_284(int iParam0, BOOL bParam1) // Position - 0xB90B
{
	if (!func_251(iParam0))
		return;
...
void func_285(int iParam0, int iParam1) // Position - 0xB961
{
	if (!func_322(iParam0))
		return;
...
int func_286(int iParam0) // Position - 0xB9D4
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_287(int iParam0) // Position - 0xB9EA
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_288(int iParam0, BOOL bParam1) // Position - 0xBA00
{
	if (func_45() != -1)
		return;
...
void func_289(int iParam0) // Position - 0xBA31
{
	Ped EntityIndex;
...
int func_290(int iParam0) // Position - 0xBA75
{
	return func_323(iParam0) + 30;
}

int func_291(int iParam0, int iParam1) // Position - 0xBA85
{
	if (iParam1 < 0)
		iParam1 = 0;
...
var func_292(BOOL bParam0, var uParam1, var uParam2) // Position - 0xBB1F
{
	if (bParam0)
		return uParam1;
...
void func_293(var uParam0, int iParam1) // Position - 0xBB36
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_294(int iParam0, int iParam1) // Position - 0xBB4B
{
	int num;
...
BOOL func_295(var uParam0, int iParam1, int iParam2) // Position - 0xBBBF
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_301(BOOL bParam0) // Position - 0xBC8E
{
	if (func_326(bParam0))
		return;
...
BOOL func_302(var uParam0, int iParam1, int iParam2) // Position - 0xBCB5
{
	int num;
	int offset;
	BOOL isBitSet;
...
int func_303(int iParam0) // Position - 0xBCE8
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_304(int iParam0, int iParam1, var uParam2) // Position - 0xC9E1
{
	var unk;
...
int func_305() // Position - 0xCA08
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_306(var uParam0, var uParam1) // Position - 0xCA1D
{
	if (!func_329(uParam0))
		return false;
...
int func_307(int iParam0, var uParam1) // Position - 0xCA51
{
	if (iParam0 == 2)
...
BOOL func_308() // Position - 0xCA6B
{
	...
	if (!func_306(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_309() // Position - 0xCAC3
{
	return Global_1051268;
}

struct<2> func_310() // Position - 0xCAD1
{
...
BOOL func_311(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0xCB1C
{
	var unk;
	float num;
	float num2;
...
int func_312(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xCB4C
{
	return func_334(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

BOOL func_313(Hash hParam0, int iParam1) // Position - 0xCB62
{
	int num;
...
int func_314(var uParam0) // Position - 0xCBD3
{
	return uParam0;
}

void func_315(int iParam0) // Position - 0xCBDD
{
	if (!func_337(iParam0))
		return;
...
BOOL func_316(int iParam0) // Position - 0xCC90
{
	if (!func_130(iParam0))
		return false;
...
BOOL func_317(Hash hParam0) // Position - 0xCCB4
{
	return hParam0 != 0;
}

BOOL func_318(int iParam0, BOOL bParam1) // Position - 0xCCC0
{
	if (!func_251(iParam0))
		return false;
...
void func_319(int iParam0, BOOL bParam1) // Position - 0xCCE6
{
	if (!func_251(iParam0))
		return;
...
void func_320(int iParam0, BOOL bParam1) // Position - 0xCD14
{
	if (!func_251(iParam0))
		return;
...
void func_321(int iParam0) // Position - 0xCD4E
{
	func_339(func_338(iParam0));
	return;
}

BOOL func_322(int iParam0) // Position - 0xCD60
{
	return iParam0 > -1 && iParam0 < 40;
}

int func_323(int iParam0) // Position - 0xCD76
{
	return iParam0 * 31;
}

BOOL func_324(var uParam0, int iParam1, int iParam2) // Position - 0xCD82
{
	return MISC::IS_BIT_SET(uParam0->[iParam1 / 31], iParam1 % 31);
}

int func_325() // Position - 0xCDB9
{
	return Global_1102813.f_3672;
}

BOOL func_326(BOOL bParam0) // Position - 0xCDC8
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_327(int iParam0, int iParam1, Any* panParam2) // Position - 0xCDDE
{
...
void func_328(Any* panParam0, int iParam1, var uParam2) // Position - 0xCE12
{
	var unk;
...
BOOL func_329(int iParam0) // Position - 0xCE8C
{
	switch (iParam0)
	{
		case 2:
...
int func_330(int iParam0) // Position - 0xCECB
{
	switch (iParam0)
	{
		case 2:
...
int func_331(var uParam0, var uParam1) // Position - 0xCF61
{
	var unk;
...
void func_332(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0xCF8D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_333(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0xDA2A
{
	float num;
	float num2;
	float num3;
...
int func_334(Hash hParam0) // Position - 0xDA90
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
int func_335(Hash hParam0) // Position - 0xDB4A
{
	switch (hParam0)
	{
...
Hash func_336(int iParam0) // Position - 0xDCAC
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_337(int iParam0) // Position - 0xDD11
{
	return func_342(iParam0, 2);
}

int func_338(int iParam0) // Position - 0xDD20
{
...
void func_339(int iParam0) // Position - 0xE23D
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_340(int iParam0) // Position - 0xE24E
{
	int num;
...
BOOL func_341(int iParam0, var uParam1, Any* panParam2) // Position - 0xE3C3
{
	if (!func_306(iParam0))
		return false;
...
BOOL func_342(int iParam0, int iParam1) // Position - 0xE4CE
{
	if (iParam0 < 0)
		return false;
...
void func_343(Any* panParam0) // Position - 0xE4EF
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
