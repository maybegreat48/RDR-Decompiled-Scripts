...
int func_3(var uParam0) // Position - 0xCC
{
	return 0;
}

int func_4() // Position - 0xD5
{
	float num;
...
BOOL func_6(Ped pedParam0, int iParam1) // Position - 0x19D
{
	int num;
...
void func_7(Ped* ppedParam0) // Position - 0x29C
{
...
int func_8(int iParam0) // Position - 0x2FB
{
	int num;
...
float func_9(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x34D
{
...
float func_10(var uParam0) // Position - 0x375
{
	if (!func_15(uParam0))
		return 0f;
...
void func_11() // Position - 0x3A7
{
	...
	Health = 160;
	ENTITY::SET_ENTITY_MAX_HEALTH(pedLocal_45, Health);
	ENTITY::SET_ENTITY_HEALTH(pedLocal_45, Health, 0);
	func_19(pedLocal_45);
	return;
}

void func_12(var uParam0) // Position - 0x424
{
	func_20(uParam0, 0f);
	return;
}

void func_13(Ped pedParam0, eControlAction ecaParam1) // Position - 0x433
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
	{
...
BOOL func_14(int iParam0, int iParam1) // Position - 0x47A
{
	return iParam0 && iParam1 != false;
}

BOOL func_15(var uParam0) // Position - 0x489
{
	return func_21(*uParam0, 1);
}

BOOL func_16(var uParam0) // Position - 0x499
{
	return func_21(*uParam0, 2);
}

float func_17() // Position - 0x4A9
{
...
Ped func_18(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0x4DB
{
	Ped EntityIndex;
	...
	func_22(EntityIndex, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return EntityIndex;
}

void func_19(Ped pedParam0) // Position - 0x51B
{
...
void func_20(var uParam0, float fParam1) // Position - 0x549
{
...
BOOL func_21(int iParam0, int iParam1) // Position - 0x56F
{
	return iParam0 && iParam1 != false;
}

void func_22(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x57E
{
	BOOL flag;
...
void func_23(Ped pedParam0) // Position - 0x648
{
...
void func_24(var uParam0, int iParam1) // Position - 0x6D1
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_25(var uParam0, int iParam1) // Position - 0x6E2
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_26(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6F7
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_27(Ped pedParam0, BOOL bParam1) // Position - 0x73C
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return;
...
void func_28(Ped pedParam0, int iParam1) // Position - 0x781
{
	if (iParam1 == 1)
