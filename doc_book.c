...
void func_1(var uParam0, var uParam1) // Position - 0x2C0
{
	if (func_11())
	{
	}
...
int func_3() // Position - 0x409
{
	return Global_1572887.f_14;
}

int func_4(Hash hParam0, int iParam1) // Position - 0x417
{
	var unk;
	int num;
	int i;
...
BOOL func_5(Hash hParam0, Hash hParam1) // Position - 0x461
{
...
BOOL func_6(Hash hParam0) // Position - 0x4A2
{
...
BOOL func_7(var uParam0, var uParam1) // Position - 0x4CF
{
...
int func_8(var uParam0, var uParam1) // Position - 0x52B
{
	if (*uParam0 > 0)
...
int func_9(var uParam0, var uParam1) // Position - 0x728
{
	if (*uParam0 > 0)
		func_28(uParam0, uParam1);
...
int func_10(var uParam0, var uParam1) // Position - 0x921
{
...
BOOL func_12() // Position - 0xA24
{
	return Global_1940252.f_2 || Global_1940252 == 1;
}

void func_13(var uParam0, var uParam1) // Position - 0xA3E
{
	return;
}

int func_14(int iParam0) // Position - 0xA46
{
	if (iParam0 < 0)
		return 0;
...
void func_15(var uParam0, var uParam1) // Position - 0xA67
{
	Hash hash;
...
void func_16(var uParam0) // Position - 0xAC3
{
...
void func_17(var uParam0) // Position - 0xAF6
{
	int i;
...
void func_18(var uParam0, var uParam1) // Position - 0xB8A
{
	if (uParam1->[0 /*11*/] != 0)
	{
...
void func_19(int iParam0) // Position - 0xC08
{
...
void func_20(var uParam0) // Position - 0xC2F
{
...
void func_21(var uParam0, var uParam1) // Position - 0xCBC
{
	if (uParam0->f_115)
		func_13(uParam0, uParam1);
...
BOOL func_22(Hash hParam0, int iParam1) // Position - 0xD36
{
	if (hParam0 == 0)
		return false;
...
Hash func_23(Hash hParam0) // Position - 0xD50
{
	return hParam0;
}

int func_24(Hash hParam0, Hash hParam1) // Position - 0xD5A
{
...
BOOL func_25(BOOL bParam0, BOOL bParam1) // Position - 0xD90
{
	int i;
...
BOOL func_26(var uParam0, var uParam1) // Position - 0xE70
{
...
BOOL func_27(Hash hParam0) // Position - 0xED7
{
	switch (hParam0)
	{
		case -904734609:
...
void func_28(var uParam0, var uParam1) // Position - 0xF07
{
	if (!uParam0->f_122)
	{
		if (func_33(uParam1->[0 /*11*/], uParam0->f_104))
...
void func_29(var uParam0, var uParam1) // Position - 0xF36
{
	var unk;
...
void func_30(var uParam0, var uParam1) // Position - 0xF8F
{
	uParam0->f_120 = 1;
...
void func_31(var uParam0, Hash hParam1) // Position - 0xFEE
{
...
void func_32(var uParam0, int iParam1) // Position - 0x107B
{
	*uParam0 = iParam1;
	return;
}

BOOL func_33(Hash hParam0, int iParam1) // Position - 0x1088
{
...
void func_34(var uParam0) // Position - 0x1297
{
	return;
}

int func_35(var uParam0, var uParam1, BOOL bParam2) // Position - 0x129F
{
...
void func_36(var uParam0, var uParam1) // Position - 0x1409
{
	int i;
	int num;
...
void func_37(var uParam0, var uParam1) // Position - 0x1503
{
...
void func_38(var uParam0, var uParam1) // Position - 0x1533
{
	Hash itemInteractionState;
...
BOOL func_39(Hash hParam0, int iParam1) // Position - 0x16FC
{
	switch (func_4(hParam0, -949239683))
	{
		case -1565009253:
...
BOOL func_40(int iParam0, BOOL bParam1) // Position - 0x1941
{
	int num;
...
void func_41(var uParam0, Hash hParam1) // Position - 0x1974
{
...
BOOL func_42(Hash hParam0, int iParam1) // Position - 0x19E7
{
	int num;
...
int func_43(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, Hash hParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9) // Position - 0x1A6A
{
	int value;
	Hash TypeOfWeapon;
	Hash lootTableKey;
	...
	if (!flag)
	{
		if (func_5(hParam0, -1588156645))
		{
			bParam2 = true;
			flag2 = true;
			TypeOfWeapon = func_95(func_94(hParam0, true), false);
		
			if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
			{
				if (func_3() == -1)
					func_96(TypeOfWeapon);
			
				if (func_97(false) && func_98(TypeOfWeapon, 0, false, true, 0, false, hParam5, false))
				{
...
Hash func_44(var uParam0) // Position - 0x251E
{
	Hash _int;
...
void func_45(var uParam0, Any anParam1) // Position - 0x2573
{
	int i;
...
void func_46(var uParam0, var uParam1) // Position - 0x25E0
{
...
int func_47(var uParam0, int iParam1) // Position - 0x2648
{
	Hash txdHash;
...
BOOL func_48(var uParam0, var uParam1) // Position - 0x26E5
{
...
int func_49(var uParam0, var uParam1) // Position - 0x2709
{
	return 1;
}

BOOL func_50(int iParam0) // Position - 0x2712
{
	if (iParam0 < 0)
		return false;
...
BOOL func_51(int iParam0, BOOL bParam1) // Position - 0x2751
{
	int num;
	int gameTimer;
	float progress;
...
void func_52(BOOL bParam0, int iParam1) // Position - 0x284B
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
BOOL func_53(var uParam0) // Position - 0x286D
{
	BOOL num;
...
Hash func_54(Hash hParam0) // Position - 0x28DA
{
	switch (func_4(hParam0, -949239683))
	{
		case -1565009253:
...
BOOL func_56(int iParam0) // Position - 0x2A07
{
	return iParam0 == -492264119 || iParam0 == 1397875340;
}

void func_57(Hash hParam0, Hash hParam1) // Position - 0x2A25
{
	int num;
	var unk;
	var unk11;
...
void func_58(int iParam0) // Position - 0x2A76
{
	switch (iParam0)
	{
		case -492264119:
...
int func_59(int iParam0) // Position - 0x2ACA
{
	switch (iParam0)
	{
		case -31140163:
...
void func_60(var uParam0) // Position - 0x2AE8
{
	uParam0->[0 /*11*/] = 0;
	uParam0->[0 /*11*/].f_1 = 0;
	uParam0->[0 /*11*/].f_3 = 0;
...
void func_61(var uParam0) // Position - 0x2B42
{
...
void func_62(var uParam0) // Position - 0x2BCA
{
...
void func_63(var uParam0) // Position - 0x2C52
{
	uParam0->[2 /*11*/] = 0;
	uParam0->[2 /*11*/].f_1 = 0;
	uParam0->[2 /*11*/].f_3 = 0;
...
int func_64(Hash hParam0, BOOL bParam1, BOOL bParam2, int iParam3, float fParam4) // Position - 0x2CF2
{
...
BOOL func_65(Hash hParam0, int iParam1) // Position - 0x3045
{
	if (hParam0 == 0)
		return false;
...
void func_70(var uParam0) // Position - 0x30D3
{
	if (uParam0->f_105 > 0)
...
void func_71(int iParam0, BOOL bParam1) // Position - 0x30F3
{
	if (func_50(*iParam0))
...
BOOL func_72(var uParam0, var uParam1) // Position - 0x3110
{
	BOOL flag;
...
BOOL func_73(Hash hParam0, int iParam1) // Position - 0x3153
{
	switch (func_4(hParam0, -949239683))
	{
		case -1565009253:
...
BOOL func_74(int iParam0, BOOL bParam1) // Position - 0x32AF
{
	if (bParam1 && !func_50(iParam0))
		return false;
...
void func_75(int iParam0, BOOL bParam1) // Position - 0x32D4
{
	if (func_50(*iParam0))
...
void func_76(var uParam0, var uParam1) // Position - 0x32F1
{
	func_75(&Global_17402[3], func_72(uParam0, uParam1));
	return;
}

BOOL func_77(Hash hParam0, int iParam1) // Position - 0x330B
{
	switch (func_4(hParam0, -949239683))
	{
		case -1565009253:
...
void func_78(var uParam0) // Position - 0x3467
{
	return;
}

void func_79(var uParam0, var uParam1) // Position - 0x346F
{
	int i;
	int j;
	int num;
...
void func_80(var uParam0) // Position - 0x3556
{
	int i;
	int j;
...
int func_81(int iParam0) // Position - 0x35E6
{
	return iParam0;
}

void func_82(var uParam0, Hash hParam1) // Position - 0x35F0
{
	Hash entryId;
...
int func_83(Hash hParam0) // Position - 0x36E3
{
	var unk;
...
BOOL func_84(Hash hParam0, int iParam1) // Position - 0x370E
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_85(Hash hParam0) // Position - 0x37B6
{
	int num;
	int num2;
	int num3;
...
int func_86(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3872
{
...
BOOL func_87(Hash hParam0, int iParam1, BOOL bParam2, Hash hParam3) // Position - 0x3934
{
	if (func_3() == -1)
	{
...
BOOL func_88(Hash hParam0, var uParam1, int iParam2) // Position - 0x398B
{
	var unk;
	int num;
	int num2;
...
void func_89(Hash hParam0, BOOL bParam1) // Position - 0x3A29
{
	if (bParam1)
		return;
...
BOOL func_90(Hash hParam0, int iParam1) // Position - 0x3ADA
{
	if (!func_22(hParam0, 0))
		return false;
...
BOOL func_91(int iParam0) // Position - 0x3AF9
{
	if (!func_174(iParam0))
		return false;
...
void func_92(int iParam0) // Position - 0x3B15
{
	if (!func_174(iParam0))
		return;
...
void func_93(Hash hParam0) // Position - 0x3B36
{
...
Hash func_94(Hash hParam0, BOOL bParam1) // Position - 0x3BBB
{
	Hash hash;
...
Hash func_95(Hash hParam0, BOOL bParam1) // Position - 0x3DB1
{
	if (!func_22(hParam0, 0))
		return 0;
...
void func_96(Hash hParam0) // Position - 0x3DDD
{
	Hash weaponUnlock;
...
BOOL func_97(BOOL bParam0) // Position - 0x3E17
{
	if (func_3() == -1)
		return true;
...
BOOL func_98(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, Hash hParam6, BOOL bParam7) // Position - 0x3E35
{
	var unk;
	var unk6;
	var unk28;
...
BOOL func_99(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x3F65
{
	if (iParam1 < 1)
		return true;
...
BOOL func_100(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x3FA0
{
	int num;
	var unk;
	var unk6;
...
BOOL func_101(Hash hParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x4010
{
	Hash TypeOfWeapon;
	var unk;
	int num;
	...
	TypeOfWeapon = func_95(hParam0, false);
	...
	if (WEAPON::IS_WEAPON_VALID(TypeOfWeapon))
	{
		if (func_3() == -1)
		{
			...
			if (hParam1 == 1248274121)
				func_188(TypeOfWeapon);
		}
	
		if (!func_172(hParam0, &unk, 1, false, false, -1, false))
		{
			func_167(hParam0, 1, false, uParam2, hParam1);
			num = func_189(TypeOfWeapon);
		
			if (WEAPON::_IS_WEAPON_SNIPER(TypeOfWeapon))
			{
				func_98(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (TypeOfWeapon == joaat("weapon_fishingrod") || WEAPON::_IS_WEAPON_BINOCULARS(TypeOfWeapon))
			{
				func_98(TypeOfWeapon, 0, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::_IS_WEAPON_LASSO(TypeOfWeapon))
			{
				func_98(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
			}
			else if (WEAPON::IS_WEAPON_MELEE_WEAPON(TypeOfWeapon))
			{
				if (TypeOfWeapon == joaat("weapon_melee_knife_john") && !func_190())
					return false;
			
				if (WEAPON::SHOULD_WEAPON_BE_DISCARDED_WHEN_SWAPPED(hParam0))
				{
				}
				else if (!func_191(TypeOfWeapon))
				{
					func_98(TypeOfWeapon, 1, bParam3, bParam4, 0, false, hParam1, false);
				}
				else
				{
					func_98(TypeOfWeapon, WEAPON::GET_WEAPON_CLIP_SIZE(TypeOfWeapon) * 4, bParam3, bParam4, 0, false, hParam1, false);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(TypeOfWeapon))
			{
				weaponHash = func_192(Global_33, 2, false, true);
			
				if (func_156(weaponHash) && !Global_26688 && weaponHash != TypeOfWeapon && !func_42(joaat("upgrade_offhand_holster"), 1) && bParam4)
					WEAPON::_SEND_WEAPON_TO_INVENTORY(Global_33, weaponHash);
			
				if (func_156(weaponHash) && func_42(joaat("upgrade_offhand_holster"), 1))
					if (!func_98(TypeOfWeapon, num, bParam3, bParam4, 3, true, hParam1, false))
						return false;
				else if (!func_98(TypeOfWeapon, num, bParam3, bParam4, 0, true, hParam1, false))
					return false;
			}
			else if (!func_98(TypeOfWeapon, num, bParam3, bParam4, 0, false, hParam1, false))
			{
				return false;
			}
		}
...
BOOL func_102(Hash hParam0) // Position - 0x421E
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

BOOL func_103(Hash hParam0, var uParam1, Hash hParam2) // Position - 0x422C
{
	int num;
	int weaponClipSize;
	int ReturnMaxAmmo;
...
struct<2> func_104(int iParam0) // Position - 0x432A
{
	var unk;
...
void func_105(var uParam0, var uParam1, int iParam2) // Position - 0x433C
{
...
struct<2> func_106(int iParam0, int iParam1) // Position - 0x4359
{
	int num;
...
void func_107(int iParam0, BOOL bParam1) // Position - 0x436F
{
	int num;
	int num2;
...
BOOL func_108() // Position - 0x439C
{
	return false;
}

int func_109(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, int iParam5, BOOL bParam6, int iParam7) // Position - 0x43A5
{
	int num;
...
void func_110(Hash hParam0) // Position - 0x43EC
{
	return;
}

void func_111(Hash hParam0) // Position - 0x43F4
{
	return;
}

void func_112(Hash hParam0) // Position - 0x43FC
{
	return;
}

void func_113(Hash hParam0) // Position - 0x4404
{
	return;
}

void func_114() // Position - 0x440C
{
...
void func_115(Hash hParam0, var uParam1) // Position - 0x4430
{
	var unk;
...
Hash func_116(Hash hParam0, BOOL bParam1) // Position - 0x4442
{
	Hash hash;
...
void func_117(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x4470
{
	int num;
	int num2;
...
void func_118(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x44D0
{
	int num;
	int num2;
...
void func_119(var uParam0) // Position - 0x454B
{
	switch (*uParam0)
	{
...
void func_120(Hash hParam0) // Position - 0x458F
{
	if (func_3() != -1)
		return;
...
int func_122(Hash hParam0, int iParam1) // Position - 0x45BE
{
	var unk;
	var unk5;
...
struct<2> func_123(Hash hParam0) // Position - 0x45F2
{
	var unk;
	var unk3;
...
void func_124(Hash hParam0) // Position - 0x4686
{
	switch (hParam0)
	{
...
void func_125(Hash hParam0, int iParam1) // Position - 0x469F
{
	char* str;
...
void func_126(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x46E0
{
	BOOL flag;
	int value;
	var unk;
	...
	else if (!func_212(hParam0, &InputString, num3, num2, 0, joaat("ui_itemviewer")))
	{
	...
	str3 = func_220(MISC::VAR_STRING(10, &unk, MISC::VAR_STRING(0, hash), value), num5);
	...
	if (num4 == -1839668642 && hParam0 != joaat("clothing_item_hair_none") && hParam0 != 1326838792 && hParam0 != -230310728 || num4 == 231148558 && hParam0 != joaat("clothing_item_m_beard_stubble") && hParam0 != joaat("clothing_item_beard_none") || num4 == 252325943 && hParam0 != joaat("clothing_blend_lipstick_none") || num4 == -636562458 && hParam0 != joaat("clothing_blend_eyeshadow_none"))
		str3 = MISC::VAR_STRING(0, func_221(hParam0, -442898163));
	...
	if (num4 == -126813555 || num4 == 1946043663)
	{
		...
		if (func_222(hParam0, &unk7))
			str3 = func_224(func_223(unk7), joaat("COLOR_PURE_WHITE"));
	}

	func_208(str3, InputString.f_1, MISC::GET_HASH_KEY(InputString), num6, num5, str2, str, 0, true);
	return;
}

int func_127(var uParam0, var uParam1) // Position - 0x4BBB
{
	int i;
	int num;
	var unk;
...
BOOL func_128(var uParam0, var uParam1) // Position - 0x4C72
{
	var unk;
	int i;
	BOOL flag;
...
void func_129(int iParam0, Hash hParam1) // Position - 0x4D2C
{
...
BOOL func_130(var uParam0, var uParam1) // Position - 0x4DA3
{
	var unk;
	int i;
	int num;
...
void func_131(var uParam0) // Position - 0x4E66
{
	int i;
...
void func_132(var uParam0) // Position - 0x4E98
{
	int i;
...
BOOL func_133(var uParam0) // Position - 0x4ED7
{
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_134(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x4F17
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
BOOL func_135(var uParam0, var uParam1) // Position - 0x500D
{
	if (uParam1->f_3)
		return true;
...
int func_136(var uParam0, var uParam1) // Position - 0x507A
{
	return 0;
}

Hash func_137(Hash hParam0, BOOL bParam1) // Position - 0x5083
{
	var unk;
...
BOOL func_138(Hash hParam0) // Position - 0x50DB
{
	return hParam0 != 0;
}

BOOL func_139(int* piParam0, Hash hParam1, var uParam2, BOOL bParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x50E7
{
...
int func_140(int iParam0, int iParam1) // Position - 0x5190
{
	int num;
...
BOOL func_141(int iParam0) // Position - 0x51F4
{
	return func_236(Global_1940085.f_38, iParam0);
}

void func_142(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5208
{
	int num;
...
BOOL func_143(int iParam0, int iParam1) // Position - 0x525C
{
	if (iParam0 < 0)
		return false;
...
void func_144(var uParam0, int iParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x527D
{
	var unk;
...
void func_145(var uParam0, int iParam1, var uParam2, Hash hParam3, BOOL bParam4) // Position - 0x5316
{
	var unk;
...
void func_146(var uParam0, Hash hParam1) // Position - 0x53DD
{
	int i;
	int j;
...
void func_147(var uParam0, Hash hParam1) // Position - 0x54E7
{
	int i;
	int j;
	int num;
...
void func_148(var uParam0, Hash hParam1) // Position - 0x55FA
{
	int i;
	int j;
	int num;
...
void func_149(var uParam0, Hash hParam1) // Position - 0x5697
{
	int i;
	int j;
...
void func_150(var uParam0, Hash hParam1) // Position - 0x575F
{
	int i;
	int j;
	int num;
...
void func_151(var uParam0, Hash hParam1) // Position - 0x5818
{
	int i;
	int j;
...
void func_152(var uParam0, Hash hParam1) // Position - 0x5938
{
	int i;
	int j;
	var unk;
...
Hash func_153(Hash hParam0, int iParam1) // Position - 0x5A32
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_154(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x5AAC
{
...
BOOL func_155(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5AD3
{
	if (iParam2 < 0)
		return false;
...
BOOL func_156(Hash hParam0) // Position - 0x5B0E
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_157(Hash hParam0) // Position - 0x5B29
{
	var unk;
...
int func_158(Hash hParam0) // Position - 0x5B54
{
	switch (hParam0)
	{
...
int func_159(var uParam0, int iParam1) // Position - 0x5C37
{
	int i;
...
int func_160(Hash hParam0) // Position - 0x5C74
{
	int num;
...
int func_161(Hash hParam0, BOOL bParam1) // Position - 0x5CE1
{
	var unk;
	int num;
	int num2;
...
int func_162(Hash hParam0, int iParam1) // Position - 0x5D40
{
	if (iParam1 == 0)
		return 0;
...
int func_163(BOOL bParam0) // Position - 0x5D6C
{
	if (func_3() == -1)
	{
...
struct<4> func_164(Hash hParam0, BOOL bParam1) // Position - 0x5DAD
{
	var unk;
...
BOOL func_165(Hash hParam0) // Position - 0x5DD2
{
	return func_83(hParam0) == joaat("WEAPON");
}

BOOL func_166(Hash hParam0) // Position - 0x5DE6
{
	var unk;
...
void func_167(Hash hParam0, int iParam1, BOOL bParam2, var uParam3, Hash hParam4) // Position - 0x5E2B
{
	Hash TypeOfWeapon;
	...
	if (bParam2 || !func_180(TypeOfWeapon))
	{
		if (bParam2 || !WEAPON::HAS_PED_GOT_WEAPON(Global_33, TypeOfWeapon, 0, false) && func_86(hParam0, false, false, false) == 0)
		{
			if (func_3() == -1)
				func_96(TypeOfWeapon);
...
void func_168(Hash hParam0, var uParam1) // Position - 0x5ED5
{
...
struct<5> func_169(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5EFA
{
	var unk;
	int num;
	var unk6;
...
int func_170(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x626E
{
	if (!func_22(hParam0, 0))
	{
		if (func_65(func_23(hParam0), 2))
...
int func_171(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x62E2
{
...
BOOL func_172(Hash hParam0, Any* panParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x6315
{
	var unk;
	var unk5;
	int num;
...
BOOL func_174(int iParam0) // Position - 0x64AE
{
	if (iParam0 == 0)
		return false;
...
BOOL func_175(int iParam0) // Position - 0x64C1
{
	int num;
	int num2;
	int offset;
...
void func_177(int iParam0) // Position - 0x6525
{
	switch (iParam0)
	{
		case 1:
...
int func_178(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x6AA1
{
	var unk;
	var unk13;
	var unk26;
...
BOOL func_179(Hash hParam0) // Position - 0x6AD1
{
	Hash weaponUnlock;
...
BOOL func_180(Hash hParam0) // Position - 0x6AF9
{
	Hash weaponUnlock;
...
BOOL func_181(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6B21
{
	return func_253(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_182(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x6B3C
{
	var unk;
...
struct<4> func_183(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x6B5D
{
	var outGuid;
...
BOOL func_184(Hash hParam0, Any* panParam1, var uParam2, int iParam3, Hash hParam4, int iParam5, BOOL bParam6) // Position - 0x6B8E
{
	var unk;
	int num;
	var unk15;
...
void func_185(Hash hParam0, int iParam1) // Position - 0x6CAC
{
	...
	{
		AmmoInClip = func_270(WEAPON::GET_WEAPON_CLIP_SIZE(hParam0), iParam1);
...
int func_186(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x6D1E
{
	int num;
	var guid2;
	var guid1;
...
int func_187(Hash hParam0, Any* panParam1, Any* panParam2, int iParam3, Hash hParam4, BOOL bParam5) // Position - 0x6D9A
{
	if (!func_22(hParam0, 0))
		return 0;
...
void func_188(Hash hParam0) // Position - 0x6E02
{
	char* decoratorName;
	char* decoratorName2;
	int value;
...
int func_189(Hash hParam0) // Position - 0x6ED1
{
	int num;
	int pedAmmoByType;
...
BOOL func_190() // Position - 0x6F4D
{
	return false;
}

BOOL func_191(Hash hParam0) // Position - 0x6F56
{
	return WEAPON::_IS_AMMO_VALID(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(hParam0));
}

Hash func_192(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6F68
{
...
int func_193(Hash hParam0) // Position - 0x6F8E
{
	Hash weaponTypeFromAmmoType;
...
void func_194(int iParam0, var uParam1, var uParam2) // Position - 0x6FFA
{
	int num;
...
BOOL func_195(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x7016
{
...
void func_196(int iParam0, int iParam1) // Position - 0x70B8
{
	int Variable;
...
int func_197(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x70DC
{
	float num;
	int num2;
	int i;
...
void func_198(int iParam0, const char* sParam1, int iParam2, BOOL bParam3) // Position - 0x71AC
{
	if (iParam0 == 0)
		return;
...
void func_199(int iParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x71FE
{
	int num;
	int value;
	int num2;
...
void func_200(Hash hParam0, var uParam1, var uParam2) // Position - 0x72D9
{
	*uParam1 = 0;
	*uParam2 = 0;
...
Hash func_201(Hash hParam0, BOOL bParam1) // Position - 0x74E5
{
	switch (hParam0)
	{
...
BOOL func_202(int iParam0, int iParam1) // Position - 0x7587
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

void func_203(var uParam0, int iParam1) // Position - 0x75A0
{
	BOOL flag;
	int i;
...
int func_204(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x76CC
{
	var unk;
	int num;
...
struct<2> func_205(int iParam0) // Position - 0x773B
{
	int num;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x774B
{
	switch (iParam0)
	{
		case 0:
...
Hash func_207(Hash hParam0) // Position - 0x7822
{
	Hash num;
...
int func_208(const char* sParam0, const char* sParam1, Hash hParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, BOOL bParam8) // Position - 0x784C
{
	int num;
	var unk13;
	int num2;
...
BOOL func_209() // Position - 0x78AF
{
	return !Global_1913444;
}

void func_210(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x78BC
{
	int i;
...
var func_211(BOOL bParam0, var uParam1, var uParam2) // Position - 0x79DF
{
	if (bParam0)
		return uParam1;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_212(Hash hParam0, var uParam1, int iParam2, Hash hParam3, Hash hParam4, Hash hParam5) // Position - 0x79F6
{
	int i;
	Hash hashKey;
	Hash hashKey2;
...
char* func_213(Hash hParam0) // Position - 0x7AE9
{
...
BOOL func_214(Hash hParam0) // Position - 0x7BE5
{
...
BOOL func_215(int iParam0) // Position - 0x7C64
{
	switch (iParam0)
	{
		case -1696039442:
...
Hash func_216(Hash hParam0) // Position - 0x7C8B
{
	var unk;
	int i;
...
Hash func_217(Hash hParam0) // Position - 0x7CF9
{
	int num;
	var unk;
	int collectionId;
...
int func_218(Hash hParam0, Hash hParam1) // Position - 0x7D7E
{
	if (hParam0 == 0)
		return 0;
...
int func_219(Hash hParam0, int iParam1, var uParam2, BOOL bParam3) // Position - 0x7DAF
{
	var unk;
...
const char* func_220(const char* sParam0, int iParam1) // Position - 0x7E0E
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

 func_221(Hash hParam0, int iParam1) // Position - 0x7E28
{
	 num;
...
BOOL func_222(Hash hParam0, char* sParam1) // Position - 0x7E46
{
	...
	TEXT_LABEL_ASSIGN_STRING(&StringToTest, func_294(hParam0), 128);
...
const char* func_223(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x7EC3
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_224(const char* sParam0, int iParam1) // Position - 0x7ED7
{
...
BOOL func_225(var uParam0, int iParam1) // Position - 0x7F0D
{
	int num;
...
BOOL func_226(Hash hParam0, Hash hParam1) // Position - 0x7FFC
{
...
void func_227(var uParam0) // Position - 0x80A2
{
	var unk;
...
int func_228(Hash hParam0, BOOL bParam1) // Position - 0x80CE
{
	int num;
...
BOOL func_229(int* piParam0, BOOL bParam1) // Position - 0x8107
{
	if (!bParam1)
...
Hash func_230(int iParam0, int iParam1, BOOL bParam2, int iParam3, BOOL bParam4) // Position - 0x81A3
{
	int num;
	BOOL flag;
	BOOL flag2;
...
BOOL func_231(int iParam0, Hash hParam1, int iParam2) // Position - 0x82A8
{
	if (iParam0 == 0)
		return false;
...
BOOL func_232(int* piParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, Hash hParam19, BOOL bParam20) // Position - 0x8308
{
...
void func_233() // Position - 0x835C
{
	return;
}

int func_234() // Position - 0x8364
{
...
BOOL func_236(int iParam0, int iParam1) // Position - 0x8440
{
	return iParam0 && iParam1 != false;
}

void func_237(int iParam0, int iParam1) // Position - 0x844F
{
	if (iParam0 < 0)
		return;
...
void func_238(int iParam0, BOOL bParam1) // Position - 0x8482
{
...
void func_239(int iParam0, BOOL bParam1) // Position - 0x84DA
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_240(int iParam0, int iParam1) // Position - 0x8503
{
	if (iParam0 < 0)
		return;
...
BOOL func_241(int iParam0) // Position - 0x852B
{
	if (iParam0 % 2 == 0)
		return true;
...
void func_242(Hash hParam0, var uParam1, var uParam2, Hash hParam3) // Position - 0x8540
{
	if (*uParam2 < 7)
	{
...
struct<18> func_243(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x859D
{
	Hash hash;
...
struct<4> func_244(BOOL bParam0) // Position - 0x867B
{
	int num;
...
void func_245(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x871C
{
...
BOOL func_246(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x8737
{
...
struct<4> func_247(BOOL bParam0) // Position - 0x875C
{
	int num;
...
BOOL func_248(Hash hParam0, BOOL bParam1) // Position - 0x87FC
{
...
struct<4> func_249(BOOL bParam0) // Position - 0x8833
{
	int num;
...
BOOL func_250(Hash hParam0, int iParam1) // Position - 0x889D
{
	Hash hash;
	int num;
	int i;
...
BOOL func_251(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x890A
{
	return func_326(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_252(var uParam0) // Position - 0x8920
{
...
int func_253(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x89AA
{
...
BOOL func_254(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x8A29
{
...
void func_255(BOOL bParam0) // Position - 0x8A52
{
...
void func_256(int iParam0) // Position - 0x8A90
{
...
void func_257(BOOL bParam0) // Position - 0x8AFE
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_258(BOOL bParam0) // Position - 0x8B38
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_259(BOOL bParam0) // Position - 0x8B72
{
	if (!ENTITY::DOES_ENTITY_EXIST(Global_33))
		return;
...
void func_260(BOOL bParam0) // Position - 0x8BAC
{
	Hash hash;
...
void func_261(BOOL bParam0) // Position - 0x8BCF
{
	int promptType;
	Player player;
...
void func_262(BOOL bParam0) // Position - 0x8C11
{
	int promptType;
	Player player;
...
BOOL func_263() // Position - 0x8C53
{
	return true;
}

int func_264(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, BOOL bParam9, BOOL bParam10) // Position - 0x8C72
{
	int num;
	int num2;
	int num3;
...
int func_265(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x8CD8
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_266(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x8DB9
{
	int inventoryId;
...
BOOL func_267(Hash hParam0) // Position - 0x8DFE
{
...
int func_268(Hash hParam0, Any* panParam1, BOOL bParam2) // Position - 0x8E14
{
	int num;
...
void func_269(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0x8E7E
{
	int i;
...
int func_270(int iParam0, int iParam1) // Position - 0x8EFC
{
	if (iParam0 > iParam1)
		return iParam1;
...
int func_271() // Position - 0x8F12
{
	return Global_1902569;
}

void func_272(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x8F1E
{
	int num;
	int i;
	int num2;
...
BOOL func_273(Hash hParam0) // Position - 0x90A6
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

BOOL func_274(int iParam0, int iParam1) // Position - 0x90B4
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_275(int iParam0) // Position - 0x90CC
{
...
BOOL func_276(int iParam0) // Position - 0x90E3
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_277(int iParam0) // Position - 0x91AF
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_278() // Position - 0x91C2
{
	if (!func_55())
		return false;
...
void func_279(int iParam0, int iParam1) // Position - 0x91DD
{
	if (iParam0 <= 0)
		return;
...
BOOL func_280() // Position - 0x9219
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_281() // Position - 0x922A
{
	return DLC::IS_DLC_PRESENT(joaat("dlc_ultimateedition"));
}

void func_282(var uParam0) // Position - 0x923B
{
...
void func_283(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x9273
{
	int i;
	var unk;
...
void func_284(const char* sParam0, const char* sParam1, Hash hParam2) // Position - 0x9329
{
...
BOOL func_285(Hash hParam0, Hash hParam1) // Position - 0x935A
{
	if (hParam1 == 0)
		return false;
...
int func_286(Hash hParam0) // Position - 0x9381
{
	var unk;
	int num;
...
struct<10> func_287(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x93BB
{
	int num;
...
BOOL func_288(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int* piParam11, int iParam12) // Position - 0x948F
{
...
BOOL func_289(Hash hParam0) // Position - 0x94B0
{
	!func_22(hParam0, 0);
...
int func_290(int iParam0) // Position - 0x94D6
{
	if (iParam0 < 0)
		return 0;
...
int func_291(Hash hParam0, int iParam1) // Position - 0x94F7
{
	var unk;
	int num;
	int num2;
...
char* func_292(Hash hParam0) // Position - 0x9545
{
	Hash labelHash;
...
BOOL func_293(Hash hParam0) // Position - 0x957B
{
...
char* func_294(Hash hParam0) // Position - 0x95A9
{
	Hash labelHash;
...
BOOL func_295(int iParam0) // Position - 0x95DE
{
	switch (iParam0)
	{
		case -1649851713:
...
BOOL func_296(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13) // Position - 0x962C
{
	var unk;
	int num;
...
BOOL func_297(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x97E2
{
	BOOL flag;
...
BOOL func_298(Hash hParam0) // Position - 0x9B6B
{
	int i;
...
BOOL func_299(BOOL bParam0) // Position - 0x9CFC
{
	if (bParam0)
...
BOOL func_300() // Position - 0x9D2C
{
	return Global_1940252.f_10;
}

void func_301(var uParam0) // Position - 0x9D3A
{
	Global_1940252.f_11588 = uParam0;
	return;
}

void func_302(int iParam0) // Position - 0x9D4B
{
	Global_1940252.f_10 = iParam0;
	return;
}

BOOL func_303(int* piParam0) // Position - 0x9D5B
{
	int num;
...
BOOL func_304(Any anParam0) // Position - 0x9D8D
{
...
BOOL func_305(int iParam0) // Position - 0x9DD3
{
	if (iParam0 == 0)
		return false;
...
BOOL func_306(int iParam0, int iParam1) // Position - 0x9DEB
{
	return iParam0 && iParam1 != false;
}

BOOL func_307(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0x9DFA
{
	if (!func_305(iParam0))
		return false;
...
BOOL func_308(int iParam0, var uParam1) // Position - 0x9E32
{
	*uParam1 = func_354(iParam0, true);
	return *uParam1 != 0;
}

BOOL func_309(int iParam0, var uParam1) // Position - 0x9E49
{
	*uParam1 = func_355(iParam0, true, false);
	return *uParam1 != 0;
}

BOOL func_310() // Position - 0x9E61
{
	return Global_1915656.f_22477;
}

BOOL func_311(int iParam0) // Position - 0x9E70
{
...
BOOL func_312(int iParam0, Hash hParam1) // Position - 0x9EAB
{
	var unk;
	int num;
	Hash unlockHash;
...
BOOL func_313(int iParam0, Hash hParam1) // Position - 0x9FF4
{
	int num;
	int num2;
	var unk;
...
BOOL func_314(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17) // Position - 0xA0AE
{
...
BOOL func_315(int* piParam0, Hash hParam1) // Position - 0xA0C7
{
	Hash action;
...
BOOL func_316(int iParam0, Hash hParam1, Any* panParam2) // Position - 0xA12A
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 18, panParam2, 0);
}

BOOL func_317(int* piParam0, BOOL bParam1) // Position - 0xA141
{
...
void func_319(int iParam0) // Position - 0xA1A1
{
...
void func_321(int iParam0) // Position - 0xA209
{
...
char* func_322(Hash hParam0, int iParam1) // Position - 0xA232
{
	switch (iParam1)
	{
		case 0:
...
struct<4> func_323() // Position - 0xA2C6
{
	var unk;
...
BOOL func_325(Hash hParam0, int iParam1, Hash hParam2) // Position - 0xA2EF
{
...
BOOL func_326(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0xA322
{
...
BOOL func_327(Hash hParam0) // Position - 0xA35C
{
	return func_5(hParam0, 1279601681);
}

void func_328(int iParam0, int iParam1) // Position - 0xA36F
{
	if (iParam1 == 0)
		return;
...
void func_329(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0xA39F
{
	int i;
	var unk;
...
BOOL func_330(Hash hParam0, Any* panParam1) // Position - 0xA45A
{
	int num;
...
BOOL func_331(int iParam0, Hash hParam1, Any* panParam2) // Position - 0xA630
{
	return NETSHOPPING::_0xA3B8D31C13CB4239(iParam0, hParam1, panParam2, 17, panParam2, 0);
}

int func_332(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0xA647
{
	if (bParam0)
	{
...
int func_333(BOOL bParam0, int iParam1, Any* panParam2) // Position - 0xA690
{
	if (bParam0)
	{
		func_365(iParam1, 1, 0, 0);
...
int func_334(int iParam0) // Position - 0xA6AC
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * MISC::IS_BIT_SET(iParam0, 31) ? -1 : 1) + 1898;
}

int func_335(int iParam0) // Position - 0xA6D1
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 22) & 15;
}

int func_336(int iParam0) // Position - 0xA6E4
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 17) & 31;
}

int func_337(int iParam0) // Position - 0xA6F7
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_338(int iParam0) // Position - 0xA70A
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

int func_339(int iParam0) // Position - 0xA71C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 0) & 63;
}

int func_340(int iParam0, int iParam1) // Position - 0xA72E
{
	if (iParam1 < 0)
		iParam1 = 0;
...
void func_341(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xA7C8
{
...
BOOL func_342() // Position - 0xA800
{
	return Global_1913444.f_127 == 0;
}

int func_343() // Position - 0xA810
{
	return Global_1953292.f_1;
}

BOOL func_344(Hash hParam0) // Position - 0xA81E
{
	int i;
...
BOOL func_345(Hash hParam0) // Position - 0xA859
{
	if (func_5(hParam0, -839724752))
...
BOOL func_346(Hash hParam0) // Position - 0xA87E
{
...
BOOL func_347(Hash hParam0, int iParam1) // Position - 0xA9A8
{
...
BOOL func_348(Hash hParam0, int iParam1) // Position - 0xAAB4
{
	if (iParam1 == 119)
...
void func_349(int iParam0, Hash hParam1, BOOL bParam2) // Position - 0xAAD7
{
	if (func_22(hParam1, 0))
		if (bParam2)
...
Hash func_350(Hash hParam0) // Position - 0xAB02
{
	Hash award;
	Hash currency;
	int i;
...
BOOL func_351(Hash hParam0) // Position - 0xAB86
{
...
BOOL func_352(Hash hParam0) // Position - 0xABA1
{
	Hash hash;
...
int func_353(int* piParam0) // Position - 0xACC6
{
	return func_377(piParam0->f_1);
}

Hash func_354(int iParam0, BOOL bParam1) // Position - 0xACD6
{
	int i;
	int num;
	var unk;
...
Hash func_355(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xAD69
{
	int i;
	int num;
	var unk;
...
int func_356(int iParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0xAEC8
{
	var unk;
	int num;
	int i;
...
BOOL func_357(int iParam0) // Position - 0xAF5C
{
	if (iParam0 < 0)
		return false;
...
int func_358(int iParam0) // Position - 0xAF7F
{
	return iParam0 / 100;
}

void func_359(const char* sParam0) // Position - 0xAF8C
{
	Global_1915656.f_22470 = func_382(sParam0, 10000, 0, 0, 0, true);
	return;
}

BOOL func_360(int iParam0) // Position - 0xAFA8
{
	if (iParam0 < 0)
		return false;
...
BOOL func_361(int iParam0, Hash hParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAFD5
{
	var unk;
	int num;
	int i;
...
BOOL func_362(int* piParam0, Hash hParam1) // Position - 0xB0DC
{
...
BOOL func_363(int* piParam0) // Position - 0xB0FA
{
	Hash action;
...
BOOL func_364(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0xB197
{
...
void func_365(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB1AF
{
	int i;
...
var func_366(BOOL bParam0, var uParam1, var uParam2) // Position - 0xB24D
{
	if (bParam0)
		return uParam1;
...
void func_367(var uParam0, int iParam1) // Position - 0xB264
{
	if (iParam1 < 0)
		return;
...
void func_368(var uParam0, int iParam1) // Position - 0xB2EA
{
...
void func_369(var uParam0, int iParam1) // Position - 0xB326
{
	int num;
	int num2;
...
void func_370(var uParam0, int iParam1) // Position - 0xB379
{
...
void func_371(var uParam0, int iParam1) // Position - 0xB3B4
{
...
void func_372(var uParam0, int iParam1) // Position - 0xB3ED
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_373(Hash hParam0, int iParam1) // Position - 0xB425
{
	return iParam1 == func_4(hParam0, 1224357681);
}

BOOL func_374(Hash hParam0, Hash hParam1) // Position - 0xB43B
{
...
BOOL func_375(Hash hParam0) // Position - 0xB4B7
{
	int i;
	int num;
...
BOOL func_376(Hash hParam0, int iParam1) // Position - 0xB508
{
	var unk;
	int num;
	Hash hash;
...
int func_377(int iParam0) // Position - 0xB592
{
	int num;
	int status;
...
Hash func_378(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB61C
{
	int num;
...
// Unhandled jump detected. Output should be considered invalid
BOOL func_379(int iParam0, Hash hParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0xB6B8
{
	int i;
...
BOOL func_380(Hash hParam0) // Position - 0xB747
{
	return func_157(hParam0) == 1946043663;
}

BOOL func_381(Hash hParam0) // Position - 0xB75B
{
	return func_157(hParam0) == -126813555;
}

int func_382(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xB76F
{
	int num;
	var unk13;
	int num2;
...
BOOL func_383(int iParam0) // Position - 0xB7AA
{
	if (iParam0 < 0)
		return false;
...
int func_385(int iParam0, Hash hParam1) // Position - 0xB7E8
{
...
int func_386(Hash hParam0, int iParam1) // Position - 0xB80D
{
	var unk;
	var guid;
	int inventoryItemCountWithGuid;
...
void func_387(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xB868
{
	int i;
...
int func_388(int iParam0) // Position - 0xB944
{
...
BOOL func_389(int iParam0, var uParam1) // Position - 0xBE61
{
	if (!func_395(iParam0))
		return false;
...
int func_390(int iParam0) // Position - 0xBE8E
{
	if (func_3() != -1)
...
int func_391(int iParam0) // Position - 0xBEBB
{
	int i;
...
void func_392(int iParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0xBF07
{
	int i;
	int j;
	int k;
...
int func_393(int iParam0) // Position - 0xC0DD
{
	switch (iParam0)
	{
		case 0:
...
void func_394(int iParam0) // Position - 0xC10E
{
	*iParam0 = -1;
	iParam0->f_1 = 0;
	iParam0->f_2 = 0;
...
BOOL func_395(int iParam0) // Position - 0xC131
{
	return iParam0 > -1 && iParam0 < 26;
}

int func_396(int iParam0) // Position - 0xC147
{
	switch (iParam0)
	{
		case 0:
...
void func_397(var uParam0) // Position - 0xC37A
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
