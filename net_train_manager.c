...
void func_4() // Position - 0xE9
{
	func_17();
	return;
}

void func_5(int iParam0, int iParam1) // Position - 0xF5
{
...
void func_8(int* piParam0) // Position - 0x251
{
	var unk;
...
int func_9(int iParam0, int iParam1, char* sParam2) // Position - 0x2DA
{
	return 1;
}

void func_10(Any* panParam0) // Position - 0x2E3
{
	int i;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		func_20(&panParam0->[i /*13*/]);
	}

	return;
}

int func_11(int iParam0, int iParam1, char* sParam2) // Position - 0x30B
{
	return 1;
}

void func_12(var uParam0) // Position - 0x314
{
	var unk;
...
void func_13(BOOL bParam0) // Position - 0x354
{
	int num;
	var unk;
	int num2;
...
BOOL func_14(BOOL bParam0, BOOL bParam1) // Position - 0x41D
{
	int i;
...
void func_17() // Position - 0x56F
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

int func_18() // Position - 0x57B
{
	return Global_1572887.f_14;
}

BOOL func_19() // Position - 0x589
{
	return Global_1051645.f_8;
}

void func_20(var uParam0) // Position - 0x597
{
	var unk;
...
void func_23() // Position - 0x5E2
{
	func_32();
	return;
}

void func_24() // Position - 0x5EE
{
	if (Global_1148506 > 0)
	{
		func_33();
...
void func_28(int iParam0) // Position - 0x65B
{
	func_38(&(Global_1148506.f_1), iParam0);
	return;
}

int func_29() // Position - 0x66F
{
	var unk;
...
void func_30(int iParam0) // Position - 0x6A7
{
...
void func_34(int iParam0) // Position - 0x7CC
{
...
void func_38(int iParam0, int iParam1) // Position - 0x8B3
{
	func_53(iParam0, iParam1);
	return;
}

BOOL func_39() // Position - 0x8C3
{
	if (!NETWORK::NETWORK_IS_HOST())
		return false;
...
var func_40(int iParam0, int iParam1) // Position - 0x8DC
{
	return func_54(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

int func_41(Any* panParam0, var uParam1) // Position - 0x8FA
{
...
void func_44(int iParam0) // Position - 0x96B
{
...
BOOL func_45(int iParam0) // Position - 0x9BF
{
	return func_59(Global_1148506.f_1, iParam0);
}

int func_46(int iParam0, BOOL bParam1) // Position - 0x9D3
{
	var unk;
...
BOOL func_47(BOOL bParam0, int iParam1) // Position - 0xA1B
{
...
BOOL func_48() // Position - 0xA57
{
	return func_61(Global_1572887.f_8, 1);
}

BOOL func_49(int iParam0) // Position - 0xA6A
{
	return func_59(Global_1149035.f_1, iParam0);
}

void func_50(int iParam0) // Position - 0xA7E
{
	func_38(&(Global_1149035.f_1), iParam0);
	return;
}

void func_51(int iParam0) // Position - 0xA92
{
	func_62(&(Global_1149035.f_1), iParam0);
	return;
}

void func_52(int iParam0) // Position - 0xAA6
{
	func_63(iParam0);
...
void func_53(int iParam0, int iParam1) // Position - 0xB0F
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

var func_54(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0xB20
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_71(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
void func_55(int iParam0) // Position - 0xEB3
{
	if (func_49(1))
		return;
...
void func_56(int iParam0) // Position - 0xF1A
{
	if (func_49(1))
	{
		func_77(iParam0, 4);
...
void func_57(int iParam0) // Position - 0xF51
{
	if (func_49(1))
	{
		func_77(iParam0, 4);
...
void func_58(int iParam0) // Position - 0x104C
{
	if (!func_85(iParam0))
		return;
...
BOOL func_59(int iParam0, int iParam1) // Position - 0x107A
{
	return iParam0 && iParam1 != false;
}

BOOL func_60(int iParam0, BOOL bParam1) // Position - 0x1089
{
	Hash trainTrack;
	Vector3 vector;
	int junctionIndex;
...
BOOL func_61(BOOL bParam0, BOOL bParam1) // Position - 0x122C
{
	return bParam0 && bParam1 != false;
}

void func_62(int iParam0, int iParam1) // Position - 0x123B
{
	func_86(iParam0, iParam1);
	return;
}

void func_63(int iParam0) // Position - 0x124B
{
	float num;
	var unk;
...
void func_64(int iParam0) // Position - 0x12AD
{
	if (func_49(1))
		return;
...
void func_65(int iParam0) // Position - 0x12FA
{
	float num;
...
void func_66(int iParam0) // Position - 0x13D6
{
	struct<2> args;
...
void func_67(int iParam0) // Position - 0x149D
{
	if (Global_1148506.f_2[iParam0 /*18*/] == 4)
		func_92(iParam0, 4);
	else if (func_49(1))
...
void func_68(int iParam0) // Position - 0x14FD
{
	var unk;
	var unk5;
...
int func_69() // Position - 0x1578
{
	return Global_1051645.f_12;
}

char* func_70() // Position - 0x1586
{
	return "unnamed";
}

BOOL func_71(int iParam0) // Position - 0x1591
{
	int num;
...
BOOL func_72(int iParam0) // Position - 0x1620
{
	if (Global_1572887.f_14 == -1)
		return false;
...
int func_73(int iParam0) // Position - 0x163E
{
	if (iParam0 == 255)
...
BOOL func_74(Player plParam0) // Position - 0x1689
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
BOOL func_75(int iParam0) // Position - 0x16CE
{
	int frameCount;
...
void func_76(int iParam0) // Position - 0x170A
{
	var unk;
...
void func_77(int iParam0, int iParam1) // Position - 0x172D
{
...
void func_78(int iParam0) // Position - 0x1750
{
	int num;
	int num2;
	int num3;
...
BOOL func_79(int iParam0, int iParam1) // Position - 0x18A1
{
	int i;
...
void func_80(int iParam0) // Position - 0x18E8
{
	int Arg;
	Player Plr;
	Vector3 vector;

	Arg = Global_1149035.f_2[iParam0 /*43*/].f_8;
	Plr = PLAYER::INT_TO_PLAYERINDEX(Arg);

	if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr))
	{
		vector = { Global_1148618[Arg /*13*/][iParam0 /*4*/].f_1 };
...
BOOL func_81(var uParam0) // Position - 0x1998
{
	return func_105(*uParam0, 1);
}

void func_82(var uParam0) // Position - 0x19A8
{
	func_106(uParam0, 0);
	return;
}

void func_83(var uParam0) // Position - 0x19B7
{
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
	*uParam0 = 0;
...
int func_84(var uParam0) // Position - 0x19CD
{
	if (!func_81(uParam0))
		return 0;
...
BOOL func_85(int iParam0) // Position - 0x19FE
{
...
void func_86(int iParam0, int iParam1) // Position - 0x1A20
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

float func_87(int iParam0) // Position - 0x1A35
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_88(var uParam0, var uParam1) // Position - 0x1A74
{
	if (!func_109(uParam0))
		return false;
...
struct<2> func_89(int iParam0) // Position - 0x1AA8
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_90(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1ABC
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

void func_91(int iParam0, int iParam1) // Position - 0x1AD7
{
...
void func_92(int iParam0, int iParam1) // Position - 0x1B0B
{
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x1B2E
{
...
BOOL func_94(int iParam0) // Position - 0x1B58
{
	int frameCount;
...
BOOL func_95(int iParam0, int iParam1) // Position - 0x1B94
{
	int num;
...
BOOL func_96(Player plParam0) // Position - 0x1C08
{
...
void func_97(Player plParam0) // Position - 0x1C25
{
	Player player;
...
int func_98(int iParam0) // Position - 0x1CA8
{
	switch (iParam0)
	{
		case 0:
...
int func_99(int iParam0) // Position - 0x1CF2
{
	int num;
...
int func_100(int iParam0) // Position - 0x1D34
{
	int num;
	float num2;
	int i;
...
Vector3 func_101(int iParam0) // Position - 0x1E78
{
	int num;
...
BOOL func_102(int iParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x2034
{
	float minRadius;
	float maxRadius;
	Player Plr;
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(playerPed))
			{
				...
				if (num < maxRadius && !func_94(iParam0))
					return false;
			}
		}
	}
...
struct<2> func_103() // Position - 0x2134
{
	var unk;
...
int func_104(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, BOOL bParam8) // Position - 0x214D
{
	if (!func_120())
		return 0;
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x21D1
{
	return iParam0 && iParam1 != false;
}

void func_106(var uParam0, int iParam1) // Position - 0x21E0
{
...
BOOL func_107(var uParam0) // Position - 0x221C
{
	return func_105(*uParam0, 2);
}

int func_108(int iParam0) // Position - 0x222C
{
	return NETWORK::GET_TIME_DIFFERENCE(iParam0, NETWORK::GET_NETWORK_TIME_ACCURATE());
}

BOOL func_109(int iParam0) // Position - 0x223E
{
	switch (iParam0)
	{
		case 2:
...
int func_110(int iParam0) // Position - 0x227D
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_111(Any* panParam0, int iParam1, int iParam2) // Position - 0x2313
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_112() // Position - 0x234A
{
	return Global_1102813.f_3672;
}

void func_113(Player plParam0) // Position - 0x2359
{
	Player player;
...
void func_114(Player plParam0) // Position - 0x23C5
{
...
int func_115(int iParam0) // Position - 0x2400
{
	int MinInt;
	int num;

	MinInt = func_116(iParam0);
	num = func_117(iParam0);
	return MISC::GET_RANDOM_INT_IN_RANGE(MinInt, num + 1);
}

int func_116(int iParam0) // Position - 0x2422
{
	switch (iParam0)
	{
		case 0:
...
int func_117(int iParam0) // Position - 0x245C
{
	switch (iParam0)
	{
		case 0:
...
float func_118(int iParam0, int iParam1) // Position - 0x2497
{
	float num;
	int trackIndex;
	float distance;
...
BOOL func_119(int iParam0) // Position - 0x255C
{
	return func_79(iParam0, 4);
}

BOOL func_120() // Position - 0x256B
{
...
void func_121(var uParam0, int iParam1) // Position - 0x25BC
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_122(var uParam0, int iParam1) // Position - 0x25CD
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

float func_123(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x25E2
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
