...
void func_1(var uParam0, BOOL bParam1) // Position - 0x234
{
	...
	if (bParam1)
	{
		...
		TASK::TASK_SWAP_WEAPON(Global_33, true, true, false, false);
	}

	return;
}

BOOL func_2(int iParam0) // Position - 0x340
{
	return func_58(Global_1300385, iParam0);
}

BOOL func_3(var uParam0) // Position - 0x352
{
	int i;
...
BOOL func_4() // Position - 0x6F8
{
	return func_2(32);
}

BOOL func_5() // Position - 0x706
{
	return func_2(64);
}

BOOL func_6(var uParam0, int iParam1) // Position - 0x714
{
	return func_58(uParam0->f_55, iParam1);
}

void func_7(var uParam0) // Position - 0x726
{
	func_69(func_68(uParam0));
	return;
}

void func_8(int iParam0) // Position - 0x738
{
	func_69(func_70(iParam0));
	return;
}

void func_9(int iParam0) // Position - 0x74A
{
	func_71(&Global_1300385, iParam0);
	return;
}

void func_10(int iParam0) // Position - 0x75C
{
	func_72(func_68(iParam0));
	return;
}

void func_11(int iParam0) // Position - 0x76E
{
	func_72(func_70(iParam0));
	return;
}

void func_12(int iParam0) // Position - 0x780
{
	func_73(&Global_1300385, iParam0);
	return;
}

void func_13(var uParam0) // Position - 0x792
{
...
void func_16(var uParam0) // Position - 0x9CC
{
...
int func_17(var uParam0) // Position - 0xA32
{
	return uParam0->f_62;
}
...
void func_20(var uParam0) // Position - 0xAD6
{
	uParam0->f_27 = 1f;
	uParam0->f_56 = -1;
	uParam0->f_57 = -1;
...
void func_24(var uParam0) // Position - 0xB6F
{
	uParam0->f_54 = MISC::GET_GAME_TIMER();
	return;
}

void func_25(var uParam0, int iParam1) // Position - 0xB7F
{
	uParam0->f_62 = iParam1;
	return;
}

BOOL func_26(var uParam0) // Position - 0xB8D
{
	BOOL num;
...
BOOL func_27(var uParam0) // Position - 0xC0B
{
	int i;
	int num;
	BOOL num2;
...
void func_28(int iParam0, BOOL bParam1) // Position - 0xC49
{
	int num;
	int num2;
...
void func_29(var uParam0) // Position - 0xC76
{
...
void func_30(var uParam0) // Position - 0xCA8
{
	uParam0->f_25 = func_79();
	uParam0->f_26 = func_80();
...
void func_31(var uParam0, int iParam1) // Position - 0xD0A
{
	int i;
	int num;
	int num2;
...
BOOL func_32() // Position - 0x1040
{
	return Global_1896762.f_352;
}

void func_33(var uParam0) // Position - 0x104F
{
...
void func_34(var uParam0) // Position - 0x1182
{
...
void func_35(var uParam0) // Position - 0x11AC
{
...
void func_36(var uParam0) // Position - 0x120E
{
	Ped EntityIndex;
	BOOL flag;
	...
	switch (func_110(uParam0))
	{
		...
		case 1:
			...
			if (ENTITY::DOES_ENTITY_EXIST(EntityIndex) && func_115(EntityIndex) && func_116(EntityIndex) && !func_117(EntityIndex, true))
				flag = true;
		...
		case 2:
			if (func_114() <= 0)
				if (!ENTITY::DOES_ENTITY_EXIST(EntityIndex) || func_117(EntityIndex, true) || ENTITY::DOES_ENTITY_EXIST(EntityIndex) && func_119(EntityIndex))
					func_111(uParam0, 4);
			break;
...
void func_37(var uParam0) // Position - 0x139B
{
	Ped ped;
	BOOL flag;
...
void func_38(var uParam0) // Position - 0x1425
{
...
BOOL func_39(int iParam0, BOOL bParam1) // Position - 0x1460
{
	int num;
...
int func_40(int iParam0) // Position - 0x1493
{
...
BOOL func_41(var uParam0) // Position - 0x14CD
{
...
BOOL func_42(var uParam0) // Position - 0x14F1
{
	var unk;
	BOOL flag;
...
void func_43(var uParam0, int iParam1) // Position - 0x16FA
{
...
int func_44(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1711
{
...
BOOL func_45(int iParam0) // Position - 0x1737
{
	if (iParam0 < 0)
		return false;
...
Prompt func_46(var uParam0) // Position - 0x1776
{
	int num;
...
void func_47(var uParam0) // Position - 0x17A6
{
	if (uParam0->f_69 == 1)
...
void func_48(var uParam0) // Position - 0x17C5
{
...
void func_49(var uParam0) // Position - 0x17E3
{
...
BOOL func_50(Ped pedParam0, BOOL bParam1) // Position - 0x17FB
{
...
void func_51(int iParam0) // Position - 0x1828
{
	func_129(func_68(iParam0));
	return;
}

void func_52(int iParam0) // Position - 0x183A
{
	func_129(func_70(iParam0));
	return;
}

void func_53(int iParam0) // Position - 0x184C
{
	func_130(func_70(iParam0));
	return;
}

void func_54(var uParam0) // Position - 0x185E
{
	int i;
...
void func_55(var uParam0) // Position - 0x1886
{
...
void func_56(var uParam0) // Position - 0x18F1
{
...
BOOL func_58(int iParam0, int iParam1) // Position - 0x193A
{
	return iParam0 && iParam1 != false;
}

BOOL func_59(Hash hParam0, int iParam1) // Position - 0x1949
{
	int num;
...
BOOL func_60(Ped pedParam0, int iParam1) // Position - 0x19CC
{
	int num;
...
BOOL func_61(BOOL bParam0) // Position - 0x1ACB
{
	if (bParam0)
...
BOOL func_62() // Position - 0x1AFB
{
	return Global_1915656.f_20637 || Global_1915656.f_22504.f_1;
}

int func_63(int iParam0) // Position - 0x1B19
{
	if (func_62())
...
BOOL func_64(int iParam0) // Position - 0x1B39
{
	int num;
...
BOOL func_65() // Position - 0x1C09
{
	return Global_1940252.f_2;
}

int func_66(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x1C17
{
	int num;
	var unk13;
	int num2;
...
int func_67(var uParam0) // Position - 0x1C52
{
	return uParam0->f_65;
}

char* func_68(int iParam0) // Position - 0x1C5E
{
	switch (iParam0)
	{
		case 0:
...
void func_69(char* sParam0) // Position - 0x1E67
{
...
char* func_70(int iParam0) // Position - 0x1E7E
{
	switch (iParam0)
	{
		case 0:
...
void func_71(int iParam0, int iParam1) // Position - 0x1EB9
{
	func_141(iParam0, iParam1);
	return;
}

void func_72(char* sParam0) // Position - 0x1EC9
{
...
void func_73(int iParam0, int iParam1) // Position - 0x1EF1
{
	func_142(iParam0, iParam1);
	return;
}

BOOL func_74(Player plParam0, int iParam1) // Position - 0x1F01
{
	Player player;
...
BOOL func_76(int iParam0, BOOL bParam1) // Position - 0x20BD
{
	int num;
...
void func_77(BOOL bParam0) // Position - 0x20F0
{
	if (bParam0)
		func_143(4);
...
void func_78(int iParam0) // Position - 0x2112
{
	Global_1940085.f_39 = Global_1940085.f_39 || iParam0;
	return;
}

int func_79() // Position - 0x2129
{
	return GRAPHICS::_GET_CURRENT_NUMBER_OF_LOCAL_PHOTOS();
}

int func_80() // Position - 0x2135
{
	return GRAPHICS::_GET_MAX_NUMBER_OF_LOCAL_PHOTOS();
}

void func_81(var uParam0, int iParam1) // Position - 0x2141
{
	func_73(&(uParam0->f_55), iParam1);
	return;
}

void func_82(var uParam0, int iParam1) // Position - 0x2153
{
	func_71(&(uParam0->f_55), iParam1);
	return;
}

void func_83(var uParam0) // Position - 0x2165
{
	var buffer;
	var buffer2;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x21CA
{
	switch (iParam0)
	{
		case 0:
...
int func_85(var uParam0) // Position - 0x22FB
{
	return MISC::GET_GAME_TIMER() - func_144(uParam0);
}

BOOL func_86(var uParam0, int iParam1) // Position - 0x230E
{
	if (!func_45(*uParam0))
	{
...
void func_87(int iParam0, var uParam1, var uParam2) // Position - 0x23AB
{
	int num;
...
BOOL func_88(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x23C7
{
...
void func_89(int iParam0, int iParam1) // Position - 0x2469
{
	int Variable;
...
int func_90(int iParam0, BOOL bParam1) // Position - 0x248D
{
	int num;
	BOOL flag;
...
void func_91(int iParam0) // Position - 0x2529
{
	func_157(func_68(iParam0));
	return;
}

int func_92(int iParam0) // Position - 0x253B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_93(var uParam0) // Position - 0x25D8
{
	BOOL flag;
	...
	MISC::GET_GROUND_Z_FOR_3D_COORD(offsetFromCoordAndHeadingInWorldCoords, &ReturnZ, false);
	MISC::GET_GROUND_Z_FOR_3D_COORD(entityCoords, &ReturnZ2, false);

	if (entityCoords.f_2 > ReturnZ)
		if (entityCoords.f_2 - ReturnZ > 2f)
			return false;
	else if (ReturnZ - entityCoords.f_2 > 2f)
		return false;
	...
	if (ReturnZ - entityCoords.f_2 > 1f)
		return false;
	...
	if (PATHFIND::IS_POINT_ON_ROAD(offsetFromCoordAndHeadingInWorldCoords, offsetFromCoordAndHeadingInWorldCoords.f_1, ReturnZ, 0))
		return false;

	num = 1f;

	if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_COORD(Global_33, offsetFromCoordAndHeadingInWorldCoords, offsetFromCoordAndHeadingInWorldCoords.f_1, ReturnZ + num, 3167))
		flag = true;
	else
		return false;
	...
	if (flag)
	{
		...
		uParam0->f_46 = { offsetFromCoordAndHeadingInWorldCoords, offsetFromCoordAndHeadingInWorldCoords.f_1, ReturnZ + num };
	}

	return true;
}

BOOL func_94(Ped pedParam0) // Position - 0x27A0
{
...
void func_95(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x27BB
{
	int num;
...
void func_96(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x280F
{
	int num;
...
void func_97(var uParam0) // Position - 0x283B
{
	uParam0->f_25 = func_79();
	return;
}

void func_98(var uParam0) // Position - 0x284B
{
	func_83(uParam0);
	func_164(uParam0);
	func_165(uParam0);
...
int func_99(var uParam0) // Position - 0x2865
{
	return uParam0->f_68;
}

BOOL func_100(char* sParam0) // Position - 0x2871
{
	return GRAPHICS::ANIMPOSTFX_IS_RUNNING(sParam0);
}

void func_101(var uParam0) // Position - 0x287F
{
	func_166(uParam0);
...
void func_102(var uParam0) // Position - 0x2905
{
...
void func_103(var uParam0, int iParam1) // Position - 0x2AF7
{
	uParam0->f_65 = iParam1;
	return;
}

void func_104() // Position - 0x2B05
{
	UIAPPS::LAUNCH_UIAPP_WITH_ENTRY("social_club_feed", "launch_to_photos");
	return;
}

void func_105(var uParam0) // Position - 0x2B1A
{
...
void func_106(var uParam0) // Position - 0x2D29
{
	BOOL flag;
...
void func_107(var uParam0) // Position - 0x3004
{
	ItemSet itemSet;
...
void func_109(var uParam0) // Position - 0x32E6
{
	Ped entityFromItem;
	Ped pedFromIndexedItem;
	int num;
...
int func_110(var uParam0) // Position - 0x3434
{
	return uParam0->f_70;
}

void func_111(var uParam0, int iParam1) // Position - 0x3440
{
	uParam0->f_70 = iParam1;
	return;
}

void func_112() // Position - 0x344E
{
	func_209(0, 0, 0, 128);
	return;
}

BOOL func_113(var uParam0) // Position - 0x345F
{
	Entity outEntity;
...
BOOL func_115(Ped pedParam0) // Position - 0x355F
{
	Ped ped;
...
BOOL func_116(Ped pedParam0) // Position - 0x3589
{
...
BOOL func_117(Ped pedParam0, BOOL bParam1) // Position - 0x35CE
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
void func_118() // Position - 0x3647
{
	func_209(0, 255, 0, 128);
	return;
}

BOOL func_119(Ped pedParam0) // Position - 0x3659
{
	Hash entityModel;
...
void func_120() // Position - 0x3685
{
	GRAPHICS::_ANIMPOSTFX_SET_POSTFX_COLOR(func_70(0), 0, 255, 255, 255, 128);
	return;
}

int func_121(int iParam0) // Position - 0x369D
{
	return iParam0;
}

void func_122(int iParam0) // Position - 0x36A7
{
	GRAPHICS::_ANIMPOSTFX_SET_STRENGTH(func_70(iParam0), 0f);
	return;
}

void func_123(int iParam0) // Position - 0x36BA
{
	GRAPHICS::_ANIMPOSTFX_SET_STRENGTH(func_70(iParam0), 1f);
	return;
}

int func_124(Any* panParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x36CD
{
	int num;
	int num2;
...
void func_125(var uParam0, BOOL bParam1) // Position - 0x36F9
{
	Ped pedFromIndexedItem;
	Hash entityModel;
	BOOL flag;
...
void func_126(var uParam0, int iParam1) // Position - 0x3873
{
	uParam0->f_63 = iParam1;
	return;
}

void func_127() // Position - 0x3881
{
	func_73(&Global_1300385, 1);
	return;
}

void func_128(var uParam0) // Position - 0x3892
{
	if (*uParam0 >= 0)
	{
...
void func_129(char* sParam0) // Position - 0x38AC
{
	GRAPHICS::_ANIMPOSTFX_SET_TO_UNLOAD(sParam0);
	return;
}

void func_130(char* sParam0) // Position - 0x38BA
{
	if (GRAPHICS::ANIMPOSTFX_IS_RUNNING(sParam0))
...
void func_131(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x38D1
{
	int num;
...
void func_132(var uParam0) // Position - 0x3925
{
...
void func_133(BOOL bParam0) // Position - 0x3940
{
	UIFEED::UI_FEED_CLEAR_CHANNEL(1, bParam0, false);
	return;
}

BOOL func_134(Hash hParam0, int iParam1) // Position - 0x3950
{
	if (hParam0 == 0)
		return false;
...
int func_135(Hash hParam0) // Position - 0x396A
{
	var unk;
...
BOOL func_136(Hash hParam0, int iParam1) // Position - 0x3995
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_137(Hash hParam0) // Position - 0x3A3D
{
	int num;
	int num2;
	int num3;
...
int func_138(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3AF9
{
...
BOOL func_139(int iParam0) // Position - 0x3BBB
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_140(int iParam0) // Position - 0x3BD1
{
...
void func_141(int iParam0, int iParam1) // Position - 0x4500
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_142(int iParam0, int iParam1) // Position - 0x4511
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_143(int iParam0) // Position - 0x4526
{
	Global_1902887.f_302 = Global_1902887.f_302 || iParam0;
	return;
}

var func_144(var uParam0) // Position - 0x453F
{
	return uParam0->f_54;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(int iParam0) // Position - 0x454B
{
	switch (iParam0)
	{
		case 0:
...
Hash func_146(int iParam0, BOOL bParam1) // Position - 0x4614
{
	switch (iParam0)
	{
		case 0:
...
int func_147(char* sParam0, Hash hParam1, Hash hParam2, int iParam3) // Position - 0x474C
{
	int i;
	int num;
...
int func_148(char* sParam0, Hash hParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, Hash hParam10, BOOL bParam11) // Position - 0x47DA
{
	int i;
	int num;
...
void func_149(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4863
{
	int num;
...
BOOL func_150(int iParam0, int iParam1) // Position - 0x48AE
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_151(int iParam0) // Position - 0x48C6
{
...
BOOL func_152(int iParam0) // Position - 0x48DD
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_153(int iParam0, int iParam1) // Position - 0x49A9
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_154(int iParam0) // Position - 0x49C2
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_155() // Position - 0x49D5
{
	if (!func_236())
		return false;
...
BOOL func_156(int iParam0) // Position - 0x49F0
{
	switch (iParam0)
	{
		case 0:
...
void func_157(char* sParam0) // Position - 0x4C67
{
	if (!GRAPHICS::_ANIMPOSTFX_HAS_LOADED(sParam0))
		GRAPHICS::_ANIMPOSTFX_PRELOAD_POSTFX(sParam0);
...
BOOL func_158(Ped pedParam0, BOOL bParam1) // Position - 0x4C7F
{
...
BOOL func_159(Ped pedParam0, Ped pedParam1) // Position - 0x4CD2
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
void func_160(int iParam0, int iParam1) // Position - 0x4CF4
{
	if (iParam0 < 0)
		return;
...
void func_161(int iParam0, BOOL bParam1) // Position - 0x4D27
{
...
void func_162(int iParam0, BOOL bParam1) // Position - 0x4D7F
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_163(int iParam0, int iParam1) // Position - 0x4DA8
{
	if (iParam0 < 0)
		return;
...
void func_164(var uParam0) // Position - 0x4DD0
{
	var unk;
	var unk9;
...
void func_165(var uParam0) // Position - 0x4E0C
{
	var unk;
...
int func_166(var uParam0) // Position - 0x4E67
{
	float fRadius;
	int bHitSomething;
	var vPos;
	...
	{
		case 0:
			uParam0->f_71 = SHAPETEST::START_SHAPE_TEST_SWEPT_SPHERE(uParam0->f_46 - { 0.2f, 0f, 0f }, uParam0->f_46 + { 0.2f, 0f, 0f }, fRadius, 3167, 0, 4);
			uParam0->f_69 = 1;
			break;
	
		case 1:
			shapeTestResult = SHAPETEST::GET_SHAPE_TEST_RESULT(uParam0->f_71, &bHitSomething, &vPos, &vNormal, &EntityIndex);
			bHitSomething > 0;
...
BOOL func_167(var uParam0) // Position - 0x4EF8
{
...
void func_168(var uParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4F45
{
...
void func_169(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4FDD
{
...
BOOL func_170(int iParam0, BOOL bParam1) // Position - 0x5087
{
	if (bParam1 && !func_45(iParam0))
		return false;
...
int func_171(var uParam0) // Position - 0x50AC
{
	return uParam0->f_66;
}

int func_172(var uParam0) // Position - 0x50B8
{
	return uParam0->f_67;
}

void func_173(var uParam0, int iParam1) // Position - 0x50C4
{
	uParam0->f_67 = iParam1;
	return;
}

void func_174() // Position - 0x50D2
{
	func_9(32);
	func_12(64);
	return;
...
void func_175(var uParam0) // Position - 0x50E6
{
...
void func_176(var uParam0) // Position - 0x52D3
{
	int num;
	int num2;
...
void func_177(var uParam0) // Position - 0x53B5
{
	int num;
	int num2;
...
void func_178(var uParam0) // Position - 0x5497
{
...
void func_179(var uParam0) // Position - 0x54F3
{
...
float func_182() // Position - 0x5588
{
	float num;
	float num2;
...
int func_184(var uParam0) // Position - 0x55E2
{
	return uParam0->f_64;
}

void func_185(var uParam0, int iParam1) // Position - 0x55EE
{
	uParam0->f_68 = iParam1;
	return;
}

void func_186(var uParam0, int iParam1) // Position - 0x55FC
{
	uParam0->f_64 = iParam1;
	return;
}

BOOL func_187(var uParam0) // Position - 0x560A
{
	Vector3 entityCoords;
	float entityHeading;
	...
	if (!flag)
	{
		uParam0->f_49 = { entityCoords, entityCoords.f_1, entityCoords.f_2 - 1f };
		uParam0->f_52 = entityHeading;
		uParam0->f_46 = { offsetFromCoordAndHeadingInWorldCoords, offsetFromCoordAndHeadingInWorldCoords.f_1, ReturnZ + 1f };
	}
...
void func_188(var uParam0) // Position - 0x5838
{
	int num;
...
void func_190(var uParam0) // Position - 0x58BC
{
	var args;
	var unk25;
	var unk28;
...
void func_191(var uParam0) // Position - 0x595D
{
	func_249(uParam0);
	func_250(uParam0);
	...
	CAM::SET_CAM_PARAMS(uParam0->f_35, uParam0->f_46, uParam0->f_92, 50f, 0, 1, 1, 2, false, false);
	return;
}

void func_192(var uParam0) // Position - 0x5B2C
{
...
void func_193(var uParam0) // Position - 0x5B94
{
...
void func_194(var uParam0) // Position - 0x5D0B
{
	int num;
...
void func_195(var uParam0) // Position - 0x5E02
{
	if (CAM::DOES_CAM_EXIST(uParam0->f_35))
	{
		CAM::SET_CAM_ACTIVE(uParam0->f_35, false);
...
float func_197() // Position - 0x5E67
{
	return 130f;
}

float func_198(Ped pedParam0, Entity eParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5E74
{
...
void func_199(Ped pedParam0, ItemSet isParam1) // Position - 0x5EBC
{
...
char* func_200() // Position - 0x5EED
{
	return "proc_bounty_target";
}

BOOL func_201(Hash hParam0) // Position - 0x5EF9
{
...
void func_202(Ped pedParam0, ItemSet isParam1) // Position - 0x5FDF
{
	if (!ITEMSET::IS_ITEMSET_VALID(isParam1))
		return;
...
int func_203(Hash hParam0) // Position - 0x6012
{
...
BOOL func_207(Ped pedParam0, int iParam1) // Position - 0x6091
{
	Ped SecondEntityIndex;

	SecondEntityIndex = func_210(pedParam0);

	if (func_204(SecondEntityIndex) && !func_117(pedParam0, true) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(Global_33, SecondEntityIndex, 3455) && func_259(pedParam0, func_255(), func_256(), func_257(), func_258()) && func_205(pedParam0) && func_260(pedParam0) >= func_261(iParam1))
		return true;

	return false;
}

BOOL func_208(Ped pedParam0, int iParam1) // Position - 0x6105
{
	Ped SecondEntityIndex;

	SecondEntityIndex = func_210(pedParam0);

	if (func_204(SecondEntityIndex) && !func_117(pedParam0, true) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(Global_33, SecondEntityIndex, 3455) && func_259(pedParam0, func_255(), func_256(), func_257(), func_258()))
		if (!PED::_IS_PED_VISIBILITY_TRACKED(pedParam0))
...
void func_209(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x618A
{
	GRAPHICS::_ANIMPOSTFX_SET_POSTFX_COLOR(func_70(0), 0, iParam0, iParam1, iParam2, iParam3);
	return;
}

Ped func_210(Ped pedParam0) // Position - 0x61A4
{
	return pedParam0;
}

BOOL func_211(Ped pedParam0, BOOL bParam1) // Position - 0x61AE
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return false;
...
void func_212() // Position - 0x61E3
{
	...
	if (func_263(num))
		TEXT_LABEL_COPY(&StringToTest, { func_264(num) }, 4);

	if (MISC::IS_STRING_NULL_OR_EMPTY(&StringToTest))
	{
		hash = func_265();
		TEXT_LABEL_ASSIGN_STRING(&StringToTest, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0(hash), 32);
	}
...
void func_214() // Position - 0x6270
{
	func_71(&Global_1300385, 1);
	return;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0(int iParam0) // Position - 0x6281
{
	switch (iParam0)
	{
		case 0:
...
int func_216(var uParam0) // Position - 0x6490
{
	switch (func_67(uParam0))
	{
		case 1:
...
struct<2> func_217(int iParam0) // Position - 0x64E4
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_218(var uParam0, var uParam1) // Position - 0x64F8
{
	return func_271(uParam0);
}

void func_219(var uParam0) // Position - 0x6508
{
	Entity outEntity;
...
void func_220(int iParam0) // Position - 0x654A
{
	if (!func_273(iParam0))
		return;
...
Hash func_221(Hash hParam0, int iParam1) // Position - 0x65FD
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_222(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x6677
{
...
BOOL func_223(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x669E
{
	if (iParam2 < 0)
		return false;
...
BOOL func_224(Hash hParam0) // Position - 0x66D9
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_225(int iParam0) // Position - 0x66F4
{
	if (iParam0 < 0)
		return 0;
...
int func_226(Hash hParam0) // Position - 0x6715
{
	var unk;
...
int func_227(Hash hParam0) // Position - 0x6740
{
	switch (hParam0)
	{
...
int func_228(var uParam0, int iParam1) // Position - 0x6823
{
	int i;
...
int func_229(Hash hParam0) // Position - 0x6860
{
	int num;
...
int func_230(Hash hParam0, BOOL bParam1) // Position - 0x68CD
{
	var unk;
	int num;
	int num2;
...
int func_231(Hash hParam0, int iParam1) // Position - 0x692C
{
	if (iParam1 == 0)
		return 0;
...
int func_232(BOOL bParam0) // Position - 0x6958
{
	if (func_282() == -1)
	{
...
struct<4> func_233(Hash hParam0, BOOL bParam1) // Position - 0x6999
{
	var unk;
...
BOOL func_234(int iParam0, int iParam1) // Position - 0x69BE
{
	if (iParam0 < 0)
		return false;
...
int func_237(Interior inParam0) // Position - 0x6D0D
{
	var position;
	int nameHash;
...
int func_238(Interior inParam0) // Position - 0x6D68
{
	var position;
	int nameHash;
...
const char* func_239(int iParam0) // Position - 0x6DA5
{
	return MISC::_GET_STRING_FROM_FLOAT(BUILTIN::TO_FLOAT(iParam0), 0);
}

BOOL func_240(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6DB8
{
	int num;
...
int func_241(var uParam0) // Position - 0x6DED
{
	return uParam0->f_33;
}

void func_242(var uParam0) // Position - 0x6DF9
{
	if (uParam0->f_33 < 3)
...
void func_243(var uParam0) // Position - 0x6E13
{
	if (uParam0->f_33 > 1)
		uParam0->f_33 = uParam0->f_33 - 1;
...
BOOL func_244(int iParam0, BOOL bParam1) // Position - 0x6E2D
{
	int num;
...
float func_245() // Position - 0x6E60
{
	return 0.5f;
}

void func_246(var uParam0) // Position - 0x6E6D
{
	int Sequence;
...
Vector3 func_247(Player plParam0) // Position - 0x6EB3
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false, false);
}

Vector3 func_248(float fParam0, var uParam1, var uParam2) // Position - 0x6EC7
{
	float num;
	float num2;
...
void func_249(var uParam0) // Position - 0x6F06
{
...
void func_250(var uParam0) // Position - 0x6F6E
{
	int num;
	int num2;
	Cam renderingCam;
...
void func_251(var uParam0) // Position - 0x71D9
{
	func_40(16);
	PED::CLEAR_FACIAL_IDLE_ANIM_OVERRIDE(Global_33);
...
void func_252(var uParam0, int iParam1) // Position - 0x7203
{
	uParam0->f_66 = iParam1;
	return;
}

Hash func_253(int iParam0) // Position - 0x7211
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_254(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x725E
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		if (!PED::IS_PED_INJURED(pedParam0))
...
float func_255() // Position - 0x72B7
{
	return 0.3f;
}

float func_256() // Position - 0x72C4
{
	return 0.7f;
}

float func_257() // Position - 0x72D1
{
	return 0.2f;
}

float func_258() // Position - 0x72DE
{
	return 0.7f;
}

BOOL func_259(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x72EB
{
	if (!ENTITY::IS_ENTITY_DEAD(pedParam0))
...
float func_260(Ped pedParam0) // Position - 0x7319
{
	return func_289(pedParam0) * 100f;
}

float func_261(int iParam0) // Position - 0x732D
{
	switch (iParam0)
	{
		case 0:
...
int func_262() // Position - 0x7397
{
	return Global_1893611.f_2;
}

BOOL func_263(int iParam0) // Position - 0x73A5
{
	return iParam0 >= 0 && iParam0 <= 150;
}

char* func_264(int iParam0) // Position - 0x73BB
{
	char* str;
...
Hash func_265() // Position - 0x73E4
{
	return ZONE::_GET_WATER_MAP_ZONE_AT_COORDS(Global_34);
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0(Hash hParam0) // Position - 0x73F5
{
	switch (hParam0)
	{
...
int func_267() // Position - 0x75B5
{
	return Global_1896646.f_41;
}

BOOL func_268(int iParam0) // Position - 0x75C3
{
	return iParam0 > -1 && iParam0 < 17;
}

char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0(int iParam0) // Position - 0x75D9
{
	switch (iParam0)
	{
		case 0:
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0(int iParam0) // Position - 0x76D9
{
	switch (iParam0)
	{
		case 0:
...
int func_271(var uParam0, var uParam1) // Position - 0x77D9
{
	int num;
...
void func_272(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7803
{
	Hash entityModel;
	var entityCoords;
...
BOOL func_273(int iParam0) // Position - 0x7876
{
	return func_234(iParam0, 2);
}

BOOL func_274(Hash hParam0, Hash hParam1) // Position - 0x7885
{
	if (!func_134(hParam0, 0))
...
void func_275(Hash hParam0, var uParam1, var uParam2) // Position - 0x78C6
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_276(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x7AD2
{
	Hash hash;
...
struct<4> func_277(BOOL bParam0) // Position - 0x7BB0
{
	int num;
...
void func_278(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7C51
{
...
BOOL func_279(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x7C6C
{
...
Hash func_280(Hash hParam0) // Position - 0x7C91
{
	return hParam0;
}

BOOL func_281(Hash hParam0, int iParam1) // Position - 0x7C9B
{
	if (hParam0 == 0)
		return false;
...
int func_282() // Position - 0x7CB5
{
	return Global_1572887.f_14;
}

struct<5> func_283(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x7CC3
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_284(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x8037
{
	var outGuid;
...
void func_285(var uParam0) // Position - 0x8068
{
	WEAPON::SET_CURRENT_PED_WEAPON(Global_33, joaat("WEAPON_UNARMED"), true, 0, false, false);
...
void func_286(var uParam0, int iParam1) // Position - 0x80AC
{
	if (*uParam0 < 0)
	{
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0_0_0_0_0_0(int iParam0) // Position - 0x80D9
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_288(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x8155
{
	float fScreenPosX;
	float fScreenPosY;
...
float func_289(Ped pedParam0) // Position - 0x819F
{
	Ped ped;
	Vector3 minimum;
	Vector3 maximum;
	...
	if (!GRAPHICS::GET_SCREEN_COORD_FROM_WORLD_COORD(minimum, &fXpos, &(fXpos.f_1)) || !GRAPHICS::GET_SCREEN_COORD_FROM_WORLD_COORD(maximum, &fXpos2, &(fXpos2.f_1)))
		return 0f;

	num = MISC::ABSF(fXpos2 - fXpos);
	num2 = MISC::ABSF(fXpos2.f_1 - fXpos.f_1);
	num3 = num * num2;
	return num3;
}

BOOL func_290(int iParam0, var uParam1, Any* panParam2) // Position - 0x8207
{
	if (!func_301(iParam0))
		return false;
...
void func_291(Ped pedParam0) // Position - 0x8312
{
	var unk;
...
void func_292(Hash hParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, BOOL bParam5, BOOL bParam6) // Position - 0x834D
{
...
BOOL func_293(Hash hParam0, Hash hParam1) // Position - 0x8398
{
...
struct<4> func_294(BOOL bParam0) // Position - 0x83CE
{
	int num;
...
int func_295(Hash hParam0, BOOL bParam1) // Position - 0x846E
{
...
BOOL func_296(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x84A5
{
	return func_305(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_297(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x84C0
{
	var unk;
...
struct<4> func_298(BOOL bParam0) // Position - 0x84E1
{
	int num;
...
BOOL func_299(Hash hParam0, int iParam1) // Position - 0x854B
{
	Hash hash;
	int num;
	int i;
...
BOOL func_300(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x85B8
{
	return func_308(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

BOOL func_301(var uParam0, var uParam1) // Position - 0x85CE
{
	if (!func_309(uParam0))
		return false;
...
void func_302(Any* panParam0) // Position - 0x8602
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
struct<4> func_303() // Position - 0x8618
{
	var unk;
...
int func_305(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x8641
{
...
BOOL func_306(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x86C0
{
	int inventoryId;
...
BOOL func_307(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x8705
{
...
BOOL func_308(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x8738
{
...
BOOL func_309(int iParam0) // Position - 0x8772
{
	switch (iParam0)
	{
		case 2:
...
int func_310(int iParam0) // Position - 0x87B1
{
	switch (iParam0)
	{
		case 2:
...
int func_311(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x8847
{
...
BOOL func_312(Hash hParam0) // Position - 0x887A
{
