...
void func_7() // Position - 0x2DB
{
	return;
}

void func_8() // Position - 0x2E3
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

void func_9(int iParam0) // Position - 0x2EF
{
	struct<2> data;
...
void func_10(int iParam0) // Position - 0x317
{
	struct<2> data;
...
void func_11(int iParam0) // Position - 0x33F
{
	struct<2> data;
...
void func_13(int iParam0) // Position - 0x38B
{
...
int func_14() // Position - 0x3CE
{
	return pedLocal_18.f_25;
}

BOOL func_15() // Position - 0x3DA
{
	return pedLocal_18.f_24;
}

void func_16() // Position - 0x3E6
{
	pedLocal_18.f_24 = 0;
	return;
}

void func_17(int iParam0) // Position - 0x3F3
{
...
void func_18(var uParam0) // Position - 0x405
{
	pedLocal_18 = uParam0->f_1;
	return;
}

void func_19(var uParam0) // Position - 0x413
{
...
void func_20(var uParam0) // Position - 0x447
{
	return;
}

void func_21() // Position - 0x44F
{
	pedLocal_18.f_24 = 1;
	return;
}
