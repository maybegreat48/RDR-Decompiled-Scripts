...
void _DEBUG_PRINT(int iParam0) // Position - 0xCD9
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0xCE5
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0xCF2
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0xCFE
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0xD0B
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0xD17
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0xD2C
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0xD3D
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xD7C
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0xD88
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0xD90
{
	if (func_54(iParam0))
		return true;
...
void func_26() // Position - 0xE48
{
	return;
}

void func_27() // Position - 0xE50
{
	return;
}

void func_28() // Position - 0xE58
{
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0xE60
{
	iParam0 = iParam0;
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0xE6C
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0xE78
{
	return;
}

void func_32() // Position - 0xE80
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0_0(int iParam0) // Position - 0xE88
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xE94
{
...
void func_35(var uParam0) // Position - 0xEC5
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xF0B
{
	iParam0 = iParam0;
...
BOOL func_38(BOOL bParam0) // Position - 0xF39
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xF4A
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xF62
{
	func_61();
	return true;
}

void func_41(var uParam0, int iParam1) // Position - 0xF6F
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0x10AE
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0x10BB
{
...
BOOL func_44(int iParam0) // Position - 0x10F1
{
	if (iParam0 == 0)
	{
		func_74();
...
int func_45() // Position - 0x1205
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0x1213
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0x121F
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0x128C
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x136C
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x138A
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x139D
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x13BB
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x14B3
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x14C4
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x14D8
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x14EC
{
	return uParam0;
}

void func_58(var uParam0, Volume volParam1, int iParam2) // Position - 0x14F6
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_59(int iParam0) // Position - 0x154F
{
...
void func_61() // Position - 0x1592
{
	...
	num = 756;
	EntityIndex = func_93(num);

	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex) && !ENTITY::DOES_ENTITY_EXIST(PED::_GET_ACTIVE_ANIMAL_OWNER(EntityIndex)))
		func_94(EntityIndex);

	return;
}

BOOL func_62(int iParam0, int iParam1) // Position - 0x15F0
{
	return iParam0 && iParam1 != false;
}

BOOL func_63(var uParam0, int iParam1) // Position - 0x15FF
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_64() // Position - 0x1610
{
	return func_62(Global_1940199, &func_74);
}

BOOL func_65(var uParam0, int iParam1) // Position - 0x1623
{
...
BOOL func_67(int iParam0, int iParam1) // Position - 0x1674
{
...
int func_68() // Position - 0x16A1
{
	return Global_1896646.f_41;
}

void func_69(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x16AF
{
	BOOL flag;
	...
	StringToTest = func_97(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_109(&unk, joaat("COLOR_PURE_WHITE")), str3, func_109(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_109(&unk, joaat("COLOR_PURE_WHITE")), func_109(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_110(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_70(var uParam0, int iParam1) // Position - 0x1916
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_71(int iParam0, BOOL bParam1) // Position - 0x1929
{
...
void func_72(BOOL bParam0) // Position - 0x1F92
{
	if (bParam0)
...
BOOL func_73(int iParam0) // Position - 0x1FBB
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_74() // Position - 0x2000
{
	return;
}

Hash func_75(int iParam0, BOOL bParam1) // Position - 0x2008
{
	switch (iParam0)
	{
		case 0:
...
void func_76(int iParam0, BOOL bParam1) // Position - 0x27CD
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_77(BOOL bParam0) // Position - 0x2820
{
	if (bParam0)
...
void func_78(int iParam0) // Position - 0x2849
{
	int num;
	Ped EntityIndex;
	...
	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex))
		PED::_CLEAR_ACTIVE_ANIMAL_OWNER(EntityIndex, false);

	return;
}

void func_79(int iParam0) // Position - 0x289B
{
	int i;
...
void func_80(int iParam0) // Position - 0x28CC
{
	int i;
...
BOOL func_81(int iParam0, BOOL bParam1) // Position - 0x28FF
{
	int num;
	int num2;
	int num3;
...
BOOL func_82(int iParam0) // Position - 0x29B5
{
	int i;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x2A2F
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_84(int iParam0) // Position - 0x2A60
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_85(int iParam0) // Position - 0x2A81
{
	if (!func_59(iParam0))
		return false;
...
BOOL func_86(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2AD4
{
	BOOL flag;
...
BOOL func_87(int iParam0) // Position - 0x3194
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_88(int iParam0) // Position - 0x31AB
{
	switch (iParam0)
	{
		case 64:
...
int func_89(int iParam0, BOOL bParam1) // Position - 0x31EE
{
	if (!func_87(iParam0))
		return 0;
...
BOOL func_90(int iParam0) // Position - 0x32D9
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_91(int iParam0) // Position - 0x32EF
{
	return iParam0 > -1 && iParam0 < 16;
}

void func_92() // Position - 0x3305
{
...
Ped func_93(int iParam0) // Position - 0x3354
{
	PersChar persChar;
...
void func_94(Ped pedParam0) // Position - 0x3382
{
	int num;
	Ped EntityIndex;
	...
	if (ENTITY::DOES_ENTITY_EXIST(EntityIndex))
		PED::SET_PED_OWNS_ANIMAL(EntityIndex, pedParam0, false);

	return;
}

BOOL func_95(int iParam0) // Position - 0x33A9
{
...
const char* func_97(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x3421
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_134(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_136(func_135(Global_34));
...
BOOL func_98(int iParam0) // Position - 0x3E87
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_99(int iParam0) // Position - 0x3E9C
{
	switch (iParam0)
	{
		case 0:
...
int func_100(int iParam0) // Position - 0x3F57
{
	int i;
	var gamerHandle;
	int bountyData;
...
char* func_102(int iParam0) // Position - 0x4154
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_103(int iParam0, BOOL bParam1) // Position - 0x418F
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_104(int iParam0, int iParam1) // Position - 0x41D1
{
	if (!func_98(iParam0))
		return false;
...
int func_105() // Position - 0x4216
{
	return Global_1902569;
}

int func_106(int iParam0) // Position - 0x4222
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_107(int iParam0) // Position - 0x4235
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_108(float fParam0) // Position - 0x4247
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_109(var uParam0, int iParam1) // Position - 0x425D
{
...
int func_110(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4293
{
	int duration;
	var data;
	int num;
...
BOOL func_111(int iParam0) // Position - 0x42D6
{
	if (func_137(iParam0))
		if (!func_138(44))
			return false;
...
void func_112(int iParam0, int iParam1) // Position - 0x42F6
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_113(int iParam0, int iParam1) // Position - 0x4307
{
	int num;
...
void func_114(var uParam0, var uParam1, int iParam2) // Position - 0x431D
{
...
void func_115(Volume volParam0) // Position - 0x433A
{
...
void func_116(int iParam0) // Position - 0x4351
{
...
void func_117(int iParam0) // Position - 0x4431
{
	int i;
	int num;
...
BOOL func_118(int iParam0, BOOL bParam1) // Position - 0x4609
{
	if (func_45() != -1)
		return false;
...
int func_119(int iParam0, BOOL bParam1) // Position - 0x4637
{
	if (!func_87(iParam0))
		return 0;
...
int func_120(int iParam0) // Position - 0x46BA
{
	switch (iParam0)
	{
		case 27:
...
int func_121(int iParam0) // Position - 0x46E1
{
	switch (iParam0)
	{
		case 33:
...
void func_124(int iParam0, BOOL bParam1) // Position - 0x4944
{
	BOOL flag;
...
Hash func_125(int iParam0) // Position - 0x4CF3
{
	if (!func_87(iParam0))
		return 0;
...
void func_126(int iParam0, PersChar pchParam1) // Position - 0x4D11
{
	if (!func_87(iParam0))
		return;
...
PersChar func_127(int iParam0) // Position - 0x4D32
{
	if (!func_87(iParam0))
		return 0;
...
void func_128(int iParam0, BOOL bParam1) // Position - 0x4D52
{
	if (func_45() != -1)
		return;
...
BOOL func_129(int iParam0) // Position - 0x4D8B
{
	if (!func_87(iParam0))
		return false;
...
int func_130(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x4DB1
{
	PersChar persChar;
...
BOOL func_131() // Position - 0x4DFF
{
	return false;
}

BOOL func_132() // Position - 0x4E08
{
	var unk;
	var unk3;
...
BOOL func_133(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4E70
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_134(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x4FE6
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_135(var uParam0, var uParam1, var uParam2) // Position - 0x4FFA
{
	int i;
...
const char* func_136(int iParam0) // Position - 0x5028
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_137(int iParam0) // Position - 0x530C
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_138(int iParam0) // Position - 0x5336
{
	if (!func_170(iParam0))
		return false;
...
struct<2> func_139(Player plParam0) // Position - 0x5352
{
	var gamerHandle;
...
const char* func_140(const char* sParam0, int iParam1) // Position - 0x5366
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_141(int iParam0, BOOL bParam1) // Position - 0x5380
{
	char* StringToTest;
...
void func_142(int iParam0, BOOL bParam1) // Position - 0x53B4
{
	switch (iParam0)
	{
		case 5:
...
void func_143(int iParam0, int iParam1) // Position - 0x53E9
{
	func_172(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_144(int iParam0) // Position - 0x5403
{
	if (!func_87(iParam0))
		return false;
...
void func_145(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5428
{
	PersChar persChar;
...
void func_146(int iParam0, BOOL bParam1) // Position - 0x5514
{
	if (!func_175(iParam0))
		return;
...
void func_147(int iParam0, int iParam1) // Position - 0x556A
{
	if (!func_180(iParam0))
		return;
...
int func_148(int iParam0) // Position - 0x55DD
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_149(Hash hParam0) // Position - 0x55F3
{
...
void func_150(int iParam0) // Position - 0x5613
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_151(int iParam0, BOOL bParam1) // Position - 0x5629
{
	if (func_45() != -1)
		return;
...
void func_152(int iParam0) // Position - 0x565A
{
	Ped EntityIndex;
...
void func_153(int iParam0) // Position - 0x569E
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_154(int iParam0) // Position - 0x56B3
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_155(int iParam0) // Position - 0x56C8
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_156(int iParam0) // Position - 0x56DD
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_157(int iParam0) // Position - 0x575C
{
...
BOOL func_158(int iParam0, int iParam1) // Position - 0x57B9
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL func_159(int iParam0, int iParam1) // Position - 0x57D2
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_160(int iParam0, int iParam1) // Position - 0x57EB
{
...
int func_161(int iParam0) // Position - 0x5826
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_162(int iParam0) // Position - 0x583A
{
	return;
}

BOOL func_163(int iParam0, int iParam1) // Position - 0x5842
{
	if (iParam0 == -1)
		return false;
...
BOOL func_164(int iParam0, BOOL bParam1) // Position - 0x5869
{
	if (func_45() != -1)
		return false;
...
BOOL func_165() // Position - 0x58C1
{
	...
	if (!func_167(Global_1051268) && Global_1572887.f_8 & true != 0)
		return true;

	return false;
}

struct<2> func_166() // Position - 0x5919
{
	return Global_1051268;
}

BOOL func_167(var uParam0, var uParam1) // Position - 0x5927
{
	if (!func_184(uParam0))
		return false;
...
struct<2> func_168() // Position - 0x595B
{
...
BOOL func_169(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x59A6
{
	var unk;
	float num;
	float num2;
...
BOOL func_170(int iParam0) // Position - 0x59D6
{
	if (iParam0 == 0)
		return false;
...
BOOL func_171(int iParam0) // Position - 0x59E9
{
	int num;
	int num2;
	int offset;
...
void func_172(var uParam0, int iParam1) // Position - 0x5A13
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_173(int iParam0) // Position - 0x5A28
{
	if (!func_87(iParam0))
		return false;
...
BOOL func_174(Hash hParam0) // Position - 0x5A4C
{
	return hParam0 != 0;
}

BOOL func_175(int iParam0) // Position - 0x5A58
{
	return iParam0 > -1 && iParam0 < 180;
}

BOOL func_176(int iParam0, BOOL bParam1) // Position - 0x5A6E
{
	if (!func_175(iParam0))
		return false;
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x5A94
{
	if (!func_175(iParam0))
		return;
...
void func_178(int iParam0, BOOL bParam1) // Position - 0x5AC2
{
	if (!func_175(iParam0))
		return;
...
void func_179(int iParam0) // Position - 0x5AFC
{
	func_189(func_188(iParam0));
	return;
}

BOOL func_180(int iParam0) // Position - 0x5B0E
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_181(Hash hParam0) // Position - 0x5B24
{
	if (func_190(hParam0))
...
BOOL func_182() // Position - 0x5B3F
{
	return 1;
}

BOOL func_183(BOOL bParam0, BOOL bParam1) // Position - 0x5B48
{
	return bParam0 && bParam1 != false;
}

BOOL func_184(int iParam0) // Position - 0x5B57
{
	switch (iParam0)
	{
		case 2:
...
int func_185(int iParam0) // Position - 0x5B96
{
	switch (iParam0)
	{
		case 2:
...
void func_186(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5C2C
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_187(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x66C9
{
	float num;
	float num2;
	float num3;
...
int func_188(int iParam0) // Position - 0x672F
{
...
void func_189(int iParam0) // Position - 0x6C4C
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_190(Hash hParam0) // Position - 0x6C5D
{
	return hParam0 != 0;
}
