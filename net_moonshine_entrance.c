...
void func_1(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x3E
{
...
BOOL func_2(BOOL bParam0, BOOL bParam1) // Position - 0x58
{
	int i;
...
int func_7(Player plParam0, BOOL bParam1) // Position - 0xBB4
{
	if (bParam1)
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0xC06
{
...
BOOL func_10(int iParam0, int iParam1) // Position - 0xC30
{
	int num;
...
void func_13(int iParam0) // Position - 0xE1E
{
	Volume volume;
	float Radius;
	...
	if (!flag)
	{
		...
		if (numberOfFiresInRange > 0)
			if (FIRE::GET_CLOSEST_FIRE_POS(&VecClosestFirePos, volumeCoords))
				if (VOLUME::IS_POINT_IN_VOLUME(volume, VecClosestFirePos))
					flag = true;
	}
...
BOOL func_14(int iParam0) // Position - 0xEE4
{
	return func_95(Global_1297441.f_157, iParam0);
}

void func_15(int iParam0) // Position - 0xEF8
{
	iLocal_19 = iParam0;
	return;
}

float func_16(int iParam0) // Position - 0xF04
{
	return Global_1297441.f_6.f_17[iParam0];
}

void func_17(Object* pobParam0) // Position - 0xF18
{
...
BOOL func_21(Player plParam0, int iParam1) // Position - 0x1255
{
	Player player;
...
BOOL func_23(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x13C7
{
	var data;
	int i;
	Hash crimeType;
...
void func_24(int iParam0, int iParam1) // Position - 0x14FC
{
	int i;
...
void func_25(BOOL bParam0) // Position - 0x15AE
{
	BOOL flag;
	int i;
...
BOOL func_26(BOOL bParam0) // Position - 0x1639
{
	Ped lastLedMount;
...
void func_27(BOOL bParam0) // Position - 0x178A
{
	int i;
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (i == 0 || i == 1)
		{
			if (func_127(iLocal_19.f_35[i /*4*/], false))
			{
				...
				{
					HUD::_0x8B55B324A9123F6B(iLocal_19.f_35[i /*4*/].f_3, iLocal_19.f_35[i /*4*/].f_2, MISC::VAR_STRING(10, "MS_ENTER_PROMPT_GROUP", func_129(PLAYER::GET_PLAYER_NAME(PlayerIndex), func_128(PlayerIndex, true, -1, false))), 3, 1, 0);
...
void func_32(var uParam0) // Position - 0x1B89
{
...
BOOL func_35() // Position - 0x1CD8
{
	char* StringToTest;
	char* StringToTest2;
	BOOL flag;

	StringToTest = func_141();

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return true;

	StringToTest2 = func_143(func_142());

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest2))
		return true;

	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_19.f_6))
		iLocal_19.f_6 = ANIMSCENE::_CREATE_ANIM_SCENE(StringToTest, 0, StringToTest2, false, true);
...
int func_37(BOOL bParam0, BOOL bParam1) // Position - 0x1E97
{
	int num;
	int instanceId;
...
BOOL func_43() // Position - 0x2511
{
	...
	{
		if (func_7(Plr, true) != iLocal_19.f_1)
			return true;
	
		if (func_144(Plr, true) != Global_1297600[Global_1295666 /*87*/].f_3)
			return true;
	}

	if (Plr != PLAYER::PLAYER_ID() && GANG::NETWORK_GET_GANG_ID(Plr) != Global_1295666.f_10 && Global_1297229.f_1 == 2 || Global_1297229.f_1 == 1)
	{
		iLocal_19.f_3 = 3;
		return true;
	}
...
void func_45(BOOL bParam0) // Position - 0x26F2
{
	if (bParam0)
	{
		if (!func_74(16384))
...
BOOL func_49() // Position - 0x279E
{
	return Global_1297229.f_1 != 1 && !func_22();
}

void func_50(int iParam0) // Position - 0x27B8
{
	Global_1297229.f_1 = iParam0;
	return;
}

BOOL func_51() // Position - 0x27C8
{
	Any gangId;
	var gamerHandle;
	Player playerFromGamerHandle;
...
BOOL func_57(BOOL bParam0) // Position - 0x29A4
{
...
void func_58(BOOL bParam0) // Position - 0x2A7A
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_33))
	{
		if (bParam0)
...
void func_62(int iParam0) // Position - 0x2CE1
{
	func_111(&(iLocal_19.f_5), iParam0);
	return;
}

void func_63(int iParam0) // Position - 0x2CF3
{
	func_111(&(Global_1297600[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*87*/].f_86), iParam0);
	return;
}

void func_64(int iParam0) // Position - 0x2D0D
{
...
void func_68(BOOL bParam0) // Position - 0x2F1E
{
	if (!bParam0)
		WEAPON::_HOLSTER_PED_WEAPONS(Global_33, false, false, false, true);
...
void func_70(BOOL bParam0) // Position - 0x302D
{
	func_6(16);
	func_64(1);
...
void func_71(Player plParam0) // Position - 0x3066
{
	Global_1297229.f_200 = plParam0;
	return;
}

void func_72() // Position - 0x3076
{
	int i;
...
BOOL func_74(int iParam0) // Position - 0x3127
{
	return func_95(iLocal_19.f_5, iParam0);
}

void func_75(int iParam0) // Position - 0x3139
{
	func_79(&(iLocal_19.f_5), iParam0);
	return;
}

void func_76(Object* pobParam0) // Position - 0x314B
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
...
BOOL func_77(int iParam0, int iParam1) // Position - 0x3188
{
	return MISC::IS_BIT_SET(Global_1072759.f_22475.f_417[iParam0 /*12*/], iParam1);
}

void func_78(int iParam0, int iParam1, BOOL bParam2) // Position - 0x31A4
{
...
void func_79(int iParam0, int iParam1) // Position - 0x320B
{
	func_175(iParam0, iParam1);
	return;
}

BOOL func_80(Any* panParam0, int iParam1, int iParam2) // Position - 0x321B
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_81() // Position - 0x3252
{
	return Global_1102813.f_3672;
}

BOOL func_82(int iParam0) // Position - 0x3261
{
	int num;
	int num2;
	int offset;
...
void func_83(int iParam0, BOOL bParam1) // Position - 0x328B
{
	int num;
	int num2;
...
void func_84(int iParam0) // Position - 0x32B8
{
	iLocal_19.f_97 = iParam0;
	return;
}

BOOL func_85() // Position - 0x32C6
{
	Ped playerPed;
...
struct<2> func_86() // Position - 0x3325
{
...
BOOL func_87(var uParam0, var uParam1) // Position - 0x3370
{
	if (!func_179(uParam0))
		return false;
...
BOOL func_88(int iParam0) // Position - 0x33A4
{
	return func_120(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), iLocal_19.f_94[func_90(iParam0)], true, 0);
}

void func_89(int iParam0, int iParam1) // Position - 0x33C6
{
...
int func_90(int iParam0) // Position - 0x340A
{
	switch (iParam0)
	{
...
BOOL func_91(var uParam0) // Position - 0x342F
{
	return func_181(*uParam0, 1);
}

BOOL func_92(var uParam0, float fParam1) // Position - 0x343F
{
...
float func_93(float fParam0, float fParam1) // Position - 0x345D
{
	if (fParam0 > fParam1)
		return fParam0;
...
void func_94(var uParam0) // Position - 0x3474
{
	func_184(uParam0, 0f);
	return;
}

BOOL func_95(int iParam0, int iParam1) // Position - 0x3483
{
	return iParam0 && iParam1 != false;
}

Player func_96() // Position - 0x3492
{
	return Global_1297229.f_200;
}

BOOL func_97(Player plParam0, BOOL bParam1) // Position - 0x34A0
{
	Player player;
...
BOOL func_99(int iParam0) // Position - 0x3517
{
	return iParam0 > -1 && iParam0 < 5;
}

Hash func_100(int iParam0, int iParam1, BOOL bParam2) // Position - 0x352C
{
	Hash hash;
...
Entity func_101(Hash hParam0, int iParam1, BOOL bParam2) // Position - 0x36EC
{
	Entity EntityIndex;

	EntityIndex = func_187(hParam0, iParam1);
	...
	if (ENTITY::IS_ENTITY_DEAD(EntityIndex) && !bParam2)
		return 0;

	return EntityIndex;
}

void func_102() // Position - 0x3731
{
	int i;
...
BOOL func_104(int iParam0, var uParam1, var uParam2) // Position - 0x38D5
{
	Any* p_any;
	var unk5;
	var unk10;
...
BOOL func_105(int iParam0) // Position - 0x3977
{
	if (iParam0 < 0)
		return false;
...
char* func_106(int iParam0, BOOL bParam1) // Position - 0x39B6
{
	char* str;
...
int func_107(char* sParam0, Hash hParam1, Volume volParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, Hash hParam12, int iParam13) // Position - 0x3A26
{
	int i;
	int num;
...
void func_108(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3AE6
{
	int num;
...
void func_109(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3B2F
{
	int num;
...
BOOL func_110() // Position - 0x3B83
{
	return Global_1295658.f_2.f_1 == 2 || Global_1295658.f_2.f_1 == 1;
}

void func_111(int iParam0, int iParam1) // Position - 0x3BA5
{
	func_197(iParam0, iParam1);
	return;
}

struct<2> func_112(int iParam0) // Position - 0x3BB5
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

BOOL func_113(BOOL bParam0) // Position - 0x3BC9
{
	if (bParam0)
...
int func_114(int iParam0, Player plParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3BF9
{
	int i;
...
BOOL func_115(int iParam0) // Position - 0x3C6E
{
	return iParam0 >= 0 && iParam0 <= 12;
}

BOOL func_116() // Position - 0x3C84
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

BOOL func_117(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3CA9
{
...
BOOL func_118() // Position - 0x3D47
{
	return func_10(1, 255);
}

BOOL func_119() // Position - 0x3D56
{
	int currentMessage;
...
BOOL func_120(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x3D76
{
...
int func_121(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x3DAC
{
	int num;
	var unk13;
	int num2;
...
BOOL func_122(int iParam0, BOOL bParam1) // Position - 0x3DE7
{
	int num;
...
BOOL func_123(int iParam0) // Position - 0x3E1A
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_125(var uParam0, var uParam1) // Position - 0x3E66
{
	return NETWORK::NETWORK_IS_HANDLE_VALID(&uParam0);
}

BOOL func_126(int iParam0, Player plParam1) // Position - 0x3E74
{
	if (plParam1 == 255)
...
BOOL func_127(int iParam0, BOOL bParam1) // Position - 0x3EA0
{
	if (bParam1 && !func_105(iParam0))
		return false;
...
int func_128(Player plParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x3EC5
{
	BOOL flag;
	BOOL isBitSet;
	Player player;
...
const char* func_129(const char* sParam0, int iParam1) // Position - 0x411A
{
...
Prompt func_130(int iParam0) // Position - 0x4158
{
	int num;
...
BOOL func_131(int iParam0, BOOL bParam1) // Position - 0x4188
{
	int num;
	int gameTimer;
	float progress;
...
void func_133(int iParam0) // Position - 0x42BB
{
...
void func_136(BOOL bParam0) // Position - 0x4340
{
	if (func_124())
		Global_1958683 = true;
...
BOOL func_137() // Position - 0x43A3
{
	return Global_1896762.f_352;
}

void func_138() // Position - 0x43B2
{
	func_213(false);
	return;
}

BOOL func_139(int iParam0) // Position - 0x43BF
{
	return func_10(1, iParam0);
}

Vector3 func_140(float fParam0) // Position - 0x43CE
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

char* func_141() // Position - 0x43E4
{
	char* str;
...
char* func_143(int iParam0) // Position - 0x4478
{
	char* str;
	BOOL flag;
	BOOL flag2;
...
int func_144(Player plParam0, BOOL bParam1) // Position - 0x4549
{
	if (bParam1)
		if (!NETWORK::NETWORK_IS_PLAYER_INDEX_VALID(plParam0))
			return -1;
...
BOOL func_145(Ped pedParam0) // Position - 0x456C
{
	return func_216(pedParam0, -1);
}

BOOL func_146(Entity eParam0) // Position - 0x457B
{
...
Vector3 func_147() // Position - 0x459E
{
	var unk;
	BOOL flag;
	BOOL flag2;
...
Vector3 func_148() // Position - 0x474F
{
	BOOL flag;
	var unk;
...
char* func_150(int iParam0, BOOL bParam1) // Position - 0x4892
{
	char* str;
...
void func_151(int iParam0) // Position - 0x496F
{
	iLocal_19.f_4 = iParam0;
	return;
}

void func_152(BOOL bParam0) // Position - 0x497D
{
	if (bParam0)
	{
		if (!func_74(2))
...
BOOL func_154() // Position - 0x4A38
{
	return Global_1108965.f_775.f_28 != -1;
}

void func_155(Hash hParam0, float fParam1, BOOL bParam2) // Position - 0x4A4B
{
...
void func_159(BOOL bParam0) // Position - 0x4AC6
{
	UIFEED::UI_FEED_CLEAR_CHANNEL(1, bParam0, false);
	return;
}

Vector3 func_160(int iParam0) // Position - 0x4AD6
{
	return Global_1297441.f_6.f_1[iParam0 /*3*/];
}

int func_161(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x4AEC
{
...
void func_162(BOOL bParam0) // Position - 0x4B73
{
	if (!bParam0)
		func_227(18);
	else
...
void func_163(BOOL bParam0) // Position - 0x4B92
{
	if (!bParam0)
		func_227(19);
	else
...
void func_164(BOOL bParam0) // Position - 0x4BB1
{
	if (bParam0)
		func_165(133);
	else
...
int func_165(int iParam0) // Position - 0x4BCF
{
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0x4BEC
{
	if (func_224(255) == 4)
		return;
...
void func_167(BOOL bParam0, int iParam1) // Position - 0x4D37
{
	int num;
	BOOL flag;
	BOOL flag2;
...
void func_168(BOOL bParam0, BOOL bParam1) // Position - 0x4DAB
{
	if (bParam0)
		func_236(49);
...
Vector3 func_169(int iParam0, int iParam1) // Position - 0x4DDA
{
	var unk;
...
float func_170(int iParam0, int iParam1) // Position - 0x4E31
{
	float num;
...
void func_171(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0x4E7C
{
	var entityCoords;
	float num;
...
void func_172(int iParam0) // Position - 0x4ED7
{
	if (iParam0 == 0)
...
void func_173(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4F36
{
	int num;
...
void func_174() // Position - 0x4F8A
{
	SCRIPTS::_SET_ALL_PLAYER_BITS(&(Global_1072759.f_21353.f_260));
	return;
}

void func_175(int iParam0, int iParam1) // Position - 0x4FA0
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_176(int iParam0, var uParam1, var uParam2) // Position - 0x4FB5
{
	int num;
...
BOOL func_177(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4FD1
{
	if (iParam1 < 0 || iParam1 > 32)
		return false;
...
void func_178(int iParam0, int iParam1) // Position - 0x5073
{
	int Variable;
...
BOOL func_179(int iParam0) // Position - 0x5097
{
	switch (iParam0)
	{
		case 2:
...
int func_180(int iParam0) // Position - 0x50D6
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_181(int iParam0, int iParam1) // Position - 0x516C
{
	return iParam0 && iParam1 != false;
}

BOOL func_182(var uParam0, float fParam1) // Position - 0x517B
{
	if (!func_91(uParam0))
		return false;
...
void func_183(var uParam0) // Position - 0x51A2
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_184(var uParam0, float fParam1) // Position - 0x51B8
{
...
BOOL func_185(int iParam0) // Position - 0x51DE
{
	return iParam0 > -1 && iParam0 <= 32;
}

BOOL func_186() // Position - 0x51F4
{
	int num;
...
Entity func_187(Hash hParam0, int iParam1) // Position - 0x5237
{
...
int func_188(int iParam0) // Position - 0x526D
{
	switch (iParam0)
	{
		case 0:
...
int func_189(int iParam0) // Position - 0x52C8
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_190(int iParam0, int iParam1) // Position - 0x52F5
{
	if (iParam0 < 0)
		return false;
...
int func_192(int iParam0) // Position - 0x5630
{
	return iParam0;
}

void func_193(int iParam0, int iParam1) // Position - 0x563A
{
	if (iParam0 < 0)
		return;
...
void func_194(int iParam0, BOOL bParam1) // Position - 0x566D
{
...
void func_195(int iParam0, BOOL bParam1) // Position - 0x56C5
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_196(int iParam0, int iParam1) // Position - 0x56EE
{
	if (iParam0 < 0)
		return;
...
void func_197(var uParam0, int iParam1) // Position - 0x5716
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_198(int iParam0, int iParam1, Player plParam2) // Position - 0x5727
{
	if (plParam2 == 255)
...
BOOL func_199(var uParam0, var uParam1) // Position - 0x575C
{
	int num;
...
int func_200(int iParam0, var uParam1) // Position - 0x577C
{
	return iParam0;
}

int func_201(Player plParam0) // Position - 0x5786
{
...
int func_202(Player plParam0) // Position - 0x581D
{
...
int func_203(Player plParam0, BOOL bParam1) // Position - 0x584C
{
	int num;
	int num2;
	int num3;
...
BOOL func_204(Player plParam0, BOOL bParam1) // Position - 0x5919
{
	Player bitIndex;
	int playerTeam;
	int playerTeam2;
...
BOOL func_205(Player plParam0, BOOL bParam1) // Position - 0x5A1B
{
	Player bitIndex;
...
BOOL func_206(Player plParam0, BOOL bParam1) // Position - 0x5AA5
{
	Player bitIndex;
...
int func_207(var uParam0, var uParam1) // Position - 0x5B47
{
	var unk;
...
int func_208(int iParam0, int iParam1) // Position - 0x5B73
{
	switch (iParam0)
	{
		case 0:
...
const char* func_209(const char* sParam0, int iParam1) // Position - 0x5BCA
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_210(Any* panParam0) // Position - 0x5BE4
{
	var playerBits;
...
void func_211(BOOL bParam0, int iParam1) // Position - 0x5C17
{
	if (bParam0)
	{
		Global_1940252 = 1;
...
BOOL func_212(Hash hParam0) // Position - 0x5C39
{
	int i;
...
void func_213(BOOL bParam0) // Position - 0x5C79
{
	if (bParam0)
...
BOOL func_214() // Position - 0x5CB0
{
	return Global_1940026 == 2;
}

BOOL func_215() // Position - 0x5CBE
{
	return Global_1940026 == 1;
}

BOOL func_216(Ped pedParam0, int iParam1) // Position - 0x5CCC
{
	var unk;
	int num;
...
void func_217(int iParam0, int iParam1) // Position - 0x5D0B
{
...
Hash func_218(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5D29
{
...
BOOL func_219(Hash hParam0) // Position - 0x5DCD
{
	if (func_265(hParam0))
...
BOOL func_220(int iParam0, int iParam1) // Position - 0x5DE8
{
	if (iParam1 == 255)
...
void func_221(int iParam0) // Position - 0x5E22
{
	func_266(3, iParam0);
	return;
}

BOOL func_222(int iParam0, int iParam1) // Position - 0x5E31
{
	if (iParam1 == 255)
		iParam1 = PLAYER::NETWORK_PLAYER_ID_TO_INT();
...
void func_223(int iParam0) // Position - 0x5E6B
{
	func_266(2, iParam0);
	return;
}

int func_224(int iParam0) // Position - 0x5E7A
{
	if (iParam0 == 255)
...
void func_225(var uParam0) // Position - 0x5EC5
{
	var unk;
...
void func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x5ED7
{
	switch (uParam0.f_5)
	{
		case 1:
...
int func_227(int iParam0) // Position - 0x5F04
{
...
BOOL func_228(Any* panParam0, int iParam1, int iParam2) // Position - 0x5F21
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_229(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x5F54
{
	func_268(iParam0);
...
void func_230(var uParam0) // Position - 0x5FB6
{
	var unk;
...
void func_231(float* pfParam0) // Position - 0x5FC8
{
	var unk;
...
void func_233(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x6030
{
	switch (uParam0.f_5)
	{
		case 1:
...
void func_234(int iParam0) // Position - 0x605D
{
	Player iPlayerIndex;
	Ped EntityIndex;
	BOOL flag;
...
void func_235(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x610F
{
	Player iPlayerIndex;
	Ped PedIndex;
...
void func_236(int iParam0) // Position - 0x6231
{
	int num;
	int BitIndex;
...
void func_237(int iParam0) // Position - 0x6265
{
	int num;
	int BitIndex;
...
int func_238(int iParam0) // Position - 0x6299
{
	switch (iParam0)
	{
		case 0:
...
void func_239(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x62F4
{
	func_276();
...
BOOL func_240(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0x6328
{
	Hash* p_hash;
	int MaxInt;
	int randomIntInRange;

	p_hash = Global_1072759.f_23824.f_383[func_277(uParam0) /*272*/];
	MaxInt = func_278(p_hash);
	...
	else
	{
		...
		if (func_279(p_hash, randomIntInRange, pvParam3, pfParam4))
			return true;
	}
...
void func_241(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, var uParam6, float fParam7, float fParam8, float fParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13) // Position - 0x6379
{
	if (func_224(255) == 4)
		return;
...
void func_242(int iParam0) // Position - 0x654E
{
	if (!func_280(iParam0))
		return;
...
BOOL func_243(int iParam0, int iParam1) // Position - 0x6601
{
	return MISC::IS_BIT_SET(Global_17418.f_2585[iParam0], iParam1);
}

BOOL func_244(int iParam0) // Position - 0x6619
{
...
BOOL func_245(int iParam0) // Position - 0x6630
{
	int i;
	int cloudTimeAsInt;
	int num;
...
BOOL func_246(int iParam0, int iParam1) // Position - 0x66FC
{
	return Global_1904402.f_33[iParam0 /*9*/].f_2 && iParam1 != false;
}

BOOL func_247(int iParam0) // Position - 0x6715
{
	return Global_1572864.f_3 && iParam0 != false;
}

BOOL func_248() // Position - 0x6728
{
	if (!func_281())
		return false;
...
float func_249(var uParam0) // Position - 0x6743
{
	if (!func_91(uParam0))
		return uParam0->f_1;
...
float func_250() // Position - 0x6778
{
...
void func_251(var uParam0, int iParam1) // Position - 0x67AA
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_252(var uParam0, int iParam1) // Position - 0x67BB
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_253(int iParam0) // Position - 0x67D0
{
	return iParam0 >= 0 && iParam0 <= 12;
}

BOOL func_254(BOOL bParam0, BOOL bParam1) // Position - 0x67E6
{
	return bParam0 && bParam1 != false;
}

int func_255(var uParam0, var uParam1) // Position - 0x67F5
{
	int num;
...
float func_257(Player plParam0, BOOL bParam1) // Position - 0x6888
{
	Player player;
...
BOOL func_258(Player plParam0) // Position - 0x6928
{
...
BOOL func_259(Player plParam0) // Position - 0x6945
{
...
BOOL func_260(Player plParam0) // Position - 0x6962
{
...
BOOL func_261(Player plParam0) // Position - 0x697F
{
	if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0))
	{
		func_284(plParam0);
...
BOOL func_262(int iParam0, var uParam1, Any* panParam2) // Position - 0x69E3
{
	if (!func_87(iParam0))
		return false;
...
var func_263(int iParam0, int iParam1) // Position - 0x6AEE
{
	return func_287(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

void func_264(int iParam0) // Position - 0x6B0C
{
	var unk;
...
BOOL func_265(Hash hParam0) // Position - 0x6B6C
{
	return hParam0 != 0;
}

void func_266(int iParam0, int iParam1) // Position - 0x6B78
{
	int data;
	var value;
	Player Plr;
...
BOOL func_267(Any* panParam0, int iParam1, int iParam2) // Position - 0x6C9C
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_273(BOOL bParam0) // Position - 0x6D6B
{
	if (func_288(bParam0))
		return;
...
BOOL func_275(int iParam0) // Position - 0x6DC1
{
...
int func_277(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x6E1F
{
	int i;
	int num;
	float num2;
...
int func_278(Hash* phParam0) // Position - 0x6E7C
{
	Any any;
...
BOOL func_279(Hash* phParam0, int iParam1, Vector3* pvParam2, float* pfParam3) // Position - 0x6EA8
{
	Any any;
...
BOOL func_280(int iParam0) // Position - 0x6F0A
{
	return func_190(iParam0, 2);
}

BOOL func_281() // Position - 0x6F19
{
...
BOOL func_282(var uParam0) // Position - 0x6F2D
{
	return func_181(*uParam0, 2);
}

int func_283(var uParam0, var uParam1) // Position - 0x6F3D
{
	var unk;
	var unk4;
	int num;
...
void func_284(Player plParam0) // Position - 0x6FE4
{
	Player player;
...
void func_285(Player plParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5) // Position - 0x7050
{
	Player player;
	int num;
	Player i;
		...
		for (i = 0; i <= 31; i = i + 1)
		{
			...
			if (i != Global_1295666 && NETWORK::NETWORK_IS_PLAYER_ACTIVE(Plr))
			{
				...
				else if (GANG::NETWORK_IS_IN_SAME_GANG(Plr, plParam0))
				{
					...
					if (i != player)
						func_285(Plr, iParam1, 0, true, false, 0);
				}
			}
		}
...
void func_286(Any* panParam0) // Position - 0x718B
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
var func_287(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x71A1
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_294(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
BOOL func_288(BOOL bParam0) // Position - 0x7534
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

void func_289(Player plParam0) // Position - 0x754A
{
...
BOOL func_290(Player plParam0, int iParam1, int iParam2) // Position - 0x7585
{
...
void func_291(Any* panParam0, var uParam1) // Position - 0x7616
{
...
int func_292() // Position - 0x7656
{
	return Global_1051645.f_12;
}

char* func_293() // Position - 0x7664
{
	return "unnamed";
}

BOOL func_294(int iParam0) // Position - 0x7670
{
	int num;
...
BOOL func_295(int iParam0) // Position - 0x76FF
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_296(Player plParam0) // Position - 0x771D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
void func_297(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x7762
{
	return;
}

void func_298(Player plParam0) // Position - 0x776A
{
	Player player;
