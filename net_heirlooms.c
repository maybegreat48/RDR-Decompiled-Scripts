...
int func_2() // Position - 0x181
{
	return Global_1572887.f_14;
}

struct<2> func_3(int iParam0) // Position - 0x18F
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_4(int iParam0, var uParam1) // Position - 0x1A3
{
	return iParam0;
}

void func_5(var uParam0) // Position - 0x1AD
{
...
BOOL func_6(var uParam0) // Position - 0x249
{
...
BOOL func_7() // Position - 0x263
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x26C
{
	BOOL flag;
	BOOL flag2;
...
int func_9(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xCA4
{
	int num;
	int num2;
	int scenario;
...
int func_10(var uParam0) // Position - 0xF5F
{
	int num;
...
void func_11(var uParam0) // Position - 0x1023
{
	switch (uParam0->f_1)
	{
		case 30:
...
BOOL func_13(var uParam0, int iParam1) // Position - 0x10D9
{
	return func_49(uParam0->f_15, iParam1);
}

void func_14(var uParam0, int iParam1) // Position - 0x10EB
{
...
int func_15(var uParam0) // Position - 0x110B
{
	int num;
...
int func_16(int iParam0) // Position - 0x1305
{
	switch (iParam0)
	{
...
void func_17(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1810
{
...
void func_18(var uParam0, var uParam1) // Position - 0x1847
{
	Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_1 = uParam0;
	return;
}

int func_19(BOOL bParam0) // Position - 0x185D
{
	int MaxInt;
	int randomIntInRange;
...
BOOL func_21(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1938
{
	return !PERSISTENCE::_PERSISTENCE_IS_SCENARIO_MARKED_AS_LOOTED_AT_COORDS(vParam0);
}

BOOL func_22() // Position - 0x1949
{
	int i;
	Player Plr;
	Player player;
...
void func_23(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x19D7
{
	int num;
...
void func_24(var uParam0) // Position - 0x1A2B
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_26))
...
void func_25(var uParam0, var uParam1, var uParam2) // Position - 0x1A4C
{
...
void func_26(var uParam0, var uParam1, BOOL bParam2) // Position - 0x1A6E
{
	var value;
	int num;
	int num2;
...
void func_27(int iParam0, int iParam1, int iParam2) // Position - 0x1B3E
{
	func_79(&Global_1222327[iParam0 /*251*/][iParam1], iParam2);
	return;
}

void func_28() // Position - 0x1B58
{
...
void func_30(var uParam0) // Position - 0x1BD2
{
	func_80(uParam0);
...
void func_31(BOOL bParam0) // Position - 0x1BE9
{
	if (bParam0)
		func_82(0, 6);
	else
...
void func_32(var uParam0) // Position - 0x1C06
{
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_7))
...
BOOL func_33(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1C21
{
...
BOOL func_34(var uParam0) // Position - 0x1C7C
{
	if (!func_13(uParam0, 32))
...
int func_35(var uParam0) // Position - 0x1CCC
{
	return uParam0->f_2;
}

BOOL func_36(int iParam0, int iParam1, int iParam2) // Position - 0x1CD8
{
	return func_49(Global_1222327[iParam0 /*251*/][iParam1], iParam2);
}

BOOL func_37(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6, int iParam7) // Position - 0x1CF2
{
	var unk;
	var unk3;
	var unk5;
...
void func_38(int iParam0, int iParam1, int iParam2) // Position - 0x1F85
{
	func_70(&Global_1222327[iParam0 /*251*/][iParam1], iParam2);
	return;
}

BOOL func_39(int iParam0) // Position - 0x1F9F
{
	int i;
	Player Plr;
	float num;
	...
	if (num > 0f)
	{
		...
		{
			if (!func_49(Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 1))
				func_70(&Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 1);
		
			return true;
		}
	
		if (!func_49(Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 32))
			func_70(&Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 32);
	}

	return false;
}

void func_40(var uParam0, int iParam1) // Position - 0x2114
{
	uParam0->f_2 = iParam1;
	return;
}

BOOL func_41(int iParam0) // Position - 0x2122
{
	if (iParam0 < 0)
		return false;
...
BOOL func_42(int iParam0, BOOL bParam1) // Position - 0x2161
{
	int num;
...
BOOL func_43(BOOL bParam0) // Position - 0x2194
{
...
void func_44(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x21C7
{
	if (!func_21(vParam1))
	{
		func_25(vParam1);
...
void func_45(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x223C
{
	BOOL flag;
	BOOL flag2;
	float num;
...
void func_46(int iParam0) // Position - 0x2465
{
...
void func_47(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2563
{
...
void func_48(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x25BB
{
	if (!func_98(iParam0))
	{
...
BOOL func_49(int iParam0, int iParam1) // Position - 0x25EF
{
	return iParam0 && iParam1 != false;
}

BOOL func_50(var uParam0, const char* sParam1, char* sParam2, Vector3 vParam3, var uParam4, var uParam5, Object obParam6, Hash hParam7, Object obParam8, Hash hParam9, Object obParam10, Hash hParam11, BOOL bParam12) // Position - 0x25FE
{
	if (bParam12)
	{
...
Vector3 func_51(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x27A6
{
	var unk;
	float X;
	float num;
	...
	unk = { func_99(uParam0) };
	X = { func_101(func_101(unk, func_100(iParam3 - 90f)), unk) };
	num = MISC::ATAN2(X.f_1, X);
	num2 = -MISC::ATAN2(X.f_2, BUILTIN::SQRT((X * X) + (X.f_1 * X.f_1)));
	vector = { -X.f_1, X, 0f };
	vector2 = { func_101(vector, X) };
	num3 = MISC::ATAN2(func_102(vector, unk) / BUILTIN::VMAG(vector), func_102(vector2, unk) / BUILTIN::VMAG(vector2)) + 180f;
	return num3, num2, num;
}

int func_52(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x285C
{
	int i;
...
BOOL func_53(var uParam0, int iParam1) // Position - 0x290C
{
	if (func_86(joaat("kit_collector_spade"), 1))
	{
...
int func_54(char* sParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, Hash hParam15, int iParam16) // Position - 0x29A7
{
	int i;
	int num;
	int num2;
...
void func_55(int iParam0, var uParam1) // Position - 0x2A85
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
BOOL func_56(int iParam0, BOOL bParam1) // Position - 0x2AC6
{
	int num;
	int gameTimer;
	float progress;
...
void func_57(Ped pedParam0) // Position - 0x2BC0
{
	Entity firstEntityPedIsCarrying;
...
float func_58(int iParam0, BOOL bParam1) // Position - 0x2C02
{
	int num;
...
float func_60(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x2C83
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
void func_61(float fParam0) // Position - 0x2CAB
{
	if (!Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_4)
	{
...
int func_62(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x2CEF
{
...
float func_63(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x2D15
{
	float num;
	float Y;
	float X;
...
BOOL func_65(var uParam0) // Position - 0x2D9E
{
	var unk;
	int i;
	int num;
...
void func_66(int iParam0) // Position - 0x2E2F
{
...
void func_67(BOOL bParam0, BOOL bParam1) // Position - 0x2E49
{
	if (bParam1)
...
int func_69(Hash hParam0) // Position - 0x2F09
{
	var unk;
...
void func_70(int iParam0, int iParam1) // Position - 0x2F25
{
	func_112(iParam0, iParam1);
	return;
}

int func_71(int iParam0) // Position - 0x2F35
{
	return iParam0;
}

void func_72(int iParam0) // Position - 0x2F3F
{
	if (!func_113(iParam0))
		return;
...
int func_73(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x2FF2
{
	int i;
	var SourceStruct;
...
BOOL func_74(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x309C
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

var func_75(int iParam0, int iParam1) // Position - 0x30C5
{
	return func_76(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

var func_76(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x30E3
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_116(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
void func_78(Any* panParam0, int* piParam1) // Position - 0x3510
{
...
void func_79(int iParam0, int iParam1) // Position - 0x3541
{
	func_121(iParam0, iParam1);
	return;
}

void func_80(var uParam0) // Position - 0x3551
{
	if (uParam0->f_4 != -1)
	{
...
void func_81(int iParam0, int iParam1) // Position - 0x3584
{
	if (func_98(iParam0))
...
void func_82(int iParam0, int iParam1) // Position - 0x359D
{
...
void func_83(int iParam0, int iParam1, BOOL bParam2) // Position - 0x35E1
{
...
float func_84(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x3648
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
int func_85(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5, int iParam6) // Position - 0x3666
{
	Volume volume;
	int num;
...
BOOL func_86(Hash hParam0, int iParam1) // Position - 0x3697
{
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x371A
{
...
BOOL func_88(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3744
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_89() // Position - 0x3843
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_90(var uParam0, int iParam1) // Position - 0x3858
{
	*uParam0 = iParam1;
	return;
}

void func_91(int iParam0) // Position - 0x3865
{
	if (iParam0 <= 0)
		return;
...
void func_92(var uParam0) // Position - 0x388C
{
	func_134(uParam0, 0f);
	return;
}

float func_93(var uParam0) // Position - 0x389B
{
	if (!func_135(uParam0))
		return uParam0->f_1;
...
BOOL func_95(Ped pedParam0) // Position - 0x3935
{
...
BOOL func_96(int iParam0, BOOL bParam1) // Position - 0x397F
{
	if (bParam1 && !func_41(iParam0))
		return false;
...
void func_97(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x39A4
{
	int num;
...
BOOL func_98(int iParam0) // Position - 0x39F8
{
	if (*iParam0 == 0)
		return false;
...
Vector3 func_99(float fParam0, var uParam1, var uParam2) // Position - 0x3A10
{
	float num;
	float num2;
...
Vector3 func_100(float fParam0) // Position - 0x3A4F
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Vector3 func_101(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x3A65
{
...
float func_102(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x3A9E
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

BOOL func_103(Entity eParam0) // Position - 0x3ABF
{
	int num;
	var InputString;
	Hash entityModel;
...
BOOL func_104(Hash hParam0) // Position - 0x3B59
{
	var unk;
...
BOOL func_105(int iParam0, int iParam1) // Position - 0x3B80
{
	if (iParam0 < 0)
		return false;
...
BOOL func_106(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x3BA1
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_108(int iParam0, Any anParam1) // Position - 0x3F10
{
	var unk;
...
struct<2> func_109(int iParam0, int iParam1) // Position - 0x3F39
{
	int num;
...
void func_110(var uParam0, var uParam1, int iParam2) // Position - 0x3F4F
{
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x3F6C
{
	var unk;
	var unk13;
	var unk26;
...
void func_112(var uParam0, int iParam1) // Position - 0x3F9C
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_113(int iParam0) // Position - 0x3FAD
{
	return func_105(iParam0, 2);
}

int func_114() // Position - 0x3FBC
{
	return Global_1051645.f_12;
}

char* func_115() // Position - 0x3FCA
{
	return "unnamed";
}

BOOL func_116(int iParam0) // Position - 0x3FD5
{
	int num;
...
BOOL func_117(int iParam0) // Position - 0x4085
{
...
int func_118(int iParam0) // Position - 0x40A3
{
	if (iParam0 == 255)
...
BOOL func_119(Player plParam0) // Position - 0x40EE
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
int func_120(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x4133
{
	if (!func_157(uParam0))
		return 0;
...
void func_121(int iParam0, int iParam1) // Position - 0x4163
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_122(int iParam0, int iParam1) // Position - 0x4178
{
	return MISC::IS_BIT_SET(Global_1072759.f_22475.f_417[iParam0 /*12*/], iParam1);
}

void func_123() // Position - 0x4194
{
	SCRIPTS::_SET_ALL_PLAYER_BITS(&(Global_1072759.f_21353.f_260));
	return;
}

int func_124(var uParam0, var uParam1, Volume volParam2, int iParam3) // Position - 0x41AA
{
	ItemSet itemSet;
...
void func_125(Volume volParam0) // Position - 0x4265
{
...
BOOL func_126(Hash hParam0, int iParam1) // Position - 0x427C
{
	if (hParam0 == 0)
		return false;
...
int func_127(Hash hParam0) // Position - 0x4296
{
	var unk;
...
BOOL func_128(Hash hParam0, int iParam1) // Position - 0x42C1
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_129(Hash hParam0) // Position - 0x4368
{
	int num;
	int num2;
	int num3;
...
int func_130(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4424
{
...
BOOL func_131(BOOL bParam0) // Position - 0x44E6
{
	if (bParam0)
...
BOOL func_132() // Position - 0x4516
{
	return func_171() != -1;
}

BOOL func_133() // Position - 0x4524
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_134(var uParam0, float fParam1) // Position - 0x4549
{
...
BOOL func_135(var uParam0) // Position - 0x456F
{
	return func_174(*uParam0, 1);
}

BOOL func_136(var uParam0) // Position - 0x457F
{
	return func_174(*uParam0, 2);
}

float func_137() // Position - 0x458F
{
...
BOOL func_138(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x45C1
{
...
BOOL func_139(Ped pedParam0) // Position - 0x45EA
{
	return func_175(pedParam0, 0);
}

BOOL func_140(Ped pedParam0) // Position - 0x45F9
{
	return func_175(pedParam0, 3);
}

BOOL func_141(Ped pedParam0) // Position - 0x4608
{
	return func_175(pedParam0, 4) || func_175(pedParam0, 5);
}

BOOL func_142(Ped pedParam0) // Position - 0x4624
{
	return func_175(pedParam0, 6);
}

BOOL func_143(Ped pedParam0) // Position - 0x4633
{
	return func_175(pedParam0, 7);
}

void func_144(int iParam0, int iParam1) // Position - 0x4642
{
	if (iParam0 < 0)
		return;
...
void func_145(int iParam0, BOOL bParam1) // Position - 0x4675
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_146(int iParam0, BOOL bParam1) // Position - 0x46CD
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_147(int iParam0, int iParam1) // Position - 0x46F6
{
	if (iParam0 < 0)
		return;
...
int func_148() // Position - 0x471E
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

struct<4> func_149(BOOL bParam0) // Position - 0x4733
{
	int num;
...
BOOL func_150(Hash hParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x47D3
{
	var unk;
	var unk5;
	int num;
...
void func_151(var uParam0, int iParam1) // Position - 0x4907
{
	BOOL flag;
	int i;
...
BOOL func_152(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x4A33
{
	var unk;
	int num;
...
int func_153(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x4AA2
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_154(int iParam0, int iParam1) // Position - 0x4B83
{
	int num;
...
BOOL func_155(Player plParam0) // Position - 0x4BF7
{
...
void func_156(Player plParam0) // Position - 0x4C14
{
	Player player;
...
BOOL func_157(var uParam0) // Position - 0x4C97
{
	if (*uParam0 >= 40)
		return false;
...
Hash func_158(Hash hParam0, int iParam1) // Position - 0x4CAC
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_159(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x4D26
{
...
BOOL func_160(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4D4D
{
	if (iParam2 < 0)
		return false;
...
BOOL func_161(Hash hParam0) // Position - 0x4D88
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_162(int iParam0) // Position - 0x4DA3
{
	if (iParam0 < 0)
		return 0;
...
int func_163(Hash hParam0) // Position - 0x4DC4
{
	var unk;
...
int func_164(Hash hParam0) // Position - 0x4DEF
{
	switch (hParam0)
	{
...
int func_165(var uParam0, int iParam1) // Position - 0x4ED2
{
	int i;
...
int func_166(Hash hParam0) // Position - 0x4F0F
{
	int num;
...
int func_167(Hash hParam0, BOOL bParam1) // Position - 0x4F7C
{
	var unk;
	int num;
	int num2;
...
int func_168(Hash hParam0, int iParam1) // Position - 0x4FDB
{
	if (iParam1 == 0)
		return 0;
...
int func_169(BOOL bParam0) // Position - 0x5007
{
	if (func_2() == -1)
	{
...
struct<4> func_170(Hash hParam0, BOOL bParam1) // Position - 0x5048
{
	var unk;
...
int func_171() // Position - 0x506D
{
	return Global_1149172.f_137;
}

void func_172(var uParam0, int iParam1) // Position - 0x507B
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_173(var uParam0, int iParam1) // Position - 0x508C
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_174(int iParam0, int iParam1) // Position - 0x50A1
{
	return iParam0 && iParam1 != false;
}

BOOL func_175(Ped pedParam0, int iParam1) // Position - 0x50B0
{
	var unk;
	int num;
...
struct<4> func_176() // Position - 0x50EF
{
	var unk;
...
struct<4> func_177(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x50FB
{
	var outGuid;
...
int func_178(var uParam0) // Position - 0x512C
{
...
Hash func_179(Hash hParam0) // Position - 0x51B6
{
	return hParam0;
}

BOOL func_180(Hash hParam0, int iParam1) // Position - 0x51C0
{
	if (hParam0 == 0)
		return false;
...
BOOL func_181(Hash hParam0) // Position - 0x51DA
{
	return func_127(hParam0) == joaat("WEAPON");
}

struct<4> func_182(BOOL bParam0) // Position - 0x51EE
{
	int num;
...
BOOL func_183(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x528F
{
	return func_187(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_184(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x52AA
{
	var unk;
...
BOOL func_185(Hash hParam0, BOOL bParam1) // Position - 0x52CB
{
...
int func_186(Hash hParam0, var uParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5302
{
	if (!func_126(hParam0, 0))
	{
		if (func_180(func_179(hParam0), 2))
...
int func_187(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x5376
{
...
void func_188(var uParam0) // Position - 0x53F5
{
...
void func_189(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x542D
{
	int i;
	var unk;
...
void func_190(int iParam0, int iParam1) // Position - 0x54E3
{
	if (iParam1 == 0)
		return;
...
void func_191(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x5513
{
	int i;
	var unk;
...
BOOL func_192(Any* panParam0, int iParam1, int iParam2) // Position - 0x55CE
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_193() // Position - 0x5605
{
	return Global_1102813.f_3672;
}

void func_194(Player plParam0) // Position - 0x5614
{
	Player player;
...
void func_195(Player plParam0) // Position - 0x5680
{
...
BOOL func_196(Hash hParam0, Hash hParam1) // Position - 0x56BB
{
	if (!func_126(hParam0, 0))
...
void func_197(Hash hParam0, var uParam1, var uParam2) // Position - 0x56FC
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_198(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x5908
{
	Hash hash;
...
void func_199(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x59E6
{
...
BOOL func_200(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x5A01
{
...
struct<5> func_201(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5A26
{
	var unk;
	int num;
	var unk6;
...
BOOL func_202(Hash hParam0) // Position - 0x5D9A
{
	return func_196(hParam0, 1279601681);
}

BOOL func_203(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x5DAD
{
	int inventoryId;
...
int func_205() // Position - 0x5E0F
{
	return Global_1953292.f_1;
}

BOOL func_206(Any anParam0) // Position - 0x5E1D
{
...
BOOL func_207(Hash hParam0, Hash hParam1) // Position - 0x5E63
{
...
struct<4> func_208(BOOL bParam0) // Position - 0x5E99
{
	int num;
...
BOOL func_209(Hash hParam0, int iParam1) // Position - 0x5F03
{
	Hash hash;
	int num;
	int i;
...
BOOL func_210(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x5F70
{
	return func_213(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_211(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5F86
{
...
BOOL func_212(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x5FB9
{
...
BOOL func_213(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x5FEC
{
...
BOOL func_214(Hash hParam0) // Position - 0x6026
{
