...
void _DEBUG_PRINT(int iParam0) // Position - 0x94C
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x958
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x965
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x971
{
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x97A
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x986
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x99B
{
	return func_53(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x9AC
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x9EB
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x9F7
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x9FF
{
	if (func_54(iParam0))
		return true;
...
void func_25() // Position - 0xAAF
{
	return;
}

void func_26() // Position - 0xAB7
{
	return;
}

void func_27() // Position - 0xABF
{
	return;
}

void func_28() // Position - 0xAC7
{
	return;
}

void func_29(int iParam0) // Position - 0xACF
{
	if (func_45() != -1)
	{
...
void func_30(int iParam0) // Position - 0xB69
{
	iParam0 = iParam0;
...
void func_31() // Position - 0xB80
{
	return;
}

void func_32() // Position - 0xB88
{
	return;
}

void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0xB90
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xB9C
{
...
void func_35(var uParam0) // Position - 0xBCD
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xC13
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xC32
{
	if (!func_66(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xC4B
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xC5C
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xC74
{
	func_68(118, volLocal_24, &uLocal_23);
	return true;
}

void func_41(var uParam0, int iParam1) // Position - 0xC87
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0xDC6
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0xDD3
{
...
BOOL func_44(int iParam0) // Position - 0xE09
{
	if (iParam0 == 0)
	{
		func_81();
...
int func_45() // Position - 0xF1D
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0xF2B
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0xF37
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0xFA4
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x1084
{
	if (!func_66(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x10A2
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x10B5
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

BOOL func_53(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x10D3
{
	int num;
	int num2;
	int num3;
...
BOOL func_54(int iParam0) // Position - 0x11CB
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_55(int iParam0) // Position - 0x11DC
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_56(int iParam0) // Position - 0x11F0
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_57(var uParam0, var uParam1) // Position - 0x1204
{
	return uParam0;
}

void func_58(int iParam0, Volume volParam1, int iParam2, Volume volParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x120E
{
...
void func_59(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x13BD
{
	int num;
...
int func_60(int iParam0, BOOL bParam1) // Position - 0x1461
{
	int num;
	Hash hash;
	float num2;
...
void func_61(int iParam0, int iParam1, Volume volParam2, int iParam3, Volume volParam4, Volume volParam5, int iParam6, float fParam7, int iParam8, int iParam9) // Position - 0x1588
{
	int num;
	var unk;
	var unk4;
...
void func_62(int iParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x1796
{
	int num;
...
void func_63(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x1832
{
...
int func_64(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x1856
{
	PersChar persChar;
...
void func_65(var uParam0, Volume volParam1, int iParam2) // Position - 0x18A4
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_66(int iParam0) // Position - 0x18FD
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_67() // Position - 0x1913
{
	int i;
...
void func_68(int iParam0, Volume volParam1, var uParam2) // Position - 0x1940
{
	if (!*uParam2)
	{
...
BOOL func_69(int iParam0, int iParam1) // Position - 0x1982
{
	return iParam0 && iParam1 != false;
}

BOOL func_70(var uParam0, int iParam1) // Position - 0x1991
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_71() // Position - 0x19A2
{
	return func_69(Global_1940199, 8192);
}

BOOL func_72(var uParam0, int iParam1) // Position - 0x19B5
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_73(int iParam0) // Position - 0x19C6
{
	if (!func_66(iParam0))
		return false;
...
BOOL func_74(int iParam0, int iParam1) // Position - 0x1A06
{
...
int func_75() // Position - 0x1A33
{
	return Global_1896646.f_41;
}

void func_76(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1A41
{
	BOOL flag;
	...
	StringToTest = func_140(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &flag);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num2, func_152(&unk, joaat("COLOR_PURE_WHITE")), str3, func_152(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num2, func_152(&unk, joaat("COLOR_PURE_WHITE")), func_152(&unk2, joaat("COLOR_PURE_WHITE")));
		}
	
		Global_1893611.f_9 = 0;
	}

	Global_1939102.f_145 = func_153(StringToTest, str, 4000, 0, 0, 0, false, true);
	return;
}

void func_77(var uParam0, int iParam1) // Position - 0x1CAB
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_78(int iParam0, BOOL bParam1) // Position - 0x1CBE
{
...
void func_79(BOOL bParam0) // Position - 0x2327
{
	if (bParam0)
...
BOOL func_80(int iParam0) // Position - 0x2350
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_81() // Position - 0x2395
{
	return;
}

Hash func_82(int iParam0, BOOL bParam1) // Position - 0x239D
{
	switch (iParam0)
	{
		case 0:
...
void func_83(int iParam0, BOOL bParam1) // Position - 0x2B62
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_84(BOOL bParam0) // Position - 0x2BB5
{
	if (bParam0)
...
void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0x2BDE
{
	iParam0 = iParam0;
	return;
}

void func_86(int iParam0) // Position - 0x2BEA
{
	int i;
...
void func_87(int iParam0) // Position - 0x2C1B
{
	int i;
...
BOOL func_88(int iParam0, BOOL bParam1) // Position - 0x2C4E
{
	int num;
	int num2;
	int num3;
...
BOOL func_89(int iParam0) // Position - 0x2D04
{
	int i;
...
BOOL func_90(int iParam0, BOOL bParam1) // Position - 0x2D7E
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_91(int iParam0) // Position - 0x2DAF
{
	if (!func_66(iParam0))
		return false;
...
BOOL func_92(int iParam0) // Position - 0x2DD0
{
	if (!func_66(iParam0))
		return false;
...
BOOL func_93(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2E23
{
	BOOL flag;
...
BOOL func_94(int iParam0) // Position - 0x34E3
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_95(int iParam0) // Position - 0x34FA
{
	switch (iParam0)
	{
		case 64:
...
int func_96(int iParam0, BOOL bParam1) // Position - 0x353D
{
	if (!func_94(iParam0))
		return 0;
...
BOOL func_98() // Position - 0x363C
{
	return func_168(func_56(0));
}

BOOL func_99(int iParam0) // Position - 0x364D
{
	return !func_169(iParam0);
}

void func_100(BOOL bParam0, BOOL bParam1) // Position - 0x365C
{
	if (func_170(255) == 4)
		return;
...
void func_101(int iParam0, BOOL bParam1) // Position - 0x37A7
{
	BOOL flag;
...
int func_102(int iParam0, int iParam1) // Position - 0x3B56
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_103(int iParam0) // Position - 0x44BC
{
	if (!func_186(iParam0))
		return 0;
...
float func_104(int iParam0) // Position - 0x44FD
{
	switch (iParam0)
	{
		case 3:
...
void func_105(int iParam0, int iParam1) // Position - 0x459A
{
...
void func_106(int iParam0) // Position - 0x45C9
{
...
int func_107(int iParam0) // Position - 0x4602
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

Hash func_108(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4616
{
...
BOOL func_109(Hash hParam0) // Position - 0x46BA
{
	if (func_188(hParam0))
...
BOOL func_110(Hash hParam0) // Position - 0x46D5
{
...
void func_111(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x46FE
{
	func_108(hParam0, false, false);
...
BOOL func_112(int iParam0, int iParam1) // Position - 0x4789
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && iParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x47A2
{
...
int func_114() // Position - 0x47CC
{
	return Global_1893611.f_2;
}

BOOL func_115(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x47DA
{
	return func_194(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_116(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x47FA
{
	return func_194(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_117(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x481A
{
	if (bParam6)
...
Vector3 func_118(int iParam0) // Position - 0x4896
{
	if (!func_186(iParam0))
		return 0f, 0f, 0f;
...
Vector3 func_119(int iParam0) // Position - 0x5015
{
	if (!func_186(iParam0))
		return 0f, 0f, 0f;
...
BOOL func_120(int iParam0, BOOL bParam1) // Position - 0x573C
{
	return func_196(Global_1915656.f_3[iParam0 /*447*/].f_5, bParam1);
}

void func_121(int iParam0) // Position - 0x5757
{
	int i;
	int num;
...
BOOL func_122(int iParam0, int iParam1) // Position - 0x592F
{
	Ped EntityIndex;
	Ped EntityIndex2;
	Ped EntityIndex3;
	...
	{
		EntityIndex3 = VOLUME::_0x7FD78DFD0C5D7B9B(Global_1915656.f_3[iParam0 /*447*/].f_28);
	
		if (ENTITY::DOES_ENTITY_EXIST(EntityIndex3))
			if (EntityIndex3 != EntityIndex)
	...
	Global_1915656.f_3[iParam0 /*447*/].f_23 = EntityIndex;
	return true;
}

void func_123(int iParam0) // Position - 0x5A66
{
...
void func_124(int iParam0) // Position - 0x5B77
{
	if (iParam0 == 81)
	{
...
void func_125() // Position - 0x5C21
{
	TEXT_LABEL_ASSIGN_STRING(&Global_1960050.f_327[15 /*8*/], "GUS", 64);
	return;
}

void func_126() // Position - 0x5C3A
{
	int randomIntInRange;
	int randomIntInRange2;
...
void func_127(int iParam0) // Position - 0x5C9B
{
	if (!func_186(iParam0))
		return;
...
void func_128(int iParam0, int iParam1) // Position - 0x5D15
{
	if (!func_204(iParam0))
		return;
...
void func_129(int iParam0, int iParam1) // Position - 0x5D88
{
	if (!func_204(iParam0))
		return;
...
int func_130(int iParam0) // Position - 0x5DE0
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

BOOL func_131(int iParam0, BOOL bParam1) // Position - 0x5DF6
{
	if (func_45() != -1)
		return false;
...
PersChar func_132(int iParam0) // Position - 0x5E4E
{
	if (!func_94(iParam0))
		return 0;
...
BOOL func_133(int iParam0) // Position - 0x5E6E
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_134(int iParam0) // Position - 0x5E84
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_135(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x5E9A
{
...
struct<2> func_136(int iParam0) // Position - 0x5ED0
{
	int num;
...
void func_137(var uParam0, var uParam1, int iParam2) // Position - 0x5EEB
{
...
BOOL func_138(int iParam0) // Position - 0x5F08
{
...
const char* func_140(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x5F80
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_209(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_211(func_210(Global_34));
...
BOOL func_141(int iParam0) // Position - 0x69E6
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_142(int iParam0) // Position - 0x69FB
{
	switch (iParam0)
	{
		case 0:
...
int func_143(int iParam0) // Position - 0x6AB6
{
	int i;
	var gamerHandle;
	int bountyData;
...
int func_144(int iParam0) // Position - 0x6B24
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_145(int iParam0) // Position - 0x6C7F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_146(int iParam0, BOOL bParam1) // Position - 0x6CB9
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_147(int iParam0, int iParam1) // Position - 0x6CFB
{
	if (!func_141(iParam0))
		return false;
...
int func_148() // Position - 0x6D40
{
	return Global_1902569;
}

int func_149(int iParam0) // Position - 0x6D4C
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 12) & 31;
}

int func_150(int iParam0) // Position - 0x6D5F
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 6) & 63;
}

float func_151(float fParam0) // Position - 0x6D71
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_152(var uParam0, int iParam1) // Position - 0x6D87
{
...
int func_153(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x6DBD
{
	int duration;
	var data;
	int num;
...
BOOL func_154(int iParam0) // Position - 0x6E00
{
	if (func_212(iParam0))
		if (!func_213(44))
			return false;
...
void func_155(int iParam0, int iParam1) // Position - 0x6E20
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_156(int iParam0, int iParam1) // Position - 0x6E31
{
	int num;
...
void func_157(int iParam0) // Position - 0x6E47
{
...
BOOL func_158(int iParam0, BOOL bParam1) // Position - 0x6F27
{
	if (func_45() != -1)
		return false;
...
int func_159(int iParam0, BOOL bParam1) // Position - 0x6F55
{
	if (!func_94(iParam0))
		return 0;
...
int func_160(int iParam0) // Position - 0x6FD8
{
	switch (iParam0)
	{
		case 27:
...
int func_161(int iParam0) // Position - 0x6FFF
{
	switch (iParam0)
	{
		case 33:
...
Hash func_164(int iParam0) // Position - 0x7262
{
	if (!func_94(iParam0))
		return 0;
...
void func_165(int iParam0, PersChar pchParam1) // Position - 0x7280
{
	if (!func_94(iParam0))
		return;
...
void func_166(int iParam0, BOOL bParam1) // Position - 0x72A1
{
	if (func_45() != -1)
		return;
...
BOOL func_167(int iParam0) // Position - 0x72DA
{
	if (!func_94(iParam0))
		return false;
...
BOOL func_168(var uParam0, var uParam1) // Position - 0x7300
{
	return func_223(uParam0, 5, 8);
}

BOOL func_169(int iParam0) // Position - 0x7313
{
	return func_224(1, iParam0);
}

int func_170(int iParam0) // Position - 0x7322
{
	if (iParam0 == 255)
...
int func_171(int iParam0) // Position - 0x736D
{
...
void func_172(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x738A
{
	func_226(iParam0);
...
int func_173(int iParam0) // Position - 0x73EC
{
...
void func_174(var uParam0) // Position - 0x7409
{
	var unk;
...
void func_175(float* pfParam0) // Position - 0x741B
{
	var unk;
...
void func_177(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x7483
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_178(int iParam0) // Position - 0x74B0
{
...
BOOL func_179(int iParam0, int iParam1) // Position - 0x750D
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_180(int iParam0, int iParam1) // Position - 0x7526
{
	func_179(iParam0, iParam1);
	Global_1051832.f_92[iParam0 /*75*/].f_1 = Global_1051832.f_92[iParam0 /*75*/].f_1 - Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1;
	return;
...
void func_181(Hash hParam0) // Position - 0x7561
{
...
void func_182(int iParam0) // Position - 0x7581
{
	return;
}

void func_183(int iParam0) // Position - 0x7589
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_184(int iParam0, int iParam1) // Position - 0x759E
{
	if (iParam0 == -1)
		return false;
...
void func_185(int iParam0) // Position - 0x75C5
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_186(int iParam0) // Position - 0x7644
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_187(int iParam0) // Position - 0x765A
{
	var unk;
...
BOOL func_188(Hash hParam0) // Position - 0x768B
{
	return hParam0 != 0;
}

void func_189(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x7697
{
	if (func_109(hParam0))
	{
...
void func_190(Hash hParam0, BOOL bParam1) // Position - 0x76CF
{
	if (func_109(hParam0))
...
void func_191(Hash hParam0, BOOL bParam1) // Position - 0x76FD
{
	if (func_109(hParam0))
...
void func_192(Hash hParam0, BOOL bParam1) // Position - 0x772B
{
	if (func_109(hParam0))
...
BOOL func_193() // Position - 0x7759
{
	return true;
}

BOOL func_194(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x7762
{
	int num;
...
int func_195(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x77EA
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

BOOL func_196(BOOL bParam0, BOOL bParam1) // Position - 0x7804
{
	return bParam0 && bParam1 != false;
}

BOOL func_197(int iParam0) // Position - 0x7813
{
	if (!func_94(iParam0))
		return false;
...
void func_198(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7838
{
	PersChar persChar;
...
void func_199(int iParam0, BOOL bParam1) // Position - 0x7924
{
	if (!func_186(iParam0))
		return;
...
void func_200(int iParam0) // Position - 0x797A
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

Ped func_201(int iParam0) // Position - 0x7990
{
	PersChar persChar;
...
BOOL func_202(int iParam0, BOOL bParam1) // Position - 0x79BE
{
	if (!func_186(iParam0))
		return false;
...
void func_203(int iParam0, BOOL bParam1) // Position - 0x79E4
{
	if (!func_186(iParam0))
		return;
...
BOOL func_204(int iParam0) // Position - 0x7A12
{
	return iParam0 > -1 && iParam0 < 40;
}

int func_205(int iParam0) // Position - 0x7A28
{
	int num;
...
BOOL func_206() // Position - 0x7A40
{
	return false;
}

BOOL func_207() // Position - 0x7A49
{
	var unk;
	var unk3;
...
BOOL func_208(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7AB1
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_209(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x7C27
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_210(var uParam0, var uParam1, var uParam2) // Position - 0x7C3B
{
	int i;
...
const char* func_211(int iParam0) // Position - 0x7C69
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_212(int iParam0) // Position - 0x7F4B
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_213(int iParam0) // Position - 0x7F75
{
	if (!func_246(iParam0))
		return false;
...
struct<2> func_214(Player plParam0) // Position - 0x7F91
{
	var gamerHandle;
...
const char* func_215(const char* sParam0, int iParam1) // Position - 0x7FA5
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_216(int iParam0, BOOL bParam1) // Position - 0x7FBF
{
	char* StringToTest;
...
void func_217(int iParam0, BOOL bParam1) // Position - 0x7FF3
{
	switch (iParam0)
	{
		case 5:
...
void func_218(int iParam0, int iParam1) // Position - 0x802E
{
	func_248(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

void func_219(int iParam0, BOOL bParam1) // Position - 0x8048
{
	if (func_45() != -1)
		return;
...
void func_220(int iParam0) // Position - 0x8079
{
	Ped EntityIndex;
...
void func_221(int iParam0) // Position - 0x80BD
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_222(int iParam0) // Position - 0x80D2
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_223(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x80E7
{
	int num;
...
BOOL func_224(int iParam0, int iParam1) // Position - 0x8122
{
	int num;
...
BOOL func_225(var uParam0, int iParam1, int iParam2) // Position - 0x8196
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_231(BOOL bParam0) // Position - 0x8265
{
	if (func_252(bParam0))
		return;
...
BOOL func_232(var uParam0, int iParam1, int iParam2) // Position - 0x828C
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_233() // Position - 0x82BF
{
	return 1;
}

int func_234(int iParam0) // Position - 0x82C8
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_235(int iParam0, int iParam1, var uParam2) // Position - 0x8CB0
{
	var unk;
...
int func_236() // Position - 0x8CD7
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_237(int iParam0) // Position - 0x8CEC
{
	if (!func_94(iParam0))
		return false;
...
BOOL func_238(Hash hParam0) // Position - 0x8D10
{
	return hParam0 != 0;
}

void func_239(int iParam0, BOOL bParam1) // Position - 0x8D1C
{
	if (!func_186(iParam0))
		return;
...
void func_240(int iParam0) // Position - 0x8D56
{
	func_256(func_255(iParam0));
	return;
}

BOOL func_241() // Position - 0x8D68
{
	if (Global_1048576)
		return true;
...
struct<2> func_242() // Position - 0x8DC0
{
	return Global_1051268;
}

BOOL func_243(var uParam0, var uParam1) // Position - 0x8DCE
{
	if (!func_257(uParam0))
		return false;
...
struct<2> func_244() // Position - 0x8E02
{
...
BOOL func_245(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x8E4D
{
	var unk;
	float num;
	float num2;
...
BOOL func_246(int iParam0) // Position - 0x8E7D
{
	if (iParam0 == 0)
		return false;
...
BOOL func_247(int iParam0) // Position - 0x8E90
{
	int num;
	int num2;
	int offset;
...
void func_248(var uParam0, int iParam1) // Position - 0x8EBA
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_249(int iParam0, var uParam1) // Position - 0x8ECF
{
	if (iParam0 == 2)
...
BOOL func_250(var uParam0, int iParam1, int iParam2) // Position - 0x8EE9
{
	return MISC::IS_BIT_SET(uParam0->[iParam1 / 31], iParam1 % 31);
}

int func_251() // Position - 0x8F20
{
	return Global_1102813.f_3672;
}

BOOL func_252(BOOL bParam0) // Position - 0x8F2F
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_253(int iParam0, int iParam1, Any* panParam2) // Position - 0x8F45
{
...
void func_254(Any* panParam0, int iParam1, var uParam2) // Position - 0x8F79
{
	var unk;
...
int func_255(int iParam0) // Position - 0x8FF3
{
...
void func_256(int iParam0) // Position - 0x9510
{
	Global_1915656.f_18247 = iParam0;
	return;
}

BOOL func_257(int iParam0) // Position - 0x9521
{
	switch (iParam0)
	{
		case 2:
...
int func_258(int iParam0) // Position - 0x9560
{
	switch (iParam0)
	{
		case 2:
...
void func_259(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x95F6
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_260(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0xA093
{
	float num;
	float num2;
	float num3;
...
int func_261(var uParam0, var uParam1) // Position - 0xA0F9
{
	var unk;
...
int func_262(int iParam0) // Position - 0xA125
{
	int num;
...
BOOL func_263(int iParam0, var uParam1, Any* panParam2) // Position - 0xA29A
{
	if (!func_243(iParam0))
		return false;
...
void func_264(Any* panParam0) // Position - 0xA3A5
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
