...
void func_1(var uParam0) // Position - 0x1D2
{
	int i;
...
BOOL func_2(var uParam0, var uParam1, var uParam2) // Position - 0x22A
{
	return false;
}

void func_3(var uParam0, int iParam1) // Position - 0x233
{
	*uParam0 = iParam1;
	func_16(uParam0);
	return;
...
BOOL func_4(int iParam0, int iParam1) // Position - 0x246
{
	return iParam0 && iParam1 != false;
}

int func_5(var uParam0) // Position - 0x255
{
	return *uParam0;
}

BOOL func_6(var uParam0) // Position - 0x260
{
	return uParam0->f_14;
}

void func_7(var uParam0) // Position - 0x26C
{
...
void func_8(var uParam0) // Position - 0x2A6
{
	uParam0->f_14 = 0;
	return;
}

int func_9(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x2B3
{
...
int func_10(var uParam0) // Position - 0x2DF
{
	int i;
	Hash ModelIndex;
...
BOOL func_11(var uParam0) // Position - 0x374
{
	int i;
	Hash ModelIndex;
...
BOOL func_12(var uParam0) // Position - 0x3C5
{
...
void func_13(var uParam0) // Position - 0x3FB
{
...
void func_14(var uParam0) // Position - 0x497
{
...
BOOL func_15(AnimScene ansParam0) // Position - 0x505
{
...
void func_16(var uParam0) // Position - 0x51D
{
	uParam0->f_14 = 1;
	return;
}
