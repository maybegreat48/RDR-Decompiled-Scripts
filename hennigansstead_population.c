...
int func_3() // Position - 0x208
{
	return Global_1572887.f_14;
}

BOOL func_4(BOOL bParam0, BOOL bParam1) // Position - 0x216
{
	int i;
...
void func_6() // Position - 0x42E
{
	return;
}

void func_7(Volume volParam0) // Position - 0x436
{
...
void func_8(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x47D
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_9(Volume volParam0) // Position - 0x4F3
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(int iParam0) // Position - 0x5B3
{
	int num;
	int num2;
	int BitIndex;
...
void func_12(int iParam0) // Position - 0x5E6
{
	int num;
	int num2;
	int BitIndex;
...
void func_13(var uParam0, int iParam1) // Position - 0x619
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_14(int iParam0, int iParam1) // Position - 0x62E
{
	switch (iParam0)
	{
...
BOOL func_15(int iParam0) // Position - 0x1ED3
{
	int num;
...
BOOL func_16(int iParam0) // Position - 0x1EF0
{
...
int func_17(int iParam0) // Position - 0x1F07
{
	return func_18(iParam0) + 30;
}

int func_18(int iParam0) // Position - 0x1F17
{
	return iParam0 * 31;
}
