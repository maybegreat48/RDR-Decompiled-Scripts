...
BOOL func_3(var uParam0) // Position - 0x9A
{
...
int func_6(Hash hParam0) // Position - 0x316
{
	switch (hParam0)
	{
...
BOOL func_7(int iParam0) // Position - 0x335
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_8(Ped pedParam0, Volume volParam1, BOOL bParam2, int iParam3) // Position - 0x36D
{
...
void func_10(int iParam0) // Position - 0x3C1
{
	Global_1956875.f_1431 = iParam0;
	return;
}

BOOL func_11(var uParam0, int iParam1) // Position - 0x3D2
{
	if (*uParam0 != iParam1)
	{
		*uParam0 = iParam1;
...
struct<11> func_12(int iParam0, int iParam1) // Position - 0x3EC
{
	var unk;
...
BOOL func_13(var uParam0, Vector3 vParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x938
{
...
Vector3 func_14(int iParam0) // Position - 0x97A
{
	switch (iParam0)
	{
		case 0:
...
int func_15(int iParam0) // Position - 0x9DE
{
	if (func_20(iParam0))
		return 3;
...
void func_16(int iParam0, int iParam1) // Position - 0xA1B
{
	switch (iParam1)
	{
		case 3:
...
void func_17(int iParam0) // Position - 0xC51
{
	Vector3 vector;
	var entityCoords;
	var unk5;
...
void func_18(var uParam0) // Position - 0xD0F
{
	if (VOLUME::DOES_VOLUME_EXIST(*uParam0))
...
BOOL func_21(int iParam0) // Position - 0xD7C
{
	int num;
...
BOOL func_22(int iParam0) // Position - 0xDB7
{
	int num;
...
BOOL func_23(int iParam0) // Position - 0xE00
{
	int num;
...
Vector3 func_24(float fParam0, var uParam1, var uParam2) // Position - 0xE57
{
	float num;
	float num2;
...
int func_25(int iParam0) // Position - 0xE96
{
	return func_26(iParam0) + func_27(iParam0) + func_28(iParam0) + func_29(iParam0);
}

int func_26(int iParam0) // Position - 0xEB9
{
	switch (iParam0)
	{
		case 0:
...
int func_28(int iParam0) // Position - 0xF1C
{
	switch (iParam0)
	{
		case 0:
...
int func_29(int iParam0) // Position - 0xF4B
{
	switch (iParam0)
	{
		case 0:
