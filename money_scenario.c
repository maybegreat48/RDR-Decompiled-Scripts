...
int func_15(Hash hParam0, BOOL bParam1, int iParam2, int iParam3, const char* sParam4, int iParam5, BOOL bParam6, int iParam7) // Position - 0x232
{
	int num;
...
int func_16() // Position - 0x279
{
	return Global_1572887.f_14;
}

int func_17(int iParam0, int iParam1) // Position - 0x287
{
	var unk;
	var unk5;
...
int func_18(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x2BB
{
	float num;
	int num2;
	int i;
...
void func_19(int iParam0, const char* sParam1, int iParam2, BOOL bParam3) // Position - 0x38B
{
	if (iParam0 == 0)
		return;
...
void func_20(int iParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x3DA
{
	int num;
	int value;
	int num2;
...
void func_21(var uParam0, int iParam1) // Position - 0x4B1
{
	BOOL flag;
	int i;
...
int func_22(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x5DD
{
	var unk;
	int num;
...
BOOL func_23(Hash hParam0, int iParam1) // Position - 0x64C
{
	int num;
...
BOOL func_24(Hash hParam0, int iParam1) // Position - 0x6CF
{
	if (hParam0 == 0)
		return false;
...
BOOL func_25(Hash hParam0, Hash hParam1) // Position - 0x6E9
{
	if (!func_24(hParam0, 0))
...
void func_26(int iParam0, int iParam1) // Position - 0x72A
{
	if (iParam0 <= 0)
		return;
...
int func_27(const char* sParam0, char* sParam1, Hash hParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, BOOL bParam8) // Position - 0x766
{
	int num;
	var unk13;
	int num2;
...
BOOL func_28() // Position - 0x7C9
{
	return UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL"));
}

BOOL func_29() // Position - 0x7DA
{
	return DLC::IS_DLC_PRESENT(joaat("dlc_ultimateedition"));
}

struct<2> func_30(int iParam0) // Position - 0x7EB
{
	int num;
...
void func_31(var uParam0, var uParam1, int iParam2) // Position - 0x7FB
{
...
void func_32(var uParam0) // Position - 0x818
{
...
void func_33(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x850
{
	int i;
	var unk;
...
int func_34(Hash hParam0) // Position - 0x906
{
	var unk;
...
BOOL func_35(Hash hParam0, int iParam1) // Position - 0x931
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_36(Hash hParam0) // Position - 0x9D8
{
	int num;
	int num2;
	int num3;
...
int func_37(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xA94
{
...
Hash func_38(Hash hParam0) // Position - 0xB56
{
	return hParam0;
}

BOOL func_39(Hash hParam0, Hash hParam1) // Position - 0xB60
{
...
BOOL func_40() // Position - 0xB96
{
	return Global_1913444.f_127 == 0;
}

void func_41(const char* sParam0, char* sParam1, Hash hParam2) // Position - 0xBA6
{
...
int func_42() // Position - 0xBD7
{
	return Global_1953292.f_1;
}

BOOL func_43(Any anParam0) // Position - 0xBE5
{
...
Hash func_44(Hash hParam0, int iParam1) // Position - 0xC2B
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_45(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0xCA5
{
...
BOOL func_46(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0xCCC
{
	if (iParam2 < 0)
		return false;
...
BOOL func_47(Hash hParam0) // Position - 0xD07
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_48(int iParam0) // Position - 0xD22
{
	if (iParam0 < 0)
		return 0;
...
int func_49(Hash hParam0) // Position - 0xD43
{
	var unk;
...
int func_50(Hash hParam0) // Position - 0xD6E
{
	switch (hParam0)
	{
...
int func_51(var uParam0, int iParam1) // Position - 0xE51
{
	int i;
...
int func_52(Hash hParam0) // Position - 0xE8E
{
	int num;
...
int func_53(Hash hParam0, BOOL bParam1) // Position - 0xEFB
{
	var unk;
	int num;
	int num2;
...
int func_54(Hash hParam0, int iParam1) // Position - 0xF5A
{
	if (iParam1 == 0)
		return 0;
...
int func_55(BOOL bParam0) // Position - 0xF86
{
	if (func_16() == -1)
	{
...
struct<4> func_56(Hash hParam0, BOOL bParam1) // Position - 0xFC7
{
	var unk;
...
BOOL func_57(Hash hParam0, int iParam1) // Position - 0xFEC
{
	if (hParam0 == 0)
		return false;
...
void func_58(Hash hParam0, var uParam1, var uParam2) // Position - 0x1006
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_59(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1212
{
	Hash hash;
...
struct<4> func_60(BOOL bParam0) // Position - 0x12F0
{
	int num;
...
void func_61(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1391
{
...
BOOL func_62(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x13AC
{
...
struct<5> func_63(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x13D1
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_64(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x1745
{
	var outGuid;
...
struct<4> func_65(BOOL bParam0) // Position - 0x1776
{
	int num;
...
int func_66(Hash hParam0, BOOL bParam1) // Position - 0x1816
{
...
BOOL func_67(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x184D
{
	return func_74(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_68(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x1868
{
	var unk;
...
struct<4> func_69(BOOL bParam0) // Position - 0x1889
{
	int num;
...
BOOL func_70(Hash hParam0, int iParam1) // Position - 0x18F3
{
	Hash hash;
	int num;
	int i;
...
BOOL func_71(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x1960
{
	return func_77(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

struct<4> func_72() // Position - 0x1976
{
	var unk;
...
int func_74(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x199F
{
...
BOOL func_75(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x1A1E
{
	int inventoryId;
...
BOOL func_76(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x1A63
{
...
BOOL func_77(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1A96
{
...
int func_78(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1AD0
{
...
BOOL func_79(Hash hParam0) // Position - 0x1B03
{
