...
BOOL func_1(var uParam0, var uParam1, BOOL bParam2, var uParam3) // Position - 0x3A
{
...
void func_2(var uParam0, BOOL bParam1) // Position - 0x192
{
...
BOOL func_3(var uParam0) // Position - 0x1B2
{
	return func_8(*uParam0, 1);
}

float func_4(var uParam0) // Position - 0x1C2
{
	if (!func_3(uParam0))
		return uParam0->f_1;
...
void func_5(var uParam0, int iParam1) // Position - 0x1F7
{
	*uParam0 = iParam1;
	return;
}

void func_6(var uParam0) // Position - 0x204
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_7(var uParam0) // Position - 0x21A
{
	func_11(uParam0, 0f);
	return;
}

BOOL func_8(int iParam0, int iParam1) // Position - 0x229
{
	return iParam0 && iParam1 != false;
}

BOOL func_9(var uParam0) // Position - 0x238
{
	return func_8(*uParam0, 2);
}

float func_10() // Position - 0x248
{
...
void func_11(var uParam0, float fParam1) // Position - 0x27A
{
...
void func_12(var uParam0, int iParam1) // Position - 0x2A0
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_13(var uParam0, int iParam1) // Position - 0x2B1
{
