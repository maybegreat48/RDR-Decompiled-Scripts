...
void func_1(int iParam0) // Position - 0x59
{
	iParam0 = iParam0;
...
void func_3(var uParam0, var uParam1, float fParam2, float fParam3, float fParam4, Hash hParam5) // Position - 0xAF
{
...
void func_4(int iParam0) // Position - 0x148
{
...
BOOL func_7(BOOL bParam0, BOOL bParam1) // Position - 0x1C8
{
	int i;
...
Hash func_8(int iParam0, BOOL bParam1) // Position - 0x2A8
{
	switch (iParam0)
	{
		case 0:
...
void func_9(int iParam0, BOOL bParam1) // Position - 0xA6D
{
