...
int func_1() // Position - 0xF6
{
	return Global_1572887.f_14;
}

void func_2(var uParam0, BOOL bParam1) // Position - 0x104
{
...
int func_3(var uParam0) // Position - 0x1E7
{
	return 0;
}

int func_4(var uParam0) // Position - 0x1F0
{
	int i;
	var unk;
...
BOOL func_5(var uParam0) // Position - 0x299
{
...
BOOL func_6(var uParam0) // Position - 0x2C5
{
	switch (uParam0->f_57)
	{
		case 0:
...
BOOL func_7(var uParam0, int iParam1) // Position - 0x3F0
{
	return uParam0->f_56 && iParam1 != false;
}

BOOL func_8(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x401
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_9() // Position - 0x456
{
	return Global_1900460.f_67;
}

BOOL func_10(var uParam0) // Position - 0x464
{
	var unk;
	var unk4;
	var unk7;
...
void func_11(var uParam0, int iParam1) // Position - 0x6D7
{
	uParam0->f_57 = iParam1;
	return;
}

BOOL func_12(var uParam0) // Position - 0x6E5
{
...
BOOL func_13(var uParam0) // Position - 0x73F
{
...
BOOL func_14(var uParam0) // Position - 0x7C2
{
	float num;
	Vector3 vector;
...
BOOL func_15(int iParam0, var uParam1) // Position - 0x8EE
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_16(var uParam0) // Position - 0x95B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_14)))
	{
...
BOOL func_17(var uParam0) // Position - 0x9BE
{
...
void func_18(var uParam0) // Position - 0xA7A
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
BOOL func_19(var uParam0) // Position - 0xA90
{
	BOOL flag;
...
BOOL func_20(var uParam0) // Position - 0xB11
{
	if (func_15(0, uParam0))
	{
		if (!func_7(uParam0, 256))
...
BOOL func_21(var uParam0) // Position - 0xE2D
{
	...
	else
	{
		for (i = 0; i < SCRIPTS::GET_NUMBER_OF_EVENTS(SCRIPT_EVENT_QUEUE_AI); i = i + 1)
		{
			...
			{
				SCRIPTS::GET_EVENT_DATA(SCRIPT_EVENT_QUEUE_AI, i, &data, 3);
			
				if (data == Global_33 && ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(data.f_1) == uParam0->f_42)
					if (data.f_2)
						return true;
					else
						return true;
				else if (data == 0 || data.f_1 == 0)
					return true;
			}
		}
	}
...
void func_22(var uParam0, int iParam1) // Position - 0xF0B
{
	uParam0->f_56 = uParam0->f_56 || iParam1;
	return;
}

int func_23(Vector3 vParam0, var uParam1, var uParam2) // Position - 0xF1E
{
	return func_36(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}

Vector3 func_24(var uParam0) // Position - 0xF34
{
	...
	worldPositionOfEntityBone = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(uParam0->f_43, iBoneIdx) };
	return worldPositionOfEntityBone;
}

Ped func_25(ePedType eptParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8, BOOL bParam9, BOOL bParam10, BOOL bParam11, BOOL bParam12) // Position - 0xF7C
{
	Ped EntityIndex;
	...
	func_37(EntityIndex, eptParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return EntityIndex;
}

void func_26(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0xFBC
{
...
void func_27(var uParam0, BOOL bParam1) // Position - 0xFF8
{
	if (bParam1)
	{
	}
...
BOOL func_28(var uParam0) // Position - 0x101E
{
	return func_38(*uParam0, 1);
}

void func_29(var uParam0) // Position - 0x102E
{
	func_39(uParam0, 0f);
	return;
}

BOOL func_30(var uParam0, float fParam1) // Position - 0x103D
{
	if (!func_28(uParam0))
		return false;
...
void func_31(var uParam0) // Position - 0x1064
{
	int pedBoneIndex;
	int pedBoneIndex2;
	int iBoneIdx;
	...
	iBoneIdx = func_41(uParam0->f_39, 0);
	iBoneIdx2 = func_41(uParam0->f_39, 1);
	worldPositionOfEntityBone = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(uParam0->f_43, iBoneIdx) };
	worldPositionOfEntityBone2 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(uParam0->f_43, iBoneIdx2) };
	PED::_0xE1AADD0055D76603(uParam0->f_42, uParam0->f_43, pedBoneIndex, iBoneIdx, worldPositionOfEntityBone, -1f, true, false, 0);
	PED::_0xE1AADD0055D76603(uParam0->f_42, uParam0->f_43, pedBoneIndex2, iBoneIdx2, worldPositionOfEntityBone2, -1f, true, false, 0);
	return;
}

void func_32(var uParam0) // Position - 0x10EA
{
	int pedBoneIndex;
	...
	pedBoneIndex = PED::GET_PED_BONE_INDEX(uParam0->f_42, uParam0->f_50);
	FirstEntityBoneIndex = func_41(uParam0->f_39, 2);
	vector = { 0f, 0f, 0f };
	vector2 = { 0f, 0f, 0f };
	vector3 = { 0f, 90f, 0f };
	...
	switch (uParam0->f_38)
	{
		case joaat("A_C_Rabbit_01"):
			vector = { -0.0125f, 0f, -0.025f };
			vector3 = { 0f, 90f, 0f };
			break;
	
		case joaat("a_c_fox_01"):
			vector2 = { -0.0125f, -0.03f, 0.0125f };
			vector3 = { 90f, 0f, 90f };
			break;
	}

	ENTITY::ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(uParam0->f_45, uParam0->f_42, FirstEntityBoneIndex, pedBoneIndex, vector2, vector, vector3, -1f, false, true, false, false, 0, true, 1065353216, 1065353216);
	return;
}

void func_33(var uParam0) // Position - 0x11A9
{
	int ropeType;
	float length;
...
void func_34(var uParam0) // Position - 0x1290
{
	Hash scenarioHash;
	Vector3 vector;
...
void func_35(var uParam0) // Position - 0x131C
{
	int i;
...
int func_36(Hash hParam0) // Position - 0x139A
{
	switch (hParam0)
	{
		case joaat("riobravo"):
...
void func_37(Ped pedParam0, ePedType eptParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x1454
{
	BOOL flag;
...
BOOL func_38(int iParam0, int iParam1) // Position - 0x151E
{
	return iParam0 && iParam1 != false;
}

void func_39(var uParam0, float fParam1) // Position - 0x152D
{
...
float func_40(var uParam0) // Position - 0x1553
{
	if (!func_28(uParam0))
		return uParam0->f_1;
...
int func_41(int iParam0, int iParam1) // Position - 0x1588
{
	switch (iParam0)
	{
		case joaat("p_carcasshangmed01a"):
...
void func_42(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x161A
{
	if (ENTITY::IS_ENTITY_DEAD(pedParam0))
		return;
...
void func_43(Ped pedParam0, BOOL bParam1) // Position - 0x165F
{
...
void func_44(Ped pedParam0, int iParam1) // Position - 0x16A4
{
	if (iParam1 == 1)
...
void func_46(var uParam0, int iParam1) // Position - 0x16FD
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_47(var uParam0, int iParam1) // Position - 0x170E
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_48(var uParam0) // Position - 0x1723
{
