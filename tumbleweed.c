...
void _DEBUG_PRINT(int iParam0) // Position - 0xB77
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0xB83
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0xB90
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0xB9C
{
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0xBA5
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0xBB1
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0xBC6
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0xC16
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0xC22
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0xC2A
{
	if (func_55(iParam0))
		return true;
...
void func_25() // Position - 0xCDA
{
	return;
}

void func_26() // Position - 0xCE2
{
	return;
}

void func_27() // Position - 0xCEA
{
	func_59(0, -5514.4536f, -2910.941f, 0.196263f, volLocal_20, 121);
	return;
}

void func_28() // Position - 0xD0A
{
	return;
}

void func_29(int iParam0) // Position - 0xD12
{
...
void func_30(int iParam0) // Position - 0xE89
{
	if (func_45() != -1)
		return;
...
void func_31() // Position - 0xEDE
{
	return;
}

void func_32() // Position - 0xEE6
{
	return;
}

void func_33(int iParam0) // Position - 0xEEE
{
	func_69(0.8f, 0.2f, 0f, 0f);
	return;
}

void func_34() // Position - 0xF06
{
...
void func_35(var uParam0) // Position - 0xF37
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xF7D
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xF92
{
	if (!func_71(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xFAB
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xFBC
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xFD4
{
...
void func_41(var uParam0, int iParam1) // Position - 0xFFF
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
...
int func_42(int iParam0) // Position - 0x113E
{
	iParam0 = iParam0;
	return 1;
}

BOOL func_43() // Position - 0x114B
{
...
BOOL func_44(int iParam0) // Position - 0x1181
{
	if (iParam0 == 0)
	{
		func_87();
...
int func_45() // Position - 0x1295
{
	return Global_1572887.f_14;
}

void func_46() // Position - 0x12A3
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

BOOL func_47() // Position - 0x12AF
{
...
BOOL func_49(BOOL bParam0, BOOL bParam1) // Position - 0x131C
{
	int i;
...
BOOL func_50(int iParam0) // Position - 0x13FC
{
	if (!func_71(iParam0))
		return false;
...
BOOL func_51(int iParam0) // Position - 0x141A
{
	return Global_1893611.f_7 && iParam0 != false;
}

void func_52(int iParam0) // Position - 0x142D
{
	Global_1893611.f_7 = Global_1893611.f_7 - Global_1893611.f_7 && iParam0;
	return;
}

void func_53(int iParam0, Volume volParam1) // Position - 0x144B
{
	Global_1915656.f_3[iParam0 /*447*/].f_32 = volParam1;
	return;
}

BOOL func_54(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1462
{
	int num;
	int num2;
	int num3;
...
BOOL func_55(int iParam0) // Position - 0x155A
{
	return Global_1940199 && iParam0 != false;
}

BOOL func_56(int iParam0) // Position - 0x156B
{
	return MISC::GET_GAME_TIMER() - iParam0 < Global_1900595;
}

struct<2> func_57(int iParam0) // Position - 0x157F
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_58(var uParam0, var uParam1) // Position - 0x1593
{
	return uParam0;
}

void func_59(int iParam0, float fParam1, float fParam2, float fParam3, Volume volParam4, int iParam5) // Position - 0x159D
{
...
void func_60(int iParam0, Volume volParam1, int iParam2, Volume volParam3, Volume volParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x15FB
{
...
void func_61(int iParam0, Hash hParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x17AA
{
	int num;
...
void func_62(int iParam0, int iParam1) // Position - 0x184E
{
	func_120(&(Global_1051832.f_92[iParam0 /*75*/].f_49), iParam1);
	return;
}

int func_63(int iParam0, BOOL bParam1) // Position - 0x1868
{
	int num;
	Hash hash;
	float num2;
...
void func_65(int iParam0) // Position - 0x1B56
{
	int i;
	Hash hash;
	float num;
...
BOOL func_67() // Position - 0x1CE7
{
	return func_133(func_57(0));
}

int func_68(int iParam0, Volume volParam1, BOOL bParam2) // Position - 0x1CF8
{
	PersChar persChar;
...
void func_69(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1D46
{
...
void func_70(var uParam0, Volume volParam1, int iParam2) // Position - 0x1D6E
{
	if (uParam0->f_61 >= 20)
		return;
...
BOOL func_71(int iParam0) // Position - 0x1DC7
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_72() // Position - 0x1DDD
{
	int i;
...
BOOL func_73(var uParam0) // Position - 0x1E0A
{
	if (func_138())
	{
		if (!*uParam0)
...
void func_74(Hash hParam0, int iParam1) // Position - 0x1E3A
{
	func_119(hParam0, true, 0, false, false, 0, false, false);
	return;
}

BOOL func_75(int iParam0, int iParam1) // Position - 0x1E4F
{
	return iParam0 && iParam1 != false;
}

BOOL func_76(var uParam0, int iParam1) // Position - 0x1E5E
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_77() // Position - 0x1E6F
{
	return func_75(Global_1940199, 8192);
}

BOOL func_78(var uParam0, int iParam1) // Position - 0x1E82
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_79(int iParam0) // Position - 0x1E93
{
	if (!func_71(iParam0))
		return false;
...
BOOL func_80(int iParam0, int iParam1) // Position - 0x1ED3
{
...
int func_81() // Position - 0x1F00
{
	return Global_1896646.f_41;
}

void func_82(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x1F0E
{
	BOOL flag;
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_153(&unk, joaat("COLOR_PURE_WHITE")), str3, func_153(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_153(&unk, joaat("COLOR_PURE_WHITE")), func_153(&unk2, joaat("COLOR_PURE_WHITE")));
		}
...
void func_83(var uParam0, int iParam1) // Position - 0x217E
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_84(int iParam0, BOOL bParam1) // Position - 0x2191
{
...
void func_85(BOOL bParam0) // Position - 0x27FA
{
	if (bParam0)
...
BOOL func_86(int iParam0) // Position - 0x2823
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_87() // Position - 0x2868
{
	return;
}

Hash func_88(int iParam0, BOOL bParam1) // Position - 0x2870
{
	switch (iParam0)
	{
		case 0:
...
void func_89(int iParam0, BOOL bParam1) // Position - 0x3035
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_90(BOOL bParam0) // Position - 0x3088
{
	if (bParam0)
...
void func_91(int iParam0) // Position - 0x30B1
{
	func_69(0.775f, 0.2f, 0.025f, 0f);
	ENTITY::REMOVE_MODEL_HIDE(-5479.709f, -2932.5544f, -1.3902f, 1f, joaat("p_blouseground01x"), false);
...
void func_92(int iParam0) // Position - 0x3114
{
	int i;
...
void func_93(int iParam0) // Position - 0x3145
{
	int i;
...
BOOL func_94(int iParam0, BOOL bParam1) // Position - 0x3178
{
	int num;
	int num2;
	int num3;
...
BOOL func_95(int iParam0) // Position - 0x322E
{
	int i;
...
BOOL func_96(int iParam0, BOOL bParam1) // Position - 0x32A8
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_97(int iParam0) // Position - 0x32D9
{
	if (!func_71(iParam0))
		return false;
...
BOOL func_98(int iParam0) // Position - 0x32FA
{
	if (!func_71(iParam0))
		return false;
...
BOOL func_99(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x334D
{
	BOOL flag;
...
BOOL func_100(int iParam0) // Position - 0x3A0D
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_101(int iParam0) // Position - 0x3A24
{
	switch (iParam0)
	{
		case 64:
...
int func_102(int iParam0, BOOL bParam1) // Position - 0x3A67
{
	if (!func_100(iParam0))
		return 0;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x3B52
{
...
void func_104(int iParam0) // Position - 0x3B7C
{
...
int func_105(int iParam0, int iParam1) // Position - 0x3C5C
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_106() // Position - 0x3D3F
{
	return func_172(func_57(0));
}

BOOL func_107(int iParam0) // Position - 0x3D50
{
	return !func_173(iParam0);
}

void func_108(BOOL bParam0, BOOL bParam1) // Position - 0x3D5F
{
	if (func_174(255) == 4)
		return;
...
void func_109(int iParam0, BOOL bParam1) // Position - 0x3EAA
{
	BOOL flag;
...
int func_110(Hash hParam0, int iParam1) // Position - 0x425B
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_111(int iParam0) // Position - 0x4BC1
{
	if (!func_187(iParam0))
		return 0;
...
int func_112(int iParam0) // Position - 0x4C02
{
	switch (iParam0)
	{
		case 3:
...
void func_113(int iParam0, int iParam1) // Position - 0x4C9F
{
...
void func_114(int iParam0) // Position - 0x4CCE
{
...
int func_115(int iParam0) // Position - 0x4D07
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

Hash func_116(Hash hParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4D1B
{
...
BOOL func_117(Hash hParam0) // Position - 0x4DBF
{
	if (func_189(hParam0))
...
BOOL func_118(Hash hParam0) // Position - 0x4DDA
{
...
void func_119(Hash hParam0, BOOL bParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x4E03
{
	func_116(hParam0, false, false);
...
void func_120(BOOL bParam0, int iParam1) // Position - 0x4E8E
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

BOOL func_121(int iParam0, BOOL bParam1) // Position - 0x4E9F
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

Hash func_122() // Position - 0x4EB8
{
	return Global_1893611.f_2;
}

BOOL func_123(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4EC6
{
	return func_195(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_124(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x4EE6
{
	return func_195(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_125(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x4F06
{
	if (bParam6)
...
void func_126(int iParam0) // Position - 0x4F82
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

void func_127(int iParam0) // Position - 0x4F97
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_128(int iParam0) // Position - 0x4FAC
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

void func_129(int iParam0) // Position - 0x4FC1
{
	int i;
	int num;
	BOOL flag;
...
int func_130(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5040
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

int func_131(int iParam0) // Position - 0x505A
{
	switch (iParam0)
	{
		case 10:
...
BOOL func_132(int iParam0, int iParam1) // Position - 0x50B8
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

BOOL func_133(var uParam0, var uParam1) // Position - 0x50D1
{
	return func_196(uParam0, 9, 12);
}

BOOL func_134(int iParam0, BOOL bParam1) // Position - 0x50E4
{
	if (func_45() != -1)
		return false;
...
PersChar func_135(int iParam0) // Position - 0x513C
{
	if (!func_100(iParam0))
		return 0;
...
BOOL func_136(int iParam0) // Position - 0x515C
{
	return iParam0 > -1 && iParam0 < 12;
}

BOOL func_137(int iParam0) // Position - 0x5172
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_138() // Position - 0x5188
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_139(int iParam0) // Position - 0x51A4
{
...
const char* func_141(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x521C
{
	const char* StringToTest;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893611.f_162)))
		StringToTest = func_201(Global_1893611.f_162);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest) && bParam4)
		StringToTest = func_203(func_202(Global_34));
...
BOOL func_142(int iParam0) // Position - 0x5C82
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_143(int iParam0) // Position - 0x5C97
{
	switch (iParam0)
	{
		case 0:
...
Hash func_144(int iParam0) // Position - 0x5D52
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_145(int iParam0) // Position - 0x5DC0
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_146(int iParam0) // Position - 0x5F1B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_147(int iParam0, BOOL bParam1) // Position - 0x5F56
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_148(int iParam0, int iParam1) // Position - 0x5F98
{
	if (!func_142(iParam0))
		return false;
...
BOOL func_149() // Position - 0x5FDD
{
	return Global_1902569;
}

int func_150(BOOL bParam0) // Position - 0x5FE9
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 12) & 31;
}

int func_151(BOOL bParam0) // Position - 0x5FFC
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 6) & 63;
}

float func_152(float fParam0) // Position - 0x600E
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_153(var uParam0, int iParam1) // Position - 0x6024
{
...
int func_154(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x605A
{
	int duration;
	var data;
	int num;
...
BOOL func_155(int iParam0) // Position - 0x609D
{
	if (func_204(iParam0))
		if (!func_205(44))
			return false;
...
void func_156(int iParam0, int iParam1) // Position - 0x60BD
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_157(int iParam0, int iParam1) // Position - 0x60CE
{
	int num;
...
void func_158(var uParam0, var uParam1, int iParam2) // Position - 0x60E4
{
...
void func_159(int iParam0) // Position - 0x6101
{
	int i;
	int num;
...
BOOL func_160(int iParam0, BOOL bParam1) // Position - 0x62D9
{
	if (func_45() != -1)
		return false;
...
int func_161(int iParam0, BOOL bParam1) // Position - 0x6307
{
	if (!func_100(iParam0))
		return 0;
...
int func_162(int iParam0) // Position - 0x638A
{
	switch (iParam0)
	{
		case 27:
...
int func_163(int iParam0) // Position - 0x63B1
{
	switch (iParam0)
	{
		case 33:
...
Hash func_165(int iParam0) // Position - 0x644D
{
	if (!func_100(iParam0))
		return 0;
...
void func_166(int iParam0, PersChar pchParam1) // Position - 0x646B
{
	if (!func_100(iParam0))
		return;
...
void func_167(int iParam0, BOOL bParam1) // Position - 0x648C
{
	if (func_45() != -1)
		return;
...
BOOL func_168(int iParam0) // Position - 0x64C5
{
	if (!func_100(iParam0))
		return false;
...
void func_169(int iParam0, BOOL bParam1) // Position - 0x64EB
{
	char* StringToTest;
...
void func_170(int iParam0, BOOL bParam1) // Position - 0x651F
{
	switch (iParam0)
	{
		case 5:
...
void func_171(int iParam0, int iParam1) // Position - 0x6554
{
	func_216(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_172(var uParam0, var uParam1) // Position - 0x656E
{
	return func_196(uParam0, 5, 8);
}

BOOL func_173(int iParam0) // Position - 0x6581
{
	return func_217(1, iParam0);
}

int func_174(int iParam0) // Position - 0x6590
{
	if (iParam0 == 255)
...
int func_175(int iParam0) // Position - 0x65DB
{
...
void func_176(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x65F8
{
	func_219(iParam0);
...
int func_177(int iParam0) // Position - 0x665A
{
...
void func_178(var uParam0) // Position - 0x6677
{
	var unk;
...
void func_179(float* pfParam0) // Position - 0x6689
{
	var unk;
...
void func_181(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x66F1
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_182(int iParam0) // Position - 0x671E
{
...
void func_183(int iParam0, int iParam1) // Position - 0x677B
{
	func_132(iParam0, iParam1);
...
void func_184(Hash hParam0) // Position - 0x67B6
{
...
void func_185(int iParam0) // Position - 0x67D6
{
	return;
}

BOOL func_186(int iParam0, int iParam1) // Position - 0x67DE
{
	if (iParam0 == -1)
		return false;
...
BOOL func_187(int iParam0) // Position - 0x6805
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_188(int iParam0) // Position - 0x681B
{
	var unk;
...
BOOL func_189(Hash hParam0) // Position - 0x684C
{
	return hParam0 != 0;
}

void func_190(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x6858
{
	if (func_117(hParam0))
	{
...
void func_191(Hash hParam0, BOOL bParam1) // Position - 0x6890
{
	if (func_117(hParam0))
...
void func_192(Hash hParam0, BOOL bParam1) // Position - 0x68BE
{
	if (func_117(hParam0))
...
void func_193(Hash hParam0, BOOL bParam1) // Position - 0x68EC
{
	if (func_117(hParam0))
...
BOOL func_194() // Position - 0x691A
{
	return true;
}

BOOL func_195(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x6923
{
	int num;
...
BOOL func_196(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x69AB
{
	int num;
...
Ped func_197(int iParam0) // Position - 0x69E6
{
	PersChar persChar;
...
BOOL func_198() // Position - 0x6A14
{
	return false;
}

BOOL func_199() // Position - 0x6A1D
{
	var unk;
	var unk3;
...
BOOL func_200(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x6A85
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_201(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6BFB
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_202(var uParam0, var uParam1, var uParam2) // Position - 0x6C0F
{
	int i;
...
const char* func_203(int iParam0) // Position - 0x6C3D
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_204(int iParam0) // Position - 0x6F21
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_205(int iParam0) // Position - 0x6F4B
{
	if (!func_237(iParam0))
		return false;
...
struct<2> func_206(Player plParam0) // Position - 0x6F67
{
	var gamerHandle;
...
const char* func_207(const char* sParam0, int iParam1) // Position - 0x6F7B
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

BOOL func_208(int iParam0) // Position - 0x6F95
{
	if (!func_100(iParam0))
		return false;
...
void func_209(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6FBA
{
	PersChar persChar;
...
void func_210(int iParam0, BOOL bParam1) // Position - 0x70A6
{
	if (!func_187(iParam0))
		return;
...
void func_211(int iParam0, int iParam1) // Position - 0x70FC
{
	if (!func_245(iParam0))
		return;
...
int func_212(int iParam0) // Position - 0x716F
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_213(int iParam0) // Position - 0x7185
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_214(int iParam0, BOOL bParam1) // Position - 0x719B
{
	if (func_45() != -1)
		return;
...
void func_215(int iParam0) // Position - 0x71CC
{
	Ped EntityIndex;
...
void func_216(BOOL bParam0, int iParam1) // Position - 0x7210
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_217(int iParam0, int iParam1) // Position - 0x7225
{
	int num;
...
BOOL func_218(int* piParam0, int iParam1, int iParam2) // Position - 0x7299
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_224(BOOL bParam0) // Position - 0x7368
{
	if (func_248(bParam0))
		return;
...
BOOL func_225(int* piParam0, int iParam1, int iParam2) // Position - 0x738F
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_226() // Position - 0x73C2
{
	return 1;
}

BOOL func_227(BOOL bParam0, BOOL bParam1) // Position - 0x73CB
{
	return bParam0 && bParam1 != false;
}

int func_228(int iParam0) // Position - 0x73DA
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_229(int iParam0, int iParam1, var uParam2) // Position - 0x7DC2
{
	var unk;
...
int func_230() // Position - 0x7DE9
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_231(var uParam0, var uParam1) // Position - 0x7DFE
{
	if (!func_251(uParam0))
		return false;
...
int func_232(int iParam0, var uParam1) // Position - 0x7E32
{
	if (iParam0 == 2)
...
struct<2> func_234() // Position - 0x7EA4
{
	return Global_1051268;
}

struct<2> func_235() // Position - 0x7EB2
{
...
BOOL func_236(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7EFD
{
	var unk;
	float num;
	float num2;
...
BOOL func_237(int iParam0) // Position - 0x7F2D
{
	if (iParam0 == 0)
		return false;
...
BOOL func_238(int iParam0) // Position - 0x7F40
{
	int num;
	int num2;
	int offset;
...
BOOL func_239(int iParam0) // Position - 0x7F6A
{
	if (!func_100(iParam0))
		return false;
...
BOOL func_240(Hash hParam0) // Position - 0x7F8E
{
	return hParam0 != 0;
}

BOOL func_241(int iParam0, BOOL bParam1) // Position - 0x7F9A
{
	if (!func_187(iParam0))
		return false;
...
void func_242(int iParam0, BOOL bParam1) // Position - 0x7FC0
{
	if (!func_187(iParam0))
		return;
...
void func_243(int iParam0, BOOL bParam1) // Position - 0x7FEE
{
	if (!func_187(iParam0))
		return;
...
void func_244(int iParam0) // Position - 0x8028
{
	func_257(func_256(iParam0));
	return;
}

BOOL func_245(int iParam0) // Position - 0x803A
{
	return iParam0 > -1 && iParam0 < 40;
}

BOOL func_246(int* piParam0, int iParam1, int iParam2) // Position - 0x8050
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_247() // Position - 0x8087
{
	return Global_1102813.f_3672;
}

BOOL func_248(BOOL bParam0) // Position - 0x8096
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_249(int iParam0, int iParam1, Any* panParam2) // Position - 0x80AC
{
...
void func_250(Any* panParam0, int iParam1, var uParam2) // Position - 0x80E0
{
	var unk;
...
BOOL func_251(int iParam0) // Position - 0x815A
{
	switch (iParam0)
	{
		case 2:
...
int func_252(int iParam0) // Position - 0x8199
{
	switch (iParam0)
	{
		case 2:
...
int func_253(var uParam0, var uParam1) // Position - 0x822F
{
	var unk;
...
void func_254(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x825B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_255(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x8CF8
{
	float num;
	float num2;
	float num3;
...
int func_256(int iParam0) // Position - 0x8D5E
{
...
void func_257(int iParam0) // Position - 0x927B
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_258(int iParam0) // Position - 0x928C
{
	int num;
...
BOOL func_259(int iParam0, var uParam1, Any* panParam2) // Position - 0x9401
{
	if (!func_231(iParam0))
		return false;
...
void func_260(Any* panParam0) // Position - 0x950C
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
