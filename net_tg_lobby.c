...
void func_1(var uParam0) // Position - 0x51
{
...
void func_2(var uParam0, var uParam1) // Position - 0x67
{
	uParam0->f_1 = *uParam1;
...
BOOL func_3(BOOL bParam0, BOOL bParam1) // Position - 0x96
{
	int i;
...
void func_4(var uParam0) // Position - 0x176
{
	func_10(uParam0);
	return;
}

BOOL func_5(var uParam0) // Position - 0x184
{
	var unk;
...
void func_6() // Position - 0x27D
{
	SCRIPTS::TERMINATE_THIS_THREAD();
	return;
}

int func_7(int iParam0) // Position - 0x289
{
	if (iParam0 == -1)
		return -1;
...
Vector3 func_8(int iParam0) // Position - 0x2A7
{
	return Global_1149172.f_1[iParam0 /*27*/].f_7;
}

void func_9(var uParam0) // Position - 0x2BD
{
	var sName;

	TEXT_LABEL_ASSIGN_STRING(&sName, "relPlayerClone", 64);
	TEXT_LABEL_APPEND_STRING(&sName, "_", 64);
	TEXT_LABEL_APPEND_INT(&sName, uParam0->f_1, 64);
	PED::ADD_RELATIONSHIP_GROUP(&sName, &(uParam0->f_14));
	func_33(2, uParam0->f_14);
	return;
}

void func_10(var uParam0) // Position - 0x2EE
{
...
BOOL func_11(var uParam0) // Position - 0x440
{
...
BOOL func_12(int iParam0) // Position - 0x460
{
	int messageState;
...
BOOL func_13(var uParam0, int iParam1) // Position - 0x480
{
	return func_57(uParam0->f_78, iParam1);
}

int func_14() // Position - 0x492
{
	if (func_20(2))
	{
	}
...
void func_15(var uParam0, BOOL bParam1) // Position - 0x4A7
{
	if (bParam1)
	{
...
void func_16(var uParam0) // Position - 0x4F8
{
...
void func_18(var uParam0, int iParam1) // Position - 0x531
{
	Ped playerPed;
...
void func_19(var uParam0) // Position - 0x5E9
{
...
BOOL func_20(int iParam0) // Position - 0x60C
{
	return func_57(Global_1149172.f_145, iParam0);
}

void func_21() // Position - 0x620
{
	func_65(false);
	return;
}

void func_22(var uParam0) // Position - 0x62D
{
	uParam0->f_78 = 0;
	return;
}

void func_23(int iParam0) // Position - 0x63A
{
...
struct<2> func_25(int iParam0) // Position - 0x6A8
{
	return Global_1149172.f_1[iParam0 /*27*/].f_4;
}

struct<2> func_26() // Position - 0x6BE
{
	return Global_1051268;
}

BOOL func_27(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x6CC
{
	return uParam0 == uParam2 && uParam0.f_1 == uParam2.f_1;
}

void func_28() // Position - 0x6E7
{
	if (!func_68())
		return;
...
BOOL func_29(var uParam0, var uParam1) // Position - 0x713
{
	int num;
...
BOOL func_30(var uParam0, var uParam1) // Position - 0x733
{
	int num;
...
void func_31(var uParam0, var uParam1, BOOL bParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x753
{
	int num;
...
void func_32(BOOL bParam0) // Position - 0x8BA
{
	int num;
...
void func_33(int iParam0, Hash hParam1) // Position - 0x9DC
{
...
BOOL func_34(var uParam0) // Position - 0xB91
{
	var unk;
...
void func_35(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC6B
{
	*uParam0 = iParam1;
...
void func_36(var uParam0) // Position - 0xC92
{
	float num;
...
void func_37(var uParam0) // Position - 0xD01
{
	if (!func_95())
		return;
...
void func_38(var uParam0) // Position - 0xD39
{
	BOOL flag;
...
void func_39(var uParam0) // Position - 0xDD1
{
	float num;
...
void func_40(var uParam0) // Position - 0xEF6
{
	float num;
	var unk;
	var memberHandles;
...
void func_41(var uParam0) // Position - 0x1329
{
	int num;
...
void func_42(var uParam0) // Position - 0x1476
{
	if (GANG::NETWORK_IS_GANG_ACTIVE(GANG::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID())))
		return;
...
void func_43(var uParam0) // Position - 0x1499
{
	if (func_20(4))
	{
		if (func_92(255))
...
void func_44(var uParam0) // Position - 0x14DC
{
	var unk;
	var unk2;
...
void func_45(var uParam0) // Position - 0x16DE
{
	int num;
	BOOL flag;
...
void func_46(var uParam0) // Position - 0x177C
{
	int num;
	BOOL flag;
	int nextEventType;
...
void func_47(var uParam0) // Position - 0x18CB
{
	struct<36> args;
...
void func_48(var uParam0) // Position - 0x1A9B
{
...
void func_49(var uParam0) // Position - 0x1B37
{
	BOOL flag;
...
void func_50(var uParam0) // Position - 0x1C24
{
	int num;
...
void func_51(var uParam0) // Position - 0x1CCC
{
	BOOL flag;
	Entity EntityIndex;
	...
	if (flag)
	{
		...
		if (func_160() == uParam0->f_1)
		{
			...
			EntityIndex = func_161(uParam0->f_1);
		
			if (ENTITY::DOES_ENTITY_EXIST(EntityIndex))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(EntityIndex, false, true);
				uParam0->f_13 = EntityIndex;
			}
...
void func_52(var uParam0) // Position - 0x1D9B
{
	if (!func_97(uParam0->f_1))
		func_35(uParam0, 16, true, true);
...
void func_53(var uParam0) // Position - 0x1DB9
{
	if (func_93())
...
void func_54(var uParam0) // Position - 0x1DED
{
	var unk;
	float num;
	int i;
...
void func_55(var uParam0) // Position - 0x200C
{
	if (func_5(uParam0))
...
BOOL func_56(int iParam0) // Position - 0x2027
{
	return iParam0 != 0;
}

BOOL func_57(int iParam0, int iParam1) // Position - 0x2033
{
	return iParam0 && iParam1 != false;
}

void func_58(var uParam0, int iParam1) // Position - 0x2042
{
	func_172(&(uParam0->f_78), iParam1);
	return;
}

void func_59(BOOL bParam0, BOOL bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8) // Position - 0x2054
{
	if (bParam0)
	{
...
void func_60(var uParam0, int iParam1) // Position - 0x2113
{
	func_66(&(uParam0->f_78), iParam1);
	return;
}

BOOL func_61(int iParam0) // Position - 0x2125
{
	if (iParam0 < 0)
		return false;
...
void func_62(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2164
{
	int num;
...
int func_63(int iParam0) // Position - 0x21B8
{
	switch (iParam0)
	{
		case 0:
...
void func_64(int iParam0) // Position - 0x2201
{
...
void func_65(BOOL bParam0) // Position - 0x223A
{
	if (bParam0)
...
void func_66(int iParam0, int iParam1) // Position - 0x2271
{
	func_175(iParam0, iParam1);
	return;
}

void func_67() // Position - 0x2281
{
	func_23(65536);
	func_23(131072);
	func_23(262144);
...
BOOL func_68() // Position - 0x22A1
{
	return func_69(Global_1051268);
}

BOOL func_69(var uParam0, var uParam1) // Position - 0x22B3
{
	if (!func_176(uParam0))
		return false;
...
void func_70(int iParam0) // Position - 0x22E7
{
	*iParam0 = -1;
	iParam0->f_1 = -1;
	return;
...
int func_71(var uParam0, var uParam1) // Position - 0x22F8
{
	int num;
...
Hash func_72(var uParam0, var uParam1) // Position - 0x2333
{
	return func_179(uParam0);
}

int func_73(BOOL bParam0, Hash hParam1) // Position - 0x2343
{
...
void func_74(var uParam0, var uParam1, int iParam2, int iParam3, Player plParam4, int iParam5) // Position - 0x2399
{
	int deedType;
	Hash deedHash;
	Hash data;
...
void func_75(var uParam0, var uParam1, int iParam2) // Position - 0x2468
{
	if (!func_69(uParam0))
		return;
...
struct<2> func_76(int iParam0) // Position - 0x24AB
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

void func_77(BOOL bParam0) // Position - 0x24BF
{
	if (bParam0)
	{
...
void func_78(BOOL bParam0) // Position - 0x2562
{
	int i;
	Hash crimeType;
	var unk;
...
int func_79(BOOL bParam0) // Position - 0x25D3
{
...
void func_80(BOOL bParam0) // Position - 0x2600
{
	Global_1900460 = Global_1900460 || bParam0;
	return;
}

int func_81(var uParam0, var uParam1) // Position - 0x2613
{
	return func_196(func_195(uParam0));
}

int func_82(var uParam0, var uParam1) // Position - 0x2627
{
	return uParam0;
}

int func_83() // Position - 0x2631
{
	return Global_1572887.f_14;
}

void func_84(int iParam0, var uParam1) // Position - 0x263F
{
	int data;
...
int func_86(int iParam0) // Position - 0x26BF
{
	switch (iParam0)
	{
		case 0:
...
int func_87(int iParam0) // Position - 0x2AC9
{
	switch (iParam0)
	{
		case 0:
...
void func_88(int iParam0, var uParam1, int iParam2) // Position - 0x2B95
{
	int data;
...
void func_89(int iParam0, Hash hParam1, Hash hParam2) // Position - 0x2BB6
{
...
BOOL func_90() // Position - 0x2BD2
{
	return Global_1149172 == 3;
}

BOOL func_91(var uParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2BE0
{
...
BOOL func_92(int iParam0) // Position - 0x2D09
{
	return func_200(1, iParam0);
}

BOOL func_93() // Position - 0x2D18
{
	return Global_1572887.f_72.f_40 != 1;
}

BOOL func_94(var uParam0, var uParam1) // Position - 0x2D2A
{
...
char* func_96(int iParam0) // Position - 0x2D6B
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_97(int iParam0) // Position - 0x2D8A
{
	return Global_1149172.f_1[iParam0 /*27*/].f_14 == 2;
}

float func_98(int iParam0) // Position - 0x2DA0
{
	return Global_1149172.f_1[iParam0 /*27*/].f_6;
}

BOOL func_99(var uParam0) // Position - 0x2DB4
{
	float num;
...
void func_100(int iParam0) // Position - 0x2E5E
{
	if (!func_57(Global_1149172.f_145, iParam0))
...
int func_101(int iParam0, BOOL bParam1) // Position - 0x2E82
{
	if (bParam1)
		func_206();
...
char* func_103(int iParam0) // Position - 0x2EE2
{
	switch (iParam0)
	{
		case -1:
...
void func_104(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, char* sParam10) // Position - 0x2F7E
{
	*uParam0 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam1, fParam4, fParam7, sParam10);
	return;
}

int func_105(Ped pedParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x2F9B
{
...
void func_106(BOOL bParam0) // Position - 0x2FDD
{
	if (func_209())
		Global_1958683 = true;
...
void func_107(var uParam0, BOOL bParam1) // Position - 0x3040
{
	char* str;
	var unk19;
	var unk23;
...
void func_108(int iParam0) // Position - 0x320E
{
	func_216(&(Global_1572887.f_72.f_15), iParam0);
	return;
}

int func_109(int iParam0) // Position - 0x3224
{
	if (iParam0 == 2)
		return -471827042;
...
int func_110(int iParam0, Player plParam1) // Position - 0x323B
{
	int num;
	Player player;
...
int func_111(int iParam0) // Position - 0x3275
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_112() // Position - 0x3290
{
	return Global_1896762.f_352;
}

int func_113(var uParam0, Hash hParam1, var uParam2, BOOL bParam3) // Position - 0x329F
{
	int num;
	BOOL flag;
	int eventData;
...
void func_114(BOOL bParam0) // Position - 0x3371
{
	int num;
	Any gangId;
...
void func_115(int iParam0) // Position - 0x3445
{
	func_220(&(Global_1572887.f_72.f_15), iParam0);
	return;
}

void func_116(var uParam0, var uParam1, BOOL bParam2) // Position - 0x345B
{
	if (!func_69(uParam0))
		return;
...
BOOL func_117() // Position - 0x349B
{
	return func_223(2) && func_224();
}

Vector3 func_118(int iParam0, var uParam1) // Position - 0x34B1
{
	switch (iParam0)
	{
		case 0:
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x3567
{
...
void func_120(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3591
{
...
void func_121(BOOL bParam0) // Position - 0x35AD
{
	if (!bParam0)
		func_227(18);
	else
...
int func_122(int iParam0) // Position - 0x35CC
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0x3605
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_126(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, int iParam6, int iParam7, BOOL bParam8, int iParam9, int iParam10) // Position - 0x3671
{
	int num;
	var unk22;
	var unk30;
...
const char* func_127(int iParam0) // Position - 0x38F4
{
	int num;
...
int func_128(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x3926
{
	int num;
	var unk13;
	int num2;
...
BOOL func_129() // Position - 0x3961
{
	return func_131(Global_1572887.f_8, 1);
}

char* func_130(int iParam0) // Position - 0x3974
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_131(BOOL bParam0, BOOL bParam1) // Position - 0x3994
{
	return bParam0 && bParam1 != false;
}

void func_132(BOOL bParam0) // Position - 0x39A3
{
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0x3A01
{
	Any any;
...
void func_135(int iParam0) // Position - 0x3A38
{
	func_216(&(Global_1572887.f_72.f_16), iParam0);
	return;
}

void func_136(var uParam0, var uParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3A4E
{
	int num;
	var unk;
...
int func_137(int iParam0) // Position - 0x3B25
{
	switch (iParam0)
	{
		case 2:
...
void func_138(int iParam0) // Position - 0x3B42
{
	int num;
	int num2;
...
BOOL func_139(var uParam0, var uParam1, var uParam2) // Position - 0x3C05
{
	...
	for (i = 0; i <= SCRIPTS::GET_NUMBER_OF_EVENTS(SCRIPT_EVENT_QUEUE_NETWORK) - 1; i = i + 1)
	{
		...
		switch (eventAtIndex)
		{
			case -1126217932:
				...
				{
					if (uParam0->f_9 == data && uParam0->f_9.f_1 == data.f_1 && uParam0->f_9.f_2 == data.f_2 && uParam0->f_9.f_3 == data.f_3)
					{
						*uParam2 = data.f_5;
...
void func_140(var uParam0, int iParam1, int iParam2) // Position - 0x3CA0
{
...
void func_141(var uParam0) // Position - 0x3CC4
{
	if (!func_13(uParam0, 128))
	{
		func_255(131072);
...
var func_142(int iParam0) // Position - 0x3CE8
{
	return Global_1149172.f_1[iParam0 /*27*/].f_10;
}

int* func_143(int iParam0, int iParam1) // Position - 0x3CFC
{
	return Global_1149172.f_1[iParam0 /*27*/].f_15[iParam1 /*3*/].f_1;
}

BOOL func_144(int iParam0) // Position - 0x3D16
{
	return Global_1149172.f_1[iParam0 /*27*/].f_1 == 2;
}

void func_145(int iParam0) // Position - 0x3D2C
{
...
void func_146(int iParam0, int iParam1) // Position - 0x3D47
{
...
void func_147() // Position - 0x3D7D
{
	Global_1072759.f_28644.f_109 = MISC::GET_GAME_TIMER();
	return;
}

int func_148() // Position - 0x3D92
{
...
BOOL func_150(BOOL bParam0) // Position - 0x3DDD
{
	return Global_1572887.f_72.f_15 && bParam0 != false;
}

void func_151(var uParam0) // Position - 0x3DF2
{
	int i;
...
char* func_152(var uParam0) // Position - 0x3EB7
{
	switch (uParam0->f_1)
	{
		case 0:
...
Vector3 func_153(int iParam0) // Position - 0x3F0D
{
	var unk;
...
BOOL func_154(char* sParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x3F39
{
...
BOOL func_155(int iParam0, int iParam1) // Position - 0x3F82
{
	if (iParam0 != Global_1149172.f_137)
		return false;
...
int func_156(int iParam0) // Position - 0x3FA7
{
	if (iParam0 != Global_1149172.f_137)
		return 0;
...
void func_157(int iParam0, int iParam1) // Position - 0x3FC6
{
	if (iParam0 != Global_1149172.f_137)
		return;
...
int func_158(int iParam0) // Position - 0x3FE6
{
	if (iParam0 != Global_1149172.f_137)
		return 0;
...
int func_160() // Position - 0x4053
{
	return Global_1149172.f_137;
}

Entity func_161(int iParam0) // Position - 0x4061
{
	if (iParam0 != Global_1149172.f_137)
		return 0;
...
BOOL func_163(int iParam0) // Position - 0x409B
{
	return func_200(48, iParam0);
}

BOOL func_164(var uParam0, var uParam1, var uParam2, Vector3* pvParam3, float* pfParam4) // Position - 0x40AB
{
	Hash* p_hash;
	int MaxInt;
	int randomIntInRange;

	p_hash = Global_1072759.f_23824.f_383[func_258(uParam0) /*272*/];
	MaxInt = func_259(p_hash);
	...
	else
	{
		...
		if (func_260(p_hash, randomIntInRange, pvParam3, pfParam4))
			return true;
	}
...
Vector3 func_165(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x40FC
{
	switch (iParam0)
	{
		case 0:
...
void func_167(int iParam0) // Position - 0x482D
{
...
void func_168(int iParam0, BOOL bParam1) // Position - 0x485E
{
	if (bParam1)
	{
...
void func_169(var uParam0) // Position - 0x48BB
{
	...
	StringToTest = func_267(Global_1149318.f_2.f_1, Global_1149318.f_2, Global_1149318.f_2.f_2);

	if (MISC::IS_STRING_NULL_OR_EMPTY(StringToTest))
		return;

	uParam0->f_15 = func_128(StringToTest, 10000, 0, 0, 0, true);
	return;
}

void func_170() // Position - 0x4915
{
...
void func_171(BOOL bParam0) // Position - 0x4936
{
	if (bParam0)
		func_228(49);
	else
...
void func_172(int iParam0, int iParam1) // Position - 0x4954
{
	func_268(iParam0, iParam1);
	return;
}

int func_173(int iParam0) // Position - 0x4964
{
	return iParam0;
}

void func_174(int iParam0) // Position - 0x496E
{
	if (!func_269(iParam0))
		return;
...
void func_175(var uParam0, int iParam1) // Position - 0x4A21
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_176(int iParam0) // Position - 0x4A36
{
	switch (iParam0)
	{
		case 2:
...
int func_177(int iParam0) // Position - 0x4A75
{
	switch (iParam0)
	{
		case 2:
...
int func_178(var uParam0, var uParam1) // Position - 0x4B0B
{
	var unk;
	var unk4;
	int num;
...
Hash func_179(var uParam0, var uParam1) // Position - 0x4BB2
{
	int num;
...
BOOL func_180() // Position - 0x4BDC
{
	return !Global_1572887.f_10;
}

BOOL func_181() // Position - 0x4BEB
{
...
void func_182(Hash hParam0, int iParam1) // Position - 0x4BFF
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

int func_183(int iParam0) // Position - 0x4C12
{
	switch (iParam0)
	{
		case 2:
...
char* func_184(var uParam0, var uParam1, var uParam2) // Position - 0x4C85
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

void func_185(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x4C99
{
	int num;
	int i;
	int num2;
...
int func_186(var uParam0, var uParam1) // Position - 0x4DAB
{
	int num;
...
int func_187(var uParam0, var uParam1, int iParam2) // Position - 0x4DCD
{
	var unk;
	var unk4;
	var unk7;
...
void func_189(int iParam0, int iParam1) // Position - 0x4F83
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

void func_190(int iParam0, int iParam1) // Position - 0x4F98
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

Hash func_191(int iParam0, int iParam1) // Position - 0x4FA9
{
	switch (iParam0)
	{
		case 0:
...
void func_192(var uParam0, var uParam1, var uParam2) // Position - 0x52FE
{
	Global_1939102.f_75.f_67 = { uParam0 };
	return;
}

void func_193() // Position - 0x5314
{
	TEXT_LABEL_ASSIGN_STRING(&(Global_1939102.f_75.f_67), "", 24);
	return;
}

BOOL func_194(int iParam0) // Position - 0x5329
{
	int num;
	int num2;
	int offset;
...
int func_195(var uParam0, var uParam1) // Position - 0x53A8
{
	int i;
...
int func_196(int iParam0) // Position - 0x53F3
{
	if (iParam0 < 0)
		return 0;
...
BOOL func_197(BOOL bParam0) // Position - 0x545E
{
...
BOOL func_198(BOOL bParam0, int iParam1) // Position - 0x547F
{
...
BOOL func_200(int iParam0, int iParam1) // Position - 0x5513
{
	int num;
...
BOOL func_201(var uParam0) // Position - 0x5587
{
	if (!func_284())
		return false;
	else if (func_129())
...
int func_202(const char* sParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, Hash hParam15, int iParam16) // Position - 0x570C
{
	int i;
	int num;
	int num2;
...
BOOL func_203(var uParam0) // Position - 0x57EA
{
	var unk;
	int num;
...
void func_204(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x599E
{
	int num;
...
BOOL func_205(int iParam0, BOOL bParam1) // Position - 0x59F2
{
	int num;
	int gameTimer;
	float progress;
...
BOOL func_207(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5B03
{
	BOOL flag;
...
void func_208(int iParam0) // Position - 0x5B2B
{
	Global_1896762.f_365 = iParam0;
	return;
}

BOOL func_209() // Position - 0x5B3C
{
...
BOOL func_210(Hash hParam0) // Position - 0x5B67
{
	int i;
...
void _STOPWATCH_RESET(var pStopwatch, BOOL useLocalTimer, BOOL useAccurateTime) // Position - 0x5BA7
{
...
const char* func_212(var uParam0, var uParam1) // Position - 0x5BE4
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

const char* func_213(var uParam0, int iParam1) // Position - 0x5BF8
{
...
int func_214(Any* panParam0, var uParam1, const char* sParam2, int iParam3, BOOL bParam4) // Position - 0x5C2E
{
	int num;
	int num2;
...
int func_215(Any* panParam0, var uParam1, const char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x5C54
{
	int num;
	int num2;
...
void func_216(BOOL bParam0, int iParam1) // Position - 0x5C80
{
	*bParam0 = *bParam0 || iParam1;
	return;
}

BOOL func_217(int iParam0, var uParam1) // Position - 0x5C91
{
	switch (iParam0)
	{
		case -471827042:
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x5CE2
{
	return uParam0->f_1;
}

int func_219(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5CEE
{
...
void func_220(BOOL bParam0, int iParam1) // Position - 0x5D35
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_221(var uParam0, var uParam1) // Position - 0x5D4A
{
	return func_71(uParam0) == 0;
}

void func_222(var uParam0, var uParam1) // Position - 0x5D5C
{
...
BOOL func_223(int iParam0) // Position - 0x5D9F
{
	return Global_1102813.f_3520 && iParam0 != false;
}

BOOL func_224() // Position - 0x5DB3
{
	return func_223(4);
}

BOOL func_225(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x5DC0
{
...
void func_226(BOOL bParam0, BOOL bParam1) // Position - 0x5E47
{
	if (func_307(255) == 4)
		return;
...
int func_227(int iParam0) // Position - 0x5F92
{
...
int func_228(int iParam0) // Position - 0x5FAF
{
...
BOOL func_229(int iParam0, int iParam1) // Position - 0x5FCC
{
...
BOOL func_230(Player plParam0) // Position - 0x5FF0
{
	Any gangId;
...
void func_231(Any* panParam0) // Position - 0x601A
{
	MISC::COPY_SCRIPT_STRUCT(&(Global_1572887.f_72.f_17), panParam0, 22);
	return;
}

void func_232(int iParam0, BOOL bParam1) // Position - 0x6032
{
...
void func_233(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x604D
{
...
void func_234(var uParam0, var uParam1, BOOL bParam2) // Position - 0x607A
{
...
void func_235(int iParam0) // Position - 0x6099
{
	Global_1572887.f_72.f_15 = iParam0;
	return;
}

void func_236(int iParam0) // Position - 0x60AB
{
	Global_1572887.f_72.f_13 = iParam0;
	return;
}

void func_237() // Position - 0x60BD
{
	Ped PedIndex;
	var entityCoords;
...
int func_239(var uParam0, var uParam1) // Position - 0x6127
{
	if (func_68())
		return 0;
...
void func_240() // Position - 0x6155
{
	Global_1056554[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*491*/].f_15.f_12 = 0;
	return;
}

void func_241(var uParam0, var uParam1) // Position - 0x616D
{
	int num;
	int num2;
	int num3;
...
int func_242(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x6215
{
	int num;
	int num2;
	int num3;
...
char* func_243(int iParam0) // Position - 0x64DB
{
	Hash hash;
...
int func_244() // Position - 0x6631
{
	return Global_1572887.f_72;
}

char* func_245(int iParam0, int iParam1) // Position - 0x663F
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_246(int iParam0, BOOL bParam1) // Position - 0x671A
{
	BOOL flag;
...
int func_247(char* sParam0) // Position - 0x67A1
{
	const char* str;
	int num;
...
void func_248(int iParam0) // Position - 0x67C3
{
	Global_1572887.f_72.f_40 = iParam0;
	return;
}

Any func_249(int iParam0, int iParam1) // Position - 0x67D5
{
	return Global_1149172.f_1[iParam0 /*27*/].f_15[iParam1 /*3*/];
}

void func_250(var uParam0, var uParam1) // Position - 0x67ED
{
	Hash hash;
	var unk;
...
int func_251(var uParam0, var uParam1, int iParam2) // Position - 0x6896
{
	int num;
...
BOOL func_252(int iParam0) // Position - 0x6907
{
	return Global_1572864.f_3 && iParam0 != false;
}

int func_253(var uParam0, var uParam1, BOOL bParam2) // Position - 0x691A
{
	int num;
...
BOOL func_254(int iParam0, var uParam1, var uParam2) // Position - 0x698E
{
	var unk;
...
void func_255(int iParam0) // Position - 0x69C2
{
	if (!func_57(Global_1072759.f_21353.f_1[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*8*/].f_7, iParam0))
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x69FC
{
	uParam0->f_1 = 0;
	return;
}

struct<10> func_257(int iParam0) // Position - 0x6A09
{
	var unk;
...
int func_258(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x6A36
{
	int i;
	int num;
	float num2;
...
int func_259(Hash* phParam0) // Position - 0x6A93
{
	Any any;
...
BOOL func_260(Hash* phParam0, int iParam1, Vector3* pvParam2, float* pfParam3) // Position - 0x6ABF
{
	Any any;
...
void func_261(var uParam0) // Position - 0x6B21
{
	var unk;
...
void func_262(float* pfParam0) // Position - 0x6B33
{
	var unk;
...
void func_263(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, int iParam30) // Position - 0x6B45
{
	switch (uParam0.f_5)
	{
		case 1:
...
void func_264(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x6B9B
{
	switch (uParam0.f_5)
	{
		case 1:
...
void func_265(int iParam0) // Position - 0x6BC8
{
	if (!func_341(iParam0))
...
BOOL func_266() // Position - 0x6BEA
{
	return Global_1149318.f_2 != 0;
}

const char* func_267(int iParam0, int iParam1, int iParam2) // Position - 0x6BFA
{
	int num;
...
void func_268(var uParam0, int iParam1) // Position - 0x6E01
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_269(int iParam0) // Position - 0x6E12
{
	return func_287(iParam0, 2);
}

BOOL func_270(int iParam0, var uParam1, Any* panParam2) // Position - 0x6E21
{
	if (!func_69(iParam0))
		return false;
...
int func_271(var uParam0, var uParam1) // Position - 0x6F2C
{
	var unk;
...
int func_272(int iParam0) // Position - 0x6F58
{
	int num;
	int num2;
...
int func_273(int iParam0) // Position - 0x6F83
{
	if (iParam0 == -1)
		return 0;
...
int func_274(int iParam0) // Position - 0x6F9D
{
	if (iParam0 == -1)
		return 0;
...
BOOL func_275(int iParam0, BOOL bParam1) // Position - 0x6FB9
{
	switch (iParam0)
	{
...
int func_276(int iParam0) // Position - 0x7021
{
	int i;
	var unk;
...
int func_277(int iParam0) // Position - 0x70C2
{
	int num;
	var unk;
...
int func_278(int iParam0, int iParam1) // Position - 0x7156
{
	switch (iParam0)
	{
...
BOOL func_279(int iParam0) // Position - 0x89FC
{
	int num;
...
BOOL func_280(int iParam0) // Position - 0x8A19
{
...
void func_281(int iParam0, int iParam1) // Position - 0x8A30
{
	int i;
...
BOOL func_282(Any* panParam0, int iParam1, int iParam2) // Position - 0x8AAA
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_283() // Position - 0x8AE1
{
	return Global_1102813.f_3672;
}

BOOL func_284() // Position - 0x8AF0
{
	if (Global_1572887.f_14 == -1)
		return false;
...
BOOL func_285(int iParam0, BOOL bParam1) // Position - 0x8B0C
{
...
BOOL func_286(var uParam0) // Position - 0x8B57
{
	float ReturnZ;

	if (!MISC::GET_GROUND_Z_FOR_3D_COORD(Global_34, &ReturnZ, false))
		return false;

	if (uParam0->f_2 == 0 && MISC::ABSF(ReturnZ - uParam0->f_77) > 0.5f)
		return false;

	if (BUILTIN::VDIST(Global_34, Global_34, Global_34.f_1, ReturnZ) > 1.2f)
		return false;

	return true;
}

BOOL func_287(int iParam0, int iParam1) // Position - 0x8BB7
{
	if (iParam0 < 0)
		return false;
...
BOOL func_288(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x8BD8
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_290(int iParam0) // Position - 0x8F47
{
	if (!func_144(iParam0))
		return false;
...
int func_291() // Position - 0x8F6B
{
	return Global_17418.f_3015.f_88;
}

BOOL func_292(int iParam0, int iParam1, Any anParam2) // Position - 0x8F7B
{
	int i;
	int num;
...
BOOL func_293(var uParam0) // Position - 0x8FF3
{
	return false;
}

char* func_294(int iParam0) // Position - 0x8FFC
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_295(Player plParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x9080
{
	var data;
	int i;
	Hash crimeType;
...
int func_297(int iParam0, int iParam1) // Position - 0x9242
{
	int num;
...
BOOL func_298(int iParam0) // Position - 0x9260
{
	if (iParam0 < 0)
		return false;
...
void func_299(int iParam0, int iParam1) // Position - 0x928D
{
	if (iParam0 < 0)
		return;
...
void func_300(int iParam0, BOOL bParam1) // Position - 0x92C0
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_301(int iParam0, BOOL bParam1) // Position - 0x9318
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_302(int iParam0, int iParam1) // Position - 0x9341
{
	if (iParam0 < 0)
		return;
...
BOOL func_303() // Position - 0x9369
{
	return Global_1915656.f_20643;
}

BOOL func_304(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x9378
{
	Player PlayerIndex;
	Ped EntityIndex;
	BOOL isEntityDead;
...
void func_305(int iParam0) // Position - 0x959D
{
	var unk;
...
const char* func_306(const char* sParam0, int iParam1) // Position - 0x95FD
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

int func_307(int iParam0) // Position - 0x9617
{
	if (iParam0 == 255)
...
void func_308(var uParam0) // Position - 0x9662
{
	var unk;
...
void func_309(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x9674
{
	switch (uParam0.f_5)
	{
		case 1:
...
void func_310(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x96A1
{
	func_354(iParam0);
...
BOOL func_311(Any* panParam0, int iParam1, int iParam2) // Position - 0x9703
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_312(Any* panParam0, int iParam1, int iParam2) // Position - 0x9735
{
	int num;
	int offset;
	BOOL isBitSet;
...
int func_314(var uParam0, var uParam1) // Position - 0x987D
{
	int i;
...
int func_315(int iParam0) // Position - 0x98B6
{
	return Global_1206497.f_78[iParam0 /*20*/].f_3;
}

int func_316(int iParam0) // Position - 0x98CA
{
	return Global_1205938.f_1[iParam0 /*26*/].f_3;
}

struct<8> func_317(int iParam0, int iParam1) // Position - 0x98DE
{
	var unk;
	var unk9;
...
void func_318(var uParam0, int iParam1) // Position - 0x992A
{
	uParam0->f_15 = uParam0->f_15 || iParam1;
	return;
}

int func_319(Hash hParam0) // Position - 0x993D
{
	int i;
...
void func_320(char* sParam0) // Position - 0x9994
{
	TEXT_LABEL_ASSIGN_STRING(&(Global_1572887.f_72.f_60.f_6), sParam0, 32);
	return;
}

BOOL func_321(int iParam0) // Position - 0x99AA
{
...
BOOL func_322(int iParam0) // Position - 0x99C2
{
...
int func_323(Hash hParam0) // Position - 0x99DA
{
	int i;
...
Vector3 func_324(int iParam0) // Position - 0x9A13
{
	int num;
	int num2;
	int i;
...
struct<2> func_325(int iParam0) // Position - 0x9AF8
{
...
BOOL func_326(int iParam0) // Position - 0x9B25
{
	if (iParam0 == 0)
		return false;
...
int func_327(int iParam0) // Position - 0x9B3F
{
	int i;
	int num;
...
struct<2> func_328(int iParam0) // Position - 0x9B71
{
	return func_373(iParam0);
}

struct<2> func_329(var uParam0) // Position - 0x9B7F
{
	var unk;
	var unk6;
...
struct<2> func_330(int iParam0) // Position - 0x9C19
{
	var unk;
...
struct<2> func_331(int iParam0) // Position - 0x9CE9
{
	var unk;
	var unk6;
...
int func_332(int iParam0) // Position - 0x9D3B
{
	switch (iParam0)
	{
		case -933924539:
...
void func_333(var uParam0) // Position - 0x9D76
{
	uParam0->f_15 = 0;
	return;
}

Hash func_334(Hash hParam0) // Position - 0x9D83
{
	int i;
...
int func_335(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x9DC7
{
	int num;
	var unk13;
	int num2;
...
void func_336(var uParam0, var uParam1, int iParam2) // Position - 0x9E02
{
	if (!func_69(uParam0))
...
BOOL func_337(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x9E43
{
	int num;
	int num2;
...
BOOL func_338(int iParam0, var uParam1, var uParam2) // Position - 0x9F4A
{
	var unk;
...
int func_339(int iParam0) // Position - 0x9F7F
{
	switch (iParam0)
	{
		case 0:
...
int func_340(int iParam0, var uParam1) // Position - 0x9FC7
{
	*uParam1 = iParam0;
...
BOOL func_341(int iParam0) // Position - 0xA3CF
{
	return SCRIPTS::_IS_PLAYER_BIT_SET_AT_INDEX(&(Global_1072759.f_21353.f_260), iParam0);
}

const char* func_342(int iParam0, int iParam1, BOOL bParam2) // Position - 0xA3E7
{
	var unk;
...
void func_343(Any* panParam0) // Position - 0xA4D4
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
...
BOOL func_344(Any* panParam0, int iParam1) // Position - 0xA4EA
{
...
int func_346(int iParam0) // Position - 0xA559
{
	return func_382(iParam0) + 30;
}

void func_347(int iParam0, int iParam1) // Position - 0xA569
{
	var unk;
...
BOOL func_348(int iParam0, int iParam1) // Position - 0xA5B6
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_349(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xA605
{
...
BOOL func_350(int iParam0, Player plParam1) // Position - 0xA6A3
{
	if (plParam1 == 255)
...
BOOL func_351(int iParam0) // Position - 0xA6CF
{
	if (iParam0 < 0)
		return false;
...
void func_359(BOOL bParam0) // Position - 0xA7C6
{
	if (func_383(bParam0))
		return;
...
BOOL func_360(Any* panParam0, int iParam1) // Position - 0xA7ED
{
...
BOOL func_361(Any* panParam0) // Position - 0xA82F
{
	panParam0->f_2 = -310067910;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam0->f_1), panParam0);
}

BOOL func_362(Any* panParam0, int iParam1) // Position - 0xA84A
{
...
BOOL func_363(Any* panParam0) // Position - 0xA86B
{
	panParam0->f_2 = 1701407264;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(panParam0->f_1), panParam0);
}

int func_364(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, char* sParam6, BOOL bParam7) // Position - 0xA886
{
	uParam0.f_2 = iParam5;
...
int func_365(int iParam0, int iParam1) // Position - 0xA8AC
{
	switch (iParam0)
	{
		case -1957416901:
...
int func_366(int iParam0, int iParam1) // Position - 0xA93E
{
	switch (iParam0)
	{
		case -1918441640:
...
Hash func_367(int iParam0) // Position - 0xAA28
{
	if (!func_385(iParam0))
		return 0;
...
BOOL func_368(Any* panParam0) // Position - 0xAA54
{
	int fileHandle;
	var SourceStruct;
...
BOOL func_369(Any* panParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xAA96
{
	var unk;
...
int func_370(Any anParam0, int iParam1) // Position - 0xAACF
{
	anParam0->f_2 = iParam1;
	return DATAFILE::_PARSEDDATA_RQ_GET_NUM_NODES(anParam0);
}

struct<2> func_371() // Position - 0xAAE3
{
	var unk;
...
int func_372(int iParam0) // Position - 0xAAFC
{
	return Global_1295849[iParam0 /*37*/].f_9;
}

struct<2> func_373(int iParam0) // Position - 0xAB0E
{
	var DestStruct;
...
var func_374(Any* panParam0) // Position - 0xAB38
{
	return func_386(panParam0, 67, 1);
}

struct<2> func_375(var uParam0, int iParam1) // Position - 0xAB49
{
	int num;
...
BOOL func_376(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0xAC6F
{
...
void func_377(int iParam0, Any* panParam1, var uParam2) // Position - 0xACA0
{
	int num;
...
int func_378(var uParam0, var uParam1, BOOL bParam2, int iParam3, int iParam4) // Position - 0xAEFB
{
	Hash hash;
...
BOOL func_379(int iParam0) // Position - 0xAF49
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_380(int iParam0, var uParam1, Any* panParam2) // Position - 0xAF88
{
...
void func_381(int iParam0, var uParam1) // Position - 0xAFBC
{
	*uParam1 = 0;
	uParam1->f_1 = 0;
...
int func_382(int iParam0) // Position - 0xB009
{
	return iParam0 * 31;
}

BOOL func_383(BOOL bParam0) // Position - 0xB015
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

int func_384(int iParam0) // Position - 0xB02B
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_385(int iParam0) // Position - 0xB146
{
	return iParam0 > -1 && iParam0 <= 80;
}

var func_386(Any* panParam0, int iParam1, int iParam2) // Position - 0xB15C
{
	var unk;
...
int func_387(var uParam0, Any* panParam1, int iParam2) // Position - 0xB177
{
	int num;
	int num2;
	int num3;
...
int func_388(int iParam0) // Position - 0xB1CC
{
	int num;
...
int func_389(int iParam0, var uParam1) // Position - 0xB341
{
	var unk;
...
int func_390(int iParam0) // Position - 0xB35E
{
	switch (iParam0)
	{
		case joaat("IWD_INF"):
...
int func_391(int iParam0) // Position - 0xB4B4
{
	switch (iParam0)
	{
...
int func_392(int iParam0) // Position - 0xB50B
{
	switch (iParam0)
	{
...
int func_393(int iParam0) // Position - 0xB5E5
{
	switch (iParam0)
	{
		case -1641798436:
...
int func_394(int iParam0) // Position - 0xB67D
{
	switch (iParam0)
	{
		case -1968391995:
...
int func_395(var uParam0, var uParam1) // Position - 0xB827
{
	int i;
...
void func_396(var uParam0, BOOL bParam1, int iParam2) // Position - 0xB874
{
...
BOOL func_397(int iParam0, var uParam1, var uParam2) // Position - 0xB8AE
{
	var unk;
...
void func_398(var uParam0, int iParam1) // Position - 0xB8D5
{
	int num;
	int num2;
	var unk;
...
void func_399(int iParam0) // Position - 0xB9A9
{
...
BOOL func_401(int iParam0, var uParam1, Any* panParam2) // Position - 0xBA16
{
	*panParam2 = Global_1149432.f_7;
...
void func_402(Any* panParam0, int iParam1, var uParam2) // Position - 0xBA4A
{
	var unk;
...
int func_403(int iParam0) // Position - 0xBAC4
{
	int i;
