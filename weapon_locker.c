...
void func_1() // Position - 0x38
{
	TELEMETRY::_TELEMETRY_START_GUN_LOCKER_INTERACTION();
	return;
}

int func_2(int* piParam0) // Position - 0x44
{
...
void func_3(var uParam0) // Position - 0x95
{
...
int func_4(var uParam0) // Position - 0xD4
{
...
void func_5(int* piParam0) // Position - 0xEE
{
	BOOL flag;
...
void func_6(int* piParam0, Hash hParam1) // Position - 0x142
{
	piParam0->f_1 = hParam1;
	return;
}

BOOL func_7(int* piParam0) // Position - 0x150
{
...
BOOL func_8(int* piParam0) // Position - 0x1B7
{
	var unk;
	char* str;
	int i;
...
void func_9(int* piParam0, Hash hParam1) // Position - 0x24B
{
...
void func_10(int* piParam0) // Position - 0x296
{
	WEAPON::_HOLSTER_PED_WEAPONS(Global_33, false, false, true, false);
	return;
}

int func_11(BOOL bParam0, Hash hParam1) // Position - 0x2A9
{
...
void func_12() // Position - 0x2FF
{
	TELEMETRY::_TELEMETRY_GUN_LOCKER();
	return;
}

void func_13(var uParam0) // Position - 0x30B
{
...
BOOL func_14(var uParam0) // Position - 0x32C
{
...
BOOL func_15(var uParam0) // Position - 0x34D
{
	!func_33(uParam0);
	return true;
}

BOOL func_16(Hash hParam0) // Position - 0x360
{
...
void func_17(int* piParam0) // Position - 0x3A4
{
	var eventData;
...
void func_18(int* piParam0) // Position - 0x3FB
{
	var unk;
...
BOOL func_19(int* piParam0, var uParam1) // Position - 0x424
{
...
BOOL func_20(var uParam0, var uParam1, var uParam2) // Position - 0x4A6
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(*uParam1))
		return false;
...
BOOL func_21(var uParam0, var uParam1) // Position - 0x52F
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(*uParam1))
		return false;
...
void func_22(var uParam0, var uParam1) // Position - 0x58A
{
	int i;
...
char* func_23(int iParam0) // Position - 0x5BE
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_24(var uParam0, var uParam1, char* sParam2) // Position - 0x606
{
	var unk;
...
Hash _STOPWATCH_IS_INITIALIZED(int* piParam0) // Position - 0x65F
{
	return piParam0->f_1;
}

void func_26(int* piParam0, int iParam1) // Position - 0x66B
{
	switch (iParam1)
	{
		case -488492526:
...
void func_27(int* piParam0, int iParam1) // Position - 0x68A
{
	switch (iParam1)
	{
		case -488492526:
...
void func_28(int* piParam0, int iParam1) // Position - 0x6AD
{
	switch (iParam1)
	{
		case -488492526:
...
void func_29(int* piParam0, int iParam1) // Position - 0x6CC
{
	switch (iParam1)
	{
		case -488492526:
...
BOOL func_30() // Position - 0x6F5
{
	return !Global_1572887.f_10;
}

BOOL func_31() // Position - 0x704
{
...
void func_32(Hash hParam0, int iParam1) // Position - 0x718
{
	hParam0->f_2 = hParam0->f_2 || iParam1;
	return;
}

BOOL func_33(var uParam0) // Position - 0x72B
{
	return true;
}

void func_34(int* piParam0, Any* panParam1) // Position - 0x734
{
	int num;
...
BOOL func_35(int* piParam0) // Position - 0x92A
{
	return piParam0->f_97 != 0;
}

struct<4> func_36(int* piParam0) // Position - 0x938
{
	return piParam0->f_97;
}

void func_37(int* piParam0) // Position - 0x946
{
	var unk;
...
struct<16> func_38(char* sParam0) // Position - 0x969
{
	var unk;
...
void func_39(int* piParam0) // Position - 0x97C
{
	return;
}

void func_40(var uParam0) // Position - 0x984
{
	if (!func_54(uParam0))
		return;
...
void func_41(int* piParam0) // Position - 0x99E
{
	int num;
...
void func_42(var uParam0, var uParam1) // Position - 0x9F7
{
	int num;
...
int func_43(int* piParam0) // Position - 0xA49
{
...
BOOL func_44(var uParam0) // Position - 0xA70
{
	return uParam0->f_6;
}

int func_45(int* piParam0, Any* panParam1) // Position - 0xA7C
{
	if (*panParam1 == 0)
		return 0;
...
BOOL func_46(int* piParam0, var uParam1) // Position - 0xA9B
{
	Hash hash;
	Hash hash2;
	var unk;
...
BOOL func_47(var uParam0, var uParam1) // Position - 0xAF8
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(*uParam1))
		return false;
...
void func_48(int* piParam0, int iParam1) // Position - 0xB6F
{
	switch (iParam1)
	{
		case -2060496899:
...
BOOL func_49(var uParam0, int iParam1) // Position - 0xBB7
{
	Hash hash;
	Hash hash2;
...
void func_50(int* piParam0, int iParam1, BOOL bParam2) // Position - 0xC0A
{
	if (bParam2)
...
BOOL func_51(var uParam0) // Position - 0xC2A
{
	Hash hash;
	Hash hash2;
	var unk;
...
BOOL func_52(var uParam0) // Position - 0xC99
{
	Hash hash;
	Hash hash2;
	var unk;
...
void func_53(int* piParam0) // Position - 0xD08
{
	func_75(&(piParam0->f_2.f_9));
	return;
}

BOOL func_54(var uParam0) // Position - 0xD1A
{
	return uParam0->f_5;
}

BOOL func_55(int* piParam0, int iParam1) // Position - 0xD26
{
	return func_76(*piParam0, iParam1);
}

int func_56(int* piParam0) // Position - 0xD37
{
	return func_61(&(piParam0->f_2.f_13));
}

// Unhandled jump detected. Output should be considered invalid
BOOL func_57(int* piParam0, int iParam1) // Position - 0xD49
{
	int num;
	int num2;
	var unk;
...
void func_58(int* piParam0) // Position - 0xE62
{
	int num;
...
void func_59(int* piParam0, int iParam1) // Position - 0xE96
{
	int num;
...
void func_60(int* piParam0, int iParam1) // Position - 0xEF9
{
	int num;
	int num2;
...
int func_61(var uParam0) // Position - 0xF6E
{
	if (!uParam0->f_5)
		return -1;
...
BOOL func_62(var uParam0, int iParam1) // Position - 0xF8A
{
...
void func_63(var uParam0, var uParam1, int iParam2) // Position - 0xFAB
{
...
struct<4> func_64(BOOL bParam0) // Position - 0xFC9
{
	int num;
...
struct<4> func_65(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x106A
{
	var outGuid;
...
BOOL func_66(Any* panParam0) // Position - 0x109B
{
...
int func_67(int* piParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x10D1
{
	if (!func_66(&uParam1))
		return 0;
...
BOOL func_68(int* piParam0, int iParam1) // Position - 0x10F5
{
	char* str;
	var guid;
	var unk4;
...
BOOL func_69(Hash hParam0, int iParam1) // Position - 0x11EB
{
	if (hParam0 == 0)
		return false;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_70(Hash hParam0, Hash hParam1, int iParam2) // Position - 0x1205
{
	int num;
	var guid;
	var unk4;
...
void func_71(int* piParam0, int iParam1) // Position - 0x13A7
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

void func_72(int* piParam0, int iParam1) // Position - 0x13B7
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

BOOL func_73(Any* panParam0) // Position - 0x13C7
{
	var guid2;
...
BOOL func_74(Any* panParam0) // Position - 0x142F
{
	var guid2;
...
void func_75(var uParam0) // Position - 0x14A1
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
BOOL func_76(int iParam0, int iParam1) // Position - 0x14BC
{
	return MISC::IS_BIT_SET(iParam0, iParam1);
}

BOOL func_77(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x14CC
{
...
BOOL func_78(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x14F3
{
	if (iParam2 < 0)
		return false;
...
BOOL func_79(Hash hParam0) // Position - 0x152E
{
	if (!func_69(hParam0, 0))
		return false;
...
int func_80(Hash hParam0) // Position - 0x156E
{
	if (!func_79(hParam0))
		return -1;
...
int func_81(Any* panParam0) // Position - 0x15E2
{
	var unk;
...
BOOL func_82(int* piParam0, int iParam1, Hash hParam2, Hash hParam3, int iParam4, int iParam5) // Position - 0x164C
{
	var unk;
	BOOL flag;
	var unk57;
...
BOOL func_83(int* piParam0, int iParam1) // Position - 0x16F9
{
	int arrayCount;
	int i;
...
BOOL func_84(int iParam0) // Position - 0x1760
{
	if (iParam0 < 0)
		return false;
...
int func_85(int* piParam0) // Position - 0x1781
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(piParam0->f_2.f_1))
		return 0;
...
int func_86(var uParam0, BOOL bParam1) // Position - 0x17A5
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(*uParam0))
		return 0;
...
int func_87(var uParam0) // Position - 0x17C7
{
...
int func_88(int* piParam0, BOOL bParam1) // Position - 0x17FD
{
...
int func_89(int* piParam0, Hash hParam1) // Position - 0x1824
{
...
var func_90(int* piParam0) // Position - 0x184B
{
	return piParam0->f_101.f_1;
}

int func_91(int iParam0) // Position - 0x1859
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_92(int* piParam0, int iParam1, var uParam2) // Position - 0x18A2
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(piParam0->f_2.f_1))
		return false;
...
BOOL func_93(int* piParam0, Any* panParam1) // Position - 0x18EA
{
	if (*panParam1 == 0)
		return false;
...
const char* func_94(var uParam0, int iParam1) // Position - 0x1915
{
	return func_112(uParam0->[iParam1 /*17*/]);
}

void func_95(var uParam0, const char* sParam1) // Position - 0x192A
{
	DATABINDING::_DATABINDING_WRITE_DATA_STRING(uParam0->f_2, sParam1);
	return;
}

void func_96(var uParam0, int iParam1) // Position - 0x193C
{
	uParam0->[iParam1 /*17*/].f_16 = 1;
	return;
}

int func_97(BOOL bParam0) // Position - 0x194D
{
	if (func_113() == -1)
	{
...
struct<4> func_98(BOOL bParam0) // Position - 0x198E
{
	int num;
...
struct<4> func_99(int* piParam0) // Position - 0x1A2E
{
	return piParam0->f_2.f_9;
}

int func_100(Any* panParam0) // Position - 0x1A3E
{
	var unk;
	int num;
...
int func_101(int* piParam0, const char* sParam1) // Position - 0x1AA8
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(piParam0->f_93.f_2))
		return 0;
...
int func_102(Hash hParam0) // Position - 0x1ACF
{
	if (!func_69(hParam0, 0))
		return 0;
...
// Unhandled jump detected. Output should be considered invalid
// Unhandled jump detected. Output should be considered invalid
BOOL func_103(Hash hParam0, int iParam1, var uParam2) // Position - 0x1B32
{
	if (!func_69(hParam0, 0))
		return false;
...
BOOL func_104(int iParam0) // Position - 0x1BFC
{
	switch (iParam0)
	{
		case 3:
...
BOOL func_105(Any* panParam0, var uParam1, BOOL bParam2) // Position - 0x1C1D
{
	var guid2;
	var data;
	var outData;
...
int func_106(Hash hParam0) // Position - 0x1CF8
{
	if (!func_69(hParam0, 0))
		return 0;
...
BOOL func_107(Hash hParam0, int iParam1, int iParam2) // Position - 0x1D16
{
	if (!func_69(hParam0, 0))
		return false;
...
int func_108(Hash hParam0) // Position - 0x1D63
{
	if (!func_69(hParam0, 0))
		return 0;
...
BOOL func_109(Hash hParam0, Hash hParam1, var uParam2, int iParam3, int iParam4) // Position - 0x1D81
{
	var unk;
...
BOOL func_110(var uParam0, var uParam1) // Position - 0x1E90
{
	if (!DATABINDING::DATABINDING_IS_ENTRY_VALID(*uParam0))
		return false;
...
BOOL func_111(int* piParam0, var uParam1) // Position - 0x211E
{
	var unk;
	Any any;
...
const char* func_112(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x2184
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_113() // Position - 0x2198
{
	return Global_1572887.f_14;
}

struct<4> func_114() // Position - 0x21A6
{
	var unk;
...
BOOL func_116(int iParam0, var uParam1) // Position - 0x21D3
{
	switch (iParam0)
	{
		case 2:
...
char* func_117(Hash hParam0) // Position - 0x223E
{
	Hash labelHash;
...
int func_118(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0x2270
{
	int num;
	var unk13;
	int num2;
...
BOOL func_119(int iParam0, var uParam1, var uParam2) // Position - 0x22AB
{
	switch (iParam0)
	{
		case -649335959:
...
BOOL func_120(Hash hParam0, var uParam1) // Position - 0x22F0
{
	int num;
	var unk22;
	int num2;
...
BOOL func_121(Hash hParam0, Hash hParam1, var uParam2) // Position - 0x258F
{
	var unk;
	int num;
	int num2;
...
BOOL func_122(int iParam0, var uParam1) // Position - 0x26D3
{
	var unk;
	var unk2;
...
char* AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(int iParam0) // Position - 0x2704
{
	switch (iParam0)
	{
		case 0:
...
int func_124(var uParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10) // Position - 0x2C12
{
...
Hash func_127(Hash hParam0, BOOL bParam1) // Position - 0x2EC5
{
	Hash hash;
...
BOOL func_128(Hash hParam0) // Position - 0x2EF3
{
	return func_144(hParam0) == joaat("WEAPON");
}

struct<2> func_129(int iParam0, Hash hParam1) // Position - 0x2F07
{
	int num;
...
struct<5> func_130(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x2F1D
{
	var unk;
	int num;
	var unk6;
...
int func_131(Hash hParam0) // Position - 0x3291
{
	int num;
...
Hash func_132(Hash hParam0, int iParam1) // Position - 0x32C0
{
	int num;
	int num2;
...
Hash func_133(var uParam0, var uParam1, var uParam2, var uParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0x3304
{
	return func_152(&uParam0, hParam4, bParam5, iParam6);
}

BOOL func_134(Hash hParam0, Hash hParam1, BOOL bParam2) // Position - 0x3318
{
	var unk;
	var unk23;
...
int func_135(Any* panParam0, int iParam1) // Position - 0x336A
{
	var unk;
	var weaponGuid;
...
BOOL func_136(int iParam0, var uParam1) // Position - 0x3413
{
	switch (iParam0)
	{
		case 2:
...
BOOL func_137(int iParam0, var uParam1) // Position - 0x348A
{
	switch (iParam0)
	{
		case 2:
...
int func_138(Any* panParam0) // Position - 0x3519
{
	var unk;
...
int func_139(Any* panParam0) // Position - 0x35A2
{
	var unk;
...
BOOL func_140(int iParam0, var uParam1, var uParam2) // Position - 0x363A
{
	switch (iParam0)
	{
		case 0:
...
int func_142(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3746
{
...
Hash func_143(Hash hParam0, BOOL bParam1) // Position - 0x3779
{
	switch (hParam0)
	{
...
int func_144(Hash hParam0) // Position - 0x381B
{
	var unk;
...
int func_145(Hash hParam0, BOOL bParam1) // Position - 0x3846
{
...
BOOL func_146(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x387D
{
	return func_158(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_147(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x3898
{
	var unk;
...
struct<4> func_148(BOOL bParam0) // Position - 0x38B9
{
	int num;
...
int func_149(Hash hParam0) // Position - 0x3923
{
	var unk;
...
BOOL func_150(Hash hParam0, int iParam1) // Position - 0x394E
{
	Hash hash;
	int num;
	int i;
...
BOOL func_151(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x39BB
{
	return func_160(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_152(Any* panParam0, Hash hParam1, BOOL bParam2, int iParam3) // Position - 0x39D1
{
	var unk;
...
BOOL func_153(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x39FF
{
	int inventoryId;
...
BOOL func_154(Any* panParam0, var uParam1) // Position - 0x3A44
{
...
int func_155(Any* panParam0) // Position - 0x3A85
{
	var unk;
	int num;
...
BOOL func_157(Hash hParam0) // Position - 0x3C89
{
	return WEAPON::_IS_AMMO_VALID(hParam0);
}

int func_158(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x3C97
{
...
BOOL func_159(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x3D16
{
...
BOOL func_160(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x3D49
{
...
BOOL func_161(Any* panParam0, Hash hParam1, Any* panParam2, BOOL bParam3, int iParam4) // Position - 0x3D83
{
	var outGuid;
...
int func_162(Hash hParam0, int iParam1) // Position - 0x3DD1
{
	if (iParam1 == 0)
		return 0;
...
Hash func_163(Hash hParam0) // Position - 0x3DFD
{
	return hParam0;
}

BOOL func_164(Hash hParam0, int iParam1) // Position - 0x3E07
{
	if (hParam0 == 0)
		return false;
