...
int func_2() // Position - 0x40E
{
	return Global_1572887.f_14;
}

BOOL func_3(BOOL bParam0, BOOL bParam1) // Position - 0x41C
{
	int i;
...
BOOL func_4(int iParam0) // Position - 0x4FC
{
	return func_28(Global_1915656.f_20241.f_3, iParam0);
}

void func_5(int iParam0) // Position - 0x513
{
	func_29(&(Global_1915656.f_20241.f_3), iParam0);
	return;
}

void func_6(var uParam0) // Position - 0x52A
{
	Global_1915656.f_20241.f_3.f_19 = uParam0;
	return;
}

void func_7(var uParam0) // Position - 0x53F
{
	Global_1915656.f_20241.f_3.f_17 = uParam0;
	return;
}

void func_8(var uParam0) // Position - 0x554
{
	Global_1915656.f_20241.f_3.f_18 = uParam0;
	return;
}

void func_9(var uParam0) // Position - 0x569
{
	Global_1915656.f_20241.f_3.f_13 = *uParam0;
	return;
}

void func_10(var uParam0) // Position - 0x57F
{
...
char* func_12() // Position - 0x5AC
{
	return "uiItemID";
}

void func_13(Any anParam0) // Position - 0x5B6
{
	Global_1915656.f_20241.f_3.f_12 = anParam0;
	return;
}

char* func_14() // Position - 0x5CB
{
	return "uiItemEnum";
}

void func_15(var uParam0) // Position - 0x5D6
{
	Global_1915656.f_20241.f_3.f_16 = *uParam0;
	return;
}

void func_16(var uParam0) // Position - 0x5EC
{
	Global_1915656.f_20241.f_3.f_14 = uParam0;
	return;
}

int func_17() // Position - 0x601
{
	Any any;
...
void func_18(Any anParam0) // Position - 0x619
{
	Global_1915656.f_20241.f_3.f_15 = anParam0;
	return;
}

void func_19(var uParam0) // Position - 0x62E
{
...
void func_21(var uParam0) // Position - 0x65B
{
	Global_1915656.f_20241.f_3.f_10 = *uParam0;
	return;
}

void func_22(Any anParam0) // Position - 0x671
{
	Global_1915656.f_20241.f_3.f_9 = anParam0;
	return;
}

void func_23(var uParam0) // Position - 0x686
{
	Global_1915656.f_20241.f_3.f_1 = uParam0;
	return;
}

void func_24(var uParam0) // Position - 0x69B
{
	Global_1915656.f_20241.f_3.f_36 = uParam0;
	return;
}

BOOL func_25(var uParam0) // Position - 0x6B0
{
	BOOL flag;
...
BOOL func_26(var uParam0) // Position - 0x6D7
{
	BOOL flag;
...
void func_27() // Position - 0x6FE
{
	Global_1915656.f_20241.f_3 = 0;
	return;
}

BOOL func_28(int iParam0, int iParam1) // Position - 0x710
{
	return iParam0 && iParam1 != false;
}

void func_29(int iParam0, int iParam1) // Position - 0x71F
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

Any func_30() // Position - 0x730
{
	return Global_1915656.f_20241.f_3.f_13;
}

char* func_31() // Position - 0x743
{
	return "uiItemType";
}

Any func_32() // Position - 0x74E
{
	return Global_1915656.f_20241.f_3.f_16;
}

Any func_33() // Position - 0x761
{
