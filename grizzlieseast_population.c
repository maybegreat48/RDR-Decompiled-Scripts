...
void func_2() // Position - 0x154
{
	...
	iLocal_23 = MISC::_ADD_DISPATCH_SPAWN_BLOCKING_AREA(volLocal_22);
	return;
}

void func_3() // Position - 0x1C2
{
...
BOOL func_6(BOOL bParam0, BOOL bParam1) // Position - 0x32F
{
	int i;
...
void func_7() // Position - 0x40F
{
	func_14();
	return;
}

void func_8(Volume volParam0) // Position - 0x41B
{
...
Volume func_9(Volume volParam0) // Position - 0x45C
{
...
void func_10(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x542
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_11(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x5AC
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_12(Volume volParam0, int iParam1, BOOL bParam2) // Position - 0x61F
{
	if (!VOLUME::DOES_VOLUME_EXIST(volParam0))
		return;
...
void func_13(Ped pedParam0, Hash hParam1, BOOL bParam2, BOOL bParam3) // Position - 0x69E
{
	Ped ped;
...
void func_14() // Position - 0x73C
{
	if (VOLUME::DOES_VOLUME_EXIST(volLocal_22))
		MISC::REMOVE_DISPATCH_SPAWN_BLOCKING_AREA(iLocal_23);

	return;
}

void func_15(var uParam0, int iParam1) // Position - 0x753
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_16(var uParam0, var uParam1) // Position - 0x768
{
...
BOOL func_17(var uParam0, var uParam1) // Position - 0x788
{
	BOOL flag;
...
void func_19(var uParam0) // Position - 0x9DA
{
	var unk;
...
int func_20(var uParam0) // Position - 0xA19
{
	*uParam0 = 1;
...
BOOL func_21(Ped pedParam0, var uParam1) // Position - 0xA5E
{
...
BOOL func_22(var uParam0, var uParam1) // Position - 0xC1E
{
	switch (*uParam0)
	{
		case 3:
...
int func_23(var uParam0) // Position - 0xC60
{
	BOOL flag;
	int num;
	int num2;
...
int func_24(var uParam0) // Position - 0xE3C
{
	BOOL flag;
...
int func_25(var uParam0) // Position - 0x12B4
{
	BOOL flag;
	BOOL flag2;
	int relationshipBetweenGroups;
...
void func_26(var uParam0) // Position - 0x16DC
{
	var unk;
...
var func_27(var uParam0) // Position - 0x1706
{
	return uParam0;
}
