...
void func_1(var uParam0, int iParam1) // Position - 0x57
{
	*uParam0 = iParam1;
...
BOOL func_2(var uParam0) // Position - 0x6C
{
	func_3(uParam0);
...
void func_3(var uParam0) // Position - 0x3F9
{
...
void func_4(var uParam0) // Position - 0x478
{
...
BOOL func_5(var uParam0, int iParam1) // Position - 0x4CE
{
...
void func_6(var uParam0) // Position - 0x4EE
{
	var unk;
	var unk2;
	BOOL flag;
...
void func_7(Ped pedParam0) // Position - 0x637
{
	Hash hash;
...
void func_8(Ped pedParam0) // Position - 0x66D
{
	Hash hash;
	var unk;
...
int func_9(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x6E2
{
	if (!func_21(hParam1))
		return 0;
...
int func_10(Hash hParam0) // Position - 0x730
{
	var unk;
...
BOOL func_11(Hash hParam0, Hash hParam1) // Position - 0x75B
{
	if (!func_30(hParam0, 0))
...
void func_12(Ped pedParam0, Hash hParam1) // Position - 0x79C
{
...
void func_13(Ped pedParam0, Hash hParam1) // Position - 0x7E0
{
...
void func_14(Ped pedParam0, Hash hParam1) // Position - 0x85F
{
	if (func_10(hParam1) != 81053684 && !func_11(hParam1, 160827531))
		return;
...
int func_19(Hash hParam0, int iParam1) // Position - 0x9D9
{
...
int func_20(var uParam0) // Position - 0xAC0
{
	return *uParam0;
}

BOOL func_21(Hash hParam0) // Position - 0xACB
{
	return func_39(hParam0);
}

BOOL func_22(var uParam0) // Position - 0xAD9
{
...
BOOL func_23(var uParam0) // Position - 0xB06
{
...
int func_24(Hash hParam0) // Position - 0xB63
{
	var unk;
...
BOOL func_25(int iParam0, int iParam1) // Position - 0xB7F
{
	return iParam0 && iParam1 != false;
}

void func_26(var uParam0, int iParam1) // Position - 0xB8E
{
	func_44(uParam0, iParam1);
	return;
}

void func_27(Hash hParam0, int iParam1) // Position - 0xB9E
{
	var unk;
	int num;
	int num2;
...
void func_28(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0xDB8
{
	int num;
...
BOOL func_29(Hash hParam0) // Position - 0xDEA
{
	Hash hash;
...
BOOL func_30(Hash hParam0, int iParam1) // Position - 0xE14
{
	if (hParam0 == 0)
		return false;
...
Hash func_31(Hash hParam0) // Position - 0xE2E
{
	return hParam0;
}

BOOL func_32(Hash hParam0, Hash hParam1) // Position - 0xE38
{
...
BOOL func_33(int iParam0, var uParam1) // Position - 0xE6E
{
	Hash hash;
	int num;
...
BOOL func_39(Hash hParam0) // Position - 0x10BF
{
	int num;
...
int func_40(int iParam0) // Position - 0x110F
{
	int num;
...
Hash func_41(int iParam0) // Position - 0x113E
{
	return Global_1953292.f_1676.f_1[func_45(iParam0, 1) /*3*/];
}

struct<5> func_42(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x1158
{
	var unk;
	int num;
	var unk6;
...
int func_43(Hash hParam0) // Position - 0x14CC
{
	int i;
...
void func_44(var uParam0, int iParam1) // Position - 0x1507
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

int func_45(int iParam0, int iParam1) // Position - 0x151C
{
	switch (iParam0)
	{
		case -1944638739:
...
int func_46(Hash hParam0) // Position - 0x16ED
{
	switch (func_10(hParam0))
	{
		case -2061583405:
...
int func_47(Hash hParam0) // Position - 0x175A
{
	var unk;
...
BOOL func_48(BOOL bParam0) // Position - 0x176A
{
	return Global_1953292 && bParam0 != false;
}

int func_49(int iParam0) // Position - 0x177B
{
	var unk;
...
int func_50(int iParam0, int iParam1) // Position - 0x179E
{
	switch (iParam0)
	{
		case 0:
...
void func_51(int iParam0) // Position - 0x19ED
{
	func_69(iParam0, 8, 6);
	return;
}

void func_52(int iParam0, int iParam1, int iParam2) // Position - 0x19FE
{
	Global_1953292.f_2686[func_45(iParam0, 1) /*2*/].f_1 = Global_1953292.f_2686[func_45(iParam0, 1) /*2*/].f_1 || iParam1;
	return;
}

void func_53(BOOL bParam0) // Position - 0x1A2D
{
	Global_1953292 = Global_1953292 || bParam0;
	return;
}

void func_54(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1A40
{
	int i;
	int num;
...
BOOL func_55(Hash hParam0, int iParam1) // Position - 0x1D3C
{
	if (hParam0 == 0)
		return false;
...
void func_56(int iParam0) // Position - 0x1D56
{
	int num;
...
int func_57() // Position - 0x1D8F
{
	...
	if (ReturnWeaponType2 == joaat("WEAPON_UNARMED"))
		if (ReturnWeaponType == joaat("WEAPON_UNARMED"))
			return 1;
		else if (WEAPON::IS_WEAPON_VALID(ReturnWeaponType) && WEAPON::_IS_WEAPON_TWO_HANDED(ReturnWeaponType) && !func_72(ReturnWeaponType) && !PED::IS_PED_FULLY_ON_MOUNT(Global_33, true) && !(PED::IS_PED_IN_ANY_VEHICLE(Global_33, false) && !CAM::IS_FIRST_PERSON_CAMERA_ACTIVE(1, 0, 0)))
			return 3;
		else if (WEAPON::_IS_WEAPON_BINOCULARS(ReturnWeaponType))
			return 1;
		else if (WEAPON::IS_WEAPON_VALID(ReturnWeaponType) && func_72(ReturnWeaponType) || WEAPON::_IS_WEAPON_LASSO(ReturnWeaponType))
			return 1;
		else
			return 0;
...
struct<4> func_58(BOOL bParam0) // Position - 0x1E82
{
	int num;
...
int func_59(Hash hParam0) // Position - 0x1F22
{
	var unk;
...
struct<4> func_60(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x1F4D
{
	var outGuid;
...
struct<4> func_61(BOOL bParam0) // Position - 0x1F7E
{
	int num;
...
int func_62(Hash hParam0, BOOL bParam1) // Position - 0x201F
{
...
BOOL func_63(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2056
{
	return func_76(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_64(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x2071
{
	var unk;
...
struct<4> func_65(BOOL bParam0) // Position - 0x2092
{
	int num;
...
BOOL func_66(Hash hParam0, int iParam1) // Position - 0x20FC
{
	Hash hash;
	int num;
	int i;
...
BOOL func_67(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x2169
{
	return func_79(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

int func_68(Hash hParam0, var uParam1) // Position - 0x217F
{
	*uParam1 = 0;
	*uParam1 = 0;
...
void func_69(int iParam0, int iParam1, int iParam2) // Position - 0x21BF
{
...
BOOL func_70(int iParam0) // Position - 0x21FE
{
	return Global_1953292.f_595[iParam0] > 0;
}

void func_71(int iParam0) // Position - 0x2213
{
	Global_1953292.f_595[iParam0] = Global_1953292.f_595[iParam0] + 1;
	return;
}

BOOL func_72(Hash hParam0) // Position - 0x2233
{
	return WEAPON::IS_WEAPON_BOW(hParam0);
}

int func_73(BOOL bParam0) // Position - 0x2241
{
	if (func_80() == -1)
	{
...
struct<4> func_74() // Position - 0x2282
{
	var unk;
...
int func_76(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x22AB
{
...
BOOL func_77(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x232A
{
	int inventoryId;
...
BOOL func_78(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x236F
{
...
BOOL func_79(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x23A2
{
...
int func_80() // Position - 0x23DC
{
	return Global_1572887.f_14;
}

int func_81(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x23EA
{
...
int func_82(Hash hParam0, int iParam1) // Position - 0x241D
{
	if (iParam1 == 0)
		return 0;
...
BOOL func_83(Hash hParam0) // Position - 0x2449
{
