...
void _DEBUG_PRINT(int iParam0) // Position - 0x85C
{
	iParam0 = iParam0;
	return;
}

BOOL func_15(int iParam0) // Position - 0x868
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0(int iParam0) // Position - 0x875
{
	iParam0 = iParam0;
	return;
}

BOOL func_17(int iParam0) // Position - 0x881
{
	iParam0 = iParam0;
	return true;
}

void _DEBUG_PRINT_0_0(int iParam0) // Position - 0x88E
{
	iParam0 = iParam0;
	return;
}

BOOL func_19(int iParam0, BOOL bParam1) // Position - 0x89A
{
	return Global_1896646[iParam0 /*2*/] && bParam1 != false;
}

BOOL func_20(int iParam0) // Position - 0x8AF
{
	return func_54(iParam0, -1, -1, false);
}

void func_21(int iParam0, BOOL bParam1) // Position - 0x8C0
{
...
void _DEBUG_PRINT_0_0_0(int iParam0) // Position - 0x8FF
{
	iParam0 = iParam0;
	return;
}

void func_23() // Position - 0x90B
{
	return;
}

BOOL func_24(int iParam0, BOOL bParam1) // Position - 0x913
{
	if (func_55(iParam0))
		return true;
...
void func_26() // Position - 0x9CB
{
	return;
}

void func_27() // Position - 0x9D3
{
	return;
}

void func_28() // Position - 0x9DB
{
	return;
}

void func_29(int iParam0) // Position - 0x9E3
{
	if (func_45() == -1)
	{
	}
...
void _DEBUG_PRINT_0_0_0_0(int iParam0) // Position - 0xA13
{
	iParam0 = iParam0;
	return;
}

void func_31() // Position - 0xA1F
{
	return;
}

void func_32() // Position - 0xA27
{
	return;
}

void _DEBUG_PRINT_0_0_0_0_0(int iParam0) // Position - 0xA2F
{
	iParam0 = iParam0;
	return;
}

void func_34() // Position - 0xA3B
{
...
void func_35(var uParam0) // Position - 0xA6C
{
	int i;
...
void func_36(int iParam0, var uParam1) // Position - 0xAB2
{
	iParam0 = iParam0;
...
void func_37(int iParam0) // Position - 0xAC6
{
	if (!func_61(iParam0))
		return;
...
BOOL func_38(BOOL bParam0) // Position - 0xADF
{
	return Global_1893611 && bParam0 != false;
}

void func_39(BOOL bParam0) // Position - 0xAF0
{
	Global_1893611 = Global_1893611 - Global_1893611 && bParam0;
	return;
}

BOOL func_40(int iParam0) // Position - 0xB08
{
	func_63();
	return false;
}
...
void func_53(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, float fParam9, char* sParam10) // Position - 0xF61
{
	*uParam0 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(fParam1, fParam4, fParam7, sParam10);
	return;
}

BOOL func_54(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0xF7E
{
	int num;
	int num2;
	int num3;
...
BOOL func_55(int iParam0) // Position - 0x1076
{
...
struct<2> func_57(int iParam0) // Position - 0x109B
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_58(var uParam0, var uParam1) // Position - 0x10AF
{
	return uParam0;
}

void func_59(int iParam0, Volume volParam1, int iParam2, Volume volParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x10B9
{
...
int func_60(int iParam0, BOOL bParam1) // Position - 0x1268
{
	int num;
	Hash hash;
	float num2;
...
BOOL func_61(int iParam0) // Position - 0x138F
{
	return iParam0 >= 0 && iParam0 <= 150;
}

void func_62() // Position - 0x13A5
{
	int i;
...
BOOL func_64(int iParam0, int iParam1) // Position - 0x147D
{
	return iParam0 && iParam1 != false;
}

BOOL func_65(var uParam0, int iParam1) // Position - 0x148C
{
	return uParam0->f_62 && iParam1 != false;
}

BOOL func_66() // Position - 0x149D
{
	return func_64(Global_1940199, 8192);
}

BOOL func_67(var uParam0, int iParam1) // Position - 0x14B0
{
	return uParam0->f_2 && iParam1 != false;
}

BOOL func_68(int iParam0) // Position - 0x14C1
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_69(int iParam0, int iParam1) // Position - 0x1501
{
...
int func_70() // Position - 0x152E
{
	return Global_1896646.f_41;
}

void func_71(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5) // Position - 0x153C
{
	BOOL flag;
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			str = MISC::VAR_STRING(674, str2, num, func_124(&unk, joaat("COLOR_PURE_WHITE")), str3, func_124(&unk2, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			TEXT_LABEL_ASSIGN_INT(&unk2, BUILTIN::ROUND(temperatureAtCoords), 8);
			str = MISC::VAR_STRING(162, str2, num, func_124(&unk, joaat("COLOR_PURE_WHITE")), func_124(&unk2, joaat("COLOR_PURE_WHITE")));
		}
...
void func_72(var uParam0, int iParam1) // Position - 0x17A1
{
	uParam0->f_2 = uParam0->f_2 || iParam1;
	return;
}

void func_73(int iParam0, BOOL bParam1) // Position - 0x17B4
{
...
void func_74(BOOL bParam0) // Position - 0x1E1D
{
	if (bParam0)
...
BOOL func_75(int iParam0) // Position - 0x1E46
{
	switch (iParam0)
	{
		case joaat("DRIZZLE"):
...
void func_76() // Position - 0x1E8B
{
	return;
}

Hash func_77(int iParam0, BOOL bParam1) // Position - 0x1E93
{
	switch (iParam0)
	{
		case 0:
...
void func_78(int iParam0, BOOL bParam1) // Position - 0x2658
{
	if (Global_1572887.f_14 == -1)
	{
...
void func_79(BOOL bParam0) // Position - 0x26AB
{
	if (bParam0)
...
void func_80(int iParam0) // Position - 0x26D4
{
	return;
}

void func_81(int iParam0) // Position - 0x26DC
{
	int i;
...
void func_82(int iParam0) // Position - 0x270D
{
	int i;
...
BOOL func_83(int iParam0, BOOL bParam1) // Position - 0x2740
{
	int num;
	int num2;
	int num3;
...
BOOL func_84(int iParam0) // Position - 0x27F6
{
	int i;
...
BOOL func_85(int iParam0, BOOL bParam1) // Position - 0x2870
{
	if (Global_1572887.f_14 == -1)
...
BOOL func_86(int iParam0) // Position - 0x28A1
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_87(int iParam0) // Position - 0x28C2
{
	if (!func_61(iParam0))
		return false;
...
BOOL func_88(int iParam0, var uParam1, var uParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2915
{
	BOOL flag;
...
BOOL func_89(int iParam0) // Position - 0x2FD5
{
	return iParam0 > -1 && iParam0 < 948;
}

BOOL func_90(int iParam0) // Position - 0x2FEC
{
	switch (iParam0)
	{
		case 64:
...
int func_91(int iParam0, BOOL bParam1) // Position - 0x302F
{
	if (!func_89(iParam0))
		return 0;
...
BOOL func_93() // Position - 0x312E
{
	return func_143(func_57(0));
}

BOOL func_94(int iParam0) // Position - 0x313F
{
	return !func_144(iParam0);
}

void func_95(BOOL bParam0, BOOL bParam1) // Position - 0x314E
{
	if (func_145(255) == 4)
		return;
...
void func_96(int iParam0, BOOL bParam1) // Position - 0x3299
{
	BOOL flag;
...
int func_97(Hash hParam0, int iParam1) // Position - 0x3648
{
	if (iParam1 == 11)
		return 119;
	else if (iParam1 == 27)
...
int func_98(int iParam0) // Position - 0x3FAE
{
	if (!func_162(iParam0))
		return 0;
...
int func_99(int iParam0) // Position - 0x3FEF
{
	switch (iParam0)
	{
		case 3:
...
void func_100(int iParam0, int iParam1) // Position - 0x4096
{
...
void func_101(int iParam0) // Position - 0x40C5
{
...
BOOL func_102(int iParam0, BOOL bParam1) // Position - 0x40FE
{
	return Global_1051832.f_92[iParam0 /*75*/].f_49 && bParam1 != false;
}

BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x4117
{
...
Hash func_104() // Position - 0x4141
{
	return Global_1893611.f_2;
}

BOOL func_105(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x414F
{
	return func_164(iParam0, "sHash", phParam1, "fHeading", pfParam2, "vPos", pvParam3);
}

BOOL func_106(int iParam0, Hash* phParam1, float* pfParam2, Vector3* pvParam3) // Position - 0x416F
{
	return func_164(iParam0, "sClosedHash", phParam1, "fClosedHeading", pfParam2, "vClosedPos", pvParam3);
}

void func_107(int iParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x418F
{
	if (bParam6)
...
BOOL func_108(int iParam0) // Position - 0x420B
{
	return iParam0 > -1 && iParam0 < 16;
}

BOOL func_109(Ped pedParam0, Volume volParam1, int iParam2, BOOL bParam3) // Position - 0x4221
{
...
BOOL func_110(int iParam0) // Position - 0x4255
{
...
const char* func_112(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, var uParam6) // Position - 0x42CD
{
	const char* StringToTest;
...
BOOL func_113(int iParam0) // Position - 0x4D33
{
	return iParam0 > -1 && iParam0 < 6;
}

int func_114(int iParam0) // Position - 0x4D48
{
	switch (iParam0)
	{
		case 0:
...
Hash func_115(int iParam0) // Position - 0x4E03
{
	int i;
	var gamerHandle;
	Hash bountyData;
...
int func_116(int iParam0) // Position - 0x4E71
{
	switch (iParam0)
	{
		case joaat("water_lannahechee_river"):
...
char* func_117(int iParam0) // Position - 0x4FCC
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_118(int iParam0, BOOL bParam1) // Position - 0x5007
{
	if (!func_10(iParam0))
		return false;
...
BOOL func_119(int iParam0, int iParam1) // Position - 0x5049
{
	if (!func_113(iParam0))
		return false;
...
BOOL func_120() // Position - 0x508E
{
	return Global_1902569;
}

int func_121(BOOL bParam0) // Position - 0x509A
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 12) & 31;
}

int func_122(BOOL bParam0) // Position - 0x50AD
{
	return BUILTIN::SHIFT_RIGHT(bParam0, 6) & 63;
}

float func_123(float fParam0) // Position - 0x50BF
{
	return (fParam0 * 1.8f) + 32f;
}

const char* func_124(var uParam0, int iParam1) // Position - 0x50D5
{
...
int func_125(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x510B
{
	int duration;
	var data;
	int num;
...
BOOL func_126(int iParam0) // Position - 0x514E
{
	if (func_172(iParam0))
		if (!func_173(44))
			return false;
...
void func_127(int iParam0, int iParam1) // Position - 0x516E
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

struct<2> func_128(int iParam0, int iParam1) // Position - 0x517F
{
	int num;
...
void func_129(var uParam0, var uParam1, int iParam2) // Position - 0x5195
{
...
void func_130(int iParam0) // Position - 0x51B2
{
...
void func_131(int iParam0) // Position - 0x5292
{
	int i;
	int num;
...
BOOL func_132(int iParam0, BOOL bParam1) // Position - 0x546A
{
	if (func_45() != -1)
		return false;
...
int func_133(int iParam0, BOOL bParam1) // Position - 0x5498
{
	if (!func_89(iParam0))
		return 0;
...
int func_134(int iParam0) // Position - 0x551B
{
	switch (iParam0)
	{
		case 27:
...
int func_135(int iParam0) // Position - 0x5542
{
	switch (iParam0)
	{
		case 33:
...
Hash func_138(int iParam0) // Position - 0x57A5
{
	if (!func_89(iParam0))
		return 0;
...
void func_139(int iParam0, PersChar pchParam1) // Position - 0x57C3
{
	if (!func_89(iParam0))
		return;
...
PersChar func_140(int iParam0) // Position - 0x57E4
{
	if (!func_89(iParam0))
		return 0;
...
void func_141(int iParam0, BOOL bParam1) // Position - 0x5804
{
	if (func_45() != -1)
		return;
...
BOOL func_142(int iParam0) // Position - 0x583D
{
	if (!func_89(iParam0))
		return false;
...
BOOL func_143(var uParam0, var uParam1) // Position - 0x5863
{
	return func_189(uParam0, 5, 8);
}

BOOL func_144(int iParam0) // Position - 0x5876
{
	return func_190(1, iParam0);
}

int func_145(int iParam0) // Position - 0x5885
{
	if (iParam0 == 255)
...
void func_147(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x58ED
{
	func_192(iParam0);
...
int func_148(int iParam0) // Position - 0x594F
{
...
void func_149(var uParam0) // Position - 0x596C
{
	var unk;
...
void func_150(float* pfParam0) // Position - 0x597E
{
	var unk;
...
void func_152(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9) // Position - 0x59E6
{
	switch (uParam0.f_5)
	{
		case 1:
...
BOOL func_153(int iParam0) // Position - 0x5A13
{
...
BOOL func_154(int iParam0, int iParam1) // Position - 0x5A70
{
	return Global_1051832.f_92[iParam0 /*75*/].f_1 && iParam1 != false;
}

void func_155(int iParam0, int iParam1) // Position - 0x5A89
{
	func_154(iParam0, iParam1);
...
int func_156(int iParam0) // Position - 0x5AC4
{
	return Global_1051832.f_92[iParam0 /*75*/].f_47;
}

void func_157(Hash hParam0) // Position - 0x5AD8
{
...
void func_158(int iParam0) // Position - 0x5AF8
{
	return;
}

void func_159(int iParam0) // Position - 0x5B00
{
	Global_1051832.f_92[iParam0 /*75*/].f_49 = 0;
	return;
}

BOOL func_160(int iParam0, int iParam1) // Position - 0x5B15
{
	if (iParam0 == -1)
		return false;
...
void func_161(int iParam0) // Position - 0x5B3C
{
	int i;
	int num;
	BOOL flag;
...
BOOL func_162(int iParam0) // Position - 0x5BBB
{
	return iParam0 > -1 && iParam0 < 180;
}

int func_163(int iParam0) // Position - 0x5BD1
{
	var unk;
...
BOOL func_164(int iParam0, char* sParam1, Hash* phParam2, char* sParam3, float* pfParam4, char* sParam5, Vector3* pvParam6) // Position - 0x5C02
{
	int num;
...
int func_165(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x5C8A
{
	return TASK::CREATE_SCENARIO_POINT_HASH(hParam0, vParam1, fParam4, iParam5, iParam6, bParam7);
}

BOOL func_166() // Position - 0x5CA4
{
	return false;
}

BOOL func_167() // Position - 0x5CAD
{
	var unk;
	var unk3;
...
BOOL func_168(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5D15
{
	if (Global_1572887.f_14 != -1)
	{
...
const char* func_169(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x5E8B
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

int func_170(var uParam0, var uParam1, var uParam2) // Position - 0x5E9F
{
	int i;
...
const char* func_171(int iParam0) // Position - 0x5ECD
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_172(int iParam0) // Position - 0x61B1
{
	switch (iParam0)
	{
		case 22:
...
BOOL func_173(int iParam0) // Position - 0x61DB
{
	if (!func_210(iParam0))
		return false;
...
struct<2> func_174(Player plParam0) // Position - 0x61F7
{
	var gamerHandle;
...
const char* func_175(const char* sParam0, int iParam1) // Position - 0x620B
{
	return MISC::VAR_STRING(42, "COLOR_STRING", MISC::_CREATE_COLOR_STRING(iParam1), sParam0);
}

void func_176(int iParam0, BOOL bParam1) // Position - 0x6225
{
	char* StringToTest;
...
void func_177(int iParam0, BOOL bParam1) // Position - 0x6259
{
	switch (iParam0)
	{
		case 5:
...
void func_178(int iParam0, int iParam1) // Position - 0x628E
{
	func_212(&(Global_1939959.f_5[iParam0 /*11*/].f_7), iParam1);
	return;
}

BOOL func_179(int iParam0) // Position - 0x62A8
{
	if (!func_89(iParam0))
		return false;
...
void func_180(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x62CD
{
	PersChar persChar;
...
void func_181(int iParam0, BOOL bParam1) // Position - 0x63B9
{
	if (!func_162(iParam0))
		return;
...
void func_182(int iParam0, int iParam1) // Position - 0x640F
{
	if (!func_219(iParam0))
		return;
...
int func_183(int iParam0) // Position - 0x6482
{
	return Global_1915656.f_3[iParam0 /*447*/].f_409;
}

void func_184(int iParam0) // Position - 0x6498
{
	Global_1915656.f_3[iParam0 /*447*/].f_6 = 0;
	return;
}

void func_185(int iParam0, BOOL bParam1) // Position - 0x64AE
{
	if (func_45() != -1)
		return;
...
void func_186(int iParam0) // Position - 0x64DF
{
	Ped EntityIndex;
...
void func_187(int iParam0) // Position - 0x6523
{
	Global_1051832.f_92[iParam0 /*75*/].f_50 = 0;
	return;
}

void func_188(int iParam0) // Position - 0x6538
{
	Global_1051832.f_92[iParam0 /*75*/].f_1 = 0;
	return;
}

BOOL func_189(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x654D
{
	int num;
...
BOOL func_190(int iParam0, int iParam1) // Position - 0x6588
{
	int num;
...
BOOL func_191(int* piParam0, int iParam1, int iParam2) // Position - 0x65FC
{
	int num;
	int offset;
	BOOL isBitSet;
...
void func_197(BOOL bParam0) // Position - 0x66CB
{
	if (func_224(bParam0))
		return;
...
BOOL func_198(int* piParam0, int iParam1, int iParam2) // Position - 0x66F2
{
	int num;
	int offset;
	BOOL isBitSet;
...
BOOL func_199(Hash hParam0) // Position - 0x6725
{
	if (func_225(hParam0))
...
BOOL func_200() // Position - 0x6740
{
	return 1;
}

BOOL func_201(BOOL bParam0, BOOL bParam1) // Position - 0x6749
{
	return bParam0 && bParam1 != false;
}

int func_202(int iParam0) // Position - 0x6758
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_203(int iParam0, int iParam1, var uParam2) // Position - 0x7140
{
	var unk;
...
int func_204() // Position - 0x7167
{
	return Global_1072759.f_28418[48 /*4*/].f_3;
}

BOOL func_205() // Position - 0x717C
{
	if (Global_1048576)
		return true;
...
struct<2> func_206() // Position - 0x71D4
{
	return Global_1051268;
}

BOOL func_207(var uParam0, var uParam1) // Position - 0x71E2
{
	if (!func_228(uParam0))
		return false;
...
struct<2> func_208() // Position - 0x7216
{
...
BOOL func_209(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7261
{
	var unk;
	float num;
	float num2;
...
BOOL func_210(int iParam0) // Position - 0x7291
{
	if (iParam0 == 0)
		return false;
...
BOOL func_211(int iParam0) // Position - 0x72A4
{
	int num;
	int num2;
	int offset;
...
void func_212(BOOL bParam0, int iParam1) // Position - 0x72CE
{
	*bParam0 = *bParam0 - *bParam0 && iParam1;
	return;
}

BOOL func_213(int iParam0) // Position - 0x72E3
{
	if (!func_89(iParam0))
		return false;
...
BOOL func_214(Hash hParam0) // Position - 0x7307
{
	return hParam0 != 0;
}

BOOL func_215(int iParam0, BOOL bParam1) // Position - 0x7313
{
	if (!func_162(iParam0))
		return false;
...
void func_216(int iParam0, BOOL bParam1) // Position - 0x7339
{
	if (!func_162(iParam0))
		return;
...
void func_217(int iParam0, BOOL bParam1) // Position - 0x7367
{
	if (!func_162(iParam0))
		return;
...
void func_218(int iParam0) // Position - 0x73A1
{
	func_233(func_232(iParam0));
	return;
}

BOOL func_219(int iParam0) // Position - 0x73B3
{
	return iParam0 > -1 && iParam0 < 40;
}

Ped func_220(int iParam0) // Position - 0x73C9
{
	PersChar persChar;
...
int func_221(int iParam0, var uParam1) // Position - 0x73F7
{
	if (iParam0 == 2)
...
BOOL func_222(int* piParam0, int iParam1, int iParam2) // Position - 0x7411
{
	return MISC::IS_BIT_SET(piParam0->[iParam1 / 31], iParam1 % 31);
}

int func_223() // Position - 0x7448
{
	return Global_1102813.f_3672;
}

BOOL func_224(BOOL bParam0) // Position - 0x7457
{
	return Global_1102813.f_26.f_9 && bParam0 == bParam0;
}

BOOL func_225(Hash hParam0) // Position - 0x746D
{
	return hParam0 != 0;
}

BOOL func_226(int iParam0, int iParam1, Any* panParam2) // Position - 0x7479
{
...
void func_227(Any* panParam0, int iParam1, var uParam2) // Position - 0x74AD
{
	var unk;
...
BOOL func_228(int iParam0) // Position - 0x7527
{
	switch (iParam0)
	{
		case 2:
...
int func_229(int iParam0) // Position - 0x7566
{
	switch (iParam0)
	{
		case 2:
...
void func_230(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x75FC
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_231(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8) // Position - 0x809E
{
	float num;
	float num2;
	float num3;
...
int func_232(int iParam0) // Position - 0x8104
{
...
void func_233(int iParam0) // Position - 0x8621
{
	Global_1915656.f_18247 = iParam0;
	return;
}

int func_234(var uParam0, var uParam1) // Position - 0x8632
{
	var unk;
...
int func_235(int iParam0) // Position - 0x865E
{
	int num;
...
BOOL func_236(int iParam0, var uParam1, Any* panParam2) // Position - 0x87D3
{
	if (!func_207(iParam0))
		return false;
...
void func_237(Any* panParam0) // Position - 0x88DE
{
	*panParam0 = 0;
	panParam0->f_1 = -1;
	panParam0->f_2 = -1;
