...
int func_2() // Position - 0x13C
{
	return Global_1572887.f_14;
}

struct<2> func_3(int iParam0) // Position - 0x14A
{
	return Global_1900460.f_1[iParam0 /*2*/];
}

int func_4(int iParam0, var uParam1) // Position - 0x15E
{
	return iParam0;
}

void func_5(var uParam0) // Position - 0x168
{
...
BOOL func_6(var uParam0) // Position - 0x1E3
{
...
BOOL func_7() // Position - 0x1FD
{
	return false;
}

BOOL func_8(var uParam0) // Position - 0x206
{
	Hash hash;
	BOOL flag;
	BOOL flag2;
...
int func_9(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x8BD
{
	int num;
	int num2;
	int scenario;
...
int func_10(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xC43
{
	int num;
	int scenario;
...
int func_11(var uParam0) // Position - 0xC76
{
	int num;
...
void func_12(var uParam0) // Position - 0xE3A
{
	switch (uParam0->f_1)
	{
		case 3:
...
int func_13(var uParam0) // Position - 0xF02
{
	int num;
...
int func_14(int iParam0) // Position - 0x1396
{
	switch (iParam0)
	{
...
void func_15(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x18A1
{
...
void func_16(var uParam0, var uParam1) // Position - 0x18D8
{
	Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_1 = uParam0;
	return;
}

void func_17() // Position - 0x18EE
{
...
void func_18(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x191D
{
	int num;
...
void func_19(var uParam0) // Position - 0x1971
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_22))
...
BOOL func_20(var uParam0, int iParam1) // Position - 0x1992
{
	return func_69(uParam0->f_16, iParam1);
}

void func_21(var uParam0, var uParam1, var uParam2) // Position - 0x19A4
{
...
void func_22(var uParam0, var uParam1, BOOL bParam2) // Position - 0x19C6
{
	var value;
	int num;
	int num2;
...
void func_23(int iParam0, int iParam1, int iParam2) // Position - 0x1A96
{
	func_75(&Global_1222327[iParam0 /*251*/][iParam1], iParam2);
	return;
}

void func_24() // Position - 0x1AB0
{
...
void func_26(var uParam0) // Position - 0x1B2A
{
	func_76(uParam0);
...
void func_27(BOOL bParam0) // Position - 0x1B41
{
	if (bParam0)
		func_78(0, 6);
	else
...
void func_28(var uParam0) // Position - 0x1B5E
{
	if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_7))
...
BOOL func_29(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5, BOOL bParam6) // Position - 0x1B79
{
...
BOOL func_30(var uParam0) // Position - 0x1BD4
{
	if (!func_20(uParam0, 32))
...
int func_31(var uParam0) // Position - 0x1C24
{
	return uParam0->f_2;
}

BOOL func_32(int iParam0) // Position - 0x1C30
{
	int i;
	Player Plr;
	float num;
	...
	if (num > 0f)
	{
		...
		{
			if (!func_69(Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 1))
				func_81(&Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 1);
		
			return true;
		}
	
		if (!func_69(Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 32))
			func_81(&Global_1222327[Global_1222034[player2 /*9*/].f_1 /*251*/][Global_1222034[player2 /*9*/].f_2], 32);
	}

	return false;
}

void func_33(var uParam0, int iParam1) // Position - 0x1DA5
{
	uParam0->f_2 = iParam1;
	return;
}

BOOL func_34(int iParam0) // Position - 0x1DB3
{
	if (iParam0 < 0)
		return false;
...
BOOL func_35(int iParam0, BOOL bParam1) // Position - 0x1DF2
{
	int num;
...
BOOL func_36(BOOL bParam0) // Position - 0x1E25
{
...
void func_37(var uParam0, Vector3 vParam1, var uParam2, var uParam3) // Position - 0x1E58
{
	if (!func_42(vParam1))
	{
		func_21(vParam1);
...
void func_38(var uParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, BOOL bParam7) // Position - 0x1ECD
{
	BOOL flag;
	BOOL flag2;
	float num;
...
void func_39(int iParam0) // Position - 0x20F6
{
...
void func_40(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5) // Position - 0x21F4
{
...
void func_41(int iParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7) // Position - 0x224C
{
	if (!func_94(iParam0))
	{
...
BOOL func_42(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x2280
{
	return !PERSISTENCE::_PERSISTENCE_IS_SCENARIO_MARKED_AS_LOOTED_AT_COORDS(vParam0);
}

Vector3 func_43(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x2291
{
	var unk;
	float X;
	float num;
	...
	unk = { func_95(uParam0) };
	X = { func_97(func_97(unk, func_96(iParam3 - 90f)), unk) };
	num = MISC::ATAN2(X.f_1, X);
	num2 = -MISC::ATAN2(X.f_2, BUILTIN::SQRT((X * X) + (X.f_1 * X.f_1)));
	vector = { -X.f_1, X, 0f };
	vector2 = { func_97(vector, X) };
	num3 = MISC::ATAN2(func_98(vector, unk) / BUILTIN::VMAG(vector), func_98(vector2, unk) / BUILTIN::VMAG(vector2)) + 180f;
	return num3, num2, num;
}

int func_44(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x2347
{
	int i;
...
BOOL func_45(var uParam0, int iParam1) // Position - 0x23F7
{
	if (func_82(joaat("kit_collector_spade"), 1))
	{
...
int func_46(char* sParam0, Hash hParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, Hash hParam15, int iParam16) // Position - 0x2483
{
	int i;
	int num;
	int num2;
...
void func_47(int iParam0, var uParam1) // Position - 0x2561
{
	if (AUDIO::PREPARE_SOUNDSET("RDRO_Collectible_Sounds_Travelling_Saleswoman", false))
	{
...
BOOL func_48(int iParam0, BOOL bParam1) // Position - 0x25A2
{
	int num;
	int gameTimer;
	float progress;
...
BOOL func_49(int iParam0, int iParam1, int iParam2) // Position - 0x269C
{
	return func_69(Global_1222327[iParam0 /*251*/][iParam1], iParam2);
}

void func_50(Ped pedParam0) // Position - 0x26B6
{
	Entity firstEntityPedIsCarrying;
...
float func_51(int iParam0, BOOL bParam1) // Position - 0x26F8
{
	int num;
...
float func_53(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x2779
{
	if (!ENTITY::DOES_ENTITY_EXIST(pedParam0))
		return 0f;
...
void func_54(float fParam0) // Position - 0x27A1
{
	if (!Global_1222034[PLAYER::PLAYER_ID() /*9*/].f_4)
	{
...
int func_55(Ped pedParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x27E5
{
...
float func_56(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x280B
{
	float num;
	float Y;
	float X;
...
BOOL func_58(var uParam0) // Position - 0x2894
{
	var unk;
	int i;
	int num;
...
void func_59(int iParam0) // Position - 0x292E
{
...
void func_60(BOOL bParam0, BOOL bParam1) // Position - 0x2948
{
	if (bParam1)
...
BOOL func_63(Hash hParam0, int iParam1) // Position - 0x2AA4
{
	if (hParam0 == 0)
		return false;
...
int func_64(int iParam0) // Position - 0x2ABE
{
	switch (iParam0)
	{
...
void func_65(var uParam0, int iParam1) // Position - 0x30E5
{
...
int func_66(int iParam0) // Position - 0x3105
{
	return iParam0;
}

void func_67(int iParam0) // Position - 0x310F
{
	if (!func_107(iParam0))
		return;
...
int func_68(Entity eParam0, Entity eParam1, int iParam2) // Position - 0x31C2
{
	int i;
	var SourceStruct;
...
BOOL func_69(int iParam0, int iParam1) // Position - 0x326C
{
	return iParam0 && iParam1 != false;
}

BOOL func_70(float fParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x327B
{
	return fParam0 == fParam3 && fParam0.f_1 == fParam3.f_1 && fParam0.f_2 == fParam3.f_2;
}

var func_71(int iParam0, int iParam1) // Position - 0x32A4
{
	return func_72(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("volCylinder"), iParam0, iParam1);
}

var func_72(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8, int iParam9, BOOL bParam10, int iParam11) // Position - 0x32C2
{
	var value;
	Player bitIndex;
	int i;
	...
	if (flag4 & 8 != 0)
		flag4 = flag4 || func_110(PLAYER::GET_PLAYER_TEAM(PlayerIndex));
...
void func_74(Any* panParam0, int* piParam1) // Position - 0x36EF
{
...
void func_75(int iParam0, int iParam1) // Position - 0x3720
{
	func_115(iParam0, iParam1);
	return;
}

void func_76(var uParam0) // Position - 0x3730
{
	if (uParam0->f_4 != -1)
	{
...
void func_77(int iParam0, int iParam1) // Position - 0x3763
{
	if (func_94(iParam0))
...
void func_78(int iParam0, int iParam1) // Position - 0x377C
{
...
void func_79(int iParam0, int iParam1, BOOL bParam2) // Position - 0x37C0
{
...
float func_80(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0x3827
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_81(int iParam0, int iParam1) // Position - 0x3845
{
	func_118(iParam0, iParam1);
	return;
}

BOOL func_82(Hash hParam0, int iParam1) // Position - 0x3855
{
	int num;
...
BOOL _IS_NULL_VECTOR(float fParam0, var uParam1, var uParam2) // Position - 0x38D8
{
...
BOOL func_84(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3902
{
	switch (uParam0->f_11)
	{
		case 0:
...
float func_85() // Position - 0x3A01
{
	return Global_1156111.f_2169[89 /*205*/].f_201;
}

void func_86(var uParam0, int iParam1) // Position - 0x3A16
{
	*uParam0 = iParam1;
	return;
}

void func_87(int iParam0) // Position - 0x3A23
{
	if (iParam0 <= 0)
		return;
...
void func_88(var uParam0) // Position - 0x3A4A
{
	func_126(uParam0, 0f);
	return;
}

float func_89(var uParam0) // Position - 0x3A59
{
	if (!func_127(uParam0))
		return uParam0->f_1;
...
BOOL func_91(Ped pedParam0) // Position - 0x3AF3
{
...
BOOL func_92(int iParam0, BOOL bParam1) // Position - 0x3B3D
{
	if (bParam1 && !func_34(iParam0))
		return false;
...
void func_93(int iParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3B62
{
	int num;
...
BOOL func_94(int iParam0) // Position - 0x3BB6
{
	if (*iParam0 == 0)
		return false;
...
Vector3 func_95(float fParam0, var uParam1, var uParam2) // Position - 0x3BCE
{
	float num;
	float num2;
...
Vector3 func_96(float fParam0) // Position - 0x3C0D
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Vector3 func_97(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x3C23
{
...
float func_98(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x3C5C
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

BOOL func_99(Entity eParam0) // Position - 0x3C7D
{
	int num;
	var InputString;
	Hash entityModel;
...
BOOL func_100(int iParam0, int iParam1) // Position - 0x3D17
{
	if (iParam0 < 0)
		return false;
...
BOOL func_101(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x3D38
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_103(int iParam0, Any anParam1) // Position - 0x40A8
{
	var unk;
...
struct<2> func_104(int iParam0, int iParam1) // Position - 0x40D1
{
	int num;
...
void func_105(var uParam0, var uParam1, int iParam2) // Position - 0x40E7
{
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x4104
{
	var unk;
	var unk13;
	var unk26;
...
BOOL func_107(int iParam0) // Position - 0x4134
{
	return func_100(iParam0, 2);
}

int func_108() // Position - 0x4143
{
	return Global_1051645.f_12;
}

char* func_109() // Position - 0x4151
{
	return "unnamed";
}

BOOL func_110(int iParam0) // Position - 0x415C
{
	int num;
...
BOOL func_111(int iParam0) // Position - 0x41EB
{
...
int func_112(int iParam0) // Position - 0x4209
{
	if (iParam0 == 255)
...
BOOL func_113(Player plParam0) // Position - 0x4254
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return false;
...
int func_114(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x4299
{
	if (!func_147(uParam0))
		return 0;
...
void func_115(int iParam0, int iParam1) // Position - 0x42C9
{
	*iParam0 = *iParam0 - *iParam0 && iParam1;
	return;
}

BOOL func_116(int iParam0, int iParam1) // Position - 0x42DE
{
	return MISC::IS_BIT_SET(Global_1072759.f_22475.f_417[iParam0 /*12*/], iParam1);
}

void func_117() // Position - 0x42FA
{
	SCRIPTS::_SET_ALL_PLAYER_BITS(&(Global_1072759.f_21353.f_260));
	return;
}

void func_118(var uParam0, int iParam1) // Position - 0x4310
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

int func_119(Hash hParam0) // Position - 0x4321
{
	var unk;
...
BOOL func_120(Hash hParam0, int iParam1) // Position - 0x434C
{
	Hash hash;
	int num;
	int num2;
...
BOOL func_121(Hash hParam0) // Position - 0x43F3
{
	int num;
	int num2;
	int num3;
...
int func_122(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x44AF
{
...
BOOL func_123(BOOL bParam0) // Position - 0x4571
{
	if (bParam0)
...
BOOL func_124() // Position - 0x45A1
{
	return func_161() != -1;
}

BOOL func_125() // Position - 0x45AF
{
	return Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_FEMALE") && Global_1953292.f_1 != joaat("MPC_PLAYER_TYPE_MP_MALE");
}

void func_126(var uParam0, float fParam1) // Position - 0x45D4
{
...
BOOL func_127(var uParam0) // Position - 0x45FA
{
	return func_164(*uParam0, 1);
}

BOOL func_128(var uParam0) // Position - 0x460A
{
	return func_164(*uParam0, 2);
}

float func_129() // Position - 0x461A
{
...
BOOL func_130(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x464C
{
...
BOOL func_131(Ped pedParam0) // Position - 0x4675
{
	return func_165(pedParam0, 0);
}

BOOL func_132(Ped pedParam0) // Position - 0x4684
{
	return func_165(pedParam0, 3);
}

BOOL func_133(Ped pedParam0) // Position - 0x4693
{
	return func_165(pedParam0, 4) || func_165(pedParam0, 5);
}

BOOL func_134(Ped pedParam0) // Position - 0x46AF
{
	return func_165(pedParam0, 6);
}

BOOL func_135(Ped pedParam0) // Position - 0x46BE
{
	return func_165(pedParam0, 7);
}

void func_136(int iParam0, int iParam1) // Position - 0x46CD
{
	if (iParam0 < 0)
		return;
...
void func_137(int iParam0, BOOL bParam1) // Position - 0x4700
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_138(int iParam0, BOOL bParam1) // Position - 0x4758
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951910[iParam0 /*23*/].f_3))
...
void func_139(int iParam0, int iParam1) // Position - 0x4781
{
	if (iParam0 < 0)
		return;
...
int func_140() // Position - 0x47A9
{
	return Global_1072759.f_28418[47 /*4*/].f_3;
}

void func_141(var uParam0, int iParam1) // Position - 0x47BE
{
	BOOL flag;
	int i;
...
BOOL func_142(int iParam0, var uParam1, Any anParam2, int iParam3, int iParam4) // Position - 0x48EA
{
	var unk;
	int num;
...
int func_143(int iParam0, Any anParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7) // Position - 0x4959
{
	BOOL flag;
	int num;
	var unk;
...
BOOL func_144(int iParam0, int iParam1) // Position - 0x4A3A
{
	int num;
...
BOOL func_145(Player plParam0) // Position - 0x4AAE
{
...
void func_146(Player plParam0) // Position - 0x4ACB
{
	Player player;
...
BOOL func_147(var uParam0) // Position - 0x4B4E
{
	if (*uParam0 >= 40)
		return false;
...
Hash func_148(Hash hParam0, int iParam1) // Position - 0x4B63
{
	int num;
	var unk;
	Hash hash;
...
BOOL func_149(char* sParam0, var uParam1, int* piParam2, Hash hParam3, BOOL bParam4) // Position - 0x4BDD
{
...
BOOL func_150(Any* panParam0, int iParam1, int iParam2, int iParam3) // Position - 0x4C04
{
	if (iParam2 < 0)
		return false;
...
BOOL func_151(Hash hParam0) // Position - 0x4C3F
{
	return WEAPON::IS_WEAPON_VALID(hParam0) && hParam0 != joaat("WEAPON_UNARMED");
}

int func_152(int iParam0) // Position - 0x4C5A
{
	if (iParam0 < 0)
		return 0;
...
int func_153(Hash hParam0) // Position - 0x4C7B
{
	var unk;
...
int func_154(Hash hParam0) // Position - 0x4CA6
{
	switch (hParam0)
	{
...
int func_155(var uParam0, int iParam1) // Position - 0x4D89
{
	int i;
...
int func_156(Hash hParam0) // Position - 0x4DC6
{
	int num;
...
int func_157(Hash hParam0, BOOL bParam1) // Position - 0x4E33
{
	var unk;
	int num;
	int num2;
...
int func_158(Hash hParam0, int iParam1) // Position - 0x4E92
{
	if (iParam1 == 0)
		return 0;
...
int func_159(BOOL bParam0) // Position - 0x4EBE
{
	if (func_2() == -1)
	{
...
struct<4> func_160(Hash hParam0, BOOL bParam1) // Position - 0x4EFF
{
	var unk;
...
int func_161() // Position - 0x4F24
{
	return Global_1149172.f_137;
}

void func_162(var uParam0, int iParam1) // Position - 0x4F32
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_163(var uParam0, int iParam1) // Position - 0x4F43
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_164(int iParam0, int iParam1) // Position - 0x4F58
{
	return iParam0 && iParam1 != false;
}

BOOL func_165(Ped pedParam0, int iParam1) // Position - 0x4F67
{
	var unk;
	int num;
...
void func_166(var uParam0) // Position - 0x4FA6
{
...
void func_167(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16) // Position - 0x4FDE
{
	int i;
	var unk;
...
void func_168(int iParam0, int iParam1) // Position - 0x5094
{
	if (iParam1 == 0)
		return;
...
void func_169(Any anParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18) // Position - 0x50C4
{
	int i;
	var unk;
...
BOOL func_170(Any* panParam0, int iParam1, int iParam2) // Position - 0x517F
{
	return MISC::IS_BIT_SET(panParam0->[iParam1 / 31], iParam1 % 31);
}

int func_171() // Position - 0x51B6
{
	return Global_1102813.f_3672;
}

void func_172(Player plParam0) // Position - 0x51C5
{
	Player player;
...
void func_173(Player plParam0) // Position - 0x5231
{
...
BOOL func_174(Hash hParam0, Hash hParam1) // Position - 0x526C
{
	if (!func_63(hParam0, 0))
...
void func_175(Hash hParam0, var uParam1, var uParam2) // Position - 0x52AD
{
	*uParam1 = 0;
	*uParam2 = 0;
...
struct<18> func_176(Hash hParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x54B9
{
	Hash hash;
...
struct<4> func_177(BOOL bParam0) // Position - 0x5597
{
	int num;
...
void func_178(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x5638
{
...
BOOL func_179(Any* panParam0, var uParam1, int* piParam2, BOOL bParam3) // Position - 0x5653
{
...
Hash func_180(Hash hParam0) // Position - 0x5678
{
	return hParam0;
}

BOOL func_181(Hash hParam0, int iParam1) // Position - 0x5682
{
	if (hParam0 == 0)
		return false;
...
struct<5> func_182(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x569C
{
	var unk;
	int num;
	var unk6;
...
struct<4> func_183(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6) // Position - 0x5A10
{
	var outGuid;
...
int func_184() // Position - 0x5A41
{
	return Global_1953292.f_1;
}

BOOL func_185(Any anParam0) // Position - 0x5A4F
{
...
BOOL func_186(Hash hParam0, Hash hParam1) // Position - 0x5A95
{
...
struct<4> func_187(BOOL bParam0) // Position - 0x5ACB
{
	int num;
...
int func_188(Hash hParam0, BOOL bParam1) // Position - 0x5B6B
{
...
BOOL func_189(Hash hParam0, var uParam1, Hash hParam2, BOOL bParam3, BOOL bParam4) // Position - 0x5BA2
{
	return func_196(hParam0, *uParam1, hParam2, bParam3, true, bParam4) > 0;
}

BOOL func_190(Hash hParam0, Any* panParam1, Hash hParam2) // Position - 0x5BBD
{
	var unk;
...
struct<4> func_191(BOOL bParam0) // Position - 0x5BDE
{
	int num;
...
BOOL func_192(Hash hParam0, int iParam1) // Position - 0x5C48
{
	Hash hash;
	int num;
	int i;
...
BOOL func_193(var uParam0, var uParam1, var uParam2, var uParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x5CB5
{
	return func_199(&uParam0, panParam4, bParam5, bParam6, iParam7);
}

struct<4> func_194() // Position - 0x5CCB
{
	var unk;
...
int func_196(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, Hash hParam5, BOOL bParam6, BOOL bParam7, BOOL bParam8) // Position - 0x5CF4
{
...
BOOL func_197(Hash hParam0, Any* panParam1, Any* panParam2, Hash hParam3) // Position - 0x5D73
{
	int inventoryId;
...
BOOL func_198(Hash hParam0, int iParam1, Hash hParam2) // Position - 0x5DB8
{
...
BOOL func_199(Any* panParam0, Any* panParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x5DEB
{
...
int func_200(Hash hParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5E25
{
...
BOOL func_201(Hash hParam0) // Position - 0x5E58
{
